...
#define RTE_COMPILE_TIME_CPUFLAGS                                              \
  RTE_CPUFLAG_SSE, RTE_CPUFLAG_SSE2, RTE_CPUFLAG_SSE3, RTE_CPUFLAG_SSSE3,      \
      RTE_CPUFLAG_SSE4_1, RTE_CPUFLAG_SSE4_2, RTE_CPUFLAG_AES,                 \
      RTE_CPUFLAG_AVX, RTE_CPUFLAG_AVX2, RTE_CPUFLAG_PCLMULQDQ,                \
      RTE_CPUFLAG_RDRAND, RTE_CPUFLAG_RDSEED, RTE_CPUFLAG_VPCLMULQDQ
...
#define RTE_EAL_PMD_PATH "/usr/local/lib64/dpdk/pmds-22.1"
