...
#define rte_bbdev_log_debug(fmt, ...)                                          \
  rte_bbdev_log(DEBUG, "fpga_lte_fec: " fmt, ##__VA_ARGS__)
#else
#define rte_bbdev_log_debug(fmt, ...)
#endif
...
struct __rte_packed fpga_dma_enc_desc {
  uint32_t done : 1, rsrvd0 : 11, error : 4, rsrvd1 : 16;
  uint32_t ncb : 16, rsrvd2 : 14, rv : 2;
  uint32_t bypass_rm : 1, irq_en : 1, crc_en : 1, rsrvd3 : 13, offset : 10,
      rsrvd4 : 6;
  uint16_t e;
  uint16_t k;
...
struct __rte_packed fpga_dma_dec_desc {
  uint32_t done : 1, iter : 5, rsrvd0 : 2, crc_pass : 1, rsrvd1 : 3, error : 4,
      crc_type : 1, rsrvd2 : 7, max_iter : 5, rsrvd3 : 3;
  uint32_t rsrvd4;
  uint32_t bypass_rm : 1, irq_en : 1, drop_crc : 1, rsrvd5 : 13, offset : 10,
      rsrvd6 : 6;
  uint16_t k;
  uint16_t in_len;
  uint32_t out_addr_lw;
...
struct __rte_packed fpga_ring_ctrl_reg {
  ...
  union { /* Miscellaneous register */
    uint8_t misc;
    uint8_t max_ul_dec : 5, max_ul_dec_en : 1, rsrvd1 : 2;
  };
  uint8_t enable;
...
static inline void mmio_write_16(void *addr, uint16_t value) {
...
static inline void mmio_write_64(void *addr, uint64_t value) {
  *((volatile uint64_t *)(addr)) = rte_cpu_to_le_64(value);
}

/* Write a 8 bit register of a FPGA LTE FEC device */
static inline void fpga_reg_write_8(void *mmio_base, uint32_t offset,
                                    uint8_t payload) {
...
static inline void fpga_reg_write_16(void *mmio_base, uint32_t offset,
                                     uint16_t payload) {
  void *reg_addr = RTE_PTR_ADD(mmio_base, offset);
...
static inline void fpga_reg_write_32(void *mmio_base, uint32_t offset,
                                     uint32_t payload) {
  void *reg_addr = RTE_PTR_ADD(mmio_base, offset);
...
static inline void fpga_reg_write_64(void *mmio_base, uint32_t offset,
                                     uint64_t payload) {
  void *reg_addr = RTE_PTR_ADD(mmio_base, offset);
...
static inline void fpga_ring_reg_write(void *mmio_base, uint32_t offset,
  ...
  fpga_reg_write_16(mmio_base, offset + FPGA_LTE_FEC_RING_SHADOW_TAIL,
                    payload.shadow_tail);
  fpga_reg_write_8(mmio_base, offset + FPGA_LTE_FEC_RING_MISC, payload.misc);
  fpga_reg_write_8(mmio_base, offset + FPGA_LTE_FEC_RING_ENABLE,
                   payload.enable);
}

/* Read a register of FPGA LTE FEC device */
static uint32_t fpga_reg_read_32(void *mmio_base, uint32_t offset) {
  void *reg_addr = RTE_PTR_ADD(mmio_base, offset);
...
#ifdef RTE_LIBRTE_BBDEV_DEBUG
/* Read a register of FPGA LTE FEC device */
static uint8_t fpga_reg_read_8(void *mmio_base, uint32_t offset) {
  void *reg_addr = RTE_PTR_ADD(mmio_base, offset);
  return *((volatile uint8_t *)(reg_addr));
}

/* Read a register of FPGA LTE FEC device */
static uint16_t fpga_reg_read_16(void *mmio_base, uint32_t offset) {
  void *reg_addr = RTE_PTR_ADD(mmio_base, offset);
...
/* Read a register of FPGA LTE FEC device */
static uint64_t fpga_reg_read_64(void *mmio_base, uint32_t offset) {
  void *reg_addr = RTE_PTR_ADD(mmio_base, offset);
...
static inline void print_ring_reg_debug_info(void *mmio_base, uint32_t offset) {
  rte_bbdev_log_debug("FPGA MMIO base address @ %p | Ring Control Register @ "
                      "offset = 0x%08" PRIx32,
                      mmio_base, offset);
  rte_bbdev_log_debug("RING_BASE_ADDR = 0x%016" PRIx64,
                      fpga_reg_read_64(mmio_base, offset));
  rte_bbdev_log_debug(
      "RING_HEAD_ADDR = 0x%016" PRIx64,
      fpga_reg_read_64(mmio_base, offset + FPGA_LTE_FEC_RING_HEAD_ADDR));
  rte_bbdev_log_debug(
      "RING_SIZE = 0x%04" PRIx16,
      fpga_reg_read_16(mmio_base, offset + FPGA_LTE_FEC_RING_SIZE));
  rte_bbdev_log_debug(
      "RING_MISC = 0x%02" PRIx8,
      fpga_reg_read_8(mmio_base, offset + FPGA_LTE_FEC_RING_MISC));
  rte_bbdev_log_debug(
      "RING_ENABLE = 0x%02" PRIx8,
      fpga_reg_read_8(mmio_base, offset + FPGA_LTE_FEC_RING_ENABLE));
  rte_bbdev_log_debug(
      "RING_FLUSH_QUEUE_EN = 0x%02" PRIx8,
      fpga_reg_read_8(mmio_base, offset + FPGA_LTE_FEC_RING_FLUSH_QUEUE_EN));
  rte_bbdev_log_debug(
      "RING_SHADOW_TAIL = 0x%04" PRIx16,
      fpga_reg_read_16(mmio_base, offset + FPGA_LTE_FEC_RING_SHADOW_TAIL));
  rte_bbdev_log_debug(
      "RING_HEAD_POINT = 0x%04" PRIx16,
      fpga_reg_read_16(mmio_base, offset + FPGA_LTE_FEC_RING_HEAD_POINT));
}

/* Read Static Register of FPGA LTE FEC device */
static inline void print_static_reg_debug_info(void *mmio_base) {
  uint16_t config = fpga_reg_read_16(mmio_base, FPGA_LTE_FEC_CONFIGURATION);
  uint8_t qmap_done =
      fpga_reg_read_8(mmio_base, FPGA_LTE_FEC_QUEUE_PF_VF_MAP_DONE);
  uint16_t lb_factor =
      fpga_reg_read_16(mmio_base, FPGA_LTE_FEC_LOAD_BALANCE_FACTOR);
  uint16_t ring_desc_len =
      fpga_reg_read_16(mmio_base, FPGA_LTE_FEC_RING_DESC_LEN);
  uint16_t flr_time_out =
      fpga_reg_read_16(mmio_base, FPGA_LTE_FEC_FLR_TIME_OUT);

  rte_bbdev_log_debug("UL.DL Weights = %u.%u", ((uint8_t)config),
                      ((uint8_t)(config >> 8)));
  rte_bbdev_log_debug("UL.DL Load Balance = %u.%u", ((uint8_t)lb_factor),
                      ((uint8_t)(lb_factor >> 8)));
...
static void print_dma_dec_desc_debug_info(union fpga_dma_desc *desc) {
  rte_bbdev_log_debug(
      "DMA response desc %p\n"
      ...
      desc, (uint32_t)desc->dec_req.done, (uint32_t)desc->dec_req.iter,
      (uint32_t)desc->dec_req.crc_pass, (uint32_t)desc->dec_req.error,
      (uint32_t)desc->dec_req.crc_type, (uint32_t)desc->dec_req.max_iter,
      (uint32_t)desc->dec_req.bypass_rm, (uint32_t)desc->dec_req.irq_en,
      (uint32_t)desc->dec_req.drop_crc, (uint32_t)desc->dec_req.offset,
      (uint32_t)desc->dec_req.k, (uint16_t)desc->dec_req.in_len,
      desc->dec_req.op_addr, (uint32_t)desc->dec_req.cbs_in_op,
      (uint32_t)desc->dec_req.in_addr_hi, (uint32_t)desc->dec_req.in_addr_lw,
      (uint32_t)desc->dec_req.out_addr_hi, (uint32_t)desc->dec_req.out_addr_lw);
}
#endif

static int fpga_setup_queues(struct rte_bbdev *dev, uint16_t num_queues,
                             int socket_id) {
  ...
  for (q_id = 0; q_id < FPGA_TOTAL_NUM_QUEUES; ++q_id) {
    ...
    if (hw_q_id != FPGA_INVALID_HW_QUEUE_ID) {
      ...
      fpga_ring_reg_write(fpga_dev->mmio_base, offset, ring_reg);
      ++hw_q_num;
    }
  }
  if (hw_q_num == 0) {
    rte_bbdev_log(ERR,
                  "No HW queues assigned to this device. Probably this is a VF "
                  "configured for PF mode. Check device configuration!");
    return -ENODEV;
  }

  if (num_queues > hw_q_num) {
    rte_bbdev_log(
        ERR, "Not enough queues for device %s! Requested: %u, available: %u",
  ...
  fpga_dev->sw_rings =
      rte_zmalloc_socket(dev->device->driver->name, num_queues * ring_size,
                         RTE_CACHE_LINE_SIZE, socket_id);
  if (fpga_dev->sw_rings == NULL) {
    rte_bbdev_log(ERR, "Failed to allocate memory for %s:%u sw_rings",
  ...
  fpga_dev->flush_queue_status = rte_zmalloc_socket(
      NULL, sizeof(uint64_t), RTE_CACHE_LINE_SIZE, socket_id);
  if (fpga_dev->flush_queue_status == NULL) {
    rte_bbdev_log(ERR, "Failed to allocate memory for %s:%u flush_queue_status",
                  dev->device->driver->name, dev->data->dev_id);
    return -ENOMEM;
  }
...
static int fpga_dev_close(struct rte_bbdev *dev) {
  struct fpga_lte_fec_device *fpga_dev = dev->data->dev_private;
...
static void fpga_dev_info_get(struct rte_bbdev *dev,
  ...
  static const struct rte_bbdev_op_cap bbdev_capabilities[] = {
      ...
      {.type = RTE_BBDEV_OP_TURBO_ENC,
       .cap.turbo_enc = {.capability_flags = RTE_BBDEV_TURBO_CRC_24B_ATTACH |
  ...
  for (q_id = 0; q_id < FPGA_TOTAL_NUM_QUEUES; ++q_id) {
    uint32_t hw_q_id =
        fpga_reg_read_32(d->mmio_base, FPGA_LTE_FEC_QUEUE_MAP + (q_id << 2));
    if (hw_q_id != FPGA_INVALID_HW_QUEUE_ID)
 ...
 */
static int fpga_find_free_queue_idx(struct rte_bbdev *dev,
...
static int fpga_queue_setup(struct rte_bbdev *dev, uint16_t queue_id,
                            const struct rte_bbdev_queue_conf *conf) {
  ...
  q->ring_ctrl_reg.ring_base_addr =
      d->sw_rings_phys + (d->sw_ring_size * queue_id);

  /* Allocate memory for Completion Head variable*/
  q->ring_head_addr =
      rte_zmalloc_socket(dev->device->driver->name, sizeof(uint64_t),
                         RTE_CACHE_LINE_SIZE, conf->socket);
  if (q->ring_head_addr == NULL) {
    /* Mark queue as un-assigned */
    d->q_assigned_bit_map &= (0xFFFFFFFF - (1ULL << q_idx));
    rte_free(q);
    rte_bbdev_log(ERR, "Failed to allocate memory for %s:%u completion_head",
                  dev->device->driver->name, dev->data->dev_id);
    return -ENOMEM;
  }
  /* Set ring_head_addr */
  ...
  if (conf->queue_size > FPGA_RING_MAX_SIZE) {
    ...
    rte_free(q);
    rte_bbdev_log(ERR, "Size of queue is too big %d (MAX: %d ) for %s:%u",
  ...
  ring_offset =
      FPGA_LTE_FEC_RING_CTRL_REGS + (sizeof(struct fpga_ring_ctrl_reg) * q_idx);
  ...
  rte_bbdev_log_debug("Setup dev%u q%u: queue_idx=%u", dev->data->dev_id,
                      queue_id, q->q_idx);

  dev->data->queues[queue_id].queue_private = q;

  rte_bbdev_log_debug("BBDEV queue[%d] set up for FPGA queue[%d]", queue_id,
                      q_idx);
...
static int fpga_queue_release(struct rte_bbdev *dev, uint16_t queue_id) {
  struct fpga_lte_fec_device *d = dev->data->dev_private;
  ...
  if (q != NULL) {
    ...
    /* Disable queue */
    fpga_reg_write_8(d->mmio_base, offset + FPGA_LTE_FEC_RING_ENABLE, 0x00);
...
static int fpga_queue_start(struct rte_bbdev *dev, uint16_t queue_id) {
  struct fpga_lte_fec_device *d = dev->data->dev_private;
#ifdef RTE_LIBRTE_BBDEV_DEBUG
  if (d == NULL) {
  ...
  fpga_reg_write_16(d->mmio_base, offset + FPGA_LTE_FEC_RING_HEAD_POINT, zero);
  fpga_reg_write_16(d->mmio_base, offset + FPGA_LTE_FEC_RING_SHADOW_TAIL, zero);

  /* Enable queue */
  fpga_reg_write_8(d->mmio_base, offset + FPGA_LTE_FEC_RING_ENABLE, enable);
...
static int fpga_queue_stop(struct rte_bbdev *dev, uint16_t queue_id) {
  struct fpga_lte_fec_device *d = dev->data->dev_private;
#ifdef RTE_LIBRTE_BBDEV_DEBUG
  if (d == NULL) {
    rte_bbdev_log(ERR, "Invalid device pointer");
  ...
  fpga_reg_write_8(d->mmio_base, offset + FPGA_LTE_FEC_RING_FLUSH_QUEUE_EN,
                   payload);
  ...
  while (!(*((volatile uint8_t *)d->flush_queue_status + q->q_idx) & payload)) {
    if (counter > timeout) {
      rte_bbdev_log(ERR, "FPGA Queue Flush failed for queue %d", queue_id);
      return -1;
    }
  ...
  /* Disable queue */
  payload = 0x00;
  fpga_reg_write_8(d->mmio_base, offset + FPGA_LTE_FEC_RING_ENABLE, payload);

  rte_bbdev_log_debug("FPGA Queue[%d] stopped", queue_id);
  return 0;
}

static inline uint16_t get_queue_id(struct rte_bbdev_data *data,
                                    uint8_t q_idx) {
  uint16_t queue_id;
...
static void fpga_dev_interrupt_handler(void *cb_arg) {
  ...
  for (i = 0; i < FPGA_TOTAL_NUM_QUEUES; ++i) {
    ...
    if (fpga_dev->q_bound_bit_map & q_idx) {
      ...
      if (q->shadow_completion_head != ring_head && q->irq_enable == 1) {
        q->shadow_completion_head = ring_head;
        rte_bbdev_pmd_callback_process(dev, RTE_BBDEV_EVENT_DEQUEUE, &queue_id);
      }
    }
  }
}

static int fpga_queue_intr_enable(struct rte_bbdev *dev, uint16_t queue_id) {
  struct fpga_queue *q = dev->data->queues[queue_id].queue_private;
...
static int fpga_queue_intr_disable(struct rte_bbdev *dev, uint16_t queue_id) {
  struct fpga_queue *q = dev->data->queues[queue_id].queue_private;
  q->irq_enable = 0;
...
static int fpga_intr_enable(struct rte_bbdev *dev) {
  int ret;
  uint8_t i;
  ...
  ret = rte_intr_callback_register(dev->intr_handle, fpga_dev_interrupt_handler,
                                   dev);
  if (ret < 0) {
 ...
 */
static inline int check_desc_error(uint32_t error_code) {
  switch (error_code) {
  ...
  case DESC_ERR_K_NOT_NORMAL:
    rte_bbdev_log(ERR,
                  "Block_size_k is not a normal value within normal range");
    break;
  ...
  case (DESC_ERR_K_OUT_OF_RANGE | DESC_ERR_DESC_OFFSET_ERR):
    rte_bbdev_log(
        ERR,
        "Block_size_k is out of range (k<40 or k>6144) and queue offset error");
    break;
  case (DESC_ERR_K_NOT_NORMAL | DESC_ERR_DESC_OFFSET_ERR):
    rte_bbdev_log(ERR, "Block_size_k is not a normal value within normal range "
                       "and queue offset error");
    break;
  case (DESC_ERR_KPAI_NOT_NORMAL | DESC_ERR_DESC_OFFSET_ERR):
    rte_bbdev_log(
        ERR,
        "Three_kpai is not a normal value for UL only and queue offset error");
    break;
...
fpga_dma_desc_te_fill(struct rte_bbdev_enc_op *op,
                      ...
                      struct rte_mbuf *output, uint16_t k, uint16_t e,
                      uint16_t ncb, uint32_t in_offset, uint32_t out_offset,
...

{
  ...
  desc->bypass_rm =
      !check_bit(op->turbo_enc.op_flags, RTE_BBDEV_TURBO_RATE_MATCH);
  desc->k = k;
  desc->e = e;
  desc->ncb = ncb;
  ...
  desc->in_addr_hi =
      (uint32_t)(rte_pktmbuf_iova_offset(input, in_offset) >> 32);
  desc->in_addr_lw = (uint32_t)(rte_pktmbuf_iova_offset(input, in_offset));

  desc->out_addr_hi =
      (uint32_t)(rte_pktmbuf_iova_offset(output, out_offset) >> 32);
  desc->out_addr_lw = (uint32_t)(rte_pktmbuf_iova_offset(output, out_offset));
...
static int validate_enc_op(struct rte_bbdev_enc_op *op) {
  ...
  if (turbo_enc->input.length > RTE_BBDEV_TURBO_MAX_TB_SIZE >> 3) {
    rte_bbdev_log(ERR, "TB size (%u) is too big, max: %d",
                  turbo_enc->input.length, RTE_BBDEV_TURBO_MAX_TB_SIZE);
...
static inline int enqueue_enc_one_op_cb(struct fpga_queue *q,
  ...
  ret = fpga_dma_desc_te_fill(op, &desc->enc_req, input, output, k, e, ncb,
                              in_offset, out_offset, ring_offset, 1);
  if (unlikely(ret < 0))
    return ret;
...
static inline int enqueue_enc_one_op_tb(struct fpga_queue *q,
                                        struct rte_bbdev_enc_op *op,
                                        uint16_t desc_offset,
                                        uint8_t cbs_in_op) {
  union fpga_dma_desc *desc;
  ...
  while (mbuf_total_left > 0 && r < c && input != NULL) {
    ...
    e = (r < op->turbo_enc.tb_params.cab) ? op->turbo_enc.tb_params.ea
                                          : op->turbo_enc.tb_params.eb;
    k = (r < op->turbo_enc.tb_params.c_neg) ? op->turbo_enc.tb_params.k_neg
                                            : op->turbo_enc.tb_params.k_pos;
    ncb = (r < op->turbo_enc.tb_params.c_neg) ? op->turbo_enc.tb_params.ncb_neg
    ...
    desc = q->ring_addr + ring_offset;
    ret = fpga_dma_desc_te_fill(op, &desc->enc_req, input, output, k, e, ncb,
                                in_offset, out_offset, ring_offset, cbs_in_op);
    if (unlikely(ret < 0))
      return ret;
...
static int validate_dec_op(struct rte_bbdev_dec_op *op) {
  ...
  if (turbo_dec->code_block_mode == RTE_BBDEV_TRANSPORT_BLOCK) {
    ...
    if ((turbo_dec->op_flags & RTE_BBDEV_TURBO_DEC_TB_CRC_24B_KEEP) &&
      ...
      rte_bbdev_log(ERR, "RTE_BBDEV_TURBO_DEC_TB_CRC_24B_KEEP should accompany "
                         "RTE_BBDEV_TURBO_CRC_TYPE_24B");
      return -1;
    }
    ...
    if (turbo_dec->op_flags & RTE_BBDEV_TURBO_DEC_TB_CRC_24B_KEEP) {
      rte_bbdev_log(
          ERR, "RTE_BBDEV_TURBO_DEC_TB_CRC_24B_KEEP is invalid in CB-mode");
      return -1;
    }
...
static inline int enqueue_dec_one_op_cb(struct fpga_queue *q,
  ...
  ring_offset = ((q->tail + desc_offset) & q->sw_ring_wrap_mask);
  desc = q->ring_addr + ring_offset;
  ret = fpga_dma_desc_td_fill(op, &desc->dec_req, input, output, in_length, k,
                              in_offset, out_offset, ring_offset, 1);
  if (unlikely(ret < 0))
    return ret;
...
static inline int enqueue_dec_one_op_tb(struct fpga_queue *q,
                                        struct rte_bbdev_dec_op *op,
                                        uint16_t desc_offset,
                                        uint8_t cbs_in_op) {
  union fpga_dma_desc *desc;
  ...
  if (!check_bit(op->turbo_dec.op_flags, RTE_BBDEV_TURBO_DEC_TB_CRC_24B_KEEP))
    crc24_overlap = 24;
  ...
  while (mbuf_total_left > 0 && r < c && input != NULL) {
    ...
    if (seg_total_left < in_length) {
      rte_bbdev_log(ERR, "Partial CB found in a TB. FPGA Driver doesn't "
    ...
    /* Update lengths */
    ret =
        rte_pktmbuf_trim(op->turbo_dec.hard_output.data, (crc24_overlap >> 3));
#ifdef RTE_LIBRTE_BBDEV_DEBUG
    if (ret < 0) {
      rte_bbdev_log(ERR, "The length to remove is greater than the length of "
                         "the last segment");
      return -EINVAL;
    }
#endif
...
static uint16_t fpga_enqueue_enc(struct rte_bbdev_queue_data *q_data,
  ...
  for (i = 0; i < num; ++i) {
    if (ops[i]->turbo_enc.code_block_mode == RTE_BBDEV_TRANSPORT_BLOCK) {
      ...
      avail -= cbs_in_op;
      enqueued_cbs =
          enqueue_enc_one_op_tb(q, ops[i], total_enqueued_cbs, cbs_in_op);
    } else {
      /* Check if there is available space for further
       * processing
       */
      if (unlikely(avail - 1 < 0))
        break;
      avail -= 1;
      enqueued_cbs = enqueue_enc_one_op_cb(q, ops[i], total_enqueued_cbs);
    }
    ...
    rte_bbdev_log_debug("enqueuing enc ops [%d/%d] | head %d | tail %d",
                        total_enqueued_cbs, num, q->head_free_desc, q->tail);
  }
...
static uint16_t fpga_enqueue_dec(struct rte_bbdev_queue_data *q_data,
  ...
  for (i = 0; i < num; ++i) {
    if (ops[i]->turbo_dec.code_block_mode == RTE_BBDEV_TRANSPORT_BLOCK) {
      ...
      avail -= cbs_in_op;
      enqueued_cbs =
          enqueue_dec_one_op_tb(q, ops[i], total_enqueued_cbs, cbs_in_op);
    } else {
      /* Check if there is available space for further
       * processing
       */
      if (unlikely(avail - 1 < 0))
        break;
      avail -= 1;
      enqueued_cbs = enqueue_dec_one_op_cb(q, ops[i], total_enqueued_cbs);
    }
...
static inline int dequeue_enc_one_op_cb(struct fpga_queue *q,
                                        struct rte_bbdev_enc_op **op,
                                        uint16_t desc_offset) {
  union fpga_dma_desc *desc;
  int desc_error = 0;
  ...
  /* Set current desc */
  desc =
      q->ring_addr + ((q->head_free_desc + desc_offset) & q->sw_ring_wrap_mask);
...
static inline int dequeue_enc_one_op_tb(struct fpga_queue *q,
                                        struct rte_bbdev_enc_op **op,
                                        uint16_t desc_offset) {
  union fpga_dma_desc *desc;
  ...
  for (cb_idx = 1; cb_idx < cbs_in_op; ++cb_idx) {
    desc = q->ring_addr +
           ((q->head_free_desc + desc_offset + cb_idx) & q->sw_ring_wrap_mask);
    if (desc->enc_req.done == 0)
      return -1;
  }
...
static inline int dequeue_dec_one_op_cb(struct fpga_queue *q,
                                        struct rte_bbdev_dec_op **op,
                                        uint16_t desc_offset) {
  union fpga_dma_desc *desc;
  int desc_error = 0;
...
static inline int dequeue_dec_one_op_tb(struct fpga_queue *q,
                                        struct rte_bbdev_dec_op **op,
                                        uint16_t desc_offset) {
  union fpga_dma_desc *desc;
...
static uint16_t fpga_dequeue_enc(struct rte_bbdev_queue_data *q_data,
                                 struct rte_bbdev_enc_op **ops, uint16_t num) {
  struct fpga_queue *q = q_data->queue_private;
  ...
  for (i = 0; (i < num) && (dequeued_cbs < avail); ++i) {
    op = (q->ring_addr +
          ((q->head_free_desc + dequeued_cbs) & q->sw_ring_wrap_mask))
             ->enc_req.op_addr;
...
static uint16_t fpga_dequeue_dec(struct rte_bbdev_queue_data *q_data,
                                 struct rte_bbdev_dec_op **ops, uint16_t num) {
  struct fpga_queue *q = q_data->queue_private;
  uint32_t avail = (q->tail - q->head_free_desc) & q->sw_ring_wrap_mask;
  uint16_t i;
...
static void fpga_lte_fec_init(struct rte_bbdev *dev,
  ...
  ((struct fpga_lte_fec_device *)dev->data->dev_private)->pf_device =
      !strcmp(drv->driver.name, RTE_STR(FPGA_LTE_FEC_PF_DRIVER_NAME));
...
static int fpga_lte_fec_probe(struct rte_pci_driver *pci_drv,
  ...
  bbdev->data->dev_private =
      rte_zmalloc_socket(dev_name, sizeof(struct fpga_lte_fec_device),
  ...
  rte_bbdev_log_debug("bbdev id = %u [%s]", bbdev->data->dev_id, dev_name);

  struct fpga_lte_fec_device *d = bbdev->data->dev_private;
  uint32_t version_id = fpga_reg_read_32(d->mmio_base, FPGA_LTE_FEC_VERSION_ID);
  rte_bbdev_log(INFO, "FEC FPGA RTL v%u.%u", ((uint16_t)(version_id >> 16)),
                ((uint16_t)version_id));

#ifdef RTE_LIBRTE_BBDEV_DEBUG
  if (!strcmp(pci_drv->driver.name, RTE_STR(FPGA_LTE_FEC_PF_DRIVER_NAME)))
    print_static_reg_debug_info(d->mmio_base);
#endif
  return 0;
}

static int fpga_lte_fec_remove(struct rte_pci_device *pci_dev) {
...
int rte_fpga_lte_fec_configure(const char *dev_name,
  ...
  if (conf == NULL) {
    rte_bbdev_log(ERR, "FPGA Configuration was not provided. Default "
  ...
  if (conf->pf_mode_en) {
    ...
    if ((total_ul_q_id > FPGA_NUM_UL_QUEUES) ||
      ...
      rte_bbdev_log(ERR,
                    "FPGA Configuration failed. Too many queues to configure: "
                    "UL_Q %u, DL_Q %u, FPGA_Q %u",
                    total_ul_q_id, total_dl_q_id, FPGA_TOTAL_NUM_QUEUES);
      return -EINVAL;
    }
    total_ul_q_id = 0;
    for (vf_id = 0; vf_id < FPGA_LTE_FEC_NUM_VFS; ++vf_id) {
      for (q_id = 0; q_id < conf->vf_ul_queues_number[vf_id];
           ++q_id, ++total_ul_q_id) {
        address = (total_ul_q_id << 2) + FPGA_LTE_FEC_QUEUE_MAP;
    ...
    for (vf_id = 0; vf_id < FPGA_LTE_FEC_NUM_VFS; ++vf_id) {
      for (q_id = 0; q_id < conf->vf_dl_queues_number[vf_id];
           ++q_id, ++total_dl_q_id) {
        address = ((total_dl_q_id + FPGA_NUM_UL_QUEUES) << 2) +
...
static struct rte_pci_id pci_id_fpga_lte_fec_pf_map[] = {
    {RTE_PCI_DEVICE(FPGA_LTE_FEC_VENDOR_ID, FPGA_LTE_FEC_PF_DEVICE_ID)},
    {.device_id = 0},
};
...
static struct rte_pci_id pci_id_fpga_lte_fec_vf_map[] = {
    {RTE_PCI_DEVICE(FPGA_LTE_FEC_VENDOR_ID, FPGA_LTE_FEC_VF_DEVICE_ID)},
    {.device_id = 0},
};
