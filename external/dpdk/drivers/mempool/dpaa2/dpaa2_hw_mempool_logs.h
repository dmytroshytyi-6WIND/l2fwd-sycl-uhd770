...
#define DPAA2_MEMPOOL_LOG(level, fmt, args...)                                 \
  rte_log(RTE_LOG_##level, dpaa2_logtype_mempool, "mempool/dpaa2: " fmt "\n",  \
          ##args)
...
#define DPAA2_MEMPOOL_INFO(fmt, args...) DPAA2_MEMPOOL_LOG(INFO, fmt, ##args)
#define DPAA2_MEMPOOL_ERR(fmt, args...) DPAA2_MEMPOOL_LOG(ERR, fmt, ##args)
#define DPAA2_MEMPOOL_WARN(fmt, args...) DPAA2_MEMPOOL_LOG(WARNING, fmt, ##args)
