...
#define RTE_DPAA_MAX_RX_QUEUE                                                  \
  (MAX_DPAA_CORES * RTE_DPAA_SEC_PMD_MAX_NB_SESSIONS)
         ...
         .sym = {.xform_type = RTE_CRYPTO_SYM_XFORM_AUTH,
                 {
                     .auth = {.algo = RTE_CRYPTO_AUTH_AES_CMAC,
                              .block_size = 16,
                              .key_size = {.min = 1, .max = 16, .increment = 1},
                              .digest_size =
...
static const struct rte_security_capability dpaa_sec_security_cap[] = {
    ...
    {/* PDCP Lookaside Protocol offload Data */
     ...
     .pdcp = {.domain = RTE_SECURITY_PDCP_MODE_DATA, .capa_flags = 0},
     .crypto_capabilities = dpaa_pdcp_capabilities},
    {/* PDCP Lookaside Protocol offload Control */
     .action = RTE_SECURITY_ACTION_TYPE_LOOKASIDE_PROTOCOL,
     .protocol = RTE_SECURITY_PROTOCOL_PDCP,
     .pdcp = {.domain = RTE_SECURITY_PDCP_MODE_CONTROL, .capa_flags = 0},
     .crypto_capabilities = dpaa_pdcp_capabilities},
    {/* PDCP Lookaside Protocol offload Short MAC */
     .action = RTE_SECURITY_ACTION_TYPE_LOOKASIDE_PROTOCOL,
     .protocol = RTE_SECURITY_PROTOCOL_PDCP,
     .pdcp = {.domain = RTE_SECURITY_PDCP_MODE_SHORT_MAC, .capa_flags = 0},
     .crypto_capabilities = dpaa_pdcp_capabilities},
...
int dpaa_sec_get_dp_ctx_size(struct rte_cryptodev *dev);
