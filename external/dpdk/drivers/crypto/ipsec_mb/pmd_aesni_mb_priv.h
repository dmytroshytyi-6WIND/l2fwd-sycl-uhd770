             ...
             {.xform_type = RTE_CRYPTO_SYM_XFORM_AUTH,
              {
                  .auth = {.algo = RTE_CRYPTO_AUTH_SHA1_HMAC,
                           .block_size = 64,
                           .key_size = {.min = 1, .max = 65535, .increment = 1},
                  ...
                  .aead =
                      {
                          ...
                          .aad_size = {.min = 0, .max = 46, .increment = 1},
    ...
    {/* AES CMAC */
     .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,
     {
         .sym =
             {.xform_type = RTE_CRYPTO_SYM_XFORM_AUTH,
              {
                  .auth = {.algo = RTE_CRYPTO_AUTH_AES_CMAC,
                           .block_size = 16,
                           .key_size = {.min = 16, .max = 16, .increment = 0},
                           .digest_size = {.min = 1, .max = 16, .increment = 1},
                           .iv_size = {0}},
    ...
    {/* AES ECB */
     .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,
     {
         .sym =
             {.xform_type = RTE_CRYPTO_SYM_XFORM_CIPHER,
              {
                  .cipher = {.algo = RTE_CRYPTO_CIPHER_AES_ECB,
                             .block_size = 16,
                             .key_size = {.min = 16, .max = 32, .increment = 8},
                             .iv_size = {0}},
              }},
             ...
             {.xform_type = RTE_CRYPTO_SYM_XFORM_AUTH,
              {
                  .auth = {.algo = RTE_CRYPTO_AUTH_ZUC_EIA3,
                           ...
                           .iv_size = {.min = 16, .max = 25, .increment = 9}},
              }},
     }},
    {/* ZUC (EEA3) */
     .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,
    ...
    {/* KASUMI (F9) */
     .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,
     {
         .sym =
             {.xform_type = RTE_CRYPTO_SYM_XFORM_AUTH,
              {
                  .auth = {.algo = RTE_CRYPTO_AUTH_KASUMI_F9,
                           .block_size = 8,
                           .key_size = {.min = 16, .max = 16, .increment = 0},
                           .digest_size = {.min = 4, .max = 4, .increment = 0},
                           .iv_size = {0}},
...
static const unsigned int auth_blocksize[] = {[IMB_AUTH_NULL] = 0,
                                              [IMB_AUTH_MD5] = 64,
 ...
 */
static inline unsigned int get_auth_algo_blocksize(IMB_HASH_ALG algo) {
 ...
 * authentication algorithm
 */
static inline unsigned int get_truncated_digest_byte_length(IMB_HASH_ALG algo) {
 ...
 * authentication algorithm
 */
static inline unsigned int get_digest_byte_length(IMB_HASH_ALG algo) {
