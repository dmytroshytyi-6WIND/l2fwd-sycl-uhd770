...
struct virtio_pci_ops {
  void (*read_dev_cfg)(struct virtio_crypto_hw *hw, size_t offset, void *dst,
                       int len);
...
extern struct virtio_hw_internal
    crypto_virtio_hw_internal[RTE_MAX_VIRTIO_CRYPTO];
...
static inline int vtpci_with_feature(struct virtio_crypto_hw *hw,
                                     uint64_t bit) {
