...
#define PMD_INIT_LOG(level, fmt, args...)                                      \
  rte_log(RTE_LOG_##level, virtio_crypto_logtype_init, "PMD: %s(): " fmt "\n", \
          __func__, ##args)
...
#define VIRTIO_CRYPTO_RX_LOG_IMPL(level, fmt, args...)                         \
  rte_log(RTE_LOG_##level, virtio_crypto_logtype_rx, "RX: %s(): " fmt "\n",    \
          __func__, ##args)
...
#define VIRTIO_CRYPTO_TX_LOG_IMPL(level, fmt, args...)                         \
  rte_log(RTE_LOG_##level, virtio_crypto_logtype_tx, "TX: %s(): " fmt "\n",    \
          __func__, ##args)
