...
static const struct rte_cryptodev_capabilities openssl_pmd_capabilities[] = {
     ...
     .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,
     {
         .sym =
             {.xform_type = RTE_CRYPTO_SYM_XFORM_AUTH,
              {
                  .auth = {.algo = RTE_CRYPTO_AUTH_MD5_HMAC,
                           .block_size = 64,
                           .key_size = {.min = 1, .max = 64, .increment = 1},
                           .digest_size = {.min = 1, .max = 16, .increment = 1},
                           .iv_size = {0}},
              }},
     }},
    {/* MD5 */
     .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,
     {
         .sym = {.xform_type = RTE_CRYPTO_SYM_XFORM_AUTH,
                 {
                     .auth = {.algo = RTE_CRYPTO_AUTH_MD5,
                              .block_size = 64,
                              .key_size = {.min = 0, .max = 0, .increment = 0},
                              .digest_size =
                                  {.min = 16, .max = 16, .increment = 0},
                              .iv_size = {0}},
                 }},
     }},
    {/* SHA1 HMAC */
    ...
    {/* SHA224 HMAC */
     .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,
     {
         .sym =
             {.xform_type = RTE_CRYPTO_SYM_XFORM_AUTH,
              {
                  .auth = {.algo = RTE_CRYPTO_AUTH_SHA224_HMAC,
                           .block_size = 64,
                           .key_size = {.min = 1, .max = 64, .increment = 1},
             ...
             {.xform_type = RTE_CRYPTO_SYM_XFORM_AUTH,
              {
                  .auth = {.algo = RTE_CRYPTO_AUTH_SHA384_HMAC,
                           .block_size = 128,
                           .key_size = {.min = 1, .max = 128, .increment = 1},
             ...
             {.xform_type = RTE_CRYPTO_SYM_XFORM_CIPHER,
              {
                  .cipher = {.algo = RTE_CRYPTO_CIPHER_AES_CBC,
                             .block_size = 16,
                             .key_size = {.min = 16, .max = 32, .increment = 8},
    ...
    {/* AES CTR */
     .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,
     {
         .sym =
             {.xform_type = RTE_CRYPTO_SYM_XFORM_CIPHER,
              {
                  .cipher = {.algo = RTE_CRYPTO_CIPHER_AES_CTR,
                             .block_size = 16,
                             .key_size = {.min = 16, .max = 32, .increment = 8},
                             .iv_size = {.min = 16, .max = 16, .increment = 0}},
              }},
                  ...
                  .aead =
                      {
                          ...
                          .block_size = 16,
                          .key_size = {.min = 16, .max = 32, .increment = 8},
                          .digest_size = {.min = 16, .max = 16, .increment = 0},
                          .aad_size = {.min = 0, .max = 65535, .increment = 1},
                          .iv_size = {.min = 12, .max = 16, .increment = 4},
                      },
              }},
     }},
    {/* AES CCM */
                  ...
                  .aead =
                      {
                          ...
                          .block_size = 16,
                          .key_size = {.min = 16, .max = 32, .increment = 8},
                          .digest_size = {.min = 4, .max = 16, .increment = 2},
                          .aad_size = {.min = 0, .max = 65535, .increment = 1},
                          .iv_size = {.min = 7, .max = 13, .increment = 1},
                      },
              }},
     }},
    {/* AES GMAC (AUTH) */
    ...
    {/* 3DES CBC */
     .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,
     {
         .sym =
             {.xform_type = RTE_CRYPTO_SYM_XFORM_CIPHER,
              {
                  .cipher = {.algo = RTE_CRYPTO_CIPHER_3DES_CBC,
                             .block_size = 8,
                             .key_size = {.min = 8, .max = 24, .increment = 8},
                             .iv_size = {.min = 8, .max = 8, .increment = 0}},
              }},
     }},
    {/* 3DES CTR */
     .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,
     {
         .sym =
             {.xform_type = RTE_CRYPTO_SYM_XFORM_CIPHER,
              {
                  .cipher = {.algo = RTE_CRYPTO_CIPHER_3DES_CTR,
                             .block_size = 8,
                             .key_size = {.min = 16, .max = 24, .increment = 8},
                             .iv_size = {.min = 8, .max = 8, .increment = 0}},
              }},
     }},
    {/* DES CBC */
     .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,
     {
         .sym =
             {.xform_type = RTE_CRYPTO_SYM_XFORM_CIPHER,
              {
                  .cipher = {.algo = RTE_CRYPTO_CIPHER_DES_CBC,
                             .block_size = 8,
                             .key_size = {.min = 8, .max = 8, .increment = 0},
                             .iv_size = {.min = 8, .max = 8, .increment = 0}},
              }},
     }},
    {/* DES DOCSIS BPI */
     .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,
     {
         .sym =
             {.xform_type = RTE_CRYPTO_SYM_XFORM_CIPHER,
              {
                  .cipher = {.algo = RTE_CRYPTO_CIPHER_DES_DOCSISBPI,
                             .block_size = 8,
                             .key_size = {.min = 8, .max = 8, .increment = 0},
                             .iv_size = {.min = 8, .max = 8, .increment = 0}},
              }},
    ...
    {/* RSA */
     ...
     {
         .asym = {.xform_capa = {.xform_type = RTE_CRYPTO_ASYM_XFORM_RSA,
                                 .op_types =
                                 ...
                                 {
                                     .modlen =
                                         {/* min length is based on openssl rsa
                                             keygen */
                                          .min = 30,
    ...
    {/* modexp */
     .op = RTE_CRYPTO_OP_TYPE_ASYMMETRIC,
     {
         .asym = {.xform_capa = {.xform_type = RTE_CRYPTO_ASYM_XFORM_MODEX,
                                 .op_types = 0,
                                 {
                                     .modlen =
                                         {/* value 0 symbolizes no limit on min
                                             length */
                                          .min = 0,
                                          /* value 0 symbolizes no limit on max
                                             length */
    ...
    {/* modinv */
     .op = RTE_CRYPTO_OP_TYPE_ASYMMETRIC,
     {
         .asym = {.xform_capa = {.xform_type = RTE_CRYPTO_ASYM_XFORM_MODINV,
                                 .op_types = 0,
                                 {
                                     .modlen =
                                         {/* value 0 symbolizes no limit on min
    ...
    {/* dh */
     .op = RTE_CRYPTO_OP_TYPE_ASYMMETRIC,
     {
         .asym = {.xform_capa = {.xform_type = RTE_CRYPTO_ASYM_XFORM_DH,
                                 .op_types =
                                     ((1
    ...
    {/* dsa */
     .op = RTE_CRYPTO_OP_TYPE_ASYMMETRIC,
     {
         .asym = {.xform_capa = {.xform_type = RTE_CRYPTO_ASYM_XFORM_DSA,
...
/** Start device */
static int openssl_pmd_start(__rte_unused struct rte_cryptodev *dev) {
  return 0;
}

/** Stop device */
static void openssl_pmd_stop(__rte_unused struct rte_cryptodev *dev) {}

/** Close device */
static int openssl_pmd_close(__rte_unused struct rte_cryptodev *dev) {
  return 0;
}

/** Get device statistics */
static void openssl_pmd_stats_get(struct rte_cryptodev *dev,
...
static void openssl_pmd_stats_reset(struct rte_cryptodev *dev) {
  int qp_id;
...
/** Get device info */
static void openssl_pmd_info_get(struct rte_cryptodev *dev,
...
/** Release queue pair */
static int openssl_pmd_qp_release(struct rte_cryptodev *dev, uint16_t qp_id) {
...
static int openssl_pmd_qp_set_unique_name(struct rte_cryptodev *dev,
                                          struct openssl_qp *qp) {
  unsigned int n = snprintf(qp->name, sizeof(qp->name), "openssl_pmd_%u_qp_%u",
...
static struct rte_ring *openssl_pmd_qp_create_processed_ops_ring(
    struct openssl_qp *qp, unsigned int ring_size, int socket_id) {
  struct rte_ring *r;

  r = rte_ring_lookup(qp->name);
  if (r) {
    if (rte_ring_get_size(r) >= ring_size) {
      OPENSSL_LOG(INFO, "Reusing existing ring %s for processed ops", qp->name);
      return r;
    }

    OPENSSL_LOG(ERR, "Unable to reuse existing ring %s for processed ops",
                qp->name);
    return NULL;
  }
...
/** Setup a queue pair */
static int openssl_pmd_qp_setup(struct rte_cryptodev *dev, uint16_t qp_id,
  ...
  qp->processed_ops = openssl_pmd_qp_create_processed_ops_ring(
      qp, qp_conf->nb_descriptors, socket_id);
...
static int openssl_pmd_sym_session_configure(
    struct rte_cryptodev *dev __rte_unused, struct rte_crypto_sym_xform *xform,
  ...
  if (rte_mempool_get(mempool, &sess_private_data)) {
    OPENSSL_LOG(ERR, "Couldn't get object from session mempool");
    return -ENOMEM;
  }
...
static int
openssl_set_asym_session_parameters(struct openssl_asym_session *asym_session,
  ...
  case RTE_CRYPTO_ASYM_XFORM_RSA: {
    ...
    n = BN_bin2bn((const unsigned char *)xform->rsa.n.data, xform->rsa.n.length,
                  n);
    e = BN_bin2bn((const unsigned char *)xform->rsa.e.data, xform->rsa.e.length,
                  e);
    ...
    if (xform->rsa.key_type == RTE_RSA_KEY_TYPE_EXP) {
      d = BN_bin2bn((const unsigned char *)xform->rsa.d.data,
                    xform->rsa.d.length, d);
      if (!d) {
        RSA_free(rsa);
        goto err_rsa;
      }
    } else {
      p = BN_bin2bn((const unsigned char *)xform->rsa.qt.p.data,
                    xform->rsa.qt.p.length, p);
      q = BN_bin2bn((const unsigned char *)xform->rsa.qt.q.data,
                    xform->rsa.qt.q.length, q);
      dmp1 = BN_bin2bn((const unsigned char *)xform->rsa.qt.dP.data,
                       xform->rsa.qt.dP.length, dmp1);
      dmq1 = BN_bin2bn((const unsigned char *)xform->rsa.qt.dQ.data,
                       xform->rsa.qt.dQ.length, dmq1);
      iqmp = BN_bin2bn((const unsigned char *)xform->rsa.qt.qInv.data,
                       xform->rsa.qt.qInv.length, iqmp);
      ...
      if (ret) {
        OPENSSL_LOG(ERR, "failed to set rsa params\n");
        RSA_free(rsa);
        goto err_rsa;
      }
      ret = set_rsa_crt_params(rsa, dmp1, dmq1, iqmp);
      if (ret) {
        OPENSSL_LOG(ERR, "failed to set crt params\n");
        RSA_free(rsa);
        /*
  ...
  case RTE_CRYPTO_ASYM_XFORM_DH: {
    ...
    p = BN_bin2bn((const unsigned char *)xform->dh.p.data, xform->dh.p.length,
                  p);
    g = BN_bin2bn((const unsigned char *)xform->dh.g.data, xform->dh.g.length,
                  g);
    if (!p || !g)
      goto err_dh;
    ...
    if (xform->dh.type == RTE_CRYPTO_ASYM_OP_PRIVATE_KEY_GENERATE) {
      ...
      if ((xform->next != NULL) &&
          (xform->next->xform_type == RTE_CRYPTO_ASYM_XFORM_DH) &&
          (xform->next->dh.type == RTE_CRYPTO_ASYM_OP_PUBLIC_KEY_GENERATE)) {
        /*
  ...
  case RTE_CRYPTO_ASYM_XFORM_DSA: {
    ...
    p = BN_bin2bn((const unsigned char *)xform->dsa.p.data, xform->dsa.p.length,
                  p);

    g = BN_bin2bn((const unsigned char *)xform->dsa.g.data, xform->dsa.g.length,
                  g);

    q = BN_bin2bn((const unsigned char *)xform->dsa.q.data, xform->dsa.q.length,
                  q);
    if (!p || !q || !g)
      goto err_dsa;

    priv_key = BN_bin2bn((const unsigned char *)xform->dsa.x.data,
                         xform->dsa.x.length, priv_key);
    if (priv_key == NULL)
      goto err_dsa;
...
openssl_pmd_asym_session_configure(struct rte_cryptodev *dev __rte_unused,
  ...
  ret = openssl_set_asym_session_parameters(asym_sess_private_data, xform);
  if (ret != 0) {
    OPENSSL_LOG(ERR, "failed configure session parameters");
    return ret;
  }
