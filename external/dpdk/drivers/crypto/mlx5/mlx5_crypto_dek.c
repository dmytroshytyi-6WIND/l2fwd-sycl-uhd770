...
int mlx5_crypto_dek_destroy(struct mlx5_crypto_priv *priv,
...
mlx5_crypto_dek_prepare(struct mlx5_crypto_priv *priv,
  ...
  uint64_t key64 =
      __rte_raw_cksum(cipher_ctx->key.data, cipher_ctx->key.length, 0);
  struct mlx5_list_entry *entry =
      mlx5_hlist_register(dek_hlist, key64, &dek_ctx);
...
mlx5_crypto_dek_clone_cb(void *tool_ctx __rte_unused,
  ...
  struct mlx5_crypto_dek *entry =
      rte_zmalloc(__func__, sizeof(*entry), RTE_CACHE_LINE_SIZE);
...
static void mlx5_crypto_dek_clone_free_cb(void *tool_ctx __rte_unused,
                                          struct mlx5_list_entry *entry) {
  struct mlx5_crypto_dek *dek =
      container_of(entry, struct mlx5_crypto_dek, entry);
...
static int mlx5_crypto_dek_match_cb(void *tool_ctx __rte_unused,
                                    struct mlx5_list_entry *entry,
                                    void *cb_ctx) {
  struct mlx5_crypto_dek_ctx *ctx = cb_ctx;
  struct rte_crypto_cipher_xform *cipher_ctx = ctx->cipher;
  struct mlx5_crypto_dek *dek = container_of(entry, typeof(*dek), entry);
...
mlx5_crypto_dek_create_cb(void *tool_ctx __rte_unused, void *cb_ctx) {
  ...
  struct rte_crypto_cipher_xform *cipher_ctx = ctx->cipher;
  struct mlx5_crypto_dek *dek =
      rte_zmalloc(__func__, sizeof(*dek), RTE_CACHE_LINE_SIZE);
  ...
  dek->obj = mlx5_devx_cmd_create_dek_obj(ctx->priv->cdev->ctx, &dek_attr);
  if (dek->obj == NULL) {
    rte_free(dek);
    return NULL;
  }
...
static void mlx5_crypto_dek_remove_cb(void *tool_ctx __rte_unused,
                                      struct mlx5_list_entry *entry) {
  struct mlx5_crypto_dek *dek = container_of(entry, typeof(*dek), entry);
...
int mlx5_crypto_dek_setup(struct mlx5_crypto_priv *priv) {
  priv->dek_hlist =
      mlx5_hlist_create("dek_hlist", MLX5_CRYPTO_DEK_HTABLE_SZ, 0, 1, NULL,
                        mlx5_crypto_dek_create_cb, mlx5_crypto_dek_match_cb,
                        mlx5_crypto_dek_remove_cb, mlx5_crypto_dek_clone_cb,
...
void mlx5_crypto_dek_unset(struct mlx5_crypto_priv *priv) {
  if (priv->dek_hlist) {
