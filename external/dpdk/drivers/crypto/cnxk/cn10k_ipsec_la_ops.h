...
static inline void ipsec_po_sa_iv_set(struct cn10k_ipsec_sa *sess,
...
static inline void ipsec_po_sa_aes_gcm_iv_set(struct cn10k_ipsec_sa *sess,
                                              struct rte_crypto_op *cop) {
...
static __rte_always_inline int process_outb_sa(struct roc_cpt_lf *lf,
                                               struct rte_crypto_op *cop,
                                               struct cn10k_ipsec_sa *sess,
