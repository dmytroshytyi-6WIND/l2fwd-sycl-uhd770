...
#define CPT_CAPS_ADD(cnxk_caps, cur_pos, hw_caps, name)                        \
  do {                                                                         \
    if ((hw_caps[CPT_ENG_TYPE_SE].name) || (hw_caps[CPT_ENG_TYPE_IE].name) ||  \
        (hw_caps[CPT_ENG_TYPE_AE].name))                                       \
      cpt_caps_add(cnxk_caps, cur_pos, caps_##name, RTE_DIM(caps_##name));     \
  } while (0)
...
static const struct rte_cryptodev_capabilities caps_mul[] = {
     ...
     .op = RTE_CRYPTO_OP_TYPE_ASYMMETRIC,
     {
         .asym = {.xform_capa =
                      {.xform_type = RTE_CRYPTO_ASYM_XFORM_RSA,
                       ...
                       {
                           .modlen = {.min = 17, .max = 1024, .increment = 1},
                       }}},
     }},
    {/* MOD_EXP */
     .op = RTE_CRYPTO_OP_TYPE_ASYMMETRIC,
    ...
    {/* ECPM */
     .op = RTE_CRYPTO_OP_TYPE_ASYMMETRIC,
     {
         .asym = {.xform_capa = {.xform_type = RTE_CRYPTO_ASYM_XFORM_ECPM,
                                 .op_types = 0}},
     }},
};
                  ...
                  .auth =
                      {
                          ...
                          .block_size = 64,
                          .key_size = {.min = 1, .max = 1024, .increment = 1},
                          .digest_size = {.min = 12, .max = 20, .increment = 8},
                      },
              }},
     }},
    {/* SHA224 */
                  ...
                  .auth =
                      {
                          ...
                          .block_size = 64,
                          .key_size = {.min = 8, .max = 64, .increment = 8},
                          .digest_size = {.min = 12, .max = 16, .increment = 4},
                      },
              }},
     }},
};
                  ...
                  .aead =
                      {
                          ...
                          .digest_size = {.min = 16, .max = 16, .increment = 0},
                          .aad_size = {.min = 0, .max = 1024, .increment = 1},
     ...
     .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,
     {
         .sym =
             {.xform_type = RTE_CRYPTO_SYM_XFORM_CIPHER,
              {
                  .cipher = {.algo = RTE_CRYPTO_CIPHER_SNOW3G_UEA2,
                             .block_size = 16,
    ...
    {/* ZUC (EEA3) */
     .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,
     {
         .sym =
             {.xform_type = RTE_CRYPTO_SYM_XFORM_CIPHER,
              {
                  .cipher = {.algo = RTE_CRYPTO_CIPHER_ZUC_EEA3,
                             .block_size = 16,
                             .key_size = {.min = 16, .max = 16, .increment = 0},
                             .iv_size = {.min = 16, .max = 16, .increment = 0}},
              }},
    ...
    {/* SNOW 3G (UIA2) */
     .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,
     {
         .sym =
             {.xform_type = RTE_CRYPTO_SYM_XFORM_AUTH,
              {
                  .auth = {.algo = RTE_CRYPTO_AUTH_SNOW3G_UIA2,
                           .block_size = 16,
                           .key_size = {.min = 16, .max = 16, .increment = 0},
                           .digest_size = {.min = 4, .max = 4, .increment = 0},
                           .iv_size = {.min = 16, .max = 16, .increment = 0}},
              }},
     }},
    {/* ZUC (EIA3) */
     .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,
     {
         .sym =
             {.xform_type = RTE_CRYPTO_SYM_XFORM_AUTH,
              {
                  .auth = {.algo = RTE_CRYPTO_AUTH_ZUC_EIA3,
                           .block_size = 16,
                           .key_size = {.min = 16, .max = 16, .increment = 0},
                           .digest_size = {.min = 4, .max = 4, .increment = 0},
                           .iv_size = {.min = 16, .max = 16, .increment = 0}},
    ...
    {/* AES GMAC (AUTH) */
     .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,
     {
         .sym =
             {.xform_type = RTE_CRYPTO_SYM_XFORM_AUTH,
              {
                  .auth = {.algo = RTE_CRYPTO_AUTH_AES_GMAC,
                           .block_size = 16,
    ...
    {/* AES GCM */
     .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,
     {
         .sym =
             {.xform_type = RTE_CRYPTO_SYM_XFORM_AEAD,
              {
                  .aead = {.algo = RTE_CRYPTO_AEAD_AES_GCM,
                           .block_size = 16,
                           .key_size = {.min = 16, .max = 32, .increment = 8},
                           .digest_size = {.min = 4, .max = 16, .increment = 1},
                           .aad_size = {.min = 0, .max = 1024, .increment = 1},
                           .iv_size = {.min = 12, .max = 12, .increment = 0}},
              }},
     }},
             ...
             {.xform_type = RTE_CRYPTO_SYM_XFORM_CIPHER,
              {
                  .cipher = {.algo = RTE_CRYPTO_CIPHER_3DES_CBC,
                             .block_size = 8,
                             .key_size = {.min = 24, .max = 24, .increment = 0},
                             .iv_size = {.min = 8, .max = 16, .increment = 8}},
              }},
     }},
    {/* 3DES ECB */
     .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,
     {
         .sym =
             {.xform_type = RTE_CRYPTO_SYM_XFORM_CIPHER,
              {
                  .cipher = {.algo = RTE_CRYPTO_CIPHER_3DES_ECB,
                             .block_size = 8,
                             .key_size = {.min = 24, .max = 24, .increment = 0},
         ...
         .sym = {.xform_type = RTE_CRYPTO_SYM_XFORM_AEAD,
                 {
                     .aead =
                         {.algo = RTE_CRYPTO_AEAD_AES_GCM,
                          ...
                          .key_size = {.min = 16, .max = 32, .increment = 8},
                          .digest_size = {.min = 16, .max = 16, .increment = 0},
                          .aad_size = {.min = 8, .max = 12, .increment = 4},
                          .iv_size = {.min = 12, .max = 12, .increment = 0}},
                 }},
     }},
    {/* AES CTR */
                  ...
                  .auth =
                      {
                          .algo = RTE_CRYPTO_AUTH_SHA1_HMAC,
                          .block_size = 64,
                          .key_size = {.min = 20, .max = 64, .increment = 1},
                          .digest_size = {.min = 12, .max = 12, .increment = 0},
                      },
              }},
     }},
    {/* SHA256 HMAC */
                  ...
                  .auth =
                      {
                          .algo = RTE_CRYPTO_AUTH_SHA384_HMAC,
                          .block_size = 64,
                          .key_size = {.min = 48, .max = 48, .increment = 0},
                          .digest_size = {.min = 24, .max = 24, .increment = 0},
                      },
              }},
     }},
    {/* SHA512 HMAC */
                  ...
                  .auth =
                      {
                          .algo = RTE_CRYPTO_AUTH_SHA512_HMAC,
                          .block_size = 128,
                          .key_size = {.min = 64, .max = 64, .increment = 0},
                          .digest_size = {.min = 32, .max = 32, .increment = 0},
                      },
              }},
     }},
...
static void cpt_caps_add(struct rte_cryptodev_capabilities cnxk_caps[],
                         int *cur_pos,
...
static void crypto_caps_populate(struct rte_cryptodev_capabilities cnxk_caps[],
...
static void sec_caps_add(struct rte_cryptodev_capabilities cnxk_caps[],
                         int *cur_pos,
                         const struct rte_cryptodev_capabilities *caps,
                         int nb_caps) {
...
sec_crypto_caps_populate(struct rte_cryptodev_capabilities cnxk_caps[],
  ...
  sec_caps_add(cnxk_caps, &cur_pos, sec_caps_null, RTE_DIM(sec_caps_null));
  sec_caps_add(cnxk_caps, &cur_pos, caps_end, RTE_DIM(caps_end));
}

static void cnxk_sec_caps_update(struct rte_security_capability *sec_cap) {
  sec_cap->ipsec.options.udp_encap = 1;
  sec_cap->ipsec.options.copy_df = 1;
  sec_cap->ipsec.options.copy_dscp = 1;
}

static void cn10k_sec_caps_update(struct rte_security_capability *sec_cap) {
...
static void cn9k_sec_caps_update(struct rte_security_capability *sec_cap) {
  if (sec_cap->ipsec.direction == RTE_SECURITY_IPSEC_SA_DIR_EGRESS) {
#ifdef LA_IPSEC_DEBUG
    sec_cap->ipsec.options.iv_gen_disable = 1;
#endif
