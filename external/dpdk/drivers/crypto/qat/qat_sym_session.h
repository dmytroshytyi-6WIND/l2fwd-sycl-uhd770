...
#define QAT_SESSION_IS_SLICE_SET(flags, flag) (!!((flags) & (flag)))
...
unsigned int qat_sym_session_get_private_size(struct rte_cryptodev *dev);

void qat_sym_sesssion_init_common_hdr(struct qat_sym_session *session,
...
int qat_security_session_create(void *dev,
                                ...
                                struct rte_mempool *mempool);
int qat_security_session_destroy(void *dev, struct rte_security_session *sess);
#endif
