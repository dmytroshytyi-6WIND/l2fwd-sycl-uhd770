...
static struct rte_cryptodev_capabilities qat_sym_crypto_caps_gen1[] = {
    ...
    QAT_SYM_AEAD_CAP(AES_GCM, CAP_SET(block_size, 16),
                     CAP_RNG(key_size, 16, 32, 8),
                     CAP_RNG(digest_size, 8, 16, 4),
                     CAP_RNG(aad_size, 0, 240, 1), CAP_RNG(iv_size, 0, 12, 12)),
    QAT_SYM_AEAD_CAP(AES_CCM, CAP_SET(block_size, 16),
                     CAP_RNG(key_size, 16, 16, 0),
                     CAP_RNG(digest_size, 4, 16, 2),
                     CAP_RNG(aad_size, 0, 224, 1), CAP_RNG(iv_size, 7, 13, 1)),
    QAT_SYM_AUTH_CAP(AES_GMAC, CAP_SET(block_size, 16),
                     CAP_RNG(key_size, 16, 32, 8),
                     CAP_RNG(digest_size, 8, 16, 4), CAP_RNG_ZERO(aad_size),
                     CAP_RNG(iv_size, 0, 12, 12)),
    QAT_SYM_AUTH_CAP(AES_CMAC, CAP_SET(block_size, 16),
                     CAP_RNG(key_size, 16, 16, 0),
                     CAP_RNG(digest_size, 4, 16, 4), CAP_RNG_ZERO(aad_size),
                     CAP_RNG_ZERO(iv_size)),
    QAT_SYM_AUTH_CAP(SHA224, CAP_SET(block_size, 64), CAP_RNG_ZERO(key_size),
                     CAP_RNG(digest_size, 1, 28, 1), CAP_RNG_ZERO(aad_size),
                     CAP_RNG_ZERO(iv_size)),
    QAT_SYM_AUTH_CAP(SHA256, CAP_SET(block_size, 64), CAP_RNG_ZERO(key_size),
                     CAP_RNG(digest_size, 1, 32, 1), CAP_RNG_ZERO(aad_size),
                     CAP_RNG_ZERO(iv_size)),
    QAT_SYM_AUTH_CAP(SHA384, CAP_SET(block_size, 128), CAP_RNG_ZERO(key_size),
                     CAP_RNG(digest_size, 1, 48, 1), CAP_RNG_ZERO(aad_size),
                     CAP_RNG_ZERO(iv_size)),
    QAT_SYM_AUTH_CAP(SHA512, CAP_SET(block_size, 128), CAP_RNG_ZERO(key_size),
                     CAP_RNG(digest_size, 1, 64, 1), CAP_RNG_ZERO(aad_size),
                     CAP_RNG_ZERO(iv_size)),
    QAT_SYM_AUTH_CAP(SHA1_HMAC, CAP_SET(block_size, 64),
                     CAP_RNG(key_size, 1, 64, 1),
                     CAP_RNG(digest_size, 1, 20, 1), CAP_RNG_ZERO(aad_size),
                     CAP_RNG_ZERO(iv_size)),
    ...
    QAT_SYM_AUTH_CAP(MD5_HMAC, CAP_SET(block_size, 64),
                     CAP_RNG(key_size, 1, 64, 1),
                     CAP_RNG(digest_size, 1, 16, 1), CAP_RNG_ZERO(aad_size),
                     CAP_RNG_ZERO(iv_size)),
    QAT_SYM_AUTH_CAP(AES_XCBC_MAC, CAP_SET(block_size, 16),
                     CAP_RNG(key_size, 16, 16, 0),
                     CAP_RNG(digest_size, 12, 12, 0), CAP_RNG_ZERO(aad_size),
                     CAP_RNG_ZERO(iv_size)),
    QAT_SYM_AUTH_CAP(SNOW3G_UIA2, CAP_SET(block_size, 16),
                     CAP_RNG(key_size, 16, 16, 0),
                     CAP_RNG(digest_size, 4, 4, 0), CAP_RNG_ZERO(aad_size),
                     CAP_RNG(iv_size, 16, 16, 0)),
    QAT_SYM_AUTH_CAP(KASUMI_F9, CAP_SET(block_size, 8),
                     CAP_RNG(key_size, 16, 16, 0),
                     CAP_RNG(digest_size, 4, 4, 0), CAP_RNG_ZERO(aad_size),
                     CAP_RNG_ZERO(iv_size)),
    QAT_SYM_AUTH_CAP(NULL, CAP_SET(block_size, 1), CAP_RNG_ZERO(key_size),
                     CAP_RNG_ZERO(digest_size), CAP_RNG_ZERO(aad_size),
                     CAP_RNG_ZERO(iv_size)),
    ...
    QAT_SYM_CIPHER_CAP(NULL, CAP_SET(block_size, 1), CAP_RNG_ZERO(key_size),
                       CAP_RNG_ZERO(iv_size)),
...
uint64_t qat_sym_crypto_feature_flags_get_gen1(
  ...
  uint64_t feature_flags =
      ...
      RTE_CRYPTODEV_FF_DIGEST_ENCRYPTED | RTE_CRYPTODEV_FF_SYM_RAW_DP;

  return feature_flags;
}

int qat_sym_build_op_cipher_gen1(void *in_op, struct qat_sym_session *ctx,
  ...
  total_len = qat_sym_build_req_set_data(req, in_op, cookie, in_sgl.vec,
                                         in_sgl.num, out_sgl.vec, out_sgl.num);
  ...
  qat_sym_debug_log_dump(req, ctx, in_sgl.vec, in_sgl.num, &cipher_iv, NULL,
                         NULL, NULL);
#endif
...
int qat_sym_build_op_auth_gen1(void *in_op, struct qat_sym_session *ctx,
                               uint8_t *out_msg, void *op_cookie) {
  register struct icp_qat_fw_la_bulk_req *req;
  struct rte_crypto_op *op = in_op;
  struct qat_sym_op_cookie *cookie = op_cookie;
  ...
  ofs.raw = qat_sym_convert_op_to_vec_auth(op, ctx, &in_sgl, &out_sgl, NULL,
                                           &auth_iv, &digest);
  if (unlikely(ofs.raw == UINT64_MAX)) {
    op->status = RTE_CRYPTO_OP_STATUS_INVALID_ARGS;
    return -EINVAL;
  ...
  enqueue_one_auth_job_gen1(ctx, req, &digest, &auth_iv, ofs, total_len);

#if RTE_LOG_DP_LEVEL >= RTE_LOG_DEBUG
  qat_sym_debug_log_dump(req, ctx, in_sgl.vec, in_sgl.num, NULL, &auth_iv, NULL,
                         &digest);
#endif
...
int qat_sym_build_op_aead_gen1(void *in_op, struct qat_sym_session *ctx,
                               uint8_t *out_msg, void *op_cookie) {
  register struct icp_qat_fw_la_bulk_req *req;
  struct rte_crypto_op *op = in_op;
  struct qat_sym_op_cookie *cookie = op_cookie;
...
int qat_sym_build_op_chain_gen1(void *in_op, struct qat_sym_session *ctx,
                                uint8_t *out_msg, void *op_cookie) {
  register struct icp_qat_fw_la_bulk_req *req;
  struct rte_crypto_op *op = in_op;
  struct qat_sym_op_cookie *cookie = op_cookie;
  ...
  enqueue_one_chain_job_gen1(ctx, req, in_sgl.vec, in_sgl.num, out_sgl.vec,
                             out_sgl.num, &cipher_iv, &digest, &auth_iv, ofs,
                             total_len);

#if RTE_LOG_DP_LEVEL >= RTE_LOG_DEBUG
  qat_sym_debug_log_dump(req, ctx, in_sgl.vec, in_sgl.num, &cipher_iv, &auth_iv,
                         NULL, &digest);
#endif
  ...
  { /* AES DOCSIS BPI */                                                       \
    .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC, {                                      \
      .sym = {                                                                 \
          ...
          {                                                                    \
              .cipher = {.algo = RTE_CRYPTO_CIPHER_AES_DOCSISBPI,              \
                         .block_size = 16,                                     \
...
static const struct rte_cryptodev_capabilities qat_security_sym_capabilities[] =
    {QAT_SECURITY_SYM_CAPABILITIES, RTE_CRYPTODEV_END_OF_CAPABILITIES_LIST()};
...
void *qat_sym_create_security_gen1(void *cryptodev) {
  struct rte_security_ctx *security_instance;

  security_instance =
      rte_malloc(NULL, sizeof(struct rte_security_ctx), RTE_CACHE_LINE_SIZE);
...
#endif
int qat_sym_dp_enqueue_single_cipher_gen1(
    void *qp_data, uint8_t *drv_ctx, struct rte_crypto_vec *data,
    uint16_t n_data_vecs, union rte_crypto_sym_ofs ofs,
    struct rte_crypto_va_iova_ptr *iv,
    struct rte_crypto_va_iova_ptr *digest __rte_unused,
    struct rte_crypto_va_iova_ptr *aad __rte_unused, void *user_data) {
  ...
  req =
      (struct icp_qat_fw_la_bulk_req *)((uint8_t *)tx_queue->base_addr + tail);
  cookie = qp->op_cookies[tail >> tx_queue->trailz];
  tail = (tail + tx_queue->msg_size) & tx_queue->modulo_mask;
  rte_mov128((uint8_t *)req, (const uint8_t *)&(ctx->fw_req));
  rte_prefetch0((uint8_t *)tx_queue->base_addr + tail);

  data_len = qat_sym_build_req_set_data(req, user_data, cookie, data,
                                        n_data_vecs, NULL, 0);
...
#if RTE_LOG_DP_LEVEL >= RTE_LOG_DEBUG
  qat_sym_debug_log_dump(req, ctx, data, n_data_vecs, iv, NULL, NULL, NULL);
#endif
...
uint32_t qat_sym_dp_enqueue_cipher_jobs_gen1(void *qp_data, uint8_t *drv_ctx,
  ...
  for (i = 0; i < n; i++) {
    struct qat_sym_op_cookie *cookie = qp->op_cookies[tail >> tx_queue->trailz];

    req = (struct icp_qat_fw_la_bulk_req *)((uint8_t *)tx_queue->base_addr +
                                            tail);
    rte_mov128((uint8_t *)req, (const uint8_t *)&(ctx->fw_req));

    if (vec->dest_sgl) {
      data_len = qat_sym_build_req_set_data(
          req, user_data[i], cookie, vec->src_sgl[i].vec, vec->src_sgl[i].num,
    ...
    if (unlikely(data_len < 0))
      break;
    enqueue_one_cipher_job_gen1(ctx, req, &vec->iv[i], ofs, (uint32_t)data_len);
    tail = (tail + tx_queue->msg_size) & tx_queue->modulo_mask;

#if RTE_LOG_DP_LEVEL >= RTE_LOG_DEBUG
    qat_sym_debug_log_dump(req, ctx, vec->src_sgl[i].vec, vec->src_sgl[i].num,
                           &vec->iv[i], NULL, NULL, NULL);
#endif
  }
...
int qat_sym_dp_enqueue_single_auth_gen1(
    void *qp_data, uint8_t *drv_ctx, struct rte_crypto_vec *data,
    uint16_t n_data_vecs, union rte_crypto_sym_ofs ofs,
    struct rte_crypto_va_iova_ptr *iv __rte_unused,
    struct rte_crypto_va_iova_ptr *digest,
    struct rte_crypto_va_iova_ptr *auth_iv, void *user_data) {
  struct qat_qp *qp = qp_data;
  struct qat_sym_dp_ctx *dp_ctx = (void *)drv_ctx;
  struct qat_queue *tx_queue = &qp->tx_q;
  struct qat_sym_op_cookie *cookie;
  ...
  enqueue_one_auth_job_gen1(ctx, req, digest, auth_iv, ofs, (uint32_t)data_len);

  dp_ctx->tail = tail;
  dp_ctx->cached_enqueue++;

#if RTE_LOG_DP_LEVEL >= RTE_LOG_DEBUG
  qat_sym_debug_log_dump(req, ctx, data, n_data_vecs, NULL, auth_iv, NULL,
                         digest);
#endif
  return 0;
}

uint32_t qat_sym_dp_enqueue_auth_jobs_gen1(void *qp_data, uint8_t *drv_ctx,
                                           struct rte_crypto_sym_vec *vec,
                                           union rte_crypto_sym_ofs ofs,
                                           void *user_data[], int *status) {
  struct qat_qp *qp = qp_data;
  ...
  for (i = 0; i < n; i++) {
    ...
    if (unlikely(data_len < 0))
      break;
    enqueue_one_auth_job_gen1(ctx, req, &vec->digest[i], &vec->auth_iv[i], ofs,
                              (uint32_t)data_len);
    tail = (tail + tx_queue->msg_size) & tx_queue->modulo_mask;

#if RTE_LOG_DP_LEVEL >= RTE_LOG_DEBUG
    qat_sym_debug_log_dump(req, ctx, vec->src_sgl[i].vec, vec->src_sgl[i].num,
                           NULL, &vec->auth_iv[i], NULL, &vec->digest[i]);
#endif
  }
...
int qat_sym_dp_enqueue_single_chain_gen1(
    void *qp_data, uint8_t *drv_ctx, struct rte_crypto_vec *data,
    uint16_t n_data_vecs, union rte_crypto_sym_ofs ofs,
    struct rte_crypto_va_iova_ptr *cipher_iv,
    struct rte_crypto_va_iova_ptr *digest,
  ...
  if (unlikely(enqueue_one_chain_job_gen1(ctx, req, data, n_data_vecs, NULL, 0,
                                          cipher_iv, digest, auth_iv, ofs,
                                          (uint32_t)data_len)))
    return -1;
...
#if RTE_LOG_DP_LEVEL >= RTE_LOG_DEBUG
  qat_sym_debug_log_dump(req, ctx, data, n_data_vecs, cipher_iv, auth_iv, NULL,
                         digest);
#endif
  return 0;
}

uint32_t qat_sym_dp_enqueue_chain_jobs_gen1(void *qp_data, uint8_t *drv_ctx,
                                            struct rte_crypto_sym_vec *vec,
                                            union rte_crypto_sym_ofs ofs,
                                            void *user_data[], int *status) {
  struct qat_qp *qp = qp_data;
  ...
  for (i = 0; i < n; i++) {
    ...
    if (unlikely(enqueue_one_chain_job_gen1(
            ctx, req, vec->src_sgl[i].vec, vec->src_sgl[i].num, NULL, 0,
            &vec->iv[i], &vec->digest[i], &vec->auth_iv[i], ofs,
            (uint32_t)data_len)))
      break;
...
int qat_sym_dp_enqueue_single_aead_gen1(
    void *qp_data, uint8_t *drv_ctx, struct rte_crypto_vec *data,
    uint16_t n_data_vecs, union rte_crypto_sym_ofs ofs,
    struct rte_crypto_va_iova_ptr *iv, struct rte_crypto_va_iova_ptr *digest,
    struct rte_crypto_va_iova_ptr *aad, void *user_data) {
  struct qat_qp *qp = qp_data;
  struct qat_sym_dp_ctx *dp_ctx = (void *)drv_ctx;
  struct qat_queue *tx_queue = &qp->tx_q;
  struct qat_sym_op_cookie *cookie;
  ...
  enqueue_one_aead_job_gen1(ctx, req, iv, digest, aad, ofs, (uint32_t)data_len);

  dp_ctx->tail = tail;
  dp_ctx->cached_enqueue++;

#if RTE_LOG_DP_LEVEL >= RTE_LOG_DEBUG
  qat_sym_debug_log_dump(req, ctx, data, n_data_vecs, iv, NULL, aad, digest);
#endif
  return 0;
}

uint32_t qat_sym_dp_enqueue_aead_jobs_gen1(void *qp_data, uint8_t *drv_ctx,
                                           struct rte_crypto_sym_vec *vec,
                                           union rte_crypto_sym_ofs ofs,
                                           void *user_data[], int *status) {
  struct qat_qp *qp = qp_data;
  ...
  for (i = 0; i < n; i++) {
    ...
    enqueue_one_aead_job_gen1(ctx, req, &vec->iv[i], &vec->digest[i],
...
#if RTE_LOG_DP_LEVEL >= RTE_LOG_DEBUG
    qat_sym_debug_log_dump(req, ctx, vec->src_sgl[i].vec, vec->src_sgl[i].num,
                           &vec->iv[i], NULL, &vec->aad[i], &vec->digest[i]);
#endif
  }
...
uint32_t qat_sym_dp_dequeue_burst_gen1(
    void *qp_data, uint8_t *drv_ctx,
    rte_cryptodev_raw_get_dequeue_count_t get_dequeue_count,
    uint32_t max_nb_to_dequeue, rte_cryptodev_raw_post_dequeue_t post_dequeue,
    void **out_user_data, uint8_t is_user_data_array, uint32_t *n_success_jobs,
    int *return_status) {
  struct qat_qp *qp = qp_data;
  struct qat_sym_dp_ctx *dp_ctx = (void *)drv_ctx;
  ...
  *return_status = 0;
  ...
  resp = (struct icp_qat_fw_comn_resp *)((uint8_t *)rx_queue->base_addr + head);
  /* no operation ready */
  ...
  *n_success_jobs += status;
  ...
  for (i = 1; i < n; i++) {
    resp =
        (struct icp_qat_fw_comn_resp *)((uint8_t *)rx_queue->base_addr + head);
    status = QAT_SYM_DP_IS_RESP_SUCCESS(resp);
    if (unlikely(*(uint32_t *)resp == ADF_RING_EMPTY_SIG))
      goto end_deq;
    head = (head + rx_queue->msg_size) & rx_queue->modulo_mask;
...
void *qat_sym_dp_dequeue_single_gen1(void *qp_data, uint8_t *drv_ctx,
                                     int *dequeue_status,
  ...
  dp_ctx->head = (dp_ctx->head + rx_queue->msg_size) & rx_queue->modulo_mask;
...
int qat_sym_dp_enqueue_done_gen1(void *qp_data, uint8_t *drv_ctx, uint32_t n) {
  struct qat_qp *qp = qp_data;
  struct qat_queue *tx_queue = &qp->tx_q;
  struct qat_sym_dp_ctx *dp_ctx = (void *)drv_ctx;
  ...
  WRITE_CSR_RING_TAIL(qp->mmap_bar_addr, tx_queue->hw_bundle_number,
...
int qat_sym_dp_dequeue_done_gen1(void *qp_data, uint8_t *drv_ctx, uint32_t n) {
  struct qat_qp *qp = qp_data;
  struct qat_queue *rx_queue = &qp->rx_q;
  struct qat_sym_dp_ctx *dp_ctx = (void *)drv_ctx;
  ...
  if (rx_queue->nb_processed_responses > QAT_CSR_HEAD_WRITE_THRESH) {
    ...
    if (new_head < old_head) {
      ...
      memset(rx_queue->base_addr, ADF_RING_EMPTY_SIG_BYTE, new_head);
    } else {
    ...
    WRITE_CSR_RING_HEAD(qp->mmap_bar_addr, rx_queue->hw_bundle_number,
                        rx_queue->hw_queue_number, new_head);
  }
...
int qat_sym_configure_raw_dp_ctx_gen1(void *_raw_dp_ctx, void *_ctx) {
  ...
  if ((ctx->qat_cmd == ICP_QAT_FW_LA_CMD_HASH_CIPHER ||
    ...
    if (ctx->qat_hash_alg == ICP_QAT_HW_AUTH_ALGO_GALOIS_128 ||
        ...
        (ctx->qat_cipher_alg == ICP_QAT_HW_CIPHER_ALGO_AES128 &&
         ...
         ctx->qat_hash_alg == ICP_QAT_HW_AUTH_ALGO_AES_CBC_MAC)) {
      raw_dp_ctx->enqueue_burst = qat_sym_dp_enqueue_aead_jobs_gen1;
      raw_dp_ctx->enqueue = qat_sym_dp_enqueue_single_aead_gen1;
    } else {
      raw_dp_ctx->enqueue_burst = qat_sym_dp_enqueue_chain_jobs_gen1;
      raw_dp_ctx->enqueue = qat_sym_dp_enqueue_single_chain_gen1;
    }
    ...
    if (ctx->qat_mode == ICP_QAT_HW_CIPHER_AEAD_MODE ||
      ...
      raw_dp_ctx->enqueue_burst = qat_sym_dp_enqueue_cipher_jobs_gen1;
      raw_dp_ctx->enqueue = qat_sym_dp_enqueue_single_cipher_gen1;
    }
  } else
    return -1;
...
int qat_sym_crypto_set_session_gen1(void *cryptodev __rte_unused,
                                    void *session) {
  ...
  if (ctx->qat_hash_alg == ICP_QAT_HW_AUTH_ALGO_ZUC_3G_128_EIA3 &&
    ...
    return -ENOTSUP;
             ...
             ctx->qat_cipher_alg != ICP_QAT_HW_CIPHER_ALGO_SNOW_3G_UEA2) {
    return -ENOTSUP;
...
RTE_INIT(qat_sym_crypto_gen1_init) {
  ...
  qat_sym_gen_dev_ops[QAT_GEN1].get_capabilities = qat_sym_crypto_cap_get_gen1;
  qat_sym_gen_dev_ops[QAT_GEN1].set_session = qat_sym_crypto_set_session_gen1;
