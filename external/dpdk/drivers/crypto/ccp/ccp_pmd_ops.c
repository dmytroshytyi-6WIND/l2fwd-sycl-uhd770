   ...
   {                                                                           \
               ...
               {                                                               \
                   .auth =                                                     \
                       {.algo = RTE_CRYPTO_AUTH_SHA1,                          \
                        ...
                        .digest_size = {.min = 20, .max = 20, .increment = 0}, \
                        .aad_size = {0}},                                      \
               }},                                                             \
   }},                                                                         \
      {/* SHA1 HMAC */                                                         \
      ...
      {/* SHA3-224 */                                                          \
       ...
       {                                                                       \
           .sym =                                                              \
               {.xform_type = RTE_CRYPTO_SYM_XFORM_AUTH,                       \
                {                                                              \
                    .auth = {.algo = RTE_CRYPTO_AUTH_SHA3_224,                 \
                             .block_size = 144,                                \
                             .key_size = {.min = 0, .max = 0, .increment = 0}, \
                             .digest_size =                                    \
                                 {.min = 28, .max = 28, .increment = 0},       \
      ...
      {/* SHA3-224  HMAC*/                                                     \
       ...
       {                                                                       \
           .sym = {.xform_type = RTE_CRYPTO_SYM_XFORM_AUTH,                    \
                   {                                                           \
                       .auth = {.algo = RTE_CRYPTO_AUTH_SHA3_224_HMAC,         \
                                .block_size = 144,                             \
                                .key_size =                                    \
                                    {.min = 1, .max = 144, .increment = 1},    \
                                .digest_size =                                 \
                                    {.min = 28, .max = 28, .increment = 0},    \
                                .aad_size = {0}},                              \
                   }},                                                         \
      ...
      {/* SHA3-256 */                                                          \
       ...
       {                                                                       \
           .sym =                                                              \
               {.xform_type = RTE_CRYPTO_SYM_XFORM_AUTH,                       \
                {                                                              \
                    .auth = {.algo = RTE_CRYPTO_AUTH_SHA3_256,                 \
                             .block_size = 136,                                \
                             .key_size = {.min = 0, .max = 0, .increment = 0}, \
                             .digest_size =                                    \
                                 {.min = 32, .max = 32, .increment = 0},       \
      ...
      {/* SHA3-256-HMAC */                                                     \
       ...
       {                                                                       \
           .sym = {.xform_type = RTE_CRYPTO_SYM_XFORM_AUTH,                    \
                   {                                                           \
                       .auth = {.algo = RTE_CRYPTO_AUTH_SHA3_256_HMAC,         \
                                .block_size = 136,                             \
                                .key_size =                                    \
                                    {.min = 1, .max = 136, .increment = 1},    \
                                .digest_size =                                 \
                                    {.min = 32, .max = 32, .increment = 0},    \
                                .aad_size = {0}},                              \
                   }},                                                         \
      ...
      {/* SHA3-384 */                                                          \
       ...
       {                                                                       \
           .sym =                                                              \
               {.xform_type = RTE_CRYPTO_SYM_XFORM_AUTH,                       \
                {                                                              \
                    .auth = {.algo = RTE_CRYPTO_AUTH_SHA3_384,                 \
                             .block_size = 104,                                \
                             .key_size = {.min = 0, .max = 0, .increment = 0}, \
                             .digest_size =                                    \
                                 {.min = 48, .max = 48, .increment = 0},       \
      ...
      {/* SHA3-384-HMAC */                                                     \
       ...
       {                                                                       \
           .sym = {.xform_type = RTE_CRYPTO_SYM_XFORM_AUTH,                    \
                   {                                                           \
                       .auth = {.algo = RTE_CRYPTO_AUTH_SHA3_384_HMAC,         \
                                .block_size = 104,                             \
                                .key_size =                                    \
                                    {.min = 1, .max = 104, .increment = 1},    \
                                .digest_size =                                 \
                                    {.min = 48, .max = 48, .increment = 0},    \
                                .aad_size = {0}},                              \
                   }},                                                         \
      ...
      {/* SHA3-512  */                                                         \
       ...
       {                                                                       \
           .sym =                                                              \
               {.xform_type = RTE_CRYPTO_SYM_XFORM_AUTH,                       \
                {                                                              \
                    .auth = {.algo = RTE_CRYPTO_AUTH_SHA3_512,                 \
                             .block_size = 72,                                 \
                             .key_size = {.min = 0, .max = 0, .increment = 0}, \
                             .digest_size =                                    \
                                 {.min = 64, .max = 64, .increment = 0},       \
                ...
                {                                                              \
                    .auth =                                                    \
                        {.algo = RTE_CRYPTO_AUTH_SHA3_512_HMAC,                \
                         .block_size = 72,                                     \
                         .key_size = {.min = 1, .max = 72, .increment = 1},    \
                         .digest_size = {.min = 1, .max = 64, .increment = 1}, \
                         .aad_size = {0}},                                     \
                }},                                                            \
       }},                                                                     \
                ...
                {                                                              \
                    .cipher =                                                  \
                        {.algo = RTE_CRYPTO_CIPHER_AES_ECB,                    \
                         ...
                         .iv_size = {.min = 0, .max = 0, .increment = 0}},     \
                }},                                                            \
       }},                                                                     \
      {/* AES CBC */                                                           \
       .op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,                                     \
...
static const struct rte_cryptodev_capabilities ccp_crypto_cap[] = {
    CCP_BASE_SYM_CRYPTO_CAPABILITIES, RTE_CRYPTODEV_END_OF_CAPABILITIES_LIST()};

static const struct rte_cryptodev_capabilities ccp_crypto_cap_complete[] = {
    CCP_EXTRA_SYM_CRYPTO_CAPABILITIES, CCP_BASE_SYM_CRYPTO_CAPABILITIES,
...
static int ccp_pmd_start(struct rte_cryptodev *dev) {
  return ccp_dev_start(dev);
}

static void ccp_pmd_stop(struct rte_cryptodev *dev __rte_unused) {}

static int ccp_pmd_close(struct rte_cryptodev *dev __rte_unused) { return 0; }

static void ccp_pmd_stats_get(struct rte_cryptodev *dev,
...
static void ccp_pmd_stats_reset(struct rte_cryptodev *dev) {
  int qp_id;
...
static void ccp_pmd_info_get(struct rte_cryptodev *dev,
...
static int ccp_pmd_qp_release(struct rte_cryptodev *dev, uint16_t qp_id) {
  struct ccp_qp *qp;
...
static int ccp_pmd_qp_set_unique_name(struct rte_cryptodev *dev,
                                      struct ccp_qp *qp) {
  unsigned int n = snprintf(qp->name, sizeof(qp->name), "ccp_pmd_%u_qp_%u",
...
ccp_pmd_qp_create_batch_info_ring(struct ccp_qp *qp, unsigned int ring_size,
                                  int socket_id) {
  struct rte_ring *r;
  ...
  if (r) {
    if (r->size >= ring_size) {
      CCP_LOG_INFO("Reusing ring %s for processed packets", qp->name);
      return r;
    }
    CCP_LOG_INFO("Unable to reuse ring %s for processed packets", qp->name);
    return NULL;
  }
...
static int ccp_pmd_qp_setup(struct rte_cryptodev *dev, uint16_t qp_id,
  ...
  if (qp_id >= internals->max_nb_qpairs) {
    CCP_LOG_ERR("Invalid qp_id %u, should be less than %u", qp_id,
                internals->max_nb_qpairs);
    return (-EINVAL);
  }
  ...
  qp->processed_pkts =
      ccp_pmd_qp_create_batch_info_ring(qp, qp_conf->nb_descriptors, socket_id);
  ...
  qp->batch_mp = rte_mempool_create(
      qp->name, qp_conf->nb_descriptors, sizeof(struct ccp_batch_info),
      RTE_CACHE_LINE_SIZE, 0, NULL, NULL, NULL, NULL, SOCKET_ID_ANY, 0);
  if (qp->batch_mp == NULL)
    goto qp_setup_cleanup;
  memset(&qp->qp_stats, 0, sizeof(qp->qp_stats));
  return 0;
...
static int ccp_pmd_sym_session_configure(struct rte_cryptodev *dev,
...
static void ccp_pmd_sym_session_clear(struct rte_cryptodev *dev,
                                      struct rte_cryptodev_sym_session *sess) {
