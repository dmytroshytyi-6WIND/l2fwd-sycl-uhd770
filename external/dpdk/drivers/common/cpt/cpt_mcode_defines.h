...
#define SRC_IOV_SIZE (sizeof(iov_ptr_t) + (sizeof(buf_ptr_t) * CPT_MAX_SG_CNT))
#define DST_IOV_SIZE (sizeof(iov_ptr_t) + (sizeof(buf_ptr_t) * CPT_MAX_SG_CNT))
 ...
 *   - session size
 */
static __rte_always_inline unsigned int cpt_get_session_size(void) {
