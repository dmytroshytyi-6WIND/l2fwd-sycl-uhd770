 ...
 *   - length
 */
__rte_internal int32_t cpt_pmd_ops_helper_get_mlen_direct_mode(void);
 ...
 *   - length
 */
__rte_internal int cpt_pmd_ops_helper_get_mlen_sg_mode(void);
 ...
 *  - length
 */
__rte_internal int cpt_pmd_ops_helper_asym_get_mlen(void);
 ...
 */
__rte_internal int cpt_fpm_init(uint64_t *fpm_table_iova);

/*
 * Clear ECC FMUL precomputed table
 */
__rte_internal void cpt_fpm_clear(void);
