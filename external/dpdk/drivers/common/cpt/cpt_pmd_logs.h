...
#define CPT_PMD_DRV_LOG_RAW(level, fmt, args...)                               \
  rte_log(RTE_LOG_##level, CPT_LOGTYPE, "cpt: %s(): " fmt "\n", __func__,      \
          ##args)

#define CPT_PMD_INIT_FUNC_TRACE() CPT_PMD_DRV_LOG_RAW(DEBUG, " >>")

#define CPT_LOG_INFO(fmt, args...) CPT_PMD_DRV_LOG_RAW(INFO, fmt, ##args)
#define CPT_LOG_WARN(fmt, args...) CPT_PMD_DRV_LOG_RAW(WARNING, fmt, ##args)
#define CPT_LOG_ERR(fmt, args...) CPT_PMD_DRV_LOG_RAW(ERR, fmt, ##args)
