 ...
 */
static inline unsigned int rta_get_sec_era(void) { return rta_sec_era; }
...
#define JOB_HDR_EXT(program, share, start_idx, share_desc, flags, ext_flags)   \
  rta_job_header(program, share, start_idx, share_desc, flags | EXT, ext_flags)
...
#define MOVEB(program, src, src_offset, dst, dst_offset, length, opt)          \
  rta_move(program, __MOVEB, src, src_offset, dst, dst_offset, length, opt)
...
#define MOVEDW(program, src, src_offset, dst, dst_offset, length, opt)         \
  rta_move(program, __MOVEDW, src, src_offset, dst, dst_offset, length, opt)
...
#define MATHB(program, operand1, operator, operand2, result, length, opt)      \
  rta_math(program, operand1, MATH_FUN_##operator, operand2, result, length,   \
           opt)
...
#define MATHI(program, operand, operator, imm, result, length, opt)            \
  rta_mathi(program, operand, MATH_FUN_##operator, imm, result, length, opt)
...
#define MATHU(program, operand1, operator, result, length, opt)                \
  rta_math(program, operand1, MATH_FUN_##operator, NONE, result, length, opt)
