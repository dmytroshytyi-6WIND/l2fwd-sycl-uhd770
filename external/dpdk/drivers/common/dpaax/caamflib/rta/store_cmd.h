...
static const uint32_t store_src_table[][2] = {
    ...
    /*32*/ {JOBDESCBUF_EFF, LDST_CLASS_DECO | LDST_SRCDST_WORD_DESCBUF_JOB_WE},
    {SHAREDESCBUF_EFF, LDST_CLASS_DECO | LDST_SRCDST_WORD_DESCBUF_SHARED_WE},
 ...
 * supported.
 */
static const unsigned int store_src_table_sz[] = {29, 31, 33, 33, 33,
                                                  33, 35, 35, 35, 35};
...
static inline int rta_store(struct program *program, uint64_t src,
  ...
  if ((src == JOBDESCBUF) || (src == SHAREDESCBUF) || (src == JOBDESCBUF_EFF) ||
