...
#define OP_PCL_LTE_MIXED_AUTH_NULL                                             \
  (OP_PCL_LTE_NULL << OP_PCL_LTE_MIXED_AUTH_SHIFT)
#define OP_PCL_LTE_MIXED_AUTH_SNOW                                             \
  (OP_PCL_LTE_SNOW << OP_PCL_LTE_MIXED_AUTH_SHIFT)
#define OP_PCL_LTE_MIXED_AUTH_AES                                              \
  (OP_PCL_LTE_AES << OP_PCL_LTE_MIXED_AUTH_SHIFT)
#define OP_PCL_LTE_MIXED_AUTH_ZUC                                              \
  (OP_PCL_LTE_ZUC << OP_PCL_LTE_MIXED_AUTH_SHIFT)
#define OP_PCL_LTE_MIXED_ENC_NULL                                              \
  (OP_PCL_LTE_NULL << OP_PCL_LTE_MIXED_ENC_SHIFT)
#define OP_PCL_LTE_MIXED_ENC_SNOW                                              \
  (OP_PCL_LTE_SNOW << OP_PCL_LTE_MIXED_ENC_SHIFT)
#define OP_PCL_LTE_MIXED_ENC_AES (OP_PCL_LTE_AES << OP_PCL_LTE_MIXED_ENC_SHIFT)
#define OP_PCL_LTE_MIXED_ENC_ZUC (OP_PCL_LTE_ZUC << OP_PCL_LTE_MIXED_ENC_SHIFT)
...
/* PKHA mode clear memory functions */
#define OP_ALG_PKMODE_CLEARMEM_ALL                                             \
  (OP_ALG_PKMODE_CLEARMEM | OP_ALG_PKMODE_A_RAM | OP_ALG_PKMODE_B_RAM |        \
   OP_ALG_PKMODE_N_RAM | OP_ALG_PKMODE_E_RAM)
#define OP_ALG_PKMODE_CLEARMEM_ABE                                             \
  (OP_ALG_PKMODE_CLEARMEM | OP_ALG_PKMODE_A_RAM | OP_ALG_PKMODE_B_RAM |        \
   OP_ALG_PKMODE_E_RAM)
#define OP_ALG_PKMODE_CLEARMEM_ABN                                             \
  (OP_ALG_PKMODE_CLEARMEM | OP_ALG_PKMODE_A_RAM | OP_ALG_PKMODE_B_RAM |        \
   OP_ALG_PKMODE_N_RAM)
#define OP_ALG_PKMODE_CLEARMEM_AB                                              \
  (OP_ALG_PKMODE_CLEARMEM | OP_ALG_PKMODE_A_RAM | OP_ALG_PKMODE_B_RAM)
#define OP_ALG_PKMODE_CLEARMEM_AEN                                             \
  (OP_ALG_PKMODE_CLEARMEM | OP_ALG_PKMODE_A_RAM | OP_ALG_PKMODE_E_RAM |        \
   OP_ALG_PKMODE_N_RAM)
#define OP_ALG_PKMODE_CLEARMEM_AE                                              \
  (OP_ALG_PKMODE_CLEARMEM | OP_ALG_PKMODE_A_RAM | OP_ALG_PKMODE_E_RAM)
#define OP_ALG_PKMODE_CLEARMEM_AN                                              \
  (OP_ALG_PKMODE_CLEARMEM | OP_ALG_PKMODE_A_RAM | OP_ALG_PKMODE_N_RAM)
#define OP_ALG_PKMODE_CLEARMEM_A (OP_ALG_PKMODE_CLEARMEM | OP_ALG_PKMODE_A_RAM)
#define OP_ALG_PKMODE_CLEARMEM_BEN                                             \
  (OP_ALG_PKMODE_CLEARMEM | OP_ALG_PKMODE_B_RAM | OP_ALG_PKMODE_E_RAM |        \
   OP_ALG_PKMODE_N_RAM)
#define OP_ALG_PKMODE_CLEARMEM_BE                                              \
  (OP_ALG_PKMODE_CLEARMEM | OP_ALG_PKMODE_B_RAM | OP_ALG_PKMODE_E_RAM)
#define OP_ALG_PKMODE_CLEARMEM_BN                                              \
  (OP_ALG_PKMODE_CLEARMEM | OP_ALG_PKMODE_B_RAM | OP_ALG_PKMODE_N_RAM)
#define OP_ALG_PKMODE_CLEARMEM_B (OP_ALG_PKMODE_CLEARMEM | OP_ALG_PKMODE_B_RAM)
#define OP_ALG_PKMODE_CLEARMEM_EN                                              \
  (OP_ALG_PKMODE_CLEARMEM | OP_ALG_PKMODE_E_RAM | OP_ALG_PKMODE_N_RAM)
#define OP_ALG_PKMODE_CLEARMEM_E (OP_ALG_PKMODE_CLEARMEM | OP_ALG_PKMODE_E_RAM)
#define OP_ALG_PKMODE_CLEARMEM_N (OP_ALG_PKMODE_CLEARMEM | OP_ALG_PKMODE_N_RAM)
...
#define OP_ALG_PKMODE_MOD_MULT_IM_OM                                           \
  (0x005 | OP_ALG_PKMODE_MOD_IN_MONTY | OP_ALG_PKMODE_MOD_OUT_MONTY)
...
#define OP_ALG_PKMODE_MOD_EXPO_IM_TEQ                                          \
  (0x006 | OP_ALG_PKMODE_MOD_IN_MONTY | OP_ALG_PKMODE_TIME_EQ)
...
#define OP_ALG_PKMODE_F2M_MUL_IM                                               \
  (0x005 | OP_ALG_PKMODE_MOD_F2M | OP_ALG_PKMODE_MOD_IN_MONTY)
#define OP_ALG_PKMODE_F2M_MUL_IM_OM                                            \
  (0x005 | OP_ALG_PKMODE_MOD_F2M | OP_ALG_PKMODE_MOD_IN_MONTY |                \
   OP_ALG_PKMODE_MOD_OUT_MONTY)
#define OP_ALG_PKMODE_F2M_EXP (0x006 | OP_ALG_PKMODE_MOD_F2M)
#define OP_ALG_PKMODE_F2M_EXP_TEQ                                              \
  (0x006 | OP_ALG_PKMODE_MOD_F2M | OP_ALG_PKMODE_TIME_EQ)
...
#define OP_ALG_PKMODE_ECC_MOD_ADD_IM_OM_PROJ                                   \
  (0x009 | OP_ALG_PKMODE_MOD_IN_MONTY | OP_ALG_PKMODE_MOD_OUT_MONTY |          \
   OP_ALG_PKMODE_PRJECTV)
#define OP_ALG_PKMODE_ECC_MOD_DBL 0x00a
#define OP_ALG_PKMODE_ECC_MOD_DBL_IM_OM_PROJ                                   \
  (0x00a | OP_ALG_PKMODE_MOD_IN_MONTY | OP_ALG_PKMODE_MOD_OUT_MONTY |          \
   OP_ALG_PKMODE_PRJECTV)
...
#define OP_ALG_PKMODE_ECC_MOD_MUL_R2_TEQ                                       \
  (0x00b | OP_ALG_PKMODE_MOD_R2_IN | OP_ALG_PKMODE_TIME_EQ)
#define OP_ALG_PKMODE_ECC_MOD_MUL_R2_PROJ                                      \
  (0x00b | OP_ALG_PKMODE_MOD_R2_IN | OP_ALG_PKMODE_PRJECTV)
...
#define OP_ALG_PKMODE_ECC_F2M_ADD_IM_OM_PROJ                                   \
  (0x009 | OP_ALG_PKMODE_MOD_F2M | OP_ALG_PKMODE_MOD_IN_MONTY |                \
   OP_ALG_PKMODE_MOD_OUT_MONTY | OP_ALG_PKMODE_PRJECTV)
#define OP_ALG_PKMODE_ECC_F2M_DBL (0x00a | OP_ALG_PKMODE_MOD_F2M)
#define OP_ALG_PKMODE_ECC_F2M_DBL_IM_OM_PROJ                                   \
  (0x00a | OP_ALG_PKMODE_MOD_F2M | OP_ALG_PKMODE_MOD_IN_MONTY |                \
   OP_ALG_PKMODE_MOD_OUT_MONTY | OP_ALG_PKMODE_PRJECTV)
#define OP_ALG_PKMODE_ECC_F2M_MUL (0x00b | OP_ALG_PKMODE_MOD_F2M)
#define OP_ALG_PKMODE_ECC_F2M_MUL_TEQ                                          \
  (0x00b | OP_ALG_PKMODE_MOD_F2M | OP_ALG_PKMODE_TIME_EQ)
#define OP_ALG_PKMODE_ECC_F2M_MUL_R2                                           \
  (0x00b | OP_ALG_PKMODE_MOD_F2M | OP_ALG_PKMODE_MOD_R2_IN)
...
#define OP_ALG_PKMODE_ECC_F2M_MUL_R2_PROJ_TEQ                                  \
  (0x00b | OP_ALG_PKMODE_MOD_F2M | OP_ALG_PKMODE_MOD_R2_IN |                   \
   OP_ALG_PKMODE_PRJECTV | OP_ALG_PKMODE_TIME_EQ)
...
#define OP_ALG_PKMODE_COPY_NSZ_A0_B0                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_A | OP_ALG_PKMODE_DST_REG_B)
#define OP_ALG_PKMODE_COPY_NSZ_A0_B1                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_DST_REG_B | OP_ALG_PKMODE_DST_SEG_1)
#define OP_ALG_PKMODE_COPY_NSZ_A0_B2                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_DST_REG_B | OP_ALG_PKMODE_DST_SEG_2)
#define OP_ALG_PKMODE_COPY_NSZ_A0_B3                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_DST_REG_B | OP_ALG_PKMODE_DST_SEG_3)

#define OP_ALG_PKMODE_COPY_NSZ_A1_B0                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_1 | OP_ALG_PKMODE_DST_REG_B)
#define OP_ALG_PKMODE_COPY_NSZ_A1_B1                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_1 | OP_ALG_PKMODE_DST_REG_B |                         \
   OP_ALG_PKMODE_DST_SEG_1)
#define OP_ALG_PKMODE_COPY_NSZ_A1_B2                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_1 | OP_ALG_PKMODE_DST_REG_B |                         \
   OP_ALG_PKMODE_DST_SEG_2)
#define OP_ALG_PKMODE_COPY_NSZ_A1_B3                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_1 | OP_ALG_PKMODE_DST_REG_B |                         \
   OP_ALG_PKMODE_DST_SEG_3)

#define OP_ALG_PKMODE_COPY_NSZ_A2_B0                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_2 | OP_ALG_PKMODE_DST_REG_B)
#define OP_ALG_PKMODE_COPY_NSZ_A2_B1                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_2 | OP_ALG_PKMODE_DST_REG_B |                         \
   OP_ALG_PKMODE_DST_SEG_1)
#define OP_ALG_PKMODE_COPY_NSZ_A2_B2                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_2 | OP_ALG_PKMODE_DST_REG_B |                         \
   OP_ALG_PKMODE_DST_SEG_2)
#define OP_ALG_PKMODE_COPY_NSZ_A2_B3                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_2 | OP_ALG_PKMODE_DST_REG_B |                         \
   OP_ALG_PKMODE_DST_SEG_3)
...
#define OP_ALG_PKMODE_COPY_NSZ_A3_B0                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_3 | OP_ALG_PKMODE_DST_REG_B)
#define OP_ALG_PKMODE_COPY_NSZ_A3_B1                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_3 | OP_ALG_PKMODE_DST_REG_B |                         \
   OP_ALG_PKMODE_DST_SEG_1)
#define OP_ALG_PKMODE_COPY_NSZ_A3_B2                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_3 | OP_ALG_PKMODE_DST_REG_B |                         \
   OP_ALG_PKMODE_DST_SEG_2)
#define OP_ALG_PKMODE_COPY_NSZ_A3_B3                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_3 | OP_ALG_PKMODE_DST_REG_B |                         \
   OP_ALG_PKMODE_DST_SEG_3)

#define OP_ALG_PKMODE_COPY_NSZ_B0_A0                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_B | OP_ALG_PKMODE_DST_REG_A)
#define OP_ALG_PKMODE_COPY_NSZ_B0_A1                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_DST_REG_A | OP_ALG_PKMODE_DST_SEG_1)
#define OP_ALG_PKMODE_COPY_NSZ_B0_A2                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_DST_REG_A | OP_ALG_PKMODE_DST_SEG_2)
#define OP_ALG_PKMODE_COPY_NSZ_B0_A3                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_DST_REG_A | OP_ALG_PKMODE_DST_SEG_3)

#define OP_ALG_PKMODE_COPY_NSZ_B1_A0                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_1 | OP_ALG_PKMODE_DST_REG_A)
#define OP_ALG_PKMODE_COPY_NSZ_B1_A1                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_1 | OP_ALG_PKMODE_DST_REG_A |                         \
   OP_ALG_PKMODE_DST_SEG_1)
#define OP_ALG_PKMODE_COPY_NSZ_B1_A2                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_1 | OP_ALG_PKMODE_DST_REG_A |                         \
   OP_ALG_PKMODE_DST_SEG_2)
#define OP_ALG_PKMODE_COPY_NSZ_B1_A3                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_1 | OP_ALG_PKMODE_DST_REG_A |                         \
   OP_ALG_PKMODE_DST_SEG_3)

#define OP_ALG_PKMODE_COPY_NSZ_B2_A0                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_2 | OP_ALG_PKMODE_DST_REG_A)
#define OP_ALG_PKMODE_COPY_NSZ_B2_A1                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_2 | OP_ALG_PKMODE_DST_REG_A |                         \
   OP_ALG_PKMODE_DST_SEG_1)
#define OP_ALG_PKMODE_COPY_NSZ_B2_A2                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_2 | OP_ALG_PKMODE_DST_REG_A |                         \
   OP_ALG_PKMODE_DST_SEG_2)
#define OP_ALG_PKMODE_COPY_NSZ_B2_A3                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_2 | OP_ALG_PKMODE_DST_REG_A |                         \
   OP_ALG_PKMODE_DST_SEG_3)

#define OP_ALG_PKMODE_COPY_NSZ_B3_A0                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_3 | OP_ALG_PKMODE_DST_REG_A)
#define OP_ALG_PKMODE_COPY_NSZ_B3_A1                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_3 | OP_ALG_PKMODE_DST_REG_A |                         \
   OP_ALG_PKMODE_DST_SEG_1)
#define OP_ALG_PKMODE_COPY_NSZ_B3_A2                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_3 | OP_ALG_PKMODE_DST_REG_A |                         \
   OP_ALG_PKMODE_DST_SEG_2)
#define OP_ALG_PKMODE_COPY_NSZ_B3_A3                                           \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_3 | OP_ALG_PKMODE_DST_REG_A |                         \
   OP_ALG_PKMODE_DST_SEG_3)

#define OP_ALG_PKMODE_COPY_NSZ_A_B                                             \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_A | OP_ALG_PKMODE_DST_REG_B)
#define OP_ALG_PKMODE_COPY_NSZ_A_E                                             \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_A | OP_ALG_PKMODE_DST_REG_E)
#define OP_ALG_PKMODE_COPY_NSZ_A_N                                             \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_A | OP_ALG_PKMODE_DST_REG_N)
#define OP_ALG_PKMODE_COPY_NSZ_B_A                                             \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_B | OP_ALG_PKMODE_DST_REG_A)
#define OP_ALG_PKMODE_COPY_NSZ_B_E                                             \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_B | OP_ALG_PKMODE_DST_REG_E)
#define OP_ALG_PKMODE_COPY_NSZ_B_N                                             \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_B | OP_ALG_PKMODE_DST_REG_N)
#define OP_ALG_PKMODE_COPY_NSZ_N_A                                             \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_N | OP_ALG_PKMODE_DST_REG_A)
#define OP_ALG_PKMODE_COPY_NSZ_N_B                                             \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_N | OP_ALG_PKMODE_DST_REG_B)
#define OP_ALG_PKMODE_COPY_NSZ_N_E                                             \
  (OP_ALG_PKMODE_COPY_NSZ | OP_ALG_PKMODE_SRC_REG_N | OP_ALG_PKMODE_DST_REG_E)

/* PKHA mode copy-memory functions - amount based on SRC SIZE */
#define OP_ALG_PKMODE_COPY_SSZ 0x11
#define OP_ALG_PKMODE_COPY_SSZ_A0_B0                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_A | OP_ALG_PKMODE_DST_REG_B)
#define OP_ALG_PKMODE_COPY_SSZ_A0_B1                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_DST_REG_B | OP_ALG_PKMODE_DST_SEG_1)
#define OP_ALG_PKMODE_COPY_SSZ_A0_B2                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_DST_REG_B | OP_ALG_PKMODE_DST_SEG_2)
#define OP_ALG_PKMODE_COPY_SSZ_A0_B3                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_DST_REG_B | OP_ALG_PKMODE_DST_SEG_3)

#define OP_ALG_PKMODE_COPY_SSZ_A1_B0                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_1 | OP_ALG_PKMODE_DST_REG_B)
#define OP_ALG_PKMODE_COPY_SSZ_A1_B1                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_1 | OP_ALG_PKMODE_DST_REG_B |                         \
   OP_ALG_PKMODE_DST_SEG_1)
#define OP_ALG_PKMODE_COPY_SSZ_A1_B2                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_1 | OP_ALG_PKMODE_DST_REG_B |                         \
   OP_ALG_PKMODE_DST_SEG_2)
#define OP_ALG_PKMODE_COPY_SSZ_A1_B3                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_1 | OP_ALG_PKMODE_DST_REG_B |                         \
   OP_ALG_PKMODE_DST_SEG_3)

#define OP_ALG_PKMODE_COPY_SSZ_A2_B0                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_2 | OP_ALG_PKMODE_DST_REG_B)
#define OP_ALG_PKMODE_COPY_SSZ_A2_B1                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_2 | OP_ALG_PKMODE_DST_REG_B |                         \
   OP_ALG_PKMODE_DST_SEG_1)
#define OP_ALG_PKMODE_COPY_SSZ_A2_B2                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_2 | OP_ALG_PKMODE_DST_REG_B |                         \
   OP_ALG_PKMODE_DST_SEG_2)
#define OP_ALG_PKMODE_COPY_SSZ_A2_B3                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_2 | OP_ALG_PKMODE_DST_REG_B |                         \
   OP_ALG_PKMODE_DST_SEG_3)

#define OP_ALG_PKMODE_COPY_SSZ_A3_B0                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_3 | OP_ALG_PKMODE_DST_REG_B)
#define OP_ALG_PKMODE_COPY_SSZ_A3_B1                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_3 | OP_ALG_PKMODE_DST_REG_B |                         \
   OP_ALG_PKMODE_DST_SEG_1)
#define OP_ALG_PKMODE_COPY_SSZ_A3_B2                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_3 | OP_ALG_PKMODE_DST_REG_B |                         \
   OP_ALG_PKMODE_DST_SEG_2)
#define OP_ALG_PKMODE_COPY_SSZ_A3_B3                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_A |                          \
   OP_ALG_PKMODE_SRC_SEG_3 | OP_ALG_PKMODE_DST_REG_B |                         \
   OP_ALG_PKMODE_DST_SEG_3)

#define OP_ALG_PKMODE_COPY_SSZ_B0_A0                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_B | OP_ALG_PKMODE_DST_REG_A)
#define OP_ALG_PKMODE_COPY_SSZ_B0_A1                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_DST_REG_A | OP_ALG_PKMODE_DST_SEG_1)
#define OP_ALG_PKMODE_COPY_SSZ_B0_A2                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_DST_REG_A | OP_ALG_PKMODE_DST_SEG_2)
#define OP_ALG_PKMODE_COPY_SSZ_B0_A3                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_DST_REG_A | OP_ALG_PKMODE_DST_SEG_3)

#define OP_ALG_PKMODE_COPY_SSZ_B1_A0                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_1 | OP_ALG_PKMODE_DST_REG_A)
#define OP_ALG_PKMODE_COPY_SSZ_B1_A1                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_1 | OP_ALG_PKMODE_DST_REG_A |                         \
   OP_ALG_PKMODE_DST_SEG_1)
#define OP_ALG_PKMODE_COPY_SSZ_B1_A2                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_1 | OP_ALG_PKMODE_DST_REG_A |                         \
   OP_ALG_PKMODE_DST_SEG_2)
#define OP_ALG_PKMODE_COPY_SSZ_B1_A3                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_1 | OP_ALG_PKMODE_DST_REG_A |                         \
   OP_ALG_PKMODE_DST_SEG_3)

#define OP_ALG_PKMODE_COPY_SSZ_B2_A0                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_2 | OP_ALG_PKMODE_DST_REG_A)
#define OP_ALG_PKMODE_COPY_SSZ_B2_A1                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_2 | OP_ALG_PKMODE_DST_REG_A |                         \
   OP_ALG_PKMODE_DST_SEG_1)
#define OP_ALG_PKMODE_COPY_SSZ_B2_A2                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_2 | OP_ALG_PKMODE_DST_REG_A |                         \
   OP_ALG_PKMODE_DST_SEG_2)
#define OP_ALG_PKMODE_COPY_SSZ_B2_A3                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_2 | OP_ALG_PKMODE_DST_REG_A |                         \
   OP_ALG_PKMODE_DST_SEG_3)

#define OP_ALG_PKMODE_COPY_SSZ_B3_A0                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_3 | OP_ALG_PKMODE_DST_REG_A)
#define OP_ALG_PKMODE_COPY_SSZ_B3_A1                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_3 | OP_ALG_PKMODE_DST_REG_A |                         \
   OP_ALG_PKMODE_DST_SEG_1)
#define OP_ALG_PKMODE_COPY_SSZ_B3_A2                                           \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_B |                          \
   OP_ALG_PKMODE_SRC_SEG_3 | OP_ALG_PKMODE_DST_REG_A |                         \
   OP_ALG_PKMODE_DST_SEG_2)
...
#define OP_ALG_PKMODE_COPY_SSZ_A_B                                             \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_A | OP_ALG_PKMODE_DST_REG_B)
#define OP_ALG_PKMODE_COPY_SSZ_A_E                                             \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_A | OP_ALG_PKMODE_DST_REG_E)
#define OP_ALG_PKMODE_COPY_SSZ_A_N                                             \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_A | OP_ALG_PKMODE_DST_REG_N)
#define OP_ALG_PKMODE_COPY_SSZ_B_A                                             \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_B | OP_ALG_PKMODE_DST_REG_A)
#define OP_ALG_PKMODE_COPY_SSZ_B_E                                             \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_B | OP_ALG_PKMODE_DST_REG_E)
#define OP_ALG_PKMODE_COPY_SSZ_B_N                                             \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_B | OP_ALG_PKMODE_DST_REG_N)
#define OP_ALG_PKMODE_COPY_SSZ_N_A                                             \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_N | OP_ALG_PKMODE_DST_REG_A)
#define OP_ALG_PKMODE_COPY_SSZ_N_B                                             \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_N | OP_ALG_PKMODE_DST_REG_B)
#define OP_ALG_PKMODE_COPY_SSZ_N_E                                             \
  (OP_ALG_PKMODE_COPY_SSZ | OP_ALG_PKMODE_SRC_REG_N | OP_ALG_PKMODE_DST_REG_E)
...
#define NFIFOENTRY_STYPE_ALTSOURCE                                             \
  ((0 << NFIFOENTRY_STYPE_SHIFT) | NFIFOENTRY_AST)
#define NFIFOENTRY_STYPE_OFIFO_SYNC                                            \
  ((1 << NFIFOENTRY_STYPE_SHIFT) | NFIFOENTRY_AST)
#define NFIFOENTRY_STYPE_SNOOP_ALT                                             \
  ((3 << NFIFOENTRY_STYPE_SHIFT) | NFIFOENTRY_AST)
