 ...
 */
static inline uint64_t __bswap_48(uint64_t x) {
 ...
 */
static inline uint64_t __bswap_40(uint64_t x) {
  return ((x & 0x00000000ffULL) << 32) | ((x & 0x000000ff00ULL) << 16) |
         ((x & 0x0000ff0000ULL)) | ((x & 0x00ff000000ULL) >> 16) |
 ...
 */
static inline uint32_t __bswap_24(uint32_t x) {
  return ((x & 0x0000ffULL) << 16) | ((x & 0x00ff00ULL)) |
         ((x & 0xff0000ULL) >> 16);
}
