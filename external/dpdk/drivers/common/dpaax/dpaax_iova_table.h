...
/* APIs exposed */
__rte_internal int dpaax_iova_table_populate(void);
__rte_internal void dpaax_iova_table_depopulate(void);
__rte_internal int dpaax_iova_table_update(phys_addr_t paddr, void *vaddr,
                                           size_t length);
__rte_internal void dpaax_iova_table_dump(void);
