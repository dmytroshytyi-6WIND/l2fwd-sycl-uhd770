...
static const struct cnxk_nix_xstats_name nix_rx_xstats_rpm[] = {
    ...
    {"rpm_rx_etherStatsPkts128to255Octets", RPM_MTI_STAT_RX_128_255_PKT_CNT},
    {"rpm_rx_etherStatsPkts256to511Octets", RPM_MTI_STAT_RX_256_511_PKT_CNT},
    {"rpm_rx_etherStatsPkts512to1023Octets", RPM_MTI_STAT_RX_512_1023_PKT_CNT},
    {"rpm_rx_etherStatsPkts1024to1518Octets",
     RPM_MTI_STAT_RX_1024_1518_PKT_CNT},
    {"rpm_rx_etherStatsPkts1519toMaxOctets", RPM_MTI_STAT_RX_1519_MAX_PKT_CNT},
...
static const struct cnxk_nix_xstats_name nix_tx_xstats_rpm[] = {
    ...
    {"rpm_tx_aPAUSEMACCtrlFramesTransmitted", RPM_MTI_STAT_TX_PAUSE_MAC_CTRL},
    ...
    {"rpm_tx_etherStatsPkts256to511Octets", RPM_MTI_STAT_TX_256_511_PKT_CNT},
    {"rpm_tx_etherStatsPkts512to1023Octets", RPM_MTI_STAT_TX_512_1023_PKT_CNT},
    {"rpm_tx_etherStatsPkts1024to1518Octets",
     RPM_MTI_STAT_TX_1024_1518_PKT_CNT},
    {"rpm_tx_etherStatsPkts1519toMaxOctets", RPM_MTI_STAT_TX_1519_MAX_PKT_CNT},
    ...
    {"rpm_tx_aMACControlFramesTransmitted", RPM_MTI_STAT_TX_MAC_CONTROL_FRAMES},
...
#define CNXK_NIX_NUM_XSTATS_REG                                                \
  (CNXK_NIX_NUM_RX_XSTATS + CNXK_NIX_NUM_TX_XSTATS + CNXK_NIX_NUM_QUEUE_XSTATS)
...
static inline uint64_t roc_nix_num_rx_xstats(void) {
...
static inline uint64_t roc_nix_num_tx_xstats(void) {
  if (roc_model_is_cn9k())
