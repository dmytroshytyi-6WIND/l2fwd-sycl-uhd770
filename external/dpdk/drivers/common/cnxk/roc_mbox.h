...
#define MBOX_MESSAGES                                                          \
  ...
  M(LMTST_TBL_SETUP, 0x00a, lmtst_tbl_setup, lmtst_tbl_setup_req, msg_rsp)     \
  ...
  M(CGX_MAC_ADDR_DEL, 0x212, cgx_mac_addr_del, cgx_mac_addr_del_req, msg_rsp)  \
  M(CGX_MAC_MAX_ENTRIES_GET, 0x213, cgx_mac_max_entries_get, msg_req,          \
    cgx_max_dmac_entries_get_rsp)                                              \
  M(CGX_SET_LINK_STATE, 0x214, cgx_set_link_state, cgx_set_link_state_msg,     \
    msg_rsp)                                                                   \
  ...
  M(NPA_LF_ALLOC, 0x400, npa_lf_alloc, npa_lf_alloc_req, npa_lf_alloc_rsp)     \
  M(NPA_LF_FREE, 0x401, npa_lf_free, msg_req, msg_rsp)                         \
  M(NPA_AQ_ENQ, 0x402, npa_aq_enq, npa_aq_enq_req, npa_aq_enq_rsp)             \
  M(NPA_HWCTX_DISABLE, 0x403, npa_hwctx_disable, hwctx_disable_req, msg_rsp)   \
  /* SSO/SSOW mbox IDs (range 0x600 - 0x7FF) */                                \
  M(SSO_LF_ALLOC, 0x600, sso_lf_alloc, sso_lf_alloc_req, sso_lf_alloc_rsp)     \
  ...
  M(SSO_HW_RELEASE_XAQ, 0x611, sso_hw_release_xaq_aura, sso_hw_xaq_release,    \
    msg_rsp)                                                                   \
  /* TIM mbox IDs (range 0x800 - 0x9FF) */                                     \
  M(TIM_LF_ALLOC, 0x800, tim_lf_alloc, tim_lf_alloc_req, tim_lf_alloc_rsp)     \
  ...
  M(TIM_GET_MIN_INTVL, 0x805, tim_get_min_intvl, tim_intvl_req, tim_intvl_rsp) \
  /* CPT mbox IDs (range 0xA00 - 0xBFF) */                                     \
  M(CPT_LF_ALLOC, 0xA00, cpt_lf_alloc, cpt_lf_alloc_req_msg, msg_rsp)          \
  M(CPT_LF_FREE, 0xA01, cpt_lf_free, msg_req, msg_rsp)                         \
  M(CPT_RD_WR_REGISTER, 0xA02, cpt_rd_wr_register, cpt_rd_wr_reg_msg,          \
    cpt_rd_wr_reg_msg)                                                         \
  M(CPT_SET_CRYPTO_GRP, 0xA03, cpt_set_crypto_grp, cpt_set_crypto_grp_req_msg, \
    msg_rsp)                                                                   \
  M(CPT_INLINE_IPSEC_CFG, 0xA04, cpt_inline_ipsec_cfg,                         \
    cpt_inline_ipsec_cfg_msg, msg_rsp)                                         \
  M(CPT_STATS, 0xA05, cpt_sts_get, cpt_sts_req, cpt_sts_rsp)                   \
  M(CPT_RXC_TIME_CFG, 0xA06, cpt_rxc_time_cfg, cpt_rxc_time_cfg_req, msg_rsp)  \
  ...
  M(CPT_GET_ENG_GRP, 0xBFF, cpt_eng_grp_get, cpt_eng_grp_req, cpt_eng_grp_rsp) \
  ...
  M(NPC_MCAM_FREE_ENTRY, 0x6001, npc_mcam_free_entry, npc_mcam_free_entry_req, \
    msg_rsp)                                                                   \
  ...
  M(NPC_MCAM_ALLOC_AND_WRITE_ENTRY, 0x600b, npc_mcam_alloc_and_write_entry,    \
    npc_mcam_alloc_and_write_entry_req, npc_mcam_alloc_and_write_entry_rsp)    \
  M(NPC_GET_KEX_CFG, 0x600c, npc_get_kex_cfg, msg_req, npc_get_kex_cfg_rsp)    \
  M(NPC_INSTALL_FLOW, 0x600d, npc_install_flow, npc_install_flow_req,          \
    npc_install_flow_rsp)                                                      \
  M(NPC_DELETE_FLOW, 0x600e, npc_delete_flow, npc_delete_flow_req, msg_rsp)    \
  M(NPC_MCAM_READ_ENTRY, 0x600f, npc_mcam_read_entry, npc_mcam_read_entry_req, \
  ...
  M(NIX_LF_ALLOC, 0x8000, nix_lf_alloc, nix_lf_alloc_req, nix_lf_alloc_rsp)    \
  M(NIX_LF_FREE, 0x8001, nix_lf_free, nix_lf_free_req, msg_rsp)                \
  M(NIX_AQ_ENQ, 0x8002, nix_aq_enq, nix_aq_enq_req, nix_aq_enq_rsp)            \
  M(NIX_HWCTX_DISABLE, 0x8003, nix_hwctx_disable, hwctx_disable_req, msg_rsp)  \
  ...
  M(NIX_RSS_FLOWKEY_CFG, 0x8009, nix_rss_flowkey_cfg, nix_rss_flowkey_cfg,     \
  ...
  M(NIX_MARK_FORMAT_CFG, 0x800f, nix_mark_format_cfg, nix_mark_format_cfg,     \
  ...
  M(NIX_BP_ENABLE, 0x8016, nix_bp_enable, nix_bp_cfg_req, nix_bp_cfg_rsp)      \
  M(NIX_BP_DISABLE, 0x8017, nix_bp_disable, nix_bp_cfg_req, msg_rsp)           \
  M(NIX_GET_MAC_ADDR, 0x8018, nix_get_mac_addr, msg_req, nix_get_mac_addr_rsp) \
  M(NIX_INLINE_IPSEC_CFG, 0x8019, nix_inline_ipsec_cfg, nix_inline_ipsec_cfg,  \
    msg_rsp)                                                                   \
  ...
  M(NIX_CPT_BP_ENABLE, 0x8020, nix_cpt_bp_enable, nix_bp_cfg_req,              \
    nix_bp_cfg_rsp)                                                            \
  M(NIX_CPT_BP_DISABLE, 0x8021, nix_cpt_bp_disable, nix_bp_cfg_req, msg_rsp)
