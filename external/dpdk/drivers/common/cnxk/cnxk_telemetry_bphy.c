...
static int cnxk_tel_bphy(struct plt_tel_data *d) {
...
static int cnxk_bphy_tel_handle_info(const char *cmd __plt_unused,
...
static int cnxk_bphy_telemetry_register(void) {
