...
#define NPC_AF_KPUX_ENTRYX_CAMX(a, b, c)                                       \
  (0x100000ull | (uint64_t)(a) << 14 | (uint64_t)(b) << 6 | (uint64_t)(c) << 3)
...
#define NPC_AF_INTFX_LDATAX_FLAGSX_CFG(a, b, c)                                \
  (0x980000ull | (uint64_t)(a) << 16 | (uint64_t)(b) << 12 | (uint64_t)(c) << 3)
#define NPC_AF_MCAMEX_BANKX_CAMX_INTF(a, b, c)                                 \
  (0x1000000ull | (uint64_t)(a) << 10 | (uint64_t)(b) << 6 | (uint64_t)(c) << 3)
#define NPC_AF_MCAMEX_BANKX_CAMX_W0(a, b, c)                                   \
  (0x1000010ull | (uint64_t)(a) << 10 | (uint64_t)(b) << 6 | (uint64_t)(c) << 3)
#define NPC_AF_MCAMEX_BANKX_CAMX_W1(a, b, c)                                   \
  (0x1000020ull | (uint64_t)(a) << 10 | (uint64_t)(b) << 6 | (uint64_t)(c) << 3)
