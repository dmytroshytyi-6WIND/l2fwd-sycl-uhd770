...
static int cnxk_tel_npa(struct plt_tel_data *d) {
  struct npa_lf *lf;
  int aura_cnt = 0;
  uint32_t i;
...
static int cnxk_tel_npa_aura(int aura_id, struct plt_tel_data *d) {
...
static int cnxk_tel_npa_pool(int pool_id, struct plt_tel_data *d) {
...
static int cnxk_npa_tel_handle_info(const char *cmd __plt_unused,
...
static int cnxk_npa_tel_handle_aura_list(const char *cmd __plt_unused,
                                         const char *params __plt_unused,
                                         struct plt_tel_data *d) {
  struct npa_lf *lf;
  int i;
...
static int cnxk_npa_tel_handle_pool_list(const char *cmd, const char *params,
                                         struct plt_tel_data *d) {
  /* In current implementation, aura and pool ID mapped 1:1 */
  return cnxk_npa_tel_handle_aura_list(cmd, params, d);
}

static int cnxk_npa_tel_handle_info_x(const char *cmd, const char *params,
                                      struct plt_tel_data *d) {
  int id, rc;
...
PLT_INIT(cnxk_telemetry_npa_init) {
  plt_telemetry_register_cmd("/cnxk/npa/info", cnxk_npa_tel_handle_info,
