...
static int cnxk_tel_sso(struct plt_tel_data *d) {
...
static int cnxk_sso_tel_handle_info(const char *cmd __plt_unused,
...
PLT_INIT(cnxk_telemetry_sso_init) {
  plt_telemetry_register_cmd("/cnxk/sso/info", cnxk_sso_tel_handle_info,
