...
int roc_nix_mcast_mcam_entry_alloc(struct roc_nix *roc_nix, uint16_t nb_entries,
...
int roc_nix_mcast_mcam_entry_free(struct roc_nix *roc_nix, uint32_t index) {
  struct mbox *mbox = get_mbox(roc_nix);
...
int roc_nix_mcast_mcam_entry_write(struct roc_nix *roc_nix,
...
int roc_nix_mcast_mcam_entry_ena_dis(struct roc_nix *roc_nix, uint32_t index,
                                     bool enable) {
