...
#define CNXK_TEL_DICT_INT(d, p, s, ...)                                        \
  plt_tel_data_add_dict_int(d, CNXK_TEL_STR_PREFIX(s, __VA_ARGS__), (p)->s)
...
#define CNXK_TEL_DICT_U64(d, p, s, ...)                                        \
  plt_tel_data_add_dict_u64(d, CNXK_TEL_STR_PREFIX(s, __VA_ARGS__), (p)->s)
#define CNXK_TEL_DICT_STR(d, p, s, ...)                                        \
  plt_tel_data_add_dict_string(d, CNXK_TEL_STR_PREFIX(s, __VA_ARGS__), (p)->s)
