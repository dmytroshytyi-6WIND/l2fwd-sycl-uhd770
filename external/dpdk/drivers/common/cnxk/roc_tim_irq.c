...
static void tim_lf_irq(void *param) {
...
static int tim_lf_register_irq(uintptr_t base, struct plt_intr_handle *handle,
...
static void tim_lf_unregister_irq(uintptr_t base,
