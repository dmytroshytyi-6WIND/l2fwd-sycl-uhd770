...
static void sso_hws_dump(uintptr_t base, FILE *f) {
...
static void sso_hwgrp_dump(uintptr_t base, FILE *f) {
...
void roc_sso_dump(struct roc_sso *roc_sso, uint8_t nb_hws, uint16_t hwgrp,
                  FILE *f) {
