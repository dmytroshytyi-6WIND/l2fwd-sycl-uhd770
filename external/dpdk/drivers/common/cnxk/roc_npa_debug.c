...
static inline void npa_pool_dump(__io struct npa_pool_s *pool) {
  ...
  npa_dump("W4: fc_hyst_bits\t%d\nW4: fc_up_crossing\t%d", pool->fc_hyst_bits,
           pool->fc_up_crossing);
  ...
  npa_dump("W8: thresh_int_ena\t%d\nW8: thresh_up\t\t%d", pool->thresh_int_ena,
           pool->thresh_up);
  npa_dump("W8: thresh_qint_idx\t%d\nW8: err_qint_idx\t%d",
           pool->thresh_qint_idx, pool->err_qint_idx);
}

static inline void npa_aura_dump(__io struct npa_aura_s *aura) {
  ...
  npa_dump("W3: fc_up_crossing\t%d\nW3: fc_stype\t\t%d", aura->fc_up_crossing,
           aura->fc_stype);
