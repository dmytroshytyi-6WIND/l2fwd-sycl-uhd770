...
#define IAVF_FW_MINOR_VERSION(_h)                                              \
  ((_h)->mac.type == IAVF_MAC_XL710 ? IAVF_FW_API_VERSION_MINOR_X710           \
...
#define IAVF_CHECK_STRUCT_LEN(n, X)                                            \
  enum iavf_static_assert_enum_##X {                                           \
...
#define IAVF_AQ_VSI_PVLAN_MODE_MASK (0x03 << IAVF_AQ_VSI_PVLAN_MODE_SHIFT)
...
#define IAVF_AQ_VSI_PVLAN_EMOD_MASK (0x3 << IAVF_AQ_VSI_PVLAN_EMOD_SHIFT)
...
#define IAVF_AQ_VSI_UP_TABLE_UP0_MASK (0x7 << IAVF_AQ_VSI_UP_TABLE_UP0_SHIFT)
#define IAVF_AQ_VSI_UP_TABLE_UP1_SHIFT 3
#define IAVF_AQ_VSI_UP_TABLE_UP1_MASK (0x7 << IAVF_AQ_VSI_UP_TABLE_UP1_SHIFT)
#define IAVF_AQ_VSI_UP_TABLE_UP2_SHIFT 6
#define IAVF_AQ_VSI_UP_TABLE_UP2_MASK (0x7 << IAVF_AQ_VSI_UP_TABLE_UP2_SHIFT)
#define IAVF_AQ_VSI_UP_TABLE_UP3_SHIFT 9
#define IAVF_AQ_VSI_UP_TABLE_UP3_MASK (0x7 << IAVF_AQ_VSI_UP_TABLE_UP3_SHIFT)
#define IAVF_AQ_VSI_UP_TABLE_UP4_SHIFT 12
#define IAVF_AQ_VSI_UP_TABLE_UP4_MASK (0x7 << IAVF_AQ_VSI_UP_TABLE_UP4_SHIFT)
#define IAVF_AQ_VSI_UP_TABLE_UP5_SHIFT 15
#define IAVF_AQ_VSI_UP_TABLE_UP5_MASK (0x7 << IAVF_AQ_VSI_UP_TABLE_UP5_SHIFT)
#define IAVF_AQ_VSI_UP_TABLE_UP6_SHIFT 18
#define IAVF_AQ_VSI_UP_TABLE_UP6_MASK (0x7 << IAVF_AQ_VSI_UP_TABLE_UP6_SHIFT)
#define IAVF_AQ_VSI_UP_TABLE_UP7_SHIFT 21
#define IAVF_AQ_VSI_UP_TABLE_UP7_MASK (0x7 << IAVF_AQ_VSI_UP_TABLE_UP7_SHIFT)
  __le32 egress_table; /* same defines as for ingress table */
  /* cascaded PV section */
  __le16 cas_pv_tag;
  u8 cas_pv_flags;
#define IAVF_AQ_VSI_CAS_PV_TAGX_SHIFT 0x00
#define IAVF_AQ_VSI_CAS_PV_TAGX_MASK (0x03 << IAVF_AQ_VSI_CAS_PV_TAGX_SHIFT)
...
#define IAVF_AQ_VSI_TC_QUE_OFFSET_MASK                                         \
  (0x1FF << IAVF_AQ_VSI_TC_QUE_OFFSET_SHIFT)
#define IAVF_AQ_VSI_TC_QUE_NUMBER_SHIFT 9
#define IAVF_AQ_VSI_TC_QUE_NUMBER_MASK (0x7 << IAVF_AQ_VSI_TC_QUE_NUMBER_SHIFT)
...
#define IAVF_AQC_SET_RSS_KEY_VSI_ID_MASK                                       \
  (0x3FF << IAVF_AQC_SET_RSS_KEY_VSI_ID_SHIFT)
  __le16 vsi_id;
  u8 reserved[6];
  __le32 addr_high;
  __le32 addr_low;
...
#define IAVF_AQC_SET_RSS_LUT_VSI_ID_MASK                                       \
  (0x3FF << IAVF_AQC_SET_RSS_LUT_VSI_ID_SHIFT)
  __le16 vsi_id;
#define IAVF_AQC_SET_RSS_LUT_TABLE_TYPE_SHIFT 0
#define IAVF_AQC_SET_RSS_LUT_TABLE_TYPE_MASK                                   \
  (0x1 << IAVF_AQC_SET_RSS_LUT_TABLE_TYPE_SHIFT)
