...
#define IAVF_MDIO_CLAUSE22_STCODE_MASK                                         \
  IAVF_MASK(1, IAVF_GLGEN_MSCA_STCODE_SHIFT)
#define IAVF_MDIO_CLAUSE22_OPCODE_WRITE_MASK                                   \
  IAVF_MASK(1, IAVF_GLGEN_MSCA_OPCODE_SHIFT)
#define IAVF_MDIO_CLAUSE22_OPCODE_READ_MASK                                    \
  IAVF_MASK(2, IAVF_GLGEN_MSCA_OPCODE_SHIFT)

#define IAVF_MDIO_CLAUSE45_STCODE_MASK                                         \
  IAVF_MASK(0, IAVF_GLGEN_MSCA_STCODE_SHIFT)
#define IAVF_MDIO_CLAUSE45_OPCODE_ADDRESS_MASK                                 \
  IAVF_MASK(0, IAVF_GLGEN_MSCA_OPCODE_SHIFT)
#define IAVF_MDIO_CLAUSE45_OPCODE_WRITE_MASK                                   \
  IAVF_MASK(1, IAVF_GLGEN_MSCA_OPCODE_SHIFT)
#define IAVF_MDIO_CLAUSE45_OPCODE_READ_INC_ADDR_MASK                           \
  IAVF_MASK(2, IAVF_GLGEN_MSCA_OPCODE_SHIFT)
#define IAVF_MDIO_CLAUSE45_OPCODE_READ_MASK                                    \
  IAVF_MASK(3, IAVF_GLGEN_MSCA_OPCODE_SHIFT)
...
/* Memory types */
enum iavf_memset_type { IAVF_NONDMA_MEM = 0, IAVF_DMA_MEM };
...
#define IAVF_RXD_QW0_MIRROR_STATUS_MASK                                        \
  (0x3FUL << IAVF_RXD_QW0_MIRROR_STATUS_SHIFT)
#define IAVF_RXD_QW0_FCOEINDX_SHIFT 0
#define IAVF_RXD_QW0_FCOEINDX_MASK (0xFFFUL << IAVF_RXD_QW0_FCOEINDX_SHIFT)
...
#define IAVF_RXD_QW1_STATUS_MASK                                               \
  ((BIT(IAVF_RX_DESC_STATUS_LAST) - 1) << IAVF_RXD_QW1_STATUS_SHIFT)

#define IAVF_RXD_QW1_STATUS_TSYNINDX_SHIFT IAVF_RX_DESC_STATUS_TSYNINDX_SHIFT
#define IAVF_RXD_QW1_STATUS_TSYNINDX_MASK                                      \
  (0x3UL << IAVF_RXD_QW1_STATUS_TSYNINDX_SHIFT)
...
#define IAVF_RXD_QW1_STATUS_UMBCAST_MASK                                       \
  (0x3UL << IAVF_RXD_QW1_STATUS_UMBCAST_SHIFT)
...
#define IAVF_RXD_QW1_LENGTH_PBUF_MASK                                          \
  (0x3FFFULL << IAVF_RXD_QW1_LENGTH_PBUF_SHIFT)

#define IAVF_RXD_QW1_LENGTH_HBUF_SHIFT 52
#define IAVF_RXD_QW1_LENGTH_HBUF_MASK                                          \
  (0x7FFULL << IAVF_RXD_QW1_LENGTH_HBUF_SHIFT)
...
#define IAVF_RXD_QW2_EXT_STATUS_MASK                                           \
  (0xFFFFFUL << IAVF_RXD_QW2_EXT_STATUS_SHIFT)
...
#define IAVF_RX_PROG_STATUS_DESC_QW1_PROGID_MASK                               \
  (0x7UL << IAVF_RX_PROG_STATUS_DESC_QW1_PROGID_SHIFT)

#define IAVF_RX_PROG_STATUS_DESC_QW1_STATUS_SHIFT 0
#define IAVF_RX_PROG_STATUS_DESC_QW1_STATUS_MASK                               \
  (0x7FFFUL << IAVF_RX_PROG_STATUS_DESC_QW1_STATUS_SHIFT)

#define IAVF_RX_PROG_STATUS_DESC_QW1_ERROR_SHIFT 19
#define IAVF_RX_PROG_STATUS_DESC_QW1_ERROR_MASK                                \
  (0x3FUL << IAVF_RX_PROG_STATUS_DESC_QW1_ERROR_SHIFT)
...
#define IAVF_TXD_QW1_OFFSET_MASK (0x3FFFFULL << IAVF_TXD_QW1_OFFSET_SHIFT)
...
#define IAVF_TXD_QW1_TX_BUF_SZ_MASK (0x3FFFULL << IAVF_TXD_QW1_TX_BUF_SZ_SHIFT)
...
#define IAVF_TXD_FLTR_QW1_ATR_SHIFT (0xEULL + IAVF_TXD_FLTR_QW1_CMD_SHIFT)
...
#define IAVF_TXD_CTX_QW1_TSO_LEN_MASK                                          \
  (0x3FFFFULL << IAVF_TXD_CTX_QW1_TSO_LEN_SHIFT)

#define IAVF_TXD_CTX_QW1_MSS_SHIFT 50
#define IAVF_TXD_CTX_QW1_MSS_MASK (0x3FFFULL << IAVF_TXD_CTX_QW1_MSS_SHIFT)
...
#define IAVF_TXD_CTX_QW0_EXT_IP_MASK (0x3ULL << IAVF_TXD_CTX_QW0_EXT_IP_SHIFT)
...
#define IAVF_TXD_CTX_QW0_EXT_IPLEN_MASK                                        \
  (0x3FULL << IAVF_TXD_CTX_QW0_EXT_IPLEN_SHIFT)
...
#define IAVF_TXD_CTX_QW0_NATLEN_MASK (0X7FULL << IAVF_TXD_CTX_QW0_NATLEN_SHIFT)

#define IAVF_TXD_CTX_QW0_DECTTL_SHIFT 19
#define IAVF_TXD_CTX_QW0_DECTTL_MASK (0xFULL << IAVF_TXD_CTX_QW0_DECTTL_SHIFT)
