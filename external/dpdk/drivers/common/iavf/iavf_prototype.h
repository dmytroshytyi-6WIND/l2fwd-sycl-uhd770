...
/* adminq functions */
__rte_internal enum iavf_status iavf_init_adminq(struct iavf_hw *hw);
__rte_internal enum iavf_status iavf_shutdown_adminq(struct iavf_hw *hw);
...
__rte_internal enum iavf_status
...
enum iavf_status iavf_aq_get_rss_lut(struct iavf_hw *hw, u16 seid, bool pf_lut,
                                     u8 *lut, u16 lut_size);
enum iavf_status iavf_aq_set_rss_lut(struct iavf_hw *hw, u16 seid, bool pf_lut,
                                     u8 *lut, u16 lut_size);
...
__rte_internal enum iavf_status iavf_set_mac_type(struct iavf_hw *hw);
