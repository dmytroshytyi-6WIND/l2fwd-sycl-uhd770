...
static inline void prefetch_read_many(const volatile void *addr) {
  rte_prefetch0(addr);
}

static inline void prefetch_read_once(const volatile void *addr) {
...
#define EFSYS_PROBE3(_name, _type1, _arg1, _type2, _arg2, _type3, _arg3)       \
  do {                                                                         \
  } while (0)

#define EFSYS_PROBE4(_name, _type1, _arg1, _type2, _arg2, _type3, _arg3,       \
                     _type4, _arg4)                                            \
  do {                                                                         \
  } while (0)

#define EFSYS_PROBE5(_name, _type1, _arg1, _type2, _arg2, _type3, _arg3,       \
                     _type4, _arg4, _type5, _arg5)                             \
  do {                                                                         \
  } while (0)

#define EFSYS_PROBE6(_name, _type1, _arg1, _type2, _arg2, _type3, _arg3,       \
                     _type4, _arg4, _type5, _arg5, _type6, _arg6)              \
  do {                                                                         \
  } while (0)

#define EFSYS_PROBE7(_name, _type1, _arg1, _type2, _arg2, _type3, _arg3,       \
                     _type4, _arg4, _type5, _arg5, _type6, _arg6, _type7,      \
                     _arg7)                                                    \
  do {                                                                         \
  } while (0)
...
#define EFSYS_MEM_READD(_esmp, _offset, _edp)                                  \
  do {                                                                         \
    ...
    volatile uint32_t *_addr;                                                  \
                                                                               \
    _NOTE(CONSTANTCONDITION);                                                  \
    SFC_EFX_ASSERT(EFX_IS_P2ALIGNED(size_t, _offset, sizeof(efx_dword_t)));    \
                                                                               \
    _addr = (volatile uint32_t *)(_base + (_offset));                          \
    (_edp)->ed_u32[0] = _addr[0];                                              \
                                                                               \
    EFSYS_PROBE2(mem_readl, unsigned int, (_offset), uint32_t,                 \
                 (_edp)->ed_u32[0]);                                           \
                                                                               \
    _NOTE(CONSTANTCONDITION);                                                  \
  } while (B_FALSE)
...
#define EFSYS_MEM_READQ(_esmp, _offset, _eqp)                                  \
  do {                                                                         \
    ...
    volatile uint64_t *_addr;                                                  \
                                                                               \
    _NOTE(CONSTANTCONDITION);                                                  \
    SFC_EFX_ASSERT(EFX_IS_P2ALIGNED(size_t, _offset, sizeof(efx_qword_t)));    \
                                                                               \
    _addr = (volatile uint64_t *)(_base + (_offset));                          \
    (_eqp)->eq_u64[0] = _addr[0];                                              \
                                                                               \
    EFSYS_PROBE3(mem_readq, unsigned int, (_offset), uint32_t,                 \
                 (_eqp)->eq_u32[1], uint32_t, (_eqp)->eq_u32[0]);              \
                                                                               \
    _NOTE(CONSTANTCONDITION);                                                  \
  } while (B_FALSE)
...
#define EFSYS_MEM_READO(_esmp, _offset, _eop)                                  \
  do {                                                                         \
    ...
    volatile efsys_uint128_t *_addr;                                           \
                                                                               \
    _NOTE(CONSTANTCONDITION);                                                  \
    SFC_EFX_ASSERT(EFX_IS_P2ALIGNED(size_t, _offset, sizeof(efx_oword_t)));    \
                                                                               \
    _addr = (volatile efsys_uint128_t *)(_base + (_offset));                   \
    (_eop)->eo_u128[0] = _addr[0];                                             \
                                                                               \
    EFSYS_PROBE5(mem_reado, unsigned int, (_offset), uint32_t,                 \
                 (_eop)->eo_u32[3], uint32_t, (_eop)->eo_u32[2], uint32_t,     \
                 (_eop)->eo_u32[1], uint32_t, (_eop)->eo_u32[0]);              \
                                                                               \
    _NOTE(CONSTANTCONDITION);                                                  \
  } while (B_FALSE)
...
#define EFSYS_MEM_WRITED(_esmp, _offset, _edp)                                 \
  do {                                                                         \
    ...
    SFC_EFX_ASSERT(EFX_IS_P2ALIGNED(size_t, _offset, sizeof(efx_dword_t)));    \
                                                                               \
    EFSYS_PROBE2(mem_writed, unsigned int, (_offset), uint32_t,                \
                 (_edp)->ed_u32[0]);                                           \
                                                                               \
    _addr = (volatile uint32_t *)(_base + (_offset));                          \
...
#define EFSYS_MEM_WRITEQ(_esmp, _offset, _eqp)                                 \
  do {                                                                         \
    ...
    SFC_EFX_ASSERT(EFX_IS_P2ALIGNED(size_t, _offset, sizeof(efx_qword_t)));    \
                                                                               \
    EFSYS_PROBE3(mem_writeq, unsigned int, (_offset), uint32_t,                \
                 (_eqp)->eq_u32[1], uint32_t, (_eqp)->eq_u32[0]);              \
                                                                               \
    _addr = (volatile uint64_t *)(_base + (_offset));                          \
...
#define EFSYS_MEM_WRITEO(_esmp, _offset, _eop)                                 \
  do {                                                                         \
    ...
    SFC_EFX_ASSERT(EFX_IS_P2ALIGNED(size_t, _offset, sizeof(efx_oword_t)));    \
                                                                               \
    EFSYS_PROBE5(mem_writeo, unsigned int, (_offset), uint32_t,                \
                 (_eop)->eo_u32[3], uint32_t, (_eop)->eo_u32[2], uint32_t,     \
                 (_eop)->eo_u32[1], uint32_t, (_eop)->eo_u32[0]);              \
                                                                               \
    _addr = (volatile efsys_uint128_t *)(_base + (_offset));                   \
...
#define EFSYS_MEM_SIZE(_esmp) ((_esmp)->esm_mz->len)

#define EFSYS_MEM_ADDR(_esmp) ((_esmp)->esm_addr)
...
#define EFSYS_BAR_READD(_esbp, _offset, _edp, _lock)                           \
  do {                                                                         \
    ...
    (_edp)->ed_u32[0] = rte_read32_relaxed(_addr);                             \
                                                                               \
    EFSYS_PROBE2(bar_readd, unsigned int, (_offset), uint32_t,                 \
                 (_edp)->ed_u32[0]);                                           \
                                                                               \
    _NOTE(CONSTANTCONDITION);                                                  \
    if (_lock)                                                                 \
...
#define EFSYS_BAR_READQ(_esbp, _offset, _eqp)                                  \
  do {                                                                         \
    ...
    (_eqp)->eq_u64[0] = rte_read64_relaxed(_addr);                             \
                                                                               \
    EFSYS_PROBE3(bar_readq, unsigned int, (_offset), uint32_t,                 \
                 (_eqp)->eq_u32[1], uint32_t, (_eqp)->eq_u32[0]);              \
                                                                               \
    SFC_BAR_UNLOCK(_esbp);                                                     \
    _NOTE(CONSTANTCONDITION);                                                  \
...
#define EFSYS_BAR_READO(_esbp, _offset, _eop, _lock)                           \
  do {                                                                         \
    ...
    (_eop)->eo_u128[0] = _addr[0];                                             \
                                                                               \
    EFSYS_PROBE5(bar_reado, unsigned int, (_offset), uint32_t,                 \
                 (_eop)->eo_u32[3], uint32_t, (_eop)->eo_u32[2], uint32_t,     \
                 (_eop)->eo_u32[1], uint32_t, (_eop)->eo_u32[0]);              \
                                                                               \
    _NOTE(CONSTANTCONDITION);                                                  \
...
#define EFSYS_BAR_WRITED(_esbp, _offset, _edp, _lock)                          \
  do {                                                                         \
    ...
    if (_lock)                                                                 \
      SFC_BAR_LOCK(_esbp);                                                     \
                                                                               \
    EFSYS_PROBE2(bar_writed, unsigned int, (_offset), uint32_t,                \
                 (_edp)->ed_u32[0]);                                           \
                                                                               \
    _addr = (volatile uint32_t *)(_base + (_offset));                          \
...
#define EFSYS_BAR_WRITEQ(_esbp, _offset, _eqp)                                 \
  do {                                                                         \
    ...
    SFC_BAR_LOCK(_esbp);                                                       \
                                                                               \
    EFSYS_PROBE3(bar_writeq, unsigned int, (_offset), uint32_t,                \
                 (_eqp)->eq_u32[1], uint32_t, (_eqp)->eq_u32[0]);              \
                                                                               \
    _addr = (volatile uint64_t *)(_base + (_offset));                          \
...
#define EFSYS_BAR_WRITEO(_esbp, _offset, _eop, _lock)                          \
  do {                                                                         \
    ...
    if (_lock)                                                                 \
      SFC_BAR_LOCK(_esbp);                                                     \
                                                                               \
    EFSYS_PROBE5(bar_writeo, unsigned int, (_offset), uint32_t,                \
                 (_eop)->eo_u32[3], uint32_t, (_eop)->eo_u32[2], uint32_t,     \
                 (_eop)->eo_u32[1], uint32_t, (_eop)->eo_u32[0]);              \
                                                                               \
    _addr = (volatile efsys_uint128_t *)(_base + (_offset));                   \
...
#define EFSYS_TIMESTAMP(_usp)                                                  \
  do {                                                                         \
    *(_usp) = rte_get_timer_cycles() * 1000000 / rte_get_timer_hz();           \
    _NOTE(CONSTANTCONDITION);                                                  \
  } while (B_FALSE)
...
#define SFC_EFSYS_LOCK_INIT(_eslp, _ifname, _label) rte_spinlock_init((_eslp))
#define SFC_EFSYS_LOCK_DESTROY(_eslp) ((void)0)
#define SFC_EFSYS_LOCK(_eslp) rte_spinlock_lock((_eslp))
#define SFC_EFSYS_UNLOCK(_eslp) rte_spinlock_unlock((_eslp))
...
#define EFSYS_ERR(_esip, _code, _dword0, _dword1)                              \
  do {                                                                         \
    (void)(_esip);                                                             \
    SFC_EFX_LOG(ERR, "FATAL ERROR #%u (0x%08x%08x)", (_code), (_dword0),       \
                (_dword1));                                                    \
    _NOTE(CONSTANTCONDITION);                                                  \
  } while (B_FALSE)
#endif
