...
static __checkReturn efx_rc_t medford2_nic_get_required_pcie_bandwidth(
...
__checkReturn efx_rc_t medford2_board_cfg(__in efx_nic_t *enp) {
   ...
   */
  rc = efx_mcdi_set_workaround(enp, MC_CMD_WORKAROUND_BUG61265, B_TRUE, NULL);
  if ((rc == 0) || (rc == EACCES))
