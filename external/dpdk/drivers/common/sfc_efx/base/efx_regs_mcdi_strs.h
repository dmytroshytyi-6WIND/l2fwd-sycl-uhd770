...
#define MC_CMD_SENSOR_PAGE0_NEXT_ENUM_STR                                      \
  "Not a sensor: reserved for the next page flag"
#define MC_CMD_SENSOR_IN_0V9_ADC_ENUM_STR "0.9v power voltage (at ADC): mV"
#define MC_CMD_SENSOR_CONTROLLER_2_TEMP_ENUM_STR                               \
  "Controller temperature 2: degC"
#define MC_CMD_SENSOR_VREG_INTERNAL_TEMP_ENUM_STR                              \
  "Voltage regulator internal temperature: degC"
#define MC_CMD_SENSOR_VREG_0V9_TEMP_ENUM_STR                                   \
  "0.9V voltage regulator temperature: degC"
#define MC_CMD_SENSOR_VREG_1V2_TEMP_ENUM_STR                                   \
  "1.2V voltage regulator temperature: degC"
#define MC_CMD_SENSOR_CONTROLLER_VPTAT_ENUM_STR                                \
  "controller internal temperature sensor voltage (internal ADC): mV"
#define MC_CMD_SENSOR_CONTROLLER_INTERNAL_TEMP_ENUM_STR                        \
  "controller internal temperature (internal ADC): degC"
#define MC_CMD_SENSOR_CONTROLLER_VPTAT_EXTADC_ENUM_STR                         \
  "controller internal temperature sensor voltage (external ADC): mV"
#define MC_CMD_SENSOR_CONTROLLER_INTERNAL_TEMP_EXTADC_ENUM_STR                 \
...
#define MC_CMD_SENSOR_VDD08D_VSS08D_CSR_ENUM_STR                               \
  "voltage between VSS08D and VSS08D at CSR: mV"
#define MC_CMD_SENSOR_VDD08D_VSS08D_CSR_EXTADC_ENUM_STR                        \
...
#define MC_CMD_SENSOR_PHY_POWER_PORT0_ENUM_STR                                 \
  "Port 0 PHY power switch over-current: bool"
#define MC_CMD_SENSOR_PHY_POWER_PORT1_ENUM_STR                                 \
  "Port 1 PHY power switch over-current: bool"
#define MC_CMD_SENSOR_MUM_VCC_ENUM_STR                                         \
  "Mop-up microcontroller reference voltage: mV"
...
#define MC_CMD_SENSOR_VREG_0V9_A_TEMP_ENUM_STR                                 \
...
#define MC_CMD_SENSOR_VREG_0V9_B_TEMP_ENUM_STR                                 \
  "0.9V voltage regulator phase B temperature: degC"
#define MC_CMD_SENSOR_CCOM_AVREG_1V2_SUPPLY_ENUM_STR                           \
  "CCOM AVREG 1v2 supply (interval ADC): mV"
#define MC_CMD_SENSOR_CCOM_AVREG_1V2_SUPPLY_EXTADC_ENUM_STR                    \
  "CCOM AVREG 1v2 supply (external ADC): mV"
#define MC_CMD_SENSOR_CCOM_AVREG_1V8_SUPPLY_ENUM_STR                           \
  "CCOM AVREG 1v8 supply (interval ADC): mV"
#define MC_CMD_SENSOR_CCOM_AVREG_1V8_SUPPLY_EXTADC_ENUM_STR                    \
  "CCOM AVREG 1v8 supply (external ADC): mV"
#define MC_CMD_SENSOR_CONTROLLER_RTS_ENUM_STR "CCOM RTS temperature: degC"
#define MC_CMD_SENSOR_PAGE1_NEXT_ENUM_STR                                      \
  "Not a sensor: reserved for the next page flag"
#define MC_CMD_SENSOR_CONTROLLER_MASTER_VPTAT_ENUM_STR                         \
  "controller internal temperature sensor voltage on master core (internal "   \
  "ADC): mV"
#define MC_CMD_SENSOR_CONTROLLER_MASTER_INTERNAL_TEMP_ENUM_STR                 \
  "controller internal temperature on master core (internal ADC): degC"
#define MC_CMD_SENSOR_CONTROLLER_MASTER_VPTAT_EXTADC_ENUM_STR                  \
  "controller internal temperature sensor voltage on master core (external "   \
  "ADC): mV"
#define MC_CMD_SENSOR_CONTROLLER_MASTER_INTERNAL_TEMP_EXTADC_ENUM_STR          \
  "controller internal temperature on master core (external ADC): degC"
#define MC_CMD_SENSOR_CONTROLLER_SLAVE_VPTAT_ENUM_STR                          \
  "controller internal temperature on slave core sensor voltage (internal "    \
  "ADC): mV"
#define MC_CMD_SENSOR_CONTROLLER_SLAVE_INTERNAL_TEMP_ENUM_STR                  \
  "controller internal temperature on slave core (internal ADC): degC"
#define MC_CMD_SENSOR_CONTROLLER_SLAVE_VPTAT_EXTADC_ENUM_STR                   \
  "controller internal temperature on slave core sensor voltage (external "    \
  "ADC): mV"
#define MC_CMD_SENSOR_CONTROLLER_SLAVE_INTERNAL_TEMP_EXTADC_ENUM_STR           \
  "controller internal temperature on slave core (external ADC): degC"
#define MC_CMD_SENSOR_SODIMM_VOUT_ENUM_STR                                     \
  "Voltage supplied to the SODIMMs from their power supply: mV"
#define MC_CMD_SENSOR_SODIMM_0_TEMP_ENUM_STR                                   \
  "Temperature of SODIMM 0 (if installed): degC"
#define MC_CMD_SENSOR_SODIMM_1_TEMP_ENUM_STR                                   \
  "Temperature of SODIMM 1 (if installed): degC"
#define MC_CMD_SENSOR_PHY0_VCC_ENUM_STR                                        \
  "Voltage supplied to the QSFP #0 from their power supply: mV"
#define MC_CMD_SENSOR_PHY1_VCC_ENUM_STR                                        \
  "Voltage supplied to the QSFP #1 from their power supply: mV"
#define MC_CMD_SENSOR_CONTROLLER_TDIODE_TEMP_ENUM_STR                          \
  "Controller die temperature (TDIODE): degC"
#define MC_CMD_SENSOR_BOARD_FRONT_TEMP_ENUM_STR                                \
  "Board temperature (front): degC"
