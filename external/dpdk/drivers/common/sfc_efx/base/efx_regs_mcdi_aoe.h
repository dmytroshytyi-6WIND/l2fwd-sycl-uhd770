...
#define MC_CMD_FC_OUT_MAC_GET_RX_STATS_LEN                                     \
  ((((0 - 1 + (64 * MC_CMD_FC_MAC_RX_NSTATS)) + 1)) >> 3)
...
#define MC_CMD_FC_OUT_MAC_GET_TX_STATS_LEN                                     \
  ((((0 - 1 + (64 * MC_CMD_FC_MAC_TX_NSTATS)) + 1)) >> 3)
...
#define MC_CMD_FC_OUT_MAC_GET_STATS_LEN                                        \
  ((((0 - 1 + (64 * MC_CMD_FC_MAC_NSTATS_PER_BLOCK)) + 1)) >> 3)
/* MAC Statistics */
...
#define MC_CMD_FC_OUT_MAC_GET_STATS_STATISTICS_NUM                             \
  MC_CMD_FC_MAC_NSTATS_PER_BLOCK
...
#define MC_CMD_FC_OUT_UHLINK_RX_EYE_LEN                                        \
  ((((0 - 1 + (32 * MC_CMD_FC_UHLINK_RX_EYE_PER_BLOCK)) + 1)) >> 3)
/* Rx Eye measurements */
...
#define MC_CMD_FC_OUT_UHLINK_READ_RX_EYE_PLOT_LEN                              \
  ((((32 - 1 + (64 * MC_CMD_FC_UHLINK_RX_EYE_PLOT_ROWS_PER_BLOCK)) + 1)) >> 3)
...
#define MC_CMD_FC_OUT_UHLINK_READ_RX_EYE_PLOT_ROWS_NUM                         \
  MC_CMD_FC_UHLINK_RX_EYE_PLOT_ROWS_PER_BLOCK
