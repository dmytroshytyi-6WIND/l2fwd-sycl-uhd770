...
#define EFX_VAL(_field, _attribute) _field##_##_attribute

/* Lowest bit number of the specified field */
#define EFX_LOW_BIT(_field) EFX_VAL(_field, LBN)

/* Width of the specified field */
#define EFX_WIDTH(_field) EFX_VAL(_field, WIDTH)

/* Highest bit number of the specified field */
#define EFX_HIGH_BIT(_field) (EFX_LOW_BIT(_field) + EFX_WIDTH(_field) - 1)
 ...
 */
#define EFX_MASK8(_field) ((uint8_t)((1 << EFX_WIDTH(_field)) - 1))
...
#define __SWAP16(_x) ((((_x)&0xff) << 8) | (((_x) >> 8) & 0xff))

#define __SWAP32(_x)                                                           \
  ((__SWAP16((_x)&0xffff) << 16) | __SWAP16(((_x) >> 16) & 0xffff))

#define __SWAP64(_x)                                                           \
  ((__SWAP32((_x)&0xffffffff) << 32) | __SWAP32(((_x) >> 32) & 0xffffffff))
...
#define EFX_BYTE_VAL(_byte) ((unsigned int)__NATIVE_8((_byte).eb_u8[0]))

/* Parameters for printing an efx_word_t */
#define EFX_WORD_VAL(_word) ((unsigned int)__LE_TO_CPU_16((_word).ew_u16[0]))

/* Parameters for printing an efx_dword_t */
#define EFX_DWORD_VAL(_dword) ((unsigned int)__LE_TO_CPU_32((_dword).ed_u32[0]))
 ...
 * shift count.
 */
#define EFX_SSUB(_val, _sub) ((_val) > (_sub) ? ((_val) - (_sub)) : 0)
...
#define EFX_EXTRACT_NATIVE(_element, _min, _max, _low, _high)                  \
  ((FIX_LINT(_low > _max) || FIX_LINT(_high < _min))                           \
       ? 0U                                                                    \
       : ((_low > _min) ? ((_element) >> EFX_SSUB(_low, _min))                 \
...
#define EFX_EXTRACT_XWORD64(_xword, _low, _high)                               \
  (EFX_EXTRACT64((_xword).ex_u64[0], FIX_LINT(0), FIX_LINT(63), _low, _high) | \
   EFX_EXTRACT64((_xword).ex_u64[1], FIX_LINT(64), FIX_LINT(127), _low,        \
                 _high) |                                                      \
   EFX_EXTRACT64((_xword).ex_u64[2], FIX_LINT(128), FIX_LINT(191), _low,       \
                 _high) |                                                      \
   EFX_EXTRACT64((_xword).ex_u64[3], FIX_LINT(192), FIX_LINT(255), _low,       \
                 _high))

#define EFX_EXTRACT_XWORD32(_xword, _low, _high)                               \
  (EFX_EXTRACT32((_xword).ex_u32[0], FIX_LINT(0), FIX_LINT(31), _low, _high) | \
   EFX_EXTRACT32((_xword).ex_u32[1], FIX_LINT(32), FIX_LINT(63), _low,         \
                 _high) |                                                      \
   EFX_EXTRACT32((_xword).ex_u32[2], FIX_LINT(64), FIX_LINT(95), _low,         \
                 _high) |                                                      \
   EFX_EXTRACT32((_xword).ex_u32[3], FIX_LINT(96), FIX_LINT(127), _low,        \
                 _high) |                                                      \
   EFX_EXTRACT32((_xword).ex_u32[4], FIX_LINT(128), FIX_LINT(159), _low,       \
                 _high) |                                                      \
   EFX_EXTRACT32((_xword).ex_u32[5], FIX_LINT(160), FIX_LINT(191), _low,       \
                 _high) |                                                      \
   EFX_EXTRACT32((_xword).ex_u32[6], FIX_LINT(192), FIX_LINT(223), _low,       \
                 _high) |                                                      \
   EFX_EXTRACT32((_xword).ex_u32[7], FIX_LINT(224), FIX_LINT(255), _low,       \
                 _high))

#define EFX_EXTRACT_OWORD64(_oword, _low, _high)                               \
  (EFX_EXTRACT64((_oword).eo_u64[0], FIX_LINT(0), FIX_LINT(63), _low, _high) | \
   EFX_EXTRACT64((_oword).eo_u64[1], FIX_LINT(64), FIX_LINT(127), _low,        \
                 _high))

#define EFX_EXTRACT_OWORD32(_oword, _low, _high)                               \
  (EFX_EXTRACT32((_oword).eo_u32[0], FIX_LINT(0), FIX_LINT(31), _low, _high) | \
   EFX_EXTRACT32((_oword).eo_u32[1], FIX_LINT(32), FIX_LINT(63), _low,         \
                 _high) |                                                      \
   EFX_EXTRACT32((_oword).eo_u32[2], FIX_LINT(64), FIX_LINT(95), _low,         \
                 _high) |                                                      \
   EFX_EXTRACT32((_oword).eo_u32[3], FIX_LINT(96), FIX_LINT(127), _low,        \
                 _high))
...
#define EFX_EXTRACT_WORD(_word, _low, _high)                                   \
  (EFX_EXTRACT16((_word).ew_u16[0], FIX_LINT(0), FIX_LINT(15), _low, _high))
...
#define EFX_XWORD_FIELD32(_xword, _field)                                      \
  (EFX_EXTRACT_XWORD32(_xword, EFX_LOW_BIT(_field), EFX_HIGH_BIT(_field)) &    \
   EFX_MASK32(_field))
...
#define EFX_OWORD_FIELD32(_oword, _field)                                      \
  (EFX_EXTRACT_OWORD32(_oword, EFX_LOW_BIT(_field), EFX_HIGH_BIT(_field)) &    \
   EFX_MASK32(_field))
...
#define EFX_QWORD_FIELD32(_qword, _field)                                      \
  (EFX_EXTRACT_QWORD32(_qword, EFX_LOW_BIT(_field), EFX_HIGH_BIT(_field)) &    \
   EFX_MASK32(_field))

#define EFX_DWORD_FIELD(_dword, _field)                                        \
  (EFX_EXTRACT_DWORD(_dword, EFX_LOW_BIT(_field), EFX_HIGH_BIT(_field)) &      \
   EFX_MASK32(_field))

#define EFX_WORD_FIELD(_word, _field)                                          \
  (EFX_EXTRACT_WORD(_word, EFX_LOW_BIT(_field), EFX_HIGH_BIT(_field)) &        \
   EFX_MASK16(_field))

#define EFX_BYTE_FIELD(_byte, _field)                                          \
  (EFX_EXTRACT_BYTE(_byte, EFX_LOW_BIT(_field), EFX_HIGH_BIT(_field)) &        \
   EFX_MASK8(_field))
...
#define EFX_XWORD_IS_ZERO64(_xword)                                            \
  (((_xword).ex_u64[0] | (_xword).ex_u64[1] | (_xword).ex_u64[2] |             \
    (_xword).ex_u64[3]) == 0)

#define EFX_XWORD_IS_ZERO32(_xword)                                            \
  (((_xword).ex_u32[0] | (_xword).ex_u32[1] | (_xword).ex_u32[2] |             \
    (_xword).ex_u32[3] | (_xword).ex_u32[4] | (_xword).ex_u32[5] |             \
    (_xword).ex_u32[6] | (_xword).ex_u32[7]) == 0)

#define EFX_OWORD_IS_ZERO64(_oword)                                            \
  (((_oword).eo_u64[0] | (_oword).eo_u64[1]) == 0)

#define EFX_OWORD_IS_ZERO32(_oword)                                            \
  (((_oword).eo_u32[0] | (_oword).eo_u32[1] | (_oword).eo_u32[2] |             \
    (_oword).eo_u32[3]) == 0)

#define EFX_QWORD_IS_ZERO64(_qword) (((_qword).eq_u64[0]) == 0)

#define EFX_QWORD_IS_ZERO32(_qword)                                            \
  (((_qword).eq_u32[0] | (_qword).eq_u32[1]) == 0)

#define EFX_DWORD_IS_ZERO(_dword) (((_dword).ed_u32[0]) == 0)

#define EFX_WORD_IS_ZERO(_word) (((_word).ew_u16[0]) == 0)

#define EFX_BYTE_IS_ZERO(_byte) (((_byte).eb_u8[0]) == 0)
...
#define EFX_XWORD_IS_SET32(_xword)                                             \
  (((_xword).ex_u32[0] & (_xword).ex_u32[1] & (_xword).ex_u32[2] &             \
    (_xword).ex_u32[3] & (_xword).ex_u32[4] & (_xword).ex_u32[5] &             \
    (_xword).ex_u32[6] & (_xword).ex_u32[7]) == ~((uint32_t)0))

#define EFX_OWORD_IS_SET64(_oword)                                             \
  (((_oword).eo_u64[0] & (_oword).eo_u64[1]) == ~((uint64_t)0))

#define EFX_OWORD_IS_SET32(_oword)                                             \
  (((_oword).eo_u32[0] & (_oword).eo_u32[1] & (_oword).eo_u32[2] &             \
    (_oword).eo_u32[3]) == ~((uint32_t)0))

#define EFX_QWORD_IS_SET64(_qword) (((_qword).eq_u64[0]) == ~((uint64_t)0))

#define EFX_QWORD_IS_SET32(_qword)                                             \
  (((_qword).eq_u32[0] & (_qword).eq_u32[1]) == ~((uint32_t)0))

#define EFX_DWORD_IS_SET(_dword) ((_dword).ed_u32[0] == ~((uint32_t)0))

#define EFX_WORD_IS_SET(_word) ((_word).ew_u16[0] == ~((uint16_t)0))

#define EFX_BYTE_IS_SET(_byte) ((_byte).eb_u8[0] == ~((uint8_t)0))
...
#define EFX_INSERT_FIELD_NATIVE64(_min, _max, _field, _value)                  \
  EFX_INSERT_NATIVE64(_min, _max, EFX_LOW_BIT(_field), EFX_HIGH_BIT(_field),   \
                      _value)

#define EFX_INSERT_FIELD_NATIVE32(_min, _max, _field, _value)                  \
  EFX_INSERT_NATIVE32(_min, _max, EFX_LOW_BIT(_field), EFX_HIGH_BIT(_field),   \
                      _value)

#define EFX_INSERT_FIELD_NATIVE16(_min, _max, _field, _value)                  \
  EFX_INSERT_NATIVE16(_min, _max, EFX_LOW_BIT(_field), EFX_HIGH_BIT(_field),   \
                      _value)

#define EFX_INSERT_FIELD_NATIVE8(_min, _max, _field, _value)                   \
  EFX_INSERT_NATIVE8(_min, _max, EFX_LOW_BIT(_field), EFX_HIGH_BIT(_field),    \
                     _value)
...
#define EFX_INSERT_FIELDS64(                                                   \
    _min, _max, _field1, _value1, _field2, _value2, _field3, _value3, _field4, \
    _value4, _field5, _value5, _field6, _value6, _field7, _value7, _field8,    \
    _value8, _field9, _value9, _field10, _value10)                             \
  __CPU_TO_LE_64(EFX_INSERT_FIELD_NATIVE64(_min, _max, _field1, _value1) |     \
...
#define EFX_INSERT_FIELDS32(                                                   \
    ...
    _value4, _field5, _value5, _field6, _value6, _field7, _value7, _field8,    \
    _value8, _field9, _value9, _field10, _value10)                             \
  __CPU_TO_LE_32(EFX_INSERT_FIELD_NATIVE32(_min, _max, _field1, _value1) |     \
...
#define EFX_INSERT_FIELDS16(                                                   \
    _min, _max, _field1, _value1, _field2, _value2, _field3, _value3, _field4, \
    _value4, _field5, _value5, _field6, _value6, _field7, _value7, _field8,    \
    _value8, _field9, _value9, _field10, _value10)                             \
  __CPU_TO_LE_16(EFX_INSERT_FIELD_NATIVE16(_min, _max, _field1, _value1) |     \
...
#define EFX_INSERT_FIELDS8(                                                    \
    ...
    _value4, _field5, _value5, _field6, _value6, _field7, _value7, _field8,    \
    _value8, _field9, _value9, _field10, _value10)                             \
  __NATIVE_8(EFX_INSERT_FIELD_NATIVE8(_min, _max, _field1, _value1) |          \
...
#define EFX_POPULATE_XWORD64(                                                  \
    _xword, _field1, _value1, _field2, _value2, _field3, _value3, _field4,     \
    _value4, _field5, _value5, _field6, _value6, _field7, _value7, _field8,    \
    _value8, _field9, _value9, _field10, _value10)                             \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u64[0] = EFX_INSERT_FIELDS64(                                  \
        0, 63, _field1, _value1, _field2, _value2, _field3, _value3, _field4,  \
        _value4, _field5, _value5, _field6, _value6, _field7, _value7,         \
        _field8, _value8, _field9, _value9, _field10, _value10);               \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u64[1] = EFX_INSERT_FIELDS64(                                  \
        64, 127, _field1, _value1, _field2, _value2, _field3, _value3,         \
        _field4, _value4, _field5, _value5, _field6, _value6, _field7,         \
        _value7, _field8, _value8, _field9, _value9, _field10, _value10);      \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u64[2] = EFX_INSERT_FIELDS64(                                  \
        128, 191, _field1, _value1, _field2, _value2, _field3, _value3,        \
        _field4, _value4, _field5, _value5, _field6, _value6, _field7,         \
        _value7, _field8, _value8, _field9, _value9, _field10, _value10);      \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u64[3] = EFX_INSERT_FIELDS64(                                  \
        192, 255, _field1, _value1, _field2, _value2, _field3, _value3,        \
        _field4, _value4, _field5, _value5, _field6, _value6, _field7,         \
        _value7, _field8, _value8, _field9, _value9, _field10, _value10);      \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)

#define EFX_POPULATE_XWORD32(                                                  \
    _xword, _field1, _value1, _field2, _value2, _field3, _value3, _field4,     \
    _value4, _field5, _value5, _field6, _value6, _field7, _value7, _field8,    \
    _value8, _field9, _value9, _field10, _value10)                             \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u32[0] = EFX_INSERT_FIELDS32(                                  \
        0, 31, _field1, _value1, _field2, _value2, _field3, _value3, _field4,  \
        _value4, _field5, _value5, _field6, _value6, _field7, _value7,         \
        _field8, _value8, _field9, _value9, _field10, _value10);               \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u32[1] = EFX_INSERT_FIELDS32(                                  \
        32, 63, _field1, _value1, _field2, _value2, _field3, _value3, _field4, \
        _value4, _field5, _value5, _field6, _value6, _field7, _value7,         \
        _field8, _value8, _field9, _value9, _field10, _value10);               \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u32[2] = EFX_INSERT_FIELDS32(                                  \
        64, 95, _field1, _value1, _field2, _value2, _field3, _value3, _field4, \
        _value4, _field5, _value5, _field6, _value6, _field7, _value7,         \
        _field8, _value8, _field9, _value9, _field10, _value10);               \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u32[3] = EFX_INSERT_FIELDS32(                                  \
        96, 127, _field1, _value1, _field2, _value2, _field3, _value3,         \
        _field4, _value4, _field5, _value5, _field6, _value6, _field7,         \
        _value7, _field8, _value8, _field9, _value9, _field10, _value10);      \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u32[4] = EFX_INSERT_FIELDS32(                                  \
        128, 159, _field1, _value1, _field2, _value2, _field3, _value3,        \
        _field4, _value4, _field5, _value5, _field6, _value6, _field7,         \
        _value7, _field8, _value8, _field9, _value9, _field10, _value10);      \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u32[5] = EFX_INSERT_FIELDS32(                                  \
        160, 191, _field1, _value1, _field2, _value2, _field3, _value3,        \
        _field4, _value4, _field5, _value5, _field6, _value6, _field7,         \
        _value7, _field8, _value8, _field9, _value9, _field10, _value10);      \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u32[6] = EFX_INSERT_FIELDS32(                                  \
        192, 223, _field1, _value1, _field2, _value2, _field3, _value3,        \
        _field4, _value4, _field5, _value5, _field6, _value6, _field7,         \
        _value7, _field8, _value8, _field9, _value9, _field10, _value10);      \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u32[7] = EFX_INSERT_FIELDS32(                                  \
        224, 255, _field1, _value1, _field2, _value2, _field3, _value3,        \
        _field4, _value4, _field5, _value5, _field6, _value6, _field7,         \
        _value7, _field8, _value8, _field9, _value9, _field10, _value10);      \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)

#define EFX_POPULATE_OWORD64(                                                  \
    _oword, _field1, _value1, _field2, _value2, _field3, _value3, _field4,     \
    _value4, _field5, _value5, _field6, _value6, _field7, _value7, _field8,    \
    _value8, _field9, _value9, _field10, _value10)                             \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_oword).eo_u64[0] = EFX_INSERT_FIELDS64(                                  \
        0, 63, _field1, _value1, _field2, _value2, _field3, _value3, _field4,  \
        _value4, _field5, _value5, _field6, _value6, _field7, _value7,         \
        _field8, _value8, _field9, _value9, _field10, _value10);               \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_oword).eo_u64[1] = EFX_INSERT_FIELDS64(                                  \
        64, 127, _field1, _value1, _field2, _value2, _field3, _value3,         \
        _field4, _value4, _field5, _value5, _field6, _value6, _field7,         \
        _value7, _field8, _value8, _field9, _value9, _field10, _value10);      \
    _NOTE(CONSTANTCONDITION)                                                   \
...
#define EFX_POPULATE_OWORD32(                                                  \
    _oword, _field1, _value1, _field2, _value2, _field3, _value3, _field4,     \
    _value4, _field5, _value5, _field6, _value6, _field7, _value7, _field8,    \
    _value8, _field9, _value9, _field10, _value10)                             \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_oword).eo_u32[0] = EFX_INSERT_FIELDS32(                                  \
        0, 31, _field1, _value1, _field2, _value2, _field3, _value3, _field4,  \
        _value4, _field5, _value5, _field6, _value6, _field7, _value7,         \
        _field8, _value8, _field9, _value9, _field10, _value10);               \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_oword).eo_u32[1] = EFX_INSERT_FIELDS32(                                  \
        ...
        _field8, _value8, _field9, _value9, _field10, _value10);               \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_oword).eo_u32[2] = EFX_INSERT_FIELDS32(                                  \
        64, 95, _field1, _value1, _field2, _value2, _field3, _value3, _field4, \
        _value4, _field5, _value5, _field6, _value6, _field7, _value7,         \
        _field8, _value8, _field9, _value9, _field10, _value10);               \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_oword).eo_u32[3] = EFX_INSERT_FIELDS32(                                  \
        96, 127, _field1, _value1, _field2, _value2, _field3, _value3,         \
        _field4, _value4, _field5, _value5, _field6, _value6, _field7,         \
        _value7, _field8, _value8, _field9, _value9, _field10, _value10);      \
    _NOTE(CONSTANTCONDITION)                                                   \
...
#define EFX_POPULATE_QWORD64(                                                  \
    _qword, _field1, _value1, _field2, _value2, _field3, _value3, _field4,     \
    _value4, _field5, _value5, _field6, _value6, _field7, _value7, _field8,    \
    _value8, _field9, _value9, _field10, _value10)                             \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_qword).eq_u64[0] = EFX_INSERT_FIELDS64(                                  \
        0, 63, _field1, _value1, _field2, _value2, _field3, _value3, _field4,  \
        _value4, _field5, _value5, _field6, _value6, _field7, _value7,         \
        _field8, _value8, _field9, _value9, _field10, _value10);               \
    _NOTE(CONSTANTCONDITION)                                                   \
...
#define EFX_POPULATE_QWORD32(                                                  \
    _qword, _field1, _value1, _field2, _value2, _field3, _value3, _field4,     \
    _value4, _field5, _value5, _field6, _value6, _field7, _value7, _field8,    \
    _value8, _field9, _value9, _field10, _value10)                             \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_qword).eq_u32[0] = EFX_INSERT_FIELDS32(                                  \
        0, 31, _field1, _value1, _field2, _value2, _field3, _value3, _field4,  \
        _value4, _field5, _value5, _field6, _value6, _field7, _value7,         \
        _field8, _value8, _field9, _value9, _field10, _value10);               \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_qword).eq_u32[1] = EFX_INSERT_FIELDS32(                                  \
        32, 63, _field1, _value1, _field2, _value2, _field3, _value3, _field4, \
        _value4, _field5, _value5, _field6, _value6, _field7, _value7,         \
        _field8, _value8, _field9, _value9, _field10, _value10);               \
    _NOTE(CONSTANTCONDITION)                                                   \
...
#define EFX_POPULATE_DWORD(                                                    \
    _dword, _field1, _value1, _field2, _value2, _field3, _value3, _field4,     \
    _value4, _field5, _value5, _field6, _value6, _field7, _value7, _field8,    \
    _value8, _field9, _value9, _field10, _value10)                             \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_dword).ed_u32[0] = EFX_INSERT_FIELDS32(                                  \
        0, 31, _field1, _value1, _field2, _value2, _field3, _value3, _field4,  \
        _value4, _field5, _value5, _field6, _value6, _field7, _value7,         \
        _field8, _value8, _field9, _value9, _field10, _value10);               \
    _NOTE(CONSTANTCONDITION)                                                   \
...
#define EFX_POPULATE_WORD(_word, _field1, _value1, _field2, _value2, _field3,  \
                          _value3, _field4, _value4, _field5, _value5,         \
                          _field6, _value6, _field7, _value7, _field8,         \
                          _value8, _field9, _value9, _field10, _value10)       \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_word).ew_u16[0] = EFX_INSERT_FIELDS16(                                   \
        0, 15, _field1, _value1, _field2, _value2, _field3, _value3, _field4,  \
        _value4, _field5, _value5, _field6, _value6, _field7, _value7,         \
        _field8, _value8, _field9, _value9, _field10, _value10);               \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)

#define EFX_POPULATE_BYTE(_byte, _field1, _value1, _field2, _value2, _field3,  \
                          _value3, _field4, _value4, _field5, _value5,         \
                          _field6, _value6, _field7, _value7, _field8,         \
                          _value8, _field9, _value9, _field10, _value10)       \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_byte).eb_u8[0] = EFX_INSERT_FIELDS8(                                     \
        0, 7, _field1, _value1, _field2, _value2, _field3, _value3, _field4,   \
        _value4, _field5, _value5, _field6, _value6, _field7, _value7,         \
        _field8, _value8, _field9, _value9, _field10, _value10);               \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_POPULATE_XWORD_9(_xword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4, _field5,      \
                             _value5, _field6, _value6, _field7, _value7,      \
                             _field8, _value8, _field9, _value9)               \
  EFX_POPULATE_XWORD_10(_xword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2, \
                        _value2, _field3, _value3, _field4, _value4, _field5,  \
                        _value5, _field6, _value6, _field7, _value7, _field8,  \
                        _value8, _field9, _value9)

#define EFX_POPULATE_XWORD_8(_xword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4, _field5,      \
                             _value5, _field6, _value6, _field7, _value7,      \
                             _field8, _value8)                                 \
  EFX_POPULATE_XWORD_9(_xword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3, _field4, _value4, _field5,   \
                       _value5, _field6, _value6, _field7, _value7, _field8,   \
                       _value8)

#define EFX_POPULATE_XWORD_7(_xword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4, _field5,      \
                             _value5, _field6, _value6, _field7, _value7)      \
  EFX_POPULATE_XWORD_8(_xword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3, _field4, _value4, _field5,   \
                       _value5, _field6, _value6, _field7, _value7)

#define EFX_POPULATE_XWORD_6(_xword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4, _field5,      \
                             _value5, _field6, _value6)                        \
  EFX_POPULATE_XWORD_7(_xword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3, _field4, _value4, _field5,   \
                       _value5, _field6, _value6)

#define EFX_POPULATE_XWORD_5(_xword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4, _field5,      \
                             _value5)                                          \
  EFX_POPULATE_XWORD_6(_xword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3, _field4, _value4, _field5,   \
                       _value5)

#define EFX_POPULATE_XWORD_4(_xword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4)               \
  EFX_POPULATE_XWORD_5(_xword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3, _field4, _value4)

#define EFX_POPULATE_XWORD_3(_xword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3)                                 \
  EFX_POPULATE_XWORD_4(_xword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3)

#define EFX_POPULATE_XWORD_2(_xword, _field1, _value1, _field2, _value2)       \
  EFX_POPULATE_XWORD_3(_xword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2)

#define EFX_POPULATE_XWORD_1(_xword, _field1, _value1)                         \
  EFX_POPULATE_XWORD_2(_xword, EFX_DUMMY_FIELD, 0, _field1, _value1)

#define EFX_ZERO_XWORD(_xword) EFX_POPULATE_XWORD_1(_xword, EFX_DUMMY_FIELD, 0)

#define EFX_SET_XWORD(_xword)                                                  \
  EFX_POPULATE_XWORD_8(_xword, EFX_DWORD_0, 0xffffffff, EFX_DWORD_1,           \
                       0xffffffff, EFX_DWORD_2, 0xffffffff, EFX_DWORD_3,       \
                       0xffffffff, EFX_DWORD_4, 0xffffffff, EFX_DWORD_5,       \
                       0xffffffff, EFX_DWORD_6, 0xffffffff, EFX_DWORD_7,       \
                       0xffffffff)

/* Populate an octword field with various numbers of arguments */
#define EFX_POPULATE_OWORD_10 EFX_POPULATE_OWORD

#define EFX_POPULATE_OWORD_9(_oword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4, _field5,      \
                             _value5, _field6, _value6, _field7, _value7,      \
                             _field8, _value8, _field9, _value9)               \
  EFX_POPULATE_OWORD_10(_oword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2, \
                        _value2, _field3, _value3, _field4, _value4, _field5,  \
                        _value5, _field6, _value6, _field7, _value7, _field8,  \
                        _value8, _field9, _value9)

#define EFX_POPULATE_OWORD_8(_oword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4, _field5,      \
                             _value5, _field6, _value6, _field7, _value7,      \
                             _field8, _value8)                                 \
  EFX_POPULATE_OWORD_9(_oword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3, _field4, _value4, _field5,   \
                       _value5, _field6, _value6, _field7, _value7, _field8,   \
                       _value8)

#define EFX_POPULATE_OWORD_7(_oword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4, _field5,      \
                             _value5, _field6, _value6, _field7, _value7)      \
  EFX_POPULATE_OWORD_8(_oword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3, _field4, _value4, _field5,   \
                       _value5, _field6, _value6, _field7, _value7)

#define EFX_POPULATE_OWORD_6(_oword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4, _field5,      \
                             _value5, _field6, _value6)                        \
  EFX_POPULATE_OWORD_7(_oword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3, _field4, _value4, _field5,   \
                       _value5, _field6, _value6)

#define EFX_POPULATE_OWORD_5(_oword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4, _field5,      \
                             _value5)                                          \
  EFX_POPULATE_OWORD_6(_oword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3, _field4, _value4, _field5,   \
                       _value5)

#define EFX_POPULATE_OWORD_4(_oword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4)               \
  EFX_POPULATE_OWORD_5(_oword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3, _field4, _value4)

#define EFX_POPULATE_OWORD_3(_oword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3)                                 \
  EFX_POPULATE_OWORD_4(_oword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3)

#define EFX_POPULATE_OWORD_2(_oword, _field1, _value1, _field2, _value2)       \
  EFX_POPULATE_OWORD_3(_oword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2)

#define EFX_POPULATE_OWORD_1(_oword, _field1, _value1)                         \
  EFX_POPULATE_OWORD_2(_oword, EFX_DUMMY_FIELD, 0, _field1, _value1)

#define EFX_ZERO_OWORD(_oword) EFX_POPULATE_OWORD_1(_oword, EFX_DUMMY_FIELD, 0)

#define EFX_SET_OWORD(_oword)                                                  \
  EFX_POPULATE_OWORD_4(_oword, EFX_DWORD_0, 0xffffffff, EFX_DWORD_1,           \
                       0xffffffff, EFX_DWORD_2, 0xffffffff, EFX_DWORD_3,       \
                       0xffffffff)
...
#define EFX_POPULATE_QWORD_9(_qword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4, _field5,      \
                             _value5, _field6, _value6, _field7, _value7,      \
                             _field8, _value8, _field9, _value9)               \
  EFX_POPULATE_QWORD_10(_qword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2, \
                        _value2, _field3, _value3, _field4, _value4, _field5,  \
                        _value5, _field6, _value6, _field7, _value7, _field8,  \
                        _value8, _field9, _value9)

#define EFX_POPULATE_QWORD_8(_qword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4, _field5,      \
                             _value5, _field6, _value6, _field7, _value7,      \
                             _field8, _value8)                                 \
  EFX_POPULATE_QWORD_9(_qword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3, _field4, _value4, _field5,   \
                       _value5, _field6, _value6, _field7, _value7, _field8,   \
                       _value8)

#define EFX_POPULATE_QWORD_7(_qword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4, _field5,      \
                             _value5, _field6, _value6, _field7, _value7)      \
  EFX_POPULATE_QWORD_8(_qword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3, _field4, _value4, _field5,   \
                       _value5, _field6, _value6, _field7, _value7)

#define EFX_POPULATE_QWORD_6(_qword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4, _field5,      \
                             _value5, _field6, _value6)                        \
  EFX_POPULATE_QWORD_7(_qword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3, _field4, _value4, _field5,   \
                       _value5, _field6, _value6)

#define EFX_POPULATE_QWORD_5(_qword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4, _field5,      \
                             _value5)                                          \
  EFX_POPULATE_QWORD_6(_qword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3, _field4, _value4, _field5,   \
                       _value5)

#define EFX_POPULATE_QWORD_4(_qword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4)               \
  EFX_POPULATE_QWORD_5(_qword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3, _field4, _value4)

#define EFX_POPULATE_QWORD_3(_qword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3)                                 \
  EFX_POPULATE_QWORD_4(_qword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3)

#define EFX_POPULATE_QWORD_2(_qword, _field1, _value1, _field2, _value2)       \
  EFX_POPULATE_QWORD_3(_qword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2)

#define EFX_POPULATE_QWORD_1(_qword, _field1, _value1)                         \
  EFX_POPULATE_QWORD_2(_qword, EFX_DUMMY_FIELD, 0, _field1, _value1)

#define EFX_ZERO_QWORD(_qword) EFX_POPULATE_QWORD_1(_qword, EFX_DUMMY_FIELD, 0)

#define EFX_SET_QWORD(_qword)                                                  \
  EFX_POPULATE_QWORD_2(_qword, EFX_DWORD_0, 0xffffffff, EFX_DWORD_1, 0xffffffff)

/* Populate a dword field with various numbers of arguments */
#define EFX_POPULATE_DWORD_10 EFX_POPULATE_DWORD

#define EFX_POPULATE_DWORD_9(_dword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4, _field5,      \
                             _value5, _field6, _value6, _field7, _value7,      \
                             _field8, _value8, _field9, _value9)               \
  EFX_POPULATE_DWORD_10(_dword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2, \
                        _value2, _field3, _value3, _field4, _value4, _field5,  \
                        _value5, _field6, _value6, _field7, _value7, _field8,  \
                        _value8, _field9, _value9)

#define EFX_POPULATE_DWORD_8(_dword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4, _field5,      \
                             _value5, _field6, _value6, _field7, _value7,      \
                             _field8, _value8)                                 \
  EFX_POPULATE_DWORD_9(_dword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3, _field4, _value4, _field5,   \
                       _value5, _field6, _value6, _field7, _value7, _field8,   \
                       _value8)

#define EFX_POPULATE_DWORD_7(_dword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4, _field5,      \
                             _value5, _field6, _value6, _field7, _value7)      \
  EFX_POPULATE_DWORD_8(_dword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3, _field4, _value4, _field5,   \
                       _value5, _field6, _value6, _field7, _value7)

#define EFX_POPULATE_DWORD_6(_dword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4, _field5,      \
                             _value5, _field6, _value6)                        \
  EFX_POPULATE_DWORD_7(_dword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3, _field4, _value4, _field5,   \
                       _value5, _field6, _value6)

#define EFX_POPULATE_DWORD_5(_dword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4, _field5,      \
                             _value5)                                          \
  EFX_POPULATE_DWORD_6(_dword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3, _field4, _value4, _field5,   \
                       _value5)

#define EFX_POPULATE_DWORD_4(_dword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3, _field4, _value4)               \
  EFX_POPULATE_DWORD_5(_dword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3, _field4, _value4)

#define EFX_POPULATE_DWORD_3(_dword, _field1, _value1, _field2, _value2,       \
                             _field3, _value3)                                 \
  EFX_POPULATE_DWORD_4(_dword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2, _field3, _value3)

#define EFX_POPULATE_DWORD_2(_dword, _field1, _value1, _field2, _value2)       \
  EFX_POPULATE_DWORD_3(_dword, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,  \
                       _value2)

#define EFX_POPULATE_DWORD_1(_dword, _field1, _value1)                         \
  EFX_POPULATE_DWORD_2(_dword, EFX_DUMMY_FIELD, 0, _field1, _value1)

#define EFX_ZERO_DWORD(_dword) EFX_POPULATE_DWORD_1(_dword, EFX_DUMMY_FIELD, 0)

#define EFX_SET_DWORD(_dword)                                                  \
  EFX_POPULATE_DWORD_1(_dword, EFX_DWORD_0, 0xffffffff)

/* Populate a word field with various numbers of arguments */
#define EFX_POPULATE_WORD_10 EFX_POPULATE_WORD

#define EFX_POPULATE_WORD_9(_word, _field1, _value1, _field2, _value2,         \
                            _field3, _value3, _field4, _value4, _field5,       \
                            _value5, _field6, _value6, _field7, _value7,       \
                            _field8, _value8, _field9, _value9)                \
  EFX_POPULATE_WORD_10(_word, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,   \
                       _value2, _field3, _value3, _field4, _value4, _field5,   \
                       _value5, _field6, _value6, _field7, _value7, _field8,   \
                       _value8, _field9, _value9)

#define EFX_POPULATE_WORD_8(_word, _field1, _value1, _field2, _value2,         \
                            _field3, _value3, _field4, _value4, _field5,       \
                            _value5, _field6, _value6, _field7, _value7,       \
                            _field8, _value8)                                  \
  EFX_POPULATE_WORD_9(_word, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,    \
                      _value2, _field3, _value3, _field4, _value4, _field5,    \
                      _value5, _field6, _value6, _field7, _value7, _field8,    \
                      _value8)

#define EFX_POPULATE_WORD_7(_word, _field1, _value1, _field2, _value2,         \
                            _field3, _value3, _field4, _value4, _field5,       \
                            _value5, _field6, _value6, _field7, _value7)       \
  EFX_POPULATE_WORD_8(_word, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,    \
                      _value2, _field3, _value3, _field4, _value4, _field5,    \
                      _value5, _field6, _value6, _field7, _value7)

#define EFX_POPULATE_WORD_6(_word, _field1, _value1, _field2, _value2,         \
                            _field3, _value3, _field4, _value4, _field5,       \
                            _value5, _field6, _value6)                         \
  EFX_POPULATE_WORD_7(_word, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,    \
                      _value2, _field3, _value3, _field4, _value4, _field5,    \
                      _value5, _field6, _value6)

#define EFX_POPULATE_WORD_5(_word, _field1, _value1, _field2, _value2,         \
                            _field3, _value3, _field4, _value4, _field5,       \
                            _value5)                                           \
  EFX_POPULATE_WORD_6(_word, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,    \
                      _value2, _field3, _value3, _field4, _value4, _field5,    \
                      _value5)

#define EFX_POPULATE_WORD_4(_word, _field1, _value1, _field2, _value2,         \
                            _field3, _value3, _field4, _value4)                \
  EFX_POPULATE_WORD_5(_word, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,    \
                      _value2, _field3, _value3, _field4, _value4)

#define EFX_POPULATE_WORD_3(_word, _field1, _value1, _field2, _value2,         \
                            _field3, _value3)                                  \
  EFX_POPULATE_WORD_4(_word, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,    \
                      _value2, _field3, _value3)

#define EFX_POPULATE_WORD_2(_word, _field1, _value1, _field2, _value2)         \
  EFX_POPULATE_WORD_3(_word, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,    \
                      _value2)

#define EFX_POPULATE_WORD_1(_word, _field1, _value1)                           \
  EFX_POPULATE_WORD_2(_word, EFX_DUMMY_FIELD, 0, _field1, _value1)

#define EFX_ZERO_WORD(_word) EFX_POPULATE_WORD_1(_word, EFX_DUMMY_FIELD, 0)

#define EFX_SET_WORD(_word) EFX_POPULATE_WORD_1(_word, EFX_WORD_0, 0xffff)

/* Populate a byte field with various numbers of arguments */
#define EFX_POPULATE_BYTE_10 EFX_POPULATE_BYTE

#define EFX_POPULATE_BYTE_9(_byte, _field1, _value1, _field2, _value2,         \
                            _field3, _value3, _field4, _value4, _field5,       \
                            _value5, _field6, _value6, _field7, _value7,       \
                            _field8, _value8, _field9, _value9)                \
  EFX_POPULATE_BYTE_10(_byte, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,   \
                       _value2, _field3, _value3, _field4, _value4, _field5,   \
                       _value5, _field6, _value6, _field7, _value7, _field8,   \
                       _value8, _field9, _value9)

#define EFX_POPULATE_BYTE_8(_byte, _field1, _value1, _field2, _value2,         \
                            _field3, _value3, _field4, _value4, _field5,       \
                            _value5, _field6, _value6, _field7, _value7,       \
                            _field8, _value8)                                  \
  EFX_POPULATE_BYTE_9(_byte, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,    \
                      _value2, _field3, _value3, _field4, _value4, _field5,    \
                      _value5, _field6, _value6, _field7, _value7, _field8,    \
                      _value8)

#define EFX_POPULATE_BYTE_7(_byte, _field1, _value1, _field2, _value2,         \
                            _field3, _value3, _field4, _value4, _field5,       \
                            _value5, _field6, _value6, _field7, _value7)       \
  EFX_POPULATE_BYTE_8(_byte, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,    \
                      _value2, _field3, _value3, _field4, _value4, _field5,    \
                      _value5, _field6, _value6, _field7, _value7)

#define EFX_POPULATE_BYTE_6(_byte, _field1, _value1, _field2, _value2,         \
                            _field3, _value3, _field4, _value4, _field5,       \
                            _value5, _field6, _value6)                         \
  EFX_POPULATE_BYTE_7(_byte, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,    \
                      _value2, _field3, _value3, _field4, _value4, _field5,    \
                      _value5, _field6, _value6)

#define EFX_POPULATE_BYTE_5(_byte, _field1, _value1, _field2, _value2,         \
                            _field3, _value3, _field4, _value4, _field5,       \
                            _value5)                                           \
  EFX_POPULATE_BYTE_6(_byte, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,    \
                      _value2, _field3, _value3, _field4, _value4, _field5,    \
                      _value5)

#define EFX_POPULATE_BYTE_4(_byte, _field1, _value1, _field2, _value2,         \
                            _field3, _value3, _field4, _value4)                \
  EFX_POPULATE_BYTE_5(_byte, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,    \
                      _value2, _field3, _value3, _field4, _value4)

#define EFX_POPULATE_BYTE_3(_byte, _field1, _value1, _field2, _value2,         \
                            _field3, _value3)                                  \
  EFX_POPULATE_BYTE_4(_byte, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,    \
                      _value2, _field3, _value3)

#define EFX_POPULATE_BYTE_2(_byte, _field1, _value1, _field2, _value2)         \
  EFX_POPULATE_BYTE_3(_byte, EFX_DUMMY_FIELD, 0, _field1, _value1, _field2,    \
                      _value2)

#define EFX_POPULATE_BYTE_1(_byte, _field1, _value1)                           \
  EFX_POPULATE_BYTE_2(_byte, EFX_DUMMY_FIELD, 0, _field1, _value1)

#define EFX_ZERO_BYTE(_byte) EFX_POPULATE_BYTE_1(_byte, EFX_DUMMY_FIELD, 0)

#define EFX_SET_BYTE(_byte) EFX_POPULATE_BYTE_1(_byte, EFX_BYTE_0, 0xff)
...
#define EFX_SET_XWORD_FIELD64(_xword, _field, _value)                          \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u64[0] =                                                       \
        (((_xword).ex_u64[0] & ~EFX_INPLACE_MASK64(0, 63, _field)) |           \
         EFX_INSERT_FIELD64(0, 63, _field, _value));                           \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u64[1] =                                                       \
        (((_xword).ex_u64[1] & ~EFX_INPLACE_MASK64(64, 127, _field)) |         \
         EFX_INSERT_FIELD64(64, 127, _field, _value));                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u64[2] =                                                       \
        (((_xword).ex_u64[2] & ~EFX_INPLACE_MASK64(128, 191, _field)) |        \
         EFX_INSERT_FIELD64(128, 191, _field, _value));                        \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u64[3] =                                                       \
        (((_xword).ex_u64[3] & ~EFX_INPLACE_MASK64(192, 255, _field)) |        \
...
#define EFX_SET_XWORD_FIELD32(_xword, _field, _value)                          \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u32[0] =                                                       \
        (((_xword).ex_u32[0] & ~EFX_INPLACE_MASK32(0, 31, _field)) |           \
         EFX_INSERT_FIELD32(0, 31, _field, _value));                           \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u32[1] =                                                       \
        (((_xword).ex_u32[1] & ~EFX_INPLACE_MASK32(32, 63, _field)) |          \
         EFX_INSERT_FIELD32(32, 63, _field, _value));                          \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u32[2] =                                                       \
        (((_xword).ex_u32[2] & ~EFX_INPLACE_MASK32(64, 95, _field)) |          \
         EFX_INSERT_FIELD32(64, 95, _field, _value));                          \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u32[3] =                                                       \
        (((_xword).ex_u32[3] & ~EFX_INPLACE_MASK32(96, 127, _field)) |         \
         EFX_INSERT_FIELD32(96, 127, _field, _value));                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u32[4] =                                                       \
        (((_xword).ex_u32[4] & ~EFX_INPLACE_MASK32(128, 159, _field)) |        \
         EFX_INSERT_FIELD32(128, 159, _field, _value));                        \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u32[5] =                                                       \
        (((_xword).ex_u32[5] & ~EFX_INPLACE_MASK32(160, 191, _field)) |        \
         EFX_INSERT_FIELD32(160, 191, _field, _value));                        \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u32[6] =                                                       \
        (((_xword).ex_u32[6] & ~EFX_INPLACE_MASK32(192, 223, _field)) |        \
         EFX_INSERT_FIELD32(192, 223, _field, _value));                        \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u32[7] =                                                       \
        (((_xword).ex_u32[7] & ~EFX_INPLACE_MASK32(224, 255, _field)) |        \
...
#define EFX_SET_OWORD_FIELD64(_oword, _field, _value)                          \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_oword).eo_u64[0] =                                                       \
        (((_oword).eo_u64[0] & ~EFX_INPLACE_MASK64(0, 63, _field)) |           \
         EFX_INSERT_FIELD64(0, 63, _field, _value));                           \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_oword).eo_u64[1] =                                                       \
        (((_oword).eo_u64[1] & ~EFX_INPLACE_MASK64(64, 127, _field)) |         \
         EFX_INSERT_FIELD64(64, 127, _field, _value));                         \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_SET_OWORD_FIELD32(_oword, _field, _value)                          \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_oword).eo_u32[0] =                                                       \
        (((_oword).eo_u32[0] & ~EFX_INPLACE_MASK32(0, 31, _field)) |           \
         EFX_INSERT_FIELD32(0, 31, _field, _value));                           \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_oword).eo_u32[1] =                                                       \
        (((_oword).eo_u32[1] & ~EFX_INPLACE_MASK32(32, 63, _field)) |          \
         EFX_INSERT_FIELD32(32, 63, _field, _value));                          \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_oword).eo_u32[2] =                                                       \
        (((_oword).eo_u32[2] & ~EFX_INPLACE_MASK32(64, 95, _field)) |          \
         EFX_INSERT_FIELD32(64, 95, _field, _value));                          \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_oword).eo_u32[3] =                                                       \
        (((_oword).eo_u32[3] & ~EFX_INPLACE_MASK32(96, 127, _field)) |         \
         EFX_INSERT_FIELD32(96, 127, _field, _value));                         \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_SET_QWORD_FIELD64(_qword, _field, _value)                          \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_qword).eq_u64[0] =                                                       \
        (((_qword).eq_u64[0] & ~EFX_INPLACE_MASK64(0, 63, _field)) |           \
         EFX_INSERT_FIELD64(0, 63, _field, _value));                           \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_SET_QWORD_FIELD32(_qword, _field, _value)                          \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_qword).eq_u32[0] =                                                       \
        (((_qword).eq_u32[0] & ~EFX_INPLACE_MASK32(0, 31, _field)) |           \
         EFX_INSERT_FIELD32(0, 31, _field, _value));                           \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_qword).eq_u32[1] =                                                       \
        (((_qword).eq_u32[1] & ~EFX_INPLACE_MASK32(32, 63, _field)) |          \
         EFX_INSERT_FIELD32(32, 63, _field, _value));                          \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_SET_DWORD_FIELD(_dword, _field, _value)                            \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_dword).ed_u32[0] =                                                       \
        (((_dword).ed_u32[0] & ~EFX_INPLACE_MASK32(0, 31, _field)) |           \
         EFX_INSERT_FIELD32(0, 31, _field, _value));                           \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_SET_WORD_FIELD(_word, _field, _value)                              \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_word).ew_u16[0] =                                                        \
        (((_word).ew_u16[0] & ~EFX_INPLACE_MASK16(0, 15, _field)) |            \
...
#define EFX_SET_BYTE_FIELD(_byte, _field, _value)                              \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_byte).eb_u8[0] =                                                         \
        (((_byte).eb_u8[0] & ~EFX_INPLACE_MASK8(0, 7, _field)) |               \
...
#define EFX_SET_XWORD_BIT64(_xword, _bit)                                      \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u64[0] |= __CPU_TO_LE_64(EFX_SHIFT64(_bit, FIX_LINT(0)));      \
    (_xword).ex_u64[1] |= __CPU_TO_LE_64(EFX_SHIFT64(_bit, FIX_LINT(64)));     \
    (_xword).ex_u64[2] |= __CPU_TO_LE_64(EFX_SHIFT64(_bit, FIX_LINT(128)));    \
    (_xword).ex_u64[3] |= __CPU_TO_LE_64(EFX_SHIFT64(_bit, FIX_LINT(192)));    \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_SET_XWORD_BIT32(_xword, _bit)                                      \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_xword).ex_u32[0] |= __CPU_TO_LE_32(EFX_SHIFT32(_bit, FIX_LINT(0)));      \
    (_xword).ex_u32[1] |= __CPU_TO_LE_32(EFX_SHIFT32(_bit, FIX_LINT(32)));     \
    (_xword).ex_u32[2] |= __CPU_TO_LE_32(EFX_SHIFT32(_bit, FIX_LINT(64)));     \
    (_xword).ex_u32[3] |= __CPU_TO_LE_32(EFX_SHIFT32(_bit, FIX_LINT(96)));     \
    (_xword).ex_u32[4] |= __CPU_TO_LE_32(EFX_SHIFT32(_bit, FIX_LINT(128)));    \
    (_xword).ex_u32[5] |= __CPU_TO_LE_32(EFX_SHIFT32(_bit, FIX_LINT(160)));    \
    (_xword).ex_u32[6] |= __CPU_TO_LE_32(EFX_SHIFT32(_bit, FIX_LINT(192)));    \
    (_xword).ex_u32[7] |= __CPU_TO_LE_32(EFX_SHIFT32(_bit, FIX_LINT(224)));    \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_SET_OWORD_BIT64(_oword, _bit)                                      \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_oword).eo_u64[0] |= __CPU_TO_LE_64(EFX_SHIFT64(_bit, FIX_LINT(0)));      \
    (_oword).eo_u64[1] |= __CPU_TO_LE_64(EFX_SHIFT64(_bit, FIX_LINT(64)));     \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_SET_OWORD_BIT32(_oword, _bit)                                      \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_oword).eo_u32[0] |= __CPU_TO_LE_32(EFX_SHIFT32(_bit, FIX_LINT(0)));      \
    (_oword).eo_u32[1] |= __CPU_TO_LE_32(EFX_SHIFT32(_bit, FIX_LINT(32)));     \
    (_oword).eo_u32[2] |= __CPU_TO_LE_32(EFX_SHIFT32(_bit, FIX_LINT(64)));     \
    (_oword).eo_u32[3] |= __CPU_TO_LE_32(EFX_SHIFT32(_bit, FIX_LINT(96)));     \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_SET_QWORD_BIT64(_qword, _bit)                                      \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_qword).eq_u64[0] |= __CPU_TO_LE_64(EFX_SHIFT64(_bit, FIX_LINT(0)));      \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_SET_QWORD_BIT32(_qword, _bit)                                      \
  do {                                                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
    (_qword).eq_u32[0] |= __CPU_TO_LE_32(EFX_SHIFT32(_bit, FIX_LINT(0)));      \
    (_qword).eq_u32[1] |= __CPU_TO_LE_32(EFX_SHIFT32(_bit, FIX_LINT(32)));     \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_TEST_QWORD_BIT64(_qword, _bit)                                     \
  (((_qword).eq_u64[0] & __CPU_TO_LE_64(EFX_SHIFT64(_bit, FIX_LINT(0)))) != 0)
...
#define EFX_SET_DWORD_BIT(_dword, _bit)                                        \
  do {                                                                         \
    (_dword).ed_u32[0] |= __CPU_TO_LE_32(EFX_SHIFT32(_bit, FIX_LINT(0)));      \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_TEST_DWORD_BIT(_dword, _bit)                                       \
  (((_dword).ed_u32[0] & __CPU_TO_LE_32(EFX_SHIFT32(_bit, FIX_LINT(0)))) != 0)

#define EFX_SET_WORD_BIT(_word, _bit)                                          \
  do {                                                                         \
    (_word).ew_u16[0] |= __CPU_TO_LE_16(EFX_SHIFT16(_bit, FIX_LINT(0)));       \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)

#define EFX_CLEAR_WORD_BIT(_word, _bit)                                        \
  do {                                                                         \
    (_word).ew_u32[0] &= __CPU_TO_LE_16(~EFX_SHIFT16(_bit, FIX_LINT(0)));      \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)

#define EFX_TEST_WORD_BIT(_word, _bit)                                         \
  (((_word).ew_u16[0] & __CPU_TO_LE_16(EFX_SHIFT16(_bit, FIX_LINT(0)))) != 0)

#define EFX_SET_BYTE_BIT(_byte, _bit)                                          \
  do {                                                                         \
    (_byte).eb_u8[0] |= __NATIVE_8(EFX_SHIFT8(_bit, FIX_LINT(0)));             \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_TEST_BYTE_BIT(_byte, _bit)                                         \
  (((_byte).eb_u8[0] & __NATIVE_8(EFX_SHIFT8(_bit, FIX_LINT(0)))) != 0)
