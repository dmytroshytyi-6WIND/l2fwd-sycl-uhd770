...
#define EFX_P2ALIGN(_type, _value, _align) ((_type)(_value) & -(_type)(_align))
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_family(__in uint16_t venid,
                                         __in uint16_t devid,
...
typedef struct efx_pci_ops_s {
   ...
   */
  efx_rc_t (*epo_config_readd)(efsys_pci_config_t *espcp, uint32_t offset,
                               efx_dword_t *edp);
  /*
   ...
   * Returns status code, 0 on success, any other value on error.
   */
  efx_rc_t (*epo_find_mem_bar)(efsys_pci_config_t *configp, int index,
                               efsys_bar_t *memp);
} efx_pci_ops_t;
 ...
 */
LIBEFX_API
extern __checkReturn efx_rc_t efx_family_probe_bar(
    __in uint16_t venid, __in uint16_t devid, __in efsys_pci_config_t *espcp,
    __in const efx_pci_ops_t *epop, __out efx_family_t *efp,
...
LIBEFX_API
extern __checkReturn uint32_t efx_crc32_calculate(__in uint32_t crc_init,
                                                  __in_ecount(length)
                                                      uint8_t const *input,
                                                  __in int length);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_nic_create(__in efx_family_t family,
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_nic_probe(__in efx_nic_t *enp,
                                            __in efx_fw_variant_t efv);

LIBEFX_API
extern __checkReturn efx_rc_t efx_nic_init(__in efx_nic_t *enp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_nic_reset(__in efx_nic_t *enp);

LIBEFX_API
extern __checkReturn boolean_t efx_nic_hw_unavailable(__in efx_nic_t *enp);

LIBEFX_API
extern void efx_nic_set_hw_unavailable(__in efx_nic_t *enp);

#if EFSYS_OPT_DIAG

LIBEFX_API
extern __checkReturn efx_rc_t efx_nic_register_test(__in efx_nic_t *enp);

#endif /* EFSYS_OPT_DIAG */

LIBEFX_API
extern void efx_nic_fini(__in efx_nic_t *enp);

LIBEFX_API
extern void efx_nic_unprobe(__in efx_nic_t *enp);

LIBEFX_API
extern void efx_nic_destroy(__in efx_nic_t *enp);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_nic_calculate_pcie_link_bandwidth(
    __in uint32_t pcie_link_width, __in uint32_t pcie_link_gen,
    __out uint32_t *bandwidth_mbpsp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_nic_check_pcie_link_speed(
    __in efx_nic_t *enp, __in uint32_t pcie_link_width,
    __in uint32_t pcie_link_gen, __out efx_pcie_link_performance_t *resultp);
...
#if EFSYS_OPT_MCDI_LOGGING
  void (*emt_logger)(void *, efx_log_msg_t, void *, size_t, void *, size_t);
#endif /* EFSYS_OPT_MCDI_LOGGING */
...
efx_mcdi_init(__in efx_nic_t *enp, __in const efx_mcdi_transport_t *mtp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mcdi_reboot(__in efx_nic_t *enp);

LIBEFX_API
extern void efx_mcdi_new_epoch(__in efx_nic_t *enp);

LIBEFX_API
extern void efx_mcdi_get_timeout(__in efx_nic_t *enp, __in efx_mcdi_req_t *emrp,
                                 __out uint32_t *usec_timeoutp);

LIBEFX_API
extern void efx_mcdi_request_start(__in efx_nic_t *enp,
                                   __in efx_mcdi_req_t *emrp,
                                   __in boolean_t ev_cpl);

LIBEFX_API
extern __checkReturn boolean_t efx_mcdi_request_poll(__in efx_nic_t *enp);

LIBEFX_API
extern __checkReturn boolean_t efx_mcdi_request_abort(__in efx_nic_t *enp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mcdi_get_client_handle(
    __in efx_nic_t *enp, __in efx_pcie_interface_t intf, __in uint16_t pf,
    __in uint16_t vf, __out uint32_t *handle);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_mcdi_get_own_client_handle(__in efx_nic_t *enp, __out uint32_t *handle);

LIBEFX_API
extern void efx_mcdi_fini(__in efx_nic_t *enp);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_intr_init(__in efx_nic_t *enp,
                                            __in efx_intr_type_t type,
                                            __in_opt efsys_mem_t *esmp);

LIBEFX_API
extern void efx_intr_enable(__in efx_nic_t *enp);

LIBEFX_API
extern void efx_intr_disable(__in efx_nic_t *enp);

LIBEFX_API
extern void efx_intr_disable_unlocked(__in efx_nic_t *enp);

#define EFX_INTR_NEVQS 32

LIBEFX_API
extern __checkReturn efx_rc_t efx_intr_trigger(__in efx_nic_t *enp,
                                               __in unsigned int level);

LIBEFX_API
extern void efx_intr_status_line(__in efx_nic_t *enp, __out boolean_t *fatalp,
                                 __out uint32_t *maskp);

LIBEFX_API
extern void efx_intr_status_message(__in efx_nic_t *enp,
                                    __in unsigned int message,
                                    __out boolean_t *fatalp);

LIBEFX_API
extern void efx_intr_fatal(__in efx_nic_t *enp);

LIBEFX_API
extern void efx_intr_fini(__in efx_nic_t *enp);
...
#define EFX_MAC_PDU_ADJUSTMENT                                                 \
  (/* EtherII */ 14 + /* VLAN */ 4 + /* CRC */ 4 + /* bug16011 */ 16)
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_mac_pdu_get(__in efx_nic_t *enp,
                                              __out size_t *pdu);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mac_pdu_set(__in efx_nic_t *enp,
                                              __in size_t pdu);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mac_addr_set(__in efx_nic_t *enp,
                                               __in uint8_t *addr);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mac_filter_set(__in efx_nic_t *enp,
...
LIBEFX_API
extern void efx_mac_filter_get_all_ucast_mcast(__in efx_nic_t *enp,
                                               __out boolean_t *all_unicst,
                                               __out boolean_t *all_mulcst);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mac_multicast_list_set(
    __in efx_nic_t *enp, __in_ecount(6 * count) uint8_t const *addrs,
    __in int count);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mac_filter_default_rxq_set(
    __in efx_nic_t *enp, __in efx_rxq_t *erp, __in boolean_t using_rss);

LIBEFX_API
extern void efx_mac_filter_default_rxq_clear(__in efx_nic_t *enp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mac_drain(__in efx_nic_t *enp,
                                            __in boolean_t enabled);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mac_up(__in efx_nic_t *enp,
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_mac_fcntl_set(__in efx_nic_t *enp,
                                                __in unsigned int fcntl,
                                                __in boolean_t autoneg);

LIBEFX_API
extern void efx_mac_fcntl_get(__in efx_nic_t *enp,
...
LIBEFX_API
extern __checkReturn const char *efx_mac_stat_name(__in efx_nic_t *enp,
...
#define EFX_MAC_STATS_MASK_NPAGES                                              \
  (EFX_P2ROUNDUP(uint32_t, EFX_MAC_NSTATS, EFX_MAC_STATS_MASK_BITS_PER_PAGE) / \
 ...
 */
LIBEFX_API
extern __checkReturn efx_rc_t efx_mac_stats_get_mask(__in efx_nic_t *enp,
                                                     __out_bcount(mask_size)
                                                         uint32_t *maskp,
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_mac_stats_clear(__in efx_nic_t *enp);
 ...
 */
LIBEFX_API
extern __checkReturn efx_rc_t efx_mac_stats_upload(__in efx_nic_t *enp,
                                                   __in efsys_mem_t *esmp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mac_stats_periodic(__in efx_nic_t *enp,
                                                     __in efsys_mem_t *esmp,
...
LIBEFX_API
extern const char *efx_mon_name(__in efx_nic_t *enp);

#endif /* EFSYS_OPT_NAMES */

LIBEFX_API
extern __checkReturn efx_rc_t efx_mon_init(__in efx_nic_t *enp);
...
LIBEFX_API
extern const char *efx_mon_stat_name(__in efx_nic_t *enp,
                                     __in efx_mon_stat_t id);

LIBEFX_API
extern const char *efx_mon_stat_description(__in efx_nic_t *enp,
                                            __in efx_mon_stat_t id);
...
LIBEFX_API
extern __checkReturn boolean_t efx_mon_get_stat_unit(
    __in efx_mon_stat_t stat, __out efx_mon_stat_unit_t *unitp);

LIBEFX_API
extern __checkReturn boolean_t efx_mon_get_stat_portmap(
    __in efx_mon_stat_t stat, __out efx_mon_stat_portmask_t *maskp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mon_stats_update(
    __in efx_nic_t *enp, __in efsys_mem_t *esmp,
    __inout_ecount(EFX_MON_NSTATS) efx_mon_stat_value_t *values);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_mon_limits_update(__in efx_nic_t *enp, __inout_ecount(EFX_MON_NSTATS)
                                               efx_mon_stat_limits_t *values);

#endif /* EFSYS_OPT_MON_STATS */

LIBEFX_API
extern void efx_mon_fini(__in efx_nic_t *enp);

/* PHY */

LIBEFX_API
extern __checkReturn efx_rc_t efx_phy_verify(__in efx_nic_t *enp);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_phy_led_set(__in efx_nic_t *enp,
                                              __in efx_phy_led_mode_t mode);

#endif /* EFSYS_OPT_PHY_LED_CONTROL */

LIBEFX_API
extern __checkReturn efx_rc_t efx_port_init(__in efx_nic_t *enp);
...
LIBEFX_API
extern void efx_port_fini(__in efx_nic_t *enp);
...
LIBEFX_API
extern void efx_phy_adv_cap_get(__in efx_nic_t *enp, __in uint32_t flag,
                                __out uint32_t *maskp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_phy_adv_cap_set(__in efx_nic_t *enp,
                                                  __in uint32_t mask);

LIBEFX_API
extern void efx_phy_lp_cap_get(__in efx_nic_t *enp, __out uint32_t *maskp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_phy_oui_get(__in efx_nic_t *enp,
                                              __out uint32_t *ouip);
 ...
 */
LIBEFX_API
extern void efx_phy_media_type_get(__in efx_nic_t *enp,
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_phy_module_get_info(
    __in efx_nic_t *enp, __in uint8_t dev_addr, __in size_t offset,
    __in size_t len, __out_bcount(len) uint8_t *data);
...
LIBEFX_API
extern const char *efx_phy_stat_name(__in efx_nic_t *enp,
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_bist_enable_offline(__in efx_nic_t *enp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_bist_start(__in efx_nic_t *enp,
                                             __in efx_bist_type_t type);

LIBEFX_API
extern __checkReturn efx_rc_t efx_bist_poll(
    __in efx_nic_t *enp, __in efx_bist_type_t type,
...
LIBEFX_API
extern void efx_bist_stop(__in efx_nic_t *enp, __in efx_bist_type_t type);
...
LIBEFX_API
extern const efx_nic_cfg_t *efx_nic_cfg_get(__in const efx_nic_t *enp);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_nic_get_board_info(
    __in efx_nic_t *enp, __out efx_nic_board_info_t *board_infop);
 ...
 */
LIBEFX_API
extern __checkReturn efx_rc_t efx_nic_set_drv_version(
    __inout efx_nic_t *enp, __in_ecount(length) char const *verp,
    __in size_t length);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_nic_get_vi_pool(__in efx_nic_t *enp,
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_vpd_init(__in efx_nic_t *enp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_vpd_size(__in efx_nic_t *enp,
                                           __out size_t *sizep);

LIBEFX_API
extern __checkReturn efx_rc_t efx_vpd_read(__in efx_nic_t *enp,
                                           __out_bcount(size) caddr_t data,
                                           __in size_t size);

LIBEFX_API
extern __checkReturn efx_rc_t efx_vpd_verify(__in efx_nic_t *enp,
                                             __in_bcount(size) caddr_t data,
                                             __in size_t size);

LIBEFX_API
extern __checkReturn efx_rc_t efx_vpd_reinit(__in efx_nic_t *enp,
                                             __in_bcount(size) caddr_t data,
                                             __in size_t size);

LIBEFX_API
extern __checkReturn efx_rc_t efx_vpd_get(__in efx_nic_t *enp,
                                          __in_bcount(size) caddr_t data,
                                          __in size_t size,
                                          __inout efx_vpd_value_t *evvp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_vpd_set(__in efx_nic_t *enp,
                                          __inout_bcount(size) caddr_t data,
                                          __in size_t size,
                                          __in efx_vpd_value_t *evvp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_vpd_next(__in efx_nic_t *enp,
                                           __inout_bcount(size) caddr_t data,
                                           __in size_t size,
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_vpd_write(__in efx_nic_t *enp,
                                            __in_bcount(size) caddr_t data,
                                            __in size_t size);

LIBEFX_API
extern void efx_vpd_fini(__in efx_nic_t *enp);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_nvram_init(__in efx_nic_t *enp);

#if EFSYS_OPT_DIAG

LIBEFX_API
extern __checkReturn efx_rc_t efx_nvram_test(__in efx_nic_t *enp);

#endif /* EFSYS_OPT_DIAG */

LIBEFX_API
extern __checkReturn efx_rc_t efx_nvram_size(__in efx_nic_t *enp,
                                             __in efx_nvram_type_t type,
                                             __out size_t *sizep);

LIBEFX_API
extern __checkReturn efx_rc_t efx_nvram_info(__in efx_nic_t *enp,
                                             __in efx_nvram_type_t type,
                                             __out efx_nvram_info_t *enip);

LIBEFX_API
extern __checkReturn efx_rc_t efx_nvram_rw_start(__in efx_nic_t *enp,
                                                 __in efx_nvram_type_t type,
                                                 __out_opt size_t *pref_chunkp);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_nvram_rw_finish(__in efx_nic_t *enp, __in efx_nvram_type_t type,
                    __out_opt uint32_t *verify_resultp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_nvram_get_version(__in efx_nic_t *enp,
                                                    __in efx_nvram_type_t type,
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_nvram_read_chunk(
    __in efx_nic_t *enp, __in efx_nvram_type_t type, __in unsigned int offset,
    __out_bcount(size) caddr_t data, __in size_t size);

LIBEFX_API
extern __checkReturn efx_rc_t efx_nvram_read_backup(
    __in efx_nic_t *enp, __in efx_nvram_type_t type, __in unsigned int offset,
    __out_bcount(size) caddr_t data, __in size_t size);

LIBEFX_API
extern __checkReturn efx_rc_t efx_nvram_set_version(__in efx_nic_t *enp,
                                                    __in efx_nvram_type_t type,
                                                    __in_ecount(4)
                                                        uint16_t version[4]);

LIBEFX_API
extern __checkReturn efx_rc_t efx_nvram_validate(__in efx_nic_t *enp,
                                                 __in efx_nvram_type_t type,
                                                 __in_bcount(partn_size)
                                                     caddr_t partn_data,
                                                 __in size_t partn_size);

LIBEFX_API
extern __checkReturn efx_rc_t efx_nvram_erase(__in efx_nic_t *enp,
                                              __in efx_nvram_type_t type);

LIBEFX_API
extern __checkReturn efx_rc_t efx_nvram_write_chunk(
    __in efx_nic_t *enp, __in efx_nvram_type_t type, __in unsigned int offset,
    __in_bcount(size) caddr_t data, __in size_t size);

LIBEFX_API
extern void efx_nvram_fini(__in efx_nic_t *enp);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_bootcfg_sector_info(
    __in efx_nic_t *enp, __in uint32_t pf, __out_opt uint32_t *sector_countp,
    __out size_t *offsetp, __out size_t *max_sizep);
 ...
 */
LIBEFX_API
extern efx_rc_t efx_bootcfg_copy_sector(
    __in efx_nic_t *enp, __inout_bcount(sector_length) uint8_t *sector,
    __in size_t sector_length, __out_bcount(data_size) uint8_t *data,
    __in size_t data_size, __in boolean_t handle_format_errors);

LIBEFX_API
extern efx_rc_t efx_bootcfg_read(__in efx_nic_t *enp,
                                 __out_bcount(size) uint8_t *data,
                                 __in size_t size);

LIBEFX_API
extern efx_rc_t efx_bootcfg_write(__in efx_nic_t *enp,
...
LIBEFX_API
extern __checkReturn uint8_t efx_dhcp_csum(__in_bcount(size)
                                               uint8_t const *data,
                                           __in size_t size);

LIBEFX_API
extern __checkReturn efx_rc_t efx_dhcp_verify(__in_bcount(size)
                                                  uint8_t const *data,
                                              __in size_t size,
                                              __out_opt size_t *usedp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_dhcp_find_tag(__in_bcount(buffer_length)
                                                    uint8_t *bufferp,
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_dhcp_find_end(__in_bcount(buffer_length)
                                                    uint8_t *bufferp,
                                                __in size_t buffer_length,
                                                __deref_out uint8_t **endpp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_dhcp_delete_tag(__inout_bcount(buffer_length)
                                                      uint8_t *bufferp,
                                                  __in size_t buffer_length,
                                                  __in uint16_t opt);

LIBEFX_API
extern __checkReturn efx_rc_t efx_dhcp_add_tag(
    __inout_bcount(buffer_length) uint8_t *bufferp, __in size_t buffer_length,
    __in uint16_t opt, __in_bcount_opt(value_length) uint8_t *valuep,
    __in size_t value_length);

LIBEFX_API
extern __checkReturn efx_rc_t efx_dhcp_update_tag(
    __inout_bcount(buffer_length) uint8_t *bufferp, __in size_t buffer_length,
    __in uint16_t opt, __in uint8_t *value_locationp,
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_build_signed_image_write_buffer(
    __out_bcount(buffer_size) uint8_t *bufferp, __in uint32_t buffer_size,
    __in efx_image_info_t *infop, __out efx_image_header_t **headerpp);
...
typedef void (*efx_sram_pattern_fn_t)(__in size_t row, __in boolean_t negate,
                                      __out efx_qword_t *eqp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_sram_test(__in efx_nic_t *enp,
                                            __in efx_pattern_type_t type);

#endif /* EFSYS_OPT_DIAG */

LIBEFX_API
extern __checkReturn efx_rc_t efx_sram_buf_tbl_set(__in efx_nic_t *enp,
                                                   __in uint32_t id,
                                                   __in efsys_mem_t *esmp,
                                                   __in size_t n);

LIBEFX_API
extern void efx_sram_buf_tbl_clear(__in efx_nic_t *enp, __in uint32_t id,
                                   __in size_t n);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_ev_init(__in efx_nic_t *enp);

LIBEFX_API
extern void efx_ev_fini(__in efx_nic_t *enp);

LIBEFX_API
extern __checkReturn size_t efx_evq_size(__in const efx_nic_t *enp,
                                         __in unsigned int ndescs,
                                         __in uint32_t flags);

LIBEFX_API
extern __checkReturn unsigned int efx_evq_nbufs(__in const efx_nic_t *enp,
                                                __in unsigned int ndescs,
                                                __in uint32_t flags);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_ev_qcreate(
    __in efx_nic_t *enp, __in unsigned int index, __in efsys_mem_t *esmp,
    __in size_t ndescs, __in uint32_t id, __in uint32_t us, __in uint32_t flags,
    __deref_out efx_evq_t **eepp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_ev_qcreate_irq(
    __in efx_nic_t *enp, __in unsigned int index, __in efsys_mem_t *esmp,
    __in size_t ndescs, __in uint32_t id, __in uint32_t us, __in uint32_t flags,
    __in uint32_t irq, __deref_out efx_evq_t **eepp);

LIBEFX_API
extern void efx_ev_qpost(__in efx_evq_t *eep, __in uint16_t data);

typedef __checkReturn boolean_t (*efx_initialized_ev_t)(__in_opt void *arg);
...
typedef __checkReturn boolean_t (*efx_rx_ev_t)(__in_opt void *arg,
                                               __in uint32_t label,
                                               __in uint32_t id,
                                               __in uint32_t size,
                                               __in uint16_t flags);
...
typedef __checkReturn
    boolean_t (*efx_rx_packets_ev_t)(__in_opt void *arg, __in uint32_t label,
...
typedef __checkReturn boolean_t (*efx_rx_ps_ev_t)(__in_opt void *arg,
                                                  __in uint32_t label,
                                                  __in uint32_t id,
...
typedef __checkReturn boolean_t (*efx_tx_ev_t)(__in_opt void *arg,
                                               __in uint32_t label,
                                               __in uint32_t id);

typedef __checkReturn boolean_t (*efx_tx_ndescs_ev_t)(__in_opt void *arg,
                                                      __in uint32_t label,
                                                      __in unsigned int ndescs);
...
typedef __checkReturn boolean_t (*efx_exception_ev_t)(__in_opt void *arg,
                                                      __in uint32_t label,
                                                      __in uint32_t data);

typedef __checkReturn
    boolean_t (*efx_rxq_flush_done_ev_t)(__in_opt void *arg,
                                         __in uint32_t rxq_index);

typedef __checkReturn
    boolean_t (*efx_rxq_flush_failed_ev_t)(__in_opt void *arg,
                                           __in uint32_t rxq_index);

typedef __checkReturn
    boolean_t (*efx_txq_flush_done_ev_t)(__in_opt void *arg,
                                         __in uint32_t txq_index);

typedef __checkReturn boolean_t (*efx_software_ev_t)(__in_opt void *arg,
                                                     __in uint16_t magic);

typedef __checkReturn boolean_t (*efx_sram_ev_t)(__in_opt void *arg,
                                                 __in uint32_t code);
...
typedef __checkReturn boolean_t (*efx_wake_up_ev_t)(__in_opt void *arg,
                                                    __in uint32_t label);

typedef __checkReturn boolean_t (*efx_timer_ev_t)(__in_opt void *arg,
                                                  __in uint32_t label);

typedef __checkReturn
    boolean_t (*efx_link_change_ev_t)(__in_opt void *arg,
                                      __in efx_link_mode_t link_mode);

#if EFSYS_OPT_MON_STATS

typedef __checkReturn
    boolean_t (*efx_monitor_ev_t)(__in_opt void *arg, __in efx_mon_stat_t id,
...
typedef __checkReturn boolean_t (*efx_mac_stats_ev_t)(__in_opt void *arg,
 ...
 */
typedef __checkReturn boolean_t (*efx_desc_proxy_txq_desc_ev_t)(
    __in_opt void *arg, __in uint16_t vi_id, __in efx_oword_t txq_desc);
 ...
 * to extract the descriptor fields as host endian values.
 */
typedef __checkReturn boolean_t (*efx_desc_proxy_virtq_desc_ev_t)(
    __in_opt void *arg, __in uint16_t vi_id, __in uint16_t avail,
...
LIBEFX_API
extern __checkReturn boolean_t efx_ev_qpending(__in efx_evq_t *eep,
                                               __in unsigned int count);

#if EFSYS_OPT_EV_PREFETCH

LIBEFX_API
extern void efx_ev_qprefetch(__in efx_evq_t *eep, __in unsigned int count);

#endif /* EFSYS_OPT_EV_PREFETCH */

LIBEFX_API
extern void efx_ev_qcreate_check_init_done(__in efx_evq_t *eep,
                                           __in const efx_ev_callbacks_t *eecp,
                                           __in_opt void *arg);

LIBEFX_API
extern void efx_ev_qpoll(__in efx_evq_t *eep, __inout unsigned int *countp,
                         __in const efx_ev_callbacks_t *eecp,
                         __in_opt void *arg);

LIBEFX_API
extern __checkReturn efx_rc_t efx_ev_usecs_to_ticks(__in efx_nic_t *enp,
                                                    __in unsigned int usecs,
                                                    __out unsigned int *ticksp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_ev_qmoderate(__in efx_evq_t *eep,
                                               __in unsigned int us);

LIBEFX_API
extern __checkReturn efx_rc_t efx_ev_qprime(__in efx_evq_t *eep,
                                            __in unsigned int count);
...
LIBEFX_API
extern const char *efx_ev_qstat_name(__in efx_nic_t *enp, __in unsigned int id);

#endif /* EFSYS_OPT_NAMES */

LIBEFX_API
extern void efx_ev_qstats_update(__in efx_evq_t *eep,
                                 __inout_ecount(EV_NQSTATS) efsys_stat_t *stat);

#endif /* EFSYS_OPT_QSTATS */

LIBEFX_API
extern void efx_ev_qdestroy(__in efx_evq_t *eep);

/* RX */

LIBEFX_API
extern __checkReturn efx_rc_t efx_rx_init(__inout efx_nic_t *enp);

LIBEFX_API
extern void efx_rx_fini(__in efx_nic_t *enp);

#if EFSYS_OPT_RX_SCATTER
LIBEFX_API
extern __checkReturn efx_rc_t efx_rx_scatter_enable(__in efx_nic_t *enp,
...
#define EFX_RX_HASH_LEGACY_MASK                                                \
  (EFX_RX_HASH_IPV4 | EFX_RX_HASH_TCPIPV4 | EFX_RX_HASH_IPV6 |                 \
   EFX_RX_HASH_TCPIPV6)
...
#define EFX_RX_CLASS_HASH_2TUPLE                                               \
  (EFX_RX_CLASS_HASH_SRC_ADDR | EFX_RX_CLASS_HASH_DST_ADDR)

#define EFX_RX_CLASS_HASH_2TUPLE_SRC                                           \
  (EFX_RX_CLASS_HASH_SRC_ADDR | EFX_RX_CLASS_HASH_SRC_PORT)

#define EFX_RX_CLASS_HASH_2TUPLE_DST                                           \
  (EFX_RX_CLASS_HASH_DST_ADDR | EFX_RX_CLASS_HASH_DST_PORT)

#define EFX_RX_CLASS_HASH_4TUPLE                                               \
  (EFX_RX_CLASS_HASH_SRC_ADDR | EFX_RX_CLASS_HASH_DST_ADDR |                   \
   EFX_RX_CLASS_HASH_SRC_PORT | EFX_RX_CLASS_HASH_DST_PORT)
...
#define EFX_RX_HASH(_class, _tuple)                                            \
  EFX_INSERT_FIELD_NATIVE32(0, 31, EFX_RX_CLASS_##_class,                      \
                            EFX_RX_CLASS_HASH_##_tuple)
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_rx_scale_hash_flags_get(
    __in efx_nic_t *enp, __in efx_rx_hash_alg_t hash_alg,
    __out_ecount_part(max_nflags, *nflagsp) unsigned int *flagsp,
    __in unsigned int max_nflags, __out unsigned int *nflagsp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_rx_hash_default_support_get(
    __in efx_nic_t *enp, __out efx_rx_hash_support_t *supportp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_rx_scale_default_support_get(
    __in efx_nic_t *enp, __out efx_rx_scale_context_type_t *typep);

LIBEFX_API
extern __checkReturn efx_rc_t efx_rx_scale_context_alloc(
    __in efx_nic_t *enp, __in efx_rx_scale_context_type_t type,
    __in uint32_t num_queues, __out uint32_t *rss_contextp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_rx_scale_context_alloc_v2(
    __in efx_nic_t *enp, __in efx_rx_scale_context_type_t type,
    __in uint32_t num_queues, __in uint32_t table_nentries,
    __out uint32_t *rss_contextp);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_rx_scale_context_free(__in efx_nic_t *enp, __in uint32_t rss_context);

LIBEFX_API
extern __checkReturn efx_rc_t efx_rx_scale_mode_set(
    __in efx_nic_t *enp, __in uint32_t rss_context, __in efx_rx_hash_alg_t alg,
    __in efx_rx_hash_type_t type, __in boolean_t insert);

LIBEFX_API
extern __checkReturn efx_rc_t efx_rx_scale_tbl_set(
    __in efx_nic_t *enp, __in uint32_t rss_context,
    __in_ecount(nentries) unsigned int *table, __in size_t nentries);

LIBEFX_API
extern __checkReturn efx_rc_t efx_rx_scale_key_set(__in efx_nic_t *enp,
                                                   __in uint32_t rss_context,
                                                   __in_ecount(n) uint8_t *key,
                                                   __in size_t n);

LIBEFX_API
extern __checkReturn uint32_t efx_pseudo_hdr_hash_get(
    __in efx_rxq_t *erp, __in efx_rx_hash_alg_t func, __in uint8_t *buffer);

#endif /* EFSYS_OPT_RX_SCALE */

LIBEFX_API
extern __checkReturn efx_rc_t efx_pseudo_hdr_pkt_length_get(
    __in efx_rxq_t *erp, __in uint8_t *buffer, __out uint16_t *pkt_lengthp);

LIBEFX_API
extern __checkReturn size_t efx_rxq_size(__in const efx_nic_t *enp,
                                         __in unsigned int ndescs);

LIBEFX_API
extern __checkReturn unsigned int efx_rxq_nbufs(__in const efx_nic_t *enp,
                                                __in unsigned int ndescs);
...
efx_rx_prefix_layout_check(__in const efx_rx_prefix_layout_t *available,
                           __in const efx_rx_prefix_layout_t *wanted);

LIBEFX_API
extern __checkReturn efx_rc_t efx_rx_prefix_get_layout(
    __in const efx_rxq_t *erp, __out efx_rx_prefix_layout_t *erplp);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_rx_qcreate(
    __in efx_nic_t *enp, __in unsigned int index, __in unsigned int label,
    __in efx_rxq_type_t type, __in size_t buf_size, __in efsys_mem_t *esmp,
    __in size_t ndescs, __in uint32_t id, __in unsigned int flags,
    __in efx_evq_t *eep, __deref_out efx_rxq_t **erpp);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_rx_qcreate_packed_stream(
    __in efx_nic_t *enp, __in unsigned int index, __in unsigned int label,
    __in uint32_t ps_buf_size, __in efsys_mem_t *esmp, __in size_t ndescs,
    __in efx_evq_t *eep, __deref_out efx_rxq_t **erpp);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_rx_qcreate_es_super_buffer(
    __in efx_nic_t *enp, __in unsigned int index, __in unsigned int label,
    __in uint32_t n_bufs_per_desc, __in uint32_t max_dma_len,
    __in uint32_t buf_stride, __in uint32_t hol_block_timeout,
    __in efsys_mem_t *esmp, __in size_t ndescs, __in unsigned int flags,
    __in efx_evq_t *eep, __deref_out efx_rxq_t **erpp);
...
LIBEFX_API
extern void efx_rx_qpost(__in efx_rxq_t *erp,
                         __in_ecount(ndescs) efsys_dma_addr_t *addrp,
                         __in size_t size, __in unsigned int ndescs,
                         __in unsigned int completed, __in unsigned int added);

LIBEFX_API
extern void efx_rx_qpush(__in efx_rxq_t *erp, __in unsigned int added,
                         __inout unsigned int *pushedp);

#if EFSYS_OPT_RX_PACKED_STREAM

LIBEFX_API
extern void efx_rx_qpush_ps_credits(__in efx_rxq_t *erp);

LIBEFX_API
extern __checkReturn uint8_t *
efx_rx_qps_packet_info(__in efx_rxq_t *erp, __in uint8_t *buffer,
                       __in uint32_t buffer_length,
                       __in uint32_t current_offset, __out uint16_t *lengthp,
                       __out uint32_t *next_offsetp, __out uint32_t *timestamp);
#endif

LIBEFX_API
extern __checkReturn efx_rc_t efx_rx_qflush(__in efx_rxq_t *erp);

LIBEFX_API
extern void efx_rx_qenable(__in efx_rxq_t *erp);

LIBEFX_API
extern void efx_rx_qdestroy(__in efx_rxq_t *erp);
...
typedef enum efx_tx_qstat_e { TX_POST, TX_POST_PIO, TX_NQSTATS } efx_tx_qstat_t;
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_tx_init(__in efx_nic_t *enp);

LIBEFX_API
extern void efx_tx_fini(__in efx_nic_t *enp);

LIBEFX_API
extern __checkReturn size_t efx_txq_size(__in const efx_nic_t *enp,
                                         __in unsigned int ndescs);

LIBEFX_API
extern __checkReturn unsigned int efx_txq_nbufs(__in const efx_nic_t *enp,
                                                __in unsigned int ndescs);
...
LIBEFX_API
extern __checkReturn efx_rc_t
efx_tx_qcreate(__in efx_nic_t *enp, __in unsigned int index,
               __in unsigned int label, __in efsys_mem_t *esmp, __in size_t n,
               __in uint32_t id, __in uint16_t flags, __in efx_evq_t *eep,
               __deref_out efx_txq_t **etpp, __out unsigned int *addedp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_tx_qpost(__in efx_txq_t *etp,
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_tx_qpace(__in efx_txq_t *etp,
                                           __in unsigned int ns);

LIBEFX_API
extern void efx_tx_qpush(__in efx_txq_t *etp, __in unsigned int added,
                         __in unsigned int pushed);

LIBEFX_API
extern __checkReturn efx_rc_t efx_tx_qflush(__in efx_txq_t *etp);

LIBEFX_API
extern void efx_tx_qenable(__in efx_txq_t *etp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_tx_qpio_enable(__in efx_txq_t *etp);

LIBEFX_API
extern void efx_tx_qpio_disable(__in efx_txq_t *etp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_tx_qpio_write(__in efx_txq_t *etp,
                                                __in_ecount(buf_length)
                                                    uint8_t *buffer,
                                                __in size_t buf_length,
                                                __in size_t pio_buf_offset);

LIBEFX_API
extern __checkReturn efx_rc_t efx_tx_qpio_post(__in efx_txq_t *etp,
                                               __in size_t pkt_length,
                                               __in unsigned int completed,
                                               __inout unsigned int *addedp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_tx_qdesc_post(__in efx_txq_t *etp,
...
LIBEFX_API
extern void efx_tx_qdesc_dma_create(__in efx_txq_t *etp,
                                    __in efsys_dma_addr_t addr,
                                    __in size_t size, __in boolean_t eop,
                                    __out efx_desc_t *edp);

LIBEFX_API
extern void efx_tx_qdesc_tso_create(__in efx_txq_t *etp, __in uint16_t ipv4_id,
...
LIBEFX_API
extern void efx_tx_qdesc_tso2_create(__in efx_txq_t *etp, __in uint16_t ipv4_id,
...
LIBEFX_API
extern void efx_tx_qdesc_vlantci_create(__in efx_txq_t *etp, __in uint16_t tci,
                                        __out efx_desc_t *edp);

LIBEFX_API
extern void efx_tx_qdesc_checksum_create(__in efx_txq_t *etp,
                                         __in uint16_t flags,
                                         __out efx_desc_t *edp);
...
LIBEFX_API
extern const char *efx_tx_qstat_name(__in efx_nic_t *etp, __in unsigned int id);

#endif /* EFSYS_OPT_NAMES */

LIBEFX_API
extern void efx_tx_qstats_update(__in efx_txq_t *etp,
                                 __inout_ecount(TX_NQSTATS) efsys_stat_t *stat);

#endif /* EFSYS_OPT_QSTATS */

LIBEFX_API
extern void efx_tx_qdestroy(__in efx_txq_t *etp);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_filter_init(__in efx_nic_t *enp);

LIBEFX_API
extern void efx_filter_fini(__in efx_nic_t *enp);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_filter_insert(__in efx_nic_t *enp, __inout efx_filter_spec_t *spec);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_filter_remove(__in efx_nic_t *enp, __inout efx_filter_spec_t *spec);

LIBEFX_API
extern __checkReturn efx_rc_t efx_filter_restore(__in efx_nic_t *enp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_filter_supported_filters(
    __in efx_nic_t *enp, __out_ecount(buffer_length) uint32_t *buffer,
    __in size_t buffer_length, __out size_t *list_lengthp);

LIBEFX_API
extern void efx_filter_spec_init_rx(__out efx_filter_spec_t *spec,
                                    __in efx_filter_priority_t priority,
                                    __in efx_filter_flags_t flags,
                                    __in efx_rxq_t *erp);

LIBEFX_API
extern void efx_filter_spec_init_tx(__out efx_filter_spec_t *spec,
                                    __in efx_txq_t *etp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_filter_spec_set_ipv4_local(
    __inout efx_filter_spec_t *spec, __in uint8_t proto, __in uint32_t host,
    __in uint16_t port);

LIBEFX_API
extern __checkReturn efx_rc_t efx_filter_spec_set_ipv4_full(
    __inout efx_filter_spec_t *spec, __in uint8_t proto, __in uint32_t lhost,
    __in uint16_t lport, __in uint32_t rhost, __in uint16_t rport);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_filter_spec_set_eth_local(__inout efx_filter_spec_t *spec,
                              __in uint16_t vid, __in const uint8_t *addr);

LIBEFX_API
extern void efx_filter_spec_set_ether_type(__inout efx_filter_spec_t *spec,
                                           __in uint16_t ether_type);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_filter_spec_set_uc_def(__inout efx_filter_spec_t *spec);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_filter_spec_set_mc_def(__inout efx_filter_spec_t *spec);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_filter_spec_set_encap_type(
    __inout efx_filter_spec_t *spec, __in efx_tunnel_protocol_t encap_type,
    __in efx_filter_inner_frame_match_t inner_frame_match);

LIBEFX_API
extern __checkReturn efx_rc_t efx_filter_spec_set_vxlan(
    __inout efx_filter_spec_t *spec, __in const uint8_t *vni,
    __in const uint8_t *inner_addr, __in const uint8_t *outer_addr);

LIBEFX_API
extern __checkReturn efx_rc_t efx_filter_spec_set_geneve(
    __inout efx_filter_spec_t *spec, __in const uint8_t *vni,
    __in const uint8_t *inner_addr, __in const uint8_t *outer_addr);

LIBEFX_API
extern __checkReturn efx_rc_t efx_filter_spec_set_nvgre(
    __inout efx_filter_spec_t *spec, __in const uint8_t *vsid,
    __in const uint8_t *inner_addr, __in const uint8_t *outer_addr);

#if EFSYS_OPT_RX_SCALE
LIBEFX_API
extern __checkReturn efx_rc_t efx_filter_spec_set_rss_context(
    __inout efx_filter_spec_t *spec, __in uint32_t rss_context);
#endif
...
LIBEFX_API
extern __checkReturn uint32_t efx_hash_dwords(__in_ecount(count)
                                                  uint32_t const *input,
                                              __in size_t count,
                                              __in uint32_t init);

LIBEFX_API
extern __checkReturn uint32_t efx_hash_bytes(__in_ecount(length)
                                                 uint8_t const *input,
                                             __in size_t length,
                                             __in uint32_t init);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_lic_init(__in efx_nic_t *enp);

LIBEFX_API
extern void efx_lic_fini(__in efx_nic_t *enp);

LIBEFX_API
extern __checkReturn boolean_t efx_lic_check_support(__in efx_nic_t *enp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_lic_update_licenses(__in efx_nic_t *enp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_lic_get_key_stats(__in efx_nic_t *enp,
                                                    __out efx_key_stats_t *ksp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_lic_app_state(__in efx_nic_t *enp,
                                                __in uint64_t app_id,
                                                __out boolean_t *licensedp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_lic_get_id(__in efx_nic_t *enp,
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_lic_find_start(__in efx_nic_t *enp,
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_lic_find_end(
    __in efx_nic_t *enp, __in_bcount(buffer_size) caddr_t bufferp,
    __in size_t buffer_size, __in uint32_t offset, __out uint32_t *endp);

LIBEFX_API
extern __checkReturn __success(return != B_FALSE) boolean_t
    efx_lic_find_key(__in efx_nic_t *enp,
                     __in_bcount(buffer_size) caddr_t bufferp,
                     __in size_t buffer_size, __in uint32_t offset,
                     __out uint32_t *startp, __out uint32_t *lengthp);

LIBEFX_API
extern __checkReturn __success(return != B_FALSE) boolean_t
    efx_lic_validate_key(__in efx_nic_t *enp, __in_bcount(length) caddr_t keyp,
                         __in uint32_t length);

LIBEFX_API
extern __checkReturn efx_rc_t efx_lic_read_key(
    __in efx_nic_t *enp, __in_bcount(buffer_size) caddr_t bufferp,
    __in size_t buffer_size, __in uint32_t offset, __in uint32_t length,
    __out_bcount_part(key_max_size, *lengthp) caddr_t keyp,
    __in size_t key_max_size, __out uint32_t *lengthp);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_lic_write_key(__in efx_nic_t *enp, __in_bcount(buffer_size) caddr_t bufferp,
                  __in size_t buffer_size, __in uint32_t offset,
                  __in_bcount(length) caddr_t keyp, __in uint32_t length,
                  __out uint32_t *lengthp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_lic_delete_key(
    __in efx_nic_t *enp, __in_bcount(buffer_size) caddr_t bufferp,
    __in size_t buffer_size, __in uint32_t offset, __in uint32_t length,
    __in uint32_t end, __out uint32_t *deltap);

LIBEFX_API
extern __checkReturn efx_rc_t efx_lic_create_partition(__in efx_nic_t *enp,
                                                       __in_bcount(buffer_size)
                                                           caddr_t bufferp,
                                                       __in size_t buffer_size);

extern __checkReturn efx_rc_t efx_lic_finish_partition(__in efx_nic_t *enp,
                                                       __in_bcount(buffer_size)
                                                           caddr_t bufferp,
                                                       __in size_t buffer_size);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_tunnel_init(__in efx_nic_t *enp);

LIBEFX_API
extern void efx_tunnel_fini(__in efx_nic_t *enp);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_tunnel_config_udp_add(
    __in efx_nic_t *enp, __in uint16_t port /* host/cpu-endian */,
 ...
 */
LIBEFX_API
extern __checkReturn efx_rc_t efx_tunnel_config_udp_remove(
    __in efx_nic_t *enp, __in uint16_t port /* host/cpu-endian */,
    __in efx_tunnel_protocol_t protocol);
 ...
 */
LIBEFX_API
extern __checkReturn efx_rc_t efx_tunnel_config_clear(__in efx_nic_t *enp);
 ...
 */
LIBEFX_API
extern __checkReturn efx_rc_t efx_tunnel_reconfigure(__in efx_nic_t *enp);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_nic_get_fw_subvariant(
    __in efx_nic_t *enp, __out efx_nic_fw_subvariant_t *subvariantp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_nic_set_fw_subvariant(
    __in efx_nic_t *enp, __in efx_nic_fw_subvariant_t subvariant);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_evb_init(__in efx_nic_t *enp);

LIBEFX_API
extern void efx_evb_fini(__in efx_nic_t *enp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_evb_vswitch_create(
    __in efx_nic_t *enp, __in uint32_t num_vports,
    __inout_ecount(num_vports) efx_vport_config_t *vport_configp,
    __deref_out efx_vswitch_t **evpp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_evb_vswitch_destroy(__in efx_nic_t *enp,
                                                      __in efx_vswitch_t *evp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_evb_vport_mac_set(
    __in efx_nic_t *enp, __in efx_vswitch_t *evp, __in efx_vport_id_t vport_id,
    __in_bcount(EFX_MAC_ADDR_LEN) uint8_t *addrp);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_evb_vport_vlan_set(__in efx_nic_t *enp, __in efx_vswitch_t *evp,
                       __in efx_vport_id_t vport_id, __in uint16_t vid);

LIBEFX_API
extern __checkReturn efx_rc_t efx_evb_vport_reset(
    __in efx_nic_t *enp, __in efx_vswitch_t *evp, __in efx_vport_id_t vport_id,
    __in_bcount(EFX_MAC_ADDR_LEN) uint8_t *addrp, __in uint16_t vid,
    __out boolean_t *is_fn_resetp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_evb_vport_stats(
    __in efx_nic_t *enp, __in efx_vswitch_t *evp, __in efx_vport_id_t vport_id,
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_proxy_auth_init(__in efx_nic_t *enp);

LIBEFX_API
extern void efx_proxy_auth_fini(__in efx_nic_t *enp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_proxy_auth_configure(
    __in efx_nic_t *enp, __in efx_proxy_auth_config_t *configp);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_proxy_auth_destroy(__in efx_nic_t *enp, __in uint32_t handled_privileges);

LIBEFX_API
extern __checkReturn efx_rc_t efx_proxy_auth_complete_request(
    __in efx_nic_t *enp, __in uint32_t fn_index, __in uint32_t proxy_result,
    __in uint32_t handle);

LIBEFX_API
extern __checkReturn efx_rc_t efx_proxy_auth_exec_cmd(
    __in efx_nic_t *enp, __inout efx_proxy_cmd_params_t *paramsp);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_proxy_auth_set_privilege_mask(__in efx_nic_t *enp, __in uint32_t vf_index,
                                  __in uint32_t mask, __in uint32_t value);

LIBEFX_API
extern __checkReturn efx_rc_t efx_proxy_auth_privilege_mask_get(
    __in efx_nic_t *enp, __in uint32_t pf_index, __in uint32_t vf_index,
    __out uint32_t *maskp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_proxy_auth_privilege_modify(
    __in efx_nic_t *enp, __in uint32_t pf_index, __in uint32_t vf_index,
    __in uint32_t add_privileges_mask, __in uint32_t remove_privileges_mask);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_init(__in efx_nic_t *enp);

LIBEFX_API
extern void efx_mae_fini(__in efx_nic_t *enp);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_get_limits(__in efx_nic_t *enp,
...
LIBEFX_API
extern __checkReturn efx_rc_t
efx_mae_match_spec_init(__in efx_nic_t *enp, __in efx_mae_rule_type_t type,
                        __in uint32_t prio, __out efx_mae_match_spec_t **specp);

LIBEFX_API
extern void efx_mae_match_spec_fini(__in efx_nic_t *enp,
...
LIBEFX_API
extern __checkReturn efx_rc_t
efx_mae_mport_invalid(__out efx_mport_sel_t *mportp);
 ...
 */
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_mport_by_phy_port(
    __in uint32_t phy_port, __out efx_mport_sel_t *mportp);
 ...
 */
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_mport_by_pcie_function(
    __in uint32_t pf, __in uint32_t vf, __out efx_mport_sel_t *mportp);
 ...
 */
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_mport_by_pcie_mh_function(
    __in efx_pcie_interface_t intf, __in uint32_t pf, __in uint32_t vf,
 ...
 */
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_mport_by_id(
    __in const efx_mport_id_t *mport_idp, __out efx_mport_sel_t *mportp);

/* Get MPORT ID by an MPORT selector */
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_mport_id_by_selector(
    __in efx_nic_t *enp, __in const efx_mport_sel_t *mport_selectorp,
 ...
 */
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_match_spec_field_set(
    __in efx_mae_match_spec_t *spec, __in efx_mae_field_id_t field_id,
    __in size_t value_size, __in_bcount(value_size) const uint8_t *value,
    __in size_t mask_size, __in_bcount(mask_size) const uint8_t *mask);

/* The corresponding mask will be set to B_TRUE. */
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_match_spec_bit_set(
    __in efx_mae_match_spec_t *spec, __in efx_mae_field_id_t field_id,
    __in boolean_t value);

/* If the mask argument is NULL, the API will use full mask by default. */
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_match_spec_mport_set(
    __in efx_mae_match_spec_t *spec, __in const efx_mport_sel_t *valuep,
    __in_opt const efx_mport_sel_t *maskp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_match_spec_recirc_id_set(
    __in efx_mae_match_spec_t *spec, __in uint8_t recirc_id);

LIBEFX_API
extern __checkReturn boolean_t
efx_mae_match_specs_equal(__in const efx_mae_match_spec_t *left,
 ...
 */
LIBEFX_API
extern __checkReturn boolean_t efx_mae_match_spec_is_valid(
    __in efx_nic_t *enp, __in const efx_mae_match_spec_t *spec);

typedef struct efx_mae_actions_s efx_mae_actions_t;

LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_action_set_spec_init(
    __in efx_nic_t *enp, __out efx_mae_actions_t **specp);

LIBEFX_API
extern void efx_mae_action_set_spec_fini(__in efx_nic_t *enp,
                                         __in efx_mae_actions_t *spec);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_mae_action_set_populate_decap(__in efx_mae_actions_t *spec);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_mae_action_set_populate_vlan_pop(__in efx_mae_actions_t *spec);
...
LIBEFX_API
extern __checkReturn efx_rc_t
efx_mae_action_set_populate_set_dst_mac(__in efx_mae_actions_t *spec);
...
LIBEFX_API
extern __checkReturn efx_rc_t
efx_mae_action_set_populate_set_src_mac(__in efx_mae_actions_t *spec);
...
LIBEFX_API
extern __checkReturn efx_rc_t
efx_mae_action_set_populate_decr_ip_ttl(__in efx_mae_actions_t *spec);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_action_set_populate_vlan_push(
    __in efx_mae_actions_t *spec, __in uint16_t tpid_be, __in uint16_t tci_be);
...
LIBEFX_API
extern __checkReturn efx_rc_t
efx_mae_action_set_populate_encap(__in efx_mae_actions_t *spec);
...
LIBEFX_API
extern __checkReturn efx_rc_t
efx_mae_action_set_populate_count(__in efx_mae_actions_t *spec);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_mae_action_set_populate_flag(__in efx_mae_actions_t *spec);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_action_set_populate_mark(
    __in efx_mae_actions_t *spec, __in uint32_t mark_value);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_action_set_populate_deliver(
    __in efx_mae_actions_t *spec, __in const efx_mport_sel_t *mportp);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_mae_action_set_populate_drop(__in efx_mae_actions_t *spec);

LIBEFX_API
extern __checkReturn boolean_t efx_mae_action_set_specs_equal(
    __in const efx_mae_actions_t *left, __in const efx_mae_actions_t *right);
 ...
 */
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_match_specs_class_cmp(
    __in efx_nic_t *enp, __in const efx_mae_match_spec_t *left,
    __in const efx_mae_match_spec_t *right, __out boolean_t *have_same_classp);
 ...
 */
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_outer_rule_recirc_id_set(
    __in efx_mae_match_spec_t *spec, __in uint8_t recirc_id);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_outer_rule_insert(
    __in efx_nic_t *enp, __in const efx_mae_match_spec_t *spec,
    __in efx_tunnel_protocol_t encap_type, __out efx_mae_rule_id_t *or_idp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_outer_rule_remove(
    __in efx_nic_t *enp, __in const efx_mae_rule_id_t *or_idp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_match_spec_outer_rule_id_set(
    __in efx_mae_match_spec_t *spec, __in const efx_mae_rule_id_t *or_idp);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_mac_addr_alloc(
    __in efx_nic_t *enp, __in uint8_t addr_bytes[EFX_MAC_ADDR_LEN],
    __out efx_mae_mac_id_t *mac_idp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_mac_addr_free(
    __in efx_nic_t *enp, __in const efx_mae_mac_id_t *mac_idp);

/* See description before efx_mae_action_set_populate_set_dst_mac(). */
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_action_set_fill_in_dst_mac_id(
    __in efx_mae_actions_t *spec, __in const efx_mae_mac_id_t *mac_idp);

/* See description before efx_mae_action_set_populate_set_src_mac(). */
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_action_set_fill_in_src_mac_id(
    __in efx_mae_actions_t *spec, __in const efx_mae_mac_id_t *mac_idp);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_encap_header_alloc(
    __in efx_nic_t *enp, __in efx_tunnel_protocol_t encap_type,
    __in_bcount(header_size) uint8_t *header_data, __in size_t header_size,
    __out efx_mae_eh_id_t *eh_idp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_encap_header_free(
    __in efx_nic_t *enp, __in const efx_mae_eh_id_t *eh_idp);

/* See description before efx_mae_action_set_populate_encap(). */
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_action_set_fill_in_eh_id(
    __in efx_mae_actions_t *spec, __in const efx_mae_eh_id_t *eh_idp);
...
efx_mae_action_set_get_nb_count(__in const efx_mae_actions_t *spec);

/* See description before efx_mae_action_set_populate_count(). */
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_action_set_fill_in_counter_id(
    __in efx_mae_actions_t *spec, __in const efx_counter_t *counter_idp);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_action_set_alloc(
    __in efx_nic_t *enp, __in const efx_mae_actions_t *spec,
 ...
 */
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_counters_alloc(
    __in efx_nic_t *enp, __in uint32_t n_counters, __out uint32_t *n_allocatedp,
    __out_ecount(n_counters) efx_counter_t *countersp,
    __out_opt uint32_t *gen_countp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_counters_free(
    __in efx_nic_t *enp, __in uint32_t n_counters, __out uint32_t *n_freedp,
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_counters_stream_start(
    __in efx_nic_t *enp, __in uint16_t rxq_id, __in uint16_t packet_size,
    __in uint32_t flags_in, __out uint32_t *flags_out);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_counters_stream_stop(
    __in efx_nic_t *enp, __in uint16_t rxq_id, __out_opt uint32_t *gen_countp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_counters_stream_give_credits(
    __in efx_nic_t *enp, __in uint32_t n_credits);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_action_set_free(
    __in efx_nic_t *enp, __in const efx_mae_aset_id_t *aset_idp);
 ...
 */
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_action_rule_insert(
    __in efx_nic_t *enp, __in const efx_mae_match_spec_t *spec,
    __in const efx_mae_aset_list_id_t *asl_idp,
    __in const efx_mae_aset_id_t *as_idp, __out efx_mae_rule_id_t *ar_idp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_action_rule_remove(
    __in efx_nic_t *enp, __in const efx_mae_rule_id_t *ar_idp);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_mcdi_mport_alloc_alias(__in efx_nic_t *enp, __out efx_mport_id_t *mportp,
                           __out_opt uint32_t *labelp);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_mae_mport_free(__in efx_nic_t *enp, __in const efx_mport_id_t *mportp);

typedef __checkReturn efx_rc_t(efx_mae_read_mport_journal_cb)(
    __in void *cb_datap, __in efx_mport_desc_t *mportp, __in size_t mport_len);
 ...
 */
LIBEFX_API
extern __checkReturn efx_rc_t efx_mae_read_mport_journal(
    __in efx_nic_t *enp, __in efx_mae_read_mport_journal_cb *cbp,
    __in void *cb_datap);
...
LIBEFX_API
extern __checkReturn efx_rc_t efx_virtio_init(__in efx_nic_t *enp);

LIBEFX_API
extern void efx_virtio_fini(__in efx_nic_t *enp);
...
LIBEFX_API
extern __checkReturn efx_rc_t
efx_virtio_qcreate(__in efx_nic_t *enp, __deref_out efx_virtio_vq_t **evvpp);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_virtio_qstart(__in efx_virtio_vq_t *evvp, __in efx_virtio_vq_cfg_t *evvcp,
                  __in_opt efx_virtio_vq_dyncfg_t *evvdp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_virtio_qstop(
    __in efx_virtio_vq_t *evvp, __out_opt efx_virtio_vq_dyncfg_t *evvdp);

LIBEFX_API
extern void efx_virtio_qdestroy(__in efx_virtio_vq_t *evvp);
 ...
 */
LIBEFX_API
extern __checkReturn efx_rc_t efx_virtio_get_doorbell_offset(
    __in efx_virtio_vq_t *evvp, __out uint32_t *offsetp);

LIBEFX_API
extern __checkReturn efx_rc_t
efx_virtio_get_features(__in efx_nic_t *enp, __in efx_virtio_device_type_t type,
                        __out uint64_t *featuresp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_virtio_verify_features(
    __in efx_nic_t *enp, __in efx_virtio_device_type_t type,
    __in uint64_t features);

#endif /* EFSYS_OPT_VIRTIO */

LIBEFX_API
extern __checkReturn efx_rc_t efx_nic_dma_config_add(
    __in efx_nic_t *enp, __in efsys_dma_addr_t trgt_addr, __in size_t len,
    __out_opt efsys_dma_addr_t *nic_basep,
    __out_opt efsys_dma_addr_t *trgt_basep, __out_opt size_t *map_lenp);

LIBEFX_API
extern __checkReturn efx_rc_t efx_nic_dma_reconfigure(__in efx_nic_t *enp);
...
LIBEFX_API
extern __checkReturn efx_rc_t
efx_nic_dma_map(__in efx_nic_t *enp, __in efx_nic_dma_addr_type_t addr_type,
                __in efsys_dma_addr_t tgt_addr, __in size_t len,
