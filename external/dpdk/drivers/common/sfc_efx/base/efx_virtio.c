...
__checkReturn efx_rc_t efx_virtio_init(__in efx_nic_t *enp) {
...
void efx_virtio_fini(__in efx_nic_t *enp) {
  EFSYS_ASSERT3U(enp->en_magic, ==, EFX_NIC_MAGIC);
  EFSYS_ASSERT3U(enp->en_mod_flags, &, EFX_MOD_PROBE);
...
__checkReturn efx_rc_t efx_virtio_qcreate(__in efx_nic_t *enp,
...
__checkReturn efx_rc_t efx_virtio_qstop(
...
void efx_virtio_qdestroy(__in efx_virtio_vq_t *evvp) {
  efx_nic_t *enp;
...
__checkReturn efx_rc_t efx_virtio_get_doorbell_offset(
...
__checkReturn efx_rc_t efx_virtio_verify_features(
