...
__checkReturn efx_rc_t efx_port_init(__in efx_nic_t *enp) {
...
__checkReturn efx_rc_t efx_port_poll(__in efx_nic_t *enp,
...
static const char *const __efx_loopback_type_name[] = {
    "OFF",          "DATA",        "GMAC",           "XGMII",     "XGXS",
    "XAUI",         "GMII",        "SGMII",          "XGBR",      "XFI",
    "XAUI_FAR",     "GMII_FAR",    "SGMII_FAR",      "XFI_FAR",   "GPHY",
    "PHY_XS",       "PCS",         "PMA_PMD",        "XPORT",     "XGMII_WS",
    "XAUI_WS",      "XAUI_WS_FAR", "XAUI_WS_NEAR",   "GMII_WS",   "XFI_WS",
    "XFI_WS_FAR",   "PHYXS_WS",    "PMA_INT",        "SD_NEAR",   "SD_FAR",
    "PMA_INT_WS",   "SD_FEP2_WS",  "SD_FEP1_5_WS",   "SD_FEP_WS", "SD_FES_WS",
    "AOE_INT_NEAR", "DATA_WS",     "FORCE_EXT_LINK",
};
...
void efx_port_fini(__in efx_nic_t *enp) {
  efx_port_t *epp = &(enp->en_port);
  const efx_phy_ops_t *epop = epp->ep_epop;
