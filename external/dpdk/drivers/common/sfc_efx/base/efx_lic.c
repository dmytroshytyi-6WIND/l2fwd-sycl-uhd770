...
__checkReturn efx_rc_t efx_lic_v1v2_find_start(__in efx_nic_t *enp,
                                               __in_bcount(buffer_size)
                                                   caddr_t bufferp,
                                               __in size_t buffer_size,
                                               __out uint32_t *startp);

__checkReturn efx_rc_t efx_lic_v1v2_find_end(
...
__checkReturn __success(return != B_FALSE) boolean_t
    efx_lic_v1v2_find_key(__in efx_nic_t *enp,
...
__checkReturn __success(return != B_FALSE) boolean_t
    efx_lic_v1v2_validate_key(__in efx_nic_t *enp,
                              __in_bcount(length) caddr_t keyp,
                              __in uint32_t length);

__checkReturn efx_rc_t efx_lic_v1v2_read_key(
    __in efx_nic_t *enp, __in_bcount(buffer_size) caddr_t bufferp,
...
__checkReturn efx_rc_t efx_lic_v1v2_write_key(
    __in efx_nic_t *enp, __in_bcount(buffer_size) caddr_t bufferp,
    __in size_t buffer_size, __in uint32_t offset,
    __in_bcount(length) caddr_t keyp, __in uint32_t length,
    __out uint32_t *lengthp);

__checkReturn efx_rc_t efx_lic_v1v2_delete_key(
    __in efx_nic_t *enp, __in_bcount(buffer_size) caddr_t bufferp,
    __in size_t buffer_size, __in uint32_t offset, __in uint32_t length,
    __in uint32_t end, __out uint32_t *deltap);

__checkReturn efx_rc_t efx_lic_v1v2_create_partition(__in efx_nic_t *enp,
                                                     __in_bcount(buffer_size)
                                                         caddr_t bufferp,
                                                     __in size_t buffer_size);

__checkReturn efx_rc_t efx_lic_v1v2_finish_partition(__in efx_nic_t *enp,
                                                     __in_bcount(buffer_size)
                                                         caddr_t bufferp,
                                                     __in size_t buffer_size);
...
efx_mcdi_fc_license_update_license(__in efx_nic_t *enp);

static __checkReturn efx_rc_t efx_mcdi_fc_license_get_key_stats(
    __in efx_nic_t *enp, __out efx_key_stats_t *eksp);
...
static __checkReturn efx_rc_t
efx_mcdi_licensing_update_licenses(__in efx_nic_t *enp);

static __checkReturn efx_rc_t efx_mcdi_licensing_get_key_stats(
    __in efx_nic_t *enp, __out efx_key_stats_t *eksp);

static __checkReturn efx_rc_t efx_mcdi_licensed_app_state(
    __in efx_nic_t *enp, __in uint64_t app_id, __out boolean_t *licensedp);
...
static __checkReturn efx_rc_t
efx_mcdi_licensing_v3_update_licenses(__in efx_nic_t *enp);

static __checkReturn efx_rc_t efx_mcdi_licensing_v3_report_license(
    __in efx_nic_t *enp, __out efx_key_stats_t *eksp);

static __checkReturn efx_rc_t efx_mcdi_licensing_v3_app_state(
    __in efx_nic_t *enp, __in uint64_t app_id, __out boolean_t *licensedp);

static __checkReturn efx_rc_t efx_mcdi_licensing_v3_get_id(
    __in efx_nic_t *enp, __in size_t buffer_size, __out uint32_t *typep,
    __out size_t *lengthp,
    __out_bcount_part_opt(buffer_size, *lengthp) uint8_t *bufferp);

__checkReturn efx_rc_t efx_lic_v3_find_start(__in efx_nic_t *enp,
                                             __in_bcount(buffer_size)
                                                 caddr_t bufferp,
                                             __in size_t buffer_size,
                                             __out uint32_t *startp);

__checkReturn efx_rc_t efx_lic_v3_find_end(
    __in efx_nic_t *enp, __in_bcount(buffer_size) caddr_t bufferp,
    __in size_t buffer_size, __in uint32_t offset, __out uint32_t *endp);

__checkReturn __success(return != B_FALSE) boolean_t
    efx_lic_v3_find_key(__in efx_nic_t *enp,
                        __in_bcount(buffer_size) caddr_t bufferp,
                        __in size_t buffer_size, __in uint32_t offset,
                        __out uint32_t *startp, __out uint32_t *lengthp);

__checkReturn __success(return != B_FALSE) boolean_t
    efx_lic_v3_validate_key(__in efx_nic_t *enp,
                            __in_bcount(length) caddr_t keyp,
                            __in uint32_t length);

__checkReturn efx_rc_t efx_lic_v3_read_key(
    __in efx_nic_t *enp, __in_bcount(buffer_size) caddr_t bufferp,
    __in size_t buffer_size, __in uint32_t offset, __in uint32_t length,
    __out_bcount_part(key_max_size, *lengthp) caddr_t keyp,
    __in size_t key_max_size, __out uint32_t *lengthp);

__checkReturn efx_rc_t efx_lic_v3_write_key(
    __in efx_nic_t *enp, __in_bcount(buffer_size) caddr_t bufferp,
    __in size_t buffer_size, __in uint32_t offset,
    __in_bcount(length) caddr_t keyp, __in uint32_t length,
    __out uint32_t *lengthp);

__checkReturn efx_rc_t efx_lic_v3_delete_key(
    __in efx_nic_t *enp, __in_bcount(buffer_size) caddr_t bufferp,
    __in size_t buffer_size, __in uint32_t offset, __in uint32_t length,
    __in uint32_t end, __out uint32_t *deltap);

__checkReturn efx_rc_t efx_lic_v3_create_partition(__in efx_nic_t *enp,
                                                   __in_bcount(buffer_size)
                                                       caddr_t bufferp,
                                                   __in size_t buffer_size);

__checkReturn efx_rc_t efx_lic_v3_finish_partition(__in efx_nic_t *enp,
                                                   __in_bcount(buffer_size)
                                                       caddr_t bufferp,
                                                   __in size_t buffer_size);
...
efx_mcdi_fc_license_update_license(__in efx_nic_t *enp) {
  ...
  MCDI_IN_SET_DWORD(req, FC_IN_CMD, MC_CMD_FC_OP_LICENSE);

  MCDI_IN_SET_DWORD(req, FC_IN_LICENSE_OP, MC_CMD_FC_IN_LICENSE_UPDATE_LICENSE);
...
static __checkReturn efx_rc_t efx_mcdi_fc_license_get_key_stats(
  ...
  MCDI_IN_SET_DWORD(req, FC_IN_LICENSE_OP, MC_CMD_FC_IN_LICENSE_GET_KEY_STATS);
  ...
  eksp->eks_valid = MCDI_OUT_DWORD(req, FC_OUT_LICENSE_VALID_KEYS);
  eksp->eks_invalid = MCDI_OUT_DWORD(req, FC_OUT_LICENSE_INVALID_KEYS);
  eksp->eks_blacklisted = MCDI_OUT_DWORD(req, FC_OUT_LICENSE_BLACKLISTED_KEYS);
...
__checkReturn efx_rc_t efx_lic_v1v2_write_key(
  ...
  if ((offset + length) > (buffer_size - EFX_LICENSE_V1V2_HEADER_LENGTH)) {
    rc = ENOSPC;
    goto fail1;
  }
...
static __checkReturn efx_rc_t efx_mcdi_licensed_app_state(
  ...
  MCDI_IN_SET_DWORD(req, GET_LICENSED_APP_STATE_IN_APP_ID, app_id & 0xffffffff);
...
static __checkReturn efx_rc_t efx_mcdi_licensing_get_key_stats(
  ...
  MCDI_IN_SET_DWORD(req, LICENSING_IN_OP, MC_CMD_LICENSING_IN_OP_GET_KEY_STATS);
  ...
  eksp->eks_valid = MCDI_OUT_DWORD(req, LICENSING_OUT_VALID_APP_KEYS);
  ...
  eksp->eks_wrong_node = MCDI_OUT_DWORD(req, LICENSING_OUT_WRONG_NODE_APP_KEYS);
  eksp->eks_licensed_apps_lo = 0;
  eksp->eks_licensed_apps_hi = 0;
  eksp->eks_licensed_features_lo = 0;
  eksp->eks_licensed_features_hi = 0;
...
static __checkReturn efx_rc_t efx_mcdi_licensing_v3_report_license(
  ...
  eksp->eks_valid = MCDI_OUT_DWORD(req, LICENSING_V3_OUT_VALID_KEYS);
  eksp->eks_invalid = MCDI_OUT_DWORD(req, LICENSING_V3_OUT_INVALID_KEYS);
  eksp->eks_blacklisted = 0;
  eksp->eks_unverifiable =
      MCDI_OUT_DWORD(req, LICENSING_V3_OUT_UNVERIFIABLE_KEYS);
  eksp->eks_wrong_node = MCDI_OUT_DWORD(req, LICENSING_V3_OUT_WRONG_NODE_KEYS);
...
static __checkReturn efx_rc_t efx_mcdi_licensing_v3_app_state(
  ...
  MCDI_IN_SET_DWORD(req, GET_LICENSED_V3_APP_STATE_IN_APP_ID_LO,
                    app_id & 0xffffffff);
  MCDI_IN_SET_DWORD(req, GET_LICENSED_V3_APP_STATE_IN_APP_ID_HI, app_id >> 32);
...
static __checkReturn efx_rc_t efx_mcdi_licensing_v3_get_id(
  ...
  *lengthp = MCDI_OUT_DWORD(req, LICENSING_GET_ID_V3_OUT_LICENSE_ID_LENGTH);
  ...
  if (bufferp != NULL) {
    memcpy(bufferp, payload + MC_CMD_LICENSING_GET_ID_V3_OUT_LICENSE_ID_OFST,
...
__checkReturn __success(return != B_FALSE) boolean_t
  ...
  return ef10_nvram_buffer_find_item(bufferp, buffer_size, offset, startp,
                                     lengthp);
}
...
__checkReturn efx_rc_t efx_lic_v3_read_key(
  ...
  return ef10_nvram_buffer_get_item(bufferp, buffer_size, offset, length, &tag,
                                    keyp, key_max_size, lengthp);
}
...
__checkReturn efx_rc_t efx_lic_v3_write_key(
  ...
  return ef10_nvram_buffer_insert_item(bufferp, buffer_size, offset,
                                       TLV_TAG_LICENSE, keyp, length, lengthp);
}
...
__checkReturn efx_rc_t efx_lic_v3_delete_key(
  ...
  if ((rc = ef10_nvram_buffer_delete_item(bufferp, buffer_size, offset, length,
                                          end)) != 0) {
    goto fail1;
  }
...
__checkReturn efx_rc_t efx_lic_v3_create_partition(__in efx_nic_t *enp,
  ...
  if ((rc = ef10_nvram_buffer_create(NVRAM_PARTITION_TYPE_LICENSE, bufferp,
                                     buffer_size)) != 0) {
    rc = EFAULT;
    goto fail1;
  }
...
__checkReturn efx_rc_t efx_lic_v3_finish_partition(__in efx_nic_t *enp,
  ...
  if ((rc = ef10_nvram_buffer_finish(bufferp, buffer_size)) != 0) {
    goto fail1;
  }

  /* Validate completed partition */
  if ((rc = ef10_nvram_buffer_validate(NVRAM_PARTITION_TYPE_LICENSE, bufferp,
                                       buffer_size)) != 0) {
    goto fail2;
  }
...
__checkReturn efx_rc_t efx_lic_init(__in efx_nic_t *enp) {
...
void efx_lic_fini(__in efx_nic_t *enp) {
  EFSYS_ASSERT3U(enp->en_magic, ==, EFX_NIC_MAGIC);
  EFSYS_ASSERT3U(enp->en_mod_flags, &, EFX_MOD_PROBE);
  EFSYS_ASSERT3U(enp->en_mod_flags, &, EFX_MOD_LIC);
...
__checkReturn efx_rc_t efx_lic_update_licenses(__in efx_nic_t *enp) {
...
__checkReturn efx_rc_t efx_lic_get_key_stats(__in efx_nic_t *enp,
...
__checkReturn efx_rc_t efx_lic_app_state(__in efx_nic_t *enp,
...
__checkReturn efx_rc_t efx_lic_get_id(__in efx_nic_t *enp,
                                      __in size_t buffer_size,
  ...
  if ((rc = elop->elo_get_id(enp, buffer_size, typep, lengthp, bufferp)) != 0)
    goto fail1;
...
__checkReturn efx_rc_t efx_lic_find_start(__in efx_nic_t *enp,
                                          __in_bcount(buffer_size)
                                              caddr_t bufferp,
                                          __in size_t buffer_size,
                                          __out uint32_t *startp) {
...
__checkReturn efx_rc_t efx_lic_find_end(
    __in efx_nic_t *enp, __in_bcount(buffer_size) caddr_t bufferp,
    __in size_t buffer_size, __in uint32_t offset, __out uint32_t *endp) {
  const efx_lic_ops_t *elop = enp->en_elop;
  efx_rc_t rc;
...
__checkReturn __success(return != B_FALSE) boolean_t
  ...
  return (
      elop->elo_find_key(enp, bufferp, buffer_size, offset, startp, lengthp));
}
...
__checkReturn efx_rc_t efx_lic_read_key(
    __in efx_nic_t *enp, __in_bcount(buffer_size) caddr_t bufferp,
    __in size_t buffer_size, __in uint32_t offset, __in uint32_t length,
    __out_bcount_part(key_max_size, *lengthp) caddr_t keyp,
    __in size_t key_max_size, __out uint32_t *lengthp) {
  ...
  if ((rc = elop->elo_read_key(enp, bufferp, buffer_size, offset, length, keyp,
                               key_max_size, lengthp)) != 0)
    goto fail1;
...
efx_lic_write_key(__in efx_nic_t *enp, __in_bcount(buffer_size) caddr_t bufferp,
  ...
  if ((rc = elop->elo_write_key(enp, bufferp, buffer_size, offset, keyp, length,
                                lengthp)) != 0)
    goto fail1;
...
__checkReturn efx_rc_t efx_lic_delete_key(
    __in efx_nic_t *enp, __in_bcount(buffer_size) caddr_t bufferp,
    __in size_t buffer_size, __in uint32_t offset, __in uint32_t length,
    __in uint32_t end, __out uint32_t *deltap) {
  const efx_lic_ops_t *elop = enp->en_elop;
  ...
  if ((rc = elop->elo_delete_key(enp, bufferp, buffer_size, offset, length, end,
                                 deltap)) != 0)
    goto fail1;
...
__checkReturn efx_rc_t efx_lic_create_partition(__in efx_nic_t *enp,
                                                __in_bcount(buffer_size)
                                                    caddr_t bufferp,
                                                __in size_t buffer_size) {
  const efx_lic_ops_t *elop = enp->en_elop;
...
__checkReturn efx_rc_t efx_lic_finish_partition(__in efx_nic_t *enp,
                                                __in_bcount(buffer_size)
                                                    caddr_t bufferp,
                                                __in size_t buffer_size) {
  const efx_lic_ops_t *elop = enp->en_elop;
