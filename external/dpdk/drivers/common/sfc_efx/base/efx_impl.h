...
typedef struct efx_ev_ops_s {
  ...
  efx_rc_t (*eevo_qcreate)(efx_nic_t *, unsigned int, efsys_mem_t *, size_t,
                           uint32_t, uint32_t, uint32_t, uint32_t, efx_evq_t *);
  void (*eevo_qdestroy)(efx_evq_t *);
  efx_rc_t (*eevo_qprime)(efx_evq_t *, unsigned int);
  void (*eevo_qpost)(efx_evq_t *, uint16_t);
  void (*eevo_qpoll)(efx_evq_t *, unsigned int *, const efx_ev_callbacks_t *,
                     void *);
...
typedef struct efx_tx_ops_s {
  ...
  efx_rc_t (*etxo_qcreate)(efx_nic_t *, unsigned int, unsigned int,
                           efsys_mem_t *, size_t, uint32_t, uint16_t,
                           efx_evq_t *, efx_txq_t *, unsigned int *);
  void (*etxo_qdestroy)(efx_txq_t *);
  efx_rc_t (*etxo_qpost)(efx_txq_t *, efx_buffer_t *, unsigned int,
  ...
  efx_rc_t (*etxo_qpio_write)(efx_txq_t *, uint8_t *, size_t, size_t);
  efx_rc_t (*etxo_qpio_post)(efx_txq_t *, size_t, unsigned int, unsigned int *);
  efx_rc_t (*etxo_qdesc_post)(efx_txq_t *, efx_desc_t *, unsigned int,
                              unsigned int, unsigned int *);
  void (*etxo_qdesc_dma_create)(efx_txq_t *, efsys_dma_addr_t, size_t,
                                boolean_t, efx_desc_t *);
  void (*etxo_qdesc_tso_create)(efx_txq_t *, uint16_t, uint32_t, uint8_t,
                                efx_desc_t *);
  void (*etxo_qdesc_tso2_create)(efx_txq_t *, uint16_t, uint16_t, uint32_t,
                                 uint16_t, efx_desc_t *, int);
  void (*etxo_qdesc_vlantci_create)(efx_txq_t *, uint16_t, efx_desc_t *);
  void (*etxo_qdesc_checksum_create)(efx_txq_t *, uint16_t, efx_desc_t *);
#if EFSYS_OPT_QSTATS
  void (*etxo_qstats_update)(efx_txq_t *, efsys_stat_t *);
#endif
} efx_tx_ops_t;
...
typedef struct efx_rx_ops_s {
  ...
  efx_rc_t (*erxo_scale_context_alloc)(efx_nic_t *, efx_rx_scale_context_type_t,
                                       uint32_t, uint32_t, uint32_t *);
  efx_rc_t (*erxo_scale_context_free)(efx_nic_t *, uint32_t);
  efx_rc_t (*erxo_scale_mode_set)(efx_nic_t *, uint32_t, efx_rx_hash_alg_t,
                                  efx_rx_hash_type_t, boolean_t);
  efx_rc_t (*erxo_scale_key_set)(efx_nic_t *, uint32_t, uint8_t *, size_t);
  efx_rc_t (*erxo_scale_tbl_set)(efx_nic_t *, uint32_t, unsigned int *, size_t);
  uint32_t (*erxo_prefix_hash)(efx_nic_t *, efx_rx_hash_alg_t, uint8_t *);
#endif /* EFSYS_OPT_RX_SCALE */
  efx_rc_t (*erxo_prefix_pktlen)(efx_nic_t *, uint8_t *, uint16_t *);
  void (*erxo_qpost)(efx_rxq_t *, efsys_dma_addr_t *, size_t, unsigned int,
                     unsigned int, unsigned int);
  void (*erxo_qpush)(efx_rxq_t *, unsigned int, unsigned int *);
#if EFSYS_OPT_RX_PACKED_STREAM
  void (*erxo_qpush_ps_credits)(efx_rxq_t *);
  uint8_t *(*erxo_qps_packet_info)(efx_rxq_t *, uint8_t *, uint32_t, uint32_t,
                                   uint16_t *, uint32_t *, uint32_t *);
#endif
  efx_rc_t (*erxo_qflush)(efx_rxq_t *);
  void (*erxo_qenable)(efx_rxq_t *);
  efx_rc_t (*erxo_qcreate)(efx_nic_t *enp, unsigned int, unsigned int,
                           efx_rxq_type_t, const efx_rxq_type_data_t *,
                           efsys_mem_t *, size_t, uint32_t, unsigned int,
                           efx_evq_t *, efx_rxq_t *);
...
typedef struct efx_mac_ops_s {
  ...
  efx_rc_t (*emo_filter_default_rxq_set)(efx_nic_t *, efx_rxq_t *, boolean_t);
  ...
  efx_rc_t (*emo_stats_periodic)(efx_nic_t *, efsys_mem_t *, uint16_t,
                                 boolean_t);
  efx_rc_t (*emo_stats_update)(efx_nic_t *, efsys_mem_t *, efsys_stat_t *,
                               uint32_t *);
...
typedef struct efx_phy_ops_s {
  ...
  efx_rc_t (*epo_stats_update)(efx_nic_t *, efsys_mem_t *, uint32_t *);
#endif /* EFSYS_OPT_PHY_STATS */
#if EFSYS_OPT_BIST
  efx_rc_t (*epo_bist_enable_offline)(efx_nic_t *);
  efx_rc_t (*epo_bist_start)(efx_nic_t *, efx_bist_type_t);
  efx_rc_t (*epo_bist_poll)(efx_nic_t *, efx_bist_type_t, efx_bist_result_t *,
                            uint32_t *, unsigned long *, size_t);
...
typedef struct efx_filter_ops_s {
  ...
  efx_rc_t (*efo_supported_filters)(efx_nic_t *, uint32_t *, size_t, size_t *);
  efx_rc_t (*efo_reconfigure)(efx_nic_t *, uint8_t const *, boolean_t,
                              boolean_t, boolean_t, boolean_t, uint8_t const *,
                              uint32_t);
} efx_filter_ops_t;

LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_filter_reconfigure(
...
typedef struct efx_virtio_ops_s {
  efx_rc_t (*evo_virtio_qstart)(efx_virtio_vq_t *, efx_virtio_vq_cfg_t *,
                                efx_virtio_vq_dyncfg_t *);
  efx_rc_t (*evo_virtio_qstop)(efx_virtio_vq_t *, efx_virtio_vq_dyncfg_t *);
  efx_rc_t (*evo_get_doorbell_offset)(efx_virtio_vq_t *, uint32_t *);
  efx_rc_t (*evo_get_features)(efx_nic_t *, efx_virtio_device_type_t,
                               uint64_t *);
  efx_rc_t (*evo_verify_features)(efx_nic_t *, efx_virtio_device_type_t,
                                  uint64_t);
} efx_virtio_ops_t;
...
typedef struct efx_port_s {
  ...
  uint8_t ep_mulcst_addr_list[EFX_MAC_ADDR_LEN * EFX_MAC_MULTICAST_LIST_MAX];
...
typedef struct efx_mon_ops_s {
  ...
  efx_rc_t (*emo_limits_update)(efx_nic_t *, efx_mon_stat_limits_t *);
...
typedef struct efx_intr_ops_s {
  ...
  void (*eio_status_message)(efx_nic_t *, unsigned int, boolean_t *);
...
typedef struct efx_nic_ops_s {
  ...
  efx_rc_t (*eno_get_bar_region)(efx_nic_t *, efx_nic_region_t, uint32_t *,
                                 size_t *);
...
LIBEFX_INTERNAL
extern void siena_filter_tbl_clear(__in efx_nic_t *enp,
...
typedef struct efx_mcdi_ops_s {
  ...
  void (*emco_send_request)(efx_nic_t *, void *, size_t, void *, size_t);
  ...
  efx_rc_t (*emco_feature_supported)(efx_nic_t *, efx_mcdi_feature_id_t,
                                     boolean_t *);
  void (*emco_get_timeout)(efx_nic_t *, efx_mcdi_req_t *, uint32_t *);
} efx_mcdi_ops_t;
...
#endif /* EFSYS_OPT_DIAG */
  efx_rc_t (*envo_type_to_partn)(efx_nic_t *, efx_nvram_type_t, uint32_t *);
  efx_rc_t (*envo_partn_info)(efx_nic_t *, uint32_t, efx_nvram_info_t *);
  efx_rc_t (*envo_partn_rw_start)(efx_nic_t *, uint32_t, size_t *);
  efx_rc_t (*envo_partn_read)(efx_nic_t *, uint32_t, unsigned int, caddr_t,
                              size_t);
  efx_rc_t (*envo_partn_read_backup)(efx_nic_t *, uint32_t, unsigned int,
                                     caddr_t, size_t);
  efx_rc_t (*envo_partn_erase)(efx_nic_t *, uint32_t, unsigned int, size_t);
  efx_rc_t (*envo_partn_write)(efx_nic_t *, uint32_t, unsigned int, caddr_t,
                               size_t);
  efx_rc_t (*envo_partn_rw_finish)(efx_nic_t *, uint32_t, uint32_t *);
  efx_rc_t (*envo_partn_get_version)(efx_nic_t *, uint32_t, uint32_t *,
                                     uint16_t *);
  efx_rc_t (*envo_partn_set_version)(efx_nic_t *, uint32_t, uint16_t *);
  efx_rc_t (*envo_buffer_validate)(uint32_t, caddr_t, size_t);
} efx_nvram_ops_t;
...
typedef struct efx_vpd_ops_s {
  ...
  efx_rc_t (*evpdo_get)(efx_nic_t *, caddr_t, size_t, efx_vpd_value_t *);
  efx_rc_t (*evpdo_set)(efx_nic_t *, caddr_t, size_t, efx_vpd_value_t *);
  efx_rc_t (*evpdo_next)(efx_nic_t *, caddr_t, size_t, efx_vpd_value_t *,
                         unsigned int *);
...
efx_mcdi_nvram_partitions(__in efx_nic_t *enp, __out_bcount(size) caddr_t data,
                          __in size_t size, __out unsigned int *npartnp);

LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_mcdi_nvram_metadata(
    __in efx_nic_t *enp, __in uint32_t partn, __out uint32_t *subtypep,
    __out_ecount(4) uint16_t version[4], __out_bcount_opt(size) char *descp,
    __in size_t size);

LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_mcdi_nvram_info(__in efx_nic_t *enp,
                                                  __in uint32_t partn,
                                                  __out efx_nvram_info_t *eni);

LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_mcdi_nvram_update_start(__in efx_nic_t *enp,
                                                          __in uint32_t partn);

LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_mcdi_nvram_read(
    __in efx_nic_t *enp, __in uint32_t partn, __in uint32_t offset,
    __out_bcount(size) caddr_t data, __in size_t size, __in uint32_t mode);

LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_mcdi_nvram_erase(__in efx_nic_t *enp,
                                                   __in uint32_t partn,
                                                   __in uint32_t offset,
                                                   __in size_t size);

LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_mcdi_nvram_write(
    __in efx_nic_t *enp, __in uint32_t partn, __in uint32_t offset,
...
LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_mcdi_nvram_update_finish(
    __in efx_nic_t *enp, __in uint32_t partn, __in boolean_t reboot,
    __in uint32_t flags, __out_opt uint32_t *verify_resultp);

#if EFSYS_OPT_DIAG

LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_mcdi_nvram_test(__in efx_nic_t *enp,
                                                  __in uint32_t partn);
...
typedef struct efx_lic_ops_s {
  ...
  efx_rc_t (*elo_get_id)(efx_nic_t *, size_t, uint32_t *, size_t *, uint8_t *);
  efx_rc_t (*elo_find_start)(efx_nic_t *, caddr_t, size_t, uint32_t *);
  efx_rc_t (*elo_find_end)(efx_nic_t *, caddr_t, size_t, uint32_t, uint32_t *);
  boolean_t (*elo_find_key)(efx_nic_t *, caddr_t, size_t, uint32_t, uint32_t *,
                            uint32_t *);
  boolean_t (*elo_validate_key)(efx_nic_t *, caddr_t, uint32_t);
  efx_rc_t (*elo_read_key)(efx_nic_t *, caddr_t, size_t, uint32_t, uint32_t,
                           caddr_t, size_t, uint32_t *);
  efx_rc_t (*elo_write_key)(efx_nic_t *, caddr_t, size_t, uint32_t, caddr_t,
                            uint32_t, uint32_t *);
  efx_rc_t (*elo_delete_key)(efx_nic_t *, caddr_t, size_t, uint32_t, uint32_t,
                             uint32_t, uint32_t *);
  efx_rc_t (*elo_create_partition)(efx_nic_t *, caddr_t, size_t);
  efx_rc_t (*elo_finish_partition)(efx_nic_t *, caddr_t, size_t);
} efx_lic_ops_t;
...
typedef struct efx_evb_ops_s {
  ...
  efx_rc_t (*eeo_vport_alloc)(efx_nic_t *, efx_vswitch_id_t, efx_vport_type_t,
                              uint16_t, boolean_t, efx_vport_id_t *);
  efx_rc_t (*eeo_vport_free)(efx_nic_t *, efx_vswitch_id_t, efx_vport_id_t);
  ...
  efx_rc_t (*eeo_vport_mac_addr_del)(efx_nic_t *, efx_vswitch_id_t,
                                     efx_vport_id_t, uint8_t *);
  efx_rc_t (*eeo_vadaptor_alloc)(efx_nic_t *, efx_vswitch_id_t, efx_vport_id_t);
  efx_rc_t (*eeo_vadaptor_free)(efx_nic_t *, efx_vswitch_id_t, efx_vport_id_t);
  efx_rc_t (*eeo_vport_assign)(efx_nic_t *, efx_vswitch_id_t, efx_vport_id_t,
                               uint32_t);
  efx_rc_t (*eeo_vport_reconfigure)(efx_nic_t *, efx_vswitch_id_t,
                                    efx_vport_id_t, uint16_t *, uint8_t *,
                                    boolean_t *);
  efx_rc_t (*eeo_vport_stats)(efx_nic_t *, efx_vswitch_id_t, efx_vport_id_t,
                              efsys_mem_t *);
} efx_evb_ops_t;

LIBEFX_INTERNAL
extern __checkReturn boolean_t
efx_is_zero_eth_addr(__in_bcount(EFX_MAC_ADDR_LEN) const uint8_t *addrp);
...
typedef struct efx_proxy_ops_s {
  ...
  efx_rc_t (*epo_mc_config)(efx_nic_t *, efsys_mem_t *, efsys_mem_t *,
                            efsys_mem_t *, uint32_t, uint32_t *, size_t);
  efx_rc_t (*epo_disable)(efx_nic_t *);
  efx_rc_t (*epo_privilege_modify)(efx_nic_t *, uint32_t, uint32_t, uint32_t,
                                   uint32_t, uint32_t);
  efx_rc_t (*epo_set_privilege_mask)(efx_nic_t *, uint32_t, uint32_t, uint32_t);
  efx_rc_t (*epo_complete_request)(efx_nic_t *, uint32_t, uint32_t, uint32_t);
  efx_rc_t (*epo_exec_cmd)(efx_nic_t *, efx_proxy_cmd_params_t *);
  efx_rc_t (*epo_get_privilege_mask)(efx_nic_t *, uint32_t, uint32_t,
                                     uint32_t *);
} efx_proxy_ops_t;
...
#define EFX_FAMILY_IS_EF100(_enp) ((_enp)->en_family == EFX_FAMILY_RIVERHEAD)
...
#define EFX_BAR_READD(_enp, _reg, _edp, _lock)                                 \
  do {                                                                         \
    ...
    EFSYS_BAR_READD((_enp)->en_esbp, _reg##_OFST, (_edp), (_lock));            \
    EFSYS_PROBE3(efx_bar_readd, const char *, #_reg, uint32_t, _reg##_OFST,    \
...
#define EFX_BAR_WRITED(_enp, _reg, _edp, _lock)                                \
  do {                                                                         \
    EFX_CHECK_REG((_enp), (_reg));                                             \
    EFSYS_PROBE3(efx_bar_writed, const char *, #_reg, uint32_t, _reg##_OFST,   \
                 uint32_t, (_edp)->ed_u32[0]);                                 \
    EFSYS_BAR_WRITED((_enp)->en_esbp, _reg##_OFST, (_edp), (_lock));           \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_BAR_READQ(_enp, _reg, _eqp)                                        \
  do {                                                                         \
    EFX_CHECK_REG((_enp), (_reg));                                             \
    EFSYS_BAR_READQ((_enp)->en_esbp, _reg##_OFST, (_eqp));                     \
    EFSYS_PROBE4(efx_bar_readq, const char *, #_reg, uint32_t, _reg##_OFST,    \
                 uint32_t, (_eqp)->eq_u32[1], uint32_t, (_eqp)->eq_u32[0]);    \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_BAR_WRITEQ(_enp, _reg, _eqp)                                       \
  do {                                                                         \
    EFX_CHECK_REG((_enp), (_reg));                                             \
    EFSYS_PROBE4(efx_bar_writeq, const char *, #_reg, uint32_t, _reg##_OFST,   \
                 uint32_t, (_eqp)->eq_u32[1], uint32_t, (_eqp)->eq_u32[0]);    \
    EFSYS_BAR_WRITEQ((_enp)->en_esbp, _reg##_OFST, (_eqp));                    \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_BAR_READO(_enp, _reg, _eop)                                        \
  do {                                                                         \
    EFX_CHECK_REG((_enp), (_reg));                                             \
    EFSYS_BAR_READO((_enp)->en_esbp, _reg##_OFST, (_eop), B_TRUE);             \
    EFSYS_PROBE6(efx_bar_reado, const char *, #_reg, uint32_t, _reg##_OFST,    \
                 uint32_t, (_eop)->eo_u32[3], uint32_t, (_eop)->eo_u32[2],     \
                 uint32_t, (_eop)->eo_u32[1], uint32_t, (_eop)->eo_u32[0]);    \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_BAR_WRITEO(_enp, _reg, _eop)                                       \
  do {                                                                         \
    EFX_CHECK_REG((_enp), (_reg));                                             \
    EFSYS_PROBE6(efx_bar_writeo, const char *, #_reg, uint32_t, _reg##_OFST,   \
                 uint32_t, (_eop)->eo_u32[3], uint32_t, (_eop)->eo_u32[2],     \
                 uint32_t, (_eop)->eo_u32[1], uint32_t, (_eop)->eo_u32[0]);    \
    EFSYS_BAR_WRITEO((_enp)->en_esbp, _reg##_OFST, (_eop), B_TRUE);            \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_BAR_TBL_READD(_enp, _reg, _index, _edp, _lock)                     \
  do {                                                                         \
    EFX_CHECK_REG((_enp), (_reg));                                             \
    EFSYS_BAR_READD((_enp)->en_esbp, (_reg##_OFST + ((_index)*_reg##_STEP)),   \
                    (_edp), (_lock));                                          \
    EFSYS_PROBE4(efx_bar_tbl_readd, const char *, #_reg, uint32_t, (_index),   \
                 uint32_t, _reg##_OFST, uint32_t, (_edp)->ed_u32[0]);          \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_BAR_TBL_WRITED(_enp, _reg, _index, _edp, _lock)                    \
  do {                                                                         \
    EFX_CHECK_REG((_enp), (_reg));                                             \
    EFSYS_PROBE4(efx_bar_tbl_writed, const char *, #_reg, uint32_t, (_index),  \
                 uint32_t, _reg##_OFST, uint32_t, (_edp)->ed_u32[0]);          \
    EFSYS_BAR_WRITED((_enp)->en_esbp, (_reg##_OFST + ((_index)*_reg##_STEP)),  \
                     (_edp), (_lock));                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_BAR_TBL_WRITED3(_enp, _reg, _index, _edp, _lock)                   \
  do {                                                                         \
    ...
    EFSYS_BAR_WRITED(                                                          \
        (_enp)->en_esbp,                                                       \
        (_reg##_OFST + (3 * sizeof(efx_dword_t)) + ((_index)*_reg##_STEP)),    \
        (_edp), (_lock));                                                      \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_BAR_TBL_READQ(_enp, _reg, _index, _eqp)                            \
  do {                                                                         \
    EFX_CHECK_REG((_enp), (_reg));                                             \
    EFSYS_BAR_READQ((_enp)->en_esbp, (_reg##_OFST + ((_index)*_reg##_STEP)),   \
                    (_eqp));                                                   \
    EFSYS_PROBE5(efx_bar_tbl_readq, const char *, #_reg, uint32_t, (_index),   \
                 uint32_t, _reg##_OFST, uint32_t, (_eqp)->eq_u32[1], uint32_t, \
                 (_eqp)->eq_u32[0]);                                           \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_BAR_TBL_WRITEQ(_enp, _reg, _index, _eqp)                           \
  do {                                                                         \
    EFX_CHECK_REG((_enp), (_reg));                                             \
    EFSYS_PROBE5(efx_bar_tbl_writeq, const char *, #_reg, uint32_t, (_index),  \
                 uint32_t, _reg##_OFST, uint32_t, (_eqp)->eq_u32[1], uint32_t, \
                 (_eqp)->eq_u32[0]);                                           \
    EFSYS_BAR_WRITEQ((_enp)->en_esbp, (_reg##_OFST + ((_index)*_reg##_STEP)),  \
                     (_eqp));                                                  \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_BAR_TBL_READO(_enp, _reg, _index, _eop, _lock)                     \
  do {                                                                         \
    EFX_CHECK_REG((_enp), (_reg));                                             \
    EFSYS_BAR_READO((_enp)->en_esbp, (_reg##_OFST + ((_index)*_reg##_STEP)),   \
                    (_eop), (_lock));                                          \
    EFSYS_PROBE7(efx_bar_tbl_reado, const char *, #_reg, uint32_t, (_index),   \
                 uint32_t, _reg##_OFST, uint32_t, (_eop)->eo_u32[3], uint32_t, \
                 (_eop)->eo_u32[2], uint32_t, (_eop)->eo_u32[1], uint32_t,     \
                 (_eop)->eo_u32[0]);                                           \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_BAR_TBL_WRITEO(_enp, _reg, _index, _eop, _lock)                    \
  do {                                                                         \
    EFX_CHECK_REG((_enp), (_reg));                                             \
    EFSYS_PROBE7(efx_bar_tbl_writeo, const char *, #_reg, uint32_t, (_index),  \
                 uint32_t, _reg##_OFST, uint32_t, (_eop)->eo_u32[3], uint32_t, \
                 (_eop)->eo_u32[2], uint32_t, (_eop)->eo_u32[1], uint32_t,     \
                 (_eop)->eo_u32[0]);                                           \
    EFSYS_BAR_WRITEO((_enp)->en_esbp, (_reg##_OFST + ((_index)*_reg##_STEP)),  \
                     (_eop), (_lock));                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_BAR_FCW_READD(_enp, _reg, _edp)                                    \
  do {                                                                         \
    ...
    EFSYS_BAR_READD((_enp)->en_esbp,                                           \
                    _reg##_OFST + (_enp)->en_arch.ef10.ena_fcw_base, (_edp),   \
                    B_FALSE);                                                  \
    EFSYS_PROBE3(efx_bar_fcw_readd, const char *, #_reg, uint32_t,             \
                 _reg##_OFST, uint32_t, (_edp)->ed_u32[0]);                    \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_BAR_FCW_WRITED(_enp, _reg, _edp)                                   \
  do {                                                                         \
    EFX_CHECK_REG((_enp), (_reg));                                             \
    EFSYS_PROBE3(efx_bar_fcw_writed, const char *, #_reg, uint32_t,            \
                 _reg##_OFST, uint32_t, (_edp)->ed_u32[0]);                    \
...
#define EFX_BAR_VI_READD(_enp, _reg, _index, _edp, _lock)                      \
  do {                                                                         \
    ...
    EFSYS_BAR_READD((_enp)->en_esbp,                                           \
                    ...
                    (_edp), (_lock));                                          \
    EFSYS_PROBE4(efx_bar_vi_readd, const char *, #_reg, uint32_t, (_index),    \
                 uint32_t, _reg##_OFST, uint32_t, (_edp)->ed_u32[0]);          \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_BAR_VI_WRITED(_enp, _reg, _index, _edp, _lock)                     \
  do {                                                                         \
    EFX_CHECK_REG((_enp), (_reg));                                             \
    EFSYS_PROBE4(efx_bar_vi_writed, const char *, #_reg, uint32_t, (_index),   \
                 uint32_t, _reg##_OFST, uint32_t, (_edp)->ed_u32[0]);          \
    EFSYS_BAR_WRITED((_enp)->en_esbp,                                          \
                     ((_reg##_OFST) +                                          \
                      ((_index) << (_enp)->en_nic_cfg.enc_vi_window_shift)),   \
...
#define EFX_BAR_VI_WRITED2(_enp, _reg, _index, _edp, _lock)                    \
  do {                                                                         \
    ...
    EFSYS_PROBE4(efx_bar_vi_writed, const char *, #_reg, uint32_t, (_index),   \
                 uint32_t, _reg##_OFST, uint32_t, (_edp)->ed_u32[0]);          \
    EFSYS_BAR_WRITED((_enp)->en_esbp,                                          \
                     ((_reg##_OFST) + (2 * sizeof(efx_dword_t)) +              \
                      ((_index) << (_enp)->en_nic_cfg.enc_vi_window_shift)),   \
                     (_edp), (_lock));                                         \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)
...
#define EFX_BAR_VI_DOORBELL_WRITEO(_enp, _reg, _index, _eop)                   \
  do {                                                                         \
    EFX_CHECK_REG((_enp), (_reg));                                             \
    EFSYS_PROBE7(efx_bar_vi_doorbell_writeo, const char *, #_reg, uint32_t,    \
                 (_index), uint32_t, _reg##_OFST, uint32_t, (_eop)->eo_u32[3], \
                 uint32_t, (_eop)->eo_u32[2], uint32_t, (_eop)->eo_u32[1],     \
                 uint32_t, (_eop)->eo_u32[0]);                                 \
    EFSYS_BAR_DOORBELL_WRITEO(                                                 \
        (_enp)->en_esbp,                                                       \
        (_reg##_OFST + ((_index) << (_enp)->en_nic_cfg.enc_vi_window_shift)),  \
        (_eop));                                                               \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)

#define EFX_DMA_SYNC_QUEUE_FOR_DEVICE(_esmp, _entries, _desc_size, _wptr,      \
                                      _owptr)                                  \
  do {                                                                         \
    ...
    unsigned int _old = (_owptr);                                              \
                                                                               \
    if ((_new) >= (_old))                                                      \
      EFSYS_DMA_SYNC_FOR_DEVICE((_esmp), (_old) * (_desc_size),                \
       ...
       */                                                                      \
      EFSYS_DMA_SYNC_FOR_DEVICE((_esmp), 0, (_entries) * (_desc_size));        \
    _NOTE(CONSTANTCONDITION)                                                   \
  } while (B_FALSE)

LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_mac_select(__in efx_nic_t *enp);

LIBEFX_INTERNAL
extern void efx_mac_multicast_hash_compute(__in_ecount(6 * count)
                                               uint8_t const *addrs,
                                           __in int count,
...
LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_phy_probe(__in efx_nic_t *enp);

LIBEFX_INTERNAL
extern void efx_phy_unprobe(__in efx_nic_t *enp);
...
LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_vpd_hunk_length(__in_bcount(size)
                                                      caddr_t data,
                                                  __in size_t size,
...
LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_vpd_hunk_reinit(__in_bcount(size)
                                                      caddr_t data,
                                                  __in size_t size,
                                                  __in boolean_t wantpid);

LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_vpd_hunk_get(__in_bcount(size) caddr_t data,
                                               __in size_t size,
...
LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_vpd_hunk_next(
    __in_bcount(size) caddr_t data, __in size_t size, __out efx_vpd_tag_t *tagp,
    __out efx_vpd_keyword_t *keyword, __out_opt unsigned int *payloadp,
    __out_opt uint8_t *paylenp, __inout unsigned int *contp);

LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_vpd_hunk_set(__in_bcount(size) caddr_t data,
                                               __in size_t size,
...
LIBEFX_INTERNAL
extern __checkReturn efx_rc_t
efx_mcdi_set_workaround(__in efx_nic_t *enp, __in uint32_t type,
                        __in boolean_t enabled, __out_opt uint32_t *flagsp);

LIBEFX_INTERNAL
extern __checkReturn efx_rc_t
efx_mcdi_get_workarounds(__in efx_nic_t *enp, __out_opt uint32_t *implementedp,
                         __out_opt uint32_t *enabledp);

#if EFSYS_OPT_RIVERHEAD || EFX_OPTS_EF10()

LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_mcdi_intf_from_pcie(
    __in uint32_t pcie_intf, __out efx_pcie_interface_t *efx_intf);

LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_mcdi_init_evq(
    __in efx_nic_t *enp, __in unsigned int instance, __in efsys_mem_t *esmp,
    __in size_t nevs, __in uint32_t irq, __in uint32_t target_evq,
    __in uint32_t us, __in uint32_t flags, __in boolean_t low_latency);

LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_mcdi_fini_evq(__in efx_nic_t *enp,
...
LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_mcdi_init_rxq(
    __in efx_nic_t *enp, __in uint32_t ndescs, __in efx_evq_t *eep,
    __in uint32_t label, __in uint32_t instance, __in efsys_mem_t *esmp,
    __in const efx_mcdi_init_rxq_params_t *params);

LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_mcdi_fini_rxq(__in efx_nic_t *enp,
                                                __in uint32_t instance);

LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_mcdi_init_txq(
    __in efx_nic_t *enp, __in uint32_t ndescs, __in uint32_t target_evq,
    __in uint32_t label, __in uint32_t instance, __in uint16_t flags,
    __in efsys_mem_t *esmp);

LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_mcdi_fini_txq(__in efx_nic_t *enp,
                                                __in uint32_t instance);
...
LIBEFX_INTERNAL
extern efx_rc_t efx_mac_stats_mask_add_ranges(
...
LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_mcdi_mac_stats(__in efx_nic_t *enp,
 ...
 */
LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_pci_config_find_next_ext_cap(
    __in efsys_pci_config_t *espcp, __in const efx_pci_ops_t *epop,
    __in uint16_t cap_id, __inout size_t *offsetp);
 ...
 */
LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_pci_config_next_ext_cap(
    __in efsys_pci_config_t *espcp, __in const efx_pci_ops_t *epop,
 ...
 */
LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_pci_find_next_xilinx_cap_table(
    __in efsys_pci_config_t *espcp, __in const efx_pci_ops_t *epop,
    __inout size_t *pci_cap_offsetp, __out unsigned int *xilinx_tbl_barp,
 ...
 */
LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_pci_read_ext_cap_xilinx_table(
    __in efsys_pci_config_t *espcp, __in const efx_pci_ops_t *epop,
    __in size_t cap_offset, __out unsigned int *barp,
 ...
 */
LIBEFX_INTERNAL
extern __checkReturn efx_rc_t efx_pci_xilinx_cap_tbl_find(
    __in efsys_bar_t *esbp, __in uint32_t format_id, __in boolean_t skip_first,
...
struct efx_mae_match_spec_s {
  ...
  union emms_mask_value_pairs {
    uint8_t action[MAE_FIELD_MASK_VALUE_PAIRS_V2_LEN];
...
struct efx_mae_actions_s {
  ...
  efx_mae_action_vlan_push_t ema_vlan_push_descs[EFX_MAE_VLAN_PUSH_MAX_NTAGS];
