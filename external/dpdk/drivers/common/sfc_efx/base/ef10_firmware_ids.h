...
enum {
  ...
  FIRMWARE_PHY_SUBTYPE_QT2025_KR =
      0x11,                            /* QT2025 in KR rather than SFP+ mode */
...
enum { FIRMWARE_DISABLED_CALLISTO_SUBTYPE_ALL = 0 };
...
enum {
  ...
  FIRMWARE_MUMFW_SUBTYPE_SIXPENCE =
      14,                             /* Melrose MUM firmware for Dell cards */
  FIRMWARE_MUMFW_SUBTYPE_CROWN = 15,  /* Coldstream MUM firmware */
  FIRMWARE_MUMFW_SUBTYPE_SOL = 16,    /* Roxburgh R2 MUM firmware for Dell cards
                                         with signed-bundle-update */
  FIRMWARE_MUMFW_SUBTYPE_KALUGA = 17, /* York MUM firmware */
  FIRMWARE_MUMFW_SUBTYPE_STERLET = 18, /* Bourn MUM firmware */
  FIRMWARE_MUMFW_SUBTYPE_TANNER =
      19, /* Melrose MUM firmware for channel cards */
...
enum {
  FIRMWARE_BUNDLE_SUBTYPE_DELL_X2522_25G =
      1, /* X2522-25G for Dell with bundle update support */
  FIRMWARE_BUNDLE_SUBTYPE_X2552 = 2, /* X2552 OCP NIC - firmware bundle */
  FIRMWARE_BUNDLE_SUBTYPE_DELL_X2562 =
      3, /* X2562 OCP NIC for Dell - firmware bundle */
