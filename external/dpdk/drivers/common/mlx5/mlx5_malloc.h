 ...
 */
__rte_internal void mlx5_memory_stat_dump(void);
 ...
 */
__rte_internal void *mlx5_malloc(uint32_t flags, size_t size,
                                 unsigned int align, int socket);
...
__rte_internal void *mlx5_realloc(void *addr, uint32_t flags, size_t size,
                                  unsigned int align, int socket);
 ...
 */
__rte_internal void mlx5_free(void *addr);
