 ...
 */
typedef int (*mlx5_list_match_cb)(void *tool_ctx, struct mlx5_list_entry *entry,
                                  void *ctx);

typedef struct mlx5_list_entry *(*mlx5_list_clone_cb)(
    void *tool_ctx, struct mlx5_list_entry *entry, void *ctx);
 ...
 */
__rte_internal struct mlx5_list *
 ...
 */
__rte_internal struct mlx5_list_entry *mlx5_list_lookup(struct mlx5_list *list,
                                                        void *ctx);
 ...
 */
__rte_internal struct mlx5_list_entry *
 ...
 */
__rte_internal int mlx5_list_unregister(struct mlx5_list *list,
                                        struct mlx5_list_entry *entry);
 ...
 *   Pointer to the mlx5 list.
 */
__rte_internal void mlx5_list_destroy(struct mlx5_list *list);
 ...
 */
__rte_internal uint32_t mlx5_list_get_entry_num(struct mlx5_list *list);
 ...
 *   0 on entry removed, 1 on entry still referenced.
 */
__rte_internal int mlx5_hlist_unregister(struct mlx5_hlist *h,
                                         struct mlx5_list_entry *entry);
 ...
 *   Pointer to the hast list table.
 */
__rte_internal void mlx5_hlist_destroy(struct mlx5_hlist *h);
