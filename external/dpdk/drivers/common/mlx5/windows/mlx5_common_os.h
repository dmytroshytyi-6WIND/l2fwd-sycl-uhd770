 ...
 *
 */
static inline void mlx5_os_free(void *addr) { _aligned_free(addr); }
...
__rte_internal void *mlx5_os_umem_reg(void *ctx, void *addr, size_t size,
                                      uint32_t access);
__rte_internal int mlx5_os_umem_dereg(void *pumem);
