...
#define MLX5_DEVX_MAX_KLM_ENTRIES                                              \
  ((UINT16_MAX - MLX5_ST_SZ_DW(create_mkey_in) * 4) / (MLX5_ST_SZ_DW(klm) * 4))
 ...
 */
__extension__ struct mlx5_hca_flex_attr {
  uint32_t node_in;
  uint32_t node_out;
...
static inline uint32_t mlx5_hca_parse_graph_node_base_hdr_len_mask(
...
__rte_internal struct mlx5_devx_obj *
mlx5_devx_cmd_flow_counter_alloc(void *ctx, uint32_t bulk_sz);
__rte_internal int mlx5_devx_cmd_destroy(struct mlx5_devx_obj *obj);
__rte_internal int
...
__rte_internal int mlx5_devx_cmd_query_hca_attr(void *ctx,
                                                struct mlx5_hca_attr *attr);
__rte_internal struct mlx5_devx_obj *
mlx5_devx_cmd_mkey_create(void *ctx, struct mlx5_devx_mkey_attr *attr);
__rte_internal int mlx5_devx_get_out_command_status(void *out);
__rte_internal int mlx5_devx_cmd_qp_query_tis_td(void *qp, uint32_t tis_num,
                                                 uint32_t *tis_td);
__rte_internal struct mlx5_devx_obj *
...
__rte_internal struct mlx5_devx_obj *
mlx5_devx_cmd_create_rmp(void *ctx, struct mlx5_devx_create_rmp_attr *rq_attr,
                         int socket);
__rte_internal struct mlx5_devx_obj *
...
__rte_internal struct mlx5_devx_obj *mlx5_devx_cmd_create_td(void *ctx);
__rte_internal int mlx5_devx_cmd_flow_dump(void *fdb_domain, void *rx_domain,
                                           void *tx_domain, FILE *file);
__rte_internal int mlx5_devx_cmd_flow_single_dump(void *rule, FILE *file);
__rte_internal struct mlx5_devx_obj *
...
__rte_internal int mlx5_devx_cmd_query_virtq(struct mlx5_devx_obj *virtq_obj,
                                             struct mlx5_devx_virtq_attr *attr);
__rte_internal struct mlx5_devx_obj *
mlx5_devx_cmd_create_qp(void *ctx, struct mlx5_devx_qp_attr *attr);
__rte_internal int mlx5_devx_cmd_modify_qp_state(struct mlx5_devx_obj *qp,
...
__rte_internal int mlx5_devx_cmd_register_read(void *ctx, uint16_t reg_id,
                                               uint32_t arg, uint32_t *data,
                                               uint32_t dw_cnt);

__rte_internal int mlx5_devx_cmd_register_write(void *ctx, uint16_t reg_id,
                                                uint32_t arg, uint32_t *data,
                                                uint32_t dw_cnt);

__rte_internal struct mlx5_devx_obj *
mlx5_devx_cmd_create_geneve_tlv_option(void *ctx, uint16_t class, uint8_t type,
                                       uint8_t len);
 ...
 */
__rte_internal int mlx5_devx_cmd_query_virtio_q_counters(
...
__rte_internal struct mlx5_devx_obj *mlx5_devx_cmd_alloc_pd(void *ctx);

__rte_internal int mlx5_devx_cmd_wq_query(void *wq, uint32_t *counter_set_id);

__rte_internal struct mlx5_devx_obj *
mlx5_devx_cmd_queue_counter_alloc(void *ctx);
__rte_internal int mlx5_devx_cmd_queue_counter_query(struct mlx5_devx_obj *dcs,
                                                     int clear,
...
__rte_internal int
mlx5_devx_cmd_query_lag(void *ctx, struct mlx5_devx_lag_context *lag_ctx);
