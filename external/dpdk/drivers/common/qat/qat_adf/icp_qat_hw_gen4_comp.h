...
static inline uint32_t ICP_QAT_FW_COMP_20_BUILD_CONFIG_UPPER(
  ...
  QAT_FIELD_SET(
      val32, csr.disable_token_fusion_ctrl,
  ...
  QAT_FIELD_SET(val32, csr.lbms, ICP_QAT_HW_COMP_20_CONFIG_CSR_LBMS_BITPOS,
...
static inline uint32_t ICP_QAT_FW_DECOMP_20_BUILD_CONFIG_LOWER(
  ...
  QAT_FIELD_SET(val32, csr.lbms, ICP_QAT_HW_DECOMP_20_CONFIG_CSR_LBMS_BITPOS,
