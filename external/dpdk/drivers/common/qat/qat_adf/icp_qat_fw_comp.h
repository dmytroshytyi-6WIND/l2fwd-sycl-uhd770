...
#define ICP_QAT_FW_COMP_REQ_PARAM_FLAGS_BUILD(sop, eop, bfinal, cnv, cnvnr)    \
  ((((sop)&ICP_QAT_FW_COMP_SOP_MASK) << ICP_QAT_FW_COMP_SOP_BITPOS) |          \
   ...
   (((bfinal)&ICP_QAT_FW_COMP_BFINAL_MASK) << ICP_QAT_FW_COMP_BFINAL_BITPOS) | \
 ...
 * @param bank_a_enable
 *****************************************************************************/
#define ICP_QAT_FW_COMP_RAM_FLAGS_BUILD(                                       \
    bank_i_enable, bank_h_enable, bank_g_enable, bank_f_enable, bank_e_enable, \
    bank_d_enable, bank_c_enable, bank_b_enable, bank_a_enable)                \
