...
#define ICP_QAT_FW_COMN_VALID_FLAG_SET(hdr_t, val)                             \
  QAT_FIELD_SET((hdr_t.hdr_flags), (val), ICP_QAT_FW_COMN_VALID_FLAG_BITPOS,   \
                ICP_QAT_FW_COMN_VALID_FLAG_MASK)
...
#define ICP_QAT_FW_COMN_NEXT_ID_SET_2(next_curr_id, val)                       \
  do {                                                                         \
    (next_curr_id) = (((next_curr_id)&ICP_QAT_FW_COMN_CURR_ID_MASK) |          \
                      (((val) << ICP_QAT_FW_COMN_NEXT_ID_BITPOS) &             \
                       ICP_QAT_FW_COMN_NEXT_ID_MASK))                          \
  } while (0)
...
#define ICP_QAT_FW_COMN_CURR_ID_SET_2(next_curr_id, val)                       \
  do {                                                                         \
    (next_curr_id) = (((next_curr_id)&ICP_QAT_FW_COMN_NEXT_ID_MASK) |          \
                      ((val)&ICP_QAT_FW_COMN_CURR_ID_MASK))                    \
  } while (0)
