...
#define QAT_STATE_REGISTERS_MAX_SIZE                                           \
  256 /* 64 bytes for GEN1-3, 256 for GEN4                                     \
       */
...
#define QAT_INFLATE_CONTEXT_SIZE                                               \
  RTE_MAX(RTE_MAX(RTE_MAX(QAT_INFLATE_CONTEXT_SIZE_GEN1,                       \
                          QAT_INFLATE_CONTEXT_SIZE_GEN2),                      \
                  QAT_INFLATE_CONTEXT_SIZE_GEN3),                              \
          QAT_INFLATE_CONTEXT_SIZE_GEN4)
...
int qat_comp_private_xform_free(struct rte_compressdev *dev,
                                void *private_xform);
