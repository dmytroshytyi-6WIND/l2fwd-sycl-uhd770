...
#define ZLIB_PMD_INFO(fmt, args...) ZLIB_PMD_LOG(INFO, fmt, ##args)
#define ZLIB_PMD_ERR(fmt, args...) ZLIB_PMD_LOG(ERR, fmt, ##args)
#define ZLIB_PMD_WARN(fmt, args...) ZLIB_PMD_LOG(WARNING, fmt, ##args)
