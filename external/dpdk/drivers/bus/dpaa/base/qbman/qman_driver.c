...
static __thread struct dpaa_ioctl_portal_map map = {.type = dpaa_portal_qman};

u16 dpaa_get_qm_channel_caam(void) { return qm_channel_caam; }

u16 dpaa_get_qm_channel_pool(void) { return qm_channel_pool1; }
...
int qman_thread_fd(void) { return qmfd; }
...
int qman_thread_finish(void) { return fsl_qman_portal_finish(); }
