...
__rte_internal int dpaa_intr_enable(char *if_name, int efd);

__rte_internal int dpaa_intr_disable(char *if_name);
...
__rte_internal int dpaa_get_link_status(char *if_name,
                                        struct rte_eth_link *link);
__rte_internal int dpaa_update_link_status(char *if_name, int link_status);
__rte_internal int dpaa_update_link_speed(char *if_name, int speed, int duplex);
