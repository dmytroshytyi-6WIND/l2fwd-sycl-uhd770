...
__rte_internal int qman_thread_fd(void);
 ...
 */
__rte_internal void qman_thread_irq(void);

__rte_internal void bman_thread_irq(void);
__rte_internal void qman_fq_portal_thread_irq(struct qman_portal *qp);
__rte_internal void qman_clear_irq(void);
...
__rte_internal struct qman_portal *fsl_qman_fq_portal_create(int *fd);
