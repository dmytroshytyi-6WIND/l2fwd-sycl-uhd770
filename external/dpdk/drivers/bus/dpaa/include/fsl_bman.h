 ...
 * function returns.
 */
__rte_internal struct bman_pool *
bman_new_pool(const struct bman_pool_params *params);

/**
 * bman_free_pool - Deallocates a Buffer Pool object
 * @pool: the pool object to release
 */
__rte_internal void bman_free_pool(struct bman_pool *pool);
 ...
 */
__rte_internal const struct bman_pool_params *
bman_get_params(const struct bman_pool *pool);
 ...
 *
 */
__rte_internal int bman_release(struct bman_pool *pool,
                                const struct bm_buffer *bufs, u8 num,
                                u32 flags);
 ...
 */
__rte_internal int bman_acquire(struct bman_pool *pool, struct bm_buffer *bufs,
                                u8 num, u32 flags);
 ...
 */
__rte_internal u32 bman_query_free_buffers(struct bman_pool *pool);
