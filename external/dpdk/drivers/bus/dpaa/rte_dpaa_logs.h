...
#define DPAA_BUS_INFO(fmt, args...) DPAA_BUS_LOG(INFO, fmt, ##args)
#define DPAA_BUS_ERR(fmt, args...) DPAA_BUS_LOG(ERR, fmt, ##args)
#define DPAA_BUS_WARN(fmt, args...) DPAA_BUS_LOG(WARNING, fmt, ##args)
