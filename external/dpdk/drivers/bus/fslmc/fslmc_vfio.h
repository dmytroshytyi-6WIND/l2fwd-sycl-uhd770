...
__rte_internal int rte_dpaa2_intr_enable(struct rte_intr_handle *intr_handle,
                                         int index);

__rte_internal int rte_dpaa2_intr_disable(struct rte_intr_handle *intr_handle,
                                          int index);
