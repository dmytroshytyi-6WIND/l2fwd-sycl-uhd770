 ...
 */
__rte_internal void qbman_swp_interrupt_clear_status(struct qbman_swp *p,
                                                     uint32_t mask);
 ...
 * desired channel.
 */
__rte_internal void qbman_swp_push_set(struct qbman_swp *s, uint8_t channel_idx,
                                       int enable);
 ...
 */
__rte_internal void qbman_pull_desc_clear(struct qbman_pull_desc *d);
 ...
 */
__rte_internal void qbman_pull_desc_set_storage(struct qbman_pull_desc *d,
 ...
 */
__rte_internal void qbman_pull_desc_set_numframes(struct qbman_pull_desc *d,
                                                  uint8_t numframes);
/**
 ...
 */
__rte_internal void qbman_pull_desc_set_fq(struct qbman_pull_desc *d,
                                           uint32_t fqid);
 ...
 * to do pull dequeue.
 */
__rte_internal int qbman_swp_pull(struct qbman_swp *s,
 ...
 */
__rte_internal const struct qbman_result *
qbman_swp_dqrr_next(struct qbman_swp *p);

/**
 * qbman_swp_prefetch_dqrr_next() - prefetch the next DQRR entry.
 * @s: the software portal object.
 */
__rte_internal void qbman_swp_prefetch_dqrr_next(struct qbman_swp *s);
 ...
 */
__rte_internal void qbman_swp_dqrr_consume(struct qbman_swp *s,
 ...
 */
__rte_internal void qbman_swp_dqrr_idx_consume(struct qbman_swp *s,
                                               uint8_t dqrr_index);
 ...
 * Return dqrr index.
 */
__rte_internal uint8_t qbman_get_dqrr_idx(const struct qbman_result *dqrr);
 ...
 */
__rte_internal struct qbman_result *qbman_get_dqrr_from_idx(struct qbman_swp *s,
                                                            uint8_t idx);
 ...
 * dequeue result.
 */
__rte_internal int qbman_result_has_new_result(struct qbman_swp *s,
 ...
 * dequeue result.
 */
__rte_internal int qbman_check_command_complete(struct qbman_result *dq);

__rte_internal int qbman_check_new_result(struct qbman_result *dq);
 ...
 */
__rte_internal uint8_t qbman_result_DQ_flags(const struct qbman_result *dq);
 ...
 */
static inline int
qbman_result_DQ_is_pull_complete(const struct qbman_result *dq) {
 ...
 * Return seqnum.
 */
__rte_internal uint16_t qbman_result_DQ_seqnum(const struct qbman_result *dq);
 ...
 * Return odpid.
 */
__rte_internal uint16_t qbman_result_DQ_odpid(const struct qbman_result *dq);
 ...
 */
__rte_internal uint64_t qbman_result_DQ_fqd_ctx(const struct qbman_result *dq);
 ...
 */
__rte_internal const struct qbman_fd *
qbman_result_DQ_fd(const struct qbman_result *dq);
 ...
 */
__rte_internal uint8_t qbman_result_SCN_state(const struct qbman_result *scn);
 ...
 */
__rte_internal void qbman_eq_desc_clear(struct qbman_eq_desc *d);
 ...
 */
__rte_internal void qbman_eq_desc_set_no_orp(struct qbman_eq_desc *d,
                                             int respond_success);
/**
 ...
 * sequence number.
 */
__rte_internal void qbman_eq_desc_set_orp(struct qbman_eq_desc *d,
                                          int respond_success, uint16_t opr_id,
                                          uint16_t seqnum, int incomplete);
 ...
 */
__rte_internal void qbman_eq_desc_set_response(struct qbman_eq_desc *d,
                                               uint64_t storage_phys,
                                               int stash);
 ...
 * value.
 */
__rte_internal void qbman_eq_desc_set_token(struct qbman_eq_desc *d,
                                            uint8_t token);
 ...
 */
__rte_internal void qbman_eq_desc_set_fq(struct qbman_eq_desc *d,
                                         uint32_t fqid);
 ...
 */
__rte_internal void qbman_eq_desc_set_qd(struct qbman_eq_desc *d, uint32_t qdid,
 ...
 * being rescheduled.)
 */
__rte_internal void qbman_eq_desc_set_dca(struct qbman_eq_desc *d, int enable,
 ...
 */
__rte_internal struct qbman_fd *
qbman_result_eqresp_fd(struct qbman_result *eqresp);
 ...
 */
__rte_internal void qbman_result_eqresp_set_rspid(struct qbman_result *eqresp,
                                                  uint8_t val);
 ...
 */
__rte_internal uint8_t qbman_result_eqresp_rspid(struct qbman_result *eqresp);
 ...
 */
__rte_internal uint8_t qbman_result_eqresp_rc(struct qbman_result *eqresp);
 ...
 */
__rte_internal int qbman_swp_enqueue_multiple(struct qbman_swp *s,
 ...
 * Return the number of enqueued frames, -EBUSY if the EQCR is not ready.
 */
__rte_internal int qbman_swp_enqueue_multiple_fd(struct qbman_swp *s,
                                                 const struct qbman_eq_desc *d,
                                                 struct qbman_fd **fd,
                                                 uint32_t *flags,
                                                 int num_frames);
 ...
 */
__rte_internal void qbman_release_desc_clear(struct qbman_release_desc *d);

/**
 * qbman_release_desc_set_bpid() - Set the ID of the buffer pool to release to
 * @d: the qbman release descriptor.
 */
__rte_internal void qbman_release_desc_set_bpid(struct qbman_release_desc *d,
                                                uint16_t bpid);
 ...
 */
__rte_internal int qbman_swp_release(struct qbman_swp *s,
 ...
 * fails.
 */
__rte_internal int qbman_swp_acquire(struct qbman_swp *s, uint16_t bpid,
                                     uint64_t *buffers,
                                     unsigned int num_buffers);
