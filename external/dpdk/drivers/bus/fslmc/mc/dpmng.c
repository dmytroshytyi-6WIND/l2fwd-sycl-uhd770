 ...
 */
int mc_get_version(struct fsl_mc_io *mc_io, uint32_t cmd_flags,
  ...
  /* prepare command */
  cmd.header = mc_encode_cmd_header(DPMNG_CMDID_GET_VERSION, cmd_flags, 0);
 ...
 * Return:     '0' on Success; Error code otherwise.
 */
int mc_get_soc_version(struct fsl_mc_io *mc_io, uint32_t cmd_flags,
  ...
  /* prepare command */
  cmd.header = mc_encode_cmd_header(DPMNG_CMDID_GET_SOC_VERSION, cmd_flags, 0);
