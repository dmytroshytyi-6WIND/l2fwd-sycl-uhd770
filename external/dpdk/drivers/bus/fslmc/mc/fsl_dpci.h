 ...
 */
enum dpci_dest { DPCI_DEST_NONE = 0, DPCI_DEST_DPIO = 1, DPCI_DEST_DPCON = 2 };
...
__rte_internal int dpci_set_rx_queue(struct fsl_mc_io *mc_io,
...
__rte_internal int dpci_set_opr(struct fsl_mc_io *mc_io, uint32_t cmd_flags,
                                uint16_t token, uint8_t index, uint8_t options,
                                struct opr_cfg *cfg);

__rte_internal int dpci_get_opr(struct fsl_mc_io *mc_io, uint32_t cmd_flags,
                                uint16_t token, uint8_t index,
