...
__rte_internal int dpaa2_affine_qbman_swp(void);

/* Affine additional DPIO portal to current crypto processing thread */
__rte_internal int dpaa2_affine_qbman_ethrx_swp(void);
...
__rte_internal uint32_t dpaa2_free_eq_descriptors(void);
