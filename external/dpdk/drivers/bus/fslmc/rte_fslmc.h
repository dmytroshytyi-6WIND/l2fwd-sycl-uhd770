 ...
 */
__rte_internal static inline dpaa2_seqn_t *dpaa2_seqn(struct rte_mbuf *mbuf) {
  return RTE_MBUF_DYNFIELD(mbuf, dpaa2_seqn_dynfield_offset, dpaa2_seqn_t *);
}
