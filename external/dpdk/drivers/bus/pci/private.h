...
enum rte_iova_mode pci_device_iova_mode(const struct rte_pci_driver *pci_drv,
                                        const struct rte_pci_device *pci_dev);
 ...
 *   NULL otherwise.
 */
void *rte_pci_dev_iterate(const void *start, const char *str,
 ...
 */
int rte_pci_devargs_parse(struct rte_devargs *da);
