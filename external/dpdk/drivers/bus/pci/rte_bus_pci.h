...
#define RTE_PCI_DEVICE(vend, dev)                                              \
  RTE_CLASS_ANY_ID, (vend), (dev), RTE_PCI_ANY_ID, RTE_PCI_ANY_ID
#else
 ...
 */
__rte_experimental off_t rte_pci_find_ext_capability(struct rte_pci_device *dev,
                                                     uint32_t cap);
 ...
 */
__rte_experimental int rte_pci_set_bus_master(struct rte_pci_device *dev,
                                              bool enable);
