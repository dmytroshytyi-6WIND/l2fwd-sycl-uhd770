...
#define IFPGA_BUS_DEBUG(fmt, args...) IFPGA_BUS_LOG(DEBUG, fmt, ##args)
#define IFPGA_BUS_INFO(fmt, args...) IFPGA_BUS_LOG(INFO, fmt, ##args)
#define IFPGA_BUS_ERR(fmt, args...) IFPGA_BUS_LOG(ERR, fmt, ##args)
#define IFPGA_BUS_WARN(fmt, args...) IFPGA_BUS_LOG(WARNING, fmt, ##args)
