 ...
 */
static inline int __rte_experimental rte_ioat_enqueue_fill(int dev_id,
                                                           uint64_t pattern,
                                                           phys_addr_t dst,
                                                           unsigned int length,
                                                           uintptr_t dst_hdl);
 ...
 *   Number of operations enqueued, either 0 or 1
 */
static inline int __rte_experimental rte_ioat_enqueue_copy(
    int dev_id, phys_addr_t src, phys_addr_t dst, unsigned int length,
 ...
 */
static inline int __rte_experimental rte_ioat_fence(int dev_id);
 ...
 */
static inline int __rte_experimental rte_ioat_perform_ops(int dev_id);
...
#define RTE_IOAT_OP_SKIPPED                                                    \
  1 /**< Operation was not attempted (Earlier fenced op failed) */
...
#define RTE_IOAT_OP_INVALID_LEN                                                \
  0x13 /**< Invalid/too big length field passed                                \
        */
 ...
 */
static inline int __rte_experimental rte_ioat_completed_ops(
    int dev_id, uint8_t max_copies, uint32_t *status, uint8_t *num_unsuccessful,
