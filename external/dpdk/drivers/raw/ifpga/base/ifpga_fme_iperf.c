...
static u64 read_cache_counter(struct ifpga_fme_hw *fme, u8 channel,
  ...
  if (fpga_wait_register_field(event_code, ctr0, &iperf->ch_ctr0, IPERF_TIMEOUT,
                               1)) {
...
static u64 read_iommu_sip_counter(struct ifpga_fme_hw *fme,
  ...
  if (fpga_wait_register_field(event_code, sip_ctr, &iperf->vtd_sip_ctr,
                               IPERF_TIMEOUT, 1)) {
    dev_err(fme,
...
static u64 read_iommu_counter(struct ifpga_fme_hw *fme, u8 port_id,
  ...
  if (fpga_wait_register_field(event_code, ctr, &iperf->vtd_ctr, IPERF_TIMEOUT,
                               1)) {
...
static bool fabric_pobj_is_enabled(u8 port_id,
                                   struct feature_fme_iperf *iperf) {
...
static u64 read_fabric_counter(struct ifpga_fme_hw *fme, u8 port_id,
  ...
  if (fpga_wait_register_field(event_code, ctr, &iperf->fab_ctr, IPERF_TIMEOUT,
                               1)) {
    dev_err(fme, "timeout, unmatched VTd event type in counter registers.\n");
    spinlock_unlock(&fme->lock);
    return -ETIMEDOUT;
...
static int fme_iperf_get_fab_port_enable(struct ifpga_fme_hw *fme, u8 port_id,
                                         u64 *enable) {
  struct feature_fme_iperf *iperf;
  int status;
 ...
 */
static int fme_iperf_set_fab_port_enable(struct ifpga_fme_hw *fme, u8 port_id,
                                         u64 enable) {
  struct feature_fme_ifpmon_fab_ctl ctl;
  struct feature_fme_iperf *iperf;
  bool state;
...
static int fme_iperf_cache_get_prop(struct ifpga_feature *feature,
  ...
  case 0xa: /* DATA_WRITE_PORT_CONTENTION */
    return fme_iperf_get_cache_data_write_port_contention(fme, &prop->data);
  case 0xb: /* TAG_WRITE_PORT_CONTENTION */
    return fme_iperf_get_cache_tag_write_port_contention(fme, &prop->data);
  }
...
static int fme_iperf_vtd_sub_get_prop(struct ifpga_feature *feature,
  ...
  case 0xe: /* READ_TRANSACTION */
    return fme_iperf_get_vtd_port_read_transaction(fme, sub, &prop->data);
  case 0xf: /* WRITE_TRANSACTION */
    return fme_iperf_get_vtd_port_write_transaction(fme, sub, &prop->data);
  case 0x10: /* DEVTLB_READ_HIT */
    return fme_iperf_get_vtd_port_devtlb_read_hit(fme, sub, &prop->data);
  case 0x11: /* DEVTLB_WRITE_HIT */
    return fme_iperf_get_vtd_port_devtlb_write_hit(fme, sub, &prop->data);
  case 0x12: /* DEVTLB_4K_FILL */
    return fme_iperf_get_vtd_port_devtlb_4k_fill(fme, sub, &prop->data);
  case 0x13: /* DEVTLB_2M_FILL */
    return fme_iperf_get_vtd_port_devtlb_2m_fill(fme, sub, &prop->data);
  case 0x14: /* DEVTLB_1G_FILL */
    return fme_iperf_get_vtd_port_devtlb_1g_fill(fme, sub, &prop->data);
  }
...
static int fme_iperf_fab_get_prop(struct ifpga_feature *feature,
  ...
  case 0x2: /* PCIE0_READ */
    return fme_iperf_get_fab_port_pcie0_read(fme, sub, &prop->data);
  case 0x3: /* PCIE0_WRITE */
    return fme_iperf_get_fab_port_pcie0_write(fme, sub, &prop->data);
  case 0x4: /* PCIE1_READ */
    return fme_iperf_get_fab_port_pcie1_read(fme, sub, &prop->data);
  case 0x5: /* PCIE1_WRITE */
    return fme_iperf_get_fab_port_pcie1_write(fme, sub, &prop->data);
  case 0x6: /* UPI_READ */
    return fme_iperf_get_fab_port_upi_read(fme, sub, &prop->data);
  case 0x7: /* UPI_WRITE */
    return fme_iperf_get_fab_port_upi_write(fme, sub, &prop->data);
  case 0x8: /* MMIO_READ */
    return fme_iperf_get_fab_port_mmio_read(fme, sub, &prop->data);
  case 0x9: /* MMIO_WRITE */
    return fme_iperf_get_fab_port_mmio_write(fme, sub, &prop->data);
  case 0xa: /* ENABLE */
