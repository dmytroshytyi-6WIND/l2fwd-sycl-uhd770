 ...
 */
#define FEATURE_DRV(n, s, p) .id = (n), .name = (s), .ops = (p)

static inline struct ifpga_port_hw *get_port(struct ifpga_hw *hw, u32 port_id) {
...
static inline void *get_fme_feature_ioaddr_by_index(struct ifpga_fme_hw *fme,
                                                    int index) {
...
static inline void *get_port_feature_ioaddr_by_index(struct ifpga_port_hw *port,
                                                     int index) {
...
static inline bool is_fme_feature_present(struct ifpga_fme_hw *fme, int index) {
  return !!get_fme_feature_ioaddr_by_index(fme, index);
}

static inline bool is_port_feature_present(struct ifpga_port_hw *port,
                                           int index) {
