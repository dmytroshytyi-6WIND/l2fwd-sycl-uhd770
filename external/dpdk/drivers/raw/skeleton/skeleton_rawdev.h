...
#define SKELETON_PMD_DEBUG(fmt, args...) SKELETON_PMD_LOG(DEBUG, fmt, ##args)
#define SKELETON_PMD_INFO(fmt, args...) SKELETON_PMD_LOG(INFO, fmt, ##args)
#define SKELETON_PMD_ERR(fmt, args...) SKELETON_PMD_LOG(ERR, fmt, ##args)
#define SKELETON_PMD_WARN(fmt, args...) SKELETON_PMD_LOG(WARNING, fmt, ##args)
...
enum skeleton_device_state { SKELETON_DEV_RUNNING, SKELETON_DEV_STOPPED };

enum skeleton_queue_state { SKELETON_QUEUE_DETACH, SKELETON_QUEUE_ATTACH };
