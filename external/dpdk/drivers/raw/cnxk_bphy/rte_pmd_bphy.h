...
static __rte_always_inline int __rte_pmd_bphy_enq_deq(uint16_t dev_id,
                                                      unsigned int queue,
                                                      void *req, void *rsp,
                                                      size_t rsp_size) {
...
static __rte_always_inline int rte_pmd_bphy_intr_init(uint16_t dev_id) {
  struct cnxk_bphy_irq_msg msg = {
      .type = CNXK_BPHY_IRQ_MSG_TYPE_INIT,
  };

  return __rte_pmd_bphy_enq_deq(dev_id, CNXK_BPHY_DEF_QUEUE, &msg, NULL, 0);
}

static __rte_always_inline int rte_pmd_bphy_intr_fini(uint16_t dev_id) {
  struct cnxk_bphy_irq_msg msg = {
...
rte_pmd_bphy_intr_register(uint16_t dev_id, int irq_num,
  ...
  struct cnxk_bphy_irq_msg msg = {.type = CNXK_BPHY_IRQ_MSG_TYPE_REGISTER,
                                  .data = &info};

  return __rte_pmd_bphy_enq_deq(dev_id, CNXK_BPHY_DEF_QUEUE, &msg, NULL, 0);
}

static __rte_always_inline int rte_pmd_bphy_intr_unregister(uint16_t dev_id,
                                                            int irq_num) {
  struct cnxk_bphy_irq_info info = {
      .irq_num = irq_num,
  };
  struct cnxk_bphy_irq_msg msg = {.type = CNXK_BPHY_IRQ_MSG_TYPE_UNREGISTER,
                                  .data = &info};
...
rte_pmd_bphy_intr_mem_get(uint16_t dev_id, struct cnxk_bphy_mem *mem) {
  ...
  return __rte_pmd_bphy_enq_deq(dev_id, CNXK_BPHY_DEF_QUEUE, &msg, mem,
                                sizeof(*mem));
}

static __rte_always_inline int rte_pmd_bphy_npa_pf_func_get(uint16_t dev_id,
                                                            uint16_t *pf_func) {
  struct cnxk_bphy_irq_msg msg = {
      .type = CNXK_BPHY_MSG_TYPE_NPA_PF_FUNC,
  };

  return __rte_pmd_bphy_enq_deq(dev_id, CNXK_BPHY_DEF_QUEUE, &msg, pf_func,
                                sizeof(*pf_func));
}

static __rte_always_inline int rte_pmd_bphy_sso_pf_func_get(uint16_t dev_id,
                                                            uint16_t *pf_func) {
  struct cnxk_bphy_irq_msg msg = {
...
static __rte_always_inline int rte_pmd_bphy_cgx_intlbk_disable(uint16_t dev_id,
                                                               uint16_t lmac) {
  struct cnxk_bphy_cgx_msg msg = {
...
static __rte_always_inline int rte_pmd_bphy_cgx_intlbk_enable(uint16_t dev_id,
                                                              uint16_t lmac) {
  struct cnxk_bphy_cgx_msg msg = {
...
static __rte_always_inline int rte_pmd_bphy_cgx_ptp_rx_disable(uint16_t dev_id,
                                                               uint16_t lmac) {
  struct cnxk_bphy_cgx_msg msg = {
...
static __rte_always_inline int rte_pmd_bphy_cgx_ptp_rx_enable(uint16_t dev_id,
                                                              uint16_t lmac) {
  struct cnxk_bphy_cgx_msg msg = {
...
static __rte_always_inline int rte_pmd_bphy_cgx_start_rxtx(uint16_t dev_id,
                                                           uint16_t lmac) {
  struct cnxk_bphy_cgx_msg msg = {
...
static __rte_always_inline int rte_pmd_bphy_cgx_stop_rxtx(uint16_t dev_id,
                                                          uint16_t lmac) {
  struct cnxk_bphy_cgx_msg msg = {
