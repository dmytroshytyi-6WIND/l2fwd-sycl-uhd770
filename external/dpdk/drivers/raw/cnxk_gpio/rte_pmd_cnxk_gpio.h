...
static __rte_always_inline int __rte_pmd_gpio_enq_deq(uint16_t dev_id, int gpio,
                                                      void *req, void *rsp,
                                                      size_t rsp_size) {
 ...
 */
static __rte_always_inline int rte_pmd_gpio_set_pin_value(uint16_t dev_id,
                                                          int gpio, int val) {
...
rte_pmd_gpio_set_pin_edge(uint16_t dev_id, int gpio,
  ...
  struct cnxk_gpio_msg msg = {.type = CNXK_GPIO_MSG_TYPE_SET_PIN_EDGE,
                              .data = &edge};
 ...
 */
static __rte_always_inline int
rte_pmd_gpio_set_pin_dir(uint16_t dev_id, int gpio,
 ...
 *   Returns 0 on success, negative error code otherwise
 */
static __rte_always_inline int rte_pmd_gpio_get_pin_value(uint16_t dev_id,
                                                          int gpio, int *val) {
  struct cnxk_gpio_msg msg = {
 ...
 */
static __rte_always_inline int
rte_pmd_gpio_get_pin_dir(uint16_t dev_id, int gpio,
                         enum cnxk_gpio_pin_dir *dir) {
  struct cnxk_gpio_msg msg = {
 ...
 *   Returns 0 on success, negative error code otherwise
 */
static __rte_always_inline int rte_pmd_gpio_unregister_irq(uint16_t dev_id,
                                                           int gpio) {
  struct cnxk_gpio_msg msg = {
 ...
 *   Returns 0 on success, negative error code otherwise
 */
static __rte_always_inline int rte_pmd_gpio_disable_interrupt(uint16_t dev_id,
                                                              int gpio) {
