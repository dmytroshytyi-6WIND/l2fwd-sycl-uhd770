...
enum ifpga_rawdev_link_speed {
  ...
  IFPGA_RAWDEV_LINK_SPEED_10GB = (1 << IFPGA_RAWDEV_LINK_SPEED_10GB_SHIFT),
  IFPGA_RAWDEV_LINK_SPEED_40GB = (1 << IFPGA_RAWDEV_LINK_SPEED_40GB_SHIFT),
  IFPGA_RAWDEV_LINK_SPEED_25GB = (1 << IFPGA_RAWDEV_LINK_SPEED_25GB_SHIFT),
};
