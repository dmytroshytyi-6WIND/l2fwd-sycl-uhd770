...
#define IPN3KE_FLOW_KEY_TOTAL_BITS                                             \
  (IPN3KE_FLOW_KEY_UNUSED_BITS + IPN3KE_FLOW_KEY_ID_BITS +                     \
   IPN3KE_FLOW_KEY_DATA_BITS)

#define IPN3KE_FLOW_KEY_ID_OFFSET (IPN3KE_FLOW_KEY_UNUSED_BITS)
...
#define IPN3KE_FLOW_RESULT_TOTAL_BITS                                          \
  (IPN3KE_FLOW_RESULT_UNUSED_BITS + IPN3KE_FLOW_RESULT_ACL_BITS +              \
   IPN3KE_FLOW_RESULT_UID_BITS)

#define IPN3KE_FLOW_RESULT_ACL_OFFSET (IPN3KE_FLOW_RESULT_UNUSED_BITS)

#define IPN3KE_FLOW_RESULT_UID_OFFSET                                          \
  (IPN3KE_FLOW_RESULT_ACL_OFFSET + IPN3KE_FLOW_RESULT_ACL_BITS)

#define IPN3KE_FLOW_RESULT_UID_MAX ((1UL << IPN3KE_FLOW_RESULT_UID_BITS) - 1)
