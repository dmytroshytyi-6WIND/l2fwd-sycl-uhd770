...
enum ngbe_l2_ptids {
  ...
  NGBE_PTID_L2_IPV6_FRAG =
      (NGBE_PTID_PKT_IP | NGBE_PTID_PKT_IPV6 | NGBE_PTID_TYP_IPFRAG),
  NGBE_PTID_L2_IPV6 =
      (NGBE_PTID_PKT_IP | NGBE_PTID_PKT_IPV6 | NGBE_PTID_TYP_IPDATA),
  NGBE_PTID_L2_IPV6_UDP =
      (NGBE_PTID_PKT_IP | NGBE_PTID_PKT_IPV6 | NGBE_PTID_TYP_UDP),
  NGBE_PTID_L2_IPV6_TCP =
      (NGBE_PTID_PKT_IP | NGBE_PTID_PKT_IPV6 | NGBE_PTID_TYP_TCP),
  NGBE_PTID_L2_IPV6_SCTP =
      (NGBE_PTID_PKT_IP | NGBE_PTID_PKT_IPV6 | NGBE_PTID_TYP_SCTP),

  NGBE_PTID_L2_TUN4_MAC = (NGBE_PTID_PKT_TUN | NGBE_PTID_TUN_EIGM),
  NGBE_PTID_L2_TUN6_MAC =
      (NGBE_PTID_PKT_TUN | NGBE_PTID_TUN_IPV6 | NGBE_PTID_TUN_EIGM),
};
