...
#define TPTE(ptid, l2, l3, l4, tun, el2, el3, el4)                             \
  [ptid] = (RTE_PTYPE_L2_##l2 | RTE_PTYPE_L3_##l3 | RTE_PTYPE_L4_##l4 |        \
            RTE_PTYPE_TUNNEL_##tun | RTE_PTYPE_INNER_L2_##el2 |                \
            RTE_PTYPE_INNER_L3_##el3 | RTE_PTYPE_INNER_L4_##el4)
...
u32 *ngbe_get_supported_ptypes(void) {
  static u32 ptypes[] = {/* For non-vec functions,
...
static inline u8 ngbe_encode_ptype_mac(u32 ptype) {
  u8 ptid;
...
static inline u8 ngbe_encode_ptype_ip(u32 ptype) {
  u8 ptid;
...
static inline u8 ngbe_encode_ptype_tunnel(u32 ptype) {
  u8 ptid;
