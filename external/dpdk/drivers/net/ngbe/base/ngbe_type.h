...
struct ngbe_rom_info {
  ...
  s32 (*readw_buffer)(struct ngbe_hw *hw, u32 offset, u32 words, void *data);
  s32 (*read32)(struct ngbe_hw *hw, u32 addr, u32 *data);
  s32 (*writew_buffer)(struct ngbe_hw *hw, u32 offset, u32 words, void *data);
...
struct ngbe_mac_info {
  ...
  s32 (*get_link_capabilities)(struct ngbe_hw *hw, u32 *speed, bool *autoneg);
  ...
  s32 (*set_vfta)(struct ngbe_hw *hw, u32 vlan, u32 vind, bool vlan_on,
                  bool vlvf_bypass);
  s32 (*set_vlvf)(struct ngbe_hw *hw, u32 vlan, u32 vind, bool vlan_on,
...
struct ngbe_phy_info {
  ...
  s32 (*init_hw)(struct ngbe_hw *hw);
  s32 (*reset_hw)(struct ngbe_hw *hw);
  s32 (*read_reg)(struct ngbe_hw *hw, u32 reg_addr, u32 device_type,
                  u16 *phy_data);
  s32 (*write_reg)(struct ngbe_hw *hw, u32 reg_addr, u32 device_type,
                   u16 phy_data);
  s32 (*read_reg_unlocked)(struct ngbe_hw *hw, u32 reg_addr, u32 device_type,
                           u16 *phy_data);
  s32 (*write_reg_unlocked)(struct ngbe_hw *hw, u32 reg_addr, u32 device_type,
                            u16 phy_data);
  s32 (*setup_link)(struct ngbe_hw *hw, u32 speed,
                    bool autoneg_wait_to_complete);
  s32 (*check_link)(struct ngbe_hw *hw, u32 *speed, bool *link_up);
