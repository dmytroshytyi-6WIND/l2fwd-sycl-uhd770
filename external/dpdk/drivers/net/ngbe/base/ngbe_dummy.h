...
static inline s32 ngbe_phy_setup_link_dummy(struct ngbe_hw *TUP0, u32 TUP1,
                                            bool TUP2) {
  return NGBE_ERR_OPS_DUMMY;
}
...
static inline s32 ngbe_mbx_read_dummy(struct ngbe_hw *TUP0, u32 *TUP1, u16 TUP2,
                                      u16 TUP3) {
  return NGBE_ERR_OPS_DUMMY;
}
