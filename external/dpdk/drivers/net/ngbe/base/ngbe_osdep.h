...
static inline u64 REVERT_BIT_MASK64(u64 mask) {
  mask =
      ((mask & 0x5555555555555555) << 1) | ((mask & 0xAAAAAAAAAAAAAAAA) >> 1);
  mask =
      ((mask & 0x3333333333333333) << 2) | ((mask & 0xCCCCCCCCCCCCCCCC) >> 2);
  mask =
      ((mask & 0x0F0F0F0F0F0F0F0F) << 4) | ((mask & 0xF0F0F0F0F0F0F0F0) >> 4);
  mask =
      ((mask & 0x00FF00FF00FF00FF) << 8) | ((mask & 0xFF00FF00FF00FF00) >> 8);
  mask =
      ((mask & 0x0000FFFF0000FFFF) << 16) | ((mask & 0xFFFF0000FFFF0000) >> 16);
...
#define NGBE_IS_MULTICAST(address) rte_is_multicast_ether_addr(address)

/* Check whether an address is broadcast. */
#define NGBE_IS_BROADCAST(address) rte_is_broadcast_ether_addr(address)
