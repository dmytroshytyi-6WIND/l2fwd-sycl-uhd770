...
#define NDIS_RSS_CAPS_SIZE offsetof(struct ndis_rss_caps, ndis_pad)
#define NDIS_RSS_CAPS_SIZE_6_0 offsetof(struct ndis_rss_caps, ndis_nind)
...
#define NDIS_VLAN_INFO_MAKE(id, pri, cfi)                                      \
  (((pri)&NDIS_VLAN_INFO_PRI_MASK) | (((cfi)&0x1) << 3) | (((id)&0xfff) << 4))
...
#define NDIS_LSO2_INFO_MAKEIPV4(thoff, mss) NDIS_LSO2_INFO_MAKE((thoff), (mss))
