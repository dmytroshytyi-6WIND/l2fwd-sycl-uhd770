...
void hn_rndis_rx_ctrl(struct hn_data *hv, const void *data, int dlen);
int hn_rndis_get_offload(struct hn_data *hv, struct rte_eth_dev_info *dev_info);
...
int hn_rndis_query_rss(struct hn_data *hv, struct rte_eth_rss_conf *rss_conf);
