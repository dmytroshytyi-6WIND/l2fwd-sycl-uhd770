...
#define RNDIS_PACKET_MSG_OFFSET_ALIGNMASK (RNDIS_PACKET_MSG_OFFSET_ALIGN - 1)
...
#define RNDIS_PKTINFO_OFFSET offsetof(struct rndis_pktinfo, data[0])
...
#define RNDIS_INIT_COMP_SIZE_MIN offsetof(struct rndis_init_comp, aflistsz)
...
#define RNDIS_QUERY_REQ_INFOBUFOFFSET                                          \
  (sizeof(struct rndis_query_req) - offsetof(struct rndis_query_req, rid))
...
#define RNDIS_SET_REQ_INFOBUFOFFSET                                            \
  (sizeof(struct rndis_set_req) - offsetof(struct rndis_set_req, rid))
