...
#define CXGBE_MAX_RX_PKTLEN                                                    \
  (9000 + RTE_ETHER_HDR_LEN + RTE_ETHER_CRC_LEN) /* max pkt */

/* The max frame size with default MTU */
#define CXGBE_ETH_MAX_LEN                                                      \
  (RTE_ETHER_MTU + RTE_ETHER_HDR_LEN + RTE_ETHER_CRC_LEN)
