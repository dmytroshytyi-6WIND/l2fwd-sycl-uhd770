...
static inline int t4_wait_op_done(struct adapter *adapter, int reg, u32 mask,
  ...
  return t4_wait_op_done_val(adapter, reg, mask, polarity, attempts, delay,
                             NULL);
}

static inline int is_pf4(struct adapter *adap) { return adap->pf == 4; }
...
static inline int t4_wr_mbox_timeout(struct adapter *adap, int mbox,
                                     ...
                                     int timeout) {
  return t4_wr_mbox_meat_timeout(adap, mbox, cmd, size, rpl, true, timeout);
}
...
static inline int t4_memory_rw(struct adapter *adap, int win, int mtype,
                               u32 maddr, u32 len, void *hbuf, int dir) {
