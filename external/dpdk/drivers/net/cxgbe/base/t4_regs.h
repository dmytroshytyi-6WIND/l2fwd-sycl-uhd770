...
#define G_T6_EGRTHRESHOLDPACKING(x)                                            \
  (((x) >> S_T6_EGRTHRESHOLDPACKING) & M_T6_EGRTHRESHOLDPACKING)
...
#define G_EGRTHRESHOLDPACKING(x)                                               \
  (((x) >> S_EGRTHRESHOLDPACKING) & M_EGRTHRESHOLDPACKING)
...
#define MPS_PORT_RX_CTL(idx) (A_MPS_PORT0_RX_CTL + (idx)*MPS_PORT_RX_CTL_STRIDE)
