...
#define G_FW_CAPS_CONFIG_CMD_MEMTYPE_CF(x)                                     \
  (((x) >> S_FW_CAPS_CONFIG_CMD_MEMTYPE_CF) & M_FW_CAPS_CONFIG_CMD_MEMTYPE_CF)
...
#define G_FW_PARAMS_PARAM_FILTER_MODE(x)                                       \
  (((x) >> S_FW_PARAMS_PARAM_FILTER_MODE) & M_FW_PARAMS_PARAM_FILTER_MODE)
...
#define G_FW_PARAMS_PARAM_FILTER_MASK(x)                                       \
  (((x) >> S_FW_PARAMS_PARAM_FILTER_MASK) & M_FW_PARAMS_PARAM_FILTER_MASK)
...
#define G_FW_RSS_VI_CONFIG_CMD_DEFAULTQ(x)                                     \
  (((x) >> S_FW_RSS_VI_CONFIG_CMD_DEFAULTQ) & M_FW_RSS_VI_CONFIG_CMD_DEFAULTQ)
