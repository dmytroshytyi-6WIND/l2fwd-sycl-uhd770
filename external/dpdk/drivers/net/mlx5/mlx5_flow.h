...
#define MLX5_INDIRECT_ACT_CT_GEN_IDX(owner, index)                             \
  ((MLX5_INDIRECT_ACTION_TYPE_CT << MLX5_INDIRECT_ACTION_TYPE_OFFSET) |        \
   (((owner)&MLX5_INDIRECT_ACT_CT_OWNER_MASK)                                  \
    << MLX5_INDIRECT_ACT_CT_OWNER_SHIFT) |                                     \
   (index))
...
#define MLX5_FLOW_LAYER_TUNNEL                                                 \
  (MLX5_FLOW_LAYER_VXLAN | MLX5_FLOW_LAYER_VXLAN_GPE | MLX5_FLOW_LAYER_GRE |   \
   MLX5_FLOW_LAYER_NVGRE | MLX5_FLOW_LAYER_MPLS | MLX5_FLOW_LAYER_IPIP |       \
   MLX5_FLOW_LAYER_IPV6_ENCAP | MLX5_FLOW_LAYER_GENEVE | MLX5_FLOW_LAYER_GTP | \
...
/* Layer Masks. */
#define MLX5_FLOW_LAYER_L2 (MLX5_FLOW_LAYER_OUTER_L2 | MLX5_FLOW_LAYER_INNER_L2)
...
#define MLX5_FLOW_LAYER_L3 (MLX5_FLOW_LAYER_L3_IPV4 | MLX5_FLOW_LAYER_L3_IPV6)
#define MLX5_FLOW_LAYER_L4 (MLX5_FLOW_LAYER_OUTER_L4 | MLX5_FLOW_LAYER_INNER_L4)
...
#define MLX5_FLOW_FATE_ACTIONS                                                 \
  (MLX5_FLOW_ACTION_DROP | MLX5_FLOW_ACTION_QUEUE | MLX5_FLOW_ACTION_RSS |     \
   MLX5_FLOW_ACTION_JUMP | MLX5_FLOW_ACTION_DEFAULT_MISS |                     \
   MLX5_FLOW_ACTION_METER_WITH_TERMINATED_POLICY)

#define MLX5_FLOW_FATE_ESWITCH_ACTIONS                                         \
  (MLX5_FLOW_ACTION_DROP | MLX5_FLOW_ACTION_PORT_ID | MLX5_FLOW_ACTION_JUMP |  \
   MLX5_FLOW_ACTION_METER_WITH_TERMINATED_POLICY)
...
#define MLX5_FLOW_MODIFY_HDR_ACTIONS                                           \
  (MLX5_FLOW_ACTION_SET_IPV4_SRC | MLX5_FLOW_ACTION_SET_IPV4_DST |             \
   ...
   MLX5_FLOW_ACTION_INC_TCP_SEQ | MLX5_FLOW_ACTION_DEC_TCP_SEQ |               \
   MLX5_FLOW_ACTION_INC_TCP_ACK | MLX5_FLOW_ACTION_DEC_TCP_ACK |               \
   MLX5_FLOW_ACTION_OF_SET_VLAN_VID | MLX5_FLOW_ACTION_SET_TAG |               \
   MLX5_FLOW_ACTION_MARK_EXT | MLX5_FLOW_ACTION_SET_META |                     \
   MLX5_FLOW_ACTION_SET_IPV4_DSCP | MLX5_FLOW_ACTION_SET_IPV6_DSCP |           \
...
#define MLX5_IPV4_LAYER_TYPES                                                  \
  (RTE_ETH_RSS_IPV4 | RTE_ETH_RSS_FRAG_IPV4 | RTE_ETH_RSS_NONFRAG_IPV4_TCP |   \
   RTE_ETH_RSS_NONFRAG_IPV4_UDP | RTE_ETH_RSS_NONFRAG_IPV4_OTHER)
...
#define MLX5_IPV6_LAYER_TYPES                                                  \
  (RTE_ETH_RSS_IPV6 | RTE_ETH_RSS_FRAG_IPV6 | RTE_ETH_RSS_NONFRAG_IPV6_TCP |   \
   RTE_ETH_RSS_NONFRAG_IPV6_UDP | RTE_ETH_RSS_IPV6_EX |                        \
...
#define MLX5_ENCAPSULATION_DECISION_SIZE                                       \
...
#define MLX5_VERBS_MAX_SPEC_SIZE                                               \
  ((2 * (sizeof(struct ibv_flow_spec_eth) +                                    \
    ...
    sizeof(struct ibv_flow_spec_gre) + sizeof(struct ibv_flow_spec_mpls)))
#else
#define MLX5_VERBS_MAX_SPEC_SIZE                                               \
  ((2 * (sizeof(struct ibv_flow_spec_eth) +                                    \
         sizeof(struct ibv_flow_spec_ipv6) +                                   \
...
__extension__ struct mlx5_flow {
...
static inline uint32_t tunnel_id_to_flow_tbl(uint32_t id) {
  return id | (1u << 16);
}

static inline uint32_t tunnel_flow_tbl_to_id(uint32_t flow_tbl) {
...
static inline bool is_tunnel_offload_active(const struct rte_eth_dev *dev) {
...
#define MLX5_RSS_HASH_IPV4_TCP                                                 \
  (MLX5_RSS_HASH_IPV4 | IBV_RX_HASH_SRC_PORT_TCP | IBV_RX_HASH_DST_PORT_TCP)
#define MLX5_RSS_HASH_IPV4_UDP                                                 \
  (MLX5_RSS_HASH_IPV4 | IBV_RX_HASH_SRC_PORT_UDP | IBV_RX_HASH_DST_PORT_UDP)
#define MLX5_RSS_HASH_IPV6 (IBV_RX_HASH_SRC_IPV6 | IBV_RX_HASH_DST_IPV6)
#define MLX5_RSS_HASH_IPV6_TCP                                                 \
  (MLX5_RSS_HASH_IPV6 | IBV_RX_HASH_SRC_PORT_TCP | IBV_RX_HASH_DST_PORT_TCP)
#define MLX5_RSS_HASH_IPV6_UDP                                                 \
  (MLX5_RSS_HASH_IPV6 | IBV_RX_HASH_SRC_PORT_UDP | IBV_RX_HASH_DST_PORT_UDP)
...
#define MLX5_ETHER_TYPE_FROM_HEADER(_s, _m, _itm, _prt)                        \
  do {                                                                         \
...
static const uint64_t mlx5_rss_hash_fields[] = {
    MLX5_RSS_HASH_IPV4, MLX5_RSS_HASH_IPV4_TCP, MLX5_RSS_HASH_IPV4_UDP,
    MLX5_RSS_HASH_IPV6, MLX5_RSS_HASH_IPV6_TCP, MLX5_RSS_HASH_IPV6_UDP,
    MLX5_RSS_HASH_NONE,
};
...
typedef void (*mlx5_flow_destroy_t)(struct rte_eth_dev *dev,
                                    struct rte_flow *flow);
typedef int (*mlx5_flow_query_t)(struct rte_eth_dev *dev, struct rte_flow *flow,
                                 const struct rte_flow_action *actions,
...
typedef int (*mlx5_flow_meter_hierarchy_rule_create_t)(
    struct rte_eth_dev *dev, struct mlx5_flow_meter_info *fm, int32_t src_port,
    const struct rte_flow_item *item, struct rte_flow_error *error);
typedef void (*mlx5_flow_destroy_sub_policy_with_rxq_t)(
    struct rte_eth_dev *dev, struct mlx5_flow_meter_policy *mtr_policy);
typedef uint32_t (*mlx5_flow_mtr_alloc_t)(struct rte_eth_dev *dev);
typedef void (*mlx5_flow_mtr_free_t)(struct rte_eth_dev *dev, uint32_t mtr_idx);
typedef uint32_t (*mlx5_flow_counter_alloc_t)(struct rte_eth_dev *dev);
typedef void (*mlx5_flow_counter_free_t)(struct rte_eth_dev *dev, uint32_t cnt);
typedef int (*mlx5_flow_counter_query_t)(struct rte_eth_dev *dev, uint32_t cnt,
                                         bool clear, uint64_t *pkts,
                                         uint64_t *bytes, void **action);
typedef int (*mlx5_flow_get_aged_flows_t)(struct rte_eth_dev *dev,
...
typedef struct rte_flow_action_handle *(*mlx5_flow_action_create_t)(
    struct rte_eth_dev *dev, const struct rte_flow_indir_action_conf *conf,
    const struct rte_flow_action *action, struct rte_flow_error *error);
typedef int (*mlx5_flow_action_destroy_t)(struct rte_eth_dev *dev,
                                          struct rte_flow_action_handle *action,
                                          struct rte_flow_error *error);
typedef int (*mlx5_flow_action_update_t)(struct rte_eth_dev *dev,
                                         struct rte_flow_action_handle *action,
                                         const void *update,
                                         struct rte_flow_error *error);
typedef int (*mlx5_flow_action_query_t)(
    struct rte_eth_dev *dev, const struct rte_flow_action_handle *action,
    void *data, struct rte_flow_error *error);
typedef int (*mlx5_flow_sync_domain_t)(struct rte_eth_dev *dev,
                                       uint32_t domains, uint32_t flags);
...
typedef void (*mlx5_flow_destroy_policy_rules_t)(
    struct rte_eth_dev *dev, struct mlx5_flow_meter_policy *mtr_policy);
typedef int (*mlx5_flow_create_def_policy_t)(struct rte_eth_dev *dev);
typedef void (*mlx5_flow_destroy_def_policy_t)(struct rte_eth_dev *dev);
typedef int (*mlx5_flow_discover_priorities_t)(struct rte_eth_dev *dev,
                                               const uint16_t *vprio,
                                               int vprio_n);
typedef struct rte_flow_item_flex_handle *(*mlx5_flow_item_create_t)(
    struct rte_eth_dev *dev, const struct rte_flow_item_flex_conf *conf,
    struct rte_flow_error *error);
typedef int (*mlx5_flow_item_release_t)(
    struct rte_eth_dev *dev, const struct rte_flow_item_flex_handle *handle,
    struct rte_flow_error *error);
typedef int (*mlx5_flow_item_update_t)(
    struct rte_eth_dev *dev, const struct rte_flow_item_flex_handle *handle,
    const struct rte_flow_item_flex_conf *conf, struct rte_flow_error *error);
typedef int (*mlx5_flow_info_get_t)(struct rte_eth_dev *dev,
...
typedef int (*mlx5_flow_pattern_template_destroy_t)(
    struct rte_eth_dev *dev, struct rte_flow_pattern_template *template,
    struct rte_flow_error *error);
typedef struct rte_flow_actions_template *(
    *mlx5_flow_actions_template_create_t)(
...
typedef int (*mlx5_flow_actions_template_destroy_t)(
    struct rte_eth_dev *dev, struct rte_flow_actions_template *template,
    struct rte_flow_error *error);
...
typedef int (*mlx5_flow_table_destroy_t)(struct rte_eth_dev *dev,
...
typedef int (*mlx5_flow_async_flow_destroy_t)(
    ...
    struct rte_flow_error *error);
typedef int (*mlx5_flow_pull_t)(struct rte_eth_dev *dev, uint32_t queue,
                                struct rte_flow_op_result res[], uint16_t n_res,
                                struct rte_flow_error *error);
typedef int (*mlx5_flow_push_t)(struct rte_eth_dev *dev, uint32_t queue,
                                struct rte_flow_error *error);

typedef struct rte_flow_action_handle *(
    *mlx5_flow_async_action_handle_create_t)(
    struct rte_eth_dev *dev, uint32_t queue,
...
__extension__ struct flow_grp_info {
  uint64_t external : 1;
  uint64_t transfer : 1;
...
static inline bool tunnel_use_standard_attr_group_translate(
    const struct rte_eth_dev *dev, const struct rte_flow_attr *attr,
    const struct mlx5_flow_tunnel *tunnel,
  ...
  if (!is_tunnel_offload_active(dev))
     ...
     * method
     */
    verdict = !attr->group && is_flow_tunnel_steer_rule(tof_rule_type);
  } else {
    /*
 ...
 */
static inline struct mlx5_aso_mtr *mlx5_aso_meter_by_idx(struct mlx5_priv *priv,
                                                         uint32_t idx) {
...
static inline uint16_t mlx5_translate_tunnel_etypes(uint64_t pattern_flags) {
...
int flow_hw_q_flow_flush(struct rte_eth_dev *dev, struct rte_flow_error *error);
...
int mlx5_flow_validate_item_mpls(struct rte_eth_dev *dev,
                                 const struct rte_flow_item *item,
                                 uint64_t item_flags, uint64_t prev_layer,
                                 struct rte_flow_error *error);
...
flow_dv_mreg_clone_cb(void *tool_ctx, struct mlx5_list_entry *entry, void *ctx);
...
void flow_dv_encap_decap_remove_cb(void *tool_ctx,
                                   struct mlx5_list_entry *entry);
struct mlx5_list_entry *
flow_dv_encap_decap_clone_cb(void *tool_ctx, struct mlx5_list_entry *entry,
                             void *cb_ctx);
...
struct mlx5_list_entry *
flow_dv_push_vlan_clone_cb(void *tool_ctx, struct mlx5_list_entry *entry,
                           void *cb_ctx);
...
void flow_dv_dest_array_remove_cb(void *tool_ctx,
                                  struct mlx5_list_entry *entry);
struct mlx5_list_entry *
flow_dv_dest_array_clone_cb(void *tool_ctx, struct mlx5_list_entry *entry,
                            void *cb_ctx);
...
int flow_hw_grp_match_cb(void *tool_ctx, struct mlx5_list_entry *entry,
                         void *cb_ctx);
