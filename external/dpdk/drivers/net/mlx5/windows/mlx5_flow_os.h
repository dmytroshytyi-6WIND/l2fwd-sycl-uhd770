 ...
 */
static inline bool mlx5_flow_os_item_supported(int item) {
  switch (item) {
 ...
 */
static inline bool mlx5_flow_os_action_supported(int action) {
  switch (action) {
...
int mlx5_flow_os_validate_flow_attributes(
    struct rte_eth_dev *dev, const struct rte_flow_attr *attributes,
    bool external, struct rte_flow_error *error);
int mlx5_flow_os_create_flow_matcher(void *ctx, void *attr, void *table,
                                     void **matcher);
