 ...
 */
static inline enum mlx5_flow_drv_type mlx5_flow_os_get_type(void) {
 ...
 */
static inline bool mlx5_flow_os_item_supported(int item __rte_unused) {
  return true;
}
 ...
 */
static inline bool mlx5_flow_os_action_supported(int action __rte_unused) {
  return true;
}
 ...
 */
static inline int mlx5_flow_os_create_flow(void *matcher, void *match_value,
 ...
 */
static inline int mlx5_flow_os_destroy_flow(void *drv_flow_ptr) {
 ...
 *   0 on success, or -1 on failure and errno is set.
 */
static inline int mlx5_flow_os_create_flow_tbl(void *domain, uint32_t table_id,
                                               void **table) {
 ...
 *   0 on success, or the value of errno on failure.
 */
static inline int mlx5_flow_os_destroy_flow_tbl(void *table) {
 ...
 *   0 on success, or -1 on failure and errno is set.
 */
static inline int mlx5_flow_os_create_flow_matcher(void *ctx, void *attr,
                                                   void *table,
                                                   void **matcher) {
 ...
 *   0 on success, or the value of errno on failure.
 */
static inline int mlx5_flow_os_destroy_flow_matcher(void *matcher) {
...
mlx5_flow_os_create_flow_action_packet_reformat(void *ctx, void *domain,
  ...
  *action = mlx5_glue->dv_create_flow_action_packet_reformat(
      ctx, res->reformat_type, res->ft_type, domain, res->flags, res->size,
 ...
 *   0 on success, or -1 on failure and errno is set.
 */
static inline int mlx5_flow_os_create_flow_action_modify_header(
    void *ctx, void *domain, void *resource, uint32_t actions_len,
    void **action) {
  struct mlx5_flow_dv_modify_hdr_resource *res =
      (struct mlx5_flow_dv_modify_hdr_resource *)resource;

  *action = mlx5_glue->dv_create_flow_action_modify_header(
      ctx, res->ft_type, domain,
      res->root ? MLX5DV_DR_ACTION_FLAGS_ROOT_LEVEL : 0, actions_len,
      (uint64_t *)res->actions);
  return (*action) ? 0 : -1;
}
 ...
 *   0 on success, or -1 on failure and errno is set.
 */
static inline int mlx5_flow_os_create_flow_action_dest_flow_tbl(void *tbl_obj,
                                                                void **action) {
 ...
 *   0 on success, or -1 on failure and errno is set.
 */
static inline int mlx5_flow_os_create_flow_action_dest_port(void *domain,
                                                            uint32_t port_id,
                                                            void **action) {
  /*
 ...
 *   0 on success, or -1 on failure and errno is set.
 */
static inline int mlx5_flow_os_create_flow_action_push_vlan(void *domain,
                                                            rte_be32_t vlan_tag,
                                                            void **action) {
 ...
 *   0 on success, or -1 on failure and errno is set.
 */
static inline int mlx5_flow_os_create_flow_action_count(void *cnt_obj,
                                                        uint16_t offset,
                                                        void **action) {
 ...
 *   0 on success, or -1 on failure and errno is set.
 */
static inline int mlx5_flow_os_create_flow_action_tag(uint32_t tag,
                                                      void **action) {
 ...
 *   0 on success, or -1 on failure and errno is set.
 */
static inline int mlx5_flow_os_create_flow_action_drop(void **action) {
 ...
 *   0 on success, or -1 on failure and errno is set.
 */
static inline int mlx5_flow_os_create_flow_action_default_miss(void **action) {
 ...
 *   0 on success, or -1 on failure and errno is set.
 */
static inline int mlx5_os_flow_dr_create_flow_action_sampler(
    struct mlx5dv_dr_flow_sampler_attr *attr, void **action) {
 ...
 *   0 on success, or -1 on failure and errno is set.
 */
static inline int mlx5_os_flow_dr_create_flow_action_dest_array(
    void *domain, size_t num_dest, struct mlx5dv_dr_action_dest_attr *dests[],
    void **action) {
  *action =
      mlx5_glue->dr_create_flow_action_dest_array(domain, num_dest, dests);
  return (*action) ? 0 : -1;
}
 ...
 *   0 on success, or the value of errno on failure.
 */
static inline int mlx5_flow_os_destroy_flow_action(void *action) {
 ...
 *    The new priority.
 */
static inline uint32_t mlx5_os_flow_adjust_priority(struct rte_eth_dev *dev,
                                                    int32_t priority,
                                                    uint32_t subpriority) {
  return mlx5_flow_adjust_priority(dev, priority, subpriority);
}

static inline int mlx5_os_flow_dr_sync_domain(void *domain, uint32_t flags) {
