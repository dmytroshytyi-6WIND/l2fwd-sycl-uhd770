...
#define MLX5_INLINE_HSIZE_L2                                                   \
  (sizeof(struct rte_ether_hdr) + sizeof(struct rte_vlan_hdr))
#define MLX5_INLINE_HSIZE_L3                                                   \
  (MLX5_INLINE_HSIZE_L2 + sizeof(struct rte_ipv6_hdr))
#define MLX5_INLINE_HSIZE_L4 (MLX5_INLINE_HSIZE_L3 + sizeof(struct rte_tcp_hdr))
#define MLX5_INLINE_HSIZE_INNER_L2                                             \
  (MLX5_INLINE_HSIZE_L3 + sizeof(struct rte_udp_hdr) +                         \
   sizeof(struct rte_vxlan_hdr) + sizeof(struct rte_ether_hdr) +               \
   sizeof(struct rte_vlan_hdr))
#define MLX5_INLINE_HSIZE_INNER_L3                                             \
  (MLX5_INLINE_HSIZE_INNER_L2 + sizeof(struct rte_ipv6_hdr))
#define MLX5_INLINE_HSIZE_INNER_L4                                             \
  (MLX5_INLINE_HSIZE_INNER_L3 + sizeof(struct rte_tcp_hdr))
