...
mlx5dr_context_open(void *ibv_ctx, struct mlx5dr_context_attr *attr) {
  (void)ibv_ctx;
  (void)attr;
  return NULL;
}
 ...
 */
__rte_weak int mlx5dr_context_close(struct mlx5dr_context *ctx) {
  (void)ctx;
  return 0;
}
 ...
 * @return zero on success non zero otherwise.
 */
__rte_weak int mlx5dr_match_template_destroy(struct mlx5dr_match_template *mt) {
  (void)mt;
  return 0;
}
 ...
 * @return zero on successful enqueue non zero otherwise.
 */
__rte_weak int mlx5dr_rule_destroy(struct mlx5dr_rule *rule __rte_unused,
                                   struct mlx5dr_rule_attr *attr __rte_unused) {
  return 0;
}
...
mlx5dr_action_create_counter(struct mlx5dr_context *ctx,
                             struct mlx5dr_devx_obj *obj, uint32_t flags);
 ...
 * @return pointer to mlx5dr_action on success NULL otherwise.
 */
__rte_weak struct mlx5dr_action *mlx5dr_action_create_reformat(
    struct mlx5dr_context *ctx __rte_unused,
    enum mlx5dr_action_reformat_type reformat_type __rte_unused,
    size_t data_sz __rte_unused, void *inline_data __rte_unused,
    uint32_t log_bulk_size __rte_unused, uint32_t flags __rte_unused) {
  return NULL;
}
 ...
 * @return zero on success non zero otherwise.
 */
__rte_weak int mlx5dr_send_queue_action(struct mlx5dr_context *ctx __rte_unused,
                                        uint16_t queue_id __rte_unused,
