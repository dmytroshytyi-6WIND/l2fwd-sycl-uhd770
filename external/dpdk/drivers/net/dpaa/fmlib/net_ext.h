...
#define ioc_net_hf_l2tpv_2_all_fields ((ioc_net_hf_l2tpv_2_type_bit << 13) - 1)
...
#define IOC_NET_HF_VLAN_TCI                                                    \
  (IOC_NET_HF_VLAN_VPRI | IOC_NET_HF_VLAN_CFI | IOC_NET_HF_VLAN_VID)
