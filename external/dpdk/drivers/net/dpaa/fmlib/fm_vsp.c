...
uint32_t fm_vsp_config_buffer_prefix_content(
    t_handle h_fm_vsp, t_fm_buffer_prefix_content *p_fm_buffer_prefix_content) {
  t_device *p_dev = NULL;
  t_device *p_vsp_dev = (t_device *)h_fm_vsp;
  ...
  memcpy(&params.fm_buffer_prefix_content, p_fm_buffer_prefix_content,
         sizeof(*p_fm_buffer_prefix_content));
