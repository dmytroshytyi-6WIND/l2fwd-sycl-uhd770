...
#define FM_FD_TX_STATUS_ERR_MASK                                               \
  (FM_FD_ERR_UNSUPPORTED_FORMAT | FM_FD_ERR_LENGTH |                           \
   FM_FD_ERR_DMA) /**< TX Error FD bits */

#define FM_FD_RX_STATUS_ERR_MASK                                               \
  (FM_FD_ERR_UNSUPPORTED_FORMAT | FM_FD_ERR_LENGTH | FM_FD_ERR_DMA |           \
   FM_FD_ERR_IPR | FM_FD_ERR_IPR_TO | FM_FD_ERR_IPR_NCSP |                     \
   FM_FD_ERR_PHYSICAL | FM_FD_ERR_SIZE | FM_FD_ERR_CLS_DISCARD |               \
   FM_FD_ERR_COLOR_RED | FM_FD_ERR_COLOR_YELLOW | FM_FD_ERR_ILL_PLCR |         \
   FM_FD_ERR_PLCR_FRAME_LEN | FM_FD_ERR_EXTRACTION | FM_FD_ERR_NO_SCHEME |     \
   FM_FD_ERR_KEYSIZE_OVERFLOW | FM_FD_ERR_PRS_TIMEOUT |                        \
   FM_FD_ERR_PRS_ILL_INSTRUCT | FM_FD_ERR_PRS_HDR_ERR |                        \
 ...
 */
#define FM_MAX_NUM_OF_VALID_PORTS                                              \
  (FM_MAX_NUM_OF_OH_PORTS + FM_MAX_NUM_OF_1G_RX_PORTS +                        \
   FM_MAX_NUM_OF_10G_RX_PORTS + FM_MAX_NUM_OF_1G_TX_PORTS +                    \
