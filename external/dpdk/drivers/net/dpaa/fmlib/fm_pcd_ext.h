...
#define FM_PCD_IOC_KG_SET_DFLT_VALUE                                           \
  _IOW(FM_IOC_TYPE_BASE, FM_PCD_IOC_NUM(6), ioc_fm_pcd_kg_dflt_value_params_t)
 ...
 */
typedef uint8_t ioc_fm_pcd_kg_key_order_t[IOC_FM_PCD_KG_MAX_EXTRACTS_PER_KEY];
...
typedef struct ioc_fm_pcd_kg_key_extract_and_hash_params_t {
   ...
   * following array
   */
  ioc_fm_pcd_extract_entry_t extract_array[IOC_FM_PCD_KG_MAX_EXTRACTS_PER_KEY];
...
#define FM_PCD_IOC_MATCH_TABLE_GET_KEY_STAT                                    \
  _IOWR(FM_IOC_TYPE_BASE, FM_PCD_IOC_NUM(12), ioc_fm_pcd_cc_tbl_get_stats_t)
...
#define FM_PCD_IOC_MATCH_TABLE_GET_MISS_STAT                                   \
  _IOWR(FM_IOC_TYPE_BASE, FM_PCD_IOC_NUM(13), ioc_fm_pcd_cc_tbl_get_stats_t)
...
#define FM_PCD_IOC_HASH_TABLE_GET_MISS_STAT                                    \
  _IOWR(FM_IOC_TYPE_BASE, FM_PCD_IOC_NUM(14), ioc_fm_pcd_cc_tbl_get_stats_t)
...
#define FM_PCD_IOC_NET_ENV_CHARACTERISTICS_SET                                 \
  _IOWR(FM_IOC_TYPE_BASE, FM_PCD_IOC_NUM(20), ioc_fm_pcd_net_env_params_t)
...
#define FM_PCD_IOC_KG_SCHEME_SET                                               \
  _IOWR(FM_IOC_TYPE_BASE, FM_PCD_IOC_NUM(24), ioc_fm_pcd_kg_scheme_params_t)
...
#define FM_PCD_IOC_HASH_TABLE_SET                                              \
  _IOWR(FM_IOC_TYPE_BASE, FM_PCD_IOC_NUM(37), ioc_fm_pcd_hash_table_params_t)
...
#define FM_PCD_IOC_PLCR_PROFILE_SET                                            \
  _IOWR(FM_IOC_TYPE_BASE, FM_PCD_IOC_NUM(41), ioc_fm_pcd_plcr_profile_params_t)
...
#define FM_PCD_IOC_MANIP_NODE_SET                                              \
  _IOWR(FM_IOC_TYPE_BASE, FM_PCD_IOC_NUM(43), ioc_fm_pcd_manip_params_t)
...
#define FM_PCD_IOC_MANIP_GET_STATS                                             \
  _IOWR(FM_IOC_TYPE_BASE, FM_PCD_IOC_NUM(50), ioc_fm_pcd_manip_get_stats_t)
...
#define FM_PCD_IOC_FRM_REPLIC_MEMBER_REMOVE                                    \
  _IOWR(FM_IOC_TYPE_BASE, FM_PCD_IOC_NUM(49), ioc_fm_pcd_frm_replic_member_t)
...
#define FM_SW_PRS_MAX_IMAGE_SIZE                                               \
  (FM_PCD_SW_PRS_SIZE /*- FM_PCD_PRS_SW_OFFSET -FM_PCD_PRS_SW_TAIL_SIZE*/      \
 ...
 */
uint32_t
fm_pcd_config_plcr_num_of_shared_profiles(t_handle h_fm_pcd,
 ...
 *		  (i.e. guestId != NCSW_PRIMARY_ID)
 */
uint32_t fm_pcd_kg_set_dflt_value(t_handle h_fm_pcd, uint8_t value_id,
                                  uint32_t value);
 ...
 *		(i.e. guestId != NCSW_PRIMARY_ID)
 */
uint32_t fm_pcd_modify_counter(t_handle h_fm_pcd, ioc_fm_pcd_counters counter,
                               uint32_t value);
 ...
 * @Cautions	  Allowed only following fm_pcd_init().
 */
t_handle fm_pcd_net_env_characteristics_set(
    t_handle h_fm_pcd, ioc_fm_pcd_net_env_params_t *p_netenv_params);
 ...
 * @Cautions	  Allowed only following fm_pcd_init() & fm_pcd_kg_scheme_set().
 */
uint32_t fm_pcd_kg_scheme_set_counter(t_handle h_scheme, uint32_t value);
 ...
 */
uint32_t
fm_pcd_plcr_profile_get_counter(t_handle h_profile,
 ...
 */
uint32_t
fm_pcd_plcr_profile_set_counter(t_handle h_profile,
                                ioc_fm_pcd_plcr_profile_counters counter,
                                uint32_t value);
 ...
 */
uint32_t fm_pcd_cc_root_modify_next_engine(
    t_handle h_cc_tree, uint8_t grp_id, uint8_t index,
 ...
 *
 */
uint32_t fm_pcd_match_table_modify_miss_next_engine(
    t_handle h_cc_node,
 ...
 */
uint32_t fm_pcd_match_table_remove_key(t_handle h_cc_node, uint16_t key_index);
 ...
 *		  this node and the nodes that lead to it.
 */
uint32_t fm_pcd_match_table_add_key(t_handle h_cc_node, uint16_t key_index,
                                    uint8_t key_size,
 ...
 *
 */
uint32_t fm_pcd_match_table_modify_next_engine(
    t_handle h_cc_node, uint16_t key_index,
    ioc_fm_pcd_cc_next_engine_params_t *p_fm_pcd_cc_next_engine);
 ...
 *		different from the currently changed table.
 */
uint32_t fm_pcd_match_table_modify_key_and_next_engine(
    t_handle h_cc_node, uint16_t key_index, uint8_t key_size,
    ioc_fm_pcd_cc_key_params_t *p_key_params);
 ...
 *		  this node and the nodes that lead to it.
 */
uint32_t fm_pcd_match_table_modify_key(t_handle h_cc_node, uint16_t key_index,
                                       uint8_t key_size, uint8_t *p_key,
                                       uint8_t *p_mask);
 ...
 *		  different from the currently changed table.
 */
uint32_t fm_pcd_match_table_find_nmodify_next_engine(
    t_handle h_cc_node, uint8_t key_size, uint8_t *p_key, uint8_t *p_mask,
    ioc_fm_pcd_cc_next_engine_params_t *p_fm_pcd_cc_next_engine);
 ...
 *		  different from the currently changed table.
 */
uint32_t fm_pcd_match_table_find_nmodify_key_and_next_engine(
    t_handle h_cc_node, uint8_t key_size, uint8_t *p_key, uint8_t *p_mask,
    ioc_fm_pcd_cc_key_params_t *p_key_params);
 ...
 * @Cautions	  Allowed only following fm_pcd_match_table_set().
 */
uint32_t fm_pcd_match_table_get_key_statistics(
    t_handle h_cc_node, uint16_t key_index,
 ...
 * @Cautions	  Allowed only following fm_pcd_match_table_set().
 */
uint32_t fm_pcd_match_table_get_miss_statistics(
    t_handle h_cc_node, ioc_fm_pcd_cc_key_statistics_t *p_miss_statistics);
 ...
 * @Cautions	  Allowed only following fm_pcd_match_table_set().
 */
uint32_t fm_pcd_match_table_find_nget_key_statistics(
    t_handle h_cc_node, uint8_t key_size, uint8_t *p_key, uint8_t *p_mask,
    ioc_fm_pcd_cc_key_statistics_t *p_key_statistics);
 ...
 * @Cautions	  Allowed only following fm_pcd_init().
 */
uint32_t fm_pcd_match_table_get_next_engine(
    t_handle h_cc_node, uint16_t key_index,
    ioc_fm_pcd_cc_next_engine_params_t *p_fm_pcd_cc_next_engine_params);
...
uint32_t fm_pcd_match_table_get_indexed_hash_bucket(
    t_handle h_cc_node, uint8_t kg_key_size, uint8_t *p_kg_key,
    uint8_t kg_hash_shift, t_handle *p_cc_node_bucket_handle,
    uint8_t *p_bucket_index, uint16_t *p_last_index);
 ...
 * @Cautions	  Allowed only following fm_pcd_hash_table_set().
 */
uint32_t fm_pcd_hash_table_add_key(t_handle h_hash_tbl, uint8_t key_size,
                                   ioc_fm_pcd_cc_key_params_t *p_key_params);
 ...
 * @Cautions	  Allowed only following fm_pcd_hash_table_set().
 */
uint32_t fm_pcd_hash_table_remove_key(t_handle h_hash_tbl, uint8_t key_size,
                                      uint8_t *p_key);
 ...
 *		  different from the currently changed table.
 */
uint32_t fm_pcd_hash_table_modify_next_engine(
    t_handle h_hash_tbl, uint8_t key_size, uint8_t *p_key,
    ioc_fm_pcd_cc_next_engine_params_t *p_fm_pcd_cc_next_engine);
 ...
 *		  different from the currently changed table.
 */
uint32_t fm_pcd_hash_table_modify_miss_next_engine(
    t_handle h_hash_tbl,
    ioc_fm_pcd_cc_next_engine_params_t *p_fm_pcd_cc_next_engine);
 ...
 * @Cautions	  Allowed only following fm_pcd_hash_table_set().
 */
uint32_t fm_pcd_hash_table_get_miss_next_engine(
    t_handle h_hash_tbl,
    ioc_fm_pcd_cc_next_engine_params_t *p_fm_pcd_cc_next_engine_params);
 ...
 * @Cautions	  Allowed only following fm_pcd_hash_table_set().
 */
uint32_t fm_pcd_hash_table_get_miss_statistics(
    t_handle h_hash_tbl, ioc_fm_pcd_cc_key_statistics_t *p_miss_statistics);
 ...
 */
t_handle
fm_pcd_manip_node_set(t_handle h_fm_pcd,
 ...
 */
uint32_t
fm_pcd_manip_get_statistics(t_handle h_manip_node,
 ...
 * @Cautions	  Allowed only following fm_pcd_init().
 */
t_handle fm_pcd_frm_replic_set_group(
    t_handle h_fm_pcd,
 ...
 *		  group.
 */
uint32_t fm_pcd_frm_replic_add_member(
    t_handle h_frm_replic_group, uint16_t member_index,
