...
#define DPAA_PKT_TYPE_IPV4_CSUM_ERR (DPAA_PKT_IP_CSUM_ERR | DPAA_PKT_TYPE_IPV4)
#define DPAA_PKT_TYPE_IPV6_CSUM_ERR (DPAA_PKT_IP_CSUM_ERR | DPAA_PKT_TYPE_IPV6)
...
#define GET_ANNOTATIONS(_buf) (struct annotations_t *)(_buf)
