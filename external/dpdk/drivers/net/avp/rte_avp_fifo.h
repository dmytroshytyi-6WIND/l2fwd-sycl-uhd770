 ...
 */
static inline void avp_fifo_init(struct rte_avp_fifo *fifo, unsigned int size) {
 ...
 */
static inline unsigned avp_fifo_put(struct rte_avp_fifo *fifo, void **data,
                                    unsigned int num) {
  unsigned int i = 0;
 ...
 */
static inline unsigned int avp_fifo_get(struct rte_avp_fifo *fifo, void **data,
                                        unsigned int num) {
  unsigned int i = 0;
 ...
 */
static inline unsigned int avp_fifo_count(struct rte_avp_fifo *fifo) {
 ...
 */
static inline unsigned int avp_fifo_free_count(struct rte_avp_fifo *fifo) {
