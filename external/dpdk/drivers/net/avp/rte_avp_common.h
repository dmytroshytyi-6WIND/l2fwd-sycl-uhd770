...
#define RTE_AVP_MIGRATION_ATTACHED                                             \
  2                               /**< Device reattached during migration      \
                                   */
...
#define RTE_AVP_CURRENT_HOST_VERSION                                           \
  RTE_AVP_MAKE_VERSION(RTE_AVP_RELEASE_VERSION_1, RTE_AVP_MAJOR_VERSION_0,     \
...
#define RTE_AVP_CURRENT_GUEST_VERSION                                          \
  RTE_AVP_MAKE_VERSION(RTE_AVP_RELEASE_VERSION_1, RTE_AVP_MAJOR_VERSION_2,     \
