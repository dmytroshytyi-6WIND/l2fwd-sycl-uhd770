...
#define ENETFEC_RD_START(X)                                                    \
  (((X) == 1) ? ENETFEC_RD_START_1                                             \
              : (((X) == 2) ? ENETFEC_RD_START_2 : ENETFEC_RD_START_0))
#define ENETFEC_TD_START(X)                                                    \
  (((X) == 1) ? ENETFEC_TD_START_1                                             \
              : (((X) == 2) ? ENETFEC_TD_START_2 : ENETFEC_TD_START_0))
#define ENETFEC_MRB_SIZE(X)                                                    \
  (((X) == 1) ? ENETFEC_MRB_SIZE_1                                             \
              : (((X) == 2) ? ENETFEC_MRB_SIZE_2 : ENETFEC_MRB_SIZE_0))
