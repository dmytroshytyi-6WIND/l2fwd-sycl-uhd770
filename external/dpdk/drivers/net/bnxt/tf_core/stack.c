...
/* Initialize stack
 */
int stack_init(int num_entries, uint32_t *items, struct stack *st) {
 ...
 */
uint32_t *stack_items(struct stack *st) { return st->items; }

/* Return the size of the stack
 */
int32_t stack_size(struct stack *st) { return st->top + 1; }

/* Check if the stack is empty
 */
bool stack_is_empty(struct stack *st) { return st->top == STACK_EMPTY; }

/* Check if the stack is full
 */
bool stack_is_full(struct stack *st) { return st->top == st->max - 1; }
