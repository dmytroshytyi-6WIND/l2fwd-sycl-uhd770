...
struct tf_rm_element_cfg tf_tbl_p4[TF_DIR_MAX][TF_TBL_TYPE_MAX] = {
    [TF_DIR_RX][TF_TBL_TYPE_FULL_ACT_RECORD] =
        {TF_RM_ELEM_CFG_HCAPI_BA, CFA_RESOURCE_TYPE_P4_FULL_ACTION, 0, 0},
    [TF_DIR_RX][TF_TBL_TYPE_MCAST_GROUPS] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                             CFA_RESOURCE_TYPE_P4_MCG, 0, 0},
    [TF_DIR_RX][TF_TBL_TYPE_ACT_ENCAP_8B] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                             CFA_RESOURCE_TYPE_P4_ENCAP_8B, 0,
                                             0},
    [TF_DIR_RX][TF_TBL_TYPE_ACT_ENCAP_16B] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                              CFA_RESOURCE_TYPE_P4_ENCAP_16B, 0,
                                              0},
    [TF_DIR_RX][TF_TBL_TYPE_ACT_ENCAP_64B] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                              CFA_RESOURCE_TYPE_P4_ENCAP_64B, 0,
                                              0},
    [TF_DIR_RX][TF_TBL_TYPE_ACT_SP_SMAC] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                            CFA_RESOURCE_TYPE_P4_SP_MAC, 0, 0},
    [TF_DIR_RX][TF_TBL_TYPE_ACT_SP_SMAC_IPV4] =
        {TF_RM_ELEM_CFG_HCAPI_BA, CFA_RESOURCE_TYPE_P4_SP_MAC_IPV4, 0, 0},
    [TF_DIR_RX][TF_TBL_TYPE_ACT_SP_SMAC_IPV6] =
        {TF_RM_ELEM_CFG_HCAPI_BA, CFA_RESOURCE_TYPE_P4_SP_MAC_IPV6, 0, 0},
    [TF_DIR_RX][TF_TBL_TYPE_ACT_STATS_64] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                             CFA_RESOURCE_TYPE_P4_COUNTER_64B,
                                             0, 0},
    [TF_DIR_RX][TF_TBL_TYPE_ACT_MODIFY_IPV4] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                                CFA_RESOURCE_TYPE_P4_NAT_IPV4,
                                                0, 0},
    [TF_DIR_RX][TF_TBL_TYPE_METER_PROF] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                           CFA_RESOURCE_TYPE_P4_METER_PROF, 0,
                                           0},
    [TF_DIR_RX][TF_TBL_TYPE_METER_INST] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                           CFA_RESOURCE_TYPE_P4_METER, 0, 0},
    [TF_DIR_RX][TF_TBL_TYPE_MIRROR_CONFIG] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                              CFA_RESOURCE_TYPE_P4_MIRROR, 0,
                                              0},
    [TF_DIR_TX][TF_TBL_TYPE_FULL_ACT_RECORD] =
        {TF_RM_ELEM_CFG_HCAPI_BA, CFA_RESOURCE_TYPE_P4_FULL_ACTION, 0, 0},
    [TF_DIR_TX][TF_TBL_TYPE_MCAST_GROUPS] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                             CFA_RESOURCE_TYPE_P4_MCG, 0, 0},
    [TF_DIR_TX][TF_TBL_TYPE_ACT_ENCAP_8B] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                             CFA_RESOURCE_TYPE_P4_ENCAP_8B, 0,
                                             0},
    [TF_DIR_TX][TF_TBL_TYPE_ACT_ENCAP_16B] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                              CFA_RESOURCE_TYPE_P4_ENCAP_16B, 0,
                                              0},
    [TF_DIR_TX][TF_TBL_TYPE_ACT_ENCAP_64B] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                              CFA_RESOURCE_TYPE_P4_ENCAP_64B, 0,
                                              0},
    [TF_DIR_TX][TF_TBL_TYPE_ACT_SP_SMAC] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                            CFA_RESOURCE_TYPE_P4_SP_MAC, 0, 0},
    [TF_DIR_TX][TF_TBL_TYPE_ACT_SP_SMAC_IPV4] =
        {TF_RM_ELEM_CFG_HCAPI_BA, CFA_RESOURCE_TYPE_P4_SP_MAC_IPV4, 0, 0},
    [TF_DIR_TX][TF_TBL_TYPE_ACT_SP_SMAC_IPV6] =
        {TF_RM_ELEM_CFG_HCAPI_BA, CFA_RESOURCE_TYPE_P4_SP_MAC_IPV6, 0, 0},
    [TF_DIR_TX][TF_TBL_TYPE_ACT_STATS_64] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                             CFA_RESOURCE_TYPE_P4_COUNTER_64B,
                                             0, 0},
    [TF_DIR_TX][TF_TBL_TYPE_ACT_MODIFY_IPV4] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                                CFA_RESOURCE_TYPE_P4_NAT_IPV4,
                                                0, 0},
    [TF_DIR_TX][TF_TBL_TYPE_METER_PROF] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                           CFA_RESOURCE_TYPE_P4_METER_PROF, 0,
                                           0},
    [TF_DIR_TX][TF_TBL_TYPE_METER_INST] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                           CFA_RESOURCE_TYPE_P4_METER, 0, 0},
    [TF_DIR_TX][TF_TBL_TYPE_MIRROR_CONFIG] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                              CFA_RESOURCE_TYPE_P4_MIRROR, 0,
                                              0},
};
 ...
 *   - (-EINVAL) on failure.
 */
static int tf_dev_p4_get_max_types(struct tf *tfp, uint16_t *max_types) {
 ...
 *   - (-EINVAL) on failure.
 */
static int tf_dev_p4_get_resource_str(struct tf *tfp __rte_unused,
 ...
 *   - (-EINVAL) on failure.
 */
static int tf_dev_p4_get_tcam_slice_info(struct tf *tfp,
...
static int tf_dev_p4_map_parif(struct tf *tfp __rte_unused,
                               uint16_t parif_bitmask, uint16_t pf,
 ...
 *   - (-EINVAL) on failure.
 */
static int tf_dev_p4_get_shared_tbl_increment(
    struct tf *tfp __rte_unused,
    struct tf_get_shared_tbl_increment_parms *parms) {
  parms->increment_cnt = 1;
  return 0;
}
static int tf_dev_p4_get_mailbox(void) { return TF_KONG_MB; }
 ...
 *   - (-EINVAL) on failure.
 */
static int tf_dev_p4_map_hcapi_caps(uint64_t hcapi_caps, uint32_t *ident_caps,
