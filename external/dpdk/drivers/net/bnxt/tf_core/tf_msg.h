 ...
 *   0 on Success else internal Truflow error
 */
int tf_msg_session_attach(struct tf *tfp, char *ctrl_channel_name,
 ...
 *  0 on Success else internal Truflow error
 */
int tf_msg_set_if_tbl_entry(struct tf *tfp, struct tf_if_tbl_set_parms *params);
 ...
 *  0 on Success else internal Truflow error
 */
int tf_msg_get_if_tbl_entry(struct tf *tfp, struct tf_if_tbl_get_parms *params);
