 ...
 */
int tf_dev_bind(struct tf *tfp, enum tf_device_type type, bool shadow_copy,
                struct tf_session_resources *resources, uint16_t wc_num_slices,
...
struct tf_dev_ops {
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_get_max_types)(struct tf *tfp, uint16_t *max_types);
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_get_resource_str)(struct tf *tfp, uint16_t resource_id,
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_get_tcam_slice_info)(struct tf *tfp, enum tf_tcam_tbl_type type,
                                    uint16_t key_sz,
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_alloc_ident)(struct tf *tfp, struct tf_ident_alloc_parms *parms);
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_free_ident)(struct tf *tfp, struct tf_ident_free_parms *parms);
   ...
   */
  bool (*tf_dev_is_sram_managed)(struct tf *tfp, enum tf_tbl_type tbl_type);
  ...
  int (*tf_dev_get_tbl_info)(struct tf *tfp, void *tbl_db,
                             enum tf_tbl_type type, uint16_t *base,
                             uint16_t *shift);
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_alloc_tbl)(struct tf *tfp, struct tf_tbl_alloc_parms *parms);
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_alloc_ext_tbl)(struct tf *tfp, struct tf_tbl_alloc_parms *parms);
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_free_tbl)(struct tf *tfp, struct tf_tbl_free_parms *parms);
  /**
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_free_sram_tbl)(struct tf *tfp, struct tf_tbl_free_parms *parms);
  /**
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_free_ext_tbl)(struct tf *tfp, struct tf_tbl_free_parms *parms);
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_set_tbl)(struct tf *tfp, struct tf_tbl_set_parms *parms);
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_set_ext_tbl)(struct tf *tfp, struct tf_tbl_set_parms *parms);
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_set_sram_tbl)(struct tf *tfp, struct tf_tbl_set_parms *parms);
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_get_tbl)(struct tf *tfp, struct tf_tbl_get_parms *parms);
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_get_sram_tbl)(struct tf *tfp, struct tf_tbl_get_parms *parms);
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_get_shared_tbl_increment)(
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_alloc_tcam)(struct tf *tfp, struct tf_tcam_alloc_parms *parms);
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_free_tcam)(struct tf *tfp, struct tf_tcam_free_parms *parms);
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_alloc_search_tcam)(struct tf *tfp,
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_set_tcam)(struct tf *tfp, struct tf_tcam_set_parms *parms);
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_get_tcam)(struct tf *tfp, struct tf_tcam_get_parms *parms);
   ...
   *    -EINVAL - Error
   */
  int (*tf_dev_map_parif)(struct tf *tfp, uint16_t parif_bitmask, uint16_t pf,
                          uint8_t *data, uint8_t *mask, uint16_t sz_in_bytes);
  /**
   * Map EEM table scope
   *
   * [in] tfp
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_set_if_tbl)(struct tf *tfp, struct tf_if_tbl_set_parms *parms);
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_get_if_tbl)(struct tf *tfp, struct tf_if_tbl_get_parms *parms);
   ...
   *   Hashes
   */
  uint64_t (*tf_dev_cfa_key_hash)(uint64_t *key_data, uint16_t bitlen);
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_map_hcapi_caps)(uint64_t hcapi_caps, uint32_t *ident_caps,
                               uint32_t *tcam_caps, uint32_t *tbl_caps,
                               uint32_t *em_caps);
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_get_sram_resources)(void *query, uint32_t *sram_bank_caps,
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_set_sram_policy)(enum tf_dir dir, enum tf_sram_bank_id *bank_id);
   ...
   *   - (-EINVAL) on failure.
   */
  int (*tf_dev_get_sram_policy)(enum tf_dir dir, enum tf_sram_bank_id *bank_id);
};
 ...
 */
extern const struct tf_hcapi_resource_map
    tf_hcapi_res_map_p4[CFA_RESOURCE_TYPE_P4_LAST + 1];
extern const struct tf_hcapi_resource_map
    tf_hcapi_res_map_p58[CFA_RESOURCE_TYPE_P58_LAST + 1];
