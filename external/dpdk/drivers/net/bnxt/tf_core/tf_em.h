 ...
 *   -EINVAL - Parameter error
 */
int tf_em_move_int_entry(struct tf *tfp, struct tf_move_em_entry_parms *parms);
 ...
 *   - (-EINVAL) on failure.
 */
int tf_tbl_ext_set(struct tf *tfp, struct tf_tbl_set_parms *parms);

int tf_em_ext_system_bind(struct tf *tfp, struct tf_em_cfg_parms *parms);
