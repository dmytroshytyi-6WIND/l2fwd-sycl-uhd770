...
struct tf_rm_element_cfg tf_tbl_p58[TF_DIR_MAX][TF_TBL_TYPE_MAX] = {
    [TF_DIR_RX][TF_TBL_TYPE_EM_FKB] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                       CFA_RESOURCE_TYPE_P58_EM_FKB, 0, 0},
    [TF_DIR_RX][TF_TBL_TYPE_WC_FKB] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                       CFA_RESOURCE_TYPE_P58_WC_FKB, 0, 0},
    [TF_DIR_RX][TF_TBL_TYPE_METER_PROF] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                           CFA_RESOURCE_TYPE_P58_METER_PROF, 0,
                                           0},
    [TF_DIR_RX][TF_TBL_TYPE_METER_INST] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                           CFA_RESOURCE_TYPE_P58_METER, 0, 0},
    [TF_DIR_RX][TF_TBL_TYPE_METER_DROP_CNT] =
        {TF_RM_ELEM_CFG_HCAPI_BA, CFA_RESOURCE_TYPE_P58_METER_DROP_CNT, 0, 0},
    [TF_DIR_RX][TF_TBL_TYPE_MIRROR_CONFIG] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                              CFA_RESOURCE_TYPE_P58_MIRROR, 0,
                                              0},
    [TF_DIR_RX][TF_TBL_TYPE_METADATA] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                         CFA_RESOURCE_TYPE_P58_METADATA, 0, 0},
    ...
    [TF_DIR_TX][TF_TBL_TYPE_EM_FKB] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                       CFA_RESOURCE_TYPE_P58_EM_FKB, 0, 0},
    [TF_DIR_TX][TF_TBL_TYPE_WC_FKB] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                       CFA_RESOURCE_TYPE_P58_WC_FKB, 0, 0},
    ...
    [TF_DIR_TX][TF_TBL_TYPE_MIRROR_CONFIG] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                              CFA_RESOURCE_TYPE_P58_MIRROR, 0,
                                              0},
    [TF_DIR_TX][TF_TBL_TYPE_METADATA] = {TF_RM_ELEM_CFG_HCAPI_BA,
                                         CFA_RESOURCE_TYPE_P58_METADATA, 0, 0},
    /* Policy - ARs in bank 1 */
 ...
 *   - (-EINVAL) on failure.
 */
static int tf_dev_p58_get_max_types(struct tf *tfp, uint16_t *max_types) {
 ...
 *   - (-EINVAL) on failure.
 */
static int tf_dev_p58_get_resource_str(struct tf *tfp __rte_unused,
...
static int tf_dev_p58_get_mailbox(void) { return TF_CHIMP_MB; }
 ...
 *   - (-EINVAL) on failure.
 */
static int tf_dev_p58_get_shared_tbl_increment(
 ...
 *   - (-EINVAL) on failure.
 */
static int tf_dev_p58_get_sram_tbl_info(struct tf *tfp __rte_unused, void *db,
 ...
 *   - (-EINVAL) on failure.
 */
static int tf_dev_p58_map_hcapi_caps(uint64_t hcapi_caps, uint32_t *ident_caps,
 ...
 *   - (-EINVAL) on failure.
 */
static int tf_dev_p58_get_sram_resources(void *q, uint32_t *sram_bank_caps,
...
static int sram_bank_hcapi_type[] = {
    CFA_RESOURCE_TYPE_P58_SRAM_BANK_0, CFA_RESOURCE_TYPE_P58_SRAM_BANK_1,
    CFA_RESOURCE_TYPE_P58_SRAM_BANK_2, CFA_RESOURCE_TYPE_P58_SRAM_BANK_3};
...
static int tf_dev_p58_set_sram_policy(enum tf_dir dir,
  ...
  for (type = TF_TBL_TYPE_FULL_ACT_RECORD; type <= TF_TBL_TYPE_ACT_MODIFY_64B;
       type++) {
