 ...
 * [in] ll, linked list
 */
static inline struct ll_entry *ll_head(struct ll *ll) { return ll->head; }
 ...
 * [in] ll, linked list
 */
static inline struct ll_entry *ll_tail(struct ll *ll) { return ll->tail; }
 ...
 * [in] ll, linked list
 */
static inline uint32_t ll_cnt(struct ll *ll) { return ll->cnt; }
#endif /* _LL_H_ */
