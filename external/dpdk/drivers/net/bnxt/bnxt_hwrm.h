...
#define GET_TX_QUEUE_INFO(x)                                                   \
  ...
  bp->tx_cos_queue[x].profile = resp->queue_id##x##_service_profile

#define GET_RX_QUEUE_INFO(x)                                                   \
  bp->rx_cos_queue[x].id = resp->queue_id##x;                                  \
  bp->rx_cos_queue[x].profile = resp->queue_id##x##_service_profile
...
int bnxt_hwrm_clear_l2_filter(struct bnxt *bp, struct bnxt_filter_info *filter);
