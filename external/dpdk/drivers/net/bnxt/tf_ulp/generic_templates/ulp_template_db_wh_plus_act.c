...
struct bnxt_ulp_mapper_tmpl_info ulp_wh_plus_act_tmpl_list[] = {
    ...
    [1] = {.device_name = BNXT_ULP_DEVICE_ID_WH_PLUS,
           .num_tbls = 5,
           .start_tbl_idx = 0,
           .reject_info = {.cond_list_opcode = BNXT_ULP_COND_LIST_OPC_OR,
                           .cond_start_idx = 0,
                           .cond_nums = 9}},
    /* act_tid: 2, ingress */
    ...
    [5] = {.device_name = BNXT_ULP_DEVICE_ID_WH_PLUS,
           ...
           .reject_info = {.cond_list_opcode = BNXT_ULP_COND_LIST_OPC_FALSE,
                           ...
                           .cond_nums = 0}},
    /* act_tid: 6, egress */
    [6] = {.device_name = BNXT_ULP_DEVICE_ID_WH_PLUS,
           .num_tbls = 6,
           .start_tbl_idx = 31,
           .reject_info = {.cond_list_opcode = BNXT_ULP_COND_LIST_OPC_FALSE,
                           .cond_start_idx = 35,
...
struct bnxt_ulp_mapper_tbl_info ulp_wh_plus_act_tbl_list[] = {
    ...
    {/* act_tid: 3, , table: control.0 */
     .resource_func = BNXT_ULP_RESOURCE_FUNC_CTRL_TABLE,
     .direction = TF_DIR_RX,
     .execute_info = {.cond_true_goto = 1023,
                      .cond_false_goto = 1,
                      .cond_list_opcode = BNXT_ULP_COND_LIST_OPC_AND,
                      .cond_start_idx = 15,
                      .cond_nums = 1},
...
struct bnxt_ulp_mapper_field_info ulp_wh_plus_act_result_field_list[] = {
    ...
    {.description = "ecv_valid",
     ...
     .field_opr1 = {ULP_WP_SYM_ECV_VALID_YES}},
    ...
    {.description = "dst_ip_ptr",
     ...
     .field_opc = BNXT_ULP_FIELD_OPC_SRC1,
     .field_src1 = BNXT_ULP_FIELD_SRC_RF,
     .field_opr1 = {(BNXT_ULP_RF_IDX_MODIFY_IPV4_DST_PTR_0 >> 8) & 0xff,
    ...
    {.description = "src_ip_ptr",
     ...
     .field_opc = BNXT_ULP_FIELD_OPC_SRC1,
     .field_src1 = BNXT_ULP_FIELD_SRC_RF,
     .field_opr1 = {(BNXT_ULP_RF_IDX_MODIFY_IPV4_SRC_PTR_0 >> 8) & 0xff,
    ...
    {.description = "decap_func",
     ...
     .field_opr3 = {ULP_WP_SYM_DECAP_FUNC_NONE}},
    ...
    {.description = "mirror",
     ...
     .field_opc = BNXT_ULP_FIELD_OPC_SRC1,
     .field_src1 = BNXT_ULP_FIELD_SRC_RF,
     .field_opr1 = {(BNXT_ULP_RF_IDX_MIRROR_ID_0 >> 8) & 0xff,
                    BNXT_ULP_RF_IDX_MIRROR_ID_0 & 0xff}},
    {.description = "drop",
     .field_bit_size = 1,
     .field_opc = BNXT_ULP_FIELD_OPC_SRC1,
    ...
    {.description = "ipv4_addr",
     ...
     .field_opc = BNXT_ULP_FIELD_OPC_SRC1,
     .field_src1 = BNXT_ULP_FIELD_SRC_ACT_PROP,
     .field_opr1 = {(BNXT_ULP_ACT_PROP_IDX_SET_IPV4_SRC >> 8) & 0xff,
    ...
    {.description = "ipv4_addr",
     ...
     .field_opc = BNXT_ULP_FIELD_OPC_SRC1,
     .field_src1 = BNXT_ULP_FIELD_SRC_ACT_PROP,
     .field_opr1 = {(BNXT_ULP_ACT_PROP_IDX_SET_IPV4_DST >> 8) & 0xff,
    ...
    {.description = "ecv_l2_en",
     ...
     .field_opc = BNXT_ULP_FIELD_OPC_SRC1,
     .field_src1 = BNXT_ULP_FIELD_SRC_CONST,
     .field_opr1 = {ULP_WP_SYM_ECV_L2_EN_YES}},
    {.description = "ecv_l3_type",
     .field_bit_size = 3,
     .field_opc = BNXT_ULP_FIELD_OPC_SRC1,
     .field_src1 = BNXT_ULP_FIELD_SRC_ZERO},
    ...
    {.description = "encap_ptr",
     ...
     .field_opr1 = {(BNXT_ULP_GLB_RF_IDX_ENCAP_MAC_PTR >> 8) & 0xff,
    ...
    {.description = "decap_func",
     ...
     .field_opr1 = {((uint64_t)BNXT_ULP_HDR_BIT_T_VXLAN >> 56) & 0xff,
     ...
     .field_src2 = BNXT_ULP_FIELD_SRC_CONST,
     .field_opr2 = {ULP_WP_SYM_DECAP_FUNC_THRU_TL2},
     .field_src3 = BNXT_ULP_FIELD_SRC_CONST,
     .field_opr3 = {ULP_WP_SYM_DECAP_FUNC_THRU_L2}},
    {.description = "vnic_or_vport",
     .field_bit_size = 12,
     .field_opc = BNXT_ULP_FIELD_OPC_SRC1,
     .field_src1 = BNXT_ULP_FIELD_SRC_ACT_PROP,
    ...
    {.description = "ecv_l4_type",
     ...
     .field_opc = BNXT_ULP_FIELD_OPC_SRC1,
     .field_src1 = BNXT_ULP_FIELD_SRC_CONST,
     .field_opr1 = {ULP_WP_SYM_ECV_L4_TYPE_UDP_CSUM}},
    {.description = "ecv_tun_type",
     .field_bit_size = 3,
     .field_opc = BNXT_ULP_FIELD_OPC_SRC1,
     .field_src1 = BNXT_ULP_FIELD_SRC_CONST,
     .field_opr1 = {ULP_WP_SYM_ECV_TUN_TYPE_VXLAN}},
    ...
    {.description = "enc_ipv4_ihl",
     ...
     .field_src2 = BNXT_ULP_FIELD_SRC_ENC_FIELD,
     .field_opr2 = {(BNXT_ULP_ENC_FIELD_IPV4_IHL >> 8) & 0xff,
    ...
    {.description = "enc_ipv4_tos",
     ...
     .field_opr1 = {((uint64_t)BNXT_ULP_HDR_BIT_O_IPV4 >> 56) & 0xff,
                    ...
                    (uint64_t)BNXT_ULP_HDR_BIT_O_IPV4 & 0xff},
     .field_src2 = BNXT_ULP_FIELD_SRC_ENC_FIELD,
     .field_opr2 = {(BNXT_ULP_ENC_FIELD_IPV4_TOS >> 8) & 0xff,
    ...
    {.description = "enc_ipv4_pkt_id",
     ...
     .field_opr1 = {((uint64_t)BNXT_ULP_HDR_BIT_O_IPV4 >> 56) & 0xff,
                    ...
                    (uint64_t)BNXT_ULP_HDR_BIT_O_IPV4 & 0xff},
     .field_src2 = BNXT_ULP_FIELD_SRC_ENC_FIELD,
     .field_opr2 = {(BNXT_ULP_ENC_FIELD_IPV4_PKT_ID >> 8) & 0xff,
    ...
    {.description = "enc_ipv4_frag",
     ...
     .field_opr1 = {((uint64_t)BNXT_ULP_HDR_BIT_O_IPV4 >> 56) & 0xff,
                    ...
                    (uint64_t)BNXT_ULP_HDR_BIT_O_IPV4 & 0xff},
     .field_src2 = BNXT_ULP_FIELD_SRC_ENC_FIELD,
     .field_opr2 = {(BNXT_ULP_ENC_FIELD_IPV4_FRAG >> 8) & 0xff,
    ...
    {.description = "enc_ipv4_ttl",
     ...
     .field_opr1 = {((uint64_t)BNXT_ULP_HDR_BIT_O_IPV4 >> 56) & 0xff,
                    ...
                    (uint64_t)BNXT_ULP_HDR_BIT_O_IPV4 & 0xff},
     .field_src2 = BNXT_ULP_FIELD_SRC_ENC_FIELD,
     .field_opr2 = {(BNXT_ULP_ENC_FIELD_IPV4_TTL >> 8) & 0xff,
    ...
    {.description = "enc_ipv4_proto",
     ...
     .field_opr1 = {((uint64_t)BNXT_ULP_HDR_BIT_O_IPV4 >> 56) & 0xff,
                    ...
                    (uint64_t)BNXT_ULP_HDR_BIT_O_IPV4 & 0xff},
     .field_src2 = BNXT_ULP_FIELD_SRC_ENC_FIELD,
     .field_opr2 = {(BNXT_ULP_ENC_FIELD_IPV4_PROTO >> 8) & 0xff,
    ...
    {.description = "enc_ipv4_daddr",
     ...
     .field_opr1 = {((uint64_t)BNXT_ULP_HDR_BIT_O_IPV4 >> 56) & 0xff,
                    ...
                    (uint64_t)BNXT_ULP_HDR_BIT_O_IPV4 & 0xff},
     .field_src2 = BNXT_ULP_FIELD_SRC_ENC_FIELD,
     .field_opr2 = {(BNXT_ULP_ENC_FIELD_IPV4_DADDR >> 8) & 0xff,
    ...
    {.description = "enc_ipv6_vtc",
     ...
     .field_opc = BNXT_ULP_FIELD_OPC_SRC1_THEN_SRC2_ELSE_SRC3,
     .field_src1 = BNXT_ULP_FIELD_SRC_ENC_HDR_BIT,
     .field_opr1 = {((uint64_t)BNXT_ULP_HDR_BIT_O_IPV6 >> 56) & 0xff,
     ...
     .field_src2 = BNXT_ULP_FIELD_SRC_ENC_FIELD,
     .field_opr2 = {(BNXT_ULP_ENC_FIELD_IPV6_VTC_FLOW >> 8) & 0xff,
    ...
    {.description = "enc_ipv6_proto",
     ...
     .field_opr1 = {((uint64_t)BNXT_ULP_HDR_BIT_O_IPV6 >> 56) & 0xff,
                    ...
                    (uint64_t)BNXT_ULP_HDR_BIT_O_IPV6 & 0xff},
     .field_src2 = BNXT_ULP_FIELD_SRC_ENC_FIELD,
     .field_opr2 = {(BNXT_ULP_ENC_FIELD_IPV6_PROTO >> 8) & 0xff,
    ...
    {.description = "enc_ipv6_ttl",
     ...
     .field_opr1 = {((uint64_t)BNXT_ULP_HDR_BIT_O_IPV6 >> 56) & 0xff,
                    ...
                    (uint64_t)BNXT_ULP_HDR_BIT_O_IPV6 & 0xff},
     .field_src2 = BNXT_ULP_FIELD_SRC_ENC_FIELD,
     .field_opr2 = {(BNXT_ULP_ENC_FIELD_IPV6_TTL >> 8) & 0xff,
    ...
    {.description = "enc_ipv6_daddr",
     ...
     .field_opr1 = {((uint64_t)BNXT_ULP_HDR_BIT_O_IPV6 >> 56) & 0xff,
                    ...
                    (uint64_t)BNXT_ULP_HDR_BIT_O_IPV6 & 0xff},
     .field_src2 = BNXT_ULP_FIELD_SRC_ENC_FIELD,
     .field_opr2 = {(BNXT_ULP_ENC_FIELD_IPV6_DADDR >> 8) & 0xff,
    ...
    {.description = "enc_udp_sport",
     ...
     .field_opc = BNXT_ULP_FIELD_OPC_SRC1_THEN_SRC2_ELSE_SRC3,
     .field_src1 = BNXT_ULP_FIELD_SRC_ENC_HDR_BIT,
     .field_opr1 = {((uint64_t)BNXT_ULP_HDR_BIT_O_UDP >> 56) & 0xff,
     ...
     .field_src2 = BNXT_ULP_FIELD_SRC_ENC_FIELD,
     .field_opr2 = {(BNXT_ULP_ENC_FIELD_UDP_SPORT >> 8) & 0xff,
    ...
    {.description = "enc_udp_dport",
     ...
     .field_opr1 = {((uint64_t)BNXT_ULP_HDR_BIT_O_UDP >> 56) & 0xff,
                    ...
                    (uint64_t)BNXT_ULP_HDR_BIT_O_UDP & 0xff},
     .field_src2 = BNXT_ULP_FIELD_SRC_ENC_FIELD,
     .field_opr2 = {(BNXT_ULP_ENC_FIELD_UDP_DPORT >> 8) & 0xff,
    ...
    {.description = "enc_vxlan_flags",
     ...
     .field_opr1 = {((uint64_t)BNXT_ULP_HDR_BIT_T_VXLAN >> 56) & 0xff,
                    ...
                    (uint64_t)BNXT_ULP_HDR_BIT_T_VXLAN & 0xff},
     .field_src2 = BNXT_ULP_FIELD_SRC_ENC_FIELD,
     .field_opr2 = {(BNXT_ULP_ENC_FIELD_VXLAN_FLAGS >> 8) & 0xff,
    ...
    {.description = "enc_vxlan_rsvd0",
     ...
     .field_opr1 = {((uint64_t)BNXT_ULP_HDR_BIT_T_VXLAN >> 56) & 0xff,
                    ...
                    (uint64_t)BNXT_ULP_HDR_BIT_T_VXLAN & 0xff},
     .field_src2 = BNXT_ULP_FIELD_SRC_ENC_FIELD,
     .field_opr2 = {(BNXT_ULP_ENC_FIELD_VXLAN_RSVD0 >> 8) & 0xff,
    ...
    {.description = "enc_vxlan_vni",
     ...
     .field_opr1 = {((uint64_t)BNXT_ULP_HDR_BIT_T_VXLAN >> 56) & 0xff,
                    ...
                    (uint64_t)BNXT_ULP_HDR_BIT_T_VXLAN & 0xff},
     .field_src2 = BNXT_ULP_FIELD_SRC_ENC_FIELD,
     .field_opr2 = {(BNXT_ULP_ENC_FIELD_VXLAN_VNI >> 8) & 0xff,
    ...
    {.description = "enc_vxlan_rsvd1",
     ...
     .field_opr1 = {((uint64_t)BNXT_ULP_HDR_BIT_T_VXLAN >> 56) & 0xff,
                    ...
                    (uint64_t)BNXT_ULP_HDR_BIT_T_VXLAN & 0xff},
     .field_src2 = BNXT_ULP_FIELD_SRC_ENC_FIELD,
     .field_opr2 = {(BNXT_ULP_ENC_FIELD_VXLAN_RSVD1 >> 8) & 0xff,
