...
extern struct bnxt_ulp_mapper_key_info ulp_wh_plus_class_key_info_list[];

extern struct bnxt_ulp_mapper_field_info ulp_wh_plus_class_result_field_list[];
...
extern struct bnxt_ulp_mapper_field_info ulp_wh_plus_act_result_field_list[];

extern struct bnxt_ulp_mapper_cond_info ulp_wh_plus_class_cond_list[];

extern struct bnxt_ulp_mapper_cond_info ulp_wh_plus_act_cond_list[];
...
extern struct bnxt_ulp_mapper_key_info ulp_stingray_class_key_info_list[];

extern struct bnxt_ulp_mapper_field_info ulp_stingray_class_result_field_list[];
...
extern struct bnxt_ulp_mapper_field_info ulp_stingray_act_result_field_list[];

extern struct bnxt_ulp_mapper_cond_info ulp_stingray_class_cond_list[];

extern struct bnxt_ulp_mapper_cond_info ulp_stingray_act_cond_list[];
...
extern struct bnxt_ulp_mapper_key_info ulp_thor_class_key_info_list[];

extern struct bnxt_ulp_mapper_field_info ulp_thor_class_result_field_list[];
...
extern struct bnxt_ulp_mapper_field_info ulp_thor_act_result_field_list[];

extern struct bnxt_ulp_mapper_cond_info ulp_thor_class_cond_list[];

extern struct bnxt_ulp_mapper_cond_info ulp_thor_act_cond_list[];
...
extern struct bnxt_ulp_shared_act_info ulp_shared_act_info[];
#endif
