...
#define BNXT_ULP_GET_IPV6_TC(vtcf) (((vtcf)&BNXT_ULP_PARSER_IPV6_TC) >> 20)
...
void bnxt_ulp_init_mapper_params(
    struct bnxt_ulp_mapper_create_parms *mapper_cparms,
    struct ulp_rte_parser_params *params, enum bnxt_ulp_fdb_type flow_type);
...
int32_t ulp_rte_pf_hdr_handler(const struct rte_flow_item *item,
                               struct ulp_rte_parser_params *params);
...
int32_t ulp_rte_void_hdr_handler(const struct rte_flow_item *item,
                                 struct ulp_rte_parser_params *params);

/* Function to handle the parsing of RTE Flow action void Header. */
int32_t ulp_rte_void_act_handler(const struct rte_flow_action *action_item,
                                 struct ulp_rte_parser_params *params);
...
int32_t ulp_rte_drop_act_handler(const struct rte_flow_action *action_item,
                                 struct ulp_rte_parser_params *params);
...
int32_t ulp_rte_pf_act_handler(const struct rte_flow_action *action_item,
                               struct ulp_rte_parser_params *params);
...
int32_t ulp_rte_dec_ttl_act_handler(const struct rte_flow_action *action_item,
                                    struct ulp_rte_parser_params *params);

/* Function to handle the parsing of RTE Flow action JUMP .*/
int32_t ulp_rte_jump_act_handler(const struct rte_flow_action *action_item,
                                 struct ulp_rte_parser_params *params);

int32_t ulp_rte_sample_act_handler(const struct rte_flow_action *action_item,
                                   struct ulp_rte_parser_params *params);

int32_t ulp_rte_shared_act_handler(const struct rte_flow_action *action_item,
                                   struct ulp_rte_parser_params *params);
