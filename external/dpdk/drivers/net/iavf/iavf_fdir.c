...
#define IAVF_FDIR_INSET_ETH (IAVF_INSET_ETHERTYPE)

#define IAVF_FDIR_INSET_ETH_IPV4                                               \
  (IAVF_INSET_IPV4_SRC | IAVF_INSET_IPV4_DST | IAVF_INSET_IPV4_PROTO |         \
   IAVF_INSET_IPV4_TOS | IAVF_INSET_IPV4_TTL | IAVF_INSET_IPV4_ID)

#define IAVF_FDIR_INSET_ETH_IPV4_UDP                                           \
  (IAVF_INSET_IPV4_SRC | IAVF_INSET_IPV4_DST | IAVF_INSET_IPV4_TOS |           \
   IAVF_INSET_IPV4_TTL | IAVF_INSET_UDP_SRC_PORT | IAVF_INSET_UDP_DST_PORT)

#define IAVF_FDIR_INSET_ETH_IPV4_TCP                                           \
  (IAVF_INSET_IPV4_SRC | IAVF_INSET_IPV4_DST | IAVF_INSET_IPV4_TOS |           \
   IAVF_INSET_IPV4_TTL | IAVF_INSET_TCP_SRC_PORT | IAVF_INSET_TCP_DST_PORT)

#define IAVF_FDIR_INSET_ETH_IPV4_SCTP                                          \
  (IAVF_INSET_IPV4_SRC | IAVF_INSET_IPV4_DST | IAVF_INSET_IPV4_TOS |           \
   IAVF_INSET_IPV4_TTL | IAVF_INSET_SCTP_SRC_PORT | IAVF_INSET_SCTP_DST_PORT)

#define IAVF_FDIR_INSET_ETH_IPV6                                               \
  (IAVF_INSET_IPV6_SRC | IAVF_INSET_IPV6_DST | IAVF_INSET_IPV6_NEXT_HDR |      \
...
#define IAVF_FDIR_INSET_ETH_IPV6_UDP                                           \
  (IAVF_INSET_IPV6_SRC | IAVF_INSET_IPV6_DST | IAVF_INSET_IPV6_TC |            \
...
#define IAVF_FDIR_INSET_IPV4_GTPU                                              \
  (IAVF_INSET_IPV4_SRC | IAVF_INSET_IPV4_DST | IAVF_INSET_GTPU_TEID)
...
#define IAVF_FDIR_INSET_GTPU_IPV4_UDP                                          \
  (IAVF_FDIR_INSET_GTPU_IPV4 | IAVF_INSET_TUN_UDP_SRC_PORT |                   \
   IAVF_INSET_TUN_UDP_DST_PORT)

#define IAVF_FDIR_INSET_GTPU_IPV4_TCP                                          \
  (IAVF_FDIR_INSET_GTPU_IPV4 | IAVF_INSET_TUN_TCP_SRC_PORT |                   \
...
#define IAVF_FDIR_INSET_IPV6_GTPU                                              \
  (IAVF_INSET_IPV6_SRC | IAVF_INSET_IPV6_DST | IAVF_INSET_GTPU_TEID)
...
#define IAVF_FDIR_INSET_GTPU_IPV6_UDP                                          \
  (IAVF_FDIR_INSET_GTPU_IPV6 | IAVF_INSET_TUN_UDP_SRC_PORT |                   \
   IAVF_INSET_TUN_UDP_DST_PORT)
...
#define IAVF_FDIR_INSET_L2TPV3OIP (IAVF_L2TPV3OIP_SESSION_ID)
...
#define IAVF_FDIR_INSET_AH (IAVF_INSET_AH_SPI)
...
#define IAVF_FDIR_INSET_PFCP (IAVF_INSET_PFCP_S_FIELD)

#define IAVF_FDIR_INSET_ECPRI (IAVF_INSET_ECPRI)
...
static struct iavf_pattern_match_item iavf_fdir_pattern[] = {
    ...
    {iavf_pattern_eth_ipv6_frag_ext, IAVF_FDIR_INSET_ETH_IPV6_FRAG_EXT,
     IAVF_INSET_NONE},
    ...
    {iavf_pattern_eth_ipv4_gtpu_eh_ipv6_tcp, IAVF_FDIR_INSET_GTPU_IPV6_TCP,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv4_gtpu, IAVF_FDIR_INSET_IPV4_GTPU,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv4_gtpu_ipv4, IAVF_FDIR_INSET_GTPU_IPV4,
     IAVF_INSET_NONE},
    ...
    {iavf_pattern_eth_ipv4_gre_ipv4_gtpu_ipv6, IAVF_FDIR_INSET_GTPU_IPV6,
     IAVF_INSET_NONE},
    ...
    {iavf_pattern_eth_ipv4_gre_ipv6_gtpu, IAVF_FDIR_INSET_IPV4_GTPU,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv6_gtpu_ipv4, IAVF_FDIR_INSET_GTPU_IPV4,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv6_gtpu_ipv4_udp,
     IAVF_FDIR_INSET_GTPU_IPV4_UDP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv6_gtpu_ipv4_tcp,
     IAVF_FDIR_INSET_GTPU_IPV4_TCP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv6_gtpu_ipv6, IAVF_FDIR_INSET_GTPU_IPV6,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv6_gtpu_ipv6_udp,
     IAVF_FDIR_INSET_GTPU_IPV6_UDP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv6_gtpu_ipv6_tcp,
     IAVF_FDIR_INSET_GTPU_IPV6_TCP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv4_gtpu, IAVF_FDIR_INSET_IPV6_GTPU,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv4_gtpu_ipv4, IAVF_FDIR_INSET_GTPU_IPV4,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv4_gtpu_ipv4_udp,
     IAVF_FDIR_INSET_GTPU_IPV4_UDP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv4_gtpu_ipv4_tcp,
     IAVF_FDIR_INSET_GTPU_IPV4_TCP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv4_gtpu_ipv6, IAVF_FDIR_INSET_GTPU_IPV6,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv4_gtpu_ipv6_udp,
     IAVF_FDIR_INSET_GTPU_IPV6_UDP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv4_gtpu_ipv6_tcp,
     IAVF_FDIR_INSET_GTPU_IPV6_TCP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv6_gtpu, IAVF_FDIR_INSET_IPV6_GTPU,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv6_gtpu_ipv4, IAVF_FDIR_INSET_GTPU_IPV4,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv6_gtpu_ipv4_udp,
     IAVF_FDIR_INSET_GTPU_IPV4_UDP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv6_gtpu_ipv4_tcp,
     IAVF_FDIR_INSET_GTPU_IPV4_TCP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv6_gtpu_ipv6, IAVF_FDIR_INSET_GTPU_IPV6,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv6_gtpu_ipv6_udp,
     IAVF_FDIR_INSET_GTPU_IPV6_UDP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv6_gtpu_ipv6_tcp,
     IAVF_FDIR_INSET_GTPU_IPV6_TCP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv4_gtpu_eh, IAVF_FDIR_INSET_IPV4_GTPU_EH,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv4_gtpu_eh_ipv4, IAVF_FDIR_INSET_GTPU_IPV4,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv4_gtpu_eh_ipv4_udp,
     IAVF_FDIR_INSET_GTPU_IPV4_UDP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv4_gtpu_eh_ipv4_tcp,
     IAVF_FDIR_INSET_GTPU_IPV4_TCP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv4_gtpu_eh_ipv6, IAVF_FDIR_INSET_GTPU_IPV6,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv4_gtpu_eh_ipv6_udp,
     IAVF_FDIR_INSET_GTPU_IPV6_UDP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv4_gtpu_eh_ipv6_tcp,
     IAVF_FDIR_INSET_GTPU_IPV6_TCP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv6_gtpu_eh, IAVF_FDIR_INSET_IPV4_GTPU_EH,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv6_gtpu_eh_ipv4, IAVF_FDIR_INSET_GTPU_IPV4,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv6_gtpu_eh_ipv4_udp,
     IAVF_FDIR_INSET_GTPU_IPV4_UDP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv6_gtpu_eh_ipv4_tcp,
     IAVF_FDIR_INSET_GTPU_IPV4_TCP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv6_gtpu_eh_ipv6, IAVF_FDIR_INSET_GTPU_IPV6,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv6_gtpu_eh_ipv6_udp,
     IAVF_FDIR_INSET_GTPU_IPV6_UDP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_gre_ipv6_gtpu_eh_ipv6_tcp,
     IAVF_FDIR_INSET_GTPU_IPV6_TCP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv4_gtpu_eh, IAVF_FDIR_INSET_IPV6_GTPU_EH,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv4_gtpu_eh_ipv4, IAVF_FDIR_INSET_GTPU_IPV4,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv4_gtpu_eh_ipv4_udp,
     IAVF_FDIR_INSET_GTPU_IPV4_UDP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv4_gtpu_eh_ipv4_tcp,
     IAVF_FDIR_INSET_GTPU_IPV4_TCP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv4_gtpu_eh_ipv6, IAVF_FDIR_INSET_GTPU_IPV6,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv4_gtpu_eh_ipv6_udp,
     IAVF_FDIR_INSET_GTPU_IPV6_UDP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv4_gtpu_eh_ipv6_tcp,
     IAVF_FDIR_INSET_GTPU_IPV6_TCP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv6_gtpu_eh, IAVF_FDIR_INSET_IPV6_GTPU_EH,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv6_gtpu_eh_ipv4, IAVF_FDIR_INSET_GTPU_IPV4,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv6_gtpu_eh_ipv4_udp,
     IAVF_FDIR_INSET_GTPU_IPV4_UDP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv6_gtpu_eh_ipv4_tcp,
     IAVF_FDIR_INSET_GTPU_IPV4_TCP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_gre_ipv6_gtpu_eh_ipv6, IAVF_FDIR_INSET_GTPU_IPV6,
     IAVF_INSET_NONE},
    ...
    {iavf_pattern_eth_ipv4_udp_esp, IAVF_FDIR_INSET_IPV4_NATT_ESP,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_udp_esp, IAVF_FDIR_INSET_IPV6_NATT_ESP,
     IAVF_INSET_NONE},
    ...
    {iavf_pattern_eth_ipv6_udp_l2tpv2_ppp, IAVF_FDIR_INSET_L2TPV2,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_udp_l2tpv2_ppp_ipv4, IAVF_FDIR_INSET_L2TPV2_PPP_IPV4,
     IAVF_INSET_NONE},
    ...
    {iavf_pattern_eth_ipv6_udp_l2tpv2_ppp_ipv4, IAVF_FDIR_INSET_L2TPV2_PPP_IPV4,
     IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_udp_l2tpv2_ppp_ipv4_udp,
     IAVF_FDIR_INSET_L2TPV2_PPP_IPV4_UDP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv6_udp_l2tpv2_ppp_ipv4_tcp,
     IAVF_FDIR_INSET_L2TPV2_PPP_IPV4_TCP, IAVF_INSET_NONE},
    {iavf_pattern_eth_ipv4_udp_l2tpv2_ppp_ipv6, IAVF_FDIR_INSET_L2TPV2_PPP_IPV6,
     IAVF_INSET_NONE},
    ...
    {iavf_pattern_eth_ipv6_udp_l2tpv2_ppp_ipv6, IAVF_FDIR_INSET_L2TPV2_PPP_IPV6,
     IAVF_INSET_NONE},
...
static int iavf_fdir_init(struct iavf_adapter *ad) {
...
static void iavf_fdir_uninit(struct iavf_adapter *ad) {
  iavf_unregister_parser(&iavf_fdir_parser, ad);
}

static int iavf_fdir_create(struct iavf_adapter *ad, struct rte_flow *flow,
...
static int iavf_fdir_destroy(struct iavf_adapter *ad, struct rte_flow *flow,
...
static int iavf_fdir_validation(struct iavf_adapter *ad,
...
iavf_fdir_parse_action_qregion(struct iavf_adapter *ad,
  ...
  if (rss->queue_num > vf->max_rss_qregion) {
    rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ACTION, act,
                       "The region size cannot be large than the supported max "
                       "RSS queue region");
    return -rte_errno;
  }
...
static int iavf_fdir_parse_action(struct iavf_adapter *ad,
  ...
  for (; actions->type != RTE_FLOW_ACTION_TYPE_END; actions++) {
    ...
    case RTE_FLOW_ACTION_TYPE_QUEUE:
      ...
      if (filter_action->act_conf.queue.index >= ad->dev_data->nb_rx_queues) {
    ...
    case RTE_FLOW_ACTION_TYPE_RSS:
      ...
      ret = iavf_fdir_parse_action_qregion(ad, error, actions, filter_action);
      if (ret)
        return ret;
...
static bool iavf_fdir_refine_input_set(const uint64_t input_set,
  ...
  case VIRTCHNL_PROTO_HDR_IPV4:
    ...
    rte_memcpy(hdr->buffer, &ipv4_spec.hdr, sizeof(ipv4_spec.hdr));
    return true;
  case VIRTCHNL_PROTO_HDR_IPV6:
    VIRTCHNL_ADD_PROTO_HDR_FIELD_BIT(hdr, IPV6, PROT);
    memset(&ipv6_spec, 0, sizeof(ipv6_spec));
    ipv6_spec.hdr.proto = proto_id;
    rte_memcpy(hdr->buffer, &ipv6_spec.hdr, sizeof(ipv6_spec.hdr));
    return true;
  default:
    return false;
  }
...
static void iavf_fdir_add_fragment_hdr(struct virtchnl_proto_hdrs *hdrs,
                                       int layer) {
...
static int iavf_fdir_parse_pattern(__rte_unused struct iavf_adapter *ad,
  ...
  for (item = pattern; item->type != RTE_FLOW_ITEM_TYPE_END; item++) {
    ...
    case RTE_FLOW_ITEM_TYPE_ETH:
      ...
      if (eth_spec && eth_mask) {
        if (!rte_is_zero_ether_addr(&eth_mask->dst)) {
          ...
          VIRTCHNL_ADD_PROTO_HDR_FIELD_BIT(hdr1, ETH, DST);
        } else if (!rte_is_zero_ether_addr(&eth_mask->src)) {
          input_set |= IAVF_INSET_SMAC;
          VIRTCHNL_ADD_PROTO_HDR_FIELD_BIT(hdr1, ETH, SRC);
        }
        ...
        rte_memcpy(hdr1->buffer, eth_spec, sizeof(struct rte_ether_hdr));
      }
    ...
    case RTE_FLOW_ITEM_TYPE_IPV6:
      ...
      if ((ipv6_mask->hdr.vtc_flow & rte_cpu_to_be_32(IAVF_IPV6_TC_MASK)) ==
    ...
    case RTE_FLOW_ITEM_TYPE_UDP:
      ...
      if (udp_spec && udp_mask) {
        ...
        if (l3 == RTE_FLOW_ITEM_TYPE_IPV4)
          rte_memcpy(hdr->buffer, &udp_spec->hdr, sizeof(udp_spec->hdr));
    ...
    case RTE_FLOW_ITEM_TYPE_TCP:
      ...
      if (tcp_spec && tcp_mask) {
        ...
        if (l3 == RTE_FLOW_ITEM_TYPE_IPV4)
          rte_memcpy(hdr->buffer, &tcp_spec->hdr, sizeof(tcp_spec->hdr));
        else if (l3 == RTE_FLOW_ITEM_TYPE_IPV6)
          rte_memcpy(hdr->buffer, &tcp_spec->hdr, sizeof(tcp_spec->hdr));
      }
    ...
    case RTE_FLOW_ITEM_TYPE_SCTP:
      ...
      if (sctp_spec && sctp_mask) {
        ...
        if (l3 == RTE_FLOW_ITEM_TYPE_IPV4)
          rte_memcpy(hdr->buffer, &sctp_spec->hdr, sizeof(sctp_spec->hdr));
        else if (l3 == RTE_FLOW_ITEM_TYPE_IPV6)
          rte_memcpy(hdr->buffer, &sctp_spec->hdr, sizeof(sctp_spec->hdr));
      }
    ...
    case RTE_FLOW_ITEM_TYPE_GTPU:
      ...
      if (gtp_spec && gtp_mask) {
        ...
        rte_memcpy(hdr->buffer, gtp_spec, sizeof(*gtp_spec));
      }
    ...
    case RTE_FLOW_ITEM_TYPE_GTP_PSC:
      ...
      else if ((gtp_psc_mask->hdr.qfi) && !(gtp_psc_mask->hdr.type))
        VIRTCHNL_SET_PROTO_HDR_TYPE(hdr, GTPU_EH);
      ...
      if (gtp_psc_spec && gtp_psc_mask) {
        ...
        rte_memcpy(hdr->buffer, gtp_psc_spec, sizeof(*gtp_psc_spec));
      }
    ...
    case RTE_FLOW_ITEM_TYPE_L2TPV3OIP:
      ...
      if (l2tpv3oip_spec && l2tpv3oip_mask) {
        ...
        rte_memcpy(hdr->buffer, l2tpv3oip_spec, sizeof(*l2tpv3oip_spec));
      }
    ...
    case RTE_FLOW_ITEM_TYPE_ESP:
      ...
      if (esp_spec && esp_mask) {
        ...
        rte_memcpy(hdr->buffer, &esp_spec->hdr, sizeof(esp_spec->hdr));
      }
    ...
    case RTE_FLOW_ITEM_TYPE_AH:
      ...
      if (ah_spec && ah_mask) {
        ...
        rte_memcpy(hdr->buffer, ah_spec, sizeof(*ah_spec));
      }
    ...
    case RTE_FLOW_ITEM_TYPE_PFCP:
      ...
      if (pfcp_spec && pfcp_mask) {
        ...
        rte_memcpy(hdr->buffer, pfcp_spec, sizeof(*pfcp_spec));
      }
    ...
    case RTE_FLOW_ITEM_TYPE_ECPRI:
      ...
      if (ecpri_spec && ecpri_mask) {
        if (ecpri_common.type == RTE_ECPRI_MSG_TYPE_IQ_DATA &&
          ...
          VIRTCHNL_ADD_PROTO_HDR_FIELD_BIT(hdr, ECPRI, PC_RTC_ID);
        }

        rte_memcpy(hdr->buffer, ecpri_spec, sizeof(*ecpri_spec));
      }
    ...
    case RTE_FLOW_ITEM_TYPE_L2TPV2:
      ...
      if (l2tpv2_spec && l2tpv2_mask) {
        flags_version = rte_be_to_cpu_16(l2tpv2_spec->hdr.common.flags_version);
        if ((flags_version == RTE_L2TPV2_MSG_TYPE_CONTROL &&
          ...
          if (flags_version & IAVF_L2TPV2_FLAGS_LEN)
            VIRTCHNL_ADD_PROTO_HDR_FIELD_BIT(hdr, L2TPV2, LEN_SESS_ID);
          else
            VIRTCHNL_ADD_PROTO_HDR_FIELD_BIT(hdr, L2TPV2, SESS_ID);
        }

        rte_memcpy(hdr->buffer, l2tpv2_spec, sizeof(*l2tpv2_spec));
      }
    ...
    case RTE_FLOW_ITEM_TYPE_PPP:
      ...
      if (ppp_spec && ppp_mask) {
        rte_memcpy(hdr->buffer, ppp_spec, sizeof(*ppp_spec));
      }
  ...
  if (!iavf_fdir_refine_input_set(
          input_set, input_set_mask | IAVF_INSET_ETHERTYPE, filter)) {
...
static int iavf_fdir_parse(struct iavf_adapter *ad,
  ...
  ret =
      iavf_fdir_parse_pattern(ad, pattern, item->input_set_mask, error, filter);
  if (ret)
    goto error;
