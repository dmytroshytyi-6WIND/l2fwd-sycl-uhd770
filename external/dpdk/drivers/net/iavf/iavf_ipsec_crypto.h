...
#define IAVF_IPSEC_TX_DESC_QW0_L4PAYLEN_MASK                                   \
  (0x3FFFULL << IAVF_IPSEC_TX_DESC_QW0_L4PAYLEN_SHIFT)

#define IAVF_IPSEC_TX_DESC_QW0_IPSECESN_SHIFT 16
#define IAVF_IPSEC_TX_DESC_QW0_IPSECESN_MASK                                   \
  (0xFFFFFFFFULL << IAVF_IPSEC_TX_DESC_QW0_IPSECESN_SHIFT)

#define IAVF_IPSEC_TX_DESC_QW0_TRAILERLEN_SHIFT 48
#define IAVF_IPSEC_TX_DESC_QW0_TRAILERLEN_MASK                                 \
  (0x3FULL << IAVF_IPSEC_TX_DESC_QW0_TRAILERLEN_SHIFT)

#define IAVF_IPSEC_TX_DESC_QW1_UDP_SHIFT 5
#define IAVF_IPSEC_TX_DESC_QW1_UDP_MASK                                        \
  (0x1ULL << IAVF_IPSEC_TX_DESC_QW1_UDP_SHIFT)

#define IAVF_IPSEC_TX_DESC_QW1_IVLEN_SHIFT 6
#define IAVF_IPSEC_TX_DESC_QW1_IVLEN_MASK                                      \
  (0x3ULL << IAVF_IPSEC_TX_DESC_QW1_IVLEN_SHIFT)

#define IAVF_IPSEC_TX_DESC_QW1_IPSECNH_SHIFT 8
#define IAVF_IPSEC_TX_DESC_QW1_IPSECNH_MASK                                    \
  (0xFFULL << IAVF_IPSEC_TX_DESC_QW1_IPSECNH_SHIFT)

#define IAVF_IPSEC_TX_DESC_QW1_EXTLEN_SHIFT 16
#define IAVF_IPSEC_TX_DESC_QW1_EXTLEN_MASK                                     \
  (0xFFULL << IAVF_IPSEC_TX_DESC_QW1_EXTLEN_SHIFT)

#define IAVF_IPSEC_TX_DESC_QW1_IPSECSA_SHIFT 32
#define IAVF_IPSEC_TX_DESC_QW1_IPSECSA_MASK                                    \
...
int iavf_ipsec_crypto_set_security_capabililites(
    ...
    struct virtchnl_ipsec_cap *virtchl_capabilities);
