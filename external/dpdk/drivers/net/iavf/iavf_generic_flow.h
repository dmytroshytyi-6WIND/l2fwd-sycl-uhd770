...
#define IAVF_INSET_IPV4_ID (IAVF_PROT_IPV4_OUTER | IAVF_IP_PKID)
...
#define IAVF_INSET_IPV6_ID (IAVF_PROT_IPV6_OUTER | IAVF_IP_PKID)

#define IAVF_INSET_TUN_IPV4_SRC (IAVF_PROT_IPV4_INNER | IAVF_IP_SRC)
#define IAVF_INSET_TUN_IPV4_DST (IAVF_PROT_IPV4_INNER | IAVF_IP_DST)
#define IAVF_INSET_TUN_IPV4_TOS (IAVF_PROT_IPV4_INNER | IAVF_IP_TOS)
#define IAVF_INSET_TUN_IPV4_PROTO (IAVF_PROT_IPV4_INNER | IAVF_IP_PROTO)
#define IAVF_INSET_TUN_IPV4_TTL (IAVF_PROT_IPV4_INNER | IAVF_IP_TTL)
#define IAVF_INSET_TUN_IPV6_SRC (IAVF_PROT_IPV6_INNER | IAVF_IP_SRC)
#define IAVF_INSET_TUN_IPV6_DST (IAVF_PROT_IPV6_INNER | IAVF_IP_DST)
#define IAVF_INSET_TUN_IPV6_NEXT_HDR (IAVF_PROT_IPV6_INNER | IAVF_IP_PROTO)
#define IAVF_INSET_TUN_IPV6_HOP_LIMIT (IAVF_PROT_IPV6_INNER | IAVF_IP_TTL)
#define IAVF_INSET_TUN_IPV6_TC (IAVF_PROT_IPV6_INNER | IAVF_IP_TOS)
...
#define IAVF_INSET_TUN_TCP_SRC_PORT (IAVF_PROT_TCP_INNER | IAVF_SPORT)
#define IAVF_INSET_TUN_TCP_DST_PORT (IAVF_PROT_TCP_INNER | IAVF_DPORT)
#define IAVF_INSET_TUN_UDP_SRC_PORT (IAVF_PROT_UDP_INNER | IAVF_SPORT)
#define IAVF_INSET_TUN_UDP_DST_PORT (IAVF_PROT_UDP_INNER | IAVF_DPORT)
...
#define IAVF_INSET_ECPRI (IAVF_PROT_ECPRI | IAVF_ECPRI_PC_RTC_ID)
#define IAVF_INSET_L2TPV2 (IAVF_PROT_L2TPV2 | IAVF_L2TPV2_SESSION_ID)
...
typedef int (*engine_create_t)(struct iavf_adapter *ad, struct rte_flow *flow,
                               void *meta, struct rte_flow_error *error);
typedef int (*engine_destroy_t)(struct iavf_adapter *ad, struct rte_flow *flow,
                                struct rte_flow_error *error);
typedef int (*engine_query_t)(struct iavf_adapter *ad, struct rte_flow *flow,
