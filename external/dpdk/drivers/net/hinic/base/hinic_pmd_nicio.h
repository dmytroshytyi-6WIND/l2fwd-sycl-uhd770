...
#define SQ_CTXT_OFFSET(max_sqs, max_rqs, q_id)                                 \
  (((max_rqs) + (max_sqs)) * TSO_LRO_CTXT_SIZE + (q_id)*Q_CTXT_SIZE)

#define RQ_CTXT_OFFSET(max_sqs, max_rqs, q_id)                                 \
  (((max_rqs) + (max_sqs)) * TSO_LRO_CTXT_SIZE + (max_sqs)*Q_CTXT_SIZE +       \
   (q_id)*Q_CTXT_SIZE)
...
#define SQ_CTXT_WQ_PAGE_SET(val, member)                                       \
  (((val)&SQ_CTXT_WQ_PAGE_##member##_MASK) << SQ_CTXT_WQ_PAGE_##member##_SHIFT)
...
#define RQ_CTXT_WQ_PAGE_SET(val, member)                                       \
  (((val)&RQ_CTXT_WQ_PAGE_##member##_MASK) << RQ_CTXT_WQ_PAGE_##member##_SHIFT)
