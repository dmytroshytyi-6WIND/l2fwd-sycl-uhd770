...
static struct ice_engine_list engine_list = TAILQ_HEAD_INITIALIZER(engine_list);
...
static struct rte_flow *ice_flow_create(struct rte_eth_dev *dev,
                                        ...
                                        const struct rte_flow_action actions[],
                                        struct rte_flow_error *error);
static int ice_flow_destroy(struct rte_eth_dev *dev, struct rte_flow *flow,
                            struct rte_flow_error *error);
static int ice_flow_flush(struct rte_eth_dev *dev,
                          struct rte_flow_error *error);
static int ice_flow_query(struct rte_eth_dev *dev, struct rte_flow *flow,
...
enum rte_flow_item_type pattern_eth_qinq_ipv4[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_VLAN,
...
enum rte_flow_item_type pattern_eth_qinq_ipv4_udp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,  RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_qinq_ipv4_tcp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_TCP,  RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_qinq_ipv4_sctp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_SCTP, RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_vlan_ipv4_icmp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_IPV4,
    RTE_FLOW_ITEM_TYPE_ICMP, RTE_FLOW_ITEM_TYPE_END,
};
enum rte_flow_item_type pattern_eth_qinq_ipv4_icmp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_ICMP, RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_qinq_ipv6_frag_ext[] = {
    RTE_FLOW_ITEM_TYPE_ETH,           RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_VLAN,          RTE_FLOW_ITEM_TYPE_IPV6,
...
enum rte_flow_item_type pattern_eth_qinq_ipv6_udp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_UDP,  RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_qinq_ipv6_tcp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_TCP,  RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_qinq_ipv6_sctp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_SCTP, RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_vlan_ipv6_icmp6[] = {
    RTE_FLOW_ITEM_TYPE_ETH,   RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_IPV6,
    RTE_FLOW_ITEM_TYPE_ICMP6, RTE_FLOW_ITEM_TYPE_END,
};
enum rte_flow_item_type pattern_eth_qinq_ipv6_icmp6[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_VLAN,  RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_ICMP6, RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_ipv4_udp_vxlan_ipv4[] = {
    ...
    RTE_FLOW_ITEM_TYPE_VXLAN, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_END,
};
enum rte_flow_item_type pattern_eth_ipv4_udp_vxlan_ipv4_udp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,   RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_VXLAN, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_END,
};
enum rte_flow_item_type pattern_eth_ipv4_udp_vxlan_ipv4_tcp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,   RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_VXLAN, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_TCP,
    RTE_FLOW_ITEM_TYPE_END,
};
enum rte_flow_item_type pattern_eth_ipv4_udp_vxlan_ipv4_sctp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,   RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_VXLAN, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_SCTP,
    RTE_FLOW_ITEM_TYPE_END,
};
enum rte_flow_item_type pattern_eth_ipv4_udp_vxlan_ipv4_icmp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,   RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_VXLAN, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_ICMP,
    RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_ipv4_udp_vxlan_eth_ipv4[] = {
    RTE_FLOW_ITEM_TYPE_ETH,   RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_VXLAN, RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_IPV4,
    RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_ipv4_udp_vxlan_ipv6[] = {
    RTE_FLOW_ITEM_TYPE_ETH,   RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_VXLAN, RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_END,
};
enum rte_flow_item_type pattern_eth_ipv4_udp_vxlan_ipv6_udp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,   RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_VXLAN, RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_END,
};
enum rte_flow_item_type pattern_eth_ipv4_udp_vxlan_ipv6_tcp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,   RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_VXLAN, RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_TCP,
    RTE_FLOW_ITEM_TYPE_END,
};
enum rte_flow_item_type pattern_eth_ipv4_udp_vxlan_ipv6_sctp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,   RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_VXLAN, RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_SCTP,
    RTE_FLOW_ITEM_TYPE_END,
};
enum rte_flow_item_type pattern_eth_ipv4_udp_vxlan_ipv6_icmp6[] = {
    RTE_FLOW_ITEM_TYPE_ETH,   RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_VXLAN, RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_ICMP6,
    RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_ipv4_udp_vxlan_eth_ipv6[] = {
    RTE_FLOW_ITEM_TYPE_ETH,   RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_VXLAN, RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_IPV6,
    RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_ipv4_nvgre_eth_ipv4[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_NVGRE,
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_ipv4_nvgre_eth_ipv4_icmp[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_NVGRE,
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_ICMP,
    RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_ipv4_nvgre_eth_ipv6[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_NVGRE,
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_ipv4_nvgre_eth_ipv6_icmp6[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_NVGRE,
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_ICMP6,
    RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_ipv4_gtpu_eh[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_IPV4,    RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_GTPU, RTE_FLOW_ITEM_TYPE_GTP_PSC, RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_ipv4_gtpu_ipv4_udp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_GTPU, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_END,
};

enum rte_flow_item_type pattern_eth_ipv4_gtpu_ipv4_tcp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_GTPU, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_TCP,
    RTE_FLOW_ITEM_TYPE_END,
};

enum rte_flow_item_type pattern_eth_ipv4_gtpu_ipv4_icmp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_GTPU, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_ICMP,
    RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_ipv4_gtpu_ipv6_udp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_GTPU, RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_END,
};

enum rte_flow_item_type pattern_eth_ipv4_gtpu_ipv6_tcp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_GTPU, RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_TCP,
    RTE_FLOW_ITEM_TYPE_END,
};

enum rte_flow_item_type pattern_eth_ipv4_gtpu_ipv6_icmp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_GTPU, RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_ICMP,
    RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_ipv4_gtpu_eh_ipv6[] = {
    RTE_FLOW_ITEM_TYPE_ETH,     RTE_FLOW_ITEM_TYPE_IPV4,
    RTE_FLOW_ITEM_TYPE_UDP,     RTE_FLOW_ITEM_TYPE_GTPU,
    RTE_FLOW_ITEM_TYPE_GTP_PSC, RTE_FLOW_ITEM_TYPE_IPV6,
    RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_qinq_pppoed[] = {
    RTE_FLOW_ITEM_TYPE_ETH,    RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_PPPOED, RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_vlan_pppoes_proto[] = {
    RTE_FLOW_ITEM_TYPE_ETH,    RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_PPPOES, RTE_FLOW_ITEM_TYPE_PPPOE_PROTO_ID,
    RTE_FLOW_ITEM_TYPE_END,
};
enum rte_flow_item_type pattern_eth_qinq_pppoes[] = {
    RTE_FLOW_ITEM_TYPE_ETH,    RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_PPPOES, RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_vlan_pppoes_ipv4[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_PPPOES,
    RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_END,
};
enum rte_flow_item_type pattern_eth_qinq_pppoes_ipv4[] = {
    RTE_FLOW_ITEM_TYPE_ETH,    RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_PPPOES, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_qinq_pppoes_ipv4_udp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,    RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_PPPOES, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_qinq_pppoes_ipv4_tcp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,    RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_PPPOES, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_TCP,
    RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_qinq_pppoes_ipv4_sctp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,    RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_PPPOES, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_SCTP,
    RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_qinq_pppoes_ipv4_icmp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,    RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_PPPOES, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_ICMP,
    RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_qinq_pppoes_ipv6[] = {
    RTE_FLOW_ITEM_TYPE_ETH,    RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_PPPOES, RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_END,
};
enum rte_flow_item_type pattern_eth_pppoes_ipv6_udp[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_PPPOES, RTE_FLOW_ITEM_TYPE_IPV6,
    RTE_FLOW_ITEM_TYPE_UDP, RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_qinq_pppoes_ipv6_udp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,    RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_PPPOES, RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_qinq_pppoes_ipv6_tcp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,    RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_PPPOES, RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_TCP,
    RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_qinq_pppoes_ipv6_sctp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,    RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_PPPOES, RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_SCTP,
    RTE_FLOW_ITEM_TYPE_END,
};
enum rte_flow_item_type pattern_eth_pppoes_ipv6_icmp6[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_PPPOES,
...
enum rte_flow_item_type pattern_eth_qinq_pppoes_ipv6_icmp6[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_PPPOES,
    RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_ICMP6,
    RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_ipv6_udp_ah[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_AH,  RTE_FLOW_ITEM_TYPE_END,
};
...
enum rte_flow_item_type pattern_eth_ipv4_pfcp[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_PFCP, RTE_FLOW_ITEM_TYPE_END,
};
...
typedef struct ice_flow_engine *(*parse_engine_t)(
    struct ice_adapter *ad, struct rte_flow *flow,
    struct ice_parser_list *parser_list, uint32_t priority,
    const struct rte_flow_item pattern[],
...
int ice_flow_init(struct ice_adapter *ad) {
  ...
  RTE_TAILQ_FOREACH_SAFE(engine, &engine_list, node, temp) {
    if (engine->init == NULL) {
      PMD_INIT_LOG(ERR, "Invalid engine type (%d)", engine->type);
      return -ENOTSUP;
    }

    ret = engine->init(ad);
    if (ret) {
      PMD_INIT_LOG(ERR, "Failed to initialize engine %d", engine->type);
      return ret;
    }
  }
  return 0;
...
ice_get_parser_list(struct ice_flow_parser *parser, struct ice_adapter *ad) {
  ...
  if (ad->devargs.pipe_mode_support) {
    ...
    if (parser->engine->type == ICE_FLOW_ENGINE_SWITCH) {
      RTE_TAILQ_FOREACH_SAFE(existing_node, list, node, temp) {
        if (existing_node->parser->engine->type == ICE_FLOW_ENGINE_ACL) {
          TAILQ_INSERT_AFTER(list, existing_node, parser_node, node);
          goto DONE;
        }
      }
      ...
      RTE_TAILQ_FOREACH_SAFE(existing_node, list, node, temp) {
        if (existing_node->parser->engine->type == ICE_FLOW_ENGINE_SWITCH) {
          TAILQ_INSERT_AFTER(list, existing_node, parser_node, node);
          goto DONE;
        }
      }
...
static int ice_flow_valid_attr(struct ice_adapter *ad,
                               const struct rte_flow_attr *attr,
  ...
  if (ad->devargs.pipe_mode_support) {
    if (attr->priority == 0)
      *ice_pipeline_stage = ICE_FLOW_CLASSIFY_STAGE_PERMISSION;
    else
      *ice_pipeline_stage = ICE_FLOW_CLASSIFY_STAGE_DISTRIBUTOR;
  } else {
    *ice_pipeline_stage = ICE_FLOW_CLASSIFY_STAGE_DISTRIBUTOR_ONLY;
    if (attr->priority > 1) {
...
static void ice_pattern_skip_void_item(struct rte_flow_item *items,
                                       const struct rte_flow_item *pattern) {
...
static bool ice_match_pattern(enum rte_flow_item_type *item_array,
                              const struct rte_flow_item *pattern) {
...
static bool ice_pattern_is_supported(__rte_unused struct ice_adapter *ad,
                                     const struct rte_flow_item *pattern) {
  uint16_t i;

  for (i = 0; i < RTE_DIM(ice_ptype_map); i++) {
    if (ice_match_pattern(ice_ptype_map[i].pattern_list, pattern)) {
      return ice_hw_ptype_ena(&ad->hw, ice_ptype_map[i].hw_ptype);
    }
  }
...
struct ice_pattern_match_item *ice_search_pattern_match_item(
    struct ice_adapter *ad, const struct rte_flow_item pattern[],
    struct ice_pattern_match_item *array, uint32_t array_len,
    struct rte_flow_error *error) {
  ...
  items =
      rte_zmalloc("ice_pattern", item_num * sizeof(struct rte_flow_item), 0);
  if (!items) {
  ...
  for (i = 0; i < array_len; i++) {
    if (ice_match_pattern(array[i].pattern_list, items)) {
      pattern_match_item->input_set_mask_o = array[i].input_set_mask_o;
      pattern_match_item->input_set_mask_i = array[i].input_set_mask_i;
      pattern_match_item->pattern_list = array[i].pattern_list;
...
ice_parse_engine_create(struct ice_adapter *ad, struct rte_flow *flow,
                        struct ice_parser_list *parser_list, uint32_t priority,
                        const struct rte_flow_item pattern[],
                        const struct rte_flow_action actions[],
                        struct rte_flow_error *error) {
  ...
  RTE_TAILQ_FOREACH_SAFE(parser_node, parser_list, node, temp) {
    ...
    if (parser_node->parser->parse_pattern_action(
            ad, parser_node->parser->array, parser_node->parser->array_len,
...
static struct ice_flow_engine *ice_parse_engine_validate(
    struct ice_adapter *ad, struct rte_flow *flow __rte_unused,
    struct ice_parser_list *parser_list, uint32_t priority,
    const struct rte_flow_item pattern[],
    const struct rte_flow_action actions[], struct rte_flow_error *error) {
  struct ice_flow_engine *engine = NULL;
...
static int ice_flow_process_filter(
    struct rte_eth_dev *dev, struct rte_flow *flow,
    const struct rte_flow_attr *attr, const struct rte_flow_item pattern[],
    const struct rte_flow_action actions[], struct ice_flow_engine **engine,
    parse_engine_t ice_parse_engine, struct rte_flow_error *error) {
  ...
  *engine = ice_parse_engine(ad, flow, &pf->rss_parser_list, attr->priority,
  ...
  case ICE_FLOW_CLASSIFY_STAGE_DISTRIBUTOR:
    *engine = ice_parse_engine(ad, flow, &pf->dist_parser_list, attr->priority,
                               pattern, actions, error);
    break;
  case ICE_FLOW_CLASSIFY_STAGE_PERMISSION:
    *engine = ice_parse_engine(ad, flow, &pf->perm_parser_list, attr->priority,
                               pattern, actions, error);
    break;
  default:
    return -EINVAL;
...
static int ice_flow_validate(struct rte_eth_dev *dev,
  ...
  return ice_flow_process_filter(dev, NULL, attr, pattern, actions, &engine,
                                 ice_parse_engine_validate, error);
}
...
static struct rte_flow *ice_flow_create(struct rte_eth_dev *dev,
  ...
  ret = ice_flow_process_filter(dev, flow, attr, pattern, actions, &engine,
                                ice_parse_engine_create, error);
  if (ret < 0) {
...
static int ice_flow_query(struct rte_eth_dev *dev, struct rte_flow *flow,
  ...
  for (; actions->type != RTE_FLOW_ACTION_TYPE_END; actions++) {
    ...
    case RTE_FLOW_ACTION_TYPE_COUNT:
      ...
      break;
    default:
      ret = rte_flow_error_set(error, ENOTSUP, RTE_FLOW_ERROR_TYPE_ACTION,
...
int ice_flow_redirect(struct ice_adapter *ad, struct ice_flow_redirect *rd) {
  struct ice_pf *pf = &ad->pf;
  struct rte_flow *p_flow;
  void *temp;
  int ret = 0;
