...
#define MSIX_TUADD(_i)                                                         \
  (0x00000004 + ((_i)*16)) /* _i=0...64 */ /* Reset Source: FLR */
#define MSIX_TUADD_MAX_INDEX 64
#define MSIX_TUADD_MSIXTUADD_S 0
#define MSIX_TUADD_MSIXTUADD_M MAKEMASK(0xFFFFFFFF, 0)
#define MSIX_TVCTRL(_i)                                                        \
  (0x0000000C + ((_i)*16)) /* _i=0...64 */ /* Reset Source: FLR */
...
#define PF0INT_DYN_CTL(_i)                                                     \
  (0x03000000 + ((_i)*4096)) /* _i=0...2047 */ /* Reset Source: CORER */
...
#define QRX_TAIL_PAGE(_QRX)                                                    \
  (0x03800000 + ((_QRX)*4096)) /* _i=0...2047 */ /* Reset Source: CORER */
#define QRX_TAIL_PAGE_MAX_INDEX 2047
#define QRX_TAIL_PAGE_TAIL_S 0
#define QRX_TAIL_PAGE_TAIL_M MAKEMASK(0x1FFF, 0)
#define QTX_COMM_DBELL_PAGE(_DBQM)                                             \
  (0x04000000 + ((_DBQM)*4096)) /* _i=0...16383 */ /* Reset Source: CORER */
...
#define QTX_COMM_DBLQ_DBELL_PAGE(_DBLQ)                                        \
  (0x02F00000 + ((_DBLQ)*4096)) /* _i=0...255 */ /* Reset Source: CORER */
...
#define VSI_MBX_ARQBAH(_VSI)                                                   \
  (0x02000018 + ((_VSI)*4096)) /* _i=0...767 */ /* Reset Source: CORER */
#define VSI_MBX_ARQBAH_MAX_INDEX 767
#define VSI_MBX_ARQBAH_ARQBAH_S 0
#define VSI_MBX_ARQBAH_ARQBAH_M MAKEMASK(0xFFFFFFFF, 0)
#define VSI_MBX_ARQBAL(_VSI)                                                   \
  (0x02000014 + ((_VSI)*4096)) /* _i=0...767 */ /* Reset Source: CORER */
...
#define VSI_MBX_ARQH(_VSI)                                                     \
  (0x02000020 + ((_VSI)*4096)) /* _i=0...767 */ /* Reset Source: CORER */
#define VSI_MBX_ARQH_MAX_INDEX 767
#define VSI_MBX_ARQH_ARQH_S 0
#define VSI_MBX_ARQH_ARQH_M MAKEMASK(0x3FF, 0)
#define VSI_MBX_ARQLEN(_VSI)                                                   \
  (0x0200001C + ((_VSI)*4096)) /* _i=0...767 */ /* Reset Source: PFR */
...
#define VSI_MBX_ATQT(_VSI)                                                     \
  (0x02000010 + ((_VSI)*4096)) /* _i=0...767 */ /* Reset Source: CORER */
...
#define GL_ACL_ACTMEM_ACT(_i)                                                  \
  (0x00393824 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GL_ACL_DEFAULT_ACT(_i)                                                 \
  (0x00391168 + ((_i)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define GL_ACL_PROFILE_BWSB_SEL(_i)                                            \
  (0x00391008 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GL_ACL_PROFILE_DWSB_SEL(_i)                                            \
  (0x00391088 + ((_i)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define GL_ACL_PROFILE_PF_CFG(_i)                                              \
  (0x003910C8 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GL_ACL_PROFILE_RC_CFG(_i)                                              \
  (0x003910E8 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GL_ACL_PROFILE_RCF_MASK(_i)                                            \
  (0x00391108 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GL_ACL_SCENARIO_ACT_CFG(_i)                                            \
  (0x003938AC + ((_i)*4)) /* _i=0...19 */ /* Reset Source: CORER */
...
#define GL_ACL_SCENARIO_CFG_H(_i)                                              \
  (0x0039386C + ((_i)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define GL_ACL_SCENARIO_CFG_L(_i)                                              \
  (0x0039382C + ((_i)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define GL_ACL_TCAM_KEY_INV_L_GL_ACL_FFU_TCAM_KEY_INV_L_M                      \
  MAKEMASK(0xFFFFFFFF, 0)
...
#define VSI_ACL_DEF_SEL(_VSI)                                                  \
  (0x00391800 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: CORER */
...
#define GL_SWT_L2TAGRXEB(_i)                                                   \
  (0x00052000 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GL_SWT_L2TAGTXIB(_i)                                                   \
  (0x000492E8 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLCOMM_CQ_CTL(_CQ)                                                     \
  (0x000F0000 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLCOMM_PKT_SHAPER_PROF(_i)                                             \
  (0x002D2DA8 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLCOMM_QTX_CNTX_DATA(_i)                                               \
  (0x002D2D40 + ((_i)*4)) /* _i=0...9 */ /* Reset Source: CORER */
...
#define GLCOMM_QUANTA_PROF(_i)                                                 \
  (0x002D2D68 + ((_i)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX0(_CQ)                                                  \
  (0x000F0800 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX1(_CQ)                                                  \
  (0x000F1000 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX10(_CQ)                                                 \
  (0x000F5800 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX11(_CQ)                                                 \
  (0x000F6000 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX12(_CQ)                                                 \
  (0x000F6800 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX13(_CQ)                                                 \
  (0x000F7000 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX14(_CQ)                                                 \
  (0x000F7800 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX15(_CQ)                                                 \
  (0x000F8000 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX16(_CQ)                                                 \
  (0x000F8800 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX17(_CQ)                                                 \
  (0x000F9000 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX18(_CQ)                                                 \
  (0x000F9800 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX19(_CQ)                                                 \
  (0x000FA000 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX2(_CQ)                                                  \
  (0x000F1800 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX20(_CQ)                                                 \
  (0x000FA800 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX21(_CQ)                                                 \
  (0x000FB000 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX3(_CQ)                                                  \
  (0x000F2000 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX4(_CQ)                                                  \
  (0x000F2800 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX5(_CQ)                                                  \
  (0x000F3000 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX6(_CQ)                                                  \
  (0x000F3800 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX7(_CQ)                                                  \
  (0x000F4000 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX8(_CQ)                                                  \
  (0x000F4800 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLTCLAN_CQ_CNTX9(_CQ)                                                  \
  (0x000F5000 + ((_CQ)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define QTX_COMM_DBELL(_DBQM)                                                  \
  (0x002C0000 + ((_DBQM)*4)) /* _i=0...16383 */ /* Reset Source: CORER */
...
#define QTX_COMM_DBLQ_CNTX(_i, _DBLQ)                                          \
  (0x002D0000 +                                                                \
   ((_i)*1024 +                                                                \
    (_DBLQ)*4)) /* _i=0...4, _DBLQ=0...255 */ /* Reset Source: CORER */
...
#define QTX_COMM_DBLQ_DBELL(_DBLQ)                                             \
  (0x002D1400 + ((_DBLQ)*4)) /* _i=0...255 */ /* Reset Source: CORER */
...
#define QTX_COMM_HEAD(_DBQM)                                                   \
  (0x000E0000 + ((_DBQM)*4)) /* _i=0...16383 */ /* Reset Source: CORER */
...
#define SB_REM_DEV_DEST(_i)                                                    \
  (0x002300F8 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define VF_MBX_ARQBAH(_VF)                                                     \
  (0x0022B800 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: CORER */
#define VF_MBX_ARQBAH_MAX_INDEX 255
#define VF_MBX_ARQBAH_ARQBAH_S 0
#define VF_MBX_ARQBAH_ARQBAH_M MAKEMASK(0xFFFFFFFF, 0)
#define VF_MBX_ARQBAL(_VF)                                                     \
  (0x0022B400 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: CORER */
...
#define VF_MBX_ARQH(_VF)                                                       \
  (0x0022C000 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: CORER */
#define VF_MBX_ARQH_MAX_INDEX 255
#define VF_MBX_ARQH_ARQH_S 0
#define VF_MBX_ARQH_ARQH_M MAKEMASK(0x3FF, 0)
#define VF_MBX_ARQLEN(_VF)                                                     \
  (0x0022BC00 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: PFR */
...
#define VF_MBX_ATQT(_VF)                                                       \
  (0x0022B000 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: CORER */
#define VF_MBX_ATQT_MAX_INDEX 255
#define VF_MBX_ATQT_ATQT_S 0
#define VF_MBX_ATQT_ATQT_M MAKEMASK(0x3FF, 0)
#define VF_MBX_CPM_ARQBAH(_VF128)                                              \
  (0x0022D400 + ((_VF128)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define VF_MBX_CPM_ARQBAL(_VF128)                                              \
  (0x0022D200 + ((_VF128)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define VF_MBX_CPM_ARQH(_VF128)                                                \
  (0x0022D800 + ((_VF128)*4)) /* _i=0...127 */ /* Reset Source: CORER */
#define VF_MBX_CPM_ARQH_MAX_INDEX 127
#define VF_MBX_CPM_ARQH_ARQH_S 0
#define VF_MBX_CPM_ARQH_ARQH_M MAKEMASK(0x3FF, 0)
#define VF_MBX_CPM_ARQLEN(_VF128)                                              \
  (0x0022D600 + ((_VF128)*4)) /* _i=0...127 */ /* Reset Source: PFR */
...
#define VF_MBX_CPM_ARQT(_VF128)                                                \
  (0x0022DA00 + ((_VF128)*4)) /* _i=0...127 */ /* Reset Source: CORER */
#define VF_MBX_CPM_ARQT_MAX_INDEX 127
#define VF_MBX_CPM_ARQT_ARQT_S 0
#define VF_MBX_CPM_ARQT_ARQT_M MAKEMASK(0x3FF, 0)
#define VF_MBX_CPM_ATQBAH(_VF128)                                              \
  (0x0022CA00 + ((_VF128)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define VF_MBX_CPM_ATQBAL(_VF128)                                              \
  (0x0022C800 + ((_VF128)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define VF_MBX_CPM_ATQH(_VF128)                                                \
  (0x0022CE00 + ((_VF128)*4)) /* _i=0...127 */ /* Reset Source: CORER */
#define VF_MBX_CPM_ATQH_MAX_INDEX 127
#define VF_MBX_CPM_ATQH_ATQH_S 0
#define VF_MBX_CPM_ATQH_ATQH_M MAKEMASK(0x3FF, 0)
#define VF_MBX_CPM_ATQLEN(_VF128)                                              \
  (0x0022CC00 + ((_VF128)*4)) /* _i=0...127 */ /* Reset Source: PFR */
...
#define VF_MBX_CPM_ATQT(_VF128)                                                \
  (0x0022D000 + ((_VF128)*4)) /* _i=0...127 */ /* Reset Source: CORER */
#define VF_MBX_CPM_ATQT_MAX_INDEX 127
#define VF_MBX_CPM_ATQT_ATQT_S 0
#define VF_MBX_CPM_ATQT_ATQT_M MAKEMASK(0x3FF, 0)
#define VF_MBX_HLP_ARQBAH(_VF16)                                               \
  (0x0022DD80 + ((_VF16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define VF_MBX_HLP_ARQBAL(_VF16)                                               \
  (0x0022DD40 + ((_VF16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define VF_MBX_HLP_ARQH(_VF16)                                                 \
  (0x0022DE00 + ((_VF16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
#define VF_MBX_HLP_ARQH_MAX_INDEX 15
#define VF_MBX_HLP_ARQH_ARQH_S 0
#define VF_MBX_HLP_ARQH_ARQH_M MAKEMASK(0x3FF, 0)
#define VF_MBX_HLP_ARQLEN(_VF16)                                               \
  (0x0022DDC0 + ((_VF16)*4)) /* _i=0...15 */ /* Reset Source: PFR */
...
#define VF_MBX_HLP_ARQT(_VF16)                                                 \
  (0x0022DE40 + ((_VF16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
#define VF_MBX_HLP_ARQT_MAX_INDEX 15
#define VF_MBX_HLP_ARQT_ARQT_S 0
#define VF_MBX_HLP_ARQT_ARQT_M MAKEMASK(0x3FF, 0)
#define VF_MBX_HLP_ATQBAH(_VF16)                                               \
  (0x0022DC40 + ((_VF16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define VF_MBX_HLP_ATQBAL(_VF16)                                               \
  (0x0022DC00 + ((_VF16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define VF_MBX_HLP_ATQH(_VF16)                                                 \
  (0x0022DCC0 + ((_VF16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
#define VF_MBX_HLP_ATQH_MAX_INDEX 15
#define VF_MBX_HLP_ATQH_ATQH_S 0
#define VF_MBX_HLP_ATQH_ATQH_M MAKEMASK(0x3FF, 0)
#define VF_MBX_HLP_ATQLEN(_VF16)                                               \
  (0x0022DC80 + ((_VF16)*4)) /* _i=0...15 */ /* Reset Source: PFR */
...
#define VF_MBX_HLP_ATQT(_VF16)                                                 \
  (0x0022DD00 + ((_VF16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
#define VF_MBX_HLP_ATQT_MAX_INDEX 15
#define VF_MBX_HLP_ATQT_ATQT_S 0
#define VF_MBX_HLP_ATQT_ATQT_M MAKEMASK(0x3FF, 0)
#define VF_MBX_PSM_ARQBAH(_VF16)                                               \
  (0x0022E000 + ((_VF16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define VF_MBX_PSM_ARQBAL(_VF16)                                               \
  (0x0022DFC0 + ((_VF16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define VF_MBX_PSM_ARQH(_VF16)                                                 \
  (0x0022E080 + ((_VF16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
#define VF_MBX_PSM_ARQH_MAX_INDEX 15
#define VF_MBX_PSM_ARQH_ARQH_S 0
#define VF_MBX_PSM_ARQH_ARQH_M MAKEMASK(0x3FF, 0)
#define VF_MBX_PSM_ARQLEN(_VF16)                                               \
  (0x0022E040 + ((_VF16)*4)) /* _i=0...15 */ /* Reset Source: PFR */
...
#define VF_MBX_PSM_ARQT(_VF16)                                                 \
  (0x0022E0C0 + ((_VF16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
#define VF_MBX_PSM_ARQT_MAX_INDEX 15
#define VF_MBX_PSM_ARQT_ARQT_S 0
#define VF_MBX_PSM_ARQT_ARQT_M MAKEMASK(0x3FF, 0)
#define VF_MBX_PSM_ATQBAH(_VF16)                                               \
  (0x0022DEC0 + ((_VF16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define VF_MBX_PSM_ATQBAL(_VF16)                                               \
  (0x0022DE80 + ((_VF16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define VF_MBX_PSM_ATQH(_VF16)                                                 \
  (0x0022DF40 + ((_VF16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
#define VF_MBX_PSM_ATQH_MAX_INDEX 15
#define VF_MBX_PSM_ATQH_ATQH_S 0
#define VF_MBX_PSM_ATQH_ATQH_M MAKEMASK(0x3FF, 0)
#define VF_MBX_PSM_ATQLEN(_VF16)                                               \
  (0x0022DF00 + ((_VF16)*4)) /* _i=0...15 */ /* Reset Source: PFR */
...
#define VF_MBX_PSM_ATQT(_VF16)                                                 \
  (0x0022DF80 + ((_VF16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
#define VF_MBX_PSM_ATQT_MAX_INDEX 15
#define VF_MBX_PSM_ATQT_ATQT_S 0
#define VF_MBX_PSM_ATQT_ATQT_M MAKEMASK(0x3FF, 0)
#define VF_SB_CPM_ARQBAH(_VF128)                                               \
  (0x0022F400 + ((_VF128)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define VF_SB_CPM_ARQBAL(_VF128)                                               \
  (0x0022F200 + ((_VF128)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define VF_SB_CPM_ARQH(_VF128)                                                 \
  (0x0022F800 + ((_VF128)*4)) /* _i=0...127 */ /* Reset Source: CORER */
#define VF_SB_CPM_ARQH_MAX_INDEX 127
#define VF_SB_CPM_ARQH_ARQH_S 0
#define VF_SB_CPM_ARQH_ARQH_M MAKEMASK(0x3FF, 0)
#define VF_SB_CPM_ARQLEN(_VF128)                                               \
  (0x0022F600 + ((_VF128)*4)) /* _i=0...127 */ /* Reset Source: PFR */
...
#define VF_SB_CPM_ARQT(_VF128)                                                 \
  (0x0022FA00 + ((_VF128)*4)) /* _i=0...127 */ /* Reset Source: CORER */
#define VF_SB_CPM_ARQT_MAX_INDEX 127
#define VF_SB_CPM_ARQT_ARQT_S 0
#define VF_SB_CPM_ARQT_ARQT_M MAKEMASK(0x3FF, 0)
#define VF_SB_CPM_ATQBAH(_VF128)                                               \
  (0x0022EA00 + ((_VF128)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define VF_SB_CPM_ATQBAL(_VF128)                                               \
  (0x0022E800 + ((_VF128)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define VF_SB_CPM_ATQH(_VF128)                                                 \
  (0x0022EE00 + ((_VF128)*4)) /* _i=0...127 */ /* Reset Source: CORER */
#define VF_SB_CPM_ATQH_MAX_INDEX 127
#define VF_SB_CPM_ATQH_ATQH_S 0
#define VF_SB_CPM_ATQH_ATQH_M MAKEMASK(0x3FF, 0)
#define VF_SB_CPM_ATQLEN(_VF128)                                               \
  (0x0022EC00 + ((_VF128)*4)) /* _i=0...127 */ /* Reset Source: PFR */
...
#define VF_SB_CPM_ATQT(_VF128)                                                 \
  (0x0022F000 + ((_VF128)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define VP_MBX_CPM_PF_VF_CTRL(_VP128)                                          \
  (0x00231800 + ((_VP128)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define VP_MBX_HLP_PF_VF_CTRL(_VP16)                                           \
  (0x00231A00 + ((_VP16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define VP_MBX_PF_VF_CTRL(_VSI)                                                \
  (0x00230800 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: CORER */
#define VP_MBX_PF_VF_CTRL_MAX_INDEX 767
#define VP_MBX_PF_VF_CTRL_QUEUE_EN_S 0
#define VP_MBX_PF_VF_CTRL_QUEUE_EN_M BIT(0)
#define VP_MBX_PSM_PF_VF_CTRL(_VP16)                                           \
  (0x00231A40 + ((_VP16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define VP_SB_CPM_PF_VF_CTRL(_VP128)                                           \
  (0x00231C00 + ((_VP128)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GL_DCB_TDSCP2TC_BLOCK_IPV4(_i)                                         \
  (0x00049018 + ((_i)*4)) /* _i=0...63 */ /* Reset Source: CORER */
...
#define GL_DCB_TDSCP2TC_BLOCK_IPV6(_i)                                         \
  (0x00049118 + ((_i)*4)) /* _i=0...63 */ /* Reset Source: CORER */
...
#define GLDCB_PRS_RETSTCC(_i)                                                  \
  (0x002000B0 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLDCB_RETSTCC(_i)                                                      \
  (0x00122140 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLDCB_RETSTCS(_i)                                                      \
  (0x001221C0 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLDCB_SWT_RETSTCC(_i)                                                  \
  (0x0020A040 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define PRTDCB_FCTTVN(_i)                                                      \
  (0x001E4580 + ((_i)*32)) /* _i=0...3 */ /* Reset Source: GLOBR */
...
#define PRTDCB_TPFCTS(_i)                                                      \
  (0x001E4660 + ((_i)*32)) /* _i=0...7 */ /* Reset Source: GLOBR */
...
#define PRTDCB_TX_DSCP2UP_IPV4_LUT(_i)                                         \
  (0x000409A0 + ((_i)*32)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define PRTDCB_TX_DSCP2UP_IPV6_LUT(_i)                                         \
  (0x00040AA0 + ((_i)*32)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define TCDCB_TCUPM_WAIT_CM(_i)                                                \
  (0x000BC520 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define TCDCB_TCUPM_WAIT_CTHR(_i)                                              \
  (0x000BC5A0 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define TCDCB_TCUPM_WAIT_DM(_i)                                                \
  (0x000BC620 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define TCDCB_TCUPM_WAIT_DTHR(_i)                                              \
  (0x000BC6A0 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define TCDCB_TCUPM_WAIT_PE_HB_DM(_i)                                          \
  (0x000BC720 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define TCDCB_TCUPM_WAIT_PE_HB_DTHR(_i)                                        \
  (0x000BC7A0 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define TCDCB_TLPM_WAIT_DM(_i)                                                 \
  (0x000A0080 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define TCDCB_TLPM_WAIT_DTHR(_i)                                               \
  (0x000A0100 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define TCTCB_WB_RL_TC_CFG(_i)                                                 \
  (0x000AE138 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define TCTCB_WB_RL_TC_STAT(_i)                                                \
  (0x000AE1B8 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define TPB_WB_RL_TC_CFG(_i)                                                   \
  (0x00099360 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define TPB_WB_RL_TC_STAT(_i)                                                  \
  (0x000993E0 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_CDMD_L1SEL(_i)                                               \
  (0x00210054 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_CTLTBL_L2ADDR(_i)                                            \
  (0x00210084 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_CTLTBL_L2DATA(_i)                                            \
  (0x00210090 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_DFLT_L2PRFL(_i)                                              \
  (0x00210138 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_DFLT_L2PRFL_ACL(_i)                                          \
  (0x00393800 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_FLGS_L1SEL0_1(_i)                                            \
  (0x0021006C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_FLGS_L1SEL2_3(_i)                                            \
  (0x00210078 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_FLGS_L1TBL(_i)                                               \
  (0x00210060 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_FORCE_L1CDID(_i)                                             \
  (0x00210018 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_FORCE_PID(_i)                                                \
  (0x00210000 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_K2N_L2ADDR(_i)                                               \
  (0x00210144 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_K2N_L2DATA(_i)                                               \
  (0x00210150 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_L2_PMASK0(_i)                                                \
  (0x002100FC + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_L2_PMASK1(_i)                                                \
  (0x00210108 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_L2_TMASK0(_i)                                                \
  (0x00210498 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_L2_TMASK1(_i)                                                \
  (0x002104A4 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_L2BMP0_3(_i)                                                 \
  (0x002100A8 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_L2BMP4_7(_i)                                                 \
  (0x002100B4 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_L2PRTMOD(_i)                                                 \
  (0x0021009C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_N2N_L2ADDR(_i)                                               \
  (0x0021015C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_N2N_L2DATA(_i)                                               \
  (0x00210168 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_P2P_L1ADDR(_i)                                               \
  (0x00210024 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_P2P_L1DATA(_i)                                               \
  (0x00210030 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_PID_L2GKTYPE(_i)                                             \
  (0x002100F0 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_PLVL_SEL(_i)                                                 \
  (0x0021000C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
#define GL_ACLEXT_PLVL_SEL_MAX_INDEX 2
#define GL_ACLEXT_PLVL_SEL_PLVL_SEL_S 0
#define GL_ACLEXT_PLVL_SEL_PLVL_SEL_M BIT(0)
#define GL_ACLEXT_TCAM_L2ADDR(_i)                                              \
  (0x00210114 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_TCAM_L2DATALSB(_i)                                           \
  (0x00210120 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_TCAM_L2DATAMSB(_i)                                           \
  (0x0021012C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_XLT0_L1ADDR(_i)                                              \
  (0x0021003C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_XLT0_L1DATA(_i)                                              \
  (0x00210048 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_XLT1_L2ADDR(_i)                                              \
  (0x002100C0 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_XLT1_L2DATA(_i)                                              \
  (0x002100CC + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_XLT2_L2ADDR(_i)                                              \
  (0x002100D8 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_ACLEXT_XLT2_L2DATA(_i)                                              \
  (0x002100E4 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_CDMD_L1SEL(_i)                                               \
  (0x0020F054 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_CTLTBL_L2ADDR(_i)                                            \
  (0x0020F084 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_CTLTBL_L2DATA(_i)                                            \
  (0x0020F090 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_DFLT_L2PRFL(_i)                                              \
  (0x0020F138 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_FLGS_L1SEL0_1(_i)                                            \
  (0x0020F06C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_FLGS_L1SEL2_3(_i)                                            \
  (0x0020F078 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_FLGS_L1TBL(_i)                                               \
  (0x0020F060 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_FORCE_L1CDID(_i)                                             \
  (0x0020F018 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_FORCE_PID(_i)                                                \
  (0x0020F000 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_K2N_L2ADDR(_i)                                               \
  (0x0020F144 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_K2N_L2DATA(_i)                                               \
  (0x0020F150 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_L2_PMASK0(_i)                                                \
  (0x0020F0FC + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_L2_PMASK1(_i)                                                \
  (0x0020F108 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_L2_TMASK0(_i)                                                \
  (0x0020F498 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_L2_TMASK1(_i)                                                \
  (0x0020F4A4 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_L2BMP0_3(_i)                                                 \
  (0x0020F0A8 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_L2BMP4_7(_i)                                                 \
  (0x0020F0B4 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_L2PRTMOD(_i)                                                 \
  (0x0020F09C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_N2N_L2ADDR(_i)                                               \
  (0x0020F15C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_N2N_L2DATA(_i)                                               \
  (0x0020F168 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_P2P_L1ADDR(_i)                                               \
  (0x0020F024 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_P2P_L1DATA(_i)                                               \
  (0x0020F030 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_PID_L2GKTYPE(_i)                                             \
  (0x0020F0F0 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_PLVL_SEL(_i)                                                 \
  (0x0020F00C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
#define GL_PREEXT_PLVL_SEL_MAX_INDEX 2
#define GL_PREEXT_PLVL_SEL_PLVL_SEL_S 0
#define GL_PREEXT_PLVL_SEL_PLVL_SEL_M BIT(0)
#define GL_PREEXT_TCAM_L2ADDR(_i)                                              \
  (0x0020F114 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_TCAM_L2DATALSB(_i)                                           \
  (0x0020F120 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_TCAM_L2DATAMSB(_i)                                           \
  (0x0020F12C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_XLT0_L1ADDR(_i)                                              \
  (0x0020F03C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_XLT0_L1DATA(_i)                                              \
  (0x0020F048 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_XLT1_L2ADDR(_i)                                              \
  (0x0020F0C0 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_XLT1_L2DATA(_i)                                              \
  (0x0020F0CC + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_XLT2_L2ADDR(_i)                                              \
  (0x0020F0D8 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PREEXT_XLT2_L2DATA(_i)                                              \
  (0x0020F0E4 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_CDMD_L1SEL(_i)                                               \
  (0x0020E054 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_CTLTBL_L2ADDR(_i)                                            \
  (0x0020E084 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_CTLTBL_L2DATA(_i)                                            \
  (0x0020E090 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_DFLT_L2PRFL(_i)                                              \
  (0x0020E138 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_FL15_BMPLSB(_i)                                              \
  (0x0020E480 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_FL15_BMPMSB(_i)                                              \
  (0x0020E48C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_FLGS_L1SEL0_1(_i)                                            \
  (0x0020E06C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_FLGS_L1SEL2_3(_i)                                            \
  (0x0020E078 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_FLGS_L1TBL(_i)                                               \
  (0x0020E060 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_FORCE_L1CDID(_i)                                             \
  (0x0020E018 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_FORCE_PID(_i)                                                \
  (0x0020E000 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_K2N_L2ADDR(_i)                                               \
  (0x0020E144 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_K2N_L2DATA(_i)                                               \
  (0x0020E150 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_L2_PMASK0(_i)                                                \
  (0x0020E0FC + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_L2_PMASK1(_i)                                                \
  (0x0020E108 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_L2_TMASK0(_i)                                                \
  (0x0020E498 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_L2_TMASK1(_i)                                                \
  (0x0020E4A4 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_L2PRTMOD(_i)                                                 \
  (0x0020E09C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_N2N_L2ADDR(_i)                                               \
  (0x0020E15C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_N2N_L2DATA(_i)                                               \
  (0x0020E168 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_P2P_L1ADDR(_i)                                               \
  (0x0020E024 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_P2P_L1DATA(_i)                                               \
  (0x0020E030 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_PID_L2GKTYPE(_i)                                             \
  (0x0020E0F0 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_PLVL_SEL(_i)                                                 \
  (0x0020E00C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
#define GL_PSTEXT_PLVL_SEL_MAX_INDEX 2
#define GL_PSTEXT_PLVL_SEL_PLVL_SEL_S 0
#define GL_PSTEXT_PLVL_SEL_PLVL_SEL_M BIT(0)
#define GL_PSTEXT_PRFLM_CTRL(_i)                                               \
  (0x0020E474 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_PRFLM_DATA_0(_i)                                             \
  (0x0020E174 + ((_i)*4)) /* _i=0...63 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_PRFLM_DATA_1(_i)                                             \
  (0x0020E274 + ((_i)*4)) /* _i=0...63 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_PRFLM_DATA_2(_i)                                             \
  (0x0020E374 + ((_i)*4)) /* _i=0...63 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_TCAM_L2ADDR(_i)                                              \
  (0x0020E114 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_TCAM_L2DATALSB(_i)                                           \
  (0x0020E120 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_TCAM_L2DATAMSB(_i)                                           \
  (0x0020E12C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_XLT0_L1ADDR(_i)                                              \
  (0x0020E03C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_XLT0_L1DATA(_i)                                              \
  (0x0020E048 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_XLT1_L2ADDR(_i)                                              \
  (0x0020E0C0 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_XLT1_L2DATA(_i)                                              \
  (0x0020E0CC + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_XLT2_L2ADDR(_i)                                              \
  (0x0020E0D8 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GL_PSTEXT_XLT2_L2DATA(_i)                                              \
  (0x0020E0E4 + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GLFLXP_PTYPE_TRANSLATION(_i)                                           \
  (0x0045C000 + ((_i)*4)) /* _i=0...255 */ /* Reset Source: CORER */
...
#define GLFLXP_RX_CMD_LX_PROT_IDX(_i)                                          \
  (0x0045C400 + ((_i)*4)) /* _i=0...255 */ /* Reset Source: CORER */
...
#define GLFLXP_RX_CMD_PROTIDS(_i, _j)                                          \
  (0x0045A000 +                                                                \
   ((_i)*4 + (_j)*1024)) /* _i=0...255, _j=0...5 */ /* Reset Source: CORER */
...
#define GLFLXP_RXDID_FLAGS(_i, _j)                                             \
  (0x0045D000 +                                                                \
   ((_i)*4 + (_j)*256)) /* _i=0...63, _j=0...4 */ /* Reset Source: CORER */
...
#define GLFLXP_RXDID_FLAGS1_OVERRIDE(_i)                                       \
  (0x0045D600 + ((_i)*4)) /* _i=0...63 */ /* Reset Source: CORER */
...
#define GLFLXP_RXDID_FLX_WRD_0(_i)                                             \
  (0x0045C800 + ((_i)*4)) /* _i=0...63 */ /* Reset Source: CORER */
...
#define GLFLXP_RXDID_FLX_WRD_1(_i)                                             \
  (0x0045C900 + ((_i)*4)) /* _i=0...63 */ /* Reset Source: CORER */
...
#define GLFLXP_RXDID_FLX_WRD_2(_i)                                             \
  (0x0045CA00 + ((_i)*4)) /* _i=0...63 */ /* Reset Source: CORER */
...
#define GLFLXP_RXDID_FLX_WRD_3(_i)                                             \
  (0x0045CB00 + ((_i)*4)) /* _i=0...63 */ /* Reset Source: CORER */
...
#define GLFLXP_RXDID_FLX_WRD_4(_i)                                             \
  (0x0045CC00 + ((_i)*4)) /* _i=0...63 */ /* Reset Source: CORER */
...
#define GLFLXP_RXDID_FLX_WRD_5(_i)                                             \
  (0x0045CD00 + ((_i)*4)) /* _i=0...63 */ /* Reset Source: CORER */
...
#define GLFLXP_TX_SCHED_CORRECT(_i, _j)                                        \
  (0x00458000 +                                                                \
   ((_i)*4 + (_j)*256)) /* _i=0...63, _j=0...31 */ /* Reset Source: CORER */
...
#define QRXFLXP_CNTXT(_QRX)                                                    \
  (0x00480000 + ((_QRX)*4)) /* _i=0...2047 */ /* Reset Source: CORER */
...
#define GL_TCVMLR_DRAIN_DONE_TCLAN(_i)                                         \
  (0x000A20A8 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GL_TCVMLR_DRAIN_DONE_TPB(_i)                                           \
  (0x000A2128 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLGEN_ANA_CFG_LU_KEY(_i)                                               \
  (0x0020C14C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GLGEN_ANA_CFG_RDDATA(_i)                                               \
  (0x0020C10C + ((_i)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define GLGEN_ANA_FLAG_MAP(_i)                                                 \
  (0x0020C000 + ((_i)*4)) /* _i=0...63 */ /* Reset Source: CORER */
...
#define GLGEN_ANA_LAST_PROT_ID(_i)                                             \
  (0x0020C1E4 + ((_i)*4)) /* _i=0...5 */ /* Reset Source: CORER */
...
#define GLGEN_ANA_NMPG_KEYMASK(_i)                                             \
  (0x0020C1D0 + ((_i)*4)) /* _i=0...3 */ /* Reset Source: CORER */
...
#define GLGEN_ANA_NMPG0_HASHKEY(_i)                                            \
  (0x0020C1B0 + ((_i)*4)) /* _i=0...3 */ /* Reset Source: CORER */
...
#define GLGEN_ANA_P2P(_i)                                                      \
  (0x0020C160 + ((_i)*4)) /* _i=0...15 */ /* Reset Source: CORER */
#define GLGEN_ANA_P2P_MAX_INDEX 15
#define GLGEN_ANA_P2P_TARGET_PROF_S 0
#define GLGEN_ANA_P2P_TARGET_PROF_M MAKEMASK(0xF, 0)
#define GLGEN_ANA_PG_KEYMASK(_i)                                               \
  (0x0020C1C0 + ((_i)*4)) /* _i=0...3 */ /* Reset Source: CORER */
...
#define GLGEN_ANA_PG0_HASHKEY(_i)                                              \
  (0x0020C1A0 + ((_i)*4)) /* _i=0...3 */ /* Reset Source: CORER */
...
#define GLGEN_ANA_TX_CFG_LU_KEY(_i)                                            \
  (0x0020D14C + ((_i)*4)) /* _i=0...2 */ /* Reset Source: CORER */
...
#define GLGEN_ANA_TX_CFG_RDDATA(_i)                                            \
  (0x0020D10C + ((_i)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define GLGEN_ANA_TX_FLAG_MAP(_i)                                              \
  (0x0020D000 + ((_i)*4)) /* _i=0...63 */ /* Reset Source: CORER */
...
#define GLGEN_ANA_TX_NMPG_KEYMASK(_i)                                          \
  (0x0020D1D0 + ((_i)*4)) /* _i=0...3 */ /* Reset Source: CORER */
...
#define GLGEN_ANA_TX_NMPG0_HASHKEY(_i)                                         \
  (0x0020D1B0 + ((_i)*4)) /* _i=0...3 */ /* Reset Source: CORER */
...
#define GLGEN_ANA_TX_P2P(_i)                                                   \
  (0x0020D160 + ((_i)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define GLGEN_ANA_TX_PG_KEYMASK(_i)                                            \
  (0x0020D1C0 + ((_i)*4)) /* _i=0...3 */ /* Reset Source: CORER */
...
#define GLGEN_ANA_TX_PG0_HASHKEY(_i)                                           \
  (0x0020D1A0 + ((_i)*4)) /* _i=0...3 */ /* Reset Source: CORER */
...
#define GLGEN_GPIO_CTL(_i)                                                     \
  (0x000880C8 + ((_i)*4)) /* _i=0...6 */ /* Reset Source: POR */
...
#define GLGEN_VFLRSTAT(_i)                                                     \
  (0x00093A04 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_CEQPART(_i)                                                      \
  (0x005031C0 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_DBCQPART(_i)                                                     \
  (0x00503180 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_DBQPPART(_i)                                                     \
  (0x005044C0 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_FSIAVBASE(_i)                                                    \
  (0x00525600 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_FSIAVCNT(_i)                                                     \
  (0x00525700 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_FSIMCBASE(_i)                                                    \
  (0x00526000 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_FSIMCCNT(_i)                                                     \
  (0x00526100 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEARPBASE(_i)                                                    \
  (0x00524800 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEARPCNT(_i)                                                     \
  (0x00524900 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PECQBASE(_i)                                                     \
  (0x00524200 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PECQCNT(_i)                                                      \
  (0x00524300 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEHDRBASE(_i)                                                    \
  (0x00526200 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEHDRCNT(_i)                                                     \
  (0x00526300 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEHTCNT(_i)                                                      \
  (0x00524700 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEHTCNT_FPMAT(_i)                                                \
  (0x00104700 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEHTEBASE(_i)                                                    \
  (0x00524600 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEHTEBASE_FPMAT(_i)                                              \
  (0x00104600 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEMDBASE(_i)                                                     \
  (0x00526400 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEMDCNT(_i)                                                      \
  (0x00526500 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEMRBASE(_i)                                                     \
  (0x00524C00 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEMRCNT(_i)                                                      \
  (0x00524D00 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEOOISCBASE(_i)                                                  \
  (0x00526600 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEOOISCCNT(_i)                                                   \
  (0x00526700 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEOOISCFFLBASE(_i)                                               \
  (0x00526C00 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEOOISCFFLCNT_PMAT(_i)                                           \
  (0x00526D00 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEPBLBASE(_i)                                                    \
  (0x00525800 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEPBLCNT(_i)                                                     \
  (0x00525900 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEQ1BASE(_i)                                                     \
  (0x00525200 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEQ1CNT(_i)                                                      \
  (0x00525300 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEQ1FLBASE(_i)                                                   \
  (0x00525400 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEQPBASE(_i)                                                     \
  (0x00524000 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEQPCNT(_i)                                                      \
  (0x00524100 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PERRFBASE(_i)                                                    \
  (0x00526800 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PERRFCNT(_i)                                                     \
  (0x00526900 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PERRFFLBASE(_i)                                                  \
  (0x00526A00 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PERRFFLCNT_PMAT(_i)                                              \
  (0x00526B00 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PETIMERBASE(_i)                                                  \
  (0x00525A00 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PETIMERCNT(_i)                                                   \
  (0x00525B00 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEXFBASE(_i)                                                     \
  (0x00524E00 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEXFCNT(_i)                                                      \
  (0x00524F00 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PEXFFLBASE(_i)                                                   \
  (0x00525000 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PFPESDPART(_i)                                                   \
  (0x00520880 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_PFPESDPART_FPMAT(_i)                                             \
  (0x00100880 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_SDPART(_i)                                                       \
  (0x00520800 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_SDPART_FPMAT(_i)                                                 \
  (0x00100800 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLHMC_VFAPBVTINUSEBASE(_i)                                             \
  (0x0052CA00 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFCEQPART(_i)                                                    \
  (0x00502F00 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFDBCQPART(_i)                                                   \
  (0x00502E00 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFDBQPPART(_i)                                                   \
  (0x00504520 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFFSIAVBASE(_i)                                                  \
  (0x0052D600 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFFSIAVCNT(_i)                                                   \
  (0x0052D700 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFFSIMCBASE(_i)                                                  \
  (0x0052E000 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFFSIMCCNT(_i)                                                   \
  (0x0052E100 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPDINV(_i)                                                      \
  (0x00528300 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPDINV_FPMAT(_i)                                                \
  (0x00108300 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEARPBASE(_i)                                                  \
  (0x0052C800 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEARPCNT(_i)                                                   \
  (0x0052C900 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPECQBASE(_i)                                                   \
  (0x0052C200 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPECQCNT(_i)                                                    \
  (0x0052C300 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEHDRBASE(_i)                                                  \
  (0x0052E200 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEHDRCNT(_i)                                                   \
  (0x0052E300 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEHTCNT(_i)                                                    \
  (0x0052C700 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEHTCNT_FPMAT(_i)                                              \
  (0x0010C700 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEHTEBASE(_i)                                                  \
  (0x0052C600 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEHTEBASE_FPMAT(_i)                                            \
  (0x0010C600 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEMDBASE(_i)                                                   \
  (0x0052E400 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEMDCNT(_i)                                                    \
  (0x0052E500 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEMRBASE(_i)                                                   \
  (0x0052CC00 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEMRCNT(_i)                                                    \
  (0x0052CD00 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEOOISCBASE(_i)                                                \
  (0x0052E600 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEOOISCCNT(_i)                                                 \
  (0x0052E700 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEOOISCFFLBASE(_i)                                             \
  (0x0052EC00 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEPBLBASE(_i)                                                  \
  (0x0052D800 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEPBLCNT(_i)                                                   \
  (0x0052D900 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEQ1BASE(_i)                                                   \
  (0x0052D200 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEQ1CNT(_i)                                                    \
  (0x0052D300 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEQ1FLBASE(_i)                                                 \
  (0x0052D400 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEQPBASE(_i)                                                   \
  (0x0052C000 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEQPCNT(_i)                                                    \
  (0x0052C100 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPERRFBASE(_i)                                                  \
  (0x0052E800 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPERRFCNT(_i)                                                   \
  (0x0052E900 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPERRFFLBASE(_i)                                                \
  (0x0052EA00 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPETIMERBASE(_i)                                                \
  (0x0052DA00 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPETIMERCNT(_i)                                                 \
  (0x0052DB00 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEXFBASE(_i)                                                   \
  (0x0052CE00 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEXFCNT(_i)                                                    \
  (0x0052CF00 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFPEXFFLBASE(_i)                                                 \
  (0x0052D000 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFSDDATAHIGH(_i)                                                 \
  (0x00528200 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFSDDATAHIGH_FPMAT(_i)                                           \
  (0x00108200 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFSDDATALOW(_i)                                                  \
  (0x00528100 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFSDDATALOW_FPMAT(_i)                                            \
  (0x00108100 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFSDPART(_i)                                                     \
  (0x00528800 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLHMC_VFSDPART_FPMAT(_i)                                               \
  (0x00108800 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLINT_CEQCTL(_INT)                                                     \
  (0x0015C000 + ((_INT)*4)) /* _i=0...2047 */ /* Reset Source: CORER */
...
#define GLINT_DYN_CTL(_INT)                                                    \
  (0x00160000 + ((_INT)*4)) /* _i=0...2047 */ /* Reset Source: CORER */
...
#define GLINT_ITR(_i, _INT)                                                    \
  (0x00154000 +                                                                \
   ((_i)*8192 +                                                                \
    (_INT)*4)) /* _i=0...2, _INT=0...2047 */ /* Reset Source: CORER */
...
#define GLINT_RATE(_INT)                                                       \
  (0x0015A000 + ((_INT)*4)) /* _i=0...2047 */ /* Reset Source: CORER */
...
#define GLINT_TSYN_PFMSTR(_i)                                                  \
  (0x0016CCC0 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLINT_VECT2FUNC(_INT)                                                  \
  (0x00162000 + ((_INT)*4)) /* _i=0...2047 */ /* Reset Source: CORER */
...
#define QINT_RQCTL(_QRX)                                                       \
  (0x00150000 + ((_QRX)*4)) /* _i=0...2047 */ /* Reset Source: CORER */
...
#define QINT_TQCTL(_DBQM)                                                      \
  (0x00140000 + ((_DBQM)*4)) /* _i=0...16383 */ /* Reset Source: CORER */
...
#define VPINT_AEQCTL(_VF)                                                      \
  (0x0016B800 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: CORER */
...
#define VPINT_ALLOC(_VF)                                                       \
  (0x001D1000 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: CORER */
...
#define VPINT_ALLOC_PCI(_VF)                                                   \
  (0x0009D000 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: PCIR */
...
#define VPINT_MBX_CPM_CTL(_VP128)                                              \
  (0x0016B000 + ((_VP128)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define VPINT_MBX_CTL(_VSI)                                                    \
  (0x0016A000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: CORER */
...
#define VPINT_MBX_HLP_CTL(_VP16)                                               \
  (0x0016B200 + ((_VP16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define VPINT_MBX_PSM_CTL(_VP16)                                               \
  (0x0016B240 + ((_VP16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define VPINT_SB_CPM_CTL(_VP128)                                               \
  (0x0016B400 + ((_VP128)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GL_HLP_PRT_IPG_PREAMBLE_SIZE(_i)                                       \
  (0x00049240 + ((_i)*4)) /* _i=0...20 */ /* Reset Source: CORER */
...
#define GL_TDPU_PSM_DEFAULT_RECIPE(_i)                                         \
  (0x00049294 + ((_i)*4)) /* _i=0...3 */ /* Reset Source: CORER */
...
#define GLLAN_PF_RECIPE(_i)                                                    \
  (0x0029420C + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define QRX_CONTEXT(_i, _QRX)                                                  \
  (0x00280000 +                                                                \
   ((_i)*8192 +                                                                \
    (_QRX)*4)) /* _i=0...7, _QRX=0...2047 */ /* Reset Source: CORER */
#define QRX_CONTEXT_MAX_INDEX 7
#define QRX_CONTEXT_RXQ_CONTEXT_S 0
#define QRX_CONTEXT_RXQ_CONTEXT_M MAKEMASK(0xFFFFFFFF, 0)
#define QRX_CTRL(_QRX)                                                         \
  (0x00120000 + ((_QRX)*4)) /* _i=0...2047 */ /* Reset Source: PFR */
...
#define QRX_ITR(_QRX)                                                          \
  (0x00292000 + ((_QRX)*4)) /* _i=0...2047 */ /* Reset Source: CORER */
#define QRX_ITR_MAX_INDEX 2047
#define QRX_ITR_NO_EXPR_S 0
#define QRX_ITR_NO_EXPR_M BIT(0)
#define QRX_TAIL(_QRX)                                                         \
  (0x00290000 + ((_QRX)*4)) /* _i=0...2047 */ /* Reset Source: CORER */
#define QRX_TAIL_MAX_INDEX 2047
#define QRX_TAIL_TAIL_S 0
#define QRX_TAIL_TAIL_M MAKEMASK(0x1FFF, 0)
#define VPDSI_RX_QTABLE(_i, _VP16)                                             \
  (0x00074C00 +                                                                \
   ((_i)*64 +                                                                  \
    (_VP16)*4)) /* _i=0...15, _VP16=0...15 */ /* Reset Source: CORER */
...
#define VPDSI_TX_QTABLE(_i, _VP16)                                             \
  (0x001D2000 +                                                                \
   ((_i)*64 +                                                                  \
    (_VP16)*4)) /* _i=0...15, _VP16=0...15 */ /* Reset Source: CORER */
...
#define VPLAN_DB_QTABLE(_i, _VF)                                               \
  (0x00070000 +                                                                \
   ((_i)*2048 +                                                                \
    (_VF)*4)) /* _i=0...3, _VF=0...255 */ /* Reset Source: CORER */
#define VPLAN_DB_QTABLE_MAX_INDEX 3
#define VPLAN_DB_QTABLE_QINDEX_S 0
#define VPLAN_DB_QTABLE_QINDEX_M MAKEMASK(0x1FF, 0)
#define VPLAN_DSI_VF_MODE(_VP16)                                               \
  (0x002D2C00 + ((_VP16)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define VPLAN_RX_QBASE(_VF)                                                    \
  (0x00072000 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: CORER */
...
#define VPLAN_TXQ_MAPENA(_VF)                                                  \
  (0x00073800 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: CORER */
#define VPLAN_TXQ_MAPENA_MAX_INDEX 255
#define VPLAN_TXQ_MAPENA_TX_ENA_S 0
#define VPLAN_TXQ_MAPENA_TX_ENA_M BIT(0)
#define VSILAN_QBASE(_VSI)                                                     \
  (0x0044C000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: PFR */
...
#define VSILAN_QTABLE(_i, _VSI)                                                \
  (0x00440000 +                                                                \
   ((_i)*4096 +                                                                \
    (_VSI)*4)) /* _i=0...7, _VSI=0...767 */ /* Reset Source: PFR */
...
#define PRTMAC_HSEC_CTL_RX_FORWARD_CONTROL                                     \
  0x001E36C0 /* Reset Source: GLOBR                                            \
              */
...
#define PRTMAC_HSEC_CTL_RX_PAUSE_DA_UCAST_PART1                                \
  0x001E3220 /* Reset Source: GLOBR */
#define PRTMAC_HSEC_CTL_RX_PAUSE_DA_UCAST_PART1_HSEC_CTL_RX_PAUSE_DA_UCAST_PART1_S \
  0
#define PRTMAC_HSEC_CTL_RX_PAUSE_DA_UCAST_PART1_HSEC_CTL_RX_PAUSE_DA_UCAST_PART1_M \
  MAKEMASK(0xFFFFFFFF, 0)
#define PRTMAC_HSEC_CTL_RX_PAUSE_DA_UCAST_PART2                                \
  0x001E3240 /* Reset Source: GLOBR */
#define PRTMAC_HSEC_CTL_RX_PAUSE_DA_UCAST_PART2_HSEC_CTL_RX_PAUSE_DA_UCAST_PART2_S \
  0
#define PRTMAC_HSEC_CTL_RX_PAUSE_DA_UCAST_PART2_HSEC_CTL_RX_PAUSE_DA_UCAST_PART2_M \
  MAKEMASK(0xFFFF, 0)
...
#define PRTMAC_HSEC_CTL_RX_PAUSE_ENABLE_HSEC_CTL_RX_PAUSE_ENABLE_M             \
  MAKEMASK(0x1FF, 0)
...
#define PRTMAC_HSEC_CTL_RX_PAUSE_SA_PART1_HSEC_CTL_RX_PAUSE_SA_PART1_M         \
  MAKEMASK(0xFFFFFFFF, 0)
...
#define PRTMAC_HSEC_CTL_RX_PAUSE_SA_PART2_HSEC_CTL_RX_PAUSE_SA_PART2_M         \
  MAKEMASK(0xFFFF, 0)
...
#define PRTMAC_HSEC_CTL_RX_QUANTA_SHIFT_PRTMAC_HSEC_CTL_RX_QUANTA_SHIFT_M      \
  MAKEMASK(0xFFFF, 0)
...
#define PRTMAC_HSEC_CTL_TX_PAUSE_QUANTA(_i)                                    \
  (0x001E36E0 + ((_i)*32)) /* _i=0...8 */ /* Reset Source: GLOBR */
...
#define PRTMAC_HSEC_CTL_TX_PAUSE_REFRESH_TIMER(_i)                             \
  (0x001E3800 + ((_i)*32)) /* _i=0...8 */ /* Reset Source: GLOBR */
...
#define PRTMAC_HSEC_CTL_TX_SA_PART1_HSEC_CTL_TX_SA_PART1_M                     \
  MAKEMASK(0xFFFFFFFF, 0)
...
#define PRTMAC_MD_OVRRIDE_ENABLE(_i)                                           \
  (0x001E3C60 + ((_i)*32)) /* _i=0...7 */ /* Reset Source: GLOBR */
#define PRTMAC_MD_OVRRIDE_ENABLE_MAX_INDEX 7
#define PRTMAC_MD_OVRRIDE_ENABLE_PRTMAC_MD_OVRRIDE_ENABLE_S 0
#define PRTMAC_MD_OVRRIDE_ENABLE_PRTMAC_MD_OVRRIDE_ENABLE_M                    \
  MAKEMASK(0xFFFFFFFF, 0)
#define PRTMAC_MD_OVRRIDE_VAL(_i)                                              \
  (0x001E3D60 + ((_i)*32)) /* _i=0...7 */ /* Reset Source: GLOBR */
...
#define VP_MDET_RX(_VF)                                                        \
  (0x00294400 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: CORER */
#define VP_MDET_RX_MAX_INDEX 255
#define VP_MDET_RX_VALID_S 0
#define VP_MDET_RX_VALID_M BIT(0)
#define VP_MDET_TX_PQM(_VF)                                                    \
  (0x002D2000 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: CORER */
#define VP_MDET_TX_PQM_MAX_INDEX 255
#define VP_MDET_TX_PQM_VALID_S 0
#define VP_MDET_TX_PQM_VALID_M BIT(0)
#define VP_MDET_TX_TCLAN(_VF)                                                  \
  (0x000FB800 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: CORER */
#define VP_MDET_TX_TCLAN_MAX_INDEX 255
#define VP_MDET_TX_TCLAN_VALID_S 0
#define VP_MDET_TX_TCLAN_VALID_M BIT(0)
#define VP_MDET_TX_TDPU(_VF)                                                   \
  (0x00040000 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: CORER */
#define VP_MDET_TX_TDPU_MAX_INDEX 255
#define VP_MDET_TX_TDPU_VALID_S 0
#define VP_MDET_TX_TDPU_VALID_M BIT(0)
#define GENERAL_MNG_FW_DBG_CSR(_i)                                             \
  (0x000B6180 + ((_i)*4)) /* _i=0...9 */ /* Reset Source: POR */
...
#define GL_MNG_SHA_EXTEND(_i)                                                  \
  (0x00083120 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: EMPR */
...
#define GL_MNG_SHA_EXTEND_ROM(_i)                                              \
  (0x00083160 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: EMPR */
...
#define GL_SWT_PRT2MDEF(_i)                                                    \
  (0x00216018 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: POR */
...
#define PRT_MNG_MAVTV(_i)                                                      \
  (0x00214780 + ((_i)*32)) /* _i=0...7 */ /* Reset Source: POR */
#define PRT_MNG_MAVTV_MAX_INDEX 7
#define PRT_MNG_MAVTV_VID_S 0
#define PRT_MNG_MAVTV_VID_M MAKEMASK(0xFFF, 0)
#define PRT_MNG_MDEF(_i)                                                       \
  (0x00214880 + ((_i)*32)) /* _i=0...7 */ /* Reset Source: POR */
...
#define PRT_MNG_MDEF_EXT(_i)                                                   \
  (0x00214A00 + ((_i)*32)) /* _i=0...7 */ /* Reset Source: POR */
...
#define PRT_MNG_MDEFVSI(_i)                                                    \
  (0x00214980 + ((_i)*32)) /* _i=0...3 */ /* Reset Source: POR */
...
#define PRT_MNG_METF(_i)                                                       \
  (0x00214120 + ((_i)*32)) /* _i=0...3 */ /* Reset Source: POR */
...
#define PRT_MNG_MFUTP(_i)                                                      \
  (0x00214320 + ((_i)*32)) /* _i=0...15 */ /* Reset Source: POR */
...
#define MSIX_TADD1(_i)                                                         \
  (0x00000000 + ((_i)*16)) /* _i=0...2047 */ /* Reset Source: FLR */
...
#define MSIX_TMSG(_i)                                                          \
  (0x00000008 + ((_i)*16)) /* _i=0...2047 */ /* Reset Source: FLR */
#define MSIX_TMSG_MAX_INDEX 2047
#define MSIX_TMSG_MSIXTMSG_S 0
#define MSIX_TMSG_MSIXTMSG_M MAKEMASK(0xFFFFFFFF, 0)
#define MSIX_TMSG_PAGE(_i)                                                     \
  (0x02E00008 + ((_i)*16)) /* _i=0...2047 */ /* Reset Source: FLR */
...
#define MSIX_TUADD_PAGE(_i)                                                    \
  (0x02E00004 + ((_i)*16)) /* _i=0...2047 */ /* Reset Source: FLR */
...
#define GLNVM_PROTCSR(_i)                                                      \
  (0x000B6010 + ((_i)*4)) /* _i=0...59 */ /* Reset Source: POR */
...
#define GL_COTF_MARKER_TRIG_RCU_PRS(_i)                                        \
  (0x002001D4 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GL_PRS_RX_PIPE_INIT0(_i)                                               \
  (0x0020000C + ((_i)*4)) /* _i=0...6 */ /* Reset Source: CORER */
...
#define GL_PRS_TX_PIPE_INIT0(_i)                                               \
  (0x00202018 + ((_i)*4)) /* _i=0...6 */ /* Reset Source: CORER */
...
#define GL_QH_MARKER_TRIG_RCU_PRS(_i)                                          \
  (0x002001C4 + ((_i)*4)) /* _i=0...3 */ /* Reset Source: CORER */
...
#define GL_TPRS_PM_CNT(_i)                                                     \
  (0x00202008 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GL_XLR_MARKER_LOG_RCU_PRS(_i)                                          \
  (0x00200208 + ((_i)*4)) /* _i=0...63 */ /* Reset Source: CORER */
...
#define GL_XLR_MARKER_STATUS(_i)                                               \
  (0x002001F4 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLPCI_GSCL_5_8(_i)                                                     \
  (0x0009E954 + ((_i)*4)) /* _i=0...3 */ /* Reset Source: PCIR */
...
#define GLPCI_GSCN_0_3(_i)                                                     \
  (0x0009E99C + ((_i)*4)) /* _i=0...3 */ /* Reset Source: PCIR */
...
#define PFPCI_VF_FLUSH_DONE(_VF)                                               \
  (0x0009E000 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: PCIR */
...
#define GLPE_MDQ_BASE(_i)                                                      \
  (0x00536000 + ((_i)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLPE_MDQ_PTR(_i)                                                       \
  (0x00537000 + ((_i)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLPE_MDQ_SIZE(_i)                                                      \
  (0x00536800 + ((_i)*4)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLPE_PEPM_THRESH(_i)                                                   \
  (0x0050C840 + ((_i)*4)) /* _i=0...511 */ /* Reset Source: PERST */
...
#define GLPE_PFAEQEDROPCNT(_i)                                                 \
  (0x00503240 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLPE_PFCEQEDROPCNT(_i)                                                 \
  (0x00503220 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLPE_PFCQEDROPCNT(_i)                                                  \
  (0x00503200 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLPE_PFFLMOOISCALLOCERR(_i)                                            \
  (0x0050B960 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLPE_PFFLMQ1ALLOCERR(_i)                                               \
  (0x0050B920 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLPE_PFFLMRRFALLOCERR(_i)                                              \
  (0x0050B940 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLPE_PFFLMXMITALLOCERR(_i)                                             \
  (0x0050B900 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLPE_PFTCPNOW50USCNT(_i)                                               \
  (0x0050B8C0 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLPE_VFAEQEDROPCNT(_i)                                                 \
  (0x00503100 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLPE_VFCEQEDROPCNT(_i)                                                 \
  (0x00503080 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLPE_VFCQEDROPCNT(_i)                                                  \
  (0x00503000 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLPE_VFFLMOOISCALLOCERR(_i)                                            \
  (0x0050B580 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLPE_VFFLMQ1ALLOCERR(_i)                                               \
  (0x0050B480 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLPE_VFFLMRRFALLOCERR(_i)                                              \
  (0x0050B500 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLPE_VFFLMXMITALLOCERR(_i)                                             \
  (0x0050B400 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLPE_VFTCPNOW50USCNT(_i)                                               \
  (0x0050B300 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: PE_CORER */
...
#define PRT_PEPM_COUNT(_i)                                                     \
  (0x0050C040 + ((_i)*4)) /* _i=0...511 */ /* Reset Source: PERST */
...
#define VFPE_AEQALLOC(_VF)                                                     \
  (0x00502800 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: PFR */
#define VFPE_AEQALLOC_MAX_INDEX 255
#define VFPE_AEQALLOC_AECOUNT_S 0
#define VFPE_AEQALLOC_AECOUNT_M MAKEMASK(0xFFFFFFFF, 0)
#define VFPE_CCQPHIGH(_VF)                                                     \
  (0x00508800 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: PFR */
...
#define VFPE_CCQPLOW(_VF)                                                      \
  (0x00508400 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: PFR */
#define VFPE_CCQPLOW_MAX_INDEX 255
#define VFPE_CCQPLOW_PECCQPLOW_S 0
#define VFPE_CCQPLOW_PECCQPLOW_M MAKEMASK(0xFFFFFFFF, 0)
#define VFPE_CCQPSTATUS(_VF)                                                   \
  (0x00508000 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: PFR */
...
#define VFPE_CQPTAIL(_VF)                                                      \
  (0x00500400 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: PFR */
...
#define VFPE_IPCONFIG0(_VF)                                                    \
  (0x00508C00 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: PFR */
...
#define VFPE_RCVUNEXPECTEDERROR(_VF)                                           \
  (0x00509C00 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: PFR */
...
#define VFPE_TCPNOWTIMER(_VF)                                                  \
  (0x00509400 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: PFR */
...
#define VFPE_WQEALLOC(_VF)                                                     \
  (0x00504000 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: PFR */
...
#define GLPES_PFIP4RXDISCARD(_i)                                               \
  (0x00541400 + ((_i)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4RXFRAGSHI(_i)                                               \
  (0x00541C04 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4RXFRAGSLO(_i)                                               \
  (0x00541C00 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4RXMCOCTSHI(_i)                                              \
  (0x00542404 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4RXMCOCTSLO(_i)                                              \
  (0x00542400 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4RXMCPKTSHI(_i)                                              \
  (0x00542C04 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4RXMCPKTSLO(_i)                                              \
  (0x00542C00 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4RXOCTSHI(_i)                                                \
  (0x00540404 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4RXOCTSLO(_i)                                                \
  (0x00540400 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4RXPKTSHI(_i)                                                \
  (0x00540C04 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4RXPKTSLO(_i)                                                \
  (0x00540C00 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4RXTRUNC(_i)                                                 \
  (0x00541800 + ((_i)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4TXFRAGSHI(_i)                                               \
  (0x00547404 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4TXFRAGSLO(_i)                                               \
  (0x00547400 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4TXMCOCTSHI(_i)                                              \
  (0x00547C04 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4TXMCOCTSLO(_i)                                              \
  (0x00547C00 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4TXMCPKTSHI(_i)                                              \
  (0x00548404 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4TXMCPKTSLO(_i)                                              \
  (0x00548400 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4TXNOROUTE(_i)                                               \
  (0x0054B400 + ((_i)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4TXOCTSHI(_i)                                                \
  (0x00546404 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4TXOCTSLO(_i)                                                \
  (0x00546400 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4TXPKTSHI(_i)                                                \
  (0x00546C04 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP4TXPKTSLO(_i)                                                \
  (0x00546C00 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6RXDISCARD(_i)                                               \
  (0x00544400 + ((_i)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6RXFRAGSHI(_i)                                               \
  (0x00544C04 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6RXFRAGSLO(_i)                                               \
  (0x00544C00 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6RXMCOCTSHI(_i)                                              \
  (0x00545404 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6RXMCOCTSLO(_i)                                              \
  (0x00545400 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6RXMCPKTSHI(_i)                                              \
  (0x00545C04 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6RXMCPKTSLO(_i)                                              \
  (0x00545C00 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6RXOCTSHI(_i)                                                \
  (0x00543404 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6RXOCTSLO(_i)                                                \
  (0x00543400 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6RXPKTSHI(_i)                                                \
  (0x00543C04 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6RXPKTSLO(_i)                                                \
  (0x00543C00 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6RXTRUNC(_i)                                                 \
  (0x00544800 + ((_i)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6TXFRAGSHI(_i)                                               \
  (0x00549C04 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6TXFRAGSLO(_i)                                               \
  (0x00549C00 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6TXMCOCTSHI(_i)                                              \
  (0x0054A404 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6TXMCOCTSLO(_i)                                              \
  (0x0054A400 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6TXMCPKTSHI(_i)                                              \
  (0x0054AC04 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6TXMCPKTSLO(_i)                                              \
  (0x0054AC00 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6TXNOROUTE(_i)                                               \
  (0x0054B800 + ((_i)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6TXOCTSHI(_i)                                                \
  (0x00548C04 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6TXOCTSLO(_i)                                                \
  (0x00548C00 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6TXPKTSHI(_i)                                                \
  (0x00549404 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFIP6TXPKTSLO(_i)                                                \
  (0x00549400 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFRDMARXRDSHI(_i)                                                \
  (0x0054EC04 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFRDMARXRDSLO(_i)                                                \
  (0x0054EC00 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFRDMARXSNDSHI(_i)                                               \
  (0x0054F404 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFRDMARXSNDSLO(_i)                                               \
  (0x0054F400 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFRDMARXWRSHI(_i)                                                \
  (0x0054E404 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFRDMARXWRSLO(_i)                                                \
  (0x0054E400 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFRDMATXRDSHI(_i)                                                \
  (0x00550404 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFRDMATXRDSLO(_i)                                                \
  (0x00550400 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFRDMATXSNDSHI(_i)                                               \
  (0x00550C04 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFRDMATXSNDSLO(_i)                                               \
  (0x00550C00 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFRDMATXWRSHI(_i)                                                \
  (0x0054FC04 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFRDMATXWRSLO(_i)                                                \
  (0x0054FC00 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFRDMAVBNDHI(_i)                                                 \
  (0x00551404 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFRDMAVBNDLO(_i)                                                 \
  (0x00551400 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFRDMAVINVHI(_i)                                                 \
  (0x00551C04 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFRDMAVINVLO(_i)                                                 \
  (0x00551C00 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFRXVLANERR(_i)                                                  \
  (0x00540000 + ((_i)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFTCPRTXSEG(_i)                                                  \
  (0x00552400 + ((_i)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFTCPRXOPTERR(_i)                                                \
  (0x0054C400 + ((_i)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFTCPRXPROTOERR(_i)                                              \
  (0x0054C800 + ((_i)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFTCPRXSEGSHI(_i)                                                \
  (0x0054BC04 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFTCPRXSEGSLO(_i)                                                \
  (0x0054BC00 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFTCPTXSEGHI(_i)                                                 \
  (0x0054CC04 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFTCPTXSEGLO(_i)                                                 \
  (0x0054CC00 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFUDPRXPKTSHI(_i)                                                \
  (0x0054D404 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFUDPRXPKTSLO(_i)                                                \
  (0x0054D400 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFUDPTXPKTSHI(_i)                                                \
  (0x0054DC04 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPES_PFUDPTXPKTSLO(_i)                                                \
  (0x0054DC00 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GL_PWR_MODE_DIVIDE_CTRL_H_DEFAULT_DEFAULT_DIV_VAL_PECLK_M              \
  MAKEMASK(0x7, 0)
#define GL_PWR_MODE_DIVIDE_CTRL_H_DEFAULT_DEFAULT_DIV_VAL_UCLK_S 3
#define GL_PWR_MODE_DIVIDE_CTRL_H_DEFAULT_DEFAULT_DIV_VAL_UCLK_M               \
  MAKEMASK(0x7, 3)
#define GL_PWR_MODE_DIVIDE_CTRL_H_DEFAULT_DEFAULT_DIV_VAL_LCLK_S 6
#define GL_PWR_MODE_DIVIDE_CTRL_H_DEFAULT_DEFAULT_DIV_VAL_LCLK_M               \
  MAKEMASK(0x7, 6)
...
#define GL_PWR_MODE_DIVIDE_CTRL_H_DEFAULT_DEFAULT_DIV_VAL_RXCTL_M              \
  MAKEMASK(0x7, 12)
#define GL_PWR_MODE_DIVIDE_CTRL_H_DEFAULT_DEFAULT_DIV_VAL_UANA_S 15
#define GL_PWR_MODE_DIVIDE_CTRL_H_DEFAULT_DEFAULT_DIV_VAL_UANA_M               \
  MAKEMASK(0x7, 15)
...
#define GL_PWR_MODE_DIVIDE_CTRL_L_DEFAULT_DEFAULT_DIV_VAL_PECLK_M              \
  MAKEMASK(0x7, 0)
#define GL_PWR_MODE_DIVIDE_CTRL_L_DEFAULT_DEFAULT_DIV_VAL_UCLK_S 3
#define GL_PWR_MODE_DIVIDE_CTRL_L_DEFAULT_DEFAULT_DIV_VAL_UCLK_M               \
  MAKEMASK(0x7, 3)
#define GL_PWR_MODE_DIVIDE_CTRL_L_DEFAULT_DEFAULT_DIV_VAL_LCLK_S 6
#define GL_PWR_MODE_DIVIDE_CTRL_L_DEFAULT_DEFAULT_DIV_VAL_LCLK_M               \
  MAKEMASK(0x7, 6)
...
#define GL_PWR_MODE_DIVIDE_CTRL_L_DEFAULT_DEFAULT_DIV_VAL_RXCTL_M              \
  MAKEMASK(0x7, 12)
#define GL_PWR_MODE_DIVIDE_CTRL_L_DEFAULT_DEFAULT_DIV_VAL_UANA_S 15
#define GL_PWR_MODE_DIVIDE_CTRL_L_DEFAULT_DEFAULT_DIV_VAL_UANA_M               \
  MAKEMASK(0x7, 15)
...
#define GL_PWR_MODE_DIVIDE_CTRL_M_DEFAULT_DEFAULT_DIV_VAL_PECLK_M              \
  MAKEMASK(0x7, 0)
#define GL_PWR_MODE_DIVIDE_CTRL_M_DEFAULT_DEFAULT_DIV_VAL_UCLK_S 3
#define GL_PWR_MODE_DIVIDE_CTRL_M_DEFAULT_DEFAULT_DIV_VAL_UCLK_M               \
  MAKEMASK(0x7, 3)
#define GL_PWR_MODE_DIVIDE_CTRL_M_DEFAULT_DEFAULT_DIV_VAL_LCLK_S 6
#define GL_PWR_MODE_DIVIDE_CTRL_M_DEFAULT_DEFAULT_DIV_VAL_LCLK_M               \
  MAKEMASK(0x7, 6)
...
#define GL_PWR_MODE_DIVIDE_CTRL_M_DEFAULT_DEFAULT_DIV_VAL_RXCTL_M              \
  MAKEMASK(0x7, 12)
#define GL_PWR_MODE_DIVIDE_CTRL_M_DEFAULT_DEFAULT_DIV_VAL_UANA_S 15
#define GL_PWR_MODE_DIVIDE_CTRL_M_DEFAULT_DEFAULT_DIV_VAL_UANA_M               \
  MAKEMASK(0x7, 15)
...
#define GL_PWR_MODE_DIVIDE_S0_CTRL_H_PECLK_DIV_VAL_TBW_A50G_H_M                \
  MAKEMASK(0xF, 12)
...
#define GL_PWR_MODE_DIVIDE_S0_CTRL_H_RXCTL_DIV_VAL_TBW_A50G_H_M                \
  MAKEMASK(0xF, 12)
...
#define GL_PWR_MODE_DIVIDE_S0_CTRL_L_PECLK_DIV_VAL_TBW_A50G_L_M                \
  MAKEMASK(0x7, 12)
...
#define GL_PWR_MODE_DIVIDE_S0_CTRL_L_RXCTL_DIV_VAL_TBW_A50G_L_M                \
  MAKEMASK(0x7, 12)
...
#define GL_PWR_MODE_DIVIDE_S0_CTRL_M_PECLK_DIV_VAL_TBW_A50G_M_M                \
  MAKEMASK(0x7, 12)
...
#define GL_PWR_MODE_DIVIDE_S0_CTRL_M_RXCTL_DIV_VAL_TBW_A50G_M_M                \
  MAKEMASK(0x7, 12)
...
#define GLQF_FDEVICTENA(_i)                                                    \
  (0x00452000 + ((_i)*4)) /* _i=0...3 */ /* Reset Source: CORER */
...
#define GLQF_FDINSET(_i, _j)                                                   \
  (0x00412000 +                                                                \
   ((_i)*4 + (_j)*512)) /* _i=0...127, _j=0...5 */ /* Reset Source: CORER */
...
#define GLQF_FDMASK(_i)                                                        \
  (0x00410800 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLQF_FDMASK_SEL(_i)                                                    \
  (0x00410400 + ((_i)*4)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLQF_HKEY(_i)                                                          \
  (0x00456000 + ((_i)*4)) /* _i=0...12 */ /* Reset Source: CORER */
...
#define GLQF_HLUT(_i, _j)                                                      \
  (0x00438000 +                                                                \
   ((_i)*4 + (_j)*512)) /* _i=0...127, _j=0...15 */ /* Reset Source: CORER */
...
#define GLQF_HLUT_SIZE(_i)                                                     \
  (0x00455400 + ((_i)*4)) /* _i=0...15 */ /* Reset Source: CORER */
#define GLQF_HLUT_SIZE_MAX_INDEX 15
#define GLQF_HLUT_SIZE_HSIZE_S 0
#define GLQF_HLUT_SIZE_HSIZE_M BIT(0)
#define GLQF_HMASK(_i)                                                         \
  (0x0040FC00 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLQF_HMASK_SEL(_i)                                                     \
  (0x00410000 + ((_i)*4)) /* _i=0...127 */ /* Reset Source: CORER */
#define GLQF_HMASK_SEL_MAX_INDEX 127
#define GLQF_HMASK_SEL_MASK_SEL_S 0
#define GLQF_HMASK_SEL_MASK_SEL_M MAKEMASK(0xFFFFFFFF, 0)
#define GLQF_HSYMM(_i, _j)                                                     \
  (0x0040F000 +                                                                \
   ((_i)*4 + (_j)*512)) /* _i=0...127, _j=0...5 */ /* Reset Source: CORER */
...
#define GLQF_PE_CTL2(_i)                                                       \
  (0x00455200 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLQF_PEINSET(_i, _j)                                                   \
  (0x00415000 +                                                                \
   ((_i)*4 + (_j)*128)) /* _i=0...31, _j=0...5 */ /* Reset Source: CORER */
...
#define GLQF_PEMASK(_i)                                                        \
  (0x00415400 + ((_i)*4)) /* _i=0...15 */ /* Reset Source: CORER */
...
#define GLQF_PEMASK_SEL(_i)                                                    \
  (0x00415500 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLQF_PETABLE_CLR(_i)                                                   \
  (0x000AA078 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLQF_PROF2TC(_i, _j)                                                   \
  (0x0044D000 +                                                                \
   ((_i)*4 + (_j)*512)) /* _i=0...127, _j=0...3 */ /* Reset Source: CORER */
...
#define PFQF_HLUT(_i)                                                          \
  (0x00430000 + ((_i)*64)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLDCB_RTCTQ(_i)                                                        \
  (0x001222C0 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLDCB_RTCTS(_i)                                                        \
  (0x00122340 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
#define GLDCB_RTCTS_MAX_INDEX 31
#define GLDCB_RTCTS_PFCTIMER_S 0
#define GLDCB_RTCTS_PFCTIMER_M MAKEMASK(0x3FFF, 0)
#define GLRCB_CFG_COTF_CNT(_i)                                                 \
  (0x001223D4 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GL_STAT_SWR_BPCH(_i)                                                   \
  (0x00347804 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
#define GL_STAT_SWR_BPCH_MAX_INDEX 127
#define GL_STAT_SWR_BPCH_VLBPCH_S 0
#define GL_STAT_SWR_BPCH_VLBPCH_M MAKEMASK(0xFF, 0)
#define GL_STAT_SWR_BPCL(_i)                                                   \
  (0x00347800 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GL_STAT_SWR_GORCH(_i)                                                  \
  (0x00342004 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
#define GL_STAT_SWR_GORCH_MAX_INDEX 127
#define GL_STAT_SWR_GORCH_VLBCH_S 0
#define GL_STAT_SWR_GORCH_VLBCH_M MAKEMASK(0xFF, 0)
#define GL_STAT_SWR_GORCL(_i)                                                  \
  (0x00342000 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GL_STAT_SWR_GOTCH(_i)                                                  \
  (0x00304004 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
#define GL_STAT_SWR_GOTCH_MAX_INDEX 127
#define GL_STAT_SWR_GOTCH_VLBCH_S 0
#define GL_STAT_SWR_GOTCH_VLBCH_M MAKEMASK(0xFF, 0)
#define GL_STAT_SWR_GOTCL(_i)                                                  \
  (0x00304000 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GL_STAT_SWR_MPCH(_i)                                                   \
  (0x00347404 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
#define GL_STAT_SWR_MPCH_MAX_INDEX 127
#define GL_STAT_SWR_MPCH_VLMPCH_S 0
#define GL_STAT_SWR_MPCH_VLMPCH_M MAKEMASK(0xFF, 0)
#define GL_STAT_SWR_MPCL(_i)                                                   \
  (0x00347400 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GL_STAT_SWR_UPCH(_i)                                                   \
  (0x00347004 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
#define GL_STAT_SWR_UPCH_MAX_INDEX 127
#define GL_STAT_SWR_UPCH_VLUPCH_S 0
#define GL_STAT_SWR_UPCH_VLUPCH_M MAKEMASK(0xFF, 0)
#define GL_STAT_SWR_UPCL(_i)                                                   \
  (0x00347000 + ((_i)*8)) /* _i=0...127 */ /* Reset Source: CORER */
...
#define GLPRT_LXOFFRXC(_i)                                                     \
  (0x003802C0 + ((_i)*8)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLPRT_LXOFFRXC_H(_i)                                                   \
  (0x003802C4 + ((_i)*8)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLPRT_LXOFFTXC(_i)                                                     \
  (0x00381180 + ((_i)*8)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLPRT_LXOFFTXC_H(_i)                                                   \
  (0x00381184 + ((_i)*8)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLPRT_LXONRXC(_i)                                                      \
  (0x00380280 + ((_i)*8)) /* _i=0...7 */ /* Reset Source: CORER */
#define GLPRT_LXONRXC_MAX_INDEX 7
#define GLPRT_LXONRXC_LXONRXCNT_S 0
#define GLPRT_LXONRXC_LXONRXCNT_M MAKEMASK(0xFFFFFFFF, 0)
#define GLPRT_LXONRXC_H(_i)                                                    \
  (0x00380284 + ((_i)*8)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLPRT_LXONTXC(_i)                                                      \
  (0x00381140 + ((_i)*8)) /* _i=0...7 */ /* Reset Source: CORER */
#define GLPRT_LXONTXC_MAX_INDEX 7
#define GLPRT_LXONTXC_LXONTXC_S 0
#define GLPRT_LXONTXC_LXONTXC_M MAKEMASK(0xFFFFFFFF, 0)
#define GLPRT_LXONTXC_H(_i)                                                    \
  (0x00381144 + ((_i)*8)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLPRT_PTC1023H(_i)                                                     \
  (0x00380C84 + ((_i)*8)) /* _i=0...7 */ /* Reset Source: CORER */
#define GLPRT_PTC1023H_MAX_INDEX 7
#define GLPRT_PTC1023H_PTC1023H_S 0
#define GLPRT_PTC1023H_PTC1023H_M MAKEMASK(0xFF, 0)
#define GLPRT_PTC1023L(_i)                                                     \
  (0x00380C80 + ((_i)*8)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define GLPRT_PXOFFRXC(_i, _j)                                                 \
  (0x00380500 +                                                                \
   ((_i)*8 + (_j)*64)) /* _i=0...7, _j=0...7 */ /* Reset Source: CORER */
...
#define GLPRT_RXON2OFFCNT_H(_i, _j)                                            \
  (0x00380704 +                                                                \
   ((_i)*8 + (_j)*64)) /* _i=0...7, _j=0...7 */ /* Reset Source: CORER */
...
#define GLSTAT_ACL_CNT_0_L(_i)                                                 \
  (0x00388000 + ((_i)*8)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLSTAT_ACL_CNT_1_H(_i)                                                 \
  (0x00389004 + ((_i)*8)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLSTAT_ACL_CNT_1_L(_i)                                                 \
  (0x00389000 + ((_i)*8)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLSTAT_ACL_CNT_2_H(_i)                                                 \
  (0x0038A004 + ((_i)*8)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLSTAT_ACL_CNT_2_L(_i)                                                 \
  (0x0038A000 + ((_i)*8)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLSTAT_ACL_CNT_3_H(_i)                                                 \
  (0x0038B004 + ((_i)*8)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLSTAT_ACL_CNT_3_L(_i)                                                 \
  (0x0038B000 + ((_i)*8)) /* _i=0...511 */ /* Reset Source: CORER */
...
#define GLSTAT_FD_CNT0H(_i)                                                    \
  (0x003A0004 + ((_i)*8)) /* _i=0...4095 */ /* Reset Source: CORER */
...
#define GLSTAT_FD_CNT0L(_i)                                                    \
  (0x003A0000 + ((_i)*8)) /* _i=0...4095 */ /* Reset Source: CORER */
...
#define GLSTAT_FD_CNT1H(_i)                                                    \
  (0x003A8004 + ((_i)*8)) /* _i=0...4095 */ /* Reset Source: CORER */
...
#define GLSTAT_FD_CNT1L(_i)                                                    \
  (0x003A8000 + ((_i)*8)) /* _i=0...4095 */ /* Reset Source: CORER */
...
#define PRTTPB_STAT_TC_BYTES_SENTL(_i)                                         \
  (0x00098200 + ((_i)*4)) /* _i=0...63 */ /* Reset Source: CORER */
...
#define TPB_PRTTPB_STAT_PKT_SENT(_i)                                           \
  (0x00099470 + ((_i)*4)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define TPB_PRTTPB_STAT_TC_BYTES_SENT(_i)                                      \
  (0x00099094 + ((_i)*4)) /* _i=0...63 */ /* Reset Source: CORER */
...
#define GL_PRE_CFG_DATA(_i)                                                    \
  (0x00214074 + ((_i)*4)) /* _i=0...6 */ /* Reset Source: CORER */
...
#define GL_SWT_FW_STS(_i)                                                      \
  (0x00216000 + ((_i)*4)) /* _i=0...5 */ /* Reset Source: CORER */
...
#define GL_SWT_MIRTARVSI(_i)                                                   \
  (0x00204500 + ((_i)*4)) /* _i=0...63 */ /* Reset Source: CORER */
...
#define GL_VP_SWITCHID(_i)                                                     \
  (0x00214094 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
#define GL_VP_SWITCHID_MAX_INDEX 31
#define GL_VP_SWITCHID_SWITCHID_S 0
#define GL_VP_SWITCHID_SWITCHID_M MAKEMASK(0xFF, 0)
#define GLSWID_STAT_BLOCK(_i)                                                  \
  (0x0020A1A4 + ((_i)*4)) /* _i=0...255 */ /* Reset Source: PFR */
...
#define PRT_TCTUPR(_i)                                                         \
  (0x00040840 + ((_i)*4)) /* _i=0...31 */ /* Reset Source: CORER */
...
#define GLTSYN_AUX_IN_0(_i)                                                    \
  (0x000889D8 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_AUX_IN_1(_i)                                                    \
  (0x000889E0 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_AUX_IN_2(_i)                                                    \
  (0x000889E8 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_AUX_OUT_0(_i)                                                   \
  (0x00088998 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_AUX_OUT_1(_i)                                                   \
  (0x000889A0 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_AUX_OUT_2(_i)                                                   \
  (0x000889A8 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_AUX_OUT_3(_i)                                                   \
  (0x000889B0 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_ENA(_i)                                                         \
  (0x00088808 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
#define GLTSYN_ENA_MAX_INDEX 1
#define GLTSYN_ENA_TSYN_ENA_S 0
#define GLTSYN_ENA_TSYN_ENA_M BIT(0)
#define GLTSYN_EVNT_H_0(_i)                                                    \
  (0x00088970 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_EVNT_H_1(_i)                                                    \
  (0x00088980 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_EVNT_H_2(_i)                                                    \
  (0x00088990 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_EVNT_L_0(_i)                                                    \
  (0x00088968 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_EVNT_L_1(_i)                                                    \
  (0x00088978 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_EVNT_L_2(_i)                                                    \
  (0x00088988 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_HHTIME_H(_i)                                                    \
  (0x00088900 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_HHTIME_L(_i)                                                    \
  (0x000888F8 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_INCVAL_H(_i)                                                    \
  (0x00088920 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
#define GLTSYN_INCVAL_H_MAX_INDEX 1
#define GLTSYN_INCVAL_H_INCVAL_H_S 0
#define GLTSYN_INCVAL_H_INCVAL_H_M MAKEMASK(0xFF, 0)
#define GLTSYN_INCVAL_L(_i)                                                    \
  (0x00088918 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_SHADJ_H(_i)                                                     \
  (0x00088910 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_SHADJ_L(_i)                                                     \
  (0x00088908 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_SHTIME_0(_i)                                                    \
  (0x000888E0 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_SHTIME_H(_i)                                                    \
  (0x000888F0 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_SHTIME_L(_i)                                                    \
  (0x000888E8 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_STAT(_i)                                                        \
  (0x000888C0 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_TGT_H_0(_i)                                                     \
  (0x00088930 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_TGT_H_1(_i)                                                     \
  (0x00088940 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_TGT_H_2(_i)                                                     \
  (0x00088950 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_TGT_H_3(_i)                                                     \
  (0x00088960 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_TGT_L_0(_i)                                                     \
  (0x00088928 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_TGT_L_1(_i)                                                     \
  (0x00088938 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_TGT_L_2(_i)                                                     \
  (0x00088948 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_TGT_L_3(_i)                                                     \
  (0x00088958 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_TIME_0(_i)                                                      \
  (0x000888C8 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_TIME_H(_i)                                                      \
  (0x000888D8 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLTSYN_TIME_L(_i)                                                      \
  (0x000888D0 + ((_i)*4)) /* _i=0...1 */ /* Reset Source: CORER */
...
#define GLPE_TSCD_FLR(_i)                                                      \
  (0x0051E24C + ((_i)*4)) /* _i=0...3 */ /* Reset Source: CORER */
...
#define VSI_L2TAGSTXVALID(_VSI)                                                \
  (0x00046000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: CORER */
...
#define VSI_PASID(_VSI)                                                        \
  (0x0009C000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: PFR */
...
#define VSI_RUPR(_VSI)                                                         \
  (0x00050000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: CORER */
...
#define VSI_RXSWCTRL(_VSI)                                                     \
  (0x00205000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: CORER */
...
#define VSI_SRCSWCTRL(_VSI)                                                    \
  (0x00209000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: CORER */
...
#define VSI_SWITCHID(_VSI)                                                     \
  (0x00215000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: CORER */
#define VSI_SWITCHID_MAX_INDEX 767
#define VSI_SWITCHID_SWITCHID_S 0
#define VSI_SWITCHID_SWITCHID_M MAKEMASK(0xFF, 0)
#define VSI_SWT_MIREG(_VSI)                                                    \
  (0x00207000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: CORER */
...
#define VSI_SWT_MIRIG(_VSI)                                                    \
  (0x00208000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: CORER */
...
#define VSI_TAIR(_VSI)                                                         \
  (0x00044000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: PFR */
#define VSI_TAIR_MAX_INDEX 767
#define VSI_TAIR_PORT_TAG_ID_S 0
#define VSI_TAIR_PORT_TAG_ID_M MAKEMASK(0xFFFF, 0)
#define VSI_TAR(_VSI)                                                          \
  (0x00045000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: CORER */
...
#define VSI_TUPIOM(_VSI)                                                       \
  (0x00048000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: CORER */
...
#define VSI_TUPR(_VSI)                                                         \
  (0x00047000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: CORER */
...
#define VSI_VSI2F(_VSI)                                                        \
  (0x001D0000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: PFR */
...
#define VSIQF_FD_CNT(_VSI)                                                     \
  (0x00464000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: PFR */
...
#define VSIQF_FD_CTL1(_VSI)                                                    \
  (0x00411000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: CORER */
...
#define VSIQF_FD_DFLT(_VSI)                                                    \
  (0x00457000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: CORER */
...
#define VSIQF_FD_SIZE(_VSI)                                                    \
  (0x00462000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: CORER */
...
#define VSIQF_HASH_CTL(_VSI)                                                   \
  (0x0040D000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: CORER */
...
#define VSIQF_HKEY(_i, _VSI)                                                   \
  (0x00400000 +                                                                \
   ((_i)*4096 +                                                                \
    (_VSI)*4)) /* _i=0...12, _VSI=0...767 */ /* Reset Source: PFR */
...
#define VSIQF_HLUT(_i, _VSI)                                                   \
  (0x00420000 +                                                                \
   ((_i)*4096 +                                                                \
    (_VSI)*4)) /* _i=0...15, _VSI=0...767 */ /* Reset Source: PFR */
...
#define VSIQF_PE_CTL1(_VSI)                                                    \
  (0x00414000 + ((_VSI)*4)) /* _i=0...767 */ /* Reset Source: CORER */
#define VSIQF_PE_CTL1_MAX_INDEX 767
#define VSIQF_PE_CTL1_PE_FLTENA_S 0
#define VSIQF_PE_CTL1_PE_FLTENA_M BIT(0)
#define VSIQF_TC_REGION(_i, _VSI)                                              \
  (0x00448000 +                                                                \
   ((_i)*4096 +                                                                \
    (_VSI)*4)) /* _i=0...3, _VSI=0...767 */ /* Reset Source: CORER */
...
#define PRTPM_SAH(_i)                                                          \
  (0x001E3BA0 + ((_i)*32)) /* _i=0...3 */ /* Reset Source: PFR */
...
#define PRTPM_SAL(_i)                                                          \
  (0x001E3B20 + ((_i)*32)) /* _i=0...3 */ /* Reset Source: PFR */
...
#define VFINT_DYN_CTLN(_i)                                                     \
  (0x00003800 + ((_i)*4)) /* _i=0...63 */ /* Reset Source: CORER */
...
#define VFINT_DYN_CTL(_i)                                                      \
  (0x00023000 + ((_i)*4096)) /* _i=0...7 */ /* Reset Source: CORER */
...
#define VFQTX_COMM_DBLQ_DBELL(_DBLQ)                                           \
  (0x00022000 + ((_DBLQ)*4)) /* _i=0...3 */ /* Reset Source: CORER */
...
#define MSIX_TMSG1(_i)                                                         \
  (0x00000008 + ((_i)*16)) /* _i=0...64 */ /* Reset Source: FLR */
...
#define VFPE_MRTEIDXMASK1(_VF)                                                 \
  (0x00509800 + ((_VF)*4)) /* _i=0...255 */ /* Reset Source: PFR */
