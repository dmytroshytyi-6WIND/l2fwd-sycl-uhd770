 ...
 */
enum ice_status ice_aq_alloc_acl_tbl(struct ice_hw *hw,
                                     struct ice_acl_alloc_tbl *tbl,
                                     struct ice_sq_cd *cd) {
 ...
 */
enum ice_status ice_aq_dealloc_acl_tbl(struct ice_hw *hw, u16 alloc_id,
...
static enum ice_status ice_aq_acl_entry(struct ice_hw *hw, u16 opcode,
                                        u8 tcam_idx, u16 entry_idx,
 ...
 */
enum ice_status ice_aq_program_acl_entry(struct ice_hw *hw, u8 tcam_idx,
                                         u16 entry_idx,
                                         struct ice_aqc_acl_data *buf,
                                         struct ice_sq_cd *cd) {
 ...
 */
enum ice_status ice_aq_query_acl_entry(struct ice_hw *hw, u8 tcam_idx,
                                       u16 entry_idx,
                                       struct ice_aqc_acl_data *buf,
                                       struct ice_sq_cd *cd) {
  return ice_aq_acl_entry(hw, ice_aqc_opc_query_acl_entry, tcam_idx, entry_idx,
                          buf, cd);
}

/* Helper function to alloc/dealloc ACL action pair */
static enum ice_status ice_aq_actpair_a_d(struct ice_hw *hw, u16 opcode,
                                          u16 alloc_id,
                                          struct ice_aqc_acl_generic *buf,
                                          struct ice_sq_cd *cd) {
  struct ice_aqc_acl_tbl_actpair *cmd;
 ...
 */
enum ice_status ice_aq_alloc_actpair(struct ice_hw *hw, u16 alloc_id,
                                     struct ice_aqc_acl_generic *buf,
                                     struct ice_sq_cd *cd) {
  return ice_aq_actpair_a_d(hw, ice_aqc_opc_alloc_acl_actpair, alloc_id, buf,
                            cd);
}
 ...
 */
enum ice_status ice_aq_dealloc_actpair(struct ice_hw *hw, u16 alloc_id,
                                       struct ice_aqc_acl_generic *buf,
                                       struct ice_sq_cd *cd) {
  return ice_aq_actpair_a_d(hw, ice_aqc_opc_dealloc_acl_actpair, alloc_id, buf,
                            cd);
}

/* Helper function to program/query ACL action pair */
static enum ice_status ice_aq_actpair_p_q(struct ice_hw *hw, u16 opcode,
                                          u8 act_mem_idx, u16 act_entry_idx,
                                          struct ice_aqc_actpair *buf,
                                          struct ice_sq_cd *cd) {
 ...
 */
enum ice_status ice_aq_program_actpair(struct ice_hw *hw, u8 act_mem_idx,
                                       u16 act_entry_idx,
                                       struct ice_aqc_actpair *buf,
                                       struct ice_sq_cd *cd) {
  return ice_aq_actpair_p_q(hw, ice_aqc_opc_program_acl_actpair, act_mem_idx,
                            act_entry_idx, buf, cd);
}
 ...
 */
enum ice_status ice_aq_query_actpair(struct ice_hw *hw, u8 act_mem_idx,
                                     u16 act_entry_idx,
                                     struct ice_aqc_actpair *buf,
                                     struct ice_sq_cd *cd) {
  return ice_aq_actpair_p_q(hw, ice_aqc_opc_query_acl_actpair, act_mem_idx,
                            act_entry_idx, buf, cd);
}
 ...
 */
enum ice_status ice_aq_dealloc_acl_res(struct ice_hw *hw,
                                       struct ice_sq_cd *cd) {
  struct ice_aq_desc desc;
 ...
 */
enum ice_status ice_query_acl_prof(struct ice_hw *hw, u8 prof_id,
                                   struct ice_aqc_acl_prof_generic_frmt *buf,
                                   struct ice_sq_cd *cd) {
  return ice_acl_prof_aq_send(hw, ice_aqc_opc_query_acl_prof, prof_id, buf, cd);
}
 ...
 */
static enum ice_status
ice_aq_acl_cntrs_chk_params(struct ice_acl_cntrs *cntrs) {
 ...
 */
enum ice_status ice_aq_alloc_acl_cntrs(struct ice_hw *hw,
 ...
 */
enum ice_status ice_aq_dealloc_acl_cntrs(struct ice_hw *hw,
                                         struct ice_acl_cntrs *cntrs,
                                         struct ice_sq_cd *cd) {
 ...
 */
enum ice_status ice_prog_acl_prof_ranges(struct ice_hw *hw, u8 prof_id,
                                         struct ice_aqc_acl_profile_ranges *buf,
                                         struct ice_sq_cd *cd) {
  struct ice_aq_desc desc;

  ice_fill_dflt_direct_cmd_desc(&desc, ice_aqc_opc_program_acl_prof_ranges);
  desc.params.profile.profile_id = prof_id;
  desc.flags |= CPU_TO_LE16(ICE_AQ_FLAG_RD);
  return ice_aq_send_cmd(hw, &desc, buf, sizeof(*buf), cd);
}
 ...
 */
enum ice_status ice_aq_alloc_acl_scen(struct ice_hw *hw, u16 *scen_id,
 ...
 */
enum ice_status ice_aq_dealloc_acl_scen(struct ice_hw *hw, u16 scen_id,
                                        struct ice_sq_cd *cd) {
 ...
 */
static enum ice_status ice_aq_update_query_scen(struct ice_hw *hw, u16 opcode,
                                                u16 scen_id,
                                                struct ice_aqc_acl_scen *buf,
                                                struct ice_sq_cd *cd) {
 ...
 */
enum ice_status ice_aq_update_acl_scen(struct ice_hw *hw, u16 scen_id,
                                       struct ice_aqc_acl_scen *buf,
                                       struct ice_sq_cd *cd) {
  return ice_aq_update_query_scen(hw, ice_aqc_opc_update_acl_scen, scen_id, buf,
                                  cd);
}
 ...
 */
enum ice_status ice_aq_query_acl_scen(struct ice_hw *hw, u16 scen_id,
                                      struct ice_aqc_acl_scen *buf,
                                      struct ice_sq_cd *cd) {
  return ice_aq_update_query_scen(hw, ice_aqc_opc_query_acl_scen, scen_id, buf,
                                  cd);
}
