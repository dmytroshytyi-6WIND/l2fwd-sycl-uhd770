...
#define ICE_FXD_FLTR_QW0_STAT_CNT_M (0x1FFFULL << ICE_FXD_FLTR_QW0_STAT_CNT_S)
...
#define ICE_FXD_FLTR_QW0_DPU_RECIPE_M (0x3ULL << ICE_FXD_FLTR_QW0_DPU_RECIPE_S)
...
#define ICE_FXD_FLTR_QW0_FLEX_VAL_M (0xFFFFULL << ICE_FXD_FLTR_QW0_FLEX_VAL_S)
...
#define ICE_FXD_FLTR_QW1_FDID_M (0xFFFFFFFFULL << ICE_FXD_FLTR_QW1_FDID_S)
...
#define ICE_FXD_FLTR_WB_QW1_PROG_ID_M (0x3ULL << ICE_FXD_FLTR_WB_QW1_PROG_ID_S)
...
#define ICE_RXD_QW1_STATUS_M                                                   \
  ((BIT(ICE_RX_DESC_STATUS_LAST) - 1) << ICE_RXD_QW1_STATUS_S)
...
enum ice_rx_flex_desc_umb_cast_bits { /* field is 2 bits long */
                                      ...
                                      ICE_RX_FLEX_DESC_UMB_CAST_LAST /* this
                                                                        entry
                                                                        must be
                                                                        last!!!
                                                                      */
...
enum ice_rx_flex_desc_sph_bits { /* field is 1 bit long */
                                 ...
                                 ICE_RX_FLEX_DESC_SPH_LAST /* this entry must be
                                                              last!!! */
};
...
enum ice_rx_flex_desc_ext_status_bits { /* field is 4 bits long */
                                        ...
                                        ICE_RX_FLEX_DESC_EXT_STATUS_OVERSIZE_S =
                                            15,
                                        ICE_RX_FLEX_DESC_EXT_STATUS_LAST /* entry
                                                                            must
                                                                            be
                                                                            last!!!
                                                                          */
...
#define ICE_CTX_STORE(_struct, _ele, _width, _lsb)                             \
  {                                                                            \
    ...
    .size_of = FIELD_SIZEOF(struct _struct, _ele), .width = _width,            \
    .lsb = _lsb,                                                               \
  }
...
#define ICE_TXD_MACLEN_MAX                                                     \
  ((ICE_TXD_QW1_MACLEN_M >> ICE_TX_DESC_LEN_MACLEN_S) * ICE_BYTES_PER_WORD)
#define ICE_TXD_IPLEN_MAX                                                      \
  ((ICE_TXD_QW1_IPLEN_M >> ICE_TX_DESC_LEN_IPLEN_S) * ICE_BYTES_PER_DWORD)
#define ICE_TXD_L4LEN_MAX                                                      \
  ((ICE_TXD_QW1_L4LEN_M >> ICE_TX_DESC_LEN_L4_LEN_S) * ICE_BYTES_PER_DWORD)
...
#define ICE_TXD_CTX_QW1_TSO_LEN_M (0x3FFFFULL << ICE_TXD_CTX_QW1_TSO_LEN_S)
...
#define ICE_PTT(PTYPE, OUTER_IP, OUTER_IP_VER, OUTER_FRAG, T, TE, TEF, I, PL)  \
  {                                                                            \
    1, ICE_RX_PTYPE_OUTER_##OUTER_IP, ICE_RX_PTYPE_OUTER_##OUTER_IP_VER,       \
        ICE_RX_PTYPE_##OUTER_FRAG, ICE_RX_PTYPE_TUNNEL_##T,                    \
        ICE_RX_PTYPE_TUNNEL_END_##TE, ICE_RX_PTYPE_##TEF,                      \
        ICE_RX_PTYPE_INNER_PROT_##I, ICE_RX_PTYPE_PAYLOAD_LAYER_##PL           \
  }
