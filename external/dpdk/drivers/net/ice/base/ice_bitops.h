...
static inline bool ice_is_bit_set(const ice_bitmap_t *bitmap, u16 nr) {
  return ice_is_bit_set_internal(BIT_IN_CHUNK(nr), &bitmap[BIT_CHUNK(nr)]);
}
 ...
 * of the bitmap.
 */
static inline bool ice_test_and_clear_bit(u16 nr, ice_bitmap_t *bitmap) {
 ...
 * the bitmap.
 */
static inline bool ice_test_and_set_bit(u16 nr, ice_bitmap_t *bitmap) {
 ...
 * non-zero.
 */
static inline int ice_and_bitmap(ice_bitmap_t *dst, const ice_bitmap_t *bmp1,
 ...
 */
static inline void ice_or_bitmap(ice_bitmap_t *dst, const ice_bitmap_t *bmp1,
                                 const ice_bitmap_t *bmp2, u16 size) {
  ice_bitmap_t mask;
  u16 i;
 ...
 * size as the "source" bitmaps to avoid buffer overflows.
 */
static inline void ice_xor_bitmap(ice_bitmap_t *dst, const ice_bitmap_t *bmp1,
                                  const ice_bitmap_t *bmp2, u16 size) {
  ice_bitmap_t mask;
  u16 i;
 ...
 */
static inline void ice_andnot_bitmap(ice_bitmap_t *dst,
                                     const ice_bitmap_t *bmp1,
                                     const ice_bitmap_t *bmp2, u16 size) {
  ice_bitmap_t mask;
  u16 i;
 ...
 */
static inline u16 ice_find_next_bit(const ice_bitmap_t *bitmap, u16 size,
                                    u16 offset) {
  u16 i, j;
 ...
 */
static inline void ice_cp_bitmap(ice_bitmap_t *dst, ice_bitmap_t *src,
                                 u16 size) {
 ...
 * ice_declare_bitmap.
 */
static inline void ice_bitmap_set(ice_bitmap_t *dst, u16 pos, u16 num_bits) {
  u16 i;
 ...
 * ice_declare_bitmap.
 */
static inline int ice_bitmap_hweight(ice_bitmap_t *bm, u16 size) {
  int count = 0;
  u16 bit = 0;
 ...
 */
static inline bool ice_cmp_bitmap(ice_bitmap_t *bmp1, ice_bitmap_t *bmp2,
                                  u16 size) {
  ice_bitmap_t mask;
  u16 i;
 ...
 */
static inline void ice_bitmap_from_array32(ice_bitmap_t *dst, u32 *src,
                                           u16 size) {
