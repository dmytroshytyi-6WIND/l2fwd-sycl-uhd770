...
#define ICE_FLOW_HASH_ETH                                                      \
  (BIT_ULL(ICE_FLOW_FIELD_IDX_ETH_DA) | BIT_ULL(ICE_FLOW_FIELD_IDX_ETH_SA))
#define ICE_FLOW_HASH_IPV4                                                     \
  (BIT_ULL(ICE_FLOW_FIELD_IDX_IPV4_SA) | BIT_ULL(ICE_FLOW_FIELD_IDX_IPV4_DA))
#define ICE_FLOW_HASH_IPV6                                                     \
  (BIT_ULL(ICE_FLOW_FIELD_IDX_IPV6_SA) | BIT_ULL(ICE_FLOW_FIELD_IDX_IPV6_DA))
...
#define ICE_FLOW_HASH_VXLAN_VNI (BIT_ULL(ICE_FLOW_FIELD_IDX_VXLAN_VNI))

#define ICE_FLOW_HASH_GTP_TEID (BIT_ULL(ICE_FLOW_FIELD_IDX_GTPC_TEID))
...
#define ICE_FLOW_HASH_GTP_U_TEID (BIT_ULL(ICE_FLOW_FIELD_IDX_GTPU_IP_TEID))
...
#define ICE_FLOW_HASH_GTP_U_EH_TEID (BIT_ULL(ICE_FLOW_FIELD_IDX_GTPU_EH_TEID))

#define ICE_FLOW_HASH_GTP_U_EH_QFI (BIT_ULL(ICE_FLOW_FIELD_IDX_GTPU_EH_QFI))
...
#define ICE_FLOW_HASH_PPPOE_SESS_ID (BIT_ULL(ICE_FLOW_FIELD_IDX_PPPOE_SESS_ID))
...
#define ICE_FLOW_HASH_PFCP_SEID (BIT_ULL(ICE_FLOW_FIELD_IDX_PFCP_SEID))
...
#define ICE_FLOW_HASH_ESP_SPI (BIT_ULL(ICE_FLOW_FIELD_IDX_ESP_SPI))
#define ICE_FLOW_HASH_ESP_IPV4_SPI (ICE_FLOW_HASH_IPV4 | ICE_FLOW_HASH_ESP_SPI)
#define ICE_FLOW_HASH_ESP_IPV6_SPI (ICE_FLOW_HASH_IPV6 | ICE_FLOW_HASH_ESP_SPI)

#define ICE_FLOW_HASH_AH_SPI (BIT_ULL(ICE_FLOW_FIELD_IDX_AH_SPI))
#define ICE_FLOW_HASH_AH_IPV4_SPI (ICE_FLOW_HASH_IPV4 | ICE_FLOW_HASH_AH_SPI)
#define ICE_FLOW_HASH_AH_IPV6_SPI (ICE_FLOW_HASH_IPV6 | ICE_FLOW_HASH_AH_SPI)

#define ICE_FLOW_HASH_NAT_T_ESP_SPI (BIT_ULL(ICE_FLOW_FIELD_IDX_NAT_T_ESP_SPI))
...
#define ICE_FLOW_SEG_HDR_GTPU                                                  \
  (ICE_FLOW_SEG_HDR_GTPU_IP | ICE_FLOW_SEG_HDR_GTPU_EH |                       \
   ICE_FLOW_SEG_HDR_GTPU_DWN | ICE_FLOW_SEG_HDR_GTPU_UP)
#define ICE_FLOW_SEG_HDR_PFCP                                                  \
  (ICE_FLOW_SEG_HDR_PFCP_NODE | ICE_FLOW_SEG_HDR_PFCP_SESSION)
...
u64 ice_flow_find_prof(struct ice_hw *hw, enum ice_block blk,
                       enum ice_flow_dir dir, struct ice_flow_seg_info *segs,
                       u8 segs_cnt);
enum ice_status ice_flow_add_prof(struct ice_hw *hw, enum ice_block blk,
                                  enum ice_flow_dir dir, u64 prof_id,
                                  struct ice_flow_seg_info *segs, u8 segs_cnt,
                                  struct ice_flow_action *acts, u8 acts_cnt,
                                  struct ice_flow_prof **prof);
enum ice_status ice_flow_rem_prof(struct ice_hw *hw, enum ice_block blk,
                                  u64 prof_id);
enum ice_status ice_flow_assoc_prof(struct ice_hw *hw, enum ice_block blk,
                                    struct ice_flow_prof *prof, u16 vsi_handle);
enum ice_status ice_flow_assoc_vsig_vsi(struct ice_hw *hw, enum ice_block blk,
                                        u16 vsi_handle, u16 vsig);
enum ice_status ice_flow_set_hw_prof(struct ice_hw *hw, u16 dest_vsi_handle,
                                     u16 fdir_vsi_handle,
                                     struct ice_parser_profile *prof,
                                     enum ice_block blk);
enum ice_status ice_flow_get_hw_prof(struct ice_hw *hw, enum ice_block blk,
                                     u64 prof_id, u8 *hw_prof);

u64 ice_flow_find_entry(struct ice_hw *hw, enum ice_block blk, u64 entry_id);
enum ice_status ice_flow_add_entry(struct ice_hw *hw, enum ice_block blk,
                                   u64 prof_id, u64 entry_id, u16 vsi,
                                   enum ice_flow_priority prio, void *data,
                                   struct ice_flow_action *acts, u8 acts_cnt,
                                   u64 *entry_h);
enum ice_status ice_flow_rem_entry(struct ice_hw *hw, enum ice_block blk,
                                   u64 entry_h);
void ice_flow_set_fld(struct ice_flow_seg_info *seg, enum ice_flow_field fld,
                      u16 val_loc, u16 mask_loc, u16 last_loc, bool range);
void ice_flow_set_fld_prefix(struct ice_flow_seg_info *seg,
                             enum ice_flow_field fld, u16 val_loc,
                             u16 prefix_loc, u8 prefix_sz);
...
enum ice_status ice_add_avf_rss_cfg(struct ice_hw *hw, u16 vsi_handle,
                                    u64 hashed_flds);
enum ice_status ice_rem_vsi_rss_cfg(struct ice_hw *hw, u16 vsi_handle);
enum ice_status ice_add_rss_cfg(struct ice_hw *hw, u16 vsi_handle,
                                const struct ice_rss_hash_cfg *cfg);
enum ice_status ice_rem_rss_cfg(struct ice_hw *hw, u16 vsi_handle,
                                const struct ice_rss_hash_cfg *cfg);
void ice_rss_update_raw_symm(struct ice_hw *hw, struct ice_rss_raw_cfg *cfg,
                             u64 id);
