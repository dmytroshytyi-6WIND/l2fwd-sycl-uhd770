 ...
 */
enum ice_status ice_aq_get_lldp_mib(struct ice_hw *hw, u8 bridge_type,
                                    u8 mib_type, void *buf, u16 buf_size,
  ...
  cmd->type |=
      (bridge_type << ICE_AQ_LLDP_BRID_TYPE_S) & ICE_AQ_LLDP_BRID_TYPE_M;
 ...
 */
enum ice_status ice_aq_cfg_lldp_mib_change(struct ice_hw *hw, bool ena_update,
                                           struct ice_sq_cd *cd) {
 ...
 */
enum ice_status ice_aq_stop_lldp(struct ice_hw *hw, bool shutdown_lldp_agent,
 ...
 */
enum ice_status ice_aq_start_lldp(struct ice_hw *hw, bool persist,
                                  struct ice_sq_cd *cd) {
...
u8 ice_get_dcbx_status(struct ice_hw *hw) {
  ...
  return (u8)((reg & PRTDCB_GENS_DCBX_STATUS_M) >> PRTDCB_GENS_DCBX_STATUS_S);
}
 ...
 */
static void ice_parse_ieee_ets_common_tlv(u8 *buf,
                                          struct ice_dcb_ets_cfg *ets_cfg) {
  u8 offset = 0;
  int i;
  ...
  for (i = 0; i < 4; i++) {
    ets_cfg->prio_table[i * 2] =
        ((buf[offset] & ICE_IEEE_ETS_PRIO_1_M) >> ICE_IEEE_ETS_PRIO_1_S);
    ets_cfg->prio_table[i * 2 + 1] =
        ((buf[offset] & ICE_IEEE_ETS_PRIO_0_M) >> ICE_IEEE_ETS_PRIO_0_S);
    offset++;
  }
 ...
 */
static void ice_parse_ieee_etscfg_tlv(struct ice_lldp_org_tlv *tlv,
  ...
  etscfg->willing =
      ((buf[0] & ICE_IEEE_ETS_WILLING_M) >> ICE_IEEE_ETS_WILLING_S);
  etscfg->cbs = ((buf[0] & ICE_IEEE_ETS_CBS_M) >> ICE_IEEE_ETS_CBS_S);
  etscfg->maxtcs = ((buf[0] & ICE_IEEE_ETS_MAXTC_M) >> ICE_IEEE_ETS_MAXTC_S);
 ...
 */
static void ice_parse_ieee_etsrec_tlv(struct ice_lldp_org_tlv *tlv,
                                      struct ice_dcbx_cfg *dcbcfg) {
  u8 *buf = tlv->tlvinfo;
 ...
 */
static void ice_parse_ieee_pfccfg_tlv(struct ice_lldp_org_tlv *tlv,
                                      struct ice_dcbx_cfg *dcbcfg) {
  u8 *buf = tlv->tlvinfo;
   ...
   */
  dcbcfg->pfc.willing =
      ((buf[0] & ICE_IEEE_PFC_WILLING_M) >> ICE_IEEE_PFC_WILLING_S);
  dcbcfg->pfc.mbc = ((buf[0] & ICE_IEEE_PFC_MBC_M) >> ICE_IEEE_PFC_MBC_S);
  dcbcfg->pfc.pfccap = ((buf[0] & ICE_IEEE_PFC_CAP_M) >> ICE_IEEE_PFC_CAP_S);
 ...
 */
static void ice_parse_ieee_app_tlv(struct ice_lldp_org_tlv *tlv,
                                   struct ice_dcbx_cfg *dcbcfg) {
  u16 offset = 0;
  u16 typelen;
  int i = 0;
  ...
  while (offset < len) {
    dcbcfg->app[i].priority =
        ((buf[offset] & ICE_IEEE_APP_PRIO_M) >> ICE_IEEE_APP_PRIO_S);
    dcbcfg->app[i].selector =
        ((buf[offset] & ICE_IEEE_APP_SEL_M) >> ICE_IEEE_APP_SEL_S);
    dcbcfg->app[i].prot_id = (buf[offset + 1] << 0x8) | buf[offset + 2];
    /* Move to next app */
    offset += 3;
    i++;
 ...
 */
static void ice_parse_ieee_tlv(struct ice_lldp_org_tlv *tlv,
                               struct ice_dcbx_cfg *dcbcfg) {
  u32 ouisubtype;
  u8 subtype;
  ...
  subtype =
      (u8)((ouisubtype & ICE_LLDP_TLV_SUBTYPE_M) >> ICE_LLDP_TLV_SUBTYPE_S);
  switch (subtype) {
 ...
 */
static void ice_parse_cee_pgcfg_tlv(struct ice_cee_feat_tlv *tlv,
                                    struct ice_dcbx_cfg *dcbcfg) {
  struct ice_dcb_ets_cfg *etscfg;
  u8 *buf = tlv->tlvinfo;
  u16 offset = 0;
  ...
  for (i = 0; i < 4; i++) {
    etscfg->prio_table[i * 2] =
        ((buf[offset] & ICE_CEE_PGID_PRIO_1_M) >> ICE_CEE_PGID_PRIO_1_S);
    etscfg->prio_table[i * 2 + 1] =
        ((buf[offset] & ICE_CEE_PGID_PRIO_0_M) >> ICE_CEE_PGID_PRIO_0_S);
    offset++;
  }
 ...
 */
static void ice_parse_cee_pfccfg_tlv(struct ice_cee_feat_tlv *tlv,
                                     struct ice_dcbx_cfg *dcbcfg) {
  u8 *buf = tlv->tlvinfo;
 ...
 */
static void ice_parse_cee_app_tlv(struct ice_cee_feat_tlv *tlv,
                                  struct ice_dcbx_cfg *dcbcfg) {
 ...
 * based on the subtype value
 */
static void ice_parse_cee_tlv(struct ice_lldp_org_tlv *tlv,
                              struct ice_dcbx_cfg *dcbcfg) {
  ...
  while (feat_tlv_count < ICE_CEE_MAX_FEAT_TYPE) {
    ...
    subtype = (u8)((typelen & ICE_LLDP_TLV_TYPE_M) >> ICE_LLDP_TLV_TYPE_S);
    switch (subtype) {
    ...
    sub_tlv =
        (struct ice_cee_feat_tlv *)((char *)sub_tlv +
 ...
 * will be returned
 */
static void ice_parse_org_tlv(struct ice_lldp_org_tlv *tlv,
                              struct ice_dcbx_cfg *dcbcfg) {
  u32 ouisubtype;
  u32 oui;
...
enum ice_status ice_lldp_to_dcb_cfg(u8 *lldpmib, struct ice_dcbx_cfg *dcbcfg) {
  ...
  while (1) {
    ...
    /* Move to next TLV */
    tlv = (struct ice_lldp_org_tlv *)((char *)tlv + sizeof(tlv->typelen) + len);
  }
 ...
 */
enum ice_status ice_aq_get_dcb_cfg(struct ice_hw *hw, u8 mib_type,
                                   u8 bridgetype, struct ice_dcbx_cfg *dcbcfg) {
  enum ice_status ret;
  u8 *lldpmib;
 ...
 */
enum ice_status ice_aq_start_stop_dcbx(struct ice_hw *hw, bool start_dcbx_agent,
 ...
 * -based PFC (0x0303)
 */
enum ice_status ice_aq_set_pfc_mode(struct ice_hw *hw, u8 pfc_mode,
                                    struct ice_sq_cd *cd) {
 ...
 */
static void ice_cee_to_dcb_cfg(struct ice_aqc_get_cee_dcb_cfg_resp *cee_cfg,
  ...
  for (i = 0; i < 3; i++) {
    ...
    if (!err && sync && oper) {
      dcbcfg->app[app_index].priority =
          (app_prio & ice_aqc_cee_app_mask) >> ice_aqc_cee_app_shift;
 ...
 */
STATIC enum ice_status ice_get_ieee_or_cee_dcb_cfg(struct ice_port_info *pi,
                                                   u8 dcbx_mode) {
 ...
 */
static void ice_add_ieee_ets_common_tlv(u8 *buf,
                                        struct ice_dcb_ets_cfg *ets_cfg) {
 ...
 */
static void ice_add_ieee_ets_tlv(struct ice_lldp_org_tlv *tlv,
                                 struct ice_dcbx_cfg *dcbcfg) {
  struct ice_dcb_ets_cfg *etscfg;
  u8 *buf = tlv->tlvinfo;
  u8 maxtcwilling = 0;
  ...
  typelen = ((ICE_TLV_TYPE_ORG << ICE_LLDP_TLV_TYPE_S) | ICE_IEEE_ETS_TLV_LEN);
  tlv->typelen = HTONS(typelen);

  ouisubtype =
      ((ICE_IEEE_8021QAZ_OUI << ICE_LLDP_TLV_OUI_S) | ICE_IEEE_SUBTYPE_ETS_CFG);
 ...
 */
static void ice_add_ieee_etsrec_tlv(struct ice_lldp_org_tlv *tlv,
                                    struct ice_dcbx_cfg *dcbcfg) {
  ...
  ouisubtype =
      ((ICE_IEEE_8021QAZ_OUI << ICE_LLDP_TLV_OUI_S) | ICE_IEEE_SUBTYPE_ETS_REC);
  tlv->ouisubtype = HTONL(ouisubtype);
 ...
 */
static void ice_add_ieee_pfc_tlv(struct ice_lldp_org_tlv *tlv,
                                 struct ice_dcbx_cfg *dcbcfg) {
  u8 *buf = tlv->tlvinfo;
  u32 ouisubtype;
  u16 typelen;

  typelen = ((ICE_TLV_TYPE_ORG << ICE_LLDP_TLV_TYPE_S) | ICE_IEEE_PFC_TLV_LEN);
  tlv->typelen = HTONS(typelen);

  ouisubtype =
      ((ICE_IEEE_8021QAZ_OUI << ICE_LLDP_TLV_OUI_S) | ICE_IEEE_SUBTYPE_PFC_CFG);
  tlv->ouisubtype = HTONL(ouisubtype);
 ...
 */
static void ice_add_ieee_app_pri_tlv(struct ice_lldp_org_tlv *tlv,
                                     struct ice_dcbx_cfg *dcbcfg) {
  ...
  if (dcbcfg->numapps == 0)
    return;
  ouisubtype =
      ((ICE_IEEE_8021QAZ_OUI << ICE_LLDP_TLV_OUI_S) | ICE_IEEE_SUBTYPE_APP_PRI);
  tlv->ouisubtype = HTONL(ouisubtype);
 ...
 */
static void ice_add_dscp_up_tlv(struct ice_lldp_org_tlv *tlv,
                                struct ice_dcbx_cfg *dcbcfg) {
  u8 *buf = tlv->tlvinfo;
  u32 ouisubtype;
  u16 typelen;
  ...
  typelen = ((ICE_TLV_TYPE_ORG << ICE_LLDP_TLV_TYPE_S) | ICE_DSCP_UP_TLV_LEN);
  tlv->typelen = HTONS(typelen);

  ouisubtype =
      (u32)((ICE_DSCP_OUI << ICE_LLDP_TLV_OUI_S) | ICE_DSCP_SUBTYPE_DSCP2UP);
  tlv->ouisubtype = HTONL(ouisubtype);
 ...
 * @tlv: location to build the TLV data
 */
static void ice_add_dscp_enf_tlv(struct ice_lldp_org_tlv *tlv) {
  u8 *buf = tlv->tlvinfo;
  u32 ouisubtype;
  u16 typelen;

  typelen = ((ICE_TLV_TYPE_ORG << ICE_LLDP_TLV_TYPE_S) | ICE_DSCP_ENF_TLV_LEN);
  tlv->typelen = HTONS(typelen);

  ouisubtype =
      (u32)((ICE_DSCP_OUI << ICE_LLDP_TLV_OUI_S) | ICE_DSCP_SUBTYPE_ENFORCE);
  tlv->ouisubtype = HTONL(ouisubtype);
 ...
 */
static void ice_add_dscp_tc_bw_tlv(struct ice_lldp_org_tlv *tlv,
                                   struct ice_dcbx_cfg *dcbcfg) {
  struct ice_dcb_ets_cfg *etscfg;
  u8 *buf = tlv->tlvinfo;
  u32 ouisubtype;
  ...
  typelen =
      ((ICE_TLV_TYPE_ORG << ICE_LLDP_TLV_TYPE_S) | ICE_DSCP_TC_BW_TLV_LEN);
  tlv->typelen = HTONS(typelen);

  ouisubtype =
      (u32)((ICE_DSCP_OUI << ICE_LLDP_TLV_OUI_S) | ICE_DSCP_SUBTYPE_TCBW);
  tlv->ouisubtype = HTONL(ouisubtype);
 ...
 * @dcbcfg: Local store which holds the PFC CFG data
 */
static void ice_add_dscp_pfc_tlv(struct ice_lldp_org_tlv *tlv,
                                 struct ice_dcbx_cfg *dcbcfg) {
  u8 *buf = tlv->tlvinfo;
  u32 ouisubtype;
  u16 typelen;

  typelen = ((ICE_TLV_TYPE_ORG << ICE_LLDP_TLV_TYPE_S) | ICE_DSCP_PFC_TLV_LEN);
  tlv->typelen = HTONS(typelen);

  ouisubtype =
      (u32)((ICE_DSCP_OUI << ICE_LLDP_TLV_OUI_S) | ICE_DSCP_SUBTYPE_PFC);
  tlv->ouisubtype = HTONL(ouisubtype);
 ...
 * Add tlv information
 */
static void ice_add_dcb_tlv(struct ice_lldp_org_tlv *tlv,
                            struct ice_dcbx_cfg *dcbcfg, u16 tlvid) {
 ...
 */
void ice_dcb_cfg_to_lldp(u8 *lldpmib, u16 *miblen,
                         struct ice_dcbx_cfg *dcbcfg) {
  ...
  while (1) {
    ...
    if (len)
      offset += len + 2;
    /* END TLV or beyond LLDPDU size */
    if (tlvid >= ICE_TLV_ID_END_OF_LLDPPDU || offset > ICE_LLDPDU_SIZE)
      break;
    /* Move to next TLV */
    if (len)
      tlv =
          (struct ice_lldp_org_tlv *)((char *)tlv + sizeof(tlv->typelen) + len);
  }
  *miblen = offset;
}
 ...
 */
enum ice_status ice_aq_query_port_ets(struct ice_port_info *pi,
 ...
 */
enum ice_status ice_update_port_tc_tree_cfg(struct ice_port_info *pi,
                                            struct ice_aqc_port_ets_elem *buf) {
 ...
 */
enum ice_status ice_query_port_ets(struct ice_port_info *pi,
                                   struct ice_aqc_port_ets_elem *buf,
                                   u16 buf_size, struct ice_sq_cd *cd) {
  enum ice_status status;
