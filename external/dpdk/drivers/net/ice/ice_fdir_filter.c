...
#define ICE_FDIR_INSET_ETH_IPV4                                                \
  (ICE_FDIR_INSET_ETH | ICE_INSET_IPV4_SRC | ICE_INSET_IPV4_DST |              \
   ICE_INSET_IPV4_TOS | ICE_INSET_IPV4_TTL | ICE_INSET_IPV4_PROTO |            \
   ICE_INSET_IPV4_PKID)

#define ICE_FDIR_INSET_ETH_IPV4_UDP                                            \
  (ICE_FDIR_INSET_ETH_IPV4 | ICE_INSET_UDP_SRC_PORT | ICE_INSET_UDP_DST_PORT)

#define ICE_FDIR_INSET_ETH_IPV4_TCP                                            \
  (ICE_FDIR_INSET_ETH_IPV4 | ICE_INSET_TCP_SRC_PORT | ICE_INSET_TCP_DST_PORT)

#define ICE_FDIR_INSET_ETH_IPV4_SCTP                                           \
  (ICE_FDIR_INSET_ETH_IPV4 | ICE_INSET_SCTP_SRC_PORT | ICE_INSET_SCTP_DST_PORT)

#define ICE_FDIR_INSET_ETH_IPV6                                                \
  (ICE_INSET_DMAC | ICE_INSET_IPV6_SRC | ICE_INSET_IPV6_DST |                  \
   ICE_INSET_IPV6_TC | ICE_INSET_IPV6_HOP_LIMIT | ICE_INSET_IPV6_NEXT_HDR |    \
   ICE_INSET_IPV6_PKID)

#define ICE_FDIR_INSET_ETH_IPV6_UDP                                            \
  (ICE_FDIR_INSET_ETH_IPV6 | ICE_INSET_UDP_SRC_PORT | ICE_INSET_UDP_DST_PORT)

#define ICE_FDIR_INSET_ETH_IPV6_TCP                                            \
  (ICE_FDIR_INSET_ETH_IPV6 | ICE_INSET_TCP_SRC_PORT | ICE_INSET_TCP_DST_PORT)

#define ICE_FDIR_INSET_ETH_IPV6_SCTP                                           \
  (ICE_FDIR_INSET_ETH_IPV6 | ICE_INSET_SCTP_SRC_PORT | ICE_INSET_SCTP_DST_PORT)

#define ICE_FDIR_INSET_IPV4                                                    \
  (ICE_INSET_IPV4_SRC | ICE_INSET_IPV4_DST | ICE_INSET_IPV4_PKID)

#define ICE_FDIR_INSET_IPV4_TCP                                                \
  (ICE_FDIR_INSET_IPV4 | ICE_INSET_TCP_SRC_PORT | ICE_INSET_TCP_DST_PORT)

#define ICE_FDIR_INSET_IPV4_UDP                                                \
  (ICE_FDIR_INSET_IPV4 | ICE_INSET_UDP_SRC_PORT | ICE_INSET_UDP_DST_PORT)

#define ICE_FDIR_INSET_IPV4_SCTP                                               \
  (ICE_FDIR_INSET_IPV4 | ICE_INSET_SCTP_SRC_PORT | ICE_INSET_SCTP_DST_PORT)

#define ICE_FDIR_INSET_ETH_IPV4_VXLAN                                          \
  (ICE_FDIR_INSET_ETH | ICE_FDIR_INSET_ETH_IPV4 | ICE_INSET_VXLAN_VNI)
...
#define ICE_FDIR_INSET_IPV4_ESP                                                \
  (ICE_INSET_IPV4_SRC | ICE_INSET_IPV4_DST | ICE_INSET_ESP_SPI)

#define ICE_FDIR_INSET_IPV6_ESP                                                \
  (ICE_INSET_IPV6_SRC | ICE_INSET_IPV6_DST | ICE_INSET_ESP_SPI)

#define ICE_FDIR_INSET_IPV4_NATT_ESP                                           \
  (ICE_INSET_IPV4_SRC | ICE_INSET_IPV4_DST | ICE_INSET_NAT_T_ESP_SPI)

#define ICE_FDIR_INSET_IPV6_NATT_ESP                                           \
  (ICE_INSET_IPV6_SRC | ICE_INSET_IPV6_DST | ICE_INSET_NAT_T_ESP_SPI)
...
static struct ice_pattern_match_item ice_fdir_pattern_list[] = {
    ...
    {pattern_eth_ipv6_frag_ext, ICE_FDIR_INSET_ETH_IPV6, ICE_INSET_NONE,
     ICE_INSET_NONE},
    ...
    {pattern_eth_ipv6_sctp, ICE_FDIR_INSET_ETH_IPV6_SCTP, ICE_INSET_NONE,
     ICE_INSET_NONE},
    {pattern_eth_ipv4_esp, ICE_FDIR_INSET_IPV4_ESP, ICE_INSET_NONE,
     ICE_INSET_NONE},
    {pattern_eth_ipv4_udp_esp, ICE_FDIR_INSET_IPV4_NATT_ESP, ICE_INSET_NONE,
     ICE_INSET_NONE},
    {pattern_eth_ipv6_esp, ICE_FDIR_INSET_IPV6_ESP, ICE_INSET_NONE,
     ICE_INSET_NONE},
    {pattern_eth_ipv6_udp_esp, ICE_FDIR_INSET_IPV6_NATT_ESP, ICE_INSET_NONE,
     ICE_INSET_NONE},
    {pattern_eth_ipv4_udp_vxlan_ipv4, ICE_FDIR_INSET_ETH_IPV4_VXLAN,
     ICE_FDIR_INSET_IPV4, ICE_INSET_NONE},
    {pattern_eth_ipv4_udp_vxlan_ipv4_udp, ICE_FDIR_INSET_ETH_IPV4_VXLAN,
     ICE_FDIR_INSET_IPV4_UDP, ICE_INSET_NONE},
    {pattern_eth_ipv4_udp_vxlan_ipv4_tcp, ICE_FDIR_INSET_ETH_IPV4_VXLAN,
     ICE_FDIR_INSET_IPV4_TCP, ICE_INSET_NONE},
    {pattern_eth_ipv4_udp_vxlan_ipv4_sctp, ICE_FDIR_INSET_ETH_IPV4_VXLAN,
     ICE_FDIR_INSET_IPV4_SCTP, ICE_INSET_NONE},
    {pattern_eth_ipv4_udp_vxlan_eth_ipv4, ICE_FDIR_INSET_ETH_IPV4_VXLAN,
     ICE_FDIR_INSET_ETH_IPV4, ICE_INSET_NONE},
    {pattern_eth_ipv4_udp_vxlan_eth_ipv4_udp, ICE_FDIR_INSET_ETH_IPV4_VXLAN,
     ICE_FDIR_INSET_ETH_IPV4_UDP, ICE_INSET_NONE},
    {pattern_eth_ipv4_udp_vxlan_eth_ipv4_tcp, ICE_FDIR_INSET_ETH_IPV4_VXLAN,
     ICE_FDIR_INSET_ETH_IPV4_TCP, ICE_INSET_NONE},
    {pattern_eth_ipv4_udp_vxlan_eth_ipv4_sctp, ICE_FDIR_INSET_ETH_IPV4_VXLAN,
    ...
    {pattern_eth_ipv4_gtpu, ICE_FDIR_INSET_IPV4_GTPU, ICE_FDIR_INSET_IPV4_GTPU,
     ICE_INSET_NONE},
    {pattern_eth_ipv4_gtpu_eh, ICE_FDIR_INSET_IPV4_GTPU_EH,
     ICE_FDIR_INSET_IPV4_GTPU_EH, ICE_INSET_NONE},
    {pattern_eth_ipv6_gtpu, ICE_FDIR_INSET_IPV6_GTPU, ICE_FDIR_INSET_IPV6_GTPU,
     ICE_INSET_NONE},
    {pattern_eth_ipv6_gtpu_eh, ICE_FDIR_INSET_IPV6_GTPU_EH,
     ICE_FDIR_INSET_IPV6_GTPU_EH, ICE_INSET_NONE},
};

static struct ice_flow_parser ice_fdir_parser;

static int ice_fdir_is_tunnel_profile(enum ice_fdir_tunnel_type tunnel_type);
...
ice_memzone_reserve(const char *name, uint32_t len, int socket_id) {
  ...
  return rte_memzone_reserve_aligned(
      name, len, socket_id, RTE_MEMZONE_IOVA_CONTIG, ICE_RING_BASE_ALIGN);
}

#define ICE_FDIR_MZ_NAME "FDIR_MEMZONE"

static int ice_fdir_prof_alloc(struct ice_hw *hw) {
  enum ice_fltr_ptype ptype, fltr_ptype;

  if (!hw->fdir_prof) {
    hw->fdir_prof = (struct ice_fd_hw_prof **)ice_malloc(
        hw, ICE_FLTR_PTYPE_MAX * sizeof(*hw->fdir_prof));
    if (!hw->fdir_prof)
      return -ENOMEM;
  }
  for (ptype = ICE_FLTR_PTYPE_NONF_NONE + 1; ptype < ICE_FLTR_PTYPE_MAX;
       ptype++) {
    if (!hw->fdir_prof[ptype]) {
      hw->fdir_prof[ptype] =
          (struct ice_fd_hw_prof *)ice_malloc(hw, sizeof(**hw->fdir_prof));
      if (!hw->fdir_prof[ptype])
        goto fail_mem;
    }
  }
...
fail_mem:
  for (fltr_ptype = ICE_FLTR_PTYPE_NONF_NONE + 1; fltr_ptype < ptype;
       fltr_ptype++) {
...
ice_fdir_counter_pool_add(__rte_unused struct ice_pf *pf,
                          ...
                          uint32_t index_start, uint32_t len) {
  struct ice_fdir_counter_pool *pool;
  uint32_t i;
  int ret = 0;

  pool = rte_zmalloc("ice_fdir_counter_pool",
                     sizeof(*pool) + sizeof(struct ice_fdir_counter) * len, 0);
  if (!pool) {
    PMD_INIT_LOG(ERR, "Failed to allocate memory for fdir counter pool");
    return -ENOMEM;
  }
...
static int ice_fdir_counter_init(struct ice_pf *pf) {
  struct ice_hw *hw = ICE_PF_TO_HW(pf);
  struct ice_fdir_info *fdir_info = &pf->fdir;
  struct ice_fdir_counter_pool_container *container = &fdir_info->counter;
...
static int ice_fdir_counter_release(struct ice_pf *pf) {
  struct ice_fdir_info *fdir_info = &pf->fdir;
  struct ice_fdir_counter_pool_container *container = &fdir_info->counter;
  uint8_t i;
...
static struct ice_fdir_counter *ice_fdir_counter_shared_search(
    struct ice_fdir_counter_pool_container *container, uint32_t id) {
  struct ice_fdir_counter_pool *pool;
  ...
  TAILQ_FOREACH(pool, &container->pool_list, next) {
    for (i = 0; i < ICE_FDIR_COUNTERS_PER_BLOCK; i++) {
      ...
      if (counter->shared && counter->ref_cnt && counter->id == id)
        return counter;
    }
  }
...
static void ice_fdir_counter_free(__rte_unused struct ice_pf *pf,
                                  struct ice_fdir_counter *counter) {
  if (!counter)
    return;
...
static int ice_fdir_init_filter_list(struct ice_pf *pf) {
  ...
  fdir_info->hash_map =
      rte_zmalloc("ice_fdir_hash_map",
                  sizeof(*fdir_info->hash_map) * ICE_MAX_FDIR_FILTER_NUM, 0);
...
static void ice_fdir_release_filter_list(struct ice_pf *pf) {
  struct ice_fdir_info *fdir_info = &pf->fdir;
 ...
 */
static int ice_fdir_setup(struct ice_pf *pf) {
  ...
  snprintf(z_name, sizeof(z_name), "ICE_%s_%d", ICE_FDIR_MZ_NAME,
...
static void ice_fdir_prof_free(struct ice_hw *hw) {
...
static void ice_fdir_prof_rm(struct ice_pf *pf, enum ice_fltr_ptype ptype,
                             bool is_tunnel) {
  struct ice_hw *hw = ICE_PF_TO_HW(pf);
  ...
  for (i = 0; i < pf->hw_prof_cnt[ptype][is_tunnel]; i++) {
    if (hw_prof->entry_h[i][is_tunnel]) {
      vsi_num = ice_get_hw_vsi_num(hw, hw_prof->vsi_h[i]);
      ice_rem_prof_id_flow(hw, ICE_BLK_FD, vsi_num, ptype);
      ice_flow_rem_entry(hw, ICE_BLK_FD, hw_prof->entry_h[i][is_tunnel]);
...
static void ice_fdir_prof_rm_all(struct ice_pf *pf) {
  enum ice_fltr_ptype ptype;
 ...
 * @pf: board private structure
 */
static void ice_fdir_teardown(struct ice_pf *pf) {
  struct rte_eth_dev *eth_dev = &rte_eth_devices[pf->dev_data->port_id];
  struct ice_hw *hw = ICE_PF_TO_HW(pf);
  struct ice_vsi *vsi;
  int err;
...
static int ice_fdir_cur_prof_conflict(struct ice_pf *pf,
                                      enum ice_fltr_ptype ptype,
  ...
  if ((!is_tunnel && !memcmp(ori_seg, seg, sizeof(*seg))) ||
    ...
    PMD_DRV_LOG(DEBUG, "Profile already exists for flow type %d.", ptype);
    return -EEXIST;
  }
  ...
  if (pf->fdir_fltr_cnt[ptype][is_tunnel]) {
    PMD_DRV_LOG(DEBUG,
                "Failed to create profile for flow type %d due to conflict "
                "with existing rule.",
                ptype);
    return -EINVAL;
  }
...
static bool ice_fdir_prof_resolve_conflict(struct ice_pf *pf,
                                           enum ice_fltr_ptype ptype,
                                           bool is_tunnel) {
  struct ice_hw *hw = ICE_PF_TO_HW(pf);
  struct ice_fd_hw_prof *hw_prof;
...
static int ice_fdir_cross_prof_conflict(struct ice_pf *pf,
                                        enum ice_fltr_ptype ptype,
                                        bool is_tunnel) {
  ...
  case ICE_FLTR_PTYPE_NONF_IPV4_SCTP:
    ...
    if (!ice_fdir_prof_resolve_conflict(pf, cflct_ptype, is_tunnel))
      goto err;
    break;
...
err:
  PMD_DRV_LOG(DEBUG,
              "Failed to create profile for flow type %d due to conflict with "
              "existing rule of flow type %d.",
              ptype, cflct_ptype);
  return -EINVAL;
}

static int ice_fdir_hw_tbl_conf(struct ice_pf *pf, struct ice_vsi *vsi,
                                struct ice_vsi *ctrl_vsi,
                                struct ice_flow_seg_info *seg,
                                enum ice_fltr_ptype ptype, bool is_tunnel) {
  struct ice_hw *hw = ICE_PF_TO_HW(pf);
  ...
  if (ret)
    return ret;
  ret = ice_flow_add_entry(hw, ICE_BLK_FD, prof_id, vsi->idx, vsi->idx,
                           ICE_FLOW_PRIO_NORMAL, seg, NULL, 0, &entry_1);
  if (ret) {
    PMD_DRV_LOG(ERR, "Failed to add main VSI flow entry for %d.", ptype);
    goto err_add_prof;
  }
  ret = ice_flow_add_entry(hw, ICE_BLK_FD, prof_id, vsi->idx, ctrl_vsi->idx,
                           ICE_FLOW_PRIO_NORMAL, seg, NULL, 0, &entry_2);
  if (ret) {
    PMD_DRV_LOG(ERR, "Failed to add control VSI flow entry for %d.", ptype);
    goto err_add_entry;
  }
...
static void ice_fdir_input_set_parse(uint64_t inset,
                                     enum ice_flow_field *field) {
  uint32_t i, j;
  ...
  for (i = 0, j = 0; i < RTE_DIM(ice_inset_map); i++) {
    if ((inset & ice_inset_map[i].inset) == ice_inset_map[i].inset)
      field[j++] = ice_inset_map[i].fld;
  }
}

static void ice_fdir_input_set_hdrs(enum ice_fltr_ptype flow,
                                    struct ice_flow_seg_info *seg) {
  switch (flow) {
  case ICE_FLTR_PTYPE_NONF_IPV4_UDP:
  ...
  case ICE_FLTR_PTYPE_NONF_IPV4_SCTP:
    ...
    break;
  case ICE_FLTR_PTYPE_NONF_IPV4_OTHER:
    ICE_FLOW_SET_HDRS(seg, ICE_FLOW_SEG_HDR_IPV4 | ICE_FLOW_SEG_HDR_IPV_OTHER);
    break;
  case ICE_FLTR_PTYPE_FRAG_IPV4:
    ICE_FLOW_SET_HDRS(seg, ICE_FLOW_SEG_HDR_IPV4 | ICE_FLOW_SEG_HDR_IPV_FRAG);
    break;
  case ICE_FLTR_PTYPE_NONF_IPV6_UDP:
    ICE_FLOW_SET_HDRS(seg, ICE_FLOW_SEG_HDR_UDP | ICE_FLOW_SEG_HDR_IPV6 |
                               ICE_FLOW_SEG_HDR_IPV_OTHER);
    break;
  case ICE_FLTR_PTYPE_NONF_IPV6_TCP:
    ICE_FLOW_SET_HDRS(seg, ICE_FLOW_SEG_HDR_TCP | ICE_FLOW_SEG_HDR_IPV6 |
                               ICE_FLOW_SEG_HDR_IPV_OTHER);
    break;
  case ICE_FLTR_PTYPE_NONF_IPV6_SCTP:
    ICE_FLOW_SET_HDRS(seg, ICE_FLOW_SEG_HDR_SCTP | ICE_FLOW_SEG_HDR_IPV6 |
                               ICE_FLOW_SEG_HDR_IPV_OTHER);
    break;
  case ICE_FLTR_PTYPE_NONF_IPV6_OTHER:
    ICE_FLOW_SET_HDRS(seg, ICE_FLOW_SEG_HDR_IPV6 | ICE_FLOW_SEG_HDR_IPV_OTHER);
    break;
  case ICE_FLTR_PTYPE_FRAG_IPV6:
    ICE_FLOW_SET_HDRS(seg, ICE_FLOW_SEG_HDR_IPV6 | ICE_FLOW_SEG_HDR_IPV_FRAG);
    break;
  case ICE_FLTR_PTYPE_NONF_IPV4_UDP_VXLAN_IPV4_UDP:
  case ICE_FLTR_PTYPE_NONF_IPV4_UDP_VXLAN_IPV4_TCP:
  case ICE_FLTR_PTYPE_NONF_IPV4_UDP_VXLAN_IPV4_SCTP:
  ...
  case ICE_FLTR_PTYPE_NONF_IPV4_GTPU:
    ICE_FLOW_SET_HDRS(seg, ICE_FLOW_SEG_HDR_GTPU_IP | ICE_FLOW_SEG_HDR_IPV4 |
                               ICE_FLOW_SEG_HDR_IPV_OTHER);
    break;
  ...
  case ICE_FLTR_PTYPE_NONF_IPV6_GTPU:
    ICE_FLOW_SET_HDRS(seg, ICE_FLOW_SEG_HDR_GTPU_IP | ICE_FLOW_SEG_HDR_IPV6 |
                               ICE_FLOW_SEG_HDR_IPV_OTHER);
    break;
  ...
  case ICE_FLTR_PTYPE_NONF_IPV4_ESP:
    ICE_FLOW_SET_HDRS(seg, ICE_FLOW_SEG_HDR_ESP | ICE_FLOW_SEG_HDR_IPV4 |
                               ICE_FLOW_SEG_HDR_IPV_OTHER);
    break;
  case ICE_FLTR_PTYPE_NONF_IPV6_ESP:
    ICE_FLOW_SET_HDRS(seg, ICE_FLOW_SEG_HDR_ESP | ICE_FLOW_SEG_HDR_IPV6 |
                               ICE_FLOW_SEG_HDR_IPV_OTHER);
    break;
  case ICE_FLTR_PTYPE_NONF_IPV4_NAT_T_ESP:
    ICE_FLOW_SET_HDRS(seg, ICE_FLOW_SEG_HDR_NAT_T_ESP | ICE_FLOW_SEG_HDR_IPV4 |
                               ICE_FLOW_SEG_HDR_IPV_OTHER);
    break;
  case ICE_FLTR_PTYPE_NONF_IPV6_NAT_T_ESP:
    ICE_FLOW_SET_HDRS(seg, ICE_FLOW_SEG_HDR_NAT_T_ESP | ICE_FLOW_SEG_HDR_IPV6 |
                               ICE_FLOW_SEG_HDR_IPV_OTHER);
    break;
  default:
...
static int ice_fdir_input_set_conf(struct ice_pf *pf, enum ice_fltr_ptype flow,
                                   uint64_t inner_input_set,
                                   uint64_t outer_input_set,
  ...
  seg_tun = (struct ice_flow_seg_info *)ice_malloc(hw, sizeof(*seg_tun) *
                                                           ICE_FD_HW_SEG_MAX);
  if (!seg_tun) {
  ...
  for (k = 0; k <= ICE_FD_HW_SEG_TUN; k++) {
    ...
    for (i = 0; field[i] != ICE_FLOW_FIELD_IDX_MAX; i++) {
      ice_flow_set_fld(seg, field[i], ICE_FLOW_FLD_OFF_INVAL,
  ...
  ret = ice_fdir_hw_tbl_conf(pf, pf->main_vsi, pf->fdir.fdir_vsi, seg_tun, flow,
                             is_tunnel);
...
static void ice_fdir_cnt_update(struct ice_pf *pf, enum ice_fltr_ptype ptype,
...
static int ice_fdir_init(struct ice_adapter *ad) {
...
static void ice_fdir_uninit(struct ice_adapter *ad) {
  struct ice_flow_parser *parser;
  struct ice_pf *pf = &ad->pf;
...
static int ice_fdir_add_del_raw(struct ice_pf *pf,
                                struct ice_fdir_filter_conf *filter, bool add) {
  struct ice_hw *hw = ICE_PF_TO_HW(pf);
...
static int ice_fdir_add_del_filter(struct ice_pf *pf,
...
static void ice_fdir_extract_fltr_key(struct ice_fdir_fltr_pattern *key,
                                      struct ice_fdir_filter_conf *filter) {
...
static int ice_fdir_entry_insert(struct ice_pf *pf,
  ...
  if (ret < 0) {
    PMD_DRV_LOG(ERR, "Failed to insert fdir entry to hash table %d!", ret);
    return ret;
  }
...
static int ice_fdir_entry_del(struct ice_pf *pf,
                              struct ice_fdir_fltr_pattern *key) {
  struct ice_fdir_info *fdir_info = &pf->fdir;
  int ret;
  ...
  if (ret < 0) {
    PMD_DRV_LOG(ERR, "Failed to delete fdir filter to hash table %d!", ret);
    return ret;
  }
...
static int ice_fdir_create_filter(struct ice_adapter *ad, struct rte_flow *flow,
  ...
  if (filter->parser_ena) {
    ...
    if (pi->fdir_actived_cnt != 0) {
      for (i = 0; i < ICE_MAX_FV_WORDS; i++)
        if (pi->prof.fv[i].proto_id != filter->prof->fv[i].proto_id ||
            pi->prof.fv[i].offset != filter->prof->fv[i].offset ||
    ...
    if (!fv_found) {
      ret = ice_flow_set_hw_prof(hw, main_vsi, ctrl_vsi, filter->prof,
                                 ICE_BLK_FD);
      if (ret)
        goto error;
    }
    ...
    if (!fv_found) {
      for (i = 0; i < filter->prof->fv_num; i++) {
        pi->prof.fv[i].proto_id = filter->prof->fv[i].proto_id;
        pi->prof.fv[i].offset = filter->prof->fv[i].offset;
        pi->prof.fv[i].msk = filter->prof->fv[i].msk;
      }
  ...
  if (node) {
    rte_flow_error_set(error, EEXIST, RTE_FLOW_ERROR_TYPE_HANDLE, NULL,
                       "Rule already exists!");
    return -rte_errno;
  }
  ...
  ret =
      ice_fdir_input_set_conf(pf, filter->input.flow_type, filter->input_set_i,
                              filter->input_set_o, filter->tunnel_type);
  if (ret) {
...
static int ice_fdir_destroy_filter(struct ice_adapter *ad,
  ...
  if (!entry) {
    rte_flow_error_set(error, ENOENT, RTE_FLOW_ERROR_TYPE_HANDLE, NULL,
                       "Can't find entry.");
    return -rte_errno;
  }
...
static int ice_fdir_query_count(struct ice_adapter *ad, struct rte_flow *flow,
...
static int ice_fdir_parse_action_qregion(struct ice_pf *pf,
                                         struct rte_flow_error *error,
...
static int ice_fdir_parse_action(struct ice_adapter *ad,
  ...
  for (; actions->type != RTE_FLOW_ACTION_TYPE_END; actions++) {
    ...
    case RTE_FLOW_ACTION_TYPE_QUEUE:
      ...
      if (filter->input.q_index >= pf->dev_data->nb_rx_queues) {
        rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ACTION, actions,
                           "Invalid queue for FDIR.");
        return -rte_errno;
      }
      filter->input.dest_ctl = ICE_FLTR_PRGM_DESC_DEST_DIRECT_PKT_QINDEX;
      break;
    ...
    case RTE_FLOW_ACTION_TYPE_RSS:
      ...
      ret = ice_fdir_parse_action_qregion(pf, error, actions, filter);
      if (ret)
        return ret;
      break;
    ...
    case RTE_FLOW_ACTION_TYPE_COUNT:
      ...
      rte_memcpy(&filter->act_count, act_count, sizeof(filter->act_count));
...
static int ice_fdir_parse_pattern(__rte_unused struct ice_adapter *ad,
  ...
  const struct rte_flow_item_ipv6_frag_ext *ipv6_frag_spec, *ipv6_frag_mask;
  ...
  for (item = pattern; item->type != RTE_FLOW_ITEM_TYPE_END; item++) {
    ...
    if (item->last && !(item_type == RTE_FLOW_ITEM_TYPE_IPV4 ||
                        item_type == RTE_FLOW_ITEM_TYPE_IPV6_FRAG_EXT)) {
      rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ITEM, item,
                         "Not support range");
    }

    input_set = (tunnel_type && !is_outer) ? &input_set_i : &input_set_o;
    ...
    case RTE_FLOW_ITEM_TYPE_RAW: {
      ...
      unsigned char *tmp_spec = (uint8_t *)(uintptr_t)raw_spec->pattern;
      unsigned char *tmp_mask = (uint8_t *)(uintptr_t)raw_mask->pattern;
      uint16_t udp_port = 0;
      uint16_t tmp_val = 0;
      uint8_t pkt_len = 0;
      uint8_t tmp = 0;
      ...
      if (strlen((char *)(uintptr_t)raw_mask->pattern) != pkt_len)
        return -rte_errno;
      ...
      filter->prof = (struct ice_parser_profile *)ice_malloc(
          &ad->hw, sizeof(*filter->prof));
      if (!filter->prof)
        return -ENOMEM;

      if (ice_parser_profile_init(&rslt, tmp_spec, tmp_mask, pkt_len,
                                  ICE_BLK_FD, true, filter->prof))
        return -rte_errno;
    ...
    case RTE_FLOW_ITEM_TYPE_ETH:
      ...
      p_ext_data = (tunnel_type && is_outer) ? &filter->input.ext_data_outer
                                             : &filter->input.ext_data;
      rte_memcpy(&p_ext_data->src_mac, &eth_spec->src, RTE_ETHER_ADDR_LEN);
      rte_memcpy(&p_ext_data->dst_mac, &eth_spec->dst, RTE_ETHER_ADDR_LEN);
      rte_memcpy(&p_ext_data->ether_type, &eth_spec->type,
    ...
    case RTE_FLOW_ITEM_TYPE_IPV4:
      ...
      ipv4_last = item->last;
      ipv4_mask = item->mask;
      p_v4 = (tunnel_type && is_outer) ? &filter->input.ip_outer.v4
                                       : &filter->input.ip.v4;
      ...
      if (ipv4_last &&
          (ipv4_last->hdr.version_ihl || ipv4_last->hdr.type_of_service ||
           ipv4_last->hdr.time_to_live ||
           ipv4_last->hdr.total_length | ipv4_last->hdr.next_proto_id ||
      ...
      if (ipv4_mask->hdr.src_addr && ipv4_mask->hdr.src_addr != UINT32_MAX)
        return -rte_errno;
      if (ipv4_mask->hdr.dst_addr && ipv4_mask->hdr.dst_addr != UINT32_MAX)
        return -rte_errno;
    ...
    case RTE_FLOW_ITEM_TYPE_IPV6:
      ...
      ipv6_spec = item->spec;
      ipv6_mask = item->mask;
      p_v6 = (tunnel_type && is_outer) ? &filter->input.ip_outer.v6
                                       : &filter->input.ip.v6;
      ...
      if ((ipv6_mask->hdr.vtc_flow & rte_cpu_to_be_32(ICE_IPV6_TC_MASK)) ==
    ...
    case RTE_FLOW_ITEM_TYPE_IPV6_FRAG_EXT:
      ...
      if (ipv6_frag_spec->hdr.frag_data == rte_cpu_to_be_16(1) &&
          ipv6_frag_mask->hdr.frag_data == rte_cpu_to_be_16(1)) {
    ...
    case RTE_FLOW_ITEM_TYPE_TCP:
      ...
      if (tcp_mask->hdr.src_port && tcp_mask->hdr.src_port != UINT16_MAX)
        return -rte_errno;
      if (tcp_mask->hdr.dst_port && tcp_mask->hdr.dst_port != UINT16_MAX)
        return -rte_errno;
    ...
    case RTE_FLOW_ITEM_TYPE_UDP:
      ...
      if (udp_mask->hdr.src_port && udp_mask->hdr.src_port != UINT16_MAX)
        return -rte_errno;
      if (udp_mask->hdr.dst_port && udp_mask->hdr.dst_port != UINT16_MAX)
        return -rte_errno;
    ...
    case RTE_FLOW_ITEM_TYPE_SCTP:
      ...
      if (sctp_mask->hdr.src_port && sctp_mask->hdr.src_port != UINT16_MAX)
        return -rte_errno;
      if (sctp_mask->hdr.dst_port && sctp_mask->hdr.dst_port != UINT16_MAX)
        return -rte_errno;
    ...
    case RTE_FLOW_ITEM_TYPE_GTP_PSC:
      ...
      filter->input.gtpu_data.qfi = gtp_psc_spec->hdr.qfi;
      break;
    case RTE_FLOW_ITEM_TYPE_ESP:
      if (l3 == RTE_FLOW_ITEM_TYPE_IPV4 && l4 == RTE_FLOW_ITEM_TYPE_UDP)
      ...
      else if (l3 == RTE_FLOW_ITEM_TYPE_IPV4 && l4 == RTE_FLOW_ITEM_TYPE_END)
        flow_type = ICE_FLTR_PTYPE_NONF_IPV4_ESP;
      else if (l3 == RTE_FLOW_ITEM_TYPE_IPV6 && l4 == RTE_FLOW_ITEM_TYPE_END)
      ...
      if (l3 == RTE_FLOW_ITEM_TYPE_IPV4)
        filter->input.ip.v4.sec_parm_idx = esp_spec->hdr.spi;
      else if (l3 == RTE_FLOW_ITEM_TYPE_IPV6)
        filter->input.ip.v6.sec_parm_idx = esp_spec->hdr.spi;
      break;
    default:
      rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ITEM, item,
...
static int
ice_fdir_parse(struct ice_adapter *ad, struct ice_pattern_match_item *array,
               uint32_t array_len, const struct rte_flow_item pattern[],
               const struct rte_flow_action actions[], uint32_t priority,
               void **meta, struct rte_flow_error *error) {
  struct ice_pf *pf = &ad->pf;
  ...
  item = ice_search_pattern_match_item(ad, pattern, array, array_len, error);
  ...
  if (!input_set ||
      filter->input_set_o & ~(item->input_set_mask_o | ICE_INSET_ETHERTYPE) ||
