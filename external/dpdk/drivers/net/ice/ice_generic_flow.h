...
#define ICE_INSET_VXLAN_VNI (ICE_PROT_VXLAN | ICE_VXLAN_VNI)
#define ICE_INSET_NVGRE_TNI (ICE_PROT_NVGRE | ICE_NVGRE_TNI)
#define ICE_INSET_GTPU_TEID (ICE_PROT_GTPU | ICE_GTPU_TEID)
#define ICE_INSET_GTPU_QFI (ICE_PROT_GTPU | ICE_GTPU_QFI)
#define ICE_INSET_PPPOE_SESSION (ICE_PROT_PPPOE_S | ICE_PPPOE_SESSION)
#define ICE_INSET_PPPOE_PROTO (ICE_PROT_PPPOE_S | ICE_PPPOE_PROTO)
#define ICE_INSET_ESP_SPI (ICE_PROT_ESP | ICE_ESP_SPI)
#define ICE_INSET_AH_SPI (ICE_PROT_AH | ICE_AH_SPI)
#define ICE_INSET_L2TPV3OIP_SESSION_ID                                         \
  (ICE_PROT_L2TPV3OIP | ICE_L2TPV3OIP_SESSION_ID)
#define ICE_INSET_PFCP_S_FIELD (ICE_PROT_PFCP | ICE_PFCP_S_FIELD)
#define ICE_INSET_PFCP_SEID (ICE_PROT_PFCP | ICE_PFCP_S_FIELD | ICE_PFCP_SEID)
#define ICE_INSET_NAT_T_ESP_SPI (ICE_PROT_NAT_T_ESP | ICE_ESP_SPI)
...
typedef int (*engine_create_t)(struct ice_adapter *ad, struct rte_flow *flow,
                               void *meta, struct rte_flow_error *error);
typedef int (*engine_destroy_t)(struct ice_adapter *ad, struct rte_flow *flow,
                                struct rte_flow_error *error);
typedef int (*engine_query_t)(struct ice_adapter *ad, struct rte_flow *flow,
                              struct rte_flow_query_count *count,
                              struct rte_flow_error *error);
typedef int (*engine_redirect_t)(struct ice_adapter *ad, struct rte_flow *flow,
...
int ice_register_parser(struct ice_flow_parser *parser, struct ice_adapter *ad);
