...
#ifdef __AVX2__
static __rte_always_inline void ice_rxq_rearm_common(struct ice_rx_queue *rxq,
  ...
  if (avx512) {
    ...
    for (i = 0; i < ICE_RXQ_REARM_THRESH; i += 8, rxep += 8, rxdp += 8) {
...
#endif /* __AVX512VL__ */
  {
    ...
    for (i = 0; i < ICE_RXQ_REARM_THRESH; i += 4, rxep += 4, rxdp += 4) {
      __m128i vaddr0, vaddr1, vaddr2, vaddr3;
      __m256i vaddr0_1, vaddr2_3;
