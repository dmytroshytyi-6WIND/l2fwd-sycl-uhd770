...
#define VALID_RSS_IPV4                                                         \
  (RTE_ETH_RSS_IPV4 | RTE_ETH_RSS_FRAG_IPV4 | VALID_RSS_IPV4_L4)
#define VALID_RSS_IPV6                                                         \
  (RTE_ETH_RSS_IPV6 | RTE_ETH_RSS_FRAG_IPV6 | VALID_RSS_IPV6_L4)
...
#define VALID_RSS_ATTR                                                         \
  (RTE_ETH_RSS_L3_SRC_ONLY | RTE_ETH_RSS_L3_DST_ONLY |                         \
   ...
   RTE_ETH_RSS_L2_SRC_ONLY | RTE_ETH_RSS_L2_DST_ONLY | RTE_ETH_RSS_L3_PRE32 |  \
   RTE_ETH_RSS_L3_PRE48 | RTE_ETH_RSS_L3_PRE64)
...
static int ice_hash_create(struct ice_adapter *ad, struct rte_flow *flow,
                           void *meta, struct rte_flow_error *error);

static int ice_hash_destroy(struct ice_adapter *ad, struct rte_flow *flow,
                            struct rte_flow_error *error);

static void ice_hash_uninit(struct ice_adapter *ad);

static void ice_hash_free(struct rte_flow *flow);

static int ice_hash_parse_pattern_action(struct ice_adapter *ad,
                                         struct ice_pattern_match_item *array,
                                         uint32_t array_len,
                                         const struct rte_flow_item pattern[],
                                         const struct rte_flow_action actions[],
                                         uint32_t priority, void **meta,
                                         struct rte_flow_error *error);

/* Rss configuration template */
struct ice_rss_hash_cfg ipv4_tmplt = {
    ICE_FLOW_SEG_HDR_ETH | ICE_FLOW_SEG_HDR_IPV4 | ICE_FLOW_SEG_HDR_IPV_OTHER,
    ICE_FLOW_HASH_ETH | ICE_FLOW_HASH_IPV4, ICE_RSS_OUTER_HEADERS, 0};
...
struct ice_rss_hash_cfg ipv6_tmplt = {
    ICE_FLOW_SEG_HDR_ETH | ICE_FLOW_SEG_HDR_IPV6 | ICE_FLOW_SEG_HDR_IPV_OTHER,
    ICE_FLOW_HASH_ETH | ICE_FLOW_HASH_IPV6, ICE_RSS_OUTER_HEADERS, 0};

struct ice_rss_hash_cfg ipv6_frag_tmplt = {
    ICE_FLOW_SEG_HDR_ETH | ICE_FLOW_SEG_HDR_IPV6 | ICE_FLOW_SEG_HDR_IPV_FRAG,
    ICE_FLOW_HASH_ETH | ICE_FLOW_HASH_IPV6, ICE_RSS_OUTER_HEADERS, 0};
...
struct ice_rss_hash_cfg outer_ipv4_inner_ipv4_tmplt = {
    ICE_FLOW_SEG_HDR_IPV4 | ICE_FLOW_SEG_HDR_IPV_OTHER, ICE_FLOW_HASH_IPV4,
    ICE_RSS_INNER_HEADERS_W_OUTER_IPV4, 0};
struct ice_rss_hash_cfg outer_ipv4_inner_ipv4_udp_tmplt = {
    ICE_FLOW_SEG_HDR_IPV4 | ICE_FLOW_SEG_HDR_IPV_OTHER | ICE_FLOW_SEG_HDR_UDP,
    ICE_HASH_UDP_IPV4 | ICE_IPV4_PROT, ICE_RSS_INNER_HEADERS_W_OUTER_IPV4, 0};
...
struct ice_rss_hash_cfg outer_ipv4_inner_ipv4_tcp_tmplt = {
    ...
    ICE_HASH_TCP_IPV4 | ICE_IPV4_PROT, ICE_RSS_INNER_HEADERS_W_OUTER_IPV4, 0};

struct ice_rss_hash_cfg outer_ipv6_inner_ipv4_tmplt = {
    ICE_FLOW_SEG_HDR_IPV4 | ICE_FLOW_SEG_HDR_IPV_OTHER, ICE_FLOW_HASH_IPV4,
    ICE_RSS_INNER_HEADERS_W_OUTER_IPV6, 0};

struct ice_rss_hash_cfg outer_ipv6_inner_ipv4_udp_tmplt = {
    ICE_FLOW_SEG_HDR_IPV4 | ICE_FLOW_SEG_HDR_IPV_OTHER | ICE_FLOW_SEG_HDR_UDP,
    ICE_HASH_UDP_IPV4 | ICE_IPV4_PROT, ICE_RSS_INNER_HEADERS_W_OUTER_IPV6, 0};

struct ice_rss_hash_cfg outer_ipv6_inner_ipv4_tcp_tmplt = {
    ICE_FLOW_SEG_HDR_IPV4 | ICE_FLOW_SEG_HDR_IPV_OTHER | ICE_FLOW_SEG_HDR_TCP,
    ICE_HASH_TCP_IPV4 | ICE_IPV4_PROT, ICE_RSS_INNER_HEADERS_W_OUTER_IPV6, 0};

struct ice_rss_hash_cfg outer_ipv4_inner_ipv6_tmplt = {
    ICE_FLOW_SEG_HDR_IPV6 | ICE_FLOW_SEG_HDR_IPV_OTHER, ICE_FLOW_HASH_IPV6,
    ICE_RSS_INNER_HEADERS_W_OUTER_IPV4, 0};

struct ice_rss_hash_cfg outer_ipv4_inner_ipv6_udp_tmplt = {
    ICE_FLOW_SEG_HDR_IPV6 | ICE_FLOW_SEG_HDR_IPV_OTHER | ICE_FLOW_SEG_HDR_UDP,
    ICE_HASH_UDP_IPV6 | ICE_IPV6_PROT, ICE_RSS_INNER_HEADERS_W_OUTER_IPV4, 0};
...
struct ice_rss_hash_cfg outer_ipv4_inner_ipv6_tcp_tmplt = {
    ...
    ICE_HASH_TCP_IPV6 | ICE_IPV6_PROT, ICE_RSS_INNER_HEADERS_W_OUTER_IPV4, 0};
...
struct ice_rss_hash_cfg outer_ipv6_inner_ipv6_udp_tmplt = {
    ICE_FLOW_SEG_HDR_IPV6 | ICE_FLOW_SEG_HDR_IPV_OTHER | ICE_FLOW_SEG_HDR_UDP,
    ICE_HASH_UDP_IPV6 | ICE_IPV6_PROT, ICE_RSS_INNER_HEADERS_W_OUTER_IPV6, 0};

struct ice_rss_hash_cfg outer_ipv6_inner_ipv6_tcp_tmplt = {
    ICE_FLOW_SEG_HDR_IPV6 | ICE_FLOW_SEG_HDR_IPV_OTHER | ICE_FLOW_SEG_HDR_TCP,
    ICE_HASH_TCP_IPV6 | ICE_IPV6_PROT, ICE_RSS_INNER_HEADERS_W_OUTER_IPV6, 0};

struct ice_rss_hash_cfg eth_ipv4_esp_tmplt = {
    ICE_FLOW_SEG_HDR_IPV4 | ICE_FLOW_SEG_HDR_IPV_OTHER | ICE_FLOW_SEG_HDR_ESP,
    ICE_FLOW_HASH_ESP_SPI, ICE_RSS_OUTER_HEADERS, 0};

struct ice_rss_hash_cfg eth_ipv4_udp_esp_tmplt = {
    ICE_FLOW_SEG_HDR_IPV4 | ICE_FLOW_SEG_HDR_IPV_OTHER |
        ICE_FLOW_SEG_HDR_NAT_T_ESP,
    ICE_FLOW_HASH_NAT_T_ESP_SPI, ICE_RSS_OUTER_HEADERS, 0};

struct ice_rss_hash_cfg eth_ipv4_ah_tmplt = {
    ICE_FLOW_SEG_HDR_IPV4 | ICE_FLOW_SEG_HDR_IPV_OTHER | ICE_FLOW_SEG_HDR_AH,
    ICE_FLOW_HASH_AH_SPI, ICE_RSS_OUTER_HEADERS, 0};

struct ice_rss_hash_cfg eth_ipv4_l2tpv3_tmplt = {
    ICE_FLOW_SEG_HDR_IPV4 | ICE_FLOW_SEG_HDR_IPV_OTHER |
        ICE_FLOW_SEG_HDR_L2TPV3,
    ICE_FLOW_HASH_L2TPV3_SESS_ID, ICE_RSS_OUTER_HEADERS, 0};

struct ice_rss_hash_cfg eth_ipv4_pfcp_tmplt = {
    ICE_FLOW_SEG_HDR_IPV4 | ICE_FLOW_SEG_HDR_IPV_OTHER |
        ICE_FLOW_SEG_HDR_PFCP_SESSION,
    ICE_FLOW_HASH_PFCP_SEID, ICE_RSS_OUTER_HEADERS, 0};

struct ice_rss_hash_cfg eth_ipv6_esp_tmplt = {
    ICE_FLOW_SEG_HDR_IPV6 | ICE_FLOW_SEG_HDR_IPV_OTHER | ICE_FLOW_SEG_HDR_ESP,
    ICE_FLOW_HASH_ESP_SPI, ICE_RSS_OUTER_HEADERS, 0};
...
struct ice_rss_hash_cfg eth_ipv6_ah_tmplt = {
    ICE_FLOW_SEG_HDR_IPV6 | ICE_FLOW_SEG_HDR_IPV_OTHER | ICE_FLOW_SEG_HDR_AH,
    ICE_FLOW_HASH_AH_SPI, ICE_RSS_OUTER_HEADERS, 0};
...
struct ice_rss_hash_cfg empty_tmplt = {ICE_FLOW_SEG_HDR_NONE, 0,
                                       ICE_RSS_ANY_HEADERS, 0};

struct ice_rss_hash_cfg eth_tmplt = {
    ICE_FLOW_SEG_HDR_ETH | ICE_FLOW_SEG_HDR_ETH_NON_IP, ICE_FLOW_HASH_ETH,
    ICE_RSS_OUTER_HEADERS, 0};

/* IPv4 */
#define ICE_RSS_TYPE_ETH_IPV4                                                  \
  (RTE_ETH_RSS_ETH | RTE_ETH_RSS_IPV4 | RTE_ETH_RSS_FRAG_IPV4 |                \
   RTE_ETH_RSS_IPV4_CHKSUM)
#define ICE_RSS_TYPE_ETH_IPV4_UDP                                              \
  (ICE_RSS_TYPE_ETH_IPV4 | RTE_ETH_RSS_NONFRAG_IPV4_UDP | RTE_ETH_RSS_L4_CHKSUM)
#define ICE_RSS_TYPE_ETH_IPV4_TCP                                              \
  (ICE_RSS_TYPE_ETH_IPV4 | RTE_ETH_RSS_NONFRAG_IPV4_TCP | RTE_ETH_RSS_L4_CHKSUM)
#define ICE_RSS_TYPE_ETH_IPV4_SCTP                                             \
  (ICE_RSS_TYPE_ETH_IPV4 | RTE_ETH_RSS_NONFRAG_IPV4_SCTP |                     \
   RTE_ETH_RSS_L4_CHKSUM)
#define ICE_RSS_TYPE_IPV4 RTE_ETH_RSS_IPV4
#define ICE_RSS_TYPE_IPV4_UDP (RTE_ETH_RSS_IPV4 | RTE_ETH_RSS_NONFRAG_IPV4_UDP)
#define ICE_RSS_TYPE_IPV4_TCP (RTE_ETH_RSS_IPV4 | RTE_ETH_RSS_NONFRAG_IPV4_TCP)
...
#define ICE_RSS_TYPE_ETH_IPV6_FRAG                                             \
  (RTE_ETH_RSS_ETH | RTE_ETH_RSS_IPV6 | RTE_ETH_RSS_FRAG_IPV6)
#define ICE_RSS_TYPE_ETH_IPV6_UDP                                              \
  (ICE_RSS_TYPE_ETH_IPV6 | RTE_ETH_RSS_NONFRAG_IPV6_UDP | RTE_ETH_RSS_L4_CHKSUM)
#define ICE_RSS_TYPE_ETH_IPV6_TCP                                              \
  (ICE_RSS_TYPE_ETH_IPV6 | RTE_ETH_RSS_NONFRAG_IPV6_TCP | RTE_ETH_RSS_L4_CHKSUM)
#define ICE_RSS_TYPE_ETH_IPV6_SCTP                                             \
  (ICE_RSS_TYPE_ETH_IPV6 | RTE_ETH_RSS_NONFRAG_IPV6_SCTP |                     \
   RTE_ETH_RSS_L4_CHKSUM)
#define ICE_RSS_TYPE_IPV6 RTE_ETH_RSS_IPV6
#define ICE_RSS_TYPE_IPV6_UDP (RTE_ETH_RSS_IPV6 | RTE_ETH_RSS_NONFRAG_IPV6_UDP)
#define ICE_RSS_TYPE_IPV6_TCP (RTE_ETH_RSS_IPV6 | RTE_ETH_RSS_NONFRAG_IPV6_TCP)
#define ICE_RSS_TYPE_IPV6_SCTP                                                 \
  (RTE_ETH_RSS_IPV6 | RTE_ETH_RSS_NONFRAG_IPV6_SCTP)

/* VLAN IPV4 */
#define ICE_RSS_TYPE_VLAN_IPV4                                                 \
  (ICE_RSS_TYPE_IPV4 | RTE_ETH_RSS_S_VLAN | RTE_ETH_RSS_C_VLAN |               \
   RTE_ETH_RSS_FRAG_IPV4)
#define ICE_RSS_TYPE_VLAN_IPV4_UDP                                             \
  (ICE_RSS_TYPE_IPV4_UDP | RTE_ETH_RSS_S_VLAN | RTE_ETH_RSS_C_VLAN)
#define ICE_RSS_TYPE_VLAN_IPV4_TCP                                             \
  (ICE_RSS_TYPE_IPV4_TCP | RTE_ETH_RSS_S_VLAN | RTE_ETH_RSS_C_VLAN)
#define ICE_RSS_TYPE_VLAN_IPV4_SCTP                                            \
  (ICE_RSS_TYPE_IPV4_SCTP | RTE_ETH_RSS_S_VLAN | RTE_ETH_RSS_C_VLAN)
/* VLAN IPv6 */
#define ICE_RSS_TYPE_VLAN_IPV6                                                 \
  (ICE_RSS_TYPE_IPV6 | RTE_ETH_RSS_S_VLAN | RTE_ETH_RSS_C_VLAN)
#define ICE_RSS_TYPE_VLAN_IPV6_FRAG                                            \
  (ICE_RSS_TYPE_IPV6 | RTE_ETH_RSS_S_VLAN | RTE_ETH_RSS_C_VLAN |               \
   RTE_ETH_RSS_FRAG_IPV6)
#define ICE_RSS_TYPE_VLAN_IPV6_UDP                                             \
  (ICE_RSS_TYPE_IPV6_UDP | RTE_ETH_RSS_S_VLAN | RTE_ETH_RSS_C_VLAN)
#define ICE_RSS_TYPE_VLAN_IPV6_TCP                                             \
  (ICE_RSS_TYPE_IPV6_TCP | RTE_ETH_RSS_S_VLAN | RTE_ETH_RSS_C_VLAN)
#define ICE_RSS_TYPE_VLAN_IPV6_SCTP                                            \
  (ICE_RSS_TYPE_IPV6_SCTP | RTE_ETH_RSS_S_VLAN | RTE_ETH_RSS_C_VLAN)

/* GTPU IPv4 */
#define ICE_RSS_TYPE_GTPU_IPV4 (ICE_RSS_TYPE_IPV4 | RTE_ETH_RSS_GTPU)
#define ICE_RSS_TYPE_GTPU_IPV4_UDP (ICE_RSS_TYPE_IPV4_UDP | RTE_ETH_RSS_GTPU)
#define ICE_RSS_TYPE_GTPU_IPV4_TCP (ICE_RSS_TYPE_IPV4_TCP | RTE_ETH_RSS_GTPU)
/* GTPU IPv6 */
#define ICE_RSS_TYPE_GTPU_IPV6 (ICE_RSS_TYPE_IPV6 | RTE_ETH_RSS_GTPU)
#define ICE_RSS_TYPE_GTPU_IPV6_UDP (ICE_RSS_TYPE_IPV6_UDP | RTE_ETH_RSS_GTPU)
#define ICE_RSS_TYPE_GTPU_IPV6_TCP (ICE_RSS_TYPE_IPV6_TCP | RTE_ETH_RSS_GTPU)

/* PPPOE */
#define ICE_RSS_TYPE_PPPOE (RTE_ETH_RSS_ETH | RTE_ETH_RSS_PPPOE)

/* PPPOE IPv4 */
#define ICE_RSS_TYPE_PPPOE_IPV4 (ICE_RSS_TYPE_IPV4 | ICE_RSS_TYPE_PPPOE)
#define ICE_RSS_TYPE_PPPOE_IPV4_UDP (ICE_RSS_TYPE_IPV4_UDP | ICE_RSS_TYPE_PPPOE)
#define ICE_RSS_TYPE_PPPOE_IPV4_TCP (ICE_RSS_TYPE_IPV4_TCP | ICE_RSS_TYPE_PPPOE)

/* PPPOE IPv6 */
#define ICE_RSS_TYPE_PPPOE_IPV6 (ICE_RSS_TYPE_IPV6 | ICE_RSS_TYPE_PPPOE)
#define ICE_RSS_TYPE_PPPOE_IPV6_UDP (ICE_RSS_TYPE_IPV6_UDP | ICE_RSS_TYPE_PPPOE)
#define ICE_RSS_TYPE_PPPOE_IPV6_TCP (ICE_RSS_TYPE_IPV6_TCP | ICE_RSS_TYPE_PPPOE)
...
static struct ice_pattern_match_item ice_hash_pattern_list[] = {
    ...
    {pattern_eth_ipv4_udp, ICE_RSS_TYPE_ETH_IPV4_UDP, ICE_INSET_NONE,
     &ipv4_udp_tmplt},
    {pattern_eth_ipv4_tcp, ICE_RSS_TYPE_ETH_IPV4_TCP, ICE_INSET_NONE,
     &ipv4_tcp_tmplt},
    {pattern_eth_ipv4_sctp, ICE_RSS_TYPE_ETH_IPV4_SCTP, ICE_INSET_NONE,
     &ipv4_sctp_tmplt},
    {pattern_eth_vlan_ipv4, ICE_RSS_TYPE_VLAN_IPV4, ICE_INSET_NONE,
     &ipv4_tmplt},
    {pattern_eth_vlan_ipv4_udp, ICE_RSS_TYPE_VLAN_IPV4_UDP, ICE_INSET_NONE,
     &ipv4_udp_tmplt},
    {pattern_eth_vlan_ipv4_tcp, ICE_RSS_TYPE_VLAN_IPV4_TCP, ICE_INSET_NONE,
     &ipv4_tcp_tmplt},
    {pattern_eth_vlan_ipv4_sctp, ICE_RSS_TYPE_VLAN_IPV4_SCTP, ICE_INSET_NONE,
     &ipv4_sctp_tmplt},
    {pattern_eth_ipv4_gtpu_ipv4, ICE_RSS_TYPE_GTPU_IPV4, ICE_INSET_NONE,
     &outer_ipv4_inner_ipv4_tmplt},
    {pattern_eth_ipv4_gtpu_ipv4_udp, ICE_RSS_TYPE_GTPU_IPV4_UDP, ICE_INSET_NONE,
     &outer_ipv4_inner_ipv4_udp_tmplt},
    {pattern_eth_ipv4_gtpu_ipv4_tcp, ICE_RSS_TYPE_GTPU_IPV4_TCP, ICE_INSET_NONE,
     &outer_ipv4_inner_ipv4_tcp_tmplt},
    {pattern_eth_ipv6_gtpu_ipv4, ICE_RSS_TYPE_GTPU_IPV4, ICE_INSET_NONE,
     &outer_ipv6_inner_ipv4_tmplt},
    {pattern_eth_ipv6_gtpu_ipv4_udp, ICE_RSS_TYPE_GTPU_IPV4_UDP, ICE_INSET_NONE,
     &outer_ipv6_inner_ipv4_udp_tmplt},
    {pattern_eth_ipv6_gtpu_ipv4_tcp, ICE_RSS_TYPE_GTPU_IPV4_TCP, ICE_INSET_NONE,
     &outer_ipv6_inner_ipv4_tcp_tmplt},
    {pattern_eth_ipv4_gtpu_eh_ipv4, ICE_RSS_TYPE_GTPU_IPV4, ICE_INSET_NONE,
     &outer_ipv4_inner_ipv4_tmplt},
    {pattern_eth_ipv4_gtpu_eh_ipv4_udp, ICE_RSS_TYPE_GTPU_IPV4_UDP,
     ICE_INSET_NONE, &outer_ipv4_inner_ipv4_udp_tmplt},
    {pattern_eth_ipv4_gtpu_eh_ipv4_tcp, ICE_RSS_TYPE_GTPU_IPV4_TCP,
     ICE_INSET_NONE, &outer_ipv4_inner_ipv4_tcp_tmplt},
    {pattern_eth_ipv6_gtpu_eh_ipv4, ICE_RSS_TYPE_GTPU_IPV4, ICE_INSET_NONE,
     &outer_ipv6_inner_ipv4_tmplt},
    {pattern_eth_ipv6_gtpu_eh_ipv4_udp, ICE_RSS_TYPE_GTPU_IPV4_UDP,
     ICE_INSET_NONE, &outer_ipv6_inner_ipv4_udp_tmplt},
    {pattern_eth_ipv6_gtpu_eh_ipv4_tcp, ICE_RSS_TYPE_GTPU_IPV4_TCP,
     ICE_INSET_NONE, &outer_ipv6_inner_ipv4_tcp_tmplt},
    {pattern_eth_pppoes_ipv4, ICE_RSS_TYPE_PPPOE_IPV4, ICE_INSET_NONE,
     &ipv4_tmplt},
    {pattern_eth_pppoes_ipv4_udp, ICE_RSS_TYPE_PPPOE_IPV4_UDP, ICE_INSET_NONE,
     &ipv4_udp_tmplt},
    {pattern_eth_pppoes_ipv4_tcp, ICE_RSS_TYPE_PPPOE_IPV4_TCP, ICE_INSET_NONE,
     &ipv4_tcp_tmplt},
    {pattern_eth_ipv4_esp, ICE_RSS_TYPE_IPV4_ESP, ICE_INSET_NONE,
     &eth_ipv4_esp_tmplt},
    {pattern_eth_ipv4_udp_esp, ICE_RSS_TYPE_IPV4_ESP, ICE_INSET_NONE,
     &eth_ipv4_udp_esp_tmplt},
    {pattern_eth_ipv4_ah, ICE_RSS_TYPE_IPV4_AH, ICE_INSET_NONE,
     &eth_ipv4_ah_tmplt},
    {pattern_eth_ipv4_l2tp, ICE_RSS_TYPE_IPV4_L2TPV3, ICE_INSET_NONE,
     &eth_ipv4_l2tpv3_tmplt},
    {pattern_eth_ipv4_pfcp, ICE_RSS_TYPE_IPV4_PFCP, ICE_INSET_NONE,
     &eth_ipv4_pfcp_tmplt},
    /* IPV6 */
    {pattern_eth_ipv6, ICE_RSS_TYPE_ETH_IPV6, ICE_INSET_NONE, &ipv6_tmplt},
    {pattern_eth_ipv6_frag_ext, ICE_RSS_TYPE_ETH_IPV6_FRAG, ICE_INSET_NONE,
     &ipv6_frag_tmplt},
    {pattern_eth_ipv6_udp, ICE_RSS_TYPE_ETH_IPV6_UDP, ICE_INSET_NONE,
     &ipv6_udp_tmplt},
    {pattern_eth_ipv6_tcp, ICE_RSS_TYPE_ETH_IPV6_TCP, ICE_INSET_NONE,
     &ipv6_tcp_tmplt},
    {pattern_eth_ipv6_sctp, ICE_RSS_TYPE_ETH_IPV6_SCTP, ICE_INSET_NONE,
     &ipv6_sctp_tmplt},
    {pattern_eth_vlan_ipv6, ICE_RSS_TYPE_VLAN_IPV6, ICE_INSET_NONE,
     &ipv6_tmplt},
    {pattern_eth_vlan_ipv6_frag_ext, ICE_RSS_TYPE_VLAN_IPV6_FRAG,
     ICE_INSET_NONE, &ipv6_frag_tmplt},
    {pattern_eth_vlan_ipv6_udp, ICE_RSS_TYPE_VLAN_IPV6_UDP, ICE_INSET_NONE,
     &ipv6_udp_tmplt},
    {pattern_eth_vlan_ipv6_tcp, ICE_RSS_TYPE_VLAN_IPV6_TCP, ICE_INSET_NONE,
     &ipv6_tcp_tmplt},
    {pattern_eth_vlan_ipv6_sctp, ICE_RSS_TYPE_VLAN_IPV6_SCTP, ICE_INSET_NONE,
     &ipv6_sctp_tmplt},
    {pattern_eth_ipv4_gtpu_ipv6, ICE_RSS_TYPE_GTPU_IPV6, ICE_INSET_NONE,
     &outer_ipv4_inner_ipv6_tmplt},
    {pattern_eth_ipv4_gtpu_ipv6_udp, ICE_RSS_TYPE_GTPU_IPV6_UDP, ICE_INSET_NONE,
     &outer_ipv4_inner_ipv6_udp_tmplt},
    {pattern_eth_ipv4_gtpu_ipv6_tcp, ICE_RSS_TYPE_GTPU_IPV6_TCP, ICE_INSET_NONE,
     &outer_ipv4_inner_ipv6_tcp_tmplt},
    {pattern_eth_ipv6_gtpu_ipv6, ICE_RSS_TYPE_GTPU_IPV6, ICE_INSET_NONE,
     &outer_ipv6_inner_ipv6_tmplt},
    {pattern_eth_ipv6_gtpu_ipv6_udp, ICE_RSS_TYPE_GTPU_IPV6_UDP, ICE_INSET_NONE,
     &outer_ipv6_inner_ipv6_udp_tmplt},
    {pattern_eth_ipv6_gtpu_ipv6_tcp, ICE_RSS_TYPE_GTPU_IPV6_TCP, ICE_INSET_NONE,
     &outer_ipv6_inner_ipv6_tcp_tmplt},
    {pattern_eth_ipv4_gtpu_eh_ipv6, ICE_RSS_TYPE_GTPU_IPV6, ICE_INSET_NONE,
     &outer_ipv4_inner_ipv6_tmplt},
    {pattern_eth_ipv4_gtpu_eh_ipv6_udp, ICE_RSS_TYPE_GTPU_IPV6_UDP,
     ICE_INSET_NONE, &outer_ipv4_inner_ipv6_udp_tmplt},
    {pattern_eth_ipv4_gtpu_eh_ipv6_tcp, ICE_RSS_TYPE_GTPU_IPV6_TCP,
     ICE_INSET_NONE, &outer_ipv4_inner_ipv6_tcp_tmplt},
    {pattern_eth_ipv6_gtpu_eh_ipv6, ICE_RSS_TYPE_GTPU_IPV6, ICE_INSET_NONE,
     &outer_ipv6_inner_ipv6_tmplt},
    {pattern_eth_ipv6_gtpu_eh_ipv6_udp, ICE_RSS_TYPE_GTPU_IPV6_UDP,
     ICE_INSET_NONE, &outer_ipv6_inner_ipv6_udp_tmplt},
    {pattern_eth_ipv6_gtpu_eh_ipv6_tcp, ICE_RSS_TYPE_GTPU_IPV6_TCP,
     ICE_INSET_NONE, &outer_ipv6_inner_ipv6_tcp_tmplt},
    {pattern_eth_pppoes_ipv6, ICE_RSS_TYPE_PPPOE_IPV6, ICE_INSET_NONE,
     &ipv6_tmplt},
    {pattern_eth_pppoes_ipv6_udp, ICE_RSS_TYPE_PPPOE_IPV6_UDP, ICE_INSET_NONE,
     &ipv6_udp_tmplt},
    {pattern_eth_pppoes_ipv6_tcp, ICE_RSS_TYPE_PPPOE_IPV6_TCP, ICE_INSET_NONE,
     &ipv6_tcp_tmplt},
    {pattern_eth_ipv6_esp, ICE_RSS_TYPE_IPV6_ESP, ICE_INSET_NONE,
     &eth_ipv6_esp_tmplt},
    {pattern_eth_ipv6_udp_esp, ICE_RSS_TYPE_IPV6_ESP, ICE_INSET_NONE,
     &eth_ipv6_udp_esp_tmplt},
    {pattern_eth_ipv6_ah, ICE_RSS_TYPE_IPV6_AH, ICE_INSET_NONE,
     &eth_ipv6_ah_tmplt},
    {pattern_eth_ipv6_l2tp, ICE_RSS_TYPE_IPV6_L2TPV3, ICE_INSET_NONE,
     &eth_ipv6_l2tpv3_tmplt},
    {pattern_eth_ipv6_pfcp, ICE_RSS_TYPE_IPV6_PFCP, ICE_INSET_NONE,
     &eth_ipv6_pfcp_tmplt},
    /* PPPOE */
...
static int ice_hash_parse_pattern(const struct rte_flow_item pattern[],
                                  uint64_t *phint,
                                  struct rte_flow_error *error) {
...
static int ice_hash_parse_raw_pattern(struct ice_adapter *ad,
  ...
  if (strlen((char *)(uintptr_t)raw_mask->pattern) != spec_len)
    return -rte_errno;
  ...
  if (ice_parser_profile_init(&rslt, pkt_buf, msk_buf, pkt_len, ICE_BLK_RSS,
                              true, &prof))
    return -rte_errno;
...
static void ice_refine_hash_cfg_l234(struct ice_rss_hash_cfg *hash_cfg,
                                     uint64_t rss_type) {
  ...
  if (*addl_hdrs & ICE_FLOW_SEG_HDR_IPV4) {
    if (rss_type &
      ...
      else if (rss_type & (RTE_ETH_RSS_L4_SRC_ONLY | RTE_ETH_RSS_L4_DST_ONLY))
  ...
  if (*addl_hdrs & ICE_FLOW_SEG_HDR_UDP) {
    if (rss_type &
      ...
      else if (rss_type & (RTE_ETH_RSS_L3_SRC_ONLY | RTE_ETH_RSS_L3_DST_ONLY))
...
static void ice_refine_proto_hdrs_by_pattern(struct ice_rss_hash_cfg *hash_cfg,
                                             uint64_t phint) {
  uint32_t *addl_hdrs = &hash_cfg->addl_hdrs;
...
static void ice_refine_hash_cfg_gtpu(struct ice_rss_hash_cfg *hash_cfg,
                                     uint64_t rss_type) {
  uint32_t *addl_hdrs = &hash_cfg->addl_hdrs;
  uint64_t *hash_flds = &hash_cfg->hash_flds;
...
static bool ice_any_invalid_rss_type(enum rte_eth_hash_function rss_func,
                                     uint64_t rss_type,
  ...
  if (rss_func == RTE_ETH_HASH_FUNCTION_SYMMETRIC_TOEPLITZ) {
    ...
    if (!(rss_type &
          (RTE_ETH_RSS_IPV4 | RTE_ETH_RSS_IPV6 | RTE_ETH_RSS_FRAG_IPV4 |
           RTE_ETH_RSS_FRAG_IPV6 | RTE_ETH_RSS_NONFRAG_IPV4_UDP |
    ...
    case RTE_FLOW_ACTION_TYPE_RSS:
      ...
      if (pattern_match_item->pattern_list != pattern_empty &&
        ...
        return rte_flow_error_set(error, ENOTSUP, RTE_FLOW_ERROR_TYPE_ACTION,
                                  action, "Not supported flow");
      } else if (rss->func == RTE_ETH_HASH_FUNCTION_SIMPLE_XOR) {
        rss_meta->hash_function = RTE_ETH_HASH_FUNCTION_SIMPLE_XOR;
        return 0;
      } else if (rss->func == RTE_ETH_HASH_FUNCTION_SYMMETRIC_TOEPLITZ) {
      ...
      rss_meta->cfg = *cfg;
      ice_refine_hash_cfg(&rss_meta->cfg, rss_type, pattern_hint);
      break;
    case RTE_FLOW_ACTION_TYPE_END:
      break;

    default:
      rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ACTION, action,
                         "Invalid action.");
      return -rte_errno;
    }
  }
...
static int ice_hash_parse_pattern_action(__rte_unused struct ice_adapter *ad,
                                         struct ice_pattern_match_item *array,
                                         uint32_t array_len,
                                         const struct rte_flow_item pattern[],
                                         const struct rte_flow_action actions[],
  ...
  /* Check rss action. */
  ret = ice_hash_parse_action(pattern_match_item, actions, phint, rss_meta_ptr,
                              error);
...
static int ice_hash_add_raw_cfg(struct ice_adapter *ad,
  ...
  if (rss_prof->prof.fv_num) {
    for (i = 0; i < ICE_MAX_FV_WORDS; i++) {
      if (rss_prof->prof.fv[i].proto_id != prof->fv[i].proto_id ||
          rss_prof->prof.fv[i].offset != prof->fv[i].offset)
        break;
    }
    ...
    ret = ice_rem_prof_id_flow(hw, ICE_BLK_RSS,
                               ice_get_hw_vsi_num(hw, vsi_handle), id);
    if (ret) {
  ...
  ice_memcpy(&rss_prof->prof, prof, sizeof(struct ice_parser_profile),
...
static int ice_hash_create(struct ice_adapter *ad, struct rte_flow *flow,
  ...
  filter_ptr =
      rte_zmalloc("ice_rss_filter", sizeof(struct ice_hash_flow_cfg), 0);
  if (!filter_ptr) {
    rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_HANDLE, NULL,
  ...
  if (hash_function == RTE_ETH_HASH_FUNCTION_SIMPLE_XOR) {
    ...
    if (rss_meta->raw.raw_ena) {
      ...
      ret = ice_hash_add_raw_cfg(ad, &rss_meta->raw, pf->main_vsi->idx);
      if (ret) {
        rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_HANDLE, NULL,
      ...
      ret = ice_add_rss_cfg_wrap(pf, vsi->idx, &filter_ptr->rss_cfg.hash);
      if (ret) {
        rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_HANDLE, NULL,
                           "rss flow create fail");
        goto error;
...
static int ice_hash_rem_raw_cfg(struct ice_adapter *ad,
                                struct ice_parser_profile *prof,
                                u16 vsi_handle) {
  struct ice_hw *hw = &ad->hw;
  int ptg, ret;
  ...
  memset(&ad->rss_prof_info[ptg], 0, sizeof(struct ice_rss_prof_info));

  /* check if vsig is already removed */
  ret = ice_vsig_find_vsi(hw, ICE_BLK_RSS, ice_get_hw_vsi_num(hw, vsi_handle),
                          &vsig);
  if (!ret && vsig) {
    ret = ice_rem_prof_id_flow(hw, ICE_BLK_RSS,
                               ice_get_hw_vsi_num(hw, vsi_handle), id);
...
static int ice_hash_destroy(struct ice_adapter *ad, struct rte_flow *flow,
  ...
  if (filter_ptr->simple_xor == 1) {
    ...
    if (filter_ptr->rss_cfg.raw.raw_ena) {
      ret = ice_hash_rem_raw_cfg(ad, &filter_ptr->rss_cfg.raw.prof,
                                 pf->main_vsi->idx);
      if (ret) {
        rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_HANDLE, NULL,
      ...
      ret = ice_rem_rss_cfg_wrap(pf, vsi->idx, &filter_ptr->rss_cfg.hash);
...
static void ice_hash_free(struct rte_flow *flow) { rte_free(flow->rule); }
