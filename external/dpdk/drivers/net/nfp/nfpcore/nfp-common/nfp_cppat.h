 ...
 */
static inline int _nfp6000_encode_basic(uint64_t *addr, int dest_island,
                                        int cpp_tgt, int mode, int addr40,
                                        int isld1, int isld0) {
  uint64_t _u64;
  int iid_lsb, idx_lsb;
  ...
  case 0:
    if (cpp_tgt == NFP6000_CPPTGT_VQDR && !addr40) {
       ...
       */
      i = _nfp6000_decode_basic(*addr, &v, cpp_tgt, mode, addr40, isld1, isld0);
      if (i != 0)
...
static inline int _nfp6000_encode_mu(uint64_t *addr, int dest_island, int mode,
...
static inline int _nfp6000_decode_mu(uint64_t addr, int *dest_island, int mode,
                                     int addr40, int isld1, int isld0) {
  int iid_lsb, idx_lsb, locality_lsb;
  int da;
...
static inline int _nfp6000_cppat_addr_encode(uint64_t *addr, int dest_island,
                                             int cpp_tgt, int mode, int addr40,
                                             int isld1, int isld0) {
  switch (cpp_tgt) {
  ...
  case NFP6000_CPPTGT_CLS:
    return _nfp6000_encode_basic(addr, dest_island, cpp_tgt, mode, addr40,
                                 isld1, isld0);

  case NFP6000_CPPTGT_MU:
    return _nfp6000_encode_mu(addr, dest_island, mode, addr40, isld1, isld0);
...
static inline int _nfp6000_cppat_addr_decode(uint64_t addr, int *dest_island,
                                             int cpp_tgt, int mode, int addr40,
                                             int isld1, int isld0) {
  switch (cpp_tgt) {
  case NFP6000_CPPTGT_NBI:
  ...
  case NFP6000_CPPTGT_CRYPTO:
  case NFP6000_CPPTGT_CLS:
    return _nfp6000_decode_basic(addr, dest_island, cpp_tgt, mode, addr40,
                                 isld1, isld0);

  case NFP6000_CPPTGT_MU:
    return _nfp6000_decode_mu(addr, dest_island, mode, addr40, isld1, isld0);
...
static inline int _nfp6000_cppat_addr_iid_clear(uint64_t *addr, int cpp_tgt,
                                                int mode, int addr40) {
