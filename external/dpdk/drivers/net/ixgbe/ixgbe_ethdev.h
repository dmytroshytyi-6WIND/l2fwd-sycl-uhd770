...
#endif
#define IXGBE_HWSTRIP_BITMAP_SIZE                                              \
  (IXGBE_MAX_RX_QUEUE_NUM / (sizeof(uint32_t) * NBBY))
...
#define IXGBE_MII_AUTONEG_ENABLE                                               \
  0x1000 /* Auto-negotiation enable (default = 1) */
...
#define IXGBE_L34T_IMIR_RESERVE                                                \
  0x00080000 /* bit 13 to 19 must be set to 1000000b. */
...
#define IXGBE_LINK_SPEED_X550_AUTONEG                                          \
  (IXGBE_LINK_SPEED_100_FULL | IXGBE_LINK_SPEED_1GB_FULL |                     \
   IXGBE_LINK_SPEED_2_5GB_FULL | IXGBE_LINK_SPEED_5GB_FULL |                   \
