 ...
 */
s32 ixgbe_dcb_hw_config_82599(struct ixgbe_hw *hw, int link_speed, u16 *refill,
                              u16 *max, u8 *bwg_id, u8 *tsa, u8 *map) {
