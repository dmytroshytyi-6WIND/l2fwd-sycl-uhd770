...
#define IXGBE_RDRXCTL_MPBEN                                                    \
  0x00000010 /* DMA config for multiple packet                                 \
              * buffers enable                                                 \
              */
#define IXGBE_RDRXCTL_MCEN                                                     \
  0x00000040 /* DMA config for multiple cores                                  \
              * (RSS) enable                                                   \
              */
...
s32 ixgbe_dcb_get_tc_stats_82599(struct ixgbe_hw *, struct ixgbe_hw_stats *,
                                 u8);
s32 ixgbe_dcb_get_pfc_stats_82599(struct ixgbe_hw *, struct ixgbe_hw_stats *,
                                  u8);
...
s32 ixgbe_dcb_hw_config_82599(struct ixgbe_hw *, int, u16 *, u16 *, u8 *, u8 *,
                              u8 *);
