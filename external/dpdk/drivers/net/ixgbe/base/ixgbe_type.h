...
#define IXGBE_EITR(_i)                                                         \
  (((_i) <= 23) ? (0x00820 + ((_i)*4)) : (0x012300 + (((_i)-24) * 4)))
...
#define IXGBE_RDBAL(_i)                                                        \
  (((_i) < 64) ? (0x01000 + ((_i)*0x40)) : (0x0D000 + (((_i)-64) * 0x40)))
#define IXGBE_RDBAH(_i)                                                        \
  (((_i) < 64) ? (0x01004 + ((_i)*0x40)) : (0x0D004 + (((_i)-64) * 0x40)))
#define IXGBE_RDLEN(_i)                                                        \
  (((_i) < 64) ? (0x01008 + ((_i)*0x40)) : (0x0D008 + (((_i)-64) * 0x40)))
#define IXGBE_RDH(_i)                                                          \
  (((_i) < 64) ? (0x01010 + ((_i)*0x40)) : (0x0D010 + (((_i)-64) * 0x40)))
#define IXGBE_RDT(_i)                                                          \
  (((_i) < 64) ? (0x01018 + ((_i)*0x40)) : (0x0D018 + (((_i)-64) * 0x40)))
#define IXGBE_RXDCTL(_i)                                                       \
  (((_i) < 64) ? (0x01028 + ((_i)*0x40)) : (0x0D028 + (((_i)-64) * 0x40)))
#define IXGBE_RSCCTL(_i)                                                       \
  (((_i) < 64) ? (0x0102C + ((_i)*0x40)) : (0x0D02C + (((_i)-64) * 0x40)))
...
#define IXGBE_RAL(_i)                                                          \
  (((_i) <= 15) ? (0x05400 + ((_i)*8)) : (0x0A200 + ((_i)*8)))
#define IXGBE_RAH(_i)                                                          \
  (((_i) <= 15) ? (0x05404 + ((_i)*8)) : (0x0A204 + ((_i)*8)))
#define IXGBE_MPSAR_LO(_i) (0x0A600 + ((_i)*8))
#define IXGBE_MPSAR_HI(_i) (0x0A604 + ((_i)*8))
/* Packet split receive type */
#define IXGBE_PSRTYPE(_i)                                                      \
  (((_i) <= 15) ? (0x05480 + ((_i)*4)) : (0x0EA00 + ((_i)*4)))
...
#define IXGBE_TQSMR(_i)                                                        \
  (((_i) <= 7) ? (0x07300 + ((_i)*4)) : (0x08600 + ((_i)*4)))
...
#define IXGBE_GCR_EXT_SRIOV (IXGBE_GCR_EXT_MSIX_EN | IXGBE_GCR_EXT_VT_MODE_64)
...
#define IXGBE_AUXSTMPH0                                                        \
  0x08C40                       /* Auxiliary Time Stamp 0 register High - RO   \
                                 */
#define IXGBE_AUXSTMPL1 0x08C44 /* Auxiliary Time Stamp 1 register Low - RO */
#define IXGBE_AUXSTMPH1                                                        \
  0x08C48                   /* Auxiliary Time Stamp 1 register High - RO       \
                             */
...
#define IXGBE_MDIO_AUTO_NEG_VENDOR_STAT                                        \
  0xC800 /* AUTO_NEG Vendor Status Reg                                         \
          */
#define IXGBE_MDIO_AUTO_NEG_VENDOR_TX_ALARM                                    \
  0xCC00 /* AUTO_NEG Vendor TX Reg                                             \
          */
#define IXGBE_MDIO_AUTO_NEG_VENDOR_TX_ALARM2                                   \
  0xCC01                                       /* AUTO_NEG Vendor Tx Reg       \
                                                */
...
#define IXGBE_AUTO_NEG_LP_1000BASE_CAP                                         \
  0x8000                                     /* AUTO NEG Rx LP 1000BaseT Cap   \
                                              */
...
#define IXGBE_MDIO_TX_VENDOR_ALARMS_3_RST_MASK                                 \
  0x3 /* PHY Reset Complete Mask                                               \
       */
#define IXGBE_MDIO_GLOBAL_RES_PR_10                                            \
  0xC479                                 /* Global Resv Provisioning 10 Reg    \
                                          */
...
#define IXGBE_MDIO_GLOBAL_AN_VEN_ALM_INT_EN                                    \
  0x1000                                  /* autoneg vendor alarm int enable */
...
#define IXGBE_EICR_GPI_SDP0_X540                                               \
  0x02000000 /* Gen Purpose Interrupt on SDP0                                  \
              */
#define IXGBE_EICR_GPI_SDP1_X540                                               \
  0x04000000 /* Gen Purpose Interrupt on SDP1                                  \
              */
...
#define IXGBE_EIMS_ENABLE_MASK                                                 \
  (IXGBE_EIMS_RTX_QUEUE | IXGBE_EIMS_LSC | IXGBE_EIMS_TCP_TIMER |              \
   IXGBE_EIMS_OTHER)
...
#define IXGBE_RXD_ERR_FRAME_ERR_MASK                                           \
  (IXGBE_RXD_ERR_CE | IXGBE_RXD_ERR_LE | IXGBE_RXD_ERR_PE |                    \
   IXGBE_RXD_ERR_OSE | IXGBE_RXD_ERR_USE)

#define IXGBE_RXDADV_ERR_FRAME_ERR_MASK                                        \
  (IXGBE_RXDADV_ERR_CE | IXGBE_RXDADV_ERR_LE | IXGBE_RXDADV_ERR_PE |           \
   IXGBE_RXDADV_ERR_OSE | IXGBE_RXDADV_ERR_USE)
...
#define IXGBE_PVTEITR(P)                                                       \
  (((P) < 24) ? (0x00820 + ((P)*4)) : (0x012300 + (((P)-24) * 4)))
...
#define IXGBE_PVFRDBAL(P)                                                      \
  ((P < 64) ? (0x01000 + (0x40 * (P))) : (0x0D000 + (0x40 * ((P)-64))))
#define IXGBE_PVFRDBAH(P)                                                      \
  ((P < 64) ? (0x01004 + (0x40 * (P))) : (0x0D004 + (0x40 * ((P)-64))))
#define IXGBE_PVFRDLEN(P)                                                      \
  ((P < 64) ? (0x01008 + (0x40 * (P))) : (0x0D008 + (0x40 * ((P)-64))))
#define IXGBE_PVFRDH(P)                                                        \
  ((P < 64) ? (0x01010 + (0x40 * (P))) : (0x0D010 + (0x40 * ((P)-64))))
#define IXGBE_PVFRDT(P)                                                        \
  ((P < 64) ? (0x01018 + (0x40 * (P))) : (0x0D018 + (0x40 * ((P)-64))))
#define IXGBE_PVFRXDCTL(P)                                                     \
  ((P < 64) ? (0x01028 + (0x40 * (P))) : (0x0D028 + (0x40 * ((P)-64))))
#define IXGBE_PVFSRRCTL(P)                                                     \
  ((P < 64) ? (0x01014 + (0x40 * (P))) : (0x0D014 + (0x40 * ((P)-64))))
...
#define IXGBE_PVFDCA_RXCTRL(P)                                                 \
  (((P) < 64) ? (0x0100C + (0x40 * (P))) : (0x0D00C + (0x40 * ((P)-64))))
...
#define FW_PHY_ACT_SETUP_LINK_PAUSE_MASK                                       \
  (3u << FW_PHY_ACT_SETUP_LINK_PAUSE_SHIFT)
...
#define IXGBE_ADVTXD_POPTS_IXSM                                                \
  (IXGBE_TXD_POPTS_IXSM << IXGBE_ADVTXD_POPTS_SHIFT)
#define IXGBE_ADVTXD_POPTS_TXSM                                                \
  (IXGBE_TXD_POPTS_TXSM << IXGBE_ADVTXD_POPTS_SHIFT)
...
#define IXGBE_DV_X540(_max_frame_link, _max_frame_tc)                          \
  ((36 *                                                                       \
        (IXGBE_B2BT(_max_frame_link) + IXGBE_PFC_D + (2 * IXGBE_CABLE_DC) +    \
         (2 * IXGBE_ID_X540) + IXGBE_HD) /                                     \
        25 +                                                                   \
    1) +                                                                       \
...
#define IXGBE_LOW_DV_X540(_max_frame_tc)                                       \
  (2 * IXGBE_B2BT(_max_frame_tc) + (36 * IXGBE_PCI_DELAY / 25) + 1)
...
#define IXGBE_MVALS_INIT(m)                                                    \
  IXGBE_CAT(EEC, m), IXGBE_CAT(FLA, m), IXGBE_CAT(GRC, m),                     \
      IXGBE_CAT(SRAMREL, m), IXGBE_CAT(FACTPS, m), IXGBE_CAT(SWSM, m),         \
      IXGBE_CAT(SWFW_SYNC, m), IXGBE_CAT(FWSM, m), IXGBE_CAT(SDP0_GPIEN, m),   \
      IXGBE_CAT(SDP1_GPIEN, m), IXGBE_CAT(SDP2_GPIEN, m),                      \
      IXGBE_CAT(EICR_GPI_SDP0, m), IXGBE_CAT(EICR_GPI_SDP1, m),                \
      IXGBE_CAT(EICR_GPI_SDP2, m), IXGBE_CAT(CIAA, m), IXGBE_CAT(CIAD, m),     \
      IXGBE_CAT(I2C_CLK_IN, m), IXGBE_CAT(I2C_CLK_OUT, m),                     \
      IXGBE_CAT(I2C_DATA_IN, m), IXGBE_CAT(I2C_DATA_OUT, m),                   \
      IXGBE_CAT(I2C_DATA_OE_N_EN, m), IXGBE_CAT(I2C_BB_EN, m),                 \
      IXGBE_CAT(I2C_CLK_OE_N_EN, m), IXGBE_CAT(I2CCTL, m)

enum ixgbe_mvals { IXGBE_MVALS_INIT(_IDX), IXGBE_MVALS_IDX_LIMIT };
...
struct ixgbe_mac_operations {
  ...
  s32 (*update_mc_addr_list)(struct ixgbe_hw *, u8 *, u32, ixgbe_mc_addr_itr,
                             bool clear);
