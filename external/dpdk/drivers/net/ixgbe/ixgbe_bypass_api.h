...
static bool ixgbe_bypass_valid_rd_generic(u32 in_reg, u32 out_reg) {
  ...
  case BYPASS_PAGE_CTL0:
     ...
     *  - The timeout value
     */
    mask = BYPASS_AUX_ON_M | BYPASS_MAIN_ON_M | BYPASS_MAIN_OFF_M |
           BYPASS_AUX_OFF_M | BYPASS_WDTIMEOUT_M | BYPASS_WDT_VALUE_M;
 ...
 **/
static s32 ixgbe_bypass_rd_eep_generic(struct ixgbe_hw *hw, u32 addr,
                                       u8 *value) {
  u32 cmd;
  u32 status;
