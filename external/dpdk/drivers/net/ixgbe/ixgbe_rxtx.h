...
struct ixgbe_rx_queue {
  ...
  struct ixgbe_scattered_rx_entry
      *sw_sc_ring;                /**< address of scattered Rx software ring. */
...
struct ixgbe_tx_queue {
  ...
  union {
    ...
    struct ixgbe_tx_entry_v
        *sw_ring_v; /**< address of SW ring for vector PMD */
  };
...
#define DCMD_DTYP_FLAGS                                                        \
  (IXGBE_ADVTXD_DTYP_DATA | IXGBE_ADVTXD_DCMD_IFCS | IXGBE_ADVTXD_DCMD_DEXT |  \
