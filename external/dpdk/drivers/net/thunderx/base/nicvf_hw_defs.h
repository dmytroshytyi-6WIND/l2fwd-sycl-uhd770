...
#define NICVF_CQ_ERR_MASK                                                      \
  (NICVF_CQ_WR_FULL | NICVF_CQ_WR_DISABLE | NICVF_CQ_WR_FAULT)
...
#define NICVF_SQ_ERR_MASK                                                      \
  (NICVF_SQ_ERR_STOPPED | NICVF_SQ_ERR_SEND | NICVF_SQ_ERR_DPE)
