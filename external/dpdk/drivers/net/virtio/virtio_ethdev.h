...
#define VIRTIO_PMD_DEFAULT_GUEST_FEATURES                                      \
  (1u << VIRTIO_NET_F_MAC | 1u << VIRTIO_NET_F_STATUS |                        \
   1u << VIRTIO_NET_F_MQ | 1u << VIRTIO_NET_F_CTRL_MAC_ADDR |                  \
   1u << VIRTIO_NET_F_CTRL_VQ | 1u << VIRTIO_NET_F_CTRL_RX |                   \
   1u << VIRTIO_NET_F_CTRL_VLAN | 1u << VIRTIO_NET_F_MRG_RXBUF |               \
   1u << VIRTIO_NET_F_MTU | 1ULL << VIRTIO_NET_F_GUEST_ANNOUNCE |              \
   1u << VIRTIO_RING_F_INDIRECT_DESC | 1ULL << VIRTIO_F_VERSION_1 |            \
   1ULL << VIRTIO_F_IN_ORDER | 1ULL << VIRTIO_F_RING_PACKED |                  \
   1ULL << VIRTIO_F_IOMMU_PLATFORM | 1ULL << VIRTIO_F_ORDER_PLATFORM |         \
   1ULL << VIRTIO_F_NOTIFICATION_DATA | 1ULL << VIRTIO_NET_F_SPEED_DUPLEX)

#define VIRTIO_PMD_SUPPORTED_GUEST_FEATURES                                    \
  (VIRTIO_PMD_DEFAULT_GUEST_FEATURES | 1u << VIRTIO_NET_F_GUEST_CSUM |         \
   1u << VIRTIO_NET_F_GUEST_TSO4 | 1u << VIRTIO_NET_F_GUEST_TSO6 |             \
   1u << VIRTIO_NET_F_CSUM | 1u << VIRTIO_NET_F_HOST_TSO4 |                    \
   1u << VIRTIO_NET_F_HOST_TSO6 | 1ULL << VIRTIO_NET_F_RSS)
