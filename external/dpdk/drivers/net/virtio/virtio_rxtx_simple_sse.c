...
uint16_t virtio_recv_pkts_vec(void *rx_queue, struct rte_mbuf **rx_pkts,
  ...
  shuf_msk1 = _mm_set_epi8(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, /* vlan tci */
                           5, 4,                               /* dat len */
  ...
  shuf_msk2 = _mm_set_epi8(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, /* vlan tci */
                           13, 12,                             /* dat len */
   ...
   */
  len_adjust = _mm_set_epi16(0, 0, 0, (uint16_t)-vq->hw->vtnet_hdr_size, 0,
                             (uint16_t)-vq->hw->vtnet_hdr_size, 0, 0);
  ...
  for (nb_pkts_received = 0; nb_pkts_received < nb_total;) {
    ...
    _mm_storeu_si128((void *)&rx_pkts[1]->rx_descriptor_fields1, pkt_mb[1]);
    _mm_storeu_si128((void *)&rx_pkts[0]->rx_descriptor_fields1, pkt_mb[0]);
    ...
    _mm_storeu_si128((void *)&rx_pkts[3]->rx_descriptor_fields1, pkt_mb[3]);
    _mm_storeu_si128((void *)&rx_pkts[2]->rx_descriptor_fields1, pkt_mb[2]);
    ...
    _mm_storeu_si128((void *)&rx_pkts[5]->rx_descriptor_fields1, pkt_mb[5]);
    _mm_storeu_si128((void *)&rx_pkts[4]->rx_descriptor_fields1, pkt_mb[4]);
    ...
    _mm_storeu_si128((void *)&rx_pkts[7]->rx_descriptor_fields1, pkt_mb[7]);
    _mm_storeu_si128((void *)&rx_pkts[6]->rx_descriptor_fields1, pkt_mb[6]);
