...
#define DPAA2_L3_IPv4                                                          \
  (L3_IPV4_1_PRESENT | L3_IPV4_1_UNICAST | L3_IP_1_UNKNOWN_PROTOCOL |          \
   L3_IP_UNKNOWN_PROTOCOL)

#define DPAA2_L3_IPv6                                                          \
  (L3_IPV6_1_PRESENT | L3_IPV6_1_UNICAST | L3_IP_1_UNKNOWN_PROTOCOL |          \
   L3_IP_UNKNOWN_PROTOCOL)

#define DPAA2_L3_IPv4_TCP                                                      \
  (L3_IPV4_1_PRESENT | L3_IPV4_1_UNICAST | L3_PROTO_TCP_PRESENT |              \
   L3_PROTO_TCP_CTRL_BIT_6_TO_11_PRESENT | L4_UNKNOWN_PROTOCOL)

#define DPAA2_L3_IPv4_UDP                                                      \
  (L3_IPV4_1_PRESENT | L3_IPV4_1_UNICAST | L3_PROTO_UDP_PRESENT |              \
   L4_UNKNOWN_PROTOCOL)

#define DPAA2_L3_IPv6_TCP                                                      \
  (L3_IPV6_1_PRESENT | L3_IPV6_1_UNICAST | L3_PROTO_TCP_PRESENT |              \
   L3_PROTO_TCP_CTRL_BIT_6_TO_11_PRESENT | L4_UNKNOWN_PROTOCOL)

#define DPAA2_L3_IPv6_UDP                                                      \
  (L3_IPV6_1_PRESENT | L3_IPV6_1_UNICAST | L3_PROTO_UDP_PRESENT |              \
   L4_UNKNOWN_PROTOCOL)
