...
#define NH_FLD_VLAN_TCI (NH_FLD_VLAN_VPRI | NH_FLD_VLAN_CFI | NH_FLD_VLAN_VID)
...
#define NH_FLD_UDP_LITE_ALL_FIELDS ((NH_FLD_UDP_LITE_PORT_SRC << 2) - 1)
...
#define NH_FLD_UDP_ENC_ESP_ALL_FIELDS ((NH_FLD_UDP_ENC_ESP_PORT_SRC << 6) - 1)
...
#define NH_FLD_L2TPV2_ALL_FIELDS ((NH_FLD_L2TPV2_TYPE_BIT << 13) - 1)
...
#define NH_FLD_L2TPV3_CTRL_ALL_FIELDS ((NH_FLD_L2TPV3_CTRL_TYPE_BIT << 9) - 1)
...
#define NH_FLD_L2TPV3_SESS_ALL_FIELDS ((NH_FLD_L2TPV3_SESS_TYPE_BIT << 4) - 1)
...
#define NH_FLD_PPPMUX_SUBFRM_ALL_FIELDS ((NH_FLD_PPPMUX_SUBFRM_PFF << 5) - 1)
...
#define NH_FLD_USER_DEFINED_ALL_FIELDS ((NH_FLD_USER_DEFINED_SRCPORT << 2) - 1)
...
#define NH_FLD_MINENCAP_ALL_FIELDS ((NH_FLD_MINENCAP_SRC_IP << 3) - 1)
...
#define NH_FLD_MPLS_LABEL_STACK_ALL_FIELDS ((NH_FLD_MPLS_LABEL_STACK << 1) - 1)
...
#define NH_IEEE8021Q_HDR(etype, pcp, dei, vlan_id)                             \
  ((((uint32_t)(etype & 0xFFFF)) << 16) | (((uint32_t)(pcp & 0x07)) << 13) |   \
   (((uint32_t)(dei & 0x01)) << 12) | (((uint32_t)(vlan_id & 0xFFF))))
