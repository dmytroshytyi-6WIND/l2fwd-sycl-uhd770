...
#define DPDMUX_CMD(id)                                                         \
  (((id) << DPDMUX_CMD_ID_OFFSET) | DPDMUX_CMD_BASE_VERSION)
#define DPDMUX_CMD_V2(id)                                                      \
  (((id) << DPDMUX_CMD_ID_OFFSET) | DPDMUX_CMD_VERSION_2)
#define DPDMUX_CMD_V3(id)                                                      \
  (((id) << DPDMUX_CMD_ID_OFFSET) | DPDMUX_CMD_VERSION_3)
#define DPDMUX_CMD_V4(id)                                                      \
  (((id) << DPDMUX_CMD_ID_OFFSET) | DPDMUX_CMD_VERSION_4)
