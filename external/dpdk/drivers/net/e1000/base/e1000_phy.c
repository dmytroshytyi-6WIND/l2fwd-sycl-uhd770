...
s32 e1000_check_reset_block_generic(struct e1000_hw *hw) {
  ...
  return (manc & E1000_MANC_BLK_PHY_RST_ON_IDE) ? E1000_BLK_PHY_RESET
                                                : E1000_SUCCESS;
}
...
s32 e1000_write_phy_reg_mdic(struct e1000_hw *hw, u32 offset, u16 data) {
   ...
   * PHY to retrieve the desired data.
   */
  mdic = (((u32)data) | (offset << E1000_MDIC_REG_SHIFT) |
...
s32 e1000_read_sfp_data_byte(struct e1000_hw *hw, u16 offset, u8 *data) {
   ...
   */
  i2ccmd = ((offset << E1000_I2CCMD_REG_ADDR_SHIFT) | E1000_I2CCMD_OPCODE_READ);
...
s32 e1000_write_sfp_data_byte(struct e1000_hw *hw, u16 offset, u8 data) {
  ...
  for (i = 0; i < E1000_I2CCMD_PHY_TIMEOUT; i++) {
    ...
    if (i2ccmd & E1000_I2CCMD_READY) {
      ...
      if ((i2ccmd & E1000_I2CCMD_OPCODE_READ) == E1000_I2CCMD_OPCODE_READ) {
...
s32 e1000_write_phy_reg_m88(struct e1000_hw *hw, u32 offset, u16 data) {
  ...
  ret_val = e1000_write_phy_reg_mdic(hw, MAX_PHY_REG_ADDRESS & offset, data);
...
STATIC s32 __e1000_read_phy_reg_igp(struct e1000_hw *hw, u32 offset, u16 *data,
  ...
  if (offset > MAX_PHY_MULTI_PAGE_REG)
    ret_val =
        e1000_write_phy_reg_mdic(hw, IGP01E1000_PHY_PAGE_SELECT, (u16)offset);
  if (!ret_val)
    ret_val = e1000_read_phy_reg_mdic(hw, MAX_PHY_REG_ADDRESS & offset, data);
  if (!locked)
    hw->phy.ops.release(hw);
...
STATIC s32 __e1000_read_kmrn_reg(struct e1000_hw *hw, u32 offset, u16 *data,
  ...
  kmrnctrlsta =
      ((offset << E1000_KMRNCTRLSTA_OFFSET_SHIFT) & E1000_KMRNCTRLSTA_OFFSET) |
...
STATIC s32 e1000_set_master_slave_mode(struct e1000_hw *hw) {
  ...
  hw->phy.original_ms_type =
      (phy_data & CR_1000T_MS_ENABLE)
          ? ((phy_data & CR_1000T_MS_VALUE) ? e1000_ms_force_master
...
s32 e1000_copper_link_setup_m88(struct e1000_hw *hw) {
  ...
  if ((phy->type == e1000_phy_m88) && (phy->revision < E1000_REVISION_4) &&
    ...
    if ((phy->revision == E1000_REVISION_2) && (phy->id == M88E1111_I_PHY_ID)) {
...
s32 e1000_setup_copper_link_generic(struct e1000_hw *hw) {
   ...
   * valid.
   */
  ret_val = e1000_phy_has_link_generic(hw, COPPER_LINK_UP_LIMIT, 10, &link);
  if (ret_val)
    return ret_val;
  ...
  if (phy->autoneg_wait_to_complete) {
    ...
    if (!link) {
      ...
      if (!reset_dsp) {
         ...
         */
        ret_val = phy->ops.write_reg(hw, M88E1000_PHY_PAGE_SELECT, 0x001d);
        if (ret_val)
          return ret_val;
...
s32 e1000_set_d3_lplu_state_generic(struct e1000_hw *hw, bool active) {
  ...
  if (!active) {
    ...
    ret_val = phy->ops.write_reg(hw, IGP02E1000_PHY_POWER_MGMT, data);
    if (ret_val)
      return ret_val;
...
s32 e1000_check_polarity_m88(struct e1000_hw *hw) {
  ...
  if (!ret_val)
    phy->cable_polarity =
        ((data & M88E1000_PSSR_REV_POLARITY) ? e1000_rev_polarity_reversed
...
s32 e1000_check_polarity_igp(struct e1000_hw *hw) {
  ...
  if ((data & IGP01E1000_PSSR_SPEED_MASK) == IGP01E1000_PSSR_SPEED_1000MBPS) {
  ...
  if (!ret_val)
    phy->cable_polarity = ((data & mask) ? e1000_rev_polarity_reversed
                                         : e1000_rev_polarity_normal);
...
s32 e1000_check_polarity_ife(struct e1000_hw *hw) {
  ...
  if (!ret_val)
    phy->cable_polarity = ((phy_data & mask) ? e1000_rev_polarity_reversed
                                             : e1000_rev_polarity_normal);
...
s32 e1000_get_cable_length_igp_2(struct e1000_hw *hw) {
  ...
  static const u16 agc_reg_array[IGP02E1000_PHY_CHANNEL_NUM] = {
      IGP02E1000_PHY_AGC_A, IGP02E1000_PHY_AGC_B, IGP02E1000_PHY_AGC_C,
...
s32 e1000_get_phy_info_ife(struct e1000_hw *hw) {
  ...
  if (phy->polarity_correction) {
    ...
    /* Polarity is forced */
    phy->cable_polarity =
        ((data & IFE_PSC_FORCE_POLARITY) ? e1000_rev_polarity_reversed
                                         : e1000_rev_polarity_normal);
  }
...
s32 e1000_write_phy_reg_bm(struct e1000_hw *hw, u32 offset, u16 data) {
  ...
  if (page == BM_WUC_PAGE) {
    ret_val = e1000_access_phy_wakeup_reg_bm(hw, offset, &data, false, false);
    goto release;
  }
  ...
  if (offset > MAX_PHY_MULTI_PAGE_REG) {
    ...
    ret_val = e1000_write_phy_reg_mdic(hw, page_select, (page << page_shift));
    if (ret_val)
      goto release;
  }
...
s32 e1000_read_phy_reg_bm2(struct e1000_hw *hw, u32 offset, u16 *data) {
  ...
  if (offset > MAX_PHY_MULTI_PAGE_REG) {
    /* Page is shifted left, PHY expects (page x 32) */
    ret_val = e1000_write_phy_reg_mdic(hw, BM_PHY_PAGE_SELECT, page);
...
STATIC s32 e1000_access_phy_wakeup_reg_bm(struct e1000_hw *hw, u32 offset,
  ...
  if (read) {
    ...
    ret_val = e1000_read_phy_reg_mdic(hw, BM_WUC_DATA_OPCODE, data);
  } else {
    /* Write the Wakeup register page value using opcode 0x12 */
    ret_val = e1000_write_phy_reg_mdic(hw, BM_WUC_DATA_OPCODE, *data);
  }
...
STATIC s32 __e1000_read_phy_reg_hv(struct e1000_hw *hw, u32 offset, u16 *data,
  ...
  if (!page_set) {
    ...
    if (reg > MAX_PHY_MULTI_PAGE_REG) {
      /* Page is shifted left, PHY expects (page x 32) */
      ret_val = e1000_set_page_igp(hw, (page << IGP_PAGE_SHIFT));
...
STATIC s32 __e1000_write_phy_reg_hv(struct e1000_hw *hw, u32 offset, u16 data,
  ...
  if (page == BM_WUC_PAGE) {
    ret_val =
        e1000_access_phy_wakeup_reg_bm(hw, offset, &data, false, page_set);
    goto out;
  }

  if (page > 0 && page < HV_INTC_FC_PAGE_START) {
    ret_val = e1000_access_phy_debug_regs_hv(hw, offset, &data, false);
    goto out;
  }
  ...
  if (!page_set) {
     ...
     */
    if ((hw->phy.type == e1000_phy_82578) && (hw->phy.revision >= 1) &&
        (hw->phy.addr == 2) && !(MAX_PHY_REG_ADDRESS & reg) &&
        (data & (1 << 11))) {
      u16 data2 = 0x7EFF;
      ret_val =
          e1000_access_phy_debug_regs_hv(hw, (1 << 6) | 0x3, &data2, false);
      if (ret_val)
        goto out;
    }
  ...
  ret_val = e1000_write_phy_reg_mdic(hw, MAX_PHY_REG_ADDRESS & reg, data);
...
STATIC s32 e1000_access_phy_debug_regs_hv(struct e1000_hw *hw, u32 offset,
  ...
  addr_reg =
      ((hw->phy.type == e1000_phy_82578) ? I82578_ADDR_REG : I82577_ADDR_REG);
  data_reg = addr_reg + 1;
...
s32 e1000_check_polarity_82577(struct e1000_hw *hw) {
  ...
  if (!ret_val)
    phy->cable_polarity =
        ((data & I82577_PHY_STATUS2_REV_POLARITY) ? e1000_rev_polarity_reversed
                                                  : e1000_rev_polarity_normal);
...
STATIC s32 __e1000_access_xmdio_reg(struct e1000_hw *hw, u16 address,
  ...
  ret_val =
      hw->phy.ops.write_reg(hw, E1000_MMDAC, E1000_MMDAC_FUNC_DATA | dev_addr);
  if (ret_val)
    return ret_val;
