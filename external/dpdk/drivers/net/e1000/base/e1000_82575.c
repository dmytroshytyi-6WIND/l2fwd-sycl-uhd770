...
STATIC const u16 e1000_82580_rxpbs_table[] = {36, 72, 144, 1,  2,  4,
                                              8,  16, 35,  70, 140};
#define E1000_82580_RXPBS_TABLE_SIZE                                           \
  (sizeof(e1000_82580_rxpbs_table) / sizeof(e1000_82580_rxpbs_table[0]))
...
s32 e1000_init_nvm_params_82575(struct e1000_hw *hw) {
  ...
  size = (u16)((eecd & E1000_EECD_SIZE_EX_MASK) >> E1000_EECD_SIZE_EX_SHIFT);
...
STATIC s32 e1000_get_phy_id_82575(struct e1000_hw *hw) {
  ...
  ctrl_ext = E1000_READ_REG(hw, E1000_CTRL_EXT);
  E1000_WRITE_REG(hw, E1000_CTRL_EXT, ctrl_ext & ~E1000_CTRL_EXT_SDP3_DATA);
...
STATIC s32 e1000_acquire_nvm_82575(struct e1000_hw *hw) {
  ...
  if (hw->mac.type == e1000_i350) {
    u32 eecd = E1000_READ_REG(hw, E1000_EECD);
    if (eecd & (E1000_EECD_BLOCKED | E1000_EECD_ABORT | E1000_EECD_TIMEOUT)) {
      /* Clear all access error flags */
      E1000_WRITE_REG(hw, E1000_EECD, eecd | E1000_EECD_ERROR_CLR);
  ...
  if (hw->mac.type == e1000_82580) {
    ...
    if (eecd & E1000_EECD_BLOCKED) {
      ...
      E1000_WRITE_REG(hw, E1000_EECD, eecd | E1000_EECD_BLOCKED);
      DEBUGOUT("Nvm bit banging access error detected and cleared.\n");
    }
  }
...
STATIC s32 e1000_get_link_up_info_82575(struct e1000_hw *hw, u16 *speed,
  ...
  if (hw->phy.media_type != e1000_media_type_copper)
    ret_val = e1000_get_pcs_speed_and_duplex_82575(hw, speed, duplex);
  else
...
STATIC s32 e1000_setup_serdes_link_82575(struct e1000_hw *hw) {
  ...
  default:
     ...
     */
    ctrl_reg |= E1000_CTRL_SPD_1000 | E1000_CTRL_FRCSPD | E1000_CTRL_FD |
                E1000_CTRL_FRCDPX;
...
STATIC s32 e1000_set_sfp_media_type_82575(struct e1000_hw *hw) {
  ...
  while (timeout) {
    ret_val = e1000_read_sfp_data_byte(
        hw, E1000_I2CCMD_SFP_DATA_ADDR(E1000_SFF_IDENTIFIER_OFFSET),
        &tranceiver_type);
    if (ret_val == E1000_SUCCESS)
      break;
    msec_delay(100);
  ...
  ret_val = e1000_read_sfp_data_byte(
      hw, E1000_I2CCMD_SFP_DATA_ADDR(E1000_SFF_ETH_FLAGS_OFFSET),
      (u8 *)eth_flags);
  if (ret_val != E1000_SUCCESS)
    goto out;
...
STATIC s32 e1000_set_pcie_completion_timeout(struct e1000_hw *hw) {
   ...
   * 16ms to 55ms
   */
  ret_val = e1000_read_pcie_cap_reg(hw, PCIE_DEVICE_CONTROL2, &pcie_devctl2);
  if (ret_val)
    goto out;

  pcie_devctl2 |= PCIE_DEVICE_CONTROL2_16ms;

  ret_val = e1000_write_pcie_cap_reg(hw, PCIE_DEVICE_CONTROL2, &pcie_devctl2);
out:
...
void e1000_vmdq_set_anti_spoofing_pf(struct e1000_hw *hw, bool enable, int pf) {
  ...
  if (enable) {
    reg_val |= (E1000_DTXSWC_MAC_SPOOF_MASK | E1000_DTXSWC_VLAN_SPOOF_MASK);
...
STATIC s32 e1000_reset_mdicnfg_82580(struct e1000_hw *hw) {
  ...
  ret_val = hw->nvm.ops.read(
      hw, NVM_INIT_CONTROL3_PORT_A + NVM_82580_LAN_FUNC_OFFSET(hw->bus.func), 1,
      &nvm_data);
  if (ret_val) {
    DEBUGOUT("NVM Read Error\n");
    goto out;
...
STATIC s32 e1000_reset_hw_82580(struct e1000_hw *hw) {
  ...
  if (global_device_reset && hw->mac.ops.acquire_swfw_sync(hw, swmbsw_mask))
    global_device_reset = false;
...
s32 e1000_update_nvm_checksum_with_offset(struct e1000_hw *hw, u16 offset) {
  ...
  ret_val = hw->nvm.ops.write(hw, (NVM_CHECKSUM_REG + offset), 1, &checksum);
  if (ret_val)
...
STATIC s32 e1000_validate_nvm_checksum_82580(struct e1000_hw *hw) {
  ...
  for (j = 0; j < eeprom_regions_count; j++) {
    ...
    ret_val = e1000_validate_nvm_checksum_with_offset(hw, nvm_offset);
    if (ret_val != E1000_SUCCESS)
      goto out;
  }
...
STATIC s32 e1000_update_nvm_checksum_82580(struct e1000_hw *hw) {
  ...
  if (!(nvm_data & NVM_COMPATIBILITY_BIT_MASK)) {
    ...
    ret_val = hw->nvm.ops.write(hw, NVM_COMPATIBILITY_REG_3, 1, &nvm_data);
    if (ret_val) {
 ...
 **/
STATIC s32 __e1000_access_emi_reg(struct e1000_hw *hw, u16 address, u16 *data,
                                  bool read) {
  s32 ret_val;
...
s32 e1000_set_eee_i354(struct e1000_hw *hw, bool adv1G, bool adv100M) {
  ...
  if ((hw->phy.media_type != e1000_media_type_copper) ||
      ((phy->id != M88E1543_E_PHY_ID) && (phy->id != M88E1512_E_PHY_ID)))
    goto out;
  ...
  if (!hw->dev_spec._82575.eee_disable) {
    ...
    ret_val = phy->ops.read_reg(hw, E1000_M88E1543_EEE_CTRL_1, &phy_data);
    if (ret_val)
      goto out;

    phy_data |= E1000_M88E1543_EEE_CTRL_1_MS;
    ret_val = phy->ops.write_reg(hw, E1000_M88E1543_EEE_CTRL_1, phy_data);
    if (ret_val)
      goto out;
    ...
    phy_data &= ~(E1000_EEE_ADV_100_SUPPORTED | E1000_EEE_ADV_1000_SUPPORTED);
    ret_val = e1000_write_xmdio_reg(hw, E1000_EEE_ADV_ADDR_I354,
                                    E1000_EEE_ADV_DEV_I354, phy_data);
  }
...
s32 e1000_get_eee_status_i354(struct e1000_hw *hw, bool *status) {
  ...
  *status =
      phy_data & (E1000_PCS_STATUS_TX_LPI_RCVD | E1000_PCS_STATUS_RX_LPI_RCVD)
          ? true
          : false;
