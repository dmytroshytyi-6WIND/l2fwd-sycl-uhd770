...
s32 e1000_get_bus_info_pci_generic(struct e1000_hw *hw) {
  ...
  /* PCI or PCI-X? */
  bus->type = (status & E1000_STATUS_PCIX_MODE) ? e1000_bus_type_pcix
                                                : e1000_bus_type_pci;

  /* Bus speed */
  if (bus->type == e1000_bus_type_pci) {
    bus->speed =
        (status & E1000_STATUS_PCI66) ? e1000_bus_speed_66 : e1000_bus_speed_33;
  } else {
  ...
  /* Bus width */
  bus->width =
      (status & E1000_STATUS_BUS64) ? e1000_bus_width_64 : e1000_bus_width_32;
...
s32 e1000_get_bus_info_pcie_generic(struct e1000_hw *hw) {
  ...
  ret_val = e1000_read_pcie_cap_reg(hw, PCIE_LINK_STATUS, &pcie_link_status);
  if (ret_val) {
    ...
    bus->width = (enum e1000_bus_width)(
...
void e1000_set_lan_id_multi_port_pci(struct e1000_hw *hw) {
  ...
  if (pci_header_type & PCI_HEADER_TYPE_MULTIFUNC) {
    ...
    bus->func = (status & E1000_STATUS_FUNC_MASK) >> E1000_STATUS_FUNC_SHIFT;
  } else {
    bus->func = 0;
  }
}
 ...
 **/
void e1000_update_mc_addr_list_generic(struct e1000_hw *hw, u8 *mc_addr_list,
                                       u32 mc_addr_count) {
...
s32 e1000_get_speed_and_duplex_fiber_serdes_generic(
    struct e1000_hw E1000_UNUSEDARG *hw, u16 *speed, u16 *duplex) {
...
s32 e1000_blink_led_generic(struct e1000_hw *hw) {
  ...
  if (hw->phy.media_type == e1000_media_type_fiber) {
    ...
    for (i = 0; i < 32; i += 8) {
      u32 mode = (hw->mac.ledctl_mode2 >> i) & E1000_LEDCTL_LED0_MODE_MASK;
      ...
      if ((!(led_default & E1000_LEDCTL_LED0_IVRT) &&
        ...
        ledctl_blink &= ~(E1000_LEDCTL_LED0_MODE_MASK << i);
        ledctl_blink |= (E1000_LEDCTL_LED0_BLINK | E1000_LEDCTL_MODE_LED_ON)
                        << i;
      }
    }
  }
...
s32 e1000_disable_pcie_master_generic(struct e1000_hw *hw) {
  ...
  while (timeout) {
    if (!(E1000_READ_REG(hw, E1000_STATUS) & E1000_STATUS_GIO_MASTER_ENABLE) ||
 ...
 *  operation.
 **/
s32 e1000_validate_mdi_setting_crossover_generic(
    struct e1000_hw E1000_UNUSEDARG *hw) {
 ...
 *  completion.
 **/
s32 e1000_write_8bit_ctrl_reg_generic(struct e1000_hw *hw, u32 reg, u32 offset,
                                      u8 data) {
  u32 i, regvalue = 0;
