...
STATIC s32 e1000_init_phy_params_82543(struct e1000_hw *hw) {
  ...
  phy->ops.read_reg = (hw->mac.type == e1000_82543) ? e1000_read_phy_reg_82543
                                                    : e1000_read_phy_reg_m88;
  phy->ops.reset = (hw->mac.type == e1000_82543) ? e1000_phy_hw_reset_82543
                                                 : e1000_phy_hw_reset_generic;
  phy->ops.write_reg = (hw->mac.type == e1000_82543) ? e1000_write_phy_reg_82543
...
STATIC s32 e1000_init_mac_params_82543(struct e1000_hw *hw) {
  ...
  /* check for link */
  mac->ops.check_for_link = (hw->phy.media_type == e1000_media_type_copper)
...
STATIC s32 e1000_read_phy_reg_82543(struct e1000_hw *hw, u32 offset,
   ...
   */
  mdic = (offset | (hw->phy.addr << 5) | (PHY_OP_READ << 10) | (PHY_SOF << 12));
...
STATIC s32 e1000_phy_force_speed_duplex_82543(struct e1000_hw *hw) {
  ...
  if (!hw->mac.autoneg && (hw->mac.forced_speed_duplex & E1000_ALL_10_SPEED))
...
STATIC s32 e1000_setup_link_82543(struct e1000_hw *hw) {
  ...
  if (hw->mac.type == e1000_82543) {
    ...
    ctrl_ext = ((data & NVM_WORD0F_SWPDIO_EXT_MASK) << NVM_SWDPIO_EXT_SHIFT);
    E1000_WRITE_REG(hw, E1000_CTRL_EXT, ctrl_ext);
  }
