...
STATIC s32 e1000_init_mac_params_82571(struct e1000_hw *hw) {
  ...
  case e1000_82572:
    ...
    if (!(swsm2 & E1000_SWSM2_LOCK)) {
      ...
      E1000_WRITE_REG(hw, E1000_SWSM2, swsm2 | E1000_SWSM2_LOCK);
...
STATIC s32 e1000_write_nvm_eewr_82571(struct e1000_hw *hw, u16 offset,
  ...
  for (i = 0; i < words; i++) {
    eewr = ((data[i] << E1000_NVM_RW_REG_DATA) |
            ((offset + i) << E1000_NVM_RW_ADDR_SHIFT) | E1000_NVM_RW_REG_START);
...
STATIC s32 e1000_init_hw_82571(struct e1000_hw *hw) {
  ...
  if (mac->type == e1000_82574)
    E1000_WRITE_REG(hw, E1000_IVAR, (E1000_IVAR_INT_ALLOC_VALID << 16));
...
STATIC void e1000_clear_vfta_82571(struct e1000_hw *hw) {
  ...
  case e1000_82583:
    if (hw->mng_cookie.vlan_id != 0) {
       ...
       */
      vfta_offset = (hw->mng_cookie.vlan_id >> E1000_VFTA_ENTRY_SHIFT) &
                    E1000_VFTA_ENTRY_MASK;
      vfta_bit_in_reg =
          1 << (hw->mng_cookie.vlan_id & E1000_VFTA_ENTRY_BIT_SHIFT_MASK);
    }
    break;
  default:
    break;
...
bool e1000_check_phy_82574(struct e1000_hw *hw) {
   ...
   */
  ret_val =
      hw->phy.ops.read_reg(hw, E1000_RECEIVE_ERROR_COUNTER, &receive_errors);
  if (ret_val)
    return false;
  if (receive_errors == E1000_RECEIVE_ERROR_MAX) {
    ret_val = hw->phy.ops.read_reg(hw, E1000_BASE1000T_STATUS, &status_1kbt);
    if (ret_val)
      return false;
