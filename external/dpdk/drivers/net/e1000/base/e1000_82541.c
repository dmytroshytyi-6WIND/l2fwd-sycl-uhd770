...
STATIC const u16 e1000_igp_cable_length_table[] = {
    ...
    5,   5,   10,  10,  10,  10,  10,  10,  10,  20,  20,  20,  20,  20,  25,
    25,  25,  25,  25,  25,  25,  30,  30,  30,  30,  40,  40,  40,  40,  40,
    40,  40,  40,  40,  50,  50,  50,  50,  50,  50,  50,  60,  60,  60,  60,
    60,  60,  60,  60,  60,  70,  70,  70,  70,  70,  70,  80,  80,  80,  80,
    80,  80,  90,  90,  90,  90,  90,  90,  90,  90,  90,  100, 100, 100, 100,
    100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 110, 110, 110, 110, 110,
    110, 110, 110, 110, 110, 110, 110, 110, 110, 110, 110, 110, 110, 120, 120,
...
STATIC s32 e1000_init_hw_82541(struct e1000_hw *hw) {
  ...
  ret_val =
      hw->phy.ops.read_reg(hw, IGP01E1000_GMII_FIFO, &dev_spec->spd_default);
  if (ret_val)
    goto out;
...
STATIC s32 e1000_get_cable_length_igp_82541(struct e1000_hw *hw) {
  ...
  u16 agc_reg_array[IGP01E1000_PHY_CHANNEL_NUM] = {
      IGP01E1000_PHY_AGC_A, IGP01E1000_PHY_AGC_B, IGP01E1000_PHY_AGC_C,
...
STATIC s32 e1000_setup_led_82541(struct e1000_hw *hw) {
  ...
  ret_val = hw->phy.ops.write_reg(
      hw, IGP01E1000_GMII_FIFO,
      (u16)(dev_spec->spd_default & ~IGP01E1000_GMII_SPD));
  if (ret_val)
    goto out;
...
STATIC s32 e1000_cleanup_led_82541(struct e1000_hw *hw) {
  ...
  ret_val =
      hw->phy.ops.write_reg(hw, IGP01E1000_GMII_FIFO, dev_spec->spd_default);
  if (ret_val)
    goto out;
...
STATIC s32 e1000_phy_init_script_82541(struct e1000_hw *hw) {
  ...
  if (hw->mac.type == e1000_82547) {
    ...
    if (!(fused & IGP01E1000_ANALOG_SPARE_FUSE_ENABLED)) {
      ...
      hw->phy.ops.write_reg(hw, IGP01E1000_ANALOG_FUSE_BYPASS,
