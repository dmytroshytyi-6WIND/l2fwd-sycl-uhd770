...
#define PMD_INIT_LOG(level, fmt, args...)                                      \
  rte_log(RTE_LOG_##level, e1000_logtype_init, "%s(): " fmt "\n", __func__,    \
          ##args)
...
#define PMD_RX_LOG(level, fmt, args...)                                        \
  rte_log(RTE_LOG_##level, e1000_logtype_rx, "%s(): " fmt "\n", __func__,      \
          ##args)
#else
#define PMD_RX_LOG(level, fmt, args...)                                        \
  do {                                                                         \
...
#define PMD_TX_LOG(level, fmt, args...)                                        \
  rte_log(RTE_LOG_##level, e1000_logtype_tx, "%s(): " fmt "\n", __func__,      \
          ##args)
#else
#define PMD_TX_LOG(level, fmt, args...)                                        \
  do {                                                                         \
...
#define PMD_DRV_LOG_RAW(level, fmt, args...)                                   \
  rte_log(RTE_LOG_##level, e1000_logtype_driver, "%s(): " fmt, __func__, ##args)
