...
static const struct rte_qede_xstats_name_off qede_xstats_strings[] = {
    ...
    {"rx_65_to_127_byte_packets",
     offsetof(struct ecore_eth_stats_common, rx_65_to_127_byte_packets)},
    {"rx_128_to_255_byte_packets",
     offsetof(struct ecore_eth_stats_common, rx_128_to_255_byte_packets)},
    {"rx_256_to_511_byte_packets",
     offsetof(struct ecore_eth_stats_common, rx_256_to_511_byte_packets)},
    {"rx_512_to_1023_byte_packets",
     offsetof(struct ecore_eth_stats_common, rx_512_to_1023_byte_packets)},
    {"rx_1024_to_1518_byte_packets",
     offsetof(struct ecore_eth_stats_common, rx_1024_to_1518_byte_packets)},
    {"tx_64_byte_packets",
     offsetof(struct ecore_eth_stats_common, tx_64_byte_packets)},
    {"tx_65_to_127_byte_packets",
     offsetof(struct ecore_eth_stats_common, tx_65_to_127_byte_packets)},
    {"tx_128_to_255_byte_packets",
     offsetof(struct ecore_eth_stats_common, tx_128_to_255_byte_packets)},
    {"tx_256_to_511_byte_packets",
     offsetof(struct ecore_eth_stats_common, tx_256_to_511_byte_packets)},
    {"tx_512_to_1023_byte_packets",
     offsetof(struct ecore_eth_stats_common, tx_512_to_1023_byte_packets)},
    {"tx_1024_to_1518_byte_packets",
     offsetof(struct ecore_eth_stats_common, tx_1024_to_1518_byte_packets)},
    ...
    {"rx_crc_errors", offsetof(struct ecore_eth_stats_common, rx_crc_errors)},
    {"rx_align_errors",
    ...
    {"rx_jabber_errors", offsetof(struct ecore_eth_stats_common, rx_jabbers)},
    ...
    {"rx_packet_too_big_discards",
     offsetof(struct ecore_eth_stats_common, packet_too_big_discard)},
    ...
    {"lro_aborts_num", offsetof(struct ecore_eth_stats_common, tpa_aborts_num)},
    {"lro_not_coalesced_packets",
     offsetof(struct ecore_eth_stats_common, tpa_not_coalesced_pkts)},
    {"lro_coalesced_bytes",
     offsetof(struct ecore_eth_stats_common, tpa_coalesced_bytes)},
};

static const struct rte_qede_xstats_name_off qede_bb_xstats_strings[] = {
    {"rx_1519_to_1522_byte_packets",
     offsetof(struct ecore_eth_stats, bb) +
         offsetof(struct ecore_eth_stats_bb, rx_1519_to_1522_byte_packets)},
    {"rx_1519_to_2047_byte_packets",
     offsetof(struct ecore_eth_stats, bb) +
         offsetof(struct ecore_eth_stats_bb, rx_1519_to_2047_byte_packets)},
    {"rx_2048_to_4095_byte_packets",
     offsetof(struct ecore_eth_stats, bb) +
         offsetof(struct ecore_eth_stats_bb, rx_2048_to_4095_byte_packets)},
    {"rx_4096_to_9216_byte_packets",
     offsetof(struct ecore_eth_stats, bb) +
         offsetof(struct ecore_eth_stats_bb, rx_4096_to_9216_byte_packets)},
    {"rx_9217_to_16383_byte_packets",
     offsetof(struct ecore_eth_stats, bb) +
         offsetof(struct ecore_eth_stats_bb, rx_9217_to_16383_byte_packets)},

    {"tx_1519_to_2047_byte_packets",
     offsetof(struct ecore_eth_stats, bb) +
         offsetof(struct ecore_eth_stats_bb, tx_1519_to_2047_byte_packets)},
    {"tx_2048_to_4095_byte_packets",
     offsetof(struct ecore_eth_stats, bb) +
         offsetof(struct ecore_eth_stats_bb, tx_2048_to_4095_byte_packets)},
    {"tx_4096_to_9216_byte_packets",
     offsetof(struct ecore_eth_stats, bb) +
         offsetof(struct ecore_eth_stats_bb, tx_4096_to_9216_byte_packets)},
    {"tx_9217_to_16383_byte_packets",
     offsetof(struct ecore_eth_stats, bb) +
         offsetof(struct ecore_eth_stats_bb, tx_9217_to_16383_byte_packets)},
...
static const struct rte_qede_xstats_name_off qede_ah_xstats_strings[] = {
    {"rx_1519_to_max_byte_packets",
     offsetof(struct ecore_eth_stats, ah) +
         offsetof(struct ecore_eth_stats_ah, rx_1519_to_max_byte_packets)},
    {"tx_1519_to_max_byte_packets",
     offsetof(struct ecore_eth_stats, ah) +
         offsetof(struct ecore_eth_stats_ah, tx_1519_to_max_byte_packets)},
};

static const struct rte_qede_xstats_name_off qede_rxq_xstats_strings[] = {
    {"rx_q_segments", offsetof(struct qede_rx_queue, rx_segs)},
    {"rx_q_hw_errors", offsetof(struct qede_rx_queue, rx_hw_errors)},
    {"rx_q_allocation_errors",
     offsetof(struct qede_rx_queue, rx_alloc_errors)}};

/* Get FW version string based on fw_size */
static int qede_fw_version_get(struct rte_eth_dev *dev, char *fw_ver,
                               size_t fw_size) {
  ...
  if (IS_PF(edev))
    ...
    snprintf(ver_str, QEDE_PMD_DRV_VER_STR_SIZE, "%d.%d.%d.%d", info->fw_major,
             info->fw_minor, info->fw_rev, info->fw_eng);
  size = strlen(ver_str);
  ...
  snprintf(ver_str + size, (QEDE_PMD_DRV_VER_STR_SIZE - size),
           " MFW: %d.%d.%d.%d", GET_MFW_FIELD(info->mfw_rev, QED_MFW_VERSION_3),
  ...
  snprintf(ver_str + size, (QEDE_PMD_DRV_VER_STR_SIZE - size), " MBI: %d.%d.%d",
...
static void qede_interrupt_handler_intx(void *param) {
...
static void qede_interrupt_handler(void *param) {
  struct rte_eth_dev *eth_dev = (struct rte_eth_dev *)param;
  struct qede_dev *qdev = eth_dev->data->dev_private;
  struct ecore_dev *edev = &qdev->edev;
...
static void qede_assign_rxtx_handlers(struct rte_eth_dev *dev, bool is_dummy) {
  ...
  use_tx_offload =
      !!(tx_offloads & (RTE_ETH_TX_OFFLOAD_OUTER_IPV4_CKSUM | /* tunnel */
...
static void qede_alloc_etherdev(struct qede_dev *qdev,
...
static void qede_print_adapter_info(struct rte_eth_dev *dev) {
  ...
  DP_INFO(edev, " %-20s: %s %c%d\n", "Chip details",
          ECORE_IS_BB(edev) ? "BB" : "AH", 'A' + edev->chip_rev,
          (int)edev->chip_metal);
  snprintf(ver_str, QEDE_PMD_DRV_VER_STR_SIZE, "%s", QEDE_PMD_DRV_VERSION);
  DP_INFO(edev, " %-20s: %s\n", "Driver version", ver_str);
  snprintf(ver_str, QEDE_PMD_DRV_VER_STR_SIZE, "%s", QEDE_PMD_BASE_VERSION);
...
static void qede_reset_queue_stats(struct qede_dev *qdev, bool xstats) {
  ...
  rxq_stat_cntrs = RTE_MIN(QEDE_RSS_COUNT(dev), RTE_ETHDEV_QUEUE_STAT_CNTRS);
  txq_stat_cntrs = RTE_MIN(QEDE_TSS_COUNT(dev), RTE_ETHDEV_QUEUE_STAT_CNTRS);

  for (qid = 0; qid < qdev->num_rx_queues; qid++) {
    OSAL_MEMSET(((char *)(qdev->fp_array[qid].rxq)) +
                    offsetof(struct qede_rx_queue, rcv_pkts),
                0, sizeof(uint64_t));
    OSAL_MEMSET(((char *)(qdev->fp_array[qid].rxq)) +
  ...
  for (qid = 0; qid < qdev->num_tx_queues; qid++) {
    ...
    OSAL_MEMSET(
        (uint64_t *)(uintptr_t)(((uint64_t)(uintptr_t)(txq)) +
                                offsetof(struct qede_tx_queue, xmit_pkts)),
        0, sizeof(uint64_t));
...
static int qede_stop_vport(struct ecore_dev *edev) {
  ...
  for_each_hwfn(edev, i) {
    p_hwfn = &edev->hwfns[i];
    rc = ecore_sp_vport_stop(p_hwfn, p_hwfn->hw_info.opaque_fid, vport_id);
    if (rc != ECORE_SUCCESS) {
...
static int qede_start_vport(struct qede_dev *qdev, uint16_t mtu) {
  struct ecore_dev *edev = QEDE_INIT_EDEV(qdev);
...
int qede_activate_vport(struct rte_eth_dev *eth_dev, bool flg) {
  ...
  for_each_hwfn(edev, i) {
    p_hwfn = &edev->hwfns[i];
    params.opaque_fid = p_hwfn->hw_info.opaque_fid;
    rc = ecore_sp_vport_update(p_hwfn, &params, ECORE_SPQ_MODE_EBLOCK, NULL);
    if (rc != ECORE_SUCCESS) {
...
static int qed_configure_filter_rx_mode(struct rte_eth_dev *eth_dev,
  ...
  if (type == QED_FILTER_RX_MODE_TYPE_PROMISC) {
    flags.rx_accept_filter |=
        (ECORE_ACCEPT_UCAST_UNMATCHED | ECORE_ACCEPT_MCAST_UNMATCHED);
    if (IS_VF(edev)) {
...
int qede_ucast_filter(struct rte_eth_dev *eth_dev,
                      struct ecore_filter_ucast *ucast, bool add) {
  struct qede_dev *qdev = QEDE_INIT_QDEV(eth_dev);
  struct ecore_dev *edev = QEDE_INIT_EDEV(qdev);
  ...
  if (add) {
    SLIST_FOREACH(tmp, &qdev->uc_list_head, list) {
      if ((memcmp(mac_addr, &tmp->mac, RTE_ETHER_ADDR_LEN) == 0) &&
          ucast->vni == tmp->vni && ucast->vlan == tmp->vlan) {
        DP_INFO(edev,
    ...
    u = rte_malloc(NULL, sizeof(struct qede_ucast_entry), RTE_CACHE_LINE_SIZE);
    if (!u) {
    ...
    SLIST_FOREACH(tmp, &qdev->uc_list_head, list) {
      if ((memcmp(mac_addr, &tmp->mac, RTE_ETHER_ADDR_LEN) == 0) &&
          ucast->vlan == tmp->vlan && ucast->vni == tmp->vni)
        break;
    }
    if (tmp == NULL) {
...
static int qede_add_mcast_filters(struct rte_eth_dev *eth_dev,
  ...
  for (i = 0; i < mc_addrs_num; i++) {
    m = rte_malloc(NULL, sizeof(struct qede_mcast_entry), RTE_CACHE_LINE_SIZE);
    if (!m) {
  ...
  for (i = 0; i < mc_addrs_num; i++)
    rte_ether_addr_copy(&mc_addrs[i], (struct rte_ether_addr *)&mcast.mac[i]);
...
enum _ecore_status_t qede_mac_int_ops(struct rte_eth_dev *eth_dev,
...
static int qede_mac_addr_add(struct rte_eth_dev *eth_dev,
                             struct rte_ether_addr *mac_addr,
...
static void qede_mac_addr_remove(struct rte_eth_dev *eth_dev, uint32_t index) {
  struct qede_dev *qdev = eth_dev->data->dev_private;
  struct ecore_dev *edev = &qdev->edev;
  struct ecore_filter_ucast ucast;
...
static int qede_mac_addr_set(struct rte_eth_dev *eth_dev,
                             struct rte_ether_addr *mac_addr) {
  struct qede_dev *qdev = QEDE_INIT_QDEV(eth_dev);
  struct ecore_dev *edev = QEDE_INIT_EDEV(qdev);

  if (IS_VF(edev) &&
      !ecore_vf_check_mac(ECORE_LEADING_HWFN(edev), mac_addr->addr_bytes)) {
...
static int qede_vlan_filter_set(struct rte_eth_dev *eth_dev, uint16_t vlan_id,
                                int on) {
  struct qede_dev *qdev = QEDE_INIT_QDEV(eth_dev);
  struct ecore_dev *edev = QEDE_INIT_EDEV(qdev);
  ...
  if (on) {
    ...
    vlan =
        rte_malloc(NULL, sizeof(struct qede_vlan_entry), RTE_CACHE_LINE_SIZE);
    ...
    if (!tmp) {
      if (qdev->configured_vlans == 0) {
        DP_INFO(edev, "No VLAN filters configured yet\n");
        return 0;
      }
  ...
  if (mask & RTE_ETH_VLAN_FILTER_MASK) {
    ...
    if (rx_offloads & RTE_ETH_RX_OFFLOAD_VLAN_FILTER) {
      ...
      if (qdev->configured_vlans > 1) { /* Excluding VLAN0 */
        DP_ERR(edev, " Please remove existing VLAN filters"
...
int qede_config_rss(struct rte_eth_dev *eth_dev) {
  ...
  if (qede_rss_reta_update(eth_dev, &reta_conf[0], ECORE_RSS_IND_TABLE_SIZE))
    return -EINVAL;
...
static int qede_args_check(const char *key, const char *val, void *opaque) {
  ...
  if ((strcmp(QEDE_NPAR_TX_SWITCHING, key) == 0) ||
    ...
    DP_INFO(edev, "Disabling %s tx-switching\n",
            strcmp(QEDE_NPAR_TX_SWITCHING, key) ? "VF" : "NPAR");
  }
...
static int qede_args(struct rte_eth_dev *eth_dev) {
  ...
  for (i = 0; (valid_args[i] != NULL); ++i) {
    if (rte_kvargs_count(kvlist, valid_args[i])) {
      ret = rte_kvargs_process(kvlist, valid_args[i], qede_args_check, eth_dev);
...
static int qede_dev_configure(struct rte_eth_dev *eth_dev) {
  ...
  if (qdev->num_tx_queues != num_txqs || qdev->num_rx_queues != num_rxqs) {
...
static int qede_dev_info_get(struct rte_eth_dev *eth_dev,
  ...
  if (IS_PF(edev))
    dev_info->max_rx_queues =
        (uint16_t)RTE_MIN(QEDE_MAX_RSS_CNT(qdev), QEDE_PF_NUM_CONNS / 2);
  else
    dev_info->max_rx_queues =
        (uint16_t)RTE_MIN(QEDE_MAX_RSS_CNT(qdev), ECORE_MAX_VF_CHAINS_PER_PF);
  ...
  dev_info->rx_offload_capa =
      (RTE_ETH_RX_OFFLOAD_IPV4_CKSUM | RTE_ETH_RX_OFFLOAD_UDP_CKSUM |
       ...
       RTE_ETH_RX_OFFLOAD_TCP_LRO | RTE_ETH_RX_OFFLOAD_KEEP_CRC |
       RTE_ETH_RX_OFFLOAD_SCATTER | RTE_ETH_RX_OFFLOAD_VLAN_FILTER |
       RTE_ETH_RX_OFFLOAD_VLAN_STRIP | RTE_ETH_RX_OFFLOAD_RSS_HASH);
  ...
  dev_info->tx_offload_capa =
      (RTE_ETH_TX_OFFLOAD_VLAN_INSERT | RTE_ETH_TX_OFFLOAD_IPV4_CKSUM |
       ...
       RTE_ETH_TX_OFFLOAD_OUTER_IPV4_CKSUM | RTE_ETH_TX_OFFLOAD_MULTI_SEGS |
...
int qede_link_update(struct rte_eth_dev *eth_dev,
  ...
  DP_INFO(edev, "Link - Speed %u Mode %u AN %u Status %u\n", link.link_speed,
          link.link_duplex, link.link_autoneg, link.link_status);
...
static int qede_promiscuous_disable(struct rte_eth_dev *eth_dev) {
  ...
  if (rte_eth_allmulticast_get(eth_dev->data->port_id) == 1)
    ecore_status = qed_configure_filter_rx_mode(
        eth_dev, QED_FILTER_RX_MODE_TYPE_MULTI_PROMISC);
  else
    ecore_status =
...
static void qede_poll_sp_sb_cb(void *param) {
  ...
  rc = rte_eal_alarm_set(QEDE_SP_TIMER_PERIOD, qede_poll_sp_sb_cb,
                         (void *)eth_dev);
  if (rc != 0) {
    DP_ERR(edev,
...
static int qede_dev_close(struct rte_eth_dev *eth_dev) {
  ...
  case RTE_INTR_HANDLE_VFIO_LEGACY:
    rte_intr_callback_unregister(pci_dev->intr_handle,
                                 qede_interrupt_handler_intx, (void *)eth_dev);
    break;
  default:
    rte_intr_callback_unregister(pci_dev->intr_handle, qede_interrupt_handler,
                                 (void *)eth_dev);
  }
...
static int qede_get_stats(struct rte_eth_dev *eth_dev,
  ...
  eth_stats->ierrors =
      stats.common.rx_crc_errors + stats.common.rx_align_errors +
      stats.common.rx_carrier_errors + stats.common.rx_oversize_packets +
  ...
  /* Queue stats */
  rxq_stat_cntrs =
      RTE_MIN(QEDE_RSS_COUNT(eth_dev), RTE_ETHDEV_QUEUE_STAT_CNTRS);
  txq_stat_cntrs =
      RTE_MIN(QEDE_TSS_COUNT(eth_dev), RTE_ETHDEV_QUEUE_STAT_CNTRS);
  ...
  for (qid = 0; qid < eth_dev->data->nb_rx_queues; qid++) {
    ...
    for_each_hwfn(edev, hw_fn) {
      ...
      eth_stats->q_ipackets[i] +=
          *(uint64_t *)(((char *)(qdev->fp_array[idx].rxq)) +
                        offsetof(struct qede_rx_queue, rcv_pkts));
...
static unsigned qede_get_xstats_count(struct qede_dev *qdev) {
  struct rte_eth_dev *dev = (struct rte_eth_dev *)qdev->ethdev;

  if (ECORE_IS_BB(&qdev->edev))
    return RTE_DIM(qede_xstats_strings) + RTE_DIM(qede_bb_xstats_strings) +
           (RTE_DIM(qede_rxq_xstats_strings) * QEDE_RSS_COUNT(dev) *
            qdev->edev.num_hwfns);
  else
    return RTE_DIM(qede_xstats_strings) + RTE_DIM(qede_ah_xstats_strings) +
           (RTE_DIM(qede_rxq_xstats_strings) * QEDE_RSS_COUNT(dev));
}

static int qede_get_xstats_names(struct rte_eth_dev *dev,
  ...
  for (i = 0; i < RTE_DIM(qede_xstats_strings); i++) {
    strlcpy(xstats_names[stat_idx].name, qede_xstats_strings[i].name,
  ...
  if (ECORE_IS_BB(edev)) {
    for (i = 0; i < RTE_DIM(qede_bb_xstats_strings); i++) {
      strlcpy(xstats_names[stat_idx].name, qede_bb_xstats_strings[i].name,
              sizeof(xstats_names[stat_idx].name));
      stat_idx++;
    }
  } else {
    for (i = 0; i < RTE_DIM(qede_ah_xstats_strings); i++) {
      strlcpy(xstats_names[stat_idx].name, qede_ah_xstats_strings[i].name,
              sizeof(xstats_names[stat_idx].name));
      stat_idx++;
    }
  }
  ...
  for (qid = 0; qid < QEDE_RSS_COUNT(dev); qid++) {
    for_each_hwfn(edev, hw_fn) {
      for (i = 0; i < RTE_DIM(qede_rxq_xstats_strings); i++) {
        snprintf(xstats_names[stat_idx].name, RTE_ETH_XSTATS_NAME_SIZE,
                 "%.4s%d.%d%s", qede_rxq_xstats_strings[i].name, hw_fn, qid,
...
static int qede_get_xstats(struct rte_eth_dev *dev,
  ...
  for (i = 0; i < RTE_DIM(qede_xstats_strings); i++) {
    xstats[stat_idx].value =
        *(uint64_t *)(((char *)&stats) + qede_xstats_strings[i].offset);
  ...
  if (ECORE_IS_BB(edev)) {
    for (i = 0; i < RTE_DIM(qede_bb_xstats_strings); i++) {
      xstats[stat_idx].value =
          *(uint64_t *)(((char *)&stats) + qede_bb_xstats_strings[i].offset);
      xstats[stat_idx].id = stat_idx;
      stat_idx++;
    }
  } else {
    for (i = 0; i < RTE_DIM(qede_ah_xstats_strings); i++) {
      xstats[stat_idx].value =
          *(uint64_t *)(((char *)&stats) + qede_ah_xstats_strings[i].offset);
      xstats[stat_idx].id = stat_idx;
      stat_idx++;
    }
  }
  ...
  for (qid = 0; qid < dev->data->nb_rx_queues; qid++) {
    for_each_hwfn(edev, hw_fn) {
      for (i = 0; i < RTE_DIM(qede_rxq_xstats_strings); i++) {
        ...
        xstats[stat_idx].value =
            *(uint64_t *)(((char *)(qdev->fp_array[fpidx].rxq)) +
...
static int qede_reset_xstats(struct rte_eth_dev *dev) {
  struct qede_dev *qdev = dev->data->dev_private;
  struct ecore_dev *edev = &qdev->edev;
...
static int qede_allmulticast_enable(struct rte_eth_dev *eth_dev) {
  enum qed_filter_rx_mode_type type = QED_FILTER_RX_MODE_TYPE_MULTI_PROMISC;
  enum _ecore_status_t ecore_status;
...
static int qede_allmulticast_disable(struct rte_eth_dev *eth_dev) {
  ...
  if (rte_eth_promiscuous_get(eth_dev->data->port_id) == 1)
    ecore_status =
        qed_configure_filter_rx_mode(eth_dev, QED_FILTER_RX_MODE_TYPE_PROMISC);
  else
    ecore_status =
        qed_configure_filter_rx_mode(eth_dev, QED_FILTER_RX_MODE_TYPE_REGULAR);
...
static int qede_set_mc_addr_list(struct rte_eth_dev *eth_dev,
                                 struct rte_ether_addr *mc_addrs,
                                 uint32_t mc_addrs_num) {
  struct qede_dev *qdev = QEDE_INIT_QDEV(eth_dev);
  struct ecore_dev *edev = QEDE_INIT_EDEV(qdev);
  ...
  if (IS_PF(edev)) {
    ...
    for_each_hwfn(edev, i) {
      ...
      if (rc == ECORE_INVAL) {
        ...
        qede_vlan_offload_set(eth_dev, qdev->vlan_offload_mask);
...
static int qede_flow_ctrl_set(struct rte_eth_dev *eth_dev,
  ...
  if (fc_conf->mode == RTE_ETH_FC_FULL)
    params.pause_config |=
        (QED_LINK_PAUSE_TX_ENABLE | QED_LINK_PAUSE_RX_ENABLE);
...
static int qede_flow_ctrl_get(struct rte_eth_dev *eth_dev,
  ...
  if (current_link.pause_config &
      (QED_LINK_PAUSE_RX_ENABLE | QED_LINK_PAUSE_TX_ENABLE))
...
qede_dev_supported_ptypes_get(struct rte_eth_dev *eth_dev) {
  static const uint32_t ptypes[] = {
      RTE_PTYPE_L2_ETHER, RTE_PTYPE_L2_ETHER_VLAN, RTE_PTYPE_L3_IPV4,
      RTE_PTYPE_L3_IPV6, RTE_PTYPE_L4_TCP, RTE_PTYPE_L4_UDP,
      RTE_PTYPE_TUNNEL_VXLAN, RTE_PTYPE_L4_FRAG, RTE_PTYPE_TUNNEL_GENEVE,
      ...
      RTE_PTYPE_INNER_L4_UDP, RTE_PTYPE_INNER_L4_FRAG, RTE_PTYPE_UNKNOWN};
...
int qede_rss_hash_update(struct rte_eth_dev *eth_dev,
  ...
  if (hf != 0) {
    ...
    if (key) {
      if (len > (ECORE_RSS_KEY_SIZE * sizeof(uint32_t))) {
        ...
        DP_NOTICE(edev, false, "RSS key length too big, trimmed to %d\n", len);
      }
  ...
  for_each_hwfn(edev, i) {
    ...
    for (j = 0; j < ECORE_RSS_IND_TABLE_SIZE; j++) {
      ...
      rss_params.rss_ind_table[j] = qdev->fp_array[fpidx].rxq->handle;
    }
...
static int qede_rss_hash_conf_get(struct rte_eth_dev *eth_dev,
  ...
  if (rss_conf->rss_key && qdev->rss_conf.rss_key)
    memcpy(rss_conf->rss_key, qdev->rss_conf.rss_key, rss_conf->rss_key_len);
  return 0;
}
  ...
  for_each_hwfn(edev, i) {
    for (j = 0; j < reta_size; j++) {
      ...
      if (reta_conf[idx].mask & (1ULL << shift)) {
        ...
        params->rss_ind_table[j] = qdev->fp_array[fid].rxq->handle;
...
static int qede_set_mtu(struct rte_eth_dev *dev, uint16_t mtu) {
  ...
  for (i = 0; i < qdev->num_rx_queues; i++) {
    fp = &qdev->fp_array[i];
    if (fp->rxq != NULL) {
      bufsz = (uint16_t)rte_pktmbuf_data_room_size(fp->rxq->mb_pool) -
...
static int qede_dev_reset(struct rte_eth_dev *dev) {
  int ret;
...
static void qede_dev_rx_queue_release(struct rte_eth_dev *dev, uint16_t qid) {
  qede_rx_queue_release(dev->data->rx_queues[qid]);
}

static void qede_dev_tx_queue_release(struct rte_eth_dev *dev, uint16_t qid) {
...
static int qede_common_dev_init(struct rte_eth_dev *eth_dev, bool is_vf) {
  ...
  rc = qed_ops->common->probe(edev, pci_dev, dp_module, dp_level, is_vf);
  if (rc != 0) {
  ...
  default:
    ...
    rte_intr_callback_register(pci_dev->intr_handle, qede_interrupt_handler,
                               (void *)eth_dev);
  }
  ...
  strncpy((char *)params.name, QEDE_PMD_VER_PREFIX, QEDE_PMD_DRV_VER_STR_SIZE);
  ...
  if (!is_vf)
    adapter->dev_info.num_mac_filters =
        (uint32_t)RESC_NUM(ECORE_LEADING_HWFN(edev), ECORE_MAC);
  else
    ecore_vf_get_num_mac_filters(
        ECORE_LEADING_HWFN(edev),
        (uint32_t *)&adapter->dev_info.num_mac_filters);

  /* Allocate memory for storing MAC addr */
  eth_dev->data->mac_addrs = rte_zmalloc(
      edev->name, (RTE_ETHER_ADDR_LEN * adapter->dev_info.num_mac_filters),
      RTE_CACHE_LINE_SIZE);
  ...
  if (!is_vf) {
    rte_ether_addr_copy(
        (struct rte_ether_addr *)edev->hwfns[0].hw_info.hw_mac_addr,
        &eth_dev->data->mac_addrs[0]);
    rte_ether_addr_copy(&eth_dev->data->mac_addrs[0], &adapter->primary_mac);
  } else {
    ecore_vf_read_bulletin(ECORE_LEADING_HWFN(edev), &bulletin_change);
    if (bulletin_change) {
      is_mac_exist = ecore_vf_bulletin_get_forced_mac(ECORE_LEADING_HWFN(edev),
                                                      vf_mac, &is_mac_forced);
      if (is_mac_exist) {
    ...
    if (!is_mac_exist) {
      ...
      rte_ether_addr_copy(mac_addr, &eth_dev->data->mac_addrs[0]);
...
static int qedevf_eth_dev_pci_probe(struct rte_pci_driver *pci_drv __rte_unused,
                                    struct rte_pci_device *pci_dev) {
  return rte_eth_dev_pci_generic_probe(pci_dev, sizeof(struct qede_dev),
                                       qedevf_eth_dev_init);
}
