...
typedef enum _ecore_status_t (*ecore_spq_async_comp_cb)(
    struct ecore_hwfn *p_hwfn, u8 opcode, u16 echo, union event_ring_data *data,
    u8 fw_return_code);
 ...
 */
void ecore_set_spq_block_timeout(struct ecore_hwfn *p_hwfn, u32 spq_timeout_ms);
