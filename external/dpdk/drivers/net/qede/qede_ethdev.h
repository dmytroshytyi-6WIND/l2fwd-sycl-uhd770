...
#define QEDE_PMD_DRV_VERSION                                                                            \
  qede_stringify(QEDE_PMD_VERSION_MAJOR) "." qede_stringify(QEDE_PMD_VERSION_MINOR) "." qede_stringify( \
      QEDE_PMD_VERSION_REVISION) "." qede_stringify(QEDE_PMD_VERSION_PATCH)

#define QEDE_PMD_BASE_VERSION                                                                     \
  qede_stringify(ECORE_MAJOR_VERSION) "." qede_stringify(ECORE_MINOR_VERSION) "." qede_stringify( \
      ECORE_REVISION_VERSION) "." qede_stringify(ECORE_ENGINEERING_VERSION)

#define QEDE_PMD_FW_VERSION                                                                 \
  qede_stringify(FW_MAJOR_VERSION) "." qede_stringify(FW_MINOR_VERSION) "." qede_stringify( \
      FW_REVISION_VERSION) "." qede_stringify(FW_ENGINEERING_VERSION)
...
#define QEDE_MAX_TSS_CNT(edev)                                                 \
  ((edev)->dev_info.num_queues * (edev)->dev_info.num_tc)
