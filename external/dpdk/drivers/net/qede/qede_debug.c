...
static const char *const s_mem_group_names[] = {
    "PXP_MEM", "DMAE_MEM",     "CM_MEM",  "QM_MEM",   "DORQ_MEM",
    "BRB_RAM", "BRB_MEM",      "PRS_MEM", "SDM_MEM",  "PBUF",
    "IOR",     "RAM",          "BTB_RAM", "RDIF_CTX", "TDIF_CTX",
    "CFC_MEM", "CONN_CFC_MEM", "CAU_PI",  "CAU_MEM",  "CAU_MEM_EXT",
    "PXP_ILT", "MULD_MEM",     "BTB_MEM", "IGU_MEM",  "IGU_MSIX",
    "CAU_SB",  "BMB_RAM",      "BMB_MEM", "TM_MEM",   "TASK_CFC_MEM",
};
...
static u32 cond1(const u32 *r, const u32 *imm) { return r[0] != imm[0]; }
...
static u32 cond13(const u32 *r, const u32 *imm) { return r[0] & imm[0]; }

static u32 cond8(const u32 *r, const u32 *imm) {
  return r[0] < (r[1] - imm[0]);
}

static u32 cond2(const u32 *r, const u32 *imm) { return r[0] > imm[0]; }
...
#define FIELD_BIT_MASK(type, field)                                            \
  (((1 << FIELD_BIT_SIZE(type, field)) - 1) << FIELD_DWORD_SHIFT(type, field))

#define SET_VAR_FIELD(var, type, field, val)                                   \
  do {                                                                         \
    var[FIELD_DWORD_OFFSET(type, field)] &= (~FIELD_BIT_MASK(type, field));    \
    var[FIELD_DWORD_OFFSET(type, field)] |= (val)                              \
...
#define PAGE_MEM_DESC_SIZE_DWORDS BYTES_TO_DWORDS(sizeof(struct phys_mem_desc))
...
#define PROTECTION_OVERRIDE_DEPTH_DWORDS                                       \
  (PROTECTION_OVERRIDE_DEPTH_ELEMENTS * PROTECTION_OVERRIDE_ELEMENT_DWORDS)
...
static struct rss_mem_defs s_rss_mem_defs[] = {
    {"rss_mem_cid", "rss_cid", 0, 32, {256, 320}},

    {"rss_mem_key_msb", "rss_key", 1024, 256, {128, 208}},

    {"rss_mem_key_lsb", "rss_key", 2048, 64, {128, 208}},

    {"rss_mem_info", "rss_info", 3072, 16, {128, 208}},

    {"rss_mem_ind", "rss_ind", 4096, 16, {16384, 26624}}};
...
static struct big_ram_defs s_big_ram_defs[] = {{"BRB",
                                                MEM_GROUP_BRB_MEM,
                                                MEM_GROUP_BRB_RAM,
                                                DBG_GRC_PARAM_DUMP_BRB,
                                                BRB_REG_BIG_RAM_ADDRESS,
                                               ...
                                               {"BMB",
                                                ...
                                                MISCS_REG_BLOCK_256B_EN,
                                                {0, 0},
                                                {36864, 36864}}};

static struct rbc_reset_defs s_rbc_reset_defs[] = {
    {MISCS_REG_RESET_PL_HV, {0x0, 0x400}},
    {MISC_REG_RESET_PL_PDA_VMAIN_1, {0x4404040, 0x4404040}},
    {MISC_REG_RESET_PL_PDA_VMAIN_2, {0x7, 0x7c00007}},
    {MISC_REG_RESET_PL_PDA_VAUX, {0x2, 0x2}},
};

static struct phy_defs s_phy_defs[] = {
    {"nw_phy", NWS_REG_NWS_CMU_K2, PHY_NW_IP_REG_PHY0_TOP_TBUS_ADDR_7_0_K2,
     PHY_NW_IP_REG_PHY0_TOP_TBUS_ADDR_15_8_K2,
     PHY_NW_IP_REG_PHY0_TOP_TBUS_DATA_7_0_K2,
     PHY_NW_IP_REG_PHY0_TOP_TBUS_DATA_11_8_K2},
    {"sgmii_phy", MS_REG_MS_CMU_K2, PHY_SGMII_IP_REG_AHB_CMU_CSR_0_X132_K2,
     PHY_SGMII_IP_REG_AHB_CMU_CSR_0_X133_K2,
     PHY_SGMII_IP_REG_AHB_CMU_CSR_0_X130_K2,
     PHY_SGMII_IP_REG_AHB_CMU_CSR_0_X131_K2},
    {"pcie_phy0", PHY_PCIE_REG_PHY0_K2, PHY_PCIE_IP_REG_AHB_CMU_CSR_0_X132_K2,
     PHY_PCIE_IP_REG_AHB_CMU_CSR_0_X133_K2,
     PHY_PCIE_IP_REG_AHB_CMU_CSR_0_X130_K2,
     PHY_PCIE_IP_REG_AHB_CMU_CSR_0_X131_K2},
    {"pcie_phy1", PHY_PCIE_REG_PHY1_K2, PHY_PCIE_IP_REG_AHB_CMU_CSR_0_X132_K2,
     PHY_PCIE_IP_REG_AHB_CMU_CSR_0_X133_K2,
     PHY_PCIE_IP_REG_AHB_CMU_CSR_0_X130_K2,
     PHY_PCIE_IP_REG_AHB_CMU_CSR_0_X131_K2},
};
...
static enum dbg_status qed_dbg_dev_init(struct ecore_hwfn *p_hwfn) {
  ...
  dev_data->num_pfs_per_port =
      OSAL_MIN_T(u32, num_pfs / dev_data->num_ports, max_pfs_per_port);
...
static const struct dbg_block_chip *
qed_get_dbg_block_per_chip(struct ecore_hwfn *p_hwfn, enum block_id block_id) {
  struct dbg_tools_data *dev_data = &p_hwfn->dbg_info;

  return (const struct dbg_block_chip *)p_hwfn
             ->dbg_arrays[BIN_BUF_DBG_BLOCKS_CHIP_DATA]
             .ptr +
         block_id * MAX_CHIP_IDS + dev_data->chip_id;
}

static const struct dbg_reset_reg *
qed_get_dbg_reset_reg(struct ecore_hwfn *p_hwfn, u8 reset_reg_id) {
  struct dbg_tools_data *dev_data = &p_hwfn->dbg_info;

  return (const struct dbg_reset_reg *)p_hwfn
             ->dbg_arrays[BIN_BUF_DBG_RESET_REGS]
             .ptr +
...
static void qed_read_storm_fw_info(struct ecore_hwfn *p_hwfn,
                                   struct ecore_ptt *p_ptt, u8 storm_id,
  ...
  addr = storm->sem_fast_mem_addr + SEM_FAST_REG_INT_RAM +
         DWORDS_TO_BYTES(SEM_FAST_REG_INT_RAM_SIZE) - sizeof(fw_info_location);
 ...
 */
static u32 qed_dump_str_param(u32 *dump_buf, bool dump, const char *param_name,
 ...
 * Returns the dumped size in dwords.
 */
static u32 qed_dump_num_param(u32 *dump_buf, bool dump, const char *param_name,
                              u32 param_val) {
  char *char_buf = (char *)dump_buf;
  u32 offset = 0;
...
static u32 qed_dump_fw_ver_param(struct ecore_hwfn *p_hwfn,
  ...
  offset +=
      qed_dump_str_param(dump_buf + offset, dump, "fw-version", fw_ver_str);
  offset += qed_dump_str_param(dump_buf + offset, dump, "fw-image", fw_img_str);
...
static u32 qed_dump_mfw_ver_param(struct ecore_hwfn *p_hwfn,
  ...
  if (dump && !qed_grc_get_param(p_hwfn, DBG_GRC_PARAM_NO_FW_VER)) {
     ...
     */
    public_data_addr =
        ecore_rd(p_hwfn, p_ptt, MISC_REG_SHARED_MEM_ADDR) | MCP_REG_SCRATCH;

    /* Find MCP public global section offset */
    global_section_offsize_addr = public_data_addr +
                                  offsetof(struct mcp_public_data, sections) +
                                  sizeof(offsize_t) * PUBLIC_GLOBAL;
    global_section_offsize =
        ecore_rd(p_hwfn, p_ptt, global_section_offsize_addr);
    global_section_addr =
        MCP_REG_SCRATCH + (global_section_offsize & OFFSIZE_OFFSET_MASK) * 4;

    /* Read MFW version from MCP public global section */
    mfw_ver =
        ecore_rd(p_hwfn, p_ptt,
                 global_section_addr + offsetof(struct public_global, mfw_ver));

    /* Dump MFW version param */
    if (snprintf(mfw_ver_str, sizeof(mfw_ver_str), "%d_%d_%d_%d",
                 (u8)(mfw_ver >> 24), (u8)(mfw_ver >> 16), (u8)(mfw_ver >> 8),
                 (u8)mfw_ver) < 0)
      DP_NOTICE(p_hwfn, false,
 ...
 * Returns the dumped size in dwords.
 */
static u32 qed_dump_section_hdr(u32 *dump_buf, bool dump, const char *name,
                                u32 num_params) {
...
static u32 qed_dump_common_global_params(struct ecore_hwfn *p_hwfn,
  ...
  ecore_set_platform_str(p_hwfn, sw_platform_str, MAX_SW_PLTAFORM_STR_SIZE);

  /* Dump global params section header */
  num_params = NUM_COMMON_GLOBAL_PARAMS + num_specific_global_params +
               (dev_data->chip_id == CHIP_BB ? 1 : 0);
  offset += qed_dump_section_hdr(dump_buf + offset, dump, "global_params",
                                 num_params);

  /* Store params */
  offset += qed_dump_fw_ver_param(p_hwfn, p_ptt, dump_buf + offset, dump);
  offset += qed_dump_mfw_ver_param(p_hwfn, p_ptt, dump_buf + offset, dump);
  offset +=
      qed_dump_chip_revision_param(p_hwfn, p_ptt, dump_buf + offset, dump);
  offset += qed_dump_num_param(dump_buf + offset, dump, "tools-version",
                               TOOLS_VERSION);
  offset += qed_dump_str_param(dump_buf + offset, dump, "chip",
                               s_chip_defs[dev_data->chip_id].name);
  offset += qed_dump_str_param(dump_buf + offset, dump, "platform",
                               s_hw_type_defs[dev_data->hw_type].name);
  offset += qed_dump_str_param(dump_buf + offset, dump, "sw-platform",
                               sw_platform_str);
  offset += qed_dump_num_param(dump_buf + offset, dump, "pci-func",
                               p_hwfn->abs_pf_id);
  offset += qed_dump_num_param(dump_buf + offset, dump, "epoch",
                               OSAL_GET_EPOCH(p_hwfn));
  if (dev_data->chip_id == CHIP_BB)
    offset += qed_dump_num_param(dump_buf + offset, dump, "path",
...
static u32 qed_dump_last_section(u32 *dump_buf, u32 offset, bool dump) {
  ...
  if (dump)
    *(dump_buf + offset) =
        ~OSAL_CRC32(0xffffffff, (u8 *)dump_buf, DWORDS_TO_BYTES(offset));
...
static void qed_update_blocks_reset_state(struct ecore_hwfn *p_hwfn,
  ...
  for (rst_reg_id = 0; rst_reg_id < NUM_DBG_RESET_REGS; rst_reg_id++) {
    ...
    rst_reg_removed = GET_FIELD(rst_reg->data, DBG_RESET_REG_IS_REMOVED);
    rst_reg_addr =
        DWORDS_TO_BYTES(GET_FIELD(rst_reg->data, DBG_RESET_REG_ADDR));

    if (!rst_reg_removed)
      reg_val[rst_reg_id] = ecore_rd(p_hwfn, p_ptt, rst_reg_addr);
  }
  ...
  for (blk_id = 0; blk_id < NUM_PHYS_BLOCKS; blk_id++) {
    ...
    has_rst_reg = GET_FIELD(blk->flags, DBG_BLOCK_CHIP_HAS_RESET_REG);

    if (!is_removed && has_rst_reg)
      dev_data->block_in_reset[blk_id] =
          !(reg_val[blk->reset_reg_id] & OSAL_BIT(blk->reset_reg_bit_offset));
  }
}
...
static bool qed_is_mode_match_rec(struct ecore_hwfn *p_hwfn,
  ...
  if (rec_depth > MAX_RECURSION_DEPTH) {
    DP_NOTICE(p_hwfn, false,
              "Unexpected error: is_mode_match_rec exceeded the max recursion "
              "depth. This is probably due to a corrupt init/debug buffer.\n");
    return false;
  }
  ...
  case INIT_MODE_OP_NOT:
    return !qed_is_mode_match_rec(p_hwfn, modes_buf_offset, rec_depth + 1);
  case INIT_MODE_OP_OR:
  case INIT_MODE_OP_AND:
    arg1 = qed_is_mode_match_rec(p_hwfn, modes_buf_offset, rec_depth + 1);
    arg2 = qed_is_mode_match_rec(p_hwfn, modes_buf_offset, rec_depth + 1);
...
static bool qed_is_mode_match(struct ecore_hwfn *p_hwfn,
...
static void qed_bus_config_dbg_line(struct ecore_hwfn *p_hwfn,
                                    struct ecore_ptt *p_ptt,
                                    enum block_id block_id, u8 line_id,
                                    u8 enable_mask, u8 right_shift,
                                    u8 force_valid_mask, u8 force_frame_mask) {
  const struct dbg_block_chip *block =
      qed_get_dbg_block_per_chip(p_hwfn, block_id);

  ecore_wr(p_hwfn, p_ptt, DWORDS_TO_BYTES(block->dbg_select_reg_addr), line_id);
  ecore_wr(p_hwfn, p_ptt, DWORDS_TO_BYTES(block->dbg_dword_enable_reg_addr),
           enable_mask);
  ecore_wr(p_hwfn, p_ptt, DWORDS_TO_BYTES(block->dbg_shift_reg_addr),
           right_shift);
  ecore_wr(p_hwfn, p_ptt, DWORDS_TO_BYTES(block->dbg_force_valid_reg_addr),
           force_valid_mask);
  ecore_wr(p_hwfn, p_ptt, DWORDS_TO_BYTES(block->dbg_force_frame_reg_addr),
           force_frame_mask);
}
...
static void qed_bus_disable_blocks(struct ecore_hwfn *p_hwfn,
  ...
  for (block_id = 0; block_id < MAX_BLOCK_ID; block_id++) {
    ...
    if (GET_FIELD(block_per_chip->flags, DBG_BLOCK_CHIP_IS_REMOVED) ||
        dev_data->block_in_reset[block_id])
      continue;

    /* Disable debug bus */
    if (GET_FIELD(block_per_chip->flags, DBG_BLOCK_CHIP_HAS_DBG_BUS)) {
      u32 dbg_en_addr = block_per_chip->dbg_dword_enable_reg_addr;
      u16 modes_buf_offset = GET_FIELD(block_per_chip->dbg_bus_mode.data,
                                       DBG_MODE_HDR_MODES_BUF_OFFSET);
      bool eval_mode = GET_FIELD(block_per_chip->dbg_bus_mode.data,
                                 DBG_MODE_HDR_EVAL_MODE) > 0;

      if (!eval_mode || qed_is_mode_match(p_hwfn, &modes_buf_offset))
        ecore_wr(p_hwfn, p_ptt, DWORDS_TO_BYTES(dbg_en_addr), 0);
    }
  }
}
...
static void qed_grc_stall_storms(struct ecore_hwfn *p_hwfn,
  ...
  for (storm_id = 0; storm_id < MAX_DBG_STORMS; storm_id++) {
    if (!qed_grc_is_storm_included(p_hwfn, (enum dbg_storms)storm_id))
      continue;

    reg_addr = s_storm_defs[storm_id].sem_fast_mem_addr + SEM_FAST_REG_STALL_0;
...
static void qed_grc_unreset_blocks(struct ecore_hwfn *p_hwfn,
  ...
  for (i = 0; i < OSAL_ARRAY_SIZE(s_rbc_reset_defs); i++)
    if (s_rbc_reset_defs[i].reset_val[dev_data->chip_id])
      ecore_wr(p_hwfn, p_ptt,
               s_rbc_reset_defs[i].reset_reg_addr + RESET_REG_UNRESET_OFFSET,
  ...
  if (!rbc_only) {
    ...
    for (block_id = 0; block_id < NUM_PHYS_BLOCKS; block_id++) {
      ...
      block = qed_get_dbg_block_per_chip(p_hwfn, (enum block_id)block_id);
      is_removed = GET_FIELD(block->flags, DBG_BLOCK_CHIP_IS_REMOVED);
      has_reset_reg = GET_FIELD(block->flags, DBG_BLOCK_CHIP_HAS_RESET_REG);
      unreset_before_dump =
          GET_FIELD(block->flags, DBG_BLOCK_CHIP_UNRESET_BEFORE_DUMP);

      if (!is_removed && has_reset_reg && unreset_before_dump)
        reg_val[block->reset_reg_id] |= OSAL_BIT(block->reset_reg_bit_offset);
    }

    /* Write reset registers */
    for (reset_reg_id = 0; reset_reg_id < NUM_DBG_RESET_REGS; reset_reg_id++) {
      const struct dbg_reset_reg *reset_reg;
      u32 reset_reg_addr;
      ...
      if (reg_val[reset_reg_id]) {
        ...
        ecore_wr(p_hwfn, p_ptt,
                 DWORDS_TO_BYTES(reset_reg_addr) + RESET_REG_UNRESET_OFFSET,
...
qed_get_block_attn_data(struct ecore_hwfn *p_hwfn, enum block_id block_id,
                        enum dbg_attn_type attn_type) {
  const struct dbg_attn_block *base_attn_block_arr =
      (const struct dbg_attn_block *)p_hwfn->dbg_arrays[BIN_BUF_DBG_ATTN_BLOCKS]
          .ptr;
...
qed_get_block_attn_regs(struct ecore_hwfn *p_hwfn, enum block_id block_id,
                        enum dbg_attn_type attn_type, u8 *num_attn_regs) {
  const struct dbg_attn_block_type_data *block_type_data =
      qed_get_block_attn_data(p_hwfn, block_id, attn_type);

  *num_attn_regs = block_type_data->num_regs;

  return (const struct dbg_attn_reg *)p_hwfn->dbg_arrays[BIN_BUF_DBG_ATTN_REGS]
             .ptr +
...
static void qed_grc_clear_all_prty(struct ecore_hwfn *p_hwfn,
  ...
  for (block_id = 0; block_id < NUM_PHYS_BLOCKS; block_id++) {
    ...
    attn_reg_arr = qed_get_block_attn_regs(p_hwfn, (enum block_id)block_id,
                                           ATTN_TYPE_PARITY, &num_attn_regs);
 ...
 */
static u32 qed_grc_dump_regs_hdr(u32 *dump_buf, bool dump, u32 num_reg_entries,
                                 enum init_split_types split_type, u8 split_id,
                                 const char *reg_type_name) {
  u8 num_params =
      2 + (split_type != SPLIT_TYPE_NONE ? 1 : 0) + (reg_type_name ? 1 : 0);
  u32 offset = 0;

  offset +=
      qed_dump_section_hdr(dump_buf + offset, dump, "grc_regs", num_params);
  offset +=
      qed_dump_num_param(dump_buf + offset, dump, "count", num_reg_entries);
  offset += qed_dump_str_param(dump_buf + offset, dump, "split",
                               s_split_type_defs[split_type].name);
  if (split_type != SPLIT_TYPE_NONE)
    offset += qed_dump_num_param(dump_buf + offset, dump, "id", split_id);
  if (reg_type_name)
    offset +=
        qed_dump_str_param(dump_buf + offset, dump, "type", reg_type_name);
 ...
 */
void qed_read_regs(struct ecore_hwfn *p_hwfn, struct ecore_ptt *p_ptt, u32 *buf,
                   u32 addr, u32 len) {
  u32 i;
...
static u32 qed_grc_dump_addr_range(struct ecore_hwfn *p_hwfn,
  ...
  case SPLIT_TYPE_PORT_PF:
    ...
    pf_id =
        port_id + dev_data->num_ports * (split_id % dev_data->num_pfs_per_port);
    break;
  case SPLIT_TYPE_VF:
    vf_id = split_id;
    break;
  ...
  if (dev_data->use_dmae && split_type != SPLIT_TYPE_VF &&
    ...
    case SPLIT_TYPE_PORT:
      ...
      break;
    case SPLIT_TYPE_PF:
      SET_FIELD(dmae_params.flags, DMAE_PARAMS_SRC_PF_VALID, 1);
    ...
    read_using_dmae =
        !ecore_dmae_grc2host(p_hwfn, p_ptt, DWORDS_TO_BYTES(addr),
                             (u64)(uintptr_t)(dump_buf), len, &dmae_params);
    if (!read_using_dmae) {
      dev_data->use_dmae = 0;
      DP_VERBOSE(p_hwfn->p_dev, ECORE_MSG_DEBUG,
  ...
  if (split_type != dev_data->pretend.split_type ||
    ...
    case SPLIT_TYPE_PORT:
      ...
      break;
    case SPLIT_TYPE_PF:
      fid = FIELD_VALUE(PXP_PRETEND_CONCRETE_FID_PFID, pf_id);
    ...
    case SPLIT_TYPE_VF:
      fid = FIELD_VALUE(PXP_PRETEND_CONCRETE_FID_VFVALID, 1) |
            FIELD_VALUE(PXP_PRETEND_CONCRETE_FID_VFID, vf_id);
      ecore_fid_pretend(p_hwfn, p_ptt, fid);
      break;
    default:
      break;
...
print_log:
  ...
  if ((dev_data->num_regs_read / thresh) >
    ...
    DP_VERBOSE(p_hwfn->p_dev, ECORE_MSG_DEBUG, "Dumped %d registers...\n",
...
static u32 qed_grc_dump_reg_entry(struct ecore_hwfn *p_hwfn,
  ...
  offset += qed_grc_dump_addr_range(p_hwfn, p_ptt, dump_buf + offset, dump,
                                    addr, len, wide_bus, split_type, split_id);
...
static u32 qed_grc_dump_reg_entry_skip(struct ecore_hwfn *p_hwfn,
  ...
  while (reg_offset < total_len) {
    ...
    offset +=
        qed_grc_dump_addr_range(p_hwfn, p_ptt, dump_buf + offset, dump, addr,
                                curr_len, false, SPLIT_TYPE_NONE, 0);
    reg_offset += curr_len;
    addr += curr_len;
...
static u32
qed_grc_dump_regs_entries(struct ecore_hwfn *p_hwfn, struct ecore_ptt *p_ptt,
                          struct virt_mem_desc input_regs_arr, u32 *dump_buf,
                          bool dump, enum init_split_types split_type,
                          u8 split_id, bool block_enable[MAX_BLOCK_ID],
  ...
  *num_dumped_reg_entries = 0;
  ...
  while (input_offset < BYTES_TO_DWORDS(input_regs_arr.size)) {
    const struct dbg_dump_cond_hdr *cond_hdr =
        (const struct dbg_dump_cond_hdr *)input_regs_arr.ptr + input_offset++;
    u16 modes_buf_offset;
    bool eval_mode;
    ...
    if (eval_mode) {
      ...
      mode_match = qed_is_mode_match(p_hwfn, &modes_buf_offset);
    }
    ...
    for (i = 0; i < cond_hdr->data_size; i++, input_offset++) {
      const struct dbg_dump_reg *reg =
          (const struct dbg_dump_reg *)input_regs_arr.ptr + input_offset;
      u32 addr, len;
      bool wide_bus;
      ...
      offset +=
          qed_grc_dump_reg_entry(p_hwfn, p_ptt, dump_buf + offset, dump, addr,
...
static u32 qed_grc_dump_split_data(struct ecore_hwfn *p_hwfn,
  ...
  offset = qed_grc_dump_regs_hdr(dump_buf, false, 0, hdr_split_type,
                                 hdr_split_id, reg_type_name);

  /* Dump registers */
  offset += qed_grc_dump_regs_entries(
      p_hwfn, p_ptt, input_regs_arr, dump_buf + offset, dump, split_type,
      split_id, block_enable, &num_dumped_reg_entries);

  /* Write register dump header */
  if (dump && num_dumped_reg_entries > 0)
    qed_grc_dump_regs_hdr(dump_buf, dump, num_dumped_reg_entries,
                          hdr_split_type, hdr_split_id, reg_type_name);
...
static u32 qed_grc_dump_registers(struct ecore_hwfn *p_hwfn,
                                  struct ecore_ptt *p_ptt, u32 *dump_buf,
                                  bool dump, bool block_enable[MAX_BLOCK_ID],
                                  const char *reg_type_name) {
  struct virt_mem_desc *dbg_buf = &p_hwfn->dbg_arrays[BIN_BUF_DBG_DUMP_REG];
  struct dbg_tools_data *dev_data = &p_hwfn->dbg_info;
  ...
  while (input_offset < BYTES_TO_DWORDS(dbg_buf->size)) {
    ...
    split_hdr =
        (const struct dbg_dump_split_hdr *)dbg_buf->ptr + input_offset++;
    split_type = GET_FIELD(split_hdr->hdr, DBG_DUMP_SPLIT_HDR_SPLIT_TYPE_ID);
    split_data_size = GET_FIELD(split_hdr->hdr, DBG_DUMP_SPLIT_HDR_DATA_SIZE);
    curr_input_regs_arr.ptr =
        (u32 *)p_hwfn->dbg_arrays[BIN_BUF_DBG_DUMP_REG].ptr + input_offset;
    ...
    case SPLIT_TYPE_PF:
    case SPLIT_TYPE_PORT_PF:
      split_count = dev_data->num_ports * dev_data->num_pfs_per_port;
      break;
    case SPLIT_TYPE_VF:
    ...
    for (split_id = 0; split_id < split_count; split_id++)
      offset += qed_grc_dump_split_data(p_hwfn, p_ptt, curr_input_regs_arr,
                                        dump_buf + offset, dump, block_enable,
                                        split_type, split_id, reg_type_name);
...
static u32 qed_grc_dump_reset_regs(struct ecore_hwfn *p_hwfn,
  ...
  offset += qed_grc_dump_regs_hdr(dump_buf, false, 0, SPLIT_TYPE_NONE, 0,
                                  "RESET_REGS");
  ...
  for (reset_reg_id = 0; reset_reg_id < NUM_DBG_RESET_REGS; reset_reg_id++) {
    ...
    reset_reg_addr = GET_FIELD(reset_reg->data, DBG_RESET_REG_ADDR);
    offset +=
        qed_grc_dump_reg_entry(p_hwfn, p_ptt, dump_buf + offset, dump,
                               reset_reg_addr, 1, false, SPLIT_TYPE_NONE, 0);
    num_regs++;
  }

  /* Write header */
  if (dump)
    qed_grc_dump_regs_hdr(dump_buf, true, num_regs, SPLIT_TYPE_NONE, 0,
                          "RESET_REGS");
...
static u32 qed_grc_dump_modified_regs(struct ecore_hwfn *p_hwfn,
  ...
  for (block_id = 0; block_id < NUM_PHYS_BLOCKS; block_id++) {
    ...
    for (reg_idx = 0; reg_idx < num_attn_regs; reg_idx++) {
      ...
      offset += qed_grc_dump_reg_entry(p_hwfn, p_ptt, dump_buf + offset, dump,
                                       addr, 1, false, SPLIT_TYPE_NONE, 0);
      addr = GET_FIELD(reg_data->data, DBG_ATTN_REG_STS_ADDRESS);
      offset += qed_grc_dump_reg_entry(p_hwfn, p_ptt, dump_buf + offset, dump,
                                       addr, 1, false, SPLIT_TYPE_NONE, 0);
      num_reg_entries += 2;
    }
  ...
  if (dump)
    qed_grc_dump_regs_hdr(dump_buf, true, num_reg_entries, SPLIT_TYPE_NONE, 0,
                          "ATTN_REGS");

  /* Write empty header for stall registers */
  stall_regs_offset = offset;
  offset +=
      qed_grc_dump_regs_hdr(dump_buf, false, 0, SPLIT_TYPE_NONE, 0, "REGS");
  ...
  for (storm_id = 0, num_reg_entries = 0; storm_id < MAX_DBG_STORMS;
    ...
    addr = BYTES_TO_DWORDS(storm->sem_fast_mem_addr + SEM_FAST_REG_STALLED);
    offset += qed_grc_dump_reg_entry(p_hwfn, p_ptt, dump_buf + offset, dump,
                                     addr, 1, false, SPLIT_TYPE_NONE, 0);
    num_reg_entries++;
  }
  ...
  if (dump)
    qed_grc_dump_regs_hdr(dump_buf + stall_regs_offset, true, num_reg_entries,
...
static u32 qed_grc_dump_special_regs(struct ecore_hwfn *p_hwfn,
  ...
  offset +=
      qed_grc_dump_regs_hdr(dump_buf, dump, 2, SPLIT_TYPE_NONE, 0, "REGS");
  ...
  offset +=
      qed_grc_dump_reg_entry_skip(p_hwfn, p_ptt, dump_buf + offset, dump, addr,
                                  RDIF_REG_DEBUG_ERROR_INFO_SIZE, 7, 1);
 ...
 *
 */
static u32 qed_grc_dump_mem_hdr(struct ecore_hwfn *p_hwfn, u32 *dump_buf,
                                bool dump, const char *name, u32 addr, u32 len,
                                u32 bit_width, bool packed,
  ...
  /* Dump section header */
  offset +=
      qed_dump_section_hdr(dump_buf + offset, dump, "grc_mem", num_params);
  ...
  if (name) {
    ...
    offset += qed_dump_str_param(dump_buf + offset, dump, "name", buf);
  } else {
    /* Dump address */
    u32 addr_in_bytes = DWORDS_TO_BYTES(addr);

    offset +=
        qed_dump_num_param(dump_buf + offset, dump, "addr", addr_in_bytes);
  }
  ...
  /* Dump bit width */
  if (bit_width)
    offset += qed_dump_num_param(dump_buf + offset, dump, "width", bit_width);

  /* Dump packed */
  if (packed)
    offset += qed_dump_num_param(dump_buf + offset, dump, "packed", 1);
 ...
 * The addr and len arguments are specified in dwords.
 */
static u32 qed_grc_dump_mem(struct ecore_hwfn *p_hwfn, struct ecore_ptt *p_ptt,
                            u32 *dump_buf, bool dump, const char *name,
                            u32 addr, u32 len, bool wide_bus, u32 bit_width,
                            bool packed, const char *mem_group,
                            char storm_letter) {
  u32 offset = 0;

  offset +=
      qed_grc_dump_mem_hdr(p_hwfn, dump_buf + offset, dump, name, addr, len,
                           bit_width, packed, mem_group, storm_letter);
  offset += qed_grc_dump_addr_range(p_hwfn, p_ptt, dump_buf + offset, dump,
                                    addr, len, wide_bus, SPLIT_TYPE_NONE, 0);
...
static u32 qed_grc_dump_mem_entries(struct ecore_hwfn *p_hwfn,
  ...
  while (input_offset < BYTES_TO_DWORDS(input_mems_arr.size)) {
    ...
    cond_hdr =
        (const struct dbg_dump_cond_hdr *)input_mems_arr.ptr + input_offset++;
    ...
    for (i = 0; i < num_entries;
      ...
      const struct dbg_dump_mem *mem =
          (const struct dbg_dump_mem *)((u32 *)input_mems_arr.ptr +
                                        input_offset);
      const struct dbg_block *block;
      char storm_letter = 0;
      ...
      mem_group_id = GET_FIELD(mem->dword0, DBG_DUMP_MEM_MEM_GROUP_ID);
      if (mem_group_id >= MEM_GROUPS_NUM) {
        DP_NOTICE(p_hwfn, false, "Invalid mem_group_id\n");
        return 0;
      }

      if (!qed_grc_is_mem_included(p_hwfn, (enum block_id)cond_hdr->block_id,
                                   mem_group_id))
        continue;
      ...
      block = get_dbg_block(p_hwfn, cond_hdr->block_id);
      ...
      /* Dump memory */
      offset += qed_grc_dump_mem(p_hwfn, p_ptt, dump_buf + offset, dump, NULL,
                                 mem_addr, mem_len, mem_wide_bus, 0, false,
                                 s_mem_group_names[mem_group_id], storm_letter);
    }
  }
...
static u32 qed_grc_dump_memories(struct ecore_hwfn *p_hwfn,
                                 struct ecore_ptt *p_ptt, u32 *dump_buf,
                                 bool dump) {
  struct virt_mem_desc *dbg_buf = &p_hwfn->dbg_arrays[BIN_BUF_DBG_DUMP_MEM];
  u32 offset = 0, input_offset = 0;
  ...
  while (input_offset < BYTES_TO_DWORDS(dbg_buf->size)) {
    ...
    if (split_type == SPLIT_TYPE_NONE)
      offset += qed_grc_dump_mem_entries(p_hwfn, p_ptt, curr_input_mems_arr,
...
static u32 qed_grc_dump_ctx_data(struct ecore_hwfn *p_hwfn,
                                 struct ecore_ptt *p_ptt, u32 *dump_buf,
                                 bool dump, const char *name, u32 num_lids,
  ...
  offset +=
      qed_grc_dump_mem_hdr(p_hwfn, dump_buf + offset, dump, name, 0, total_size,
                           lid_size * 32, false, name, storm->letter);
  ...
  for (lid = 0; lid < num_lids; lid++) {
    for (i = 0; i < lid_size; i++) {
      ...
      offset +=
          qed_grc_dump_addr_range(p_hwfn, p_ptt, dump_buf + offset, dump,
                                  rd_reg_addr, 1, false, SPLIT_TYPE_NONE, 0);
    }
  }
...
static u32 qed_grc_dump_ctx(struct ecore_hwfn *p_hwfn, struct ecore_ptt *p_ptt,
                            u32 *dump_buf, bool dump) {
  u32 offset = 0;
  u8 storm_id;
  ...
  for (storm_id = 0; storm_id < MAX_DBG_STORMS; storm_id++) {
    ...
    offset += qed_grc_dump_ctx_data(p_hwfn, p_ptt, dump_buf + offset, dump,
                                    "CONN_AG_CTX", NUM_OF_LCIDS, CM_CTX_CONN_AG,
                                    storm_id);

    /* Dump Conn ST context size */
    offset += qed_grc_dump_ctx_data(p_hwfn, p_ptt, dump_buf + offset, dump,
                                    "CONN_ST_CTX", NUM_OF_LCIDS, CM_CTX_CONN_ST,
                                    storm_id);

    /* Dump Task AG context size */
    offset += qed_grc_dump_ctx_data(p_hwfn, p_ptt, dump_buf + offset, dump,
                                    "TASK_AG_CTX", NUM_OF_LTIDS, CM_CTX_TASK_AG,
                                    storm_id);

    /* Dump Task ST context size */
    offset += qed_grc_dump_ctx_data(p_hwfn, p_ptt, dump_buf + offset, dump,
                                    "TASK_ST_CTX", NUM_OF_LTIDS, CM_CTX_TASK_ST,
                                    storm_id);
  }
...
static u32 qed_grc_dump_read_from_vfc(struct ecore_hwfn *p_hwfn,
                                      struct ecore_ptt *p_ptt,
                                      struct storm_defs *storm, u32 *cmd_data,
                                      u32 cmd_size, u32 *addr_data,
                                      u32 addr_size, u32 resp_size,
                                      u32 *dump_buf) {
  struct dbg_tools_data *dev_data = &p_hwfn->dbg_info;
  ...
  polling_ms =
      VFC_POLLING_DELAY_MS * s_hw_type_defs[dev_data->hw_type].delay_factor;

  /* Write VFC command */
  ARR_REG_WR(p_hwfn, p_ptt, sem_base + SEM_FAST_REG_VFC_DATA_WR, cmd_data,
             cmd_size);

  /* Write VFC address */
  ARR_REG_WR(p_hwfn, p_ptt, sem_base + SEM_FAST_REG_VFC_ADDR, addr_data,
             addr_size);
  ...
  for (i = 0; i < resp_size; i++) {
    ...
    do {
      ...
      qed_grc_dump_addr_range(p_hwfn, p_ptt, &vfc_status, true,
                              BYTES_TO_DWORDS(reg_addr), 1, false,
                              SPLIT_TYPE_NONE, 0);
      is_ready = vfc_status & OSAL_BIT(VFC_STATUS_RESP_READY_BIT);
    ...
    qed_grc_dump_addr_range(p_hwfn, p_ptt, dump_buf + i, true,
                            BYTES_TO_DWORDS(reg_addr), 1, false,
                            SPLIT_TYPE_NONE, 0);
  }
...
static u32 qed_grc_dump_vfc_cam(struct ecore_hwfn *p_hwfn,
  ...
  offset +=
      qed_grc_dump_mem_hdr(p_hwfn, dump_buf + offset, dump, "vfc_cam", 0,
                           total_size, 256, false, "vfc_cam", storm->letter);
  ...
  for (row = 0; row < VFC_CAM_NUM_ROWS; row++) {
    ...
    offset += qed_grc_dump_read_from_vfc(
        p_hwfn, p_ptt, storm, cam_cmd, VFC_CAM_CMD_DWORDS, cam_addr,
        VFC_CAM_ADDR_DWORDS, VFC_CAM_RESP_DWORDS, dump_buf + offset);
  }
...
static u32 qed_grc_dump_vfc_ram(struct ecore_hwfn *p_hwfn,
  ...
  offset += qed_grc_dump_mem_hdr(p_hwfn, dump_buf + offset, dump,
                                 ram_defs->mem_name, 0, total_size, 256, false,
  ...
  /* Read VFC RAM data */
  for (row = ram_defs->base_row; row < ram_defs->base_row + ram_defs->num_rows;
       row++) {
    SET_VAR_FIELD(ram_addr, VFC_RAM_ADDR, ROW, row);
    offset += qed_grc_dump_read_from_vfc(
        p_hwfn, p_ptt, storm, ram_cmd, VFC_RAM_CMD_DWORDS, ram_addr,
        VFC_RAM_ADDR_DWORDS, VFC_RAM_RESP_DWORDS, dump_buf + offset);
  }
...
static u32 qed_grc_dump_vfc(struct ecore_hwfn *p_hwfn, struct ecore_ptt *p_ptt,
                            u32 *dump_buf, bool dump) {
  u8 storm_id, i;
  u32 offset = 0;
  ...
  for (storm_id = 0; storm_id < MAX_DBG_STORMS; storm_id++) {
    ...
    /* Read CAM */
    offset +=
        qed_grc_dump_vfc_cam(p_hwfn, p_ptt, dump_buf + offset, dump, storm_id);

    /* Read RAM */
    for (i = 0; i < NUM_VFC_RAM_TYPES; i++)
      offset += qed_grc_dump_vfc_ram(p_hwfn, p_ptt, dump_buf + offset, dump,
                                     storm_id, &s_vfc_ram_defs[i]);
  }
...
static u32 qed_grc_dump_rss(struct ecore_hwfn *p_hwfn, struct ecore_ptt *p_ptt,
                            u32 *dump_buf, bool dump) {
  struct dbg_tools_data *dev_data = &p_hwfn->dbg_info;
  u32 offset = 0;
  u8 rss_mem_id;
  ...
  for (rss_mem_id = 0; rss_mem_id < NUM_RSS_MEM_TYPES; rss_mem_id++) {
    ...
    offset += qed_grc_dump_mem_hdr(
        p_hwfn, dump_buf + offset, dump, rss_defs->mem_name, 0, total_dwords,
        rss_defs->entry_width, packed, rss_defs->type_name, 0);
    ...
    while (total_dwords) {
      num_dwords_to_read =
          OSAL_MIN_T(u32, RSS_REG_RSS_RAM_DATA_SIZE, total_dwords);
      ecore_wr(p_hwfn, p_ptt, RSS_REG_RSS_RAM_ADDR, rss_addr);
      offset += qed_grc_dump_addr_range(p_hwfn, p_ptt, dump_buf + offset, dump,
                                        addr, num_dwords_to_read, false,
                                        SPLIT_TYPE_NONE, 0);
...
static u32 qed_grc_dump_big_ram(struct ecore_hwfn *p_hwfn,
  ...
  block_size =
      reg_val & OSAL_BIT(big_ram->is_256b_bit_offset[dev_data->chip_id]) ? 256
                                                                         : 128;
  ...
  /* Dump memory header */
  offset += qed_grc_dump_mem_hdr(p_hwfn, dump_buf + offset, dump, mem_name, 0,
                                 ram_size, block_size * 8, false, type_name, 0);
  ...
  for (i = 0; i < DIV_ROUND_UP(ram_size, BRB_REG_BIG_RAM_DATA_SIZE); i++) {
    ...
    offset += qed_grc_dump_addr_range(p_hwfn, p_ptt, dump_buf + offset, dump,
                                      addr, len, false, SPLIT_TYPE_NONE, 0);
  }
...
static u32 qed_grc_dump_mcp(struct ecore_hwfn *p_hwfn, struct ecore_ptt *p_ptt,
                            u32 *dump_buf, bool dump) {
  ...
  offset += qed_grc_dump_mem(p_hwfn, p_ptt, dump_buf + offset, dump, NULL,
                             ...
                             MCP_REG_SCRATCH_SIZE, false, 0, false, "MCP", 0);

  /* Dump MCP cpu_reg_file */
  offset +=
      qed_grc_dump_mem(p_hwfn, p_ptt, dump_buf + offset, dump, NULL,
                       BYTES_TO_DWORDS(MCP_REG_CPU_REG_FILE),
                       MCP_REG_CPU_REG_FILE_SIZE, false, 0, false, "MCP", 0);

  /* Dump MCP registers */
  block_enable[BLOCK_MCP] = true;
  offset += qed_grc_dump_registers(p_hwfn, p_ptt, dump_buf + offset, dump,
                                   block_enable, "MCP");

  /* Dump required non-MCP registers */
  offset += qed_grc_dump_regs_hdr(dump_buf + offset, dump, 1, SPLIT_TYPE_NONE,
                                  0, "MCP");
  addr = BYTES_TO_DWORDS(MISC_REG_SHARED_MEM_ADDR);
  offset += qed_grc_dump_reg_entry(p_hwfn, p_ptt, dump_buf + offset, dump, addr,
 ...
 * Returns the dumped size in dwords.
 */
static u32 qed_grc_dump_phy(struct ecore_hwfn *p_hwfn, struct ecore_ptt *p_ptt,
                            u32 *dump_buf, bool dump) {
  ...
  for (phy_id = 0; phy_id < OSAL_ARRAY_SIZE(s_phy_defs); phy_id++) {
    ...
    if (snprintf(mem_name, sizeof(mem_name), "tbus_%s", phy_defs->phy_name) < 0)
      DP_NOTICE(p_hwfn, false,
                "Unexpected debug error: invalid PHY memory name\n");

    offset += qed_grc_dump_mem_hdr(p_hwfn, dump_buf + offset, dump, mem_name, 0,
                                   PHY_DUMP_SIZE_DWORDS, 16, true, mem_name, 0);
    ...
    for (tbus_hi_offset = 0; tbus_hi_offset < (NUM_PHY_TBUS_ADDRESSES >> 8);
         tbus_hi_offset++) {
...
static u32 qed_grc_dump_mcp_hw_dump(struct ecore_hwfn *p_hwfn,
  ...
  status = qed_find_nvram_image(p_hwfn, p_ptt, NVM_TYPE_HW_DUMP_OUT,
                                &hw_dump_offset_bytes, &hw_dump_size_bytes);
  ...
  offset += qed_dump_section_hdr(dump_buf + offset, dump, "mcp_hw_dump", 1);
  offset +=
      qed_dump_num_param(dump_buf + offset, dump, "size", hw_dump_size_dwords);

  /* Read MCP HW dump image into dump buffer */
  if (dump && hw_dump_size_dwords) {
    status = qed_nvram_read(p_hwfn, p_ptt, hw_dump_offset_bytes,
                            hw_dump_size_bytes, dump_buf + offset);
    if (status != DBG_STATUS_OK) {
      DP_NOTICE(p_hwfn, false, "Failed to read MCP HW Dump image from NVRAM\n");
      return 0;
    }
  }
...
static u32 qed_grc_dump_static_debug(struct ecore_hwfn *p_hwfn,
  ...
  if (dump) {
    ...
    ecore_wr(p_hwfn, p_ptt, DBG_REG_FRAMING_MODE, DBG_BUS_FRAME_MODE_8HW);
  ...
  for (block_id = 0; block_id < MAX_BLOCK_ID; block_id++) {
    ...
    block_per_chip =
        qed_get_dbg_block_per_chip(p_hwfn, (enum block_id)block_id);
    is_removed = GET_FIELD(block_per_chip->flags, DBG_BLOCK_CHIP_IS_REMOVED);
    has_dbg_bus = GET_FIELD(block_per_chip->flags, DBG_BLOCK_CHIP_HAS_DBG_BUS);
    ...
    if (!is_removed && has_dbg_bus &&
        GET_FIELD(block_per_chip->dbg_bus_mode.data, DBG_MODE_HDR_EVAL_MODE) >
            0) {
      modes_buf_offset = GET_FIELD(block_per_chip->dbg_bus_mode.data,
                                   DBG_MODE_HDR_MODES_BUF_OFFSET);
    ...
    block_dwords = NUM_DBG_LINES(block_per_chip) * STATIC_DEBUG_LINE_DWORDS;

    /* Dump static section params */
    block = get_dbg_block(p_hwfn, (enum block_id)block_id);
    offset += qed_grc_dump_mem_hdr(p_hwfn, dump_buf + offset, dump,
                                   (const char *)block->name, 0, block_dwords,
                                   32, false, "STATIC", 0);
    ...
    if (dev_data->block_in_reset[block_id]) {
      memset(dump_buf + offset, 0, DWORDS_TO_BYTES(block_dwords));
      offset += block_dwords;
      continue;
    }
    ...
    for (line_id = 0; line_id < (u32)NUM_DBG_LINES(block_per_chip); line_id++) {
      /* Configure debug line ID */
      qed_bus_config_dbg_line(p_hwfn, p_ptt, (enum block_id)block_id,
                              (u8)line_id, 0xf, 0, 0, 0);

      /* Read debug line info */
      offset += qed_grc_dump_addr_range(p_hwfn, p_ptt, dump_buf + offset, dump,
                                        addr, len, true, SPLIT_TYPE_NONE, 0);
    }

    /* Disable block's client and debug output */
    qed_bus_enable_clients(p_hwfn, p_ptt, 0);
    qed_bus_config_dbg_line(p_hwfn, p_ptt, (enum block_id)block_id, 0, 0, 0, 0,
                            0);
  }
...
static enum dbg_status qed_grc_dump(struct ecore_hwfn *p_hwfn,
  ...
  *num_dumped_dwords = 0;
  ...
  /* Dump global params */
  offset +=
      qed_dump_common_global_params(p_hwfn, p_ptt, dump_buf + offset, dump, 4);
  offset +=
      qed_dump_str_param(dump_buf + offset, dump, "dump-type", "grc-dump");
  offset +=
      qed_dump_num_param(dump_buf + offset, dump, "num-lcids", NUM_OF_LCIDS);
  offset +=
      qed_dump_num_param(dump_buf + offset, dump, "num-ltids", NUM_OF_LTIDS);
  offset += qed_dump_num_param(dump_buf + offset, dump, "num-ports",
                               dev_data->num_ports);

  /* Dump reset registers (dumped before taking blocks out of reset ) */
  if (qed_grc_is_included(p_hwfn, DBG_GRC_PARAM_DUMP_REGS))
    offset += qed_grc_dump_reset_regs(p_hwfn, p_ptt, dump_buf + offset, dump);
  ...
  if (dump && !qed_grc_get_param(p_hwfn, DBG_GRC_PARAM_NO_MCP)) {
    ...
    if (!parities_masked) {
      ...
      if (qed_grc_get_param(p_hwfn, DBG_GRC_PARAM_PARITY_SAFE))
  ...
  if (qed_grc_is_included(p_hwfn, DBG_GRC_PARAM_DUMP_REGS))
    offset +=
        qed_grc_dump_modified_regs(p_hwfn, p_ptt, dump_buf + offset, dump);

  /* Stall storms */
  if (dump && (qed_grc_is_included(p_hwfn, DBG_GRC_PARAM_DUMP_IOR) ||
  ...
  if (qed_grc_is_included(p_hwfn, DBG_GRC_PARAM_DUMP_REGS)) {
    ...
    offset += qed_grc_dump_special_regs(p_hwfn, p_ptt, dump_buf + offset, dump);
  }
  ...
  if (qed_grc_is_included(p_hwfn, DBG_GRC_PARAM_DUMP_MCP))
    offset += qed_grc_dump_mcp(p_hwfn, p_ptt, dump_buf + offset, dump);

  /* Dump context */
  if (qed_grc_is_included(p_hwfn, DBG_GRC_PARAM_DUMP_CM_CTX))
    offset += qed_grc_dump_ctx(p_hwfn, p_ptt, dump_buf + offset, dump);

  /* Dump RSS memories */
  if (qed_grc_is_included(p_hwfn, DBG_GRC_PARAM_DUMP_RSS))
    offset += qed_grc_dump_rss(p_hwfn, p_ptt, dump_buf + offset, dump);

  /* Dump Big RAM */
  for (i = 0; i < NUM_BIG_RAM_TYPES; i++)
    if (qed_grc_is_included(p_hwfn, s_big_ram_defs[i].grc_param))
      offset += qed_grc_dump_big_ram(p_hwfn, p_ptt, dump_buf + offset, dump, i);

  /* Dump VFC */
  if (qed_grc_is_included(p_hwfn, DBG_GRC_PARAM_DUMP_VFC)) {
    dwords_read = qed_grc_dump_vfc(p_hwfn, p_ptt, dump_buf + offset, dump);
    offset += dwords_read;
    if (!dwords_read)
  ...
  /* Dump PHY tbus */
  if (qed_grc_is_included(p_hwfn, DBG_GRC_PARAM_DUMP_PHY) &&
      dev_data->chip_id == CHIP_K2 && dev_data->hw_type == HW_TYPE_ASIC)
    offset += qed_grc_dump_phy(p_hwfn, p_ptt, dump_buf + offset, dump);

  /* Dump MCP HW Dump */
  if (qed_grc_is_included(p_hwfn, DBG_GRC_PARAM_DUMP_MCP_HW_DUMP) &&
      !qed_grc_get_param(p_hwfn, DBG_GRC_PARAM_NO_MCP))
    offset += qed_grc_dump_mcp_hw_dump(p_hwfn, p_ptt, dump_buf + offset, dump);

  /* Dump static debug data (only if not during debug bus recording) */
  if (qed_grc_is_included(p_hwfn, DBG_GRC_PARAM_DUMP_STATIC) &&
      (!dump || dev_data->bus.state == DBG_BUS_STATE_IDLE))
    offset += qed_grc_dump_static_debug(p_hwfn, p_ptt, dump_buf + offset, dump);
...
static u32 qed_idle_chk_dump_failure(struct ecore_hwfn *p_hwfn,
  ...
  regs = (const union dbg_idle_chk_reg *)p_hwfn
             ->dbg_arrays[BIN_BUF_DBG_IDLE_CHK_REGS]
             .ptr +
         rule->reg_offset;
  ...
  for (reg_id = 0; reg_id < rule->num_cond_regs; reg_id++) {
    ...
    SET_FIELD(reg_hdr->data, DBG_IDLE_CHK_RESULT_REG_HDR_IS_MEM,
  ...
  for (reg_id = 0; reg_id < rule->num_info_regs; reg_id++) {
    ...
    if (!dev_data->block_in_reset[block_id]) {
      ...
      SET_FIELD(reg_hdr->data, DBG_IDLE_CHK_RESULT_REG_HDR_REG_ID,
                rule->num_cond_regs + reg_id);

      /* Write register values */
      offset +=
          qed_grc_dump_addr_range(p_hwfn, p_ptt, dump_buf + offset, dump, addr,
                                  reg->size, wide_bus, SPLIT_TYPE_NONE, 0);
    }
  }
...
static u32 qed_idle_chk_dump_rule_entries(
    struct ecore_hwfn *p_hwfn, struct ecore_ptt *p_ptt, u32 *dump_buf,
    bool dump, const struct dbg_idle_chk_rule *input_rules, u32 num_input_rules,
  ...
  *num_failing_rules = 0;
  ...
  for (i = 0; i < num_input_rules; i++) {
    ...
    regs = (const union dbg_idle_chk_reg *)p_hwfn
           ...
           rule->reg_offset;
    cond_regs = &regs[0].cond_reg;
    imm_values = (u32 *)p_hwfn->dbg_arrays[BIN_BUF_DBG_IDLE_CHK_IMMS].ptr +
                 rule->imm_offset;
    ...
    for (reg_id = 0; reg_id < rule->num_cond_regs && check_rule; reg_id++) {
      u32 block_id =
          GET_FIELD(cond_regs[reg_id].data, DBG_IDLE_CHK_COND_REG_BLOCK_ID);
    ...
    if (!dump) {
      u32 entry_dump_size =
          qed_idle_chk_dump_failure(p_hwfn, p_ptt, dump_buf + offset, false,
                                    rule->rule_id, rule, 0, NULL);
    ...
    for (entry_id = 0; entry_id < num_reg_entries; entry_id++) {
      ...
      for (reg_id = 0; reg_id < rule->num_cond_regs; reg_id++) {
        ...
        if (reg->num_entries > 1 || reg->start_entry > 0) {
          padded_entry_size = reg->entry_size > 1
        ...
        if (next_reg_offset + reg->entry_size >= IDLE_CHK_MAX_ENTRIES_SIZE) {
          DP_NOTICE(p_hwfn, false, "idle check registers entry is too large\n");
          return 0;
        }

        next_reg_offset += qed_grc_dump_addr_range(
            p_hwfn, p_ptt, cond_reg_values + next_reg_offset, dump, addr,
            reg->entry_size, wide_bus, SPLIT_TYPE_NONE, 0);
      }
      ...
      if ((*cond_arr[rule->cond_id])(cond_reg_values, imm_values)) {
        offset += qed_idle_chk_dump_failure(p_hwfn, p_ptt, dump_buf + offset,
                                            dump, rule->rule_id, rule, entry_id,
                                            cond_reg_values);
        (*num_failing_rules)++;
      }
    }
 ...
 * Returns the dumped size in dwords.
 */
static u32 qed_idle_chk_dump(struct ecore_hwfn *p_hwfn, struct ecore_ptt *p_ptt,
                             u32 *dump_buf, bool dump) {
  ...
  offset +=
      qed_dump_common_global_params(p_hwfn, p_ptt, dump_buf + offset, dump, 1);
  offset +=
      qed_dump_str_param(dump_buf + offset, dump, "dump-type", "idle-chk");
  ...
  while (input_offset < BYTES_TO_DWORDS(dbg_buf->size)) {
    const struct dbg_idle_chk_cond_hdr *cond_hdr =
        (const struct dbg_idle_chk_cond_hdr *)dbg_buf->ptr + input_offset++;
    ...
    if (mode_match) {
      const struct dbg_idle_chk_rule *rule =
          (const struct dbg_idle_chk_rule *)((u32 *)dbg_buf->ptr +
                                             input_offset);
      u32 num_input_rules = cond_hdr->data_size / IDLE_CHK_RULE_SIZE_DWORDS;
      offset += qed_idle_chk_dump_rule_entries(p_hwfn, p_ptt, dump_buf + offset,
                                               dump, rule, num_input_rules,
                                               &curr_failing_rules);
  ...
  if (dump)
    qed_dump_num_param(dump_buf + num_failing_rules_offset, dump, "num_rules",
                       num_failing_rules);
...
static enum dbg_status qed_find_nvram_image(struct ecore_hwfn *p_hwfn,
  ...
  nvm_result = ecore_mcp_nvm_rd_cmd(
      p_hwfn, p_ptt, DRV_MSG_CODE_NVM_GET_FILE_ATT, image_type, &ret_mcp_resp,
      &ret_mcp_param, &ret_txn_size, (u32 *)&file_att);
  ...
  *nvram_size_bytes = file_att.len;
  ...
  DP_VERBOSE(p_hwfn->p_dev, ECORE_MSG_DEBUG,
             "find_nvram_image: found NVRAM image of type %d in NVRAM offset "
             "%d bytes with size %d bytes\n",
...
static enum dbg_status qed_nvram_read(struct ecore_hwfn *p_hwfn,
  ...
  do {
    bytes_to_copy =
        (bytes_left > MCP_DRV_NVM_BUF_LEN) ? MCP_DRV_NVM_BUF_LEN : bytes_left;

    /* Call NVRAM read command */
    SET_MFW_FIELD(param, DRV_MB_PARAM_NVM_OFFSET,
                  nvram_offset_bytes + read_offset);
    SET_MFW_FIELD(param, DRV_MB_PARAM_NVM_LEN, bytes_to_copy);
    if (ecore_mcp_nvm_rd_cmd(p_hwfn, p_ptt, DRV_MSG_CODE_NVM_READ_NVRAM, param,
                             &ret_mcp_resp, &ret_mcp_param, &ret_read_size,
...
static enum dbg_status qed_mcp_trace_get_data_info(struct ecore_hwfn *p_hwfn,
  ...
  *trace_data_grc_addr = MCP_REG_SCRATCH + SECTION_OFFSET(spad_trace_offsize);
  ...
  signature =
      ecore_rd(p_hwfn, p_ptt,
               *trace_data_grc_addr + offsetof(struct mcp_trace, signature));

  if (signature != MFW_TRACE_SIGNATURE)
    return DBG_STATUS_INVALID_TRACE_SIGNATURE;

  /* Read trace size from MCP trace section */
  *trace_data_size = ecore_rd(
      p_hwfn, p_ptt, *trace_data_grc_addr + offsetof(struct mcp_trace, size));
...
qed_mcp_trace_get_meta_info(struct ecore_hwfn *p_hwfn, struct ecore_ptt *p_ptt,
                            u32 trace_data_size_bytes, u32 *running_bundle_id,
                            u32 *trace_meta_offset, u32 *trace_meta_size) {
  ...
  running_mfw_addr = MCP_REG_SCRATCH + SECTION_OFFSET(spad_trace_offsize) +
  ...
  *running_bundle_id = ecore_rd(p_hwfn, p_ptt, running_mfw_addr);
  ...
  /* Find image in NVRAM */
  nvram_image_type = (*running_bundle_id == DIR_ID_1) ? NVM_TYPE_MFW_TRACE1
                                                      : NVM_TYPE_MFW_TRACE2;
  return qed_find_nvram_image(p_hwfn, p_ptt, nvram_image_type,
...
static enum dbg_status qed_mcp_trace_read_meta(struct ecore_hwfn *p_hwfn,
  ...
  status =
      qed_nvram_read(p_hwfn, p_ptt, nvram_offset_in_bytes, size_in_bytes, buf);
  if (status != DBG_STATUS_OK)
    return status;
...
static enum dbg_status qed_mcp_trace_dump(struct ecore_hwfn *p_hwfn,
  ...
  *num_dumped_dwords = 0;
  ...
  /* Get trace data info */
  status = qed_mcp_trace_get_data_info(p_hwfn, p_ptt, &trace_data_grc_addr,
  ...
  offset +=
      qed_dump_common_global_params(p_hwfn, p_ptt, dump_buf + offset, dump, 1);
  offset +=
      qed_dump_str_param(dump_buf + offset, dump, "dump-type", "mcp-trace");
  ...
  trace_data_size_dwords = DIV_ROUND_UP(
      trace_data_size_bytes + sizeof(struct mcp_trace), BYTES_IN_DWORD);

  /* Dump trace data section header and param */
  offset += qed_dump_section_hdr(dump_buf + offset, dump, "mcp_trace_data", 1);
  ...
  offset += qed_dump_section_hdr(dump_buf + offset, dump, "mcp_trace_meta", 1);
  ...
  if ((!trace_meta_size_bytes || dump) && use_mfw)
    status = qed_mcp_trace_get_meta_info(
        p_hwfn, p_ptt, trace_data_size_bytes, &running_bundle_id,
        &trace_meta_offset_bytes, &trace_meta_size_bytes);
  if (status == DBG_STATUS_OK)
  ...
  if (dump && trace_meta_size_dwords)
    status = qed_mcp_trace_read_meta(p_hwfn, p_ptt, trace_meta_offset_bytes,
                                     trace_meta_size_bytes, dump_buf + offset);
  if (status == DBG_STATUS_OK)
...
static enum dbg_status qed_reg_fifo_dump(struct ecore_hwfn *p_hwfn,
  ...
  *num_dumped_dwords = 0;
  ...
  offset +=
      qed_dump_common_global_params(p_hwfn, p_ptt, dump_buf + offset, dump, 1);
  offset +=
      qed_dump_str_param(dump_buf + offset, dump, "dump-type", "reg-fifo");

  /* Dump fifo data section header and param. The size param is 0 for
   * now, and is overwritten after reading the FIFO.
   */
  offset += qed_dump_section_hdr(dump_buf + offset, dump, "reg_fifo_data", 1);
  ...
  for (dwords_read = 0; fifo_has_data && dwords_read < REG_FIFO_DEPTH_DWORDS;
       dwords_read += REG_FIFO_ELEMENT_DWORDS) {
    offset += qed_grc_dump_addr_range(p_hwfn, p_ptt, dump_buf + offset, true,
                                      addr, len, true, SPLIT_TYPE_NONE, 0);
    fifo_has_data = ecore_rd(p_hwfn, p_ptt, GRC_REG_TRACE_FIFO_VALID_DATA) > 0;
  }

  qed_dump_num_param(dump_buf + size_param_offset, dump, "size", dwords_read);
out:
  /* Dump last section */
  offset += qed_dump_last_section(dump_buf, offset, dump);
...
static enum dbg_status qed_igu_fifo_dump(struct ecore_hwfn *p_hwfn,
  ...
  *num_dumped_dwords = 0;
  ...
  offset +=
      qed_dump_common_global_params(p_hwfn, p_ptt, dump_buf + offset, dump, 1);
  offset +=
      qed_dump_str_param(dump_buf + offset, dump, "dump-type", "igu-fifo");

  /* Dump fifo data section header and param. The size param is 0 for
   * now, and is overwritten after reading the FIFO.
   */
  offset += qed_dump_section_hdr(dump_buf + offset, dump, "igu_fifo_data", 1);
  size_param_offset = offset;
  offset += qed_dump_num_param(dump_buf + offset, dump, "size", 0);
  ...
  fifo_has_data =
      ecore_rd(p_hwfn, p_ptt, IGU_REG_ERROR_HANDLING_DATA_VALID) > 0;
  ...
  for (dwords_read = 0; fifo_has_data && dwords_read < IGU_FIFO_DEPTH_DWORDS;
...
static enum dbg_status qed_protection_override_dump(struct ecore_hwfn *p_hwfn,
  ...
  *num_dumped_dwords = 0;
  ...
  offset +=
      qed_dump_common_global_params(p_hwfn, p_ptt, dump_buf + offset, dump, 1);
  offset += qed_dump_str_param(dump_buf + offset, dump, "dump-type",
                               "protection-override");
  ...
  if (override_window_dwords) {
    ...
    offset += qed_grc_dump_addr_range(p_hwfn, p_ptt, dump_buf + offset, true,
                                      addr, override_window_dwords, true,
                                      SPLIT_TYPE_NONE, 0);
...
static u32 qed_fw_asserts_dump(struct ecore_hwfn *p_hwfn,
  ...
  offset +=
      qed_dump_common_global_params(p_hwfn, p_ptt, dump_buf + offset, dump, 1);
  offset +=
      qed_dump_str_param(dump_buf + offset, dump, "dump-type", "fw-asserts");
  ...
  for (storm_id = 0; storm_id < MAX_DBG_STORMS; storm_id++) {
    ...
    offset += qed_dump_section_hdr(dump_buf + offset, dump, "fw_asserts", 2);
    offset +=
        qed_dump_str_param(dump_buf + offset, dump, "storm", storm_letter_str);
    offset += qed_dump_num_param(dump_buf + offset, dump, "size",
 ...
 * Returns the dumped size in dwords.
 */
static u32 qed_ilt_dump_pages_range(u32 *dump_buf, bool dump, u32 start_page_id,
                                    u32 num_pages,
  ...
  for (page_id = start_page_id; page_id <= end_page_id; page_id++) {
    ...
    if (dump_page_ids) {
      ...
      if (dump)
        memcpy(dump_buf + offset, mem_desc->virt_addr, mem_desc->size);
 ...
 * Returns the dumped size in dwords.
 */
static u32 qed_ilt_dump_pages_section(struct ecore_hwfn *p_hwfn, u32 *dump_buf,
                                      bool dump, u32 valid_conn_pf_pages,
  ...
  offset += qed_dump_section_hdr(dump_buf + offset, dump, section_name, 1);
  ...
  if (qed_grc_get_param(p_hwfn, DBG_GRC_PARAM_DUMP_ILT_CDUC)) {
    ...
    offset +=
        qed_ilt_dump_pages_range(dump_buf + offset, dump, start_page_id,
                                 valid_conn_pf_pages, ilt_pages, dump_page_ids);
    ...
    for (i = 0; i < p_hwfn->p_cxt_mngr->vf_count;
      ...
      offset += qed_ilt_dump_pages_range(dump_buf + offset, dump, start_page_id,
                                         valid_conn_vf_pages, ilt_pages,
                                         dump_page_ids);
  }
  ...
  if (qed_grc_get_param(p_hwfn, DBG_GRC_PARAM_DUMP_ILT_CDUT)) {
    /* Dump task PF pages */
    start_page_id =
        clients[ILT_CLI_CDUT].first.val + cdut_pf_init_pages - pf_start_line;
    offset +=
        qed_ilt_dump_pages_range(dump_buf + offset, dump, start_page_id,
                                 cdut_pf_work_pages, ilt_pages, dump_page_ids);

    /* Dump task VF pages */
    start_page_id = clients[ILT_CLI_CDUT].first.val + cdut_pf_pages +
                    cdut_vf_init_pages - pf_start_line;
    for (i = 0; i < p_hwfn->p_cxt_mngr->vf_count;
 ...
 * Returns the dumped size in dwords.
 */
static u32 qed_ilt_dump(struct ecore_hwfn *p_hwfn, struct ecore_ptt *p_ptt,
                        u32 *dump_buf, bool dump) {
  struct ecore_ilt_client_cfg *clients = p_hwfn->p_cxt_mngr->clients;
  ...
  cduc_page_size =
      1 << (clients[ILT_CLI_CDUC].p_size.val + PXP_ILT_PAGE_SIZE_NUM_BITS_MIN);
  cdut_page_size =
      1 << (clients[ILT_CLI_CDUT].p_size.val + PXP_ILT_PAGE_SIZE_NUM_BITS_MIN);
  ...
  offset +=
      qed_dump_common_global_params(p_hwfn, p_ptt, dump_buf + offset, dump, 22);
  offset +=
      qed_dump_str_param(dump_buf + offset, dump, "dump-type", "ilt-dump");
  offset += qed_dump_num_param(dump_buf + offset, dump, "cduc-page-size",
                               cduc_page_size);
  offset += qed_dump_num_param(dump_buf + offset, dump, "cduc-first-page-id",
                               clients[ILT_CLI_CDUC].first.val);
  offset += qed_dump_num_param(dump_buf + offset, dump, "cduc-last-page-id",
                               clients[ILT_CLI_CDUC].last.val);
  offset += qed_dump_num_param(dump_buf + offset, dump, "cduc-num-pf-pages",
                               clients[ILT_CLI_CDUC].pf_total_lines);
  offset += qed_dump_num_param(dump_buf + offset, dump, "cduc-num-vf-pages",
                               clients[ILT_CLI_CDUC].vf_total_lines);
  offset += qed_dump_num_param(dump_buf + offset, dump, "max-conn-ctx-size",
                               conn_ctx_size);
  offset += qed_dump_num_param(dump_buf + offset, dump, "cdut-page-size",
                               cdut_page_size);
  offset += qed_dump_num_param(dump_buf + offset, dump, "cdut-first-page-id",
                               clients[ILT_CLI_CDUT].first.val);
  offset += qed_dump_num_param(dump_buf + offset, dump, "cdut-last-page-id",
                               clients[ILT_CLI_CDUT].last.val);
  offset +=
      qed_dump_num_param(dump_buf + offset, dump, "cdut-num-pf-init-pages",
                         ecore_get_cdut_num_pf_init_pages(p_hwfn));
  offset +=
      qed_dump_num_param(dump_buf + offset, dump, "cdut-num-vf-init-pages",
                         ecore_get_cdut_num_vf_init_pages(p_hwfn));
  offset +=
      qed_dump_num_param(dump_buf + offset, dump, "cdut-num-pf-work-pages",
                         ecore_get_cdut_num_pf_work_pages(p_hwfn));
  offset +=
      qed_dump_num_param(dump_buf + offset, dump, "cdut-num-vf-work-pages",
                         ecore_get_cdut_num_vf_work_pages(p_hwfn));
  offset += qed_dump_num_param(dump_buf + offset, dump, "max-task-ctx-size",
                               p_hwfn->p_cxt_mngr->task_ctx_size);
  offset += qed_dump_num_param(dump_buf + offset, dump, "task-type-id",
                               p_hwfn->p_cxt_mngr->task_type_id);
  offset += qed_dump_num_param(dump_buf + offset, dump, "first-vf-id-in-pf",
                               p_hwfn->p_cxt_mngr->first_vf_in_pf);
  offset += /* 18 */ qed_dump_num_param(
      dump_buf + offset, dump, "num-vfs-in-pf", p_hwfn->p_cxt_mngr->vf_count);
  offset += qed_dump_num_param(dump_buf + offset, dump, "ptr-size-bytes",
                               sizeof(void *));
  offset += qed_dump_num_param(dump_buf + offset, dump, "pf-start-line",
                               p_hwfn->p_cxt_mngr->pf_start_line);
  offset +=
      qed_dump_num_param(dump_buf + offset, dump, "page-mem-desc-size-dwords",
                         PAGE_MEM_DESC_SIZE_DWORDS);
  offset += qed_dump_num_param(dump_buf + offset, dump, "ilt-shadow-size",
  ...
  for (conn_type = 0, valid_conn_pf_cids = 0;
    ...
    u32 num_pf_cids = p_hwfn->p_cxt_mngr->conn_cfg[conn_type].cid_count;
  ...
  for (conn_type = 0, valid_conn_vf_cids = 0;
       conn_type < NUM_OF_CONNECTION_TYPES; conn_type++, offset++) {
    u32 num_vf_cids = p_hwfn->p_cxt_mngr->conn_cfg[conn_type].cids_per_vf;
  ...
  offset += qed_dump_section_hdr(dump_buf + offset, dump, "ilt_page_desc", 1);
  offset += qed_dump_num_param(dump_buf + offset, dump, "size",
  ...
  if (dump) {
    ...
    for (page_id = 0; page_id < num_pages;
      ...
      memcpy(dump_buf + offset, &ilt_pages[page_id],
             DWORDS_TO_BYTES(PAGE_MEM_DESC_SIZE_DWORDS));
  } else {
    offset += num_pages * PAGE_MEM_DESC_SIZE_DWORDS;
  }

  valid_conn_pf_pages = DIV_ROUND_UP(valid_conn_pf_cids, num_cids_per_page);
  valid_conn_vf_pages = DIV_ROUND_UP(valid_conn_vf_cids, num_cids_per_page);

  /* Dump ILT pages IDs */
  offset += qed_ilt_dump_pages_section(p_hwfn, dump_buf + offset, dump,
...
enum dbg_status qed_dbg_set_bin_ptr(struct ecore_hwfn *p_hwfn,
  ...
  for (buf_id = 0; buf_id < MAX_BIN_DBG_BUFFER_TYPE; buf_id++)
    qed_set_dbg_bin_buf(p_hwfn, buf_id,
                        (const u32 *)(bin_ptr + buf_hdrs[buf_id].offset),
...
bool qed_read_fw_info(struct ecore_hwfn *p_hwfn, struct ecore_ptt *p_ptt,
                      struct fw_info *fw_info) {
  struct dbg_tools_data *dev_data = &p_hwfn->dbg_info;
  u8 storm_id;
  ...
  if (s_grc_param_defs[grc_param].is_preset) {
    ...
    for (i = 0; i < MAX_DBG_GRC_PARAMS; i++) {
      ...
      if (grc_param == DBG_GRC_PARAM_EXCLUDE_ALL)
        preset_val = defs->exclude_all_preset_val;
      else if (grc_param == DBG_GRC_PARAM_CRASH)
        preset_val = defs->crash_preset_val[dev_data->chip_id];
      else
        return DBG_STATUS_INVALID_ARGS;
...
enum dbg_status qed_dbg_grc_dump(struct ecore_hwfn *p_hwfn,
  ...
  *num_dumped_dwords = 0;
  ...
  status =
      qed_dbg_grc_get_dump_buf_size(p_hwfn, p_ptt, &needed_buf_size_in_dwords);
  if (status != DBG_STATUS_OK)
    return status;
...
enum dbg_status qed_dbg_idle_chk_get_dump_buf_size(struct ecore_hwfn *p_hwfn,
  ...
  *buf_size = 0;
  ...
  if (!idle_chk->buf_size_set) {
    idle_chk->buf_size = qed_idle_chk_dump(p_hwfn, p_ptt, NULL, false);
...
enum dbg_status qed_dbg_mcp_trace_dump(struct ecore_hwfn *p_hwfn,
  ...
  /* Perform dump */
  status = qed_mcp_trace_dump(p_hwfn, p_ptt, dump_buf, true, num_dumped_dwords);
...
enum dbg_status qed_dbg_reg_fifo_dump(struct ecore_hwfn *p_hwfn,
  ...
  *num_dumped_dwords = 0;
  ...
  status = qed_reg_fifo_dump(p_hwfn, p_ptt, dump_buf, true, num_dumped_dwords);
...
enum dbg_status qed_dbg_igu_fifo_dump(struct ecore_hwfn *p_hwfn,
  ...
  *num_dumped_dwords = 0;
  ...
  status = qed_igu_fifo_dump(p_hwfn, p_ptt, dump_buf, true, num_dumped_dwords);
  /* Revert GRC params to their default */
  qed_dbg_grc_set_params_default(p_hwfn);
...
enum dbg_status qed_dbg_protection_override_get_dump_buf_size(
    struct ecore_hwfn *p_hwfn, struct ecore_ptt *p_ptt, u32 *buf_size) {
  enum dbg_status status = qed_dbg_dev_init(p_hwfn);
  ...
  *buf_size = 0;
  ...
  return qed_protection_override_dump(p_hwfn, p_ptt, NULL, false, buf_size);
}
...
enum dbg_status qed_dbg_protection_override_dump(struct ecore_hwfn *p_hwfn,
  ...
  *num_dumped_dwords = 0;
  ...
  status = qed_dbg_protection_override_get_dump_buf_size(p_hwfn, p_ptt, p_size);
  if (status != DBG_STATUS_OK)
    return status;
  ...
  status = qed_protection_override_dump(p_hwfn, p_ptt, dump_buf, true,
                                        num_dumped_dwords);
...
enum dbg_status qed_dbg_fw_asserts_dump(struct ecore_hwfn *p_hwfn,
  ...
  *num_dumped_dwords = 0;
  ...
  status = qed_dbg_fw_asserts_get_dump_buf_size(p_hwfn, p_ptt, p_size);
  if (status != DBG_STATUS_OK)
    return status;
...
static enum dbg_status qed_dbg_ilt_dump(struct ecore_hwfn *p_hwfn,
  ...
  *num_dumped_dwords = 0;
  ...
  status =
      qed_dbg_ilt_get_dump_buf_size(p_hwfn, p_ptt, &needed_buf_size_in_dwords);
  if (status != DBG_STATUS_OK)
    return status;
...
enum dbg_status
qed_dbg_read_attn(struct ecore_hwfn *p_hwfn, struct ecore_ptt *p_ptt,
                  enum block_id block_id, enum dbg_attn_type attn_type,
                  bool clear_status, struct dbg_attn_block_result *results) {
  enum dbg_status status = qed_dbg_dev_init(p_hwfn);
  ...
  attn_reg_arr =
      qed_get_block_attn_regs(p_hwfn, block_id, attn_type, &num_attn_regs);
  ...
  for (reg_idx = 0; reg_idx < num_attn_regs; reg_idx++) {
    ...
    sts_addr = DWORDS_TO_BYTES(
        clear_status ? reg_data->sts_clr_address
                     : GET_FIELD(reg_data->data, DBG_ATTN_REG_STS_ADDRESS));
    ...
    SET_FIELD(reg_result->data, DBG_ATTN_REG_RESULT_NUM_REG_ATTN,
    ...
    reg_result->mask_val =
        ecore_rd(p_hwfn, p_ptt, DWORDS_TO_BYTES(reg_data->mask_address));
    num_result_regs++;
  }
...
static const char *const s_status_str[] = {
    ...
    "A constraint can be added only after a filter was enabled or a trigger "
    "state was added",
    ...
    "Debug arrays were not set (when using binary files, dbg_set_bin_ptr must "
    "be called)",
    ...
    "Non-matching debug lines - in E4, all lines must be of the same type "
    "(either 128b or 256b)",
    ...
    "The configured filter mode requires that all the constraints of a single "
    "trigger state will be defined on a single Storm/block input",
...
static const char *const s_idle_chk_severity_str[] = {
    "Error", "Error if no traffic", "Warning"};

/* MCP Trace level names array */
static const char *const s_mcp_trace_level_str[] = {"ERROR", "TRACE", "DEBUG"};

/* Access type names array */
static const char *const s_access_strs[] = {"read", "write"};

/* Privilege type names array */
static const char *const s_privilege_strs[] = {"VF", "PDA", "HV", "UA"};

/* Protection type names array */
static const char *const s_protection_strs[] = {
    "(default)",   "(default)",    "(default)",   "(default)",
    "override VF", "override PDA", "override HV", "override UA"};

/* Master type names array */
static const char *const s_master_strs[] = {
    "???",  "pxp", "mcp",  "msdm", "psdm", "ysdm", "usdm", "tsdm",
    "xsdm", "dbu", "dmae", "jdap", "???",  "???",  "???",  "???"};
...
static const char *const s_igu_fifo_source_strs[] = {
    "TSTORM", "MSTORM",     "USTORM", "XSTORM", "YSTORM", "PSTORM",
    "PCIE",   "NIG_QM_PBF", "CAU",    "ATTN",   "GRC",
};
...
static const struct igu_fifo_addr_data s_igu_fifo_addr_data[] = {
    ...
    {0x201, 0x201, "Write PBA[64:127]", "reserved", IGU_ADDR_TYPE_WRITE_PBA},
    ...
    {0x5f0, 0x5f0, "Attention bits update", NULL,
     IGU_ADDR_TYPE_WRITE_ATTN_BITS},
    {0x5f1, 0x5f1, "Attention bits set", NULL, IGU_ADDR_TYPE_WRITE_ATTN_BITS},
    {0x5f2, 0x5f2, "Attention bits clear", NULL, IGU_ADDR_TYPE_WRITE_ATTN_BITS},
...
static u32 qed_cyclic_add(u32 a, u32 b, u32 size) { return (a + b) % size; }
 ...
 * updated.
 */
static u32 qed_read_from_cyclic_buf(void *buf, u32 *offset, u32 buf_size,
 ...
 */
static u32 qed_read_param(u32 *dump_buf, const char **param_name,
 ...
 */
static u32 qed_read_section_hdr(u32 *dump_buf, const char **section_name,
                                u32 *num_section_params) {
  const char *param_str_val;

  return qed_read_param(dump_buf, section_name, &param_str_val,
                        num_section_params);
}
 ...
 */
static u32 qed_print_section_params(u32 *dump_buf, u32 num_section_params,
  ...
  for (i = 0; i < num_section_params; i++) {
    ...
    dump_offset += qed_read_param(dump_buf + dump_offset, &param_name,
...
static const char *qed_dbg_get_block_name(struct ecore_hwfn *p_hwfn,
  ...
  const struct dbg_block_user *block =
      (const struct dbg_block_user *)p_hwfn
          ->dbg_arrays[BIN_BUF_DBG_BLOCKS_USER_DATA]
          .ptr +
      block_id;
...
qed_dbg_get_user_data(struct ecore_hwfn *p_hwfn) {
...
static u32 qed_parse_idle_chk_dump_rules(struct ecore_hwfn *p_hwfn,
                                         u32 *dump_buf, u32 *dump_buf_end,
                                         u32 num_rules, bool print_fw_idle_chk,
                                         char *results_buf, u32 *num_errors,
                                         u32 *num_warnings) {
  ...
  *num_warnings = 0;
  ...
  for (rule_idx = 0; rule_idx < num_rules && dump_buf < dump_buf_end;
    ...
    hdr = (struct dbg_idle_chk_result_hdr *)dump_buf;
    rule_parsing_data = (const struct dbg_idle_chk_rule_parsing_data *)p_hwfn
                            ->dbg_arrays[BIN_BUF_DBG_IDLE_CHK_PARSING_DATA]
                            .ptr +
                        hdr->rule_id;
    parsing_str_offset = GET_FIELD(rule_parsing_data->data,
                                   DBG_IDLE_CHK_RULE_PARSING_DATA_STR_OFFSET);
    has_fw_msg = GET_FIELD(rule_parsing_data->data,
                           DBG_IDLE_CHK_RULE_PARSING_DATA_HAS_FW_MSG) > 0;
    parsing_str =
        (const char *)p_hwfn->dbg_arrays[BIN_BUF_DBG_PARSING_STRINGS].ptr +
        parsing_str_offset;
    lsi_msg = parsing_str;
    curr_reg_id = 0;
    ...
    /* Print rule severity */
    results_offset += sprintf(qed_get_buf_ptr(results_buf, results_offset),
                              "%s: ", s_idle_chk_severity_str[hdr->severity]);

    /* Print rule message */
    if (has_fw_msg)
      parsing_str += strlen(parsing_str) + 1;
    results_offset +=
        sprintf(qed_get_buf_ptr(results_buf, results_offset), "%s.",
                has_fw_msg && print_fw_idle_chk ? parsing_str : lsi_msg);
    parsing_str += strlen(parsing_str) + 1;

    /* Print register values */
    results_offset +=
        sprintf(qed_get_buf_ptr(results_buf, results_offset), " Registers:");
    for (i = 0; i < hdr->num_dumped_cond_regs + hdr->num_dumped_info_regs;
         i++) {
      struct dbg_idle_chk_result_reg_hdr *reg_hdr;
      bool is_mem;
      u8 reg_id;

      reg_hdr = (struct dbg_idle_chk_result_reg_hdr *)dump_buf;
      is_mem = GET_FIELD(reg_hdr->data, DBG_IDLE_CHK_RESULT_REG_HDR_IS_MEM);
      reg_id = GET_FIELD(reg_hdr->data, DBG_IDLE_CHK_RESULT_REG_HDR_REG_ID);
      ...
      if (i < hdr->num_dumped_cond_regs && is_mem)
        results_offset +=
            sprintf(qed_get_buf_ptr(results_buf, results_offset), "[%d]",
                    hdr->mem_entry_id + reg_hdr->start_entry);
      results_offset +=
 ...
 */
static enum dbg_status
qed_parse_idle_chk_dump(struct ecore_hwfn *p_hwfn, u32 *dump_buf,
                        u32 num_dumped_dwords, char *results_buf,
                        u32 *parsed_results_bytes, u32 *num_errors,
                        u32 *num_warnings) {
  ...
  *num_warnings = 0;
  ...
  dump_buf +=
      qed_read_section_hdr(dump_buf, &section_name, &num_section_params);
  if (strcmp(section_name, "global_params"))
    return DBG_STATUS_IDLE_CHK_PARSE_FAILED;

  /* Print global params */
  dump_buf += qed_print_section_params(dump_buf, num_section_params,
  ...
  if (strcmp(section_name, "idle_chk") || num_section_params != 1)
    return DBG_STATUS_IDLE_CHK_PARSE_FAILED;
  dump_buf += qed_read_param(dump_buf, &param_name, &param_str_val, &num_rules);
  ...
  if (num_rules) {
    ...
    rules_print_size = qed_parse_idle_chk_dump_rules(
        p_hwfn, dump_buf, dump_buf_end, num_rules, true,
        results_buf ? results_buf + results_offset : NULL, num_errors,
        num_warnings);
    ...
    results_offset += sprintf(qed_get_buf_ptr(results_buf, results_offset),
                              "\nLSI_IDLE_CHECK:\n");
    rules_print_size = qed_parse_idle_chk_dump_rules(
        p_hwfn, dump_buf, dump_buf_end, num_rules, false,
        results_buf ? results_buf + results_offset : NULL, num_errors,
        num_warnings);
    results_offset += rules_print_size;
    if (!rules_print_size)
 ...
 */
static enum dbg_status qed_mcp_trace_alloc_meta_data(struct ecore_hwfn *p_hwfn,
                                                     const u32 *meta_buf) {
  ...
  for (i = 0; i < meta->modules_num; i++) {
    ...
    *(meta->modules + i) =
        (char *)OSAL_ZALLOC(p_hwfn->p_dev, GFP_KERNEL, module_len);
    if (!(*(meta->modules + i))) {
  ...
  meta->formats = (struct mcp_trace_format *)OSAL_ZALLOC(
      p_hwfn->p_dev, GFP_KERNEL,
  ...
  for (i = 0; i < meta->formats_num; i++) {
    ...
    format_ptr->data = qed_read_dword_from_buf(meta_buf_bytes, &offset);
    format_len = GET_MFW_FIELD(format_ptr->data, MCP_TRACE_FORMAT_LEN);
    format_ptr->format_str =
        (char *)OSAL_ZALLOC(p_hwfn->p_dev, GFP_KERNEL, format_len);
    ...
    qed_read_str_from_buf(meta_buf_bytes, &offset, format_len,
                          format_ptr->format_str);
  }
 ...
 */
static enum dbg_status
qed_parse_mcp_trace_buf(struct ecore_hwfn *p_hwfn, u8 *trace_buf,
                        u32 trace_buf_size, u32 data_offset, u32 data_size,
                        char *parsed_buf, u32 *parsed_results_bytes) {
  struct dbg_tools_user_data *dev_user_data;
  struct mcp_trace_meta *meta;
  ...
  *parsed_results_bytes = 0;
  ...
  while (data_size) {
    ...
    header = qed_read_from_cyclic_buf(trace_buf, &data_offset, trace_buf_size,
    ...
    if (format_idx >= meta->formats_num) {
      u8 format_size = (u8)GET_MFW_FIELD(header, MFW_TRACE_PRM_SIZE);

      if (data_size < format_size)
        return DBG_STATUS_MCP_TRACE_BAD_DATA;

      data_offset = qed_cyclic_add(data_offset, format_size, trace_buf_size);
      data_size -= format_size;
      continue;
    }

    format_ptr = (struct mcp_trace_format *)&meta->formats[format_idx];

    for (i = 0, param_mask = MCP_TRACE_FORMAT_P1_SIZE_MASK,
        param_shift = MCP_TRACE_FORMAT_P1_SIZE_OFFSET;
         i < MCP_TRACE_FORMAT_MAX_PARAMS;
         i++, param_mask <<= MCP_TRACE_FORMAT_PARAM_WIDTH,
        param_shift += MCP_TRACE_FORMAT_PARAM_WIDTH) {
      /* Extract param size (0..3) */
      u8 param_size = (u8)((format_ptr->data & param_mask) >> param_shift);
      ...
      params[i] = qed_read_from_cyclic_buf(trace_buf, &data_offset,
                                           trace_buf_size, param_size);
      data_size -= param_size;
    }

    format_level = (u8)GET_MFW_FIELD(format_ptr->data, MCP_TRACE_FORMAT_LEVEL);
    format_module =
        (u8)GET_MFW_FIELD(format_ptr->data, MCP_TRACE_FORMAT_MODULE);
    if (format_level >= OSAL_ARRAY_SIZE(s_mcp_trace_level_str))
      return DBG_STATUS_MCP_TRACE_BAD_DATA;

    /* Print current message to results buffer */
    *parsed_results_bytes +=
        OSAL_SPRINTF(qed_get_buf_ptr(parsed_buf, *parsed_results_bytes),
                     "%s %-8s: ", s_mcp_trace_level_str[format_level],
                     meta->modules[format_module]);
    *parsed_results_bytes +=
        sprintf(qed_get_buf_ptr(parsed_buf, *parsed_results_bytes),
                format_ptr->format_str, params[0], params[1], params[2]);
  }
...
static enum dbg_status qed_parse_mcp_trace_dump(struct ecore_hwfn *p_hwfn,
  ...
  *parsed_results_bytes = 0;
  ...
  if (strcmp(section_name, "mcp_trace_data") || num_section_params != 1)
    return DBG_STATUS_MCP_TRACE_BAD_DATA;
  dump_buf +=
      qed_read_param(dump_buf, &param_name, &param_str_val, &param_num_val);
  ...
  if (!trace_meta_dwords) {
    ...
    struct dbg_tools_user_data *dev_user_data = qed_dbg_get_user_data(p_hwfn);
  ...
  status = qed_parse_mcp_trace_buf(
      p_hwfn, trace_buf, trace->size, offset, data_size,
      results_buf ? results_buf + results_offset : NULL, &results_buf_bytes);
  if (status != DBG_STATUS_OK)
    return status;
 ...
 * The parsing status is returned.
 */
static enum dbg_status qed_parse_reg_fifo_dump(u32 *dump_buf, char *results_buf,
                                               u32 *parsed_results_bytes) {
  const char *section_name, *param_name, *param_str_val;
  ...
  for (i = 0; i < num_elements; i++) {
    ...
    for (j = 0; j < OSAL_ARRAY_SIZE(s_reg_fifo_errors) && !err_msg; j++)
      if (err_code == s_reg_fifo_errors[j].err_code)
        err_msg = s_reg_fifo_errors[j].err_msg;

    /* Add parsed element to parsed buffer */
    results_offset += sprintf(
        qed_get_buf_ptr(results_buf, results_offset),
        "raw: 0x%016" PRIx64
        ", address: 0x%07x, access: %-5s, pf: %2d, vf: %s, "
        "port: %d, privilege: %-3s, protection: %-12s, master: %-4s, error: "
        "%s\n",
        elements[i].data,
        (u32)GET_FIELD(elements[i].data, REG_FIFO_ELEMENT_ADDRESS) *
            REG_FIFO_ELEMENT_ADDR_FACTOR,
        s_access_strs[GET_FIELD(elements[i].data, REG_FIFO_ELEMENT_ACCESS)],
        (u32)GET_FIELD(elements[i].data, REG_FIFO_ELEMENT_PF), vf_str,
        (u32)GET_FIELD(elements[i].data, REG_FIFO_ELEMENT_PORT),
        s_privilege_strs[GET_FIELD(elements[i].data,
                                   REG_FIFO_ELEMENT_PRIVILEGE)],
        s_protection_strs[GET_FIELD(elements[i].data,
                                    REG_FIFO_ELEMENT_PROTECTION)],
        s_master_strs[GET_FIELD(elements[i].data, REG_FIFO_ELEMENT_MASTER)],
...
static enum dbg_status
qed_parse_igu_fifo_element(struct igu_fifo_element *element, char *results_buf,
                           u32 *results_offset) {
  ...
  /* Find address data */
  for (i = 0; i < OSAL_ARRAY_SIZE(s_igu_fifo_addr_data) && !found_addr; i++) {
    const struct igu_fifo_addr_data *curr_addr = &s_igu_fifo_addr_data[i];

    if (cmd_addr >= curr_addr->start_addr && cmd_addr <= curr_addr->end_addr)
  ...
  case IGU_ADDR_TYPE_WRITE_PROD_UPDATE:
    sprintf(parsed_addr_data, " SB = 0x%x", cmd_addr - found_addr->start_addr);
    break;
  default:
  ...
  if (source == IGU_SRC_ATTN) {
    ...
    if (is_cleanup) {
      ...
      cleanup_val = GET_FIELD(wr_data, IGU_FIFO_CLEANUP_WR_DATA_CLEANUP_VAL);
      cleanup_type = GET_FIELD(wr_data, IGU_FIFO_CLEANUP_WR_DATA_CLEANUP_TYPE);

      sprintf(parsed_wr_data,
              "cmd_type: cleanup, cleanup_val: %s, cleanup_type : %d, ",
              cleanup_val ? "set" : "clear", cleanup_type);
    } else {
      u8 update_flag, en_dis_int_for_sb, segment;
      u8 timer_mask;

      update_flag = GET_FIELD(wr_data, IGU_FIFO_WR_DATA_UPDATE_FLAG);
      en_dis_int_for_sb =
          GET_FIELD(wr_data, IGU_FIFO_WR_DATA_EN_DIS_INT_FOR_SB);
      segment = GET_FIELD(wr_data, IGU_FIFO_WR_DATA_SEGMENT);
      timer_mask = GET_FIELD(wr_data, IGU_FIFO_WR_DATA_TIMER_MASK);

      sprintf(parsed_wr_data,
              "cmd_type: prod/cons update, prod/cons: 0x%x, update_flag: %s, "
              "en_dis_int_for_sb : %s, segment : %s, timer_mask = %d, ",
              prod_cons, update_flag ? "update" : "nop",
              en_dis_int_for_sb ? (en_dis_int_for_sb == 1 ? "disable" : "nop")
                                : "enable",
              segment ? "attn" : "regular", timer_mask);
    }
  }
out:
  /* Add parsed element to parsed buffer */
  *results_offset += sprintf(
      qed_get_buf_ptr(results_buf, *results_offset),
      "raw: 0x%01x%08x%08x, %s: %d, source : %s, type : %s, cmd_addr : "
      "0x%x(%s%s), %serror: %s\n",
      element->dword2, element->dword1, element->dword0, is_pf ? "pf" : "vf",
      GET_FIELD(element->dword0, IGU_FIFO_ELEMENT_DWORD0_FID),
      s_igu_fifo_source_strs[source], is_wr_cmd ? "wr" : "rd", cmd_addr,
      (!is_pf && found_addr->vf_desc) ? found_addr->vf_desc : found_addr->desc,
      parsed_addr_data, parsed_wr_data, s_igu_fifo_error_strs[err_type]);
 ...
 * The parsing status is returned.
 */
static enum dbg_status qed_parse_igu_fifo_dump(u32 *dump_buf, char *results_buf,
                                               u32 *parsed_results_bytes) {
  const char *section_name, *param_name, *param_str_val;
  u32 param_num_val, num_section_params, num_elements;
  ...
  for (i = 0; i < num_elements; i++) {
    status =
        qed_parse_igu_fifo_element(&elements[i], results_buf, &results_offset);
    if (status != DBG_STATUS_OK)
      return status;
  }
...
static enum dbg_status
qed_parse_protection_override_dump(u32 *dump_buf, char *results_buf,
                                   u32 *parsed_results_bytes) {
  const char *section_name, *param_name, *param_str_val;
  u32 param_num_val, num_section_params, num_elements;
  ...
  for (i = 0; i < num_elements; i++) {
    ...
    results_offset += sprintf(
        qed_get_buf_ptr(results_buf, results_offset),
        "window %2d, address: 0x%07x, size: %7d regs, read: %d, write: %d, "
        "read protection: %-12s, write protection: %-12s\n",
        i, address,
        (u32)GET_FIELD(elements[i].data,
                       PROTECTION_OVERRIDE_ELEMENT_WINDOW_SIZE),
        (u32)GET_FIELD(elements[i].data, PROTECTION_OVERRIDE_ELEMENT_READ),
        (u32)GET_FIELD(elements[i].data, PROTECTION_OVERRIDE_ELEMENT_WRITE),
        s_protection_strs[GET_FIELD(
            elements[i].data, PROTECTION_OVERRIDE_ELEMENT_READ_PROTECTION)],
        s_protection_strs[GET_FIELD(
            elements[i].data, PROTECTION_OVERRIDE_ELEMENT_WRITE_PROTECTION)]);
  }

  results_offset +=
      sprintf(qed_get_buf_ptr(results_buf, results_offset),
              "protection override contained %d elements", num_elements);
  ...
  *parsed_results_bytes = 0;
  ...
  while (!last_section_found) {
    ...
    if (!strcmp(section_name, "fw_asserts")) {
      ...
      for (i = 0; i < num_section_params; i++) {
        dump_buf += qed_read_param(dump_buf, &param_name, &param_str_val,
                                   &param_num_val);
...
enum dbg_status qed_dbg_user_set_bin_ptr(struct ecore_hwfn *p_hwfn,
  ...
  /* Convert binary data to debug arrays */
  for (buf_id = 0; buf_id < MAX_BIN_DBG_BUFFER_TYPE; buf_id++)
    qed_set_dbg_bin_buf(p_hwfn, (enum bin_dbg_buffer_type)buf_id,
                        (const u32 *)(bin_ptr + buf_hdrs[buf_id].offset),
                        buf_hdrs[buf_id].length);
...
const char *qed_dbg_get_status_str(enum dbg_status status) {
  return (status < MAX_DBG_STATUS) ? s_status_str[status]
...
enum dbg_status qed_get_idle_chk_results_buf_size(struct ecore_hwfn *p_hwfn,
  ...
  return qed_parse_idle_chk_dump(p_hwfn, dump_buf, num_dumped_dwords, NULL,
                                 results_buf_size, &num_errors, &num_warnings);
}
...
enum dbg_status qed_print_idle_chk_results(struct ecore_hwfn *p_hwfn,
  ...
  return qed_parse_idle_chk_dump(p_hwfn, dump_buf, num_dumped_dwords,
                                 results_buf, &parsed_buf_size, num_errors,
                                 num_warnings);
}
...
enum dbg_status
qed_get_mcp_trace_results_buf_size(struct ecore_hwfn *p_hwfn, u32 *dump_buf,
                                   __rte_unused u32 num_dumped_dwords,
                                   u32 *results_buf_size) {
  return qed_parse_mcp_trace_dump(p_hwfn, dump_buf, NULL, results_buf_size,
                                  true);
}
...
enum dbg_status qed_print_mcp_trace_line(struct ecore_hwfn *p_hwfn,
                                         u8 *dump_buf, u32 num_dumped_bytes,
                                         char *results_buf) {
  u32 parsed_results_bytes;

  return qed_parse_mcp_trace_buf(p_hwfn, dump_buf, num_dumped_bytes, 0,
                                 num_dumped_bytes, results_buf,
                                 &parsed_results_bytes);
}
...
enum dbg_status qed_get_reg_fifo_results_buf_size(
    __rte_unused struct ecore_hwfn *p_hwfn, u32 *dump_buf,
    __rte_unused u32 num_dumped_dwords, u32 *results_buf_size) {
...
qed_print_reg_fifo_results(__rte_unused struct ecore_hwfn *p_hwfn,
                           u32 *dump_buf, __rte_unused u32 num_dumped_dwords,
                           char *results_buf) {
  u32 parsed_buf_size;
...
enum dbg_status qed_get_protection_override_results_buf_size(
    __rte_unused struct ecore_hwfn *p_hwfn, u32 *dump_buf,
    __rte_unused u32 num_dumped_dwords, u32 *results_buf_size) {
  return qed_parse_protection_override_dump(dump_buf, NULL, results_buf_size);
}

enum dbg_status qed_print_protection_override_results(
    __rte_unused struct ecore_hwfn *p_hwfn, u32 *dump_buf,
    __rte_unused u32 num_dumped_dwords, char *results_buf) {
  u32 parsed_buf_size;

  return qed_parse_protection_override_dump(dump_buf, results_buf,
                                            &parsed_buf_size);
}
...
qed_print_fw_asserts_results(__rte_unused struct ecore_hwfn *p_hwfn,
  ...
  return qed_parse_fw_asserts_dump(dump_buf, results_buf, &parsed_buf_size);
}
...
enum dbg_status qed_dbg_parse_attn(struct ecore_hwfn *p_hwfn,
  ...
  for (i = 0; i < num_regs; i++) {
    ...
    num_reg_attn =
        GET_FIELD(reg_result->data, DBG_ATTN_REG_RESULT_NUM_REG_ATTN);
    bit_mapping = (struct dbg_attn_bit_mapping *)p_hwfn
                      ->dbg_arrays[BIN_BUF_DBG_ATTN_INDEXES]
                      .ptr +
    ...
    for (j = 0; j < num_reg_attn; j++, bit_idx++) {
      u16 attn_idx_val =
          GET_FIELD(bit_mapping[j].data, DBG_ATTN_BIT_MAPPING_VAL);
       ...
       * Find attention name
       */
      attn_name_offset = block_attn_name_offsets[attn_idx_val];
      attn_name = attn_name_base + attn_name_offset;
      attn_type_str =
          (attn_type == ATTN_TYPE_INTERRUPT ? "Interrupt" : "Parity");
      masked_str = reg_result->mask_val & OSAL_BIT(bit_idx) ? " [masked]" : "";
      sts_addr = GET_FIELD(reg_result->data, DBG_ATTN_REG_RESULT_STS_ADDRESS);
      DP_NOTICE(p_hwfn, false, "%s (%s) : %s [address 0x%08x, bit %d]%s\n",
                block_name, attn_type_str, attn_name, sts_addr * 4, bit_idx,
                masked_str);
    }
  }
...
static enum dbg_status
qed_print_idle_chk_results_wrapper(struct ecore_hwfn *p_hwfn, u32 *dump_buf,
                                   u32 num_dumped_dwords, char *results_buf) {
  u32 num_errors, num_warnnings;

  return qed_print_idle_chk_results(p_hwfn, dump_buf, num_dumped_dwords,
                                    results_buf, &num_errors, &num_warnnings);
}
...
static struct {
  ...
  enum dbg_status (*print_results)(struct ecore_hwfn *p_hwfn, u32 *dump_buf,
                                   u32 num_dumped_dwords, char *results_buf);
  enum dbg_status (*results_buf_size)(struct ecore_hwfn *p_hwfn, u32 *dump_buf,
                                      u32 num_dumped_dwords,
                                      u32 *results_buf_size);
} qed_features_lookup[] = {
    {"grc", qed_dbg_grc_get_dump_buf_size, qed_dbg_grc_dump, NULL, NULL},
    {"idle_chk", qed_dbg_idle_chk_get_dump_buf_size, qed_dbg_idle_chk_dump,
     qed_print_idle_chk_results_wrapper, qed_get_idle_chk_results_buf_size},
    {"mcp_trace", qed_dbg_mcp_trace_get_dump_buf_size, qed_dbg_mcp_trace_dump,
     qed_print_mcp_trace_results, qed_get_mcp_trace_results_buf_size},
    {"reg_fifo", qed_dbg_reg_fifo_get_dump_buf_size, qed_dbg_reg_fifo_dump,
     qed_print_reg_fifo_results, qed_get_reg_fifo_results_buf_size},
    {"igu_fifo", qed_dbg_igu_fifo_get_dump_buf_size, qed_dbg_igu_fifo_dump,
     qed_print_igu_fifo_results, qed_get_igu_fifo_results_buf_size},
    {"protection_override", qed_dbg_protection_override_get_dump_buf_size,
     qed_dbg_protection_override_dump, qed_print_protection_override_results,
     qed_get_protection_override_results_buf_size},
    {"fw_asserts", qed_dbg_fw_asserts_get_dump_buf_size,
     qed_dbg_fw_asserts_dump, qed_print_fw_asserts_results,
     qed_get_fw_asserts_results_buf_size},
    {"ilt", qed_dbg_ilt_get_dump_buf_size, qed_dbg_ilt_dump, NULL, NULL},
};
...
static enum dbg_status format_feature(struct ecore_hwfn *p_hwfn,
  ...
  rc = qed_features_lookup[feature_idx].results_buf_size(
      p_hwfn, (u32 *)feature->dump_buf, feature->dumped_dwords,
      &text_size_bytes);
  if (rc != DBG_STATUS_OK)
    return rc;
  ...
  rc = qed_features_lookup[feature_idx].print_results(
      p_hwfn, (u32 *)feature->dump_buf, feature->dumped_dwords, text_buf);
  if (rc != DBG_STATUS_OK) {
...
static enum dbg_status qed_dbg_dump(struct ecore_hwfn *p_hwfn,
  ...
  if (buf_size_dwords > MAX_DBG_FEATURE_SIZE_DWORDS) {
    feature->buf_size = 0;
    DP_NOTICE(p_hwfn->p_dev, false,
              "Debug feature [\"%s\"] size (0x%x dwords) exceeds maximum size "
              "(0x%x dwords)\n",
              qed_features_lookup[feature_idx].name, buf_size_dwords,
  ...
  rc = qed_features_lookup[feature_idx].perform_dump(
      p_hwfn, p_ptt, (u32 *)feature->dump_buf, feature->buf_size / sizeof(u32),
...
int qed_dbg_idle_chk(struct ecore_dev *edev, void *buffer,
  ...
  return qed_dbg_feature(edev, buffer, DBG_FEATURE_IDLE_CHK, num_dumped_bytes);
}
...
int qed_dbg_reg_fifo(struct ecore_dev *edev, void *buffer,
                     u32 *num_dumped_bytes) {
  return qed_dbg_feature(edev, buffer, DBG_FEATURE_REG_FIFO, num_dumped_bytes);
}
...
int qed_dbg_igu_fifo(struct ecore_dev *edev, void *buffer,
                     u32 *num_dumped_bytes) {
  return qed_dbg_feature(edev, buffer, DBG_FEATURE_IGU_FIFO, num_dumped_bytes);
}
...
int qed_dbg_mcp_trace(struct ecore_dev *edev, void *buffer,
                      u32 *num_dumped_bytes) {
  return qed_dbg_feature(edev, buffer, DBG_FEATURE_MCP_TRACE, num_dumped_bytes);
}
...
int qed_dbg_all_data(struct ecore_dev *edev, void *buffer) {
  ...
  struct ecore_hwfn *p_hwfn = &edev->hwfns[edev->dbg_params.engine_for_debug];
  struct dbg_tools_data *dev_data = &p_hwfn->dbg_info;
  ...
  for (cur_engine = 0; cur_engine < edev->num_hwfns; cur_engine++) {
    ...
    /* First idle_chk */
    rc = qed_dbg_idle_chk(edev, (u8 *)buffer + offset + REGDUMP_HEADER_SIZE,
                          &feature_size);
    if (!rc) {
      *(u32 *)((u8 *)buffer + offset) = qed_calc_regdump_header(
          edev, IDLE_CHK, cur_engine, feature_size, omit_engine);
    ...
    /* reg_fifo dump */
    rc = qed_dbg_reg_fifo(edev, (u8 *)buffer + offset + REGDUMP_HEADER_SIZE,
                          &feature_size);
    if (!rc) {
      *(u32 *)((u8 *)buffer + offset) = qed_calc_regdump_header(
          edev, REG_FIFO, cur_engine, feature_size, omit_engine);
      offset += (feature_size + REGDUMP_HEADER_SIZE);
    } else {
    ...
    /* igu_fifo dump */
    rc = qed_dbg_igu_fifo(edev, (u8 *)buffer + offset + REGDUMP_HEADER_SIZE,
                          &feature_size);
    if (!rc) {
      *(u32 *)((u8 *)buffer + offset) = qed_calc_regdump_header(
          edev, IGU_FIFO, cur_engine, feature_size, omit_engine);
      offset += (feature_size + REGDUMP_HEADER_SIZE);
    } else {
    ...
    rc = qed_dbg_protection_override(
        edev, (u8 *)buffer + offset + REGDUMP_HEADER_SIZE, &feature_size);
    if (!rc) {
      *(u32 *)((u8 *)buffer + offset) = qed_calc_regdump_header(
          edev, PROTECTION_OVERRIDE, cur_engine, feature_size, omit_engine);
      offset += (feature_size + REGDUMP_HEADER_SIZE);
    } else {
      DP_ERR(edev, "qed_dbg_protection_override failed. rc = %d\n", rc);
    }

    /* fw_asserts dump */
    rc = qed_dbg_fw_asserts(edev, (u8 *)buffer + offset + REGDUMP_HEADER_SIZE,
                            &feature_size);
    if (!rc) {
      *(u32 *)((u8 *)buffer + offset) = qed_calc_regdump_header(
          edev, FW_ASSERTS, cur_engine, feature_size, omit_engine);
      offset += (feature_size + REGDUMP_HEADER_SIZE);
    } else {
    ...
    rc = qed_dbg_grc(edev, (u8 *)buffer + offset + REGDUMP_HEADER_SIZE,
                     &feature_size);
    if (!rc) {
      *(u32 *)((u8 *)buffer + offset) = qed_calc_regdump_header(
          edev, GRC_DUMP, cur_engine, feature_size, omit_engine);
      offset += (feature_size + REGDUMP_HEADER_SIZE);
    } else {
  ...
  /* mcp_trace */
  rc = qed_dbg_mcp_trace(edev, (u8 *)buffer + offset + REGDUMP_HEADER_SIZE,
                         &feature_size);
  if (!rc) {
    *(u32 *)((u8 *)buffer + offset) = qed_calc_regdump_header(
        edev, MCP_TRACE, cur_engine, feature_size, omit_engine);
    offset += (feature_size + REGDUMP_HEADER_SIZE);
  } else {
...
int qed_dbg_all_data_size(struct ecore_dev *edev) {
  ...
  for (cur_engine = 0; cur_engine < edev->num_hwfns; cur_engine++) {
    /* Engine specific */
    DP_VERBOSE(edev, ECORE_MSG_DEBUG,
               "calculating idle_chk and grcdump register length for current "
               "engine\n");
    qed_set_debug_engine(edev, cur_engine);
    regs_len += REGDUMP_HEADER_SIZE + qed_dbg_idle_chk_size(edev) +
                ...
                REGDUMP_HEADER_SIZE + qed_dbg_protection_override_size(edev) +
  ...
  qed_dbg_nvm_image_length(p_hwfn, ECORE_NVM_IMAGE_DEFAULT_CFG, &image_len);
  if (image_len)
    regs_len += REGDUMP_HEADER_SIZE + image_len;
...
int qed_dbg_feature(struct ecore_dev *edev, void *buffer,
  ...
  struct ecore_hwfn *p_hwfn = &edev->hwfns[edev->dbg_params.engine_for_debug];
  struct ecore_dbg_feature *qed_feature = &edev->dbg_params.features[feature];
  ...
  *num_dumped_bytes = edev->dbg_params.features[feature].dumped_dwords * 4;
...
int qed_dbg_feature_size(struct ecore_dev *edev,
                         enum ecore_dbg_features feature) {
  struct ecore_hwfn *p_hwfn = &edev->hwfns[edev->dbg_params.engine_for_debug];
