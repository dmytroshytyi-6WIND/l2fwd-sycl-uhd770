...
static inline __m128i descs_to_fdir_32b(volatile union i40e_rx_desc *rxdp,
 ...
 */
static inline __m128i descs_to_fdir_16b(__m128i fltstat, __m128i descs[4],
                                        struct rte_mbuf **rx_pkt) {
...
static inline void desc_to_olflags_v(struct i40e_rx_queue *rxq,
  ...
  if (rxq->fdir_enabled) {
    ...
    __m128i v_fdir_ol_flags = descs_to_fdir_16b(desc_fltstat, descs, rx_pkts);
#endif
