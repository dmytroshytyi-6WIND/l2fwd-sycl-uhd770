  ...
  do {                                                                         \
    ...
    if (ori_val != value)                                                      \
      PMD_DRV_LOG(WARNING,                                                     \
                  ...
                  "new: 0x%08x ",                                              \
                  (dev->device->name), (reg), (ori_val), (value));             \
  } while (0)
...
#define I40E_FLAG_ALL                                                          \
  (I40E_FLAG_RSS | I40E_FLAG_DCB | I40E_FLAG_VMDQ | I40E_FLAG_SRIOV |          \
   I40E_FLAG_HEADER_SPLIT_DISABLED | I40E_FLAG_HEADER_SPLIT_ENABLED |          \
   I40E_FLAG_FDIR | I40E_FLAG_VXLAN | I40E_FLAG_RSS_AQ_CAPABLE)

#define I40E_RSS_OFFLOAD_ALL                                                   \
  (RTE_ETH_RSS_FRAG_IPV4 | RTE_ETH_RSS_NONFRAG_IPV4_TCP |                      \
...
#define I40E_RSS_HENA_ALL_X722                                                 \
  ((1ULL << I40E_FILTER_PCTYPE_NONF_UNICAST_IPV4_UDP) |                        \
   ...
   (1ULL << I40E_FILTER_PCTYPE_NONF_IPV6_TCP_SYN_NO_ACK) | I40E_RSS_HENA_ALL)
...
struct i40e_fdir_flow_ext {
  ...
  struct i40e_fdir_flex_pit
      flex_pit[I40E_MAX_FLXPLD_LAYER * I40E_MAX_FLXPLD_FIED];
  bool is_flex_flow;
};
...
#define FLOW_TO_FLOW_BITMAP(f) container_of((f), struct i40e_fdir_entry, flow)
...
struct i40e_fdir_info {
   ...
   */
  struct i40e_fdir_flex_pit
      flex_set[I40E_MAX_FLXPLD_LAYER * I40E_MAX_FLXPLD_FIED];
...
/* I40E_DEV_PRIVATE_TO */
#define I40E_DEV_PRIVATE_TO_PF(adapter) (&((struct i40e_adapter *)adapter)->pf)
#define I40E_DEV_PRIVATE_TO_HW(adapter) (&((struct i40e_adapter *)adapter)->hw)
#define I40E_DEV_PRIVATE_TO_ADAPTER(adapter) ((struct i40e_adapter *)adapter)
...
/* I40E_VSI_TO */
#define I40E_VSI_TO_HW(vsi) (&(((struct i40e_vsi *)vsi)->adapter->hw))
#define I40E_VSI_TO_PF(vsi) (&(((struct i40e_vsi *)vsi)->adapter->pf))
#define I40E_VSI_TO_VF(vsi) (&(((struct i40e_vsi *)vsi)->adapter->vf))
...
/* I40E_PF_TO */
#define I40E_PF_TO_HW(pf) (&(((struct i40e_pf *)pf)->adapter->hw))
#define I40E_PF_TO_ADAPTER(pf) ((struct i40e_adapter *)pf->adapter)
