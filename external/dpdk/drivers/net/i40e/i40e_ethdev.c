...
#define I40E_PFINT_ICR0_ENA_MASK                                               \
  (I40E_PFINT_ICR0_ENA_ECC_ERR_MASK | I40E_PFINT_ICR0_ENA_MAL_DETECT_MASK |    \
   I40E_PFINT_ICR0_ENA_GRST_MASK | I40E_PFINT_ICR0_ENA_PCI_EXCEPTION_MASK |    \
   I40E_PFINT_ICR0_ENA_STORM_DETECT_MASK | I40E_PFINT_ICR0_ENA_HMC_ERR_MASK |  \
   I40E_PFINT_ICR0_ENA_PE_CRITERR_MASK | I40E_PFINT_ICR0_ENA_VFLR_MASK |       \
   I40E_PFINT_ICR0_ENA_ADMINQ_MASK)

#define I40E_FLOW_TYPES                                                        \
  ((1UL << RTE_ETH_FLOW_FRAG_IPV4) | (1UL << RTE_ETH_FLOW_NONFRAG_IPV4_TCP) |  \
   (1UL << RTE_ETH_FLOW_NONFRAG_IPV4_UDP) |                                    \
   (1UL << RTE_ETH_FLOW_NONFRAG_IPV4_SCTP) |                                   \
   (1UL << RTE_ETH_FLOW_NONFRAG_IPV4_OTHER) |                                  \
   (1UL << RTE_ETH_FLOW_FRAG_IPV6) | (1UL << RTE_ETH_FLOW_NONFRAG_IPV6_TCP) |  \
...
#define I40E_GLQF_PIT_SOURCE_OFF_GET(a)                                        \
  (((a)&I40E_GLQF_PIT_SOURCE_OFF_MASK) >> I40E_GLQF_PIT_SOURCE_OFF_SHIFT)

#define I40E_GLQF_PIT_DEST_OFF_GET(a)                                          \
  (((a)&I40E_GLQF_PIT_DEST_OFF_MASK) >> I40E_GLQF_PIT_DEST_OFF_SHIFT)

#define I40E_GLQF_PIT_FSIZE_GET(a)                                             \
  (((a)&I40E_GLQF_PIT_FSIZE_MASK) >> I40E_GLQF_PIT_FSIZE_SHIFT)
...
static int i40e_fw_version_get(struct rte_eth_dev *dev, char *fw_version,
                               size_t fw_size);
static int i40e_dev_info_get(struct rte_eth_dev *dev,
                             struct rte_eth_dev_info *dev_info);
static int i40e_vlan_filter_set(struct rte_eth_dev *dev, uint16_t vlan_id,
                                int on);
...
static void i40e_vlan_strip_queue_set(struct rte_eth_dev *dev, uint16_t queue,
                                      int on);
...
static void i40e_stat_update_32(struct i40e_hw *hw, uint32_t reg,
                                ...
                                uint64_t *stat);
static void i40e_stat_update_48(struct i40e_hw *hw, uint32_t hireg,
...
static int i40e_res_pool_init(struct i40e_res_pool_info *pool, uint32_t base,
                              uint32_t num);
...
static int
i40e_tunnel_filter_convert(struct i40e_aqc_cloud_filters_element_bb *cld_filter,
...
static const char *const valid_keys[] = {
    ETH_I40E_FLOATING_VEB_ARG,     ETH_I40E_FLOATING_VEB_LIST_ARG,
    ETH_I40E_SUPPORT_MULTI_DRIVER, ETH_I40E_QUEUE_NUM_PER_VF_ARG,
    ETH_I40E_VF_MSG_CFG,           NULL};
...
static const struct rte_i40e_xstats_name_off rte_i40e_stats_strings[] = {
    ...
    {"rx_unknown_protocol_packets",
     offsetof(struct i40e_eth_stats, rx_unknown_protocol)},
    {"rx_size_error_packets",
     offsetof(struct i40e_pf, rx_err1) - offsetof(struct i40e_pf, stats)},
...
#define I40E_NB_ETH_XSTATS                                                     \
  (sizeof(rte_i40e_stats_strings) / sizeof(rte_i40e_stats_strings[0]))

static const struct rte_i40e_xstats_name_off rte_i40e_hw_port_strings[] = {
    {"tx_link_down_dropped",
     offsetof(struct i40e_hw_port_stats, tx_dropped_link_down)},
    {"rx_crc_errors", offsetof(struct i40e_hw_port_stats, crc_errors)},
    {"rx_illegal_byte_errors",
     offsetof(struct i40e_hw_port_stats, illegal_bytes)},
    {"rx_error_bytes", offsetof(struct i40e_hw_port_stats, error_bytes)},
    {"mac_local_errors", offsetof(struct i40e_hw_port_stats, mac_local_faults)},
    {"mac_remote_errors",
     offsetof(struct i40e_hw_port_stats, mac_remote_faults)},
    {"rx_length_errors", offsetof(struct i40e_hw_port_stats, rx_length_errors)},
    ...
    {"rx_size_65_to_127_packets",
     offsetof(struct i40e_hw_port_stats, rx_size_127)},
    {"rx_size_128_to_255_packets",
     offsetof(struct i40e_hw_port_stats, rx_size_255)},
    {"rx_size_256_to_511_packets",
     offsetof(struct i40e_hw_port_stats, rx_size_511)},
    {"rx_size_512_to_1023_packets",
     offsetof(struct i40e_hw_port_stats, rx_size_1023)},
    {"rx_size_1024_to_1522_packets",
     offsetof(struct i40e_hw_port_stats, rx_size_1522)},
    {"rx_size_1523_to_max_packets",
     offsetof(struct i40e_hw_port_stats, rx_size_big)},
    {"rx_undersized_errors", offsetof(struct i40e_hw_port_stats, rx_undersize)},
    {"rx_oversize_errors", offsetof(struct i40e_hw_port_stats, rx_oversize)},
    {"rx_mac_short_dropped",
     offsetof(struct i40e_hw_port_stats, mac_short_packet_dropped)},
    {"rx_fragmented_errors", offsetof(struct i40e_hw_port_stats, rx_fragments)},
    ...
    {"tx_size_65_to_127_packets",
     offsetof(struct i40e_hw_port_stats, tx_size_127)},
    {"tx_size_128_to_255_packets",
     offsetof(struct i40e_hw_port_stats, tx_size_255)},
    {"tx_size_256_to_511_packets",
     offsetof(struct i40e_hw_port_stats, tx_size_511)},
    {"tx_size_512_to_1023_packets",
     offsetof(struct i40e_hw_port_stats, tx_size_1023)},
    {"tx_size_1024_to_1522_packets",
     offsetof(struct i40e_hw_port_stats, tx_size_1522)},
    {"tx_size_1523_to_max_packets",
     offsetof(struct i40e_hw_port_stats, tx_size_big)},
    ...
    {"tx_low_power_idle_status",
     offsetof(struct i40e_hw_port_stats, tx_lpi_status)},
    {"rx_low_power_idle_status",
     offsetof(struct i40e_hw_port_stats, rx_lpi_status)},
    {"tx_low_power_idle_count",
     offsetof(struct i40e_hw_port_stats, tx_lpi_count)},
    {"rx_low_power_idle_count",
     offsetof(struct i40e_hw_port_stats, rx_lpi_count)},
};

#define I40E_NB_HW_PORT_XSTATS                                                 \
  (sizeof(rte_i40e_hw_port_strings) / sizeof(rte_i40e_hw_port_strings[0]))

static const struct rte_i40e_xstats_name_off rte_i40e_rxq_prio_strings[] = {
    {"xon_packets", offsetof(struct i40e_hw_port_stats, priority_xon_rx)},
    {"xoff_packets", offsetof(struct i40e_hw_port_stats, priority_xoff_rx)},
};

#define I40E_NB_RXQ_PRIO_XSTATS                                                \
  (sizeof(rte_i40e_rxq_prio_strings) / sizeof(rte_i40e_rxq_prio_strings[0]))

static const struct rte_i40e_xstats_name_off rte_i40e_txq_prio_strings[] = {
    {"xon_packets", offsetof(struct i40e_hw_port_stats, priority_xon_tx)},
    {"xoff_packets", offsetof(struct i40e_hw_port_stats, priority_xoff_tx)},
    {"xon_to_xoff_packets",
     offsetof(struct i40e_hw_port_stats, priority_xon_2_xoff)},
};

#define I40E_NB_TXQ_PRIO_XSTATS                                                \
  (sizeof(rte_i40e_txq_prio_strings) / sizeof(rte_i40e_txq_prio_strings[0]))
...
static int eth_i40e_pci_probe(struct rte_pci_driver *pci_drv __rte_unused,
  ...
  retval = rte_eth_dev_create(
      &pci_dev->device, pci_dev->device.name, sizeof(struct i40e_adapter),
      eth_dev_pci_specific_init, pci_dev, eth_i40e_dev_init, NULL);

  if (retval || eth_da.nb_representor_ports < 1)
    return retval;

  /* probe VF representor ports */
  struct rte_eth_dev *pf_ethdev = rte_eth_dev_allocated(pci_dev->device.name);
  ...
  for (i = 0; i < eth_da.nb_representor_ports; i++) {
    struct i40e_vf_representor representor = {
        ...
        .switch_domain_id = I40E_DEV_PRIVATE_TO_PF(pf_ethdev->data->dev_private)
                                ->switch_domain_id,
        .adapter = I40E_DEV_PRIVATE_TO_ADAPTER(pf_ethdev->data->dev_private)};
...
static int eth_i40e_pci_remove(struct rte_pci_device *pci_dev) {
  ...
  if (ethdev->data->dev_flags & RTE_ETH_DEV_REPRESENTOR)
    return rte_eth_dev_pci_generic_remove(pci_dev, i40e_vf_representor_uninit);
  else
...
static inline void i40e_write_global_rx_ctl(struct i40e_hw *hw,
                                            uint32_t reg_addr,
                                            uint32_t reg_val) {
 ...
 * from VSIs.
 */
static void i40e_add_tx_flow_control_drop_filter(struct i40e_pf *pf) {
  struct i40e_hw *hw = I40E_PF_TO_HW(pf);
  ...
  ret = i40e_aq_add_rem_control_packet_filter(
      hw, NULL, I40E_FLOW_CONTROL_ETHERTYPE, flags, pf->main_vsi_seid, 0, TRUE,
      NULL, NULL);
  if (ret)
    PMD_INIT_LOG(ERR,
...
static int floating_veb_list_handler(__rte_unused const char *key,
...
static void config_vf_floating_veb(struct rte_devargs *devargs,
   ...
   */
  if (rte_kvargs_process(kvlist, floating_veb_list, floating_veb_list_handler,
                         vf_floating_veb) < 0) {
    rte_kvargs_free(kvlist);
    return;
  }
...
static int is_floating_veb_supported(struct rte_devargs *devargs) {
  struct rte_kvargs *kvlist;
   ...
   */
  if (rte_kvargs_process(kvlist, floating_veb_key, i40e_check_floating_handler,
                         NULL) < 0) {
    rte_kvargs_free(kvlist);
    return 0;
  }
...
static void config_floating_veb(struct rte_eth_dev *dev) {
  ...
  if (hw->aq.fw_maj_ver >= FLOATING_VEB_SUPPORTED_FW_MAJ) {
    pf->floating_veb = is_floating_veb_supported(pci_dev->device.devargs);
    config_vf_floating_veb(pci_dev->device.devargs, pf->floating_veb,
...
static int i40e_init_ethtype_filter_list(struct rte_eth_dev *dev) {
  struct i40e_pf *pf = I40E_DEV_PRIVATE_TO_PF(dev->data->dev_private);
  ...
  snprintf(ethertype_hash_name, RTE_HASH_NAMESIZE, "ethertype_%s",
           dev->device->name);
  ...
  ethertype_rule->hash_map = rte_zmalloc(
      "i40e_ethertype_hash_map",
      sizeof(struct i40e_ethertype_filter *) * I40E_MAX_ETHERTYPE_FILTER_NUM,
      0);
  if (!ethertype_rule->hash_map) {
    PMD_INIT_LOG(ERR, "Failed to allocate memory for ethertype hash map!");
    ret = -ENOMEM;
...
static int i40e_init_tunnel_filter_list(struct rte_eth_dev *dev) {
  struct i40e_pf *pf = I40E_DEV_PRIVATE_TO_PF(dev->data->dev_private);
  ...
  snprintf(tunnel_hash_name, RTE_HASH_NAMESIZE, "tunnel_%s", dev->device->name);
  tunnel_rule->hash_table = rte_hash_create(&tunnel_hash_params);
  if (!tunnel_rule->hash_table) {
    PMD_INIT_LOG(ERR, "Failed to create tunnel hash table!");
    return -EINVAL;
  }
  tunnel_rule->hash_map = rte_zmalloc(
      "i40e_tunnel_hash_map",
      sizeof(struct i40e_tunnel_filter *) * I40E_MAX_TUNNEL_FILTER_NUM, 0);
  if (!tunnel_rule->hash_map) {
    PMD_INIT_LOG(ERR, "Failed to allocate memory for tunnel hash map!");
    ret = -ENOMEM;
...
static int i40e_init_fdir_filter_list(struct rte_eth_dev *dev) {
  struct i40e_pf *pf = I40E_DEV_PRIVATE_TO_PF(dev->data->dev_private);
  struct i40e_hw *hw = I40E_PF_TO_HW(pf);
  ...
  snprintf(fdir_hash_name, RTE_HASH_NAMESIZE, "fdir_%s", dev->device->name);
  ...
  fdir_info->hash_map = rte_zmalloc(
      "i40e_fdir_hash_map",
      sizeof(struct i40e_fdir_filter *) * I40E_MAX_FDIR_FILTER_NUM, 0);
  ...
  fdir_info->fdir_filter_array = rte_zmalloc(
      "fdir_filter", sizeof(struct i40e_fdir_filter) * I40E_MAX_FDIR_FILTER_NUM,
      0);

  if (!fdir_info->fdir_filter_array) {
    PMD_INIT_LOG(ERR, "Failed to allocate memory for fdir filter array!");
    ret = -ENOMEM;
  ...
  fdir_info->fdir_guarantee_free_space = fdir_info->fdir_guarantee_total_space;

  PMD_DRV_LOG(INFO, "FDIR guarantee space: %u, best_effort space %u.", alloc,
              best);

  fdir_info->fdir_flow_pool.pool = rte_zmalloc(
      "i40e_fdir_entry",
      sizeof(struct i40e_fdir_entry) * fdir_info->fdir_space_size, 0);

  if (!fdir_info->fdir_flow_pool.pool) {
    PMD_INIT_LOG(ERR, "Failed to allocate memory for bitmap flow!");
    ret = -ENOMEM;
  ...
  if (mem == NULL) {
    PMD_INIT_LOG(ERR, "Failed to allocate memory for fdir bitmap!");
    ret = -ENOMEM;
    goto err_fdir_mem_alloc;
  }
  bmp = rte_bitmap_init(fdir_info->fdir_space_size, mem, bmp_size);
  if (bmp == NULL) {
    PMD_INIT_LOG(ERR, "Failed to initialization fdir bitmap!");
    ret = -ENOMEM;
...
static void i40e_init_customized_info(struct i40e_pf *pf) {
  int i;
...
static void i40e_init_filter_invalidation(struct i40e_pf *pf) {
  struct i40e_hw *hw = I40E_PF_TO_HW(pf);
  struct i40e_fdir_info *fdir_info = &pf->fdir;
...
static int i40e_parse_multi_drv_handler(__rte_unused const char *key,
  ...
  if (support_multi_driver == 1 || support_multi_driver == 0)
    ...
    PMD_DRV_LOG(WARNING, "%s must be 1 or 0,",
                "enable global configuration by "
                "default." ETH_I40E_SUPPORT_MULTI_DRIVER);
  return 0;
}

static int i40e_support_multi_driver(struct rte_eth_dev *dev) {
  struct i40e_pf *pf = I40E_DEV_PRIVATE_TO_PF(dev->data->dev_private);
  struct rte_kvargs *kvlist;
  int kvargs_count;
...
static int
i40e_aq_debug_write_global_register(struct i40e_hw *hw, uint32_t reg_addr,
                                    uint64_t reg_val,
  ...
  if (ret != I40E_SUCCESS) {
    PMD_DRV_LOG(ERR, "Fail to debug read from 0x%08x", reg_addr);
    return -EIO;
  }
...
static int read_vf_msg_config(__rte_unused const char *key, const char *value,
                              void *opaque) {
...
static int i40e_parse_vf_msg_config(struct rte_eth_dev *dev,
  ...
  if (kvargs_count > 1) {
    PMD_DRV_LOG(ERR, "More than one argument \"%s\"!", ETH_I40E_VF_MSG_CFG);
    ret = -EINVAL;
    goto free_end;
  }

  if (rte_kvargs_process(kvlist, ETH_I40E_VF_MSG_CFG, read_vf_msg_config,
                         msg_cfg) < 0)
    ret = -EINVAL;
...
static int eth_i40e_dev_init(struct rte_eth_dev *dev,
  ...
  PMD_INIT_LOG(INFO, "FW %d.%d API %d.%d NVM %02d.%02d.%02d eetrack %04x",
               hw->aq.fw_maj_ver, hw->aq.fw_min_ver, hw->aq.api_maj_ver,
               hw->aq.api_min_ver, ((hw->nvm.version >> 12) & 0xf),
               ((hw->nvm.version >> 4) & 0xff), (hw->nvm.version & 0xf),
               hw->nvm.eetrack);
  ...
  if (!pf->support_multi_driver) {
    ret = i40e_aq_debug_write_global_register(hw, I40E_GLQF_L3_MAP(40),
                                              0x00000028, NULL);
    if (ret)
      PMD_INIT_LOG(ERR, "Failed to write L3 MAP register %d", ret);
    PMD_INIT_LOG(DEBUG, "Global register 0x%08x is changed with 0x28",
                 I40E_GLQF_L3_MAP(40));
  }
  ...
  ret =
      i40e_res_pool_init(&pf->msix_pool, 1, hw->func_caps.num_msix_vectors - 1);
  if (ret < 0) {
  ...
  /* Initialize lan hmc */
  ret = i40e_init_lan_hmc(hw, hw->func_caps.num_tx_qp, hw->func_caps.num_rx_qp,
                          0, 0);
  if (ret != I40E_SUCCESS) {
  ...
  if (!pf->support_multi_driver) {
    ret = i40e_vlan_tpid_set(dev, RTE_ETH_VLAN_TYPE_OUTER, RTE_ETHER_TYPE_VLAN);
    if (ret != I40E_SUCCESS) {
  ...
  rte_intr_callback_register(intr_handle, i40e_dev_interrupt_handler, dev);
...
err_init_ethtype_filter_list:
  rte_intr_callback_unregister(intr_handle, i40e_dev_interrupt_handler, dev);
...
static void i40e_rm_ethtype_filter_list(struct i40e_pf *pf) {
  ...
  while ((p_ethertype = TAILQ_FIRST(&ethertype_rule->ethertype_list))) {
    TAILQ_REMOVE(&ethertype_rule->ethertype_list, p_ethertype, rules);
    rte_free(p_ethertype);
  }
}

static void i40e_rm_tunnel_filter_list(struct i40e_pf *pf) {
...
static void i40e_rm_fdir_filter_list(struct i40e_pf *pf) {
...
static void i40e_fdir_memory_cleanup(struct i40e_pf *pf) {
  struct i40e_fdir_info *fdir_info;
...
static int eth_i40e_dev_uninit(struct rte_eth_dev *dev) {
  struct i40e_hw *hw;
...
void i40e_vsi_queues_unbind_intr(struct i40e_vsi *vsi) {
  ...
  if (vsi->type != I40E_VSI_SRIOV) {
    if (!rte_intr_allow_others(intr_handle)) {
      ...
      I40E_WRITE_REG(hw, I40E_PFINT_ITR0(I40E_ITR_INDEX_DEFAULT), 0);
    } else {
      I40E_WRITE_REG(hw, I40E_PFINT_LNKLSTN(msix_vect - 1),
                     I40E_PFINT_LNKLSTN_FIRSTQ_INDX_MASK);
      I40E_WRITE_REG(hw, I40E_PFINT_ITRN(I40E_ITR_INDEX_DEFAULT, msix_vect - 1),
                     0);
    }
  } else {
    uint32_t reg;
    reg = (hw->func_caps.num_msix_vectors_vf - 1) * vsi->user_param +
          (msix_vect - 1);
...
static void __vsi_queues_bind_intr(struct i40e_vsi *vsi, uint16_t msix_vect,
  ...
  if (vsi->type != I40E_VSI_SRIOV) {
    uint16_t interval = i40e_calc_itr_interval(1, pf->support_multi_driver);

    if (msix_vect == I40E_MISC_VEC_ID) {
      I40E_WRITE_REG(hw, I40E_PFINT_LNKLST0,
                     (base_queue << I40E_PFINT_LNKLST0_FIRSTQ_INDX_SHIFT) |
                         (0x0 << I40E_PFINT_LNKLST0_FIRSTQ_TYPE_SHIFT));
      I40E_WRITE_REG(hw, I40E_PFINT_ITR0(I40E_ITR_INDEX_DEFAULT), interval);
    } else {
      I40E_WRITE_REG(hw, I40E_PFINT_LNKLSTN(msix_vect - 1),
                     (base_queue << I40E_PFINT_LNKLSTN_FIRSTQ_INDX_SHIFT) |
    ...
    if (msix_vect == I40E_MISC_VEC_ID) {
      I40E_WRITE_REG(hw, I40E_VPINT_LNKLST0(vsi->user_param),
                     (base_queue << I40E_VPINT_LNKLST0_FIRSTQ_INDX_SHIFT) |
                         (0x0 << I40E_VPINT_LNKLST0_FIRSTQ_TYPE_SHIFT));
    } else {
      ...
      I40E_WRITE_REG(hw, I40E_VPINT_LNKLSTN(reg),
                     (base_queue << I40E_VPINT_LNKLSTN_FIRSTQ_INDX_SHIFT) |
...
int i40e_vsi_queues_bind_intr(struct i40e_vsi *vsi, uint16_t itr_idx) {
  ...
  if (vsi->type == I40E_VSI_SRIOV) {
    ...
    __vsi_queues_bind_intr(vsi, msix_vect, vsi->base_queue, vsi->nb_qps,
                           itr_idx);
    return 0;
  }
  ...
  if (rte_intr_dp_is_en(intr_handle)) {
    if (vsi->type == I40E_VSI_MAIN) {
      ...
      struct i40e_vsi *main_vsi = I40E_DEV_PRIVATE_TO_MAIN_VSI(vsi->adapter);
  ...
  for (i = 0; i < vsi->nb_used_qps; i++) {
    if (vsi->nb_msix == 0) {
      ...
      __vsi_queues_bind_intr(vsi, msix_vect, vsi->base_queue + i,
                             vsi->nb_used_qps - i, itr_idx);
      for (; !!record && i < vsi->nb_used_qps; i++)
        rte_intr_vec_list_index_set(intr_handle, queue_idx + i, msix_vect);
      break;
    }
    /* 1:1 queue/msix_vect mapping */
    __vsi_queues_bind_intr(vsi, msix_vect, vsi->base_queue + i, 1, itr_idx);
    if (!!record)
      if (rte_intr_vec_list_index_set(intr_handle, queue_idx + i, msix_vect))
        return -rte_errno;
...
void i40e_vsi_disable_queues_intr(struct i40e_vsi *vsi) {
  ...
  if (rte_intr_allow_others(intr_handle) && !pf->support_multi_driver)
    ...
    I40E_WRITE_REG(hw, I40E_PFINT_DYN_CTL0, I40E_PFINT_DYN_CTL0_ITR_INDX_MASK);

  I40E_WRITE_FLUSH(hw);
}

static inline uint8_t i40e_parse_link_speeds(uint16_t link_speeds) {
...
static int i40e_phy_conf_link(struct i40e_hw *hw, uint8_t abilities,
                              uint8_t force_speed, bool is_up) {
  ...
  const uint8_t mask = I40E_AQ_PHY_FLAG_PAUSE_TX | I40E_AQ_PHY_FLAG_PAUSE_RX |
                       I40E_AQ_PHY_FLAG_PAUSE_RX | I40E_AQ_PHY_FLAG_LOW_POWER;
  int ret = -ENOTSUP;

  /* To get phy capabilities of available speeds. */
  status = i40e_aq_get_phy_capabilities(hw, false, true, &phy_ab, NULL);
  if (status) {
  ...
  status = i40e_aq_get_phy_capabilities(hw, false, false, &phy_ab, NULL);
  if (status) {
   ...
   */
  if (is_up && phy_ab.phy_type != 0 && abilities & I40E_AQ_PHY_AN_ENABLED &&
      phy_ab.link_speed != 0)
    return I40E_SUCCESS;
  ...
  phy_conf.phy_type_ext =
      is_up ? (I40E_AQ_PHY_TYPE_EXT_25G_KR | I40E_AQ_PHY_TYPE_EXT_25G_CR |
               I40E_AQ_PHY_TYPE_EXT_25G_SR | I40E_AQ_PHY_TYPE_EXT_25G_LR |
               I40E_AQ_PHY_TYPE_EXT_25G_AOC | I40E_AQ_PHY_TYPE_EXT_25G_ACC)
            : 0;
  ...
  PMD_DRV_LOG(DEBUG, "\tCurrent: abilities %x, link_speed %x", phy_ab.abilities,
              phy_ab.link_speed);
...
static int i40e_apply_link_speed(struct rte_eth_dev *dev) {
  uint8_t speed;
  uint8_t abilities = 0;
  struct i40e_hw *hw = I40E_DEV_PRIVATE_TO_HW(dev->data->dev_private);
  struct rte_eth_conf *conf = &dev->data->dev_conf;

  abilities |= I40E_AQ_PHY_ENABLE_ATOMIC_LINK | I40E_AQ_PHY_LINK_ENABLED;

  if (conf->link_speeds == RTE_ETH_LINK_SPEED_AUTONEG) {
    conf->link_speeds = RTE_ETH_LINK_SPEED_40G | RTE_ETH_LINK_SPEED_25G |
...
static int i40e_dev_start(struct rte_eth_dev *dev) {
  ...
  for (i = 0; i < pf->nb_cfg_vmdq_vsi; i++) {
    ...
    ret = i40e_vsi_queues_bind_intr(pf->vmdq[i].vsi, I40E_ITR_INDEX_DEFAULT);
    if (ret < 0)
      return ret;
  ...
  for (i = 0; i < pf->nb_cfg_vmdq_vsi; i++) {
    ret = i40e_aq_set_vsi_broadcast(hw, pf->vmdq[i].vsi->seid, true, NULL);
    if (ret != I40E_SUCCESS)
      PMD_DRV_LOG(INFO, "fail to set vsi broadcast");
  }
  ...
  if (dev->data->dev_conf.intr_conf.rxq == 0) {
    rte_eal_alarm_set(I40E_ALARM_INTERVAL, i40e_dev_alarm_handler, dev);
  } else {
    /* enable uio intr after callback register */
    rte_intr_enable(intr_handle);
  }
...
static int i40e_dev_stop(struct rte_eth_dev *dev) {
  ...
  if (!rte_intr_allow_others(intr_handle))
    ...
    rte_intr_callback_register(intr_handle, i40e_dev_interrupt_handler,
                               (void *)dev);
...
static int i40e_dev_close(struct rte_eth_dev *dev) {
  ...
  I40E_WRITE_REG(hw, I40E_PFGEN_CTRL, (reg | I40E_PFGEN_CTRL_PFSWR_MASK));
  I40E_WRITE_FLUSH(hw);
  ...
  do {
    ret = rte_intr_callback_unregister(intr_handle, i40e_dev_interrupt_handler,
                                       dev);
    if (ret >= 0 || ret == -ENOENT) {
      break;
    } else if (ret != -EAGAIN) {
...
static int i40e_dev_promiscuous_enable(struct rte_eth_dev *dev) {
  ...
  status = i40e_aq_set_vsi_unicast_promiscuous(hw, vsi->seid, true, NULL, true);
  if (status != I40E_SUCCESS) {
    PMD_DRV_LOG(ERR, "Failed to enable unicast promiscuous");
    return -EAGAIN;
  }

  status = i40e_aq_set_vsi_multicast_promiscuous(hw, vsi->seid, TRUE, NULL);
  if (status != I40E_SUCCESS) {
    PMD_DRV_LOG(ERR, "Failed to enable multicast promiscuous");
    /* Rollback unicast promiscuous mode */
    i40e_aq_set_vsi_unicast_promiscuous(hw, vsi->seid, false, NULL, true);
    return -EAGAIN;
  }
...
static int i40e_dev_promiscuous_disable(struct rte_eth_dev *dev) {
  ...
  status = i40e_aq_set_vsi_multicast_promiscuous(hw, vsi->seid, false, NULL);
  if (status != I40E_SUCCESS) {
    PMD_DRV_LOG(ERR, "Failed to disable multicast promiscuous");
    /* Rollback unicast promiscuous mode */
    i40e_aq_set_vsi_unicast_promiscuous(hw, vsi->seid, true, NULL, true);
    return -EAGAIN;
  }
...
static int i40e_dev_allmulticast_disable(struct rte_eth_dev *dev) {
  ...
  ret = i40e_aq_set_vsi_multicast_promiscuous(hw, vsi->seid, FALSE, NULL);
  if (ret != I40E_SUCCESS) {
    PMD_DRV_LOG(ERR, "Failed to disable multicast promiscuous");
    return -EAGAIN;
  }
...
static __rte_always_inline void update_link_reg(struct i40e_hw *hw,
...
static __rte_always_inline void update_link_aq(struct i40e_hw *hw,
                                               struct rte_eth_link *link,
                                               bool enable_lse,
...
static void i40e_stat_update_48_in_64(struct i40e_hw *hw, uint32_t hireg,
                                      uint32_t loreg, bool offset_loaded,
                                      uint64_t *offset, uint64_t *stat,
                                      uint64_t *prev_stat) {
...
void i40e_update_vsi_stats(struct i40e_vsi *vsi) {
  ...
  i40e_stat_update_48_in_64(hw, I40E_GLV_GORCH(idx), I40E_GLV_GORCL(idx),
                            vsi->offset_loaded, &oes->rx_bytes, &nes->rx_bytes,
                            &vsi->prev_rx_bytes);
  i40e_stat_update_48(hw, I40E_GLV_UPRCH(idx), I40E_GLV_UPRCL(idx),
                      vsi->offset_loaded, &oes->rx_unicast, &nes->rx_unicast);
  ...
  i40e_stat_update_48_in_64(hw, I40E_GLV_GOTCH(idx), I40E_GLV_GOTCL(idx),
                            vsi->offset_loaded, &oes->tx_bytes, &nes->tx_bytes,
                            &vsi->prev_tx_bytes);
  i40e_stat_update_48(hw, I40E_GLV_UPTCH(idx), I40E_GLV_UPTCL(idx),
                      vsi->offset_loaded, &oes->tx_unicast, &nes->tx_unicast);
...
static void i40e_read_stats_registers(struct i40e_pf *pf, struct i40e_hw *hw) {
  ...
  i40e_stat_update_48_in_64(
      hw, I40E_GLV_GORCH(hw->port), I40E_GLV_GORCL(hw->port), pf->offset_loaded,
      &pf->internal_stats_offset.rx_bytes, &pf->internal_stats.rx_bytes,
      &pf->internal_prev_rx_bytes);
  i40e_stat_update_48_in_64(
      hw, I40E_GLV_GOTCH(hw->port), I40E_GLV_GOTCL(hw->port), pf->offset_loaded,
      &pf->internal_stats_offset.tx_bytes, &pf->internal_stats.tx_bytes,
      &pf->internal_prev_tx_bytes);
  /* Get total internal rx packet count */
  i40e_stat_update_48(hw, I40E_GLV_UPRCH(hw->port), I40E_GLV_UPRCL(hw->port),
                      pf->offset_loaded, &pf->internal_stats_offset.rx_unicast,
                      &pf->internal_stats.rx_unicast);
  i40e_stat_update_48(hw, I40E_GLV_MPRCH(hw->port), I40E_GLV_MPRCL(hw->port),
                      pf->offset_loaded,
                      &pf->internal_stats_offset.rx_multicast,
                      &pf->internal_stats.rx_multicast);
  i40e_stat_update_48(hw, I40E_GLV_BPRCH(hw->port), I40E_GLV_BPRCL(hw->port),
                      pf->offset_loaded,
                      &pf->internal_stats_offset.rx_broadcast,
                      &pf->internal_stats.rx_broadcast);
  /* Get total internal tx packet count */
  i40e_stat_update_48(hw, I40E_GLV_UPTCH(hw->port), I40E_GLV_UPTCL(hw->port),
                      pf->offset_loaded, &pf->internal_stats_offset.tx_unicast,
                      &pf->internal_stats.tx_unicast);
  i40e_stat_update_48(hw, I40E_GLV_MPTCH(hw->port), I40E_GLV_MPTCL(hw->port),
                      pf->offset_loaded,
                      &pf->internal_stats_offset.tx_multicast,
                      &pf->internal_stats.tx_multicast);
  i40e_stat_update_48(hw, I40E_GLV_BPTCH(hw->port), I40E_GLV_BPTCL(hw->port),
                      pf->offset_loaded,
  ...
  i40e_stat_update_32(hw, I40E_GLPRT_TDOLD(hw->port), pf->offset_loaded,
                      &os->tx_dropped_link_down, &ns->tx_dropped_link_down);
  i40e_stat_update_32(hw, I40E_GLPRT_CRCERRS(hw->port), pf->offset_loaded,
                      &os->crc_errors, &ns->crc_errors);
  i40e_stat_update_32(hw, I40E_GLPRT_ILLERRC(hw->port), pf->offset_loaded,
                      &os->illegal_bytes, &ns->illegal_bytes);
  /* GLPRT_ERRBC not supported */
  i40e_stat_update_32(hw, I40E_GLPRT_MLFC(hw->port), pf->offset_loaded,
                      &os->mac_local_faults, &ns->mac_local_faults);
  i40e_stat_update_32(hw, I40E_GLPRT_MRFC(hw->port), pf->offset_loaded,
                      &os->mac_remote_faults, &ns->mac_remote_faults);
  i40e_stat_update_32(hw, I40E_GLPRT_RLEC(hw->port), pf->offset_loaded,
                      &os->rx_length_errors, &ns->rx_length_errors);
  i40e_stat_update_32(hw, I40E_GLPRT_LXONRXC(hw->port), pf->offset_loaded,
                      &os->link_xon_rx, &ns->link_xon_rx);
  i40e_stat_update_32(hw, I40E_GLPRT_LXOFFRXC(hw->port), pf->offset_loaded,
                      &os->link_xoff_rx, &ns->link_xoff_rx);
  for (i = 0; i < 8; i++) {
    i40e_stat_update_32(hw, I40E_GLPRT_PXONRXC(hw->port, i), pf->offset_loaded,
                        &os->priority_xon_rx[i], &ns->priority_xon_rx[i]);
    i40e_stat_update_32(hw, I40E_GLPRT_PXOFFRXC(hw->port, i), pf->offset_loaded,
                        &os->priority_xoff_rx[i], &ns->priority_xoff_rx[i]);
  }
  i40e_stat_update_32(hw, I40E_GLPRT_LXONTXC(hw->port), pf->offset_loaded,
                      &os->link_xon_tx, &ns->link_xon_tx);
  i40e_stat_update_32(hw, I40E_GLPRT_LXOFFTXC(hw->port), pf->offset_loaded,
                      &os->link_xoff_tx, &ns->link_xoff_tx);
  for (i = 0; i < 8; i++) {
    i40e_stat_update_32(hw, I40E_GLPRT_PXONTXC(hw->port, i), pf->offset_loaded,
                        &os->priority_xon_tx[i], &ns->priority_xon_tx[i]);
    i40e_stat_update_32(hw, I40E_GLPRT_PXOFFTXC(hw->port, i), pf->offset_loaded,
                        &os->priority_xoff_tx[i], &ns->priority_xoff_tx[i]);
...
static int i40e_dev_stats_get(struct rte_eth_dev *dev,
  ...
  stats->ipackets = pf->main_vsi->eth_stats.rx_unicast +
                    ...
                    pf->main_vsi->eth_stats.rx_discards - pf->rx_err1;
  stats->opackets =
      ns->eth.tx_unicast + ns->eth.tx_multicast + ns->eth.tx_broadcast;
  ...
  stats->ierrors = ns->crc_errors + ns->rx_length_errors + ns->rx_undersize +
  ...
  if (pf->vfs) {
    for (i = 0; i < pf->vf_num; i++) {
      ...
      stats->ipackets +=
          (vsi->eth_stats.rx_unicast + vsi->eth_stats.rx_multicast +
           vsi->eth_stats.rx_broadcast - vsi->eth_stats.rx_discards);
  ...
  for (i = 0; i < 8; i++) {
    PMD_DRV_LOG(DEBUG, "priority_xon_rx[%d]:      %" PRIu64 "", i,
                ns->priority_xon_rx[i]);
    PMD_DRV_LOG(DEBUG, "priority_xoff_rx[%d]:     %" PRIu64 "", i,
  ...
  for (i = 0; i < 8; i++) {
    PMD_DRV_LOG(DEBUG, "priority_xon_tx[%d]:      %" PRIu64 "", i,
                ns->priority_xon_tx[i]);
    PMD_DRV_LOG(DEBUG, "priority_xoff_tx[%d]:     %" PRIu64 "", i,
                ns->priority_xoff_tx[i]);
    PMD_DRV_LOG(DEBUG, "priority_xon_2_xoff[%d]:  %" PRIu64 "", i,
                ns->priority_xon_2_xoff[i]);
  }
...
static uint32_t i40e_xstats_calc_num(void) {
  return I40E_NB_ETH_XSTATS + I40E_NB_HW_PORT_XSTATS +
         (I40E_NB_RXQ_PRIO_XSTATS * 8) + (I40E_NB_TXQ_PRIO_XSTATS * 8);
}
...
static int i40e_dev_xstats_get_names(__rte_unused struct rte_eth_dev *dev,
  ...
  for (i = 0; i < I40E_NB_ETH_XSTATS; i++) {
    strlcpy(xstats_names[count].name, rte_i40e_stats_strings[i].name,
  ...
  for (i = 0; i < I40E_NB_HW_PORT_XSTATS; i++) {
    strlcpy(xstats_names[count].name, rte_i40e_hw_port_strings[i].name,
            sizeof(xstats_names[count].name));
    count++;
  }
  ...
  for (i = 0; i < I40E_NB_RXQ_PRIO_XSTATS; i++) {
    for (prio = 0; prio < 8; prio++) {
      snprintf(xstats_names[count].name, sizeof(xstats_names[count].name),
               "rx_priority%u_%s", prio, rte_i40e_rxq_prio_strings[i].name);
      count++;
    }
  }
  ...
  for (i = 0; i < I40E_NB_TXQ_PRIO_XSTATS; i++) {
    for (prio = 0; prio < 8; prio++) {
      snprintf(xstats_names[count].name, sizeof(xstats_names[count].name),
               "tx_priority%u_%s", prio, rte_i40e_txq_prio_strings[i].name);
      count++;
    }
  }
  return count;
...
static int i40e_dev_xstats_get(struct rte_eth_dev *dev,
  ...
  for (i = 0; i < I40E_NB_HW_PORT_XSTATS; i++) {
    xstats[count].value =
        *(uint64_t *)(((char *)hw_stats) + rte_i40e_hw_port_strings[i].offset);
    xstats[count].id = count;
    count++;
  }
...
static int i40e_fw_version_get(struct rte_eth_dev *dev, char *fw_version,
  ...
  ret =
      snprintf(fw_version, fw_size, "%d.%d%d 0x%08x %d.%d.%d",
               ((hw->nvm.version >> 12) & 0xf), ((hw->nvm.version >> 4) & 0xff),
               (hw->nvm.version & 0xf), hw->nvm.eetrack, ver, build, patch);
  if (ret < 0)
    return -EINVAL;
 ...
 */
static bool i40e_need_stop_lldp(struct rte_eth_dev *dev) {
  double nvm_ver;
  char ver_str[64] = {0};
  struct i40e_hw *hw = I40E_DEV_PRIVATE_TO_HW(dev->data->dev_private);
...
static int i40e_dev_info_get(struct rte_eth_dev *dev,
  ...
  dev_info->rx_offload_capa =
      ...
      RTE_ETH_RX_OFFLOAD_KEEP_CRC | RTE_ETH_RX_OFFLOAD_SCATTER |
      RTE_ETH_RX_OFFLOAD_VLAN_EXTEND | RTE_ETH_RX_OFFLOAD_VLAN_FILTER |
  ...
  dev_info->tx_offload_capa =
      ...
      RTE_ETH_TX_OFFLOAD_OUTER_IPV4_CKSUM | RTE_ETH_TX_OFFLOAD_TCP_TSO |
  ...
  if (pf->flags & I40E_FLAG_VMDQ) {
    ...
    dev_info->vmdq_queue_num = pf->vmdq_nb_qps * pf->max_nb_vmdq_vsi;
...
static int i40e_vlan_tpid_set_by_registers(struct rte_eth_dev *dev,
  ...
  ret = i40e_aq_debug_read_register(hw, I40E_GL_SWT_L2TAGCTRL(reg_id), &reg_r,
                                    NULL);
  if (ret != I40E_SUCCESS) {
    PMD_DRV_LOG(ERR, "Fail to debug read from I40E_GL_SWT_L2TAGCTRL[%d]",
                reg_id);
    return -EIO;
  }
  PMD_DRV_LOG(DEBUG, "Debug read from I40E_GL_SWT_L2TAGCTRL[%d]: 0x%08" PRIx64,
              reg_id, reg_r);
  ...
  ret = i40e_aq_debug_write_global_register(hw, I40E_GL_SWT_L2TAGCTRL(reg_id),
                                            reg_w, NULL);
  if (ret != I40E_SUCCESS) {
    PMD_DRV_LOG(ERR, "Fail to debug write to I40E_GL_SWT_L2TAGCTRL[%d]",
                reg_id);
    return -EIO;
  }
  PMD_DRV_LOG(DEBUG, "Global register 0x%08x is changed with value 0x%08x",
...
static int i40e_vlan_tpid_set(struct rte_eth_dev *dev,
  ...
  if (hw->flags & I40E_HW_FLAG_802_1AD_CAPABLE) {
    ...
    if (ret != I40E_SUCCESS) {
      PMD_DRV_LOG(ERR, "Set switch config failed aq_err: %d",
                  hw->aq.asq_last_status);
      ret = -EIO;
    }
  } else
    /* If NVM API < 1.7, keep the register setting */
    ret = i40e_vlan_tpid_set_by_registers(dev, vlan_type, tpid, qinq);

  return ret;
}

/* Configure outer vlan stripping on or off in QinQ mode */
static int i40e_vsi_config_outer_vlan_stripping(struct i40e_vsi *vsi, bool on) {
  struct i40e_hw *hw = I40E_VSI_TO_HW(vsi);
  ...
  ret = i40e_aq_debug_write_register(hw, I40E_VSI_TSR(vsi->vsi_id), reg, NULL);
  if (ret < 0) {
    PMD_DRV_LOG(ERR, "Failed to update VSI_TSR[%d]", vsi->vsi_id);
...
static int i40e_vlan_offload_set(struct rte_eth_dev *dev, int mask) {
  ...
  if (mask & RTE_ETH_VLAN_EXTEND_MASK) {
    if (rxmode->offloads & RTE_ETH_RX_OFFLOAD_VLAN_EXTEND) {
      ...
      i40e_vlan_tpid_set(dev, RTE_ETH_VLAN_TYPE_OUTER, RTE_ETHER_TYPE_VLAN);
      i40e_vlan_tpid_set(dev, RTE_ETH_VLAN_TYPE_INNER, RTE_ETHER_TYPE_VLAN);
    } else
      i40e_vsi_config_double_vlan(vsi, FALSE);
  }
...
static void i40e_vlan_strip_queue_set(__rte_unused struct rte_eth_dev *dev,
...
static int i40e_flow_ctrl_set(struct rte_eth_dev *dev,
  ...
  if (I40E_PHY_TYPE_SUPPORT_40G(hw->phy.phy_types)) {
    ...
    fctrl_reg = I40E_READ_REG(hw, I40E_PRTMAC_HSEC_CTL_RX_FORWARD_CONTROL);
    ...
    I40E_WRITE_REG(hw, I40E_PRTMAC_HSEC_CTL_RX_FORWARD_CONTROL, fctrl_reg);
  } else {
    ...
    I40E_WRITE_REG(hw, I40E_PRTDCB_FCRTV, pf->fc_conf.pause_time / 2);
  ...
  if (!pf->support_multi_driver) {
    ...
    I40E_WRITE_GLB_REG(
        hw, I40E_GLRPB_PHW,
        (pf->fc_conf.high_water[I40E_MAX_TRAFFIC_CLASS] << I40E_KILOSHIFT) /
            I40E_PACKET_AVERAGE_SIZE);
    I40E_WRITE_GLB_REG(
        hw, I40E_GLRPB_PLW,
        (pf->fc_conf.low_water[I40E_MAX_TRAFFIC_CLASS] << I40E_KILOSHIFT) /
            I40E_PACKET_AVERAGE_SIZE);
    ...
    PMD_DRV_LOG(ERR, "Water marker configuration is not supported.");
  }
...
static int i40e_macaddr_add(struct rte_eth_dev *dev,
  ...
  if (pool != 0 && (!(pf->flags & I40E_FLAG_VMDQ) || !pf->nb_cfg_vmdq_vsi)) {
    PMD_DRV_LOG(ERR, "VMDQ not %s, can't set mac to pool %u",
                pf->flags & I40E_FLAG_VMDQ ? "configured" : "enabled", pool);
    return -ENOTSUP;
  }

  if (pool > pf->nb_cfg_vmdq_vsi) {
    PMD_DRV_LOG(ERR, "Pool number %u invalid. Max pool is %u", pool,
                pf->nb_cfg_vmdq_vsi);
    return -EINVAL;
  }
  ...
  for (i = 0; i < sizeof(pool_sel) * CHAR_BIT; i++) {
    if (pool_sel & (1ULL << i)) {
      if (i == 0)
        ...
        if (!(pf->flags & I40E_FLAG_VMDQ) || (i > pf->nb_cfg_vmdq_vsi)) {
...
static int i40e_get_rss_lut(struct i40e_vsi *vsi, uint8_t *lut,
                            uint16_t lut_size) {
  struct i40e_pf *pf = I40E_VSI_TO_PF(vsi);
  struct i40e_hw *hw = I40E_VSI_TO_HW(vsi);
  uint32_t reg;
...
int i40e_set_rss_lut(struct i40e_vsi *vsi, uint8_t *lut, uint16_t lut_size) {
  ...
  if (pf->flags & I40E_FLAG_RSS_AQ_CAPABLE) {
    ...
    status = i40e_aq_set_rss_lut(hw, vsi->vsi_id, vsi->type != I40E_VSI_SRIOV,
                                 lut, lut_size);
    if (status) {
      PMD_DRV_LOG(ERR, "Failed to update RSS lookup table, error status: %d",
                  status);
      return -EIO;
    }
  } else {
    ...
    if (vsi->type == I40E_VSI_SRIOV) {
      for (i = 0; i < lut_size_dw; i++)
        I40E_WRITE_REG(hw, I40E_VFQF_HLUT1(i, vsi->user_param), lut_dw[i]);
    } else {
      for (i = 0; i < lut_size_dw; i++)
...
static int i40e_dev_rss_reta_update(struct rte_eth_dev *dev,
  ...
  if (reta_size != lut_size || reta_size > RTE_ETH_RSS_RETA_SIZE_512) {
    PMD_DRV_LOG(ERR,
                "The size of hash lookup table configured (%d) doesn't match "
                "the number hardware can supported (%d)",
                reta_size, lut_size);
    return -EINVAL;
  }
 ...
 **/
enum i40e_status_code i40e_allocate_dma_mem_d(__rte_unused struct i40e_hw *hw,
  ...
  PMD_DRV_LOG(DEBUG, "memzone %s allocated with physical address: %" PRIu64,
              mz->name, mem->pa);
 ...
 **/
enum i40e_status_code i40e_free_dma_mem_d(__rte_unused struct i40e_hw *hw,
                                          struct i40e_dma_mem *mem) {
  if (!mem)
    return I40E_ERR_PARAM;

  PMD_DRV_LOG(DEBUG, "memzone %s to be freed with physical address: %" PRIu64,
 ...
 * @size: size of memory requested
 **/
enum i40e_status_code i40e_allocate_virt_mem_d(__rte_unused struct i40e_hw *hw,
 ...
 **/
enum i40e_status_code i40e_free_virt_mem_d(__rte_unused struct i40e_hw *hw,
                                           struct i40e_virt_mem *mem) {
  if (!mem)
    return I40E_ERR_PARAM;
...
void i40e_destroy_spinlock_d(__rte_unused struct i40e_spinlock *sp) { return; }
...
static int i40e_get_cap(struct i40e_hw *hw) {
  ...
  ret = i40e_aq_discover_capabilities(
      hw, buf, len, &size, i40e_aqc_opc_list_func_capabilities, NULL);
  if (ret != I40E_SUCCESS)
...
static int i40e_pf_parameter_init(struct rte_eth_dev *dev) {
  ...
  if (hw->func_caps.vmdq) {
    if (qp_count < hw->func_caps.num_tx_qp &&
      ...
      pf->max_nb_vmdq_vsi =
          (hw->func_caps.num_tx_qp - qp_count) / pf->vmdq_nb_qp_max;

      /* Limit the maximum number of VMDq vsi to the maximum
       * ethdev can support
       */
      pf->max_nb_vmdq_vsi =
          RTE_MIN(pf->max_nb_vmdq_vsi, hw->func_caps.num_vsis - vsi_count);
      pf->max_nb_vmdq_vsi = RTE_MIN(pf->max_nb_vmdq_vsi, RTE_ETH_64_POOLS);
...
static int i40e_pf_get_switch_config(struct i40e_pf *pf) {
  struct i40e_hw *hw = I40E_PF_TO_HW(pf);
  ...
  switch_config = (struct i40e_aqc_get_switch_config_resp *)rte_zmalloc(
      "i40e", I40E_AQ_LARGE_BUF, 0);
  if (!switch_config) {
  ...
  ret = i40e_aq_get_switch_config(hw, switch_config, I40E_AQ_LARGE_BUF,
                                  &start_seid, NULL);
  if (ret != I40E_SUCCESS) {
...
static int i40e_res_pool_alloc(struct i40e_res_pool_info *pool, uint16_t num) {
  ...
  if (pool->num_free < num) {
    PMD_DRV_LOG(ERR, "No resource. ask:%u, available:%u", num, pool->num_free);
    return -ENOMEM;
  }
 ...
 **/
static inline int bitmap_is_subset(uint8_t src1, uint8_t src2) {
  return !((src1 ^ src2) & src2);
}

static enum i40e_status_code validate_tcmap_parameter(struct i40e_vsi *vsi,
...
int i40e_vsi_vlan_pvid_set(struct i40e_vsi *vsi,
  ...
  if (info->on) {
     ...
     */
    vlan_flags |= I40E_AQ_VSI_PVLAN_INSERT_PVID | I40E_AQ_VSI_PVLAN_MODE_TAGGED;
  } else {
    vsi->info.pvid = 0;
  ...
  vsi->info.port_vlan_flags &=
      ~(I40E_AQ_VSI_PVLAN_INSERT_PVID | I40E_AQ_VSI_PVLAN_MODE_MASK);
  vsi->info.port_vlan_flags |= vlan_flags;
  vsi->info.valid_sections = rte_cpu_to_le_16(I40E_AQ_VSI_PROP_VLAN_VALID);
...
static int i40e_vsi_update_tc_bandwidth(struct i40e_vsi *vsi,
                                        uint8_t enabled_tcmap) {
  struct i40e_hw *hw = I40E_VSI_TO_HW(vsi);
  int i, ret;
  ...
  for (i = 0; i < I40E_MAX_TRAFFIC_CLASS; i++)
    tc_bw_data.tc_bw_credits[i] = (enabled_tcmap & (1 << i)) ? 1 : 0;
...
i40e_vsi_config_tc_queue_mapping(struct i40e_vsi *vsi,
  ...
  for (i = 0; i < I40E_MAX_TRAFFIC_CLASS; i++) {
    if (vsi->enabled_tc & (1 << i)) {
      info->tc_mapping[i] =
          rte_cpu_to_le_16((qp_idx << I40E_AQ_VSI_TC_QUE_OFFSET_SHIFT) |
  ...
  if (vsi->type == I40E_VSI_SRIOV) {
    info->mapping_flags |= rte_cpu_to_le_16(I40E_AQ_VSI_QUE_MAP_NONCONTIG);
    for (i = 0; i < vsi->nb_qps; i++)
      info->queue_mapping[i] = rte_cpu_to_le_16(vsi->base_queue + i);
  } else {
    info->mapping_flags |= rte_cpu_to_le_16(I40E_AQ_VSI_QUE_MAP_CONTIG);
    info->queue_mapping[0] = rte_cpu_to_le_16(vsi->base_queue);
  }
  info->valid_sections |= rte_cpu_to_le_16(I40E_AQ_VSI_PROP_QUEUE_MAP_VALID);
...
static struct i40e_veb *i40e_veb_setup(struct i40e_pf *pf,
  ...
  if (pf == NULL) {
    PMD_DRV_LOG(ERR, "veb setup failed, associated PF shouldn't null");
    return NULL;
  }
  hw = I40E_PF_TO_HW(pf);
  ...
  if (vsi != NULL) {
    ret = i40e_aq_add_veb(hw, veb->uplink_seid, vsi->seid, I40E_DEFAULT_TCMAP,
                          false, &veb->seid, false, NULL);
  } else {
    ret = i40e_aq_add_veb(hw, 0, 0, I40E_DEFAULT_TCMAP, true, &veb->seid, false,
                          NULL);
  }
  ...
  ret = i40e_aq_get_veb_parameters(hw, veb->seid, NULL, NULL, &veb->stats_idx,
                                   NULL, NULL, NULL);
  if (ret != I40E_SUCCESS) {
...
int i40e_vsi_release(struct i40e_vsi *vsi) {
  ...
  if (vsi->type != I40E_VSI_MAIN &&
      ((vsi->type != I40E_VSI_SRIOV) || !pf->floating_veb_list[user_param])) {
    /* Remove vsi from parent's sibling list */
    if (vsi->parent_vsi == NULL || vsi->parent_vsi->veb == NULL) {
      PMD_DRV_LOG(ERR, "VSI's parent VSI is NULL");
      return I40E_ERR_PARAM;
    }
    TAILQ_REMOVE(&vsi->parent_vsi->veb->head, &vsi->sib_vsi_list, list);
  ...
  if ((vsi->type == I40E_VSI_SRIOV) && pf->floating_veb_list[user_param]) {
    /* Remove vsi from parent's sibling list */
    if (vsi->parent_vsi == NULL || vsi->parent_vsi->floating_veb == NULL) {
      PMD_DRV_LOG(ERR, "VSI's parent VSI is NULL");
      return I40E_ERR_PARAM;
    }
    TAILQ_REMOVE(&vsi->parent_vsi->floating_veb->head, &vsi->sib_vsi_list,
                 list);
...
static int i40e_update_default_filter_setting(struct i40e_vsi *vsi) {
  struct i40e_hw *hw = I40E_VSI_TO_HW(vsi);
  ...
  rte_memcpy(def_filter.mac_addr, hw->mac.perm_addr, ETH_ADDR_LEN);
  ...
  if (ret != I40E_SUCCESS) {
    ...
    rte_memcpy(&mac->addr_bytes, hw->mac.perm_addr, ETH_ADDR_LEN);
  ...
  rte_memcpy(&filter.mac_addr, (struct rte_ether_addr *)(hw->mac.perm_addr),
             ETH_ADDR_LEN);
 ...
 */
static enum i40e_status_code i40e_vsi_get_bw_config(struct i40e_vsi *vsi) {
  ...
  ret = i40e_aq_query_vsi_ets_sla_config(hw, vsi->seid, &ets_sla_config, NULL);
  if (ret != I40E_SUCCESS) {
    PMD_DRV_LOG(ERR, "VSI failed to get TC bandwidth configuration %u",
                hw->aq.asq_last_status);
    return ret;
  }
  ...
  bw_max = rte_le_to_cpu_16(ets_sla_config.tc_bw_max[0]) |
           (rte_le_to_cpu_16(ets_sla_config.tc_bw_max[1]) << I40E_16_BIT_WIDTH);
  for (i = 0; i < I40E_MAX_TRAFFIC_CLASS; i++) {
    vsi->bw_info.bw_ets_share_credits[i] = ets_sla_config.share_credits[i];
    vsi->bw_info.bw_ets_credits[i] =
        rte_le_to_cpu_16(ets_sla_config.credits[i]);
    /* 4 bits per TC, 4th bit is reserved */
    vsi->bw_info.bw_ets_max[i] = (uint8_t)((bw_max >> (i * I40E_4_BIT_WIDTH)) &
 ...
 */
static inline void i40e_enable_pf_lb(struct i40e_pf *pf) {
  struct i40e_hw *hw = I40E_PF_TO_HW(pf);
  struct i40e_vsi_context ctxt;
  int ret;
  ...
  if (ret) {
    PMD_DRV_LOG(ERR, "cannot get pf vsi config, err %d, aq_err %d", ret,
                hw->aq.asq_last_status);
    return;
  }
  ctxt.flags = I40E_AQ_VSI_TYPE_PF;
  ctxt.info.valid_sections = rte_cpu_to_le_16(I40E_AQ_VSI_PROP_SWITCH_VALID);
  ctxt.info.switch_id |= rte_cpu_to_le_16(I40E_AQ_VSI_SW_ID_FLAG_ALLOW_LB);
...
/* Setup a VSI */
struct i40e_vsi *i40e_vsi_setup(struct i40e_pf *pf, enum i40e_vsi_type type,
  ...
  if (type != I40E_VSI_MAIN && type != I40E_VSI_SRIOV && uplink_vsi == NULL) {
  ...
  if (type != I40E_VSI_MAIN && uplink_vsi != NULL && uplink_vsi->veb == NULL) {
  ...
  if (type != I40E_VSI_FDIR) {
    ...
    if (ret < 0) {
      PMD_DRV_LOG(ERR, "VSI %d allocate queue failed %d", vsi->seid, ret);
      goto fail_mem;
    }
    vsi->base_queue = ret;
  } else
  ...
  if (type == I40E_VSI_MAIN) {
    if (pf->support_multi_driver) {
      ...
      if (ret < 0) {
        PMD_DRV_LOG(ERR, "VSI MAIN %d get heap failed %d", vsi->seid, ret);
  ...
  if (type == I40E_VSI_MAIN) {
    ...
    if (i40e_vsi_update_tc_bandwidth(vsi, I40E_DEFAULT_TCMAP) != I40E_SUCCESS) {
    ...
    vsi->info.valid_sections |= rte_cpu_to_le_16(I40E_AQ_VSI_PROP_VLAN_VALID);
    vsi->info.port_vlan_flags =
        I40E_AQ_VSI_PVLAN_MODE_ALL | I40E_AQ_VSI_PVLAN_EMOD_STR_BOTH;
    rte_memcpy(&ctxt.info, &vsi->info,
               sizeof(struct i40e_aqc_vsi_properties_data));
    ret = i40e_vsi_config_tc_queue_mapping(vsi, &ctxt.info, I40E_DEFAULT_TCMAP);
    if (ret != I40E_SUCCESS) {
    ...
    rte_memcpy(&vsi->info.queue_mapping, &ctxt.info.queue_mapping,
               sizeof(vsi->info.queue_mapping));
    vsi->info.mapping_flags = ctxt.info.mapping_flags;
    vsi->info.valid_sections = 0;

    rte_memcpy(pf->dev_addr.addr_bytes, hw->mac.perm_addr, ETH_ADDR_LEN);
    ...
    /* Configure port/vlan */
    ctxt.info.valid_sections |= rte_cpu_to_le_16(I40E_AQ_VSI_PROP_VLAN_VALID);
    ...
    ctxt.info.valid_sections |= rte_cpu_to_le_16(I40E_AQ_VSI_PROP_SCHED_VALID);
    /**
    ...
    if (user_param) {
      ctxt.info.switch_id = rte_cpu_to_le_16(I40E_AQ_VSI_SW_ID_FLAG_LOCAL_LB);
      ctxt.info.switch_id |= rte_cpu_to_le_16(I40E_AQ_VSI_SW_ID_FLAG_ALLOW_LB);
    }
  ...
  if (vsi->type != I40E_VSI_MAIN) {
    ...
    if (vsi->type == I40E_VSI_SRIOV && uplink_vsi == NULL) {
      TAILQ_INSERT_TAIL(&pf->main_vsi->floating_veb->head, &vsi->sib_vsi_list,
                        list);
    } else {
      TAILQ_INSERT_TAIL(&uplink_vsi->veb->head, &vsi->sib_vsi_list, list);
    }
  }
...
int i40e_vsi_config_vlan_filter(struct i40e_vsi *vsi, bool on) {
  ...
  mac_filter =
      rte_zmalloc("mac_filter_info_data", num * sizeof(*mac_filter), 0);
  if (mac_filter == NULL) {
    PMD_DRV_LOG(ERR, "failed to allocate memory");
    return I40E_ERR_NO_MEMORY;
  }
...
int i40e_vsi_config_vlan_stripping(struct i40e_vsi *vsi, bool on) {
  ...
  if (vsi->info.valid_sections &
    ...
    if (on) {
      if ((vsi->info.port_vlan_flags & I40E_AQ_VSI_PVLAN_EMOD_MASK) == 0)
        return 0; /* already on */
    } else {
      if ((vsi->info.port_vlan_flags & I40E_AQ_VSI_PVLAN_EMOD_MASK) ==
...
static int i40e_dev_init_vlan(struct rte_eth_dev *dev) {
  ...
  mask = RTE_ETH_VLAN_STRIP_MASK | RTE_ETH_QINQ_STRIP_MASK |
...
static int i40e_update_flow_control(struct i40e_hw *hw) {
...
write_reg:
  I40E_WRITE_REG(hw, I40E_PRTDCB_FCCFG, txfc << I40E_PRTDCB_FCCFG_TFCE_SHIFT);
...
static int i40e_pf_setup(struct i40e_pf *pf) {
  ...
  if (ret)
    PMD_INIT_LOG(WARNING, "failed to allocate switch domain for device %d",
                 ret);
...
int i40e_switch_tx_queue(struct i40e_hw *hw, uint16_t q_idx, bool on) {
  ...
  if (j >= I40E_CHK_Q_ENA_COUNT) {
    PMD_DRV_LOG(ERR, "Failed to %s tx queue[%u]", (on ? "enable" : "disable"),
                q_idx);
...
static int i40e_dev_tx_init(struct i40e_pf *pf) {
...
static int i40e_dev_rx_init(struct i40e_pf *pf) {
  struct rte_eth_dev_data *data = pf->dev_data;
  int ret = I40E_SUCCESS;
  uint16_t i;
...
static int i40e_vmdq_setup(struct rte_eth_dev *dev) {
  ...
  pf->vmdq = rte_zmalloc("vmdq_info_struct", sizeof(*vmdq_info) * conf_vsis, 0);
  ...
  for (i = 0; i < vmdq_conf->nb_pool_maps; i++) {
    for (j = 0; j < loop && j < pf->nb_cfg_vmdq_vsi; j++) {
      if (vmdq_conf->pool_map[i].pools & (1UL << j)) {
        ...
        err =
            i40e_vsi_add_vlan(pf->vmdq[j].vsi, vmdq_conf->pool_map[i].vlan_id);
        if (err) {
...
static void i40e_stat_update_32(struct i40e_hw *hw, uint32_t reg,
  ...
  if (new_data >= *offset)
    ...
    *stat =
        (uint64_t)((new_data + ((uint64_t)1 << I40E_32_BIT_WIDTH)) - *offset);
}
...
static void i40e_stat_update_48(struct i40e_hw *hw, uint32_t hireg,
  ...
  if (hw->device_id == I40E_DEV_ID_QEMU) {
    ...
    new_data |= ((uint64_t)(I40E_READ_REG(hw, hireg) & I40E_16_BIT_MASK))
                << I40E_32_BIT_WIDTH;
  } else {
  ...
  if (new_data >= *offset)
    ...
    *stat =
        (uint64_t)((new_data + ((uint64_t)1 << I40E_48_BIT_WIDTH)) - *offset);
...
static void i40e_pf_config_irq0(struct i40e_hw *hw, bool no_queue) {
  ...
  if (no_queue)
    ...
    I40E_WRITE_REG(hw, I40E_PFINT_LNKLST0, I40E_PFINT_LNKLST0_FIRSTQ_INDX_MASK);
}

static void i40e_dev_handle_vfr_event(struct rte_eth_dev *dev) {
  struct i40e_hw *hw = I40E_DEV_PRIVATE_TO_HW(dev->data->dev_private);
  struct i40e_pf *pf = I40E_DEV_PRIVATE_TO_PF(dev->data->dev_private);
  int i;
  uint16_t abs_vf_id;
  ...
  for (i = 0; i < pf->vf_num; i++) {
    ...
    if (val & (0x1 << offset)) {
      ...
      I40E_WRITE_REG(hw, I40E_GLGEN_VFLRSTAT(index), (0x1 << offset));
...
static void i40e_dev_handle_aq_msg(struct rte_eth_dev *dev) {
  struct i40e_hw *hw = I40E_DEV_PRIVATE_TO_HW(dev->data->dev_private);
  ...
  while (pending) {
    ...
    case i40e_aqc_opc_send_msg_to_pf:
      ...
      i40e_pf_host_handle_vf_msg(dev, rte_le_to_cpu_16(info.desc.retval),
                                 rte_le_to_cpu_32(info.desc.cookie_high),
                                 rte_le_to_cpu_32(info.desc.cookie_low),
                                 info.msg_buf, info.msg_len);
      break;
...
static void i40e_handle_mdd_event(struct rte_eth_dev *dev) {
...
#define I40E_MDD_CLEAR16 0xFFFF
  ...
  if (reg & I40E_GL_MDET_TX_VALID_MASK) {
    uint8_t pf_num =
        (reg & I40E_GL_MDET_TX_PF_NUM_MASK) >> I40E_GL_MDET_TX_PF_NUM_SHIFT;
    uint16_t vf_num =
        (reg & I40E_GL_MDET_TX_VF_NUM_MASK) >> I40E_GL_MDET_TX_VF_NUM_SHIFT;
    uint8_t event =
        (reg & I40E_GL_MDET_TX_EVENT_MASK) >> I40E_GL_MDET_TX_EVENT_SHIFT;
    uint16_t queue =
        ((reg & I40E_GL_MDET_TX_QUEUE_MASK) >> I40E_GL_MDET_TX_QUEUE_SHIFT) -
        hw->func_caps.base_queue;
    PMD_DRV_LOG(WARNING,
                "Malicious Driver Detection event 0x%02x on TX "
  ...
  if (reg & I40E_GL_MDET_RX_VALID_MASK) {
    uint8_t func =
        (reg & I40E_GL_MDET_RX_FUNCTION_MASK) >> I40E_GL_MDET_RX_FUNCTION_SHIFT;
    uint8_t event =
        (reg & I40E_GL_MDET_RX_EVENT_MASK) >> I40E_GL_MDET_RX_EVENT_SHIFT;
    uint16_t queue =
        ((reg & I40E_GL_MDET_RX_QUEUE_MASK) >> I40E_GL_MDET_RX_QUEUE_SHIFT) -
        hw->func_caps.base_queue;

    PMD_DRV_LOG(WARNING,
                "Malicious Driver Detection event 0x%02x on RX "
  ...
  if (mdd_detected) {
    ...
    if (reg & I40E_PF_MDET_RX_VALID_MASK) {
      I40E_WRITE_REG(hw, I40E_PF_MDET_RX, I40E_MDD_CLEAR16);
  ...
  for (i = 0; i < pf->vf_num && mdd_detected; i++) {
    ...
    if (reg & I40E_VP_MDET_TX_VALID_MASK) {
      I40E_WRITE_REG(hw, I40E_VP_MDET_TX(i), I40E_MDD_CLEAR16);
      vf->num_mdd_events++;
      PMD_DRV_LOG(WARNING,
                  "TX driver issue detected on VF %d %-" PRIu64 "times\n", i,
                  vf->num_mdd_events);
    }

    reg = I40E_READ_REG(hw, I40E_VP_MDET_RX(i));
    if (reg & I40E_VP_MDET_RX_VALID_MASK) {
      I40E_WRITE_REG(hw, I40E_VP_MDET_RX(i), I40E_MDD_CLEAR16);
      vf->num_mdd_events++;
      PMD_DRV_LOG(WARNING,
                  "RX driver issue detected on VF %d %-" PRIu64 "times\n", i,
                  vf->num_mdd_events);
    }
  }
}
...
int i40e_add_macvlan_filters(struct i40e_vsi *vsi,
                             struct i40e_macvlan_filter *filter, int total) {
  ...
  do {
    ...
    for (i = 0; i < actual_num; i++) {
      rte_memcpy(req_list[i].mac_addr, &filter[num + i].macaddr, ETH_ADDR_LEN);
      req_list[i].vlan_tag = rte_cpu_to_le_16(filter[num + i].vlan_id);
      ...
      case I40E_MAC_HASH_MATCH:
        flags =
            I40E_AQC_MACVLAN_ADD_HASH_MATCH | I40E_AQC_MACVLAN_ADD_IGNORE_VLAN;
        break;
    ...
    ret = i40e_aq_add_macvlan(hw, vsi->seid, req_list, actual_num, NULL);
    if (ret != I40E_SUCCESS) {
      PMD_DRV_LOG(ERR, "Failed to add macvlan filter");
      goto DONE;
    }
...
int i40e_remove_macvlan_filters(struct i40e_vsi *vsi,
  ...
  do {
    ...
    for (i = 0; i < actual_num; i++) {
      ...
      case I40E_MAC_HASH_MATCH:
        flags =
            I40E_AQC_MACVLAN_DEL_HASH_MATCH | I40E_AQC_MACVLAN_DEL_IGNORE_VLAN;
        break;
      case I40E_MACVLAN_HASH_MATCH:
    ...
    ret = i40e_aq_remove_macvlan_v2(hw, vsi->seid, req_list, actual_num, NULL,
                                    &aq_status);
...
i40e_find_mac_filter(struct i40e_vsi *vsi, struct rte_ether_addr *macaddr) {
  struct i40e_mac_filter *f;
...
static bool i40e_find_vlan_filter(struct i40e_vsi *vsi, uint16_t vlan_id) {
...
static void i40e_store_vlan_filter(struct i40e_vsi *vsi, uint16_t vlan_id,
                                   bool on) {
  uint32_t vid_idx, vid_bit;
...
int i40e_find_all_vlan_for_mac(struct i40e_vsi *vsi,
                               struct i40e_macvlan_filter *mv_f, int num,
  ...
  for (j = 0; j < I40E_VFTA_SIZE; j++) {
    if (vsi->vfta[j]) {
      for (k = 0; k < I40E_UINT32_BIT_SIZE; k++) {
        if (vsi->vfta[j] & (1 << k)) {
          if (i > num - 1) {
            PMD_DRV_LOG(ERR, "vlan number doesn't match");
            return I40E_ERR_PARAM;
          }
          rte_memcpy(&mv_f[i].macaddr, addr, ETH_ADDR_LEN);
          mv_f[i].vlan_id = j * I40E_UINT32_BIT_SIZE + k;
          i++;
        }
      }
    }
...
static inline int i40e_find_all_mac_for_vlan(struct i40e_vsi *vsi,
  ...
  TAILQ_FOREACH(f, &vsi->mac_list, next) {
    ...
    rte_memcpy(&mv_f[i].macaddr, &f->mac_info.mac_addr, ETH_ADDR_LEN);
    mv_f[i].vlan_id = vlan;
...
static int i40e_vsi_remove_all_macvlan_filter(struct i40e_vsi *vsi) {
  ...
  if (vsi->vlan_num == 0) {
    ...
    TAILQ_FOREACH(f, &vsi->mac_list, next) {
      ret = i40e_find_all_vlan_for_mac(vsi, &mv_f[i], vsi->vlan_num,
                                       &f->mac_info.mac_addr);
      if (ret != I40E_SUCCESS)
        goto DONE;
...
int i40e_vsi_add_mac(struct i40e_vsi *vsi,
                     struct i40e_mac_filter_info *mac_filter) {
  struct i40e_mac_filter *f;
  struct i40e_macvlan_filter *mv_f;
  int i, vlan_num = 0;
  ...
  for (i = 0; i < vlan_num; i++) {
    ...
    rte_memcpy(&mv_f[i].macaddr, &mac_filter->mac_addr, ETH_ADDR_LEN);
  }

  if (mac_filter->filter_type == I40E_MACVLAN_PERFECT_MATCH ||
      mac_filter->filter_type == I40E_MACVLAN_HASH_MATCH) {
    ret =
        i40e_find_all_vlan_for_mac(vsi, mv_f, vlan_num, &mac_filter->mac_addr);
    if (ret != I40E_SUCCESS)
      goto DONE;
  }
  ...
  rte_memcpy(&f->mac_info.mac_addr, &mac_filter->mac_addr, ETH_ADDR_LEN);
...
int i40e_set_rss_key(struct i40e_vsi *vsi, uint8_t *key, uint8_t key_len) {
  struct i40e_pf *pf = I40E_VSI_TO_PF(vsi);
  struct i40e_hw *hw = I40E_VSI_TO_HW(vsi);
  uint16_t key_idx = (vsi->type == I40E_VSI_SRIOV) ? I40E_VFQF_HKEY_MAX_INDEX
  ...
  if (pf->flags & I40E_FLAG_RSS_AQ_CAPABLE) {
    ...
    enum i40e_status_code status = i40e_aq_set_rss_key(hw, vsi->vsi_id, key_dw);

    if (status) {
      PMD_DRV_LOG(ERR, "Failed to configure RSS key via AQ, error status: %d",
                  status);
      return -EIO;
    }
  } else {
    ...
    if (vsi->type == I40E_VSI_SRIOV) {
      for (i = 0; i <= I40E_VFQF_HKEY_MAX_INDEX; i++)
        I40E_WRITE_REG(hw, I40E_VFQF_HKEY1(i, vsi->user_param), hash_key[i]);
...
static int i40e_get_rss_key(struct i40e_vsi *vsi, uint8_t *key,
                            uint8_t *key_len) {
  struct i40e_pf *pf = I40E_VSI_TO_PF(vsi);
  struct i40e_hw *hw = I40E_VSI_TO_HW(vsi);
  uint32_t reg;
...
static int i40e_hw_rss_hash_set(struct i40e_pf *pf,
                                struct rte_eth_rss_conf *rss_conf) {
  struct i40e_hw *hw = I40E_PF_TO_HW(pf);
  uint64_t hena;
  int ret;
  ...
  ret =
      i40e_set_rss_key(pf->main_vsi, rss_conf->rss_key, rss_conf->rss_key_len);
  if (ret)
    return ret;
...
static int i40e_dev_rss_hash_conf_get(struct rte_eth_dev *dev,
  ...
  ret =
      i40e_get_rss_key(pf->main_vsi, rss_conf->rss_key, &rss_conf->rss_key_len);
  if (ret)
    return ret;
...
static int i40e_dev_get_filter_type(uint16_t filter_type, uint16_t *flag) {
  switch (filter_type) {
...
i40e_tunnel_filter_convert(struct i40e_aqc_cloud_filters_element_bb *cld_filter,
  ...
  if ((rte_le_to_cpu_16(cld_filter->element.flags) &
       I40E_AQC_ADD_CLOUD_FLAGS_IPV6) == I40E_AQC_ADD_CLOUD_FLAGS_IPV6)
  ...
  rte_memcpy(tunnel_filter->input.general_fields, cld_filter->general_fields,
...
i40e_sw_tunnel_filter_insert(struct i40e_pf *pf,
  ...
  if (ret < 0) {
    PMD_DRV_LOG(ERR, "Failed to insert tunnel filter to hash table %d!", ret);
    return ret;
  }
...
int i40e_sw_tunnel_filter_del(struct i40e_pf *pf,
  ...
  if (ret < 0) {
    PMD_DRV_LOG(ERR, "Failed to delete tunnel filter to hash table %d!", ret);
    return ret;
  }
...
static enum i40e_status_code i40e_replace_mpls_l1_filter(struct i40e_pf *pf) {
  ...
  /* create L1 filter */
  filter_replace.old_filter_type = I40E_AQC_REPLACE_CLOUD_CMD_INPUT_FV_IMAC;
  filter_replace.new_filter_type = I40E_AQC_ADD_L1_FILTER_0X11;
  filter_replace.tr_bit = 0;

  /* Prepare the buffer, 3 entries */
  filter_replace_buf.data[0] = I40E_AQC_REPLACE_CLOUD_CMD_INPUT_FV_TEID_WORD0;
  ...
  filter_replace_buf.data[4] = I40E_AQC_REPLACE_CLOUD_CMD_INPUT_FV_TEID_WORD1;
  filter_replace_buf.data[4] |= I40E_AQC_REPLACE_CLOUD_CMD_INPUT_VALIDATED;
  filter_replace_buf.data[7] = 0xF0;
  filter_replace_buf.data[8] = I40E_AQC_REPLACE_CLOUD_CMD_INPUT_TR_WORD0;
  filter_replace_buf.data[8] |= I40E_AQC_REPLACE_CLOUD_CMD_INPUT_VALIDATED;
  filter_replace_buf.data[10] = I40E_TR_VXLAN_GRE_KEY_MASK |
                                I40E_TR_GENEVE_KEY_MASK |
                                I40E_TR_GENERIC_UDP_TUNNEL_MASK;
  filter_replace_buf.data[11] =
      (I40E_TR_GRE_KEY_MASK | I40E_TR_GRE_KEY_WITH_XSUM_MASK |
       I40E_TR_GRE_NO_KEY_MASK) >>
      8;

  status =
      i40e_aq_replace_cloud_filters(hw, &filter_replace, &filter_replace_buf);
  if (!status &&
      (filter_replace.old_filter_type != filter_replace.new_filter_type))
    PMD_DRV_LOG(WARNING,
                "i40e device %s changed cloud l1 type."
                " original: 0x%x, new: 0x%x",
                dev->device->name, filter_replace.old_filter_type,
...
i40e_replace_mpls_cloud_filter(struct i40e_pf *pf) {
  ...
  memset(&filter_replace_buf, 0,
         sizeof(struct i40e_aqc_replace_cloud_filters_cmd_buf));
  filter_replace.valid_flags =
      I40E_AQC_REPLACE_CLOUD_FILTER | I40E_AQC_MIRROR_CLOUD_FILTER;
  ...
  if (status < 0)
    return status;
  if (filter_replace.old_filter_type != filter_replace.new_filter_type)
    PMD_DRV_LOG(WARNING,
  ...
  filter_replace.new_filter_type = I40E_AQC_ADD_CLOUD_FILTER_0X12;
  /* Prepare the buffer, 2 entries */
  filter_replace_buf.data[0] = I40E_AQC_REPLACE_CLOUD_CMD_INPUT_FV_STAG;
  filter_replace_buf.data[0] |= I40E_AQC_REPLACE_CLOUD_CMD_INPUT_VALIDATED;
  filter_replace_buf.data[4] = I40E_AQC_ADD_L1_FILTER_0X11;
...
static enum i40e_status_code i40e_replace_gtp_l1_filter(struct i40e_pf *pf) {
  struct i40e_aqc_replace_cloud_filters_cmd filter_replace;
  struct i40e_aqc_replace_cloud_filters_cmd_buf filter_replace_buf;
  struct i40e_hw *hw = I40E_PF_TO_HW(pf);
  struct rte_eth_dev *dev = &rte_eth_devices[pf->dev_data->port_id];
  ...
  filter_replace.tr_bit =
      I40E_AQC_NEW_TR_22 | I40E_AQC_REPLACE_CLOUD_CMD_INPUT_VALIDATED;
  /* Prepare the buffer, 2 entries */
  filter_replace_buf.data[0] = I40E_AQC_REPLACE_CLOUD_CMD_INPUT_FV_TEID_WORD0;
  filter_replace_buf.data[0] |= I40E_AQC_REPLACE_CLOUD_CMD_INPUT_VALIDATED;
  filter_replace_buf.data[2] = 0xFF;
  ...
  filter_replace.tr_bit =
      I40E_AQC_NEW_TR_21 | I40E_AQC_REPLACE_CLOUD_CMD_INPUT_VALIDATED;
  /* Prepare the buffer, 2 entries */
  filter_replace_buf.data[0] = I40E_AQC_REPLACE_CLOUD_CMD_INPUT_FV_TEID_WORD0;
  filter_replace_buf.data[0] |= I40E_AQC_REPLACE_CLOUD_CMD_INPUT_VALIDATED;
  filter_replace_buf.data[2] = 0xFF;
...
static enum i40e_status_code i40e_replace_gtp_cloud_filter(struct i40e_pf *pf) {
  struct i40e_aqc_replace_cloud_filters_cmd filter_replace;
  struct i40e_aqc_replace_cloud_filters_cmd_buf filter_replace_buf;
  struct i40e_hw *hw = I40E_PF_TO_HW(pf);
  struct rte_eth_dev *dev = &rte_eth_devices[pf->dev_data->port_id];
  ...
  memset(&filter_replace_buf, 0,
         sizeof(struct i40e_aqc_replace_cloud_filters_cmd_buf));
  filter_replace.valid_flags = I40E_AQC_REPLACE_CLOUD_FILTER;
  filter_replace.old_filter_type = I40E_AQC_ADD_CLOUD_FILTER_IMAC_IVLAN_TEN_ID;
  filter_replace.new_filter_type = I40E_AQC_ADD_CLOUD_FILTER_0X12;
  /* Prepare the buffer, 2 entries */
...
i40e_replace_port_l1_filter(struct i40e_pf *pf,
  ...
  if (l4_port_type == I40E_L4_PORT_TYPE_SRC) {
    filter_replace.old_filter_type =
        I40E_AQC_REPLACE_CLOUD_CMD_INPUT_FV_TUNNLE_KEY;
    filter_replace.new_filter_type = I40E_AQC_ADD_L1_FILTER_0X11;
    filter_replace_buf.data[8] = I40E_AQC_REPLACE_CLOUD_CMD_INPUT_FV_SRC_PORT;
  } else {
    filter_replace.old_filter_type =
        I40E_AQC_REPLACE_CLOUD_CMD_INPUT_FV_STAG_IVLAN;
    filter_replace.new_filter_type = I40E_AQC_ADD_L1_FILTER_0X10;
    filter_replace_buf.data[8] = I40E_AQC_REPLACE_CLOUD_CMD_INPUT_FV_DST_PORT;
  }

  filter_replace.tr_bit = 0;
  /* Prepare the buffer, 3 entries */
  filter_replace_buf.data[0] = I40E_AQC_REPLACE_CLOUD_CMD_INPUT_DIRECTION_WORD0;
  filter_replace_buf.data[0] |= I40E_AQC_REPLACE_CLOUD_CMD_INPUT_VALIDATED;
  filter_replace_buf.data[2] = 0x00;
  filter_replace_buf.data[3] = I40E_AQC_REPLACE_CLOUD_CMD_INPUT_INGRESS_WORD0;
  filter_replace_buf.data[4] = I40E_AQC_REPLACE_CLOUD_CMD_INPUT_PORT_TR_WORD0;
  filter_replace_buf.data[4] |= I40E_AQC_REPLACE_CLOUD_CMD_INPUT_VALIDATED;
  filter_replace_buf.data[5] = 0x00;
  filter_replace_buf.data[6] =
      I40E_TR_L4_TYPE_UDP | I40E_TR_L4_TYPE_TCP | I40E_TR_L4_TYPE_SCTP;
...
int i40e_dev_consistent_tunnel_filter_set(
    struct i40e_pf *pf, struct i40e_tunnel_filter_conf *tunnel_filter,
    uint8_t add) {
  uint16_t ip_type;
  ...
  cld_filter = rte_zmalloc(
      "tunnel_filter", sizeof(struct i40e_aqc_add_rm_cloud_filt_elem_ext), 0);
  ...
  pfilter->element.inner_vlan = rte_cpu_to_le_16(tunnel_filter->inner_vlan);
  if (tunnel_filter->ip_type == I40E_TUNNEL_IPTYPE_IPV4) {
    ip_type = I40E_AQC_ADD_CLOUD_FLAGS_IPV4;
    ipv4_addr = rte_be_to_cpu_32(tunnel_filter->ip_addr.ipv4_addr);
    ipv4_addr_le = rte_cpu_to_le_32(ipv4_addr);
    rte_memcpy(&pfilter->element.ipaddr.v4.data, &ipv4_addr_le,
               sizeof(pfilter->element.ipaddr.v4.data));
  } else {
    ip_type = I40E_AQC_ADD_CLOUD_FLAGS_IPV6;
    for (i = 0; i < 4; i++) {
      convert_ipv6[i] = rte_cpu_to_le_32(
          rte_be_to_cpu_32(tunnel_filter->ip_addr.ipv6_addr[i]));
    }
    rte_memcpy(&pfilter->element.ipaddr.v6.data, &convert_ipv6,
  ...
  case I40E_TUNNEL_TYPE_MPLSoUDP:
    ...
    pfilter->general_fields[I40E_AQC_ADD_CLOUD_FV_FLU_0X11_WORD1] =
        (teid_le & 0xF) << 12;
    pfilter->general_fields[I40E_AQC_ADD_CLOUD_FV_FLU_0X11_WORD2] = 0x40;
    big_buffer = 1;
  ...
  case I40E_TUNNEL_TYPE_MPLSoGRE:
    ...
    pfilter->general_fields[I40E_AQC_ADD_CLOUD_FV_FLU_0X11_WORD1] =
        (teid_le & 0xF) << 12;
    pfilter->general_fields[I40E_AQC_ADD_CLOUD_FV_FLU_0X11_WORD2] = 0x0;
    big_buffer = 1;
  ...
  case I40E_TUNNEL_TYPE_GTPC:
    ...
    pfilter->general_fields[I40E_AQC_ADD_CLOUD_FV_FLU_0X12_WORD1] =
        teid_le & 0xFFFF;
    pfilter->general_fields[I40E_AQC_ADD_CLOUD_FV_FLU_0X12_WORD2] = 0x0;
    big_buffer = 1;
    break;
  case I40E_TUNNEL_TYPE_GTPU:
    ...
    pfilter->general_fields[I40E_AQC_ADD_CLOUD_FV_FLU_0X13_WORD1] =
        teid_le & 0xFFFF;
    pfilter->general_fields[I40E_AQC_ADD_CLOUD_FV_FLU_0X13_WORD2] = 0x0;
    big_buffer = 1;
    break;
  case I40E_TUNNEL_TYPE_QINQ:
    if (!pf->qinq_replace_flag) {
      ...
      if (ret < 0)
        PMD_DRV_LOG(DEBUG, "QinQ tunnel filter already created.");
  ...
  if (tunnel_filter->tunnel_type == I40E_TUNNEL_TYPE_MPLSoUDP)
    pfilter->element.flags = I40E_AQC_ADD_CLOUD_FILTER_0X11;
  else if (tunnel_filter->tunnel_type == I40E_TUNNEL_TYPE_MPLSoGRE)
    pfilter->element.flags = I40E_AQC_ADD_CLOUD_FILTER_0X12;
    ...
    pfilter->element.flags |= I40E_AQC_ADD_CLOUD_FILTER_0X10;
  ...
  pfilter->element.queue_number = rte_cpu_to_le_16(tunnel_filter->queue_id);
  ...
  if (add) {
    if (big_buffer)
      ret = i40e_aq_add_cloud_filters_bb(hw, vsi->seid, cld_filter, 1);
    else
      ret = i40e_aq_add_cloud_filters(hw, vsi->seid, &cld_filter->element, 1);
    if (ret < 0) {
    ...
    if (big_buffer)
      ret = i40e_aq_rem_cloud_filters_bb(hw, vsi->seid, cld_filter, 1);
    else
      ret = i40e_aq_rem_cloud_filters(hw, vsi->seid, &cld_filter->element, 1);
    if (ret < 0) {
...
static int i40e_get_vxlan_port_idx(struct i40e_pf *pf, uint16_t port) {
  uint8_t i;
...
static int i40e_add_vxlan_port(struct i40e_pf *pf, uint16_t port,
                               int udp_type) {
  int idx, ret;
  ...
  if (idx < 0) {
    PMD_DRV_LOG(ERR, "Maximum number of UDP ports reached, not adding port %d",
                port);
    return -ENOSPC;
  }

  ret = i40e_aq_add_udp_tunnel(hw, port, udp_type, &filter_idx, NULL);
  if (ret < 0) {
    PMD_DRV_LOG(ERR, "Failed to add VXLAN UDP port %d", port);
    return -1;
  }

  PMD_DRV_LOG(INFO, "Added port %d with AQ command with index %d", port,
              filter_idx);
...
static int i40e_del_vxlan_port(struct i40e_pf *pf, uint16_t port) {
  int idx;
  struct i40e_hw *hw = I40E_PF_TO_HW(pf);
  ...
  PMD_DRV_LOG(INFO, "Deleted port %d with AQ command with index %d", port, idx);
...
static void i40e_pf_global_rss_reset(struct i40e_pf *pf) {
  struct i40e_hw *hw = I40E_PF_TO_HW(pf);
...
int i40e_pf_reset_rss_key(struct i40e_pf *pf) {
  const uint8_t key_len = (I40E_PFQF_HKEY_MAX_INDEX + 1) * sizeof(uint32_t);
  uint8_t *rss_key;
  ...
  if (!rss_key ||
    ...
    static uint32_t rss_key_default[] = {
        0x6b793944, 0x23504cb5, 0x5bea75b6, 0x309f4f12, 0x3dc0a2b8,
        0x024ddcdf, 0x339b8ca0, 0x4c4af64a, 0x34fac605, 0x55d85839,
        0x3a58997d, 0x2ec938e1, 0x66031581};
...
static int i40e_pf_rss_reset(struct i40e_pf *pf) {
  struct i40e_hw *hw = I40E_PF_TO_HW(pf);
...
int i40e_dev_set_gre_key_len(struct i40e_hw *hw, uint8_t len) {
  ...
  if (reg != val) {
    ret =
        i40e_aq_debug_write_global_register(hw, I40E_GL_PRS_FVBM(2), reg, NULL);
    if (ret != 0)
      return ret;
    PMD_DRV_LOG(DEBUG,
 ...
 */
static uint64_t i40e_get_valid_input_set(enum i40e_filter_pctype pctype,
                                         enum rte_filter_type filter) {
  uint64_t valid;

  static const uint64_t valid_hash_inset_table[] = {
      [I40E_FILTER_PCTYPE_FRAG_IPV4] =
          I40E_INSET_DMAC | I40E_INSET_SMAC | I40E_INSET_VLAN_OUTER |
          I40E_INSET_VLAN_INNER | I40E_INSET_VLAN_TUNNEL | I40E_INSET_IPV4_SRC |
          I40E_INSET_IPV4_DST | I40E_INSET_IPV4_TOS | I40E_INSET_IPV4_PROTO |
          I40E_INSET_IPV4_TTL | I40E_INSET_TUNNEL_DMAC | I40E_INSET_TUNNEL_ID |
          I40E_INSET_FLEX_PAYLOAD,
      [I40E_FILTER_PCTYPE_NONF_IPV4_UDP] =
          I40E_INSET_DMAC | I40E_INSET_SMAC | I40E_INSET_VLAN_OUTER |
          I40E_INSET_VLAN_INNER | I40E_INSET_VLAN_TUNNEL | I40E_INSET_IPV4_TOS |
          I40E_INSET_IPV4_PROTO | I40E_INSET_IPV4_TTL | I40E_INSET_TUNNEL_DMAC |
          I40E_INSET_TUNNEL_ID | I40E_INSET_IPV4_SRC | I40E_INSET_IPV4_DST |
          I40E_INSET_SRC_PORT | I40E_INSET_DST_PORT | I40E_INSET_FLEX_PAYLOAD,
      ...
      [I40E_FILTER_PCTYPE_NONF_IPV4_TCP] =
          ...
          I40E_INSET_IPV4_PROTO | I40E_INSET_IPV4_TTL | I40E_INSET_TUNNEL_DMAC |
          I40E_INSET_TUNNEL_ID | I40E_INSET_IPV4_SRC | I40E_INSET_IPV4_DST |
          I40E_INSET_SRC_PORT | I40E_INSET_DST_PORT | I40E_INSET_TCP_FLAGS |
          I40E_INSET_FLEX_PAYLOAD,
      ...
      [I40E_FILTER_PCTYPE_FRAG_IPV6] =
          I40E_INSET_DMAC | I40E_INSET_SMAC | I40E_INSET_VLAN_OUTER |
          I40E_INSET_VLAN_INNER | I40E_INSET_VLAN_TUNNEL | I40E_INSET_IPV6_TC |
      ...
      [I40E_FILTER_PCTYPE_NONF_IPV6_UDP] =
          ...
          I40E_INSET_IPV6_DST | I40E_INSET_SRC_PORT | I40E_INSET_DST_PORT |
          I40E_INSET_FLEX_PAYLOAD,
      ...
      [I40E_FILTER_PCTYPE_NONF_IPV6_OTHER] =
          ...
          I40E_INSET_IPV6_FLOW | I40E_INSET_IPV6_NEXT_HDR |
          I40E_INSET_IPV6_HOP_LIMIT | I40E_INSET_IPV6_SRC |
          I40E_INSET_IPV6_DST | I40E_INSET_TUNNEL_ID | I40E_INSET_FLEX_PAYLOAD,
      [I40E_FILTER_PCTYPE_L2_PAYLOAD] =
          I40E_INSET_DMAC | I40E_INSET_SMAC | I40E_INSET_VLAN_OUTER |
          I40E_INSET_VLAN_INNER | I40E_INSET_VLAN_TUNNEL |
  ...
  static const uint64_t valid_fdir_inset_table[] = {
      ...
      [I40E_FILTER_PCTYPE_NONF_IPV4_UDP] =
          I40E_INSET_DMAC | I40E_INSET_SMAC | I40E_INSET_VLAN_OUTER |
          I40E_INSET_VLAN_INNER | I40E_INSET_IPV4_SRC | I40E_INSET_IPV4_DST |
          I40E_INSET_IPV4_TOS | I40E_INSET_IPV4_TTL | I40E_INSET_SRC_PORT |
          I40E_INSET_DST_PORT,
      [I40E_FILTER_PCTYPE_NONF_UNICAST_IPV4_UDP] =
          I40E_INSET_VLAN_OUTER | I40E_INSET_VLAN_INNER | I40E_INSET_IPV4_SRC |
          I40E_INSET_IPV4_DST | I40E_INSET_IPV4_TOS | I40E_INSET_IPV4_TTL |
      ...
      [I40E_FILTER_PCTYPE_NONF_IPV4_OTHER] =
          I40E_INSET_DMAC | I40E_INSET_SMAC | I40E_INSET_VLAN_OUTER |
          I40E_INSET_VLAN_INNER | I40E_INSET_IPV4_SRC | I40E_INSET_IPV4_DST |
          I40E_INSET_IPV4_TOS | I40E_INSET_IPV4_PROTO | I40E_INSET_IPV4_TTL,
      [I40E_FILTER_PCTYPE_FRAG_IPV6] =
          I40E_INSET_VLAN_OUTER | I40E_INSET_VLAN_INNER | I40E_INSET_IPV6_SRC |
          I40E_INSET_IPV6_DST | I40E_INSET_IPV6_TC | I40E_INSET_IPV6_NEXT_HDR |
          I40E_INSET_IPV6_HOP_LIMIT,
      [I40E_FILTER_PCTYPE_NONF_IPV6_UDP] =
          I40E_INSET_VLAN_OUTER | I40E_INSET_VLAN_INNER | I40E_INSET_IPV6_SRC |
          I40E_INSET_IPV6_DST | I40E_INSET_IPV6_TC | I40E_INSET_IPV6_HOP_LIMIT |
          I40E_INSET_SRC_PORT | I40E_INSET_DST_PORT,
      [I40E_FILTER_PCTYPE_NONF_UNICAST_IPV6_UDP] =
          I40E_INSET_VLAN_OUTER | I40E_INSET_VLAN_INNER | I40E_INSET_IPV6_SRC |
          I40E_INSET_IPV6_DST | I40E_INSET_IPV6_TC | I40E_INSET_IPV6_HOP_LIMIT |
      ...
      [I40E_FILTER_PCTYPE_NONF_IPV6_OTHER] =
          ...
          I40E_INSET_IPV6_DST | I40E_INSET_IPV6_TC | I40E_INSET_IPV6_NEXT_HDR |
          I40E_INSET_IPV6_HOP_LIMIT,
      [I40E_FILTER_PCTYPE_L2_PAYLOAD] = I40E_INSET_VLAN_OUTER |
...
uint64_t i40e_get_default_input_set(uint16_t pctype) {
  static const uint64_t default_inset_table[] = {
      ...
      [I40E_FILTER_PCTYPE_NONF_IPV4_UDP] =
          I40E_INSET_IPV4_SRC | I40E_INSET_IPV4_DST | I40E_INSET_SRC_PORT |
          I40E_INSET_DST_PORT,
      [I40E_FILTER_PCTYPE_NONF_UNICAST_IPV4_UDP] =
          I40E_INSET_IPV4_SRC | I40E_INSET_IPV4_DST | I40E_INSET_SRC_PORT |
          I40E_INSET_DST_PORT,
      ...
      [I40E_FILTER_PCTYPE_NONF_IPV6_UDP] =
          I40E_INSET_IPV6_SRC | I40E_INSET_IPV6_DST | I40E_INSET_SRC_PORT |
          I40E_INSET_DST_PORT,
      [I40E_FILTER_PCTYPE_NONF_UNICAST_IPV6_UDP] =
          I40E_INSET_IPV6_SRC | I40E_INSET_IPV6_DST | I40E_INSET_SRC_PORT |
          I40E_INSET_DST_PORT,
      ...
      [I40E_FILTER_PCTYPE_NONF_IPV6_OTHER] =
          I40E_INSET_IPV6_SRC | I40E_INSET_IPV6_DST,
      [I40E_FILTER_PCTYPE_L2_PAYLOAD] = I40E_INSET_LAST_ETHER_TYPE,
  };
...
uint64_t i40e_translate_input_set_reg(enum i40e_mac_type type, uint64_t input) {
  ...
  static const struct inset_map inset_map_common[] = {
      ...
      {I40E_INSET_TUNNEL_DMAC, I40E_REG_INSET_TUNNEL_L2_INNER_DST_MAC},
      {I40E_INSET_TUNNEL_IPV4_DST, I40E_REG_INSET_TUNNEL_L3_DST_IP4},
      {I40E_INSET_TUNNEL_IPV6_DST, I40E_REG_INSET_TUNNEL_L3_DST_IP6},
      {I40E_INSET_TUNNEL_SRC_PORT, I40E_REG_INSET_TUNNEL_L4_UDP_SRC_PORT},
      {I40E_INSET_TUNNEL_DST_PORT, I40E_REG_INSET_TUNNEL_L4_UDP_DST_PORT},
...
static int i40e_get_inset_field_offset(struct i40e_hw *hw,
                                       uint32_t pit_reg_start,
                                       uint32_t pit_reg_count,
                                       uint32_t hdr_off) {
...
int i40e_generate_inset_mask_reg(struct i40e_hw *hw, uint64_t inset,
  ...
  for (i = 0; i < RTE_DIM(inset_mask_offset_map); i++) {
    ...
    if (idx >= nb_elem) {
      PMD_DRV_LOG(ERR, "Configuration of inset mask out of range %u", nb_elem);
      return -ERANGE;
    }

    mask[idx] =
        I40E_GLQF_PIT_BUILD((uint32_t)offset, inset_mask_offset_map[i].mask);
    idx++;
  }
...
void i40e_check_write_global_reg(struct i40e_hw *hw, uint32_t addr,
                                 uint32_t val) {
  uint32_t reg = i40e_read_rx_ctl(hw, addr);
  struct rte_eth_dev_data *dev_data =
      ((struct i40e_adapter *)hw->back)->pf.dev_data;
...
static void i40e_filter_input_set_init(struct i40e_pf *pf) {
  ...
  for (pctype = I40E_FILTER_PCTYPE_NONF_IPV4_UDP;
    ...
    i40e_check_write_reg(
        hw, I40E_PRTQF_FD_INSET(pctype, 1),
        (uint32_t)((inset_reg >> I40E_32_BIT_WIDTH) & UINT32_MAX));
    if (!pf->support_multi_driver) {
      i40e_check_write_global_reg(hw, I40E_GLQF_HASH_INSET(0, pctype),
                                  (uint32_t)(inset_reg & UINT32_MAX));
      i40e_check_write_global_reg(
          hw, I40E_GLQF_HASH_INSET(1, pctype),
          (uint32_t)((inset_reg >> I40E_32_BIT_WIDTH) & UINT32_MAX));
      ...
      for (i = num; i < I40E_INSET_MASK_NUM_REG; i++) {
        i40e_check_write_global_reg(hw, I40E_GLQF_FD_MSK(i, pctype), 0);
        i40e_check_write_global_reg(hw, I40E_GLQF_HASH_MSK(i, pctype), 0);
      }
    } else {
      PMD_DRV_LOG(ERR, "Input set setting is not supported.");
    }
...
int i40e_set_hash_inset(struct i40e_hw *hw, uint64_t input_set, uint32_t pctype,
                        bool add) {
  struct i40e_pf *pf = &((struct i40e_adapter *)hw->back)->pf;
  uint32_t mask_reg[I40E_INSET_MASK_NUM_REG] = {0};
  ...
  for (i = 0; i < num; i++)
    i40e_check_write_global_reg(hw, I40E_GLQF_HASH_MSK(i, pctype), mask_reg[i]);
  /*clear unused mask registers of the pctype */
  for (i = num; i < I40E_INSET_MASK_NUM_REG; i++)
    i40e_check_write_global_reg(hw, I40E_GLQF_HASH_MSK(i, pctype), 0);
  I40E_WRITE_FLUSH(hw);
...
struct i40e_ethertype_filter *i40e_sw_ethertype_filter_lookup(
    struct i40e_ethertype_rule *ethertype_rule,
...
int i40e_ethertype_filter_set(struct i40e_pf *pf,
  ...
  node = i40e_sw_ethertype_filter_lookup(ethertype_rule, &check_filter.input);
  if (add && node) {
  ...
  ret = i40e_aq_add_rem_control_packet_filter(
      hw, filter->mac_addr.addr_bytes, filter->ether_type, flags,
      pf->main_vsi->seid, filter->queue, add, &stats, NULL);

  PMD_DRV_LOG(INFO,
              "add/rem control packet filter, return %d, mac_etype_used = %u, "
              "etype_used = %u, mac_etype_free = %u, etype_free = %u",
              ret, stats.mac_etype_used, stats.etype_used, stats.mac_etype_free,
              stats.etype_free);
  if (ret < 0)
    return -ENOSYS;
  ...
  if (add) {
    ethertype_filter =
        rte_zmalloc("ethertype_filter", sizeof(*ethertype_filter), 0);
    if (ethertype_filter == NULL) {
      PMD_DRV_LOG(ERR, "Failed to alloc memory.");
      return -ENOMEM;
    }

    rte_memcpy(ethertype_filter, &check_filter, sizeof(check_filter));
 ...
 */
static void i40e_enable_extended_tag(struct rte_eth_dev *dev) {
  struct rte_pci_device *pci_dev = RTE_ETH_DEV_TO_PCI(dev);
  uint32_t buf = 0;
  int ret;

  ret = rte_pci_read_config(pci_dev, &buf, sizeof(buf), PCI_DEV_CAP_REG);
  if (ret < 0) {
    PMD_DRV_LOG(ERR, "Failed to read PCI offset 0x%x", PCI_DEV_CAP_REG);
    return;
  }
  ...
  buf = 0;
  ret = rte_pci_read_config(pci_dev, &buf, sizeof(buf), PCI_DEV_CTRL_REG);
  if (ret < 0) {
    PMD_DRV_LOG(ERR, "Failed to read PCI offset 0x%x", PCI_DEV_CTRL_REG);
    return;
  }
  ...
  ret = rte_pci_write_config(pci_dev, &buf, sizeof(buf), PCI_DEV_CTRL_REG);
  if (ret < 0) {
    PMD_DRV_LOG(ERR, "Failed to write PCI offset 0x%x", PCI_DEV_CTRL_REG);
    return;
  }
}
 ...
 */
static bool i40e_get_swr_pm_cfg(struct i40e_hw *hw, uint32_t *value) {
#define I40E_GL_SWR_PM_EF_DEVICE(dev)                                          \
  .device_id = (dev), .val = I40E_GL_SWR_PM_UP_THR_EF_VALUE

#define I40E_GL_SWR_PM_SF_DEVICE(dev)                                          \
  .device_id = (dev), .val = I40E_GL_SWR_PM_UP_THR_SF_VALUE
...
static int i40e_dev_sync_phy_type(struct i40e_hw *hw) {
  ...
  while (status) {
    PMD_INIT_LOG(WARNING, "Failed to sync phy type: status=%d", status);
    retries++;
    rte_delay_us(100000);
    if (retries < 5)
      status = i40e_aq_get_phy_capabilities(hw, false, true, &phy_ab, NULL);
  ...
  for (i = 0; i < RTE_DIM(reg_table); i++) {
    if (reg_table[i].addr == I40E_GL_SWR_PRI_JOIN_MAP_0) {
      if (hw->mac.type == I40E_MAC_X722) /* For X722 */
        reg_table[i].val = I40E_X722_GL_SWR_PRI_JOIN_MAP_0_VALUE;
      else /* For X710/XL710/XXV710 */
          if (hw->aq.fw_maj_ver < 6)
        reg_table[i].val = I40E_GL_SWR_PRI_JOIN_MAP_0_VALUE_1;
      else
        reg_table[i].val = I40E_GL_SWR_PRI_JOIN_MAP_0_VALUE_2;
    }

    if (reg_table[i].addr == I40E_GL_SWR_PRI_JOIN_MAP_2) {
      if (hw->mac.type == I40E_MAC_X722) /* For X722 */
        reg_table[i].val = I40E_X722_GL_SWR_PRI_JOIN_MAP_2_VALUE;
      else /* For X710/XL710/XXV710 */
        reg_table[i].val = I40E_GL_SWR_PRI_JOIN_MAP_2_VALUE;
    }
    ...
    ret = i40e_aq_debug_read_register(hw, reg_table[i].addr, &reg, NULL);
    if (ret < 0) {
      PMD_DRV_LOG(ERR, "Failed to read from 0x%" PRIx32, reg_table[i].addr);
      break;
    }
    PMD_DRV_LOG(DEBUG, "Read from 0x%" PRIx32 ": 0x%" PRIx64, reg_table[i].addr,
                reg);
    if (reg == reg_table[i].val)
      continue;

    ret = i40e_aq_debug_write_register(hw, reg_table[i].addr, reg_table[i].val,
                                       NULL);
    if (ret < 0) {
      PMD_DRV_LOG(ERR,
    ...
    PMD_DRV_LOG(DEBUG,
                "Write 0x%" PRIx64 " to the address of "
                "0x%" PRIx32,
                reg_table[i].val, reg_table[i].addr);
  }
}
...
static int i40e_config_qinq(struct i40e_hw *hw, struct i40e_vsi *vsi) {
  ...
  if ((reg & I40E_VSI_TSR_QINQ_CONFIG) != I40E_VSI_TSR_QINQ_CONFIG) {
    ...
    ret =
        i40e_aq_debug_write_register(hw, I40E_VSI_TSR(vsi->vsi_id), reg, NULL);
    if (ret < 0) {
      PMD_DRV_LOG(ERR, "Failed to update VSI_TSR[%d]", vsi->vsi_id);
      return I40E_ERR_CONFIG;
    }
  ...
  if ((reg & 0xff) != I40E_VSI_L2TAGSTXVALID_QINQ) {
    ...
    ret = i40e_aq_debug_write_register(hw, I40E_VSI_L2TAGSTXVALID(vsi->vsi_id),
                                       reg, NULL);
    if (ret < 0) {
...
static uint64_t i40e_read_systime_cyclecounter(struct rte_eth_dev *dev) {
  struct i40e_hw *hw = I40E_DEV_PRIVATE_TO_HW(dev->data->dev_private);
  uint64_t systim_cycles;

  systim_cycles = (uint64_t)I40E_READ_REG(hw, I40E_PRTTSYN_TIME_L);
  systim_cycles |= (uint64_t)I40E_READ_REG(hw, I40E_PRTTSYN_TIME_H) << 32;

  return systim_cycles;
}

static uint64_t i40e_read_rx_tstamp_cyclecounter(struct rte_eth_dev *dev,
                                                 uint8_t index) {
  struct i40e_hw *hw = I40E_DEV_PRIVATE_TO_HW(dev->data->dev_private);
  uint64_t rx_tstamp;

  rx_tstamp = (uint64_t)I40E_READ_REG(hw, I40E_PRTTSYN_RXTIME_L(index));
  rx_tstamp |= (uint64_t)I40E_READ_REG(hw, I40E_PRTTSYN_RXTIME_H(index)) << 32;

  return rx_tstamp;
}

static uint64_t i40e_read_tx_tstamp_cyclecounter(struct rte_eth_dev *dev) {
  struct i40e_hw *hw = I40E_DEV_PRIVATE_TO_HW(dev->data->dev_private);
  uint64_t tx_tstamp;

  tx_tstamp = (uint64_t)I40E_READ_REG(hw, I40E_PRTTSYN_TXTIME_L);
  tx_tstamp |= (uint64_t)I40E_READ_REG(hw, I40E_PRTTSYN_TXTIME_H) << 32;

  return tx_tstamp;
}

static void i40e_start_timecounters(struct rte_eth_dev *dev) {
  struct i40e_hw *hw = I40E_DEV_PRIVATE_TO_HW(dev->data->dev_private);
 ...
 * Returns 0 on success, negative value on failure
 */
static int i40e_parse_dcb_configure(struct rte_eth_dev *dev,
  ...
  for (i = 0; i < I40E_MAX_USER_PRIORITY; i++)
    dcb_cfg->etscfg.prioritytable[i] = dcb_rx_conf->dcb_tc[i];
...
i40e_vsi_update_queue_mapping(struct i40e_vsi *vsi,
  ...
  qpnum_per_tc = RTE_MIN(i40e_align_floor(qpnum_per_tc), I40E_MAX_Q_PER_TC);
  bsf = rte_bsf32(qpnum_per_tc);
 ...
 * Returns 0 on success, negative value on failure
 */
static enum i40e_status_code i40e_config_switch_comp_tc(struct i40e_veb *veb,
                                                        uint8_t tc_map) {
  ...
  ret = i40e_aq_config_switch_comp_bw_config(hw, veb->seid, &veb_bw, NULL);
  if (ret) {
    PMD_INIT_LOG(
        ERR, "AQ command Config switch_comp BW allocation per TC failed = %d",
        hw->aq.asq_last_status);
    return ret;
  }

  memset(&ets_query, 0, sizeof(ets_query));
  ret = i40e_aq_query_switch_comp_ets_config(hw, veb->seid, &ets_query, NULL);
  if (ret != I40E_SUCCESS) {
    PMD_DRV_LOG(ERR, "Failed to get switch_comp ETS configuration %u",
                hw->aq.asq_last_status);
    return ret;
  }
  memset(&bw_query, 0, sizeof(bw_query));
  ret = i40e_aq_query_switch_comp_bw_config(hw, veb->seid, &bw_query, NULL);
  if (ret != I40E_SUCCESS) {
    PMD_DRV_LOG(ERR, "Failed to get switch_comp bandwidth configuration %u",
                hw->aq.asq_last_status);
    return ret;
  }
  ...
  bw_max = rte_le_to_cpu_16(bw_query.tc_bw_max[0]) |
           (rte_le_to_cpu_16(bw_query.tc_bw_max[1]) << I40E_16_BIT_WIDTH);
  for (i = 0; i < I40E_MAX_TRAFFIC_CLASS; i++) {
    veb->bw_info.bw_ets_share_credits[i] = bw_query.tc_bw_share_credits[i];
    veb->bw_info.bw_ets_credits[i] = rte_le_to_cpu_16(bw_query.tc_bw_limits[i]);
    /* 4 bits per TC, 4th bit is reserved */
    veb->bw_info.bw_ets_max[i] = (uint8_t)((bw_max >> (i * I40E_4_BIT_WIDTH)) &
                                           RTE_LEN2MASK(3, uint8_t));
 ...
 * Returns 0 on success, negative value on failure
 */
static enum i40e_status_code i40e_vsi_config_tc(struct i40e_vsi *vsi,
                                                uint8_t tc_map) {
  ...
  if (ret) {
    PMD_INIT_LOG(ERR, "Failed updating vsi bw info, err %s aq_err %s",
 ...
 */
static enum i40e_status_code
i40e_dcb_hw_configure(struct i40e_pf *pf, struct i40e_dcbx_config *new_cfg,
                      uint8_t tc_map) {
  struct i40e_hw *hw = I40E_PF_TO_HW(pf);
  ...
  *old_cfg = *new_cfg;
  ...
  i40e_aq_get_dcb_config(hw, I40E_AQ_LLDP_MIB_LOCAL, 0, &hw->local_dcbx_config);

  /* if Veb is created, need to update TC of it at first */
  if (main_vsi->veb) {
    ret = i40e_config_switch_comp_tc(main_vsi->veb, tc_map);
    if (ret)
      PMD_INIT_LOG(WARNING, "Failed configuring TC for VEB seid=%d",
                   main_vsi->veb->seid);
  }
  /* Update each VSI */
  ...
  if (main_vsi->veb) {
    TAILQ_FOREACH(vsi_list, &main_vsi->veb->head, list) {
      ...
      if (vsi_list->vsi->type == I40E_VSI_VMDQ2)
        ret = i40e_vsi_config_tc(vsi_list->vsi, tc_map);
      else
        ret = i40e_vsi_config_tc(vsi_list->vsi, I40E_DEFAULT_TCMAP);
      if (ret)
        PMD_INIT_LOG(WARNING, "Failed configuring TC for VSI seid=%d",
                     vsi_list->vsi->seid);
      /* continue */
    }
  }
...
int i40e_dcb_init_configure(struct rte_eth_dev *dev, bool sw_dcb) {
  ...
  if (sw_dcb == TRUE) {
     ...
     */
    if ((ret == I40E_SUCCESS) ||
        (ret != I40E_SUCCESS && hw->aq.asq_last_status == I40E_AQ_RC_EPERM)) {
      memset(&hw->local_dcbx_config, 0, sizeof(struct i40e_dcbx_config));
      ...
      hw->local_dcbx_config.etsrec = hw->local_dcbx_config.etscfg;
      hw->local_dcbx_config.pfc.willing = 0;
      hw->local_dcbx_config.pfc.pfccap = I40E_MAX_TRAFFIC_CLASS;
      /* FW needs one App to configure HW */
      hw->local_dcbx_config.numapps = 1;
      hw->local_dcbx_config.app[0].selector = I40E_APP_SEL_ETHTYPE;
      hw->local_dcbx_config.app[0].priority = 3;
      hw->local_dcbx_config.app[0].protocolid = I40E_APP_PROTOID_FCOE;
      ret = i40e_set_dcb_config(hw);
      if (ret) {
        PMD_INIT_LOG(ERR, "default dcb config fails. err = %d, aq_err = %d.",
    ...
    if (!ret) {
      ...
      PMD_INIT_LOG(ERR, "DCBX configuration failed, err = %d, aq_err = %d.",
                   ret, hw->aq.asq_last_status);
      return -ENOTSUP;
    }
  }
...
static int i40e_dev_rx_queue_intr_enable(struct rte_eth_dev *dev,
  ...
  if (msix_intr == I40E_MISC_VEC_ID)
    ...
    I40E_WRITE_REG(hw, I40E_PFINT_DYN_CTLN(msix_intr - I40E_RX_VEC_START),
                   I40E_PFINT_DYN_CTLN_INTENA_MASK |
                       I40E_PFINT_DYN_CTLN_CLEARPBA_MASK |
                       I40E_PFINT_DYN_CTLN_ITR_INDX_MASK);
 ...
 * 0x265c00--0x266000
 */
static inline int i40e_valid_regs(enum i40e_mac_type type,
                                  uint32_t reg_offset) {
  if ((type != I40E_MAC_X722) &&
...
static int i40e_get_regs(struct rte_eth_dev *dev,
  ...
  while (i40e_regs_adminq[reg_idx].name) {
    ...
    for (arr_idx = 0; arr_idx <= reg_info->count1; arr_idx++)
      for (arr_idx2 = 0; arr_idx2 <= reg_info->count2; arr_idx2++) {
        reg_offset = arr_idx * reg_info->stride1 + arr_idx2 * reg_info->stride2;
        reg_offset += reg_info->base_addr;
        ptr_data[reg_offset >> 2] = i40e_read_rx_ctl(hw, reg_offset);
      }
  }
    ...
    for (arr_idx = 0; arr_idx <= reg_info->count1; arr_idx++)
      for (arr_idx2 = 0; arr_idx2 <= reg_info->count2; arr_idx2++) {
        ...
        if (!i40e_valid_regs(hw->mac.type, reg_offset))
          ...
          ptr_data[reg_offset >> 2] = I40E_READ_REG(hw, reg_offset);
      }
  }
...
static int i40e_get_eeprom(struct rte_eth_dev *dev,
  ...
  if (offset > hw->nvm.sr_size || offset + length > hw->nvm.sr_size) {
...
static int i40e_get_module_info(struct rte_eth_dev *dev,
  ...
  if (hw->phy.link_info.phy_type == I40E_PHY_TYPE_EMPTY) {
    PMD_DRV_LOG(ERR, "Cannot read module EEPROM memory. "
                     "No module connected.\n");
    return -EINVAL;
  }
  ...
  case I40E_MODULE_TYPE_SFP:
    status = i40e_aq_get_phy_register(
        hw, I40E_AQ_PHY_REG_ACCESS_EXTERNAL_MODULE, I40E_I2C_EEPROM_DEV_ADDR, 1,
        I40E_MODULE_SFF_8472_COMP, &sff8472_comp, NULL);
    if (status)
      return -EIO;

    status = i40e_aq_get_phy_register(
        hw, I40E_AQ_PHY_REG_ACCESS_EXTERNAL_MODULE, I40E_I2C_EEPROM_DEV_ADDR, 1,
        I40E_MODULE_SFF_8472_SWAP, &sff8472_swap, NULL);
    if (status)
      return -EIO;
  ...
  case I40E_MODULE_TYPE_QSFP_PLUS:
    ...
    status = i40e_aq_get_phy_register(
        hw, I40E_AQ_PHY_REG_ACCESS_EXTERNAL_MODULE, 0, 1,
        I40E_MODULE_REVISION_ADDR, &sff8636_rev, NULL);
    if (status)
      return -EIO;
...
static int i40e_get_module_eeprom(struct rte_eth_dev *dev,
  ...
  for (i = 0; i < info->length; i++) {
    ...
    status =
        i40e_aq_get_phy_register(hw, I40E_AQ_PHY_REG_ACCESS_EXTERNAL_MODULE,
...
static int i40e_dev_mtu_set(struct rte_eth_dev *dev,
...
static void i40e_ethertype_filter_restore(struct i40e_pf *pf) {
  ...
  TAILQ_FOREACH(f, ethertype_list, rules) {
    ...
    i40e_aq_add_rem_control_packet_filter(
        hw, f->input.mac_addr.addr_bytes, f->input.ether_type, flags,
        pf->main_vsi->seid, f->queue, 1, &stats, NULL);
  }
  PMD_DRV_LOG(INFO,
              "Ethertype filter:"
              " mac_etype_used = %u, etype_used = %u,"
              " mac_etype_free = %u, etype_free = %u",
              stats.mac_etype_used, stats.etype_used, stats.mac_etype_free,
              stats.etype_free);
}
...
static void i40e_tunnel_filter_restore(struct i40e_pf *pf) {
  ...
  struct i40e_vsi *vsi;
  struct i40e_pf_vf *vf;
  struct i40e_tunnel_filter_list *tunnel_list = &pf->tunnel.tunnel_list;
  ...
  TAILQ_FOREACH(f, tunnel_list, rules) {
    ...
    rte_memcpy(cld_filter.general_fields, f->input.general_fields,
               sizeof(f->input.general_fields));

    if (((f->input.flags & I40E_AQC_ADD_CLOUD_FILTER_0X11) ==
         I40E_AQC_ADD_CLOUD_FILTER_0X11) ||
        ((f->input.flags & I40E_AQC_ADD_CLOUD_FILTER_0X12) ==
         I40E_AQC_ADD_CLOUD_FILTER_0X12) ||
        ((f->input.flags & I40E_AQC_ADD_CLOUD_FILTER_0X10) ==
         I40E_AQC_ADD_CLOUD_FILTER_0X10))
      big_buffer = 1;

    if (big_buffer)
      i40e_aq_add_cloud_filters_bb(hw, vsi->seid, &cld_filter, 1);
    else
      i40e_aq_add_cloud_filters(hw, vsi->seid, &cld_filter.element, 1);
  }
}
...
struct i40e_customized_pctype *i40e_find_customized_pctype(struct i40e_pf *pf,
                                                           uint8_t index) {
  int i;
...
static int i40e_update_customized_pctype(struct rte_eth_dev *dev, uint8_t *pkg,
  ...
  if (op != RTE_PMD_I40E_PKG_OP_WR_ADD && op != RTE_PMD_I40E_PKG_OP_WR_DEL) {
  ...
  for (i = 0; i < pctype_num; i++) {
    ...
    if (!strcmp(name, "GTPC"))
      new_pctype = i40e_find_customized_pctype(pf, I40E_CUSTOMIZED_GTPC);
    else if (!strcmp(name, "GTPU_IPV4"))
      new_pctype = i40e_find_customized_pctype(pf, I40E_CUSTOMIZED_GTPU_IPV4);
    else if (!strcmp(name, "GTPU_IPV6"))
      new_pctype = i40e_find_customized_pctype(pf, I40E_CUSTOMIZED_GTPU_IPV6);
    else if (!strcmp(name, "GTPU"))
      new_pctype = i40e_find_customized_pctype(pf, I40E_CUSTOMIZED_GTPU);
    else if (!strcmp(name, "IPV4_L2TPV3"))
      new_pctype = i40e_find_customized_pctype(pf, I40E_CUSTOMIZED_IPV4_L2TPV3);
    else if (!strcmp(name, "IPV6_L2TPV3"))
      new_pctype = i40e_find_customized_pctype(pf, I40E_CUSTOMIZED_IPV6_L2TPV3);
    else if (!strcmp(name, "IPV4_ESP"))
      new_pctype = i40e_find_customized_pctype(pf, I40E_CUSTOMIZED_ESP_IPV4);
    else if (!strcmp(name, "IPV6_ESP"))
      new_pctype = i40e_find_customized_pctype(pf, I40E_CUSTOMIZED_ESP_IPV6);
    else if (!strcmp(name, "IPV4_UDP_ESP"))
      new_pctype =
          i40e_find_customized_pctype(pf, I40E_CUSTOMIZED_ESP_IPV4_UDP);
    else if (!strcmp(name, "IPV6_UDP_ESP"))
      new_pctype =
          i40e_find_customized_pctype(pf, I40E_CUSTOMIZED_ESP_IPV6_UDP);
    else if (!strcmp(name, "IPV4_AH"))
      new_pctype = i40e_find_customized_pctype(pf, I40E_CUSTOMIZED_AH_IPV4);
    else if (!strcmp(name, "IPV6_AH"))
      new_pctype = i40e_find_customized_pctype(pf, I40E_CUSTOMIZED_AH_IPV6);
    if (new_pctype) {
...
static int i40e_update_customized_ptype(struct rte_eth_dev *dev, uint8_t *pkg,
                                        uint32_t pkg_size, uint32_t proto_num,
                                        struct rte_pmd_i40e_proto_info *proto,
                                        enum rte_pmd_i40e_package_op op) {
    ...
    for (j = 0; j < RTE_PMD_I40E_PROTO_NUM; j++) {
      ...
      for (n = 0; n < proto_num; n++) {
        ...
        if (!strncasecmp(name, "PPPOE", 5))
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_L2_ETHER_PPPOE;
        else if (!strncasecmp(name, "IPV4FRAG", 8) && !in_tunnel) {
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_L3_IPV4_EXT_UNKNOWN;
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_L4_FRAG;
        } else if (!strncasecmp(name, "IPV4FRAG", 8) && in_tunnel) {
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_INNER_L3_IPV4_EXT_UNKNOWN;
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_INNER_L4_FRAG;
        } else if (!strncasecmp(name, "OIPV4", 5)) {
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_L3_IPV4_EXT_UNKNOWN;
          in_tunnel = true;
        } else if (!strncasecmp(name, "IPV4", 4) && !in_tunnel)
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_L3_IPV4_EXT_UNKNOWN;
        else if (!strncasecmp(name, "IPV4", 4) && in_tunnel)
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_INNER_L3_IPV4_EXT_UNKNOWN;
        else if (!strncasecmp(name, "IPV6FRAG", 8) && !in_tunnel) {
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_L3_IPV6_EXT_UNKNOWN;
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_L4_FRAG;
        } else if (!strncasecmp(name, "IPV6FRAG", 8) && in_tunnel) {
          ...
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_L3_IPV6_EXT_UNKNOWN;
          in_tunnel = true;
        } else if (!strncasecmp(name, "IPV6", 4) && !in_tunnel)
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_L3_IPV6_EXT_UNKNOWN;
        else if (!strncasecmp(name, "IPV6", 4) && in_tunnel)
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_INNER_L3_IPV6_EXT_UNKNOWN;
        else if (!strncasecmp(name, "UDP", 3) && !in_tunnel)
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_L4_UDP;
        else if (!strncasecmp(name, "UDP", 3) && in_tunnel)
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_INNER_L4_UDP;
        else if (!strncasecmp(name, "TCP", 3) && !in_tunnel)
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_L4_TCP;
        else if (!strncasecmp(name, "TCP", 3) && in_tunnel)
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_INNER_L4_TCP;
        else if (!strncasecmp(name, "SCTP", 4) && !in_tunnel)
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_L4_SCTP;
        else if (!strncasecmp(name, "SCTP", 4) && in_tunnel)
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_INNER_L4_SCTP;
        else if ((!strncasecmp(name, "ICMP", 4) ||
                  !strncasecmp(name, "ICMPV6", 6)) &&
                 !in_tunnel)
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_L4_ICMP;
        else if ((!strncasecmp(name, "ICMP", 4) ||
                  !strncasecmp(name, "ICMPV6", 6)) &&
                 in_tunnel)
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_INNER_L4_ICMP;
        else if (!strncasecmp(name, "GTPC", 4)) {
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_TUNNEL_GTPC;
          in_tunnel = true;
        } else if (!strncasecmp(name, "GTPU", 4)) {
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_TUNNEL_GTPU;
          in_tunnel = true;
        } else if (!strncasecmp(name, "ESP", 3)) {
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_TUNNEL_ESP;
          in_tunnel = true;
        } else if (!strncasecmp(name, "GRENAT", 6)) {
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_TUNNEL_GRENAT;
          in_tunnel = true;
        } else if (!strncasecmp(name, "L2TPV2CTL", 9) ||
                   !strncasecmp(name, "L2TPV2", 6) ||
                   !strncasecmp(name, "L2TPV3", 6)) {
          ptype_mapping[i].sw_ptype |= RTE_PTYPE_TUNNEL_L2TP;
          in_tunnel = true;
        }
  ...
  ret = rte_pmd_i40e_ptype_mapping_update(port_id, ptype_mapping, ptype_num, 0);
  if (ret)
...
void i40e_update_customized_info(struct rte_eth_dev *dev, uint8_t *pkg,
  ...
  ret = i40e_update_customized_pctype(dev, pkg, pkg_size, proto_num, proto, op);
  if (ret)
    PMD_DRV_LOG(INFO, "No pctype is updated.");

  /* Update customized ptype info */
  ret = i40e_update_customized_ptype(dev, pkg, pkg_size, proto_num, proto, op);
  if (ret)
...
RTE_PMD_REGISTER_PARAM_STRING(net_i40e, ETH_I40E_FLOATING_VEB_ARG
                              "=1" ETH_I40E_FLOATING_VEB_LIST_ARG
                              "=<string>" ETH_I40E_QUEUE_NUM_PER_VF_ARG
                              "=1|2|4|8|16" ETH_I40E_SUPPORT_MULTI_DRIVER "=1");
