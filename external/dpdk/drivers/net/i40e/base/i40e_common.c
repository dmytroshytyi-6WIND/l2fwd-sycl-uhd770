...
void i40e_debug_aq(struct i40e_hw *hw, enum i40e_debug_mask mask, void *desc,
  ...
  i40e_debug(
      hw, mask & I40E_DEBUG_AQ_DESCRIPTOR,
      "AQ CMD: opcode 0x%04X, flags 0x%04X, datalen 0x%04X, retval 0x%04X\n",
      LE16_TO_CPU(aq_desc->opcode), LE16_TO_CPU(aq_desc->flags),
      LE16_TO_CPU(aq_desc->datalen), LE16_TO_CPU(aq_desc->retval));
  i40e_debug(
      hw, mask & I40E_DEBUG_AQ_DESCRIPTOR, "\tcookie (h,l) 0x%08X 0x%08X\n",
      LE32_TO_CPU(aq_desc->cookie_high), LE32_TO_CPU(aq_desc->cookie_low));
  ...
  if (buffer && (buf_len != 0) && (len != 0) &&
    ...
    if (i < len) {
      ...
      i40e_debug(hw, mask,
                 "\t0x%04X  %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X "
                 "%02X %02X %02X %02X %02X %02X\n",
                 i_sav, d_buf[0], d_buf[1], d_buf[2], d_buf[3], d_buf[4],
                 d_buf[5], d_buf[6], d_buf[7], d_buf[8], d_buf[9], d_buf[10],
                 d_buf[11], d_buf[12], d_buf[13], d_buf[14], d_buf[15]);
    }
  }
}
...
#ifdef INTEGRATED_VF
  if (i40e_is_vf(hw))
    return !!(rd32(hw, hw->aq.asq.len) & I40E_VF_ATQLEN1_ATQENABLE_MASK);
#else
  return !!(rd32(hw, hw->aq.asq.len) & I40E_VF_ATQLEN1_ATQENABLE_MASK);
#endif /* INTEGRATED_VF */
#endif /* VF_DRIVER */
...
enum i40e_status_code i40e_aq_queue_shutdown(struct i40e_hw *hw,
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_queue_shutdown);
...
STATIC enum i40e_status_code i40e_aq_get_set_rss_lut(struct i40e_hw *hw,
  ...
  if (set)
    i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_set_rss_lut);
  else
    i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_get_rss_lut);
  ...
  cmd_resp->vsi_id =
      CPU_TO_LE16((u16)((vsi_id << I40E_AQC_SET_RSS_LUT_VSI_ID_SHIFT) &
                        I40E_AQC_SET_RSS_LUT_VSI_ID_MASK));
  cmd_resp->vsi_id |= CPU_TO_LE16((u16)I40E_AQC_SET_RSS_LUT_VSI_VALID);

  if (pf_lut)
    cmd_resp->flags |=
        CPU_TO_LE16((u16)((I40E_AQC_SET_RSS_LUT_TABLE_TYPE_PF
                           << I40E_AQC_SET_RSS_LUT_TABLE_TYPE_SHIFT) &
                          I40E_AQC_SET_RSS_LUT_TABLE_TYPE_MASK));
  else
    cmd_resp->flags |=
        CPU_TO_LE16((u16)((I40E_AQC_SET_RSS_LUT_TABLE_TYPE_VSI
                           << I40E_AQC_SET_RSS_LUT_TABLE_TYPE_SHIFT) &
                          I40E_AQC_SET_RSS_LUT_TABLE_TYPE_MASK));
...
i40e_aq_get_set_rss_key(struct i40e_hw *hw, u16 vsi_id,
                        struct i40e_aqc_get_set_rss_key_data *key, bool set) {
  enum i40e_status_code status;
  struct i40e_aq_desc desc;
  ...
  if (set)
    i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_set_rss_key);
  else
    i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_get_rss_key);
  ...
  cmd_resp->vsi_id =
      CPU_TO_LE16((u16)((vsi_id << I40E_AQC_SET_RSS_KEY_VSI_ID_SHIFT) &
...
i40e_aq_get_rss_key(struct i40e_hw *hw, u16 vsi_id,
 ...
 **/
enum i40e_status_code
i40e_aq_set_rss_key(struct i40e_hw *hw, u16 vsi_id,
                    struct i40e_aqc_get_set_rss_key_data *key) {
...
#define I40E_PTT(PTYPE, OUTER_IP, OUTER_IP_VER, OUTER_FRAG, T, TE, TEF, I, PL) \
  {                                                                            \
    PTYPE, 1, I40E_RX_PTYPE_OUTER_##OUTER_IP,                                  \
        I40E_RX_PTYPE_OUTER_##OUTER_IP_VER, I40E_RX_PTYPE_##OUTER_FRAG,        \
        I40E_RX_PTYPE_TUNNEL_##T, I40E_RX_PTYPE_TUNNEL_END_##TE,               \
        I40E_RX_PTYPE_##TEF, I40E_RX_PTYPE_INNER_PROT_##I,                     \
...
struct i40e_rx_ptype_decoded i40e_ptype_lookup[] = {
    ...
    I40E_PTT_UNUSED_ENTRY(4), I40E_PTT_UNUSED_ENTRY(5),
    I40E_PTT(6, L2, NONE, NOF, NONE, NONE, NOF, NONE, PAY2),
    I40E_PTT(7, L2, NONE, NOF, NONE, NONE, NOF, NONE, PAY2),
    I40E_PTT_UNUSED_ENTRY(8), I40E_PTT_UNUSED_ENTRY(9),
    ...
    /* unused entries */
    I40E_PTT_UNUSED_ENTRY(154), I40E_PTT_UNUSED_ENTRY(155),
    I40E_PTT_UNUSED_ENTRY(156), I40E_PTT_UNUSED_ENTRY(157),
    I40E_PTT_UNUSED_ENTRY(158), I40E_PTT_UNUSED_ENTRY(159),

    I40E_PTT_UNUSED_ENTRY(160), I40E_PTT_UNUSED_ENTRY(161),
    I40E_PTT_UNUSED_ENTRY(162), I40E_PTT_UNUSED_ENTRY(163),
    I40E_PTT_UNUSED_ENTRY(164), I40E_PTT_UNUSED_ENTRY(165),
    I40E_PTT_UNUSED_ENTRY(166), I40E_PTT_UNUSED_ENTRY(167),
    I40E_PTT_UNUSED_ENTRY(168), I40E_PTT_UNUSED_ENTRY(169),

    I40E_PTT_UNUSED_ENTRY(170), I40E_PTT_UNUSED_ENTRY(171),
    I40E_PTT_UNUSED_ENTRY(172), I40E_PTT_UNUSED_ENTRY(173),
    I40E_PTT_UNUSED_ENTRY(174), I40E_PTT_UNUSED_ENTRY(175),
    I40E_PTT_UNUSED_ENTRY(176), I40E_PTT_UNUSED_ENTRY(177),
    I40E_PTT_UNUSED_ENTRY(178), I40E_PTT_UNUSED_ENTRY(179),

    I40E_PTT_UNUSED_ENTRY(180), I40E_PTT_UNUSED_ENTRY(181),
    I40E_PTT_UNUSED_ENTRY(182), I40E_PTT_UNUSED_ENTRY(183),
    I40E_PTT_UNUSED_ENTRY(184), I40E_PTT_UNUSED_ENTRY(185),
    I40E_PTT_UNUSED_ENTRY(186), I40E_PTT_UNUSED_ENTRY(187),
    I40E_PTT_UNUSED_ENTRY(188), I40E_PTT_UNUSED_ENTRY(189),

    I40E_PTT_UNUSED_ENTRY(190), I40E_PTT_UNUSED_ENTRY(191),
    I40E_PTT_UNUSED_ENTRY(192), I40E_PTT_UNUSED_ENTRY(193),
    I40E_PTT_UNUSED_ENTRY(194), I40E_PTT_UNUSED_ENTRY(195),
    I40E_PTT_UNUSED_ENTRY(196), I40E_PTT_UNUSED_ENTRY(197),
    I40E_PTT_UNUSED_ENTRY(198), I40E_PTT_UNUSED_ENTRY(199),

    I40E_PTT_UNUSED_ENTRY(200), I40E_PTT_UNUSED_ENTRY(201),
    I40E_PTT_UNUSED_ENTRY(202), I40E_PTT_UNUSED_ENTRY(203),
    I40E_PTT_UNUSED_ENTRY(204), I40E_PTT_UNUSED_ENTRY(205),
    I40E_PTT_UNUSED_ENTRY(206), I40E_PTT_UNUSED_ENTRY(207),
    I40E_PTT_UNUSED_ENTRY(208), I40E_PTT_UNUSED_ENTRY(209),

    I40E_PTT_UNUSED_ENTRY(210), I40E_PTT_UNUSED_ENTRY(211),
    I40E_PTT_UNUSED_ENTRY(212), I40E_PTT_UNUSED_ENTRY(213),
    I40E_PTT_UNUSED_ENTRY(214), I40E_PTT_UNUSED_ENTRY(215),
    I40E_PTT_UNUSED_ENTRY(216), I40E_PTT_UNUSED_ENTRY(217),
    I40E_PTT_UNUSED_ENTRY(218), I40E_PTT_UNUSED_ENTRY(219),

    I40E_PTT_UNUSED_ENTRY(220), I40E_PTT_UNUSED_ENTRY(221),
    I40E_PTT_UNUSED_ENTRY(222), I40E_PTT_UNUSED_ENTRY(223),
    I40E_PTT_UNUSED_ENTRY(224), I40E_PTT_UNUSED_ENTRY(225),
    I40E_PTT_UNUSED_ENTRY(226), I40E_PTT_UNUSED_ENTRY(227),
    I40E_PTT_UNUSED_ENTRY(228), I40E_PTT_UNUSED_ENTRY(229),

    I40E_PTT_UNUSED_ENTRY(230), I40E_PTT_UNUSED_ENTRY(231),
    I40E_PTT_UNUSED_ENTRY(232), I40E_PTT_UNUSED_ENTRY(233),
    I40E_PTT_UNUSED_ENTRY(234), I40E_PTT_UNUSED_ENTRY(235),
    I40E_PTT_UNUSED_ENTRY(236), I40E_PTT_UNUSED_ENTRY(237),
    I40E_PTT_UNUSED_ENTRY(238), I40E_PTT_UNUSED_ENTRY(239),

    I40E_PTT_UNUSED_ENTRY(240), I40E_PTT_UNUSED_ENTRY(241),
    I40E_PTT_UNUSED_ENTRY(242), I40E_PTT_UNUSED_ENTRY(243),
    I40E_PTT_UNUSED_ENTRY(244), I40E_PTT_UNUSED_ENTRY(245),
    I40E_PTT_UNUSED_ENTRY(246), I40E_PTT_UNUSED_ENTRY(247),
    I40E_PTT_UNUSED_ENTRY(248), I40E_PTT_UNUSED_ENTRY(249),

    I40E_PTT_UNUSED_ENTRY(250), I40E_PTT_UNUSED_ENTRY(251),
    I40E_PTT_UNUSED_ENTRY(252), I40E_PTT_UNUSED_ENTRY(253),
    I40E_PTT_UNUSED_ENTRY(254), I40E_PTT_UNUSED_ENTRY(255)};
 ...
 **/
STATIC enum i40e_status_code
i40e_aq_mac_address_read(struct i40e_hw *hw, u16 *flags,
 ...
 **/
enum i40e_status_code
i40e_aq_mac_address_write(struct i40e_hw *hw, u16 flags, u8 *mac_addr,
                          struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_mac_address_write);
  cmd_data->command_flags = CPU_TO_LE16(flags);
  cmd_data->mac_sah = CPU_TO_LE16((u16)mac_addr[0] << 8 | mac_addr[1]);
  cmd_data->mac_sal =
      CPU_TO_LE32(((u32)mac_addr[2] << 24) | ((u32)mac_addr[3] << 16) |
...
enum i40e_status_code i40e_pf_reset(struct i40e_hw *hw) {
  ...
  if (!cnt) {
    ...
    wr32(hw, I40E_PFGEN_CTRL, (reg | I40E_PFGEN_CTRL_PFSWR_MASK));
...
void i40e_clear_hw(struct i40e_hw *hw) {
  ...
  base_queue =
      (val & I40E_PFLAN_QALLOC_FIRSTQ_MASK) >> I40E_PFLAN_QALLOC_FIRSTQ_SHIFT;
  j = (val & I40E_PFLAN_QALLOC_LASTQ_MASK) >> I40E_PFLAN_QALLOC_LASTQ_SHIFT;
  ...
  j = (val & I40E_PF_VT_PFALLOC_LASTVF_MASK) >> I40E_PF_VT_PFALLOC_LASTVF_SHIFT;
...
static u32 i40e_led_is_mine(struct i40e_hw *hw, int idx) {
  ...
  if (!I40E_IS_X710TL_DEVICE(hw->device_id) && !hw->func_caps.led[idx])
    return 0;
   ...
   */
  if ((gpio_val & I40E_GLGEN_GPIO_CTL_PRT_NUM_NA_MASK) || (port != hw->port))
    return 0;
...
#define I40E_LED_MODE_VALID                                                    \
  (I40E_GLGEN_GPIO_CTL_LED_MODE_MASK >> I40E_GLGEN_GPIO_CTL_LED_MODE_SHIFT)
...
void i40e_led_set(struct i40e_hw *hw, u32 mode, bool blink) {
  ...
  for (i = I40E_LED0; i <= I40E_GLGEN_GPIO_CTL_MAX_INDEX; i++) {
    ...
    if (I40E_IS_X710TL_DEVICE(hw->device_id)) {
      ...
      gpio_val |= ((pin_func << I40E_GLGEN_GPIO_CTL_PIN_FUNC_SHIFT) &
 ...
 **/
enum i40e_status_code
i40e_aq_get_phy_capabilities(struct i40e_hw *hw, bool qualified_modules,
                             bool report_init,
  ...
  do {
    i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_get_phy_abilities);
 ...
 **/
enum i40e_status_code
i40e_aq_set_phy_config(struct i40e_hw *hw,
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_set_phy_config);
...
enum i40e_status_code i40e_set_fc(struct i40e_hw *hw, u8 *aq_failures,
  ...
  *aq_failures = 0x0;
  ...
  status = i40e_aq_get_phy_capabilities(hw, false, false, &abilities, NULL);
  if (status) {
  ...
  if (config.abilities != abilities.abilities) {
    ...
    config.fec_config =
        abilities.fec_cfg_curr_mod_ext_info & I40E_AQ_PHY_FEC_CONFIG_MASK;
 ...
 **/
enum i40e_status_code
i40e_aq_set_mac_config(struct i40e_hw *hw, u16 max_frame_size, bool crc_en,
                       u16 pacing, bool auto_drop_blocking_packets,
                       struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  ...
  if (auto_drop_blocking_packets) {
    if (hw->flags & I40E_HW_FLAG_DROP_MODE)
      cmd->params |= I40E_AQ_SET_MAC_CONFIG_DROP_BLOCKING_PACKET_EN;
    else
 ...
 **/
enum i40e_status_code
i40e_aq_clear_pxe_mode(struct i40e_hw *hw,
                       struct i40e_asq_cmd_details *cmd_details) {
  enum i40e_status_code status;
  struct i40e_aq_desc desc;
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_clear_pxe_mode);
 ...
 **/
enum i40e_status_code
i40e_aq_set_link_restart_an(struct i40e_hw *hw, bool enable_link,
                            struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_set_link_restart_an);
 ...
 **/
enum i40e_status_code
i40e_aq_get_link_info(struct i40e_hw *hw, bool enable_lse,
  ...
  i40e_memcpy(&hw->phy.link_info_old, hw_link_info, sizeof(*hw_link_info),
              I40E_NONDMA_TO_NONDMA);
  ...
  hw_link_info->fec_info =
      resp->config & (I40E_AQ_CONFIG_FEC_KR_ENA | I40E_AQ_CONFIG_FEC_RS_ENA);
  ...
  if ((hw->mac.type == I40E_MAC_XL710) &&
      (hw->aq.fw_maj_ver < 4 ||
       (hw->aq.fw_maj_ver == 4 && hw->aq.fw_min_ver < 40)) &&
  ...
  if (hw->flags & I40E_HW_FLAG_AQ_PHY_ACCESS_CAPABLE &&
    ...
    i40e_memcpy(&tmp, resp->link_type, sizeof(tmp), I40E_NONDMA_TO_NONDMA);
 ...
 **/
enum i40e_status_code
i40e_aq_set_phy_int_mask(struct i40e_hw *hw, u16 mask,
                         struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_set_phy_int_mask);
 ...
 **/
enum i40e_status_code
i40e_aq_get_local_advt_reg(struct i40e_hw *hw, u64 *advt_reg,
                           struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_get_local_advt_reg);
 ...
 **/
enum i40e_status_code
i40e_aq_set_local_advt_reg(struct i40e_hw *hw, u64 advt_reg,
                           struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code
i40e_aq_get_partner_advt(struct i40e_hw *hw, u64 *advt_reg,
                         struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_an_advt_reg *resp =
      (struct i40e_aqc_an_advt_reg *)&desc.params.raw;
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_get_partner_advt);
 ...
 **/
enum i40e_status_code
i40e_aq_set_lb_modes(struct i40e_hw *hw, u16 lb_modes,
                     struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code
i40e_aq_set_phy_debug(struct i40e_hw *hw, u8 cmd_flags,
                      struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code
i40e_aq_add_vsi(struct i40e_hw *hw, struct i40e_vsi_context *vsi_ctx,
                struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_add_get_update_vsi *cmd =
      (struct i40e_aqc_add_get_update_vsi *)&desc.params.raw;
  struct i40e_aqc_add_get_update_vsi_completion *resp =
      (struct i40e_aqc_add_get_update_vsi_completion *)&desc.params.raw;
  enum i40e_status_code status;

  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_add_vsi);
 ...
 **/
enum i40e_status_code
i40e_aq_set_default_vsi(struct i40e_hw *hw, u16 seid,
                        struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code
i40e_aq_clear_default_vsi(struct i40e_hw *hw, u16 seid,
                          struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_set_vsi_promiscuous_modes *cmd =
      (struct i40e_aqc_set_vsi_promiscuous_modes *)&desc.params.raw;
...
i40e_aq_set_vsi_unicast_promiscuous(struct i40e_hw *hw, u16 seid, bool set,
  ...
  if (i40e_hw_ver_ge(hw, 1, 5))
    cmd->valid_flags |= CPU_TO_LE16(I40E_AQC_SET_VSI_PROMISC_RX_ONLY);
 ...
 * @cmd_details: pointer to command details structure or NULL
 **/
enum i40e_status_code i40e_aq_set_vsi_multicast_promiscuous(
    struct i40e_hw *hw, u16 seid, bool set,
    struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_set_vsi_promiscuous_modes *cmd =
      (struct i40e_aqc_set_vsi_promiscuous_modes *)&desc.params.raw;
 ...
 **/
enum i40e_status_code
i40e_aq_set_vsi_full_promiscuous(struct i40e_hw *hw, u16 seid, bool set,
                                 struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_set_vsi_promiscuous_modes *cmd =
      (struct i40e_aqc_set_vsi_promiscuous_modes *)&desc.params.raw;
 ...
 **/
enum i40e_status_code
i40e_aq_set_vsi_mc_promisc_on_vlan(struct i40e_hw *hw, u16 seid, bool enable,
                                   u16 vid,
                                   struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_set_vsi_promiscuous_modes *cmd =
 ...
 **/
enum i40e_status_code
i40e_aq_set_vsi_uc_promisc_on_vlan(struct i40e_hw *hw, u16 seid, bool enable,
                                   u16 vid,
                                   struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_set_vsi_promiscuous_modes *cmd =
 ...
 **/
enum i40e_status_code
i40e_aq_set_vsi_bc_promisc_on_vlan(struct i40e_hw *hw, u16 seid, bool enable,
                                   u16 vid,
                                   struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_set_vsi_promiscuous_modes *cmd =
 ...
 **/
enum i40e_status_code
i40e_aq_set_vsi_broadcast(struct i40e_hw *hw, u16 seid, bool set_filter,
                          struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_set_vsi_promiscuous_modes *cmd =
      (struct i40e_aqc_set_vsi_promiscuous_modes *)&desc.params.raw;
  ...
  if (set_filter)
    cmd->promiscuous_flags |= CPU_TO_LE16(I40E_AQC_SET_VSI_PROMISC_BROADCAST);
  else
    cmd->promiscuous_flags &= CPU_TO_LE16(~I40E_AQC_SET_VSI_PROMISC_BROADCAST);
 ...
 **/
enum i40e_status_code
i40e_aq_set_vsi_vlan_promisc(struct i40e_hw *hw, u16 seid, bool enable,
                             struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_set_vsi_promiscuous_modes *cmd =
      (struct i40e_aqc_set_vsi_promiscuous_modes *)&desc.params.raw;
 ...
 **/
enum i40e_status_code
i40e_aq_get_vsi_params(struct i40e_hw *hw, struct i40e_vsi_context *vsi_ctx,
                       struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_add_get_update_vsi *cmd =
      (struct i40e_aqc_add_get_update_vsi *)&desc.params.raw;
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_get_vsi_parameters);
 ...
 **/
enum i40e_status_code
i40e_aq_update_vsi_params(struct i40e_hw *hw, struct i40e_vsi_context *vsi_ctx,
                          struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_add_get_update_vsi *cmd =
      (struct i40e_aqc_add_get_update_vsi *)&desc.params.raw;
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_update_vsi_parameters);
  cmd->uplink_seid = CPU_TO_LE16(vsi_ctx->seid);
 ...
 **/
enum i40e_status_code i40e_aq_get_switch_config(
    struct i40e_hw *hw, struct i40e_aqc_get_switch_config_resp *buf,
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_get_switch_config);
  desc.flags |= CPU_TO_LE16((u16)I40E_AQ_FLAG_BUF);
 ...
 **/
enum i40e_status_code
i40e_aq_set_switch_config(struct i40e_hw *hw, u16 flags, u16 valid_flags,
                          u8 mode, struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_set_switch_config *scfg =
      (struct i40e_aqc_set_switch_config *)&desc.params.raw;
  enum i40e_status_code status;

  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_set_switch_config);
 ...
 **/
enum i40e_status_code
i40e_aq_get_firmware_version(struct i40e_hw *hw, u16 *fw_major_version,
                             u16 *fw_minor_version, u32 *fw_build,
  ...
  if (status == I40E_SUCCESS) {
    ...
    if (api_major_version && api_minor_version && fw_major_version &&
        fw_minor_version &&
 ...
 **/
enum i40e_status_code
i40e_aq_send_driver_version(struct i40e_hw *hw, struct i40e_driver_version *dv,
                            struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  ...
  len = 0;
  while (len < sizeof(dv->driver_string) && (dv->driver_string[len] < 0x80) &&
         dv->driver_string[len])
    len++;
  status =
      i40e_asq_send_command(hw, &desc, dv->driver_string, len, cmd_details);
...
enum i40e_status_code i40e_update_link_info(struct i40e_hw *hw) {
  ...
  if (((hw->phy.link_info.link_info & I40E_AQ_MEDIA_AVAILABLE) &&
    ...
    status = i40e_aq_get_phy_capabilities(
        hw, false, hw->mac.type == I40E_MAC_X722, &abilities, NULL);
    if (status)
      return status;

    if (abilities.fec_cfg_curr_mod_ext_info & I40E_AQ_ENABLE_FEC_AUTO)
 ...
 **/
enum i40e_status_code
i40e_aq_add_veb(struct i40e_hw *hw, u16 uplink_seid, u16 downlink_seid,
                u8 enabled_tc, bool default_port, u16 *veb_seid,
                bool enable_stats, struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code
i40e_aq_get_veb_parameters(struct i40e_hw *hw, u16 veb_seid, u16 *switch_id,
                           bool *floating, u16 *statistic_index, u16 *vebs_used,
                           u16 *vebs_free,
                           struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_get_veb_parameters_completion *cmd_resp =
      (struct i40e_aqc_get_veb_parameters_completion *)&desc.params.raw;
  enum i40e_status_code status;

  if (veb_seid == 0)
    return I40E_ERR_PARAM;

  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_get_veb_parameters);
...
i40e_prepare_add_macvlan(struct i40e_aqc_add_macvlan_element_data *mv_list,
  ...
  for (i = 0; i < count; i++)
    if (I40E_IS_MULTICAST(mv_list[i].mac_addr))
      mv_list[i].flags |= CPU_TO_LE16(I40E_AQC_MACVLAN_ADD_USE_SHARED_MAC);
...
i40e_aq_add_macvlan(struct i40e_hw *hw, u16 seid,
  ...
  status = i40e_asq_send_command(hw, &desc, mv_list, buf_size, cmd_details);
...
i40e_aq_add_macvlan_v2(struct i40e_hw *hw, u16 seid,
  ...
  status = i40e_asq_send_command_v2(hw, &desc, mv_list, buf_size, cmd_details,
                                    aq_status);
 ...
 **/
static enum i40e_status_code
i40e_mirrorrule_op(struct i40e_hw *hw, u16 opcode, u16 sw_seid, u16 rule_type,
                   u16 id, u16 count, __le16 *mr_list,
                   struct i40e_asq_cmd_details *cmd_details, u16 *rule_id,
  ...
  cmd->rule_type = CPU_TO_LE16(rule_type & I40E_AQC_MIRROR_RULE_TYPE_MASK);
  ...
  status = i40e_asq_send_command(hw, &desc, mr_list, buf_size, cmd_details);
  if (status == I40E_SUCCESS || hw->aq.asq_last_status == I40E_AQ_RC_ENOSPC) {
    if (rule_id)
 ...
 **/
enum i40e_status_code
i40e_aq_add_mirrorrule(struct i40e_hw *hw, u16 sw_seid, u16 rule_type,
                       u16 dest_vsi, u16 count, __le16 *mr_list,
                       struct i40e_asq_cmd_details *cmd_details, u16 *rule_id,
                       u16 *rules_used, u16 *rules_free) {
  ...
  return i40e_mirrorrule_op(hw, i40e_aqc_opc_add_mirror_rule, sw_seid,
                            rule_type, dest_vsi, count, mr_list, cmd_details,
 ...
 **/
enum i40e_status_code
i40e_aq_delete_mirrorrule(struct i40e_hw *hw, u16 sw_seid, u16 rule_type,
                          u16 rule_id, u16 count, __le16 *mr_list,
                          struct i40e_asq_cmd_details *cmd_details,
                          u16 *rules_used, u16 *rules_free) {
  ...
  return i40e_mirrorrule_op(hw, i40e_aqc_opc_delete_mirror_rule, sw_seid,
                            rule_type, rule_id, count, mr_list, cmd_details,
                            NULL, rules_used, rules_free);
}
 ...
 **/
enum i40e_status_code
i40e_aq_add_vlan(struct i40e_hw *hw, u16 seid,
                 struct i40e_aqc_add_remove_vlan_element_data *v_list, u8 count,
                 struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_macvlan *cmd = (struct i40e_aqc_macvlan *)&desc.params.raw;
  enum i40e_status_code status;
  ...
  status = i40e_asq_send_command(hw, &desc, v_list, buf_size, cmd_details);
 ...
 **/
enum i40e_status_code
i40e_aq_remove_vlan(struct i40e_hw *hw, u16 seid,
 ...
 **/
enum i40e_status_code
i40e_aq_send_msg_to_vf(struct i40e_hw *hw, u16 vfid, u32 v_opcode, u32 v_retval,
                       u8 *msg, u16 msglen,
                       struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code
i40e_aq_debug_read_register(struct i40e_hw *hw, u32 reg_addr, u64 *reg_val,
                            struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code
i40e_aq_debug_write_register(struct i40e_hw *hw, u32 reg_addr, u64 reg_val,
                             struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code i40e_aq_request_resource(
    struct i40e_hw *hw, enum i40e_aq_resources_ids resource,
    enum i40e_aq_resource_access_type access, u8 sdp_number, u64 *timeout,
    struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code
i40e_aq_release_resource(struct i40e_hw *hw,
 ...
 **/
enum i40e_status_code
i40e_aq_read_nvm(struct i40e_hw *hw, u8 module_pointer, u32 offset, u16 length,
                 void *data, bool last_command,
                 struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code
i40e_aq_read_nvm_config(struct i40e_hw *hw, u8 cmd_flags, u32 field_id,
                        void *data, u16 buf_size, u16 *element_count,
                        struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code
i40e_aq_write_nvm_config(struct i40e_hw *hw, u8 cmd_flags, void *data,
 ...
 **/
enum i40e_status_code
i40e_aq_nvm_update_in_process(struct i40e_hw *hw, bool update_flow_state,
                              struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_nvm_update_in_process);
 ...
 **/
enum i40e_status_code
i40e_aq_oem_post_update(struct i40e_hw *hw, void *buff, u16 buff_size,
                        struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  enum i40e_status_code status;
 ...
 **/
enum i40e_status_code
i40e_aq_erase_nvm(struct i40e_hw *hw, u8 module_pointer, u32 offset, u16 length,
                  bool last_command, struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_nvm_update *cmd =
      (struct i40e_aqc_nvm_update *)&desc.params.raw;
  enum i40e_status_code status;
 ...
 **/
STATIC void
i40e_parse_discover_capabilities(struct i40e_hw *hw, void *buff, u32 cap_count,
  ...
  for (i = 0; i < cap_count; i++, cap++) {
    ...
    case I40E_AQ_CAP_ID_SWITCH_MODE:
      ...
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: Switch mode = %d\n",
                 p->switch_mode);
      break;
    case I40E_AQ_CAP_ID_MNG_MODE:
      ...
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: Management Mode = %d\n",
                 p->management_mode);
      break;
    case I40E_AQ_CAP_ID_NPAR_ACTIVE:
      p->npar_enable = number;
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: NPAR enable = %d\n",
                 p->npar_enable);
      break;
    case I40E_AQ_CAP_ID_OS2BMC_CAP:
      p->os2bmc = number;
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: OS2BMC = %d\n",
                 p->os2bmc);
      break;
    case I40E_AQ_CAP_ID_FUNCTIONS_VALID:
      p->valid_functions = number;
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: Valid Functions = %d\n",
                 p->valid_functions);
      break;
    case I40E_AQ_CAP_ID_SRIOV:
      if (number == 1)
        p->sr_iov_1_1 = true;
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: SR-IOV = %d\n",
                 p->sr_iov_1_1);
      break;
    case I40E_AQ_CAP_ID_VF:
      p->num_vfs = number;
      p->vf_base_id = logical_id;
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: VF count = %d\n",
                 p->num_vfs);
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: VF base_id = %d\n",
                 p->vf_base_id);
      break;
    case I40E_AQ_CAP_ID_VMDQ:
      if (number == 1)
        p->vmdq = true;
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: VMDQ = %d\n", p->vmdq);
      break;
    case I40E_AQ_CAP_ID_8021QBG:
      if (number == 1)
        p->evb_802_1_qbg = true;
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: 802.1Qbg = %d\n", number);
      break;
    case I40E_AQ_CAP_ID_8021QBR:
      if (number == 1)
        p->evb_802_1_qbh = true;
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: 802.1Qbh = %d\n", number);
      break;
    case I40E_AQ_CAP_ID_VSI:
      p->num_vsis = number;
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: VSI count = %d\n",
                 p->num_vsis);
      break;
    case I40E_AQ_CAP_ID_DCB:
      ...
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: DCB = %d\n", p->dcb);
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: TC Mapping = %d\n",
                 logical_id);
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: TC Max = %d\n", p->maxtc);
      break;
    case I40E_AQ_CAP_ID_FCOE:
      if (number == 1)
        p->fcoe = true;
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: FCOE = %d\n", p->fcoe);
      break;
    case I40E_AQ_CAP_ID_ISCSI:
      if (number == 1)
        p->iscsi = true;
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: iSCSI = %d\n", p->iscsi);
      break;
    case I40E_AQ_CAP_ID_RSS:
      p->rss = true;
      p->rss_table_size = number;
      p->rss_table_entry_width = logical_id;
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: RSS = %d\n", p->rss);
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: RSS table size = %d\n",
                 p->rss_table_size);
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: RSS table width = %d\n",
                 p->rss_table_entry_width);
      break;
    case I40E_AQ_CAP_ID_RXQ:
      p->num_rx_qp = number;
      p->base_queue = phys_id;
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: Rx QP = %d\n", number);
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: base_queue = %d\n",
                 p->base_queue);
      break;
    case I40E_AQ_CAP_ID_TXQ:
      p->num_tx_qp = number;
      p->base_queue = phys_id;
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: Tx QP = %d\n", number);
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: base_queue = %d\n",
                 p->base_queue);
      break;
    ...
    case I40E_AQ_CAP_ID_FLEX10:
      ...
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: Flex10 mode = %d\n",
                 p->flex10_mode);
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: Flex10 status = %d\n",
                 p->flex10_status);
      break;
    case I40E_AQ_CAP_ID_CEM:
      if (number == 1)
        p->mgmt_cem = true;
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: CEM = %d\n", p->mgmt_cem);
      break;
    case I40E_AQ_CAP_ID_IWARP:
      if (number == 1)
        p->iwarp = true;
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: iWARP = %d\n", p->iwarp);
      break;
    case I40E_AQ_CAP_ID_LED:
      if (phys_id < I40E_HW_CAP_MAX_GPIO)
        p->led[phys_id] = true;
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: LED - PIN %d\n", phys_id);
      break;
    case I40E_AQ_CAP_ID_SDP:
      if (phys_id < I40E_HW_CAP_MAX_GPIO)
        p->sdp[phys_id] = true;
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: SDP - PIN %d\n", phys_id);
      break;
    case I40E_AQ_CAP_ID_MDIO:
      ...
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: MDIO port number = %d\n",
                 p->mdio_port_num);
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: MDIO port mode = %d\n",
                 p->mdio_port_mode);
      break;
    case I40E_AQ_CAP_ID_1588:
      if (number == 1)
        p->ieee_1588 = true;
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: IEEE 1588 = %d\n",
                 p->ieee_1588);
      break;
    case I40E_AQ_CAP_ID_FLOW_DIRECTOR:
      ...
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: Flow Director = 1\n");
      i40e_debug(hw, I40E_DEBUG_INIT,
    ...
    case I40E_AQ_CAP_ID_WOL_AND_PROXY:
      ...
      i40e_debug(hw, I40E_DEBUG_INIT, "HW Capability: WOL proxy filters = %d\n",
  ...
  if (hw->mac.type == I40E_MAC_X722) {
    if (i40e_acquire_nvm(hw, I40E_RESOURCE_READ) == I40E_SUCCESS) {
      status = i40e_aq_read_nvm(
          hw, I40E_SR_EMP_MODULE_PTR, 2 * I40E_SR_OCP_CFG_WORD0,
          sizeof(ocp_cfg_word0), &ocp_cfg_word0, true, NULL);
      if (status == I40E_SUCCESS && (ocp_cfg_word0 & I40E_SR_OCP_ENABLED))
        hw->num_ports = 4;
      i40e_release_nvm(hw);
    }
  }
 ...
 **/
enum i40e_status_code
i40e_aq_discover_capabilities(struct i40e_hw *hw, void *buff, u16 buff_size,
                              u16 *data_size,
                              enum i40e_admin_queue_opc list_type_opc,
                              struct i40e_asq_cmd_details *cmd_details) {
 ...
 **/
enum i40e_status_code
i40e_aq_update_nvm(struct i40e_hw *hw, u8 module_pointer, u32 offset,
  ...
  if (hw->mac.type == I40E_MAC_X722) {
    if (preservation_flags == I40E_NVM_PRESERVATION_FLAGS_SELECTED)
      cmd->command_flags |= (I40E_AQ_NVM_PRESERVATION_FLAGS_SELECTED
 ...
 **/
enum i40e_status_code
i40e_aq_rearrange_nvm(struct i40e_hw *hw, u8 rearrange_nvm,
                      struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aqc_nvm_update *cmd;
  enum i40e_status_code status;
  struct i40e_aq_desc desc;
  ...
  rearrange_nvm &=
      (I40E_AQ_NVM_REARRANGE_TO_FLAT | I40E_AQ_NVM_REARRANGE_TO_STRUCT);
 ...
 **/
enum i40e_status_code
i40e_aq_get_lldp_mib(struct i40e_hw *hw, u8 bridge_type, u8 mib_type,
 ...
 **/
enum i40e_status_code
i40e_aq_set_lldp_mib(struct i40e_hw *hw, u8 mib_type, void *buff, u16 buff_size,
                     struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_lldp_set_local_mib);
  /* Indirect Command */
  desc.flags |= CPU_TO_LE16((u16)(I40E_AQ_FLAG_BUF | I40E_AQ_FLAG_RD));
  if (buff_size > I40E_AQ_LARGE_BUF)
    desc.flags |= CPU_TO_LE16((u16)I40E_AQ_FLAG_LB);
 ...
 **/
enum i40e_status_code
i40e_aq_cfg_lldp_mib_change_event(struct i40e_hw *hw, bool enable_update,
                                  struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code
i40e_aq_stop_lldp(struct i40e_hw *hw, bool shutdown_agent, bool persist,
                  struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code
i40e_aq_start_lldp(struct i40e_hw *hw, bool persist,
                   struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
...
i40e_aq_set_dcb_parameters(struct i40e_hw *hw, bool dcb_enable,
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_set_dcb_parameters);
 ...
 **/
enum i40e_status_code
i40e_aq_get_cee_dcb_config(struct i40e_hw *hw, void *buff, u16 buff_size,
                           struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  enum i40e_status_code status;
  ...
  desc.flags |= CPU_TO_LE16((u16)I40E_AQ_FLAG_BUF);
  status =
      i40e_asq_send_command(hw, &desc, (void *)buff, buff_size, cmd_details);
 ...
 **/
enum i40e_status_code
i40e_aq_start_stop_dcbx(struct i40e_hw *hw, bool start_agent,
                        struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_lldp_stop_start_specific_agent *cmd =
      (struct i40e_aqc_lldp_stop_start_specific_agent *)&desc.params.raw;
  enum i40e_status_code status;
 ...
 **/
enum i40e_status_code
i40e_aq_add_udp_tunnel(struct i40e_hw *hw, u16 udp_port, u8 protocol_index,
                       u8 *filter_index,
                       struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code
i40e_aq_del_udp_tunnel(struct i40e_hw *hw, u8 index,
                       struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code i40e_aq_get_switch_resource_alloc(
    struct i40e_hw *hw, u8 *num_entries,
    struct i40e_aqc_switch_resource_alloc_element_resp *buf, u16 count,
    struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code
i40e_aq_delete_element(struct i40e_hw *hw, u16 seid,
                       struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code
i40e_aq_add_tag(struct i40e_hw *hw, bool direct_to_queue, u16 vsi_seid, u16 tag,
                u16 queue_num, u16 *tags_used, u16 *tags_free,
                struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_add_tag *cmd = (struct i40e_aqc_add_tag *)&desc.params.raw;
 ...
 **/
enum i40e_status_code
i40e_aq_remove_tag(struct i40e_hw *hw, u16 vsi_seid, u16 tag, u16 *tags_used,
                   u16 *tags_free, struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
...
enum i40e_status_code i40e_aq_add_mcast_etag(
    struct i40e_hw *hw, u16 pv_seid, u16 etag, u8 num_tags_in_buf, void *buf,
    u16 *tags_used, u16 *tags_free, struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_add_multicast_etag);
 ...
 **/
enum i40e_status_code
i40e_aq_remove_mcast_etag(struct i40e_hw *hw, u16 pv_seid, u16 etag,
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_remove_multicast_etag);
 ...
 **/
enum i40e_status_code
i40e_aq_update_tag(struct i40e_hw *hw, u16 vsi_seid, u16 old_tag, u16 new_tag,
                   u16 *tags_used, u16 *tags_free,
                   struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code
i40e_aq_dcb_ignore_pfc(struct i40e_hw *hw, u8 tcmap, bool request,
                       u8 *tcmap_ret,
                       struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code
i40e_aq_dcb_updated(struct i40e_hw *hw,
                    struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  enum i40e_status_code status;
 ...
 **/
enum i40e_status_code
i40e_aq_add_statistics(struct i40e_hw *hw, u16 seid, u16 vlan_id,
                       u16 *stat_index,
                       struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code
i40e_aq_remove_statistics(struct i40e_hw *hw, u16 seid, u16 vlan_id,
                          u16 stat_index,
                          struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_remove_statistics);
 ...
 **/
enum i40e_status_code
i40e_aq_set_port_parameters(struct i40e_hw *hw, u16 bad_frame_vsi,
                            bool save_bad_pac, bool pad_short_pac,
                            bool double_vlan,
                            struct i40e_asq_cmd_details *cmd_details) {
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_set_port_parameters);
 ...
 **/
static enum i40e_status_code
i40e_aq_tx_sched_cmd(struct i40e_hw *hw, u16 seid, void *buff, u16 buff_size,
 ...
 **/
enum i40e_status_code
i40e_aq_config_vsi_bw_limit(struct i40e_hw *hw, u16 seid, u16 credit,
                            u8 max_credit,
                            struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_configure_vsi_bw_limit);
 ...
 **/
enum i40e_status_code
i40e_aq_config_switch_comp_bw_limit(struct i40e_hw *hw, u16 seid, u16 credit,
                                    u8 max_bw,
                                    struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  ...
  i40e_fill_default_direct_cmd_desc(
      &desc, i40e_aqc_opc_configure_switching_comp_bw_limit);
 ...
 * @cmd_details: pointer to command details structure or NULL
 **/
enum i40e_status_code i40e_aq_config_vsi_ets_sla_bw_limit(
 ...
 **/
enum i40e_status_code
i40e_aq_config_vsi_tc_bw(struct i40e_hw *hw, u16 seid,
                         struct i40e_aqc_configure_vsi_tc_bw_data *bw_data,
                         struct i40e_asq_cmd_details *cmd_details) {
  return i40e_aq_tx_sched_cmd(hw, seid, (void *)bw_data, sizeof(*bw_data),
                              i40e_aqc_opc_configure_vsi_tc_bw, cmd_details);
}
 ...
 * @cmd_details: pointer to command details structure or NULL
 **/
enum i40e_status_code i40e_aq_config_switch_comp_ets(
    struct i40e_hw *hw, u16 seid,
    struct i40e_aqc_configure_switching_comp_ets_data *ets_data,
    enum i40e_admin_queue_opc opcode,
    struct i40e_asq_cmd_details *cmd_details) {
  return i40e_aq_tx_sched_cmd(hw, seid, (void *)ets_data, sizeof(*ets_data),
                              opcode, cmd_details);
}
 ...
 * @cmd_details: pointer to command details structure or NULL
 **/
enum i40e_status_code i40e_aq_config_switch_comp_bw_config(
    struct i40e_hw *hw, u16 seid,
...
enum i40e_status_code i40e_aq_config_switch_comp_ets_bw_limit(
    ...
    struct i40e_asq_cmd_details *cmd_details) {
  return i40e_aq_tx_sched_cmd(
      hw, seid, (void *)bw_data, sizeof(*bw_data),
      i40e_aqc_opc_configure_switching_comp_ets_bw_limit, cmd_details);
}
 ...
 **/
enum i40e_status_code
i40e_aq_query_vsi_bw_config(struct i40e_hw *hw, u16 seid,
                            struct i40e_aqc_query_vsi_bw_config_resp *bw_data,
                            struct i40e_asq_cmd_details *cmd_details) {
  return i40e_aq_tx_sched_cmd(hw, seid, (void *)bw_data, sizeof(*bw_data),
                              i40e_aqc_opc_query_vsi_bw_config, cmd_details);
}
 ...
 * @cmd_details: pointer to command details structure or NULL
 **/
enum i40e_status_code i40e_aq_query_vsi_ets_sla_config(
    struct i40e_hw *hw, u16 seid,
...
enum i40e_status_code i40e_aq_query_port_ets_config(
    ...
    struct i40e_asq_cmd_details *cmd_details) {
  return i40e_aq_tx_sched_cmd(hw, seid, (void *)bw_data, sizeof(*bw_data),
                              i40e_aqc_opc_query_port_ets_config, cmd_details);
}
 ...
 * @cmd_details: pointer to command details structure or NULL
 **/
enum i40e_status_code i40e_aq_query_switch_comp_bw_config(
    struct i40e_hw *hw, u16 seid,
 ...
 **/
enum i40e_status_code
i40e_set_filter_control(struct i40e_hw *hw,
                        struct i40e_filter_control_settings *settings) {
  ...
  val |= ((u32)settings->fcoe_cntx_num << I40E_PFQF_CTL_0_PFFCDSIZE_SHIFT) &
 ...
 * the stats member.
 **/
enum i40e_status_code i40e_aq_add_rem_control_packet_filter(
    struct i40e_hw *hw, u8 *mac_addr, u16 ethtype, u16 flags, u16 vsi_seid,
    u16 queue, bool is_add, struct i40e_control_filter_stats *stats,
    struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_add_remove_control_packet_filter *cmd =
      (struct i40e_aqc_add_remove_control_packet_filter *)&desc.params.raw;
  struct i40e_aqc_add_remove_control_packet_filter_completion *resp =
      (struct i40e_aqc_add_remove_control_packet_filter_completion *)&desc
          .params.raw;
  enum i40e_status_code status;
  ...
  if (is_add) {
    ...
    i40e_fill_default_direct_cmd_desc(
        &desc, i40e_aqc_opc_remove_control_packet_filter);
  }

  if (mac_addr)
    i40e_memcpy(cmd->mac, mac_addr, ETH_ALEN, I40E_NONDMA_TO_NONDMA);
...
#define I40E_FLOW_CONTROL_ETHTYPE 0x8808
  ...
  status = i40e_aq_add_rem_control_packet_filter(hw, NULL, ethtype, flag, seid,
                                                 0, true, NULL, NULL);
  if (status)
    DEBUGOUT(
 ...
 **/
STATIC void
i40e_fix_up_geneve_vni(struct i40e_aqc_cloud_filters_element_data *filters,
                       u8 filter_count) {
  ...
  for (i = 0; i < filter_count; i++) {
    ...
    tnl_type = (LE16_TO_CPU(f[i].flags) & I40E_AQC_ADD_CLOUD_TNL_TYPE_MASK) >>
...
i40e_aq_add_cloud_filters(struct i40e_hw *hw, u16 seid,
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_add_cloud_filters);
...
i40e_aq_rem_cloud_filters(struct i40e_hw *hw, u16 seid,
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_remove_cloud_filters);
 ...
 *
 **/
enum i40e_status_code i40e_aq_replace_cloud_filters(
    struct i40e_hw *hw, struct i40e_aqc_replace_cloud_filters_cmd *filters,
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_replace_cloud_filters);
  ...
  status = i40e_asq_send_command(
      hw, &desc, cmd_buf, sizeof(struct i40e_aqc_replace_cloud_filters_cmd_buf),
      NULL);
 ...
 *
 **/
enum i40e_status_code i40e_aq_alternate_write(struct i40e_hw *hw, u32 reg_addr0,
                                              u32 reg_val0, u32 reg_addr1,
                                              u32 reg_val1) {
  struct i40e_aq_desc desc;
...
enum i40e_status_code i40e_aq_alternate_write_indirect(struct i40e_hw *hw,
  ...
  status = i40e_asq_send_command(hw, &desc, buffer, I40E_LO_DWORD(4 * dw_count),
                                 NULL);
 ...
 *
 **/
enum i40e_status_code i40e_aq_alternate_read(struct i40e_hw *hw, u32 reg_addr0,
                                             u32 *reg_val0, u32 reg_addr1,
                                             u32 *reg_val1) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_alternate_write *cmd_resp =
...
enum i40e_status_code i40e_aq_alternate_clear(struct i40e_hw *hw) {
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_alternate_clear_port);
...
enum i40e_status_code i40e_aq_alternate_write_done(struct i40e_hw *hw,
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_alternate_write_done);
  ...
  if (!status && reset_needed)
    *reset_needed =
        ((LE16_TO_CPU(cmd->cmd_flags) & I40E_AQ_ALTERNATE_RESET_NEEDED) != 0);
 ...
 *
 **/
enum i40e_status_code i40e_aq_set_oem_mode(struct i40e_hw *hw, u8 oem_mode) {
  struct i40e_aq_desc desc;
  struct i40e_aqc_alternate_write_done *cmd =
      (struct i40e_aqc_alternate_write_done *)&desc.params.raw;
  enum i40e_status_code status;

  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_alternate_set_mode);
 ...
 **/
enum i40e_status_code
i40e_aq_resume_port_tx(struct i40e_hw *hw,
                       struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  enum i40e_status_code status;
 ...
 **/
enum i40e_status_code
i40e_aq_debug_dump(struct i40e_hw *hw, u8 cluster_id, u8 table_id,
                   u32 start_index, u16 buff_size, void *buff,
                   u16 *ret_buff_size, u8 *ret_next_table, u32 *ret_next_index,
                   struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_debug_dump_internals);
  /* Indirect Command */
  desc.flags |= CPU_TO_LE16((u16)I40E_AQ_FLAG_BUF);
  if (buff_size > I40E_AQ_LARGE_BUF)
    desc.flags |= CPU_TO_LE16((u16)I40E_AQ_FLAG_LB);
...
enum i40e_status_code i40e_enable_eee(struct i40e_hw *hw, bool enable) {
  ...
  status = i40e_aq_get_phy_capabilities(hw, false, true, &abilities, NULL);
  if (status)
    goto err;
  ...
  config.phy_type_ext = abilities.phy_type_ext;
  config.link_speed = abilities.link_speed;
  config.abilities = abilities.abilities | I40E_AQ_PHY_ENABLE_ATOMIC_LINK;
  config.eeer = abilities.eeer_val;
  config.low_power_ctrl = abilities.d3_lpan;
  config.fec_config =
      abilities.fec_cfg_curr_mod_ext_info & I40E_AQ_PHY_FEC_CONFIG_MASK;
 ...
 **/
enum i40e_status_code i40e_read_bw_from_alt_ram(struct i40e_hw *hw, u32 *max_bw,
                                                u32 *min_bw, bool *min_valid,
                                                bool *max_valid) {
  enum i40e_status_code status;
 ...
 **/
enum i40e_status_code i40e_aq_configure_partition_bw(
    struct i40e_hw *hw, struct i40e_aqc_configure_partition_bw_data *bw_data,
    struct i40e_asq_cmd_details *cmd_details) {
  enum i40e_status_code status;
  struct i40e_aq_desc desc;
  u16 bwd_size = sizeof(*bw_data);

  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_configure_partition_bw);
...
enum i40e_status_code i40e_read_phy_register_clause22(struct i40e_hw *hw,
  ...
  command = (reg << I40E_GLGEN_MSCA_DEVADD_SHIFT) |
            ...
            (I40E_MDIO_CLAUSE22_STCODE_MASK) | (I40E_GLGEN_MSCA_MDICMD_MASK);
...
enum i40e_status_code i40e_read_phy_register_clause45(struct i40e_hw *hw,
  ...
  command = (reg << I40E_GLGEN_MSCA_MDIADD_SHIFT) |
            ...
            (I40E_MDIO_CLAUSE45_STCODE_MASK) | (I40E_GLGEN_MSCA_MDICMD_MASK) |
...
enum i40e_status_code i40e_write_phy_register(struct i40e_hw *hw, u8 page,
  ...
  switch (hw->device_id) {
  case I40E_DEV_ID_1G_BASE_T_X722:
    status = i40e_write_phy_register_clause22(hw, reg, phy_addr, value);
    break;
  case I40E_DEV_ID_10G_BASE_T:
  case I40E_DEV_ID_10G_BASE_T4:
  case I40E_DEV_ID_10G_BASE_T_BC:
  ...
  case I40E_DEV_ID_25G_B:
  case I40E_DEV_ID_25G_SFP28:
    status = i40e_write_phy_register_clause45(hw, page, reg, phy_addr, value);
    break;
  default:
    status = I40E_ERR_UNKNOWN_PHY;
    break;
...
enum i40e_status_code i40e_read_phy_register(struct i40e_hw *hw, u8 page,
  ...
  switch (hw->device_id) {
  case I40E_DEV_ID_1G_BASE_T_X722:
    status = i40e_read_phy_register_clause22(hw, reg, phy_addr, value);
    break;
  case I40E_DEV_ID_10G_BASE_T:
  case I40E_DEV_ID_10G_BASE_T4:
  case I40E_DEV_ID_5G_BASE_T_BC:
  ...
  case I40E_DEV_ID_25G_B:
  case I40E_DEV_ID_25G_SFP28:
    status = i40e_read_phy_register_clause45(hw, page, reg, phy_addr, value);
    break;
  default:
    status = I40E_ERR_UNKNOWN_PHY;
    break;
 ...
 * Blinks PHY link LED
 **/
enum i40e_status_code i40e_blink_phy_link_led(struct i40e_hw *hw, u32 time,
                                              u32 interval) {
  enum i40e_status_code status = I40E_SUCCESS;
  u32 i;
  u16 led_ctl = 0;
  ...
  for (gpio_led_port = 0; gpio_led_port < 3; gpio_led_port++, led_addr++) {
...
restore_config:
  status = i40e_write_phy_register_clause45(hw, I40E_PHY_COM_REG_PAGE, led_addr,
                                            phy_addr, led_ctl);
...
enum i40e_status_code i40e_led_get_reg(struct i40e_hw *hw, u16 led_addr,
  ...
  *reg_val = 0;
  if (hw->flags & I40E_HW_FLAG_AQ_PHY_ACCESS_CAPABLE) {
    status = i40e_aq_get_phy_register(hw, I40E_AQ_PHY_REG_ACCESS_EXTERNAL,
                                      I40E_PHY_COM_REG_PAGE, true,
                                      I40E_PHY_LED_PROV_REG_1, reg_val, NULL);
  } else {
    phy_addr = i40e_get_phy_address(hw, hw->port);
    status = i40e_read_phy_register_clause45(
        hw, I40E_PHY_COM_REG_PAGE, led_addr, phy_addr, (u16 *)reg_val);
  }
  return status;
}
...
enum i40e_status_code i40e_led_set_reg(struct i40e_hw *hw, u16 led_addr,
  ...
  if (hw->flags & I40E_HW_FLAG_AQ_PHY_ACCESS_CAPABLE) {
    status = i40e_aq_set_phy_register(hw, I40E_AQ_PHY_REG_ACCESS_EXTERNAL,
                                      I40E_PHY_COM_REG_PAGE, true,
                                      I40E_PHY_LED_PROV_REG_1, reg_val, NULL);
  } else {
    phy_addr = i40e_get_phy_address(hw, hw->port);
    status = i40e_write_phy_register_clause45(hw, I40E_PHY_COM_REG_PAGE,
                                              led_addr, phy_addr, (u16)reg_val);
  }
...
enum i40e_status_code i40e_led_get_phy(struct i40e_hw *hw, u16 *led_addr,
  ...
  if (hw->flags & I40E_HW_FLAG_AQ_PHY_ACCESS_CAPABLE) {
    status = i40e_aq_get_phy_register(
        hw, I40E_AQ_PHY_REG_ACCESS_EXTERNAL, I40E_PHY_COM_REG_PAGE, true,
        I40E_PHY_LED_PROV_REG_1, &reg_val_aq, NULL);
    if (status == I40E_SUCCESS)
      *val = (u16)reg_val_aq;
    return status;
  }
  ...
  phy_addr = i40e_get_phy_address(hw, hw->port);
  for (gpio_led_port = 0; gpio_led_port < 3; gpio_led_port++, temp_addr++) {
    status = i40e_read_phy_register_clause45(hw, I40E_PHY_COM_REG_PAGE,
...
enum i40e_status_code i40e_get_phy_lpi_status(struct i40e_hw *hw,
  ...
  eee_bcm_phy = (hw->device_id == I40E_DEV_ID_10G_BASE_T_BC ||
  ...
  eee_mrvl_phy = hw->device_id == I40E_DEV_ID_1G_BASE_T_X722;

  if (eee_bcm_phy || eee_mrvl_phy) {
    /* read Clause 45 PCS Status 1 register */
    ret = i40e_aq_get_phy_register(hw, I40E_AQ_PHY_REG_ACCESS_EXTERNAL,
                                   I40E_BCM_PHY_PCS_STATUS1_PAGE, true,
                                   I40E_BCM_PHY_PCS_STATUS1_REG, &val, NULL);
...
enum i40e_status_code i40e_get_lpi_counters(struct i40e_hw *hw, u32 *tx_counter,
  ...
  if ((hw->device_id == I40E_DEV_ID_10G_BASE_T_BC ||
    ...
    *is_clear = false;
    retval =
        i40e_aq_run_phy_activity(hw, I40E_AQ_RUN_PHY_ACT_ID_USR_DFND,
...
enum i40e_status_code i40e_get_lpi_duration(struct i40e_hw *hw,
  ...
  if (hw->phy.link_info.link_speed == I40E_LINK_SPEED_1GB && !tx_time_dur &&
      !rx_time_dur && stat->tx_lpi_status && stat->rx_lpi_status) {
    retval = i40e_aq_run_phy_activity(
        hw, I40E_AQ_RUN_PHY_ACT_ID_USR_DFND,
        I40E_AQ_RUN_PHY_ACT_DNL_OPCODE_GET_EEE_STAT_DUR, &cmd_status,
 ...
 **/
enum i40e_status_code
i40e_aq_rx_ctl_read_register(struct i40e_hw *hw, u32 reg_addr, u32 *reg_val,
                             struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
 ...
 **/
enum i40e_status_code
i40e_aq_rx_ctl_write_register(struct i40e_hw *hw, u32 reg_addr, u32 reg_val,
                              struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
...
void i40e_write_rx_ctl(struct i40e_hw *hw, u32 reg_addr, u32 reg_val) {
  ...
  if (!use_register) {
  do_retry:
    status = i40e_aq_rx_ctl_write_register(hw, reg_addr, reg_val, NULL);
    if (hw->aq.asq_last_status == I40E_AQ_RC_EAGAIN && retry) {
      i40e_msec_delay(1);
      retry--;
      goto do_retry;
  ...
  if (set_mdio && cmd->phy_interface == I40E_AQ_PHY_REG_ACCESS_EXTERNAL) {
    if (hw->flags & I40E_HW_FLAG_AQ_PHY_ACCESS_EXTENDED)
      cmd->cmd_flags |=
          ...
          ((mdio_num << I40E_AQ_PHY_REG_ACCESS_MDIO_IF_NUMBER_SHIFT) &
 ...
 **/
enum i40e_status_code
i40e_aq_set_phy_register_ext(struct i40e_hw *hw, u8 phy_select, u8 dev_addr,
                             bool page_change, bool set_mdio, u8 mdio_num,
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_set_phy_register);
 ...
 **/
enum i40e_status_code
i40e_aq_get_phy_register_ext(struct i40e_hw *hw, u8 phy_select, u8 dev_addr,
                             bool page_change, bool set_mdio, u8 mdio_num,
                             u32 reg_addr, u32 *reg_val,
                             struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_get_phy_register);
...
i40e_aq_run_phy_activity(struct i40e_hw *hw, u16 activity_id, u32 dnl_opcode,
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_run_phy_activity);
 ...
 **/
enum i40e_status_code
i40e_aq_send_msg_to_pf(struct i40e_hw *hw, enum virtchnl_ops v_opcode,
                       enum i40e_status_code v_retval, u8 *msg, u16 msglen,
                       struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  ...
  status = i40e_asq_send_command(hw, (struct i40e_aq_desc *)&desc, msg, msglen,
                                 cmd_details);
  return status;
}
...
void i40e_vf_parse_hw_config(struct i40e_hw *hw,
  ...
  hw->dev_caps.iwarp = (msg->vf_cap_flags & VIRTCHNL_VF_OFFLOAD_IWARP) ? 1 : 0;
  for (i = 0; i < msg->num_vsis; i++) {
    if (vsi_res->vsi_type == VIRTCHNL_VSI_SRIOV) {
      i40e_memcpy(hw->mac.perm_addr, vsi_res->default_mac_addr, ETH_ALEN,
                  I40E_NONDMA_TO_NONDMA);
      i40e_memcpy(hw->mac.addr, vsi_res->default_mac_addr, ETH_ALEN,
                  I40E_NONDMA_TO_NONDMA);
    }
    vsi_res++;
  }
...
enum i40e_status_code i40e_vf_reset(struct i40e_hw *hw) {
  return i40e_aq_send_msg_to_pf(hw, VIRTCHNL_OP_RESET_VF, I40E_SUCCESS, NULL, 0,
                                NULL);
}
#endif /* VF_DRIVER */
...
i40e_aq_set_arp_proxy_config(struct i40e_hw *hw,
  ...
  desc.params.external.addr_low = CPU_TO_LE32(I40E_LO_DWORD((u64)proxy_config));
...
enum i40e_status_code i40e_aq_set_ns_proxy_table_entry(
    struct i40e_hw *hw, struct i40e_aqc_ns_proxy_data *ns_proxy_table_entry,
    struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  enum i40e_status_code status;
  ...
  status =
      i40e_asq_send_command(hw, &desc, ns_proxy_table_entry,
                            sizeof(struct i40e_aqc_ns_proxy_data), cmd_details);
 ...
 **/
enum i40e_status_code
i40e_aq_set_clear_wol_filter(struct i40e_hw *hw, u8 filter_index,
  ...
  status = i40e_asq_send_command(hw, &desc, filter, buff_len, cmd_details);
 ...
 **/
enum i40e_status_code
i40e_aq_get_wake_event_reason(struct i40e_hw *hw, u16 *wake_reason,
                              struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
...
i40e_aq_clear_all_wol_filters(struct i40e_hw *hw,
  ...
  i40e_fill_default_direct_cmd_desc(&desc, i40e_aqc_opc_clear_all_wol_filters);
 ...
 **/
enum i40e_status_code
i40e_aq_write_ddp(struct i40e_hw *hw, void *buff, u16 buff_size, u32 track_id,
 ...
 **/
enum i40e_status_code
i40e_aq_get_ddp_list(struct i40e_hw *hw, void *buff, u16 buff_size, u8 flags,
                     struct i40e_asq_cmd_details *cmd_details) {
  struct i40e_aq_desc desc;
  ...
  i40e_fill_default_direct_cmd_desc(
      &desc, i40e_aqc_opc_get_personalization_profile_list);
...
i40e_find_segment_in_package(u32 segment_type,
  ...
  for (i = 0; i < pkg_hdr->segment_count; i++) {
    segment = (struct i40e_generic_seg_header *)((u8 *)pkg_hdr +
 ...
 **/
STATIC enum i40e_status_code
i40e_ddp_exec_aq_section(struct i40e_hw *hw,
 ...
 */
enum i40e_status_code i40e_write_profile(struct i40e_hw *hw,
                                         struct i40e_profile_segment *profile,
                                         u32 track_id) {
  enum i40e_status_code status = I40E_SUCCESS;
  struct i40e_section_table *sec_tbl;
  ...
  for (i = 0; i < sec_tbl->section_count; i++) {
    ...
    section_size =
        sec->section.size + sizeof(struct i40e_profile_section_header);

    /* Write MMIO section */
    status = i40e_aq_write_ddp(hw, (void *)sec, (u16)section_size, track_id,
                               &offset, &info, NULL);
    if (status) {
      i40e_debug(hw, I40E_DEBUG_PACKAGE,
 ...
 */
enum i40e_status_code
i40e_add_pinfo_to_list(struct i40e_hw *hw, struct i40e_profile_segment *profile,
  ...
  pinfo = (struct i40e_profile_info *)(profile_info_sec + sec->section.offset);
  ...
  status = i40e_aq_write_ddp(hw, (void *)sec, sec->data_end, track_id, &offset,
                             &info, NULL);
  return status;
}
