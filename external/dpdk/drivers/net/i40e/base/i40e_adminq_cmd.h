...
#define I40E_FW_MINOR_VERSION(_h)                                              \
  ((_h)->mac.type == I40E_MAC_XL710 ? I40E_FW_API_VERSION_MINOR_X710           \
...
#define I40E_CHECK_STRUCT_LEN(n, X)                                            \
  enum i40e_static_assert_enum_##X {                                           \
...
#define I40E_AQC_SET_WOL_FILTER_TYPE_MAGIC_MASK                                \
  (0x1 << I40E_AQC_SET_WOL_FILTER_TYPE_MAGIC_SHIFT)

#define I40E_AQC_SET_WOL_FILTER_INDEX_SHIFT 0
#define I40E_AQC_SET_WOL_FILTER_INDEX_MASK                                     \
  (0x7 << I40E_AQC_SET_WOL_FILTER_INDEX_SHIFT)
  __le16 cmd_flags;
...
#define I40E_AQC_GET_WAKE_UP_REASON_WOL_REASON_MATCHED_INDEX_MASK              \
  (0xFF << I40E_AQC_GET_WAKE_UP_REASON_WOL_REASON_MATCHED_INDEX_SHIFT)
#define I40E_AQC_GET_WAKE_UP_REASON_WOL_REASON_RESERVED_SHIFT 8
#define I40E_AQC_GET_WAKE_UP_REASON_WOL_REASON_RESERVED_MASK                   \
  (0xFF << I40E_AQC_GET_WAKE_UP_REASON_WOL_REASON_RESERVED_SHIFT)
  u8 reserved_2[12];
};
...
#define I40E_AQ_VSI_OVLAN_MODE_MASK (0x03 << I40E_AQ_VSI_OVLAN_MODE_SHIFT)
...
#define I40E_AQ_VSI_OVLAN_EMOD_MASK (0x03 << I40E_AQ_VSI_OVLAN_EMOD_SHIFT)
...
#define I40E_AQ_VSI_TC_QUE_OFFSET_MASK                                         \
  (0x1FF << I40E_AQ_VSI_TC_QUE_OFFSET_SHIFT)
...
#define I40E_AQC_ADD_VEB_PORT_TYPE_MASK                                        \
  (0x3 << I40E_AQC_ADD_VEB_PORT_TYPE_SHIFT)
...
#define I40E_AQC_MACVLAN_CMD_SEID_NUM_MASK                                     \
  (0x3FF << I40E_AQC_MACVLAN_CMD_SEID_NUM_SHIFT)
...
#define I40E_AQC_MACVLAN_CMD_QUEUE_MASK                                        \
  (0x7FF << I40E_AQC_MACVLAN_CMD_SEID_NUM_SHIFT)
  /* response section */
  u8 match_method;
...
#define I40E_AQC_ADD_TAG_CMD_SEID_NUM_MASK                                     \
  (0x3FF << I40E_AQC_ADD_TAG_CMD_SEID_NUM_SHIFT)
  __le16 tag;
  __le16 queue_number;
  u8 reserved[8];
};
...
#define I40E_AQC_REMOVE_TAG_CMD_SEID_NUM_MASK                                  \
  (0x3FF << I40E_AQC_REMOVE_TAG_CMD_SEID_NUM_SHIFT)
  __le16 tag;
  u8 reserved[12];
};
...
#define I40E_AQC_UPDATE_TAG_CMD_SEID_NUM_MASK                                  \
...
#define I40E_AQC_ADD_CONTROL_PACKET_CMD_SEID_NUM_MASK                          \
  (0x3FF << I40E_AQC_ADD_CONTROL_PACKET_CMD_SEID_NUM_SHIFT)
  __le16 queue;
  u8 reserved[2];
};
...
#define I40E_AQC_ADD_CLOUD_CMD_SEID_NUM_MASK                                   \
  (0x3FF << I40E_AQC_ADD_CLOUD_CMD_SEID_NUM_SHIFT)
  u8 big_buffer_flag;
...
#define I40E_AQC_ADD_CLOUD_FILTER_MASK (0x3F << I40E_AQC_ADD_CLOUD_FILTER_SHIFT)
/* 0x0000 reserved */
...
#define I40E_AQC_ADD_CLOUD_QUEUE_MASK (0x7FF << I40E_AQC_ADD_CLOUD_QUEUE_SHIFT)
  u8 reserved2[14];
  /* response section */
...
#define I40E_AQC_MIRROR_RULE_TYPE_MASK (0x7 << I40E_AQC_MIRROR_RULE_TYPE_SHIFT)
...
#define I40E_PHY_TYPES_BITMASK                                                 \
  (BIT_ULL(I40E_PHY_TYPE_SGMII) | BIT_ULL(I40E_PHY_TYPE_1000BASE_KX) |         \
   BIT_ULL(I40E_PHY_TYPE_10GBASE_KX4) | BIT_ULL(I40E_PHY_TYPE_10GBASE_KR) |    \
   BIT_ULL(I40E_PHY_TYPE_40GBASE_KR4) | BIT_ULL(I40E_PHY_TYPE_XAUI) |          \
   BIT_ULL(I40E_PHY_TYPE_XFI) | BIT_ULL(I40E_PHY_TYPE_SFI) |                   \
   BIT_ULL(I40E_PHY_TYPE_XLAUI) | BIT_ULL(I40E_PHY_TYPE_XLPPI) |               \
   BIT_ULL(I40E_PHY_TYPE_40GBASE_CR4_CU) |                                     \
   BIT_ULL(I40E_PHY_TYPE_10GBASE_CR1_CU) |                                     \
   BIT_ULL(I40E_PHY_TYPE_10GBASE_AOC) | BIT_ULL(I40E_PHY_TYPE_40GBASE_AOC) |   \
   ...
   BIT_ULL(I40E_PHY_TYPE_10GBASE_T) | BIT_ULL(I40E_PHY_TYPE_10GBASE_SR) |      \
   BIT_ULL(I40E_PHY_TYPE_10GBASE_LR) |                                         \
   BIT_ULL(I40E_PHY_TYPE_10GBASE_SFPP_CU) |                                    \
   BIT_ULL(I40E_PHY_TYPE_10GBASE_CR1) | BIT_ULL(I40E_PHY_TYPE_40GBASE_CR4) |   \
   BIT_ULL(I40E_PHY_TYPE_40GBASE_SR4) | BIT_ULL(I40E_PHY_TYPE_40GBASE_LR4) |   \
   BIT_ULL(I40E_PHY_TYPE_1000BASE_SX) | BIT_ULL(I40E_PHY_TYPE_1000BASE_LX) |   \
   BIT_ULL(I40E_PHY_TYPE_1000BASE_T_OPTICAL) |                                 \
   BIT_ULL(I40E_PHY_TYPE_20GBASE_KR2) | BIT_ULL(I40E_PHY_TYPE_25GBASE_KR) |    \
   BIT_ULL(I40E_PHY_TYPE_25GBASE_CR) | BIT_ULL(I40E_PHY_TYPE_25GBASE_SR) |     \
   BIT_ULL(I40E_PHY_TYPE_25GBASE_LR) | BIT_ULL(I40E_PHY_TYPE_25GBASE_AOC) |    \
   BIT_ULL(I40E_PHY_TYPE_25GBASE_ACC) | BIT_ULL(I40E_PHY_TYPE_2_5GBASE_T) |    \
...
#define I40E_AQ_PHY_DEBUG_RESET_EXTERNAL_MASK                                  \
  (0x03 << I40E_AQ_PHY_DEBUG_RESET_EXTERNAL_SHIFT)
...
#define I40E_AQ_PHY_REG_ACCESS_MDIO_IF_NUMBER_MASK                             \
  (0x3 << I40E_AQ_PHY_REG_ACCESS_MDIO_IF_NUMBER_SHIFT)
  u8 reserved1;
  __le32 reg_address;
  __le32 reg_value;
  u8 reserved2[4];
...
#define SET_LOCAL_MIB_AC_TYPE_NON_WILLING_APPS_MASK                            \
  (1 << SET_LOCAL_MIB_AC_TYPE_NON_WILLING_APPS_SHIFT)
...
#define I40E_AQC_SET_RSS_KEY_VSI_ID_MASK                                       \
  (0x3FF << I40E_AQC_SET_RSS_KEY_VSI_ID_SHIFT)
  __le16 vsi_id;
  u8 reserved[6];
  __le32 addr_high;
  __le32 addr_low;
...
#define I40E_AQC_SET_RSS_LUT_VSI_ID_MASK                                       \
  (0x3FF << I40E_AQC_SET_RSS_LUT_VSI_ID_SHIFT)
  __le16 vsi_id;
#define I40E_AQC_SET_RSS_LUT_TABLE_TYPE_SHIFT 0
#define I40E_AQC_SET_RSS_LUT_TABLE_TYPE_MASK                                   \
  (0x1 << I40E_AQC_SET_RSS_LUT_TABLE_TYPE_SHIFT)
