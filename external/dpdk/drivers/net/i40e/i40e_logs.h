...
#define PMD_RX_LOG(level, fmt, args...)                                        \
  rte_log(RTE_LOG_##level, i40e_logtype_rx, "%s(): " fmt "\n", __func__, ##args)
#else
#define PMD_RX_LOG(level, fmt, args...)                                        \
  do {                                                                         \
  } while (0)
...
#define PMD_TX_LOG(level, fmt, args...)                                        \
  rte_log(RTE_LOG_##level, i40e_logtype_tx, "%s(): " fmt "\n", __func__, ##args)
#else
#define PMD_TX_LOG(level, fmt, args...)                                        \
  do {                                                                         \
  } while (0)
...
#define PMD_DRV_LOG_RAW(level, fmt, args...)                                   \
  rte_log(RTE_LOG_##level, i40e_logtype_driver, "%s(): " fmt, __func__, ##args)
