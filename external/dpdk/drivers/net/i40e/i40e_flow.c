...
static struct rte_flow *i40e_flow_create(struct rte_eth_dev *dev,
                                         ...
                                         const struct rte_flow_action actions[],
                                         struct rte_flow_error *error);
static int i40e_flow_destroy(struct rte_eth_dev *dev, struct rte_flow *flow,
                             struct rte_flow_error *error);
static int i40e_flow_flush(struct rte_eth_dev *dev,
                           struct rte_flow_error *error);
static int i40e_flow_query(struct rte_eth_dev *dev, struct rte_flow *flow,
                           const struct rte_flow_action *actions, void *data,
                           struct rte_flow_error *error);
static int i40e_flow_parse_ethertype_pattern(
    struct rte_eth_dev *dev, const struct rte_flow_item *pattern,
    struct rte_flow_error *error, struct rte_eth_ethertype_filter *filter);
static int i40e_flow_parse_ethertype_action(
...
static int i40e_flow_parse_fdir_action(struct rte_eth_dev *dev,
                                       ...
                                       struct rte_flow_error *error,
                                       struct i40e_fdir_filter_conf *filter);
static int i40e_flow_parse_tunnel_action(
    struct rte_eth_dev *dev, const struct rte_flow_action *actions,
    struct rte_flow_error *error, struct i40e_tunnel_filter_conf *filter);
static int i40e_flow_parse_attr(const struct rte_flow_attr *attr,
                                struct rte_flow_error *error);
static int i40e_flow_parse_ethertype_filter(
...
static int i40e_flow_parse_qinq_filter(struct rte_eth_dev *dev,
                                       const struct rte_flow_attr *attr,
                                       const struct rte_flow_item pattern[],
                                       const struct rte_flow_action actions[],
                                       struct rte_flow_error *error,
                                       union i40e_filter_t *filter);
static int i40e_flow_parse_qinq_pattern(struct rte_eth_dev *dev,
                                        const struct rte_flow_item *pattern,
                                        struct rte_flow_error *error,
                                        struct i40e_tunnel_filter_conf *filter);

static int i40e_flow_parse_l4_cloud_filter(
    struct rte_eth_dev *dev, const struct rte_flow_attr *attr,
    const struct rte_flow_item pattern[],
    const struct rte_flow_action actions[], struct rte_flow_error *error,
    union i40e_filter_t *filter);
...
static enum rte_flow_item_type pattern_fdir_ipv4_gtpc[] = {
    ...
    RTE_FLOW_ITEM_TYPE_GTPC, RTE_FLOW_ITEM_TYPE_END,
};

static enum rte_flow_item_type pattern_fdir_ipv4_gtpu[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_GTPU, RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_fdir_ipv4_gtpu_ipv6[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_GTPU, RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_fdir_ipv4_raw_2[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_RAW,
    RTE_FLOW_ITEM_TYPE_RAW, RTE_FLOW_ITEM_TYPE_END,
};

static enum rte_flow_item_type pattern_fdir_ipv4_raw_3[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_RAW,
    RTE_FLOW_ITEM_TYPE_RAW, RTE_FLOW_ITEM_TYPE_RAW,  RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_fdir_ipv4_udp_raw_3[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_RAW, RTE_FLOW_ITEM_TYPE_RAW,  RTE_FLOW_ITEM_TYPE_RAW,
    RTE_FLOW_ITEM_TYPE_END,
};

static enum rte_flow_item_type pattern_fdir_ipv4_tcp_raw_1[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_TCP,
    RTE_FLOW_ITEM_TYPE_RAW, RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_fdir_ipv4_sctp_raw_1[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_SCTP,
    RTE_FLOW_ITEM_TYPE_RAW, RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_fdir_ipv6_raw_2[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_RAW,
    RTE_FLOW_ITEM_TYPE_RAW, RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_fdir_ipv6_tcp_raw_1[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_TCP,
    RTE_FLOW_ITEM_TYPE_RAW, RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_fdir_ipv6_sctp_raw_1[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_SCTP,
    RTE_FLOW_ITEM_TYPE_RAW, RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_fdir_vlan_ipv6_udp[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_IPV6,
    RTE_FLOW_ITEM_TYPE_UDP, RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_fdir_ethertype_vlan_raw_2[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_RAW,
    RTE_FLOW_ITEM_TYPE_RAW, RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_fdir_vlan_ipv4_udp_raw_1[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_IPV4,
    RTE_FLOW_ITEM_TYPE_UDP, RTE_FLOW_ITEM_TYPE_RAW,  RTE_FLOW_ITEM_TYPE_END,
};

static enum rte_flow_item_type pattern_fdir_vlan_ipv4_udp_raw_2[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_IPV4,
    RTE_FLOW_ITEM_TYPE_UDP, RTE_FLOW_ITEM_TYPE_RAW,  RTE_FLOW_ITEM_TYPE_RAW,
    RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_fdir_ipv4_udp_vf[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_VF,  RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_fdir_ethertype_raw_3_vf[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_RAW, RTE_FLOW_ITEM_TYPE_RAW,
    RTE_FLOW_ITEM_TYPE_RAW, RTE_FLOW_ITEM_TYPE_VF,  RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_fdir_ipv4_raw_3_vf[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_RAW,
    RTE_FLOW_ITEM_TYPE_RAW, RTE_FLOW_ITEM_TYPE_RAW,  RTE_FLOW_ITEM_TYPE_VF,
    RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_fdir_vlan_ipv4_udp_vf[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_IPV4,
    RTE_FLOW_ITEM_TYPE_UDP, RTE_FLOW_ITEM_TYPE_VF,   RTE_FLOW_ITEM_TYPE_END,
};

static enum rte_flow_item_type pattern_fdir_vlan_ipv4_tcp_vf[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_IPV4,
    RTE_FLOW_ITEM_TYPE_TCP, RTE_FLOW_ITEM_TYPE_VF,   RTE_FLOW_ITEM_TYPE_END,
};

static enum rte_flow_item_type pattern_fdir_vlan_ipv4_sctp_vf[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_IPV4,
    RTE_FLOW_ITEM_TYPE_SCTP, RTE_FLOW_ITEM_TYPE_VF,   RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_fdir_vlan_ipv4_udp_raw_1_vf[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_IPV4,
    RTE_FLOW_ITEM_TYPE_UDP, RTE_FLOW_ITEM_TYPE_RAW,  RTE_FLOW_ITEM_TYPE_VF,
    RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_fdir_vlan_ipv4_tcp_raw_1_vf[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_IPV4,
    RTE_FLOW_ITEM_TYPE_TCP, RTE_FLOW_ITEM_TYPE_RAW,  RTE_FLOW_ITEM_TYPE_VF,
    RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_fdir_vlan_ipv4_sctp_raw_1_vf[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_IPV4,
    RTE_FLOW_ITEM_TYPE_SCTP, RTE_FLOW_ITEM_TYPE_RAW,  RTE_FLOW_ITEM_TYPE_VF,
    RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_vxlan_1[] = {
    RTE_FLOW_ITEM_TYPE_ETH,   RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_VXLAN, RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_vxlan_3[] = {
    RTE_FLOW_ITEM_TYPE_ETH,   RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_VXLAN, RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_VLAN,
    RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_nvgre_2[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV6, RTE_FLOW_ITEM_TYPE_NVGRE,
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_END,
};

static enum rte_flow_item_type pattern_nvgre_3[] = {
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_NVGRE,
    RTE_FLOW_ITEM_TYPE_ETH, RTE_FLOW_ITEM_TYPE_VLAN, RTE_FLOW_ITEM_TYPE_END,
};
...
static enum rte_flow_item_type pattern_mpls_1[] = {
    RTE_FLOW_ITEM_TYPE_ETH,  RTE_FLOW_ITEM_TYPE_IPV4, RTE_FLOW_ITEM_TYPE_UDP,
    RTE_FLOW_ITEM_TYPE_MPLS, RTE_FLOW_ITEM_TYPE_END,
};
...
static void i40e_pattern_skip_void_item(struct rte_flow_item *items,
                                        const struct rte_flow_item *pattern) {
...
static bool i40e_match_pattern(enum rte_flow_item_type *item_array,
...
static parse_filter_t i40e_find_parse_filter_func(struct rte_flow_item *pattern,
                                                  uint32_t *idx) {
  parse_filter_t parse_filter = NULL;
  uint8_t i = *idx;

  for (; i < RTE_DIM(i40e_supported_patterns); i++) {
    if (i40e_match_pattern(i40e_supported_patterns[i].items, pattern)) {
...
static int i40e_flow_parse_attr(const struct rte_flow_attr *attr,
  ...
  if (!attr->ingress) {
    rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ATTR_INGRESS, attr,
  ...
  /* Not supported */
  if (attr->egress) {
    rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ATTR_EGRESS, attr,
                       "Not support egress.");
    return -rte_errno;
  }
  ...
  /* Not supported */
  if (attr->priority) {
    rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ATTR_PRIORITY, attr,
  ...
  /* Not supported */
  if (attr->group) {
    rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ATTR_GROUP, attr,
                       "Not support group.");
    return -rte_errno;
  }
...
static uint16_t i40e_get_outer_vlan(struct rte_eth_dev *dev) {
  ...
  i40e_aq_debug_read_register(hw, I40E_GL_SWT_L2TAGCTRL(reg_id), &reg_r, NULL);
...
static int i40e_flow_parse_ethertype_filter(
  ...
  ret =
      i40e_flow_parse_ethertype_pattern(dev, pattern, error, ethertype_filter);
  if (ret)
    return ret;

  ret = i40e_flow_parse_ethertype_action(dev, actions, error, ethertype_filter);
  if (ret)
    return ret;
...
static int i40e_flow_check_raw_item(const struct rte_flow_item *item,
...
i40e_flow_fdir_get_pctype_value(struct i40e_pf *pf,
  ...
  case RTE_FLOW_ITEM_TYPE_GTPC:
    cus_pctype = i40e_find_customized_pctype(pf, I40E_CUSTOMIZED_GTPC);
    break;
  case RTE_FLOW_ITEM_TYPE_GTPU:
    if (!filter->input.flow_ext.inner_ip)
      cus_pctype = i40e_find_customized_pctype(pf, I40E_CUSTOMIZED_GTPU);
    else if (filter->input.flow_ext.iip_type == I40E_FDIR_IPTYPE_IPV4)
      cus_pctype = i40e_find_customized_pctype(pf, I40E_CUSTOMIZED_GTPU_IPV4);
    else if (filter->input.flow_ext.iip_type == I40E_FDIR_IPTYPE_IPV6)
      cus_pctype = i40e_find_customized_pctype(pf, I40E_CUSTOMIZED_GTPU_IPV6);
    break;
  case RTE_FLOW_ITEM_TYPE_L2TPV3OIP:
    if (filter->input.flow_ext.oip_type == I40E_FDIR_IPTYPE_IPV4)
      cus_pctype = i40e_find_customized_pctype(pf, I40E_CUSTOMIZED_IPV4_L2TPV3);
    else if (filter->input.flow_ext.oip_type == I40E_FDIR_IPTYPE_IPV6)
      cus_pctype = i40e_find_customized_pctype(pf, I40E_CUSTOMIZED_IPV6_L2TPV3);
    break;
  case RTE_FLOW_ITEM_TYPE_ESP:
    if (!filter->input.flow_ext.is_udp) {
      if (filter->input.flow_ext.oip_type == I40E_FDIR_IPTYPE_IPV4)
        cus_pctype = i40e_find_customized_pctype(pf, I40E_CUSTOMIZED_ESP_IPV4);
      else if (filter->input.flow_ext.oip_type == I40E_FDIR_IPTYPE_IPV6)
        cus_pctype = i40e_find_customized_pctype(pf, I40E_CUSTOMIZED_ESP_IPV6);
    } else {
      if (filter->input.flow_ext.oip_type == I40E_FDIR_IPTYPE_IPV4)
        cus_pctype =
...
static void i40e_flow_set_filter_spi(struct i40e_fdir_filter_conf *filter,
  ...
  if (filter->input.flow_ext.oip_type == I40E_FDIR_IPTYPE_IPV6) {
    if (filter->input.flow_ext.is_udp)
...
static int i40e_flow_parse_fdir_pattern(struct rte_eth_dev *dev,
  ...
  uint32_t i, j;
  uint8_t ipv6_addr_mask[16] = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
  ...
  for (; item->type != RTE_FLOW_ITEM_TYPE_END; item++) {
    ...
    case RTE_FLOW_ITEM_TYPE_ETH:
      ...
      if (next_type == RTE_FLOW_ITEM_TYPE_END && (!eth_spec || !eth_mask)) {
        rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ITEM, item,
                           "NULL eth spec/mask.");
        return -rte_errno;
      }
      ...
      if (eth_spec && eth_mask && next_type == RTE_FLOW_ITEM_TYPE_END) {
        ...
        filter->input.flow.l2_flow.ether_type = eth_spec->type;
      }
    ...
    case RTE_FLOW_ITEM_TYPE_VLAN:
      ...
      if (vlan_spec && vlan_mask) {
        if (vlan_mask->tci != rte_cpu_to_be_16(I40E_VLAN_TCI_MASK) &&
            vlan_mask->tci != rte_cpu_to_be_16(I40E_VLAN_PRI_MASK) &&
            vlan_mask->tci != rte_cpu_to_be_16(I40E_VLAN_CFI_MASK) &&
            vlan_mask->tci != rte_cpu_to_be_16(I40E_VLAN_VID_MASK)) {
          rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ITEM, item,
                             "Unsupported TCI mask.");
        }
        input_set |= I40E_INSET_VLAN_INNER;
        filter->input.flow_ext.vlan_tci = vlan_spec->tci;
      }
      if (vlan_spec && vlan_mask && vlan_mask->inner_type) {
        ...
        ether_type = rte_be_to_cpu_16(vlan_spec->inner_type);
        ...
        input_set |= I40E_INSET_LAST_ETHER_TYPE;
        filter->input.flow.l2_flow.ether_type = vlan_spec->inner_type;
      }
    ...
    case RTE_FLOW_ITEM_TYPE_IPV4:
      ...
      if (ipv4_last) {
        ...
        if (ipv4_last->hdr.version_ihl || ipv4_last->hdr.type_of_service ||
            ipv4_last->hdr.total_length || ipv4_last->hdr.packet_id ||
            ipv4_last->hdr.time_to_live || ipv4_last->hdr.next_proto_id ||
            ipv4_last->hdr.hdr_checksum || ipv4_last->hdr.src_addr ||
      ...
      if (ipv4_spec && ipv4_mask && outer_ip) {
        ...
        uint16_t frag_mask = ipv4_mask->hdr.fragment_offset;
        uint16_t frag_spec = ipv4_spec->hdr.fragment_offset;
        uint16_t frag_last = 0;
        if (ipv4_last)
          frag_last = ipv4_last->hdr.fragment_offset;
        if (frag_mask) {
        ...
        if (input_set & (I40E_INSET_DMAC | I40E_INSET_SMAC)) {
          if (input_set &
              (I40E_INSET_IPV4_SRC | I40E_INSET_IPV4_DST | I40E_INSET_IPV4_TOS |
    ...
    case RTE_FLOW_ITEM_TYPE_IPV6:
      ...
      if (ipv6_spec && ipv6_mask && outer_ip) {
        ...
        if ((ipv6_mask->hdr.vtc_flow & rte_cpu_to_be_32(I40E_IPV6_TC_MASK)) ==
        ...
        filter->input.flow.ipv6_flow.tc =
            (uint8_t)(vtc_flow_cpu >> I40E_FDIR_IPv6_TC_OFFSET);
        ...
        rte_memcpy(filter->input.flow.ipv6_flow.src_ip, ipv6_spec->hdr.src_addr,
                   16);
        rte_memcpy(filter->input.flow.ipv6_flow.dst_ip, ipv6_spec->hdr.dst_addr,
                   16);
    ...
    case RTE_FLOW_ITEM_TYPE_TCP:
      ...
      if (tcp_spec && tcp_mask) {
        ...
        if (input_set & (I40E_INSET_DMAC | I40E_INSET_SMAC)) {
          if (input_set & (I40E_INSET_SRC_PORT | I40E_INSET_DST_PORT)) {
            rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ITEM, item,
          ...
          /* Get filter info */
          if (l3 == RTE_FLOW_ITEM_TYPE_IPV4) {
            filter->input.flow.tcp4_flow.src_port = tcp_spec->hdr.src_port;
            filter->input.flow.tcp4_flow.dst_port = tcp_spec->hdr.dst_port;
          } else if (l3 == RTE_FLOW_ITEM_TYPE_IPV6) {
            filter->input.flow.tcp6_flow.src_port = tcp_spec->hdr.src_port;
            filter->input.flow.tcp6_flow.dst_port = tcp_spec->hdr.dst_port;
          }
        }
      }
    ...
    case RTE_FLOW_ITEM_TYPE_UDP:
      ...
      if (udp_spec && udp_mask) {
        ...
        if (input_set & (I40E_INSET_DMAC | I40E_INSET_SMAC)) {
          ...
          /* Get filter info */
          if (l3 == RTE_FLOW_ITEM_TYPE_IPV4) {
            filter->input.flow.udp4_flow.src_port = udp_spec->hdr.src_port;
            filter->input.flow.udp4_flow.dst_port = udp_spec->hdr.dst_port;
          } else if (l3 == RTE_FLOW_ITEM_TYPE_IPV6) {
            filter->input.flow.udp6_flow.src_port = udp_spec->hdr.src_port;
            filter->input.flow.udp6_flow.dst_port = udp_spec->hdr.dst_port;
          }
        }
      }
    ...
    case RTE_FLOW_ITEM_TYPE_SCTP:
      ...
      if (sctp_spec && sctp_mask) {
        ...
        /* Get filter info */
        if (l3 == RTE_FLOW_ITEM_TYPE_IPV4) {
          filter->input.flow.sctp4_flow.src_port = sctp_spec->hdr.src_port;
          filter->input.flow.sctp4_flow.dst_port = sctp_spec->hdr.dst_port;
          filter->input.flow.sctp4_flow.verify_tag = sctp_spec->hdr.tag;
        } else if (l3 == RTE_FLOW_ITEM_TYPE_IPV6) {
          filter->input.flow.sctp6_flow.src_port = sctp_spec->hdr.src_port;
          filter->input.flow.sctp6_flow.dst_port = sctp_spec->hdr.dst_port;
          filter->input.flow.sctp6_flow.verify_tag = sctp_spec->hdr.tag;
        }
      }
    ...
    case RTE_FLOW_ITEM_TYPE_RAW:
      ...
      if (pf->support_multi_driver) {
        rte_flow_error_set(error, ENOTSUP, RTE_FLOW_ERROR_TYPE_ITEM, item,
      ...
      flex_pit.size = raw_spec->length / sizeof(uint16_t);
      flex_pit.dst_offset = next_dst_off / sizeof(uint16_t);

      for (i = 0; i <= raw_id; i++) {
        if (i == raw_id)
          flex_pit.src_offset += raw_spec->offset / sizeof(uint16_t);
        else
          flex_pit.src_offset += (off_arr[i] + len_arr[i]) / sizeof(uint16_t);
        flex_size += len_arr[i];
      }
      ...
      for (i = 0; i < raw_spec->length; i++) {
        j = i + next_dst_off;
        if (j >= RTE_ETH_FDIR_MAX_FLEXLEN || j >= I40E_FDIR_MAX_FLEX_LEN)
          break;
      ...
      memcpy(&filter->input.flow_ext.flex_pit[field_idx], &flex_pit,
             sizeof(struct i40e_fdir_flex_pit));
...
static int i40e_flow_parse_fdir_filter(struct rte_eth_dev *dev,
  ...
  ret = i40e_flow_parse_fdir_pattern(dev, attr, pattern, error, fdir_filter);
  if (ret)
    return ret;
  ...
  if (pf->fdir.fdir_vsi == NULL) {
    ...
    if (ret != I40E_SUCCESS) {
      rte_flow_error_set(error, ENOTSUP, RTE_FLOW_ERROR_TYPE_HANDLE, NULL,
...
static int i40e_flow_parse_tunnel_action(
  ...
  if (act->type == RTE_FLOW_ACTION_TYPE_QUEUE) {
    ...
    if ((!filter->is_to_vf) &&
      ...
      return -rte_errno;
    } else if (filter->is_to_vf && (filter->queue_id >= pf->vf_nb_qps)) {
      rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ACTION, act,
                         "Invalid queue ID for tunnel filter");
      return -rte_errno;
    }
 ...
 *    filled with 0.
 */
static int i40e_flow_parse_l4_pattern(const struct rte_flow_item *pattern,
                                      struct rte_flow_error *error,
                                      struct i40e_tunnel_filter_conf *filter) {
  const struct rte_flow_item_sctp *sctp_spec, *sctp_mask;
  const struct rte_flow_item_tcp *tcp_spec, *tcp_mask;
  ...
  for (; item->type != RTE_FLOW_ITEM_TYPE_END; item++) {
    ...
    case RTE_FLOW_ITEM_TYPE_UDP:
      ...
      if (udp_spec->hdr.src_port != 0 && udp_spec->hdr.dst_port != 0) {
        rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ITEM, item,
                           "Invalid udp spec");
        return -rte_errno;
      }
      ...
      if (udp_spec->hdr.src_port != 0) {
        filter->l4_port_type = I40E_L4_PORT_TYPE_SRC;
        filter->tenant_id = rte_be_to_cpu_32(udp_spec->hdr.src_port);
      }

      if (udp_spec->hdr.dst_port != 0) {
        filter->l4_port_type = I40E_L4_PORT_TYPE_DST;
        filter->tenant_id = rte_be_to_cpu_32(udp_spec->hdr.dst_port);
      }
    ...
    case RTE_FLOW_ITEM_TYPE_TCP:
      ...
      if (tcp_spec->hdr.src_port != 0 && tcp_spec->hdr.dst_port != 0) {
        rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ITEM, item,
                           "Invalid tcp spec");
        return -rte_errno;
      }
      ...
      if (tcp_spec->hdr.src_port != 0) {
        filter->l4_port_type = I40E_L4_PORT_TYPE_SRC;
        filter->tenant_id = rte_be_to_cpu_32(tcp_spec->hdr.src_port);
      }

      if (tcp_spec->hdr.dst_port != 0) {
        filter->l4_port_type = I40E_L4_PORT_TYPE_DST;
        filter->tenant_id = rte_be_to_cpu_32(tcp_spec->hdr.dst_port);
      }
    ...
    case RTE_FLOW_ITEM_TYPE_SCTP:
      ...
      if (sctp_spec->hdr.src_port != 0 && sctp_spec->hdr.dst_port != 0) {
        rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ITEM, item,
                           "Invalid sctp spec");
        return -rte_errno;
      }
      ...
      if (sctp_spec->hdr.src_port != 0) {
        filter->l4_port_type = I40E_L4_PORT_TYPE_SRC;
        filter->tenant_id = rte_be_to_cpu_32(sctp_spec->hdr.src_port);
      }

      if (sctp_spec->hdr.dst_port != 0) {
        filter->l4_port_type = I40E_L4_PORT_TYPE_DST;
        filter->tenant_id = rte_be_to_cpu_32(sctp_spec->hdr.dst_port);
      }
...
static int i40e_check_tunnel_filter_type(uint8_t filter_type) {
  uint8_t i;
 ...
 *    filled with 0.
 */
static int i40e_flow_parse_vxlan_pattern(
    __rte_unused struct rte_eth_dev *dev, const struct rte_flow_item *pattern,
    struct rte_flow_error *error, struct i40e_tunnel_filter_conf *filter) {
  const struct rte_flow_item *item = pattern;
  const struct rte_flow_item_eth *eth_spec;
  const struct rte_flow_item_eth *eth_mask;
  ...
  for (; item->type != RTE_FLOW_ITEM_TYPE_END; item++) {
    ...
    case RTE_FLOW_ITEM_TYPE_ETH:
      ...
      if (eth_spec && eth_mask) {
         ...
         */
        if (!rte_is_broadcast_ether_addr(&eth_mask->dst) ||
            !rte_is_zero_ether_addr(&eth_mask->src) || eth_mask->type) {
          rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ITEM, item,
                             "Invalid ether spec/mask");
          return -rte_errno;
        }
        ...
        if (!vxlan_flag) {
          rte_memcpy(&filter->outer_mac, &eth_spec->dst, RTE_ETHER_ADDR_LEN);
          filter_type |= RTE_ETH_TUNNEL_FILTER_OMAC;
        } else {
          rte_memcpy(&filter->inner_mac, &eth_spec->dst, RTE_ETHER_ADDR_LEN);
    ...
    case RTE_FLOW_ITEM_TYPE_VLAN:
      ...
      if (vlan_spec && vlan_mask) {
        if (vlan_mask->tci == rte_cpu_to_be_16(I40E_VLAN_TCI_MASK))
          filter->inner_vlan =
              rte_be_to_cpu_16(vlan_spec->tci) & I40E_VLAN_TCI_MASK;
    ...
    case RTE_FLOW_ITEM_TYPE_VXLAN:
      ...
      if (vxlan_spec && vxlan_mask) {
        is_vni_masked = !!memcmp(vxlan_mask->vni, vni_mask, RTE_DIM(vni_mask));
        if (is_vni_masked) {
          rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ITEM, item,
                             "Invalid VNI mask");
          return -rte_errno;
...
static int i40e_flow_parse_vxlan_filter(struct rte_eth_dev *dev,
  ...
  ret = i40e_flow_parse_vxlan_pattern(dev, pattern, error, tunnel_filter);
  if (ret)
    return ret;
 ...
 *    filled with 0.
 */
static int i40e_flow_parse_nvgre_pattern(
    __rte_unused struct rte_eth_dev *dev, const struct rte_flow_item *pattern,
    struct rte_flow_error *error, struct i40e_tunnel_filter_conf *filter) {
  const struct rte_flow_item *item = pattern;
  const struct rte_flow_item_eth *eth_spec;
  ...
  for (; item->type != RTE_FLOW_ITEM_TYPE_END; item++) {
    ...
    case RTE_FLOW_ITEM_TYPE_NVGRE:
      ...
      if (nvgre_spec && nvgre_mask) {
        is_tni_masked = !!memcmp(nvgre_mask->tni, tni_mask, RTE_DIM(tni_mask));
        if (is_tni_masked) {
          rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ITEM, item,
                             "Invalid TNI mask");
          return -rte_errno;
        }
        if (nvgre_mask->protocol && nvgre_mask->protocol != 0xFFFF) {
          rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ITEM, item,
                             "Invalid NVGRE item");
          return -rte_errno;
        }
        if (nvgre_mask->c_k_s_rsvd0_ver &&
            nvgre_mask->c_k_s_rsvd0_ver != rte_cpu_to_be_16(0xFFFF)) {
          rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ITEM, item,
                             "Invalid NVGRE item");
          return -rte_errno;
        }
        if (nvgre_spec->c_k_s_rsvd0_ver != rte_cpu_to_be_16(0x2000) &&
...
static int i40e_flow_parse_nvgre_filter(struct rte_eth_dev *dev,
  ...
  ret = i40e_flow_parse_nvgre_pattern(dev, pattern, error, tunnel_filter);
  if (ret)
    return ret;
 ...
 *    filled with 0.
 */
static int i40e_flow_parse_mpls_pattern(
    __rte_unused struct rte_eth_dev *dev, const struct rte_flow_item *pattern,
    struct rte_flow_error *error, struct i40e_tunnel_filter_conf *filter) {
  const struct rte_flow_item *item = pattern;
  ...
  for (; item->type != RTE_FLOW_ITEM_TYPE_END; item++) {
    ...
    case RTE_FLOW_ITEM_TYPE_MPLS:
      ...
      rte_memcpy(((uint8_t *)&label_be + 1), mpls_spec->label_tc_s, 3);
...
static int i40e_flow_parse_mpls_filter(struct rte_eth_dev *dev,
  ...
  ret = i40e_flow_parse_mpls_pattern(dev, pattern, error, tunnel_filter);
  if (ret)
    return ret;
 ...
 */
static int i40e_flow_parse_gtp_pattern(struct rte_eth_dev *dev,
                                       const struct rte_flow_item *pattern,
                                       struct rte_flow_error *error,
                                       struct i40e_tunnel_filter_conf *filter) {
  struct i40e_pf *pf = I40E_DEV_PRIVATE_TO_PF(dev->data->dev_private);
...
static int i40e_flow_parse_gtp_filter(struct rte_eth_dev *dev,
  ...
  ret = i40e_flow_parse_gtp_pattern(dev, pattern, error, tunnel_filter);
  if (ret)
    return ret;
 ...
 *    filled with 0.
 */
static int i40e_flow_parse_qinq_pattern(
    __rte_unused struct rte_eth_dev *dev, const struct rte_flow_item *pattern,
    struct rte_flow_error *error, struct i40e_tunnel_filter_conf *filter) {
  const struct rte_flow_item *item = pattern;
...
static int i40e_flow_parse_qinq_filter(struct rte_eth_dev *dev,
  ...
  ret = i40e_flow_parse_qinq_pattern(dev, pattern, error, tunnel_filter);
  if (ret)
    return ret;
...
static int i40e_flow_validate(struct rte_eth_dev *dev,
  ...
  if (!actions) {
    rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ACTION_NUM, NULL,
                       "NULL action.");
    return -rte_errno;
  }
  ...
  if ((actions + i)->type == RTE_FLOW_ACTION_TYPE_RSS) {
    ...
    return i40e_hash_parse(dev, pattern, actions + i, &cons_filter.rss_conf,
                           error);
  }
  ...
  if (item_num <= ARRAY_SIZE(g_items)) {
    ...
    items =
        rte_zmalloc("i40e_pattern", item_num * sizeof(struct rte_flow_item), 0);
    if (!items) {
      rte_flow_error_set(error, ENOMEM, RTE_FLOW_ERROR_TYPE_ITEM_NUM, NULL,
...
static struct rte_flow *i40e_flow_create(struct rte_eth_dev *dev,
  ...
  if (cons_filter_type == RTE_ETH_FILTER_FDIR) {
    ...
    if (flow == NULL) {
      rte_flow_error_set(error, ENOBUFS, RTE_FLOW_ERROR_TYPE_HANDLE, NULL,
                         "Fdir space full");
    ...
    if (!flow) {
      rte_flow_error_set(error, ENOMEM, RTE_FLOW_ERROR_TYPE_HANDLE, NULL,
  ...
  case RTE_ETH_FILTER_ETHERTYPE:
    ret = i40e_ethertype_filter_set(pf, &cons_filter.ethertype_filter, 1);
    if (ret)
      goto free_flow;
    flow->rule =
        TAILQ_LAST(&pf->ethertype.ethertype_list, i40e_ethertype_filter_list);
    break;
  case RTE_ETH_FILTER_FDIR:
    ret = i40e_flow_add_del_fdir_filter(dev, &cons_filter.fdir_filter, 1);
    if (ret)
      goto free_flow;
    flow->rule = TAILQ_LAST(&pf->fdir.fdir_list, i40e_fdir_filter_list);
    break;
  case RTE_ETH_FILTER_TUNNEL:
    ret = i40e_dev_consistent_tunnel_filter_set(
        pf, &cons_filter.consistent_tunnel_filter, 1);
    if (ret)
      goto free_flow;
    flow->rule = TAILQ_LAST(&pf->tunnel.tunnel_list, i40e_tunnel_filter_list);
    break;
  case RTE_ETH_FILTER_HASH:
    ret = i40e_hash_filter_create(pf, &cons_filter.rss_conf);
    if (ret)
      goto free_flow;
    flow->rule = TAILQ_LAST(&pf->rss_config_list, i40e_rss_conf_list);
    break;
  default:
    goto free_flow;
  }
...
static int i40e_flow_destroy(struct rte_eth_dev *dev, struct rte_flow *flow,
  ...
  switch (filter_type) {
  case RTE_ETH_FILTER_ETHERTYPE:
    ret = i40e_flow_destroy_ethertype_filter(
        pf, (struct i40e_ethertype_filter *)flow->rule);
    break;
  case RTE_ETH_FILTER_TUNNEL:
    ret = i40e_flow_destroy_tunnel_filter(
        pf, (struct i40e_tunnel_filter *)flow->rule);
    break;
  case RTE_ETH_FILTER_FDIR:
    ret = i40e_flow_add_del_fdir_filter(
        dev, &((struct i40e_fdir_filter *)flow->rule)->fdir, 0);
  ...
  case RTE_ETH_FILTER_HASH:
    ...
    break;
  default:
    PMD_DRV_LOG(WARNING, "Filter type (%d) not supported", filter_type);
    ret = -EINVAL;
    break;
  }
...
i40e_flow_destroy_ethertype_filter(struct i40e_pf *pf,
  ...
  ret = i40e_aq_add_rem_control_packet_filter(
      hw, filter->input.mac_addr.addr_bytes, filter->input.ether_type, flags,
      pf->main_vsi->seid, filter->queue, 0, &stats, NULL);
  if (ret < 0)
    return ret;
...
static int i40e_flow_destroy_tunnel_filter(struct i40e_pf *pf,
  ...
  rte_memcpy(cld_filter.general_fields, filter->input.general_fields,
...
static int i40e_flow_flush_fdir_filter(struct i40e_pf *pf) {
  ...
  if (!ret) {
    ...
    while ((fdir_filter = TAILQ_FIRST(&fdir_info->fdir_list))) {
      ret = i40e_sw_fdir_filter_del(pf, &fdir_filter->fdir.input);
      if (ret < 0)
        return ret;
    }
    ...
    memset(fdir_info->fdir_filter_array, 0,
           sizeof(struct i40e_fdir_filter) * I40E_MAX_FDIR_FILTER_NUM);
...
static int i40e_flow_query(struct rte_eth_dev *dev __rte_unused,
                           struct rte_flow *flow,
                           const struct rte_flow_action *actions, void *data,
                           struct rte_flow_error *error) {
  ...
  for (; actions->type != RTE_FLOW_ACTION_TYPE_END; actions++) {
    ...
    case RTE_FLOW_ACTION_TYPE_RSS:
      ...
      rte_memcpy(rss_conf, &rss_rule->rss_filter_info.conf,
