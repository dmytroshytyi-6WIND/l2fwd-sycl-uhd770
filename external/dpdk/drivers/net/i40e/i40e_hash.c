...
#define I40E_HASH_HDR_IPV4_INNER                                               \
  (I40E_HASH_HDR_IPV4 << I40E_HASH_HDR_INNER_SHIFT)
#define I40E_HASH_HDR_IPV6_INNER                                               \
  (I40E_HASH_HDR_IPV6 << I40E_HASH_HDR_INNER_SHIFT)
...
#define I40E_PHINT_IPV6_FRAG (I40E_PHINT_IPV6 | I40E_HASH_HDR_IPV6_FRAG)
...
#define I40E_PHINT_IPV4_UDP_ESP (I40E_PHINT_IPV4_UDP | I40E_HASH_HDR_ESP)
#define I40E_PHINT_IPV6_UDP_ESP (I40E_PHINT_IPV6_UDP | I40E_HASH_HDR_ESP)

/* GTPC */
#define I40E_PHINT_IPV4_GTPC (I40E_PHINT_IPV4_UDP | I40E_HASH_HDR_GTPC)
#define I40E_PHINT_IPV6_GTPC (I40E_PHINT_IPV6_UDP | I40E_HASH_HDR_GTPC)

/* GTPU */
#define I40E_PHINT_IPV4_GTPU (I40E_PHINT_IPV4_UDP | I40E_HASH_HDR_GTPU)
#define I40E_PHINT_IPV4_GTPU_IPV4                                              \
  (I40E_PHINT_IPV4_GTPU | I40E_HASH_HDR_IPV4_INNER)
#define I40E_PHINT_IPV4_GTPU_IPV6                                              \
  (I40E_PHINT_IPV4_GTPU | I40E_HASH_HDR_IPV6_INNER)
#define I40E_PHINT_IPV6_GTPU (I40E_PHINT_IPV6_UDP | I40E_HASH_HDR_GTPU)
#define I40E_PHINT_IPV6_GTPU_IPV4                                              \
  (I40E_PHINT_IPV6_GTPU | I40E_HASH_HDR_IPV4_INNER)
#define I40E_PHINT_IPV6_GTPU_IPV6                                              \
  (I40E_PHINT_IPV6_GTPU | I40E_HASH_HDR_IPV6_INNER)
...
const struct i40e_hash_map_rss_inset i40e_hash_rss_inset[] = {
    ...
    {RTE_ETH_RSS_NONFRAG_IPV4_OTHER, I40E_INSET_IPV4_SRC | I40E_INSET_IPV4_DST},
    ...
    {RTE_ETH_RSS_NONFRAG_IPV6_OTHER, I40E_INSET_IPV6_SRC | I40E_INSET_IPV6_DST},
...
#define I40E_HASH_ETH_NEXT_ALLOW                                               \
  (BIT_ULL(RTE_FLOW_ITEM_TYPE_IPV4) | BIT_ULL(RTE_FLOW_ITEM_TYPE_IPV6) |       \
   BIT_ULL(RTE_FLOW_ITEM_TYPE_VLAN))

#define I40E_HASH_IP_NEXT_ALLOW                                                \
  (BIT_ULL(RTE_FLOW_ITEM_TYPE_TCP) | BIT_ULL(RTE_FLOW_ITEM_TYPE_UDP) |         \
   BIT_ULL(RTE_FLOW_ITEM_TYPE_SCTP) | BIT_ULL(RTE_FLOW_ITEM_TYPE_ESP) |        \
   BIT_ULL(RTE_FLOW_ITEM_TYPE_L2TPV3OIP) | BIT_ULL(RTE_FLOW_ITEM_TYPE_AH))

#define I40E_HASH_IPV6_NEXT_ALLOW                                              \
  (I40E_HASH_IP_NEXT_ALLOW | BIT_ULL(RTE_FLOW_ITEM_TYPE_IPV6_FRAG_EXT))

#define I40E_HASH_UDP_NEXT_ALLOW                                               \
  (BIT_ULL(RTE_FLOW_ITEM_TYPE_GTPU) | BIT_ULL(RTE_FLOW_ITEM_TYPE_GTPC))

#define I40E_HASH_GTPU_NEXT_ALLOW                                              \
  (BIT_ULL(RTE_FLOW_ITEM_TYPE_IPV4) | BIT_ULL(RTE_FLOW_ITEM_TYPE_IPV6))
...
#define I40E_HASH_L2_RSS_MASK                                                  \
  (RTE_ETH_RSS_VLAN | RTE_ETH_RSS_ETH | RTE_ETH_RSS_L2_SRC_ONLY |              \
   RTE_ETH_RSS_L2_DST_ONLY)

#define I40E_HASH_L23_RSS_MASK                                                 \
  (I40E_HASH_L2_RSS_MASK | RTE_ETH_RSS_L3_SRC_ONLY | RTE_ETH_RSS_L3_DST_ONLY)
...
#define I40E_HASH_L234_RSS_MASK                                                \
  (I40E_HASH_L23_RSS_MASK | RTE_ETH_RSS_PORT | RTE_ETH_RSS_L4_SRC_ONLY |       \
   RTE_ETH_RSS_L4_DST_ONLY)

#define I40E_HASH_IPV4_L234_RSS_MASK                                           \
  (I40E_HASH_L234_RSS_MASK | RTE_ETH_RSS_IPV4)
#define I40E_HASH_IPV6_L234_RSS_MASK                                           \
  (I40E_HASH_L234_RSS_MASK | RTE_ETH_RSS_IPV6)

#define I40E_HASH_L4_TYPES                                                     \
...
static const struct i40e_hash_match_pattern match_patterns[] = {
    ...
    /* ESP */
    I40E_HASH_MAP_CUS_PATTERN(I40E_PHINT_IPV4_ESP, RTE_ETH_RSS_ESP,
                              I40E_CUSTOMIZED_ESP_IPV4),
    I40E_HASH_MAP_CUS_PATTERN(I40E_PHINT_IPV6_ESP, RTE_ETH_RSS_ESP,
                              I40E_CUSTOMIZED_ESP_IPV6),
    I40E_HASH_MAP_CUS_PATTERN(I40E_PHINT_IPV4_UDP_ESP, RTE_ETH_RSS_ESP,
                              I40E_CUSTOMIZED_ESP_IPV4_UDP),
    I40E_HASH_MAP_CUS_PATTERN(I40E_PHINT_IPV6_UDP_ESP, RTE_ETH_RSS_ESP,
    ...
    I40E_HASH_MAP_CUS_PATTERN(I40E_PHINT_IPV4_GTPU_IPV4, RTE_ETH_RSS_GTPU,
                              I40E_CUSTOMIZED_GTPU_IPV4),
    I40E_HASH_MAP_CUS_PATTERN(I40E_PHINT_IPV4_GTPU_IPV6, RTE_ETH_RSS_GTPU,
                              I40E_CUSTOMIZED_GTPU_IPV6),
    I40E_HASH_MAP_CUS_PATTERN(I40E_PHINT_IPV6_GTPU,
                              I40E_HASH_IPV6_L234_RSS_MASK,
                              I40E_CUSTOMIZED_GTPU),
    I40E_HASH_MAP_CUS_PATTERN(I40E_PHINT_IPV6_GTPU_IPV4, RTE_ETH_RSS_GTPU,
                              I40E_CUSTOMIZED_GTPU_IPV4),
    I40E_HASH_MAP_CUS_PATTERN(I40E_PHINT_IPV6_GTPU_IPV6, RTE_ETH_RSS_GTPU,
                              I40E_CUSTOMIZED_GTPU_IPV6),

    /* L2TPV3 */
    I40E_HASH_MAP_CUS_PATTERN(I40E_PHINT_IPV4_L2TPV3, RTE_ETH_RSS_L2TPV3,
                              I40E_CUSTOMIZED_IPV4_L2TPV3),
    I40E_HASH_MAP_CUS_PATTERN(I40E_PHINT_IPV6_L2TPV3, RTE_ETH_RSS_L2TPV3,
...
static int i40e_hash_get_pattern_type(const struct rte_flow_item pattern[],
  ...
  for (; pattern->type != RTE_FLOW_ITEM_TYPE_END; pattern++) {
    ...
    if (prev_item_type >=
            (enum rte_flow_item_type)RTE_DIM(pattern_next_allow_items) ||
        !(pattern_next_allow_items[prev_item_type] & BIT_ULL(pattern->type)))
      goto not_sup;
    ...
    assert(last_item_type <
           (enum rte_flow_item_type)RTE_DIM(pattern_item_header));
...
not_sup:
  return rte_flow_error_set(error, ENOTSUP, RTE_FLOW_ERROR_TYPE_ITEM, pattern,
                            message);
}

static uint64_t i40e_hash_get_x722_ext_pctypes(uint8_t match_pctype) {
  uint64_t pctypes = 0;
...
i40e_hash_translate_gtp_inset(struct i40e_rte_flow_rss_conf *rss_conf,
                              struct rte_flow_error *error) {
  if (rss_conf->inset & (I40E_INSET_IPV4_SRC | I40E_INSET_IPV6_SRC |
                         I40E_INSET_DST_PORT | I40E_INSET_SRC_PORT))
    return rte_flow_error_set(error, ENOTSUP, RTE_FLOW_ERROR_TYPE_ACTION_CONF,
                              NULL, "Only support external destination IP");

  if (rss_conf->inset & I40E_INSET_IPV4_DST)
    rss_conf->inset =
        (rss_conf->inset & ~I40E_INSET_IPV4_DST) | I40E_INSET_TUNNEL_IPV4_DST;

  if (rss_conf->inset & I40E_INSET_IPV6_DST)
    rss_conf->inset =
        (rss_conf->inset & ~I40E_INSET_IPV6_DST) | I40E_INSET_TUNNEL_IPV6_DST;

  return 0;
}

static int i40e_hash_get_pctypes(const struct rte_eth_dev *dev,
...
static int i40e_hash_get_pattern_pctypes(
    const struct rte_eth_dev *dev, const struct rte_flow_item pattern[],
    const struct rte_flow_action_rss *rss_act,
    struct i40e_rte_flow_rss_conf *rss_conf, struct rte_flow_error *error) {
  ...
  for (i = 0; i < (int)RTE_DIM(match_patterns); i++) {
    const struct i40e_hash_match_pattern *match = &match_patterns[i];
    ...
    if (!(rss_act->types & ~match->rss_mask)) {
      ret = i40e_hash_get_pctypes(dev, match, rss_conf, error);
      if (ret)
        return ret;
    }
  }
...
static uint64_t i40e_hash_get_inset(uint64_t rss_types) {
  ...
  if (rss_types & I40E_HASH_L4_TYPES) {
    uint64_t l3_mask =
        rss_types & (RTE_ETH_RSS_L3_SRC_ONLY | RTE_ETH_RSS_L3_DST_ONLY);
    uint64_t l4_mask =
        rss_types & (RTE_ETH_RSS_L4_SRC_ONLY | RTE_ETH_RSS_L4_DST_ONLY);
...
static int i40e_hash_config_func(struct i40e_hw *hw,
  ...
  if (pf->support_multi_driver) {
    PMD_DRV_LOG(
        ERR, "Modify hash function is not permitted when multi-driver enabled");
    return -EPERM;
  }
...
static int i40e_hash_config_pctype_symmetric(struct i40e_hw *hw,
                                             uint32_t pctype, bool symmetric) {
  ...
  if (pf->support_multi_driver) {
    PMD_DRV_LOG(ERR, "Enable/Disable symmetric hash is not permitted when "
                     "multi-driver enabled");
    return -EPERM;
  }
...
static void i40e_hash_enable_pctype(struct i40e_hw *hw, uint32_t pctype,
                                    bool enable) {
...
static int i40e_hash_config_pctype(struct i40e_hw *hw,
                                   struct i40e_rte_flow_rss_conf *rss_conf,
                                   uint32_t pctype) {
...
i40e_hash_config_region(struct i40e_pf *pf,
  ...
  for (i = 0; i < num; i++) {
    if (rss_conf->region_queue_start == regions[i].queue_start_index &&
        rss_conf->region_queue_num == regions[i].queue_num) {
      uint32_t j;

      for (j = 0; j < regions[i].user_priority_num; j++) {
        if (regions[i].user_priority[j] == rss_conf->region_priority)
          return 0;
      }

      if (j >= I40E_MAX_USER_PRIORITY) {
        PMD_DRV_LOG(ERR, "Priority number exceed the maximum %d",
...
static int i40e_hash_config(struct i40e_pf *pf,
                            struct i40e_rte_flow_rss_conf *rss_conf) {
  ...
  if (rss_info->key_len > 0) {
    ret = i40e_set_rss_key(pf->main_vsi, rss_conf->key, rss_info->key_len);
    if (ret)
      return ret;
...
static void i40e_hash_parse_key(const struct rte_flow_action_rss *rss_act,
                                struct i40e_rte_flow_rss_conf *rss_conf) {
  const uint8_t *key = rss_act->key;

  if (!key || rss_act->key_len != sizeof(rss_conf->key)) {
    const uint32_t rss_key_default[] = {
...
static int i40e_hash_parse_queues(const struct rte_eth_dev *dev,
                                  const struct rte_flow_action_rss *rss_act,
                                  struct i40e_rte_flow_rss_conf *rss_conf,
                                  struct rte_flow_error *error) {
  struct i40e_pf *pf;
  ...
  if (!rss_act->queue_num || rss_act->queue_num > hw->func_caps.rss_table_size)
    return rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ACTION_CONF,
                              NULL, "Invalid RSS queue number");

  if (rss_act->key_len)
    PMD_DRV_LOG(WARNING, "RSS key is ignored when queues specified");
...
static int i40e_hash_parse_queue_region(
    const struct rte_eth_dev *dev, const struct rte_flow_item pattern[],
    const struct rte_flow_action_rss *rss_act,
    struct i40e_rte_flow_rss_conf *rss_conf, struct rte_flow_error *error) {
  struct i40e_pf *pf;
  ...
  if (pattern[1].type != RTE_FLOW_ITEM_TYPE_END)
    return rte_flow_error_set(error, ENOTSUP, RTE_FLOW_ERROR_TYPE_ITEM_NUM,
                              &pattern[1], "Pattern not supported.");

  vlan_spec = pattern->spec;
  vlan_mask = pattern->mask;
  if (!vlan_spec || !vlan_mask || (rte_be_to_cpu_16(vlan_mask->tci) >> 13) != 7)
    return rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ITEM, pattern,
                              "Pattern error.");
  ...
  if (rss_act->key_len)
    PMD_DRV_LOG(WARNING, "RSS key is ignored when configure queue region");

  /* Use a 64 bit variable to represent all queues in a region. */
  RTE_BUILD_BUG_ON(I40E_MAX_Q_PER_TC > 64);

  if (!rss_act->queue_num || !rte_is_power_of_2(rss_act->queue_num) ||
  ...
  if (i < rss_act->queue_num)
    return rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ACTION_CONF,
                              NULL, "Queues must be incremented continuously");
...
static int i40e_hash_parse_global_conf(
    const struct rte_eth_dev *dev, const struct rte_flow_item pattern[],
    const struct rte_flow_action_rss *rss_act,
    struct i40e_rte_flow_rss_conf *rss_conf, struct rte_flow_error *error) {
  ...
  if (rss_act->types)
    PMD_DRV_LOG(WARNING, "RSS types are ignored when no pattern specified");

  if (pattern[0].type == RTE_FLOW_ITEM_TYPE_VLAN)
    return i40e_hash_parse_queue_region(dev, pattern, rss_act, rss_conf, error);
...
static bool i40e_hash_validate_rss_types(uint64_t rss_types) {
  uint64_t type, mask;
...
static int i40e_hash_parse_pattern_act(
    const struct rte_eth_dev *dev, const struct rte_flow_item pattern[],
    const struct rte_flow_action_rss *rss_act,
    struct i40e_rte_flow_rss_conf *rss_conf, struct rte_flow_error *error) {
  if (rss_act->queue)
  ...
  return i40e_hash_get_pattern_pctypes(dev, pattern, rss_act, rss_conf, error);
}
...
int i40e_hash_parse(const struct rte_eth_dev *dev,
  ...
  if (actions[1].type != RTE_FLOW_ACTION_TYPE_END)
    return rte_flow_error_set(error, EINVAL, RTE_FLOW_ERROR_TYPE_ACTION,
                              &actions[1], "Only support one action for RSS.");

  rss_act = (const struct rte_flow_action_rss *)actions[0].conf;
  if (rss_act->level)
    return rte_flow_error_set(error, ENOTSUP, RTE_FLOW_ERROR_TYPE_ACTION_CONF,
                              actions, "RSS level is not supported");
  ...
  if (pattern[0].type == RTE_FLOW_ITEM_TYPE_END ||
    ...
    return i40e_hash_parse_global_conf(dev, pattern, rss_act, rss_conf, error);
...
int i40e_hash_filter_restore(struct i40e_pf *pf) {
  ...
  TAILQ_FOREACH(filter, &pf->rss_config_list, next) {
    ...
    if (ret) {
      ...
      i40e_pf_disable_rss(pf);
      PMD_DRV_LOG(ERR, "Re-configure RSS failed, RSS has been disabled");
      return ret;
    }
    ...
    TAILQ_FOREACH(prev, &pf->rss_config_list, next) {
      if (prev == filter)
        break;
      i40e_invalid_rss_filter(rss_conf, &prev->rss_filter_info);
    }
  }
...
static int i40e_hash_reset_conf(struct i40e_pf *pf,
                                struct i40e_rte_flow_rss_conf *rss_conf) {
  struct i40e_hw *hw = &pf->adapter->hw;
...
int i40e_hash_filter_destroy(struct i40e_pf *pf,
  ...
  TAILQ_FOREACH(filter, &pf->rss_config_list, next) {
    if (rss_filter == filter) {
      ret = i40e_hash_reset_conf(pf, &filter->rss_filter_info);
      if (ret)
        return ret;
