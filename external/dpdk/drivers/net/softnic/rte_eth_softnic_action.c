...
struct softnic_port_in_action_profile *softnic_port_in_action_profile_create(
  ...
  /* Check input params */
  if (name == NULL || softnic_port_in_action_profile_find(p, name) ||
      params == NULL)
    return NULL;
  ...
  if (params->action_mask & (1LLU << RTE_PORT_IN_ACTION_FLTR)) {
    status = rte_port_in_action_profile_action_register(
        ap, RTE_PORT_IN_ACTION_FLTR, &params->fltr);
  ...
  if (params->action_mask & (1LLU << RTE_PORT_IN_ACTION_LB)) {
    status = rte_port_in_action_profile_action_register(
        ap, RTE_PORT_IN_ACTION_LB, &params->lb);
...
struct softnic_table_action_profile *softnic_table_action_profile_create(
  ...
  /* Check input params */
  if (name == NULL || softnic_table_action_profile_find(p, name) ||
      params == NULL ||
  ...
  if (params->action_mask & (1LLU << RTE_TABLE_ACTION_FWD)) {
    status = rte_table_action_profile_action_register(ap, RTE_TABLE_ACTION_FWD,
                                                      NULL);
  ...
  if (params->action_mask & (1LLU << RTE_TABLE_ACTION_LB)) {
    status = rte_table_action_profile_action_register(ap, RTE_TABLE_ACTION_LB,
                                                      &params->lb);
  ...
  if (params->action_mask & (1LLU << RTE_TABLE_ACTION_MTR)) {
    status = rte_table_action_profile_action_register(ap, RTE_TABLE_ACTION_MTR,
                                                      &params->mtr);
  ...
  if (params->action_mask & (1LLU << RTE_TABLE_ACTION_TM)) {
    status = rte_table_action_profile_action_register(ap, RTE_TABLE_ACTION_TM,
                                                      &params->tm);
  ...
  if (params->action_mask & (1LLU << RTE_TABLE_ACTION_ENCAP)) {
    status = rte_table_action_profile_action_register(
        ap, RTE_TABLE_ACTION_ENCAP, &params->encap);
  ...
  if (params->action_mask & (1LLU << RTE_TABLE_ACTION_NAT)) {
    status = rte_table_action_profile_action_register(ap, RTE_TABLE_ACTION_NAT,
                                                      &params->nat);
  ...
  if (params->action_mask & (1LLU << RTE_TABLE_ACTION_TTL)) {
    status = rte_table_action_profile_action_register(ap, RTE_TABLE_ACTION_TTL,
                                                      &params->ttl);
  ...
  if (params->action_mask & (1LLU << RTE_TABLE_ACTION_STATS)) {
    status = rte_table_action_profile_action_register(
        ap, RTE_TABLE_ACTION_STATS, &params->stats);
  ...
  if (params->action_mask & (1LLU << RTE_TABLE_ACTION_TIME)) {
    status = rte_table_action_profile_action_register(ap, RTE_TABLE_ACTION_TIME,
                                                      NULL);
  ...
  if (params->action_mask & (1LLU << RTE_TABLE_ACTION_TAG)) {
    status = rte_table_action_profile_action_register(ap, RTE_TABLE_ACTION_TAG,
                                                      NULL);
  ...
  if (params->action_mask & (1LLU << RTE_TABLE_ACTION_DECAP)) {
    status = rte_table_action_profile_action_register(
        ap, RTE_TABLE_ACTION_DECAP, NULL);
  ...
  if (params->action_mask & (1LLU << RTE_TABLE_ACTION_SYM_CRYPTO)) {
    status = rte_table_action_profile_action_register(
        ap, RTE_TABLE_ACTION_SYM_CRYPTO, &params->sym_crypto);
