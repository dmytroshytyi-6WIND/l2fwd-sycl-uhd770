...
#define OCCTX_L2_OVERHEAD                                                      \
  (RTE_ETHER_HDR_LEN + RTE_ETHER_CRC_LEN + OCCTX_MAX_VTAG_ACT_SIZE)
...
extern uint16_t rte_octeontx_pchan_map[OCTEONTX_MAX_BGX_PORTS]
...
void octeontx_set_tx_function(struct rte_eth_dev *dev);
