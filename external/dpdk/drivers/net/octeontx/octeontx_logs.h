...
#define PMD_INIT_LOG(level, fmt, args...)                                      \
  rte_log(RTE_LOG_##level, otx_net_logtype_init, "%s(): " fmt "\n", __func__,  \
          ##args)

#define PMD_INIT_FUNC_TRACE() PMD_INIT_LOG(DEBUG, ">>")

#define PMD_DRV_LOG(level, fmt, args...)                                       \
  rte_log(RTE_LOG_##level, otx_net_logtype_driver, "%s(): " fmt "\n",          \
          __func__, ##args)

#define PMD_MBOX_LOG(level, fmt, args...)                                      \
  rte_log(RTE_LOG_##level, otx_net_logtype_mbox, "%s(): " fmt "\n", __func__,  \
          ##args)

#define octeontx_log_info(fmt, args...) RTE_LOG(INFO, PMD, fmt "\n", ##args)
