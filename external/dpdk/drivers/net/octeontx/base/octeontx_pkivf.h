...
static inline int octeontx_pki_port_modify_qos(int port,
                                               pki_mod_qos_t *qos_cfg) {
...
static inline int octeontx_pki_port_delete_qos(int port,
                                               pki_del_qos_t *qos_cfg) {
  struct octeontx_mbox_hdr hdr;
  int res;
...
static inline int octeontx_pki_port_close(int port) {
  struct octeontx_mbox_hdr hdr;
  int res;
...
static inline int octeontx_pki_port_start(int port) {
  struct octeontx_mbox_hdr hdr;
  int res;
...
static inline int octeontx_pki_port_stop(int port) {
  struct octeontx_mbox_hdr hdr;
  int res;
...
int octeontx_pki_port_vlan_fltr_entry_config(
    int port, pki_port_vlan_filter_entry_config_t *entry_cfg);
