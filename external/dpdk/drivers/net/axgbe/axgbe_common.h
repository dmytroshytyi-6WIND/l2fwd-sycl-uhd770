...
static inline uint32_t low32_value(uint64_t addr) { return (addr)&0x0ffffffff; }
...
#define SET_BITS_LE(_var, _index, _width, _val)                                \
  do {                                                                         \
    ...
    (_var) |=                                                                  \
        rte_cpu_to_le_32((((_val) & ((0x1U << (_width)) - 1)) << (_index)));   \
  } while (0)
...
#define AXGMAC_GET_BITS(_var, _prefix, _field)                                 \
  GET_BITS((_var), _prefix##_##_field##_INDEX, _prefix##_##_field##_WIDTH)

#define AXGMAC_SET_BITS(_var, _prefix, _field, _val)                           \
  SET_BITS((_var), _prefix##_##_field##_INDEX, _prefix##_##_field##_WIDTH,     \
           (_val))

#define AXGMAC_GET_BITS_LE(_var, _prefix, _field)                              \
  GET_BITS_LE((_var), _prefix##_##_field##_INDEX, _prefix##_##_field##_WIDTH)

#define AXGMAC_SET_BITS_LE(_var, _prefix, _field, _val)                        \
  SET_BITS_LE((_var), _prefix##_##_field##_INDEX, _prefix##_##_field##_WIDTH,  \
              (_val))
...
#define AXGMAC_IOREAD_BITS(_pdata, _reg, _field)                               \
  GET_BITS(AXGMAC_IOREAD((_pdata), _reg), _reg##_##_field##_INDEX,             \
           _reg##_##_field##_WIDTH)

#define AXGMAC_IOWRITE(_pdata, _reg, _val)                                     \
  rte_write32((_val), (uint8_t *)((_pdata)->xgmac_regs) + (_reg))

#define AXGMAC_IOWRITE_BITS(_pdata, _reg, _field, _val)                        \
  do {                                                                         \
    u32 reg_val = AXGMAC_IOREAD((_pdata), _reg);                               \
    SET_BITS(reg_val, _reg##_##_field##_INDEX, _reg##_##_field##_WIDTH,        \
             (_val));                                                          \
...
#define AXGMAC_MTL_IOREAD(_pdata, _n, _reg)                                    \
  rte_read32((uint8_t *)((_pdata)->xgmac_regs) + MTL_Q_BASE +                  \
             ((_n)*MTL_Q_INC) + (_reg))

#define AXGMAC_MTL_IOREAD_BITS(_pdata, _n, _reg, _field)                       \
  GET_BITS(AXGMAC_MTL_IOREAD((_pdata), (_n), (_reg)), _reg##_##_field##_INDEX, \
           _reg##_##_field##_WIDTH)

#define AXGMAC_MTL_IOWRITE(_pdata, _n, _reg, _val)                             \
  rte_write32((_val), (uint8_t *)((_pdata)->xgmac_regs) + MTL_Q_BASE +         \
                          ((_n)*MTL_Q_INC) + (_reg))
...
#define AXGMAC_DMA_IOREAD_BITS(_channel, _reg, _field)                         \
  GET_BITS(AXGMAC_DMA_IOREAD((_channel), _reg), _reg##_##_field##_INDEX,       \
           _reg##_##_field##_WIDTH)

#define AXGMAC_DMA_IOWRITE(_channel, _reg, _val)                               \
  rte_write32((_val), (uint8_t *)((_channel)->dma_regs) + (_reg))
...
#define XSIR0_IOREAD_BITS(_pdata, _reg, _field)                                \
  GET_BITS(XSIR0_IOREAD((_pdata), _reg), _reg##_##_field##_INDEX,              \
           _reg##_##_field##_WIDTH)

#define XSIR0_IOWRITE(_pdata, _reg, _val)                                      \
  rte_write16((_val), (uint8_t *)((_pdata)->sir0_regs) + (_reg))
...
#define XSIR1_IOREAD_BITS(_pdata, _reg, _field)                                \
  GET_BITS(XSIR1_IOREAD((_pdata), _reg), _reg##_##_field##_INDEX,              \
           _reg##_##_field##_WIDTH)

#define XSIR1_IOWRITE(_pdata, _reg, _val)                                      \
  rte_write16((_val), (uint8_t *)((_pdata)->sir1_regs) + (_reg))
...
#define XRXTX_IOREAD_BITS(_pdata, _reg, _field)                                \
  GET_BITS(XRXTX_IOREAD((_pdata), _reg), _reg##_##_field##_INDEX,              \
           _reg##_##_field##_WIDTH)
...
#define XP_IOREAD_BITS(_pdata, _reg, _field)                                   \
  GET_BITS(XP_IOREAD((_pdata), (_reg)), _reg##_##_field##_INDEX,               \
           _reg##_##_field##_WIDTH)

#define XP_IOWRITE(_pdata, _reg, _val)                                         \
  rte_write32((_val), (uint8_t *)((_pdata)->xprop_regs) + (_reg))
...
#define XI2C_IOREAD_BITS(_pdata, _reg, _field)                                 \
  GET_BITS(XI2C_IOREAD((_pdata), (_reg)), _reg##_##_field##_INDEX,             \
           _reg##_##_field##_WIDTH)

#define XI2C_IOWRITE(_pdata, _reg, _val)                                       \
  rte_write32((_val), (uint8_t *)((_pdata)->xi2c_regs) + (_reg))
...
#define XMDIO_READ(_pdata, _mmd, _reg)                                         \
  ((_pdata)->hw_if.read_mmd_regs(                                              \
      (_pdata), 0, MII_ADDR_C45 | ((_mmd) << 16) | ((_reg)&0xffff)))

#define XMDIO_READ_BITS(_pdata, _mmd, _reg, _mask)                             \
  (XMDIO_READ((_pdata), _mmd, _reg) & _mask)

#define XMDIO_WRITE(_pdata, _mmd, _reg, _val)                                  \
  ((_pdata)->hw_if.write_mmd_regs(                                             \
      (_pdata), 0, MII_ADDR_C45 | ((_mmd) << 16) | ((_reg)&0xffff), (_val)))
