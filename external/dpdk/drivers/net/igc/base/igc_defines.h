...
#define IGC_RXD_ERR_FRAME_ERR_MASK                                             \
  (IGC_RXD_ERR_CE | IGC_RXD_ERR_SE | IGC_RXD_ERR_SEQ | IGC_RXD_ERR_CXE |       \
   IGC_RXD_ERR_RXE)

/* Same mask, but for extended and packet split descriptors */
#define IGC_RXDEXT_ERR_FRAME_ERR_MASK                                          \
  (IGC_RXDEXT_STATERR_CE | IGC_RXDEXT_STATERR_SE | IGC_RXDEXT_STATERR_SEQ |    \
   IGC_RXDEXT_STATERR_CXE | IGC_RXDEXT_STATERR_RXE)
...
#define PCIE_NO_SNOOP_ALL                                                      \
  (IGC_GCR_RXD_NO_SNOOP | IGC_GCR_RXDSCW_NO_SNOOP | IGC_GCR_RXDSCR_NO_SNOOP |  \
   IGC_GCR_TXD_NO_SNOOP | IGC_GCR_TXDSCW_NO_SNOOP | IGC_GCR_TXDSCR_NO_SNOOP)
...
#define ID_LED_DEFAULT                                                         \
  ((ID_LED_OFF1_ON2 << 12) | (ID_LED_OFF1_OFF2 << 8) |                         \
