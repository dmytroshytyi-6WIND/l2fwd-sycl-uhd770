...
s32 igc_write_nvm_srwr_i225(struct igc_hw *hw, u16 offset, u16 words,
                            u16 *data);
s32 igc_read_nvm_srrd_i225(struct igc_hw *hw, u16 offset, u16 words, u16 *data);
s32 igc_read_invm_version_i225(struct igc_hw *hw,
                               struct igc_fw_version *invm_ver);
s32 igc_set_flsw_flash_burst_counter_i225(struct igc_hw *hw, u32 burst_counter);
...
s32 igc_set_eee_i225(struct igc_hw *hw, bool adv2p5G, bool adv1G, bool adv100M);
