...
struct igc_mac_operations {
  ...
  void (*update_mc_addr_list)(struct igc_hw *hw, u8 *mc_addr_list, u32 count);
...
struct igc_phy_operations {
  ...
  s32 (*read_i2c_byte)(struct igc_hw *hw, u8 byte_offset, u8 dev_addr,
                       u8 *data);
  s32 (*write_i2c_byte)(struct igc_hw *hw, u8 byte_offset, u8 dev_addr,
                        u8 data);
};
