...
#define ID_LED_DEFAULT_82575_SERDES                                            \
  ((ID_LED_DEF1_DEF2 << 12) | (ID_LED_DEF1_DEF2 << 8) |                        \
   (ID_LED_DEF1_DEF2 << 4) | (ID_LED_OFF1_ON2))
/*
...
#define IGC_VMRCTL_MIRROR_DSTPORT_MASK (7 << IGC_VMRCTL_MIRROR_PORT_SHIFT)
...
#define IGC_EICR_TX_QUEUE                                                      \
  (IGC_EICR_TX_QUEUE0 | IGC_EICR_TX_QUEUE1 | IGC_EICR_TX_QUEUE2 |              \
   IGC_EICR_TX_QUEUE3)

#define IGC_EICR_RX_QUEUE                                                      \
  (IGC_EICR_RX_QUEUE0 | IGC_EICR_RX_QUEUE1 | IGC_EICR_RX_QUEUE2 |              \
   IGC_EICR_RX_QUEUE3)
...
#define EIMS_ENABLE_MASK                                                       \
  (IGC_EIMS_RX_QUEUE | IGC_EIMS_TX_QUEUE | IGC_EIMS_TCP_TIMER | IGC_EIMS_OTHER)
