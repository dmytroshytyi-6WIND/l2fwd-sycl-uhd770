...
#define ID_LED_DEFAULT_ICH8LAN                                                 \
  ((ID_LED_DEF1_DEF2 << 12) | (ID_LED_OFF1_OFF2 << 8) |                        \
   (ID_LED_OFF1_ON2 << 4) | (ID_LED_DEF1_DEF2))
...
#define I82579_DFT_CTRL_GATE_PHY_RESET                                         \
  0x0040 /* Gate PHY Reset on MAC Reset                                        \
          */
...
void igc_set_kmrn_lock_loss_workaround_ich8lan(struct igc_hw *hw, bool state);
