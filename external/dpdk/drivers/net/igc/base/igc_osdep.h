...
#define IGC_READ_REG(hw, reg) igc_read_addr(IGC_PCI_REG_ADDR((hw), (reg)))

#define IGC_READ_REG_LE_VALUE(hw, reg) rte_read32(IGC_PCI_REG_ADDR((hw), (reg)))
...
#define IGC_WRITE_REG_ARRAY(hw, reg, index, value)                             \
  IGC_PCI_REG_WRITE(IGC_PCI_REG_ARRAY_ADDR((hw), (reg), (index)), (value))
...
#define IGC_WRITE_REG_IO(hw, reg, value) IGC_WRITE_REG(hw, reg, value)
