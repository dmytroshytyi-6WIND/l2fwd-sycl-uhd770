 ...
 */
#define IGC_ETH_OVERHEAD                                                       \
  (RTE_ETHER_HDR_LEN + RTE_ETHER_CRC_LEN + VLAN_TAG_SIZE * 2)
...
#define IGC_RXD_ALIGN ((uint16_t)(IGC_ALIGN / sizeof(union igc_adv_rx_desc)))
#define IGC_TXD_ALIGN ((uint16_t)(IGC_ALIGN / sizeof(union igc_adv_tx_desc)))
...
#define IGC_RX_OFFLOAD_ALL                                                     \
  (RTE_ETH_RX_OFFLOAD_VLAN_STRIP | RTE_ETH_RX_OFFLOAD_VLAN_FILTER |            \
   ...
   RTE_ETH_RX_OFFLOAD_SCTP_CKSUM | RTE_ETH_RX_OFFLOAD_KEEP_CRC |               \
...
static inline void igc_read_reg_check_set_bits(struct igc_hw *hw, uint32_t reg,
                                               uint32_t bits) {
...
static inline void igc_read_reg_check_clear_bits(struct igc_hw *hw,
