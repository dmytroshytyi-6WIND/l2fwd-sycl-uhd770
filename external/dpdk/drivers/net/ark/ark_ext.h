 ...
 * @return (0) if successful.
 */
int rte_pmd_ark_link_update(struct rte_eth_dev *dev, int wait_to_complete,
                            void *user_data);
 ...
 * @return (0) if successful.
 */
int rte_pmd_ark_stats_get(struct rte_eth_dev *dev, struct rte_eth_stats *stats,
                          void *user_data);
...
void rte_pmd_ark_mac_addr_add(struct rte_eth_dev *dev,
                              struct rte_ether_addr *macaddr, uint32_t index,
                              uint32_t pool, void *user_data);
 ...
 * @return (0) if successful.
 */
void rte_pmd_ark_mac_addr_remove(struct rte_eth_dev *dev, uint32_t index,
                                 void *user_data);
...
void rte_pmd_ark_mac_addr_set(struct rte_eth_dev *dev,
                              struct rte_ether_addr *mac_addr, void *user_data);
 ...
 * @return (0) if successful.
 */
int rte_pmd_ark_set_mtu(struct rte_eth_dev *dev, uint16_t size,
                        void *user_data);
 ...
 *   user argument from dev_init() call.
 */
void rte_pmd_ark_rx_user_meta_hook(struct rte_mbuf *mbuf, const uint32_t *meta,
                                   void *user_data);
 ...
 *   user argument from dev_init() call.
 */
void rte_pmd_ark_tx_user_meta_hook(const struct rte_mbuf *mbuf, uint32_t *meta,
                                   uint8_t *meta_cnt, void *user_data);
