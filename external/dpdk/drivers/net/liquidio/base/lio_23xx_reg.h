...
#define CN23XX_PKT_INPUT_CTL_MASK                                              \
  (CN23XX_PKT_INPUT_CTL_RDSIZE | CN23XX_PKT_INPUT_CTL_DATA_ES_64B_SWAP |       \
   CN23XX_PKT_INPUT_CTL_USE_CSR)
#elif RTE_BYTE_ORDER == RTE_BIG_ENDIAN
#define CN23XX_PKT_INPUT_CTL_MASK                                              \
  (CN23XX_PKT_INPUT_CTL_RDSIZE | CN23XX_PKT_INPUT_CTL_DATA_ES_64B_SWAP |       \
   CN23XX_PKT_INPUT_CTL_USE_CSR | CN23XX_PKT_INPUT_CTL_GATHER_ES_64B_SWAP)
#endif
...
#define CN23XX_SLI_PKT_PF_VF_MBOX_SIG(q, idx)                                  \
  (CN23XX_SLI_PKT_PF_VF_MBOX_SIG_START +                                       \
   ((q)*CN23XX_SLI_MBOX_OFFSET + (idx)*CN23XX_SLI_MBOX_SIG_IDX_OFFSET))
