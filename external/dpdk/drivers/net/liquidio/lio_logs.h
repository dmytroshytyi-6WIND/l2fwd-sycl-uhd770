...
#define lio_dev_printf(lio_dev, level, fmt, args...)                           \
  rte_log(RTE_LOG_##level, lio_logtype_driver, "%s" fmt,                       \
          (lio_dev)->dev_string, ##args)
...
#define PMD_INIT_LOG(level, fmt, args...)                                      \
  rte_log(RTE_LOG_##level, lio_logtype_init, fmt, ##args)
...
#define PMD_REGS_LOG(level, fmt, args...)                                      \
  do {                                                                         \
  } while (0)
