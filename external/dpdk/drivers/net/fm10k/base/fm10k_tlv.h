...
#define FM10K_TLV_ATTR_NULL_STRING(id, len)                                    \
  { id, FM10K_TLV_NULL_STRING, len }
#define FM10K_TLV_ATTR_MAC_ADDR(id)                                            \
  { id, FM10K_TLV_MAC_ADDR, 6 }
#define FM10K_TLV_ATTR_BOOL(id)                                                \
  { id, FM10K_TLV_BOOL, 0 }
#define FM10K_TLV_ATTR_U8(id)                                                  \
  { id, FM10K_TLV_UNSIGNED, 1 }
#define FM10K_TLV_ATTR_U16(id)                                                 \
  { id, FM10K_TLV_UNSIGNED, 2 }
#define FM10K_TLV_ATTR_U32(id)                                                 \
  { id, FM10K_TLV_UNSIGNED, 4 }
#define FM10K_TLV_ATTR_U64(id)                                                 \
  { id, FM10K_TLV_UNSIGNED, 8 }
#define FM10K_TLV_ATTR_S8(id)                                                  \
  { id, FM10K_TLV_SIGNED, 1 }
#define FM10K_TLV_ATTR_S16(id)                                                 \
  { id, FM10K_TLV_SIGNED, 2 }
#define FM10K_TLV_ATTR_S32(id)                                                 \
  { id, FM10K_TLV_SIGNED, 4 }
#define FM10K_TLV_ATTR_S64(id)                                                 \
  { id, FM10K_TLV_SIGNED, 8 }
#define FM10K_TLV_ATTR_LE_STRUCT(id, len)                                      \
  { id, FM10K_TLV_LE_STRUCT, len }
#define FM10K_TLV_ATTR_NESTED(id)                                              \
  { id, FM10K_TLV_NESTED }
#define FM10K_TLV_ATTR_LAST                                                    \
  { FM10K_TLV_ERROR }
...
#define FM10K_MSG_HANDLER(id, attr, func)                                      \
  { id, attr, func }
