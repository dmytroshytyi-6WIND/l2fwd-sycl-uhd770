...
enum rte_bond_8023ad_selection { UNSELECTED, STANDBY, SELECTED };

enum rte_bond_8023ad_agg_selection { AGG_BANDWIDTH, AGG_COUNT, AGG_STABLE };
 ...
 */
int rte_eth_bond_8023ad_slave_info(uint16_t port_id, uint16_t slave_id,
 ...
 *   0 on success, negative value otherwise.
 */
int rte_eth_bond_8023ad_dedicated_queues_enable(uint16_t port_id);
 ...
 *
 */
int rte_eth_bond_8023ad_dedicated_queues_disable(uint16_t port_id);
