 ...
 */
int bond_mode_8023ad_enable(struct rte_eth_dev *dev);
 ...
 */
int bond_mode_8023ad_start(struct rte_eth_dev *dev);
 ...
 */
void bond_mode_8023ad_stop(struct rte_eth_dev *dev);
 ...
 *  0 on success, negative value otherwise.
 */
void bond_mode_8023ad_activate_slave(struct rte_eth_dev *dev, uint16_t port_id);
 ...
 *  0 on success, negative value otherwise.
 */
int bond_mode_8023ad_deactivate_slave(struct rte_eth_dev *dev,
                                      uint16_t slave_pos);
