 ...
 * - For optimal performance during initial handshaking the array of mbufs
 * provided to rx_burst should be at least 2 times the slave count size.
 *
 */
 ...
 * @param socket_id		Socket Id on which to allocate eth_dev
 *resources.
 *
 * @return
 ...
 * @param slaves			Array to be populated with the current
 *active slaves
 ...
 *overriding slaves MAC addresses
 *
 * @return
 *	0 on success, negative value otherwise
 */
