 ...
 */
typedef bool(sfc_dp_rx_qrx_ps_ev_t)(struct sfc_dp_rxq *dp_rxq, unsigned int id);
...
static inline struct sfc_dp_rx *sfc_dp_find_rx_by_name(struct sfc_dp_list *head,
                                                       const char *name) {
...
static inline uint64_t sfc_dp_rx_offload_capa(const struct sfc_dp_rx *dp_rx) {
