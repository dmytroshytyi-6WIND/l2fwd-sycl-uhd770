...
typedef void(sfc_mae_switch_port_iterator_cb)(
    enum sfc_mae_switch_port_type type, const efx_mport_sel_t *ethdev_mportp,
    uint16_t ethdev_port_id, const efx_mport_sel_t *entity_mportp,
    uint16_t switch_port_id, union sfc_mae_switch_port_data *port_datap,
    void *user_datap);
