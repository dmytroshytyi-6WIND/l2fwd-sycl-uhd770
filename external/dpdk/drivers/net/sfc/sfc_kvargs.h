...
#define SFC_KVARG_VALUES_SWITCH_MODE                                           \
  "[" SFC_KVARG_SWITCH_MODE_LEGACY "|" SFC_KVARG_SWITCH_MODE_SWITCHDEV "]"
...
#define SFC_KVARG_VALUES_PERF_PROFILE                                          \
  "[" SFC_KVARG_PERF_PROFILE_AUTO "|" SFC_KVARG_PERF_PROFILE_THROUGHPUT        \
...
#define SFC_KVARG_VALUES_RX_DATAPATH                                           \
  "[" SFC_KVARG_DATAPATH_EFX "|" SFC_KVARG_DATAPATH_EF10                       \
  "|" SFC_KVARG_DATAPATH_EF10_ESSB "|" SFC_KVARG_DATAPATH_EF100 "]"

#define SFC_KVARG_TX_DATAPATH "tx_datapath"
#define SFC_KVARG_VALUES_TX_DATAPATH                                           \
  "[" SFC_KVARG_DATAPATH_EFX "|" SFC_KVARG_DATAPATH_EF10                       \
  "|" SFC_KVARG_DATAPATH_EF10_SIMPLE "|" SFC_KVARG_DATAPATH_EF100 "]"
...
#define SFC_KVARG_VALUES_FW_VARIANT                                            \
  "[" SFC_KVARG_FW_VARIANT_DONT_CARE "|" SFC_KVARG_FW_VARIANT_FULL_FEATURED    \
  "|" SFC_KVARG_FW_VARIANT_LOW_LATENCY "|" SFC_KVARG_FW_VARIANT_PACKED_STREAM  \
