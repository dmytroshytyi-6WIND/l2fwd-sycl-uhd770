...
static int ionic_dev_xstats_get_names(struct rte_eth_dev *dev,
                                      ...
                                      unsigned int size);
static int
ionic_dev_xstats_get_names_by_id(struct rte_eth_dev *dev, const uint64_t *ids,
                                 struct rte_eth_xstat_name *xstats_names,
                                 unsigned int limit);
...
static const struct rte_ionic_xstats_name_off rte_ionic_xstats_strings[] = {
    /* RX */
    {"rx_ucast_bytes", offsetof(struct ionic_lif_stats, rx_ucast_bytes)},
    {"rx_ucast_packets", offsetof(struct ionic_lif_stats, rx_ucast_packets)},
    {"rx_mcast_bytes", offsetof(struct ionic_lif_stats, rx_mcast_bytes)},
    {"rx_mcast_packets", offsetof(struct ionic_lif_stats, rx_mcast_packets)},
    {"rx_bcast_bytes", offsetof(struct ionic_lif_stats, rx_bcast_bytes)},
    {"rx_bcast_packets", offsetof(struct ionic_lif_stats, rx_bcast_packets)},
    /* RX drops */
    {"rx_ucast_drop_bytes",
     offsetof(struct ionic_lif_stats, rx_ucast_drop_bytes)},
    {"rx_ucast_drop_packets",
     offsetof(struct ionic_lif_stats, rx_ucast_drop_packets)},
    {"rx_mcast_drop_bytes",
     offsetof(struct ionic_lif_stats, rx_mcast_drop_bytes)},
    {"rx_mcast_drop_packets",
     offsetof(struct ionic_lif_stats, rx_mcast_drop_packets)},
    {"rx_bcast_drop_bytes",
     offsetof(struct ionic_lif_stats, rx_bcast_drop_bytes)},
    {"rx_bcast_drop_packets",
     offsetof(struct ionic_lif_stats, rx_bcast_drop_packets)},
    {"rx_dma_error", offsetof(struct ionic_lif_stats, rx_dma_error)},
    /* TX */
    {"tx_ucast_bytes", offsetof(struct ionic_lif_stats, tx_ucast_bytes)},
    {"tx_ucast_packets", offsetof(struct ionic_lif_stats, tx_ucast_packets)},
    {"tx_mcast_bytes", offsetof(struct ionic_lif_stats, tx_mcast_bytes)},
    {"tx_mcast_packets", offsetof(struct ionic_lif_stats, tx_mcast_packets)},
    {"tx_bcast_bytes", offsetof(struct ionic_lif_stats, tx_bcast_bytes)},
    {"tx_bcast_packets", offsetof(struct ionic_lif_stats, tx_bcast_packets)},
    /* TX drops */
    {"tx_ucast_drop_bytes",
     offsetof(struct ionic_lif_stats, tx_ucast_drop_bytes)},
    {"tx_ucast_drop_packets",
     offsetof(struct ionic_lif_stats, tx_ucast_drop_packets)},
    {"tx_mcast_drop_bytes",
     offsetof(struct ionic_lif_stats, tx_mcast_drop_bytes)},
    {"tx_mcast_drop_packets",
     offsetof(struct ionic_lif_stats, tx_mcast_drop_packets)},
    {"tx_bcast_drop_bytes",
     offsetof(struct ionic_lif_stats, tx_bcast_drop_bytes)},
    {"tx_bcast_drop_packets",
     offsetof(struct ionic_lif_stats, tx_bcast_drop_packets)},
    {"tx_dma_error", offsetof(struct ionic_lif_stats, tx_dma_error)},
    /* Rx Queue/Ring drops */
    {"rx_queue_disabled", offsetof(struct ionic_lif_stats, rx_queue_disabled)},
    {"rx_queue_empty", offsetof(struct ionic_lif_stats, rx_queue_empty)},
    {"rx_queue_error", offsetof(struct ionic_lif_stats, rx_queue_error)},
    {"rx_desc_fetch_error",
     offsetof(struct ionic_lif_stats, rx_desc_fetch_error)},
    {"rx_desc_data_error",
     offsetof(struct ionic_lif_stats, rx_desc_data_error)},
    /* Tx Queue/Ring drops */
    {"tx_queue_disabled", offsetof(struct ionic_lif_stats, tx_queue_disabled)},
    {"tx_queue_error", offsetof(struct ionic_lif_stats, tx_queue_error)},
    {"tx_desc_fetch_error",
     offsetof(struct ionic_lif_stats, tx_desc_fetch_error)},
    {"tx_desc_data_error",
     offsetof(struct ionic_lif_stats, tx_desc_data_error)},
};
...
static int ionic_dev_fw_version_get(struct rte_eth_dev *eth_dev,
  ...
  ret = snprintf(fw_version, fw_size, "%s", adapter->fw_version);
  if (ret < 0)
    return -EINVAL;
 ...
 */
static int ionic_dev_set_link_up(struct rte_eth_dev *eth_dev) {
  struct ionic_lif *lif = IONIC_ETH_DEV_TO_LIF(eth_dev);
  int err;
 ...
 */
static int ionic_dev_set_link_down(struct rte_eth_dev *eth_dev) {
  struct ionic_lif *lif = IONIC_ETH_DEV_TO_LIF(eth_dev);
...
int ionic_dev_link_update(struct rte_eth_dev *eth_dev,
  ...
  if (!adapter->link_up || !(lif->state & IONIC_LIF_F_UP)) {
    /* Interface is down */
 ...
 *  void
 */
static void ionic_dev_interrupt_handler(void *param) {
...
static int ionic_dev_mtu_set(struct rte_eth_dev *eth_dev, uint16_t mtu) {
  struct ionic_lif *lif = IONIC_ETH_DEV_TO_LIF(eth_dev);
  int err;
...
static int ionic_dev_info_get(struct rte_eth_dev *eth_dev,
  ...
  dev_info->max_rx_queues =
      (uint16_t)rte_le_to_cpu_32(cfg->queue_count[IONIC_QTYPE_RXQ]);
  dev_info->max_tx_queues =
      (uint16_t)rte_le_to_cpu_32(cfg->queue_count[IONIC_QTYPE_TXQ]);
  ...
  dev_info->rx_offload_capa =
      dev_info->rx_queue_offload_capa | RTE_ETH_RX_OFFLOAD_IPV4_CKSUM |
      RTE_ETH_RX_OFFLOAD_UDP_CKSUM | RTE_ETH_RX_OFFLOAD_TCP_CKSUM |
      RTE_ETH_RX_OFFLOAD_VLAN_FILTER | RTE_ETH_RX_OFFLOAD_VLAN_STRIP |
      RTE_ETH_RX_OFFLOAD_SCATTER | RTE_ETH_RX_OFFLOAD_RSS_HASH | 0;
  ...
  dev_info->tx_offload_capa =
      ...
      RTE_ETH_TX_OFFLOAD_MULTI_SEGS | RTE_ETH_TX_OFFLOAD_TCP_TSO |
      RTE_ETH_TX_OFFLOAD_VLAN_INSERT | 0;
...
static int ionic_dev_rss_reta_query(struct rte_eth_dev *eth_dev,
  ...
  for (i = 0; i < num; i++) {
    memcpy(reta_conf->reta, &lif->rss_ind_tbl[i * RTE_ETH_RETA_GROUP_SIZE],
...
static int ionic_dev_rss_hash_conf_get(struct rte_eth_dev *eth_dev,
  ...
  if (rss_conf->rss_key != NULL &&
    ...
    memcpy(rss_conf->rss_key, lif->rss_hash_key, IONIC_RSS_HASH_KEY_SIZE);
...
static int ionic_dev_xstats_get_names(__rte_unused struct rte_eth_dev *eth_dev,
                                      struct rte_eth_xstat_name *xstats_names,
...
static int ionic_dev_xstats_get_names_by_id(
    struct rte_eth_dev *eth_dev, const uint64_t *ids,
...
static int ionic_dev_xstats_get(struct rte_eth_dev *eth_dev,
                                struct rte_eth_xstat *xstats, unsigned int n) {
  struct ionic_lif *lif = IONIC_ETH_DEV_TO_LIF(eth_dev);
  ...
  for (i = 0; i < IONIC_NB_HW_STATS; i++) {
    xstats[i].value =
        *(uint64_t *)(((char *)&hw_stats) + rte_ionic_xstats_strings[i].offset);
    xstats[i].id = i;
  }
...
static int ionic_dev_xstats_get_by_id(struct rte_eth_dev *eth_dev,
                                      const uint64_t *ids, uint64_t *values,
                                      unsigned int n) {
  struct ionic_lif *lif = IONIC_ETH_DEV_TO_LIF(eth_dev);
  struct ionic_lif_stats hw_stats;
  ...
  ionic_dev_xstats_get_by_id(eth_dev, NULL, values_copy, IONIC_NB_HW_STATS);
...
static int ionic_dev_xstats_reset(struct rte_eth_dev *eth_dev) {
  struct ionic_lif *lif = IONIC_ETH_DEV_TO_LIF(eth_dev);
...
static int ionic_dev_configure(struct rte_eth_dev *eth_dev) {
  struct ionic_lif *lif = IONIC_ETH_DEV_TO_LIF(eth_dev);
...
static inline uint32_t ionic_parse_link_speeds(uint16_t link_speeds) {
 ...
 */
static int ionic_dev_start(struct rte_eth_dev *eth_dev) {
  ...
  allowed_speeds = RTE_ETH_LINK_SPEED_FIXED | RTE_ETH_LINK_SPEED_10G |
  ...
  if (speed) {
    ...
    err = ionic_dev_cmd_wait_check(idev, IONIC_DEVCMD_TIMEOUT);
    if (err)
      IONIC_PRINT(WARNING, "Failed to set link speed %u", speed);
  }
 ...
 */
static int ionic_dev_stop(struct rte_eth_dev *eth_dev) {
  struct ionic_lif *lif = IONIC_ETH_DEV_TO_LIF(eth_dev);
 ...
 */
static int ionic_dev_close(struct rte_eth_dev *eth_dev) {
  struct ionic_lif *lif = IONIC_ETH_DEV_TO_LIF(eth_dev);
  struct ionic_adapter *adapter = lif->adapter;
...
static int eth_ionic_dev_init(struct rte_eth_dev *eth_dev, void *init_params) {
  ...
  eth_dev->data->mac_addrs =
      rte_zmalloc("ionic", RTE_ETHER_ADDR_LEN * adapter->max_mac_addrs, 0);

  if (eth_dev->data->mac_addrs == NULL) {
    IONIC_PRINT(ERR,
                "Failed to allocate %u bytes needed to "
                "store MAC addresses",
  ...
  if (err) {
    IONIC_PRINT(ERR, "Cannot allocate LIFs: %d, aborting", err);
    goto err;
  }
...
static int ionic_configure_intr(struct ionic_adapter *adapter) {
  ...
  if (rte_intr_dp_is_en(intr_handle))
    IONIC_PRINT(DEBUG, "Packet I/O interrupt on datapath is enabled");

  if (rte_intr_vec_list_alloc(intr_handle, "intr_vec", adapter->nintrs)) {
    IONIC_PRINT(ERR, "Failed to allocate %u vectors", adapter->nintrs);
    return -ENOMEM;
  }

  err = rte_intr_callback_register(intr_handle, ionic_dev_interrupt_handler,
                                   adapter);

  if (err) {
    IONIC_PRINT(ERR, "Failure registering interrupts handler (%d)", err);
    return err;
  }
...
static void ionic_unconfigure_intr(struct ionic_adapter *adapter) {
  ...
  rte_intr_callback_unregister(intr_handle, ionic_dev_interrupt_handler,
                               adapter);
}

static int eth_ionic_pci_probe(struct rte_pci_driver *pci_drv __rte_unused,
  ...
  IONIC_PRINT(DEBUG, "Initializing device %s", pci_dev->device.name);
  ...
  if (err) {
    IONIC_PRINT(ERR, "Cannot identify device: %d, aborting", err);
    goto err_free_adapter;
  }
  ...
  if (err) {
    IONIC_PRINT(ERR, "Cannot identify port: %d, aborting", err);
    goto err_free_adapter;
  }
  ...
  err = rte_eth_dev_create(&pci_dev->device, name, sizeof(struct ionic_lif),
...
static int eth_ionic_pci_remove(struct rte_pci_device *pci_dev) {
  char name[RTE_ETH_NAME_MAX_LEN];
  ...
  if (eth_dev)
    ...
    IONIC_PRINT(DEBUG, "Cannot find device %s", pci_dev->device.name);
