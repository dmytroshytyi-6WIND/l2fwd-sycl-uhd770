...
static inline u64 encode_txq_desc_cmd(u8 opcode, u8 flags, u8 nsge, u64 addr) {
  u64 cmd;
...
static inline void decode_txq_desc_cmd(u64 cmd, u8 *opcode, u8 *flags, u8 *nsge,
                                       u64 *addr) {
...
#define intr_to_coal(intr_ctrl) ((void __iomem *)&(intr_ctrl)->coalescing_init)
#define intr_to_mask(intr_ctrl) ((void __iomem *)&(intr_ctrl)->mask)
#define intr_to_credits(intr_ctrl) ((void __iomem *)&(intr_ctrl)->int_credits)
