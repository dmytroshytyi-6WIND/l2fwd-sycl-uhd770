...
static const struct hns3_xstats_name_offset hns3_rxq_basic_stats_strings[] = {
    {"packets", HNS3_RXQ_BASIC_STATS_FIELD_OFFSET(packets)},
    {"bytes", HNS3_RXQ_BASIC_STATS_FIELD_OFFSET(bytes)},
    {"errors", HNS3_RXQ_BASIC_STATS_FIELD_OFFSET(errors)}};

/* The statistics of the per-txq basic stats */
static const struct hns3_xstats_name_offset hns3_txq_basic_stats_strings[] = {
    {"packets", HNS3_TXQ_BASIC_STATS_FIELD_OFFSET(packets)},
    {"bytes", HNS3_TXQ_BASIC_STATS_FIELD_OFFSET(bytes)}};
...
static const struct hns3_xstats_name_offset hns3_mac_strings[] = {
    ...
    {"mac_rx_mac_pause_num", HNS3_MAC_STATS_OFFSET(mac_rx_mac_pause_num)},
    {"mac_tx_control_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_ctrl_pkt_num)},
    {"mac_rx_control_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_ctrl_pkt_num)},
    {"mac_tx_pfc_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_pfc_pause_pkt_num)},
    {"mac_tx_pfc_pri0_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_pfc_pri0_pkt_num)},
    {"mac_tx_pfc_pri1_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_pfc_pri1_pkt_num)},
    {"mac_tx_pfc_pri2_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_pfc_pri2_pkt_num)},
    {"mac_tx_pfc_pri3_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_pfc_pri3_pkt_num)},
    {"mac_tx_pfc_pri4_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_pfc_pri4_pkt_num)},
    {"mac_tx_pfc_pri5_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_pfc_pri5_pkt_num)},
    {"mac_tx_pfc_pri6_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_pfc_pri6_pkt_num)},
    {"mac_tx_pfc_pri7_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_pfc_pri7_pkt_num)},
    {"mac_rx_pfc_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_pfc_pause_pkt_num)},
    {"mac_rx_pfc_pri0_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_pfc_pri0_pkt_num)},
    {"mac_rx_pfc_pri1_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_pfc_pri1_pkt_num)},
    {"mac_rx_pfc_pri2_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_pfc_pri2_pkt_num)},
    {"mac_rx_pfc_pri3_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_pfc_pri3_pkt_num)},
    {"mac_rx_pfc_pri4_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_pfc_pri4_pkt_num)},
    {"mac_rx_pfc_pri5_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_pfc_pri5_pkt_num)},
    {"mac_rx_pfc_pri6_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_pfc_pri6_pkt_num)},
    {"mac_rx_pfc_pri7_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_pfc_pri7_pkt_num)},
    {"mac_tx_total_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_total_pkt_num)},
    {"mac_tx_total_oct_num", HNS3_MAC_STATS_OFFSET(mac_tx_total_oct_num)},
    {"mac_tx_good_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_good_pkt_num)},
    {"mac_tx_bad_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_bad_pkt_num)},
    {"mac_tx_good_oct_num", HNS3_MAC_STATS_OFFSET(mac_tx_good_oct_num)},
    {"mac_tx_bad_oct_num", HNS3_MAC_STATS_OFFSET(mac_tx_bad_oct_num)},
    {"mac_tx_uni_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_uni_pkt_num)},
    {"mac_tx_multi_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_multi_pkt_num)},
    {"mac_tx_broad_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_broad_pkt_num)},
    {"mac_tx_undersize_pkt_num",
     HNS3_MAC_STATS_OFFSET(mac_tx_undersize_pkt_num)},
    {"mac_tx_oversize_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_oversize_pkt_num)},
    {"mac_tx_64_oct_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_64_oct_pkt_num)},
    ...
    {"mac_rx_total_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_total_pkt_num)},
    {"mac_rx_total_oct_num", HNS3_MAC_STATS_OFFSET(mac_rx_total_oct_num)},
    {"mac_rx_good_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_good_pkt_num)},
    {"mac_rx_bad_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_bad_pkt_num)},
    {"mac_rx_good_oct_num", HNS3_MAC_STATS_OFFSET(mac_rx_good_oct_num)},
    {"mac_rx_bad_oct_num", HNS3_MAC_STATS_OFFSET(mac_rx_bad_oct_num)},
    {"mac_rx_uni_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_uni_pkt_num)},
    {"mac_rx_multi_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_multi_pkt_num)},
    {"mac_rx_broad_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_broad_pkt_num)},
    {"mac_rx_undersize_pkt_num",
     HNS3_MAC_STATS_OFFSET(mac_rx_undersize_pkt_num)},
    {"mac_rx_oversize_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_oversize_pkt_num)},
    {"mac_rx_64_oct_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_64_oct_pkt_num)},
    ...
    {"mac_tx_fragment_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_fragment_pkt_num)},
    {"mac_tx_undermin_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_undermin_pkt_num)},
    {"mac_tx_jabber_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_jabber_pkt_num)},
    {"mac_tx_err_all_pkt_num", HNS3_MAC_STATS_OFFSET(mac_tx_err_all_pkt_num)},
    {"mac_tx_from_app_good_pkt_num",
     HNS3_MAC_STATS_OFFSET(mac_tx_from_app_good_pkt_num)},
    {"mac_tx_from_app_bad_pkt_num",
     HNS3_MAC_STATS_OFFSET(mac_tx_from_app_bad_pkt_num)},
    {"mac_rx_fragment_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_fragment_pkt_num)},
    {"mac_rx_undermin_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_undermin_pkt_num)},
    {"mac_rx_jabber_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_jabber_pkt_num)},
    {"mac_rx_fcs_err_pkt_num", HNS3_MAC_STATS_OFFSET(mac_rx_fcs_err_pkt_num)},
...
static const struct hns3_xstats_name_offset hns3_reset_stats_strings[] = {
    {"REQ_RESET_CNT", HNS3_RESET_STATS_FIELD_OFFSET(request_cnt)},
    {"GLOBAL_RESET_CNT", HNS3_RESET_STATS_FIELD_OFFSET(global_cnt)},
    {"IMP_RESET_CNT", HNS3_RESET_STATS_FIELD_OFFSET(imp_cnt)},
    {"RESET_EXEC_CNT", HNS3_RESET_STATS_FIELD_OFFSET(exec_cnt)},
    {"RESET_SUCCESS_CNT", HNS3_RESET_STATS_FIELD_OFFSET(success_cnt)},
    {"RESET_FAIL_CNT", HNS3_RESET_STATS_FIELD_OFFSET(fail_cnt)},
    {"RESET_MERGE_CNT", HNS3_RESET_STATS_FIELD_OFFSET(merge_cnt)}};

/* The statistic of errors in Rx BD */
static const struct hns3_xstats_name_offset hns3_rx_bd_error_strings[] = {
    {"PKT_LEN_ERRORS", HNS3_RX_BD_ERROR_STATS_FIELD_OFFSET(pkt_len_errors)},
    {"L2_ERRORS", HNS3_RX_BD_ERROR_STATS_FIELD_OFFSET(l2_errors)}};

/* The dfx statistic in Rx datapath */
static const struct hns3_xstats_name_offset hns3_rxq_dfx_stats_strings[] = {
    {"L3_CHECKSUM_ERRORS", HNS3_RXQ_DFX_STATS_FIELD_OFFSET(l3_csum_errors)},
    {"L4_CHECKSUM_ERRORS", HNS3_RXQ_DFX_STATS_FIELD_OFFSET(l4_csum_errors)},
    {"OL3_CHECKSUM_ERRORS", HNS3_RXQ_DFX_STATS_FIELD_OFFSET(ol3_csum_errors)},
    {"OL4_CHECKSUM_ERRORS", HNS3_RXQ_DFX_STATS_FIELD_OFFSET(ol4_csum_errors)}};
...
static const struct hns3_xstats_name_offset hns3_txq_dfx_stats_strings[] = {
    ...
    {"QUEUE_FULL_CNT", HNS3_TXQ_DFX_STATS_FIELD_OFFSET(queue_full_cnt)},
...
static const struct hns3_xstats_name_offset hns3_imissed_stats_strings[] = {
    {"RPU_DROP_CNT", HNS3_IMISSED_STATS_FIELD_OFFSET(rpu_rx_drop_cnt)},
    {"SSU_DROP_CNT", HNS3_IMISSED_STATS_FIELD_OFFSET(ssu_rx_drop_cnt)},
};

#define HNS3_NUM_MAC_STATS                                                     \
  (sizeof(hns3_mac_strings) / sizeof(hns3_mac_strings[0]))

#define HNS3_NUM_RESET_XSTATS                                                  \
  (sizeof(hns3_reset_stats_strings) / sizeof(hns3_reset_stats_strings[0]))

#define HNS3_NUM_RX_BD_ERROR_XSTATS                                            \
  (sizeof(hns3_rx_bd_error_strings) / sizeof(hns3_rx_bd_error_strings[0]))

#define HNS3_NUM_RXQ_DFX_XSTATS                                                \
  (sizeof(hns3_rxq_dfx_stats_strings) / sizeof(hns3_rxq_dfx_stats_strings[0]))

#define HNS3_NUM_TXQ_DFX_XSTATS                                                \
  (sizeof(hns3_txq_dfx_stats_strings) / sizeof(hns3_txq_dfx_stats_strings[0]))

#define HNS3_NUM_RX_QUEUE_STATS                                                \
  (sizeof(hns3_rx_queue_strings) / sizeof(hns3_rx_queue_strings[0]))

#define HNS3_NUM_TX_QUEUE_STATS                                                \
  (sizeof(hns3_tx_queue_strings) / sizeof(hns3_tx_queue_strings[0]))

#define HNS3_NUM_RXQ_BASIC_STATS                                               \
  (sizeof(hns3_rxq_basic_stats_strings) /                                      \
   sizeof(hns3_rxq_basic_stats_strings[0]))

#define HNS3_NUM_TXQ_BASIC_STATS                                               \
  (sizeof(hns3_txq_basic_stats_strings) /                                      \
   sizeof(hns3_txq_basic_stats_strings[0]))

#define HNS3_NUM_IMISSED_XSTATS                                                \
  (sizeof(hns3_imissed_stats_strings) / sizeof(hns3_imissed_stats_strings[0]))

#define HNS3_FIX_NUM_STATS (HNS3_NUM_MAC_STATS + HNS3_NUM_RESET_XSTATS)

static void hns3_tqp_stats_clear(struct hns3_hw *hw);

static int hns3_update_mac_stats(struct hns3_hw *hw) {
#define HNS3_MAC_STATS_REG_NUM_PER_DESC 4
  ...
  desc =
      rte_malloc("hns3_mac_desc", desc_num * sizeof(struct hns3_cmd_desc), 0);
  if (desc == NULL) {
  ...
  stats_iterms =
      RTE_MIN(sizeof(hw->mac_stats) / sizeof(uint64_t), hw->mac_stats_reg_num);
...
static int hns3_mac_query_reg_num(struct hns3_hw *hw, uint32_t *reg_num) {
#define HNS3_MAC_STATS_RSV_REG_NUM_ON_HIP08_B 3
  ...
  if (ret) {
    hns3_err(hw, "failed to query MAC statistic reg number, ret = %d", ret);
    return ret;
  }
...
int hns3_query_mac_stats_reg_num(struct hns3_hw *hw) {
  ...
  if (hw->mac_stats_reg_num > sizeof(hw->mac_stats) / sizeof(uint64_t))
    hns3_warn(hw, "MAC stats reg number from firmware is greater than stats "
                  "iterms in driver.");

  return 0;
}

static int hns3_query_update_mac_stats(struct rte_eth_dev *dev) {
...
static int hns3_update_port_rpu_drop_stats(struct hns3_hw *hw) {
...
static void hns3_update_function_rpu_drop_stats(struct hns3_hw *hw) {
  struct hns3_rx_missed_stats *stats = &hw->imissed_stats;

  stats->rpu_rx_drop_cnt += hns3_read_dev(hw, HNS3_RPU_DROP_CNT_REG);
}

static int hns3_update_rpu_drop_stats(struct hns3_hw *hw) {
...
static int hns3_get_ssu_drop_stats(struct hns3_hw *hw,
                                   struct hns3_cmd_desc *desc, int bd_num,
                                   bool is_rx) {
...
static int hns3_update_port_rx_ssu_drop_stats(struct hns3_hw *hw) {
  struct hns3_rx_missed_stats *stats = &hw->imissed_stats;
  ...
  ret = hns3_get_ssu_drop_stats(hw, desc, HNS3_OPC_SSU_DROP_REG_NUM, true);
  if (ret) {
...
static int hns3_update_port_tx_ssu_drop_stats(struct hns3_hw *hw) {
  struct hns3_cmd_desc desc[HNS3_OPC_SSU_DROP_REG_NUM];
  struct hns3_query_ssu_cmd *req;
  uint64_t cnt;
  int ret;

  ret = hns3_get_ssu_drop_stats(hw, desc, HNS3_OPC_SSU_DROP_REG_NUM, false);
  if (ret) {
...
static int hns3_update_oerror_stats(struct hns3_hw *hw, bool is_clear) {
  struct hns3_adapter *hns = HNS3_DEV_HW_TO_ADAPTER(hw);
  int ret;
...
int hns3_stats_get(struct rte_eth_dev *eth_dev,
  ...
  rte_stats->imissed =
      imissed_stats->rpu_rx_drop_cnt + imissed_stats->ssu_rx_drop_cnt;
  ...
  for (i = 0; i < eth_dev->data->nb_rx_queues; i++) {
     ...
     */
    rte_stats->ierrors +=
        rxq->err_stats.l2_errors + rxq->err_stats.pkt_len_errors;
   ...
   */
  rte_stats->ipackets = stats->rcb_rx_ring_pktnum_rcd > rte_stats->ierrors
                            ? stats->rcb_rx_ring_pktnum_rcd - rte_stats->ierrors
                            : 0;
  rte_stats->opackets = stats->rcb_tx_ring_pktnum_rcd - rte_stats->oerrors;
...
static int hns3_mac_stats_reset(__rte_unused struct rte_eth_dev *dev) {
  struct hns3_adapter *hns = dev->data->dev_private;
  struct hns3_hw *hw = &hns->hw;
...
static int hns3_get_imissed_stats_num(struct hns3_adapter *hns) {
...
static int hns3_xstats_calc_num(struct rte_eth_dev *dev) {
#define HNS3_PF_VF_RX_COMM_STATS_NUM                                           \
  (HNS3_NUM_RX_BD_ERROR_XSTATS + HNS3_NUM_RXQ_DFX_XSTATS +                     \
   HNS3_NUM_RX_QUEUE_STATS + HNS3_NUM_RXQ_BASIC_STATS)
#define HNS3_PF_VF_TX_COMM_STATS_NUM                                           \
  (HNS3_NUM_TXQ_DFX_XSTATS + HNS3_NUM_TX_QUEUE_STATS + HNS3_NUM_TXQ_BASIC_STATS)
...
static void hns3_queue_stats_get(struct rte_eth_dev *dev,
                                 struct rte_eth_xstat *xstats, int *count) {
  struct hns3_adapter *hns = dev->data->dev_private;
  struct hns3_hw *hw = &hns->hw;
  uint32_t reg_offset;
  uint16_t i, j;
  ...
  for (j = 0; j < dev->data->nb_rx_queues; j++) {
    for (i = 0; i < HNS3_NUM_RX_QUEUE_STATS; i++) {
      ...
      xstats[*count].value =
          hns3_read_dev(hw, reg_offset + hns3_rx_queue_strings[i].offset);
  ...
  for (j = 0; j < dev->data->nb_tx_queues; j++) {
    for (i = 0; i < HNS3_NUM_TX_QUEUE_STATS; i++) {
      reg_offset = hns3_get_tqp_reg_offset(j);
      xstats[*count].value =
          hns3_read_dev(hw, reg_offset + hns3_tx_queue_strings[i].offset);
      xstats[*count].id = *count;
      (*count)++;
    }
  }
...
static void hns3_rxq_dfx_stats_get(struct rte_eth_dev *dev,
                                   struct rte_eth_xstat *xstats, int *count) {
  ...
  for (i = 0; i < dev->data->nb_rx_queues; i++) {
    ...
    for (j = 0; j < HNS3_NUM_RXQ_DFX_XSTATS; j++) {
      val = (char *)dfx_stats + hns3_rxq_dfx_stats_strings[j].offset;
...
static void hns3_txq_dfx_stats_get(struct rte_eth_dev *dev,
                                   struct rte_eth_xstat *xstats, int *count) {
  ...
  for (i = 0; i < dev->data->nb_tx_queues; i++) {
    ...
    for (j = 0; j < HNS3_NUM_TXQ_DFX_XSTATS; j++) {
      val = (char *)dfx_stats + hns3_txq_dfx_stats_strings[j].offset;
      xstats[*count].value = *(uint64_t *)val;
      xstats[*count].id = *count;
      (*count)++;
    }
...
static void hns3_tqp_dfx_stats_get(struct rte_eth_dev *dev,
                                   struct rte_eth_xstat *xstats, int *count) {
  hns3_rxq_dfx_stats_get(dev, xstats, count);
  hns3_txq_dfx_stats_get(dev, xstats, count);
}

static void hns3_rxq_basic_stats_get(struct rte_eth_dev *dev,
                                     struct rte_eth_xstat *xstats, int *count) {
  ...
  for (i = 0; i < dev->data->nb_rx_queues; i++) {
     ...
     */
    rxq_stats->packets = stats->rcb_rx_ring_pktnum[i] > rxq_stats->errors
                             ? stats->rcb_rx_ring_pktnum[i] - rxq_stats->errors
                             : 0;
    for (j = 0; j < HNS3_NUM_RXQ_BASIC_STATS; j++) {
      val = (char *)rxq_stats + hns3_rxq_basic_stats_strings[j].offset;
      xstats[*count].value = *(uint64_t *)val;
      xstats[*count].id = *count;
      (*count)++;
    }
...
static void hns3_txq_basic_stats_get(struct rte_eth_dev *dev,
                                     struct rte_eth_xstat *xstats, int *count) {
  struct hns3_hw *hw = HNS3_DEV_PRIVATE_TO_HW(dev->data->dev_private);
  struct hns3_tqp_stats *stats = &hw->tqp_stats;
  ...
  for (i = 0; i < dev->data->nb_tx_queues; i++) {
    ...
    for (j = 0; j < HNS3_NUM_TXQ_BASIC_STATS; j++) {
      val = (char *)txq_stats + hns3_txq_basic_stats_strings[j].offset;
      xstats[*count].value = *(uint64_t *)val;
      xstats[*count].id = *count;
      (*count)++;
    }
...
static void hns3_tqp_basic_stats_get(struct rte_eth_dev *dev,
                                     struct rte_eth_xstat *xstats, int *count) {
  hns3_rxq_basic_stats_get(dev, xstats, count);
  hns3_txq_basic_stats_get(dev, xstats, count);
}

static void hns3_imissed_stats_get(struct rte_eth_dev *dev,
                                   struct rte_eth_xstat *xstats, int *count) {
  struct hns3_adapter *hns = dev->data->dev_private;
  struct hns3_hw *hw = &hns->hw;
  struct hns3_rx_missed_stats *imissed_stats = &hw->imissed_stats;
  ...
  for (i = 0; i < imissed_stats_num; i++) {
    addr = (char *)imissed_stats + hns3_imissed_stats_strings[i].offset;
  ...
  for (j = 0; j < dev->data->nb_rx_queues; j++) {
    for (i = 0; i < HNS3_NUM_RX_BD_ERROR_XSTATS; i++) {
      ...
      if (rxq) {
        ...
        addr = (char *)rx_err_stats + hns3_rx_bd_error_strings[i].offset;
        xstats[count].value = *(uint64_t *)addr;
        xstats[count].id = count;
        count++;
      }
  ...
  for (i = 0; i < dev->data->nb_rx_queues; i++) {
    for (j = 0; j < HNS3_NUM_RXQ_BASIC_STATS; j++) {
      snprintf(xstats_names[*count].name, sizeof(xstats_names[*count].name),
               "rx_q%u_%s", i, hns3_rxq_basic_stats_strings[j].name);
      (*count)++;
    }
  }
  for (i = 0; i < dev->data->nb_tx_queues; i++) {
    for (j = 0; j < HNS3_NUM_TXQ_BASIC_STATS; j++) {
      snprintf(xstats_names[*count].name, sizeof(xstats_names[*count].name),
               "tx_q%u_%s", i, hns3_txq_basic_stats_strings[j].name);
      (*count)++;
    }
  }
}

static void hns3_tqp_dfx_stats_name_get(struct rte_eth_dev *dev,
                                        struct rte_eth_xstat_name *xstats_names,
                                        uint32_t *count) {
  uint16_t i, j;
  ...
  for (i = 0; i < dev->data->nb_rx_queues; i++) {
    for (j = 0; j < HNS3_NUM_RXQ_DFX_XSTATS; j++) {
      snprintf(xstats_names[*count].name, sizeof(xstats_names[*count].name),
               "rx_q%u_%s", i, hns3_rxq_dfx_stats_strings[j].name);
      (*count)++;
    }
  }
  ...
  for (i = 0; i < dev->data->nb_tx_queues; i++) {
    for (j = 0; j < HNS3_NUM_TXQ_DFX_XSTATS; j++) {
      snprintf(xstats_names[*count].name, sizeof(xstats_names[*count].name),
               "tx_q%u_%s", i, hns3_txq_dfx_stats_strings[j].name);
      (*count)++;
    }
  }
}

static void hns3_imissed_stats_name_get(struct rte_eth_dev *dev,
                                        struct rte_eth_xstat_name *xstats_names,
                                        uint32_t *count) {
  struct hns3_adapter *hns = dev->data->dev_private;
  uint32_t cnt = *count;
  ...
  for (i = 0; i < imissed_stats_num; i++) {
    snprintf(xstats_names[cnt].name, sizeof(xstats_names[cnt].name), "%s",
...
int hns3_dev_xstats_get_names(struct rte_eth_dev *dev,
  ...
  for (j = 0; j < dev->data->nb_rx_queues; j++) {
    for (i = 0; i < HNS3_NUM_RX_BD_ERROR_XSTATS; i++) {
      snprintf(xstats_names[count].name, sizeof(xstats_names[count].name),
               "rx_q%u_%s", j, hns3_rx_bd_error_strings[i].name);
      count++;
    }
  }
 ...
 *   - 0 on no ids.
 */
int hns3_dev_xstats_get_by_id(struct rte_eth_dev *dev, const uint64_t *ids,
  ...
  if (values_copy == NULL) {
    hns3_err(hw,
             "Failed to allocate 0x%" PRIx64 " bytes needed "
  ...
  if (ids == NULL && values != NULL) {
    for (i = 0; i < cnt_stats; i++)
      memcpy(&values[i], &values_copy[i].value, sizeof(values[i]));
  ...
  for (i = 0; i < size; i++) {
    if (ids[i] >= cnt_stats) {
      hns3_err(hw,
               "ids[%u] (%" PRIu64 ") is invalid, "
               "should < %u",
               i, ids[i], cnt_stats);
      rte_free(values_copy);
      return -EINVAL;
    }
    memcpy(&values[i], &values_copy[ids[i]].value, sizeof(values[i]));
  }
...
static void hns3_tqp_dfx_stats_clear(struct rte_eth_dev *dev) {
  struct hns3_rx_queue *rxq;
  struct hns3_tx_queue *txq;
  uint16_t i;
...
int hns3_tqp_stats_init(struct hns3_hw *hw) {
  ...
  tqp_stats->rcb_rx_ring_pktnum =
      rte_zmalloc("hns3_rx_ring_pkt_num", sizeof(uint64_t) * hw->tqps_num, 0);
  ...
  tqp_stats->rcb_tx_ring_pktnum =
      rte_zmalloc("hns3_tx_ring_pkt_num", sizeof(uint64_t) * hw->tqps_num, 0);
