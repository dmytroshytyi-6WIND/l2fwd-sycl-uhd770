...
enum txgbe_l2_ptids {
  ...
  TXGBE_PTID_L2_IPV6_FRAG =
      (TXGBE_PTID_PKT_IP | TXGBE_PTID_PKT_IPV6 | TXGBE_PTID_TYP_IPFRAG),
  TXGBE_PTID_L2_IPV6 =
      (TXGBE_PTID_PKT_IP | TXGBE_PTID_PKT_IPV6 | TXGBE_PTID_TYP_IPDATA),
  TXGBE_PTID_L2_IPV6_UDP =
      (TXGBE_PTID_PKT_IP | TXGBE_PTID_PKT_IPV6 | TXGBE_PTID_TYP_UDP),
  TXGBE_PTID_L2_IPV6_TCP =
      (TXGBE_PTID_PKT_IP | TXGBE_PTID_PKT_IPV6 | TXGBE_PTID_TYP_TCP),
  TXGBE_PTID_L2_IPV6_SCTP =
      (TXGBE_PTID_PKT_IP | TXGBE_PTID_PKT_IPV6 | TXGBE_PTID_TYP_SCTP),

  TXGBE_PTID_L2_FCOE = (TXGBE_PTID_PKT_FCOE | TXGBE_PTID_TYP_FCOE),
  TXGBE_PTID_L2_FCOE_FCDATA = (TXGBE_PTID_PKT_FCOE | TXGBE_PTID_TYP_FCDATA),
  TXGBE_PTID_L2_FCOE_FCRDY = (TXGBE_PTID_PKT_FCOE | TXGBE_PTID_TYP_FCRDY),
  TXGBE_PTID_L2_FCOE_FCRSP = (TXGBE_PTID_PKT_FCOE | TXGBE_PTID_TYP_FCRSP),
  TXGBE_PTID_L2_FCOE_FCOTHER = (TXGBE_PTID_PKT_FCOE | TXGBE_PTID_TYP_FCOTHER),
  TXGBE_PTID_L2_FCOE_VFT = (TXGBE_PTID_PKT_FCOE | TXGBE_PTID_PKT_VFT),
  TXGBE_PTID_L2_FCOE_VFT_FCDATA =
      (TXGBE_PTID_PKT_FCOE | TXGBE_PTID_PKT_VFT | TXGBE_PTID_TYP_FCDATA),
  TXGBE_PTID_L2_FCOE_VFT_FCRDY =
      (TXGBE_PTID_PKT_FCOE | TXGBE_PTID_PKT_VFT | TXGBE_PTID_TYP_FCRDY),
  TXGBE_PTID_L2_FCOE_VFT_FCRSP =
      (TXGBE_PTID_PKT_FCOE | TXGBE_PTID_PKT_VFT | TXGBE_PTID_TYP_FCRSP),
  TXGBE_PTID_L2_FCOE_VFT_FCOTHER =
      (TXGBE_PTID_PKT_FCOE | TXGBE_PTID_PKT_VFT | TXGBE_PTID_TYP_FCOTHER),

  TXGBE_PTID_L2_TUN4_MAC = (TXGBE_PTID_PKT_TUN | TXGBE_PTID_TUN_EIGM),
  TXGBE_PTID_L2_TUN6_MAC =
      (TXGBE_PTID_PKT_TUN | TXGBE_PTID_TUN_IPV6 | TXGBE_PTID_TUN_EIGM),
};
