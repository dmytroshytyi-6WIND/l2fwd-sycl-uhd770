...
static inline int txgbe_read_regs(struct txgbe_hw *hw,
...
static inline int txgbe_regs_group_count(const struct reg_info *regs) {
  int count = 0;
  int i = 0;
...
static inline int txgbe_read_regs_group(struct rte_eth_dev *dev,
                                        uint32_t *reg_buf,
