...
static inline s32 txgbe_mac_get_mac_addr_dummy(struct txgbe_hw *TUP0,
                                               u8 *TUP1) {
  return TXGBE_ERR_OPS_DUMMY;
}
...
static inline s32 txgbe_mac_enable_rx_dma_dummy(struct txgbe_hw *TUP0,
                                                u32 TUP1) {
  return TXGBE_ERR_OPS_DUMMY;
}
...
static inline void txgbe_mac_autoc_write_dummy(struct txgbe_hw *TUP0,
                                               u64 TUP1) {}
...
static inline s32 txgbe_mac_set_fw_drv_ver_dummy(struct txgbe_hw *TUP0, u8 TUP1,
                                                 ...
                                                 u16 TUP5, const char *TUP6) {
  return TXGBE_ERR_OPS_DUMMY;
}
static inline s32
txgbe_mac_get_thermal_sensor_data_dummy(struct txgbe_hw *TUP0) {
  return TXGBE_ERR_OPS_DUMMY;
}
static inline s32 txgbe_mac_init_thermal_ssth_dummy(struct txgbe_hw *TUP0) {
  return TXGBE_ERR_OPS_DUMMY;
}
static inline void txgbe_mac_get_rtrup2tc_dummy(struct txgbe_hw *TUP0,
                                                u8 *TUP1) {}
...
static inline s32 txgbe_mbx_check_for_msg_dummy(struct txgbe_hw *TUP0,
                                                u16 TUP1) {
  return TXGBE_ERR_OPS_DUMMY;
}
static inline s32 txgbe_mbx_check_for_ack_dummy(struct txgbe_hw *TUP0,
                                                u16 TUP1) {
  return TXGBE_ERR_OPS_DUMMY;
}
static inline s32 txgbe_mbx_check_for_rst_dummy(struct txgbe_hw *TUP0,
                                                u16 TUP1) {
  return TXGBE_ERR_OPS_DUMMY;
}
