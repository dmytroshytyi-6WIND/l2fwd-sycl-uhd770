...
struct txgbe_link_info {
  ...
  s32 (*read_link_unlocked)(struct txgbe_hw *hw, u8 addr, u16 reg, u16 *val);
  s32 (*write_link)(struct txgbe_hw *hw, u8 addr, u16 reg, u16 val);
  s32 (*write_link_unlocked)(struct txgbe_hw *hw, u8 addr, u16 reg, u16 val);
...
struct txgbe_rom_info {
  ...
  s32 (*readw_buffer)(struct txgbe_hw *hw, u32 offset, u32 words, void *data);
  ...
  s32 (*writew_buffer)(struct txgbe_hw *hw, u32 offset, u32 words, void *data);
...
struct txgbe_mac_info {
  ...
  s32 (*get_link_capabilities)(struct txgbe_hw *hw, u32 *speed, bool *autoneg);
  ...
  s32 (*update_mc_addr_list)(struct txgbe_hw *hw, u8 *mc_addr_list,
                             u32 mc_addr_count, txgbe_mc_addr_itr func,
                             bool clear);
  s32 (*clear_vfta)(struct txgbe_hw *hw);
  s32 (*set_vfta)(struct txgbe_hw *hw, u32 vlan, u32 vind, bool vlan_on,
                  bool vlvf_bypass);
  s32 (*set_vlvf)(struct txgbe_hw *hw, u32 vlan, u32 vind, bool vlan_on,
  ...
  void (*set_vlan_anti_spoofing)(struct txgbe_hw *hw, bool enable, int vf);
  ...
  s32 (*set_fw_drv_ver)(struct txgbe_hw *hw, u8 maj, u8 min, u8 build, u8 ver,
                        u16 len, const char *driver_ver);
...
struct txgbe_phy_info {
  ...
  s32 (*read_reg)(struct txgbe_hw *hw, u32 reg_addr, u32 device_type,
                  u16 *phy_data);
  s32 (*write_reg)(struct txgbe_hw *hw, u32 reg_addr, u32 device_type,
                   u16 phy_data);
  s32 (*read_reg_mdi)(struct txgbe_hw *hw, u32 reg_addr, u32 device_type,
                      u16 *phy_data);
  s32 (*write_reg_mdi)(struct txgbe_hw *hw, u32 reg_addr, u32 device_type,
                       u16 phy_data);
  ...
  s32 (*read_i2c_byte)(struct txgbe_hw *hw, u8 byte_offset, u8 dev_addr,
                       u8 *data);
  s32 (*write_i2c_byte)(struct txgbe_hw *hw, u8 byte_offset, u8 dev_addr,
                        u8 data);
  s32 (*read_i2c_sff8472)(struct txgbe_hw *hw, u8 byte_offset,
                          u8 *sff8472_data);
  s32 (*read_i2c_eeprom)(struct txgbe_hw *hw, u8 byte_offset, u8 *eeprom_data);
...
static const char *const txgbe_valid_arguments[] = {
    TXGBE_DEVARG_BP_AUTO,  TXGBE_DEVARG_KR_POLL,  TXGBE_DEVARG_KR_PRESENT,
    TXGBE_DEVARG_KX_SGMII, TXGBE_DEVARG_FFE_SET,  TXGBE_DEVARG_FFE_MAIN,
    TXGBE_DEVARG_FFE_PRE,  TXGBE_DEVARG_FFE_POST, NULL};
