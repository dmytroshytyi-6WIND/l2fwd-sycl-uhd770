...
#define VF_MAX_FILTERS (VF_MAX_MAC_FILTERS + VF_MAX_VLAN_FILTERS)
...
#define MAC_ADDR_VALID                                                         \
  0 /* alert the vf that a new mac address                                     \
     * is available for it                                                     \
     */
#define VLAN_VALID                                                             \
  1 /* when set, the vf should no access the                                   \
     * vf channel                                                              \
     */
#define CHANNEL_DOWN                                                           \
  2 /* vf channel is disabled. VFs are not                                     \
