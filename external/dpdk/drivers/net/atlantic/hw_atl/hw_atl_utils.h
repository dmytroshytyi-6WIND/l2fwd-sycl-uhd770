...
#define IS_CHIP_FEATURE(_F_)                                                   \
  (HAL_ATLANTIC_UTILS_CHIP_##_F_ & self->chip_features)
...
int hw_atl_utils_hw_set_power(struct aq_hw_s *self, unsigned int power_state);
