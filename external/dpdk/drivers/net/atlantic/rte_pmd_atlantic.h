 ...
 */
__rte_experimental int rte_pmd_atl_macsec_enable(uint16_t port, uint8_t encr,
                                                 uint8_t repl_prot);
 ...
 *   - (-ENOTSUP) if hardware doesn't support this feature.
 */
__rte_experimental int rte_pmd_atl_macsec_disable(uint16_t port);
 ...
 *   - (-ENOTSUP) if hardware doesn't support this feature.
 */
__rte_experimental int rte_pmd_atl_macsec_config_txsc(uint16_t port,
                                                      uint8_t *mac);
 ...
 */
__rte_experimental int rte_pmd_atl_macsec_select_txsa(uint16_t port,
 ...
 *   - (-EINVAL) if bad parameter.
 */
__rte_experimental int rte_pmd_atl_macsec_select_rxsa(uint16_t port,
                                                      uint8_t idx, uint8_t an,
                                                      uint32_t pn,
                                                      uint8_t *key);
