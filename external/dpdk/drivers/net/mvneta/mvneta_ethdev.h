...
#define MRVL_NETA_ETH_HDRS_LEN                                                 \
  (RTE_ETHER_HDR_LEN + RTE_ETHER_CRC_LEN + RTE_VLAN_HLEN)
...
#define MVNETA_TX_OFFLOADS                                                     \
  (MVNETA_TX_OFFLOAD_CHECKSUM | RTE_ETH_TX_OFFLOAD_MULTI_SEGS)

#define MVNETA_TX_PKT_OFFLOADS                                                 \
