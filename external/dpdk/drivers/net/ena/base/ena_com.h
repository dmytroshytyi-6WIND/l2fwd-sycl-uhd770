 ...
 * flush it to the device, the new configuration will be lost.
 *
 * @return: 0 on Success and negative value otherwise.
 */
 ...
 */
static inline struct ena_com_dev *
ena_com_io_sq_to_ena_dev(struct ena_com_io_sq *io_sq) {
 ...
 */
static inline struct ena_com_dev *
ena_com_io_cq_to_ena_dev(struct ena_com_io_cq *io_cq) {
...
static inline void ena_com_update_intr_reg(struct ena_eth_io_intr_reg *intr_reg,
                                           ...
                                           u32 tx_delay_interval, bool unmask) {
  intr_reg->intr_control = 0;
  intr_reg->intr_control |=
      rx_delay_interval & ENA_ETH_IO_INTR_REG_RX_INTR_DELAY_MASK;
