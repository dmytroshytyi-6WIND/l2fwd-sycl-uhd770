...
#define MLX5_RXP_CTRL_JOB_DESC_FLAGS                                           \
  (MLX5_RXP_CTRL_JOB_DESC_SOF | MLX5_RXP_CTRL_JOB_DESC_EOF |                   \
   MLX5_RXP_CTRL_JOB_DESC_HPM_ENABLE | MLX5_RXP_CTRL_JOB_DESC_ANYMATCH_ENABLE)
