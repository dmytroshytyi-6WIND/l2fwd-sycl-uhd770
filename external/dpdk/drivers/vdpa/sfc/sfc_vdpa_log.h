...
#define sfc_vdpa_err(sva, ...) SFC_VDPA_LOG(sva, ERR, __VA_ARGS__)

#define sfc_vdpa_warn(sva, ...) SFC_VDPA_LOG(sva, WARNING, __VA_ARGS__)

#define sfc_vdpa_notice(sva, ...) SFC_VDPA_LOG(sva, NOTICE, __VA_ARGS__)

#define sfc_vdpa_info(sva, ...) SFC_VDPA_LOG(sva, INFO, __VA_ARGS__)
