...
#define DPAA2_EVENTDEV_LOG(level, fmt, args...)                                \
  rte_log(RTE_LOG_##level, dpaa2_logtype_event, "dpaa2_event: " fmt "\n",      \
          ##args)
...
#define DPAA2_EVENTDEV_INFO(fmt, args...) DPAA2_EVENTDEV_LOG(INFO, fmt, ##args)
#define DPAA2_EVENTDEV_ERR(fmt, args...) DPAA2_EVENTDEV_LOG(ERR, fmt, ##args)
