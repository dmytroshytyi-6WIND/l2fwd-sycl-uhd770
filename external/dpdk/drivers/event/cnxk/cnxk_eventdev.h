...
static inline int parse_kvargs_flag(const char *key, const char *value,
                                    void *opaque) {
  RTE_SET_USED(key);
...
static inline int parse_kvargs_value(const char *key, const char *value,
                                     void *opaque) {
  RTE_SET_USED(key);
...
static inline struct cnxk_sso_hws_cookie *cnxk_sso_hws_get_cookie(void *ws) {
