 ...
 *   NUMA socket.
 */
int opdl_ring_get_socket(const struct opdl_ring *t);
 ...
 *   Name string.
 */
const char *opdl_ring_get_name(const struct opdl_ring *t);
 ...
 */
uint32_t opdl_stage_claim_check(struct opdl_stage *s, void **entries,
                                uint32_t num_entries, uint32_t *seq, bool block,
 ...
 */
int opdl_stage_disclaim(struct opdl_stage *s, uint32_t num_entries, bool block);
 ...
 */
struct opdl_stage *opdl_stage_create(struct opdl_ring *t, bool threadsafe);
