...
enum queue_pos { OPDL_Q_POS_START = 0, OPDL_Q_POS_MIDDLE, OPDL_Q_POS_END };
...
struct opdl_evdev {
  ...
  struct opdl_queue queue[RTE_EVENT_MAX_QUEUES_PER_DEV] __rte_cache_aligned;
...
static inline uint8_t opdl_pmd_dev_id(const struct opdl_evdev *opdl) {
