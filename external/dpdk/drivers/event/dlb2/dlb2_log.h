...
#define DLB2_LOG_INFO(fmt, args...) DLB2_LOG_IMPL(INFO, fmt, ##args)

#define DLB2_LOG_ERR(fmt, args...) DLB2_LOG_IMPL(ERR, fmt, ##args)

/* remove debug logs at compile time unless actually debugging */
#define DLB2_LOG_DBG(fmt, args...) RTE_LOG_DP(DEBUG, PMD, fmt, ##args)
