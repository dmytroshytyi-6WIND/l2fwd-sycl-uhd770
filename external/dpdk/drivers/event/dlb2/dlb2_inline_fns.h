...
static inline void dlb2_movntdq_single(void *pp_addr, void *qe4) {
...
static inline void dlb2_movdir64b(void *dest, void *src) {
  asm volatile(".byte 0x66, 0x0f, 0x38, 0xf8, 0x02" : : "a"(dest), "d"(src));
}
