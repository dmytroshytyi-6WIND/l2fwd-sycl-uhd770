...
#define DLB2_PF_VF2PF_MAILBOX(vf_id, x) (0x1000 + 0x4 * (x) + (vf_id)*0x10000)
#define DLB2_PF_VF2PF_MAILBOX_RST 0x0

#define DLB2_PF_VF2PF_MAILBOX_MSG 0xFFFFFFFF
#define DLB2_PF_VF2PF_MAILBOX_MSG_LOC 0

#define DLB2_PF_VF2PF_MAILBOX_ISR(vf_id) (0x1f00 + (vf_id)*0x10000)
...
#define DLB2_PF_VF2PF_FLR_ISR(vf_id) (0x1f04 + (vf_id)*0x10000)
...
#define DLB2_PF_VF2PF_ISR_PEND(vf_id) (0x1f10 + (vf_id)*0x10000)
...
#define DLB2_PF_PF2VF_MAILBOX(vf_id, x) (0x2000 + 0x4 * (x) + (vf_id)*0x10000)
#define DLB2_PF_PF2VF_MAILBOX_RST 0x0

#define DLB2_PF_PF2VF_MAILBOX_MSG 0xFFFFFFFF
#define DLB2_PF_PF2VF_MAILBOX_MSG_LOC 0

#define DLB2_PF_PF2VF_MAILBOX_ISR(vf_id) (0x2f00 + (vf_id)*0x10000)
...
#define DLB2_PF_VF_RESET_IN_PROGRESS(vf_id) (0x3000 + (vf_id)*0x10000)
...
#define DLB2_MSIX_VECTOR_CTRL(x) (0x100000c + (x)*0x10)
...
#define DLB2_IOSF_FUNC_VF_BAR_DSBL(x) (0x20 + (x)*0x4)
...
#define DLB2_SYS_TOTAL_VAS(ver)                                                \
  (ver == DLB2_HW_V2 ? DLB2_V2SYS_TOTAL_VAS : DLB2_V2_5SYS_TOTAL_VAS)
...
#define DLB2_SYS_VF_LDB_VPP_V(x) (0x10000f00 + (x)*0x1000)
...
#define DLB2_SYS_VF_LDB_VPP2PP(x) (0x10000f04 + (x)*0x1000)
...
#define DLB2_SYS_VF_DIR_VPP_V(x) (0x10000f08 + (x)*0x1000)
...
#define DLB2_SYS_VF_DIR_VPP2PP(x) (0x10000f0c + (x)*0x1000)
...
#define DLB2_SYS_VF_LDB_VQID_V(x) (0x10000f10 + (x)*0x1000)
...
#define DLB2_SYS_VF_LDB_VQID2QID(x) (0x10000f14 + (x)*0x1000)
...
#define DLB2_SYS_LDB_QID2VQID(x) (0x10000f18 + (x)*0x1000)
...
#define DLB2_SYS_VF_DIR_VQID_V(x) (0x10000f1c + (x)*0x1000)
...
#define DLB2_SYS_VF_DIR_VQID2QID(x) (0x10000f20 + (x)*0x1000)
...
#define DLB2_SYS_LDB_VASQID_V(x) (0x10000f24 + (x)*0x1000)
...
#define DLB2_SYS_DIR_VASQID_V(x) (0x10000f28 + (x)*0x1000)
...
#define DLB2_SYS_ALARM_VF_SYND2(x) (0x10000f48 + (x)*0x1000)
...
#define DLB2_SYS_ALARM_VF_SYND1(x) (0x10000f44 + (x)*0x1000)
...
#define DLB2_SYS_ALARM_VF_SYND0(x) (0x10000f40 + (x)*0x1000)
...
#define DLB2_SYS_LDB_QID_CFG_V(x) (0x10000f58 + (x)*0x1000)
...
#define DLB2_SYS_LDB_QID_ITS(x) (0x10000f54 + (x)*0x1000)
...
#define DLB2_SYS_LDB_QID_V(x) (0x10000f50 + (x)*0x1000)
...
#define DLB2_SYS_DIR_QID_ITS(x) (0x10000f64 + (x)*0x1000)
...
#define DLB2_SYS_DIR_QID_V(x) (0x10000f60 + (x)*0x1000)
...
#define DLB2_SYS_LDB_CQ_AI_DATA(x) (0x10000fa8 + (x)*0x1000)
...
#define DLB2_SYS_LDB_CQ_AI_ADDR(x) (0x10000fa4 + (x)*0x1000)
...
#define DLB2_V2SYS_LDB_CQ_PASID(x) (0x10000fa0 + (x)*0x1000)
#define DLB2_V2_5SYS_LDB_CQ_PASID(x) (0x10000f9c + (x)*0x1000)
#define DLB2_SYS_LDB_CQ_PASID(ver, x)                                          \
  (ver == DLB2_HW_V2 ? DLB2_V2SYS_LDB_CQ_PASID(x)                              \
...
#define DLB2_SYS_LDB_CQ_AT(x) (0x10000f9c + (x)*0x1000)
...
#define DLB2_SYS_LDB_CQ_ISR(x) (0x10000f98 + (x)*0x1000)
...
#define DLB2_SYS_LDB_CQ2VF_PF_RO(x) (0x10000f94 + (x)*0x1000)
...
#define DLB2_SYS_LDB_PP_V(x) (0x10000f90 + (x)*0x1000)
...
#define DLB2_SYS_LDB_PP2VDEV(x) (0x10000f8c + (x)*0x1000)
...
#define DLB2_SYS_LDB_PP2VAS(x) (0x10000f88 + (x)*0x1000)
...
#define DLB2_SYS_LDB_CQ_ADDR_U(x) (0x10000f84 + (x)*0x1000)
...
#define DLB2_SYS_LDB_CQ_ADDR_L(x) (0x10000f80 + (x)*0x1000)
...
#define DLB2_SYS_DIR_CQ_FMT(x) (0x10000fec + (x)*0x1000)
...
#define DLB2_SYS_DIR_CQ_AI_DATA(x) (0x10000fe8 + (x)*0x1000)
...
#define DLB2_SYS_DIR_CQ_AI_ADDR(x) (0x10000fe4 + (x)*0x1000)
...
#define DLB2_V2SYS_DIR_CQ_PASID(x) (0x10000fe0 + (x)*0x1000)
#define DLB2_V2_5SYS_DIR_CQ_PASID(x) (0x10000fdc + (x)*0x1000)
#define DLB2_SYS_DIR_CQ_PASID(ver, x)                                          \
  (ver == DLB2_HW_V2 ? DLB2_V2SYS_DIR_CQ_PASID(x)                              \
...
#define DLB2_SYS_DIR_CQ_AT(x) (0x10000fdc + (x)*0x1000)
...
#define DLB2_SYS_DIR_CQ_ISR(x) (0x10000fd8 + (x)*0x1000)
...
#define DLB2_SYS_DIR_CQ2VF_PF_RO(x) (0x10000fd4 + (x)*0x1000)
...
#define DLB2_SYS_DIR_PP_V(x) (0x10000fd0 + (x)*0x1000)
...
#define DLB2_SYS_DIR_PP2VDEV(x) (0x10000fcc + (x)*0x1000)
...
#define DLB2_SYS_DIR_PP2VAS(x) (0x10000fc8 + (x)*0x1000)
...
#define DLB2_SYS_DIR_CQ_ADDR_U(x) (0x10000fc4 + (x)*0x1000)
...
#define DLB2_SYS_DIR_CQ_ADDR_L(x) (0x10000fc0 + (x)*0x1000)
...
#define DLB2_SYS_SMON_COMP_MASK1(x) (0x18002024 + (x)*0x40)
...
#define DLB2_SYS_SMON_COMP_MASK0(x) (0x18002020 + (x)*0x40)
...
#define DLB2_SYS_SMON_MAX_TMR(x) (0x1800201c + (x)*0x40)
...
#define DLB2_SYS_SMON_ACTIVITYCNTR0(x) (0x18002010 + (x)*0x40)
...
#define DLB2_SYS_SMON_COMPARE1(x) (0x1800200c + (x)*0x40)
...
#define DLB2_SYS_SMON_COMPARE0(x) (0x18002008 + (x)*0x40)
...
#define DLB2_SYS_SMON_CFG1(x) (0x18002004 + (x)*0x40)
...
#define DLB2_SYS_SMON_CFG0(x) (0x18002000 + (x)*0x40)
...
#define DLB2_AQED_QID_FID_LIM(x) (0x20000000 + (x)*0x1000)
...
#define DLB2_AQED_QID_HID_WIDTH(x) (0x20080000 + (x)*0x1000)
...
#define DLB2_ATM_QID2CQIDIX_00(x) (0x30080000 + (x)*0x1000)
#define DLB2_ATM_QID2CQIDIX_00_RST 0x0
#define DLB2_ATM_QID2CQIDIX(x, y) (DLB2_ATM_QID2CQIDIX_00(x) + 0x80000 * (y))
...
#define DLB2_CHP_CFG_DIR_VAS_CRD(x) (0x40000000 + (x)*0x1000)
...
#define DLB2_CHP_CFG_LDB_VAS_CRD(x) (0x40080000 + (x)*0x1000)
...
#define DLB2_V2CHP_ORD_QID_SN(x) (0x40100000 + (x)*0x1000)
#define DLB2_V2_5CHP_ORD_QID_SN(x) (0x40080000 + (x)*0x1000)
#define DLB2_CHP_ORD_QID_SN(ver, x)                                            \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_ORD_QID_SN(x) : DLB2_V2_5CHP_ORD_QID_SN(x))
...
#define DLB2_V2CHP_ORD_QID_SN_MAP(x) (0x40180000 + (x)*0x1000)
#define DLB2_V2_5CHP_ORD_QID_SN_MAP(x) (0x40100000 + (x)*0x1000)
#define DLB2_CHP_ORD_QID_SN_MAP(ver, x)                                        \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_ORD_QID_SN_MAP(x)                            \
...
#define DLB2_V2CHP_SN_CHK_ENBL(x) (0x40200000 + (x)*0x1000)
#define DLB2_V2_5CHP_SN_CHK_ENBL(x) (0x40180000 + (x)*0x1000)
#define DLB2_CHP_SN_CHK_ENBL(ver, x)                                           \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_SN_CHK_ENBL(x) : DLB2_V2_5CHP_SN_CHK_ENBL(x))
...
#define DLB2_V2CHP_DIR_CQ_DEPTH(x) (0x40280000 + (x)*0x1000)
#define DLB2_V2_5CHP_DIR_CQ_DEPTH(x) (0x40300000 + (x)*0x1000)
#define DLB2_CHP_DIR_CQ_DEPTH(ver, x)                                          \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_DIR_CQ_DEPTH(x)                              \
...
#define DLB2_V2CHP_DIR_CQ_INT_DEPTH_THRSH(x) (0x40300000 + (x)*0x1000)
#define DLB2_V2_5CHP_DIR_CQ_INT_DEPTH_THRSH(x) (0x40380000 + (x)*0x1000)
#define DLB2_CHP_DIR_CQ_INT_DEPTH_THRSH(ver, x)                                \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_DIR_CQ_INT_DEPTH_THRSH(x)                    \
...
#define DLB2_V2CHP_DIR_CQ_INT_ENB(x) (0x40380000 + (x)*0x1000)
#define DLB2_V2_5CHP_DIR_CQ_INT_ENB(x) (0x40400000 + (x)*0x1000)
#define DLB2_CHP_DIR_CQ_INT_ENB(ver, x)                                        \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_DIR_CQ_INT_ENB(x)                            \
...
#define DLB2_V2CHP_DIR_CQ_TMR_THRSH(x) (0x40480000 + (x)*0x1000)
#define DLB2_V2_5CHP_DIR_CQ_TMR_THRSH(x) (0x40500000 + (x)*0x1000)
#define DLB2_CHP_DIR_CQ_TMR_THRSH(ver, x)                                      \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_DIR_CQ_TMR_THRSH(x)                          \
...
#define DLB2_V2CHP_DIR_CQ_TKN_DEPTH_SEL(x) (0x40500000 + (x)*0x1000)
#define DLB2_V2_5CHP_DIR_CQ_TKN_DEPTH_SEL(x) (0x40580000 + (x)*0x1000)
#define DLB2_CHP_DIR_CQ_TKN_DEPTH_SEL(ver, x)                                  \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_DIR_CQ_TKN_DEPTH_SEL(x)                      \
...
#define DLB2_V2CHP_DIR_CQ_WD_ENB(x) (0x40580000 + (x)*0x1000)
#define DLB2_V2_5CHP_DIR_CQ_WD_ENB(x) (0x40600000 + (x)*0x1000)
#define DLB2_CHP_DIR_CQ_WD_ENB(ver, x)                                         \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_DIR_CQ_WD_ENB(x)                             \
...
#define DLB2_V2CHP_DIR_CQ_WPTR(x) (0x40600000 + (x)*0x1000)
#define DLB2_V2_5CHP_DIR_CQ_WPTR(x) (0x40680000 + (x)*0x1000)
#define DLB2_CHP_DIR_CQ_WPTR(ver, x)                                           \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_DIR_CQ_WPTR(x) : DLB2_V2_5CHP_DIR_CQ_WPTR(x))
...
#define DLB2_V2CHP_DIR_CQ2VAS(x) (0x40680000 + (x)*0x1000)
#define DLB2_V2_5CHP_DIR_CQ2VAS(x) (0x40700000 + (x)*0x1000)
#define DLB2_CHP_DIR_CQ2VAS(ver, x)                                            \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_DIR_CQ2VAS(x) : DLB2_V2_5CHP_DIR_CQ2VAS(x))
...
#define DLB2_V2CHP_HIST_LIST_BASE(x) (0x40700000 + (x)*0x1000)
#define DLB2_V2_5CHP_HIST_LIST_BASE(x) (0x40780000 + (x)*0x1000)
#define DLB2_CHP_HIST_LIST_BASE(ver, x)                                        \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_HIST_LIST_BASE(x)                            \
...
#define DLB2_V2CHP_HIST_LIST_LIM(x) (0x40780000 + (x)*0x1000)
#define DLB2_V2_5CHP_HIST_LIST_LIM(x) (0x40800000 + (x)*0x1000)
#define DLB2_CHP_HIST_LIST_LIM(ver, x)                                         \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_HIST_LIST_LIM(x)                             \
...
#define DLB2_V2CHP_HIST_LIST_POP_PTR(x) (0x40800000 + (x)*0x1000)
#define DLB2_V2_5CHP_HIST_LIST_POP_PTR(x) (0x40880000 + (x)*0x1000)
#define DLB2_CHP_HIST_LIST_POP_PTR(ver, x)                                     \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_HIST_LIST_POP_PTR(x)                         \
...
#define DLB2_V2CHP_HIST_LIST_PUSH_PTR(x) (0x40880000 + (x)*0x1000)
#define DLB2_V2_5CHP_HIST_LIST_PUSH_PTR(x) (0x40900000 + (x)*0x1000)
#define DLB2_CHP_HIST_LIST_PUSH_PTR(ver, x)                                    \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_HIST_LIST_PUSH_PTR(x)                        \
...
#define DLB2_V2CHP_LDB_CQ_DEPTH(x) (0x40900000 + (x)*0x1000)
#define DLB2_V2_5CHP_LDB_CQ_DEPTH(x) (0x40a80000 + (x)*0x1000)
#define DLB2_CHP_LDB_CQ_DEPTH(ver, x)                                          \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_LDB_CQ_DEPTH(x)                              \
...
#define DLB2_V2CHP_LDB_CQ_INT_DEPTH_THRSH(x) (0x40980000 + (x)*0x1000)
#define DLB2_V2_5CHP_LDB_CQ_INT_DEPTH_THRSH(x) (0x40b00000 + (x)*0x1000)
#define DLB2_CHP_LDB_CQ_INT_DEPTH_THRSH(ver, x)                                \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_LDB_CQ_INT_DEPTH_THRSH(x)                    \
...
#define DLB2_V2CHP_LDB_CQ_INT_ENB(x) (0x40a00000 + (x)*0x1000)
#define DLB2_V2_5CHP_LDB_CQ_INT_ENB(x) (0x40b80000 + (x)*0x1000)
#define DLB2_CHP_LDB_CQ_INT_ENB(ver, x)                                        \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_LDB_CQ_INT_ENB(x)                            \
...
#define DLB2_V2CHP_LDB_CQ_TMR_THRSH(x) (0x40b00000 + (x)*0x1000)
#define DLB2_V2_5CHP_LDB_CQ_TMR_THRSH(x) (0x40c80000 + (x)*0x1000)
#define DLB2_CHP_LDB_CQ_TMR_THRSH(ver, x)                                      \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_LDB_CQ_TMR_THRSH(x)                          \
...
#define DLB2_V2CHP_LDB_CQ_TKN_DEPTH_SEL(x) (0x40b80000 + (x)*0x1000)
#define DLB2_V2_5CHP_LDB_CQ_TKN_DEPTH_SEL(x) (0x40d00000 + (x)*0x1000)
#define DLB2_CHP_LDB_CQ_TKN_DEPTH_SEL(ver, x)                                  \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_LDB_CQ_TKN_DEPTH_SEL(x)                      \
...
#define DLB2_V2CHP_LDB_CQ_WD_ENB(x) (0x40c00000 + (x)*0x1000)
#define DLB2_V2_5CHP_LDB_CQ_WD_ENB(x) (0x40d80000 + (x)*0x1000)
#define DLB2_CHP_LDB_CQ_WD_ENB(ver, x)                                         \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_LDB_CQ_WD_ENB(x)                             \
...
#define DLB2_V2CHP_LDB_CQ_WPTR(x) (0x40c80000 + (x)*0x1000)
#define DLB2_V2_5CHP_LDB_CQ_WPTR(x) (0x40e00000 + (x)*0x1000)
#define DLB2_CHP_LDB_CQ_WPTR(ver, x)                                           \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_LDB_CQ_WPTR(x) : DLB2_V2_5CHP_LDB_CQ_WPTR(x))
...
#define DLB2_V2CHP_LDB_CQ2VAS(x) (0x40d00000 + (x)*0x1000)
#define DLB2_V2_5CHP_LDB_CQ2VAS(x) (0x40e80000 + (x)*0x1000)
#define DLB2_CHP_LDB_CQ2VAS(ver, x)                                            \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_LDB_CQ2VAS(x) : DLB2_V2_5CHP_LDB_CQ2VAS(x))
...
#define DLB2_CHP_DIR_CQ_INTR_ARMED0(ver)                                       \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_DIR_CQ_INTR_ARMED0                           \
...
#define DLB2_CHP_DIR_CQ_INTR_ARMED1(ver)                                       \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_DIR_CQ_INTR_ARMED1                           \
...
#define DLB2_CHP_CFG_DIR_CQ_TIMER_CTL(ver)                                     \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_CFG_DIR_CQ_TIMER_CTL                         \
...
#define DLB2_CHP_CFG_DIR_WDTO_0(ver)                                           \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_CFG_DIR_WDTO_0 : DLB2_V2_5CHP_CFG_DIR_WDTO_0)
...
#define DLB2_CHP_CFG_DIR_WDTO_1(ver)                                           \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_CFG_DIR_WDTO_1 : DLB2_V2_5CHP_CFG_DIR_WDTO_1)
...
#define DLB2_CHP_CFG_DIR_WD_DISABLE0(ver)                                      \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_CFG_DIR_WD_DISABLE0                          \
...
#define DLB2_CHP_CFG_DIR_WD_DISABLE1(ver)                                      \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_CFG_DIR_WD_DISABLE1                          \
...
#define DLB2_CHP_CFG_DIR_WD_ENB_INTERVAL(ver)                                  \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_CFG_DIR_WD_ENB_INTERVAL                      \
...
#define DLB2_CHP_CFG_DIR_WD_THRESHOLD(ver)                                     \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_CFG_DIR_WD_THRESHOLD                         \
...
#define DLB2_CHP_LDB_CQ_INTR_ARMED0(ver)                                       \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_LDB_CQ_INTR_ARMED0                           \
...
#define DLB2_CHP_LDB_CQ_INTR_ARMED1(ver)                                       \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_LDB_CQ_INTR_ARMED1                           \
...
#define DLB2_CHP_CFG_LDB_CQ_TIMER_CTL(ver)                                     \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_CFG_LDB_CQ_TIMER_CTL                         \
...
#define DLB2_CHP_CFG_LDB_WDTO_0(ver)                                           \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_CFG_LDB_WDTO_0 : DLB2_V2_5CHP_CFG_LDB_WDTO_0)
...
#define DLB2_CHP_CFG_LDB_WDTO_1(ver)                                           \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_CFG_LDB_WDTO_1 : DLB2_V2_5CHP_CFG_LDB_WDTO_1)
...
#define DLB2_CHP_CFG_LDB_WD_DISABLE0(ver)                                      \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_CFG_LDB_WD_DISABLE0                          \
...
#define DLB2_CHP_CFG_LDB_WD_DISABLE1(ver)                                      \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_CFG_LDB_WD_DISABLE1                          \
...
#define DLB2_CHP_CFG_LDB_WD_ENB_INTERVAL(ver)                                  \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_CFG_LDB_WD_ENB_INTERVAL                      \
...
#define DLB2_CHP_CFG_LDB_WD_THRESHOLD(ver)                                     \
  (ver == DLB2_HW_V2 ? DLB2_V2CHP_CFG_LDB_WD_THRESHOLD                         \
...
#define DLB2_NALB_CFG_ARB_WEIGHTS_TQPRI_ATQ_0(ver)                             \
  (ver == DLB2_HW_V2 ? DLB2_V2NALB_CFG_ARB_WEIGHTS_TQPRI_ATQ_0                 \
...
#define DLB2_NALB_CFG_ARB_WEIGHTS_TQPRI_ATQ_1(ver)                             \
  (ver == DLB2_HW_V2 ? DLB2_V2NALB_CFG_ARB_WEIGHTS_TQPRI_ATQ_1                 \
...
#define DLB2_NALB_CFG_ARB_WEIGHTS_TQPRI_NALB_0(ver)                            \
  (ver == DLB2_HW_V2 ? DLB2_V2NALB_CFG_ARB_WEIGHTS_TQPRI_NALB_0                \
...
#define DLB2_NALB_CFG_ARB_WEIGHTS_TQPRI_NALB_1(ver)                            \
  (ver == DLB2_HW_V2 ? DLB2_V2NALB_CFG_ARB_WEIGHTS_TQPRI_NALB_1                \
...
#define DLB2_NALB_CFG_ARB_WEIGHTS_TQPRI_REPLAY_0(ver)                          \
  (ver == DLB2_HW_V2 ? DLB2_V2NALB_CFG_ARB_WEIGHTS_TQPRI_REPLAY_0              \
...
#define DLB2_NALB_CFG_ARB_WEIGHTS_TQPRI_REPLAY_1(ver)                          \
  (ver == DLB2_HW_V2 ? DLB2_V2NALB_CFG_ARB_WEIGHTS_TQPRI_REPLAY_1              \
...
#define DLB2_V2RO_GRP_0_SLT_SHFT(x) (0x96000000 + (x)*0x4)
#define DLB2_V2_5RO_GRP_0_SLT_SHFT(x) (0x86000000 + (x)*0x4)
#define DLB2_RO_GRP_0_SLT_SHFT(ver, x)                                         \
  (ver == DLB2_HW_V2 ? DLB2_V2RO_GRP_0_SLT_SHFT(x)                             \
...
#define DLB2_V2RO_GRP_1_SLT_SHFT(x) (0x96010000 + (x)*0x4)
#define DLB2_V2_5RO_GRP_1_SLT_SHFT(x) (0x86010000 + (x)*0x4)
#define DLB2_RO_GRP_1_SLT_SHFT(ver, x)                                         \
  (ver == DLB2_HW_V2 ? DLB2_V2RO_GRP_1_SLT_SHFT(x)                             \
...
#define DLB2_RO_GRP_SN_MODE(ver)                                               \
  (ver == DLB2_HW_V2 ? DLB2_V2RO_GRP_SN_MODE : DLB2_V2_5RO_GRP_SN_MODE)
...
#define DLB2_RO_CFG_CTRL_GENERAL_0(ver)                                        \
  (ver == DLB2_HW_V2 ? DLB2_V2RO_CFG_CTRL_GENERAL_0                            \
...
#define DLB2_V2LSP_CQ2PRIOV(x) (0xa0000000 + (x)*0x1000)
#define DLB2_V2_5LSP_CQ2PRIOV(x) (0x90000000 + (x)*0x1000)
#define DLB2_LSP_CQ2PRIOV(ver, x)                                              \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CQ2PRIOV(x) : DLB2_V2_5LSP_CQ2PRIOV(x))
...
#define DLB2_V2LSP_CQ2QID0(x) (0xa0080000 + (x)*0x1000)
#define DLB2_V2_5LSP_CQ2QID0(x) (0x90080000 + (x)*0x1000)
#define DLB2_LSP_CQ2QID0(ver, x)                                               \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CQ2QID0(x) : DLB2_V2_5LSP_CQ2QID0(x))
...
#define DLB2_V2LSP_CQ2QID1(x) (0xa0100000 + (x)*0x1000)
#define DLB2_V2_5LSP_CQ2QID1(x) (0x90100000 + (x)*0x1000)
#define DLB2_LSP_CQ2QID1(ver, x)                                               \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CQ2QID1(x) : DLB2_V2_5LSP_CQ2QID1(x))
...
#define DLB2_V2LSP_CQ_DIR_DSBL(x) (0xa0180000 + (x)*0x1000)
#define DLB2_V2_5LSP_CQ_DIR_DSBL(x) (0x90180000 + (x)*0x1000)
#define DLB2_LSP_CQ_DIR_DSBL(ver, x)                                           \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CQ_DIR_DSBL(x) : DLB2_V2_5LSP_CQ_DIR_DSBL(x))
...
#define DLB2_V2LSP_CQ_DIR_TKN_CNT(x) (0xa0200000 + (x)*0x1000)
#define DLB2_V2_5LSP_CQ_DIR_TKN_CNT(x) (0x90200000 + (x)*0x1000)
#define DLB2_LSP_CQ_DIR_TKN_CNT(ver, x)                                        \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CQ_DIR_TKN_CNT(x)                            \
...
#define DLB2_V2LSP_CQ_DIR_TKN_DEPTH_SEL_DSI(x) (0xa0280000 + (x)*0x1000)
#define DLB2_V2_5LSP_CQ_DIR_TKN_DEPTH_SEL_DSI(x) (0x90280000 + (x)*0x1000)
#define DLB2_LSP_CQ_DIR_TKN_DEPTH_SEL_DSI(ver, x)                              \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CQ_DIR_TKN_DEPTH_SEL_DSI(x)                  \
...
#define DLB2_V2LSP_CQ_DIR_TOT_SCH_CNTL(x) (0xa0300000 + (x)*0x1000)
#define DLB2_V2_5LSP_CQ_DIR_TOT_SCH_CNTL(x) (0x90300000 + (x)*0x1000)
#define DLB2_LSP_CQ_DIR_TOT_SCH_CNTL(ver, x)                                   \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CQ_DIR_TOT_SCH_CNTL(x)                       \
...
#define DLB2_V2LSP_CQ_DIR_TOT_SCH_CNTH(x) (0xa0380000 + (x)*0x1000)
#define DLB2_V2_5LSP_CQ_DIR_TOT_SCH_CNTH(x) (0x90380000 + (x)*0x1000)
#define DLB2_LSP_CQ_DIR_TOT_SCH_CNTH(ver, x)                                   \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CQ_DIR_TOT_SCH_CNTH(x)                       \
...
#define DLB2_V2LSP_CQ_LDB_DSBL(x) (0xa0400000 + (x)*0x1000)
#define DLB2_V2_5LSP_CQ_LDB_DSBL(x) (0x90400000 + (x)*0x1000)
#define DLB2_LSP_CQ_LDB_DSBL(ver, x)                                           \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CQ_LDB_DSBL(x) : DLB2_V2_5LSP_CQ_LDB_DSBL(x))
...
#define DLB2_V2LSP_CQ_LDB_INFL_CNT(x) (0xa0480000 + (x)*0x1000)
#define DLB2_V2_5LSP_CQ_LDB_INFL_CNT(x) (0x90480000 + (x)*0x1000)
#define DLB2_LSP_CQ_LDB_INFL_CNT(ver, x)                                       \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CQ_LDB_INFL_CNT(x)                           \
...
#define DLB2_V2LSP_CQ_LDB_INFL_LIM(x) (0xa0500000 + (x)*0x1000)
#define DLB2_V2_5LSP_CQ_LDB_INFL_LIM(x) (0x90500000 + (x)*0x1000)
#define DLB2_LSP_CQ_LDB_INFL_LIM(ver, x)                                       \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CQ_LDB_INFL_LIM(x)                           \
...
#define DLB2_V2LSP_CQ_LDB_TKN_CNT(x) (0xa0580000 + (x)*0x1000)
#define DLB2_V2_5LSP_CQ_LDB_TKN_CNT(x) (0x90600000 + (x)*0x1000)
#define DLB2_LSP_CQ_LDB_TKN_CNT(ver, x)                                        \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CQ_LDB_TKN_CNT(x)                            \
...
#define DLB2_V2LSP_CQ_LDB_TKN_DEPTH_SEL(x) (0xa0600000 + (x)*0x1000)
#define DLB2_V2_5LSP_CQ_LDB_TKN_DEPTH_SEL(x) (0x90680000 + (x)*0x1000)
#define DLB2_LSP_CQ_LDB_TKN_DEPTH_SEL(ver, x)                                  \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CQ_LDB_TKN_DEPTH_SEL(x)                      \
...
#define DLB2_V2LSP_CQ_LDB_TOT_SCH_CNTL(x) (0xa0680000 + (x)*0x1000)
#define DLB2_V2_5LSP_CQ_LDB_TOT_SCH_CNTL(x) (0x90700000 + (x)*0x1000)
#define DLB2_LSP_CQ_LDB_TOT_SCH_CNTL(ver, x)                                   \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CQ_LDB_TOT_SCH_CNTL(x)                       \
...
#define DLB2_V2LSP_CQ_LDB_TOT_SCH_CNTH(x) (0xa0700000 + (x)*0x1000)
#define DLB2_V2_5LSP_CQ_LDB_TOT_SCH_CNTH(x) (0x90780000 + (x)*0x1000)
#define DLB2_LSP_CQ_LDB_TOT_SCH_CNTH(ver, x)                                   \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CQ_LDB_TOT_SCH_CNTH(x)                       \
...
#define DLB2_V2LSP_QID_DIR_MAX_DEPTH(x) (0xa0780000 + (x)*0x1000)
#define DLB2_V2_5LSP_QID_DIR_MAX_DEPTH(x) (0x90800000 + (x)*0x1000)
#define DLB2_LSP_QID_DIR_MAX_DEPTH(ver, x)                                     \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_QID_DIR_MAX_DEPTH(x)                         \
...
#define DLB2_V2LSP_QID_DIR_TOT_ENQ_CNTL(x) (0xa0800000 + (x)*0x1000)
#define DLB2_V2_5LSP_QID_DIR_TOT_ENQ_CNTL(x) (0x90880000 + (x)*0x1000)
#define DLB2_LSP_QID_DIR_TOT_ENQ_CNTL(ver, x)                                  \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_QID_DIR_TOT_ENQ_CNTL(x)                      \
...
#define DLB2_V2LSP_QID_DIR_TOT_ENQ_CNTH(x) (0xa0880000 + (x)*0x1000)
#define DLB2_V2_5LSP_QID_DIR_TOT_ENQ_CNTH(x) (0x90900000 + (x)*0x1000)
#define DLB2_LSP_QID_DIR_TOT_ENQ_CNTH(ver, x)                                  \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_QID_DIR_TOT_ENQ_CNTH(x)                      \
...
#define DLB2_V2LSP_QID_DIR_ENQUEUE_CNT(x) (0xa0900000 + (x)*0x1000)
#define DLB2_V2_5LSP_QID_DIR_ENQUEUE_CNT(x) (0x90980000 + (x)*0x1000)
#define DLB2_LSP_QID_DIR_ENQUEUE_CNT(ver, x)                                   \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_QID_DIR_ENQUEUE_CNT(x)                       \
...
#define DLB2_V2LSP_QID_DIR_DEPTH_THRSH(x) (0xa0980000 + (x)*0x1000)
#define DLB2_V2_5LSP_QID_DIR_DEPTH_THRSH(x) (0x90a00000 + (x)*0x1000)
#define DLB2_LSP_QID_DIR_DEPTH_THRSH(ver, x)                                   \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_QID_DIR_DEPTH_THRSH(x)                       \
...
#define DLB2_V2LSP_QID_AQED_ACTIVE_CNT(x) (0xa0a00000 + (x)*0x1000)
#define DLB2_V2_5LSP_QID_AQED_ACTIVE_CNT(x) (0x90b80000 + (x)*0x1000)
#define DLB2_LSP_QID_AQED_ACTIVE_CNT(ver, x)                                   \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_QID_AQED_ACTIVE_CNT(x)                       \
...
#define DLB2_V2LSP_QID_AQED_ACTIVE_LIM(x) (0xa0a80000 + (x)*0x1000)
#define DLB2_V2_5LSP_QID_AQED_ACTIVE_LIM(x) (0x90c00000 + (x)*0x1000)
#define DLB2_LSP_QID_AQED_ACTIVE_LIM(ver, x)                                   \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_QID_AQED_ACTIVE_LIM(x)                       \
...
#define DLB2_V2LSP_QID_ATM_TOT_ENQ_CNTL(x) (0xa0b00000 + (x)*0x1000)
#define DLB2_V2_5LSP_QID_ATM_TOT_ENQ_CNTL(x) (0x90c80000 + (x)*0x1000)
#define DLB2_LSP_QID_ATM_TOT_ENQ_CNTL(ver, x)                                  \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_QID_ATM_TOT_ENQ_CNTL(x)                      \
...
#define DLB2_V2LSP_QID_ATM_TOT_ENQ_CNTH(x) (0xa0b80000 + (x)*0x1000)
#define DLB2_V2_5LSP_QID_ATM_TOT_ENQ_CNTH(x) (0x90d00000 + (x)*0x1000)
#define DLB2_LSP_QID_ATM_TOT_ENQ_CNTH(ver, x)                                  \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_QID_ATM_TOT_ENQ_CNTH(x)                      \
...
#define DLB2_V2LSP_QID_LDB_ENQUEUE_CNT(x) (0xa0c80000 + (x)*0x1000)
#define DLB2_V2_5LSP_QID_LDB_ENQUEUE_CNT(x) (0x90e00000 + (x)*0x1000)
#define DLB2_LSP_QID_LDB_ENQUEUE_CNT(ver, x)                                   \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_QID_LDB_ENQUEUE_CNT(x)                       \
...
#define DLB2_V2LSP_QID_LDB_INFL_CNT(x) (0xa0d00000 + (x)*0x1000)
#define DLB2_V2_5LSP_QID_LDB_INFL_CNT(x) (0x90e80000 + (x)*0x1000)
#define DLB2_LSP_QID_LDB_INFL_CNT(ver, x)                                      \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_QID_LDB_INFL_CNT(x)                          \
...
#define DLB2_V2LSP_QID_LDB_INFL_LIM(x) (0xa0d80000 + (x)*0x1000)
#define DLB2_V2_5LSP_QID_LDB_INFL_LIM(x) (0x90f00000 + (x)*0x1000)
#define DLB2_LSP_QID_LDB_INFL_LIM(ver, x)                                      \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_QID_LDB_INFL_LIM(x)                          \
...
#define DLB2_V2LSP_QID2CQIDIX_00(x) (0xa0e00000 + (x)*0x1000)
#define DLB2_V2_5LSP_QID2CQIDIX_00(x) (0x90f80000 + (x)*0x1000)
#define DLB2_LSP_QID2CQIDIX_00(ver, x)                                         \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_QID2CQIDIX_00(x)                             \
...
#define DLB2_V2LSP_QID2CQIDIX2_00(x) (0xa1600000 + (x)*0x1000)
#define DLB2_V2_5LSP_QID2CQIDIX2_00(x) (0x91780000 + (x)*0x1000)
#define DLB2_LSP_QID2CQIDIX2_00(ver, x)                                        \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_QID2CQIDIX2_00(x)                            \
...
#define DLB2_V2LSP_QID_NALDB_MAX_DEPTH(x) (0xa1f00000 + (x)*0x1000)
#define DLB2_V2_5LSP_QID_NALDB_MAX_DEPTH(x) (0x92080000 + (x)*0x1000)
#define DLB2_LSP_QID_NALDB_MAX_DEPTH(ver, x)                                   \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_QID_NALDB_MAX_DEPTH(x)                       \
...
#define DLB2_V2LSP_QID_NALDB_TOT_ENQ_CNTL(x) (0xa1f80000 + (x)*0x1000)
#define DLB2_V2_5LSP_QID_NALDB_TOT_ENQ_CNTL(x) (0x92100000 + (x)*0x1000)
#define DLB2_LSP_QID_NALDB_TOT_ENQ_CNTL(ver, x)                                \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_QID_NALDB_TOT_ENQ_CNTL(x)                    \
...
#define DLB2_V2LSP_QID_NALDB_TOT_ENQ_CNTH(x) (0xa2000000 + (x)*0x1000)
#define DLB2_V2_5LSP_QID_NALDB_TOT_ENQ_CNTH(x) (0x92180000 + (x)*0x1000)
#define DLB2_LSP_QID_NALDB_TOT_ENQ_CNTH(ver, x)                                \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_QID_NALDB_TOT_ENQ_CNTH(x)                    \
...
#define DLB2_V2LSP_QID_ATM_DEPTH_THRSH(x) (0xa2080000 + (x)*0x1000)
#define DLB2_V2_5LSP_QID_ATM_DEPTH_THRSH(x) (0x92200000 + (x)*0x1000)
#define DLB2_LSP_QID_ATM_DEPTH_THRSH(ver, x)                                   \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_QID_ATM_DEPTH_THRSH(x)                       \
...
#define DLB2_V2LSP_QID_NALDB_DEPTH_THRSH(x) (0xa2100000 + (x)*0x1000)
#define DLB2_V2_5LSP_QID_NALDB_DEPTH_THRSH(x) (0x92280000 + (x)*0x1000)
#define DLB2_LSP_QID_NALDB_DEPTH_THRSH(ver, x)                                 \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_QID_NALDB_DEPTH_THRSH(x)                     \
...
#define DLB2_V2LSP_QID_ATM_ACTIVE(x) (0xa2180000 + (x)*0x1000)
#define DLB2_V2_5LSP_QID_ATM_ACTIVE(x) (0x92300000 + (x)*0x1000)
#define DLB2_LSP_QID_ATM_ACTIVE(ver, x)                                        \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_QID_ATM_ACTIVE(x)                            \
...
#define DLB2_LSP_CFG_ARB_WEIGHT_ATM_NALB_QID_0(ver)                            \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CFG_ARB_WEIGHT_ATM_NALB_QID_0                \
...
#define DLB2_LSP_CFG_ARB_WEIGHT_ATM_NALB_QID_1(ver)                            \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CFG_ARB_WEIGHT_ATM_NALB_QID_1                \
...
#define DLB2_LSP_CFG_ARB_WEIGHT_LDB_QID_0(ver)                                 \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CFG_ARB_WEIGHT_LDB_QID_0                     \
...
#define DLB2_LSP_CFG_ARB_WEIGHT_LDB_QID_1(ver)                                 \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CFG_ARB_WEIGHT_LDB_QID_1                     \
...
#define DLB2_LSP_LDB_SCHED_CTRL(ver)                                           \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_LDB_SCHED_CTRL : DLB2_V2_5LSP_LDB_SCHED_CTRL)
...
#define DLB2_LSP_DIR_SCH_CNT_L(ver)                                            \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_DIR_SCH_CNT_L : DLB2_V2_5LSP_DIR_SCH_CNT_L)
...
#define DLB2_LSP_DIR_SCH_CNT_H(ver)                                            \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_DIR_SCH_CNT_H : DLB2_V2_5LSP_DIR_SCH_CNT_H)
...
#define DLB2_LSP_LDB_SCH_CNT_L(ver)                                            \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_LDB_SCH_CNT_L : DLB2_V2_5LSP_LDB_SCH_CNT_L)
...
#define DLB2_LSP_LDB_SCH_CNT_H(ver)                                            \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_LDB_SCH_CNT_H : DLB2_V2_5LSP_LDB_SCH_CNT_H)
...
#define DLB2_LSP_CFG_SHDW_CTRL(ver)                                            \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CFG_SHDW_CTRL : DLB2_V2_5LSP_CFG_SHDW_CTRL)
...
#define DLB2_V2LSP_CFG_SHDW_RANGE_COS(x) (0xa4000074 + (x)*4)
#define DLB2_V2_5LSP_CFG_SHDW_RANGE_COS(x) (0x94000074 + (x)*4)
#define DLB2_LSP_CFG_SHDW_RANGE_COS(ver, x)                                    \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CFG_SHDW_RANGE_COS(x)                        \
...
#define DLB2_LSP_CFG_CTRL_GENERAL_0(ver)                                       \
  (ver == DLB2_HW_V2 ? DLB2_V2LSP_CFG_CTRL_GENERAL_0                           \
...
#define DLB2_CM_DIAG_RESET_STS(ver)                                            \
  (ver == DLB2_HW_V2 ? V2CM_DIAG_RESET_STS : V2_5CM_DIAG_RESET_STS)
...
#define DLB2_CM_CFG_DIAGNOSTIC_IDLE_STATUS(ver)                                \
  (ver == DLB2_HW_V2 ? DLB2_V2CM_CFG_DIAGNOSTIC_IDLE_STATUS                    \
...
#define DLB2_CM_CFG_PM_STATUS(ver)                                             \
  (ver == DLB2_HW_V2 ? DLB2_V2CM_CFG_PM_STATUS : DLB2_V2_5CM_CFG_PM_STATUS)
...
#define DLB2_CM_CFG_PM_PMCSR_DISABLE(ver)                                      \
  (ver == DLB2_HW_V2 ? DLB2_V2CM_CFG_PM_PMCSR_DISABLE                          \
...
#define DLB2_VF_VF2PF_MAILBOX(x) (0x1000 + (x)*0x4)
...
#define DLB2_VF_PF2VF_MAILBOX(x) (0x2000 + (x)*0x4)
...
#define DLB2_SYS_LDB_CQ_AI_ADDR_U(x) (0x10000fa4 + (x)*0x1000)
...
#define DLB2_SYS_LDB_CQ_AI_ADDR_L(x) (0x10000fa0 + (x)*0x1000)
...
#define DLB2_SYS_DIR_CQ_AI_ADDR_U(x) (0x10000fe4 + (x)*0x1000)
...
#define DLB2_SYS_DIR_CQ_AI_ADDR_L(x) (0x10000fe0 + (x)*0x1000)
...
#define DLB2_SYS_WB_DIR_CQ_STATE(x) (0x11c00000 + (x)*0x1000)
...
#define DLB2_SYS_WB_LDB_CQ_STATE(x) (0x11d00000 + (x)*0x1000)
...
#define DLB2_CHP_CFG_VAS_CRD(x) (0x40000000 + (x)*0x1000)
...
#define DLB2_LSP_CFG_CQ_LDB_WU_LIMIT(x) (0x90b00000 + (x)*0x1000)
