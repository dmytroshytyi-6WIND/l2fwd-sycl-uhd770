...
int dlb2_hw_create_ldb_queue(struct dlb2_hw *hw, u32 domain_id,
                             ...
                             struct dlb2_cmd_response *resp, bool vdev_request,
 ...
 * EFAULT - Internal error (resp->status not set).
 */
int dlb2_hw_enable_ldb_port(struct dlb2_hw *hw, u32 domain_id,
 ...
 * EFAULT - Internal error (resp->status not set).
 */
int dlb2_hw_disable_ldb_port(struct dlb2_hw *hw, u32 domain_id,
 ...
 * EFAULT - Internal error (resp->status not set).
 */
int dlb2_hw_enable_dir_port(struct dlb2_hw *hw, u32 domain_id,
 ...
 * EFAULT - Internal error (resp->status not set).
 */
int dlb2_hw_disable_dir_port(struct dlb2_hw *hw, u32 domain_id,
 ...
 */
int dlb2_configure_ldb_cq_interrupt(struct dlb2_hw *hw, int port_id, int vector,
                                    int mode, unsigned int vf,
                                    unsigned int owner_vf, u16 threshold);
 ...
 * EINVAL - The port ID is invalid.
 */
int dlb2_configure_dir_cq_interrupt(struct dlb2_hw *hw, int port_id, int vector,
                                    int mode, unsigned int vf,
                                    unsigned int owner_vf, u16 threshold);
 ...
 */
int dlb2_arm_cq_interrupt(struct dlb2_hw *hw, int port_id, bool is_ldb,
                          bool vdev_request, unsigned int vdev_id);
 ...
 */
void dlb2_ack_compressed_cq_intr(struct dlb2_hw *hw, u32 *ldb_interrupts,
                                 u32 *dir_interrupts);
 ...
 * device.
 */
void dlb2_ack_vdev_to_pf_int(struct dlb2_hw *hw, u32 mbox_bitvec,
                             u32 flr_bitvec);
 ...
 */
int dlb2_reset_domain(struct dlb2_hw *hw, u32 domain_id, bool vdev_request,
                      unsigned int vdev_id);
 ...
 */
int dlb2_ldb_port_owned_by_domain(struct dlb2_hw *hw, u32 domain_id,
                                  u32 port_id, bool vdev_request,
                                  unsigned int vdev_id);
 ...
 * EINVAL - Invalid domain or port ID, or the domain is not configured.
 */
int dlb2_dir_port_owned_by_domain(struct dlb2_hw *hw, u32 domain_id,
                                  u32 port_id, bool vdev_request,
                                  unsigned int vdev_id);
 ...
 */
int dlb2_pf_read_vf_mbox_req(struct dlb2_hw *hw, unsigned int vf_id, void *data,
                             int len);
 ...
 */
int dlb2_pf_read_vf_mbox_resp(struct dlb2_hw *hw, unsigned int vf_id,
                              void *data, int len);
 ...
 */
int dlb2_pf_write_vf_mbox_resp(struct dlb2_hw *hw, unsigned int vf_id,
                               void *data, int len);
 ...
 */
int dlb2_pf_write_vf_mbox_req(struct dlb2_hw *hw, unsigned int vf_id,
                              void *data, int len);
 ...
 * EPERM  - The vdev's resource assignment is locked and cannot be changed.
 */
int dlb2_update_vdev_ldb_cos_ports(struct dlb2_hw *hw, u32 id, u32 cos,
                                   u32 num);
 ...
 */
int dlb2_notify_vf(struct dlb2_hw *hw, unsigned int vf_id, u32 notification);
 ...
 * Returns >= 0 upon success, -1 otherwise.
 */
s32 dlb2_hw_get_ldb_port_phys_id(struct dlb2_hw *hw, u32 id,
                                 unsigned int vdev_id);
 ...
 * Returns >= 0 upon success, -1 otherwise.
 */
s32 dlb2_hw_get_dir_port_phys_id(struct dlb2_hw *hw, u32 id,
                                 unsigned int vdev_id);
 ...
 */
void dlb2_hw_register_sw_mbox(struct dlb2_hw *hw, unsigned int vdev_id,
                              u32 *vdev2pf_mbox, u32 *pf2vdev_mbox,
                              void (*pf2vdev_inject)(void *), void *inject_arg);
 ...
 * not needed.
 */
void dlb2_hw_setup_cq_ims_entry(struct dlb2_hw *hw, unsigned int vdev_id,
                                u32 virt_cq_id, bool is_ldb, u32 addr_lo,
                                u32 data);
 ...
 */
void dlb2_hw_clear_cq_ims_entry(struct dlb2_hw *hw, unsigned int vdev_id,
                                u32 virt_cq_id, bool is_ldb);
 ...
 * Returns >= 0 upon success, -1 otherwise.
 */
int dlb2_hw_register_pasid(struct dlb2_hw *hw, unsigned int vdev_id,
                           unsigned int pasid);
...
int dlb2_hw_pending_port_unmaps(struct dlb2_hw *hw, u32 domain_id,
                                ...
                                struct dlb2_cmd_response *resp, bool vf_request,
                                unsigned int vf_id);
 ...
 */
int dlb2_hw_enable_dir_cq_wd_int(struct dlb2_hw *hw, u32 id, bool vdev_req,
                                 unsigned int vdev_id);
 ...
 */
int dlb2_hw_enable_ldb_cq_wd_int(struct dlb2_hw *hw, u32 id, bool vdev_req,
                                 unsigned int vdev_id);
 ...
 */
void dlb2_hw_ldb_cq_interrupt_set_mode(struct dlb2_hw *hw, int port_id,
                                       int mode);
 ...
 */
void dlb2_hw_dir_cq_interrupt_set_mode(struct dlb2_hw *hw, int port_id,
                                       int mode);
