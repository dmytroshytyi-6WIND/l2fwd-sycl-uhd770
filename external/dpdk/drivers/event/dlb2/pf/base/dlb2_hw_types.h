...
#define DLB2_BITS_SET(x, val, mask)                                            \
  (x = ((x) & ~(mask)) | (((val) << (mask##_LOC)) & (mask)))
...
#define DLB2_DRV_LDB_PP_BOUND                                                  \
  (DLB2_DRV_LDB_PP_BASE + DLB2_DRV_LDB_PP_STRIDE * DLB2_MAX_NUM_LDB_PORTS)
#define DLB2_DRV_DIR_PP_BASE 0x2200000
#define DLB2_DRV_DIR_PP_STRIDE 0x1000
#define DLB2_DRV_DIR_PP_BOUND                                                  \
  (DLB2_DRV_DIR_PP_BASE + DLB2_DRV_DIR_PP_STRIDE * DLB2_MAX_NUM_DIR_PORTS)
#define DLB2_LDB_PP_BASE 0x2100000
#define DLB2_LDB_PP_STRIDE 0x1000
#define DLB2_LDB_PP_BOUND                                                      \
  (DLB2_LDB_PP_BASE + DLB2_LDB_PP_STRIDE * DLB2_MAX_NUM_LDB_PORTS)
...
#define DLB2_DIR_PP_BOUND                                                      \
  (DLB2_DIR_PP_BASE + DLB2_DIR_PP_STRIDE * DLB2_MAX_NUM_DIR_PORTS_V2_5)
...
static inline bool dlb2_sn_group_full(struct dlb2_sn_group *group) {
  const u32 mask[] = {0x0000ffff,  /* 64 SNs per queue */
...
static inline void dlb2_sn_group_free_slot(struct dlb2_sn_group *group,
                                           int slot) {
