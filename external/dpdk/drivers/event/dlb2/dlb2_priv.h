...
#define DLB2_MAX_NUM_DIR_PORTS(ver)                                            \
  (ver == DLB2_HW_V2 ? DLB2_MAX_NUM_DIR_PORTS_V2 : DLB2_MAX_NUM_DIR_PORTS_V2_5)
...
#define DLB2_MAX_NUM_DIR_QUEUES(ver)                                           \
  (ver == DLB2_HW_V2 ? DLB2_MAX_NUM_DIR_QUEUES_V2                              \
...
#define DLB2_MAX_NUM_CREDITS(ver)                                              \
  (ver == DLB2_HW_V2 ? 0 : DLB2_MAX_NUM_LDB_CREDITS)
...
#define DLB2_NUM_HIST_LIST_ENTRIES_PER_LDB_PORT DLB2_MAX_CQ_DEPTH
...
#define CQ_SIZE(is_dir) ((is_dir) ? DLB2_DIR_CQ_MAX_SIZE : DLB2_LDB_CQ_MAX_SIZE)
...
enum dlb2_port_state { PORT_CLOSED, PORT_STARTED, PORT_STOPPED };
...
int dlb2_eventdev_xstats_get_names(
    ...
    uint8_t queue_port_id, struct rte_event_dev_xstats_name *xstat_names,
