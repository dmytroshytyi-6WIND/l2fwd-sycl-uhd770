...
#define SW_LOG_INFO(fmt, args...) SW_LOG_IMPL(INFO, fmt, ##args)

#define SW_LOG_DBG(fmt, args...) SW_LOG_IMPL(DEBUG, fmt, ##args)

#define SW_LOG_ERR(fmt, args...) SW_LOG_IMPL(ERR, fmt, ##args)
