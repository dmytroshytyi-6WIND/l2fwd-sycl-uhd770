...
rte_tm_get_number_of_leaf_nodes(uint16_t port_id, uint32_t *n_leaf_nodes,
 ...
 *   0 on success, non-zero error code otherwise.
 */
__rte_experimental int rte_tm_node_type_get(uint16_t port_id, uint32_t node_id,
                                            int *is_leaf,
                                            struct rte_tm_error *error);
 ...
 */
__rte_experimental int
rte_tm_level_capabilities_get(uint16_t port_id, uint32_t level_id,
 ...
 */
__rte_experimental int
rte_tm_node_capabilities_get(uint16_t port_id, uint32_t node_id,
 ...
 */
__rte_experimental int
rte_tm_wred_profile_add(uint16_t port_id, uint32_t wred_profile_id,
 ...
 */
__rte_experimental int rte_tm_shared_wred_context_add_update(
    uint16_t port_id, uint32_t shared_wred_context_id, uint32_t wred_profile_id,
    struct rte_tm_error *error);
 ...
 */
__rte_experimental int
rte_tm_shaper_profile_add(uint16_t port_id, uint32_t shaper_profile_id,
 ...
 */
__rte_experimental int
rte_tm_shared_shaper_add_update(uint16_t port_id, uint32_t shared_shaper_id,
                                uint32_t shaper_profile_id,
                                struct rte_tm_error *error);
 ...
 */
__rte_experimental int
rte_tm_node_add(uint16_t port_id, uint32_t node_id, uint32_t parent_node_id,
 ...
 * @see RTE_TM_UPDATE_NODE_ADD_DELETE
 */
__rte_experimental int rte_tm_node_delete(uint16_t port_id, uint32_t node_id,
                                          struct rte_tm_error *error);
 ...
 */
__rte_experimental int rte_tm_node_suspend(uint16_t port_id, uint32_t node_id,
                                           struct rte_tm_error *error);
 ...
 * @see RTE_TM_UPDATE_NODE_SUSPEND_RESUME
 */
__rte_experimental int rte_tm_node_resume(uint16_t port_id, uint32_t node_id,
                                          struct rte_tm_error *error);
 ...
 */
__rte_experimental int
rte_tm_node_parent_update(uint16_t port_id, uint32_t node_id,
 ...
 */
__rte_experimental int
rte_tm_node_shared_shaper_update(uint16_t port_id, uint32_t node_id,
 ...
 */
__rte_experimental int rte_tm_node_wfq_weight_mode_update(
    uint16_t port_id, uint32_t node_id, int *wfq_weight_mode,
 ...
 */
__rte_experimental int
rte_tm_node_wred_context_update(uint16_t port_id, uint32_t node_id,
                                uint32_t wred_profile_id,
                                struct rte_tm_error *error);
 ...
 */
__rte_experimental int
rte_tm_node_shared_wred_context_update(uint16_t port_id, uint32_t node_id,
 ...
 */
__rte_experimental int rte_tm_mark_vlan_dei(uint16_t port_id, int mark_green,
 ...
 */
__rte_experimental int rte_tm_mark_ip_ecn(uint16_t port_id, int mark_green,
                                          int mark_yellow, int mark_red,
                                          struct rte_tm_error *error);
 ...
 */
__rte_experimental int rte_tm_mark_ip_dscp(uint16_t port_id, int mark_green,
                                           int mark_yellow, int mark_red,
                                           struct rte_tm_error *error);
