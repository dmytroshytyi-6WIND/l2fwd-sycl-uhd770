...
typedef int (*rte_tm_node_type_get_t)(struct rte_eth_dev *dev, uint32_t node_id,
...
typedef int (*rte_tm_level_capabilities_get_t)(
    struct rte_eth_dev *dev, uint32_t level_id,
...
typedef int (*rte_tm_node_capabilities_get_t)(
    struct rte_eth_dev *dev, uint32_t node_id,
...
typedef int (*rte_tm_shared_wred_context_add_update_t)(
    struct rte_eth_dev *dev, uint32_t shared_wred_context_id,
...
typedef int (*rte_tm_node_add_t)(struct rte_eth_dev *dev, uint32_t node_id,
...
typedef int (*rte_tm_node_delete_t)(struct rte_eth_dev *dev, uint32_t node_id,
                                    struct rte_tm_error *error);

/** @internal Traffic manager node suspend */
typedef int (*rte_tm_node_suspend_t)(struct rte_eth_dev *dev, uint32_t node_id,
                                     struct rte_tm_error *error);

/** @internal Traffic manager node resume */
typedef int (*rte_tm_node_resume_t)(struct rte_eth_dev *dev, uint32_t node_id,
                                    struct rte_tm_error *error);
...
typedef int (*rte_tm_node_stats_update_t)(struct rte_eth_dev *dev,
                                          uint32_t node_id, uint64_t stats_mask,
                                          struct rte_tm_error *error);
...
typedef int (*rte_tm_node_shared_wred_context_update_t)(
    struct rte_eth_dev *dev, uint32_t node_id, uint32_t shared_wred_context_id,
...
typedef int (*rte_tm_mark_vlan_dei_t)(struct rte_eth_dev *dev, int mark_green,
                                      int mark_yellow, int mark_red,
                                      struct rte_tm_error *error);

/** @internal Traffic manager packet marking - IPv4/IPv6 ECN */
typedef int (*rte_tm_mark_ip_ecn_t)(struct rte_eth_dev *dev, int mark_green,
                                    int mark_yellow, int mark_red,
                                    struct rte_tm_error *error);

/** @internal Traffic manager packet marking - IPv4/IPv6 DSCP */
typedef int (*rte_tm_mark_ip_dscp_t)(struct rte_eth_dev *dev, int mark_green,
                                     int mark_yellow, int mark_red,
                                     struct rte_tm_error *error);
 ...
 *   Error code.
 */
static inline int rte_tm_error_set(struct rte_tm_error *error, int code,
