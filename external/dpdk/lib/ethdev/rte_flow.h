...
static const struct rte_flow_item_icmp6_nd_ns rte_flow_item_icmp6_nd_ns_mask = {
    .target_addr = "\xff\xff\xff\xff\xff\xff\xff\xff"
                   "\xff\xff\xff\xff\xff\xff\xff\xff",
};
#endif
...
#define PKT_RX_DYNF_METADATA                                                   \
  RTE_DEPRECATED(PKT_RX_DYNF_METADATA)                                         \
  RTE_MBUF_DYNFLAG_RX_METADATA
#define RTE_MBUF_DYNFLAG_TX_METADATA (rte_flow_dynf_metadata_mask)
#define PKT_TX_DYNF_METADATA                                                   \
  RTE_DEPRECATED(PKT_TX_DYNF_METADATA)                                         \
  RTE_MBUF_DYNFLAG_TX_METADATA

__rte_experimental static inline uint32_t
 ...
 */
__rte_experimental static inline int rte_flow_dynf_metadata_avail(void) {
 ...
 */
__rte_deprecated size_t rte_flow_copy(struct rte_flow_desc *fd, size_t len,
                                      const struct rte_flow_attr *attr,
 ...
 */
__rte_experimental int rte_flow_conv(enum rte_flow_conv_op op, void *dst,
 ...
 */
__rte_experimental struct rte_flow_action_handle *rte_flow_action_handle_create(
 ...
 */
__rte_experimental int
rte_flow_tunnel_decap_set(uint16_t port_id, struct rte_flow_tunnel *tunnel,
 ...
 */
__rte_experimental int
rte_flow_get_restore_info(uint16_t port_id, struct rte_mbuf *m,
 ...
 *   0 on success, a negative errno value otherwise and rte_errno is set.
 */
__rte_experimental int rte_flow_tunnel_action_decap_release(
    uint16_t port_id, struct rte_flow_action *actions, uint32_t num_of_actions,
    struct rte_flow_error *error);
 ...
 */
__rte_experimental int
rte_flow_tunnel_item_release(uint16_t port_id, struct rte_flow_item *items,
                             uint32_t num_of_items,
                             struct rte_flow_error *error);
 ...
 *   0 on success, a negative errno value otherwise and rte_errno is set.
 */
__rte_experimental int rte_flow_pattern_template_destroy(
 ...
 *   0 on success, a negative errno value otherwise and rte_errno is set.
 */
__rte_experimental int rte_flow_actions_template_destroy(
 ...
 */
__rte_experimental struct rte_flow *rte_flow_async_create(
 ...
 *   0 on success, a negative errno value otherwise and rte_errno is set.
 */
__rte_experimental int rte_flow_async_destroy(
    uint16_t port_id, uint32_t queue_id, const struct rte_flow_op_attr *op_attr,
    struct rte_flow *flow, void *user_data, struct rte_flow_error *error);
 ...
 *   0 on success, a negative errno value otherwise and rte_errno is set.
 */
__rte_experimental int rte_flow_push(uint16_t port_id, uint32_t queue_id,
                                     struct rte_flow_error *error);
 ...
 */
__rte_experimental int rte_flow_pull(uint16_t port_id, uint32_t queue_id,
 ...
 *   0 on success, a negative errno value otherwise and rte_errno is set.
 */
__rte_experimental int rte_flow_async_action_handle_destroy(
    uint16_t port_id, uint32_t queue_id, const struct rte_flow_op_attr *op_attr,
 ...
 *   0 on success, a negative errno value otherwise and rte_errno is set.
 */
__rte_experimental int rte_flow_async_action_handle_update(
    uint16_t port_id, uint32_t queue_id, const struct rte_flow_op_attr *op_attr,
