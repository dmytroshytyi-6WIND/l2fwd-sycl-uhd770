...
#define ETH_LINK_SPEED_AUTONEG                                                 \
  RTE_DEPRECATED(ETH_LINK_SPEED_AUTONEG) RTE_ETH_LINK_SPEED_AUTONEG
#define ETH_LINK_SPEED_FIXED                                                   \
  RTE_DEPRECATED(ETH_LINK_SPEED_FIXED) RTE_ETH_LINK_SPEED_FIXED
#define ETH_LINK_SPEED_10M_HD                                                  \
  RTE_DEPRECATED(ETH_LINK_SPEED_10M_HD) RTE_ETH_LINK_SPEED_10M_HD
#define ETH_LINK_SPEED_10M                                                     \
  RTE_DEPRECATED(ETH_LINK_SPEED_10M) RTE_ETH_LINK_SPEED_10M
#define ETH_LINK_SPEED_100M_HD                                                 \
  RTE_DEPRECATED(ETH_LINK_SPEED_100M_HD) RTE_ETH_LINK_SPEED_100M_HD
#define ETH_LINK_SPEED_100M                                                    \
  RTE_DEPRECATED(ETH_LINK_SPEED_100M) RTE_ETH_LINK_SPEED_100M
#define ETH_LINK_SPEED_1G                                                      \
  RTE_DEPRECATED(ETH_LINK_SPEED_1G) RTE_ETH_LINK_SPEED_1G
#define ETH_LINK_SPEED_2_5G                                                    \
  RTE_DEPRECATED(ETH_LINK_SPEED_2_5G) RTE_ETH_LINK_SPEED_2_5G
#define ETH_LINK_SPEED_5G                                                      \
  RTE_DEPRECATED(ETH_LINK_SPEED_5G) RTE_ETH_LINK_SPEED_5G
#define ETH_LINK_SPEED_10G                                                     \
  RTE_DEPRECATED(ETH_LINK_SPEED_10G) RTE_ETH_LINK_SPEED_10G
#define ETH_LINK_SPEED_20G                                                     \
  RTE_DEPRECATED(ETH_LINK_SPEED_20G) RTE_ETH_LINK_SPEED_20G
#define ETH_LINK_SPEED_25G                                                     \
  RTE_DEPRECATED(ETH_LINK_SPEED_25G) RTE_ETH_LINK_SPEED_25G
#define ETH_LINK_SPEED_40G                                                     \
  RTE_DEPRECATED(ETH_LINK_SPEED_40G) RTE_ETH_LINK_SPEED_40G
#define ETH_LINK_SPEED_50G                                                     \
  RTE_DEPRECATED(ETH_LINK_SPEED_50G) RTE_ETH_LINK_SPEED_50G
#define ETH_LINK_SPEED_56G                                                     \
  RTE_DEPRECATED(ETH_LINK_SPEED_56G) RTE_ETH_LINK_SPEED_56G
#define ETH_LINK_SPEED_100G                                                    \
  RTE_DEPRECATED(ETH_LINK_SPEED_100G) RTE_ETH_LINK_SPEED_100G
#define ETH_LINK_SPEED_200G                                                    \
  RTE_DEPRECATED(ETH_LINK_SPEED_200G) RTE_ETH_LINK_SPEED_200G
...
#define ETH_SPEED_NUM_NONE                                                     \
  RTE_DEPRECATED(ETH_SPEED_NUM_NONE) RTE_ETH_SPEED_NUM_NONE
#define ETH_SPEED_NUM_10M                                                      \
  RTE_DEPRECATED(ETH_SPEED_NUM_10M) RTE_ETH_SPEED_NUM_10M
#define ETH_SPEED_NUM_100M                                                     \
  RTE_DEPRECATED(ETH_SPEED_NUM_100M) RTE_ETH_SPEED_NUM_100M
#define ETH_SPEED_NUM_1G RTE_DEPRECATED(ETH_SPEED_NUM_1G) RTE_ETH_SPEED_NUM_1G
#define ETH_SPEED_NUM_2_5G                                                     \
  RTE_DEPRECATED(ETH_SPEED_NUM_2_5G) RTE_ETH_SPEED_NUM_2_5G
#define ETH_SPEED_NUM_5G RTE_DEPRECATED(ETH_SPEED_NUM_5G) RTE_ETH_SPEED_NUM_5G
#define ETH_SPEED_NUM_10G                                                      \
  RTE_DEPRECATED(ETH_SPEED_NUM_10G) RTE_ETH_SPEED_NUM_10G
#define ETH_SPEED_NUM_20G                                                      \
  RTE_DEPRECATED(ETH_SPEED_NUM_20G) RTE_ETH_SPEED_NUM_20G
#define ETH_SPEED_NUM_25G                                                      \
  RTE_DEPRECATED(ETH_SPEED_NUM_25G) RTE_ETH_SPEED_NUM_25G
#define ETH_SPEED_NUM_40G                                                      \
  RTE_DEPRECATED(ETH_SPEED_NUM_40G) RTE_ETH_SPEED_NUM_40G
#define ETH_SPEED_NUM_50G                                                      \
  RTE_DEPRECATED(ETH_SPEED_NUM_50G) RTE_ETH_SPEED_NUM_50G
#define ETH_SPEED_NUM_56G                                                      \
  RTE_DEPRECATED(ETH_SPEED_NUM_56G) RTE_ETH_SPEED_NUM_56G
#define ETH_SPEED_NUM_100G                                                     \
  RTE_DEPRECATED(ETH_SPEED_NUM_100G) RTE_ETH_SPEED_NUM_100G
#define ETH_SPEED_NUM_200G                                                     \
  RTE_DEPRECATED(ETH_SPEED_NUM_200G) RTE_ETH_SPEED_NUM_200G
#define ETH_SPEED_NUM_UNKNOWN                                                  \
  RTE_DEPRECATED(ETH_SPEED_NUM_UNKNOWN) RTE_ETH_SPEED_NUM_UNKNOWN

/**
 * A structure used to retrieve link-level information of an Ethernet port.
 */
__extension__ struct rte_eth_link {
...
#define ETH_LINK_HALF_DUPLEX                                                   \
  RTE_DEPRECATED(ETH_LINK_HALF_DUPLEX) RTE_ETH_LINK_HALF_DUPLEX
#define ETH_LINK_FULL_DUPLEX                                                   \
  RTE_DEPRECATED(ETH_LINK_FULL_DUPLEX) RTE_ETH_LINK_FULL_DUPLEX
...
#define ETH_MQ_RX_RSS_FLAG                                                     \
  RTE_DEPRECATED(ETH_MQ_RX_RSS_FLAG) RTE_ETH_MQ_RX_RSS_FLAG
#define ETH_MQ_RX_DCB_FLAG                                                     \
  RTE_DEPRECATED(ETH_MQ_RX_DCB_FLAG) RTE_ETH_MQ_RX_DCB_FLAG
#define ETH_MQ_RX_VMDQ_FLAG                                                    \
  RTE_DEPRECATED(ETH_MQ_RX_VMDQ_FLAG) RTE_ETH_MQ_RX_VMDQ_FLAG
...
#define ETH_MQ_RX_DCB_RSS                                                      \
  RTE_DEPRECATED(ETH_MQ_RX_DCB_RSS) RTE_ETH_MQ_RX_DCB_RSS
#define ETH_MQ_RX_VMDQ_ONLY                                                    \
  RTE_DEPRECATED(ETH_MQ_RX_VMDQ_ONLY) RTE_ETH_MQ_RX_VMDQ_ONLY
#define ETH_MQ_RX_VMDQ_RSS                                                     \
  RTE_DEPRECATED(ETH_MQ_RX_VMDQ_RSS) RTE_ETH_MQ_RX_VMDQ_RSS
#define ETH_MQ_RX_VMDQ_DCB                                                     \
  RTE_DEPRECATED(ETH_MQ_RX_VMDQ_DCB) RTE_ETH_MQ_RX_VMDQ_DCB
#define ETH_MQ_RX_VMDQ_DCB_RSS                                                 \
  RTE_DEPRECATED(ETH_MQ_RX_VMDQ_DCB_RSS) RTE_ETH_MQ_RX_VMDQ_DCB_RSS
...
#define ETH_MQ_TX_VMDQ_DCB                                                     \
  RTE_DEPRECATED(ETH_MQ_TX_VMDQ_DCB) RTE_ETH_MQ_TX_VMDQ_DCB
#define ETH_MQ_TX_VMDQ_ONLY                                                    \
  RTE_DEPRECATED(ETH_MQ_TX_VMDQ_ONLY) RTE_ETH_MQ_TX_VMDQ_ONLY
...
#define ETH_VLAN_TYPE_UNKNOWN                                                  \
  RTE_DEPRECATED(ETH_VLAN_TYPE_UNKNOWN) RTE_ETH_VLAN_TYPE_UNKNOWN
#define ETH_VLAN_TYPE_INNER                                                    \
  RTE_DEPRECATED(ETH_VLAN_TYPE_INNER) RTE_ETH_VLAN_TYPE_INNER
#define ETH_VLAN_TYPE_OUTER                                                    \
  RTE_DEPRECATED(ETH_VLAN_TYPE_OUTER) RTE_ETH_VLAN_TYPE_OUTER
#define ETH_VLAN_TYPE_MAX                                                      \
  RTE_DEPRECATED(ETH_VLAN_TYPE_MAX) RTE_ETH_VLAN_TYPE_MAX
...
#define ETH_RSS_FRAG_IPV4                                                      \
  RTE_DEPRECATED(ETH_RSS_FRAG_IPV4) RTE_ETH_RSS_FRAG_IPV4
#define ETH_RSS_NONFRAG_IPV4_TCP                                               \
  RTE_DEPRECATED(ETH_RSS_NONFRAG_IPV4_TCP) RTE_ETH_RSS_NONFRAG_IPV4_TCP
#define ETH_RSS_NONFRAG_IPV4_UDP                                               \
  RTE_DEPRECATED(ETH_RSS_NONFRAG_IPV4_UDP) RTE_ETH_RSS_NONFRAG_IPV4_UDP
#define ETH_RSS_NONFRAG_IPV4_SCTP                                              \
  RTE_DEPRECATED(ETH_RSS_NONFRAG_IPV4_SCTP) RTE_ETH_RSS_NONFRAG_IPV4_SCTP
#define ETH_RSS_NONFRAG_IPV4_OTHER                                             \
  RTE_DEPRECATED(ETH_RSS_NONFRAG_IPV4_OTHER) RTE_ETH_RSS_NONFRAG_IPV4_OTHER
#define ETH_RSS_IPV6 RTE_DEPRECATED(ETH_RSS_IPV6) RTE_ETH_RSS_IPV6
#define ETH_RSS_FRAG_IPV6                                                      \
  RTE_DEPRECATED(ETH_RSS_FRAG_IPV6) RTE_ETH_RSS_FRAG_IPV6
#define ETH_RSS_NONFRAG_IPV6_TCP                                               \
  RTE_DEPRECATED(ETH_RSS_NONFRAG_IPV6_TCP) RTE_ETH_RSS_NONFRAG_IPV6_TCP
#define ETH_RSS_NONFRAG_IPV6_UDP                                               \
  RTE_DEPRECATED(ETH_RSS_NONFRAG_IPV6_UDP) RTE_ETH_RSS_NONFRAG_IPV6_UDP
#define ETH_RSS_NONFRAG_IPV6_SCTP                                              \
  RTE_DEPRECATED(ETH_RSS_NONFRAG_IPV6_SCTP) RTE_ETH_RSS_NONFRAG_IPV6_SCTP
#define ETH_RSS_NONFRAG_IPV6_OTHER                                             \
  RTE_DEPRECATED(ETH_RSS_NONFRAG_IPV6_OTHER) RTE_ETH_RSS_NONFRAG_IPV6_OTHER
#define ETH_RSS_L2_PAYLOAD                                                     \
  RTE_DEPRECATED(ETH_RSS_L2_PAYLOAD) RTE_ETH_RSS_L2_PAYLOAD
#define ETH_RSS_IPV6_EX RTE_DEPRECATED(ETH_RSS_IPV6_EX) RTE_ETH_RSS_IPV6_EX
#define ETH_RSS_IPV6_TCP_EX                                                    \
  RTE_DEPRECATED(ETH_RSS_IPV6_TCP_EX) RTE_ETH_RSS_IPV6_TCP_EX
#define ETH_RSS_IPV6_UDP_EX                                                    \
  RTE_DEPRECATED(ETH_RSS_IPV6_UDP_EX) RTE_ETH_RSS_IPV6_UDP_EX
...
#define ETH_RSS_IPV4_CHKSUM                                                    \
  RTE_DEPRECATED(ETH_RSS_IPV4_CHKSUM) RTE_ETH_RSS_IPV4_CHKSUM
...
#define ETH_RSS_L4_CHKSUM                                                      \
  RTE_DEPRECATED(ETH_RSS_L4_CHKSUM) RTE_ETH_RSS_L4_CHKSUM
...
#define ETH_RSS_L3_SRC_ONLY                                                    \
  RTE_DEPRECATED(ETH_RSS_L3_SRC_ONLY) RTE_ETH_RSS_L3_SRC_ONLY
#define ETH_RSS_L3_DST_ONLY                                                    \
  RTE_DEPRECATED(ETH_RSS_L3_DST_ONLY) RTE_ETH_RSS_L3_DST_ONLY
#define ETH_RSS_L4_SRC_ONLY                                                    \
  RTE_DEPRECATED(ETH_RSS_L4_SRC_ONLY) RTE_ETH_RSS_L4_SRC_ONLY
#define ETH_RSS_L4_DST_ONLY                                                    \
  RTE_DEPRECATED(ETH_RSS_L4_DST_ONLY) RTE_ETH_RSS_L4_DST_ONLY
#define ETH_RSS_L2_SRC_ONLY                                                    \
  RTE_DEPRECATED(ETH_RSS_L2_SRC_ONLY) RTE_ETH_RSS_L2_SRC_ONLY
...
#define ETH_RSS_LEVEL_PMD_DEFAULT                                              \
  RTE_DEPRECATED(ETH_RSS_LEVEL_PMD_DEFAULT) RTE_ETH_RSS_LEVEL_PMD_DEFAULT
...
#define ETH_RSS_LEVEL_OUTERMOST                                                \
  RTE_DEPRECATED(ETH_RSS_LEVEL_OUTERMOST) RTE_ETH_RSS_LEVEL_OUTERMOST
...
#define ETH_RSS_LEVEL_INNERMOST                                                \
  RTE_DEPRECATED(ETH_RSS_LEVEL_INNERMOST) RTE_ETH_RSS_LEVEL_INNERMOST
#define ETH_RSS_LEVEL_MASK                                                     \
  RTE_DEPRECATED(ETH_RSS_LEVEL_MASK) RTE_ETH_RSS_LEVEL_MASK

#define RTE_ETH_RSS_LEVEL(rss_hf) ((rss_hf & RTE_ETH_RSS_LEVEL_MASK) >> 50)
#define ETH_RSS_LEVEL(rss_hf)                                                  \
  RTE_DEPRECATED(ETH_RSS_LEVEL(rss_hf)) RTE_ETH_RSS_LEVEL(rss_hf)
...
#define ETH_RSS_PROTO_MASK                                                     \
  RTE_DEPRECATED(ETH_RSS_PROTO_MASK) RTE_ETH_RSS_PROTO_MASK
...
#define ETH_RSS_RETA_SIZE_64                                                   \
  RTE_DEPRECATED(ETH_RSS_RETA_SIZE_64) RTE_ETH_RSS_RETA_SIZE_64
#define ETH_RSS_RETA_SIZE_128                                                  \
  RTE_DEPRECATED(ETH_RSS_RETA_SIZE_128) RTE_ETH_RSS_RETA_SIZE_128
#define ETH_RSS_RETA_SIZE_256                                                  \
  RTE_DEPRECATED(ETH_RSS_RETA_SIZE_256) RTE_ETH_RSS_RETA_SIZE_256
#define ETH_RSS_RETA_SIZE_512                                                  \
  RTE_DEPRECATED(ETH_RSS_RETA_SIZE_512) RTE_ETH_RSS_RETA_SIZE_512
#define RTE_RETA_GROUP_SIZE                                                    \
  RTE_DEPRECATED(RTE_RETA_GROUP_SIZE) RTE_ETH_RETA_GROUP_SIZE
...
#define RTE_ETH_DCB_NUM_USER_PRIORITIES                                        \
  8 /**< Maximum nb. of DCB priorities.                                        \
     */
#define RTE_ETH_VMDQ_DCB_NUM_QUEUES                                            \
  128                              /**< Maximum nb. of VMDq DCB queues.        \
                                    */
#define RTE_ETH_DCB_NUM_QUEUES 128 /**< Maximum nb. of DCB queues. */
/**@}*/

#define ETH_VMDQ_MAX_VLAN_FILTERS                                              \
  RTE_DEPRECATED(ETH_VMDQ_MAX_VLAN_FILTERS) RTE_ETH_VMDQ_MAX_VLAN_FILTERS
#define ETH_DCB_NUM_USER_PRIORITIES                                            \
  RTE_DEPRECATED(ETH_DCB_NUM_USER_PRIORITIES) RTE_ETH_DCB_NUM_USER_PRIORITIES
#define ETH_VMDQ_DCB_NUM_QUEUES                                                \
  RTE_DEPRECATED(ETH_VMDQ_DCB_NUM_QUEUES) RTE_ETH_VMDQ_DCB_NUM_QUEUES
#define ETH_DCB_NUM_QUEUES                                                     \
  RTE_DEPRECATED(ETH_DCB_NUM_QUEUES) RTE_ETH_DCB_NUM_QUEUES

/**@{@name DCB capabilities */
#define RTE_ETH_DCB_PG_SUPPORT                                                 \
  RTE_BIT32(0) /**< Priority Group(ETS) support.                               \
                */
...
#define ETH_DCB_PG_SUPPORT                                                     \
  RTE_DEPRECATED(ETH_DCB_PG_SUPPORT) RTE_ETH_DCB_PG_SUPPORT
#define ETH_DCB_PFC_SUPPORT                                                    \
  RTE_DEPRECATED(ETH_DCB_PFC_SUPPORT) RTE_ETH_DCB_PFC_SUPPORT
...
#define ETH_VLAN_STRIP_OFFLOAD                                                 \
  RTE_DEPRECATED(ETH_VLAN_STRIP_OFFLOAD) RTE_ETH_VLAN_STRIP_OFFLOAD
#define ETH_VLAN_FILTER_OFFLOAD                                                \
  RTE_DEPRECATED(ETH_VLAN_FILTER_OFFLOAD) RTE_ETH_VLAN_FILTER_OFFLOAD
#define ETH_VLAN_EXTEND_OFFLOAD                                                \
  RTE_DEPRECATED(ETH_VLAN_EXTEND_OFFLOAD) RTE_ETH_VLAN_EXTEND_OFFLOAD
#define ETH_QINQ_STRIP_OFFLOAD                                                 \
  RTE_DEPRECATED(ETH_QINQ_STRIP_OFFLOAD) RTE_ETH_QINQ_STRIP_OFFLOAD
...
#define ETH_VLAN_STRIP_MASK                                                    \
  RTE_DEPRECATED(ETH_VLAN_STRIP_MASK) RTE_ETH_VLAN_STRIP_MASK
#define ETH_VLAN_FILTER_MASK                                                   \
  RTE_DEPRECATED(ETH_VLAN_FILTER_MASK) RTE_ETH_VLAN_FILTER_MASK
#define ETH_VLAN_EXTEND_MASK                                                   \
  RTE_DEPRECATED(ETH_VLAN_EXTEND_MASK) RTE_ETH_VLAN_EXTEND_MASK
#define ETH_QINQ_STRIP_MASK                                                    \
  RTE_DEPRECATED(ETH_QINQ_STRIP_MASK) RTE_ETH_QINQ_STRIP_MASK
...
#define ETH_NUM_RECEIVE_MAC_ADDR                                               \
  RTE_DEPRECATED(ETH_NUM_RECEIVE_MAC_ADDR) RTE_ETH_NUM_RECEIVE_MAC_ADDR

/* Definitions used for unicast hash  */
#define RTE_ETH_VMDQ_NUM_UC_HASH_ARRAY                                         \
  128 /**< Maximum nb. of UC hash array.                                       \
       */
#define ETH_VMDQ_NUM_UC_HASH_ARRAY                                             \
  RTE_DEPRECATED(ETH_VMDQ_NUM_UC_HASH_ARRAY) RTE_ETH_VMDQ_NUM_UC_HASH_ARRAY
...
#define ETH_VMDQ_ACCEPT_UNTAG                                                  \
  RTE_DEPRECATED(ETH_VMDQ_ACCEPT_UNTAG) RTE_ETH_VMDQ_ACCEPT_UNTAG
#define ETH_VMDQ_ACCEPT_HASH_MC                                                \
  RTE_DEPRECATED(ETH_VMDQ_ACCEPT_HASH_MC) RTE_ETH_VMDQ_ACCEPT_HASH_MC
#define ETH_VMDQ_ACCEPT_HASH_UC                                                \
  RTE_DEPRECATED(ETH_VMDQ_ACCEPT_HASH_UC) RTE_ETH_VMDQ_ACCEPT_HASH_UC
#define ETH_VMDQ_ACCEPT_BROADCAST                                              \
  RTE_DEPRECATED(ETH_VMDQ_ACCEPT_BROADCAST) RTE_ETH_VMDQ_ACCEPT_BROADCAST
#define ETH_VMDQ_ACCEPT_MULTICAST                                              \
  RTE_DEPRECATED(ETH_VMDQ_ACCEPT_MULTICAST) RTE_ETH_VMDQ_ACCEPT_MULTICAST
...
#define RTE_TUNNEL_TYPE_NONE                                                   \
  RTE_DEPRECATED(RTE_TUNNEL_TYPE_NONE) RTE_ETH_TUNNEL_TYPE_NONE
#define RTE_TUNNEL_TYPE_VXLAN                                                  \
  RTE_DEPRECATED(RTE_TUNNEL_TYPE_VXLAN) RTE_ETH_TUNNEL_TYPE_VXLAN
#define RTE_TUNNEL_TYPE_GENEVE                                                 \
  RTE_DEPRECATED(RTE_TUNNEL_TYPE_GENEVE) RTE_ETH_TUNNEL_TYPE_GENEVE
#define RTE_TUNNEL_TYPE_TEREDO                                                 \
  RTE_DEPRECATED(RTE_TUNNEL_TYPE_TEREDO) RTE_ETH_TUNNEL_TYPE_TEREDO
#define RTE_TUNNEL_TYPE_NVGRE                                                  \
  RTE_DEPRECATED(RTE_TUNNEL_TYPE_NVGRE) RTE_ETH_TUNNEL_TYPE_NVGRE
#define RTE_TUNNEL_TYPE_IP_IN_GRE                                              \
  RTE_DEPRECATED(RTE_TUNNEL_TYPE_IP_IN_GRE) RTE_ETH_TUNNEL_TYPE_IP_IN_GRE
#define RTE_L2_TUNNEL_TYPE_E_TAG                                               \
  RTE_DEPRECATED(RTE_L2_TUNNEL_TYPE_E_TAG) RTE_ETH_L2_TUNNEL_TYPE_E_TAG
#define RTE_TUNNEL_TYPE_VXLAN_GPE                                              \
  RTE_DEPRECATED(RTE_TUNNEL_TYPE_VXLAN_GPE) RTE_ETH_TUNNEL_TYPE_VXLAN_GPE
#define RTE_TUNNEL_TYPE_ECPRI                                                  \
  RTE_DEPRECATED(RTE_TUNNEL_TYPE_ECPRI) RTE_ETH_TUNNEL_TYPE_ECPRI
#define RTE_TUNNEL_TYPE_MAX                                                    \
  RTE_DEPRECATED(RTE_TUNNEL_TYPE_MAX) RTE_ETH_TUNNEL_TYPE_MAX
...
#define RTE_FDIR_PBALLOC_64K                                                   \
  RTE_DEPRECATED(RTE_FDIR_PBALLOC_64K) RTE_ETH_FDIR_PBALLOC_64K
#define RTE_FDIR_PBALLOC_128K                                                  \
  RTE_DEPRECATED(RTE_FDIR_PBALLOC_128K) RTE_ETH_FDIR_PBALLOC_128K
#define RTE_FDIR_PBALLOC_256K                                                  \
  RTE_DEPRECATED(RTE_FDIR_PBALLOC_256K) RTE_ETH_FDIR_PBALLOC_256K
...
#define DEV_RX_OFFLOAD_VLAN_STRIP                                              \
  RTE_DEPRECATED(DEV_RX_OFFLOAD_VLAN_STRIP) RTE_ETH_RX_OFFLOAD_VLAN_STRIP
#define DEV_RX_OFFLOAD_IPV4_CKSUM                                              \
  RTE_DEPRECATED(DEV_RX_OFFLOAD_IPV4_CKSUM) RTE_ETH_RX_OFFLOAD_IPV4_CKSUM
#define DEV_RX_OFFLOAD_UDP_CKSUM                                               \
  RTE_DEPRECATED(DEV_RX_OFFLOAD_UDP_CKSUM) RTE_ETH_RX_OFFLOAD_UDP_CKSUM
#define DEV_RX_OFFLOAD_TCP_CKSUM                                               \
  RTE_DEPRECATED(DEV_RX_OFFLOAD_TCP_CKSUM) RTE_ETH_RX_OFFLOAD_TCP_CKSUM
#define DEV_RX_OFFLOAD_TCP_LRO                                                 \
  RTE_DEPRECATED(DEV_RX_OFFLOAD_TCP_LRO) RTE_ETH_RX_OFFLOAD_TCP_LRO
#define DEV_RX_OFFLOAD_QINQ_STRIP                                              \
  RTE_DEPRECATED(DEV_RX_OFFLOAD_QINQ_STRIP) RTE_ETH_RX_OFFLOAD_QINQ_STRIP
#define DEV_RX_OFFLOAD_OUTER_IPV4_CKSUM                                        \
  RTE_DEPRECATED(DEV_RX_OFFLOAD_OUTER_IPV4_CKSUM)                              \
  RTE_ETH_RX_OFFLOAD_OUTER_IPV4_CKSUM
#define DEV_RX_OFFLOAD_MACSEC_STRIP                                            \
  RTE_DEPRECATED(DEV_RX_OFFLOAD_MACSEC_STRIP) RTE_ETH_RX_OFFLOAD_MACSEC_STRIP
#define DEV_RX_OFFLOAD_HEADER_SPLIT                                            \
  RTE_DEPRECATED(DEV_RX_OFFLOAD_HEADER_SPLIT) RTE_ETH_RX_OFFLOAD_HEADER_SPLIT
#define DEV_RX_OFFLOAD_VLAN_FILTER                                             \
  RTE_DEPRECATED(DEV_RX_OFFLOAD_VLAN_FILTER) RTE_ETH_RX_OFFLOAD_VLAN_FILTER
#define DEV_RX_OFFLOAD_VLAN_EXTEND                                             \
  RTE_DEPRECATED(DEV_RX_OFFLOAD_VLAN_EXTEND) RTE_ETH_RX_OFFLOAD_VLAN_EXTEND
#define DEV_RX_OFFLOAD_SCATTER                                                 \
  RTE_DEPRECATED(DEV_RX_OFFLOAD_SCATTER) RTE_ETH_RX_OFFLOAD_SCATTER
#define DEV_RX_OFFLOAD_TIMESTAMP                                               \
  RTE_DEPRECATED(DEV_RX_OFFLOAD_TIMESTAMP) RTE_ETH_RX_OFFLOAD_TIMESTAMP
#define DEV_RX_OFFLOAD_SECURITY                                                \
  RTE_DEPRECATED(DEV_RX_OFFLOAD_SECURITY) RTE_ETH_RX_OFFLOAD_SECURITY
#define DEV_RX_OFFLOAD_KEEP_CRC                                                \
  RTE_DEPRECATED(DEV_RX_OFFLOAD_KEEP_CRC) RTE_ETH_RX_OFFLOAD_KEEP_CRC
#define DEV_RX_OFFLOAD_SCTP_CKSUM                                              \
  RTE_DEPRECATED(DEV_RX_OFFLOAD_SCTP_CKSUM) RTE_ETH_RX_OFFLOAD_SCTP_CKSUM
...
#define DEV_RX_OFFLOAD_CHECKSUM                                                \
  RTE_DEPRECATED(DEV_RX_OFFLOAD_CHECKSUM) RTE_ETH_RX_OFFLOAD_CHECKSUM
...
#define DEV_TX_OFFLOAD_VLAN_INSERT                                             \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_VLAN_INSERT) RTE_ETH_TX_OFFLOAD_VLAN_INSERT
#define DEV_TX_OFFLOAD_IPV4_CKSUM                                              \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_IPV4_CKSUM) RTE_ETH_TX_OFFLOAD_IPV4_CKSUM
#define DEV_TX_OFFLOAD_UDP_CKSUM                                               \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_UDP_CKSUM) RTE_ETH_TX_OFFLOAD_UDP_CKSUM
#define DEV_TX_OFFLOAD_TCP_CKSUM                                               \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_TCP_CKSUM) RTE_ETH_TX_OFFLOAD_TCP_CKSUM
#define DEV_TX_OFFLOAD_SCTP_CKSUM                                              \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_SCTP_CKSUM) RTE_ETH_TX_OFFLOAD_SCTP_CKSUM
#define DEV_TX_OFFLOAD_TCP_TSO                                                 \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_TCP_TSO) RTE_ETH_TX_OFFLOAD_TCP_TSO
#define DEV_TX_OFFLOAD_UDP_TSO                                                 \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_UDP_TSO) RTE_ETH_TX_OFFLOAD_UDP_TSO
#define DEV_TX_OFFLOAD_OUTER_IPV4_CKSUM                                        \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_OUTER_IPV4_CKSUM)                              \
  RTE_ETH_TX_OFFLOAD_OUTER_IPV4_CKSUM
#define DEV_TX_OFFLOAD_QINQ_INSERT                                             \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_QINQ_INSERT) RTE_ETH_TX_OFFLOAD_QINQ_INSERT
#define DEV_TX_OFFLOAD_VXLAN_TNL_TSO                                           \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_VXLAN_TNL_TSO) RTE_ETH_TX_OFFLOAD_VXLAN_TNL_TSO
#define DEV_TX_OFFLOAD_GRE_TNL_TSO                                             \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_GRE_TNL_TSO) RTE_ETH_TX_OFFLOAD_GRE_TNL_TSO
#define DEV_TX_OFFLOAD_IPIP_TNL_TSO                                            \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_IPIP_TNL_TSO) RTE_ETH_TX_OFFLOAD_IPIP_TNL_TSO
#define DEV_TX_OFFLOAD_GENEVE_TNL_TSO                                          \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_GENEVE_TNL_TSO)                                \
  RTE_ETH_TX_OFFLOAD_GENEVE_TNL_TSO
#define DEV_TX_OFFLOAD_MACSEC_INSERT                                           \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_MACSEC_INSERT) RTE_ETH_TX_OFFLOAD_MACSEC_INSERT
#define DEV_TX_OFFLOAD_MT_LOCKFREE                                             \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_MT_LOCKFREE) RTE_ETH_TX_OFFLOAD_MT_LOCKFREE
#define DEV_TX_OFFLOAD_MULTI_SEGS                                              \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_MULTI_SEGS) RTE_ETH_TX_OFFLOAD_MULTI_SEGS
#define DEV_TX_OFFLOAD_MBUF_FAST_FREE                                          \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_MBUF_FAST_FREE)                                \
  RTE_ETH_TX_OFFLOAD_MBUF_FAST_FREE
#define DEV_TX_OFFLOAD_SECURITY                                                \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_SECURITY) RTE_ETH_TX_OFFLOAD_SECURITY
#define DEV_TX_OFFLOAD_UDP_TNL_TSO                                             \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_UDP_TNL_TSO) RTE_ETH_TX_OFFLOAD_UDP_TNL_TSO
#define DEV_TX_OFFLOAD_IP_TNL_TSO                                              \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_IP_TNL_TSO) RTE_ETH_TX_OFFLOAD_IP_TNL_TSO
#define DEV_TX_OFFLOAD_OUTER_UDP_CKSUM                                         \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_OUTER_UDP_CKSUM)                               \
  RTE_ETH_TX_OFFLOAD_OUTER_UDP_CKSUM
#define DEV_TX_OFFLOAD_SEND_ON_TIMESTAMP                                       \
  RTE_DEPRECATED(DEV_TX_OFFLOAD_SEND_ON_TIMESTAMP)                             \
...
#define ETH_MAX_VMDQ_POOL                                                      \
  RTE_DEPRECATED(ETH_MAX_VMDQ_POOL) RTE_ETH_MAX_VMDQ_POOL
 ...
 *   - (0) on success
 */
__rte_experimental int rte_eth_rx_metadata_negotiate(uint16_t port_id,
                                                     uint64_t *features);
...
static inline uint16_t rte_eth_rx_burst(uint16_t port_id, uint16_t queue_id,
  ...
  if (port_id >= RTE_MAX_ETHPORTS || queue_id >= RTE_MAX_QUEUES_PER_PORT) {
    RTE_ETHDEV_LOG(ERR, "Invalid port_id=%u or queue_id=%u\n", port_id,
                   queue_id);
    return 0;
  }
#endif
