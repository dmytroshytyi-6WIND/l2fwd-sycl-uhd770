...
typedef int (*rte_mtr_meter_profile_add_t)(
...
typedef int (*rte_mtr_meter_policy_validate_t)(
    struct rte_eth_dev *dev, struct rte_mtr_meter_policy_params *policy,
    struct rte_mtr_error *error);

/** @internal MTR meter policy add. */
typedef int (*rte_mtr_meter_policy_add_t)(
    struct rte_eth_dev *dev, uint32_t policy_id,
...
typedef int (*rte_mtr_create_t)(struct rte_eth_dev *dev, uint32_t mtr_id,
                                struct rte_mtr_params *params, int shared,
                                struct rte_mtr_error *error);

/** @internal MTR object destroy. */
typedef int (*rte_mtr_destroy_t)(struct rte_eth_dev *dev, uint32_t mtr_id,
                                 struct rte_mtr_error *error);

/** @internal MTR object meter enable. */
typedef int (*rte_mtr_meter_enable_t)(struct rte_eth_dev *dev, uint32_t mtr_id,
                                      struct rte_mtr_error *error);

/** @internal MTR object meter disable. */
typedef int (*rte_mtr_meter_disable_t)(struct rte_eth_dev *dev, uint32_t mtr_id,
                                       struct rte_mtr_error *error);
...
typedef int (*rte_mtr_stats_update_t)(struct rte_eth_dev *dev, uint32_t mtr_id,
                                      uint64_t stats_mask,
                                      struct rte_mtr_error *error);

/** @internal MTR object stats read. */
typedef int (*rte_mtr_stats_read_t)(struct rte_eth_dev *dev, uint32_t mtr_id,
 ...
 *   Error code.
 */
static inline int rte_mtr_error_set(struct rte_mtr_error *error, int code,
