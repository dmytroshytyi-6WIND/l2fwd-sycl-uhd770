...
#define RTE_NTUPLE_FLAGS_DST_IP                                                \
  0x0001 /**< If set, dst_ip is part of ntuple                                 \
          */
#define RTE_NTUPLE_FLAGS_SRC_IP                                                \
  0x0002 /**< If set, src_ip is part of ntuple                                 \
          */
#define RTE_NTUPLE_FLAGS_DST_PORT                                              \
  0x0004 /**< If set, dst_port is part of ntuple */
#define RTE_NTUPLE_FLAGS_SRC_PORT                                              \
  0x0008 /**< If set, src_port is part of ntuple */
#define RTE_NTUPLE_FLAGS_PROTO                                                 \
  0x0010 /**< If set, protocol is part of ntuple                               \
          */
#define RTE_NTUPLE_FLAGS_TCP_FLAG 0x0020 /**< If set, tcp flag is involved */

#define RTE_5TUPLE_FLAGS                                                       \
  (RTE_NTUPLE_FLAGS_DST_IP | RTE_NTUPLE_FLAGS_SRC_IP |                         \
   RTE_NTUPLE_FLAGS_DST_PORT | RTE_NTUPLE_FLAGS_SRC_PORT |                     \
