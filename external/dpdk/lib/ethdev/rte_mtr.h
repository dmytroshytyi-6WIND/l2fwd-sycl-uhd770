...
rte_mtr_capabilities_get(uint16_t port_id, struct rte_mtr_capabilities *cap,
 ...
 */
__rte_experimental int
rte_mtr_meter_profile_add(uint16_t port_id, uint32_t meter_profile_id,
 ...
 */
__rte_experimental int
rte_mtr_meter_profile_delete(uint16_t port_id, uint32_t meter_profile_id,
                             struct rte_mtr_error *error);
 ...
 */
__rte_experimental int
rte_mtr_meter_policy_add(uint16_t port_id, uint32_t policy_id,
                         struct rte_mtr_meter_policy_params *policy,
                         struct rte_mtr_error *error);
 ...
 */
__rte_experimental int rte_mtr_create(uint16_t port_id, uint32_t mtr_id,
 ...
 *   0 on success, non-zero error code otherwise.
 */
__rte_experimental int rte_mtr_destroy(uint16_t port_id, uint32_t mtr_id,
                                       struct rte_mtr_error *error);
 ...
 *   0 on success, non-zero error code otherwise.
 */
__rte_experimental int rte_mtr_meter_disable(uint16_t port_id, uint32_t mtr_id,
                                             struct rte_mtr_error *error);
 ...
 *   0 on success, non-zero error code otherwise.
 */
__rte_experimental int rte_mtr_meter_enable(uint16_t port_id, uint32_t mtr_id,
                                            struct rte_mtr_error *error);
 ...
 */
__rte_experimental int
rte_mtr_meter_profile_update(uint16_t port_id, uint32_t mtr_id,
                             uint32_t meter_profile_id,
                             struct rte_mtr_error *error);
 ...
 */
__rte_experimental int
rte_mtr_meter_dscp_table_update(uint16_t port_id, uint32_t mtr_id,
                                enum rte_color *dscp_table,
                                struct rte_mtr_error *error);
 ...
 * @see enum rte_mtr_stats_type
 */
__rte_experimental int rte_mtr_stats_update(uint16_t port_id, uint32_t mtr_id,
                                            uint64_t stats_mask,
                                            struct rte_mtr_error *error);
 ...
 * @see enum rte_mtr_stats_type
 */
__rte_experimental int rte_mtr_stats_read(uint16_t port_id, uint32_t mtr_id,
