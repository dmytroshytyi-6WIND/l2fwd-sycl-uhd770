...
RTE_TRACE_POINT_REGISTER(rte_mempool_trace_generic_put, lib.mempool.generic.put)

RTE_TRACE_POINT_REGISTER(rte_mempool_trace_put_bulk, lib.mempool.put.bulk)

RTE_TRACE_POINT_REGISTER(rte_mempool_trace_generic_get, lib.mempool.generic.get)

RTE_TRACE_POINT_REGISTER(rte_mempool_trace_get_bulk, lib.mempool.get.bulk)

RTE_TRACE_POINT_REGISTER(rte_mempool_trace_get_contig_blocks,
                         lib.mempool.get.blocks)

RTE_TRACE_POINT_REGISTER(rte_mempool_trace_create, lib.mempool.create)

RTE_TRACE_POINT_REGISTER(rte_mempool_trace_create_empty,
                         lib.mempool.create.empty)

RTE_TRACE_POINT_REGISTER(rte_mempool_trace_free, lib.mempool.free)
...
RTE_TRACE_POINT_REGISTER(rte_mempool_trace_cache_free, lib.mempool.cache.free)
...
RTE_TRACE_POINT_REGISTER(rte_mempool_trace_cache_flush, lib.mempool.cache.flush)

RTE_TRACE_POINT_REGISTER(rte_mempool_trace_ops_populate,
                         lib.mempool.ops.populate)

RTE_TRACE_POINT_REGISTER(rte_mempool_trace_ops_alloc, lib.mempool.ops.alloc)

RTE_TRACE_POINT_REGISTER(rte_mempool_trace_ops_free, lib.mempool.ops.free)
