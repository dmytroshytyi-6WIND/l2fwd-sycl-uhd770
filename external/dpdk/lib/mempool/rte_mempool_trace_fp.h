...
RTE_TRACE_POINT_FP(rte_mempool_trace_ops_dequeue_bulk,
...
RTE_TRACE_POINT_FP(rte_mempool_trace_ops_dequeue_contig_blocks,
...
RTE_TRACE_POINT_FP(rte_mempool_trace_ops_enqueue_bulk,
...
RTE_TRACE_POINT_FP(rte_mempool_trace_generic_put,
                   RTE_TRACE_POINT_ARGS(void *mempool, void *const *obj_table,
...
RTE_TRACE_POINT_FP(rte_mempool_trace_put_bulk,
                   RTE_TRACE_POINT_ARGS(void *mempool, void *const *obj_table,
                                        uint32_t nb_objs, void *cache),
                   rte_trace_point_emit_ptr(mempool);
                   rte_trace_point_emit_ptr(obj_table);
...
RTE_TRACE_POINT_FP(rte_mempool_trace_generic_get,
                   RTE_TRACE_POINT_ARGS(void *mempool, void *const *obj_table,
                                        uint32_t nb_objs, void *cache),
                   rte_trace_point_emit_ptr(mempool);
                   rte_trace_point_emit_ptr(obj_table);
...
RTE_TRACE_POINT_FP(rte_mempool_trace_get_bulk,
                   RTE_TRACE_POINT_ARGS(void *mempool, void **obj_table,
                                        uint32_t nb_objs, void *cache),
                   rte_trace_point_emit_ptr(mempool);
                   rte_trace_point_emit_ptr(obj_table);
...
RTE_TRACE_POINT_FP(rte_mempool_trace_get_contig_blocks,
                   RTE_TRACE_POINT_ARGS(void *mempool, void **first_obj_table,
                                        uint32_t nb_objs),
                   rte_trace_point_emit_ptr(mempool);
                   rte_trace_point_emit_ptr(first_obj_table);
...
RTE_TRACE_POINT_FP(rte_mempool_trace_default_cache,
...
RTE_TRACE_POINT_FP(rte_mempool_trace_cache_flush,
