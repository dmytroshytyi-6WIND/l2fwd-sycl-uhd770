 ...
 */
__rte_experimental int
rte_swx_pipeline_port_in_config(struct rte_swx_pipeline *p, uint32_t port_id,
 ...
 */
__rte_experimental int
rte_swx_pipeline_port_out_config(struct rte_swx_pipeline *p, uint32_t port_id,
                                 const char *port_type_name, void *args);
 ...
 */
__rte_experimental int rte_swx_pipeline_extern_type_register(
 ...
 */
__rte_experimental int rte_swx_pipeline_extern_type_member_func_register(
 ...
 */
__rte_experimental int rte_swx_pipeline_extern_func_register(
    struct rte_swx_pipeline *p, const char *name,
 ...
 */
__rte_experimental int rte_swx_pipeline_struct_type_register(
    struct rte_swx_pipeline *p, const char *name,
    struct rte_swx_field_params *fields, uint32_t n_fields,
 ...
 */
__rte_experimental int rte_swx_pipeline_packet_header_register(
    struct rte_swx_pipeline *p, const char *name, const char *struct_type_name);
 ...
 *
 *<pre>+------------+----------------------+-------------------+------+--------+</pre>
 *<pre>| Instr.     | Instruction          | Instruction       | 1st  | 2nd
 *|</pre> <pre>| Name       | Description          | Format            | opnd.|
 *opnd.  |</pre>
 *<pre>+------------+----------------------+-------------------+------+--------+</pre>
 ...
 *<pre>+------------+----------------------+-------------------+------+--------+</pre>
 *<pre>| mov        | dst = src            | mov dst src       | HMEF | HMEFTI
 *|</pre>
 *<pre>+------------+----------------------+-------------------+------+--------+</pre>
 *<pre>| add        | dst += src           | add dst src       | HMEF | HMEFTI
 *|</pre>
 *<pre>+------------+----------------------+-------------------+------+--------+</pre>
 *<pre>| sub        | dst -= src           | add dst src       | HMEF | HMEFTI
 *|</pre>
 *<pre>+------------+----------------------+-------------------+------+--------+</pre>
 *<pre>| ckadd      | Checksum add: dst =  | add dst src       | HMEF | HMEFTI
 *|</pre> <pre>|            | dst '+ src[0:1] '+   |                   |      |
 *or hdr |</pre> <pre>|            | src[2:3] '+ ...      |                   |
 *|        |</pre>
 *<pre>+------------+----------------------+-------------------+------+--------+</pre>
 *<pre>| cksub      | Checksum subtract:   | add dst src       | HMEF | HMEFTI
 *|</pre> <pre>|            | dst = dst '- src     |                   |      |
 *|</pre>
 *<pre>+------------+----------------------+-------------------+------+--------+</pre>
 *<pre>| and        | dst &= src           | and dst src       | HMEF | HMEFTI
 *|</pre>
 *<pre>+------------+----------------------+-------------------+------+--------+</pre>
 *<pre>| or         | dst |= src           | or  dst src       | HMEF | HMEFTI
 *|</pre>
 *<pre>+------------+----------------------+-------------------+------+--------+</pre>
 *<pre>| xor        | dst ^= src           | xor dst src       | HMEF | HMEFTI
 *|</pre>
 *<pre>+------------+----------------------+-------------------+------+--------+</pre>
 *<pre>| shl        | dst <<= src          | shl dst src       | HMEF | HMEFTI
 *|</pre>
 *<pre>+------------+----------------------+-------------------+------+--------+</pre>
 *<pre>| shr        | dst >>= src          | shr dst src       | HMEF | HMEFTI
 *|</pre>
 *<pre>+------------+----------------------+-------------------+------+--------+</pre>
 ...
 *<pre>+------------+----------------------+-------------------+------+--------+</pre>
 *<pre>| jmpeq      | Jump if (a == b)     | jmpeq LABEL a b   | HMEFT| HMEFTI
 *|</pre>
 *<pre>+------------+----------------------+-------------------+------+--------+</pre>
 *<pre>| jmpneq     | Jump if (a != b)     | jmpneq LABEL a b  | HMEFT| HMEFTI
 *|</pre>
 *<pre>+------------+----------------------+-------------------+------+--------+</pre>
 *<pre>| jmplt      | Jump if (a < b)      | jmplt LABEL a b   | HMEFT| HMEFTI
 *|</pre>
 *<pre>+------------+----------------------+-------------------+------+--------+</pre>
 *<pre>| jmpgt      | Jump if (a > b)      | jmpgt LABEL a b   | HMEFT| HMEFTI
 *|</pre>
 *<pre>+------------+----------------------+-------------------+------+--------+</pre>
 ...
 */
__rte_experimental int
rte_swx_pipeline_action_config(struct rte_swx_pipeline *p, const char *name,
 ...
 */
__rte_experimental int rte_swx_pipeline_table_type_register(
    struct rte_swx_pipeline *p, const char *name,
 ...
 */
__rte_experimental int
rte_swx_pipeline_table_config(struct rte_swx_pipeline *p, const char *name,
 ...
 */
__rte_experimental int rte_swx_pipeline_selector_config(
    struct rte_swx_pipeline *p, const char *name,
 ...
 */
__rte_experimental int
rte_swx_pipeline_learner_config(struct rte_swx_pipeline *p, const char *name,
 ...
 */
__rte_experimental int
rte_swx_pipeline_regarray_config(struct rte_swx_pipeline *p, const char *name,
 ...
 */
__rte_experimental int
rte_swx_pipeline_metarray_config(struct rte_swx_pipeline *p, const char *name,
                                 uint32_t size);
 ...
 */
__rte_experimental int
rte_swx_pipeline_build_from_spec(struct rte_swx_pipeline *p, FILE *spec,
