 ...
 */
__rte_experimental int
rte_swx_ctl_action_info_get(struct rte_swx_pipeline *p, uint32_t action_id,
 ...
 */
__rte_experimental int
rte_swx_ctl_action_arg_info_get(struct rte_swx_pipeline *p, uint32_t action_id,
 ...
 */
__rte_experimental int
rte_swx_ctl_table_info_get(struct rte_swx_pipeline *p, uint32_t table_id,
 ...
 *   -EINVAL: Invalid argument.
 */
__rte_experimental int rte_swx_ctl_table_match_field_info_get(
 ...
 *   -EINVAL: Invalid argument.
 */
__rte_experimental int rte_swx_ctl_table_action_info_get(
 ...
 */
__rte_experimental int
rte_swx_ctl_table_ops_get(struct rte_swx_pipeline *p, uint32_t table_id,
                          struct rte_swx_table_ops *table_ops, int *is_stub);
 ...
 */
__rte_experimental int
rte_swx_ctl_selector_info_get(struct rte_swx_pipeline *p, uint32_t selector_id,
 ...
 *   -EINVAL: Invalid argument.
 */
__rte_experimental int rte_swx_ctl_selector_field_info_get(
    struct rte_swx_pipeline *p, uint32_t selector_id,
 ...
 *   -EINVAL: Invalid argument.
 */
__rte_experimental int rte_swx_ctl_pipeline_selector_stats_read(
 ...
 */
__rte_experimental int
rte_swx_ctl_learner_info_get(struct rte_swx_pipeline *p, uint32_t learner_id,
 ...
 *   -EINVAL: Invalid argument.
 */
__rte_experimental int rte_swx_ctl_learner_match_field_info_get(
 ...
 *   Action index within the set of learner table actions (0 .. learner table
 * n_actions - 1). Not to be confused with the pipeline-leve action ID (0 ..
 * pipeline n_actions - 1), which is precisely what this function returns as
 * part of the *learner_action*.
 ...
 *   -EINVAL: Invalid argument.
 */
__rte_experimental int rte_swx_ctl_learner_action_info_get(
...
struct rte_swx_learner_stats {
  ...
  /** Number of packets (with either lookup hit or miss) per pipeline action.
   * Array of pipeline *n_actions* elements indexed by the pipeline-level
   * *action_id*, therefore this array has the same size for all the tables
 ...
 *   Learner table name.
 * @param[out] stats
 *   Learner table stats. Must point to a pre-allocated structure. The
 * *n_pkts_action* field also needs to be pre-allocated as array of pipeline
 * *n_actions* elements. The pipeline actions that are not valid for the current
 * learner table have their associated *n_pkts_action* element always set to
 * zero.
 * @return
 *   0 on success or the following error codes otherwise:
 *   -EINVAL: Invalid argument.
 ...
 *   -EINVAL: Invalid argument.
 */
__rte_experimental int rte_swx_ctl_pipeline_selector_group_member_delete(
    struct rte_swx_ctl_pipeline *ctl, const char *selector_name,
    uint32_t group_id, uint32_t member_id);

/**
 * Pipeline learner table default entry add
 *
 * Schedule learner table default entry update as part of the next commit
 * operation.
 *
 * @param[in] ctl
 *   Pipeline control handle.
 ...
 */
__rte_experimental int
rte_swx_ctl_pipeline_table_fprintf(FILE *f, struct rte_swx_ctl_pipeline *ctl,
                                   const char *table_name);
 ...
 */
__rte_experimental int
rte_swx_ctl_pipeline_selector_fprintf(FILE *f, struct rte_swx_ctl_pipeline *ctl,
                                      const char *selector_name);
 ...
 */
__rte_experimental int
rte_swx_ctl_regarray_info_get(struct rte_swx_pipeline *p, uint32_t regarray_id,
...
rte_swx_ctl_pipeline_regarray_read(struct rte_swx_pipeline *p,
                                   ...
                                   uint32_t regarray_index, uint64_t *value);
 ...
 */
__rte_experimental int
rte_swx_ctl_metarray_info_get(struct rte_swx_pipeline *p, uint32_t metarray_id,
 ...
 */
__rte_experimental int
rte_swx_ctl_meter_profile_add(struct rte_swx_pipeline *p, const char *name,
 ...
 */
__rte_experimental int
rte_swx_ctl_meter_profile_delete(struct rte_swx_pipeline *p, const char *name);
...
rte_swx_ctl_meter_stats_read(struct rte_swx_pipeline *p,
                             const char *metarray_name, uint32_t metarray_index,
