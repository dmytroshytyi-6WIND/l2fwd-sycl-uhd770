 ...
 *   Zero on success, non-zero error code otherwise.
 */
__rte_experimental int rte_table_action_profile_action_register(
 ...
 *   Zero on success, non-zero error code otherwise.
 */
__rte_experimental int rte_table_action_meter_profile_add(
 ...
 *   Zero on success, non-zero error code otherwise.
 */
__rte_experimental int rte_table_action_meter_read(
    struct rte_table_action *action, void *data, uint32_t tc_mask,
    struct rte_table_action_mtr_counters *stats, int clear);
 ...
 */
__rte_experimental int
rte_table_action_ttl_read(struct rte_table_action *action, void *data,
 ...
 */
__rte_experimental int
rte_table_action_stats_read(struct rte_table_action *action, void *data,
 ...
 */
__rte_experimental int
rte_table_action_time_read(struct rte_table_action *action, void *data,
                           uint64_t *timestamp);
