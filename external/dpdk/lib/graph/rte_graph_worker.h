 ...
 */
__rte_experimental void __rte_node_stream_alloc(struct rte_graph *graph,
 ...
 */
__rte_experimental void __rte_node_stream_alloc_size(struct rte_graph *graph,
                                                     struct rte_node *node,
                                                     uint16_t req_size);
 ...
 */
__rte_experimental static inline void rte_graph_walk(struct rte_graph *graph) {
