...
static inline void acl_set_flow_avx512(struct acl_flow_avx512 *flow,
                                       const struct rte_acl_ctx *ctx,
                                       uint32_t trie, const uint8_t *data[],
                                       uint32_t *matches,
 ...
 */
static inline uint32_t update_flow_mask(const struct acl_flow_avx512 *flow,
