 ...
 */
int rte_acl_classify_avx512x16(__rte_unused const struct rte_acl_ctx *ctx,
...
int rte_acl_classify_avx512x32(__rte_unused const struct rte_acl_ctx *ctx,
                               __rte_unused const uint8_t **data,
                               __rte_unused uint32_t *results,
                               __rte_unused uint32_t num,
                               __rte_unused uint32_t categories) {
 ...
 */
int rte_acl_classify_avx2(__rte_unused const struct rte_acl_ctx *ctx,
                          __rte_unused const uint8_t **data,
                          __rte_unused uint32_t *results,
                          __rte_unused uint32_t num,
                          __rte_unused uint32_t categories) {
...
#ifndef RTE_ARCH_X86
int rte_acl_classify_sse(__rte_unused const struct rte_acl_ctx *ctx,
                         __rte_unused const uint8_t **data,
                         __rte_unused uint32_t *results,
                         __rte_unused uint32_t num,
                         __rte_unused uint32_t categories) {
...
#ifndef RTE_ARCH_ARM
int rte_acl_classify_neon(__rte_unused const struct rte_acl_ctx *ctx,
                          __rte_unused const uint8_t **data,
                          __rte_unused uint32_t *results,
                          __rte_unused uint32_t num,
                          __rte_unused uint32_t categories) {
...
int rte_acl_classify_altivec(__rte_unused const struct rte_acl_ctx *ctx,
                             __rte_unused const uint8_t **data,
                             __rte_unused uint32_t *results,
                             __rte_unused uint32_t num,
                             __rte_unused uint32_t categories) {
 ...
 */
static int acl_check_alg_arm(enum rte_acl_classify_alg alg) {
 ...
 */
static int acl_check_alg_ppc(enum rte_acl_classify_alg alg) {
...
static int acl_check_avx512_cpu_flags(void) {
 ...
 */
static int acl_check_alg_x86(enum rte_acl_classify_alg alg) {
 ...
 */
static int acl_check_alg(enum rte_acl_classify_alg alg) {
  switch (alg) {
 ...
 */
static enum rte_acl_classify_alg acl_get_best_alg(void) {
  /*
...
extern int rte_acl_set_ctx_classify(struct rte_acl_ctx *ctx,
...
int rte_acl_classify_alg(const struct rte_acl_ctx *ctx, const uint8_t **data,
                         uint32_t *results, uint32_t num, uint32_t categories,
                         enum rte_acl_classify_alg alg) {
  if (categories != 1 && ((RTE_ACL_RESULTS_MULTIPLIER - 1) & categories) != 0)
    return -EINVAL;

  return classify_fns[alg](ctx, data, results, num, categories);
}

int rte_acl_classify(const struct rte_acl_ctx *ctx, const uint8_t **data,
                     uint32_t *results, uint32_t num, uint32_t categories) {
  return rte_acl_classify_alg(ctx, data, results, num, categories, ctx->alg);
}
...
static int acl_add_rules(struct rte_acl_ctx *ctx, const void *rules,
                         uint32_t num) {
  uint8_t *pos;
...
static int acl_check_rule(const struct rte_acl_rule_data *rd) {
...
int rte_acl_add_rules(struct rte_acl_ctx *ctx, const struct rte_acl_rule *rules,
                      uint32_t num) {
  ...
  for (i = 0; i != num; i++) {
    rv = (const struct rte_acl_rule *)((uintptr_t)rules + i * ctx->rule_sz);
