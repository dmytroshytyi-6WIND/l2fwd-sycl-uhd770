 ...
 */
static inline void resolve_priority_neon(uint64_t transition, int n,
  ...
  for (x = 0; x < categories; x += RTE_ACL_RESULTS_MULTIPLIER) {
    ...
    results = vld1q_s32((const int32_t *)&p[transition].results[x]);
    priority = vld1q_s32((const int32_t *)&p[transition].priority[x]);
 ...
 */
static __rte_always_inline int32x4_t transition4(int32x4_t next_input,
 ...
 */
static inline int search_neon_8(const struct rte_acl_ctx *ctx,
 ...
 */
static inline int search_neon_4(const struct rte_acl_ctx *ctx,
                                const uint8_t **data, uint32_t *results,
