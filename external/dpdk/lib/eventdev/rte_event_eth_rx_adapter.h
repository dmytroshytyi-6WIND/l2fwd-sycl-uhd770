 ...
 *  rte_event_eth_rx_adapter_create_ext().
 */
typedef int (*rte_event_eth_rx_adapter_conf_cb)(
    uint8_t id, uint8_t dev_id, struct rte_event_eth_rx_adapter_conf *conf,
    void *arg);
 ...
 */
typedef uint16_t (*rte_event_eth_rx_adapter_cb_fn)(
    uint16_t eth_dev_id, uint16_t queue_id, uint32_t enqueue_buf_size,
    uint32_t enqueue_buf_count, struct rte_event *ev, uint16_t nb_event,
    void *cb_arg, uint16_t *nb_dropped);
 ...
 *   - <0: Error code on failure
 */
__rte_experimental int rte_event_eth_rx_adapter_create_with_params(
 ...
 *  - <0: Error code on failure.
 */
__rte_experimental int rte_event_eth_rx_adapter_queue_conf_get(
 ...
 *  - <0: Error code on failure.
 */
__rte_experimental int rte_event_eth_rx_adapter_queue_stats_get(
    uint8_t id, uint16_t eth_dev_id, uint16_t rx_queue_id,
...
rte_event_eth_rx_adapter_queue_stats_reset(uint8_t id, uint16_t eth_dev_id,
