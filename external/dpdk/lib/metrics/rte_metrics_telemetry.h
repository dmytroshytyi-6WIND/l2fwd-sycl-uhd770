...
enum rte_telemetry_stats_type { PORT_STATS = 0, GLOBAL_STATS = 1 };
...
__rte_experimental int32_t rte_metrics_tel_encode_json_format(
...
__rte_experimental int32_t rte_metrics_tel_get_ports_stats_json(
    struct telemetry_encode_param *ep, int *reg_index, char **json_buffer);
