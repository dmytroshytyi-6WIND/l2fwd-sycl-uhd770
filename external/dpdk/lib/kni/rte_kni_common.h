...
struct rte_kni_mbuf {
  ...
  __attribute__((__aligned__(RTE_CACHE_LINE_MIN_SIZE))) void
      *next; /**< Physical address of next mbuf in kernel. */
};
...
struct rte_kni_device_info {
  ...
  __extension__ uint8_t force_bind : 1; /**< Flag for kernel thread binding */
