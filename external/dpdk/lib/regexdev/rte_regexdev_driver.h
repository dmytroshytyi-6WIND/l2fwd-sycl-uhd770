 ...
 *   NULL otherwise.
 */
__rte_internal struct rte_regexdev *rte_regexdev_register(const char *name);
 ...
 */
__rte_internal void rte_regexdev_unregister(struct rte_regexdev *dev);
 ...
 *   The device name.
 */
__rte_internal struct rte_regexdev *
