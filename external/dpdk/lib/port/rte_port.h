 ...
 *   0 on success, error code otherwise
 */
typedef int (*rte_port_in_op_rx)(void *port, struct rte_mbuf **pkts,
                                 uint32_t n_pkts);
 ...
 */
typedef int (*rte_port_in_op_stats_read)(void *port,
 ...
 *   0 on success, error code otherwise
 */
typedef int (*rte_port_out_op_tx_bulk)(void *port, struct rte_mbuf **pkts,
                                       uint64_t pkts_mask);
 ...
 *   Error code or 0 on success.
 */
typedef int (*rte_port_out_op_stats_read)(void *port,
