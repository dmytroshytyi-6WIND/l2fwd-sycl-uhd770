...
static void source_free(void *port) {
...
static void *source_create(void *args) {
  ...
  n_pkts_max =
      params->n_pkts_max ? params->n_pkts_max : RTE_SWX_PORT_SOURCE_PKTS_MAX;
...
static int source_pkt_rx(void *port, struct rte_swx_pkt *pkt) {
  struct source *p = port;
...
static void source_stats_read(void *port, struct rte_swx_port_in_stats *stats) {
  struct source *p = port;
...
static void sink_free(void *port) {
  struct sink *p = port;
...
static void *sink_create(void *args __rte_unused) {
  struct sink *p;
...
static void sink_pkt_tx(void *port, struct rte_swx_pkt *pkt) {
  struct sink *p = port;
...
static void sink_stats_read(void *port, struct rte_swx_port_out_stats *stats) {
  struct sink *p = port;
