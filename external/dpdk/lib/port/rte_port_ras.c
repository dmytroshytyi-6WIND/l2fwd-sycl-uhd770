...
#define RTE_PORT_RAS_N_ENTRIES                                                 \
  (RTE_PORT_RAS_N_BUCKETS * RTE_PORT_RAS_N_ENTRIES_PER_BUCKET)
#endif
...
typedef void (*ras_op)(struct rte_port_ring_writer_ras *p,
                       struct rte_mbuf *pkt);

static void process_ipv4(struct rte_port_ring_writer_ras *p,
                         struct rte_mbuf *pkt);
static void process_ipv6(struct rte_port_ring_writer_ras *p,
                         struct rte_mbuf *pkt);
...
static void *rte_port_ring_writer_ras_create(void *params, int socket_id,
                                             int is_ipv4) {
  struct rte_port_ring_writer_ras_params *conf = params;
  ...
  port->frag_tbl = rte_ip_frag_table_create(
      RTE_PORT_RAS_N_BUCKETS, RTE_PORT_RAS_N_ENTRIES_PER_BUCKET,
      RTE_PORT_RAS_N_ENTRIES, frag_cycles, socket_id);
...
static void *rte_port_ring_writer_ipv4_ras_create(void *params, int socket_id) {
  return rte_port_ring_writer_ras_create(params, socket_id, 1);
}

static void *rte_port_ring_writer_ipv6_ras_create(void *params, int socket_id) {
  return rte_port_ring_writer_ras_create(params, socket_id, 0);
}

static inline void send_burst(struct rte_port_ring_writer_ras *p) {
  uint32_t nb_tx;
...
static int rte_port_ring_writer_ras_tx(void *port, struct rte_mbuf *pkt) {
  struct rte_port_ring_writer_ras *p = port;
...
static int rte_port_ring_writer_ras_tx_bulk(void *port, struct rte_mbuf **pkts,
                                            uint64_t pkts_mask) {
  struct rte_port_ring_writer_ras *p = port;
...
static int rte_port_ring_writer_ras_flush(void *port) {
  struct rte_port_ring_writer_ras *p = port;
...
static int rte_port_ring_writer_ras_free(void *port) {
  struct rte_port_ring_writer_ras *p = port;
...
static int rte_port_ras_writer_stats_read(void *port,
                                          struct rte_port_out_stats *stats,
                                          int clear) {
  struct rte_port_ring_writer_ras *p = port;
