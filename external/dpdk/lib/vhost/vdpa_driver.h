 ...
 */
__rte_internal struct rte_vdpa_device *
 ...
 */
__rte_internal int rte_vdpa_unregister_device(struct rte_vdpa_device *dev);
 ...
 */
__rte_internal int rte_vhost_host_notifier_ctrl(int vid, uint16_t qid,
                                                bool enable);
 ...
 */
__rte_internal int rte_vdpa_relay_vring_used(int vid, uint16_t qid,
                                             void *vring_m);
