 ...
 */
__rte_experimental int rte_vhost_async_channel_register(int vid,
                                                        uint16_t queue_id);
 ...
 *  0 on success, -1 on failures
 */
__rte_experimental int rte_vhost_async_channel_unregister(int vid,
                                                          uint16_t queue_id);
 ...
 */
__rte_experimental uint16_t rte_vhost_poll_enqueue_completed(
    int vid, uint16_t queue_id, struct rte_mbuf **pkts, uint16_t count,
    int16_t dma_id, uint16_t vchan_id);
 ...
 */
__rte_experimental int rte_vhost_async_get_inflight(int vid, uint16_t queue_id);
 ...
 */
__rte_experimental uint16_t rte_vhost_clear_queue_thread_unsafe(
    int vid, uint16_t queue_id, struct rte_mbuf **pkts, uint16_t count,
    int16_t dma_id, uint16_t vchan_id);
 ...
 */
__rte_experimental int rte_vhost_async_dma_configure(int16_t dma_id,
                                                     uint16_t vchan_id);
