 ...
 */
static inline uint64_t rte_cyclecounter_cycles_to_ns(struct rte_timecounter *tc,
                                                     uint64_t cycles) {
  uint64_t ns;
 ...
 */
static inline uint64_t rte_timecounter_update(struct rte_timecounter *tc,
                                              uint64_t cycle_now) {
 ...
 */
static inline uint64_t rte_timespec_to_ns(const struct timespec *ts) {
 ...
 */
static inline struct timespec rte_ns_to_timespec(uint64_t nsec) {
