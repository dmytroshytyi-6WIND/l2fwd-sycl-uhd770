 ...
 */
__rte_experimental static inline void rte_prefetch0_write(const void *p) {
 ...
 * @param p Address to prefetch
 */
__rte_experimental static inline void rte_prefetch1_write(const void *p) {
 ...
 * @param p Address to prefetch
 */
__rte_experimental static inline void rte_prefetch2_write(const void *p) {
 ...
 *   Address to demote
 */
__rte_experimental static inline void rte_cldemote(const volatile void *p);
