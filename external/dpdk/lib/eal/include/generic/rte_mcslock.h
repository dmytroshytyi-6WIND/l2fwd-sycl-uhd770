 ...
 */
static inline void rte_mcslock_lock(rte_mcslock_t **msl, rte_mcslock_t *me) {
  rte_mcslock_t *prev;
 ...
 */
static inline void rte_mcslock_unlock(rte_mcslock_t **msl, rte_mcslock_t *me) {
 ...
 */
static inline int rte_mcslock_trylock(rte_mcslock_t **msl, rte_mcslock_t *me) {
  /* Init me node */
  __atomic_store_n(&me->next, NULL, __ATOMIC_RELAXED);
   ...
   */
  return __atomic_compare_exchange_n(msl, &expected, me, 0, __ATOMIC_ACQ_REL,
                                     __ATOMIC_RELAXED);
}
 ...
 */
static inline int rte_mcslock_is_locked(rte_mcslock_t *msl) {
