 ...
 */
static inline int rte_atomic16_cmpset(volatile uint16_t *dst, uint16_t exp,
                                      uint16_t src);
 ...
 */
static inline uint16_t rte_atomic16_exchange(volatile uint16_t *dst,
                                             uint16_t val);
 ...
 *   A pointer to the atomic counter.
 */
static inline void rte_atomic16_clear(rte_atomic16_t *v) { v->cnt = 0; }
 ...
 *   The value to be added to the counter.
 */
static inline void rte_atomic32_add(rte_atomic32_t *v, int32_t inc) {
  __sync_fetch_and_add(&v->cnt, inc);
}
 ...
 *   The value of v after the addition.
 */
static inline int32_t rte_atomic32_add_return(rte_atomic32_t *v, int32_t inc) {
  return __sync_add_and_fetch(&v->cnt, inc);
}
 ...
 *   The value of v after the subtraction.
 */
static inline int32_t rte_atomic32_sub_return(rte_atomic32_t *v, int32_t dec) {
  return __sync_sub_and_fetch(&v->cnt, dec);
}
 ...
 *   Non-zero on success; 0 on failure.
 */
static inline int rte_atomic64_cmpset(volatile uint64_t *dst, uint64_t exp,
                                      uint64_t src);
...
static inline void rte_atomic64_init(rte_atomic64_t *v) {
  ...
  while (success == 0) {
    tmp = v->cnt;
    success = rte_atomic64_cmpset((volatile uint64_t *)&v->cnt, tmp, 0);
  }
#endif
}
#endif
...
static inline int64_t rte_atomic64_read(rte_atomic64_t *v) {
  ...
  while (success == 0) {
    ...
    success = rte_atomic64_cmpset((volatile uint64_t *)&v->cnt, tmp, tmp);
  }
  return tmp;
#endif
}
...
static inline void rte_atomic64_set(rte_atomic64_t *v, int64_t new_value) {
  ...
  while (success == 0) {
    tmp = v->cnt;
    success = rte_atomic64_cmpset((volatile uint64_t *)&v->cnt, tmp, new_value);
  }
#endif
}
#endif
 ...
 *   The value of v after the addition.
 */
static inline int64_t rte_atomic64_add_return(rte_atomic64_t *v, int64_t inc);
 ...
 *   The value of v after the subtraction.
 */
static inline int64_t rte_atomic64_sub_return(rte_atomic64_t *v, int64_t dec);
...
rte_atomic128_cmp_exchange(rte_int128_t *dst, rte_int128_t *exp,
                           const rte_int128_t *src, unsigned int weak,
