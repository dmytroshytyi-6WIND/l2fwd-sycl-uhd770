 ...
 */
__rte_experimental static inline void rte_pflock_init(struct rte_pflock *pf) {
  pf->rd.in = 0;
  pf->rd.out = 0;
  pf->wr.in = 0;
  pf->wr.out = 0;
 ...
 */
__rte_experimental static inline void rte_pflock_read_lock(rte_pflock_t *pf) {
  uint16_t w;
 ...
 */
__rte_experimental static inline void rte_pflock_read_unlock(rte_pflock_t *pf) {
 ...
 *   A pointer to the pflock structure.
 */
__rte_experimental static inline void rte_pflock_write_lock(rte_pflock_t *pf) {
  uint16_t ticket, w;
