 ...
 *  read value
 */
static inline uint8_t rte_read8_relaxed(const volatile void *addr);
 ...
 *  read value
 */
static inline uint16_t rte_read16_relaxed(const volatile void *addr);
 ...
 *  read value
 */
static inline uint32_t rte_read32_relaxed(const volatile void *addr);
 ...
 *  read value
 */
static inline uint64_t rte_read64_relaxed(const volatile void *addr);
...
static inline void rte_write8_relaxed(uint8_t value, volatile void *addr);
 ...
 *  I/O memory address to write the value to
 */
static inline void rte_write16_relaxed(uint16_t value, volatile void *addr);
 ...
 *  I/O memory address to write the value to
 */
static inline void rte_write64_relaxed(uint64_t value, volatile void *addr);
 ...
 *  read value
 */
static inline uint8_t rte_read8(const volatile void *addr);
 ...
 *  read value
 */
static inline uint16_t rte_read16(const volatile void *addr);
 ...
 *  read value
 */
static inline uint64_t rte_read64(const volatile void *addr);
...
static inline void rte_write8(uint8_t value, volatile void *addr);
 ...
 *  I/O memory address to write the value to
 */
static inline void rte_write16(uint16_t value, volatile void *addr);
 ...
 *  I/O memory address to write the value to
 */
static inline void rte_write32(uint32_t value, volatile void *addr);
 ...
 *  I/O memory address to write the value to
 */
__rte_experimental static inline void rte_write32_wc(uint32_t value,
                                                     volatile void *addr);
...
static __rte_always_inline void rte_write8(uint8_t value, volatile void *addr) {
  rte_io_wmb();
