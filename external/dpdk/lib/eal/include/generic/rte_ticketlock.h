 ...
 */
static inline void rte_ticketlock_init(rte_ticketlock_t *tl) {
 ...
 *   A pointer to the ticketlock.
 */
static inline void rte_ticketlock_lock(rte_ticketlock_t *tl) {
 ...
 *   A pointer to the ticketlock.
 */
static inline void rte_ticketlock_unlock(rte_ticketlock_t *tl) {
 ...
 */
static inline int rte_ticketlock_trylock(rte_ticketlock_t *tl) {
  ...
  if (oldl.s.next == oldl.s.current) {
    if (__atomic_compare_exchange_n(&tl->tickets, &oldl.tickets, newl.tickets,
 ...
 */
static inline int rte_ticketlock_is_locked(rte_ticketlock_t *tl) {
...
#define RTE_TICKETLOCK_RECURSIVE_INITIALIZER                                   \
  { RTE_TICKETLOCK_INITIALIZER, TICKET_LOCK_INVALID_ID, 0 }
