...
/** Interrupt instance will not be shared between primary and secondary
 * processes. */
 ...
 */
typedef void (*rte_intr_unregister_callback_fn)(
    struct rte_intr_handle *intr_handle, void *cb_arg);
 ...
 *  - On failure, NULL.
 */
__rte_experimental struct rte_intr_handle *
 ...
 */
__rte_experimental enum rte_intr_handle_type
 ...
 */
__rte_internal int rte_intr_tls_epfd(void);
 ...
 *   - On failure, a negative value.
 */
__rte_internal int rte_intr_rx_ctl(struct rte_intr_handle *intr_handle,
 ...
 *   Pointer to the interrupt handle.
 */
__rte_internal void rte_intr_free_epoll_fd(struct rte_intr_handle *intr_handle);
 ...
 *   - On failure, a negative value.
 */
__rte_internal int rte_intr_efd_enable(struct rte_intr_handle *intr_handle,
                                       uint32_t nb_efd);
 ...
 *   Pointer to the interrupt handle.
 */
__rte_internal void rte_intr_efd_disable(struct rte_intr_handle *intr_handle);
 ...
 *   Pointer to the interrupt handle.
 */
__rte_internal int rte_intr_dp_is_en(struct rte_intr_handle *intr_handle);
 ...
 *   Pointer to the interrupt handle.
 */
__rte_internal int rte_intr_allow_others(struct rte_intr_handle *intr_handle);
 ...
 *   Pointer to the interrupt handle.
 */
__rte_internal int rte_intr_cap_multiple(struct rte_intr_handle *intr_handle);
 ...
 *  - On failure, NULL.
 */
__rte_internal struct rte_intr_handle *
 ...
 *  - On failure, a negative value and rte_errno is set.
 */
__rte_internal int rte_intr_dev_fd_set(struct rte_intr_handle *intr_handle,
                                       int fd);
 ...
 *  - On failure, a negative value and rte_errno is set.
 */
__rte_internal int rte_intr_max_intr_set(struct rte_intr_handle *intr_handle,
                                         int max_intr);
 ...
 *  - On failure, a negative value and rte_errno is set.
 */
__rte_internal int rte_intr_nb_efd_set(struct rte_intr_handle *intr_handle,
                                       int nb_efd);
 ...
 *  - On failure, a negative value and rte_errno is set.
 */
__rte_internal int rte_intr_efds_index_set(struct rte_intr_handle *intr_handle,
                                           int index, int fd);
 ...
 *  - On failure, a negative value and rte_errno is set.
 */
__rte_internal int rte_intr_elist_index_set(struct rte_intr_handle *intr_handle,
                                            int index,
 ...
 *  - On failure, a negative value and rte_errno is set.
 */
__rte_internal struct rte_epoll_event *
 ...
 *  - On failure, a negative value and rte_errno is set.
 */
__rte_internal int rte_intr_vec_list_alloc(struct rte_intr_handle *intr_handle,
 ...
 *  - On failure, a negative value and rte_errno is set.
 */
__rte_internal void rte_intr_vec_list_free(struct rte_intr_handle *intr_handle);
