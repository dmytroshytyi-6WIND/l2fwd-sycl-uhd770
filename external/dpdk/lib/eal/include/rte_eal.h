...
#define RTE_MAGIC                                                              \
  19820526 /**< Magic number written by the main partition when ready. */
...
#define RTE_MP_MAX_FD_NUM 32     /* The max amount of fds */
 ...
 *
 *   Calling this routine with a NULL value will reset the usage hook routine
 * and return the current value, which could be NULL.
 * @return
