...
/**
 *  Structure to hold heap statistics obtained from rte_malloc_get_socket_stats
 * function.
 */
...
void *rte_calloc_socket(const char *type, size_t num, size_t size,
                        unsigned align, int socket) __rte_alloc_size(2, 3);
