 ...
 */
int rte_strsplit(char *string, int stringlen, char **tokens, int maxtokens,
                 char delim);
 ...
 */
static inline size_t rte_strlcpy(char *dst, const char *src, size_t size) {
 ...
 * libc or libbsd copies of the function
 */
static inline size_t rte_strlcat(char *dst, const char *src, size_t size) {
