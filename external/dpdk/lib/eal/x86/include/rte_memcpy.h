 ...
 */
static __rte_always_inline void *rte_memcpy(void *dst, const void *src,
                                            size_t n);
 ...
 * locations should not overlap.
 */
static __rte_always_inline void rte_mov128blocks(uint8_t *dst,
...
static __rte_always_inline void *rte_memcpy_generic(void *dst, const void *src,
                                                    size_t n) {
...
static __rte_always_inline void rte_mov128blocks(uint8_t *dst,
  ...
  while (n >= 128) {
    ymm0 = _mm256_loadu_si256(
        (const __m256i *)(const void *)((const uint8_t *)src + 0 * 32));
    n -= 128;
    ymm1 = _mm256_loadu_si256(
        (const __m256i *)(const void *)((const uint8_t *)src + 1 * 32));
    ymm2 = _mm256_loadu_si256(
        (const __m256i *)(const void *)((const uint8_t *)src + 2 * 32));
    ymm3 = _mm256_loadu_si256(
        (const __m256i *)(const void *)((const uint8_t *)src + 3 * 32));
    src = (const uint8_t *)src + 128;
  ...
  __extension__({                                                              \
    ...
    while (len >= 128 + 16 - offset) {                                         \
      xmm0 = _mm_loadu_si128(                                                  \
          (const __m128i *)(const void *)((const uint8_t *)src - offset +      \
                                          0 * 16));                            \
      len -= 128;                                                              \
      ...
      xmm8 = _mm_loadu_si128(                                                  \
          (const __m128i *)(const void *)((const uint8_t *)src - offset +      \
                                          8 * 16));                            \
      src = (const uint8_t *)src + 128;                                        \
      _mm_storeu_si128((__m128i *)(void *)((uint8_t *)dst + 0 * 16),           \
                       _mm_alignr_epi8(xmm1, xmm0, offset));                   \
      _mm_storeu_si128((__m128i *)(void *)((uint8_t *)dst + 1 * 16),           \
                       _mm_alignr_epi8(xmm2, xmm1, offset));                   \
      _mm_storeu_si128((__m128i *)(void *)((uint8_t *)dst + 2 * 16),           \
                       _mm_alignr_epi8(xmm3, xmm2, offset));                   \
      _mm_storeu_si128((__m128i *)(void *)((uint8_t *)dst + 3 * 16),           \
                       _mm_alignr_epi8(xmm4, xmm3, offset));                   \
      _mm_storeu_si128((__m128i *)(void *)((uint8_t *)dst + 4 * 16),           \
                       _mm_alignr_epi8(xmm5, xmm4, offset));                   \
      _mm_storeu_si128((__m128i *)(void *)((uint8_t *)dst + 5 * 16),           \
                       _mm_alignr_epi8(xmm6, xmm5, offset));                   \
      _mm_storeu_si128((__m128i *)(void *)((uint8_t *)dst + 6 * 16),           \
                       _mm_alignr_epi8(xmm7, xmm6, offset));                   \
      _mm_storeu_si128((__m128i *)(void *)((uint8_t *)dst + 7 * 16),           \
...
static __rte_always_inline void *rte_memcpy_aligned(void *dst, const void *src,
                                                    size_t n) {
  void *ret = dst;
