...
unsigned eal_cpu_core_id(__rte_unused unsigned lcore_id) { return 0; }

static int eal_get_ncpus(void) {
  static int ncpu = -1;
...
unsigned eal_cpu_socket_id(__rte_unused unsigned cpu_id) { return 0; }
