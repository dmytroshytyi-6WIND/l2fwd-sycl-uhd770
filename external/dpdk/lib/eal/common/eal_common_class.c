...
void rte_class_register(struct rte_class *class) {
  RTE_VERIFY(class);
...
void rte_class_unregister(struct rte_class *class) {
...
static int cmp_class_name(const struct rte_class *class, const void *_name) {
