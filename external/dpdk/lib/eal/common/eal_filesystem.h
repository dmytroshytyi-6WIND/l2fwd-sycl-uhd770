...
static inline const char *eal_runtime_config_path(void) {
...
static inline const char *eal_mp_socket_path(void) {
  static char buffer[PATH_MAX]; /* static so auto-zeroed */
...
static inline const char *eal_get_fbarray_path(char *buffer, size_t buflen,
                                               const char *name) {
...
static inline const char *eal_hugepage_info_path(void) {
  static char buffer[PATH_MAX]; /* static so auto-zeroed */
...
static inline const char *eal_hugepage_data_path(void) {
  static char buffer[PATH_MAX]; /* static so auto-zeroed */
...
static inline const char *eal_get_hugefile_path(char *buffer, size_t buflen,
                                                const char *hugedir, int f_id) {
  snprintf(buffer, buflen, HUGEFILE_FMT, hugedir, eal_get_hugefile_prefix(),
           f_id);
  return buffer;
}
