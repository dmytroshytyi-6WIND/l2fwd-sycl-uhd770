...
const char *rte_eal_get_runtime_dir(void) { return runtime_dir; }
...
int rte_eal_has_hugepages(void) { return !internal_config.no_hugetlbfs; }

int rte_eal_has_pci(void) { return !internal_config.no_pci; }
