...
static __rte_always_inline void rte_memcpy_lt16(uint8_t *dst,
...
static __rte_always_inline void rte_memcpy_ge128(uint8_t *dst,
                                                 const uint8_t *src, size_t n) {
  do {
    rte_mov128(dst, src);
    src += 128;
...
static __rte_always_inline void rte_memcpy_ge64(uint8_t *dst,
                                                const uint8_t *src, size_t n) {
  do {
    rte_mov64(dst, src);
    src += 64;
