...
static __rte_always_inline uint64_t __rte_arm64_cntvct(void) {
  uint64_t tsc;
...
static __rte_always_inline uint64_t __rte_arm64_cntvct_precise(void) {
 ...
 */
static __rte_always_inline uint64_t rte_rdtsc(void) {
  return __rte_arm64_cntvct();
}
#else
/**
...
static __rte_always_inline uint64_t __rte_arm64_pmccntr(void) {
  uint64_t tsc;
...
static __rte_always_inline uint64_t rte_rdtsc_precise(void) {
  asm volatile("isb" : : : "memory");
  return rte_rdtsc();
}

static __rte_always_inline uint64_t rte_get_tsc_cycles(void) {
  return rte_rdtsc();
}
