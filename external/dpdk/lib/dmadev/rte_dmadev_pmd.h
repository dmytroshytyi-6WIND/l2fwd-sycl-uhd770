...
typedef int (*rte_dma_vchan_status_t)(const struct rte_dma_dev *dev,
                                      uint16_t vchan,
 ...
 *   NULL otherwise.
 */
__rte_internal struct rte_dma_dev *
 ...
 */
__rte_internal int rte_dma_pmd_release(const char *name);
