 ...
 */
void rte_pktmbuf_init(struct rte_mempool *mp, __rte_unused void *opaque_arg,
 ...
 */
static void __rte_pktmbuf_init_extmem(struct rte_mempool *mp, void *opaque_arg,
                                      void *_m, __rte_unused unsigned int i) {
  struct rte_mbuf *m = _m;
...
rte_pktmbuf_pool_create_by_ops(const char *name, unsigned int n,
  ...
  elt_size =
      sizeof(struct rte_mbuf) + (unsigned)priv_size + (unsigned)data_room_size;
...
void rte_pktmbuf_free_bulk(struct rte_mbuf **mbufs, unsigned int count) {
  ...
  for (idx = 0; idx < count; idx++) {
    ...
    do {
      m_next = m->next;
      __rte_pktmbuf_free_seg_via_array(m, pending, &nb_pending,
...
struct rte_mbuf *rte_pktmbuf_copy(const struct rte_mbuf *m,
                                  struct rte_mempool *mp, uint32_t off,
                                  uint32_t len) {
  ...
  while (len > 0) {
    ...
    rte_memcpy(rte_pktmbuf_mtod_offset(m_last, char *, m_last->data_len),
...
void rte_pktmbuf_dump(FILE *f, const struct rte_mbuf *m, unsigned dump_len) {
  ...
  while (m && nb_segs != 0) {
    ...
    fprintf(f, "  segment at %p, data=%p, len=%u, off=%u, refcnt=%u\n", m,
            rte_pktmbuf_mtod(m, void *), m->data_len, m->data_off,
...
const void *__rte_pktmbuf_read(const struct rte_mbuf *m, uint32_t off,
  ...
  while (len > 0) {
    ...
    if (copy_len > len)
      copy_len = len;
    rte_memcpy((char *)buf + buf_off, rte_pktmbuf_mtod_offset(seg, char *, off),
               copy_len);
    off = 0;
    buf_off += copy_len;
    len -= copy_len;
...
const char *rte_get_rx_ol_flag_name(uint64_t mask) {
  switch (mask) {
  case RTE_MBUF_F_RX_VLAN:
    return "RTE_MBUF_F_RX_VLAN";
  case RTE_MBUF_F_RX_RSS_HASH:
    return "RTE_MBUF_F_RX_RSS_HASH";
  case RTE_MBUF_F_RX_FDIR:
    return "RTE_MBUF_F_RX_FDIR";
  case RTE_MBUF_F_RX_L4_CKSUM_BAD:
    return "RTE_MBUF_F_RX_L4_CKSUM_BAD";
  case RTE_MBUF_F_RX_L4_CKSUM_GOOD:
  ...
  case RTE_MBUF_F_RX_OUTER_IP_CKSUM_BAD:
    return "RTE_MBUF_F_RX_OUTER_IP_CKSUM_BAD";
  case RTE_MBUF_F_RX_VLAN_STRIPPED:
    return "RTE_MBUF_F_RX_VLAN_STRIPPED";
  case RTE_MBUF_F_RX_IEEE1588_PTP:
    return "RTE_MBUF_F_RX_IEEE1588_PTP";
  case RTE_MBUF_F_RX_IEEE1588_TMST:
    return "RTE_MBUF_F_RX_IEEE1588_TMST";
  case RTE_MBUF_F_RX_FDIR_ID:
    return "RTE_MBUF_F_RX_FDIR_ID";
  case RTE_MBUF_F_RX_FDIR_FLX:
    return "RTE_MBUF_F_RX_FDIR_FLX";
  case RTE_MBUF_F_RX_QINQ_STRIPPED:
    return "RTE_MBUF_F_RX_QINQ_STRIPPED";
  case RTE_MBUF_F_RX_QINQ:
    return "RTE_MBUF_F_RX_QINQ";
  case RTE_MBUF_F_RX_LRO:
    return "RTE_MBUF_F_RX_LRO";
  case RTE_MBUF_F_RX_SEC_OFFLOAD:
    return "RTE_MBUF_F_RX_SEC_OFFLOAD";
  case RTE_MBUF_F_RX_SEC_OFFLOAD_FAILED:
    return "RTE_MBUF_F_RX_SEC_OFFLOAD_FAILED";
  case RTE_MBUF_F_RX_OUTER_L4_CKSUM_BAD:
    return "RTE_MBUF_F_RX_OUTER_L4_CKSUM_BAD";
  case RTE_MBUF_F_RX_OUTER_L4_CKSUM_GOOD:
    return "RTE_MBUF_F_RX_OUTER_L4_CKSUM_GOOD";
...
int rte_get_rx_ol_flag_list(uint64_t mask, char *buf, size_t buflen) {
  const struct flag_mask rx_flags[] = {
      ...
      {RTE_MBUF_F_RX_OUTER_IP_CKSUM_BAD, RTE_MBUF_F_RX_OUTER_IP_CKSUM_BAD,
       NULL},
      ...
      {RTE_MBUF_F_RX_SEC_OFFLOAD_FAILED, RTE_MBUF_F_RX_SEC_OFFLOAD_FAILED,
       NULL},
      {RTE_MBUF_F_RX_QINQ, RTE_MBUF_F_RX_QINQ, NULL},
      {RTE_MBUF_F_RX_OUTER_L4_CKSUM_BAD, RTE_MBUF_F_RX_OUTER_L4_CKSUM_MASK,
       NULL},
...
const char *rte_get_tx_ol_flag_name(uint64_t mask) {
  ...
  case RTE_MBUF_F_TX_TUNNEL_MPLSINUDP:
    return "RTE_MBUF_F_TX_TUNNEL_MPLSINUDP";
  ...
  case RTE_MBUF_F_TX_QINQ:
    return "RTE_MBUF_F_TX_QINQ";
  case RTE_MBUF_F_TX_MACSEC:
    return "RTE_MBUF_F_TX_MACSEC";
  case RTE_MBUF_F_TX_SEC_OFFLOAD:
    return "RTE_MBUF_F_TX_SEC_OFFLOAD";
  case RTE_MBUF_F_TX_UDP_SEG:
    return "RTE_MBUF_F_TX_UDP_SEG";
  case RTE_MBUF_F_TX_OUTER_UDP_CKSUM:
    return "RTE_MBUF_F_TX_OUTER_UDP_CKSUM";
  default:
    return NULL;
  }
}
...
int rte_get_tx_ol_flag_list(uint64_t mask, char *buf, size_t buflen) {
  const struct flag_mask tx_flags[] = {
      ...
      {RTE_MBUF_F_TX_L4_NO_CKSUM, RTE_MBUF_F_TX_L4_MASK,
