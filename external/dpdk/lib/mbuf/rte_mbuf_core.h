...
#define PKT_RX_OUTER_IP_CKSUM_BAD                                              \
  RTE_DEPRECATED(PKT_RX_OUTER_IP_CKSUM_BAD)                                    \
...
#define PKT_RX_VLAN_STRIPPED                                                   \
  RTE_DEPRECATED(PKT_RX_VLAN_STRIPPED)                                         \
...
#define PKT_RX_IP_CKSUM_MASK                                                   \
  RTE_DEPRECATED(PKT_RX_IP_CKSUM_MASK)                                         \
...
#define PKT_RX_IP_CKSUM_UNKNOWN                                                \
  RTE_DEPRECATED(PKT_RX_IP_CKSUM_UNKNOWN)                                      \
  RTE_MBUF_F_RX_IP_CKSUM_UNKNOWN
#define PKT_RX_IP_CKSUM_BAD                                                    \
  RTE_DEPRECATED(PKT_RX_IP_CKSUM_BAD)                                          \
  RTE_MBUF_F_RX_IP_CKSUM_BAD
#define PKT_RX_IP_CKSUM_GOOD                                                   \
  RTE_DEPRECATED(PKT_RX_IP_CKSUM_GOOD)                                         \
  RTE_MBUF_F_RX_IP_CKSUM_GOOD
#define PKT_RX_IP_CKSUM_NONE                                                   \
  RTE_DEPRECATED(PKT_RX_IP_CKSUM_NONE)                                         \
...
#define PKT_RX_L4_CKSUM_MASK                                                   \
  RTE_DEPRECATED(PKT_RX_L4_CKSUM_MASK)                                         \
...
#define PKT_RX_L4_CKSUM_UNKNOWN                                                \
  RTE_DEPRECATED(PKT_RX_L4_CKSUM_UNKNOWN)                                      \
  RTE_MBUF_F_RX_L4_CKSUM_UNKNOWN
#define PKT_RX_L4_CKSUM_BAD                                                    \
  RTE_DEPRECATED(PKT_RX_L4_CKSUM_BAD)                                          \
  RTE_MBUF_F_RX_L4_CKSUM_BAD
#define PKT_RX_L4_CKSUM_GOOD                                                   \
  RTE_DEPRECATED(PKT_RX_L4_CKSUM_GOOD)                                         \
  RTE_MBUF_F_RX_L4_CKSUM_GOOD
#define PKT_RX_L4_CKSUM_NONE                                                   \
  RTE_DEPRECATED(PKT_RX_L4_CKSUM_NONE)                                         \
  RTE_MBUF_F_RX_L4_CKSUM_NONE

/** RX IEEE1588 L2 Ethernet PT Packet. */
#define RTE_MBUF_F_RX_IEEE1588_PTP (1ULL << 9)
#define PKT_RX_IEEE1588_PTP                                                    \
  RTE_DEPRECATED(PKT_RX_IEEE1588_PTP)                                          \
  RTE_MBUF_F_RX_IEEE1588_PTP

/** RX IEEE1588 L2/L4 timestamped packet.*/
#define RTE_MBUF_F_RX_IEEE1588_TMST (1ULL << 10)
#define PKT_RX_IEEE1588_TMST                                                   \
  RTE_DEPRECATED(PKT_RX_IEEE1588_TMST)                                         \
  RTE_MBUF_F_RX_IEEE1588_TMST

/** FD id reported if FDIR match. */
#define RTE_MBUF_F_RX_FDIR_ID (1ULL << 13)
#define PKT_RX_FDIR_ID                                                         \
  RTE_DEPRECATED(PKT_RX_FDIR_ID)                                               \
  RTE_MBUF_F_RX_FDIR_ID

/** Flexible bytes reported if FDIR match. */
#define RTE_MBUF_F_RX_FDIR_FLX (1ULL << 14)
#define PKT_RX_FDIR_FLX                                                        \
  RTE_DEPRECATED(PKT_RX_FDIR_FLX)                                              \
...
#define PKT_RX_QINQ_STRIPPED                                                   \
  RTE_DEPRECATED(PKT_RX_QINQ_STRIPPED)                                         \
...
#define PKT_RX_SEC_OFFLOAD                                                     \
  RTE_DEPRECATED(PKT_RX_SEC_OFFLOAD)                                           \
...
#define PKT_RX_SEC_OFFLOAD_FAILED                                              \
  RTE_DEPRECATED(PKT_RX_SEC_OFFLOAD_FAILED)                                    \
...
#define PKT_RX_OUTER_L4_CKSUM_MASK                                             \
  RTE_DEPRECATED(PKT_RX_OUTER_L4_CKSUM_MASK)                                   \
...
#define PKT_RX_OUTER_L4_CKSUM_BAD                                              \
  RTE_DEPRECATED(PKT_RX_OUTER_L4_CKSUM_BAD)                                    \
  RTE_MBUF_F_RX_OUTER_L4_CKSUM_BAD
#define PKT_RX_OUTER_L4_CKSUM_GOOD                                             \
  RTE_DEPRECATED(PKT_RX_OUTER_L4_CKSUM_GOOD)                                   \
...
#define PKT_TX_OUTER_UDP_CKSUM                                                 \
  RTE_DEPRECATED(PKT_TX_OUTER_UDP_CKSUM)                                       \
...
#define PKT_TX_SEC_OFFLOAD                                                     \
  RTE_DEPRECATED(PKT_TX_SEC_OFFLOAD)                                           \
...
#define PKT_TX_TUNNEL_VXLAN                                                    \
  RTE_DEPRECATED(PKT_TX_TUNNEL_VXLAN)                                          \
  RTE_MBUF_F_TX_TUNNEL_VXLAN
#define PKT_TX_TUNNEL_GRE                                                      \
  RTE_DEPRECATED(PKT_TX_TUNNEL_GRE)                                            \
  RTE_MBUF_F_TX_TUNNEL_GRE
#define PKT_TX_TUNNEL_IPIP                                                     \
  RTE_DEPRECATED(PKT_TX_TUNNEL_IPIP)                                           \
  RTE_MBUF_F_TX_TUNNEL_IPIP
#define PKT_TX_TUNNEL_GENEVE                                                   \
  RTE_DEPRECATED(PKT_TX_TUNNEL_GENEVE)                                         \
  RTE_MBUF_F_TX_TUNNEL_GENEVE
#define PKT_TX_TUNNEL_MPLSINUDP                                                \
  RTE_DEPRECATED(PKT_TX_TUNNEL_MPLSINUDP)                                      \
  RTE_MBUF_F_TX_TUNNEL_MPLSINUDP
#define PKT_TX_TUNNEL_VXLAN_GPE                                                \
  RTE_DEPRECATED(PKT_TX_TUNNEL_VXLAN_GPE)                                      \
  RTE_MBUF_F_TX_TUNNEL_VXLAN_GPE
#define PKT_TX_TUNNEL_GTP                                                      \
  RTE_DEPRECATED(PKT_TX_TUNNEL_GTP)                                            \
  RTE_MBUF_F_TX_TUNNEL_GTP
#define PKT_TX_TUNNEL_IP                                                       \
  RTE_DEPRECATED(PKT_TX_TUNNEL_IP)                                             \
  RTE_MBUF_F_TX_TUNNEL_IP
#define PKT_TX_TUNNEL_UDP                                                      \
  RTE_DEPRECATED(PKT_TX_TUNNEL_UDP)                                            \
  RTE_MBUF_F_TX_TUNNEL_UDP
#define PKT_TX_TUNNEL_MASK                                                     \
  RTE_DEPRECATED(PKT_TX_TUNNEL_MASK)                                           \
...
#define PKT_TX_IEEE1588_TMST                                                   \
  RTE_DEPRECATED(PKT_TX_IEEE1588_TMST)                                         \
...
#define PKT_TX_TCP_CKSUM                                                       \
  RTE_DEPRECATED(PKT_TX_TCP_CKSUM)                                             \
  RTE_MBUF_F_TX_TCP_CKSUM
#define PKT_TX_SCTP_CKSUM                                                      \
  RTE_DEPRECATED(PKT_TX_SCTP_CKSUM)                                            \
  RTE_MBUF_F_TX_SCTP_CKSUM
#define PKT_TX_UDP_CKSUM                                                       \
  RTE_DEPRECATED(PKT_TX_UDP_CKSUM)                                             \
  RTE_MBUF_F_TX_UDP_CKSUM
...
#define PKT_TX_OUTER_IP_CKSUM                                                  \
  RTE_DEPRECATED(PKT_TX_OUTER_IP_CKSUM)                                        \
...
#define PKT_TX_OUTER_IPV4                                                      \
  RTE_DEPRECATED(PKT_TX_OUTER_IPV4)                                            \
...
#define PKT_TX_OFFLOAD_MASK                                                    \
  RTE_DEPRECATED(PKT_TX_OFFLOAD_MASK) RTE_MBUF_F_TX_OFFLOAD_MASK
...
enum {
  ...
  RTE_MBUF_TXOFLD_UNUSED_BITS =
      ...
      RTE_MBUF_L3_LEN_BITS - RTE_MBUF_L4_LEN_BITS - RTE_MBUF_TSO_SEGSZ_BITS -
