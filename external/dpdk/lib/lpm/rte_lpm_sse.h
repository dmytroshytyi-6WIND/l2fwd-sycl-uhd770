...
static inline void rte_lpm_lookupx4(const struct rte_lpm *lpm, xmm_t ip,
  ...
  if (unlikely((pt & RTE_LPM_VALID_EXT_ENTRY_BITMASK) ==
    ...
    i8.u32[0] =
        i8.u32[0] + (tbl[0] & 0x00FFFFFF) * RTE_LPM_TBL8_GROUP_NUM_ENTRIES;
  ...
  if (unlikely((pt >> 32 & RTE_LPM_VALID_EXT_ENTRY_BITMASK) ==
               RTE_LPM_VALID_EXT_ENTRY_BITMASK)) {
    i8.u32[1] =
        i8.u32[1] + (tbl[1] & 0x00FFFFFF) * RTE_LPM_TBL8_GROUP_NUM_ENTRIES;
  ...
  if (unlikely((pt2 & RTE_LPM_VALID_EXT_ENTRY_BITMASK) ==
               RTE_LPM_VALID_EXT_ENTRY_BITMASK)) {
    i8.u32[2] =
        i8.u32[2] + (tbl[2] & 0x00FFFFFF) * RTE_LPM_TBL8_GROUP_NUM_ENTRIES;
  ...
  if (unlikely((pt2 >> 32 & RTE_LPM_VALID_EXT_ENTRY_BITMASK) ==
               RTE_LPM_VALID_EXT_ENTRY_BITMASK)) {
    i8.u32[3] =
        i8.u32[3] + (tbl[3] & 0x00FFFFFF) * RTE_LPM_TBL8_GROUP_NUM_ENTRIES;
