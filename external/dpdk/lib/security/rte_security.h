 ...
 */
__rte_experimental static inline rte_security_dynfield_t *
rte_security_dynfield(struct rte_mbuf *mbuf) {
  return RTE_MBUF_DYNFIELD(mbuf, rte_security_dynfield_offset,
 ...
 */
__rte_experimental static inline bool
rte_security_dynfield_is_registered(void) {
  return rte_security_dynfield_offset >= 0;
}

/** Function to call PMD specific function pointer set_pkt_metadata() */
__rte_experimental extern int
...
__rte_experimental extern void *
