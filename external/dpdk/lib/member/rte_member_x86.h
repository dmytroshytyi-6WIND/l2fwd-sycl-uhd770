...
static inline int update_entry_search_avx(uint32_t bucket_id,
...
static inline int search_bucket_single_avx(uint32_t bucket_id,
                                           member_sig_t tmp_sig,
                                           struct member_ht_bucket *buckets,
                                           member_set_t *set_id) {
  uint32_t hitmask = _mm256_movemask_epi8((__m256i)_mm256_cmpeq_epi16(
...
search_bucket_multi_avx(uint32_t bucket_id, member_sig_t tmp_sig,
                        struct member_ht_bucket *buckets, uint32_t *counter,
