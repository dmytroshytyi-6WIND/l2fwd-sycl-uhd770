...
static void update_ipv4_tcp_headers(struct rte_mbuf *pkt, uint8_t ipid_delta,
...
int gso_tcp4_segment(struct rte_mbuf *pkt, uint16_t gso_size,
                     uint8_t ipid_delta, struct rte_mempool *direct_pool,
