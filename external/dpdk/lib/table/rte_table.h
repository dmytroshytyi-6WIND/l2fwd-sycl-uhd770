 ...
 *   0 on success, error code otherwise
 */
typedef int (*rte_table_op_entry_add)(void *table, void *key, void *entry,
 ...
 *   0 on success, error code otherwise
 */
typedef int (*rte_table_op_entry_delete)(void *table, void *key, int *key_found,
                                         void *entry);
 ...
 *   0 on success, error code otherwise
 */
typedef int (*rte_table_op_entry_add_bulk)(void *table, void **keys,
 ...
 *   0 on success, error code otherwise
 */
typedef int (*rte_table_op_entry_delete_bulk)(void *table, void **keys,
 ...
 *   0 on success, error code otherwise
 */
typedef int (*rte_table_op_lookup)(void *table, struct rte_mbuf **pkts,
                                   uint64_t pkts_mask,
                                   uint64_t *lookup_hit_mask, void **entries);
