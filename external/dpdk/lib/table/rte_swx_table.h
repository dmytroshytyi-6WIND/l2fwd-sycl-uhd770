...
typedef uint64_t (*rte_swx_table_footprint_get_t)(
    ...
    struct rte_swx_table_entry_list *entries, const char *args);
 ...
 */
typedef void *(*rte_swx_table_create_t)(
    struct rte_swx_table_params *params,
    struct rte_swx_table_entry_list *entries, const char *args, int numa_node);
 ...
 *   -ENOSPC: Table full.
 */
typedef int (*rte_swx_table_add_t)(void *table,
 ...
 *   -ENOSPC: Table full.
 */
typedef int (*rte_swx_table_delete_t)(void *table,
                                      struct rte_swx_table_entry *entry);
 ...
 */
typedef int (*rte_swx_table_lookup_t)(void *table, void *mailbox, uint8_t **key,
                                      uint64_t *action_id,
