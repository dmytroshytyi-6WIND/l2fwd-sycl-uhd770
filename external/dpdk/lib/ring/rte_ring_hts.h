...
rte_ring_mp_hts_enqueue_bulk(struct rte_ring *r, void *const *obj_table,
  ...
  return rte_ring_mp_hts_enqueue_bulk_elem(r, obj_table, sizeof(uintptr_t), n,
                                           free_space);
}
...
rte_ring_mc_hts_dequeue_bulk(struct rte_ring *r, void **obj_table,
  ...
  return rte_ring_mc_hts_dequeue_bulk_elem(r, obj_table, sizeof(uintptr_t), n,
                                           available);
}
...
rte_ring_mp_hts_enqueue_burst(struct rte_ring *r, void *const *obj_table,
                              unsigned int n, unsigned int *free_space) {
  return rte_ring_mp_hts_enqueue_burst_elem(r, obj_table, sizeof(uintptr_t), n,
                                            free_space);
}
...
rte_ring_mc_hts_dequeue_burst(struct rte_ring *r, void **obj_table,
                              unsigned int n, unsigned int *available) {
  return rte_ring_mc_hts_dequeue_burst_elem(r, obj_table, sizeof(uintptr_t), n,
                                            available);
}
