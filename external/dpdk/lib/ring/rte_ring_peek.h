...
rte_ring_enqueue_burst_elem_start(struct rte_ring *r, unsigned int n,
                                  unsigned int *free_space) {
  return __rte_ring_do_enqueue_start(r, n, RTE_RING_QUEUE_VARIABLE, free_space);
}
 ...
 *   The number of objects to add to the ring from the obj_table.
 */
static __rte_always_inline void rte_ring_enqueue_finish(struct rte_ring *r,
...
rte_ring_dequeue_bulk_start(struct rte_ring *r, void **obj_table,
  ...
  return rte_ring_dequeue_bulk_elem_start(r, obj_table, sizeof(uintptr_t), n,
                                          available);
}
...
rte_ring_dequeue_burst_start(struct rte_ring *r, void **obj_table,
                             unsigned int n, unsigned int *available) {
  return rte_ring_dequeue_burst_elem_start(r, obj_table, sizeof(uintptr_t), n,
                                           available);
}
 ...
 */
static __rte_always_inline void rte_ring_dequeue_elem_finish(struct rte_ring *r,
                                                             unsigned int n) {
  uint32_t tail;
 ...
 *   The number of objects to remove from the ring.
 */
static __rte_always_inline void rte_ring_dequeue_finish(struct rte_ring *r,
                                                        unsigned int n) {
