 ...
 */
static int rte_kvargs_tokenize(struct rte_kvargs *kvlist, const char *params) {
  char *str, *start;
 ...
 */
static int is_valid_key(const char *const valid[], const char *key_match) {
 ...
 * into a list of valid keys.
 */
static int check_for_valid_keys(struct rte_kvargs *kvlist,
 ...
 */
int rte_kvargs_process(const struct rte_kvargs *kvlist, const char *key_match,
