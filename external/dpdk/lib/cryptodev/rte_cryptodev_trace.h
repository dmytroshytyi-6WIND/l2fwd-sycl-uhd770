...
RTE_TRACE_POINT(rte_cryptodev_trace_configure,
...
RTE_TRACE_POINT(rte_cryptodev_trace_start,
                RTE_TRACE_POINT_ARGS(uint8_t dev_id, int rc),
                rte_trace_point_emit_u8(dev_id);
                rte_trace_point_emit_int(rc);)

RTE_TRACE_POINT(rte_cryptodev_trace_stop, RTE_TRACE_POINT_ARGS(uint8_t dev_id),
                rte_trace_point_emit_u8(dev_id);)

RTE_TRACE_POINT(rte_cryptodev_trace_close,
                RTE_TRACE_POINT_ARGS(uint8_t dev_id, int rc),
                rte_trace_point_emit_u8(dev_id);
                rte_trace_point_emit_int(rc);)

RTE_TRACE_POINT(rte_cryptodev_trace_queue_pair_setup,
...
RTE_TRACE_POINT(rte_cryptodev_trace_sym_session_pool_create,
...
RTE_TRACE_POINT(rte_cryptodev_trace_sym_session_create,
...
RTE_TRACE_POINT(rte_cryptodev_trace_asym_session_pool_create,
                RTE_TRACE_POINT_ARGS(const char *name, uint32_t nb_elts,
...
RTE_TRACE_POINT(rte_cryptodev_trace_asym_session_create,
...
RTE_TRACE_POINT(rte_cryptodev_trace_sym_session_free,
                RTE_TRACE_POINT_ARGS(struct rte_cryptodev_sym_session *sess),
                rte_trace_point_emit_ptr(sess);)

RTE_TRACE_POINT(rte_cryptodev_trace_asym_session_free,
                RTE_TRACE_POINT_ARGS(uint8_t dev_id, void *sess),
                rte_trace_point_emit_u8(dev_id);
                rte_trace_point_emit_ptr(sess);)

RTE_TRACE_POINT(rte_cryptodev_trace_sym_session_init,
                RTE_TRACE_POINT_ARGS(uint8_t dev_id,
                                     struct rte_cryptodev_sym_session *sess,
...
RTE_TRACE_POINT(rte_cryptodev_trace_sym_session_clear,
                RTE_TRACE_POINT_ARGS(uint8_t dev_id, void *sess),
                rte_trace_point_emit_u8(dev_id);
                rte_trace_point_emit_ptr(sess);)
