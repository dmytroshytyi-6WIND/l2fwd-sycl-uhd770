...
extern const char *rte_crypto_cipher_algorithm_strings[];
...
extern const char *rte_crypto_auth_algorithm_strings[];
...
struct rte_crypto_sym_xform {
  ...
  /**< next xform in chain */
  enum rte_crypto_sym_xform_type type; /**< xform type */
  RTE_STD_C11
  union {
 ...
 */
static inline void __rte_crypto_sym_op_reset(struct rte_crypto_sym_op *op) {
