...
RTE_TRACE_POINT_REGISTER(rte_cryptodev_trace_configure, lib.cryptodev.configure)

RTE_TRACE_POINT_REGISTER(rte_cryptodev_trace_start, lib.cryptodev.start)

RTE_TRACE_POINT_REGISTER(rte_cryptodev_trace_stop, lib.cryptodev.stop)

RTE_TRACE_POINT_REGISTER(rte_cryptodev_trace_close, lib.cryptodev.close)
