...
static inline uint32_t rte_min_pos_4_u16(uint16_t *x) {
  uint32_t pos0 = 0;
  uint32_t pos1 = 2;
 ...
 *
 */
static inline uint64_t rte_get_gcd64(uint64_t a, uint64_t b) {
  uint64_t c;
 ...
 */
static inline uint32_t rte_get_gcd(uint32_t a, uint32_t b) {
 ...
 *
 */
static inline uint32_t rte_get_lcd(uint32_t a, uint32_t b) {
