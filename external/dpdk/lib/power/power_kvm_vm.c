...
uint32_t power_kvm_vm_freqs(__rte_unused unsigned int lcore_id,
                            __rte_unused uint32_t *freqs,
                            __rte_unused uint32_t num) {
  RTE_LOG(ERR, POWER,
          "rte_power_freqs is not implemented "
          "for Virtual Machine Power Management\n");
  return -ENOTSUP;
}

uint32_t power_kvm_vm_get_freq(__rte_unused unsigned int lcore_id) {
  RTE_LOG(ERR, POWER,
          "rte_power_get_freq is not implemented "
          "for Virtual Machine Power Management\n");
  return -ENOTSUP;
}

int power_kvm_vm_set_freq(__rte_unused unsigned int lcore_id,
                          __rte_unused uint32_t index) {
  RTE_LOG(ERR, POWER,
          "rte_power_set_freq is not implemented "
          "for Virtual Machine Power Management\n");
  return -ENOTSUP;
}

static inline int send_msg(unsigned int lcore_id, uint32_t scale_direction) {
  int ret;
...
int power_kvm_vm_turbo_status(__rte_unused unsigned int lcore_id) {
  RTE_LOG(ERR, POWER,
          "rte_power_turbo_status is not implemented for Virtual Machine Power "
          "Management\n");
  return -ENOTSUP;
}
...
int power_kvm_vm_get_capabilities(
    __rte_unused unsigned int lcore_id,
    __rte_unused struct rte_power_core_capabilities *caps) {
  RTE_LOG(ERR, POWER,
          "rte_power_get_capabilities is not implemented for Virtual Machine "
          "Power Management\n");
  return -ENOTSUP;
}
