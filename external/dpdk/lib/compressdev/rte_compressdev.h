 ...
 */
__rte_experimental int rte_compressdev_socket_id(uint8_t dev_id);
 ...
 *   *ops* array.
 */
__rte_experimental uint16_t rte_compressdev_dequeue_burst(
    uint8_t dev_id, uint16_t qp_id, struct rte_comp_op **ops, uint16_t nb_ops);
 ...
 *   a *rte_comp_op*.
 */
__rte_experimental uint16_t rte_compressdev_enqueue_burst(
    uint8_t dev_id, uint16_t qp_id, struct rte_comp_op **ops, uint16_t nb_ops);
 ...
 *
 */
__rte_experimental int rte_compressdev_stream_create(
    uint8_t dev_id, const struct rte_comp_xform *xform, void **stream);
 ...
 */
__rte_experimental int rte_compressdev_private_xform_create(
    uint8_t dev_id, const struct rte_comp_xform *xform, void **private_xform);
