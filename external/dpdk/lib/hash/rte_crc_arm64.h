...
static inline uint32_t crc32c_arm64_u8(uint8_t data, uint32_t init_val) {
  __asm__ volatile("crc32cb %w[crc], %w[crc], %w[value]"
                   : [crc] "+r"(init_val)
                   : [value] "r"(data));
  return init_val;
}

static inline uint32_t crc32c_arm64_u16(uint16_t data, uint32_t init_val) {
  __asm__ volatile("crc32ch %w[crc], %w[crc], %w[value]"
                   : [crc] "+r"(init_val)
                   : [value] "r"(data));
  return init_val;
}

static inline uint32_t crc32c_arm64_u32(uint32_t data, uint32_t init_val) {
  __asm__ volatile("crc32cw %w[crc], %w[crc], %w[value]"
                   : [crc] "+r"(init_val)
                   : [value] "r"(data));
  return init_val;
}

static inline uint32_t crc32c_arm64_u64(uint64_t data, uint32_t init_val) {
  __asm__ volatile("crc32cx %w[crc], %w[crc], %x[value]"
                   : [crc] "+r"(init_val)
                   : [value] "r"(data));
  return init_val;
}
 ...
 *
 */
static inline void rte_hash_crc_set_alg(uint8_t alg) {
  switch (alg) {
  case CRC32_ARM64:
...
RTE_INIT(rte_hash_crc_init_alg) { rte_hash_crc_set_alg(CRC32_ARM64); }
 ...
 */
static inline uint32_t rte_hash_crc_1byte(uint8_t data, uint32_t init_val) {
