...
typedef void(rdline_validate_t)(struct rdline *rdl, const char *buf,
                                unsigned int size);
 ...
 */
__rte_experimental struct rdline *rdline_new(rdline_write_char_t *write_char,
 ...
 */
__rte_experimental void rdline_free(struct rdline *rdl);
 ...
 */
__rte_experimental size_t rdline_get_history_buffer_size(struct rdline *rdl);

/**
 * Get the opaque pointer supplied on struct rdline creation.
 */
__rte_experimental void *rdline_get_opaque(struct rdline *rdl);
