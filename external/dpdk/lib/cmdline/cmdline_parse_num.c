...
static inline int add_to_res(unsigned int c, uint64_t *res, unsigned int base) {
  /* overflow */
...
/* parse an int */
int cmdline_parse_num(cmdline_parse_token_hdr_t *tk, const char *srcbuf,
...
/* parse an int */
int cmdline_get_help_num(cmdline_parse_token_hdr_t *tk, char *dstbuf,
                         unsigned int size) {
  struct cmdline_token_num_data nd;
  int ret;
