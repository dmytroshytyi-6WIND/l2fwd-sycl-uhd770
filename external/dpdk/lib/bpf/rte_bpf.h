...
struct rte_bpf_xsym {
  ...
  union {
    struct {
      uint64_t (*val)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t);
      uint32_t nb_args;
 ...
 */
__rte_experimental void rte_bpf_dump(FILE *f, const struct ebpf_insn *buf,
                                     uint32_t len);
 ...
 */
__rte_experimental struct rte_bpf_prm *
