...
static void cmd_show_vm_parsed(void *parsed_result, struct cmdline *cl,
...
cmdline_parse_token_string_t cmd_vm_show =
    TOKEN_STRING_INITIALIZER(struct cmd_show_vm_result, show_vm, "show_vm");
cmdline_parse_token_string_t cmd_show_vm_name =
    TOKEN_STRING_INITIALIZER(struct cmd_show_vm_result, vm_name, NULL);
...
static void cmd_set_pcpu_parsed(void *parsed_result, struct cmdline *cl,
                                __rte_unused void *data) {
  struct cmd_set_pcpu_result *res = parsed_result;

  if (set_pcpu(res->vm_name, res->vcpu, res->core) == 0)
    cmdline_printf(cl,
                   "Pinned vCPU(%" PRId8 ") to pCPU core "
                   "%" PRId8 ")\n",
                   res->vcpu, res->core);
  else
    cmdline_printf(cl,
                   "Unable to pin vCPU(%" PRId8 ") to pCPU core "
                   "%" PRId8 ")\n",
                   res->vcpu, res->core);
}

cmdline_parse_token_string_t cmd_set_pcpu =
    TOKEN_STRING_INITIALIZER(struct cmd_set_pcpu_result, set_pcpu, "set_pcpu");
cmdline_parse_token_string_t cmd_set_pcpu_vm_name =
    TOKEN_STRING_INITIALIZER(struct cmd_set_pcpu_result, vm_name, NULL);
cmdline_parse_token_num_t set_pcpu_vcpu =
    TOKEN_NUM_INITIALIZER(struct cmd_set_pcpu_result, vcpu, RTE_UINT8);
cmdline_parse_token_num_t set_pcpu_core =
    TOKEN_NUM_INITIALIZER(struct cmd_set_pcpu_result, core, RTE_UINT64);
...
static void cmd_vm_op_parsed(void *parsed_result, struct cmdline *cl,
                             __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_vm_op =
    TOKEN_STRING_INITIALIZER(struct cmd_vm_op_result, op_vm, "add_vm#rm_vm");
cmdline_parse_token_string_t cmd_vm_name =
    TOKEN_STRING_INITIALIZER(struct cmd_vm_op_result, vm_name, NULL);
...
static void cmd_channels_op_parsed(void *parsed_result, struct cmdline *cl,
                                   __rte_unused void *data) {
  ...
  while (1) {
    ...
    if (channel_num == RTE_MAX_LCORE) {
      cmdline_printf(cl,
                     ...
                     channel_num, RTE_MAX_LCORE, res->vm_name);
      return;
    }
  ...
  channels_added = add_channels(res->vm_name, channel_list, num_channels);
  cmdline_printf(cl, "Enabled %d channels for '%s'\n", channels_added,
                 res->vm_name);
}

cmdline_parse_token_string_t cmd_channels_op =
    TOKEN_STRING_INITIALIZER(struct cmd_channels_op_result, op, "add_channels");
cmdline_parse_token_string_t cmd_channels_vm_name =
    TOKEN_STRING_INITIALIZER(struct cmd_channels_op_result, vm_name, NULL);
cmdline_parse_token_string_t cmd_channels_list =
    TOKEN_STRING_INITIALIZER(struct cmd_channels_op_result, channel_list, NULL);
...
static void cmd_set_query_parsed(void *parsed_result,
...
cmdline_parse_token_string_t cmd_set_query = TOKEN_STRING_INITIALIZER(
    struct cmd_set_query_result, set_query, "set_query");
cmdline_parse_token_string_t cmd_set_query_vm_name =
    TOKEN_STRING_INITIALIZER(struct cmd_set_query_result, vm_name, NULL);
cmdline_parse_token_string_t cmd_set_query_status = TOKEN_STRING_INITIALIZER(
    struct cmd_set_query_result, query_status, "enable#disable");

cmdline_parse_inst_t cmd_set_query_set = {
    .f = cmd_set_query_parsed,
    .data = NULL,
    .help_str =
        "set_query <vm_name> <enable|disable>, allow or disallow queries"
...
static void cmd_channels_status_op_parsed(void *parsed_result,
                                          struct cmdline *cl,
                                          __rte_unused void *data) {
  ...
  changed =
      set_channel_status(res->vm_name, channel_list, num_channels, status);
  cmdline_printf(cl,
                 "Updated status of %d channels "
                 "for VM '%s'\n",
                 changed, res->vm_name);
...
cmdline_parse_token_string_t cmd_channels_status_op = TOKEN_STRING_INITIALIZER(
    struct cmd_channels_status_op_result, op, "set_channel_status");
cmdline_parse_token_string_t cmd_channels_status_vm_name =
    TOKEN_STRING_INITIALIZER(struct cmd_channels_status_op_result, vm_name,
                             NULL);
cmdline_parse_token_string_t cmd_channels_status_list =
    TOKEN_STRING_INITIALIZER(struct cmd_channels_status_op_result, channel_list,
                             NULL);
cmdline_parse_token_string_t cmd_channels_status = TOKEN_STRING_INITIALIZER(
    struct cmd_channels_status_op_result, status, "enabled#disabled");
...
static void cmd_show_cpu_freq_parsed(void *parsed_result, struct cmdline *cl,
                                     __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_show_cpu_freq = TOKEN_STRING_INITIALIZER(
    struct cmd_show_cpu_freq_result, show_cpu_freq, "show_cpu_freq");

cmdline_parse_token_num_t cmd_show_cpu_freq_core_num =
    TOKEN_NUM_INITIALIZER(struct cmd_show_cpu_freq_result, core_num, RTE_UINT8);
...
static void cmd_set_cpu_freq_parsed(void *parsed_result, struct cmdline *cl,
                                    __rte_unused void *data) {
  int ret = -1;
...
cmdline_parse_token_string_t cmd_set_cpu_freq = TOKEN_STRING_INITIALIZER(
    struct cmd_set_cpu_freq_result, set_cpu_freq, "set_cpu_freq");
cmdline_parse_token_num_t cmd_set_cpu_freq_core_num =
    TOKEN_NUM_INITIALIZER(struct cmd_set_cpu_freq_result, core_num, RTE_UINT8);
cmdline_parse_token_string_t cmd_set_cpu_freq_cmd_cmd =
    TOKEN_STRING_INITIALIZER(struct cmd_set_cpu_freq_result, cmd,
