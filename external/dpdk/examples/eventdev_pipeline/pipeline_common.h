...
static __rte_always_inline void exchange_mac(struct rte_mbuf *m) {
...
static __rte_always_inline void work(void) {
...
static __rte_always_inline void schedule_devices(unsigned int lcore_id) {
