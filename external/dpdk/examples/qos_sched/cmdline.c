...
static void cmd_help_parsed(__rte_unused void *parsed_result,
  ...
  cmdline_printf(
      ...
      "    stats port X subport Y                    : Show stats of a "
      "specific subport.\n"
      "    stats port X subport Y pipe Z             : Show stats of a "
      "specific pipe.\n"
      "\nAverage queue size:\n"
      "    qavg port X subport Y                     : Show average queue size "
      "per subport.\n"
      "    qavg port X subport Y tc Z                : Show average queue size "
      "per subport and TC.\n"
      "    qavg port X subport Y pipe Z              : Show average queue size "
      "per pipe.\n"
      "    qavg port X subport Y pipe Z tc A         : Show average queue size "
      "per pipe and TC.\n"
      "    qavg port X subport Y pipe Z tc A q B     : Show average queue size "
      "of a specific queue.\n"
      "    qavg [n|period] X                     : Set number of times and "
      "period (us).\n\n");
}
...
cmdline_parse_token_string_t cmd_setqavg_qavg_string =
    TOKEN_STRING_INITIALIZER(struct cmd_setqavg_result, qavg_string, "qavg");
...
cmdline_parse_token_num_t cmd_setqavg_number =
    TOKEN_NUM_INITIALIZER(struct cmd_setqavg_result, number, RTE_UINT32);
...
cmdline_parse_token_string_t cmd_appstats_stats_string =
    TOKEN_STRING_INITIALIZER(struct cmd_appstats_result, stats_string, "stats");
cmdline_parse_token_string_t cmd_appstats_app_string =
    TOKEN_STRING_INITIALIZER(struct cmd_appstats_result, app_string, "app");
...
static void cmd_subportstats_parsed(void *parsed_result,
  ...
  if (subport_stat(res->port_number, res->subport_number) < 0)
    printf("\nStats not available for these parameters. Check that both the "
           "port and subport are correct.\n\n");
}
...
cmdline_parse_token_num_t cmd_subportstats_subport_number =
    TOKEN_NUM_INITIALIZER(struct cmd_subportstats_result, subport_number,
                          RTE_UINT32);
cmdline_parse_token_num_t cmd_subportstats_port_number = TOKEN_NUM_INITIALIZER(
    struct cmd_subportstats_result, port_number, RTE_UINT16);
...
cmdline_parse_token_string_t cmd_pipestats_port_string =
    TOKEN_STRING_INITIALIZER(struct cmd_pipestats_result, port_string, "port");
cmdline_parse_token_num_t cmd_pipestats_port_number =
    TOKEN_NUM_INITIALIZER(struct cmd_pipestats_result, port_number, RTE_UINT16);
cmdline_parse_token_string_t cmd_pipestats_subport_string =
    TOKEN_STRING_INITIALIZER(struct cmd_pipestats_result, subport_string,
                             "subport");
cmdline_parse_token_num_t cmd_pipestats_subport_number = TOKEN_NUM_INITIALIZER(
    struct cmd_pipestats_result, subport_number, RTE_UINT32);
cmdline_parse_token_string_t cmd_pipestats_pipe_string =
    TOKEN_STRING_INITIALIZER(struct cmd_pipestats_result, pipe_string, "pipe");
cmdline_parse_token_num_t cmd_pipestats_pipe_number =
    TOKEN_NUM_INITIALIZER(struct cmd_pipestats_result, pipe_number, RTE_UINT32);
...
static void cmd_avg_q_parsed(void *parsed_result,
  ...
  if (qavg_q(res->port_number, res->subport_number, res->pipe_number,
             res->tc_number, res->q_number) < 0)
    printf("\nStats not available for these parameters. Check that both the "
           "port and subport are correct.\n\n");
}

cmdline_parse_token_string_t cmd_avg_q_qavg_string =
    TOKEN_STRING_INITIALIZER(struct cmd_avg_q_result, qavg_string, "qavg");
cmdline_parse_token_string_t cmd_avg_q_port_string =
    TOKEN_STRING_INITIALIZER(struct cmd_avg_q_result, port_string, "port");
cmdline_parse_token_num_t cmd_avg_q_port_number =
    TOKEN_NUM_INITIALIZER(struct cmd_avg_q_result, port_number, RTE_UINT16);
...
cmdline_parse_token_num_t cmd_avg_q_subport_number =
    TOKEN_NUM_INITIALIZER(struct cmd_avg_q_result, subport_number, RTE_UINT32);
cmdline_parse_token_string_t cmd_avg_q_pipe_string =
    TOKEN_STRING_INITIALIZER(struct cmd_avg_q_result, pipe_string, "pipe");
cmdline_parse_token_num_t cmd_avg_q_pipe_number =
    TOKEN_NUM_INITIALIZER(struct cmd_avg_q_result, pipe_number, RTE_UINT32);
cmdline_parse_token_string_t cmd_avg_q_tc_string =
    TOKEN_STRING_INITIALIZER(struct cmd_avg_q_result, tc_string, "tc");
cmdline_parse_token_num_t cmd_avg_q_tc_number =
    TOKEN_NUM_INITIALIZER(struct cmd_avg_q_result, tc_number, RTE_UINT8);
cmdline_parse_token_string_t cmd_avg_q_q_string =
    TOKEN_STRING_INITIALIZER(struct cmd_avg_q_result, q_string, "q");
cmdline_parse_token_num_t cmd_avg_q_q_number =
    TOKEN_NUM_INITIALIZER(struct cmd_avg_q_result, q_number, RTE_UINT8);
...
static void cmd_avg_tcpipe_parsed(void *parsed_result,
  ...
  if (qavg_tcpipe(res->port_number, res->subport_number, res->pipe_number,
                  res->tc_number) < 0)
    printf("\nStats not available for these parameters. Check that both the "
           "port and subport are correct.\n\n");
}
...
cmdline_parse_token_string_t cmd_avg_tcpipe_qavg_string =
    TOKEN_STRING_INITIALIZER(struct cmd_avg_tcpipe_result, qavg_string, "qavg");
cmdline_parse_token_string_t cmd_avg_tcpipe_port_string =
    TOKEN_STRING_INITIALIZER(struct cmd_avg_tcpipe_result, port_string, "port");
cmdline_parse_token_num_t cmd_avg_tcpipe_port_number = TOKEN_NUM_INITIALIZER(
    struct cmd_avg_tcpipe_result, port_number, RTE_UINT16);
cmdline_parse_token_string_t cmd_avg_tcpipe_subport_string =
    TOKEN_STRING_INITIALIZER(struct cmd_avg_tcpipe_result, subport_string,
                             "subport");
cmdline_parse_token_num_t cmd_avg_tcpipe_subport_number = TOKEN_NUM_INITIALIZER(
    struct cmd_avg_tcpipe_result, subport_number, RTE_UINT32);
cmdline_parse_token_string_t cmd_avg_tcpipe_pipe_string =
    TOKEN_STRING_INITIALIZER(struct cmd_avg_tcpipe_result, pipe_string, "pipe");
cmdline_parse_token_num_t cmd_avg_tcpipe_pipe_number = TOKEN_NUM_INITIALIZER(
    struct cmd_avg_tcpipe_result, pipe_number, RTE_UINT32);
cmdline_parse_token_string_t cmd_avg_tcpipe_tc_string =
    TOKEN_STRING_INITIALIZER(struct cmd_avg_tcpipe_result, tc_string, "tc");
cmdline_parse_token_num_t cmd_avg_tcpipe_tc_number =
    TOKEN_NUM_INITIALIZER(struct cmd_avg_tcpipe_result, tc_number, RTE_UINT8);
...
cmdline_parse_token_string_t cmd_avg_pipe_qavg_string =
    TOKEN_STRING_INITIALIZER(struct cmd_avg_pipe_result, qavg_string, "qavg");
cmdline_parse_token_string_t cmd_avg_pipe_port_string =
    TOKEN_STRING_INITIALIZER(struct cmd_avg_pipe_result, port_string, "port");
cmdline_parse_token_num_t cmd_avg_pipe_port_number =
    TOKEN_NUM_INITIALIZER(struct cmd_avg_pipe_result, port_number, RTE_UINT16);
cmdline_parse_token_string_t cmd_avg_pipe_subport_string =
    TOKEN_STRING_INITIALIZER(struct cmd_avg_pipe_result, subport_string,
                             "subport");
cmdline_parse_token_num_t cmd_avg_pipe_subport_number = TOKEN_NUM_INITIALIZER(
    struct cmd_avg_pipe_result, subport_number, RTE_UINT32);
cmdline_parse_token_string_t cmd_avg_pipe_pipe_string =
    TOKEN_STRING_INITIALIZER(struct cmd_avg_pipe_result, pipe_string, "pipe");
cmdline_parse_token_num_t cmd_avg_pipe_pipe_number =
    TOKEN_NUM_INITIALIZER(struct cmd_avg_pipe_result, pipe_number, RTE_UINT32);
...
cmdline_parse_token_string_t cmd_avg_tcsubport_port_string =
    TOKEN_STRING_INITIALIZER(struct cmd_avg_tcsubport_result, port_string,
                             "port");
cmdline_parse_token_num_t cmd_avg_tcsubport_port_number = TOKEN_NUM_INITIALIZER(
    struct cmd_avg_tcsubport_result, port_number, RTE_UINT16);
...
cmdline_parse_token_string_t cmd_avg_tcsubport_tc_string =
    TOKEN_STRING_INITIALIZER(struct cmd_avg_tcsubport_result, tc_string, "tc");
cmdline_parse_token_num_t cmd_avg_tcsubport_tc_number = TOKEN_NUM_INITIALIZER(
    struct cmd_avg_tcsubport_result, tc_number, RTE_UINT8);
...
cmdline_parse_token_string_t cmd_avg_subport_port_string =
    TOKEN_STRING_INITIALIZER(struct cmd_avg_subport_result, port_string,
                             "port");
cmdline_parse_token_num_t cmd_avg_subport_port_number = TOKEN_NUM_INITIALIZER(
    struct cmd_avg_subport_result, port_number, RTE_UINT16);
