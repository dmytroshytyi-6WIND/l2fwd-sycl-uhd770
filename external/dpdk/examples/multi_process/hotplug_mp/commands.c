...
static void cmd_dev_attach_parsed(void *parsed_result, struct cmdline *cl,
...
cmdline_parse_token_string_t cmd_dev_attach_attach =
    TOKEN_STRING_INITIALIZER(struct cmd_dev_attach_result, attach, "attach");
...
static void cmd_dev_detach_parsed(void *parsed_result, struct cmdline *cl,
                                  __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_dev_detach_detach =
    TOKEN_STRING_INITIALIZER(struct cmd_dev_detach_result, detach, "detach");
