...
/* timer0 callback. 8< */
static void timer0_cb(__rte_unused struct rte_timer *tim,
...
/* timer1 callback. 8< */
static void timer1_cb(__rte_unused struct rte_timer *tim,
                      __rte_unused void *arg) {
  unsigned lcore_id = rte_lcore_id();
  uint64_t hz;
...
static __rte_noreturn int lcore_mainloop(__rte_unused void *arg) {
