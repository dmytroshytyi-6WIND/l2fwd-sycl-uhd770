...
struct kni *kni_find(const char *name) {
  struct kni *kni;
...
struct kni *kni_create(const char *name __rte_unused,
                       struct kni_params *params __rte_unused) {
  return NULL;
}

void kni_handle_request(void) { return; }
...
struct kni *kni_create(const char *name, struct kni_params *params) {
