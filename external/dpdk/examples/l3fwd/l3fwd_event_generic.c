...
static uint32_t l3fwd_event_device_setup_generic(void) {
...
static void l3fwd_event_port_setup_generic(void) {
  struct l3fwd_event_resources *evt_rsrc = l3fwd_get_eventdev_rsrc();
...
static void l3fwd_event_queue_setup_generic(uint32_t event_queue_cfg) {
  struct l3fwd_event_resources *evt_rsrc = l3fwd_get_eventdev_rsrc();
  uint8_t event_d_id = evt_rsrc->event_d_id;
...
static void l3fwd_rx_tx_adapter_setup_generic(void) {
  struct l3fwd_event_resources *evt_rsrc = l3fwd_get_eventdev_rsrc();
