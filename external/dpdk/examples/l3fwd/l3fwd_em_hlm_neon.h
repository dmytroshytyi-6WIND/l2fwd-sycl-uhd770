...
static inline void get_ipv4_5tuple(struct rte_mbuf *m0, int32x4_t mask0,
...
static inline void get_ipv6_5tuple(struct rte_mbuf *m0, int32x4_t mask0,
                                   int32x4_t mask1,
  ...
  int32x4_t tmpdata1 = vld1q_s32(rte_pktmbuf_mtod_offset(
      m0, int *,
      sizeof(struct rte_ether_hdr) +
          offsetof(struct rte_ipv6_hdr, payload_len) + 8));

  int32x4_t tmpdata2 = vld1q_s32(rte_pktmbuf_mtod_offset(
      m0, int *,
      sizeof(struct rte_ether_hdr) +
