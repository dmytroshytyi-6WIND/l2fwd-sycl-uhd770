...
static int parse_interim_xts_enc_dec(const char *key, __rte_unused char *text,
...
static int parse_test_xts_writeback(struct fips_val *val) {
...
static int rsp_test_xts_check(struct fips_val *val) {
