...
struct hash_size_conversion {
  ...
  enum rte_crypto_auth_algorithm algo;
    ...
    {"20", RTE_CRYPTO_AUTH_SHA1_HMAC},   {"28", RTE_CRYPTO_AUTH_SHA224_HMAC},
    {"32", RTE_CRYPTO_AUTH_SHA256_HMAC}, {"48", RTE_CRYPTO_AUTH_SHA384_HMAC},
    {"64", RTE_CRYPTO_AUTH_SHA512_HMAC},
};

static int parse_interim_algo(__rte_unused const char *key, char *text,
...
static int parse_test_hmac_writeback(struct fips_val *val) {
...
static int rsp_test_hmac_check(struct fips_val *val) {
