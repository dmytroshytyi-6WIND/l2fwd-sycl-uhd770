...
struct plain_hash_size_conversion {
  ...
  enum rte_crypto_auth_algorithm algo;
    ...
    {"20", RTE_CRYPTO_AUTH_SHA1},   {"28", RTE_CRYPTO_AUTH_SHA224},
    {"32", RTE_CRYPTO_AUTH_SHA256}, {"48", RTE_CRYPTO_AUTH_SHA384},
...
static int parse_test_sha_writeback(struct fips_val *val) // !
{
...
static int rsp_test_sha_check(struct fips_val *val) {
