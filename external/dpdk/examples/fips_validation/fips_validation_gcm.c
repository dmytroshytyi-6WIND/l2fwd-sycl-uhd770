 ...
 **/
static int parser_read_gcm_pt_len(const char *key, char *src,
...
static int parse_gcm_aad_str(const char *key, char *src,
                             __rte_unused struct fips_val *val) {
...
static int parse_gcm_pt_ct_str(const char *key, char *src,
                               struct fips_val *val) {
...
struct fips_test_callback gcm_dec_vectors[] = {
    ...
    {TAG_STR, parse_uint8_known_len_hex_str, &vec.aead.digest},
...
struct fips_test_callback gcm_interim_vectors[] = {
    ...
    {TAGLEN_STR, parser_read_uint32_bit_val, &vec.aead.digest},
    {NULL, NULL, NULL} /**< end pointer */
};
...
static int parse_test_gcm_writeback(struct fips_val *val) {
