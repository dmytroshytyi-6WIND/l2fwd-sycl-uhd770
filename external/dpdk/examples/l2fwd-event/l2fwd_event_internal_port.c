...
static void l2fwd_event_port_setup_internal_port(struct l2fwd_resources *rsrc) {
  struct l2fwd_event_resources *evt_rsrc = rsrc->evt_rsrc;
...
static void l2fwd_event_queue_setup_internal_port(struct l2fwd_resources *rsrc,
