...
static void cmd_single_parsed(__rte_unused void *parsed_result,
                              struct cmdline *cl, __rte_unused void *data) {
  cmdline_printf(cl, "Single word command parsed!\n");
}

cmdline_parse_token_string_t cmd_single_tok =
    TOKEN_STRING_INITIALIZER(struct cmd_single_result, single, "single");
...
static void cmd_single_long_parsed(__rte_unused void *parsed_result,
                                   struct cmdline *cl,
                                   __rte_unused void *data) {
  cmdline_printf(cl, "Single long word command parsed!\n");
}

cmdline_parse_token_string_t cmd_single_long_tok = TOKEN_STRING_INITIALIZER(
    struct cmd_single_long_result, single_long, "single_long");
...
static void cmd_autocomplete_1_parsed(__rte_unused void *parsed_result,
                                      struct cmdline *cl,
                                      __rte_unused void *data) {
  cmdline_printf(cl, "Autocomplete command 1 parsed!\n");
}

cmdline_parse_token_string_t cmd_autocomplete_1_tok = TOKEN_STRING_INITIALIZER(
    struct cmd_autocomplete_1_result, token, "autocomplete_1");
...
static void cmd_autocomplete_2_parsed(__rte_unused void *parsed_result,
                                      struct cmdline *cl,
                                      __rte_unused void *data) {
  cmdline_printf(cl, "Autocomplete command 2 parsed!\n");
}

cmdline_parse_token_string_t cmd_autocomplete_2_tok = TOKEN_STRING_INITIALIZER(
    struct cmd_autocomplete_2_result, token, "autocomplete_2");
...
static void cmd_num_parsed(void *parsed_result, struct cmdline *cl,
                           __rte_unused void *data) {
...
static void cmd_ambig_1_parsed(__rte_unused void *parsed_result,
                               struct cmdline *cl, __rte_unused void *data) {
  cmdline_printf(cl, "Command 1 parsed!\n");
}

cmdline_parse_token_string_t cmd_ambig_common_1 = TOKEN_STRING_INITIALIZER(
    struct cmd_ambig_result_1, common_part, "ambiguous");
cmdline_parse_token_string_t cmd_ambig_ambig_1 = TOKEN_STRING_INITIALIZER(
    struct cmd_ambig_result_1, ambig_part, "first#ambiguous#ambiguous2");
...
static void cmd_ambig_2_parsed(__rte_unused void *parsed_result,
                               struct cmdline *cl, __rte_unused void *data) {
  cmdline_printf(cl, "Command 2 parsed!\n");
}

cmdline_parse_token_string_t cmd_ambig_common_2 = TOKEN_STRING_INITIALIZER(
    struct cmd_ambig_result_2, common_part, "ambiguous");
cmdline_parse_token_string_t cmd_ambig_ambig_2 = TOKEN_STRING_INITIALIZER(
    struct cmd_ambig_result_2, ambig_part, "second#ambiguous#ambiguous2");
...
static void cmd_get_history_bufsize_parsed(__rte_unused void *parsed_result,
                                           struct cmdline *cl,
                                           __rte_unused void *data) {
...
static void cmd_clear_history_parsed(__rte_unused void *parsed_result,
                                     struct cmdline *cl,
                                     __rte_unused void *data) {
  struct rdline *rdl = cmdline_get_rdline(cl);
...
cmdline_parse_token_string_t cmd_clear_history_tok = TOKEN_STRING_INITIALIZER(
    struct cmd_clear_history_result, str, "clear_history");
