...
typedef int (*option_parser_t)(struct evt_options *opt, const char *arg);
...
static int evt_parse_nb_flows(struct evt_options *opt, const char *arg) {
  int ret;
...
static int evt_parse_dev_id(struct evt_options *opt, const char *arg) {
  int ret;
...
static int evt_parse_verbose(struct evt_options *opt,
                             const char *arg __rte_unused) {
  opt->verbose_level = atoi(arg);
  return 0;
}

static int evt_parse_fwd_latency(struct evt_options *opt,
                                 const char *arg __rte_unused) {
  opt->fwd_latency = 1;
  return 0;
}

static int evt_parse_queue_priority(struct evt_options *opt,
                                    const char *arg __rte_unused) {
  opt->q_priority = 1;
  return 0;
}

static int evt_parse_deq_tmo_nsec(struct evt_options *opt, const char *arg) {
  int ret;
...
static int evt_parse_eth_prod_type(struct evt_options *opt,
                                   const char *arg __rte_unused) {
  opt->prod_type = EVT_PROD_TYPE_ETH_RX_ADPTR;
  return 0;
}

static int evt_parse_timer_prod_type(struct evt_options *opt,
                                     const char *arg __rte_unused) {
  opt->prod_type = EVT_PROD_TYPE_EVENT_TIMER_ADPTR;
  return 0;
}

static int evt_parse_timer_prod_type_burst(struct evt_options *opt,
                                           const char *arg __rte_unused) {
  opt->prod_type = EVT_PROD_TYPE_EVENT_TIMER_ADPTR;
...
static int evt_parse_crypto_prod_type(struct evt_options *opt,
                                      const char *arg __rte_unused) {
  opt->prod_type = EVT_PROD_TYPE_EVENT_CRYPTO_ADPTR;
  return 0;
}

static int evt_parse_crypto_adptr_mode(struct evt_options *opt,
                                       const char *arg) {
  uint8_t mode;
  int ret;
...
static int evt_parse_test_name(struct evt_options *opt, const char *arg) {
  strlcpy(opt->test_name, arg, EVT_TEST_NAME_MAX_LEN);
  return 0;
}

static int evt_parse_socket_id(struct evt_options *opt, const char *arg) {
  opt->socket_id = atoi(arg);
  return 0;
}

static int evt_parse_wkr_deq_dep(struct evt_options *opt, const char *arg) {
  int ret;
...
static int evt_parse_nb_pkts(struct evt_options *opt, const char *arg) {
  int ret;
...
static int evt_parse_nb_timers(struct evt_options *opt, const char *arg) {
  int ret;
...
static int evt_parse_timer_tick_nsec(struct evt_options *opt, const char *arg) {
  int ret;
...
static int evt_parse_max_tmo_nsec(struct evt_options *opt, const char *arg) {
  int ret;
...
static int evt_parse_expiry_nsec(struct evt_options *opt, const char *arg) {
  int ret;
...
static int evt_parse_nb_timer_adptrs(struct evt_options *opt, const char *arg) {
  int ret;
...
static int evt_parse_pool_sz(struct evt_options *opt, const char *arg) {
  opt->pool_sz = atoi(arg);

  return 0;
}

static int evt_parse_plcores(struct evt_options *opt, const char *corelist) {
  int ret;
...
static int evt_parse_work_lcores(struct evt_options *opt,
                                 const char *corelist) {
  int ret;
...
static int evt_parse_mbuf_sz(struct evt_options *opt, const char *arg) {
  int ret;
...
static int evt_parse_max_pkt_sz(struct evt_options *opt, const char *arg) {
  int ret;
...
static int evt_parse_ena_vector(struct evt_options *opt,
                                const char *arg __rte_unused) {
  opt->ena_vector = 1;
  return 0;
}

static int evt_parse_vector_size(struct evt_options *opt, const char *arg) {
  int ret;
...
static int evt_parse_vector_tmo_ns(struct evt_options *opt, const char *arg) {
  int ret;
...
static int evt_parse_eth_queues(struct evt_options *opt, const char *arg) {
  int ret;
...
static int evt_parse_per_port_pool(struct evt_options *opt,
                                   const char *arg __rte_unused) {
  opt->per_port_pool = 1;
  return 0;
}

static int evt_parse_prod_enq_burst_sz(struct evt_options *opt,
                                       const char *arg) {
  int ret;
...
static int evt_parse_sched_type_list(struct evt_options *opt, const char *arg) {
  char c;
  int i = 0, j = -1;
...
static struct option lgopts[] = {{EVT_NB_FLOWS, 1, 0, 0},
                                 {EVT_DEVICE, 1, 0, 0},
                                 {EVT_VERBOSE, 1, 0, 0},
                                 {EVT_TEST, 1, 0, 0},
...
static int evt_opts_parse_long(int opt_idx, struct evt_options *opt) {
  unsigned int i;
