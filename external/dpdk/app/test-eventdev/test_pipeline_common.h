...
static __rte_always_inline void pipeline_fwd_event(struct rte_event *ev,
                                                   uint8_t sched) {
...
static __rte_always_inline void pipeline_fwd_event_vector(struct rte_event *ev,
                                                          uint8_t sched) {
...
static __rte_always_inline void pipeline_event_tx(const uint8_t dev,
                                                  const uint8_t port,
...
static __rte_always_inline void pipeline_event_tx_burst(const uint8_t dev,
                                                        const uint8_t port,
                                                        struct rte_event *ev,
  ...
  while (enq < nb_rx) {
    enq +=
        rte_event_eth_tx_adapter_enqueue(dev, port, ev + enq, nb_rx - enq, 0);
  }
}

static __rte_always_inline void pipeline_event_enqueue(const uint8_t dev,
                                                       const uint8_t port,
                                                       struct rte_event *ev) {
...
static inline int pipeline_nb_event_ports(struct evt_options *opt) {
