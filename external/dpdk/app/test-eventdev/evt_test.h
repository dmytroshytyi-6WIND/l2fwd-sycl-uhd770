...
typedef int (*evt_test_setup_t)(struct evt_test *test, struct evt_options *opt);
typedef int (*evt_test_mempool_setup_t)(struct evt_test *test,
                                        struct evt_options *opt);
typedef int (*evt_test_ethdev_setup_t)(struct evt_test *test,
                                       struct evt_options *opt);
typedef int (*evt_test_cryptodev_setup_t)(struct evt_test *test,
                                          struct evt_options *opt);
typedef int (*evt_test_eventdev_setup_t)(struct evt_test *test,
                                         struct evt_options *opt);
typedef int (*evt_test_launch_lcores_t)(struct evt_test *test,
                                        struct evt_options *opt);
typedef int (*evt_test_result_t)(struct evt_test *test,
                                 struct evt_options *opt);
typedef void (*evt_test_eventdev_destroy_t)(struct evt_test *test,
                                            struct evt_options *opt);
typedef void (*evt_test_ethdev_destroy_t)(struct evt_test *test,
                                          struct evt_options *opt);
typedef void (*evt_test_cryptodev_destroy_t)(struct evt_test *test,
                                             struct evt_options *opt);
typedef void (*evt_test_mempool_destroy_t)(struct evt_test *test,
                                           struct evt_options *opt);
typedef void (*evt_test_destroy_t)(struct evt_test *test,
                                   struct evt_options *opt);
...
#define EVT_TEST_REGISTER(nm)                                                  \
  ...
  RTE_INIT(evt_test_##nm) {                                                    \
    ...
    memcpy(&_evt_test_entry_##nm.test.ops, &nm, sizeof(struct evt_test_ops));  \
    evt_test_register(&_evt_test_entry_##nm);                                  \
  }

struct evt_test *evt_test_get(const char *name);

static inline void *evt_test_priv(struct evt_test *test) {
