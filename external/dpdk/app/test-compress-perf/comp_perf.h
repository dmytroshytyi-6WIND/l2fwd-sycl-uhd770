...
void cperf_throughput_test_destructor(void *arg __rte_unused);

int cperf_throughput_test_runner(void *test_ctx __rte_unused);
...
void cperf_verify_test_destructor(void *arg __rte_unused);

int cperf_verify_test_runner(void *test_ctx __rte_unused);
