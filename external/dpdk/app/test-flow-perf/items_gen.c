...
static void add_ether(struct rte_flow_item *items, uint8_t items_counter,
...
static void add_vlan(struct rte_flow_item *items, uint8_t items_counter,
                     __rte_unused struct additional_para para) {
...
static void add_ipv4(struct rte_flow_item *items, uint8_t items_counter,
                     struct additional_para para) {
  static struct rte_flow_item_ipv4
      ipv4_specs[RTE_MAX_LCORE] __rte_cache_aligned;
  static struct rte_flow_item_ipv4
      ipv4_masks[RTE_MAX_LCORE] __rte_cache_aligned;
...
static void add_ipv6(struct rte_flow_item *items, uint8_t items_counter,
                     struct additional_para para) {
  static struct rte_flow_item_ipv6
      ipv6_specs[RTE_MAX_LCORE] __rte_cache_aligned;
  static struct rte_flow_item_ipv6
      ipv6_masks[RTE_MAX_LCORE] __rte_cache_aligned;
  uint8_t ti = para.core_idx;
  uint8_t i;
...
static void add_tcp(struct rte_flow_item *items, uint8_t items_counter,
                    __rte_unused struct additional_para para) {
...
static void add_udp(struct rte_flow_item *items, uint8_t items_counter,
                    __rte_unused struct additional_para para) {
...
static void add_vxlan(struct rte_flow_item *items, uint8_t items_counter,
                      struct additional_para para) {
  static struct rte_flow_item_vxlan
      vxlan_specs[RTE_MAX_LCORE] __rte_cache_aligned;
  static struct rte_flow_item_vxlan
      vxlan_masks[RTE_MAX_LCORE] __rte_cache_aligned;
  uint8_t ti = para.core_idx;
  uint32_t vni_value;
  uint8_t i;
...
static void add_vxlan_gpe(struct rte_flow_item *items, uint8_t items_counter,
                          __rte_unused struct additional_para para) {
  static struct rte_flow_item_vxlan_gpe
      vxlan_gpe_specs[RTE_MAX_LCORE] __rte_cache_aligned;
  static struct rte_flow_item_vxlan_gpe
      vxlan_gpe_masks[RTE_MAX_LCORE] __rte_cache_aligned;
  uint8_t ti = para.core_idx;
  uint32_t vni_value;
  uint8_t i;
...
static void add_gre(struct rte_flow_item *items, uint8_t items_counter,
                    __rte_unused struct additional_para para) {
...
static void add_geneve(struct rte_flow_item *items, uint8_t items_counter,
                       __rte_unused struct additional_para para) {
  static struct rte_flow_item_geneve
      geneve_specs[RTE_MAX_LCORE] __rte_cache_aligned;
  static struct rte_flow_item_geneve
      geneve_masks[RTE_MAX_LCORE] __rte_cache_aligned;
  uint8_t ti = para.core_idx;
  uint32_t vni_value;
  uint8_t i;
...
static void add_gtp(struct rte_flow_item *items, uint8_t items_counter,
                    __rte_unused struct additional_para para) {
...
static void add_meta_data(struct rte_flow_item *items, uint8_t items_counter,
                          __rte_unused struct additional_para para) {
...
static void add_meta_tag(struct rte_flow_item *items, uint8_t items_counter,
                         __rte_unused struct additional_para para) {
...
static void add_icmpv4(struct rte_flow_item *items, uint8_t items_counter,
                       __rte_unused struct additional_para para) {
...
static void add_icmpv6(struct rte_flow_item *items, uint8_t items_counter,
                       __rte_unused struct additional_para para) {
