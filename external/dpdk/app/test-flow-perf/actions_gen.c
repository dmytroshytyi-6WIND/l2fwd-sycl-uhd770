...
static void add_mark(struct rte_flow_action *actions, uint8_t actions_counter,
  ...
  static struct rte_flow_action_mark
      mark_actions[RTE_MAX_LCORE] __rte_cache_aligned;
...
static void add_queue(struct rte_flow_action *actions, uint8_t actions_counter,
                      struct additional_para para) {
  static struct rte_flow_action_queue
      queue_actions[RTE_MAX_LCORE] __rte_cache_aligned;
...
static void add_jump(struct rte_flow_action *actions, uint8_t actions_counter,
                     struct additional_para para) {
...
static void add_rss(struct rte_flow_action *actions, uint8_t actions_counter,
                    struct additional_para para) {
  ...
  if (rss_data[para.core_idx] == NULL)
    rss_data[para.core_idx] =
        rte_malloc("rss_data", sizeof(struct action_rss_data), 0);
...
static void add_set_meta(struct rte_flow_action *actions,
...
static void add_set_tag(struct rte_flow_action *actions,
                        uint8_t actions_counter,
                        __rte_unused struct additional_para para) {
...
static void add_port_id(struct rte_flow_action *actions,
                        uint8_t actions_counter, struct additional_para para) {
...
static void add_drop(struct rte_flow_action *actions, uint8_t actions_counter,
                     __rte_unused struct additional_para para) {
  actions[actions_counter].type = RTE_FLOW_ACTION_TYPE_DROP;
}

static void add_count(struct rte_flow_action *actions, uint8_t actions_counter,
                      __rte_unused struct additional_para para) {
...
static void add_set_src_mac(struct rte_flow_action *actions,
                            uint8_t actions_counter,
                            struct additional_para para) {
  static struct rte_flow_action_set_mac
      set_macs[RTE_MAX_LCORE] __rte_cache_aligned;
...
static void add_set_dst_mac(struct rte_flow_action *actions,
                            uint8_t actions_counter,
                            struct additional_para para) {
  static struct rte_flow_action_set_mac
      set_macs[RTE_MAX_LCORE] __rte_cache_aligned;
...
static void add_set_src_ipv4(struct rte_flow_action *actions,
                             uint8_t actions_counter,
                             struct additional_para para) {
  static struct rte_flow_action_set_ipv4
      set_ipv4[RTE_MAX_LCORE] __rte_cache_aligned;
...
static void add_set_dst_ipv4(struct rte_flow_action *actions,
                             uint8_t actions_counter,
                             struct additional_para para) {
  static struct rte_flow_action_set_ipv4
      set_ipv4[RTE_MAX_LCORE] __rte_cache_aligned;
...
static void add_set_src_ipv6(struct rte_flow_action *actions,
                             uint8_t actions_counter,
                             struct additional_para para) {
  static struct rte_flow_action_set_ipv6
      set_ipv6[RTE_MAX_LCORE] __rte_cache_aligned;
...
static void add_set_dst_ipv6(struct rte_flow_action *actions,
                             uint8_t actions_counter,
                             struct additional_para para) {
  static struct rte_flow_action_set_ipv6
      set_ipv6[RTE_MAX_LCORE] __rte_cache_aligned;
...
static void add_set_src_tp(struct rte_flow_action *actions,
                           uint8_t actions_counter,
                           struct additional_para para) {
  static struct rte_flow_action_set_tp
      set_tp[RTE_MAX_LCORE] __rte_cache_aligned;
...
static void add_set_dst_tp(struct rte_flow_action *actions,
                           uint8_t actions_counter,
                           struct additional_para para) {
  static struct rte_flow_action_set_tp
      set_tp[RTE_MAX_LCORE] __rte_cache_aligned;
...
static void add_inc_tcp_ack(struct rte_flow_action *actions,
                            uint8_t actions_counter,
                            struct additional_para para) {
...
static void add_dec_tcp_ack(struct rte_flow_action *actions,
                            uint8_t actions_counter,
                            struct additional_para para) {
  static rte_be32_t value[RTE_MAX_LCORE] __rte_cache_aligned;
  uint32_t ack_value = para.counter;
...
static void add_inc_tcp_seq(struct rte_flow_action *actions,
                            uint8_t actions_counter,
                            struct additional_para para) {
  static rte_be32_t value[RTE_MAX_LCORE] __rte_cache_aligned;
...
static void add_dec_tcp_seq(struct rte_flow_action *actions,
                            uint8_t actions_counter,
                            struct additional_para para) {
  static rte_be32_t value[RTE_MAX_LCORE] __rte_cache_aligned;
  uint32_t seq_value = para.counter;
...
static void add_set_ttl(struct rte_flow_action *actions,
                        uint8_t actions_counter, struct additional_para para) {
  static struct rte_flow_action_set_ttl
      set_ttl[RTE_MAX_LCORE] __rte_cache_aligned;
...
static void add_dec_ttl(struct rte_flow_action *actions,
                        uint8_t actions_counter,
                        __rte_unused struct additional_para para) {
  actions[actions_counter].type = RTE_FLOW_ACTION_TYPE_DEC_TTL;
}

static void add_set_ipv4_dscp(struct rte_flow_action *actions,
                              uint8_t actions_counter,
                              struct additional_para para) {
  static struct rte_flow_action_set_dscp
      set_dscp[RTE_MAX_LCORE] __rte_cache_aligned;
...
static void add_set_ipv6_dscp(struct rte_flow_action *actions,
                              uint8_t actions_counter,
                              struct additional_para para) {
  static struct rte_flow_action_set_dscp
      set_dscp[RTE_MAX_LCORE] __rte_cache_aligned;
...
static void add_flag(struct rte_flow_action *actions, uint8_t actions_counter,
                     __rte_unused struct additional_para para) {
  actions[actions_counter].type = RTE_FLOW_ACTION_TYPE_FLAG;
}

static void add_ether_header(uint8_t **header, uint64_t data,
                             __rte_unused struct additional_para para) {
...
static void add_vlan_header(uint8_t **header, uint64_t data,
                            __rte_unused struct additional_para para) {
...
static void add_ipv4_header(uint8_t **header, uint64_t data,
                            struct additional_para para) {
...
static void add_ipv6_header(uint8_t **header, uint64_t data,
                            __rte_unused struct additional_para para) {
...
static void add_udp_header(uint8_t **header, uint64_t data,
                           __rte_unused struct additional_para para) {
...
static void add_vxlan_header(uint8_t **header, uint64_t data,
                             struct additional_para para) {
...
static void add_vxlan_gpe_header(uint8_t **header, uint64_t data,
                                 struct additional_para para) {
...
static void add_gre_header(uint8_t **header, uint64_t data,
                           __rte_unused struct additional_para para) {
...
static void add_geneve_header(uint8_t **header, uint64_t data,
                              struct additional_para para) {
...
static void add_gtp_header(uint8_t **header, uint64_t data,
                           struct additional_para para) {
...
static const struct encap_decap_headers {
  void (*funct)(uint8_t **header, uint64_t data, struct additional_para para);
} headers[] = {
    {.funct = add_ether_header},     {.funct = add_vlan_header},
    {.funct = add_ipv4_header},      {.funct = add_ipv6_header},
    {.funct = add_udp_header},       {.funct = add_vxlan_header},
    {.funct = add_vxlan_gpe_header}, {.funct = add_gre_header},
    {.funct = add_geneve_header},    {.funct = add_gtp_header},
};

static void add_raw_encap(struct rte_flow_action *actions,
                          uint8_t actions_counter,
                          struct additional_para para) {
  static struct action_raw_encap_data
      *action_encap_data[RTE_MAX_LCORE] __rte_cache_aligned;
  ...
  if (action_encap_data[para.core_idx] == NULL)
    action_encap_data[para.core_idx] =
        rte_malloc("encap_data", sizeof(struct action_raw_encap_data), 0);
  ...
  *action_encap_data[para.core_idx] = (struct action_raw_encap_data){
  ...
  action_encap_data[para.core_idx]->conf.size =
      header - action_encap_data[para.core_idx]->data;
...
static void add_raw_decap(struct rte_flow_action *actions,
                          uint8_t actions_counter,
                          struct additional_para para) {
  static struct action_raw_decap_data
      *action_decap_data[RTE_MAX_LCORE] __rte_cache_aligned;
  ...
  if (action_decap_data[para.core_idx] == NULL)
    action_decap_data[para.core_idx] =
        rte_malloc("decap_data", sizeof(struct action_raw_decap_data), 0);
  ...
  *action_decap_data[para.core_idx] = (struct action_raw_decap_data){
  ...
  action_decap_data[para.core_idx]->conf.size =
      header - action_decap_data[para.core_idx]->data;
...
static void add_vxlan_encap(struct rte_flow_action *actions,
                            uint8_t actions_counter,
                            __rte_unused struct additional_para para) {
  static struct rte_flow_action_vxlan_encap
      vxlan_encap[RTE_MAX_LCORE] __rte_cache_aligned;
...
static void add_vxlan_decap(struct rte_flow_action *actions,
                            uint8_t actions_counter,
                            __rte_unused struct additional_para para) {
  actions[actions_counter].type = RTE_FLOW_ACTION_TYPE_VXLAN_DECAP;
}

static void add_meter(struct rte_flow_action *actions, uint8_t actions_counter,
                      __rte_unused struct additional_para para) {
  static struct rte_flow_action_meter meters[RTE_MAX_LCORE] __rte_cache_aligned;
...
void fill_actions(struct rte_flow_action *actions, uint64_t *flow_actions,
  ...
  static const struct actions_dict {
    uint64_t mask;
    void (*funct)(struct rte_flow_action *actions, uint8_t actions_counter,
                  struct additional_para para);
  } actions_list[] = {
      {
      ...
      {
          .mask = FLOW_ACTION_MASK(RTE_FLOW_ACTION_TYPE_RAW_ENCAP),
          .funct = add_raw_encap,
      },
      {
          .mask = FLOW_ACTION_MASK(RTE_FLOW_ACTION_TYPE_RAW_DECAP),
          .funct = add_raw_decap,
      },
      {
  ...
  for (j = 0; j < MAX_ACTIONS_NUM; j++) {
    ...
    for (i = 0; i < RTE_DIM(actions_list); i++) {
      if ((flow_actions[j] & actions_list[i].mask) == 0)
        continue;
      actions_list[i].funct(actions, actions_counter++, additional_para_data);
      break;
    }
  }
