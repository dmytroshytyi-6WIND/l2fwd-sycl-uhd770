...
static void cmd_help_long_parsed(void *parsed_result, struct cmdline *cl,
  ...
  if (show_all || !strcmp(res->section, "config")) {
    cmdline_printf(
        ...
        "set macsec offload (port_id) on encrypt (on|off) replay-protect "
        "(on|off)\n"
        ...
        "    Set the VLAN strip for all queues in a pool for a VF from the "
        "PF.\n\n"
        ...
        "	Create a new bonded device with specific bonding mode and "
        "socket.\n\n"
        ...
        "	Set the transmit balance policy for bonded device running in "
        "balance mode.\n\n"

        "set bonding mon_period (port_id) (value)\n"
        "	Set the bonding link status monitoring polling period in "
        "ms.\n\n"
        ...
        "add port meter profile srtcm_rfc2697 (port_id) (profile_id) (cir) "
        "(cbs) (ebs) (packet_mode)\n"
        "    meter profile add - srtcm rfc 2697\n\n"

        "add port meter profile trtcm_rfc2698 (port_id) (profile_id) (cir) "
        "(pir) (cbs) (pbs) (packet_mode)\n"
        "    meter profile add - trtcm rfc 2698\n\n"

        "add port meter profile trtcm_rfc4115 (port_id) (profile_id) (cir) "
        "(eir) (cbs) (ebs) (packet_mode)\n"
        "    meter profile add - trtcm rfc 4115\n\n"

        "del port meter profile (port_id) (profile_id)\n"
        "    meter profile delete\n\n"

        "create port meter (port_id) (mtr_id) (profile_id) (policy_id) "
        "(meter_enable)\n"
  ...
  if (show_all || !strcmp(res->section, "ports")) {
    ...
    cmdline_printf(
        ...
        "    Enable or disable packet drop on all RX queues of all ports when "
        "no "
        ...
        "port config (port_id) udp_tunnel_port add|rm vxlan|geneve|ecpri "
        "(udp_port)\n\n"
...
cmdline_parse_token_string_t cmd_help_long_section = TOKEN_STRING_INITIALIZER(
    struct cmd_help_long_result, section,
...
cmdline_parse_token_string_t cmd_operate_port_all_cmd =
    TOKEN_STRING_INITIALIZER(struct cmd_operate_port_result, keyword, "port");
...
cmdline_parse_inst_t cmd_operate_port = {
    ...
    .data = NULL,
    .help_str =
        "port start|stop|close|reset all: Start/Stop/Close/Reset all ports",
    .tokens =
        {
...
cmdline_parse_token_string_t cmd_operate_specific_port_cmd =
    TOKEN_STRING_INITIALIZER(struct cmd_operate_specific_port_result, keyword,
                             "port");
cmdline_parse_token_string_t cmd_operate_specific_port_port =
    TOKEN_STRING_INITIALIZER(struct cmd_operate_specific_port_result, name,
                             "start#stop#close#reset");
cmdline_parse_token_num_t cmd_operate_specific_port_id = TOKEN_NUM_INITIALIZER(
    struct cmd_operate_specific_port_result, value, RTE_UINT8);

cmdline_parse_inst_t cmd_operate_specific_port = {
    .f = cmd_operate_specific_port_parsed,
    .data = NULL,
    .help_str =
        "port start|stop|close|reset <port_id>: Start/Stop/Close/Reset port_id",
    .tokens =
        {
...
cmdline_parse_token_string_t cmd_set_port_setup_on_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_port_setup_on_result, set, "set");
cmdline_parse_token_string_t cmd_set_port_setup_on_port =
    TOKEN_STRING_INITIALIZER(struct cmd_set_port_setup_on_result, port, "port");
cmdline_parse_token_string_t cmd_set_port_setup_on_setup =
    TOKEN_STRING_INITIALIZER(struct cmd_set_port_setup_on_result, setup,
                             "setup");
cmdline_parse_token_string_t cmd_set_port_setup_on_on =
    TOKEN_STRING_INITIALIZER(struct cmd_set_port_setup_on_result, on, "on");
cmdline_parse_token_string_t cmd_set_port_setup_on_mode =
    TOKEN_STRING_INITIALIZER(struct cmd_set_port_setup_on_result, mode,
                             "iterator#event");
...
cmdline_parse_token_string_t cmd_operate_attach_port_port =
    TOKEN_STRING_INITIALIZER(struct cmd_operate_attach_port_result, port,
                             "port");
cmdline_parse_token_string_t cmd_operate_attach_port_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_operate_attach_port_result, keyword,
                             "attach");
cmdline_parse_token_string_t cmd_operate_attach_port_identifier =
    TOKEN_STRING_INITIALIZER(struct cmd_operate_attach_port_result, identifier,
                             TOKEN_STRING_MULTI);
...
cmdline_parse_token_string_t cmd_operate_detach_port_port =
    TOKEN_STRING_INITIALIZER(struct cmd_operate_detach_port_result, port,
                             "port");
cmdline_parse_token_string_t cmd_operate_detach_port_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_operate_detach_port_result, keyword,
                             "detach");
cmdline_parse_token_num_t cmd_operate_detach_port_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_operate_detach_port_result, port_id,
                          RTE_UINT16);
...
cmdline_parse_token_string_t cmd_operate_detach_device_device =
    TOKEN_STRING_INITIALIZER(struct cmd_operate_detach_device_result, device,
                             "device");
cmdline_parse_token_string_t cmd_operate_detach_device_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_operate_detach_device_result, keyword,
                             "detach");
...
static int parse_and_check_speed_duplex(char *speedstr, char *duplexstr,
                                        uint32_t *speed) {
  ...
  if (!strcmp(speedstr, "10")) {
    *speed = (duplex == RTE_ETH_LINK_HALF_DUPLEX) ? RTE_ETH_LINK_SPEED_10M_HD
                                                  : RTE_ETH_LINK_SPEED_10M;
  } else if (!strcmp(speedstr, "100")) {
    *speed = (duplex == RTE_ETH_LINK_HALF_DUPLEX) ? RTE_ETH_LINK_SPEED_100M_HD
...
static void cmd_config_speed_all_parsed(void *parsed_result,
                                        __rte_unused struct cmdline *cl,
                                        __rte_unused void *data) {
  ...
  RTE_ETH_FOREACH_DEV(pid) { ports[pid].dev_conf.link_speeds = link_speed; }
...
cmdline_parse_token_string_t cmd_config_speed_all_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_config_speed_all, keyword, "config");
...
cmdline_parse_token_string_t cmd_config_speed_all_value1 =
    TOKEN_STRING_INITIALIZER(
        struct cmd_config_speed_all, value1,
...
static void cmd_config_speed_specific_parsed(void *parsed_result,
                                             __rte_unused struct cmdline *cl,
                                             __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_config_speed_specific_port =
    TOKEN_STRING_INITIALIZER(struct cmd_config_speed_specific, port, "port");
...
cmdline_parse_token_string_t cmd_config_speed_specific_item1 =
    TOKEN_STRING_INITIALIZER(struct cmd_config_speed_specific, item1, "speed");
cmdline_parse_token_string_t cmd_config_speed_specific_value1 =
    TOKEN_STRING_INITIALIZER(
        struct cmd_config_speed_specific, value1,
        "10#100#1000#10000#25000#40000#50000#100000#200000#auto");
cmdline_parse_token_string_t cmd_config_speed_specific_item2 =
    TOKEN_STRING_INITIALIZER(struct cmd_config_speed_specific, item2, "duplex");
...
static void cmd_config_loopback_all_parsed(void *parsed_result,
                                           __rte_unused struct cmdline *cl,
                                           __rte_unused void *data) {
  ...
  RTE_ETH_FOREACH_DEV(pid) { ports[pid].dev_conf.lpbk_mode = res->mode; }
...
cmdline_parse_token_string_t cmd_config_loopback_all_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_config_loopback_all, keyword, "config");
...
cmdline_parse_token_string_t cmd_config_loopback_all_item =
    TOKEN_STRING_INITIALIZER(struct cmd_config_loopback_all, item, "loopback");
...
static void cmd_config_loopback_specific_parsed(void *parsed_result,
                                                __rte_unused struct cmdline *cl,
                                                __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_config_loopback_specific_port =
    TOKEN_STRING_INITIALIZER(struct cmd_config_loopback_specific, port, "port");
...
static void cmd_config_rx_tx_parsed(void *parsed_result,
                                    __rte_unused struct cmdline *cl,
                                    __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_config_rx_tx_name =
    TOKEN_STRING_INITIALIZER(struct cmd_config_rx_tx, name, "rxq#txq#rxd#txd");
...
static void cmd_config_max_pkt_len_parsed(void *parsed_result,
                                          __rte_unused struct cmdline *cl,
                                          __rte_unused void *data) {
  ...
  RTE_ETH_FOREACH_DEV(port_id) {
    ...
    if (res->value < RTE_ETHER_MIN_LEN) {
      fprintf(stderr, "max-pkt-len can not be less than %d\n",
              RTE_ETHER_MIN_LEN);
      return;
    }
...
cmdline_parse_token_string_t cmd_config_max_pkt_len_all =
    TOKEN_STRING_INITIALIZER(struct cmd_config_max_pkt_len_result, all, "all");
cmdline_parse_token_string_t cmd_config_max_pkt_len_name =
    TOKEN_STRING_INITIALIZER(struct cmd_config_max_pkt_len_result, name,
                             "max-pkt-len");
cmdline_parse_token_num_t cmd_config_max_pkt_len_value = TOKEN_NUM_INITIALIZER(
    struct cmd_config_max_pkt_len_result, value, RTE_UINT32);
...
static void cmd_config_max_lro_pkt_size_parsed(void *parsed_result,
                                               __rte_unused struct cmdline *cl,
                                               __rte_unused void *data) {
  ...
  RTE_ETH_FOREACH_DEV(pid) {
    ...
    if (!strcmp(res->name, "max-lro-pkt-size")) {
      if (res->value == port->dev_conf.rxmode.max_lro_pkt_size)
        return;
...
cmdline_parse_token_string_t cmd_config_max_lro_pkt_size_port =
    TOKEN_STRING_INITIALIZER(struct cmd_config_max_lro_pkt_size_result, port,
                             "port");
cmdline_parse_token_string_t cmd_config_max_lro_pkt_size_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_config_max_lro_pkt_size_result, keyword,
                             "config");
cmdline_parse_token_string_t cmd_config_max_lro_pkt_size_all =
    TOKEN_STRING_INITIALIZER(struct cmd_config_max_lro_pkt_size_result, all,
                             "all");
cmdline_parse_token_string_t cmd_config_max_lro_pkt_size_name =
    TOKEN_STRING_INITIALIZER(struct cmd_config_max_lro_pkt_size_result, name,
                             "max-lro-pkt-size");
cmdline_parse_token_num_t cmd_config_max_lro_pkt_size_value =
    TOKEN_NUM_INITIALIZER(struct cmd_config_max_lro_pkt_size_result, value,
                          RTE_UINT32);
...
static void cmd_config_mtu_parsed(void *parsed_result,
                                  __rte_unused struct cmdline *cl,
                                  __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_config_mtu_port =
    TOKEN_STRING_INITIALIZER(struct cmd_config_mtu_result, port, "port");
cmdline_parse_token_string_t cmd_config_mtu_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_config_mtu_result, keyword, "config");
cmdline_parse_token_string_t cmd_config_mtu_mtu =
    TOKEN_STRING_INITIALIZER(struct cmd_config_mtu_result, keyword, "mtu");
...
static void cmd_config_rx_mode_flag_parsed(void *parsed_result,
                                           __rte_unused struct cmdline *cl,
                                           __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_config_rx_mode_flag_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_config_rx_mode_flag, keyword, "config");
cmdline_parse_token_string_t cmd_config_rx_mode_flag_all =
    TOKEN_STRING_INITIALIZER(struct cmd_config_rx_mode_flag, all, "all");
cmdline_parse_token_string_t cmd_config_rx_mode_flag_name =
    TOKEN_STRING_INITIALIZER(struct cmd_config_rx_mode_flag, name, "drop-en");
cmdline_parse_token_string_t cmd_config_rx_mode_flag_value =
    TOKEN_STRING_INITIALIZER(struct cmd_config_rx_mode_flag, value, "on#off");
...
static void cmd_config_rss_parsed(void *parsed_result,
                                  __rte_unused struct cmdline *cl,
                                  __rte_unused void *data) {
  ...
  if (!strcmp(res->value, "all"))
    rss_conf.rss_hf = RTE_ETH_RSS_ETH | RTE_ETH_RSS_VLAN | RTE_ETH_RSS_IP |
                      ...
                      RTE_ETH_RSS_GTPU | RTE_ETH_RSS_ECPRI | RTE_ETH_RSS_L2TPV2;
  ...
  RTE_ETH_FOREACH_DEV(i) {
    ...
    if (diag < 0) {
      all_updated = 0;
      fprintf(stderr,
              "Configuration of RSS hash at ethernet port %d failed with error "
              "(%d): %s.\n",
...
static void cmd_config_rss_hash_key_parsed(void *parsed_result,
                                           __rte_unused struct cmdline *cl,
                                           __rte_unused void *data) {
  ...
  if (dev_info.hash_key_size > 0 && dev_info.hash_key_size <= sizeof(hash_key))
  ...
  if (key_len != (hash_key_size * 2)) {
    fprintf(stderr,
            "key length: %d invalid - key must be a string of %d hexa-decimal "
            "numbers\n",
...
static void cmd_cleanup_txq_mbufs_parsed(void *parsed_result,
                                         __rte_unused struct cmdline *cl,
                                         __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_cleanup_txq_mbufs_port =
    TOKEN_STRING_INITIALIZER(struct cmd_cleanup_txq_mbufs_result, port, "port");
cmdline_parse_token_string_t cmd_cleanup_txq_mbufs_cleanup =
    TOKEN_STRING_INITIALIZER(struct cmd_cleanup_txq_mbufs_result, keyword,
                             "cleanup");
cmdline_parse_token_num_t cmd_cleanup_txq_mbufs_port_id = TOKEN_NUM_INITIALIZER(
    struct cmd_cleanup_txq_mbufs_result, port_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_cleanup_txq_mbufs_txq =
    TOKEN_STRING_INITIALIZER(struct cmd_cleanup_txq_mbufs_result, name, "txq");
...
static void cmd_config_rxtx_ring_size_parsed(void *parsed_result,
                                             __rte_unused struct cmdline *cl,
                                             __rte_unused void *data) {
  ...
  if (isrx && res->size != 0 && res->size <= rx_free_thresh) {
    fprintf(stderr, "Invalid rx ring_size, must > rx_free_thresh: %d\n",
            rx_free_thresh);
    return;
  }
...
cmdline_parse_token_string_t cmd_config_rxtx_ring_size_port =
    TOKEN_STRING_INITIALIZER(struct cmd_config_rxtx_ring_size, port, "port");
cmdline_parse_token_string_t cmd_config_rxtx_ring_size_config =
    TOKEN_STRING_INITIALIZER(struct cmd_config_rxtx_ring_size, config,
                             "config");
cmdline_parse_token_num_t cmd_config_rxtx_ring_size_portid =
    TOKEN_NUM_INITIALIZER(struct cmd_config_rxtx_ring_size, portid, RTE_UINT16);
cmdline_parse_token_string_t cmd_config_rxtx_ring_size_rxtxq =
    TOKEN_STRING_INITIALIZER(struct cmd_config_rxtx_ring_size, rxtxq,
                             "rxq#txq");
cmdline_parse_token_num_t cmd_config_rxtx_ring_size_qid =
    TOKEN_NUM_INITIALIZER(struct cmd_config_rxtx_ring_size, qid, RTE_UINT16);
cmdline_parse_token_string_t cmd_config_rxtx_ring_size_rsize =
    TOKEN_STRING_INITIALIZER(struct cmd_config_rxtx_ring_size, rsize,
                             "ring_size");
cmdline_parse_token_num_t cmd_config_rxtx_ring_size_size =
    TOKEN_NUM_INITIALIZER(struct cmd_config_rxtx_ring_size, size, RTE_UINT16);
...
static void cmd_config_rxtx_queue_parsed(void *parsed_result,
                                         __rte_unused struct cmdline *cl,
                                         __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_config_deferred_start_rxtx_queue_port =
    TOKEN_STRING_INITIALIZER(struct cmd_config_deferred_start_rxtx_queue, port,
                             "port");
cmdline_parse_token_num_t cmd_config_deferred_start_rxtx_queue_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_config_deferred_start_rxtx_queue, port_id,
                          RTE_UINT16);
cmdline_parse_token_string_t cmd_config_deferred_start_rxtx_queue_rxtxq =
    TOKEN_STRING_INITIALIZER(struct cmd_config_deferred_start_rxtx_queue, rxtxq,
                             "rxq#txq");
cmdline_parse_token_num_t cmd_config_deferred_start_rxtx_queue_qid =
    TOKEN_NUM_INITIALIZER(struct cmd_config_deferred_start_rxtx_queue, qid,
                          RTE_UINT16);
...
cmdline_parse_token_string_t cmd_config_deferred_start_rxtx_queue_state =
    TOKEN_STRING_INITIALIZER(struct cmd_config_deferred_start_rxtx_queue, state,
                             "on#off");
...
static void cmd_setup_rxtx_queue_parsed(void *parsed_result,
                                        __rte_unused struct cmdline *cl,
                                        __rte_unused void *data) {
  ...
  if (isrx) {
    ...
    ret = rx_queue_setup(res->portid, res->qid, port->nb_rx_desc[res->qid],
                         socket_id, &port->rx_conf[res->qid], mp);
    if (ret)
    ...
    if (port->nb_tx_desc[res->qid] < tx_pkt_nb_segs) {
      fprintf(stderr, "Failed to setup TX queue: not enough descriptors\n");
      return;
    }
    ret = rte_eth_tx_queue_setup(res->portid, res->qid,
                                 port->nb_tx_desc[res->qid], socket_id,
...
static int parse_reta_config(const char *str,
...
static void cmd_set_rss_reta_parsed(void *parsed_result,
                                    __rte_unused struct cmdline *cl,
                                    __rte_unused void *data) {
  int ret;
  struct rte_eth_dev_info dev_info;
  ...
  if (!strcmp(res->list_name, "reta")) {
    if (parse_reta_config(res->list_of_items, reta_conf, dev_info.reta_size)) {
    ...
    ret = rte_eth_dev_rss_reta_update(res->port_id, reta_conf,
                                      dev_info.reta_size);
    if (ret != 0)
      fprintf(stderr, "Bad redirection table parameter, return code = %d\n",
              ret);
  }
}
...
static int showport_parse_reta_config(struct rte_eth_rss_reta_entry64 *conf,
  ...
  uint16_t i;
  uint16_t num =
      (nb_entries + RTE_ETH_RETA_GROUP_SIZE - 1) / RTE_ETH_RETA_GROUP_SIZE;
  int ret;
...
static void cmd_showport_reta_parsed(void *parsed_result,
  ...
  memset(reta_conf, 0, sizeof(reta_conf));
  if (showport_parse_reta_config(reta_conf, res->size, res->list_of_items) <
      0) {
...
static void cmd_config_dcb_parsed(void *parsed_result,
                                  __rte_unused struct cmdline *cl,
                                  __rte_unused void *data) {
  ...
  if (!strncmp(res->vt_en, "on", 2))
    ret = init_port_dcb_config(port_id, DCB_VT_ENABLED,
                               (enum rte_eth_nb_tcs)res->num_tcs, pfc_en);
  else
...
static void cmd_config_burst_parsed(void *parsed_result,
                                    __rte_unused struct cmdline *cl,
                                    __rte_unused void *data) {
...
static void cmd_config_thresh_parsed(void *parsed_result,
                                     __rte_unused struct cmdline *cl,
                                     __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_config_thresh_name = TOKEN_STRING_INITIALIZER(
    struct cmd_config_thresh, name, "txpt#txht#txwt#rxpt#rxht#rxwt");
...
static void cmd_config_threshold_parsed(void *parsed_result,
                                        __rte_unused struct cmdline *cl,
                                        __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_config_threshold_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_config_threshold, keyword, "config");
...
unsigned int parse_item_list(const char *str, const char *item_name,
                             unsigned int max_items, unsigned int *parsed_items,
                             int check_unique_values) {
  ...
  for (i = 0; i < nb_item; i++) {
    for (j = i + 1; j < nb_item; j++) {
      if (parsed_items[j] == parsed_items[i]) {
        fprintf(stderr, "duplicated %s %u at index %u and %u\n", item_name,
                parsed_items[i], i, j);
        return 0;
      }
    }
...
static void cmd_set_list_parsed(void *parsed_result,
  ...
  if (!strcmp(res->list_name, "corelist")) {
    nb_item = parse_item_list(res->list_of_items, "core", RTE_MAX_LCORE,
  ...
  if (!strcmp(res->list_name, "portlist")) {
    nb_item = parse_item_list(res->list_of_items, "port", RTE_MAX_ETHPORTS,
...
cmdline_parse_token_string_t cmd_set_list_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_set_list_result, cmd_keyword, "set");
cmdline_parse_token_string_t cmd_set_list_name = TOKEN_STRING_INITIALIZER(
    struct cmd_set_list_result, list_name, "corelist#portlist");
cmdline_parse_token_string_t cmd_set_list_of_items =
    TOKEN_STRING_INITIALIZER(struct cmd_set_list_result, list_of_items, NULL);
...
cmdline_parse_token_string_t cmd_setmask_mask = TOKEN_STRING_INITIALIZER(
    struct cmd_setmask_result, mask, "coremask#portmask");
...
static void cmd_set_parsed(void *parsed_result, __rte_unused struct cmdline *cl,
                           __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_set_what = TOKEN_STRING_INITIALIZER(
    struct cmd_set_result, what, "nbport#nbcore#burst#verbose");
...
static void cmd_set_log_parsed(void *parsed_result,
                               __rte_unused struct cmdline *cl,
                               __rte_unused void *data) {
...
static void cmd_set_rxoffs_parsed(void *parsed_result,
                                  __rte_unused struct cmdline *cl,
                                  __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_set_rxoffs_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_set_rxoffs_result, cmd_keyword, "set");
cmdline_parse_token_string_t cmd_set_rxoffs_name =
    TOKEN_STRING_INITIALIZER(struct cmd_set_rxoffs_result, rxoffs, "rxoffs");
cmdline_parse_token_string_t cmd_set_rxoffs_offsets =
    TOKEN_STRING_INITIALIZER(struct cmd_set_rxoffs_result, seg_offsets, NULL);
...
static void cmd_set_rxpkts_parsed(void *parsed_result,
                                  __rte_unused struct cmdline *cl,
                                  __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_set_rxpkts_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_set_rxpkts_result, cmd_keyword, "set");
cmdline_parse_token_string_t cmd_set_rxpkts_name =
    TOKEN_STRING_INITIALIZER(struct cmd_set_rxpkts_result, rxpkts, "rxpkts");
cmdline_parse_token_string_t cmd_set_rxpkts_lengths =
    TOKEN_STRING_INITIALIZER(struct cmd_set_rxpkts_result, seg_lengths, NULL);
...
static void cmd_set_txpkts_parsed(void *parsed_result,
                                  __rte_unused struct cmdline *cl,
                                  __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_set_txpkts_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_set_txpkts_result, cmd_keyword, "set");
cmdline_parse_token_string_t cmd_set_txpkts_name =
    TOKEN_STRING_INITIALIZER(struct cmd_set_txpkts_result, txpkts, "txpkts");
cmdline_parse_token_string_t cmd_set_txpkts_lengths =
    TOKEN_STRING_INITIALIZER(struct cmd_set_txpkts_result, seg_lengths, NULL);
...
static void cmd_set_txsplit_parsed(void *parsed_result,
                                   __rte_unused struct cmdline *cl,
                                   __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_set_txsplit_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_set_txsplit_result, cmd_keyword, "set");
cmdline_parse_token_string_t cmd_set_txsplit_name =
    TOKEN_STRING_INITIALIZER(struct cmd_set_txsplit_result, txsplit, "txsplit");
cmdline_parse_token_string_t cmd_set_txsplit_mode =
    TOKEN_STRING_INITIALIZER(struct cmd_set_txsplit_result, mode, NULL);
...
static void cmd_set_txtimes_parsed(void *parsed_result,
                                   __rte_unused struct cmdline *cl,
                                   __rte_unused void *data) {
  ...
  res = parsed_result;
  n_times = parse_item_list(res->tx_times, "tx times", 2, tx_times, 0);
  if (n_times == 2)
    set_tx_pkt_times(tx_times);
}

cmdline_parse_token_string_t cmd_set_txtimes_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_set_txtimes_result, cmd_keyword, "set");
cmdline_parse_token_string_t cmd_set_txtimes_name =
    TOKEN_STRING_INITIALIZER(struct cmd_set_txtimes_result, txtimes, "txtimes");
cmdline_parse_token_string_t cmd_set_txtimes_value =
    TOKEN_STRING_INITIALIZER(struct cmd_set_txtimes_result, tx_times, NULL);
...
static void cmd_rx_vlan_filter_all_parsed(void *parsed_result,
                                          __rte_unused struct cmdline *cl,
                                          __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_rx_vlan_filter_all_rx_vlan =
    TOKEN_STRING_INITIALIZER(struct cmd_rx_vlan_filter_all_result, rx_vlan,
                             "rx_vlan");
cmdline_parse_token_string_t cmd_rx_vlan_filter_all_what =
    TOKEN_STRING_INITIALIZER(struct cmd_rx_vlan_filter_all_result, what,
                             "add#rm");
cmdline_parse_token_string_t cmd_rx_vlan_filter_all_all =
    TOKEN_STRING_INITIALIZER(struct cmd_rx_vlan_filter_all_result, all, "all");
cmdline_parse_token_num_t cmd_rx_vlan_filter_all_portid = TOKEN_NUM_INITIALIZER(
    struct cmd_rx_vlan_filter_all_result, port_id, RTE_UINT16);
...
static void cmd_vlan_offload_parsed(void *parsed_result,
                                    __rte_unused struct cmdline *cl,
                                    __rte_unused void *data) {
  int on;
...
cmdline_parse_token_string_t cmd_vlan_offload_vlan =
    TOKEN_STRING_INITIALIZER(struct cmd_vlan_offload_result, vlan, "vlan");
cmdline_parse_token_string_t cmd_vlan_offload_set =
    TOKEN_STRING_INITIALIZER(struct cmd_vlan_offload_result, set, "set");
cmdline_parse_token_string_t cmd_vlan_offload_what =
    TOKEN_STRING_INITIALIZER(struct cmd_vlan_offload_result, what,
                             "strip#filter#qinq_strip#extend#stripq");
cmdline_parse_token_string_t cmd_vlan_offload_on =
    TOKEN_STRING_INITIALIZER(struct cmd_vlan_offload_result, on, "on#off");
cmdline_parse_token_string_t cmd_vlan_offload_portid =
    TOKEN_STRING_INITIALIZER(struct cmd_vlan_offload_result, port_id, NULL);
...
static void cmd_vlan_tpid_parsed(void *parsed_result,
                                 __rte_unused struct cmdline *cl,
                                 __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_vlan_tpid_vlan =
    TOKEN_STRING_INITIALIZER(struct cmd_vlan_tpid_result, vlan, "vlan");
cmdline_parse_token_string_t cmd_vlan_tpid_set =
    TOKEN_STRING_INITIALIZER(struct cmd_vlan_tpid_result, set, "set");
cmdline_parse_token_string_t cmd_vlan_type = TOKEN_STRING_INITIALIZER(
    struct cmd_vlan_tpid_result, vlan_type, "inner#outer");
cmdline_parse_token_string_t cmd_vlan_tpid_what =
    TOKEN_STRING_INITIALIZER(struct cmd_vlan_tpid_result, what, "tpid");
cmdline_parse_token_num_t cmd_vlan_tpid_tpid =
    TOKEN_NUM_INITIALIZER(struct cmd_vlan_tpid_result, tp_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_vlan_tpid_portid =
    TOKEN_NUM_INITIALIZER(struct cmd_vlan_tpid_result, port_id, RTE_UINT16);
...
static void cmd_rx_vlan_filter_parsed(void *parsed_result,
                                      __rte_unused struct cmdline *cl,
                                      __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_rx_vlan_filter_rx_vlan =
    TOKEN_STRING_INITIALIZER(struct cmd_rx_vlan_filter_result, rx_vlan,
                             "rx_vlan");
cmdline_parse_token_string_t cmd_rx_vlan_filter_what =
    TOKEN_STRING_INITIALIZER(struct cmd_rx_vlan_filter_result, what, "add#rm");
cmdline_parse_token_num_t cmd_rx_vlan_filter_vlanid = TOKEN_NUM_INITIALIZER(
    struct cmd_rx_vlan_filter_result, vlan_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_rx_vlan_filter_portid = TOKEN_NUM_INITIALIZER(
    struct cmd_rx_vlan_filter_result, port_id, RTE_UINT16);
...
static void cmd_tx_vlan_set_parsed(void *parsed_result,
                                   __rte_unused struct cmdline *cl,
                                   __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_tx_vlan_set_tx_vlan =
    TOKEN_STRING_INITIALIZER(struct cmd_tx_vlan_set_result, tx_vlan, "tx_vlan");
cmdline_parse_token_string_t cmd_tx_vlan_set_set =
    TOKEN_STRING_INITIALIZER(struct cmd_tx_vlan_set_result, set, "set");
cmdline_parse_token_num_t cmd_tx_vlan_set_portid =
    TOKEN_NUM_INITIALIZER(struct cmd_tx_vlan_set_result, port_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_tx_vlan_set_vlanid =
    TOKEN_NUM_INITIALIZER(struct cmd_tx_vlan_set_result, vlan_id, RTE_UINT16);
...
static void cmd_tx_vlan_set_qinq_parsed(void *parsed_result,
                                        __rte_unused struct cmdline *cl,
                                        __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_tx_vlan_set_qinq_tx_vlan =
    TOKEN_STRING_INITIALIZER(struct cmd_tx_vlan_set_qinq_result, tx_vlan,
                             "tx_vlan");
cmdline_parse_token_string_t cmd_tx_vlan_set_qinq_set =
    TOKEN_STRING_INITIALIZER(struct cmd_tx_vlan_set_qinq_result, set, "set");
cmdline_parse_token_num_t cmd_tx_vlan_set_qinq_portid = TOKEN_NUM_INITIALIZER(
    struct cmd_tx_vlan_set_qinq_result, port_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_tx_vlan_set_qinq_vlanid = TOKEN_NUM_INITIALIZER(
    struct cmd_tx_vlan_set_qinq_result, vlan_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_tx_vlan_set_qinq_vlanid_outer =
    TOKEN_NUM_INITIALIZER(struct cmd_tx_vlan_set_qinq_result, vlan_id_outer,
                          RTE_UINT16);
...
static void cmd_tx_vlan_set_pvid_parsed(void *parsed_result,
                                        __rte_unused struct cmdline *cl,
                                        __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_tx_vlan_set_pvid_tx_vlan =
    TOKEN_STRING_INITIALIZER(struct cmd_tx_vlan_set_pvid_result, tx_vlan,
                             "tx_vlan");
cmdline_parse_token_string_t cmd_tx_vlan_set_pvid_set =
    TOKEN_STRING_INITIALIZER(struct cmd_tx_vlan_set_pvid_result, set, "set");
cmdline_parse_token_string_t cmd_tx_vlan_set_pvid_pvid =
    TOKEN_STRING_INITIALIZER(struct cmd_tx_vlan_set_pvid_result, pvid, "pvid");
cmdline_parse_token_num_t cmd_tx_vlan_set_pvid_port_id = TOKEN_NUM_INITIALIZER(
    struct cmd_tx_vlan_set_pvid_result, port_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_tx_vlan_set_pvid_vlan_id = TOKEN_NUM_INITIALIZER(
    struct cmd_tx_vlan_set_pvid_result, vlan_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_tx_vlan_set_pvid_mode =
    TOKEN_STRING_INITIALIZER(struct cmd_tx_vlan_set_pvid_result, mode,
                             "on#off");
...
static void cmd_tx_vlan_reset_parsed(void *parsed_result,
                                     __rte_unused struct cmdline *cl,
                                     __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_tx_vlan_reset_tx_vlan =
    TOKEN_STRING_INITIALIZER(struct cmd_tx_vlan_reset_result, tx_vlan,
                             "tx_vlan");
cmdline_parse_token_string_t cmd_tx_vlan_reset_reset =
    TOKEN_STRING_INITIALIZER(struct cmd_tx_vlan_reset_result, reset, "reset");
cmdline_parse_token_num_t cmd_tx_vlan_reset_portid =
    TOKEN_NUM_INITIALIZER(struct cmd_tx_vlan_reset_result, port_id, RTE_UINT16);
...
static void csum_show(int port_id) {
  struct rte_eth_dev_info dev_info;
  ...
  if ((tx_offloads & RTE_ETH_TX_OFFLOAD_SCTP_CKSUM) &&
    ...
    fprintf(stderr,
            "Warning: hardware SCTP checksum enabled but not supported by port "
            "%d\n",
            port_id);
  }
  if ((tx_offloads & RTE_ETH_TX_OFFLOAD_OUTER_IPV4_CKSUM) &&
    ...
    fprintf(stderr,
            "Warning: hardware outer IP checksum enabled but not supported by "
            "port %d\n",
            port_id);
  }
  if ((tx_offloads & RTE_ETH_TX_OFFLOAD_OUTER_UDP_CKSUM) &&
      (dev_info.tx_offload_capa & RTE_ETH_TX_OFFLOAD_OUTER_UDP_CKSUM) == 0) {
    fprintf(stderr,
            "Warning: hardware outer UDP checksum enabled but not supported by "
            "port %d\n",
            port_id);
  }
}

static void cmd_config_queue_tx_offloads(struct rte_port *port) {
  int k;

  /* Apply queue tx offloads configuration */
  for (k = 0; k < port->dev_info.max_tx_queues; k++)
    port->tx_conf[k].offloads = port->dev_conf.txmode.offloads;
}

static void cmd_csum_parsed(void *parsed_result,
                            __rte_unused struct cmdline *cl,
                            __rte_unused void *data) {
  ...
  if (!strcmp(res->mode, "set")) {
    ...
    if (!strcmp(res->proto, "ip")) {
      if (hw == 0 ||
        ...
        fprintf(stderr, "IP checksum offload is not supported by port %u\n",
                res->port_id);
      }
      ...
      if (hw == 0 ||
        ...
        fprintf(stderr, "UDP checksum offload is not supported by port %u\n",
                res->port_id);
      }
      ...
      if (hw == 0 ||
        ...
        fprintf(stderr, "TCP checksum offload is not supported by port %u\n",
                res->port_id);
      }
    } else if (!strcmp(res->proto, "sctp")) {
      if (hw == 0 ||
          (dev_info.tx_offload_capa & RTE_ETH_TX_OFFLOAD_SCTP_CKSUM)) {
        csum_offloads |= RTE_ETH_TX_OFFLOAD_SCTP_CKSUM;
      } else {
        fprintf(stderr, "SCTP checksum offload is not supported by port %u\n",
                res->port_id);
      }
    } else if (!strcmp(res->proto, "outer-ip")) {
      if (hw == 0 ||
          (dev_info.tx_offload_capa & RTE_ETH_TX_OFFLOAD_OUTER_IPV4_CKSUM)) {
        csum_offloads |= RTE_ETH_TX_OFFLOAD_OUTER_IPV4_CKSUM;
      } else {
        fprintf(stderr,
      ...
      if (hw == 0 ||
        ...
        csum_offloads |= RTE_ETH_TX_OFFLOAD_OUTER_UDP_CKSUM;
      } else {
        fprintf(stderr,
    ...
    if (hw) {
      ports[res->port_id].dev_conf.txmode.offloads |= csum_offloads;
    } else {
      ports[res->port_id].dev_conf.txmode.offloads &= (~csum_offloads);
    }
...
cmdline_parse_token_string_t cmd_csum_csum =
    TOKEN_STRING_INITIALIZER(struct cmd_csum_result, csum, "csum");
cmdline_parse_token_string_t cmd_csum_mode =
    TOKEN_STRING_INITIALIZER(struct cmd_csum_result, mode, "set");
cmdline_parse_token_string_t cmd_csum_proto = TOKEN_STRING_INITIALIZER(
    struct cmd_csum_result, proto, "ip#tcp#udp#sctp#outer-ip#outer-udp");
cmdline_parse_token_string_t cmd_csum_hwsw =
    TOKEN_STRING_INITIALIZER(struct cmd_csum_result, hwsw, "hw#sw");
cmdline_parse_token_num_t cmd_csum_portid =
    TOKEN_NUM_INITIALIZER(struct cmd_csum_result, port_id, RTE_UINT16);
...
cmdline_parse_token_string_t cmd_csum_mode_show =
    TOKEN_STRING_INITIALIZER(struct cmd_csum_result, mode, "show");
...
static void cmd_csum_tunnel_parsed(void *parsed_result,
                                   __rte_unused struct cmdline *cl,
                                   __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_csum_tunnel_csum =
    TOKEN_STRING_INITIALIZER(struct cmd_csum_tunnel_result, csum, "csum");
cmdline_parse_token_string_t cmd_csum_tunnel_parse = TOKEN_STRING_INITIALIZER(
    struct cmd_csum_tunnel_result, parse, "parse-tunnel");
cmdline_parse_token_string_t cmd_csum_tunnel_onoff =
    TOKEN_STRING_INITIALIZER(struct cmd_csum_tunnel_result, onoff, "on#off");
cmdline_parse_token_num_t cmd_csum_tunnel_portid =
    TOKEN_NUM_INITIALIZER(struct cmd_csum_tunnel_result, port_id, RTE_UINT16);
...
static void cmd_tso_set_parsed(void *parsed_result,
                               __rte_unused struct cmdline *cl,
                               __rte_unused void *data) {
  ...
  if (ports[res->port_id].tso_segsz == 0) {
    ports[res->port_id].dev_conf.txmode.offloads &= ~RTE_ETH_TX_OFFLOAD_TCP_TSO;
  ...
  if ((ports[res->port_id].tso_segsz != 0) &&
      (dev_info.tx_offload_capa & RTE_ETH_TX_OFFLOAD_TCP_TSO) == 0) {
    fprintf(stderr, "Warning: TSO enabled but not supported by port %d\n",
            res->port_id);
  }
...
cmdline_parse_token_string_t cmd_tso_set_tso =
    TOKEN_STRING_INITIALIZER(struct cmd_tso_set_result, tso, "tso");
cmdline_parse_token_string_t cmd_tso_set_mode =
    TOKEN_STRING_INITIALIZER(struct cmd_tso_set_result, mode, "set");
cmdline_parse_token_num_t cmd_tso_set_tso_segsz =
    TOKEN_NUM_INITIALIZER(struct cmd_tso_set_result, tso_segsz, RTE_UINT16);
cmdline_parse_token_num_t cmd_tso_set_portid =
    TOKEN_NUM_INITIALIZER(struct cmd_tso_set_result, port_id, RTE_UINT16);
...
cmdline_parse_token_string_t cmd_tso_show_mode =
    TOKEN_STRING_INITIALIZER(struct cmd_tso_set_result, mode, "show");
...
static struct rte_eth_dev_info check_tunnel_tso_nic_support(portid_t port_id) {
  struct rte_eth_dev_info dev_info;
  ...
  if (!(dev_info.tx_offload_capa & RTE_ETH_TX_OFFLOAD_VXLAN_TNL_TSO))
    fprintf(stderr,
            "Warning: VXLAN TUNNEL TSO not supported therefore not enabled for "
            "port %d\n",
            port_id);
  if (!(dev_info.tx_offload_capa & RTE_ETH_TX_OFFLOAD_GRE_TNL_TSO))
    fprintf(stderr,
            "Warning: GRE TUNNEL TSO not supported therefore not enabled for "
            "port %d\n",
            port_id);
  if (!(dev_info.tx_offload_capa & RTE_ETH_TX_OFFLOAD_IPIP_TNL_TSO))
    fprintf(stderr,
            "Warning: IPIP TUNNEL TSO not supported therefore not enabled for "
            "port %d\n",
            port_id);
  if (!(dev_info.tx_offload_capa & RTE_ETH_TX_OFFLOAD_GENEVE_TNL_TSO))
    fprintf(stderr,
            "Warning: GENEVE TUNNEL TSO not supported therefore not enabled "
            "for port %d\n",
            port_id);
  if (!(dev_info.tx_offload_capa & RTE_ETH_TX_OFFLOAD_IP_TNL_TSO))
    fprintf(stderr,
            "Warning: IP TUNNEL TSO not supported therefore not enabled for "
            "port %d\n",
            port_id);
  if (!(dev_info.tx_offload_capa & RTE_ETH_TX_OFFLOAD_UDP_TNL_TSO))
    fprintf(stderr,
            "Warning: UDP TUNNEL TSO not supported therefore not enabled for "
            "port %d\n",
            port_id);
  return dev_info;
}

static void cmd_tunnel_tso_set_parsed(void *parsed_result,
                                      __rte_unused struct cmdline *cl,
                                      __rte_unused void *data) {
  ...
  if (ports[res->port_id].tunnel_tso_segsz == 0) {
    ...
    if (!ports[res->port_id].parse_tunnel)
      fprintf(stderr, "Warning: csum parse_tunnel must be set so that tunneled "
                      "packets are recognized\n");
    if (!(ports[res->port_id].dev_conf.txmode.offloads &
          RTE_ETH_TX_OFFLOAD_OUTER_IPV4_CKSUM))
      fprintf(stderr, "Warning: csum set outer-ip must be set to hw if outer "
                      "L3 is IPv4; not necessary for IPv6\n");
  }
...
cmdline_parse_token_string_t cmd_tunnel_tso_set_tso = TOKEN_STRING_INITIALIZER(
    struct cmd_tunnel_tso_set_result, tso, "tunnel_tso");
cmdline_parse_token_string_t cmd_tunnel_tso_set_mode =
    TOKEN_STRING_INITIALIZER(struct cmd_tunnel_tso_set_result, mode, "set");
cmdline_parse_token_num_t cmd_tunnel_tso_set_tso_segsz = TOKEN_NUM_INITIALIZER(
    struct cmd_tunnel_tso_set_result, tso_segsz, RTE_UINT16);
cmdline_parse_token_num_t cmd_tunnel_tso_set_portid = TOKEN_NUM_INITIALIZER(
    struct cmd_tunnel_tso_set_result, port_id, RTE_UINT16);
...
cmdline_parse_token_string_t cmd_tunnel_tso_show_mode =
    TOKEN_STRING_INITIALIZER(struct cmd_tunnel_tso_set_result, mode, "show");
...
static void cmd_gro_enable_parsed(void *parsed_result,
                                  __rte_unused struct cmdline *cl,
                                  __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_gro_enable_set =
    TOKEN_STRING_INITIALIZER(struct cmd_gro_enable_result, cmd_set, "set");
cmdline_parse_token_string_t cmd_gro_enable_port =
    TOKEN_STRING_INITIALIZER(struct cmd_gro_enable_result, cmd_keyword, "port");
cmdline_parse_token_num_t cmd_gro_enable_pid =
    TOKEN_NUM_INITIALIZER(struct cmd_gro_enable_result, cmd_pid, RTE_UINT16);
cmdline_parse_token_string_t cmd_gro_enable_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_gro_enable_result, cmd_keyword, "gro");
cmdline_parse_token_string_t cmd_gro_enable_onoff =
    TOKEN_STRING_INITIALIZER(struct cmd_gro_enable_result, cmd_onoff, "on#off");
...
static void cmd_gro_show_parsed(void *parsed_result,
                                __rte_unused struct cmdline *cl,
                                __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_gro_show_show =
    TOKEN_STRING_INITIALIZER(struct cmd_gro_show_result, cmd_show, "show");
cmdline_parse_token_string_t cmd_gro_show_port =
    TOKEN_STRING_INITIALIZER(struct cmd_gro_show_result, cmd_port, "port");
cmdline_parse_token_num_t cmd_gro_show_pid =
    TOKEN_NUM_INITIALIZER(struct cmd_gro_show_result, cmd_pid, RTE_UINT16);
cmdline_parse_token_string_t cmd_gro_show_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_gro_show_result, cmd_keyword, "gro");
...
static void cmd_gro_flush_parsed(void *parsed_result,
                                 __rte_unused struct cmdline *cl,
                                 __rte_unused void *data) {
  struct cmd_gro_flush_result *res;

  res = parsed_result;
  if ((!strcmp(res->cmd_keyword, "gro")) && (!strcmp(res->cmd_flush, "flush")))
    setup_gro_flush_cycles(res->cmd_cycles);
}

cmdline_parse_token_string_t cmd_gro_flush_set =
    TOKEN_STRING_INITIALIZER(struct cmd_gro_flush_result, cmd_set, "set");
cmdline_parse_token_string_t cmd_gro_flush_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_gro_flush_result, cmd_keyword, "gro");
cmdline_parse_token_string_t cmd_gro_flush_flush =
    TOKEN_STRING_INITIALIZER(struct cmd_gro_flush_result, cmd_flush, "flush");
cmdline_parse_token_num_t cmd_gro_flush_cycles =
    TOKEN_NUM_INITIALIZER(struct cmd_gro_flush_result, cmd_cycles, RTE_UINT8);
...
static void cmd_gso_enable_parsed(void *parsed_result,
                                  __rte_unused struct cmdline *cl,
                                  __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_gso_enable_set =
    TOKEN_STRING_INITIALIZER(struct cmd_gso_enable_result, cmd_set, "set");
cmdline_parse_token_string_t cmd_gso_enable_port =
    TOKEN_STRING_INITIALIZER(struct cmd_gso_enable_result, cmd_port, "port");
cmdline_parse_token_string_t cmd_gso_enable_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_gso_enable_result, cmd_keyword, "gso");
cmdline_parse_token_string_t cmd_gso_enable_mode =
    TOKEN_STRING_INITIALIZER(struct cmd_gso_enable_result, cmd_mode, "on#off");
cmdline_parse_token_num_t cmd_gso_enable_pid =
    TOKEN_NUM_INITIALIZER(struct cmd_gso_enable_result, cmd_pid, RTE_UINT16);
...
static void cmd_gso_size_parsed(void *parsed_result,
                                __rte_unused struct cmdline *cl,
                                __rte_unused void *data) {
  ...
  if (!strcmp(res->cmd_keyword, "gso") && !strcmp(res->cmd_segsz, "segsz")) {
...
cmdline_parse_token_string_t cmd_gso_size_set =
    TOKEN_STRING_INITIALIZER(struct cmd_gso_size_result, cmd_set, "set");
cmdline_parse_token_string_t cmd_gso_size_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_gso_size_result, cmd_keyword, "gso");
cmdline_parse_token_string_t cmd_gso_size_segsz =
    TOKEN_STRING_INITIALIZER(struct cmd_gso_size_result, cmd_segsz, "segsz");
cmdline_parse_token_num_t cmd_gso_size_size =
    TOKEN_NUM_INITIALIZER(struct cmd_gso_size_result, cmd_size, RTE_UINT16);
...
static void cmd_gso_show_parsed(void *parsed_result,
                                __rte_unused struct cmdline *cl,
                                __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_gso_show_show =
    TOKEN_STRING_INITIALIZER(struct cmd_gso_show_result, cmd_show, "show");
cmdline_parse_token_string_t cmd_gso_show_port =
    TOKEN_STRING_INITIALIZER(struct cmd_gso_show_result, cmd_port, "port");
cmdline_parse_token_string_t cmd_gso_show_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_gso_show_result, cmd_keyword, "gso");
cmdline_parse_token_num_t cmd_gso_show_pid =
    TOKEN_NUM_INITIALIZER(struct cmd_gso_show_result, cmd_pid, RTE_UINT16);
...
static void cmd_set_flush_rx_parsed(void *parsed_result,
                                    __rte_unused struct cmdline *cl,
                                    __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_setflushrx_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_flush_rx, set, "set");
cmdline_parse_token_string_t cmd_setflushrx_flush_rx =
    TOKEN_STRING_INITIALIZER(struct cmd_set_flush_rx, flush_rx, "flush_rx");
cmdline_parse_token_string_t cmd_setflushrx_mode =
    TOKEN_STRING_INITIALIZER(struct cmd_set_flush_rx, mode, "on#off");
...
static void cmd_set_link_check_parsed(void *parsed_result,
                                      __rte_unused struct cmdline *cl,
                                      __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_setlinkcheck_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_link_check, set, "set");
cmdline_parse_token_string_t cmd_setlinkcheck_link_check =
    TOKEN_STRING_INITIALIZER(struct cmd_set_link_check, link_check,
                             "link_check");
cmdline_parse_token_string_t cmd_setlinkcheck_mode =
    TOKEN_STRING_INITIALIZER(struct cmd_set_link_check, mode, "on#off");
...
static void cmd_set_bypass_mode_parsed(void *parsed_result,
                                       __rte_unused struct cmdline *cl,
                                       __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_setbypass_mode_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bypass_mode_result, set, "set");
cmdline_parse_token_string_t cmd_setbypass_mode_bypass =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bypass_mode_result, bypass,
                             "bypass");
cmdline_parse_token_string_t cmd_setbypass_mode_mode =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bypass_mode_result, mode, "mode");
cmdline_parse_token_string_t cmd_setbypass_mode_value =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bypass_mode_result, value,
                             "normal#bypass#isolate");
cmdline_parse_token_num_t cmd_setbypass_mode_port = TOKEN_NUM_INITIALIZER(
    struct cmd_set_bypass_mode_result, port_id, RTE_UINT16);
...
static void cmd_set_bypass_event_parsed(void *parsed_result,
                                        __rte_unused struct cmdline *cl,
                                        __rte_unused void *data) {
  int32_t rc = -EINVAL;
  ...
  if (bypass_event == RTE_PMD_IXGBE_BYPASS_EVENT_TIMEOUT) {
    ...
    if (RTE_PMD_IXGBE_BYPASS_TMT_VALID(bypass_timeout)) {
      rc = rte_pmd_ixgbe_bypass_wd_timeout_store(port_id, bypass_timeout);
    }
    if (rc != 0) {
      fprintf(stderr,
  ...
  rc = rte_pmd_ixgbe_bypass_event_store(port_id, bypass_event, bypass_mode);
#endif
...
cmdline_parse_token_string_t cmd_setbypass_event_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bypass_event_result, set, "set");
cmdline_parse_token_string_t cmd_setbypass_event_bypass =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bypass_event_result, bypass,
                             "bypass");
cmdline_parse_token_string_t cmd_setbypass_event_event =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bypass_event_result, event,
                             "event");
cmdline_parse_token_string_t cmd_setbypass_event_event_value =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bypass_event_result, event_value,
                             "none#timeout#os_off#os_on#power_on#power_off");
cmdline_parse_token_string_t cmd_setbypass_event_mode =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bypass_event_result, mode, "mode");
cmdline_parse_token_string_t cmd_setbypass_event_mode_value =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bypass_event_result, mode_value,
                             "normal#bypass#isolate");
cmdline_parse_token_num_t cmd_setbypass_event_port = TOKEN_NUM_INITIALIZER(
    struct cmd_set_bypass_event_result, port_id, RTE_UINT16);
...
static void cmd_set_bypass_timeout_parsed(void *parsed_result,
                                          __rte_unused struct cmdline *cl,
                                          __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_setbypass_timeout_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bypass_timeout_result, set, "set");
cmdline_parse_token_string_t cmd_setbypass_timeout_bypass =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bypass_timeout_result, bypass,
                             "bypass");
cmdline_parse_token_string_t cmd_setbypass_timeout_timeout =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bypass_timeout_result, timeout,
                             "timeout");
cmdline_parse_token_string_t cmd_setbypass_timeout_value =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bypass_timeout_result, value,
                             "0#1.5#2#3#4#8#16#32");
...
static void cmd_show_bypass_config_parsed(void *parsed_result,
                                          __rte_unused struct cmdline *cl,
                                          __rte_unused void *data) {
  ...
  static const char *const events[RTE_PMD_IXGBE_BYPASS_EVENT_NUM] = {
      "NONE",         "OS/board on",      "power supply on",
      "OS/board off", "power supply off", "timeout"};
...
cmdline_parse_token_string_t cmd_showbypass_config_show =
    TOKEN_STRING_INITIALIZER(struct cmd_show_bypass_config_result, show,
                             "show");
cmdline_parse_token_string_t cmd_showbypass_config_bypass =
    TOKEN_STRING_INITIALIZER(struct cmd_show_bypass_config_result, bypass,
                             "bypass");
cmdline_parse_token_string_t cmd_showbypass_config_config =
    TOKEN_STRING_INITIALIZER(struct cmd_show_bypass_config_result, config,
                             "config");
cmdline_parse_token_num_t cmd_showbypass_config_port = TOKEN_NUM_INITIALIZER(
    struct cmd_show_bypass_config_result, port_id, RTE_UINT16);
...
cmdline_parse_token_string_t cmd_setbonding_mode_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bonding_mode_result, set, "set");
cmdline_parse_token_string_t cmd_setbonding_mode_bonding =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bonding_mode_result, bonding,
                             "bonding");
cmdline_parse_token_string_t cmd_setbonding_mode_mode =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bonding_mode_result, mode, "mode");
cmdline_parse_token_num_t cmd_setbonding_mode_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_bonding_mode_result, value, RTE_UINT8);
cmdline_parse_token_num_t cmd_setbonding_mode_port = TOKEN_NUM_INITIALIZER(
    struct cmd_set_bonding_mode_result, port_id, RTE_UINT16);
...
cmdline_parse_inst_t cmd_set_bonding_mode = {
    ...
    .data = NULL,
    .tokens = {
        (void *)&cmd_setbonding_mode_set, (void *)&cmd_setbonding_mode_bonding,
        (void *)&cmd_setbonding_mode_mode, (void *)&cmd_setbonding_mode_value,
        (void *)&cmd_setbonding_mode_port, NULL}};
...
cmdline_parse_token_string_t cmd_setbonding_lacp_dedicated_queues_set =
    TOKEN_STRING_INITIALIZER(
        struct cmd_set_bonding_lacp_dedicated_queues_result, set, "set");
cmdline_parse_token_string_t cmd_setbonding_lacp_dedicated_queues_bonding =
    TOKEN_STRING_INITIALIZER(
        struct cmd_set_bonding_lacp_dedicated_queues_result, bonding,
        "bonding");
cmdline_parse_token_string_t cmd_setbonding_lacp_dedicated_queues_lacp =
    TOKEN_STRING_INITIALIZER(
        struct cmd_set_bonding_lacp_dedicated_queues_result, lacp, "lacp");
...
cmdline_parse_inst_t cmd_set_lacp_dedicated_queues = {
    ...
    .tokens = {(void *)&cmd_setbonding_lacp_dedicated_queues_set,
               ...
               (void *)&cmd_setbonding_lacp_dedicated_queues_mode, NULL}};
...
cmdline_parse_inst_t cmd_set_balance_xmit_policy = {
    ...
    .data = NULL,
    .tokens = {(void *)&cmd_setbonding_balance_xmit_policy_set,
               ...
               (void *)&cmd_setbonding_balance_xmit_policy_policy, NULL}};
...
static void lacp_slave_info_show(struct rte_eth_bond_8023ad_slave_info *info) {
  ...
  static const char *const state[] = {
      "ACTIVE",     "TIMEOUT",      "AGGREGATION", "SYNCHRONIZATION",
      "COLLECTING", "DISTRIBUTING", "DEFAULTED",   "EXPIRED"};
  static const char *const selection[] = {"UNSELECTED", "STANDBY", "SELECTED"};

  for (i = 0; i < RTE_DIM(state); i++) {
    if ((info->actor_state >> i) & 1)
      a_len +=
          snprintf(&a_state[a_len], RTE_DIM(a_state) - a_len, "%s ", state[i]);

    if ((info->partner_state >> i) & 1)
      p_len +=
          snprintf(&p_state[p_len], RTE_DIM(p_state) - p_len, "%s ", state[i]);
  }
...
static void cmd_show_bonding_lacp_info_parsed(void *parsed_result,
  ...
  num_active_slaves =
      rte_eth_bond_active_slaves_get(port_id, slaves, RTE_MAX_ETHPORTS);
  ...
  for (i = 0; i < num_active_slaves; i++) {
    ret = rte_eth_bond_8023ad_slave_info(port_id, slaves[i], &slave_info);
    if (ret) {
...
cmdline_parse_token_string_t cmd_show_bonding_lacp_info_show =
    TOKEN_STRING_INITIALIZER(struct cmd_show_bonding_lacp_info_result, show,
                             "show");
cmdline_parse_token_string_t cmd_show_bonding_lacp_info_bonding =
    TOKEN_STRING_INITIALIZER(struct cmd_show_bonding_lacp_info_result, bonding,
                             "bonding");
cmdline_parse_token_string_t cmd_show_bonding_lacp_info_lacp =
    TOKEN_STRING_INITIALIZER(struct cmd_show_bonding_lacp_info_result, bonding,
                             "lacp");
cmdline_parse_token_string_t cmd_show_bonding_lacp_info_info =
    TOKEN_STRING_INITIALIZER(struct cmd_show_bonding_lacp_info_result, info,
                             "info");
cmdline_parse_token_num_t cmd_show_bonding_lacp_info_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_show_bonding_lacp_info_result, port_id,
                          RTE_UINT16);
...
static void cmd_show_bonding_config_parsed(void *parsed_result,
  ...
  if (bonding_mode == BONDING_MODE_BALANCE ||
    ...
    if (balance_xmit_policy < 0) {
      fprintf(stderr, "\tFailed to get balance xmit policy for port = %d\n",
              port_id);
      return;
    } else {
  ...
  if (num_active_slaves < 0) {
    fprintf(stderr, "\tFailed to get active slave list for port = %d\n",
            port_id);
    return;
  }
  if (num_active_slaves > 0) {
...
cmdline_parse_token_string_t cmd_showbonding_config_show =
    TOKEN_STRING_INITIALIZER(struct cmd_show_bonding_config_result, show,
                             "show");
cmdline_parse_token_string_t cmd_showbonding_config_bonding =
    TOKEN_STRING_INITIALIZER(struct cmd_show_bonding_config_result, bonding,
                             "bonding");
cmdline_parse_token_string_t cmd_showbonding_config_config =
    TOKEN_STRING_INITIALIZER(struct cmd_show_bonding_config_result, config,
                             "config");
cmdline_parse_token_num_t cmd_showbonding_config_port = TOKEN_NUM_INITIALIZER(
    struct cmd_show_bonding_config_result, port_id, RTE_UINT16);
...
cmdline_parse_inst_t cmd_show_bonding_config = {
    ...
    .help_str = "show bonding config <port_id>: "
                "Show the bonding config for port_id",
    .data = NULL,
    .tokens = {(void *)&cmd_showbonding_config_show,
               (void *)&cmd_showbonding_config_bonding,
               (void *)&cmd_showbonding_config_config,
               (void *)&cmd_showbonding_config_port, NULL}};
...
cmdline_parse_token_string_t cmd_setbonding_primary_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bonding_primary_result, set, "set");
cmdline_parse_token_string_t cmd_setbonding_primary_bonding =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bonding_primary_result, bonding,
                             "bonding");
cmdline_parse_token_string_t cmd_setbonding_primary_primary =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bonding_primary_result, primary,
                             "primary");
cmdline_parse_token_num_t cmd_setbonding_primary_slave = TOKEN_NUM_INITIALIZER(
    struct cmd_set_bonding_primary_result, slave_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_setbonding_primary_port = TOKEN_NUM_INITIALIZER(
    struct cmd_set_bonding_primary_result, port_id, RTE_UINT16);
...
static void cmd_add_bonding_slave_parsed(void *parsed_result,
  ...
  if (0 != rte_eth_bond_slave_add(master_port_id, slave_port_id)) {
    fprintf(stderr, "\t Failed to add slave %d to master port = %d.\n",
...
cmdline_parse_token_string_t cmd_addbonding_slave_add =
    TOKEN_STRING_INITIALIZER(struct cmd_add_bonding_slave_result, add, "add");
cmdline_parse_token_string_t cmd_addbonding_slave_bonding =
    TOKEN_STRING_INITIALIZER(struct cmd_add_bonding_slave_result, bonding,
                             "bonding");
cmdline_parse_token_string_t cmd_addbonding_slave_slave =
    TOKEN_STRING_INITIALIZER(struct cmd_add_bonding_slave_result, slave,
                             "slave");
cmdline_parse_token_num_t cmd_addbonding_slave_slaveid = TOKEN_NUM_INITIALIZER(
    struct cmd_add_bonding_slave_result, slave_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_addbonding_slave_port = TOKEN_NUM_INITIALIZER(
    struct cmd_add_bonding_slave_result, port_id, RTE_UINT16);
...
cmdline_parse_inst_t cmd_add_bonding_slave = {
    ...
    .tokens = {(void *)&cmd_addbonding_slave_add,
               ...
               (void *)&cmd_addbonding_slave_port, NULL}};
...
cmdline_parse_token_string_t cmd_removebonding_slave_remove =
    TOKEN_STRING_INITIALIZER(struct cmd_remove_bonding_slave_result, remove,
                             "remove");
cmdline_parse_token_string_t cmd_removebonding_slave_bonding =
    TOKEN_STRING_INITIALIZER(struct cmd_remove_bonding_slave_result, bonding,
                             "bonding");
cmdline_parse_token_string_t cmd_removebonding_slave_slave =
    TOKEN_STRING_INITIALIZER(struct cmd_remove_bonding_slave_result, slave,
                             "slave");
cmdline_parse_token_num_t cmd_removebonding_slave_slaveid =
    TOKEN_NUM_INITIALIZER(struct cmd_remove_bonding_slave_result, slave_id,
                          RTE_UINT16);
cmdline_parse_token_num_t cmd_removebonding_slave_port = TOKEN_NUM_INITIALIZER(
    struct cmd_remove_bonding_slave_result, port_id, RTE_UINT16);
...
cmdline_parse_inst_t cmd_remove_bonding_slave = {
    ...
    .tokens = {(void *)&cmd_removebonding_slave_remove,
               ...
               (void *)&cmd_removebonding_slave_port, NULL}};
...
cmdline_parse_token_string_t cmd_createbonded_device_create =
    TOKEN_STRING_INITIALIZER(struct cmd_create_bonded_device_result, create,
                             "create");
cmdline_parse_token_string_t cmd_createbonded_device_bonded =
    TOKEN_STRING_INITIALIZER(struct cmd_create_bonded_device_result, bonded,
                             "bonded");
cmdline_parse_token_string_t cmd_createbonded_device_device =
    TOKEN_STRING_INITIALIZER(struct cmd_create_bonded_device_result, device,
                             "device");
cmdline_parse_token_num_t cmd_createbonded_device_mode = TOKEN_NUM_INITIALIZER(
    struct cmd_create_bonded_device_result, mode, RTE_UINT8);
cmdline_parse_token_num_t cmd_createbonded_device_socket =
    TOKEN_NUM_INITIALIZER(struct cmd_create_bonded_device_result, socket,
                          RTE_UINT8);
...
cmdline_parse_token_string_t cmd_set_bond_mac_addr_mac =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bond_mac_addr_result, mac_addr,
                             "mac_addr");
cmdline_parse_token_num_t cmd_set_bond_mac_addr_portnum = TOKEN_NUM_INITIALIZER(
    struct cmd_set_bond_mac_addr_result, port_num, RTE_UINT16);
...
cmdline_parse_token_string_t cmd_set_bond_mon_period_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bond_mon_period_result, set, "set");
cmdline_parse_token_string_t cmd_set_bond_mon_period_bonding =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bond_mon_period_result, bonding,
                             "bonding");
cmdline_parse_token_string_t cmd_set_bond_mon_period_mon_period =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bond_mon_period_result, mon_period,
                             "mon_period");
cmdline_parse_token_num_t cmd_set_bond_mon_period_portnum =
    TOKEN_NUM_INITIALIZER(struct cmd_set_bond_mon_period_result, port_num,
                          RTE_UINT16);
cmdline_parse_token_num_t cmd_set_bond_mon_period_period_ms =
    TOKEN_NUM_INITIALIZER(struct cmd_set_bond_mon_period_result, period_ms,
                          RTE_UINT32);
...
static void cmd_set_bonding_agg_mode(void *parsed_result,
                                     __rte_unused struct cmdline *cl,
                                     __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_set_bonding_agg_mode_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_bonding_agg_mode_policy_result, set,
                             "set");
...
cmdline_parse_token_string_t cmd_setfwd_mode = TOKEN_STRING_INITIALIZER(
    struct cmd_set_fwd_mode_result, mode, "" /* defined at init */);
...
cmdline_parse_token_string_t cmd_setfwd_retry_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_fwd_retry_mode_result, set, "set");
cmdline_parse_token_string_t cmd_setfwd_retry_fwd =
    TOKEN_STRING_INITIALIZER(struct cmd_set_fwd_retry_mode_result, fwd, "fwd");
cmdline_parse_token_string_t cmd_setfwd_retry_mode = TOKEN_STRING_INITIALIZER(
    struct cmd_set_fwd_retry_mode_result, mode, "" /* defined at init */);
cmdline_parse_token_string_t cmd_setfwd_retry_retry = TOKEN_STRING_INITIALIZER(
    struct cmd_set_fwd_retry_mode_result, retry, "retry");
...
static void cmd_set_fwd_retry_mode_init(void) {
  ...
  snprintf(help, sizeof(help),
           "set fwd %s retry: "
           "Set packet forwarding mode with retry",
           modes);
  ...
  for (c = token; *modes != '\0'; modes++)
    if (*modes == '|')
      ...
      *c++ = *modes;
  token_struct =
      (cmdline_parse_token_string_t *)cmd_set_fwd_retry_mode.tokens[2];
  token_struct->string_data.str = token;
}
...
cmdline_parse_token_string_t cmd_set_burst_tx_retry_delay =
    TOKEN_STRING_INITIALIZER(struct cmd_set_burst_tx_retry_result, delay,
                             "delay");
cmdline_parse_token_num_t cmd_set_burst_tx_retry_time = TOKEN_NUM_INITIALIZER(
    struct cmd_set_burst_tx_retry_result, time, RTE_UINT32);
cmdline_parse_token_string_t cmd_set_burst_tx_retry_retry =
    TOKEN_STRING_INITIALIZER(struct cmd_set_burst_tx_retry_result, retry,
                             "retry");
...
cmdline_parse_token_string_t cmd_setpromisc_promisc = TOKEN_STRING_INITIALIZER(
    struct cmd_set_promisc_mode_result, promisc, "promisc");
cmdline_parse_token_string_t cmd_setpromisc_portall = TOKEN_STRING_INITIALIZER(
    struct cmd_set_promisc_mode_result, port_all, "all");
cmdline_parse_token_num_t cmd_setpromisc_portnum = TOKEN_NUM_INITIALIZER(
    struct cmd_set_promisc_mode_result, port_num, RTE_UINT16);
cmdline_parse_token_string_t cmd_setpromisc_mode = TOKEN_STRING_INITIALIZER(
    struct cmd_set_promisc_mode_result, mode, "on#off");
...
static void cmd_set_allmulti_mode_parsed(void *parsed_result,
  ...
  /* all ports */
  if (allports) {
    RTE_ETH_FOREACH_DEV(i) { eth_set_allmulticast_mode(i, enable); }
  } else {
...
cmdline_parse_token_string_t cmd_setallmulti_allmulti =
    TOKEN_STRING_INITIALIZER(struct cmd_set_allmulti_mode_result, allmulti,
                             "allmulti");
cmdline_parse_token_string_t cmd_setallmulti_portall = TOKEN_STRING_INITIALIZER(
    struct cmd_set_allmulti_mode_result, port_all, "all");
cmdline_parse_token_num_t cmd_setallmulti_portnum = TOKEN_NUM_INITIALIZER(
    struct cmd_set_allmulti_mode_result, port_num, RTE_UINT16);
cmdline_parse_token_string_t cmd_setallmulti_mode = TOKEN_STRING_INITIALIZER(
    struct cmd_set_allmulti_mode_result, mode, "on#off");
...
cmdline_parse_token_string_t cmd_lfc_show_show =
    TOKEN_STRING_INITIALIZER(struct cmd_link_flow_ctrl_show, show, "show");
cmdline_parse_token_string_t cmd_lfc_show_port =
    TOKEN_STRING_INITIALIZER(struct cmd_link_flow_ctrl_show, port, "port");
cmdline_parse_token_num_t cmd_lfc_show_portid =
    TOKEN_NUM_INITIALIZER(struct cmd_link_flow_ctrl_show, port_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_lfc_show_flow_ctrl = TOKEN_STRING_INITIALIZER(
    struct cmd_link_flow_ctrl_show, flow_ctrl, "flow_ctrl");

static void cmd_link_flow_ctrl_show_parsed(void *parsed_result,
                                           __rte_unused struct cmdline *cl,
                                           __rte_unused void *data) {
  ...
  if (ret != 0) {
    fprintf(stderr, "Failed to get current flow ctrl information: err = %d\n",
            ret);
    return;
  }
...
cmdline_parse_token_string_t cmd_lfc_set_set =
    TOKEN_STRING_INITIALIZER(struct cmd_link_flow_ctrl_set_result, set, "set");
cmdline_parse_token_string_t cmd_lfc_set_flow_ctrl = TOKEN_STRING_INITIALIZER(
    struct cmd_link_flow_ctrl_set_result, flow_ctrl, "flow_ctrl");
cmdline_parse_token_string_t cmd_lfc_set_rx =
    TOKEN_STRING_INITIALIZER(struct cmd_link_flow_ctrl_set_result, rx, "rx");
cmdline_parse_token_string_t cmd_lfc_set_rx_mode = TOKEN_STRING_INITIALIZER(
    struct cmd_link_flow_ctrl_set_result, rx_lfc_mode, "on#off");
cmdline_parse_token_string_t cmd_lfc_set_tx =
    TOKEN_STRING_INITIALIZER(struct cmd_link_flow_ctrl_set_result, tx, "tx");
cmdline_parse_token_string_t cmd_lfc_set_tx_mode = TOKEN_STRING_INITIALIZER(
    struct cmd_link_flow_ctrl_set_result, tx_lfc_mode, "on#off");
cmdline_parse_token_string_t cmd_lfc_set_high_water_str =
    TOKEN_STRING_INITIALIZER(struct cmd_link_flow_ctrl_set_result, hw_str,
                             "high_water");
cmdline_parse_token_num_t cmd_lfc_set_high_water = TOKEN_NUM_INITIALIZER(
    struct cmd_link_flow_ctrl_set_result, high_water, RTE_UINT32);
cmdline_parse_token_string_t cmd_lfc_set_low_water_str =
    TOKEN_STRING_INITIALIZER(struct cmd_link_flow_ctrl_set_result, lw_str,
                             "low_water");
cmdline_parse_token_num_t cmd_lfc_set_low_water = TOKEN_NUM_INITIALIZER(
    struct cmd_link_flow_ctrl_set_result, low_water, RTE_UINT32);
cmdline_parse_token_string_t cmd_lfc_set_pause_time_str =
    TOKEN_STRING_INITIALIZER(struct cmd_link_flow_ctrl_set_result, pt_str,
                             "pause_time");
cmdline_parse_token_num_t cmd_lfc_set_pause_time = TOKEN_NUM_INITIALIZER(
    struct cmd_link_flow_ctrl_set_result, pause_time, RTE_UINT16);
cmdline_parse_token_string_t cmd_lfc_set_send_xon_str =
    TOKEN_STRING_INITIALIZER(struct cmd_link_flow_ctrl_set_result, xon_str,
                             "send_xon");
cmdline_parse_token_num_t cmd_lfc_set_send_xon = TOKEN_NUM_INITIALIZER(
    struct cmd_link_flow_ctrl_set_result, send_xon, RTE_UINT16);
...
cmdline_parse_token_string_t cmd_lfc_set_autoneg_str = TOKEN_STRING_INITIALIZER(
    struct cmd_link_flow_ctrl_set_result, autoneg_str, "autoneg");
cmdline_parse_token_string_t cmd_lfc_set_autoneg = TOKEN_STRING_INITIALIZER(
    struct cmd_link_flow_ctrl_set_result, autoneg, "on#off");
cmdline_parse_token_num_t cmd_lfc_set_portid = TOKEN_NUM_INITIALIZER(
    struct cmd_link_flow_ctrl_set_result, port_id, RTE_UINT16);

/* forward declaration */
static void cmd_link_flow_ctrl_set_parsed(void *parsed_result,
...
static void cmd_link_flow_ctrl_set_parsed(void *parsed_result,
  ...
  if (ret != 0)
    fprintf(stderr, "bad flow control parameter, return code = %d\n", ret);
}
...
static void cmd_priority_flow_ctrl_set_parsed(void *parsed_result,
                                              __rte_unused struct cmdline *cl,
                                              __rte_unused void *data) {
  ...
  if (ret != 0)
    fprintf(stderr, "bad priority flow control parameter, return code = %d\n",
            ret);
}

cmdline_parse_token_string_t cmd_pfc_set_set = TOKEN_STRING_INITIALIZER(
    struct cmd_priority_flow_ctrl_set_result, set, "set");
cmdline_parse_token_string_t cmd_pfc_set_flow_ctrl = TOKEN_STRING_INITIALIZER(
    struct cmd_priority_flow_ctrl_set_result, pfc_ctrl, "pfc_ctrl");
cmdline_parse_token_string_t cmd_pfc_set_rx = TOKEN_STRING_INITIALIZER(
    struct cmd_priority_flow_ctrl_set_result, rx, "rx");
cmdline_parse_token_string_t cmd_pfc_set_rx_mode = TOKEN_STRING_INITIALIZER(
    struct cmd_priority_flow_ctrl_set_result, rx_pfc_mode, "on#off");
cmdline_parse_token_string_t cmd_pfc_set_tx = TOKEN_STRING_INITIALIZER(
    struct cmd_priority_flow_ctrl_set_result, tx, "tx");
cmdline_parse_token_string_t cmd_pfc_set_tx_mode = TOKEN_STRING_INITIALIZER(
    struct cmd_priority_flow_ctrl_set_result, tx_pfc_mode, "on#off");
cmdline_parse_token_num_t cmd_pfc_set_high_water = TOKEN_NUM_INITIALIZER(
    struct cmd_priority_flow_ctrl_set_result, high_water, RTE_UINT32);
cmdline_parse_token_num_t cmd_pfc_set_low_water = TOKEN_NUM_INITIALIZER(
    struct cmd_priority_flow_ctrl_set_result, low_water, RTE_UINT32);
cmdline_parse_token_num_t cmd_pfc_set_pause_time = TOKEN_NUM_INITIALIZER(
    struct cmd_priority_flow_ctrl_set_result, pause_time, RTE_UINT16);
cmdline_parse_token_num_t cmd_pfc_set_priority = TOKEN_NUM_INITIALIZER(
    struct cmd_priority_flow_ctrl_set_result, priority, RTE_UINT8);
cmdline_parse_token_num_t cmd_pfc_set_portid = TOKEN_NUM_INITIALIZER(
    struct cmd_priority_flow_ctrl_set_result, port_id, RTE_UINT16);
...
cmd_queue_priority_flow_ctrl_set_parsed(void *parsed_result,
  ...
  ret = rte_eth_dev_priority_flow_ctrl_queue_configure(res->port_id,
                                                       &pfc_queue_conf);
  if (ret != 0) {
    fprintf(stderr, "bad queue priority flow control parameter, rc = %d\n",
            ret);
  }
}

cmdline_parse_token_string_t cmd_q_pfc_set_set = TOKEN_STRING_INITIALIZER(
    struct cmd_queue_priority_flow_ctrl_set_result, set, "set");
...
cmdline_parse_token_num_t cmd_q_pfc_set_portid = TOKEN_NUM_INITIALIZER(
    struct cmd_queue_priority_flow_ctrl_set_result, port_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_q_pfc_set_rx = TOKEN_STRING_INITIALIZER(
    struct cmd_queue_priority_flow_ctrl_set_result, rx, "rx");
cmdline_parse_token_string_t cmd_q_pfc_set_rx_mode = TOKEN_STRING_INITIALIZER(
    struct cmd_queue_priority_flow_ctrl_set_result, rx_pfc_mode, "on#off");
cmdline_parse_token_num_t cmd_q_pfc_set_tx_qid = TOKEN_NUM_INITIALIZER(
    struct cmd_queue_priority_flow_ctrl_set_result, tx_qid, RTE_UINT16);
cmdline_parse_token_num_t cmd_q_pfc_set_tx_tc = TOKEN_NUM_INITIALIZER(
    struct cmd_queue_priority_flow_ctrl_set_result, tx_tc, RTE_UINT8);
cmdline_parse_token_string_t cmd_q_pfc_set_tx = TOKEN_STRING_INITIALIZER(
    struct cmd_queue_priority_flow_ctrl_set_result, tx, "tx");
cmdline_parse_token_string_t cmd_q_pfc_set_tx_mode = TOKEN_STRING_INITIALIZER(
    struct cmd_queue_priority_flow_ctrl_set_result, tx_pfc_mode, "on#off");
cmdline_parse_token_num_t cmd_q_pfc_set_rx_qid = TOKEN_NUM_INITIALIZER(
    struct cmd_queue_priority_flow_ctrl_set_result, rx_qid, RTE_UINT16);
cmdline_parse_token_num_t cmd_q_pfc_set_rx_tc = TOKEN_NUM_INITIALIZER(
    struct cmd_queue_priority_flow_ctrl_set_result, rx_tc, RTE_UINT8);
cmdline_parse_token_num_t cmd_q_pfc_set_pause_time = TOKEN_NUM_INITIALIZER(
    struct cmd_queue_priority_flow_ctrl_set_result, pause_time, RTE_UINT16);
...
cmdline_parse_token_string_t cmd_reset_def =
    TOKEN_STRING_INITIALIZER(struct cmd_reset_result, def, "default");
...
static void cmd_start_tx_first_parsed(__rte_unused void *parsed_result,
                                      __rte_unused struct cmdline *cl,
                                      __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_start_tx_first_start =
    TOKEN_STRING_INITIALIZER(struct cmd_start_tx_first_result, start, "start");
cmdline_parse_token_string_t cmd_start_tx_first_tx_first =
    TOKEN_STRING_INITIALIZER(struct cmd_start_tx_first_result, tx_first,
                             "tx_first");
...
static void cmd_start_tx_first_n_parsed(void *parsed_result,
                                        __rte_unused struct cmdline *cl,
                                        __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_start_tx_first_n_start =
    TOKEN_STRING_INITIALIZER(struct cmd_start_tx_first_n_result, start,
                             "start");
cmdline_parse_token_string_t cmd_start_tx_first_n_tx_first =
    TOKEN_STRING_INITIALIZER(struct cmd_start_tx_first_n_result, tx_first,
                             "tx_first");
cmdline_parse_token_num_t cmd_start_tx_first_n_tx_num = TOKEN_NUM_INITIALIZER(
    struct cmd_start_tx_first_n_result, tx_num, RTE_UINT32);
...
cmdline_parse_token_string_t cmd_set_link_up_link_up =
    TOKEN_STRING_INITIALIZER(struct cmd_set_link_up_result, link_up, "link-up");
...
static void cmd_set_link_down_parsed(__rte_unused void *parsed_result,
                                     __rte_unused struct cmdline *cl,
                                     __rte_unused void *data) {
...
static void cmd_showportall_parsed(void *parsed_result,
  ...
  if (!strcmp(res->show, "clear")) {
    if (!strcmp(res->what, "stats"))
      RTE_ETH_FOREACH_DEV(i)
    nic_stats_clear(i);
    else if (!strcmp(res->what, "xstats")) RTE_ETH_FOREACH_DEV(i)
        nic_xstats_clear(i);
  ...
  else if (!strcmp(res->what, "stats")) RTE_ETH_FOREACH_DEV(i)
      nic_stats_display(i);
  else if (!strcmp(res->what, "xstats")) RTE_ETH_FOREACH_DEV(i)
      nic_xstats_display(i);
#if defined(RTE_NET_I40E) || defined(RTE_NET_IXGBE)
  else if (!strcmp(res->what, "fdir")) RTE_ETH_FOREACH_DEV(i) fdir_get_infos(i);
#endif
  else if (!strcmp(res->what, "dcb_tc")) RTE_ETH_FOREACH_DEV(i)
      port_dcb_info_display(i);
}

cmdline_parse_token_string_t cmd_showportall_show =
    TOKEN_STRING_INITIALIZER(struct cmd_showportall_result, show, "show#clear");
...
static void cmd_representor_info_parsed(void *parsed_result,
                                        __rte_unused struct cmdline *cl,
                                        __rte_unused void *data) {
  ...
  if (ret < 0) {
    fprintf(stderr,
            "Failed to get the number of representor info ranges for port %hu: "
            "%s\n",
  ...
  if (ret < 0) {
    fprintf(stderr, "Failed to get the representor info for port %hu: %s\n",
            res->cmd_pid, rte_strerror(-ret));
    free(info);
    return;
  }
...
cmdline_parse_token_string_t cmd_representor_info_show =
    TOKEN_STRING_INITIALIZER(struct cmd_representor_info_result, cmd_show,
                             "show");
cmdline_parse_token_string_t cmd_representor_info_port =
    TOKEN_STRING_INITIALIZER(struct cmd_representor_info_result, cmd_port,
                             "port");
cmdline_parse_token_string_t cmd_representor_info_info =
    TOKEN_STRING_INITIALIZER(struct cmd_representor_info_result, cmd_info,
                             "info");
cmdline_parse_token_num_t cmd_representor_info_pid = TOKEN_NUM_INITIALIZER(
    struct cmd_representor_info_result, cmd_pid, RTE_UINT16);
cmdline_parse_token_string_t cmd_representor_info_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_representor_info_result, cmd_keyword,
                             "representor");
...
cmdline_parse_token_string_t cmd_showdevice_show =
    TOKEN_STRING_INITIALIZER(struct cmd_showdevice_result, show, "show");
...
cmdline_parse_token_string_t cmd_showdevice_what =
    TOKEN_STRING_INITIALIZER(struct cmd_showdevice_result, what, "info");
cmdline_parse_token_string_t cmd_showdevice_identifier =
    TOKEN_STRING_INITIALIZER(struct cmd_showdevice_result, identifier, NULL);
...
cmdline_parse_token_num_t cmd_showeeprom_portnum =
    TOKEN_NUM_INITIALIZER(struct cmd_showeeprom_result, portnum, RTE_UINT16);
cmdline_parse_token_string_t cmd_showeeprom_type = TOKEN_STRING_INITIALIZER(
    struct cmd_showeeprom_result, type, "module_eeprom#eeprom");
...
static void cmd_showqueue_parsed(void *parsed_result,
                                 __rte_unused struct cmdline *cl,
                                 __rte_unused void *data) {
...
static void cmd_showfwdall_parsed(void *parsed_result,
                                  __rte_unused struct cmdline *cl,
                                  __rte_unused void *data) {
...
static void cmd_read_reg_parsed(void *parsed_result,
                                __rte_unused struct cmdline *cl,
                                __rte_unused void *data) {
...
static void cmd_read_reg_bit_field_parsed(void *parsed_result,
                                          __rte_unused struct cmdline *cl,
                                          __rte_unused void *data) {
  struct cmd_read_reg_bit_field_result *res = parsed_result;
  port_reg_bit_field_display(res->port_id, res->reg_off, res->bit1_pos,
                             res->bit2_pos);
}
...
cmdline_parse_token_string_t cmd_read_reg_bit_field_regfield =
    TOKEN_STRING_INITIALIZER(struct cmd_read_reg_bit_field_result, regfield,
                             "regfield");
...
static void cmd_read_reg_bit_parsed(void *parsed_result,
                                    __rte_unused struct cmdline *cl,
                                    __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_read_reg_bit_regbit =
    TOKEN_STRING_INITIALIZER(struct cmd_read_reg_bit_result, regbit, "regbit");
...
static void cmd_write_reg_parsed(void *parsed_result,
                                 __rte_unused struct cmdline *cl,
                                 __rte_unused void *data) {
...
static void cmd_write_reg_bit_field_parsed(void *parsed_result,
                                           __rte_unused struct cmdline *cl,
                                           __rte_unused void *data) {
  struct cmd_write_reg_bit_field_result *res = parsed_result;
  port_reg_bit_field_set(res->port_id, res->reg_off, res->bit1_pos,
                         res->bit2_pos, res->value);
}
...
cmdline_parse_token_string_t cmd_write_reg_bit_field_regfield =
    TOKEN_STRING_INITIALIZER(struct cmd_write_reg_bit_field_result, regfield,
                             "regfield");
...
cmdline_parse_token_num_t cmd_write_reg_bit_field_bit2_pos =
    TOKEN_NUM_INITIALIZER(struct cmd_write_reg_bit_field_result, bit2_pos,
                          RTE_UINT8);
cmdline_parse_token_num_t cmd_write_reg_bit_field_value = TOKEN_NUM_INITIALIZER(
    struct cmd_write_reg_bit_field_result, value, RTE_UINT32);
...
static void cmd_write_reg_bit_parsed(void *parsed_result,
                                     __rte_unused struct cmdline *cl,
                                     __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_write_reg_bit_write =
    TOKEN_STRING_INITIALIZER(struct cmd_write_reg_bit_result, write, "write");
cmdline_parse_token_string_t cmd_write_reg_bit_regbit =
    TOKEN_STRING_INITIALIZER(struct cmd_write_reg_bit_result, regbit, "regbit");
...
static void cmd_mac_addr_parsed(void *parsed_result,
  ...
  if (strcmp(res->what, "add") == 0)
    ...
    ret = rte_eth_dev_default_mac_addr_set(res->port_num, &res->address);
  else
...
cmdline_parse_token_string_t cmd_mac_addr_cmd = TOKEN_STRING_INITIALIZER(
    struct cmd_mac_addr_result, mac_addr_cmd, "mac_addr");
cmdline_parse_token_string_t cmd_mac_addr_what = TOKEN_STRING_INITIALIZER(
    struct cmd_mac_addr_result, what, "add#remove#set");
cmdline_parse_token_num_t cmd_mac_addr_portnum =
    TOKEN_NUM_INITIALIZER(struct cmd_mac_addr_result, port_num, RTE_UINT16);
...
static void cmd_set_qmap_parsed(void *parsed_result,
                                __rte_unused struct cmdline *cl,
                                __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_setqmap_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_qmap_result, set, "set");
cmdline_parse_token_string_t cmd_setqmap_qmap =
    TOKEN_STRING_INITIALIZER(struct cmd_set_qmap_result, qmap, "stat_qmap");
cmdline_parse_token_string_t cmd_setqmap_what =
    TOKEN_STRING_INITIALIZER(struct cmd_set_qmap_result, what, "tx#rx");
cmdline_parse_token_num_t cmd_setqmap_portid =
    TOKEN_NUM_INITIALIZER(struct cmd_set_qmap_result, port_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_setqmap_queueid =
    TOKEN_NUM_INITIALIZER(struct cmd_set_qmap_result, queue_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_setqmap_mapvalue =
    TOKEN_NUM_INITIALIZER(struct cmd_set_qmap_result, map_value, RTE_UINT8);
...
static void cmd_set_xstats_hide_zero_parsed(void *parsed_result,
                                            __rte_unused struct cmdline *cl,
                                            __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_set_xstats_hide_zero_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_set_xstats_hide_zero_result, keyword,
                             "set");
cmdline_parse_token_string_t cmd_set_xstats_hide_zero_name =
    TOKEN_STRING_INITIALIZER(struct cmd_set_xstats_hide_zero_result, name,
                             "xstats-hide-zero");
cmdline_parse_token_string_t cmd_set_xstats_hide_zero_on_off =
    TOKEN_STRING_INITIALIZER(struct cmd_set_xstats_hide_zero_result, on_off,
                             "on#off");
...
static void cmd_set_record_core_cycles_parsed(void *parsed_result,
                                              __rte_unused struct cmdline *cl,
                                              __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_set_record_core_cycles_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_set_record_core_cycles_result, keyword,
                             "set");
cmdline_parse_token_string_t cmd_set_record_core_cycles_name =
    TOKEN_STRING_INITIALIZER(struct cmd_set_record_core_cycles_result, name,
                             "record-core-cycles");
cmdline_parse_token_string_t cmd_set_record_core_cycles_on_off =
    TOKEN_STRING_INITIALIZER(struct cmd_set_record_core_cycles_result, on_off,
                             "on#off");
...
static void cmd_set_record_burst_stats_parsed(void *parsed_result,
                                              __rte_unused struct cmdline *cl,
                                              __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_set_record_burst_stats_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_set_record_burst_stats_result, keyword,
                             "set");
cmdline_parse_token_string_t cmd_set_record_burst_stats_name =
    TOKEN_STRING_INITIALIZER(struct cmd_set_record_burst_stats_result, name,
                             "record-burst-stats");
cmdline_parse_token_string_t cmd_set_record_burst_stats_on_off =
    TOKEN_STRING_INITIALIZER(struct cmd_set_record_burst_stats_result, on_off,
                             "on#off");
...
static void cmd_set_uc_hash_parsed(void *parsed_result,
                                   __rte_unused struct cmdline *cl,
                                   __rte_unused void *data) {
  int ret = 0;
  ...
  if (strcmp(res->what, "uta") == 0)
    ret = rte_eth_dev_uc_hash_table_set(res->port_id, &res->address,
                                        (uint8_t)is_on);
  if (ret < 0)
    fprintf(stderr, "bad unicast hash table parameter, return code = %d\n",
            ret);
}

cmdline_parse_token_string_t cmd_set_uc_hash_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_uc_hash_table, set, "set");
cmdline_parse_token_string_t cmd_set_uc_hash_port =
    TOKEN_STRING_INITIALIZER(struct cmd_set_uc_hash_table, port, "port");
cmdline_parse_token_num_t cmd_set_uc_hash_portid =
    TOKEN_NUM_INITIALIZER(struct cmd_set_uc_hash_table, port_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_set_uc_hash_what =
    TOKEN_STRING_INITIALIZER(struct cmd_set_uc_hash_table, what, "uta");
cmdline_parse_token_etheraddr_t cmd_set_uc_hash_mac =
    TOKEN_ETHERADDR_INITIALIZER(struct cmd_set_uc_hash_table, address);
cmdline_parse_token_string_t cmd_set_uc_hash_mode =
    TOKEN_STRING_INITIALIZER(struct cmd_set_uc_hash_table, mode, "on#off");
...
static void cmd_set_uc_all_hash_parsed(void *parsed_result,
                                       __rte_unused struct cmdline *cl,
                                       __rte_unused void *data) {
  int ret = 0;
  ...
  if ((strcmp(res->what, "uta") == 0) && (strcmp(res->value, "all") == 0))
...
cmdline_parse_token_string_t cmd_set_uc_all_hash_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_uc_all_hash_table, set, "set");
cmdline_parse_token_string_t cmd_set_uc_all_hash_port =
    TOKEN_STRING_INITIALIZER(struct cmd_set_uc_all_hash_table, port, "port");
cmdline_parse_token_num_t cmd_set_uc_all_hash_portid = TOKEN_NUM_INITIALIZER(
    struct cmd_set_uc_all_hash_table, port_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_set_uc_all_hash_what =
    TOKEN_STRING_INITIALIZER(struct cmd_set_uc_all_hash_table, what, "uta");
cmdline_parse_token_string_t cmd_set_uc_all_hash_value =
    TOKEN_STRING_INITIALIZER(struct cmd_set_uc_all_hash_table, value, "all");
cmdline_parse_token_string_t cmd_set_uc_all_hash_mode =
    TOKEN_STRING_INITIALIZER(struct cmd_set_uc_all_hash_table, mode, "on#off");
...
static void cmd_set_vf_traffic_parsed(void *parsed_result,
                                      __rte_unused struct cmdline *cl,
                                      __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_setvf_traffic_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_traffic, set, "set");
cmdline_parse_token_string_t cmd_setvf_traffic_port =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_traffic, port, "port");
cmdline_parse_token_num_t cmd_setvf_traffic_portid =
    TOKEN_NUM_INITIALIZER(struct cmd_set_vf_traffic, port_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_setvf_traffic_vf =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_traffic, vf, "vf");
cmdline_parse_token_num_t cmd_setvf_traffic_vfid =
    TOKEN_NUM_INITIALIZER(struct cmd_set_vf_traffic, vf_id, RTE_UINT8);
cmdline_parse_token_string_t cmd_setvf_traffic_what =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_traffic, what, "tx#rx");
cmdline_parse_token_string_t cmd_setvf_traffic_mode =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_traffic, mode, "on#off");
...
static void cmd_set_vf_rxmode_parsed(void *parsed_result,
                                     __rte_unused struct cmdline *cl,
                                     __rte_unused void *data) {
  int ret = -ENOTSUP;
...
#ifdef RTE_NET_IXGBE
  if (ret == -ENOTSUP)
    ret = rte_pmd_ixgbe_set_vf_rxmode(res->port_id, res->vf_id, vf_rxmode,
                                      (uint8_t)is_on);
#endif
#ifdef RTE_NET_BNXT
  if (ret == -ENOTSUP)
    ret = rte_pmd_bnxt_set_vf_rxmode(res->port_id, res->vf_id, vf_rxmode,
                                     (uint8_t)is_on);
#endif
  if (ret < 0)
    fprintf(stderr, "bad VF receive mode parameter, return code = %d\n", ret);
}

cmdline_parse_token_string_t cmd_set_vf_rxmode_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_rxmode, set, "set");
cmdline_parse_token_string_t cmd_set_vf_rxmode_port =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_rxmode, port, "port");
cmdline_parse_token_num_t cmd_set_vf_rxmode_portid =
    TOKEN_NUM_INITIALIZER(struct cmd_set_vf_rxmode, port_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_set_vf_rxmode_vf =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_rxmode, vf, "vf");
cmdline_parse_token_num_t cmd_set_vf_rxmode_vfid =
    TOKEN_NUM_INITIALIZER(struct cmd_set_vf_rxmode, vf_id, RTE_UINT8);
cmdline_parse_token_string_t cmd_set_vf_rxmode_what =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_rxmode, what, "rxmode");
cmdline_parse_token_string_t cmd_set_vf_rxmode_mode = TOKEN_STRING_INITIALIZER(
    struct cmd_set_vf_rxmode, mode, "AUPE#ROPE#BAM#MPE");
cmdline_parse_token_string_t cmd_set_vf_rxmode_on =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_rxmode, on, "on#off");
...
static void cmd_vf_mac_addr_parsed(void *parsed_result,
  ...
  if (ret == -ENOTSUP)
    ret =
        rte_pmd_i40e_add_vf_mac_addr(res->port_num, res->vf_num, &res->address);
#endif
#ifdef RTE_NET_BNXT
  if (ret == -ENOTSUP)
    ret = rte_pmd_bnxt_mac_addr_add(res->port_num, &res->address, res->vf_num);
#endif
...
cmdline_parse_token_string_t cmd_vf_mac_addr_cmd = TOKEN_STRING_INITIALIZER(
    struct cmd_vf_mac_addr_result, mac_addr_cmd, "mac_addr");
cmdline_parse_token_string_t cmd_vf_mac_addr_what =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_mac_addr_result, what, "add");
cmdline_parse_token_string_t cmd_vf_mac_addr_port =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_mac_addr_result, port, "port");
cmdline_parse_token_num_t cmd_vf_mac_addr_portnum =
    TOKEN_NUM_INITIALIZER(struct cmd_vf_mac_addr_result, port_num, RTE_UINT16);
cmdline_parse_token_string_t cmd_vf_mac_addr_vf =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_mac_addr_result, vf, "vf");
cmdline_parse_token_num_t cmd_vf_mac_addr_vfnum =
    TOKEN_NUM_INITIALIZER(struct cmd_vf_mac_addr_result, vf_num, RTE_UINT8);
cmdline_parse_token_etheraddr_t cmd_vf_mac_addr_addr =
    TOKEN_ETHERADDR_INITIALIZER(struct cmd_vf_mac_addr_result, address);
...
static void cmd_vf_rx_vlan_filter_parsed(void *parsed_result,
                                         __rte_unused struct cmdline *cl,
                                         __rte_unused void *data) {
...
#ifdef RTE_NET_I40E
  if (ret == -ENOTSUP)
    ret = rte_pmd_i40e_set_vf_vlan_filter(res->port_id, res->vlan_id,
                                          res->vf_mask, is_add);
#endif
#ifdef RTE_NET_BNXT
  if (ret == -ENOTSUP)
    ret = rte_pmd_bnxt_set_vf_vlan_filter(res->port_id, res->vlan_id,
                                          res->vf_mask, is_add);
#endif
...
cmdline_parse_token_string_t cmd_vf_rx_vlan_filter_rx_vlan =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_rx_vlan_filter, rx_vlan, "rx_vlan");
cmdline_parse_token_string_t cmd_vf_rx_vlan_filter_what =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_rx_vlan_filter, what, "add#rm");
cmdline_parse_token_num_t cmd_vf_rx_vlan_filter_vlanid =
    TOKEN_NUM_INITIALIZER(struct cmd_vf_rx_vlan_filter, vlan_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_vf_rx_vlan_filter_port =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_rx_vlan_filter, port, "port");
cmdline_parse_token_num_t cmd_vf_rx_vlan_filter_portid =
    TOKEN_NUM_INITIALIZER(struct cmd_vf_rx_vlan_filter, port_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_vf_rx_vlan_filter_vf =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_rx_vlan_filter, vf, "vf");
cmdline_parse_token_num_t cmd_vf_rx_vlan_filter_vf_mask =
    TOKEN_NUM_INITIALIZER(struct cmd_vf_rx_vlan_filter, vf_mask, RTE_UINT64);
...
static void cmd_queue_rate_limit_parsed(void *parsed_result,
  ...
  if ((strcmp(res->set, "set") == 0) && (strcmp(res->port, "port") == 0) &&
      (strcmp(res->queue, "queue") == 0) && (strcmp(res->rate, "rate") == 0))
    ret = set_queue_rate_limit(res->port_num, res->queue_num, res->rate_num);
  if (ret < 0)
    fprintf(stderr, "queue_rate_limit_cmd error: (%s)\n", strerror(-ret));
}

cmdline_parse_token_string_t cmd_queue_rate_limit_set =
    TOKEN_STRING_INITIALIZER(struct cmd_queue_rate_limit_result, set, "set");
cmdline_parse_token_string_t cmd_queue_rate_limit_port =
    TOKEN_STRING_INITIALIZER(struct cmd_queue_rate_limit_result, port, "port");
cmdline_parse_token_num_t cmd_queue_rate_limit_portnum = TOKEN_NUM_INITIALIZER(
    struct cmd_queue_rate_limit_result, port_num, RTE_UINT16);
cmdline_parse_token_string_t cmd_queue_rate_limit_queue =
    TOKEN_STRING_INITIALIZER(struct cmd_queue_rate_limit_result, queue,
                             "queue");
cmdline_parse_token_num_t cmd_queue_rate_limit_queuenum = TOKEN_NUM_INITIALIZER(
    struct cmd_queue_rate_limit_result, queue_num, RTE_UINT8);
cmdline_parse_token_string_t cmd_queue_rate_limit_rate =
    TOKEN_STRING_INITIALIZER(struct cmd_queue_rate_limit_result, rate, "rate");
cmdline_parse_token_num_t cmd_queue_rate_limit_ratenum = TOKEN_NUM_INITIALIZER(
    struct cmd_queue_rate_limit_result, rate_num, RTE_UINT16);
...
static void cmd_vf_rate_limit_parsed(void *parsed_result,
  ...
  if ((strcmp(res->set, "set") == 0) && (strcmp(res->port, "port") == 0) &&
      (strcmp(res->vf, "vf") == 0) && (strcmp(res->rate, "rate") == 0) &&
      (strcmp(res->q_msk, "queue_mask") == 0))
    ret = set_vf_rate_limit(res->port_num, res->vf_num, res->rate_num,
                            res->q_msk_val);
  if (ret < 0)
...
cmdline_parse_token_string_t cmd_vf_rate_limit_set =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_rate_limit_result, set, "set");
cmdline_parse_token_string_t cmd_vf_rate_limit_port =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_rate_limit_result, port, "port");
cmdline_parse_token_num_t cmd_vf_rate_limit_portnum = TOKEN_NUM_INITIALIZER(
    struct cmd_vf_rate_limit_result, port_num, RTE_UINT16);
cmdline_parse_token_string_t cmd_vf_rate_limit_vf =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_rate_limit_result, vf, "vf");
cmdline_parse_token_num_t cmd_vf_rate_limit_vfnum =
    TOKEN_NUM_INITIALIZER(struct cmd_vf_rate_limit_result, vf_num, RTE_UINT8);
cmdline_parse_token_string_t cmd_vf_rate_limit_rate =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_rate_limit_result, rate, "rate");
cmdline_parse_token_num_t cmd_vf_rate_limit_ratenum = TOKEN_NUM_INITIALIZER(
    struct cmd_vf_rate_limit_result, rate_num, RTE_UINT16);
cmdline_parse_token_string_t cmd_vf_rate_limit_q_msk = TOKEN_STRING_INITIALIZER(
    struct cmd_vf_rate_limit_result, q_msk, "queue_mask");
cmdline_parse_token_num_t cmd_vf_rate_limit_q_msk_val = TOKEN_NUM_INITIALIZER(
    struct cmd_vf_rate_limit_result, q_msk_val, RTE_UINT64);
...
static void cmd_tunnel_udp_config_parsed(void *parsed_result,
                                         __rte_unused struct cmdline *cl,
                                         __rte_unused void *data) {
  ...
  if (!strcmp(res->what, "add"))
    ret = rte_eth_dev_udp_tunnel_port_add(res->port_id, &tunnel_udp);
  else
    ret = rte_eth_dev_udp_tunnel_port_delete(res->port_id, &tunnel_udp);
...
cmdline_parse_token_string_t cmd_tunnel_udp_config_rx_vxlan_port =
    TOKEN_STRING_INITIALIZER(struct cmd_tunnel_udp_config, rx_vxlan_port,
                             "rx_vxlan_port");
cmdline_parse_token_string_t cmd_tunnel_udp_config_what =
    TOKEN_STRING_INITIALIZER(struct cmd_tunnel_udp_config, what, "add#rm");
...
cmdline_parse_token_num_t cmd_tunnel_udp_config_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_tunnel_udp_config, port_id, RTE_UINT16);
...
static void cmd_cfg_tunnel_udp_port_parsed(void *parsed_result,
                                           __rte_unused struct cmdline *cl,
                                           __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_config_tunnel_udp_port_port =
    TOKEN_STRING_INITIALIZER(struct cmd_config_tunnel_udp_port, port, "port");
...
cmdline_parse_token_string_t cmd_config_tunnel_udp_port_tunnel_port =
    TOKEN_STRING_INITIALIZER(struct cmd_config_tunnel_udp_port, udp_tunnel_port,
                             "udp_tunnel_port");
...
static void dump_struct_sizes(void) {
...
static void dump_socket_mem(FILE *f) {
  ...
  for (i = 0; i < RTE_MAX_NUMA_NODES; i++) {
    ...
    fprintf(f,
            ...
            i, (double)socket_stats.heap_totalsz_bytes / (1024 * 1024),
            ...
            socket_stats.alloc_count, socket_stats.free_count);
  }
  fprintf(f,
          ...
          (double)free / (1024 * 1024), n_alloc, n_free);
  if (last_allocs)
    fprintf(stdout,
            "Memory total change: %.6lf(M), allocation change: %.6lf(M)\n",
...
static void cmd_queue_region_parsed(void *parsed_result,
                                    __rte_unused struct cmdline *cl,
                                    __rte_unused void *data) {
  ...
  ret = rte_pmd_i40e_rss_queue_region_conf(res->port_id, op_type, &region_conf);
#endif
...
cmdline_parse_token_string_t cmd_queue_region_set =
    TOKEN_STRING_INITIALIZER(struct cmd_queue_region_result, set, "set");
...
cmdline_parse_token_num_t cmd_queue_region_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_queue_region_result, port_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_queue_region_cmd = TOKEN_STRING_INITIALIZER(
    struct cmd_queue_region_result, cmd, "queue-region");
cmdline_parse_token_string_t cmd_queue_region_id = TOKEN_STRING_INITIALIZER(
    struct cmd_queue_region_result, region, "region_id");
cmdline_parse_token_num_t cmd_queue_region_index =
    TOKEN_NUM_INITIALIZER(struct cmd_queue_region_result, region_id, RTE_UINT8);
...
cmdline_parse_token_num_t cmd_queue_region_queue_id =
    TOKEN_NUM_INITIALIZER(struct cmd_queue_region_result, queue_id, RTE_UINT8);
cmdline_parse_token_string_t cmd_queue_region_queue_num =
    TOKEN_STRING_INITIALIZER(struct cmd_queue_region_result, queue_num,
                             "queue_num");
cmdline_parse_token_num_t cmd_queue_region_queue_num_value =
    TOKEN_NUM_INITIALIZER(struct cmd_queue_region_result, queue_num_value,
                          RTE_UINT8);
...
static void cmd_region_flowtype_parsed(void *parsed_result,
                                       __rte_unused struct cmdline *cl,
                                       __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_region_flowtype_set =
    TOKEN_STRING_INITIALIZER(struct cmd_region_flowtype_result, set, "set");
cmdline_parse_token_string_t cmd_region_flowtype_port =
    TOKEN_STRING_INITIALIZER(struct cmd_region_flowtype_result, port, "port");
cmdline_parse_token_num_t cmd_region_flowtype_port_index =
    TOKEN_NUM_INITIALIZER(struct cmd_region_flowtype_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_string_t cmd_region_flowtype_cmd = TOKEN_STRING_INITIALIZER(
    struct cmd_region_flowtype_result, cmd, "queue-region");
cmdline_parse_token_string_t cmd_region_flowtype_index =
    TOKEN_STRING_INITIALIZER(struct cmd_region_flowtype_result, region,
                             "region_id");
cmdline_parse_token_num_t cmd_region_flowtype_id = TOKEN_NUM_INITIALIZER(
    struct cmd_region_flowtype_result, region_id, RTE_UINT8);
cmdline_parse_token_string_t cmd_region_flowtype_flow_index =
    TOKEN_STRING_INITIALIZER(struct cmd_region_flowtype_result, flowtype,
                             "flowtype");
cmdline_parse_token_num_t cmd_region_flowtype_flow_id = TOKEN_NUM_INITIALIZER(
    struct cmd_region_flowtype_result, flowtype_id, RTE_UINT8);
...
static void cmd_user_priority_region_parsed(void *parsed_result,
                                            __rte_unused struct cmdline *cl,
                                            __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_user_priority_region_set =
    TOKEN_STRING_INITIALIZER(struct cmd_user_priority_region_result, set,
                             "set");
cmdline_parse_token_string_t cmd_user_priority_region_port =
    TOKEN_STRING_INITIALIZER(struct cmd_user_priority_region_result, port,
                             "port");
cmdline_parse_token_num_t cmd_user_priority_region_port_index =
    TOKEN_NUM_INITIALIZER(struct cmd_user_priority_region_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_string_t cmd_user_priority_region_cmd =
    TOKEN_STRING_INITIALIZER(struct cmd_user_priority_region_result, cmd,
                             "queue-region");
...
cmdline_parse_token_num_t cmd_user_priority_region_region_id =
    TOKEN_NUM_INITIALIZER(struct cmd_user_priority_region_result, region_id,
                          RTE_UINT8);
...
static void cmd_flush_queue_region_parsed(void *parsed_result,
                                          __rte_unused struct cmdline *cl,
                                          __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_flush_queue_region_set =
    TOKEN_STRING_INITIALIZER(struct cmd_flush_queue_region_result, set, "set");
cmdline_parse_token_string_t cmd_flush_queue_region_port =
    TOKEN_STRING_INITIALIZER(struct cmd_flush_queue_region_result, port,
                             "port");
cmdline_parse_token_num_t cmd_flush_queue_region_port_index =
    TOKEN_NUM_INITIALIZER(struct cmd_flush_queue_region_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_string_t cmd_flush_queue_region_cmd =
    TOKEN_STRING_INITIALIZER(struct cmd_flush_queue_region_result, cmd,
                             "queue-region");
cmdline_parse_token_string_t cmd_flush_queue_region_flush =
    TOKEN_STRING_INITIALIZER(struct cmd_flush_queue_region_result, flush,
                             "flush");
cmdline_parse_token_string_t cmd_flush_queue_region_what =
    TOKEN_STRING_INITIALIZER(struct cmd_flush_queue_region_result, what,
                             "on#off");
...
static void cmd_show_queue_region_info_parsed(void *parsed_result,
                                              __rte_unused struct cmdline *cl,
                                              __rte_unused void *data) {
  ...
  ret = rte_pmd_i40e_rss_queue_region_conf(res->port_id, op_type,
                                           &rte_pmd_regions);
...
cmdline_parse_token_string_t cmd_show_queue_region_info_get =
    TOKEN_STRING_INITIALIZER(struct cmd_show_queue_region_info, show, "show");
cmdline_parse_token_string_t cmd_show_queue_region_info_port =
    TOKEN_STRING_INITIALIZER(struct cmd_show_queue_region_info, port, "port");
cmdline_parse_token_num_t cmd_show_queue_region_info_port_index =
    TOKEN_NUM_INITIALIZER(struct cmd_show_queue_region_info, port_id,
                          RTE_UINT16);
cmdline_parse_token_string_t cmd_show_queue_region_info_cmd =
    TOKEN_STRING_INITIALIZER(struct cmd_show_queue_region_info, cmd,
                             "queue-region");
...
#define IPV6_ADDR_TO_ARRAY(ip_addr, ip)                                        \
  do {                                                                         \
    if ((ip_addr).family == AF_INET6)                                          \
      rte_memcpy(&(ip), &((ip_addr).addr.ipv6), sizeof(struct in6_addr));      \
    else {                                                                     \
      fprintf(stderr, "invalid parameter.\n");                                 \
      return;                                                                  \
    }                                                                          \
...
static uint16_t str2flowtype(char *string) {
  uint8_t i = 0;
  static const struct {
    char str[32];
    uint16_t type;
...
static void cmd_flow_director_filter_parsed(void *parsed_result,
                                            __rte_unused struct cmdline *cl,
                                            __rte_unused void *data) {
  ...
  conf.input.packet = open_file(res->filepath, &conf.input.length);
  if (!conf.input.packet)
    return;
  if (!strcmp(res->drop, "drop"))
    conf.action.behavior = RTE_PMD_I40E_PKT_TEMPLATE_REJECT;
  else
    conf.action.behavior = RTE_PMD_I40E_PKT_TEMPLATE_ACCEPT;
  conf.action.report_status = RTE_PMD_I40E_PKT_TEMPLATE_REPORT_ID;
  conf.action.rx_queue = res->queue_id;
  conf.soft_id = res->fd_id_value;
  add = strcmp(res->ops, "del") ? 1 : 0;
  ret = rte_pmd_i40e_flow_add_del_packet_template(port, &conf, add);
  if (ret < 0)
...
cmdline_parse_token_num_t cmd_flow_director_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_flow_director_result, port_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_flow_director_ops = TOKEN_STRING_INITIALIZER(
    struct cmd_flow_director_result, ops, "add#del#update");
cmdline_parse_token_string_t cmd_flow_director_flow =
    TOKEN_STRING_INITIALIZER(struct cmd_flow_director_result, flow, "flow");
cmdline_parse_token_string_t cmd_flow_director_flow_type =
    TOKEN_STRING_INITIALIZER(struct cmd_flow_director_result, flow_type, NULL);
cmdline_parse_token_string_t cmd_flow_director_drop =
    TOKEN_STRING_INITIALIZER(struct cmd_flow_director_result, drop, "drop#fwd");
cmdline_parse_token_string_t cmd_flow_director_queue =
    TOKEN_STRING_INITIALIZER(struct cmd_flow_director_result, queue, "queue");
cmdline_parse_token_num_t cmd_flow_director_queue_id = TOKEN_NUM_INITIALIZER(
    struct cmd_flow_director_result, queue_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_flow_director_fd_id =
    TOKEN_STRING_INITIALIZER(struct cmd_flow_director_result, fd_id, "fd_id");
cmdline_parse_token_num_t cmd_flow_director_fd_id_value = TOKEN_NUM_INITIALIZER(
    struct cmd_flow_director_result, fd_id_value, RTE_UINT32);

cmdline_parse_token_string_t cmd_flow_director_mode =
    TOKEN_STRING_INITIALIZER(struct cmd_flow_director_result, mode, "mode");
cmdline_parse_token_string_t cmd_flow_director_mode_raw =
    TOKEN_STRING_INITIALIZER(struct cmd_flow_director_result, mode_value,
                             "raw");
cmdline_parse_token_string_t cmd_flow_director_packet =
    TOKEN_STRING_INITIALIZER(struct cmd_flow_director_result, packet, "packet");
cmdline_parse_token_string_t cmd_flow_director_filepath =
    TOKEN_STRING_INITIALIZER(struct cmd_flow_director_result, filepath, NULL);
...
static void cmd_flow_director_mask_parsed(void *parsed_result,
                                          __rte_unused struct cmdline *cl,
                                          __rte_unused void *data) {
...
cmdline_parse_token_num_t cmd_flow_director_mask_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_flow_director_mask_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_string_t cmd_flow_director_mask_vlan =
    TOKEN_STRING_INITIALIZER(struct cmd_flow_director_mask_result, vlan,
                             "vlan");
cmdline_parse_token_num_t cmd_flow_director_mask_vlan_value =
    TOKEN_NUM_INITIALIZER(struct cmd_flow_director_mask_result, vlan_mask,
                          RTE_UINT16);
cmdline_parse_token_string_t cmd_flow_director_mask_src =
    TOKEN_STRING_INITIALIZER(struct cmd_flow_director_mask_result, src_mask,
                             "src_mask");
cmdline_parse_token_ipaddr_t cmd_flow_director_mask_ipv4_src =
    TOKEN_IPADDR_INITIALIZER(struct cmd_flow_director_mask_result, ipv4_src);
cmdline_parse_token_ipaddr_t cmd_flow_director_mask_ipv6_src =
    TOKEN_IPADDR_INITIALIZER(struct cmd_flow_director_mask_result, ipv6_src);
cmdline_parse_token_num_t cmd_flow_director_mask_port_src =
    TOKEN_NUM_INITIALIZER(struct cmd_flow_director_mask_result, port_src,
                          RTE_UINT16);
cmdline_parse_token_string_t cmd_flow_director_mask_dst =
    TOKEN_STRING_INITIALIZER(struct cmd_flow_director_mask_result, dst_mask,
                             "dst_mask");
cmdline_parse_token_ipaddr_t cmd_flow_director_mask_ipv4_dst =
    TOKEN_IPADDR_INITIALIZER(struct cmd_flow_director_mask_result, ipv4_dst);
cmdline_parse_token_ipaddr_t cmd_flow_director_mask_ipv6_dst =
    TOKEN_IPADDR_INITIALIZER(struct cmd_flow_director_mask_result, ipv6_dst);
cmdline_parse_token_num_t cmd_flow_director_mask_port_dst =
    TOKEN_NUM_INITIALIZER(struct cmd_flow_director_mask_result, port_dst,
                          RTE_UINT16);

cmdline_parse_token_string_t cmd_flow_director_mask_mode =
    TOKEN_STRING_INITIALIZER(struct cmd_flow_director_mask_result, mode,
                             "mode");
cmdline_parse_token_string_t cmd_flow_director_mask_mode_ip =
    TOKEN_STRING_INITIALIZER(struct cmd_flow_director_mask_result, mode_value,
                             "IP");
...
cmdline_parse_token_string_t cmd_flow_director_mask_mac =
    TOKEN_STRING_INITIALIZER(struct cmd_flow_director_mask_result, mac, "mac");
...
cmdline_parse_token_string_t cmd_flow_director_mask_tunnel_type =
    TOKEN_STRING_INITIALIZER(struct cmd_flow_director_mask_result, tunnel_type,
                             "tunnel-type");
...
cmdline_parse_token_string_t cmd_flow_director_mask_tunnel_id =
    TOKEN_STRING_INITIALIZER(struct cmd_flow_director_mask_result, tunnel_id,
                             "tunnel-id");
cmdline_parse_token_num_t cmd_flow_director_mask_tunnel_id_value =
    TOKEN_NUM_INITIALIZER(struct cmd_flow_director_mask_result, tunnel_id_mask,
                          RTE_UINT32);
...
static inline int parse_offsets(const char *q_arg, uint16_t *offsets,
                                uint16_t max_num) {
  char s[256];
...
static void cmd_flow_director_flxpld_parsed(void *parsed_result,
                                            __rte_unused struct cmdline *cl,
                                            __rte_unused void *data) {
...
cmdline_parse_token_num_t cmd_flow_director_flexpayload_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_flow_director_flexpayload_result, port_id,
                          RTE_UINT16);
...
static void cmd_mcast_addr_parsed(void *parsed_result,
  ...
  if (!rte_is_multicast_ether_addr(&res->mc_addr)) {
    fprintf(stderr, "Invalid multicast addr " RTE_ETHER_ADDR_PRT_FMT "\n",
...
cmdline_parse_token_string_t cmd_mcast_addr_cmd = TOKEN_STRING_INITIALIZER(
    struct cmd_mcast_addr_result, mcast_addr_cmd, "mcast_addr");
cmdline_parse_token_string_t cmd_mcast_addr_what =
    TOKEN_STRING_INITIALIZER(struct cmd_mcast_addr_result, what, "add#remove");
...
cmdline_parse_token_string_t cmd_vf_vlan_anti_spoof_set =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_vlan_anti_spoof_result, set, "set");
cmdline_parse_token_string_t cmd_vf_vlan_anti_spoof_vf =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_vlan_anti_spoof_result, vf, "vf");
cmdline_parse_token_string_t cmd_vf_vlan_anti_spoof_vlan =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_vlan_anti_spoof_result, vlan,
                             "vlan");
...
cmdline_parse_token_num_t cmd_vf_vlan_anti_spoof_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_vf_vlan_anti_spoof_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_num_t cmd_vf_vlan_anti_spoof_vf_id = TOKEN_NUM_INITIALIZER(
    struct cmd_vf_vlan_anti_spoof_result, vf_id, RTE_UINT32);
cmdline_parse_token_string_t cmd_vf_vlan_anti_spoof_on_off =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_vlan_anti_spoof_result, on_off,
                             "on#off");

static void cmd_set_vf_vlan_anti_spoof_parsed(void *parsed_result,
                                              __rte_unused struct cmdline *cl,
                                              __rte_unused void *data) {
...
#ifdef RTE_NET_I40E
  if (ret == -ENOTSUP)
    ret = rte_pmd_i40e_set_vf_vlan_anti_spoof(res->port_id, res->vf_id, is_on);
#endif
#ifdef RTE_NET_BNXT
  if (ret == -ENOTSUP)
    ret = rte_pmd_bnxt_set_vf_vlan_anti_spoof(res->port_id, res->vf_id, is_on);
#endif
...
cmdline_parse_token_string_t cmd_vf_mac_anti_spoof_set =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_mac_anti_spoof_result, set, "set");
cmdline_parse_token_string_t cmd_vf_mac_anti_spoof_vf =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_mac_anti_spoof_result, vf, "vf");
cmdline_parse_token_string_t cmd_vf_mac_anti_spoof_mac =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_mac_anti_spoof_result, mac, "mac");
cmdline_parse_token_string_t cmd_vf_mac_anti_spoof_antispoof =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_mac_anti_spoof_result, antispoof,
                             "antispoof");
cmdline_parse_token_num_t cmd_vf_mac_anti_spoof_port_id = TOKEN_NUM_INITIALIZER(
    struct cmd_vf_mac_anti_spoof_result, port_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_vf_mac_anti_spoof_vf_id = TOKEN_NUM_INITIALIZER(
    struct cmd_vf_mac_anti_spoof_result, vf_id, RTE_UINT32);
cmdline_parse_token_string_t cmd_vf_mac_anti_spoof_on_off =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_mac_anti_spoof_result, on_off,
                             "on#off");

static void cmd_set_vf_mac_anti_spoof_parsed(void *parsed_result,
                                             __rte_unused struct cmdline *cl,
                                             __rte_unused void *data) {
...
#ifdef RTE_NET_I40E
  if (ret == -ENOTSUP)
    ret = rte_pmd_i40e_set_vf_mac_anti_spoof(res->port_id, res->vf_id, is_on);
#endif
#ifdef RTE_NET_BNXT
  if (ret == -ENOTSUP)
    ret = rte_pmd_bnxt_set_vf_mac_anti_spoof(res->port_id, res->vf_id, is_on);
#endif
...
cmdline_parse_token_string_t cmd_vf_vlan_stripq_set =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_vlan_stripq_result, set, "set");
cmdline_parse_token_string_t cmd_vf_vlan_stripq_vf =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_vlan_stripq_result, vf, "vf");
cmdline_parse_token_string_t cmd_vf_vlan_stripq_vlan =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_vlan_stripq_result, vlan, "vlan");
cmdline_parse_token_string_t cmd_vf_vlan_stripq_stripq =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_vlan_stripq_result, stripq,
                             "stripq");
cmdline_parse_token_num_t cmd_vf_vlan_stripq_port_id = TOKEN_NUM_INITIALIZER(
    struct cmd_vf_vlan_stripq_result, port_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_vf_vlan_stripq_vf_id =
    TOKEN_NUM_INITIALIZER(struct cmd_vf_vlan_stripq_result, vf_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_vf_vlan_stripq_on_off =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_vlan_stripq_result, on_off,
                             "on#off");

static void cmd_set_vf_vlan_stripq_parsed(void *parsed_result,
                                          __rte_unused struct cmdline *cl,
                                          __rte_unused void *data) {
...
#ifdef RTE_NET_I40E
  if (ret == -ENOTSUP)
    ret = rte_pmd_i40e_set_vf_vlan_stripq(res->port_id, res->vf_id, is_on);
#endif
#ifdef RTE_NET_BNXT
  if (ret == -ENOTSUP)
    ret = rte_pmd_bnxt_set_vf_vlan_stripq(res->port_id, res->vf_id, is_on);
#endif
...
cmdline_parse_token_string_t cmd_vf_vlan_insert_set =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_vlan_insert_result, set, "set");
cmdline_parse_token_string_t cmd_vf_vlan_insert_vf =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_vlan_insert_result, vf, "vf");
cmdline_parse_token_string_t cmd_vf_vlan_insert_vlan =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_vlan_insert_result, vlan, "vlan");
cmdline_parse_token_string_t cmd_vf_vlan_insert_insert =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_vlan_insert_result, insert,
                             "insert");
cmdline_parse_token_num_t cmd_vf_vlan_insert_port_id = TOKEN_NUM_INITIALIZER(
    struct cmd_vf_vlan_insert_result, port_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_vf_vlan_insert_vf_id =
    TOKEN_NUM_INITIALIZER(struct cmd_vf_vlan_insert_result, vf_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_vf_vlan_insert_vlan_id = TOKEN_NUM_INITIALIZER(
    struct cmd_vf_vlan_insert_result, vlan_id, RTE_UINT16);

static void cmd_set_vf_vlan_insert_parsed(void *parsed_result,
                                          __rte_unused struct cmdline *cl,
                                          __rte_unused void *data) {
  ...
  if (ret == -ENOTSUP)
    ret =
        rte_pmd_i40e_set_vf_vlan_insert(res->port_id, res->vf_id, res->vlan_id);
#endif
#ifdef RTE_NET_BNXT
  if (ret == -ENOTSUP)
    ret =
        rte_pmd_bnxt_set_vf_vlan_insert(res->port_id, res->vf_id, res->vlan_id);
#endif
...
cmdline_parse_token_string_t cmd_tx_loopback_set =
    TOKEN_STRING_INITIALIZER(struct cmd_tx_loopback_result, set, "set");
cmdline_parse_token_string_t cmd_tx_loopback_tx =
    TOKEN_STRING_INITIALIZER(struct cmd_tx_loopback_result, tx, "tx");
cmdline_parse_token_string_t cmd_tx_loopback_loopback =
    TOKEN_STRING_INITIALIZER(struct cmd_tx_loopback_result, loopback,
                             "loopback");
cmdline_parse_token_num_t cmd_tx_loopback_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_tx_loopback_result, port_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_tx_loopback_on_off =
    TOKEN_STRING_INITIALIZER(struct cmd_tx_loopback_result, on_off, "on#off");

static void cmd_set_tx_loopback_parsed(void *parsed_result,
                                       __rte_unused struct cmdline *cl,
                                       __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_all_queues_drop_en_set =
    TOKEN_STRING_INITIALIZER(struct cmd_all_queues_drop_en_result, set, "set");
cmdline_parse_token_string_t cmd_all_queues_drop_en_all =
    TOKEN_STRING_INITIALIZER(struct cmd_all_queues_drop_en_result, all, "all");
cmdline_parse_token_string_t cmd_all_queues_drop_en_queues =
    TOKEN_STRING_INITIALIZER(struct cmd_all_queues_drop_en_result, queues,
                             "queues");
cmdline_parse_token_string_t cmd_all_queues_drop_en_drop =
    TOKEN_STRING_INITIALIZER(struct cmd_all_queues_drop_en_result, drop,
                             "drop");
cmdline_parse_token_num_t cmd_all_queues_drop_en_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_all_queues_drop_en_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_string_t cmd_all_queues_drop_en_on_off =
    TOKEN_STRING_INITIALIZER(struct cmd_all_queues_drop_en_result, on_off,
                             "on#off");

static void cmd_set_all_queues_drop_en_parsed(void *parsed_result,
                                              __rte_unused struct cmdline *cl,
                                              __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_vf_split_drop_en_set =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_split_drop_en_result, set, "set");
cmdline_parse_token_string_t cmd_vf_split_drop_en_vf =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_split_drop_en_result, vf, "vf");
cmdline_parse_token_string_t cmd_vf_split_drop_en_split =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_split_drop_en_result, split,
                             "split");
cmdline_parse_token_string_t cmd_vf_split_drop_en_drop =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_split_drop_en_result, drop, "drop");
cmdline_parse_token_num_t cmd_vf_split_drop_en_port_id = TOKEN_NUM_INITIALIZER(
    struct cmd_vf_split_drop_en_result, port_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_vf_split_drop_en_vf_id = TOKEN_NUM_INITIALIZER(
    struct cmd_vf_split_drop_en_result, vf_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_vf_split_drop_en_on_off =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_split_drop_en_result, on_off,
                             "on#off");

static void cmd_set_vf_split_drop_en_parsed(void *parsed_result,
                                            __rte_unused struct cmdline *cl,
                                            __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_set_vf_mac_addr_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_mac_addr_result, set, "set");
cmdline_parse_token_string_t cmd_set_vf_mac_addr_vf =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_mac_addr_result, vf, "vf");
cmdline_parse_token_string_t cmd_set_vf_mac_addr_mac =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_mac_addr_result, mac, "mac");
cmdline_parse_token_string_t cmd_set_vf_mac_addr_addr =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_mac_addr_result, addr, "addr");
cmdline_parse_token_num_t cmd_set_vf_mac_addr_port_id = TOKEN_NUM_INITIALIZER(
    struct cmd_set_vf_mac_addr_result, port_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_set_vf_mac_addr_vf_id =
    TOKEN_NUM_INITIALIZER(struct cmd_set_vf_mac_addr_result, vf_id, RTE_UINT16);
cmdline_parse_token_etheraddr_t cmd_set_vf_mac_addr_mac_addr =
    TOKEN_ETHERADDR_INITIALIZER(struct cmd_set_vf_mac_addr_result, mac_addr);

static void cmd_set_vf_mac_addr_parsed(void *parsed_result,
                                       __rte_unused struct cmdline *cl,
                                       __rte_unused void *data) {
  ...
  if (ret == -ENOTSUP)
    ret =
        rte_pmd_ixgbe_set_vf_mac_addr(res->port_id, res->vf_id, &res->mac_addr);
#endif
#ifdef RTE_NET_I40E
  if (ret == -ENOTSUP)
    ret =
        rte_pmd_i40e_set_vf_mac_addr(res->port_id, res->vf_id, &res->mac_addr);
#endif
#ifdef RTE_NET_BNXT
  if (ret == -ENOTSUP)
    ret =
        rte_pmd_bnxt_set_vf_mac_addr(res->port_id, res->vf_id, &res->mac_addr);
#endif
...
cmdline_parse_token_string_t cmd_macsec_offload_on_set =
    TOKEN_STRING_INITIALIZER(struct cmd_macsec_offload_on_result, set, "set");
cmdline_parse_token_string_t cmd_macsec_offload_on_macsec =
    TOKEN_STRING_INITIALIZER(struct cmd_macsec_offload_on_result, macsec,
                             "macsec");
cmdline_parse_token_string_t cmd_macsec_offload_on_offload =
    TOKEN_STRING_INITIALIZER(struct cmd_macsec_offload_on_result, offload,
                             "offload");
cmdline_parse_token_num_t cmd_macsec_offload_on_port_id = TOKEN_NUM_INITIALIZER(
    struct cmd_macsec_offload_on_result, port_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_macsec_offload_on_on =
    TOKEN_STRING_INITIALIZER(struct cmd_macsec_offload_on_result, on, "on");
cmdline_parse_token_string_t cmd_macsec_offload_on_encrypt =
    TOKEN_STRING_INITIALIZER(struct cmd_macsec_offload_on_result, encrypt,
                             "encrypt");
cmdline_parse_token_string_t cmd_macsec_offload_on_en_on_off =
    TOKEN_STRING_INITIALIZER(struct cmd_macsec_offload_on_result, en_on_off,
                             "on#off");
...
cmdline_parse_token_string_t cmd_macsec_offload_on_rp_on_off =
    TOKEN_STRING_INITIALIZER(struct cmd_macsec_offload_on_result, rp_on_off,
                             "on#off");

static void cmd_set_macsec_offload_on_parsed(void *parsed_result,
                                             __rte_unused struct cmdline *cl,
                                             __rte_unused void *data) {
  ...
  switch (ret) {
  case 0:
    ports[port_id].dev_conf.txmode.offloads |= RTE_ETH_TX_OFFLOAD_MACSEC_INSERT;
    cmd_reconfig_device_queue(port_id, 1, 1);
    break;
  case -ENODEV:
    fprintf(stderr, "invalid port_id %d\n", port_id);
...
cmdline_parse_token_string_t cmd_macsec_offload_off_set =
    TOKEN_STRING_INITIALIZER(struct cmd_macsec_offload_off_result, set, "set");
cmdline_parse_token_string_t cmd_macsec_offload_off_macsec =
    TOKEN_STRING_INITIALIZER(struct cmd_macsec_offload_off_result, macsec,
                             "macsec");
cmdline_parse_token_string_t cmd_macsec_offload_off_offload =
    TOKEN_STRING_INITIALIZER(struct cmd_macsec_offload_off_result, offload,
                             "offload");
cmdline_parse_token_num_t cmd_macsec_offload_off_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_macsec_offload_off_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_string_t cmd_macsec_offload_off_off =
    TOKEN_STRING_INITIALIZER(struct cmd_macsec_offload_off_result, off, "off");

static void cmd_set_macsec_offload_off_parsed(void *parsed_result,
                                              __rte_unused struct cmdline *cl,
                                              __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_macsec_sc_set =
    TOKEN_STRING_INITIALIZER(struct cmd_macsec_sc_result, set, "set");
cmdline_parse_token_string_t cmd_macsec_sc_macsec =
    TOKEN_STRING_INITIALIZER(struct cmd_macsec_sc_result, macsec, "macsec");
cmdline_parse_token_string_t cmd_macsec_sc_sc =
    TOKEN_STRING_INITIALIZER(struct cmd_macsec_sc_result, sc, "sc");
cmdline_parse_token_string_t cmd_macsec_sc_tx_rx =
    TOKEN_STRING_INITIALIZER(struct cmd_macsec_sc_result, tx_rx, "tx#rx");
cmdline_parse_token_num_t cmd_macsec_sc_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_macsec_sc_result, port_id, RTE_UINT16);
cmdline_parse_token_etheraddr_t cmd_macsec_sc_mac =
    TOKEN_ETHERADDR_INITIALIZER(struct cmd_macsec_sc_result, mac);
cmdline_parse_token_num_t cmd_macsec_sc_pi =
    TOKEN_NUM_INITIALIZER(struct cmd_macsec_sc_result, pi, RTE_UINT16);

static void cmd_set_macsec_sc_parsed(void *parsed_result,
                                     __rte_unused struct cmdline *cl,
                                     __rte_unused void *data) {
...
#ifdef RTE_NET_IXGBE
  ret = is_tx ? rte_pmd_ixgbe_macsec_config_txsc(res->port_id,
                                                 res->mac.addr_bytes)
...
cmdline_parse_token_string_t cmd_macsec_sa_set =
    TOKEN_STRING_INITIALIZER(struct cmd_macsec_sa_result, set, "set");
cmdline_parse_token_string_t cmd_macsec_sa_macsec =
    TOKEN_STRING_INITIALIZER(struct cmd_macsec_sa_result, macsec, "macsec");
cmdline_parse_token_string_t cmd_macsec_sa_sa =
    TOKEN_STRING_INITIALIZER(struct cmd_macsec_sa_result, sa, "sa");
cmdline_parse_token_string_t cmd_macsec_sa_tx_rx =
    TOKEN_STRING_INITIALIZER(struct cmd_macsec_sa_result, tx_rx, "tx#rx");
cmdline_parse_token_num_t cmd_macsec_sa_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_macsec_sa_result, port_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_macsec_sa_idx =
    TOKEN_NUM_INITIALIZER(struct cmd_macsec_sa_result, idx, RTE_UINT8);
cmdline_parse_token_num_t cmd_macsec_sa_an =
    TOKEN_NUM_INITIALIZER(struct cmd_macsec_sa_result, an, RTE_UINT8);
cmdline_parse_token_num_t cmd_macsec_sa_pn =
    TOKEN_NUM_INITIALIZER(struct cmd_macsec_sa_result, pn, RTE_UINT32);
cmdline_parse_token_string_t cmd_macsec_sa_key =
    TOKEN_STRING_INITIALIZER(struct cmd_macsec_sa_result, key, NULL);

static void cmd_set_macsec_sa_parsed(void *parsed_result,
                                     __rte_unused struct cmdline *cl,
                                     __rte_unused void *data) {
...
#ifdef RTE_NET_IXGBE
  ret = is_tx ? rte_pmd_ixgbe_macsec_select_txsa(res->port_id, res->idx,
                                                 res->an, res->pn, key)
              : rte_pmd_ixgbe_macsec_select_rxsa(res->port_id, res->idx,
                                                 res->an, res->pn, key);
#endif
  RTE_SET_USED(is_tx);
  RTE_SET_USED(key);
...
cmdline_parse_token_string_t cmd_vf_promisc_set =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_promisc_result, set, "set");
cmdline_parse_token_string_t cmd_vf_promisc_vf =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_promisc_result, vf, "vf");
cmdline_parse_token_string_t cmd_vf_promisc_promisc =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_promisc_result, promisc, "promisc");
cmdline_parse_token_num_t cmd_vf_promisc_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_vf_promisc_result, port_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_vf_promisc_vf_id =
    TOKEN_NUM_INITIALIZER(struct cmd_vf_promisc_result, vf_id, RTE_UINT32);
cmdline_parse_token_string_t cmd_vf_promisc_on_off =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_promisc_result, on_off, "on#off");

static void cmd_set_vf_promisc_parsed(void *parsed_result,
                                      __rte_unused struct cmdline *cl,
                                      __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_vf_allmulti_set =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_allmulti_result, set, "set");
cmdline_parse_token_string_t cmd_vf_allmulti_vf =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_allmulti_result, vf, "vf");
cmdline_parse_token_string_t cmd_vf_allmulti_allmulti =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_allmulti_result, allmulti,
                             "allmulti");
cmdline_parse_token_num_t cmd_vf_allmulti_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_vf_allmulti_result, port_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_vf_allmulti_vf_id =
    TOKEN_NUM_INITIALIZER(struct cmd_vf_allmulti_result, vf_id, RTE_UINT32);
cmdline_parse_token_string_t cmd_vf_allmulti_on_off =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_allmulti_result, on_off, "on#off");

static void cmd_set_vf_allmulti_parsed(void *parsed_result,
                                       __rte_unused struct cmdline *cl,
                                       __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_set_vf_broadcast_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_broadcast_result, set, "set");
cmdline_parse_token_string_t cmd_set_vf_broadcast_vf =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_broadcast_result, vf, "vf");
cmdline_parse_token_string_t cmd_set_vf_broadcast_broadcast =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_broadcast_result, broadcast,
                             "broadcast");
cmdline_parse_token_num_t cmd_set_vf_broadcast_port_id = TOKEN_NUM_INITIALIZER(
    struct cmd_set_vf_broadcast_result, port_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_set_vf_broadcast_vf_id = TOKEN_NUM_INITIALIZER(
    struct cmd_set_vf_broadcast_result, vf_id, RTE_UINT16);
...
static void cmd_set_vf_broadcast_parsed(void *parsed_result,
                                        __rte_unused struct cmdline *cl,
                                        __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_set_vf_vlan_tag_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_vlan_tag_result, set, "set");
cmdline_parse_token_string_t cmd_set_vf_vlan_tag_vf =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_vlan_tag_result, vf, "vf");
cmdline_parse_token_string_t cmd_set_vf_vlan_tag_vlan =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_vlan_tag_result, vlan, "vlan");
cmdline_parse_token_string_t cmd_set_vf_vlan_tag_tag =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_vlan_tag_result, tag, "tag");
cmdline_parse_token_num_t cmd_set_vf_vlan_tag_port_id = TOKEN_NUM_INITIALIZER(
    struct cmd_set_vf_vlan_tag_result, port_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_set_vf_vlan_tag_vf_id =
    TOKEN_NUM_INITIALIZER(struct cmd_set_vf_vlan_tag_result, vf_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_set_vf_vlan_tag_on_off =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vf_vlan_tag_result, on_off,
                             "on#off");

static void cmd_set_vf_vlan_tag_parsed(void *parsed_result,
                                       __rte_unused struct cmdline *cl,
                                       __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_vf_tc_bw_set =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_tc_bw_result, set, "set");
cmdline_parse_token_string_t cmd_vf_tc_bw_vf =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_tc_bw_result, vf, "vf");
cmdline_parse_token_string_t cmd_vf_tc_bw_tc =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_tc_bw_result, tc, "tc");
cmdline_parse_token_string_t cmd_vf_tc_bw_tx =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_tc_bw_result, tx, "tx");
cmdline_parse_token_string_t cmd_vf_tc_bw_strict_link_prio =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_tc_bw_result, strict_link_prio,
                             "strict-link-priority");
cmdline_parse_token_string_t cmd_vf_tc_bw_min_bw = TOKEN_STRING_INITIALIZER(
    struct cmd_vf_tc_bw_result, min_bw, "min-bandwidth");
cmdline_parse_token_string_t cmd_vf_tc_bw_max_bw = TOKEN_STRING_INITIALIZER(
    struct cmd_vf_tc_bw_result, max_bw, "max-bandwidth");
cmdline_parse_token_num_t cmd_vf_tc_bw_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_vf_tc_bw_result, port_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_vf_tc_bw_vf_id =
    TOKEN_NUM_INITIALIZER(struct cmd_vf_tc_bw_result, vf_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_vf_tc_bw_tc_no =
    TOKEN_NUM_INITIALIZER(struct cmd_vf_tc_bw_result, tc_no, RTE_UINT8);
cmdline_parse_token_num_t cmd_vf_tc_bw_bw =
    TOKEN_NUM_INITIALIZER(struct cmd_vf_tc_bw_result, bw, RTE_UINT32);
cmdline_parse_token_string_t cmd_vf_tc_bw_bw_list =
    TOKEN_STRING_INITIALIZER(struct cmd_vf_tc_bw_result, bw_list, NULL);
cmdline_parse_token_num_t cmd_vf_tc_bw_tc_map =
    TOKEN_NUM_INITIALIZER(struct cmd_vf_tc_bw_result, tc_map, RTE_UINT8);

/* VF max bandwidth setting */
static void cmd_vf_max_bw_parsed(void *parsed_result,
                                 __rte_unused struct cmdline *cl,
                                 __rte_unused void *data) {
...
#ifdef RTE_NET_I40E
  ret = rte_pmd_i40e_set_vf_max_bw(res->port_id, res->vf_id, res->bw);
#endif
...
static int vf_tc_min_bw_parse_bw_list(uint8_t *bw_list, uint8_t *tc_num,
                                      char *str) {
  uint32_t size;
  const char *p, *p0 = str;
  char s[256];
...
static void cmd_vf_tc_min_bw_parsed(void *parsed_result,
                                    __rte_unused struct cmdline *cl,
                                    __rte_unused void *data) {
  struct cmd_vf_tc_bw_result *res = parsed_result;
  uint8_t tc_num;
...
static void cmd_tc_min_bw_parsed(void *parsed_result,
                                 __rte_unused struct cmdline *cl,
                                 __rte_unused void *data) {
  struct cmd_vf_tc_bw_result *res = parsed_result;
  struct rte_port *port;
...
static void cmd_vf_tc_max_bw_parsed(void *parsed_result,
                                    __rte_unused struct cmdline *cl,
                                    __rte_unused void *data) {
  struct cmd_vf_tc_bw_result *res = parsed_result;
  int ret = -ENOTSUP;
...
#ifdef RTE_NET_I40E
  ret = rte_pmd_i40e_set_vf_tc_max_bw(res->port_id, res->vf_id, res->tc_no,
                                      res->bw);
#endif
  ...
  case 0:
    break;
  case -EINVAL:
    fprintf(stderr, "invalid vf_id %d, tc_no %d or bandwidth %d\n", res->vf_id,
            res->tc_no, res->bw);
    break;
  case -ENODEV:
    fprintf(stderr, "invalid port_id %d\n", res->port_id);
...
cmdline_parse_token_string_t cmd_set_vxlan_vni =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vxlan_result, pos_token, "vni");
...
cmdline_parse_token_string_t cmd_set_vxlan_udp_src =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vxlan_result, pos_token, "udp-src");
...
cmdline_parse_token_string_t cmd_set_vxlan_udp_dst =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vxlan_result, pos_token, "udp-dst");
...
cmdline_parse_token_string_t cmd_set_vxlan_ip_tos =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vxlan_result, pos_token, "ip-tos");
...
cmdline_parse_token_string_t cmd_set_vxlan_ip_ttl =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vxlan_result, pos_token, "ip-ttl");
...
cmdline_parse_token_string_t cmd_set_vxlan_ip_src =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vxlan_result, pos_token, "ip-src");
...
cmdline_parse_token_string_t cmd_set_vxlan_ip_dst =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vxlan_result, pos_token, "ip-dst");
cmdline_parse_token_ipaddr_t cmd_set_vxlan_ip_dst_value =
    TOKEN_IPADDR_INITIALIZER(struct cmd_set_vxlan_result, ip_dst);
cmdline_parse_token_string_t cmd_set_vxlan_vlan = TOKEN_STRING_INITIALIZER(
    struct cmd_set_vxlan_result, pos_token, "vlan-tci");
...
cmdline_parse_token_string_t cmd_set_vxlan_eth_src =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vxlan_result, pos_token, "eth-src");
...
cmdline_parse_token_string_t cmd_set_vxlan_eth_dst =
    TOKEN_STRING_INITIALIZER(struct cmd_set_vxlan_result, pos_token, "eth-dst");
...
cmdline_parse_token_string_t cmd_set_nvgre_tni =
    TOKEN_STRING_INITIALIZER(struct cmd_set_nvgre_result, pos_token, "tni");
...
cmdline_parse_token_string_t cmd_set_nvgre_ip_src =
    TOKEN_STRING_INITIALIZER(struct cmd_set_nvgre_result, pos_token, "ip-src");
...
cmdline_parse_token_string_t cmd_set_nvgre_ip_dst =
    TOKEN_STRING_INITIALIZER(struct cmd_set_nvgre_result, pos_token, "ip-dst");
cmdline_parse_token_ipaddr_t cmd_set_nvgre_ip_dst_value =
    TOKEN_IPADDR_INITIALIZER(struct cmd_set_nvgre_result, ip_dst);
cmdline_parse_token_string_t cmd_set_nvgre_vlan = TOKEN_STRING_INITIALIZER(
    struct cmd_set_nvgre_result, pos_token, "vlan-tci");
...
cmdline_parse_token_string_t cmd_set_nvgre_eth_src =
    TOKEN_STRING_INITIALIZER(struct cmd_set_nvgre_result, pos_token, "eth-src");
...
cmdline_parse_token_string_t cmd_set_nvgre_eth_dst =
    TOKEN_STRING_INITIALIZER(struct cmd_set_nvgre_result, pos_token, "eth-dst");
...
cmdline_parse_token_string_t cmd_set_l2_encap_ip_version_value =
    TOKEN_STRING_INITIALIZER(struct cmd_set_l2_encap_result, ip_version,
                             "ipv4#ipv6");
cmdline_parse_token_string_t cmd_set_l2_encap_vlan = TOKEN_STRING_INITIALIZER(
    struct cmd_set_l2_encap_result, pos_token, "vlan-tci");
...
cmdline_parse_token_string_t cmd_set_mplsogre_encap_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_mplsogre_encap_result, set, "set");
...
cmdline_parse_token_string_t cmd_set_mplsogre_encap_mplsogre_encap_with_vlan =
    TOKEN_STRING_INITIALIZER(struct cmd_set_mplsogre_encap_result, mplsogre,
                             "mplsogre_encap-with-vlan");
cmdline_parse_token_string_t cmd_set_mplsogre_encap_ip_version =
    TOKEN_STRING_INITIALIZER(struct cmd_set_mplsogre_encap_result, pos_token,
                             "ip-version");
cmdline_parse_token_string_t cmd_set_mplsogre_encap_ip_version_value =
    TOKEN_STRING_INITIALIZER(struct cmd_set_mplsogre_encap_result, ip_version,
                             "ipv4#ipv6");
...
cmdline_parse_token_etheraddr_t cmd_set_mplsogre_encap_eth_src_value =
    TOKEN_ETHERADDR_INITIALIZER(struct cmd_set_mplsogre_encap_result, eth_src);
...
cmdline_parse_token_etheraddr_t cmd_set_mplsogre_encap_eth_dst_value =
    TOKEN_ETHERADDR_INITIALIZER(struct cmd_set_mplsogre_encap_result, eth_dst);
...
cmdline_parse_token_string_t cmd_set_mplsogre_decap_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_mplsogre_decap_result, set, "set");
...
cmdline_parse_token_string_t cmd_set_mplsogre_decap_mplsogre_decap_with_vlan =
    TOKEN_STRING_INITIALIZER(struct cmd_set_mplsogre_decap_result, mplsogre,
                             "mplsogre_decap-with-vlan");
cmdline_parse_token_string_t cmd_set_mplsogre_decap_ip_version =
    TOKEN_STRING_INITIALIZER(struct cmd_set_mplsogre_decap_result, pos_token,
                             "ip-version");
cmdline_parse_token_string_t cmd_set_mplsogre_decap_ip_version_value =
    TOKEN_STRING_INITIALIZER(struct cmd_set_mplsogre_decap_result, ip_version,
                             "ipv4#ipv6");
...
cmdline_parse_token_string_t cmd_set_mplsoudp_encap_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_mplsoudp_encap_result, set, "set");
...
cmdline_parse_token_string_t cmd_set_mplsoudp_encap_mplsoudp_encap_with_vlan =
    TOKEN_STRING_INITIALIZER(struct cmd_set_mplsoudp_encap_result, mplsoudp,
                             "mplsoudp_encap-with-vlan");
cmdline_parse_token_string_t cmd_set_mplsoudp_encap_ip_version =
    TOKEN_STRING_INITIALIZER(struct cmd_set_mplsoudp_encap_result, pos_token,
                             "ip-version");
cmdline_parse_token_string_t cmd_set_mplsoudp_encap_ip_version_value =
    TOKEN_STRING_INITIALIZER(struct cmd_set_mplsoudp_encap_result, ip_version,
                             "ipv4#ipv6");
...
cmdline_parse_token_etheraddr_t cmd_set_mplsoudp_encap_eth_src_value =
    TOKEN_ETHERADDR_INITIALIZER(struct cmd_set_mplsoudp_encap_result, eth_src);
...
cmdline_parse_token_etheraddr_t cmd_set_mplsoudp_encap_eth_dst_value =
    TOKEN_ETHERADDR_INITIALIZER(struct cmd_set_mplsoudp_encap_result, eth_dst);
...
cmdline_parse_token_string_t cmd_set_mplsoudp_decap_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_mplsoudp_decap_result, set, "set");
...
cmdline_parse_token_string_t cmd_set_mplsoudp_decap_mplsoudp_decap_with_vlan =
    TOKEN_STRING_INITIALIZER(struct cmd_set_mplsoudp_decap_result, mplsoudp,
                             "mplsoudp_decap-with-vlan");
cmdline_parse_token_string_t cmd_set_mplsoudp_decap_ip_version =
    TOKEN_STRING_INITIALIZER(struct cmd_set_mplsoudp_decap_result, pos_token,
                             "ip-version");
cmdline_parse_token_string_t cmd_set_mplsoudp_decap_ip_version_value =
    TOKEN_STRING_INITIALIZER(struct cmd_set_mplsoudp_decap_result, ip_version,
                             "ipv4#ipv6");
...
cmdline_parse_token_string_t cmd_set_conntrack_set = TOKEN_STRING_INITIALIZER(
    struct cmd_set_conntrack_common_result, set, "set");
cmdline_parse_token_string_t cmd_set_conntrack_conntrack =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_common_result, conntrack,
                             "conntrack");
cmdline_parse_token_string_t cmd_set_conntrack_common_com =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_common_result, common,
                             "com");
cmdline_parse_token_string_t cmd_set_conntrack_common_peer =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_common_result, peer,
                             "peer");
cmdline_parse_token_num_t cmd_set_conntrack_common_peer_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_common_result, peer_port,
                          RTE_UINT16);
cmdline_parse_token_string_t cmd_set_conntrack_common_is_orig =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_common_result, is_orig,
                             "is_orig");
cmdline_parse_token_num_t cmd_set_conntrack_common_is_orig_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_common_result, is_original,
                          RTE_UINT32);
cmdline_parse_token_string_t cmd_set_conntrack_common_enable =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_common_result, enable,
                             "enable");
cmdline_parse_token_num_t cmd_set_conntrack_common_enable_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_common_result, en,
                          RTE_UINT32);
cmdline_parse_token_string_t cmd_set_conntrack_common_live =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_common_result, live,
                             "live");
cmdline_parse_token_num_t cmd_set_conntrack_common_live_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_common_result, is_live,
                          RTE_UINT32);
cmdline_parse_token_string_t cmd_set_conntrack_common_sack =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_common_result, sack,
                             "sack");
cmdline_parse_token_num_t cmd_set_conntrack_common_sack_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_common_result, s_ack,
                          RTE_UINT32);
cmdline_parse_token_string_t cmd_set_conntrack_common_cack =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_common_result, cack,
                             "cack");
cmdline_parse_token_num_t cmd_set_conntrack_common_cack_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_common_result, c_ack,
                          RTE_UINT32);
cmdline_parse_token_string_t cmd_set_conntrack_common_last_dir =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_common_result, last_dir,
                             "last_dir");
cmdline_parse_token_num_t cmd_set_conntrack_common_last_dir_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_common_result, ld,
                          RTE_UINT32);
cmdline_parse_token_string_t cmd_set_conntrack_common_liberal =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_common_result, liberal,
                             "liberal");
cmdline_parse_token_num_t cmd_set_conntrack_common_liberal_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_common_result, lb,
                          RTE_UINT32);
cmdline_parse_token_string_t cmd_set_conntrack_common_state =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_common_result, state,
                             "state");
cmdline_parse_token_num_t cmd_set_conntrack_common_state_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_common_result, stat,
                          RTE_UINT8);
...
cmdline_parse_token_num_t cmd_set_conntrack_common_max_ackwin_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_common_result, factor,
                          RTE_UINT8);
cmdline_parse_token_string_t cmd_set_conntrack_common_retrans =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_common_result, retrans,
                             "r_lim");
cmdline_parse_token_num_t cmd_set_conntrack_common_retrans_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_common_result, re_num,
                          RTE_UINT8);
cmdline_parse_token_string_t cmd_set_conntrack_common_last_win =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_common_result, last_win,
                             "last_win");
cmdline_parse_token_num_t cmd_set_conntrack_common_last_win_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_common_result, lw,
                          RTE_UINT16);
cmdline_parse_token_string_t cmd_set_conntrack_common_last_seq =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_common_result, last_seq,
                             "last_seq");
cmdline_parse_token_num_t cmd_set_conntrack_common_last_seq_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_common_result, ls,
                          RTE_UINT32);
cmdline_parse_token_string_t cmd_set_conntrack_common_last_ack =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_common_result, last_ack,
                             "last_ack");
cmdline_parse_token_num_t cmd_set_conntrack_common_last_ack_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_common_result, la,
                          RTE_UINT32);
cmdline_parse_token_string_t cmd_set_conntrack_common_last_end =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_common_result, last_end,
                             "last_end");
cmdline_parse_token_num_t cmd_set_conntrack_common_last_end_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_common_result, le,
                          RTE_UINT32);
cmdline_parse_token_string_t cmd_set_conntrack_common_last_index =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_common_result, last_index,
                             "last_index");
cmdline_parse_token_num_t cmd_set_conntrack_common_last_index_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_common_result, li,
                          RTE_UINT8);
...
cmdline_parse_token_string_t cmd_set_conntrack_dir_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_dir_result, set, "set");
cmdline_parse_token_string_t cmd_set_conntrack_dir_conntrack =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_dir_result, conntrack,
                             "conntrack");
cmdline_parse_token_string_t cmd_set_conntrack_dir_dir =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_dir_result, dir,
                             "orig#rply");
cmdline_parse_token_string_t cmd_set_conntrack_dir_scale =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_dir_result, scale,
                             "scale");
cmdline_parse_token_num_t cmd_set_conntrack_dir_scale_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_dir_result, factor,
                          RTE_UINT32);
cmdline_parse_token_string_t cmd_set_conntrack_dir_fin =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_dir_result, fin, "fin");
cmdline_parse_token_num_t cmd_set_conntrack_dir_fin_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_dir_result, f, RTE_UINT32);
cmdline_parse_token_string_t cmd_set_conntrack_dir_ack =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_dir_result, ack_seen,
                             "acked");
cmdline_parse_token_num_t cmd_set_conntrack_dir_ack_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_dir_result, as, RTE_UINT32);
cmdline_parse_token_string_t cmd_set_conntrack_dir_unack_data =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_dir_result, unack,
                             "unack_data");
cmdline_parse_token_num_t cmd_set_conntrack_dir_unack_data_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_dir_result, un, RTE_UINT32);
cmdline_parse_token_string_t cmd_set_conntrack_dir_sent_end =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_dir_result, sent_end,
                             "sent_end");
cmdline_parse_token_num_t cmd_set_conntrack_dir_sent_end_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_dir_result, se, RTE_UINT32);
cmdline_parse_token_string_t cmd_set_conntrack_dir_reply_end =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_dir_result, reply_end,
                             "reply_end");
cmdline_parse_token_num_t cmd_set_conntrack_dir_reply_end_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_dir_result, re, RTE_UINT32);
cmdline_parse_token_string_t cmd_set_conntrack_dir_max_win =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_dir_result, max_win,
                             "max_win");
cmdline_parse_token_num_t cmd_set_conntrack_dir_max_win_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_dir_result, mw, RTE_UINT32);
cmdline_parse_token_string_t cmd_set_conntrack_dir_max_ack =
    TOKEN_STRING_INITIALIZER(struct cmd_set_conntrack_dir_result, max_ack,
                             "max_ack");
cmdline_parse_token_num_t cmd_set_conntrack_dir_max_ack_value =
    TOKEN_NUM_INITIALIZER(struct cmd_set_conntrack_dir_result, ma, RTE_UINT32);
...
static void cmd_strict_link_prio_parsed(void *parsed_result,
                                        __rte_unused struct cmdline *cl,
                                        __rte_unused void *data) {
  struct cmd_vf_tc_bw_result *res = parsed_result;
  int ret = -ENOTSUP;
...
static void cmd_ddp_add_parsed(void *parsed_result,
                               __rte_unused struct cmdline *cl,
                               __rte_unused void *data) {
...
static void cmd_ddp_del_parsed(void *parsed_result,
                               __rte_unused struct cmdline *cl,
                               __rte_unused void *data) {
...
static void cmd_ddp_info_parsed(void *parsed_result,
                                __rte_unused struct cmdline *cl,
                                __rte_unused void *data) {
...
#ifdef RTE_NET_I40E
  ret = rte_pmd_i40e_get_ddp_info(pkg, pkg_size, (uint8_t *)&info, sizeof(info),
                                  RTE_PMD_I40E_PKG_INFO_GLOBAL_HEADER);
  if (!ret) {
    printf("Global Track id:       0x%x\n", info.track_id);
    printf("Global Version:        %d.%d.%d.%d\n", info.version.major,
           info.version.minor, info.version.update, info.version.draft);
  ...
  ret = rte_pmd_i40e_get_ddp_info(pkg, pkg_size, (uint8_t *)&buff_size,
                                  sizeof(buff_size),
                                  RTE_PMD_I40E_PKG_INFO_GLOBAL_NOTES_SIZE);
  if (!ret && buff_size) {
    buff = (uint8_t *)malloc(buff_size);
    if (buff) {
      ret = rte_pmd_i40e_get_ddp_info(pkg, pkg_size, buff, buff_size,
  ...
  ret = rte_pmd_i40e_get_ddp_info(pkg, pkg_size, (uint8_t *)&dev_num,
                                  sizeof(dev_num),
  ...
  if (!ret && dev_num) {
    ...
    if (devs) {
      ret = rte_pmd_i40e_get_ddp_info(pkg, pkg_size, (uint8_t *)devs, buff_size,
  ...
  ret = rte_pmd_i40e_get_ddp_info(pkg, pkg_size, (uint8_t *)&proto_num,
                                  sizeof(proto_num),
  ...
  ret = rte_pmd_i40e_get_ddp_info(pkg, pkg_size, (uint8_t *)&pctype_num,
                                  sizeof(pctype_num),
...
static void cmd_ddp_get_list_parsed(__rte_unused void *parsed_result,
                                    __rte_unused struct cmdline *cl,
                                    __rte_unused void *data) {
#ifdef RTE_NET_I40E
  ...
  if (ret == -ENOTSUP)
    ret = rte_pmd_i40e_get_ddp_list(res->port_id, (uint8_t *)p_list, size);
  ...
  if (!ret) {
    ...
    for (i = 0; i < p_num; i++) {
      ...
      printf("Version:      %d.%d.%d.%d\n", p_info->version.major,
             p_info->version.minor, p_info->version.update,
...
static void cmd_cfg_input_set_parsed(__rte_unused void *parsed_result,
                                     __rte_unused struct cmdline *cl,
                                     __rte_unused void *data) {
#ifdef RTE_NET_I40E
  ...
  ret =
      rte_pmd_i40e_inset_get(res->port_id, res->pctype_id, &inset, inset_type);
  if (ret) {
  ...
  ret =
      rte_pmd_i40e_inset_set(res->port_id, res->pctype_id, &inset, inset_type);
  if (ret) {
...
cmdline_parse_token_string_t cmd_cfg_input_set_port =
    TOKEN_STRING_INITIALIZER(struct cmd_cfg_input_set_result, port, "port");
cmdline_parse_token_string_t cmd_cfg_input_set_cfg =
    TOKEN_STRING_INITIALIZER(struct cmd_cfg_input_set_result, cfg, "config");
cmdline_parse_token_num_t cmd_cfg_input_set_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_cfg_input_set_result, port_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_cfg_input_set_pctype =
    TOKEN_STRING_INITIALIZER(struct cmd_cfg_input_set_result, pctype, "pctype");
cmdline_parse_token_num_t cmd_cfg_input_set_pctype_id = TOKEN_NUM_INITIALIZER(
    struct cmd_cfg_input_set_result, pctype_id, RTE_UINT8);
cmdline_parse_token_string_t cmd_cfg_input_set_inset_type =
    TOKEN_STRING_INITIALIZER(struct cmd_cfg_input_set_result, inset_type,
                             "hash_inset#fdir_inset#fdir_flx_inset");
cmdline_parse_token_string_t cmd_cfg_input_set_opt = TOKEN_STRING_INITIALIZER(
    struct cmd_cfg_input_set_result, opt, "get#set#clear");
cmdline_parse_token_string_t cmd_cfg_input_set_field =
    TOKEN_STRING_INITIALIZER(struct cmd_cfg_input_set_result, field, "field");
cmdline_parse_token_num_t cmd_cfg_input_set_field_idx = TOKEN_NUM_INITIALIZER(
    struct cmd_cfg_input_set_result, field_idx, RTE_UINT8);
...
static void cmd_clear_input_set_parsed(__rte_unused void *parsed_result,
                                       __rte_unused struct cmdline *cl,
                                       __rte_unused void *data) {
#ifdef RTE_NET_I40E
...
cmdline_parse_token_string_t cmd_clear_input_set_port =
    TOKEN_STRING_INITIALIZER(struct cmd_clear_input_set_result, port, "port");
cmdline_parse_token_string_t cmd_clear_input_set_cfg =
    TOKEN_STRING_INITIALIZER(struct cmd_clear_input_set_result, cfg, "config");
cmdline_parse_token_num_t cmd_clear_input_set_port_id = TOKEN_NUM_INITIALIZER(
    struct cmd_clear_input_set_result, port_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_clear_input_set_pctype =
    TOKEN_STRING_INITIALIZER(struct cmd_clear_input_set_result, pctype,
                             "pctype");
cmdline_parse_token_num_t cmd_clear_input_set_pctype_id = TOKEN_NUM_INITIALIZER(
    struct cmd_clear_input_set_result, pctype_id, RTE_UINT8);
cmdline_parse_token_string_t cmd_clear_input_set_inset_type =
    TOKEN_STRING_INITIALIZER(struct cmd_clear_input_set_result, inset_type,
                             "hash_inset#fdir_inset#fdir_flx_inset");
cmdline_parse_token_string_t cmd_clear_input_set_clear =
    TOKEN_STRING_INITIALIZER(struct cmd_clear_input_set_result, clear, "clear");
cmdline_parse_token_string_t cmd_clear_input_set_all =
    TOKEN_STRING_INITIALIZER(struct cmd_clear_input_set_result, all, "all");
...
cmdline_parse_token_string_t cmd_show_vf_stats_show =
    TOKEN_STRING_INITIALIZER(struct cmd_show_vf_stats_result, show, "show");
cmdline_parse_token_string_t cmd_show_vf_stats_vf =
    TOKEN_STRING_INITIALIZER(struct cmd_show_vf_stats_result, vf, "vf");
cmdline_parse_token_string_t cmd_show_vf_stats_stats =
    TOKEN_STRING_INITIALIZER(struct cmd_show_vf_stats_result, stats, "stats");
cmdline_parse_token_num_t cmd_show_vf_stats_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_show_vf_stats_result, port_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_show_vf_stats_vf_id =
    TOKEN_NUM_INITIALIZER(struct cmd_show_vf_stats_result, vf_id, RTE_UINT16);

static void cmd_show_vf_stats_parsed(void *parsed_result,
                                     __rte_unused struct cmdline *cl,
                                     __rte_unused void *data) {
...
#ifdef RTE_NET_I40E
  if (ret == -ENOTSUP)
    ret = rte_pmd_i40e_get_vf_stats(res->port_id, res->vf_id, &stats);
#endif
#ifdef RTE_NET_BNXT
  if (ret == -ENOTSUP)
    ret = rte_pmd_bnxt_get_vf_stats(res->port_id, res->vf_id, &stats);
#endif
  ...
  printf("\n  %s NIC statistics for port %-2d vf %-2d %s\n", nic_stats_border,
         res->port_id, res->vf_id, nic_stats_border);
...
cmdline_parse_token_string_t cmd_clear_vf_stats_clear =
    TOKEN_STRING_INITIALIZER(struct cmd_clear_vf_stats_result, clear, "clear");
cmdline_parse_token_string_t cmd_clear_vf_stats_vf =
    TOKEN_STRING_INITIALIZER(struct cmd_clear_vf_stats_result, vf, "vf");
cmdline_parse_token_string_t cmd_clear_vf_stats_stats =
    TOKEN_STRING_INITIALIZER(struct cmd_clear_vf_stats_result, stats, "stats");
cmdline_parse_token_num_t cmd_clear_vf_stats_port_id = TOKEN_NUM_INITIALIZER(
    struct cmd_clear_vf_stats_result, port_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_clear_vf_stats_vf_id =
    TOKEN_NUM_INITIALIZER(struct cmd_clear_vf_stats_result, vf_id, RTE_UINT16);

static void cmd_clear_vf_stats_parsed(void *parsed_result,
                                      __rte_unused struct cmdline *cl,
                                      __rte_unused void *data) {
...
#ifdef RTE_NET_I40E
  if (ret == -ENOTSUP)
    ret = rte_pmd_i40e_reset_vf_stats(res->port_id, res->vf_id);
#endif
#ifdef RTE_NET_BNXT
  if (ret == -ENOTSUP)
    ret = rte_pmd_bnxt_reset_vf_stats(res->port_id, res->vf_id);
#endif
...
cmdline_parse_token_string_t cmd_pctype_mapping_reset_port =
    TOKEN_STRING_INITIALIZER(struct cmd_pctype_mapping_reset_result, port,
                             "port");
cmdline_parse_token_string_t cmd_pctype_mapping_reset_config =
    TOKEN_STRING_INITIALIZER(struct cmd_pctype_mapping_reset_result, config,
                             "config");
cmdline_parse_token_num_t cmd_pctype_mapping_reset_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_pctype_mapping_reset_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_string_t cmd_pctype_mapping_reset_pctype =
    TOKEN_STRING_INITIALIZER(struct cmd_pctype_mapping_reset_result, pctype,
                             "pctype");
cmdline_parse_token_string_t cmd_pctype_mapping_reset_mapping =
    TOKEN_STRING_INITIALIZER(struct cmd_pctype_mapping_reset_result, mapping,
                             "mapping");
cmdline_parse_token_string_t cmd_pctype_mapping_reset_reset =
    TOKEN_STRING_INITIALIZER(struct cmd_pctype_mapping_reset_result, reset,
                             "reset");

static void cmd_pctype_mapping_reset_parsed(void *parsed_result,
                                            __rte_unused struct cmdline *cl,
                                            __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_pctype_mapping_get_show =
    TOKEN_STRING_INITIALIZER(struct cmd_pctype_mapping_get_result, show,
                             "show");
cmdline_parse_token_string_t cmd_pctype_mapping_get_port =
    TOKEN_STRING_INITIALIZER(struct cmd_pctype_mapping_get_result, port,
                             "port");
cmdline_parse_token_num_t cmd_pctype_mapping_get_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_pctype_mapping_get_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_string_t cmd_pctype_mapping_get_pctype =
    TOKEN_STRING_INITIALIZER(struct cmd_pctype_mapping_get_result, pctype,
                             "pctype");
cmdline_parse_token_string_t cmd_pctype_mapping_get_mapping =
    TOKEN_STRING_INITIALIZER(struct cmd_pctype_mapping_get_result, mapping,
                             "mapping");

static void cmd_pctype_mapping_get_parsed(void *parsed_result,
                                          __rte_unused struct cmdline *cl,
                                          __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_pctype_mapping_update_port =
    TOKEN_STRING_INITIALIZER(struct cmd_pctype_mapping_update_result, port,
                             "port");
cmdline_parse_token_string_t cmd_pctype_mapping_update_config =
    TOKEN_STRING_INITIALIZER(struct cmd_pctype_mapping_update_result, config,
                             "config");
cmdline_parse_token_num_t cmd_pctype_mapping_update_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_pctype_mapping_update_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_string_t cmd_pctype_mapping_update_pctype =
    TOKEN_STRING_INITIALIZER(struct cmd_pctype_mapping_update_result, pctype,
                             "pctype");
cmdline_parse_token_string_t cmd_pctype_mapping_update_mapping =
    TOKEN_STRING_INITIALIZER(struct cmd_pctype_mapping_update_result, mapping,
                             "mapping");
cmdline_parse_token_string_t cmd_pctype_mapping_update_update =
    TOKEN_STRING_INITIALIZER(struct cmd_pctype_mapping_update_result, update,
                             "update");
...
cmdline_parse_token_num_t cmd_pctype_mapping_update_flow_type =
    TOKEN_NUM_INITIALIZER(struct cmd_pctype_mapping_update_result, flow_type,
                          RTE_UINT16);

static void cmd_pctype_mapping_update_parsed(void *parsed_result,
                                             __rte_unused struct cmdline *cl,
                                             __rte_unused void *data) {
  ...
  ret = rte_pmd_i40e_flow_type_mapping_update(res->port_id, &mapping, 1, 0);
#endif
...
cmdline_parse_token_string_t cmd_ptype_mapping_get_ptype =
    TOKEN_STRING_INITIALIZER(struct cmd_ptype_mapping_get_result, ptype,
                             "ptype");
cmdline_parse_token_string_t cmd_ptype_mapping_get_mapping =
    TOKEN_STRING_INITIALIZER(struct cmd_ptype_mapping_get_result, mapping,
                             "mapping");
cmdline_parse_token_string_t cmd_ptype_mapping_get_get =
    TOKEN_STRING_INITIALIZER(struct cmd_ptype_mapping_get_result, get, "get");
cmdline_parse_token_num_t cmd_ptype_mapping_get_port_id = TOKEN_NUM_INITIALIZER(
    struct cmd_ptype_mapping_get_result, port_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_ptype_mapping_get_valid_only =
    TOKEN_NUM_INITIALIZER(struct cmd_ptype_mapping_get_result, valid_only,
                          RTE_UINT8);

static void cmd_ptype_mapping_get_parsed(void *parsed_result,
                                         __rte_unused struct cmdline *cl,
                                         __rte_unused void *data) {
...
#ifdef RTE_NET_I40E
  ret = rte_pmd_i40e_ptype_mapping_get(res->port_id, mapping, max_ptype_num,
                                       &count, res->valid_only);
#endif
...
cmdline_parse_token_string_t cmd_ptype_mapping_replace_ptype =
    TOKEN_STRING_INITIALIZER(struct cmd_ptype_mapping_replace_result, ptype,
                             "ptype");
cmdline_parse_token_string_t cmd_ptype_mapping_replace_mapping =
    TOKEN_STRING_INITIALIZER(struct cmd_ptype_mapping_replace_result, mapping,
                             "mapping");
cmdline_parse_token_string_t cmd_ptype_mapping_replace_replace =
    TOKEN_STRING_INITIALIZER(struct cmd_ptype_mapping_replace_result, replace,
                             "replace");
cmdline_parse_token_num_t cmd_ptype_mapping_replace_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_ptype_mapping_replace_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_num_t cmd_ptype_mapping_replace_target =
    TOKEN_NUM_INITIALIZER(struct cmd_ptype_mapping_replace_result, target,
                          RTE_UINT32);
cmdline_parse_token_num_t cmd_ptype_mapping_replace_mask =
    TOKEN_NUM_INITIALIZER(struct cmd_ptype_mapping_replace_result, mask,
                          RTE_UINT8);
cmdline_parse_token_num_t cmd_ptype_mapping_replace_pkt_type =
    TOKEN_NUM_INITIALIZER(struct cmd_ptype_mapping_replace_result, pkt_type,
                          RTE_UINT32);

static void cmd_ptype_mapping_replace_parsed(void *parsed_result,
                                             __rte_unused struct cmdline *cl,
                                             __rte_unused void *data) {
...
#ifdef RTE_NET_I40E
  ret = rte_pmd_i40e_ptype_mapping_replace(res->port_id, res->target, res->mask,
                                           res->pkt_type);
#endif
...
cmdline_parse_inst_t cmd_ptype_mapping_replace = {
    ...
    .data = NULL,
    .help_str = "ptype mapping replace <port_id> <target> <mask> <pkt_type>",
    .tokens =
        {
...
cmdline_parse_token_string_t cmd_ptype_mapping_reset_ptype =
    TOKEN_STRING_INITIALIZER(struct cmd_ptype_mapping_reset_result, ptype,
                             "ptype");
cmdline_parse_token_string_t cmd_ptype_mapping_reset_mapping =
    TOKEN_STRING_INITIALIZER(struct cmd_ptype_mapping_reset_result, mapping,
                             "mapping");
cmdline_parse_token_string_t cmd_ptype_mapping_reset_reset =
    TOKEN_STRING_INITIALIZER(struct cmd_ptype_mapping_reset_result, reset,
                             "reset");
cmdline_parse_token_num_t cmd_ptype_mapping_reset_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_ptype_mapping_reset_result, port_id,
                          RTE_UINT16);

static void cmd_ptype_mapping_reset_parsed(void *parsed_result,
                                           __rte_unused struct cmdline *cl,
                                           __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_ptype_mapping_update_ptype =
    TOKEN_STRING_INITIALIZER(struct cmd_ptype_mapping_update_result, ptype,
                             "ptype");
cmdline_parse_token_string_t cmd_ptype_mapping_update_mapping =
    TOKEN_STRING_INITIALIZER(struct cmd_ptype_mapping_update_result, mapping,
                             "mapping");
cmdline_parse_token_string_t cmd_ptype_mapping_update_update =
    TOKEN_STRING_INITIALIZER(struct cmd_ptype_mapping_update_result, reset,
                             "update");
cmdline_parse_token_num_t cmd_ptype_mapping_update_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_ptype_mapping_update_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_num_t cmd_ptype_mapping_update_hw_ptype =
    TOKEN_NUM_INITIALIZER(struct cmd_ptype_mapping_update_result, hw_ptype,
                          RTE_UINT8);
cmdline_parse_token_num_t cmd_ptype_mapping_update_sw_ptype =
    TOKEN_NUM_INITIALIZER(struct cmd_ptype_mapping_update_result, sw_ptype,
                          RTE_UINT32);

static void cmd_ptype_mapping_update_parsed(void *parsed_result,
                                            __rte_unused struct cmdline *cl,
                                            __rte_unused void *data) {
  ...
  ret = rte_pmd_i40e_ptype_mapping_update(res->port_id, &mapping, 1, 0);
#endif
...
static void cmd_load_from_file_parsed(void *parsed_result,
                                      __rte_unused struct cmdline *cl,
                                      __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_rx_offload_get_capa_show =
    TOKEN_STRING_INITIALIZER(struct cmd_rx_offload_get_capa_result, show,
                             "show");
cmdline_parse_token_string_t cmd_rx_offload_get_capa_port =
    TOKEN_STRING_INITIALIZER(struct cmd_rx_offload_get_capa_result, port,
                             "port");
cmdline_parse_token_num_t cmd_rx_offload_get_capa_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_rx_offload_get_capa_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_string_t cmd_rx_offload_get_capa_rx_offload =
    TOKEN_STRING_INITIALIZER(struct cmd_rx_offload_get_capa_result, rx_offload,
                             "rx_offload");
cmdline_parse_token_string_t cmd_rx_offload_get_capa_capabilities =
    TOKEN_STRING_INITIALIZER(struct cmd_rx_offload_get_capa_result,
...
static void cmd_rx_offload_get_capa_parsed(void *parsed_result,
                                           __rte_unused struct cmdline *cl,
                                           __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_rx_offload_get_configuration_show =
    TOKEN_STRING_INITIALIZER(struct cmd_rx_offload_get_configuration_result,
                             show, "show");
...
cmdline_parse_token_num_t cmd_rx_offload_get_configuration_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_rx_offload_get_configuration_result,
                          port_id, RTE_UINT16);
...
static void
cmd_rx_offload_get_configuration_parsed(void *parsed_result,
                                        __rte_unused struct cmdline *cl,
                                        __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_config_per_port_rx_offload_result_port =
    TOKEN_STRING_INITIALIZER(struct cmd_config_per_port_rx_offload_result, port,
                             "port");
cmdline_parse_token_string_t cmd_config_per_port_rx_offload_result_config =
    TOKEN_STRING_INITIALIZER(struct cmd_config_per_port_rx_offload_result,
                             config, "config");
cmdline_parse_token_num_t cmd_config_per_port_rx_offload_result_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_config_per_port_rx_offload_result, port_id,
                          RTE_UINT16);
...
cmdline_parse_token_string_t cmd_config_per_port_rx_offload_result_offload =
    TOKEN_STRING_INITIALIZER(
        struct cmd_config_per_port_rx_offload_result, offload,
...
static uint64_t search_rx_offload(const char *name) {
  uint64_t single_offload;
...
cmd_config_per_port_rx_offload_parsed(void *parsed_result,
  ...
  if (port->port_status != RTE_PORT_STOPPED) {
    fprintf(stderr, "Error: Can't config offload when Port %d is not stopped\n",
            port_id);
    return;
  }
...
cmdline_parse_token_string_t cmd_config_per_queue_rx_offload_result_port =
    TOKEN_STRING_INITIALIZER(struct cmd_config_per_queue_rx_offload_result,
                             port, "port");
cmdline_parse_token_num_t cmd_config_per_queue_rx_offload_result_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_config_per_queue_rx_offload_result,
                          port_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_config_per_queue_rx_offload_result_rxq =
    TOKEN_STRING_INITIALIZER(struct cmd_config_per_queue_rx_offload_result, rxq,
                             "rxq");
...
cmdline_parse_token_string_t cmd_config_per_queue_rx_offload_result_offload =
    TOKEN_STRING_INITIALIZER(
        struct cmd_config_per_queue_rx_offload_result, offload,
        "vlan_strip#ipv4_cksum#udp_cksum#tcp_cksum#tcp_lro#"
        "qinq_strip#outer_ipv4_cksum#macsec_strip#"
        "header_split#vlan_filter#vlan_extend#jumbo_frame#"
...
cmd_config_per_queue_rx_offload_parsed(void *parsed_result,
  ...
  if (queue_id >= dev_info.nb_rx_queues) {
    fprintf(stderr, "Error: input queue_id should be 0 ... %d\n",
...
cmdline_parse_token_string_t cmd_tx_offload_get_capa_show =
    TOKEN_STRING_INITIALIZER(struct cmd_tx_offload_get_capa_result, show,
                             "show");
cmdline_parse_token_string_t cmd_tx_offload_get_capa_port =
    TOKEN_STRING_INITIALIZER(struct cmd_tx_offload_get_capa_result, port,
                             "port");
cmdline_parse_token_num_t cmd_tx_offload_get_capa_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_tx_offload_get_capa_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_string_t cmd_tx_offload_get_capa_tx_offload =
    TOKEN_STRING_INITIALIZER(struct cmd_tx_offload_get_capa_result, tx_offload,
                             "tx_offload");
cmdline_parse_token_string_t cmd_tx_offload_get_capa_capabilities =
    TOKEN_STRING_INITIALIZER(struct cmd_tx_offload_get_capa_result,
                             capabilities, "capabilities");

static void print_tx_offloads(uint64_t offloads) {
  uint64_t single_offload;
  int begin;
  int end;
  int bit;
...
static void cmd_tx_offload_get_capa_parsed(void *parsed_result,
                                           __rte_unused struct cmdline *cl,
                                           __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_tx_offload_get_configuration_show =
    TOKEN_STRING_INITIALIZER(struct cmd_tx_offload_get_configuration_result,
                             show, "show");
...
cmdline_parse_token_num_t cmd_tx_offload_get_configuration_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_tx_offload_get_configuration_result,
                          port_id, RTE_UINT16);
...
static void
cmd_tx_offload_get_configuration_parsed(void *parsed_result,
                                        __rte_unused struct cmdline *cl,
                                        __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_config_per_port_tx_offload_result_port =
    TOKEN_STRING_INITIALIZER(struct cmd_config_per_port_tx_offload_result, port,
                             "port");
cmdline_parse_token_string_t cmd_config_per_port_tx_offload_result_config =
    TOKEN_STRING_INITIALIZER(struct cmd_config_per_port_tx_offload_result,
                             config, "config");
cmdline_parse_token_num_t cmd_config_per_port_tx_offload_result_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_config_per_port_tx_offload_result, port_id,
                          RTE_UINT16);
...
static uint64_t search_tx_offload(const char *name) {
  uint64_t single_offload;
  const char *single_name;
  int found = 0;
  unsigned int bit;
...
cmdline_parse_token_string_t cmd_config_per_queue_tx_offload_result_port =
    TOKEN_STRING_INITIALIZER(struct cmd_config_per_queue_tx_offload_result,
                             port, "port");
cmdline_parse_token_num_t cmd_config_per_queue_tx_offload_result_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_config_per_queue_tx_offload_result,
                          port_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_config_per_queue_tx_offload_result_txq =
    TOKEN_STRING_INITIALIZER(struct cmd_config_per_queue_tx_offload_result, txq,
                             "txq");
...
cmdline_parse_token_num_t cmd_config_tx_metadata_specific_value =
    TOKEN_NUM_INITIALIZER(struct cmd_config_tx_metadata_specific_result, value,
                          RTE_UINT32);
...
static void cmd_config_dynf_specific_parsed(void *parsed_result,
                                            __rte_unused struct cmdline *cl,
                                            __rte_unused void *data) {
  ...
  if (flag <= 0) {
    if (strlcpy(desc_flag.name, res->name, RTE_MBUF_DYN_NAMESIZE) >=
...
cmdline_parse_token_string_t cmd_config_tx_dynf_specific_port =
    TOKEN_STRING_INITIALIZER(struct cmd_config_tx_dynf_specific_result, keyword,
                             "port");
...
cmdline_parse_token_num_t cmd_config_tx_dynf_specific_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_config_tx_dynf_specific_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_string_t cmd_config_tx_dynf_specific_item =
    TOKEN_STRING_INITIALIZER(struct cmd_config_tx_dynf_specific_result, item,
                             "dynf");
cmdline_parse_token_string_t cmd_config_tx_dynf_specific_name =
    TOKEN_STRING_INITIALIZER(struct cmd_config_tx_dynf_specific_result, name,
                             NULL);
cmdline_parse_token_string_t cmd_config_tx_dynf_specific_value =
    TOKEN_STRING_INITIALIZER(struct cmd_config_tx_dynf_specific_result, value,
                             "set#clear");
...
static void cmd_show_tx_metadata_parsed(void *parsed_result,
                                        __rte_unused struct cmdline *cl,
                                        __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_show_tx_metadata_show =
    TOKEN_STRING_INITIALIZER(struct cmd_show_tx_metadata_result, cmd_show,
                             "show");
cmdline_parse_token_string_t cmd_show_tx_metadata_port =
    TOKEN_STRING_INITIALIZER(struct cmd_show_tx_metadata_result, cmd_port,
                             "port");
cmdline_parse_token_num_t cmd_show_tx_metadata_pid = TOKEN_NUM_INITIALIZER(
    struct cmd_show_tx_metadata_result, cmd_pid, RTE_UINT16);
cmdline_parse_token_string_t cmd_show_tx_metadata_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_show_tx_metadata_result, cmd_keyword,
                             "tx_metadata");
...
static void cmd_show_fec_capability_parsed(void *parsed_result,
                                           __rte_unused struct cmdline *cl,
                                           __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_show_fec_capability_show =
    TOKEN_STRING_INITIALIZER(struct cmd_show_fec_capability_result, cmd_show,
                             "show");
cmdline_parse_token_string_t cmd_show_fec_capability_port =
    TOKEN_STRING_INITIALIZER(struct cmd_show_fec_capability_result, cmd_port,
                             "port");
cmdline_parse_token_num_t cmd_show_fec_capability_pid = TOKEN_NUM_INITIALIZER(
    struct cmd_show_fec_capability_result, cmd_pid, RTE_UINT16);
cmdline_parse_token_string_t cmd_show_fec_capability_fec =
    TOKEN_STRING_INITIALIZER(struct cmd_show_fec_capability_result, cmd_fec,
                             "fec");
cmdline_parse_token_string_t cmd_show_fec_capability_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_show_fec_capability_result, cmd_keyword,
                             "capabilities");
...
static void cmd_show_fec_mode_parsed(void *parsed_result,
                                     __rte_unused struct cmdline *cl,
                                     __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_show_fec_mode_show = TOKEN_STRING_INITIALIZER(
    struct cmd_show_fec_metadata_result, cmd_show, "show");
cmdline_parse_token_string_t cmd_show_fec_mode_port = TOKEN_STRING_INITIALIZER(
    struct cmd_show_fec_metadata_result, cmd_port, "port");
cmdline_parse_token_num_t cmd_show_fec_mode_pid = TOKEN_NUM_INITIALIZER(
    struct cmd_show_fec_metadata_result, cmd_pid, RTE_UINT16);
cmdline_parse_token_string_t cmd_show_fec_mode_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_show_fec_metadata_result, cmd_keyword,
                             "fec_mode");
...
cmdline_parse_token_string_t cmd_set_port_fec_mode_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_port_fec_mode, set, "set");
cmdline_parse_token_string_t cmd_set_port_fec_mode_port =
    TOKEN_STRING_INITIALIZER(struct cmd_set_port_fec_mode, port, "port");
cmdline_parse_token_num_t cmd_set_port_fec_mode_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_set_port_fec_mode, port_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_set_port_fec_mode_str =
    TOKEN_STRING_INITIALIZER(struct cmd_set_port_fec_mode, fec_mode,
                             "fec_mode");
cmdline_parse_token_string_t cmd_set_port_fec_mode_value =
    TOKEN_STRING_INITIALIZER(struct cmd_set_port_fec_mode, fec_value, NULL);

static void cmd_set_port_fec_mode_parsed(void *parsed_result,
                                         __rte_unused struct cmdline *cl,
                                         __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_show_port_supported_ptypes_show =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_supported_ptypes_result, show,
                             "show");
cmdline_parse_token_string_t cmd_show_port_supported_ptypes_port =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_supported_ptypes_result, port,
                             "port");
cmdline_parse_token_num_t cmd_show_port_supported_ptypes_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_show_port_supported_ptypes_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_string_t cmd_show_port_supported_ptypes_ptypes =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_supported_ptypes_result,
                             ptypes, "ptypes");

static void
cmd_show_port_supported_ptypes_parsed(void *parsed_result,
                                      __rte_unused struct cmdline *cl,
                                      __rte_unused void *data) {
...
#define PTYPE_NAMESIZE 256
  ...
  while (ptype_mask != RSVD_PTYPE_MASK) {
    ...
    ret = rte_eth_dev_get_supported_ptypes(res->port_id, ptype_mask, ptypes,
...
static void cmd_show_rx_tx_desc_status_parsed(void *parsed_result,
                                              __rte_unused struct cmdline *cl,
                                              __rte_unused void *data) {
  ...
  if (!strcmp(res->cmd_keyword, "rxq")) {
    rc = rte_eth_rx_descriptor_status(res->cmd_pid, res->cmd_qid, res->cmd_did);
    if (rc < 0) {
      fprintf(stderr, "Invalid input: queue id = %d, desc id = %d\n",
    ...
    rc = rte_eth_tx_descriptor_status(res->cmd_pid, res->cmd_qid, res->cmd_did);
    if (rc < 0) {
      fprintf(stderr, "Invalid input: queue id = %d, desc id = %d\n",
              res->cmd_qid, res->cmd_did);
      return;
...
cmdline_parse_token_string_t cmd_show_rx_tx_desc_status_show =
    TOKEN_STRING_INITIALIZER(struct cmd_show_rx_tx_desc_status_result, cmd_show,
                             "show");
cmdline_parse_token_string_t cmd_show_rx_tx_desc_status_port =
    TOKEN_STRING_INITIALIZER(struct cmd_show_rx_tx_desc_status_result, cmd_port,
                             "port");
cmdline_parse_token_num_t cmd_show_rx_tx_desc_status_pid =
    TOKEN_NUM_INITIALIZER(struct cmd_show_rx_tx_desc_status_result, cmd_pid,
                          RTE_UINT16);
...
cmdline_parse_token_num_t cmd_show_rx_tx_desc_status_qid =
    TOKEN_NUM_INITIALIZER(struct cmd_show_rx_tx_desc_status_result, cmd_qid,
                          RTE_UINT16);
cmdline_parse_token_string_t cmd_show_rx_tx_desc_status_desc =
    TOKEN_STRING_INITIALIZER(struct cmd_show_rx_tx_desc_status_result, cmd_desc,
                             "desc");
cmdline_parse_token_num_t cmd_show_rx_tx_desc_status_did =
    TOKEN_NUM_INITIALIZER(struct cmd_show_rx_tx_desc_status_result, cmd_did,
                          RTE_UINT16);
...
cmdline_parse_token_string_t cmd_show_rx_queue_desc_used_count_show =
    TOKEN_STRING_INITIALIZER(struct cmd_show_rx_queue_desc_used_count_result,
                             cmd_show, "show");
...
cmdline_parse_token_num_t cmd_show_rx_queue_desc_used_count_pid =
    TOKEN_NUM_INITIALIZER(struct cmd_show_rx_queue_desc_used_count_result,
                          cmd_pid, RTE_UINT16);
...
cmdline_parse_token_string_t cmd_set_port_ptypes_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_port_ptypes_result, set, "set");
cmdline_parse_token_string_t cmd_set_port_ptypes_port =
    TOKEN_STRING_INITIALIZER(struct cmd_set_port_ptypes_result, port, "port");
cmdline_parse_token_num_t cmd_set_port_ptypes_port_id = TOKEN_NUM_INITIALIZER(
    struct cmd_set_port_ptypes_result, port_id, RTE_UINT16);
cmdline_parse_token_string_t cmd_set_port_ptypes_mask_str =
    TOKEN_STRING_INITIALIZER(struct cmd_set_port_ptypes_result, ptype_mask,
                             "ptype_mask");
cmdline_parse_token_num_t cmd_set_port_ptypes_mask_u32 =
    TOKEN_NUM_INITIALIZER(struct cmd_set_port_ptypes_result, mask, RTE_UINT32);

static void cmd_set_port_ptypes_parsed(void *parsed_result,
                                       __rte_unused struct cmdline *cl,
                                       __rte_unused void *data) {
...
#define PTYPE_NAMESIZE 256
  ...
  ret = rte_eth_dev_get_supported_ptypes(port_id, RTE_PTYPE_ALL_MASK, NULL, 0);
  if (ret <= 0) {
...
static void cmd_showport_macs_parsed(void *parsed_result,
                                     __rte_unused struct cmdline *cl,
                                     __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_showport_macs_show =
    TOKEN_STRING_INITIALIZER(struct cmd_showport_macs_result, cmd_show, "show");
cmdline_parse_token_string_t cmd_showport_macs_port =
    TOKEN_STRING_INITIALIZER(struct cmd_showport_macs_result, cmd_port, "port");
cmdline_parse_token_num_t cmd_showport_macs_pid =
    TOKEN_NUM_INITIALIZER(struct cmd_showport_macs_result, cmd_pid, RTE_UINT16);
cmdline_parse_token_string_t cmd_showport_macs_keyword =
    TOKEN_STRING_INITIALIZER(struct cmd_showport_macs_result, cmd_keyword,
                             "macs#mcast_macs");
...
cmdline_parse_token_string_t cmd_show_port_flow_transfer_proxy_show =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_flow_transfer_proxy_result,
                             show, "show");
...
cmdline_parse_token_num_t cmd_show_port_flow_transfer_proxy_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_show_port_flow_transfer_proxy_result,
                          port_id, RTE_UINT16);
...
void cmdline_read_from_file(const char *filename) {
  ...
  if (cl == NULL) {
    fprintf(stderr, "Failed to create file based cmdline context: %s\n",
            filename);
    return;
  }
