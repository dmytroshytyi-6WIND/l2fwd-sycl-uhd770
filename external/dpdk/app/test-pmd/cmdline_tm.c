...
static void print_err_msg(struct rte_tm_error *error) {
  static const char *const errstrlist[] = {
      [RTE_TM_ERROR_TYPE_NONE] = "no error",
      [RTE_TM_ERROR_TYPE_UNSPECIFIED] = "cause unspecified",
      [RTE_TM_ERROR_TYPE_CAPABILITIES] = "capability parameter null",
      [RTE_TM_ERROR_TYPE_LEVEL_ID] = "level id",
      [RTE_TM_ERROR_TYPE_WRED_PROFILE] = "wred profile null",
      [RTE_TM_ERROR_TYPE_WRED_PROFILE_GREEN] = "wred profile(green)",
      [RTE_TM_ERROR_TYPE_WRED_PROFILE_YELLOW] = "wred profile(yellow)",
      [RTE_TM_ERROR_TYPE_WRED_PROFILE_RED] = "wred profile(red)",
      [RTE_TM_ERROR_TYPE_WRED_PROFILE_ID] = "wred profile id",
      [RTE_TM_ERROR_TYPE_SHARED_WRED_CONTEXT_ID] = "shared wred context id",
      ...
      [RTE_TM_ERROR_TYPE_NODE_PARAMS_STATS] = "stats field (node params)",
  ...
  fprintf(stderr, "%s: %s%s (error %d)\n", errstr, error->cause ? buf : "",
          error->message ? error->message : "(no stated reason)", error->type);
}

static int read_uint64(uint64_t *value, const char *p) {
  char *next;
  uint64_t val;
...
static int read_uint32(uint32_t *value, const char *p) {
  uint64_t val = 0;
...
static int parse_multi_ss_id_str(char *s_str, uint32_t *n_ssp,
                                 uint32_t shaper_id[]) {
...
cmdline_parse_token_string_t cmd_show_port_tm_cap_show =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_cap_result, show, "show");
cmdline_parse_token_string_t cmd_show_port_tm_cap_port =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_cap_result, port, "port");
cmdline_parse_token_string_t cmd_show_port_tm_cap_tm =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_cap_result, tm, "tm");
cmdline_parse_token_string_t cmd_show_port_tm_cap_cap =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_cap_result, cap, "cap");
cmdline_parse_token_num_t cmd_show_port_tm_cap_port_id = TOKEN_NUM_INITIALIZER(
    struct cmd_show_port_tm_cap_result, port_id, RTE_UINT16);
...
cmdline_parse_token_string_t cmd_show_port_tm_level_cap_show =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_level_cap_result, show,
                             "show");
cmdline_parse_token_string_t cmd_show_port_tm_level_cap_port =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_level_cap_result, port,
                             "port");
cmdline_parse_token_string_t cmd_show_port_tm_level_cap_tm =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_level_cap_result, tm,
                             "tm");
cmdline_parse_token_string_t cmd_show_port_tm_level_cap_level =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_level_cap_result, level,
                             "level");
cmdline_parse_token_string_t cmd_show_port_tm_level_cap_cap =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_level_cap_result, cap,
                             "cap");
cmdline_parse_token_num_t cmd_show_port_tm_level_cap_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_show_port_tm_level_cap_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_num_t cmd_show_port_tm_level_cap_level_id =
    TOKEN_NUM_INITIALIZER(struct cmd_show_port_tm_level_cap_result, level_id,
                          RTE_UINT32);
...
static void cmd_show_port_tm_level_cap_parsed(void *parsed_result,
  ...
  if (level_id <= 3) {
    ...
    printf("cap.nonleaf.shaper_private_packet_mode_supported %" PRId32 "\n",
    ...
    printf("cap.nonleaf.shaper_shared_packet_mode_supported %" PRId32 "\n",
           lcap.nonleaf.shaper_shared_packet_mode_supported);
    printf("cap.nonleaf.shaper_shared_byte_mode_supported %" PRId32 "\n",
...
cmdline_parse_token_string_t cmd_show_port_tm_node_cap_show =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_node_cap_result, show,
                             "show");
cmdline_parse_token_string_t cmd_show_port_tm_node_cap_port =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_node_cap_result, port,
                             "port");
cmdline_parse_token_string_t cmd_show_port_tm_node_cap_tm =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_node_cap_result, tm, "tm");
cmdline_parse_token_string_t cmd_show_port_tm_node_cap_node =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_node_cap_result, node,
                             "node");
cmdline_parse_token_string_t cmd_show_port_tm_node_cap_cap =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_node_cap_result, cap,
                             "cap");
cmdline_parse_token_num_t cmd_show_port_tm_node_cap_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_show_port_tm_node_cap_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_num_t cmd_show_port_tm_node_cap_node_id =
    TOKEN_NUM_INITIALIZER(struct cmd_show_port_tm_node_cap_result, node_id,
                          RTE_UINT32);
...
cmdline_parse_token_string_t cmd_show_port_tm_node_stats_show =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_node_stats_result, show,
                             "show");
cmdline_parse_token_string_t cmd_show_port_tm_node_stats_port =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_node_stats_result, port,
                             "port");
cmdline_parse_token_string_t cmd_show_port_tm_node_stats_tm =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_node_stats_result, tm,
                             "tm");
cmdline_parse_token_string_t cmd_show_port_tm_node_stats_node =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_node_stats_result, node,
                             "node");
cmdline_parse_token_string_t cmd_show_port_tm_node_stats_stats =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_node_stats_result, stats,
                             "stats");
cmdline_parse_token_num_t cmd_show_port_tm_node_stats_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_show_port_tm_node_stats_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_num_t cmd_show_port_tm_node_stats_node_id =
    TOKEN_NUM_INITIALIZER(struct cmd_show_port_tm_node_stats_result, node_id,
                          RTE_UINT32);
cmdline_parse_token_num_t cmd_show_port_tm_node_stats_clear =
    TOKEN_NUM_INITIALIZER(struct cmd_show_port_tm_node_stats_result, clear,
                          RTE_UINT32);
...
static void cmd_show_port_tm_node_stats_parsed(void *parsed_result,
  ...
  ret = rte_tm_node_stats_read(port_id, node_id, &stats, &stats_mask, clear,
                               &error);
  if (ret != 0) {
    print_err_msg(&error);
    return;
...
cmdline_parse_token_string_t cmd_show_port_tm_node_type_show =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_node_type_result, show,
                             "show");
cmdline_parse_token_string_t cmd_show_port_tm_node_type_port =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_node_type_result, port,
                             "port");
cmdline_parse_token_string_t cmd_show_port_tm_node_type_tm =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_node_type_result, tm,
                             "tm");
cmdline_parse_token_string_t cmd_show_port_tm_node_type_node =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_node_type_result, node,
                             "node");
cmdline_parse_token_string_t cmd_show_port_tm_node_type_type =
    TOKEN_STRING_INITIALIZER(struct cmd_show_port_tm_node_type_result, type,
                             "type");
cmdline_parse_token_num_t cmd_show_port_tm_node_type_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_show_port_tm_node_type_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_num_t cmd_show_port_tm_node_type_node_id =
    TOKEN_NUM_INITIALIZER(struct cmd_show_port_tm_node_type_result, node_id,
                          RTE_UINT32);
...
cmdline_parse_token_string_t cmd_del_port_tm_node_shaper_profile_del =
    TOKEN_STRING_INITIALIZER(struct cmd_del_port_tm_node_shaper_profile_result,
                             del, "del");
...
cmdline_parse_token_num_t cmd_del_port_tm_node_shaper_profile_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_del_port_tm_node_shaper_profile_result,
                          port_id, RTE_UINT16);
...
static void
cmd_del_port_tm_node_shaper_profile_parsed(void *parsed_result,
                                           __rte_unused struct cmdline *cl,
                                           __rte_unused void *data) {
...
cmd_add_port_tm_node_shared_shaper_parsed(void *parsed_result,
  ...
  memset(&error, 0, sizeof(struct rte_tm_error));
  /* Command type: add */
  if ((strcmp(res->cmd_type, "add") == 0) && (port_is_started(port_id))) {
    fprintf(stderr, " Port %u not stopped (error)\n", port_id);
    return;
  }

  /* Command type: set (update) */
  if ((strcmp(res->cmd_type, "set") == 0) && (!port_is_started(port_id))) {
    fprintf(stderr, " Port %u not started (error)\n", port_id);
    return;
  }
...
cmdline_parse_token_string_t cmd_del_port_tm_node_shared_shaper_del =
    TOKEN_STRING_INITIALIZER(struct cmd_del_port_tm_node_shared_shaper_result,
                             del, "del");
...
cmdline_parse_token_num_t cmd_del_port_tm_node_shared_shaper_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_del_port_tm_node_shared_shaper_result,
                          port_id, RTE_UINT16);
...
cmdline_parse_token_string_t cmd_del_port_tm_node_wred_profile_del =
    TOKEN_STRING_INITIALIZER(struct cmd_del_port_tm_node_wred_profile_result,
                             del, "del");
...
cmdline_parse_token_num_t cmd_del_port_tm_node_wred_profile_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_del_port_tm_node_wred_profile_result,
                          port_id, RTE_UINT16);
...
static void
cmd_del_port_tm_node_wred_profile_parsed(void *parsed_result,
                                         __rte_unused struct cmdline *cl,
                                         __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_set_port_tm_node_shaper_profile_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_port_tm_node_shaper_profile_result,
                             set, "set");
...
cmd_set_port_tm_node_shaper_profile_parsed(void *parsed_result,
  ...
  ret = rte_tm_node_shaper_update(port_id, node_id, shaper_profile_id, &error);
  if (ret != 0) {
    print_err_msg(&error);
    return;
  }
...
cmdline_parse_token_string_t cmd_add_port_tm_nonleaf_node_add =
    TOKEN_STRING_INITIALIZER(struct cmd_add_port_tm_nonleaf_node_result, add,
                             "add");
cmdline_parse_token_string_t cmd_add_port_tm_nonleaf_node_port =
    TOKEN_STRING_INITIALIZER(struct cmd_add_port_tm_nonleaf_node_result, port,
                             "port");
cmdline_parse_token_string_t cmd_add_port_tm_nonleaf_node_tm =
    TOKEN_STRING_INITIALIZER(struct cmd_add_port_tm_nonleaf_node_result, tm,
                             "tm");
...
cmdline_parse_token_string_t cmd_add_port_tm_nonleaf_node_node =
    TOKEN_STRING_INITIALIZER(struct cmd_add_port_tm_nonleaf_node_result, node,
                             "node");
cmdline_parse_token_num_t cmd_add_port_tm_nonleaf_node_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_add_port_tm_nonleaf_node_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_num_t cmd_add_port_tm_nonleaf_node_node_id =
    TOKEN_NUM_INITIALIZER(struct cmd_add_port_tm_nonleaf_node_result, node_id,
                          RTE_UINT32);
...
cmdline_parse_token_num_t cmd_add_port_tm_nonleaf_node_priority =
    TOKEN_NUM_INITIALIZER(struct cmd_add_port_tm_nonleaf_node_result, priority,
                          RTE_UINT32);
cmdline_parse_token_num_t cmd_add_port_tm_nonleaf_node_weight =
    TOKEN_NUM_INITIALIZER(struct cmd_add_port_tm_nonleaf_node_result, weight,
                          RTE_UINT32);
cmdline_parse_token_num_t cmd_add_port_tm_nonleaf_node_level_id =
    TOKEN_NUM_INITIALIZER(struct cmd_add_port_tm_nonleaf_node_result, level_id,
                          RTE_UINT32);
...
static void cmd_add_port_tm_nonleaf_node_parsed(void *parsed_result,
  ...
  shared_shaper_id =
      (uint32_t *)malloc(MAX_NUM_SHARED_SHAPERS * sizeof(uint32_t));
  ...
  ret = rte_tm_node_add(port_id, res->node_id, parent_node_id, res->priority,
                        res->weight, res->level_id, &np, &error);
  if (ret != 0) {
    print_err_msg(&error);
    free(shared_shaper_id);
    return;
...
cmdline_parse_token_string_t cmd_add_port_tm_nonleaf_node_pmode_add =
    TOKEN_STRING_INITIALIZER(struct cmd_add_port_tm_nonleaf_node_pmode_result,
                             add, "add");
...
static void
cmd_add_port_tm_nonleaf_node_pmode_parsed(void *parsed_result,
                                          __rte_unused struct cmdline *cl,
                                          __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_add_port_tm_leaf_node_add =
    TOKEN_STRING_INITIALIZER(struct cmd_add_port_tm_leaf_node_result, add,
                             "add");
cmdline_parse_token_string_t cmd_add_port_tm_leaf_node_port =
    TOKEN_STRING_INITIALIZER(struct cmd_add_port_tm_leaf_node_result, port,
                             "port");
cmdline_parse_token_string_t cmd_add_port_tm_leaf_node_tm =
    TOKEN_STRING_INITIALIZER(struct cmd_add_port_tm_leaf_node_result, tm, "tm");
cmdline_parse_token_string_t cmd_add_port_tm_leaf_node_nonleaf =
    TOKEN_STRING_INITIALIZER(struct cmd_add_port_tm_leaf_node_result, leaf,
                             "leaf");
cmdline_parse_token_string_t cmd_add_port_tm_leaf_node_node =
    TOKEN_STRING_INITIALIZER(struct cmd_add_port_tm_leaf_node_result, node,
                             "node");
cmdline_parse_token_num_t cmd_add_port_tm_leaf_node_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_add_port_tm_leaf_node_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_num_t cmd_add_port_tm_leaf_node_node_id =
    TOKEN_NUM_INITIALIZER(struct cmd_add_port_tm_leaf_node_result, node_id,
                          RTE_UINT32);
...
cmdline_parse_token_num_t cmd_add_port_tm_leaf_node_priority =
    TOKEN_NUM_INITIALIZER(struct cmd_add_port_tm_leaf_node_result, priority,
                          RTE_UINT32);
cmdline_parse_token_num_t cmd_add_port_tm_leaf_node_weight =
    TOKEN_NUM_INITIALIZER(struct cmd_add_port_tm_leaf_node_result, weight,
                          RTE_UINT32);
cmdline_parse_token_num_t cmd_add_port_tm_leaf_node_level_id =
    TOKEN_NUM_INITIALIZER(struct cmd_add_port_tm_leaf_node_result, level_id,
                          RTE_UINT32);
...
cmdline_parse_token_num_t cmd_add_port_tm_leaf_node_cman_mode =
    TOKEN_NUM_INITIALIZER(struct cmd_add_port_tm_leaf_node_result, cman_mode,
                          RTE_UINT32);
...
cmdline_parse_token_num_t cmd_add_port_tm_leaf_node_stats_mask =
    TOKEN_NUM_INITIALIZER(struct cmd_add_port_tm_leaf_node_result, stats_mask,
                          RTE_UINT64);
cmdline_parse_token_string_t cmd_add_port_tm_leaf_node_multi_shared_shaper_id =
...
cmdline_parse_token_string_t cmd_del_port_tm_node_del =
    TOKEN_STRING_INITIALIZER(struct cmd_del_port_tm_node_result, del, "del");
cmdline_parse_token_string_t cmd_del_port_tm_node_port =
    TOKEN_STRING_INITIALIZER(struct cmd_del_port_tm_node_result, port, "port");
cmdline_parse_token_string_t cmd_del_port_tm_node_tm =
    TOKEN_STRING_INITIALIZER(struct cmd_del_port_tm_node_result, tm, "tm");
cmdline_parse_token_string_t cmd_del_port_tm_node_node =
    TOKEN_STRING_INITIALIZER(struct cmd_del_port_tm_node_result, node, "node");
cmdline_parse_token_num_t cmd_del_port_tm_node_port_id = TOKEN_NUM_INITIALIZER(
    struct cmd_del_port_tm_node_result, port_id, RTE_UINT16);
cmdline_parse_token_num_t cmd_del_port_tm_node_node_id = TOKEN_NUM_INITIALIZER(
    struct cmd_del_port_tm_node_result, node_id, RTE_UINT32);
...
cmdline_parse_token_string_t cmd_set_port_tm_node_parent_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_port_tm_node_parent_result, set,
                             "set");
cmdline_parse_token_string_t cmd_set_port_tm_node_parent_port =
    TOKEN_STRING_INITIALIZER(struct cmd_set_port_tm_node_parent_result, port,
                             "port");
cmdline_parse_token_string_t cmd_set_port_tm_node_parent_tm =
    TOKEN_STRING_INITIALIZER(struct cmd_set_port_tm_node_parent_result, tm,
                             "tm");
cmdline_parse_token_string_t cmd_set_port_tm_node_parent_node =
    TOKEN_STRING_INITIALIZER(struct cmd_set_port_tm_node_parent_result, node,
                             "node");
cmdline_parse_token_string_t cmd_set_port_tm_node_parent_parent =
    TOKEN_STRING_INITIALIZER(struct cmd_set_port_tm_node_parent_result, parent,
                             "parent");
cmdline_parse_token_num_t cmd_set_port_tm_node_parent_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_set_port_tm_node_parent_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_num_t cmd_set_port_tm_node_parent_node_id =
    TOKEN_NUM_INITIALIZER(struct cmd_set_port_tm_node_parent_result, node_id,
                          RTE_UINT32);
cmdline_parse_token_num_t cmd_set_port_tm_node_parent_parent_id =
    TOKEN_NUM_INITIALIZER(struct cmd_set_port_tm_node_parent_result, parent_id,
                          RTE_UINT32);
cmdline_parse_token_num_t cmd_set_port_tm_node_parent_priority =
    TOKEN_NUM_INITIALIZER(struct cmd_set_port_tm_node_parent_result, priority,
                          RTE_UINT32);
cmdline_parse_token_num_t cmd_set_port_tm_node_parent_weight =
    TOKEN_NUM_INITIALIZER(struct cmd_set_port_tm_node_parent_result, weight,
                          RTE_UINT32);
...
static void cmd_set_port_tm_node_parent_parsed(void *parsed_result,
  ...
  ret = rte_tm_node_parent_update(port_id, node_id, parent_id, priority, weight,
                                  &error);
  if (ret != 0) {
    print_err_msg(&error);
    return;
...
cmdline_parse_token_string_t cmd_suspend_port_tm_node_suspend =
    TOKEN_STRING_INITIALIZER(struct cmd_suspend_port_tm_node_result, suspend,
                             "suspend");
cmdline_parse_token_string_t cmd_suspend_port_tm_node_port =
    TOKEN_STRING_INITIALIZER(struct cmd_suspend_port_tm_node_result, port,
                             "port");
cmdline_parse_token_string_t cmd_suspend_port_tm_node_tm =
    TOKEN_STRING_INITIALIZER(struct cmd_suspend_port_tm_node_result, tm, "tm");
cmdline_parse_token_string_t cmd_suspend_port_tm_node_node =
    TOKEN_STRING_INITIALIZER(struct cmd_suspend_port_tm_node_result, node,
                             "node");
cmdline_parse_token_num_t cmd_suspend_port_tm_node_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_suspend_port_tm_node_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_num_t cmd_suspend_port_tm_node_node_id =
    TOKEN_NUM_INITIALIZER(struct cmd_suspend_port_tm_node_result, node_id,
                          RTE_UINT32);
...
cmdline_parse_token_string_t cmd_resume_port_tm_node_resume =
    TOKEN_STRING_INITIALIZER(struct cmd_resume_port_tm_node_result, resume,
                             "resume");
cmdline_parse_token_string_t cmd_resume_port_tm_node_port =
    TOKEN_STRING_INITIALIZER(struct cmd_resume_port_tm_node_result, port,
                             "port");
cmdline_parse_token_string_t cmd_resume_port_tm_node_tm =
    TOKEN_STRING_INITIALIZER(struct cmd_resume_port_tm_node_result, tm, "tm");
cmdline_parse_token_string_t cmd_resume_port_tm_node_node =
    TOKEN_STRING_INITIALIZER(struct cmd_resume_port_tm_node_result, node,
                             "node");
cmdline_parse_token_num_t cmd_resume_port_tm_node_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_resume_port_tm_node_result, port_id,
                          RTE_UINT16);
cmdline_parse_token_num_t cmd_resume_port_tm_node_node_id =
    TOKEN_NUM_INITIALIZER(struct cmd_resume_port_tm_node_result, node_id,
                          RTE_UINT32);
...
cmdline_parse_token_string_t cmd_port_tm_hierarchy_commit_port =
    TOKEN_STRING_INITIALIZER(struct cmd_port_tm_hierarchy_commit_result, port,
                             "port");
cmdline_parse_token_string_t cmd_port_tm_hierarchy_commit_tm =
    TOKEN_STRING_INITIALIZER(struct cmd_port_tm_hierarchy_commit_result, tm,
                             "tm");
...
cmdline_parse_token_string_t cmd_port_tm_hierarchy_commit_commit =
    TOKEN_STRING_INITIALIZER(struct cmd_port_tm_hierarchy_commit_result, commit,
                             "commit");
cmdline_parse_token_num_t cmd_port_tm_hierarchy_commit_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_port_tm_hierarchy_commit_result, port_id,
                          RTE_UINT16);
...
cmdline_parse_token_string_t cmd_port_tm_mark_ip_ecn_set =
    TOKEN_STRING_INITIALIZER(struct cmd_port_tm_mark_ip_ecn_result, set, "set");

cmdline_parse_token_string_t cmd_port_tm_mark_ip_ecn_port =
    TOKEN_STRING_INITIALIZER(struct cmd_port_tm_mark_ip_ecn_result, port,
                             "port");

cmdline_parse_token_string_t cmd_port_tm_mark_ip_ecn_tm =
    TOKEN_STRING_INITIALIZER(struct cmd_port_tm_mark_ip_ecn_result, tm, "tm");

cmdline_parse_token_string_t cmd_port_tm_mark_ip_ecn_mark =
    TOKEN_STRING_INITIALIZER(struct cmd_port_tm_mark_ip_ecn_result, mark,
                             "mark");

cmdline_parse_token_string_t cmd_port_tm_mark_ip_ecn_ip_ecn =
    TOKEN_STRING_INITIALIZER(struct cmd_port_tm_mark_ip_ecn_result, ip_ecn,
                             "ip_ecn");
cmdline_parse_token_num_t cmd_port_tm_mark_ip_ecn_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_port_tm_mark_ip_ecn_result, port_id,
                          RTE_UINT16);

cmdline_parse_token_num_t cmd_port_tm_mark_ip_ecn_green = TOKEN_NUM_INITIALIZER(
    struct cmd_port_tm_mark_ip_ecn_result, green, RTE_UINT16);
cmdline_parse_token_num_t cmd_port_tm_mark_ip_ecn_yellow =
    TOKEN_NUM_INITIALIZER(struct cmd_port_tm_mark_ip_ecn_result, yellow,
                          RTE_UINT16);
cmdline_parse_token_num_t cmd_port_tm_mark_ip_ecn_red = TOKEN_NUM_INITIALIZER(
    struct cmd_port_tm_mark_ip_ecn_result, red, RTE_UINT16);
...
cmdline_parse_token_string_t cmd_port_tm_mark_ip_dscp_set =
    TOKEN_STRING_INITIALIZER(struct cmd_port_tm_mark_ip_dscp_result, set,
                             "set");

cmdline_parse_token_string_t cmd_port_tm_mark_ip_dscp_port =
    TOKEN_STRING_INITIALIZER(struct cmd_port_tm_mark_ip_dscp_result, port,
                             "port");

cmdline_parse_token_string_t cmd_port_tm_mark_ip_dscp_tm =
    TOKEN_STRING_INITIALIZER(struct cmd_port_tm_mark_ip_dscp_result, tm, "tm");

cmdline_parse_token_string_t cmd_port_tm_mark_ip_dscp_mark =
    TOKEN_STRING_INITIALIZER(struct cmd_port_tm_mark_ip_dscp_result, mark,
                             "mark");

cmdline_parse_token_string_t cmd_port_tm_mark_ip_dscp_ip_dscp =
    TOKEN_STRING_INITIALIZER(struct cmd_port_tm_mark_ip_dscp_result, ip_dscp,
                             "ip_dscp");
cmdline_parse_token_num_t cmd_port_tm_mark_ip_dscp_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_port_tm_mark_ip_dscp_result, port_id,
                          RTE_UINT16);

cmdline_parse_token_num_t cmd_port_tm_mark_ip_dscp_green =
    TOKEN_NUM_INITIALIZER(struct cmd_port_tm_mark_ip_dscp_result, green,
                          RTE_UINT16);
cmdline_parse_token_num_t cmd_port_tm_mark_ip_dscp_yellow =
    TOKEN_NUM_INITIALIZER(struct cmd_port_tm_mark_ip_dscp_result, yellow,
                          RTE_UINT16);
cmdline_parse_token_num_t cmd_port_tm_mark_ip_dscp_red = TOKEN_NUM_INITIALIZER(
    struct cmd_port_tm_mark_ip_dscp_result, red, RTE_UINT16);
...
cmdline_parse_token_string_t cmd_port_tm_mark_vlan_dei_set =
    TOKEN_STRING_INITIALIZER(struct cmd_port_tm_mark_vlan_dei_result, set,
                             "set");

cmdline_parse_token_string_t cmd_port_tm_mark_vlan_dei_port =
    TOKEN_STRING_INITIALIZER(struct cmd_port_tm_mark_vlan_dei_result, port,
                             "port");

cmdline_parse_token_string_t cmd_port_tm_mark_vlan_dei_tm =
    TOKEN_STRING_INITIALIZER(struct cmd_port_tm_mark_vlan_dei_result, tm, "tm");

cmdline_parse_token_string_t cmd_port_tm_mark_vlan_dei_mark =
    TOKEN_STRING_INITIALIZER(struct cmd_port_tm_mark_vlan_dei_result, mark,
                             "mark");

cmdline_parse_token_string_t cmd_port_tm_mark_vlan_dei_vlan_dei =
    TOKEN_STRING_INITIALIZER(struct cmd_port_tm_mark_vlan_dei_result, vlan_dei,
                             "vlan_dei");
cmdline_parse_token_num_t cmd_port_tm_mark_vlan_dei_port_id =
    TOKEN_NUM_INITIALIZER(struct cmd_port_tm_mark_vlan_dei_result, port_id,
                          RTE_UINT16);

cmdline_parse_token_num_t cmd_port_tm_mark_vlan_dei_green =
    TOKEN_NUM_INITIALIZER(struct cmd_port_tm_mark_vlan_dei_result, green,
                          RTE_UINT16);
cmdline_parse_token_num_t cmd_port_tm_mark_vlan_dei_yellow =
    TOKEN_NUM_INITIALIZER(struct cmd_port_tm_mark_vlan_dei_result, yellow,
                          RTE_UINT16);
cmdline_parse_token_num_t cmd_port_tm_mark_vlan_dei_red = TOKEN_NUM_INITIALIZER(
    struct cmd_port_tm_mark_vlan_dei_result, red, RTE_UINT16);
