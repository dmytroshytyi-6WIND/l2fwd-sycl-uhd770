...
static int test_trace_metadata_dump(void) {
...
static int32_t test_trace_point_globbing(void) {
  int rc;
...
static int32_t test_trace_point_regex(void) {
  int rc;
...
static int32_t test_trace_point_disable_enable(void) {
  int rc;
...
static int test_trace_mode(void) {
...
static int test_trace_points_lookup(void) {
...
static int test_fp_trace_points(void) {
  /* Emit the FP trace */
  app_dpdk_test_fp();
...
static int test_generic_trace_points(void) {
  int tmp;
...
static struct unit_test_suite trace_tests = {
    ...
    .teardown = NULL,
    .unit_test_cases = {
        TEST_CASE(test_trace_mode), TEST_CASE(test_generic_trace_points),
        TEST_CASE(test_fp_trace_points),
        TEST_CASE(test_trace_point_disable_enable),
        TEST_CASE(test_trace_point_globbing), TEST_CASE(test_trace_point_regex),
        TEST_CASE(test_trace_points_lookup), TEST_CASES_END()}};

static int test_trace(void) { return unit_test_suite_runner(&trace_tests); }
