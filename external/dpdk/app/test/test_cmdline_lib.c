...
static void valid_buffer(__rte_unused struct rdline *rdl,
                         __rte_unused const char *buf,
                         __rte_unused unsigned int size) {}

static int complete_buffer(__rte_unused struct rdline *rdl,
                           __rte_unused const char *buf,
...
static int test_cmdline_parse_fns(void) {
  struct cmdline *cl;
...
static int test_cmdline_rdline_fns(void) {
  struct rdline *rdl;
...
static int test_cmdline_vt100_fns(void) {
...
static int test_cmdline_socket_fns(void) {
  cmdline_parse_ctx_t ctx;
  struct cmdline *cl;
...
static int test_cmdline_fns(void) {
  cmdline_parse_ctx_t ctx;
  struct cmdline *cl;
