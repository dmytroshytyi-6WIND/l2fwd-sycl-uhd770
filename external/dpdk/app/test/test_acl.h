...
struct rte_acl_ipv4vlan_rule invalid_layout_rules[] = {
    ...
    {
        .data = {.userdata = 3, .category_mask = 1, .priority = 1},
        .dst_port_low = 100,
        .dst_port_high = 100,
    },
    {
        .data = {.userdata = 4, .category_mask = 1, .priority = 1},
        .src_port_low = 100,
        .src_port_high = 100,
    },
    /* test proto */
    {.data = {.userdata = 5, .category_mask = 1, .priority = 1},
     .proto = 0xf,
     .proto_mask = 0xf},
    {
        .data = {.userdata = 6, .category_mask = 1, .priority = 1},
        .dst_port_low = 0xf,
        .dst_port_high = 0xf,
    }};
...
struct ipv4_7tuple acl_test_data[] = {
    ...
    {.vlan = 0x5,
     .ip_src = RTE_IPV4(10, 1, 1, 1),
     .allow = 5,
     .deny = 9}, /* should match 5, 9 */
    {.vlan = 0x5,
     .ip_src = RTE_IPV4(192, 168, 2, 50),
     .allow = 8,
     .deny = 9}, /* should match 8, 9 */
    {.vlan = 0x55,
     .ip_src = RTE_IPV4(192, 168, 1, 49),
     .allow = 8}, /* should match 8 */
    {.port_dst = 80,
     .port_src = 1024,
     .allow = 13,
     .deny = 20}, /* should match 13,20 */
    {.port_dst = 79,
     .port_src = 1024,
     .allow = 14,
     .deny = 20}, /* should match 14,20 */
    {.proto = 0x5,
     .ip_dst = RTE_IPV4(192, 168, 2, 50),
     .allow = 1,
     .deny = 23}, /* should match 1, 23 */
    ...
    {.vlan = 0x64,
     .domain = 0x5,
     .allow = 11,
     .deny = 12}, /* should match 11, 12 */
    {.proto = 0x5,
     .port_src = 80,
     .allow = 17,
     .deny = 23}, /* should match 17, 23 */
    {.proto = 0x5,
     .port_dst = 80,
     .allow = 13,
     .deny = 23},                      /* should match 13, 23 */
