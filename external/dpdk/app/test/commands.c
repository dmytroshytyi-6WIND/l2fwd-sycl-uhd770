...
cmdline_parse_token_string_t cmd_set_rxtx_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_rxtx_result, set, "set_rxtx_mode");
...
static void cmd_set_rxtx_anchor_parsed(void *parsed_result, struct cmdline *cl,
                                       __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_set_rxtx_anchor_set = TOKEN_STRING_INITIALIZER(
    struct cmd_set_rxtx_anchor, set, "set_rxtx_anchor");
...
static void cmd_set_rxtx_sc_parsed(void *parsed_result, struct cmdline *cl,
                                   __rte_unused void *data) {
...
cmdline_parse_token_string_t cmd_set_rxtx_sc_set =
    TOKEN_STRING_INITIALIZER(struct cmd_set_rxtx_sc, set, "set_rxtx_sc");
