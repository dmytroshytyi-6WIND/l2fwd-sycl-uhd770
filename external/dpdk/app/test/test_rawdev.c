...
static int test_rawdev_selftests(void) {
...
static int test_rawdev_selftest_impl(const char *pmd, const char *opts) {
  int ret;
...
static int test_rawdev_selftest_skeleton(void) {
