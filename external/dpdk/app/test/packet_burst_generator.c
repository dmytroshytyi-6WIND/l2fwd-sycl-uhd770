...
void initialize_arp_header(struct rte_arp_hdr *arp_hdr,
                           struct rte_ether_addr *src_mac,
                           struct rte_ether_addr *dst_mac, uint32_t src_ip,
                           uint32_t dst_ip, uint32_t opcode) {
...
uint16_t initialize_udp_header(struct rte_udp_hdr *udp_hdr, uint16_t src_port,
...
uint16_t initialize_ipv6_header(struct rte_ipv6_hdr *ip_hdr, uint8_t *src_addr,
...
uint16_t initialize_ipv4_header(struct rte_ipv4_hdr *ip_hdr, uint32_t src_addr,
...
uint16_t initialize_ipv4_header_proto(struct rte_ipv4_hdr *ip_hdr,
                                      ...
                                      uint16_t pkt_data_len, uint8_t proto) {
  uint16_t pkt_len;
  unaligned_uint16_t *ptr16;
  uint32_t ip_cksum;
...
int generate_packet_burst(struct rte_mempool *mp, struct rte_mbuf **pkts_burst,
                          struct rte_ether_hdr *eth_hdr, uint8_t vlan_enabled,
                          void *ip_hdr, uint8_t ipv4,
                          struct rte_udp_hdr *udp_hdr, int nb_pkt_per_burst,
