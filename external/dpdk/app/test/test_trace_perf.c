...
static void measure_perf(const char *str, struct test_data *data) {
...
static void wait_till_workers_are_ready(struct test_data *data) {
  unsigned int workers;
...
static void signal_workers_to_finish(struct test_data *data) {
  unsigned int workers;
...
#define WORKER_DEFINE(func)                                                    \
  static void __rte_noinline __worker_##func(struct lcore_data *ldata) {       \
    uint64_t start;                                                            \
    int i;                                                                     \
    while (!ldata->done) {                                                     \
  ...
  static int worker_fn_##func(void *arg) {                                     \
...
static void run_test(const char *str, lcore_function_t f,
...
static int test_trace_perf(void) {
