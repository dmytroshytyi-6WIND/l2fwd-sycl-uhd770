...
static int assign_vars(__rte_unused void *arg) {
...
static int display_vars(__rte_unused void *arg) {
...
static int test_per_lcore_delay(__rte_unused void *arg) {
  rte_delay_ms(100);
...
static int test_per_lcore(void) {
  unsigned lcore_id;
  int ret;
