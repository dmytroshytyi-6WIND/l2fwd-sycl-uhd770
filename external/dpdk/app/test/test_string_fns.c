...
static int test_rte_strsplit(void) {
  int i;
  do {
    /* =======================================================
    ...
    if (rte_strsplit(test_string, sizeof(test_string), splits, 6, ':') != 6) {
  ...
  do {
    ...
    LOG("Source string: '%s', to split on ' '\n", test_string);
    if (rte_strsplit(test_string, sizeof(test_string), splits, 3, ' ') != 3) {
  ...
  do {
    ...
    LOG("Source string: '%s', to split on ','\n", test_string);
    if (rte_strsplit(test_string, sizeof(test_string), splits, 6, ',') != 4) {
  ...
  do {
    ...
    LOG("Source string: '%s', to split on ' '\n", test_string);
    if (rte_strsplit(test_string, sizeof(test_string), splits, 6, ' ') != 1) {
      LOG("Error splitting %s on ' '\n", test_string);
      return -1;
    }
  ...
  do {
    ...
    if (rte_strsplit(NULL, 0, splits, 6, ',') >= 0 || errno != EINVAL) {
...
static int test_rte_strlcat(void) {
...
static int test_string_fns(void) {
