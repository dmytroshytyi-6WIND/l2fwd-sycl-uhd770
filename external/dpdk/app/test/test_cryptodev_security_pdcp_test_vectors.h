...
static const struct pdcp_short_mac_test list_pdcp_smac_tests[] = {
    {
        ...
        .in_len = 7,
        .data_out = (uint8_t[]){0x33, 0x32, 0x34, 0x62, 0x63, 0x39, 0x38, 0x56,
                                0xd2, 0x09, 0xae},
    },

    {
        ...
        .in_len = 7,
        .data_out = (uint8_t[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x13,
                                0xf8, 0x4b, 0xea},
    },

    {
        ...
        .in_len = 8,
        .data_out = (uint8_t[]){0x00, 0xc0, 0x00, 0x00, 0x00, 0x05, 0x09, 0xe4,
                                0xdd, 0xff, 0xde, 0xa9},
    },

    {
        ...
        .data_in = (uint8_t[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
        .in_len = 7,
        .data_out = (uint8_t[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x23,
                                0xea, 0x95, 0xb0},
    },

    {
        ...
        .data_in = (uint8_t[]){0x33, 0x32, 0x34, 0x62, 0x63, 0x39, 0x38},
        .in_len = 7,
        .data_out = (uint8_t[]){0x33, 0x32, 0x34, 0x62, 0x63, 0x39, 0x38, 0x00,
                                0x00, 0x00, 0x00},
    },
...
static struct pdcp_test_param pdcp_test_params[] = {
    ...
    {
        .name = "PDCP Control Plane with NULL encryption and NULL integrity "
                "Downlink",
        .cipher_alg = RTE_CRYPTO_CIPHER_NULL,
        .auth_alg = RTE_CRYPTO_AUTH_NULL,
        .domain = RTE_SECURITY_PDCP_MODE_CONTROL,
    ...
    {
        .name = "PDCP Control Plane with NULL encryption and SNOW f9 integrity "
                "Uplink",
        .cipher_alg = RTE_CRYPTO_CIPHER_NULL,
        .auth_alg = RTE_CRYPTO_AUTH_SNOW3G_UIA2,
        .domain = RTE_SECURITY_PDCP_MODE_CONTROL,
    ...
    {
        .name = "PDCP Control Plane with NULL encryption and AES CMAC "
                "integrity Uplink",
        .cipher_alg = RTE_CRYPTO_CIPHER_NULL,
        .auth_alg = RTE_CRYPTO_AUTH_AES_CMAC,
        .domain = RTE_SECURITY_PDCP_MODE_CONTROL,
    ...
    {
        .name = "PDCP Control Plane with NULL encryption and ZUC integrity "
                "Downlink",
        .cipher_alg = RTE_CRYPTO_CIPHER_NULL,
        .auth_alg = RTE_CRYPTO_AUTH_ZUC_EIA3,
        .domain = RTE_SECURITY_PDCP_MODE_CONTROL,
    ...
    {
        .name = "PDCP Control Plane with SNOW f8 encryption and NULL integrity "
                "Uplink",
    ...
    {
        .name = "PDCP Control Plane with SNOW f8 encryption and SNOW f9 "
                "integrity Uplink",
        .cipher_alg = RTE_CRYPTO_CIPHER_SNOW3G_UEA2,
        .auth_alg = RTE_CRYPTO_AUTH_SNOW3G_UIA2,
        .domain = RTE_SECURITY_PDCP_MODE_CONTROL,
    ...
    {
        .name = "PDCP Control Plane with SNOW f8 encryption and AES CMAC "
                "integrity Uplink",
        .cipher_alg = RTE_CRYPTO_CIPHER_SNOW3G_UEA2,
        .auth_alg = RTE_CRYPTO_AUTH_AES_CMAC,
        .domain = RTE_SECURITY_PDCP_MODE_CONTROL,
    ...
    {
        .name = "PDCP Control Plane with SNOW f8 encryption and ZUC integrity "
                "Uplink",
        .cipher_alg = RTE_CRYPTO_CIPHER_SNOW3G_UEA2,
        .auth_alg = RTE_CRYPTO_AUTH_ZUC_EIA3,
        .domain = RTE_SECURITY_PDCP_MODE_CONTROL,
    ...
    {
        .name = "PDCP Control Plane with AES CTR encryption and NULL integrity "
                "Uplink",
    ...
    {
        .name = "PDCP Control Plane with AES CTR encryption and SNOW f9 "
                "integrity Uplink",
        .cipher_alg = RTE_CRYPTO_CIPHER_AES_CTR,
        .auth_alg = RTE_CRYPTO_AUTH_SNOW3G_UIA2,
        .domain = RTE_SECURITY_PDCP_MODE_CONTROL,
    ...
    {
        .name = "PDCP Control Plane with AES CTR encryption and AES CMAC "
                "integrity Uplink",
        .cipher_alg = RTE_CRYPTO_CIPHER_AES_CTR,
        .auth_alg = RTE_CRYPTO_AUTH_AES_CMAC,
        .domain = RTE_SECURITY_PDCP_MODE_CONTROL,
    ...
    {
        .name = "PDCP Control Plane with AES CTR encryption and ZUC integrity "
                "Uplink",
        .cipher_alg = RTE_CRYPTO_CIPHER_AES_CTR,
        .auth_alg = RTE_CRYPTO_AUTH_ZUC_EIA3,
        .domain = RTE_SECURITY_PDCP_MODE_CONTROL,
    ...
    {
        .name = "PDCP Control Plane with ZUC encryption and NULL integrity "
                "Downlink",
        .cipher_alg = RTE_CRYPTO_CIPHER_ZUC_EEA3,
        .auth_alg = RTE_CRYPTO_AUTH_NULL,
        .domain = RTE_SECURITY_PDCP_MODE_CONTROL,
    ...
    {
        .name = "PDCP Control Plane with ZUC encryption and SNOW f9 integrity "
                "Uplink",
        .cipher_alg = RTE_CRYPTO_CIPHER_ZUC_EEA3,
        .auth_alg = RTE_CRYPTO_AUTH_SNOW3G_UIA2,
        .domain = RTE_SECURITY_PDCP_MODE_CONTROL,
    ...
    {
        .name = "PDCP Control Plane with ZUC encryption and AES CMAC integrity "
                "Uplink",
        .cipher_alg = RTE_CRYPTO_CIPHER_ZUC_EEA3,
        .auth_alg = RTE_CRYPTO_AUTH_AES_CMAC,
        .domain = RTE_SECURITY_PDCP_MODE_CONTROL,
    ...
    {
        .name = "PDCP User Plane with NULL encryption Uplink with long "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_NULL,
        .auth_alg = 0,
    ...
    {
        .name = "PDCP User Plane with NULL encryption Downlink with long "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_NULL,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with NULL encryption Uplink with short "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_NULL,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with NULL encryption Downlink with short "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_NULL,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with NULL encryption Uplink with 15 bit "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_NULL,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with NULL encryption Downlink with 15 bit "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_NULL,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with NULL encryption Uplink with 18 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_NULL,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
        .cipher_key_len = 0,
    ...
    {
        .name = "PDCP User Plane with NULL encryption Downlink with 18 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_NULL,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
        .cipher_key_len = 0,
    ...
    {
        .name = "PDCP User Plane with SNOW f8 encryption Uplink with long "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_SNOW3G_UEA2,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with SNOW f8 encryption Downlink with long "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_SNOW3G_UEA2,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with SNOW f8 encryption Uplink with short "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_SNOW3G_UEA2,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with SNOW f8 encryption Downlink with short "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_SNOW3G_UEA2,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with SNOW f8 encryption Uplink with 15 bit "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_SNOW3G_UEA2,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with SNOW f8 encryption Downlink with 15 bit "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_SNOW3G_UEA2,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with SNOW f8 encryption Uplink with 18 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_SNOW3G_UEA2,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
        .cipher_key_len = 16,
    ...
    {
        .name = "PDCP User Plane with AES CTR encryption Uplink with long "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_AES_CTR,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with AES CTR encryption Downlink with long "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_AES_CTR,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with AES CTR encryption Uplink with short "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_AES_CTR,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with AES CTR encryption Downlink with short "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_AES_CTR,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with AES CTR encryption Uplink with 15 bit "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_AES_CTR,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with AES CTR encryption Downlink with 15 bit "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_AES_CTR,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with AES CTR encryption Uplink with 18 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_AES_CTR,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
        .cipher_key_len = 16,
    ...
    {
        .name = "PDCP User Plane with ZUC encryption Uplink with long sequence "
                "number",
        .cipher_alg = RTE_CRYPTO_CIPHER_ZUC_EEA3,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with ZUC encryption Downlink with long "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_ZUC_EEA3,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with ZUC encryption Uplink with short "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_ZUC_EEA3,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with ZUC encryption Downlink with short "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_ZUC_EEA3,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with ZUC encryption Uplink with 15 bit "
                "sequence number",
        .cipher_alg = RTE_CRYPTO_CIPHER_ZUC_EEA3,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {.name = "PDCP User Plane with ZUC encryption Downlink with 15 bit "
             "sequence number",
     .cipher_alg = RTE_CRYPTO_CIPHER_ZUC_EEA3,
     .auth_alg = 0,
     .domain = RTE_SECURITY_PDCP_MODE_DATA,
     ...
     .auth_key_len = 0},
    {
        .name = "PDCP User Plane with ZUC encryption Uplink with 18 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_ZUC_EEA3,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
        .cipher_key_len = 16,
    ...
    {
        .name = "PDCP User Plane with ZUC encryption Downlink with 18 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_ZUC_EEA3,
        .auth_alg = 0,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
        .cipher_key_len = 16,
    ...
    {
        .name = "PDCP User Plane with NULL encryption and NULL integrity "
                "Uplink with 12 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_NULL,
        .auth_alg = RTE_CRYPTO_AUTH_NULL,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
        .cipher_key_len = 0,
    ...
    {
        .name = "PDCP User Plane with NULL encryption and SNOW f9 integrity "
                "Uplink with 12 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_NULL,
        .auth_alg = RTE_CRYPTO_AUTH_SNOW3G_UIA2,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with NULL encryption and AES CMAC integrity "
                "Uplink with 12 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_NULL,
        .auth_alg = RTE_CRYPTO_AUTH_AES_CMAC,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with NULL encryption and ZUC integrity Uplink "
                "with 12 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_NULL,
        .auth_alg = RTE_CRYPTO_AUTH_ZUC_EIA3,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with NULL encryption and ZUC integrity "
                "Downlink with 12 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_NULL,
        .auth_alg = RTE_CRYPTO_AUTH_ZUC_EIA3,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with SNOW f8 encryption and NULL integrity "
                "Uplink with 12 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_SNOW3G_UEA2,
        .auth_alg = RTE_CRYPTO_AUTH_NULL,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with SNOW f8 encryption and SNOW f9 integrity "
                "Uplink with 12 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_SNOW3G_UEA2,
        .auth_alg = RTE_CRYPTO_AUTH_SNOW3G_UIA2,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with SNOW f8 encryption and AES CMAC "
                "integrity Uplink with 12 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_SNOW3G_UEA2,
        .auth_alg = RTE_CRYPTO_AUTH_AES_CMAC,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
        .cipher_key_len = 16,
    ...
    {
        .name = "PDCP User Plane with SNOW f8 encryption and AES CMAC "
                "integrity Downlink with 12 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_SNOW3G_UEA2,
        .auth_alg = RTE_CRYPTO_AUTH_AES_CMAC,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
        .cipher_key_len = 16,
    ...
    {
        .name = "PDCP User Plane with SNOW f8 encryption and ZUC integrity "
                "Uplink with 12 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_SNOW3G_UEA2,
        .auth_alg = RTE_CRYPTO_AUTH_ZUC_EIA3,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with AES CTR encryption and NULL integrity "
                "Uplink with 12 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_AES_CTR,
        .auth_alg = RTE_CRYPTO_AUTH_NULL,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with AES CTR encryption and SNOW f9 integrity "
                "Uplink with 12 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_AES_CTR,
        .auth_alg = RTE_CRYPTO_AUTH_SNOW3G_UIA2,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with AES CTR encryption and AES CMAC "
                "integrity Uplink with 12 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_AES_CTR,
        .auth_alg = RTE_CRYPTO_AUTH_AES_CMAC,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with AES CTR encryption and ZUC integrity "
                "Uplink with 12 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_AES_CTR,
        .auth_alg = RTE_CRYPTO_AUTH_ZUC_EIA3,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with ZUC encryption and NULL integrity Uplink "
                "with 12 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_ZUC_EEA3,
        .auth_alg = RTE_CRYPTO_AUTH_NULL,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with ZUC encryption and NULL integrity "
                "Downlink with 12 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_ZUC_EEA3,
        .auth_alg = RTE_CRYPTO_AUTH_NULL,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with ZUC encryption and SNOW f9 integrity "
                "Uplink with 12 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_ZUC_EEA3,
        .auth_alg = RTE_CRYPTO_AUTH_SNOW3G_UIA2,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with ZUC encryption and AES CMAC integrity "
                "Uplink with 12 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_ZUC_EEA3,
        .auth_alg = RTE_CRYPTO_AUTH_AES_CMAC,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with ZUC encryption and ZUC integrity Uplink "
                "with 12 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_ZUC_EEA3,
        .auth_alg = RTE_CRYPTO_AUTH_ZUC_EIA3,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with ZUC encryption and ZUC integrity "
                "Downlink with 12 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_ZUC_EEA3,
        .auth_alg = RTE_CRYPTO_AUTH_ZUC_EIA3,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
    ...
    {
        .name = "PDCP User Plane with SNOW f8 encryption and AES CMAC "
                "integrity Uplink with 18 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_SNOW3G_UEA2,
        .auth_alg = RTE_CRYPTO_AUTH_AES_CMAC,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
        .cipher_key_len = 16,
    ...
    {
        .name = "PDCP User Plane with SNOW f8 encryption and AES CMAC "
                "integrity Downlink with 18 bit SN",
        .cipher_alg = RTE_CRYPTO_CIPHER_SNOW3G_UEA2,
        .auth_alg = RTE_CRYPTO_AUTH_AES_CMAC,
        .domain = RTE_SECURITY_PDCP_MODE_DATA,
        .cipher_key_len = 16,
...
static uint8_t *pdcp_test_data_in[] = {
    ...
    /* User Plane w/NULL enc. UL for 18-bit SN*/
    (uint8_t[]){
        0xF8, 0x00, 0x00, 0xF8, 0xDB, 0x2D, 0x3F, 0x23, 0x82, 0x53, 0xFD, 0x37,
        0xDE, 0x88, 0x63, 0x08, 0x4F, 0xD3, 0x71, 0xFB, 0xEB, 0x35, 0xF3, 0x64,
        0xD3, 0x5E, 0xAF, 0x3F, 0x57, 0xC2, 0xE2, 0x91, 0x91, 0xA3, 0x9C, 0xE6,
        0x30, 0x69, 0x70, 0x33, 0x8A, 0x15, 0xD0, 0x36, 0x47, 0x0E, 0x8F, 0xEE,
        0x2C, 0x96, 0x0C, 0xD7, 0x7D, 0x70, 0x1B, 0x01, 0x7F, 0x96, 0x46, 0x53,
        0xB0, 0xA4, 0x7A, 0xF9, 0xDD, 0xCC, 0x69, 0x00, 0x00, 0x00, 0x00},
    /* User Plane w/NULL enc. DL for 18-bit SN*/
    (uint8_t[]){
        0xF8, 0x00, 0x00, 0xF8, 0xDB, 0x2D, 0x3F, 0x23, 0x82, 0x53, 0xFD, 0x37,
        0xDE, 0x88, 0x63, 0x08, 0x4F, 0xD3, 0x71, 0xFB, 0xEB, 0x35, 0xF3, 0x64,
    ...
    /* User Plane w/SNOW enc. UL for 18-bit SN*/
    (uint8_t[]){
        0x0C, 0x00, 0x01, 0xB8, 0x33, 0x4F, 0x85, 0x8C, 0x2C, 0x65, 0x7D, 0x8F,
        0x5D, 0x40, 0x57, 0x60, 0x52, 0x4F, 0xB9, 0xF1, 0x69, 0xE9, 0x68, 0x04,
        0xFC, 0x7A, 0xBE, 0xD2, 0x5B, 0x4A, 0x21, 0x7F, 0x13, 0x52, 0x08, 0xBA,
        0xBD, 0x69, 0x51, 0xC9, 0x63, 0xCF, 0x06, 0x62, 0x31, 0xA2, 0x76, 0xBA,
        0xFC, 0x5A, 0xDB, 0xAA, 0xA3, 0x0B, 0x6A, 0xD2, 0xEE, 0xD6, 0x93, 0xE4,
        0x1B, 0x11, 0x4F, 0xC4, 0xD7, 0xDA, 0x91, 0x00, 0x00, 0x00, 0x00},
    /* User Plane w/SNOW enc. DL for 18-bit SN*/
    (uint8_t[]){
        0xF8, 0x00, 0x00, 0xF8, 0xDB, 0x2D, 0x3F, 0x23, 0x82, 0x53, 0xFD, 0x37,
        0xDE, 0x88, 0x63, 0x08, 0x4F, 0xD3, 0x71, 0xFB, 0xEB, 0x35, 0xF3, 0x64,
    ...
    /*************** u-plane with integrity for 18-bit SN *****/
    /* User Plane w/NULL enc. + NULL int. UL for 18-bit SN*/
    (uint8_t[]){0xF8, 0x00, 0x00, 0xF8, 0xDB, 0x2D, 0x3F, 0x23, 0x82, 0x53,
                0xFD, 0x37, 0xDE, 0x88, 0x63, 0x08, 0x4F, 0xD3, 0x71, 0xFB,
                0xEB, 0x35, 0xF3, 0x64, 0xD3, 0x5E, 0xAF, 0x3F, 0x57, 0xC2,
                0xE2, 0x91, 0x91, 0xA3, 0x9C, 0xE6, 0x30, 0x69, 0x70, 0x33,
                0x8A, 0x15, 0xD0, 0x36, 0x47, 0x0E, 0x8F, 0xEE, 0x2C, 0x96,
                0x0C, 0xD7, 0x7D, 0x70, 0x1B, 0x01, 0x7F, 0x96, 0x46, 0x53,
                0xB0, 0xA4, 0x7A, 0xF9, 0xDD, 0xCC, 0x69},
    /* User Plane w/NULL enc. + NULL int. DL for 18-bit SN*/
    (uint8_t[]){0xF8, 0x00, 0x00, 0xF8, 0xDB, 0x2D, 0x3F, 0x23, 0x82, 0x53,
                0xFD, 0x37, 0xDE, 0x88, 0x63, 0x08, 0x4F, 0xD3, 0x71, 0xFB,
                0xEB, 0x35, 0xF3, 0x64, 0xD3, 0x5E, 0xAF, 0x3F, 0x57, 0xC2,
                ...
                0xB0, 0xA4, 0x7A, 0xF9, 0xDD, 0xCC, 0x69},
    /* User Plane w/NULL enc. + SNOW f9 int. UL for 18-bit SN*/
    (uint8_t[]){0x0C, 0x00, 0x01, 0xB8, 0x33, 0x4F, 0x85, 0x8C, 0x2C, 0x65,
                0x7D, 0x8F, 0x5D, 0x40, 0x57, 0x60, 0x52, 0x4F, 0xB9, 0xF1,
                0x69, 0xE9, 0x68, 0x04, 0xFC, 0x7A, 0xBE, 0xD2, 0x5B, 0x4A,
                0x21, 0x7F, 0x13, 0x52, 0x08, 0xBA, 0xBD, 0x69, 0x51, 0xC9,
                0x63, 0xCF, 0x06, 0x62, 0x31, 0xA2, 0x76, 0xBA, 0xFC, 0x5A,
                0xDB, 0xAA, 0xA3, 0x0B, 0x6A, 0xD2, 0xEE, 0xD6, 0x93, 0xE4,
                0x1B, 0x11, 0x4F, 0xC4, 0xD7, 0xDA, 0x91},
    /* User Plane w/NULL enc. + SNOW f9 int. DL for 18-bit SN*/
    (uint8_t[]){0xF8, 0x00, 0x00, 0xF8, 0xDB, 0x2D, 0x3F, 0x23, 0x82, 0x53,
                0xFD, 0x37, 0xDE, 0x88, 0x63, 0x08, 0x4F, 0xD3, 0x71, 0xFB,
                0xEB, 0x35, 0xF3, 0x64, 0xD3, 0x5E, 0xAF, 0x3F, 0x57, 0xC2,
...
static uint8_t *pdcp_test_data_out[] = {
    ...
    /* User Plane w/SNOW enc. UL for 18-bit SN*/
    (uint8_t[]){
        0x0C, 0x00, 0x01, 0x9A, 0xAF, 0x1D, 0x21, 0x2F, 0x48, 0xB2, 0x30, 0xCF,
        0xBB, 0x8A, 0x2C, 0xB7, 0x57, 0xB6, 0x27, 0x89, 0x0D, 0x91, 0x03, 0x2C,
        0x2B, 0x8D, 0x29, 0x4A, 0xBD, 0x8D, 0x48, 0xD2, 0x69, 0x37, 0xB1, 0xA1,
        0x97, 0x12, 0xBD, 0x0A, 0x91, 0x4D, 0xEB, 0x76, 0xC8, 0x96, 0x7A, 0x0A,
        0x25, 0x08, 0xEB, 0x41, 0x30, 0x00, 0x33, 0xC7, 0xFF, 0x33, 0x4E, 0xC1,
        0xFE, 0x5C, 0x0F, 0x15, 0xE7, 0x9F, 0x31, 0x55, 0xDA, 0x18, 0x4D},
    /* User Plane w/SNOW enc. DL for 18-bit SN*/
    (uint8_t[]){
        0xF8, 0x00, 0x00, 0x22, 0x2D, 0x15, 0xBA, 0x95, 0xAC, 0x47, 0x5A, 0xE3,
        0x90, 0x82, 0xEA, 0xC2, 0x93, 0x80, 0x23, 0xE9, 0xAC, 0xEA, 0x5D, 0xAA,
        0x70, 0x42, 0x04, 0x7C, 0xE6, 0xA6, 0x1D, 0x91, 0xAE, 0x2E, 0x43, 0x60,
        0x39, 0x23, 0x06, 0xD2, 0x31, 0x73, 0x98, 0xF0, 0x61, 0x47, 0xB5, 0xC4,
        0xB0, 0xB8, 0x31, 0x50, 0x9E, 0x37, 0x15, 0x0E, 0x0D, 0x29, 0x9D, 0xB3,
        0x78, 0xFB, 0x9D, 0x5C, 0x90, 0xF8, 0x80, 0x53, 0x93, 0xEF, 0x7C},
    /* User Plane w/AES CTR enc. UL LONG SN */
    ...
    /* User Plane w/AES enc. UL for 18-bit SN*/
    (uint8_t[]){
        0x0C, 0x00, 0x01, 0
. UL for 18-bit SN */
    (uint8_t[]){
        0x0C, 0x00, 0x01, 0x9A, 0xAF, 0x1D, 0x21, 0x2F, 0x48, 0xB2, 0x30, 0xCF,
        0xBB, 0x8A, 0x2C, 0xB7, 0x57, 0xB6, 0x27, 0x89, 0x0D, 0x91, 0x03, 0x2C,
    ...
    (uint8_t[]){
        ...
        0x97, 0x12, 0xBD, 0x0A, 0x91, 0x4D, 0xEB, 0x76, 0xC8, 0x96, 0x7A, 0x0A,
        0x25, 0x08, 0xEB, 0x41, 0x30, 0x00, 0x33, 0xC7, 0xFF, 0x33, 0x4E, 0xC1,
        0xFE, 0x5C, 0x0F, 0x15, 0xE7, 0x9F, 0x31, 0x2A, 0xAB, 0x0F, 0x24},
    /* User Plane w/SNOW f8 enc. + SNOW f9 int. DL for 18-bit SN */
    (uint8_t[]){
        0xF8, 0x00, 0x00, 0x22, 0x2D, 0x15, 0xBA, 0x95, 0xAC, 0x47, 0x5A, 0xE3,
        0x90, 0x82, 0xEA, 0xC2, 0x93, 0x80, 0x23, 0xE9, 0xAC, 0xEA, 0x5D, 0xAA,
        ...
        0x39, 0x23, 0x06, 0xD2, 0x31, 0x73, 0x98, 0xF0, 0x61, 0x47, 0xB5, 0xC4,
        0xB0, 0xB8, 0x31, 0x50, 0x9E, 0x37, 0x15, 0x0E, 0x0D, 0x29, 0x9D, 0xB3,
        0x78, 0xFB, 0x9D, 0x5C, 0x90, 0xF8, 0x80, 0xD7, 0xD6, 0x47, 0xF4},
    /* User Plane w/SNOW f8 enc. + AES CMAC int. UL for 18-bit SN */
    (uint8_t[]){
        0x0C, 0x00, 0x01, 0x9A, 0xAF, 0x1D, 0x21, 0x2F, 0x48, 0xB2, 0x30, 0xCF,
        0xBB, 0x8A, 0x2C, 0xB7, 0x57, 0xB6, 0x27, 0x89, 0x0D, 0x91, 0x03, 0x2C,
        ...
        0x97, 0x12, 0xBD, 0x0A, 0x91, 0x4D, 0xEB, 0x76, 0xC8, 0x96, 0x7A, 0x0A,
        0x25, 0x08, 0xEB, 0x41, 0x30, 0x00, 0x33, 0xC7, 0xFF, 0x33, 0x4E, 0xC1,
        0xFE, 0x5C, 0x0F, 0x15, 0xE7, 0x9F, 0x31, 0x66, 0x41, 0x20, 0xBA},
    /* User Plane w/SNOW f8 enc. + AES CMAC int. DL for 18-bit SN */
    (uint8_t[]){
        0xF8, 0x00, 0x00, 0x22, 0x2D, 0x15, 0xBA, 0x95, 0xAC, 0x47, 0x5A, 0xE3,
        0x90, 0x82, 0xEA, 0xC2, 0x93, 0x80, 0x23, 0xE9, 0xAC, 0xEA, 0x5D, 0xAA,
        ...
        0x39, 0x23, 0x06, 0xD2, 0x31, 0x73, 0x98, 0xF0, 0x61, 0x47, 0xB5, 0xC4,
        0xB0, 0xB8, 0x31, 0x50, 0x9E, 0x37, 0x15, 0x0E, 0x0D, 0x29, 0x9D, 0xB3,
        0x78, 0xFB, 0x9D, 0x5C, 0x90, 0xF8, 0x80, 0x8A, 0x98, 0x66, 0x03},
    /* User Plane w/SNOW f8 enc. + ZUC int. UL for 18-bit SN */
    (uint8_t[]){
        0x0C, 0x00, 0x01, 0x9A, 0xAF, 0x1D, 0x21, 0x2F, 0x48, 0xB2, 0x30, 0xCF,
        0xBB, 0x8A, 0x2C, 0xB7, 0x57, 0xB6, 0x27, 0x89, 0x0D, 0x91, 0x03, 0x2C,
        ...
        0x97, 0x12, 0xBD, 0x0A, 0x91, 0x4D, 0xEB, 0x76, 0xC8, 0x96, 0x7A, 0x0A,
        0x25, 0x08, 0xEB, 0x41, 0x30, 0x00, 0x33, 0xC7, 0xFF, 0x33, 0x4E, 0xC1,
        0xFE, 0x5C, 0x0F, 0x15, 0xE7, 0x9F, 0x31, 0xE0, 0x03, 0x45, 0xAD},
    /* User Plane w/SNOW f8 enc. + ZUC int. DL for 18-bit SN */
    (uint8_t[]){
        0xF8, 0x00, 0x00, 0x22, 0x2D, 0x15, 0xBA, 0x95, 0xAC, 0x47, 0x5A, 0xE3,
        0x90, 0x82, 0xEA, 0xC2, 0x93, 0x80, 0x23, 0xE9, 0xAC, 0xEA, 0x5D, 0xAA,
        ...
        0x39, 0x23, 0x06, 0xD2, 0x31, 0x73, 0x98, 0xF0, 0x61, 0x47, 0xB5, 0xC4,
        0xB0, 0xB8, 0x31, 0x50, 0x9E, 0x37, 0x15, 0x0E, 0x0D, 0x29, 0x9D, 0xB3,
        0x78, 0xFB, 0x9D, 0x5C, 0x90, 0xF8, 0x80, 0x89, 0x7A, 0xF8, 0xEA},
    /* User Plane w/AES CTR enc. + NULL int. UL for 18-bit SN  */
    (uint8_t[]){
        0x0C, 0x00, 0x01, 0xBF, 0x31, 0x94, 0xCF, 0x6E, 0x99, 0x84, 0x08, 0xF1,
        0x90, 0xC2, 0x22, 0xD0, 0xD2, 0x3D, 0x44, 0x75, 0x7F, 0xC5, 0x0F, 0xAC,
    ...
    (uint8_t[]){
        ...
        0xCB, 0x70, 0x17, 0xBC, 0x01, 0x1D, 0xA3, 0x65, 0x0E, 0x4B, 0x53, 0x14,
        0x73, 0x76, 0xDE, 0x54, 0xA0, 0xF9, 0x4C, 0xC2, 0x8F, 0x02, 0x88, 0x36,
        0xC7, 0xC4, 0x5A, 0x57, 0x7D, 0xA1, 0x0D, 0xBE, 0x17, 0x81, 0xA1},
    /* User Plane w/AES CTR enc. + SNOW f9 int. DL for 18-bit SN */
    (uint8_t[]){
        0xF8, 0x00, 0x00, 0x01, 0x0D, 0x4B, 0x5E, 0xD3, 0xCE, 0x96, 0xE1, 0x9A,
        0x9D, 0xB3, 0x01, 0xD6, 0x40, 0x50, 0x00, 0x6C, 0x63, 0xFD, 0x37, 0xD9,
        ...
        0x14, 0xD3, 0x14, 0xBC, 0x7E, 0x57, 0xAB, 0xB0, 0x8D, 0x8F, 0x42, 0x39,
        0x22, 0xB2, 0xF6, 0x5F, 0xBD, 0x58, 0xE3, 0xE0, 0xDB, 0xD5, 0x7F, 0xFB,
        0x78, 0x95, 0xE1, 0x5E, 0x36, 0xF8, 0x52, 0x1C, 0x50, 0xC0, 0xBD},
    /* User Plane w/AES CTR enc. + AES CMAC int. UL for 18-bit SN */
    (uint8_t[]){
        0x0C, 0x00, 0x01, 0xBF, 0x31, 0x94, 0xCF, 0x6E, 0x99, 0x84, 0x08, 0xF1,
        0x90, 0xC2, 0x22, 0xD0, 0xD2, 0x3D, 0x44, 0x75, 0x7F, 0xC5, 0x0F, 0xAC,
        ...
        0xCB, 0x70, 0x17, 0xBC, 0x01, 0x1D, 0xA3, 0x65, 0x0E, 0x4B, 0x53, 0x14,
        0x73, 0x76, 0xDE, 0x54, 0xA0, 0xF9, 0x4C, 0xC2, 0x8F, 0x02, 0x88, 0x36,
        0xC7, 0xC4, 0x5A, 0x57, 0x7D, 0xA1, 0x0D, 0xF2, 0xFD, 0xAE, 0x3F},
    /* User Plane w/AES CTR enc. + AES CMAC int. DL for 18-bit SN */
    (uint8_t[]){
        0xF8, 0x00, 0x00, 0x01, 0x0D, 0x4B, 0x5E, 0xD3, 0xCE, 0x96, 0xE1, 0x9A,
        0x9D, 0xB3, 0x01, 0xD6, 0x40, 0x50, 0x00, 0x6C, 0x63, 0xFD, 0x37, 0xD9,
        ...
        0x14, 0xD3, 0x14, 0xBC, 0x7E, 0x57, 0xAB, 0xB0, 0x8D, 0x8F, 0x42, 0x39,
        0x22, 0xB2, 0xF6, 0x5F, 0xBD, 0x58, 0xE3, 0xE0, 0xDB, 0xD5, 0x7F, 0xFB,
        0x78, 0x95, 0xE1, 0x5E, 0x36, 0xF8, 0x52, 0x41, 0x1E, 0xE1, 0x4A},
    /* User Plane w/AES CTR enc. + ZUC int. UL for 18-bit SN */
    (uint8_t[]){
        0x0C, 0x00, 0x01, 0xBF, 0x31, 0x94, 0xCF, 0x6E, 0x99, 0x84, 0x08, 0xF1,
        0x90, 0xC2, 0x22, 0xD0, 0xD2, 0x3D, 0x44, 0x75, 0x7F, 0xC5, 0x0F, 0xAC,
        ...
        0xCB, 0x70, 0x17, 0xBC, 0x01, 0x1D, 0xA3, 0x65, 0x0E, 0x4B, 0x53, 0x14,
        0x73, 0x76, 0xDE, 0x54, 0xA0, 0xF9, 0x4C, 0xC2, 0x8F, 0x02, 0x88, 0x36,
        0xC7, 0xC4, 0x5A, 0x57, 0x7D, 0xA1, 0x0D, 0x74, 0xBF, 0xCB, 0x28},
    /* User Plane w/AES CTR enc. + ZUC int. DL for 18-bit SN */
    (uint8_t[]){
        0xF8, 0x00, 0x00, 0x01, 0x0D, 0x4B, 0x5E, 0xD3, 0xCE, 0x96, 0xE1, 0x9A,
        0x9D, 0xB3, 0x01, 0xD6, 0x40, 0x50, 0x00, 0x6C, 0x63, 0xFD, 0x37, 0xD9,
        ...
        0x14, 0xD3, 0x14, 0xBC, 0x7E, 0x57, 0xAB, 0xB0, 0x8D, 0x8F, 0x42, 0x39,
        0x22, 0xB2, 0xF6, 0x5F, 0xBD, 0x58, 0xE3, 0xE0, 0xDB, 0xD5, 0x7F, 0xFB,
        0x78, 0x95, 0xE1, 0x5E, 0x36, 0xF8, 0x52, 0x42, 0xFC, 0x7F, 0xA3},
    /* User Plane w/ZUC enc. + NULL int. UL for 18-bit SN */
    (uint8_t[]){
        0x0C, 0x00, 0x01, 0x32, 0xF9, 0x21, 0x1D, 0xBB, 0xF8, 0xE5, 0x7C, 0x74,
        0xC2, 0xD7, 0xFF, 0x74, 0x59, 0x3A, 0x69, 0xD1, 0x8B, 0x65, 0x98, 0xB9,
    ...
    (uint8_t[]){
        ...
        0x5A, 0xAF, 0x15, 0x8E, 0x71, 0xED, 0xE4, 0xFA, 0x99, 0x79, 0xF9, 0x51,
        0x54, 0x82, 0x69, 0x4C, 0x45, 0x0B, 0xFA, 0x87, 0x4D, 0x97, 0x6E, 0xB0,
        0xC9, 0x06, 0x08, 0x6B, 0xFC, 0x4A, 0x85, 0x3C, 0x13, 0x64, 0xB1},
    /* User Plane w/ZUC enc. + SNOW f9 int. DL for 18-bit SN */
    (uint8_t[]){
        0xF8, 0x00, 0x00, 0x30, 0x62, 0x48, 0xC0, 0xB1, 0xED, 0x1F, 0x13, 0x8A,
        0x7A, 0x62, 0x40, 0x12, 0x35, 0x54, 0x03, 0x93, 0xBD, 0xE5, 0x88, 0x51,
        ...
        0xEC, 0x71, 0xD8, 0x42, 0x01, 0x03, 0x3C, 0x0E, 0xBB, 0x7B, 0xDD, 0x7D,
        0x2D, 0xE0, 0x3C, 0xE3, 0x81, 0xAA, 0xEA, 0xCC, 0xD7, 0xFC, 0x46, 0x07,
        0x7C, 0x8E, 0x8E, 0x0E, 0x99, 0xB8, 0x31, 0xE1, 0x52, 0x5E, 0x6B},
    /* User Plane w/ZUC enc. + AES CMAC int. UL for 18-bit SN */
    (uint8_t[]){
        0x0C, 0x00, 0x01, 0x32, 0xF9, 0x21, 0x1D, 0xBB, 0xF8, 0xE5, 0x7C, 0x74,
        0xC2, 0xD7, 0xFF, 0x74, 0x59, 0x3A, 0x69, 0xD1, 0x8B, 0x65, 0x98, 0xB9,
        ...
        0x5A, 0xAF, 0x15, 0x8E, 0x71, 0xED, 0xE4, 0xFA, 0x99, 0x79, 0xF9, 0x51,
        0x54, 0x82, 0x69, 0x4C, 0x45, 0x0B, 0xFA, 0x87, 0x4D, 0x97, 0x6E, 0xB0,
        0xC9, 0x06, 0x08, 0x6B, 0xFC, 0x4A, 0x85, 0x70, 0xF9, 0x4B, 0x2F},
    /* User Plane w/ZUC enc. + AES CMAC int. DL for 18-bit SN */
    (uint8_t[]){
        0xF8, 0x00, 0x00, 0x30, 0x62, 0x48, 0xC0, 0xB1, 0xED, 0x1F, 0x13, 0x8A,
        0x7A, 0x62, 0x40, 0x12, 0x35, 0x54, 0x03, 0x93, 0xBD, 0xE5, 0x88, 0x51,
        ...
        0xEC, 0x71, 0xD8, 0x42, 0x01, 0x03, 0x3C, 0x0E, 0xBB, 0x7B, 0xDD, 0x7D,
        0x2D, 0xE0, 0x3C, 0xE3, 0x81, 0xAA, 0xEA, 0xCC, 0xD7, 0xFC, 0x46, 0x07,
        0x7C, 0x8E, 0x8E, 0x0E, 0x99, 0xB8, 0x31, 0xBC, 0x1C, 0x7F, 0x9C},
    /* User Plane w/ZUC enc. + ZUC int. UL for 18-bit SN */
    (uint8_t[]){
        0x0C, 0x00, 0x01, 0x32, 0xF9, 0x21, 0x1D, 0xBB, 0xF8, 0xE5, 0x7C, 0x74,
        0xC2, 0xD7, 0xFF, 0x74, 0x59, 0x3A, 0x69, 0xD1, 0x8B, 0x65, 0x98, 0xB9,
        ...
        0x5A, 0xAF, 0x15, 0x8E, 0x71, 0xED, 0xE4, 0xFA, 0x99, 0x79, 0xF9, 0x51,
        0x54, 0x82, 0x69, 0x4C, 0x45, 0x0B, 0xFA, 0x87, 0x4D, 0x97, 0x6E, 0xB0,
        0xC9, 0x06, 0x08, 0x6B, 0xFC, 0x4A, 0x85, 0xF6, 0xBB, 0x2E, 0x38},
    /* User Plane w/ZUC enc. + ZUC int. DL for 18-bit SN */
    (uint8_t[]){
        0xF8, 0x00, 0x00, 0x30, 0x62, 0x48, 0xC0, 0xB1, 0xED, 0x1F, 0x13, 0x8A,
        0x7A, 0x62, 0x40, 0x12, 0x35, 0x54, 0x03, 0x93, 0xBD, 0xE5, 0x88, 0x51,
        ...
        0xEC, 0x71, 0xD8, 0x42, 0x01, 0x03, 0x3C, 0x0E, 0xBB, 0x7B, 0xDD, 0x7D,
        0x2D, 0xE0, 0x3C, 0xE3, 0x81, 0xAA, 0xEA, 0xCC, 0xD7, 0xFC, 0x46, 0x07,
        0x7C, 0x8E, 0x8E, 0x0E, 0x99, 0xB8, 0x31, 0xBF, 0xFE, 0xE1, 0x75},
};
