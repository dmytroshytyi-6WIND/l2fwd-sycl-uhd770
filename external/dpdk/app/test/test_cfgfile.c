...
static int test_cfgfile_setup(void) {
...
static int test_cfgfile_cleanup(void) {
  const struct resource *r;
  int ret;
...
static int _test_cfgfile_sample(struct rte_cfgfile *cfgfile) {
  const char *value;
  int ret;
  ...
  TEST_ASSERT(strcmp("value1", value) == 0, "key1 unexpected value: %s", value);
  ...
  TEST_ASSERT(strcmp("value2", value) == 0, "key2 unexpected value: %s", value);

  value = rte_cfgfile_get_entry(cfgfile, "section2", "key3");
  TEST_ASSERT(strcmp("value3", value) == 0, "key3 unexpected value: %s", value);

  return 0;
}

static int test_cfgfile_sample1(void) {
...
static int test_cfgfile_sample2(void) {
  ...
  cfgfile =
      rte_cfgfile_load_with_params(CFG_FILES_ETC "/sample2.ini", 0, &params);
...
static int test_cfgfile_realloc_sections(void) {
  struct rte_cfgfile *cfgfile;
  int ret;
  const char *value;
  ...
  TEST_ASSERT(ret == 21, "section3 unexpected number of entries: %d", ret);
  ...
  TEST_ASSERT(strcmp("value8_section9", value) == 0, "key unexpected value: %s",
              value);
...
static int test_cfgfile_invalid_section_header(void) {
  struct rte_cfgfile *cfgfile;
...
static int test_cfgfile_invalid_comment(void) {
  struct rte_cfgfile_parameters params;
  struct rte_cfgfile *cfgfile;
...
static int test_cfgfile_invalid_key_value_pair(void) {
  struct rte_cfgfile *cfgfile;
...
static int test_cfgfile_empty_key_value_pair(void) {
  struct rte_cfgfile *cfgfile;
  const char *value;
  int ret;
...
static int test_cfgfile_missing_section(void) {
  struct rte_cfgfile *cfgfile;
...
static int test_cfgfile_global_properties(void) {
  struct rte_cfgfile *cfgfile;
  const char *value;
  int ret;
  ...
  TEST_ASSERT(strcmp("value", value) == 0, "key unexpected value: %s", value);
...
static int test_cfgfile_empty_file(void) {
  struct rte_cfgfile *cfgfile;
  int ret;
