...
#define RING_ENQUEUE(ring, value)                                              \
  do {                                                                         \
    struct rte_mbuf *m;                                                        \
...
#define RUN_PIPELINE(pipeline)                                                 \
  do {                                                                         \
    rte_pipeline_run((pipeline));                                              \
    rte_pipeline_flush((pipeline));                                            \
  } while (0)

#define VERIFY(var, value)                                                     \
  do {                                                                         \
    if ((var) != -(value))                                                     \
      return var;                                                              \
  } while (0)

#define VERIFY_TRAFFIC(ring, sent, expected)                                   \
  do {                                                                         \
    unsigned i, n = 0;                                                         \
    void *mbuf = NULL;                                                         \
                                                                               \
...
uint64_t pipeline_test_hash(void *key, __rte_unused void *key_mask,
