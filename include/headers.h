...
// void workload_launch_gpu_processing(rte_gpu_comm_list **pkt_pipeline, long
// idx, uint64_t wtime_n, 		int cuda_blocks, int cuda_threads,
// dpct::queue_ptr
// stream);
...
void workload_launch_persistent_gpu_processing(
    struct rte_gpu_comm_list *comm_item_list, uint64_t wtime_n, int cuda_blocks,
    int cuda_threads, dpct::queue_ptr stream);

void workload_launch_gpu_graph_processing(struct rte_gpu_comm_list *comm_item,
                                          uint64_t wtime_n, int cuda_blocks,
                                          int cuda_threads,
